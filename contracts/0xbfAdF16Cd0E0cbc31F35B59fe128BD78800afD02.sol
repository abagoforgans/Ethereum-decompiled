...
function _fallback() payable {
    ...
    if not msg.value:
        stor0 = msg.sender
        require code.data[14184 len 20]
        stor3 = code.data[14184 len 20]
        stor4 = code.data[14216 len 20]
        stor5 = code.data[14248 len 20]
        stor6 = code.data[14280 len 20]
        if ext_code.size(stor3):
            call stor3.getReserveBalance(address rg1) with:
                 gas gas_remaining - 710 wei
                args stor4
            if ext_call.success:
                return code.data[1722 len 12450]
    revert
}
...
function sub_21c4d12a(?) {
    require msg.sender == owner
    delegate stor9 with:
       funct (Mask(32, 224, sha3('this.etherToken().approve(addres', 's,uint256)')) >> 224)
         gas gas_remaining - 710 wei
        args stor15, 0
    require delegate.return_code
    delegate stor9 with:
...
function sub_35d86662(?) {
    ...
    if not arg1:
        delegate stor8 with:
           funct (Mask(32, 224, sha3('this.tokenChanger().withdrawToke', 'ns(IERC20Token,address,uint256)')) >> 224)
             gas gas_remaining - 710 wei
        ...
        if arg1 == 1:
            ...
            if arg1 == 2:
                ...
                if arg1 == 3:
                    ...
                    if arg1 == 4:
                        delegate stor8 with:
                           funct (Mask(32, 224, sha3('this.smartToken().transfer(addre', 'ss,uint256)')) >> 224)
                             gas gas_remaining - 710 wei
                            args address(arg2), arg3
                    else:
                        if arg1 == 5:
                            ...
                            if arg1 == 6:
                                delegate stor8 with:
                                   funct (Mask(32, 224, sha3('this.smartToken().issue(address,', 'uint256)')) >> 224)
                                     gas gas_remaining - 710 wei
                                    args address(arg2), arg3
                            else:
                                if arg1 != 7:
                                    return 0
                                delegate stor8 with:
                                   funct (Mask(32, 224, sha3('this.tokenChanger().setFormula(I', 'BancorFormula)')) >> 224)
                                     gas gas_remaining - 710 wei
