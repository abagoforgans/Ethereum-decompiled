...
function _fallback() payable {
    ...
    mem[160 len -4538] = code.data[5081 len -4538]
    ...
    stor3 = mem[255 len 1]
    stor7 = msg.sender
    stor10[address(this.address)] = 300000 * 10^18
    stor10[msg.sender] += 0xffffffffffffffffffffffffffffffffffffffffffffc078f7a85c1f1c800000
    return code.data[543 len 4538]
}
...
function sell(uint256 arg1) {
    require balanceOf[address(msg.sender)] >= arg1
    require not stor11[address(msg.sender)]
    require balanceOf[address(this.address)] >= arg1 * sellPrice
