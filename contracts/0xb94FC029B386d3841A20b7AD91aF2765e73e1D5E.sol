...
function sub_d44b75ff(?) payable {
    ...
    while idx < _7:
        ...
        while s < stor1:
            require s < 6
            require s < 0
            mem[(32 * s) + _4 + 32] = mem[(32 * s) + _15 + 31 len 1]
            require s < 0
            require s < 6
            uint256(sub_24c9af35[0.03125 / s]) = mem[(32 * s) + _4 + 32] * 256^(s % 32) or !(255 * 256^(s % 32)) and uint256(sub_24c9af35[0.03125 / s])
            s = s + 1
            continue 
        s = _15
        idx = idx + 1
