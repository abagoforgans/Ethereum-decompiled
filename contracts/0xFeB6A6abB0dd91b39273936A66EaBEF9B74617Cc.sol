...
function sub_0d50844b(?) {
    ...
    call stor1.testTrade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11, address rg12) with:
         gas gas_remaining - 710 wei
        args address(arg1), arg7 << 128, 0, arg7 << 128, Mask(56, 192, arg8) << 8, arg8 << 192, address(arg9), arg8 << 248, arg10, arg11, arg8 << 128, this.address
    require ext_call.success
    require ext_code.size(stor1)
    call stor1.testTrade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11, address rg12) with:
         gas gas_remaining - 710 wei
        args 0, arg2 << 128, address(arg1), arg2 << 128, Mask(56, 192, arg3) << 8, arg3 << 192, address(arg4), arg3 << 248, arg5, arg6, arg3 << 128, this.address
    require ext_call.success
