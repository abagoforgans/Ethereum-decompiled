...
function sub_adca1847(?) payable {
    if msg.sender == sub_aaabd6b0Address:
        ...
        voters[address(arg1)].field_0 = voters[address(arg1)].field_0
        voters[address(arg1)].field_64 = voters[address(arg1)].field_64
        voters[address(arg1)].field_128 = voters[address(arg1)].field_128
}
