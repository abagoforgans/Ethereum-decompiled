...
function _fallback() payable {
    ...
    stor5 = code.data[5381 len 20]
    stor6 = code.data[5413 len 20]
    stor3 = code.data[5433 len 32]
    stor4 = code.data[5465 len 32]
...
function sub_1ce9413b(?) {
    require _saleState <= 3
    if _saleState == 2:
        return 3000
    require endBlock - startBlock
    return ((3 * ((10000 * endBlock) - (10000 * arg1) / endBlock - startBlock) + 5 / 10) + 3000)
}
