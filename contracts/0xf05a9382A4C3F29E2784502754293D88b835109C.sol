...
function _fallback() payable {
    ...
    stor4 = msg.sender
    stor21 = code.data[5141 len 32]
    stor19 = code.data[5185 len 20]
    stor20 = code.data[5217 len 20]
    stor0 = 0
    return code.data[407 len 4734]
}
...
const WEI_RAISED_CAP = 120000 * 10^18
...
function claimMigrate() {
    ...
    require stor24[address(msg.sender)].field_256
    require block.timestamp >= stor24[address(msg.sender)].field_0 + (168 * 24 * 3600)
    balanceOf[address(msg.sender)] += stor24[address(msg.sender)].field_256
    totalSupply += stor24[address(msg.sender)].field_256
    stor24[address(msg.sender)].field_0 = 0
    stor24[address(msg.sender)].field_256 = 0
}

function migrate(uint256 arg1) {
    require stor0
    require not migrateDisabled
    require stor24[address(msg.sender)].field_256 <= 0
    require ext_code.size(stor20)
    call stor20.0x23b872dd with:
         gas gas_remaining - 710 wei
        args msg.sender, address(this.address), arg1
    require ext_call.success
    stor24[address(msg.sender)].field_0 = block.timestamp
    stor24[address(msg.sender)].field_256 = arg1
}
...
function createTokens(address arg1) payable {
    ...
    require block.timestamp <= startTime + (672 * 24 * 3600)
    require weiRaised < 120000 * 10^18
    if weiRaised + msg.value <= 120000 * 10^18:
        if block.timestamp < startTime + (168 * 24 * 3600):
            if msg.value:
                require msg.value
        ...
        call msg.sender with:
           value msg.value + weiRaised - 120000 * 10^18 wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        if block.timestamp < startTime + (168 * 24 * 3600):
            if -weiRaised + 120000 * 10^18:
                require -weiRaised + 120000 * 10^18
                require (-1000 * weiRaised) + 120000000 * 10^18 / -weiRaised + 120000 * 10^18 == 1000
            require (-1000 * weiRaised) + totalSupply + 120000000 * 10^18 >= totalSupply
            totalSupply = (-1000 * weiRaised) + totalSupply + 120000000 * 10^18
            require 120000 * 10^18 >= weiRaised
            weiRaised = 120000 * 10^18
            require (-1000 * weiRaised) + balanceOf[address(arg1)] + 120000000 * 10^18 >= balanceOf[address(arg1)]
            balanceOf[address(arg1)] = (-1000 * weiRaised) + balanceOf[address(arg1)] + 120000000 * 10^18
            emit TokenCreated(((-1000 * weiRaised) + 120000000 * 10^18), arg1);
        else:
            if block.timestamp < startTime + (336 * 24 * 3600):
                if -weiRaised + 120000 * 10^18:
                    require -weiRaised + 120000 * 10^18
                    require (-900 * weiRaised) + (30000 * 10^18 * 24 * 3600) / -weiRaised + 120000 * 10^18 == 900
                require (-900 * weiRaised) + totalSupply + (30000 * 10^18 * 24 * 3600) >= totalSupply
                totalSupply = (-900 * weiRaised) + totalSupply + (30000 * 10^18 * 24 * 3600)
                require 120000 * 10^18 >= weiRaised
                weiRaised = 120000 * 10^18
                require (-900 * weiRaised) + balanceOf[address(arg1)] + (30000 * 10^18 * 24 * 3600) >= balanceOf[address(arg1)]
                balanceOf[address(arg1)] = (-900 * weiRaised) + balanceOf[address(arg1)] + (30000 * 10^18 * 24 * 3600)
                emit TokenCreated(((-900 * weiRaised) + (30000 * 10^18 * 24 * 3600)), arg1);
            else:
                if block.timestamp >= startTime + (504 * 24 * 3600):
                    if -weiRaised + 120000 * 10^18:
                        require -weiRaised + 120000 * 10^18
                        require (-700 * weiRaised) + 84000000 * 10^18 / -weiRaised + 120000 * 10^18 == 700
                    require (-700 * weiRaised) + totalSupply + 84000000 * 10^18 >= totalSupply
                    totalSupply = (-700 * weiRaised) + totalSupply + 84000000 * 10^18
                    require 120000 * 10^18 >= weiRaised
                    weiRaised = 120000 * 10^18
                    require (-700 * weiRaised) + balanceOf[address(arg1)] + 84000000 * 10^18 >= balanceOf[address(arg1)]
                    balanceOf[address(arg1)] = (-700 * weiRaised) + balanceOf[address(arg1)] + 84000000 * 10^18
                    emit TokenCreated(((-700 * weiRaised) + 84000000 * 10^18), arg1);
                else:
                    if -weiRaised + 120000 * 10^18:
                        require -weiRaised + 120000 * 10^18
                        require (-800 * weiRaised) + 96000000 * 10^18 / -weiRaised + 120000 * 10^18 == 800
                    require (-800 * weiRaised) + totalSupply + 96000000 * 10^18 >= totalSupply
                    totalSupply = (-800 * weiRaised) + totalSupply + 96000000 * 10^18
                    require 120000 * 10^18 >= weiRaised
                    weiRaised = 120000 * 10^18
                    require (-800 * weiRaised) + balanceOf[address(arg1)] + 96000000 * 10^18 >= balanceOf[address(arg1)]
                    balanceOf[address(arg1)] = (-800 * weiRaised) + balanceOf[address(arg1)] + 96000000 * 10^18
                    emit TokenCreated(((-800 * weiRaised) + 96000000 * 10^18), arg1);
        call stor19 with:
           value -weiRaised + 120000 * 10^18 wei
             gas 2300 * is_zero(value) wei
    require ext_call.success
}
...
function _fallback() payable {
    ...
    if weiRaised + msg.value <= 120000 * 10^18:
        ...
        if block.timestamp < startTime + (168 * 24 * 3600):
            ...
            require 120000 * 10^18 >= weiRaised
            weiRaised = 120000 * 10^18
            require (-1000 * weiRaised) + balanceOf[address(msg.sender)] + 120000000 * 10^18 >= balanceOf[address(msg.sender)]
            balanceOf[address(msg.sender)] = (-1000 * weiRaised) + balanceOf[address(msg.sender)] + 120000000 * 10^18
            emit TokenCreated(((-1000 * weiRaised) + 120000000 * 10^18), msg.sender);
        else:
            if block.timestamp < startTime + (336 * 24 * 3600):
                if -weiRaised + 120000 * 10^18:
                    require -weiRaised + 120000 * 10^18
                ...
                require 120000 * 10^18 >= weiRaised
                weiRaised = 120000 * 10^18
                require (-900 * weiRaised) + balanceOf[address(msg.sender)] + (30000 * 10^18 * 24 * 3600) >= balanceOf[address(msg.sender)]
                balanceOf[address(msg.sender)] = (-900 * weiRaised) + balanceOf[address(msg.sender)] + (30000 * 10^18 * 24 * 3600)
                emit TokenCreated(((-900 * weiRaised) + (30000 * 10^18 * 24 * 3600)), msg.sender);
            else:
                if block.timestamp >= startTime + (504 * 24 * 3600):
                    if -weiRaised + 120000 * 10^18:
                        require -weiRaised + 120000 * 10^18
                    ...
                    require 120000 * 10^18 >= weiRaised
                    weiRaised = 120000 * 10^18
                    require (-700 * weiRaised) + balanceOf[address(msg.sender)] + 84000000 * 10^18 >= balanceOf[address(msg.sender)]
                    balanceOf[address(msg.sender)] = (-700 * weiRaised) + balanceOf[address(msg.sender)] + 84000000 * 10^18
                    emit TokenCreated(((-700 * weiRaised) + 84000000 * 10^18), msg.sender);
                else:
                    if -weiRaised + 120000 * 10^18:
                        require -weiRaised + 120000 * 10^18
                        require (-800 * weiRaised) + 96000000 * 10^18 / -weiRaised + 120000 * 10^18 == 800
                    ...
                    require 120000 * 10^18 >= weiRaised
                    weiRaised = 120000 * 10^18
                    require (-800 * weiRaised) + balanceOf[address(msg.sender)] + 96000000 * 10^18 >= balanceOf[address(msg.sender)]
                    balanceOf[address(msg.sender)] = (-800 * weiRaised) + balanceOf[address(msg.sender)] + 96000000 * 10^18
                    emit TokenCreated(((-800 * weiRaised) + 96000000 * 10^18), msg.sender);
        call stor19 with:
           value -weiRaised + 120000 * 10^18 wei
             gas 2300 * is_zero(value) wei
    require ext_call.success
