...
uint256 stor13;
uint256 stor14;
uint256 startGameGas;
uint256 winnerDecidedGas;
uint8 settingsState;
...
function winnerDecidedGas() {
    return winnerDecidedGas
}
...
function getArbInfo(uint256 arg1) {
    return stor19[arg1], 
           stor18[stor19[arg1]].field_256,
           stor18[stor19[arg1]].field_256,
           stor18[stor19[arg1]].field_256,
           stor18[stor19[arg1]].field_512
}
                        ...
                        if stor((0.5 / idx) + ('map', ('param', 'arg1'), ('name', 'stor21', 21)) + 1)[uint8(idx)] < arg3:
                            ...
                            if gameInfo[arg1].field_32 > 0:
                                if uint128(uint128(stor18[address(msg.sender)].field_312 * gameInfo[arg1].field_32) / 1000) + uint128(uint128(stor18[address(msg.sender)].field_296 * gameInfo[arg1].field_32) / 1000) <= stor18[address(msg.sender)].field_360:
                                    if (startGameGas * block.gasprice) + (winnerDecidedGas * block.gasprice) > gameInfo[arg1].field_32 - uint128(uint128(stor18[address(msg.sender)].field_296 * gameInfo[arg1].field_32) / 1000) - uint128(uint128(stor18[address(msg.sender)].field_312 * gameInfo[arg1].field_32) / 1000):
                                        ...
                                        stor18[address(msg.sender)].field_512 = uint128((startGameGas * block.gasprice) + (winnerDecidedGas * block.gasprice) + uint128(uint128(stor18[address(msg.sender)].field_312 * gameInfo[arg1].field_32) / 1000) + stor18[address(msg.sender)].field_512)
                                        houseFeeHoldover += uint128(uint128(stor18[address(msg.sender)].field_296 * gameInfo[arg1].field_32) / 1000)
                                        if uint128(uint128(stor18[address(msg.sender)].field_296 * gameInfo[arg1].field_32) / 1000) + houseFeeHoldover <= houseFeeThreshold:
                                            if gameInfo[arg1].field_32 - uint128(uint128(stor18[address(msg.sender)].field_296 * gameInfo[arg1].field_32) / 1000) - uint128(uint128(stor18[address(msg.sender)].field_312 * gameInfo[arg1].field_32) / 1000) - (startGameGas * block.gasprice) - (winnerDecidedGas * block.gasprice) > 0:
                                                call arg2 with:
                                                   value gameInfo[arg1].field_32 - uint128(uint128(stor18[address(msg.sender)].field_296 * gameInfo[arg1].field_32) / 1000) - uint128(uint128(stor18[address(msg.sender)].field_312 * gameInfo[arg1].field_32) / 1000) - (startGameGas * block.gasprice) - (winnerDecidedGas * block.gasprice) wei
                                                     gas stor13 wei
                                                if not ext_call.success:
                                                    houseFeeHoldover = gameInfo[arg1].field_32 - uint128(uint128(stor18[address(msg.sender)].field_296 * gameInfo[arg1].field_32) / 1000) - uint128(uint128(stor18[address(msg.sender)].field_312 * gameInfo[arg1].field_32) / 1000) - (startGameGas * block.gasprice) - (winnerDecidedGas * block.gasprice) + houseFeeHoldover
                                    ...
                                    if (startGameGas * block.gasprice) + (winnerDecidedGas * block.gasprice) > gameInfo[arg1].field_32 - uint128(uint128(stor18[address(msg.sender)].field_296 * stor18[address(msg.sender)].field_360) / uint16(stor18[address(msg.sender)].field_296 + stor18[address(msg.sender)].field_312)) - uint128(uint128(stor18[address(msg.sender)].field_360 * stor18[address(msg.sender)].field_312) / uint16(stor18[address(msg.sender)].field_312 + stor18[address(msg.sender)].field_296)):
