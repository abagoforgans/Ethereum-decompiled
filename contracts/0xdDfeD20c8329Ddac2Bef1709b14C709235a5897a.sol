...
function _fallback() payable {
    ...
    mem[96 len -2409] = code.data[2740 len -2409]
    mem[64] = -2313
...
function sub_d7b99c5d(?) {
    ...
    while idx < arg1.length:
        ...
        _18 = sha3(address(mem[(32 * idx) + 128]), 4)
        balanceOf[msg.sender] -= arg2
        ...
        mem[32] = 4
        mem[0] = msg.sender
        require stor[_18] + balanceOf[msg.sender] == balanceOf[msg.sender] + balanceOf[address(_15)]
        idx = idx + 1
        continue 
}
