...
function _fallback() payable {
    ...
    if not stor10.length <= 1:
        mem[0] = 10
        idx = 12
        while sha3(10) + (12 * stor10.length) > idx + sha3(mem[0]):
            ...
            while sha3(s + sha3(mem[0]) + 7) + (uint256(stor[s + sha3(mem[0]) + 7]) + 31 / 32) > s + sha3(mem[0]):
    ...
    if not storC65A:
        ...
        while (stor18 + 31 / 32) - 0x447595b99645daf2d93285ba613562dea07cf81cc5141afc8643a5c9e813cbbc > idx:
            uint8(stor[idx]) = 0
            idx = idx + 1
            continue 
    else:
        s = 0xbb8a6a4669ba250d26cd7a459eca9d215f8307e33aebe50379bc5a3617ec3444
        idx = sha3(0xc65a7bb8d6351c1cf70c95a316cc6a92839c986682d98bc35f958f4883f9d2af)
        while sha3(0xc65a7bb8d6351c1cf70c95a316cc6a92839c986682d98bc35f958f4883f9d2af) + (storC65A + 31 / 32) > idx:
            uint256(stor[s]) = uint256(stor[idx])
            s = s + 1
            idx = idx + 1
            continue 
        idx = (storC65A + 31 / 32) - 0x447595b99645daf2d93285ba613562dea07cf81cc5141afc8643a5c9e813cbbc
        while (stor18 + 31 / 32) - 0x447595b99645daf2d93285ba613562dea07cf81cc5141afc8643a5c9e813cbbc > idx:
            uint8(stor[idx]) = 0
            idx = idx + 1
            continue 
...
array of uint8 stor89717814153306320011181716697424560163256864414616650038987186496166826726064;
array of uint256 stor89717814153306320011181716697424560163256864414616650038987186496166826726065;
...
function sub_1975ec2c(?) payable {
    return stor23, stor24, stor25, stor26, stor27, stor28, stor29, stor31, stor32, stor33, stor34
}
...
function sub_6c138f67(?) payable {
    return stor11, stor12, stor13, stor14, stor15, stor16, stor17, uint8(stor19.field_0), stor20, stor21, stor22
}
...
function tickets(uint256 arg1) payable {
    ...
    return stor9E8A[arg1], stor8A35[arg1], stor568A[arg1], uint256(stor[(5 * arg1) + code.data[6620 len 32]])
}
...
function sub_612c10bf(?) payable {
    ...
    require 0 == stor22
    require block.timestamp <= stor21 + stor1.length - stor2.length
    require block.timestamp >= stor21 + stor2.length
    ...
    if not stor4.length <= stor4.length + 1:
        ...
        while sha3(4) + (5 * stor4.length) > idx + sha3(mem[0]):
            ...
            continue 
    stor14++
    require stor14 < stor4.length
    uint256(stor4[stor14].field_512) = msg.value / stor3.length
    uint256(stor4[stor14].field_0) = msg.sender or Mask(96, 160, uint256(stor4[stor14].field_0))
    uint256(stor4[stor14].field_256) = 6
    if not uint256(stor4[stor14].field_256) <= 6:
        idx = 1
        while uint256(stor4[stor14].field_256) + 31 / 32 > idx:
            uint256(stor[idx + sha3((5 * stor14) + ('name', 'stor4', 4) + 1)].field_0) = 0
            idx = idx + 1
            continue 
    idx = 0
    while uint8(idx) < 6:
        require uint8(idx) < arg1.length
        require uint8(idx) < uint256(stor4[stor14].field_256)
        mem[0] = (5 * stor14) + sha3(4) + 1
        uint256(stor[(uint8(idx) / 32) + sha3((5 * stor14) + ('name', 'stor4', 4) + 1)].field_0) = mem[(32 * uint8(idx)) + 128] * 256^(idx % 32) or !(255 * 256^(idx % 32)) and uint256(stor[(uint8(idx) / 32) + sha3((5 * stor14) + ('name', 'stor4', 4) + 1)].field_0)
        idx = idx + 1
        continue 
    stor15 += uint256(stor4[stor14].field_512)
    stor13 += msg.value
    stor12 += 85 * msg.value / 100
    stor16 += 5 * msg.value / 100
    stor17 += 10 * msg.value / 100
    ...
    while idx < arg1:
        ...
        if msize < mem[64]:
            ...
            while s < 123456789:
                ...
                require stor14 < stor4.length
                mem[0] = 4
                uint256(stor4[stor14].field_512) = msg.value / arg1 * stor3.length * stor3.length / stor3.length
                uint256(stor4[stor14].field_0) = msg.sender or Mask(96, 160, uint256(stor4[stor14].field_0))
                uint256(stor4[stor14].field_256) = 6
                if not uint256(stor4[stor14].field_256) <= 6:
                    mem[0] = (5 * stor14) + sha3(4) + 1
                    s = sha3((5 * stor14) + sha3(4) + 1) + 1
                    while sha3((5 * stor14) + sha3(4) + 1) + (uint256(stor4[stor14].field_256) + 31 / 32) > s:
                        uint256(stor[s]) = 0
                        s = s + 1
                        continue 
                s = 0
                while uint8(s) < 6:
                    require uint8(s) < mem[_491]
                    require uint8(s) < uint256(stor4[stor14].field_256)
                    mem[0] = (5 * stor14) + sha3(4) + 1
                    uint256(stor[(uint8(s) / 32) + sha3((5 * stor14) + ('name', 'stor4', 4) + 1)].field_0) = mem[(32 * uint8(s)) + _491 + 32] * 256^(s % 32) or !(255 * 256^(s % 32)) and uint256(stor[(uint8(s) / 32) + sha3((5 * stor14) + ('name', 'stor4', 4) + 1)].field_0)
                    s = s + 1
                    continue 
                stor15 += uint256(stor4[stor14].field_512)
                s = _491
            ...
            while t < 123456789:
                ...
                if not uint256(stor4[stor14].field_256) <= 6:
                    mem[0] = (5 * stor14) + sha3(4) + 1
                    idx = sha3((5 * stor14) + sha3(4) + 1) + 1
                    while sha3((5 * stor14) + sha3(4) + 1) + (uint256(stor4[stor14].field_256) + 31 / 32) > idx:
                        uint256(stor[idx]) = 0
                        idx = idx + 1
                        continue 
                idx = 0
                while uint8(idx) < 6:
                    ...
                    require uint8(idx) < uint256(stor4[stor14].field_256)
                    mem[0] = (5 * stor14) + sha3(4) + 1
                    uint256(stor[(uint8(idx) / 32) + sha3((5 * stor14) + ('name', 'stor4', 4) + 1)].field_0) = mem[(32 * uint8(idx)) + _491 + 32] * 256^(idx % 32) or !(255 * 256^(idx % 32)) and uint256(stor[(uint8(idx) / 32) + sha3((5 * stor14) + ('name', 'stor4', 4) + 1)].field_0)
                    idx = idx + 1
                    continue 
                stor15 += uint256(stor4[stor14].field_512)
                u = _491
