...
function isAssetProxyRegistered(address arg1) {
...
function registerAssetProxy(address arg1, bool arg2) {
    require this.address == msg.sender
    require arg1
    stor8[address(arg1)] = uint8(arg2)
    emit AssetProxyRegistration(address(arg1), arg2);
}
...
function getConfirmations(uint256 arg1) {
    if owners.length:
        mem[128 len 32 * owners.length] = code.data[8883 len 32 * owners.length]
    idx = 0
    s = 0
    while idx < owners.length:
        mem[0] = address(owners[idx].field_0)
    ...
    if s:
        mem[(32 * owners.length) + 160 len 32 * s] = code.data[8883 len 32 * s]
    t = 0
    while t < s:
...
function executeRemoveAuthorizedAddressAtIndex(uint256 arg1) {
    require not uint8(stor0[arg1].field_768)
    idx = 0
    s = 0
    while idx < owners.length:
        ...
        if not uint8(stor1[arg1][address(stor3[idx].field_0)]):
            ...
            if s + 1 != required:
                ...
                s = s + 1
                continue 
        if not stor8[address(stor0[arg1].field_0)]:
            revert with 0, 'UNREGISTERED_ASSET_PROXY'
        mem[128] = stor0[arg1][2].field_0
        idx = 128
        s = sha3(sha3(arg1, 0) + 2)
        while stor0[arg1][2].length + 96 > idx:
        ...
        if Mask(32, 224, mem[128]) != Mask(32, 224, sha3('removeAuthorizedAddressAtIndex(a', 'ddress,uint256)')):
            revert with 0, 'INVALID_FUNCTION_SELECTOR'
        uint8(stor0[arg1].field_768) = 1
        mem[ceil32(stor0[arg1][2].length) + 160] = stor0[arg1][2].field_0
        idx = ceil32(stor0[arg1][2].length) + 160
        s = sha3(sha3(arg1, 0) + 2)
        while ceil32(stor0[arg1][2].length) + stor0[arg1][2].length + 128 > idx:
            mem[idx + 32] = uint256(stor1[s])
            idx = idx + 32
            s = s + 1
            continue 
        call address(stor0[arg1].field_0).mem[ceil32(stor0[arg1][2].length) + 160 len 4] with:
           value stor0[arg1].field_256 wei
             gas gas_remaining - 34710 wei
            args mem[ceil32(stor0[arg1][2].length) + 164 len stor0[arg1][2].length - 4]
        if ext_call.success:
            emit Execution(arg1);
        else:
            emit ExecutionFailure(arg1);
...
function getTransactionIds(uint256 arg1, uint256 arg2, bool arg3, bool arg4) {
    if transactionCount:
        mem[128 len 32 * transactionCount] = code.data[8883 len 32 * transactionCount]
    idx = 0
    s = 0
    while idx < transactionCount:
        if not arg3:
    ...
    if arg2 - arg1:
        mem[(32 * transactionCount) + 160 len 32 * arg2 - arg1] = code.data[8883 len 32 * arg2 - arg1]
    idx = arg1
    while idx < arg2:
