    ...
    if msg.value <= 21 * 10^18:
        ...
        if not stor0.length > stor0.length + 1:
            ...
            if not stor0.length:
                ...
                balance += msg.value
            if balance <= 155 * stor5629[stor1] / 100:
            require payoutIdx < stor0.length
            call address(stor5629[stor1]) with:
               value var25003 wei
                 gas 0 wei
            balance += -155 * stor[code.data[1122 len 32] + (2 * stor1)] / 100
            payoutIdx++
            if balance <= 155 * stor5629[stor1] / 100:
            require payoutIdx < stor0.length
            call address(stor5629[stor1]) with:
        ...
        if not stor0.length > stor0.length + 1:
            require stor0.length < stor0.length
            uint256(stor5629[stor0.length]) = msg.sender or Mask(96, 160, uint256(stor5629[stor0.length]))
            stor[code.data[1122 len 32] + (2 * stor0.length)] = 21 * 10^18
            if not stor0.length:
