...
function get_Holders(uint256 arg1) {
    ...
    if arg1 < ext_call.return_data[0]:
        return mem[96], mem[128], mem[160], mem[192 len 1952], v
    mem[2176] = 0
    require ext_code.size(stor2)
    call stor2.getCountTempHolders() with:
         gas gas_remaining - 50 wei
    ...
    while idx < ext_call.return_data[0]:
        ...
        if ext_call.return_data[0] / stor3 < tokensNeededToGetPayment:
            ...
            continue 
        require uint8(w) < 64
        mem[(32 * uint8(w)) + 96] = address(ext_call.return_data[0])
        if uint8(w + 1) != 64:
            s = ext_call.return_data[0]
            t = ext_call.return_data[0]
            w = ext_call.return_data[0]
        ...
        while idx > 32:
            ...
            idx = idx - 32
            continue 
        return mem[96], mem[128], mem[160], mem[2240 len 1952], x + 1
    return mem[96], mem[128], mem[160], mem[192 len 1952], x
}
