...
function _fallback() {
    mem[96 len -3782] = code.data[4286 len -3782]
    mem[64] = -3686
        ...
        if totalShareholders > 0:
            ...
            while idx <= totalShareholders:
                ...
                if balanceOf[stor9[idx]] <= 0:
                    ...
                    idx = idx + 1
                    continue 
                dividendsOf[stor9[idx]] += balanceOf[stor9[idx]]
                mem[0] = stor9[idx]
                mem[32] = 11
                if dividendsOf[stor9[idx]] < sub_f720ee4c:
                    s = s
                    t = balanceOf[stor9[idx]]
                    idx = idx + 1
                    continue 
                ...
                call stor9[idx] with:
                   value eth.balance(this.address) * dividendsOf[stor9[idx]] / sub_12579d85 wei
                     gas 2300 * is_zero(value) wei
                require ext_call.success
                mem[0] = stor9[idx]
                mem[32] = 11
                dividendsOf[stor9[idx]] = 0
                s = eth.balance(this.address) * dividendsOf[stor9[idx]] / sub_12579d85
                t = balanceOf[stor9[idx]]
                idx = idx + 1
                continue 
}
