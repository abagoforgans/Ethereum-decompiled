...
function _fallback() {
    require not code.data[2462 len 32] % 10
    stor4 = code.data[2462 len 32]
    stor3 = code.data[2506 len 20]
    stor2 = msg.sender
    return code.data[127 len 2335]
}
...
function _fallback() payable {
    require msg.value == sub_659f2878
    sub_9989ec5dAddress = msg.sender
}

function cancel() {
    require adminAddress == msg.sender
    require not sub_c537b30bAddress
    call sub_9989ec5dAddress with:
