...
function sub_af507833(?) payable {
    ...
    mem[128 len 736] = 0
    mem[64] = 1632
    mem[864] = ('signextend', 0, ('stor', ('length', ('name', 'stor198A', 6538))))
    mem[var6001] = ('signextend', 0, ('div', ('stor', ('length', ('name', 'stor198A', 6538))), ('exp', 256, ('var', 6002))))
    if 1632 <= var6001 + 32:
        return ('signextend', 0, ('stor', ('length', ('name', 'stor198A', 6538)))), mem[896 len 736]
    mem[var6001 + 32] = ('signextend', 0, ('div', ('stor', ('array', ('div', 0.03125, ('add', 1, ('var', 6002))), ('name', 'stor198A', 6538))), ('exp', 256, ('add', 1, ('mul', -1, ('div', ('mask', 256, 0, ('add', 1, ('var', 6002))), 32)), ('var', 6002), ('mul', -1, ('div', ('mask', 256, 0, ('add', 1, ('var', 6002))), 32), ('var', 6002))))))
    idx = var6001 + 32
    s = -(var6002 + 1 / 32) + var6002 + (-1 * var6002 + 1 / 32 * var6002) + 1
    t = (var6002 + 1 / 32) + 6538
    while 1632 > idx + 32:
        mem[idx + 32] = ('signextend', 0, ('div', ('type', 256, ('field', 0, ('stor', ('add', ('div', 0.03125, ('add', 1, ('var', 1))), ('var', 2))))), ('exp', 256, ('add', 1, ('mul', -1, ('div', ('mask', 256, 0, ('add', 1, ('var', 1))), 32)), ('var', 1), ('mul', -1, ('div', ('mask', 256, 0, ('add', 1, ('var', 1))), 32), ('var', 1))))))
        idx = idx + 32
        s = -(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1
        t = (s + 1 / 32) + t
        continue 
    mem[mem[64] len 768] = mem[864 len 768]
    return memory
      from mem[64]
       len 768
}
