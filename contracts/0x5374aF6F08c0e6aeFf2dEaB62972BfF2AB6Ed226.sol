...
function _fallback() payable {
    ...
    stor3 = 150 * 10^6 * 10^stor2
    stor4[address(msg.sender)] = 150 * 10^6 * 10^stor2
    bool(stor0.length) = 0
    stor0.length.field_1 = 11
    stor0.length.field_8 = 'Beauty Coin' / 256
    idx = 0
    ...
    stor1.length.field_8 = 'BTY' / 256
    idx = 0
    while stor1.length + 31 / 32 > idx:
        stor1[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[395 len 1842]
}
