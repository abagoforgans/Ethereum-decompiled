...
function _fallback() payable {
    ...
    return code.data[116 len 10923]
}
    ...
    if tx.origin == address(stor[(6 * arg2) + (198 * arg1) + 1].field_0):
        ...
        if stor1987 != tx.origin:
            ...
            if locked:
                ...
                uint8(whatHappened.length) = 36
                Mask(248, 0, whatHappened.length.field_8) = '52:setName:SUCCESS' / 256
    idx = code.data[10891 len 32]
    while code.data[10891 len 32] + (whatHappened.length + 31 / 32) > idx:
