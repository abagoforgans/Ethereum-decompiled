...
function _fallback() payable {
    ...
    stor4[address(msg.sender)] = code.data[3250 len 32]
    stor6 = code.data[3250 len 32]
    stor1 = code.data[3294 len 20]
    stor2 = code.data[3314 len 32]
    stor3 = 1
    return code.data[153 len 3097]
}
...
function currentSwapRate() {
    ...
    if creationTime + (576 * 24 * 3600) > block.timestamp:
        return 120
    if creationTime + (1254 * 3600) <= block.timestamp:
        return 0
    return 100
}
