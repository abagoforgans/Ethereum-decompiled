...
function _fallback() payable {
    stor0 = code.data[2227 len 32] or Mask(96, 160, stor0)
    stor1 = code.data[2259 len 32]
    stor3 = block.timestamp + (60 * code.data[2291 len 32])
    stor4 = code.data[2323 len 32]
    stor5 = code.data[2355 len 32] or Mask(96, 160, stor5)
    return code.data[195 len 2032]
}
