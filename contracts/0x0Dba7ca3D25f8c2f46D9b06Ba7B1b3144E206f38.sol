...
function transferOwnership(address arg1) {
    require msg.sender == 0x395d5881be6ca42d96ba01a2de69416f10cebe
    if arg1:
        stor1 = arg1
}
...
function BFTcoin() {
    ...
    require totalDistributed + balanceOf[0x395d5881be6ca42d96ba01a2de69416f10cebe000000000000000000000000] >= balanceOf[0x395d5881be6ca42d96ba01a2de69416f10cebe000000000000000000000000]
    balanceOf[0x395d5881be6ca42d96ba01a2de69416f10cebe000000000000000000000000] += totalDistributed
    emit Distr(address arg1, uint256 arg2):
               totalDistributed,
    emit 0x395d5881: totalDistributed
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  totalDistributed,
    emit 0x0: totalDistributed
    emit 0x395d5881: totalDistributed
}
...
function airdrop(address[] arg1) {
    ...
    while idx < arg1.length:
        ...
        emit Transfer(value, 0, address(_16));
        idx = idx + 1
        continue 
    if totalDistributed >= totalSupply:
        stor9 = 1
...
function distribution(address[] arg1, uint256 arg2) {
    ...
    while idx < arg1.length:
        ...
        emit Transfer(arg2, 0, address(_16));
        idx = idx + 1
        continue 
    if totalDistributed >= totalSupply:
        stor9 = 1
...
function distributeAmounts(address[] arg1, uint256[] arg2) {
    ...
    while uint8(idx) < arg1.length:
        ...
        require uint8(idx) < arg2.length
        _27 = mem[(32 * uint8(idx)) + (32 * arg1.length) + 160]
        require not stor9
        ...
        emit Distr(mem[(32 * arg1.length) + (32 * arg2.length) + 160], address(_25));
        mem[(32 * arg1.length) + (32 * arg2.length) + 160] = _27
        emit Transfer(_27, 0, address(_25));
        if totalDistributed >= totalSupply:
            stor9 = 1
        idx = idx + 1
        continue 
