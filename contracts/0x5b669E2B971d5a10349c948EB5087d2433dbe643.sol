...
function _fallback() payable {
    ...
    stor1 = code.data[5422 len 32]
    stor2 = code.data[5454 len 32]
    stor3 = code.data[5486 len 32]
    stor7.length++
    ...
    if address(code.data[5518 len 32]) != 0:
        stor0 = code.data[5518 len 32] or Mask(96, 160, stor0)
    return code.data[622 len 4800]
}
