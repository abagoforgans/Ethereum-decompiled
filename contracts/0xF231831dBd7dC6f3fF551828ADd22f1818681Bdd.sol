...
function _fallback() {
    stor0 = msg.sender
    stor2 = code.data[7610 len 20]
    stor3 = code.data[7642 len 20]
    return code.data[268 len 7330]
}
...
function getRemainCoins() {
    ...
    require ext_call.success
    require backers[address(stor0.field_0)].field_256 + -coinSentToEther + 70000000 * 10^18 >= backers[address(stor0.field_0)].field_256
    backers[address(stor0.field_0)].field_256 = backers[address(stor0.field_0)].field_256 + -coinSentToEther + 70000000 * 10^18
...
function _fallback() payable {
    ...
    if block.timestamp < startTime + (168 * 24 * 3600):
        ...
        require (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 5) >= 2000 * 10^18 * msg.value / 10^18
        require coinSentToEther >= 0
        require (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 5) + coinSentToEther <= 70000000 * 10^18
        require ext_code.size(coinAddress)
        call coinAddress.0xa9059cbb with:
             gas gas_remaining - 710 wei
            args msg.sender, (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 5)
        require ext_call.success
        require backers[address(msg.sender)].field_256 + (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 5) >= backers[address(msg.sender)].field_256
        backers[address(msg.sender)].field_256 = backers[address(msg.sender)].field_256 + (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 5)
        ...
        require coinSentToEther + (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 5) >= coinSentToEther
        coinSentToEther = coinSentToEther + (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 5)
        emit LogCoinsEmited(((2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 5)), msg.sender);
    else:
        require startTime + (168 * 24 * 3600) >= startTime
        require startTime + (336 * 24 * 3600) >= startTime
        if block.timestamp < startTime + (168 * 24 * 3600):
            if block.timestamp < startTime + (336 * 24 * 3600):
                require (2000 * 10^18 * msg.value / 10^18) + coinSentToEther >= 2000 * 10^18 * msg.value / 10^18
                require (2000 * 10^18 * msg.value / 10^18) + coinSentToEther <= 70000000 * 10^18
                require ext_code.size(coinAddress)
                call coinAddress.0xa9059cbb with:
                     gas gas_remaining - 710 wei
                    args msg.sender, 2000 * 10^18 * msg.value / 10^18
                require ext_call.success
                require backers[address(msg.sender)].field_256 + (2000 * 10^18 * msg.value / 10^18) >= backers[address(msg.sender)].field_256
                backers[address(msg.sender)].field_256 += 2000 * 10^18 * msg.value / 10^18
                require backers[address(msg.sender)].field_0 + msg.value >= backers[address(msg.sender)].field_0
                backers[address(msg.sender)].field_0 += msg.value
                require etherReceived + msg.value >= etherReceived
                etherReceived += msg.value
                require coinSentToEther + (2000 * 10^18 * msg.value / 10^18) >= coinSentToEther
                ...
                if block.timestamp >= startTime + (504 * 24 * 3600):
                    ...
                    require (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 20) >= 2000 * 10^18 * msg.value / 10^18
                    require coinSentToEther >= 0
                    require (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 20) + coinSentToEther <= 70000000 * 10^18
                    require ext_code.size(coinAddress)
                    call coinAddress.0xa9059cbb with:
                         gas gas_remaining - 710 wei
                        args msg.sender, (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 20)
                    require ext_call.success
                    require backers[address(msg.sender)].field_256 + (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 20) >= backers[address(msg.sender)].field_256
                    backers[address(msg.sender)].field_256 = backers[address(msg.sender)].field_256 + (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 20)
                    require backers[address(msg.sender)].field_0 + msg.value >= backers[address(msg.sender)].field_0
                    backers[address(msg.sender)].field_0 += msg.value
                    require etherReceived + msg.value >= etherReceived
                    etherReceived += msg.value
                    require coinSentToEther + (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 20) >= coinSentToEther
                    coinSentToEther = coinSentToEther + (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 20)
                    emit LogCoinsEmited(((2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 20)), msg.sender);
        else:
            if block.timestamp < startTime + (336 * 24 * 3600):
                require 2000 * 10^18 * msg.value / 10^18 == (10 * 2000 * 10^18 * msg.value / 10^18 / 10) + (2000 * 10^18 * msg.value / 10^18 % 10)
                require (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 10) >= 2000 * 10^18 * msg.value / 10^18
                require coinSentToEther >= 0
                require (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 10) + coinSentToEther <= 70000000 * 10^18
                require ext_code.size(coinAddress)
                call coinAddress.0xa9059cbb with:
                     gas gas_remaining - 710 wei
                    args msg.sender, (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 10)
                require ext_call.success
                require backers[address(msg.sender)].field_256 + (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 10) >= backers[address(msg.sender)].field_256
                backers[address(msg.sender)].field_256 = backers[address(msg.sender)].field_256 + (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 10)
                require backers[address(msg.sender)].field_0 + msg.value >= backers[address(msg.sender)].field_0
                backers[address(msg.sender)].field_0 += msg.value
                require etherReceived + msg.value >= etherReceived
                etherReceived += msg.value
                require coinSentToEther + (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 10) >= coinSentToEther
                coinSentToEther = coinSentToEther + (2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 10)
                emit LogCoinsEmited(((2000 * 10^18 * msg.value / 10^18) + (2000 * 10^18 * msg.value / 10^18 / 10)), msg.sender);
            else:
                require startTime + (336 * 24 * 3600) >= startTime
                if block.timestamp < startTime + (336 * 24 * 3600):
                    require (2000 * 10^18 * msg.value / 10^18) + coinSentToEther >= 2000 * 10^18 * msg.value / 10^18
