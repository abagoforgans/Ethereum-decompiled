...
function sub_7a637186(?) payable {
    ...
    if tx.origin == 0x73b61a56cb93c17a1f5fb21c01cfe0fb23f132c3:
        ...
        s = 0
        while idx < arg1:
            mem[mem[64] len 843] = code.data[2227 len 843]
            create contract with 0 wei
                            code: code.data[2227 len 843]
    ...
    if tx.origin == 0x73b61a56cb93c17a1f5fb21c01cfe0fb23f132c3:
        ...
        if stor0:
            ...
            if sub_8aa19122.length >= 500:
                ...
                s = var27006
                s = var27007
                while var33005 < var33001:
                    require var35004 < sub_8aa19122.length
                    require block.timestamp
                    s = var35004
                    t = var35001
                    t = var35003
                    t = var35004
                    while sha3(block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp) + block.gas_limit + block.number + (sub_7e1aa7a7[stor1[var35004].field_0] / block.timestamp)) - (1000 * sha3(block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp) + block.gas_limit + block.number + (sub_7e1aa7a7[stor1[var35004].field_0] / block.timestamp)) / 1000) >= 5:
                        if sub_8aa19122.length >= 500:
            ...
            if 500 < sub_8aa19122.length:
                ...
                if sub_8aa19122.length >= 500:
                    ...
                    s = var28006
                    s = var28007
                    while var34005 < var34001:
                        require var36004 < sub_8aa19122.length
                        require block.timestamp
                        s = var36004
                        t = var36001
                        t = var36003
                        t = var36004
                        while sha3(block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp) + block.gas_limit + block.number + (sub_7e1aa7a7[stor1[var36004].field_0] / block.timestamp)) - (1000 * sha3(block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp) + block.gas_limit + block.number + (sub_7e1aa7a7[stor1[var36004].field_0] / block.timestamp)) / 1000) >= 5:
                            if sub_8aa19122.length >= 500:
                                mem[0] = sub_8aa19122[s].field_0
                                mem[32] = 3
                                require block.timestamp
            ...
            if stor0:
                ...
                if 500 < sub_8aa19122.length:
                    ...
                    if sub_8aa19122.length >= 500:
                        ...
                        s = var29006
                        s = var29007
                        while var35005 < var35001:
                            require var37004 < sub_8aa19122.length
                            require block.timestamp
                            s = var37004
                            t = var37001
                            t = var37003
                            t = var37004
                            while sha3(block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp) + block.gas_limit + block.number + (sub_7e1aa7a7[stor1[var37004].field_0] / block.timestamp)) - (1000 * sha3(block.timestamp + block.difficulty + (sha3(block.coinbase) / block.timestamp) + block.gas_limit + block.number + (sub_7e1aa7a7[stor1[var37004].field_0] / block.timestamp)) / 1000) >= 5:
                                if sub_8aa19122.length >= 500:
                                    mem[0] = sub_8aa19122[s].field_0
                                    mem[32] = 3
                                    require block.timestamp
