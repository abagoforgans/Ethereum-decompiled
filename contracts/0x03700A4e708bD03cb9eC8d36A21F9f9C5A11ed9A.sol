...
function _fallback() payable {
    address(stor1.field_0) = 0xdb15058402c241b04a03846f6fb104b1fbeea10b
    uint8(stor1.field_160) = 255
    stor1.field_256 % 1 = 0
    stor0 = msg.sender or Mask(96, 160, stor0)
    return code.data[109 len 1166]
}
...
function scheduleSetIt(uint256 arg1, uint256 arg2) payable {
    ...
    call address(stor1.field_0).scheduleCall(address rg1, bytes4 rg2, bytes32 rg3, uint256 rg4, uint8 rg5, uint256 rg6) with:
         gas gas_remaining - 25050 wei
        args 0, uint32(arg2), Mask(32, 224, sha3('setIt(uint256)')), sha3(arg2), arg1 + block.number, uint8(stor1.field_160), 0
    require ext_call.success
}
