...
function tickets(uint256 arg1) payable {
    ...
    return address(stor[code.data[1443 len 32] + arg1])
}
    ...
    if block.number % 88 < 68:
        if block.number % 88 > 48:
            if sha3(arg1) == sub_6ac2da19[address(msg.sender)]:
                ...
                idx = 0
                while uint32(idx) < balances[address(msg.sender)] / 10^17:
                    stor3.length++
                    if not stor3.length <= stor3.length + 1:
                        s = stor3.length + code.data[1443 len 32] + 1
                        while code.data[1443 len 32] + stor3.length > s:
                            uint256(stor[s]) = 0
                            mem[0] = msg.sender
                            mem[32] = 6
                            s = s + 1
                    ...
                    uint256(stor[code.data[1443 len 32] + stor3.length - 1]) = msg.sender or Mask(96, 160, uint256(stor[code.data[1443 len 32] + stor3.length - 1]))
                    mem[0] = msg.sender
                    mem[32] = 6
                    idx = idx + 1
                    continue 
...
function payout() payable {
    ...
    while idx < stor3.length:
        sub_6ac2da19[address(stor[code.data[1443 len 32] + idx])] = 0
        mem[0] = address(stor[code.data[1443 len 32] + idx])
        mem[32] = 6
        balances[address(stor[code.data[1443 len 32] + idx])] = 0
        idx = idx + 1
        continue 
    stor3.length = 0
    idx = code.data[1443 len 32]
    while code.data[1443 len 32] + stor3.length > idx:
        uint256(stor[idx]) = 0
        idx = idx + 1
        continue 
