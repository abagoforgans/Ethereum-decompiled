...
function _fallback() payable {
    ...
    stor5.length.field_8 = 'CobaToken' / 256
    idx = 0
    ...
    stor11 = 72 * 24 * 3600
    stor12 = 2160 * 24 * 3600
    stor13 = 10000000000000000 * 10^18
    require not msg.value
    stor4 = msg.sender
    stor15 = 0xf6764d1e2a90f7f8e2d7664000000
    stor16 = 0x1667d8771b2473a2432adac000000000000
    stor8 = block.timestamp
    stor9 = block.number
    stor17[address(msg.sender)] = 0x1667d8771b2473a2432adac000000000000
    stor14 = 0x1667d8771b2473a2432adac000000000000
    return code.data[506 len 7150]
}
...
function batchTransfer(address[] arg1, uint256[] arg2) {
    ...
    while idx < arg1.length:
        ...
        require idx < mem[96]
        mem[32] = 19
        _216 = sha3(mem[(32 * idx) + 140 len 20], 19)
        ...
        if not uint256(stor19[mem[(32 * idx) + 140 len 20]].field_0) > uint256(stor19[mem[(32 * idx) + 140 len 20]].field_0) + 1:
            ...
            _228 = sha3(sha3(mem[(32 * idx) + 140 len 20], 19))
            _229 = mem[64]
            mem[64] = mem[64] + 64
            require idx < mem[(32 * arg1.length) + 128]
            mem[_229] = mem[(32 * idx) + (32 * arg1.length) + 176 len 16]
            mem[_229 + 32] = uint64(block.timestamp)
            uint128(stor[uint256(stor[_216]) + _228]) = mem[_229 + 16 len 16]
            uint256(stor[uint256(stor[_216]) + _228]) = 0xffffffffffffffff0000000000000000ffffffffffffffffffffffffffffff and uint256(stor[uint256(stor[_216]) + _228]) or uint64(block.timestamp) << 128
            require idx < mem[96]
            _238 = mem[(32 * idx) + 128]
            require idx < mem[(32 * arg1.length) + 128]
            mem[mem[64]] = mem[(32 * idx) + (32 * arg1.length) + 160]
            emit Transfer(mem[mem[64]], msg.sender, address(_238));
        else:
            ...
            uint128(stor[uint256(stor[_216]) + sha3(_216)]) = mem[_299 + 16 len 16]
            mem[0] = _216
            uint256(stor[uint256(stor[_216]) + sha3(_216)]) = 0xffffffffffffffff0000000000000000ffffffffffffffffffffffffffffff and uint256(stor[uint256(stor[_216]) + sha3(_216)]) or uint64(block.timestamp) << 128
            require idx < mem[96]
            _308 = mem[(32 * idx) + 128]
            require idx < mem[(32 * arg1.length) + 128]
            mem[mem[64]] = mem[(32 * idx) + (32 * arg1.length) + 160]
            emit Transfer(mem[mem[64]], msg.sender, address(_308));
        idx = idx + 1
        continue 
    ...
    if uint256(stor19[address(msg.sender)].field_0) <= 0:
        ...
        uint256(stor19[address(msg.sender)].field_0) = 0
        s = 0
        while uint256(stor19[address(msg.sender)].field_0) > s:
            Mask(192, 0, stor19[address(msg.sender)][s].field_0) = 0
            s = s + 1
            continue 
        if uint256(balanceOf[address(msg.sender)]) > 0:
            uint256(stor19[address(msg.sender)].field_0)++
            if not uint256(stor19[address(msg.sender)].field_0) <= uint256(stor19[address(msg.sender)].field_0) + 1:
                s = uint256(stor19[address(msg.sender)].field_0) + 1
                while uint256(stor19[address(msg.sender)].field_0) > s:
                    Mask(192, 0, stor19[address(msg.sender)][s].field_0) = 0
                    s = s + 1
                    continue 
