...
function _fallback() {
    stor0[address(msg.sender)] = 21 * 10^14
    return code.data[64 len 2379]
}
...
function multiPartyTransfer(address[] arg1, uint256[] arg2) {
    ...
    while uint8(idx) < arg1.length:
        ...
        require not ext_code.size(mem[(32 * uint8(idx)) + 128])
...
function multiPartyTransferFrom(address arg1, address[] arg2, uint256[] arg3) {
    ...
    while uint8(idx) < arg2.length:
        ...
        require mem[(32 * uint8(idx)) + 140 len 20]
        require mem[(32 * uint8(idx)) + 140 len 20] != this.address
        ...
        require balanceOf[arg1] - mem[(32 * uint8(idx)) + (32 * arg2.length) + 160] < balanceOf[arg1]
        balanceOf[address(arg1)] = balanceOf[arg1] - mem[(32 * uint8(idx)) + (32 * arg2.length) + 160]
        mem[0] = msg.sender
