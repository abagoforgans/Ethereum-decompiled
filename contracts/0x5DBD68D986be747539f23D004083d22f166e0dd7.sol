...
const getBuyPrice = 10025483152147531
...
function getTimeLeft() {
    round_[stor11].field_512 = block.timestamp + -(block.timestamp % 120) + 125
    return (-(block.timestamp % 120) + 125)
}
...
function withdraw() {
    ...
    call 0x7ce07aa2fc356fa52f622c1f4df1e8eaad7febf0 with:
       value eth.balance(this.address) / 2 wei
         gas 2300 * is_zero(value) wei
}
