...
function _fallback() payable {
    ...
    return code.data[116 len 10917]
}
...
function setName(uint8 arg1, uint8 arg2, string arg3) payable {
    ...
    if address(stor[(6 * arg2) + (198 * arg1) + 1].field_0) != tx.origin:
        ...
        Mask(248, 0, whatHappened.length.field_8) = '50:setName:ERR:not owner' / 256
    else:
        if stor1987 != tx.origin:
            ...
            Mask(248, 0, whatHappened.length.field_8) = '52:setName:SUCCESS' / 256
        else:
            if not locked:
                uint8(whatHappened.length) = 48
                Mask(248, 0, whatHappened.length.field_8) = '50:setName:ERR:not owner' / 256
                ...
                uint8(whatHappened.length) = 36
                Mask(248, 0, whatHappened.length.field_8) = '52:setName:SUCCESS' / 256
    idx = code.data[10885 len 32]
    while code.data[10885 len 32] + (whatHappened.length + 31 / 32) > idx:
...
function setStatus(uint8 arg1, uint8 arg2, string arg3) payable {
    if 10^18 != msg.value:
        call tx.origin with:
           value msg.value wei
             gas 0 wei
        mem[ceil32(arg3.length) + 160] = '41:setStatus:ERR:value was not 1'
        mem[ceil32(arg3.length) + 192] = ' ETH'
        whatHappened.length = 73
        s = code.data[10885 len 32]
        ...
        if address(stor[(6 * arg2) + (198 * arg1) + 1].field_0) != tx.origin:
            ...
            Mask(248, 0, whatHappened.length.field_8) = '43:setStatus:ERR:not owner' / 256
        else:
            if stor1987 != tx.origin:
                ...
                Mask(248, 0, whatHappened.length.field_8) = '44:setStatus:SUCCESS' / 256
            else:
                if not locked:
                    call tx.origin with:
                       value msg.value wei
...
function buyTile(uint8 arg1, uint8 arg2) payable {
    ...
    if address(stor[(6 * arg2) + (198 * arg1) + 1].field_0) != 0:
        mem[128] = '5:buyTile:ERR:OOB or already own'
        mem[160] = 'ed'
        whatHappened.length = 69
        s = code.data[10885 len 32]
        idx = 128
        while 162 > idx:
            uint256(stor[s].field_0) = mem[idx]
        ...
        if msg.value != 10^18:
            call tx.origin with:
               value msg.value wei
                 gas 0 wei
            mem[128] = '3:buyTile:ERR:wrong val or water'
            whatHappened.length = 65
            s = code.data[10885 len 32]
            idx = 128
            while 160 > idx:
                uint256(stor[s].field_0) = mem[idx]
            ...
            if ext_call.return_data[31 len 1] < 125:
                ...
                Mask(248, 0, whatHappened.length.field_8) = '4:buyTile:SUCCESS' / 256
                idx = code.data[10885 len 32]
                while code.data[10885 len 32] + (whatHappened.length + 31 / 32) > idx:
                    uint256(stor[idx].field_0) = 0
                    idx = idx + 1
...
function farmTile(uint8 arg1, uint8 arg2, int8 arg3) payable {
    if ('signextend', 0, ('param', 'arg3')) < 0:
        mem[128] = '34:farmTile:ERR:invalid blocktyp'
        mem[160] = 'e'
        ...
        if ('signextend', 0, ('param', 'arg3')) > 17:
            ...
            if address(stor[(6 * arg2) + (198 * arg1) + 1].field_0) != tx.origin:
                ...
                Mask(248, 0, whatHappened.length.field_8) = '31:farmTile:ERR:not owner' / 256
                idx = code.data[10885 len 32]
                while code.data[10885 len 32] + (whatHappened.length + 31 / 32) > idx:
                    uint256(stor[idx].field_0) = 0
                    idx = idx + 1
                ...
                if block.number - uint256(stor[(6 * arg2) + (198 * arg1) + 5].field_0) >= 2500:
                    ...
                    Mask(248, 0, whatHappened.length.field_8) = '33:farmTile:SUCCESS' / 256
                    idx = code.data[10885 len 32]
                    while code.data[10885 len 32] + (whatHappened.length + 31 / 32) > idx:
                        uint256(stor[idx].field_0) = 0
                        idx = idx + 1
                    ...
                    if 10^18 != msg.value:
                        call tx.origin with:
                           value msg.value wei
                             gas 0 wei
                        mem[128] = '31:farmTile:ERR:value was not 1 '
                        mem[160] = 'ETH'
