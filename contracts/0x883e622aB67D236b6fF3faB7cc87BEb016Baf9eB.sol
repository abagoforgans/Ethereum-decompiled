...
function _fallback() payable {
    mem[96 len -5100] = code.data[5377 len -5100]
    mem[64] = -5004
...
function sub_b945d1f6(?) payable {
    ...
    if 65 == ('cd', 164).length:
        signer = erecover(sha3(address(cd[4]), cd[36], call.data[cd[68] + 36 len ('cd', 68).length], cd[100], cd[132]), 0, 0, 0) 
