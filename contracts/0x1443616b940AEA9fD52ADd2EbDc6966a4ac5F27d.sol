...
const name = 'Useless Ethereum Token 2'
...
function _fallback() payable {
    ...
    if msg.value:
        ...
        if msg.value < 10^16:
            ...
            if Mask(8, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 256, 1) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8 != 0:
                ...
                if Mask(1, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 263, 2) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8:
                    if '@' and Mask(8, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 256, 2) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8:
                        if ' ' and Mask(8, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 256, 2) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8:
                            if Mask(1, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 260, 2) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8:
                                if Mask(1, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 259, 2) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8:
                                    if Mask(1, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 258, 2) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8:
                                        if Mask(1, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 257, 2) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8:
                                            if Mask(1, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 256, 2) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8:
                                ...
                                if Mask(1, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 259, 2) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8:
                                    ...
                                    if Mask(1, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 258, 2) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8:
                                        ...
                                        if Mask(1, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 257, 2) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8:
                                            ...
                                            if not Mask(1, -(('mask_shl', 160, 0, 93, ('var', 'hash')), 0) + 256, 2) << (('mask_shl', 160, 0, 93, ('var', 'hash')), 0) - 8:
                                                totalSupply = (100 * msg.value) + totalContribution + totalSupply
                                                balanceOf[address(msg.sender)] = (100 * msg.value) + totalContribution + balanceOf[address(msg.sender)]
                                                emit Transfer(((100 * msg.value) + totalContribution), this.address, msg.sender);
                                            else:
