...
function sub_edb0d0b3(?) {
    mem[96 len 416] = code.data[15703 len 416]
    require not gameState
    require ext_code.size(stor74)
    call stor74.0x6352211e with:
         gas gas_remaining wei
...
function sub_1cfff79f(?) payable {
    ...
    if not address(stor70[arg2]):
        ...
        while idx < arg1:
            ...
            emit 0xfeeebd70: stor73, ext_call.return_data[0], ext_call.return_data[32], msg.value / arg1, msg.sender
        ...
        if msg.sender == address(stor70[arg2]):
            ...
            if not msg.value:
                ...
                while idx < arg1:
                    ...
                    emit 0xfeeebd70: stor73, ext_call.return_data[0], ext_call.return_data[32], (msg.value / arg1) - (0 / arg1), msg.sender
                    s = ext_call.return_data[32]
                    s = ext_call.return_data[0]
                    idx = idx + 1
                    continue 
                ...
                while idx < arg1:
                    ...
                    emit 0xfeeebd70: stor73, ext_call.return_data[0], ext_call.return_data[32], (msg.value / arg1) - (stor71[arg2] * msg.value / 100 / arg1), msg.sender
                    s = ext_call.return_data[32]
                    s = ext_call.return_data[0]
                    idx = idx + 1
                    continue 
