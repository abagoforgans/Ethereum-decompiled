...
function sub_e1661299(?) {
    ...
    while idx < ('cd', 36).length + 128:
        ...
        s = Mask(8, -(('mask_shl', 256, 0, -3, ('var', '_82')), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('var', '_82')), 0) - 256
        idx = idx + 1
        continue 
    _83 = mem[64]
    _84 = mem[96]
    ...
    mem[_83 + _84] = 28
    if stor[sha3(mem[mem[64] len _83 + _84 + -mem[64] + 32])]:
    ...
    Mask(80, 0, stor5[uint256(stor6)].field_432) = Mask(80, 0, cd[68])
    ...
    mem[_290 + _289] = 28
    stor[sha3(mem[mem[64] len _290 + _289 + -mem[64] + 32])] = uint256(stor6) + 1
    ...
    mem[mem[64] + 32 len 10] = Mask(80, 0, cd[68])
    mem[mem[64] + 32 len 8] = uint64(cd[100])
    mem[mem[64] + 64] = uint256(stor6)
    mem[mem[64] + 96] = 'Ether'
    mem[mem[64] + 128] = stor30[cd[68]]
    mem[mem[64]] = 160
    mem[_314 + 160] = ('cd', 36).length
    mem[_314 + 192 len ('cd', 36).length] = call.data[cd[36] + 36 len ('cd', 36).length]
    emit Mint(address arg1, address arg2, bytes32 arg3, string arg4, bytes32 arg5, uint256 arg6, bytes32 arg7, uint256 arg8):
              mem[mem[64] len _314 + ('cd', 36).length + -mem[64] + 192],
              this.address,
              address(cd[4]),
              stor20[cd[68]],
