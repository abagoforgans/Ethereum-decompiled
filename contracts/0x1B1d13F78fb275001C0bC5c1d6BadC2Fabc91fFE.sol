...
function initialSupplyAddress() {
    return initialSupplyAddress
}
...
function projectMemberAddress() {
    return projectMemberAddress
}
...
function SkillCoin() {
    ...
    if not totalSupply:
        ...
        require totalSupply
        require 25 * totalSupply / totalSupply == 25
        balanceOf[address(msg.sender)] = 25 * totalSupply / 100
    if not totalSupply:
        balanceOf[stor6] = 0
    else:
        require totalSupply
        require 10 * totalSupply / totalSupply == 10
        balanceOf[stor6] = 10 * totalSupply / 100
    if not totalSupply:
        balanceOf[stor7] = 0
    else:
        require totalSupply
        require 30 * totalSupply / totalSupply == 30
        balanceOf[stor7] = 30 * totalSupply / 100
    if not totalSupply:
        balanceOf[stor8] = 0
    else:
        require totalSupply
        require 10 * totalSupply / totalSupply == 10
        balanceOf[stor8] = 10 * totalSupply / 100
    if not totalSupply:
        balanceOf[stor9] = 0
    else:
        require totalSupply
        require 25 * totalSupply / totalSupply == 25
        balanceOf[stor9] = 25 * totalSupply / 100
}
...
function bulkTransfer(address[] arg1, uint256 arg2) {
    ...
    if not arg2:
        ...
        while idx < arg1.length:
            ...
            require mem[(32 * idx) + 140 len 20]
            require idx < arg1.length
            require not stor12[mem[(32 * idx) + 140 len 20]]
            require idx < arg1.length
...
function bulkTransfer(address[] arg1, uint256[] arg2) {
    ...
    while idx < arg1.length:
        ...
        require idx < arg2.length
        mem[(32 * arg1.length) + (32 * arg2.length) + 160] = mem[(32 * idx) + (32 * arg1.length) + 160]
        emit Transfer(mem[(32 * arg1.length) + (32 * arg2.length) + 160], msg.sender, address(_94));
        idx = idx + 1
        continue 
    return 1
}
