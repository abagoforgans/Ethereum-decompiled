...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'Bitcoin Token' / 256
    idx = 0
    ...
    stor8 = msg.sender
    stor0[address(msg.sender)] = 88888 * 10^18
    return code.data[807 len 5482]
}
...
function sub_55c0aabf(?) {
    ...
    require totalSupply + (30000 * msg.value) >= totalSupply
    require totalSupply + (30000 * msg.value) >= 30000 * msg.value
    if totalSupply + (30000 * msg.value) > totalCap:
        call msg.sender with:
           value msg.value wei
             gas 2300 * is_zero(value) wei
        revert 
    require balanceOf[address(arg1)] + (30000 * msg.value) >= balanceOf[address(arg1)]
    require balanceOf[address(arg1)] + (30000 * msg.value) >= 30000 * msg.value
    balanceOf[address(arg1)] += 30000 * msg.value
    require totalSupply + (30000 * msg.value) >= totalSupply
    require totalSupply + (30000 * msg.value) >= 30000 * msg.value
    ...
    emit Buy(msg.value, 30000 * msg.value, arg1);
}
...
function _fallback() payable {
    ...
    if totalSupply + (30000 * msg.value) > totalCap:
        call msg.sender with:
           value msg.value wei
             gas 2300 * is_zero(value) wei
        revert 
    require balanceOf[address(msg.sender)] + (30000 * msg.value) >= balanceOf[address(msg.sender)]
    require balanceOf[address(msg.sender)] + (30000 * msg.value) >= 30000 * msg.value
    ...
    call founderAddress with:
       value msg.value wei
         gas 2300 * is_zero(value) wei
    require ext_call.success
    emit Buy(msg.value, 30000 * msg.value, msg.sender);
}
