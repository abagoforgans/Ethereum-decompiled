    ...
    if not stor0.length:
        ...
        if not stor0.length:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require 10 * ext_call.return_data[0] <= 10 * 2 * ext_call.return_data[0]
            if not (10 * 2 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) - (10 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) / 10^18:
            ...
            if (10 * 2 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) - (10 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) / 10^18 <= 3:
                require 1000 * ext_call.return_data[0] <= 1
                ...
                return (-1000 * ext_call.return_data[0]) + 1 / 997, 
                       ...
                       address(ext_call.return_data[0])
            s = ((10 * 2 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) - (10 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) / 10^18) + 1 / 2
            t = (10 * 2 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) - (10 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) / 10^18
            while s < t:
                require s
                s = ((10 * 2 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) - (10 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) / 10^18 / s) + s / 2
                t = s
                continue 
            require 1000 * ext_call.return_data[0] <= t
            ...
            if not stor0.length:
                ...
                call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args mem[(98 * stor0.length) + 356], address(_943), 997 * t - (1000 * ext_call.return_data[0]) / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * t - (1000 * ext_call.return_data[0]) / 997) / 10^(-ext_call.return_data[0] + 18)
                mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require 2 < stor0.length
                require 4 < stor0.length
                _983 = mem[(64 * stor0.length) + 480]
                mem[(98 * stor0.length) + 356] = mem[(64 * stor0.length) + 428 len 20]
                require ext_code.size(0xcbc6a023eb975a1e2630223a7959988948e664f3)
                call 0xcbc6a023eb975a1e2630223a7959988948e664f3.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args mem[(98 * stor0.length) + 356], address(_983), ext_call.return_data[0]
        else:
            ...
            if not (10 * 2 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) - (10 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) / 10^18:
                ...
                if not stor0.length:
                    ...
                    require 0 < stor0.length
                    require 2 < stor0.length
                    _758 = ext_call.return_data[28 len 4], mem[(64 * stor0.length) + 420 len 28]
                    require 0 < stor0.length
                    require ext_code.size(ext_call.return_data[44 len 20])
                    call ext_call.return_data[44 len 20].0x313ce567 with:
                         gas gas_remaining wei
                    ...
                    mem[(98 * stor0.length) + 388] = address(_758)
                    mem[(98 * stor0.length) + 420] = 997 * -1000 * ext_call.return_data[0] / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * -1000 * ext_call.return_data[0] / 997) / 10^(-ext_call.return_data[0] + 18)
                    require ext_code.size(arg1)
                    call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args ext_call.return_data[44 len 20], address(_758), 997 * -1000 * ext_call.return_data[0] / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * -1000 * ext_call.return_data[0] / 997) / 10^(-ext_call.return_data[0] + 18)
                    mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    ...
                    call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args mem[(98 * stor0.length) + 356], address(_1082), 997 * -1000 * ext_call.return_data[0] / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * -1000 * ext_call.return_data[0] / 997) / 10^(-ext_call.return_data[0] + 18)
                    mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
            ...
            if (10 * 2 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) - (10 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) / 10^18 <= 3:
                ...
                if not stor0.length:
                    ...
                    call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args mem[(98 * stor0.length) + 356], address(_1080), 997 * (-1000 * ext_call.return_data[0]) + 1 / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * (-1000 * ext_call.return_data[0]) + 1 / 997) / 10^(-ext_call.return_data[0] + 18)
                    mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
            ...
            if not stor0.length:
                ...
                require 0 < stor0.length
                require 2 < stor0.length
                _986 = ext_call.return_data[28 len 4], mem[(64 * stor0.length) + 420 len 28]
                require 0 < stor0.length
                require ext_code.size(ext_call.return_data[44 len 20])
                call ext_call.return_data[44 len 20].0x313ce567 with:
                     gas gas_remaining wei
                ...
                require 10^(-ext_call.return_data[0] + 18)
                mem[(98 * stor0.length) + 356] = ext_call.return_data[44 len 20]
                mem[(98 * stor0.length) + 388] = address(_986)
                mem[(98 * stor0.length) + 420] = 997 * t - (1000 * ext_call.return_data[0]) / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * t - (1000 * ext_call.return_data[0]) / 997) / 10^(-ext_call.return_data[0] + 18)
                require ext_code.size(arg1)
                call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args ext_call.return_data[44 len 20], address(_986), 997 * t - (1000 * ext_call.return_data[0]) / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * t - (1000 * ext_call.return_data[0]) / 997) / 10^(-ext_call.return_data[0] + 18)
                mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                ...
                call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args mem[(98 * stor0.length) + 356], address(_1315), 997 * t - (1000 * ext_call.return_data[0]) / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * t - (1000 * ext_call.return_data[0]) / 997) / 10^(-ext_call.return_data[0] + 18)
                mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require 2 < stor0.length
                require 4 < stor0.length
                _1356 = mem[(64 * stor0.length) + 480]
                mem[(98 * stor0.length) + 356] = mem[(64 * stor0.length) + 428 len 20]
                require ext_code.size(0xcbc6a023eb975a1e2630223a7959988948e664f3)
                call 0xcbc6a023eb975a1e2630223a7959988948e664f3.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args mem[(98 * stor0.length) + 356], address(_1356), ext_call.return_data[0]
    else:
        ...
        if not stor0.length:
            ...
            require 2 < stor0.length
            require 4 < stor0.length
            _715 = mem[(32 * stor0.length) + 448]
            mem[(64 * stor0.length) + 324] = mem[(32 * stor0.length) + 396 len 20]
            mem[(64 * stor0.length) + 356] = address(_715)
            mem[(64 * stor0.length) + 388] = ext_call.return_data[0]
            require ext_code.size(0xcbc6a023eb975a1e2630223a7959988948e664f3)
            call 0xcbc6a023eb975a1e2630223a7959988948e664f3.getReturn(address arg1, address arg2, uint256 arg3) with:
                 gas gas_remaining wei
                args mem[(64 * stor0.length) + 324], address(_715), ext_call.return_data[0]
            mem[(64 * stor0.length) + 320 len 64] = ext_call.return_data[0 len 64]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 64
            ...
            if not (10 * 2 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) - (10 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) / 10^18:
                ...
                if not stor0.length:
                    ...
                    call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args ext_call.return_data[44 len 20], address(_863), 997 * -1000 * ext_call.return_data[0] / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * -1000 * ext_call.return_data[0] / 997) / 10^(-ext_call.return_data[0] + 18)
                    mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    ...
                    call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args mem[(98 * stor0.length) + 356], address(_1086), 997 * -1000 * ext_call.return_data[0] / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * -1000 * ext_call.return_data[0] / 997) / 10^(-ext_call.return_data[0] + 18)
                    mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
            ...
            if (10 * 2 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) - (10 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) / 10^18 <= 3:
                ...
                if not stor0.length:
                    ...
                    call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args ext_call.return_data[44 len 20], address(_866), 997 * (-1000 * ext_call.return_data[0]) + 1 / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * (-1000 * ext_call.return_data[0]) + 1 / 997) / 10^(-ext_call.return_data[0] + 18)
                    mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    ...
                    call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args mem[(98 * stor0.length) + 356], address(_1084), 997 * (-1000 * ext_call.return_data[0]) + 1 / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * (-1000 * ext_call.return_data[0]) + 1 / 997) / 10^(-ext_call.return_data[0] + 18)
                    mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
            ...
            if not stor0.length:
                ...
                require 0 < stor0.length
                require 2 < stor0.length
                _988 = ext_call.return_data[28 len 4], mem[(64 * stor0.length) + 420 len 28]
                require 0 < stor0.length
                require ext_code.size(ext_call.return_data[44 len 20])
                call ext_call.return_data[44 len 20].0x313ce567 with:
                     gas gas_remaining wei
                ...
                require 10^(-ext_call.return_data[0] + 18)
                mem[(98 * stor0.length) + 356] = ext_call.return_data[44 len 20]
                mem[(98 * stor0.length) + 388] = address(_988)
                mem[(98 * stor0.length) + 420] = 997 * t - (1000 * ext_call.return_data[0]) / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * t - (1000 * ext_call.return_data[0]) / 997) / 10^(-ext_call.return_data[0] + 18)
                require ext_code.size(arg1)
                call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args ext_call.return_data[44 len 20], address(_988), 997 * t - (1000 * ext_call.return_data[0]) / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * t - (1000 * ext_call.return_data[0]) / 997) / 10^(-ext_call.return_data[0] + 18)
                mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                ...
                call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args mem[(98 * stor0.length) + 356], address(_1317), 997 * t - (1000 * ext_call.return_data[0]) / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * t - (1000 * ext_call.return_data[0]) / 997) / 10^(-ext_call.return_data[0] + 18)
                mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
            ...
            if not (10 * 2 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) - (10 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) / 10^18:
                ...
                if not stor0.length:
                    ...
                    call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args ext_call.return_data[44 len 20], address(_1226), 997 * -1000 * ext_call.return_data[0] / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * -1000 * ext_call.return_data[0] / 997) / 10^(-ext_call.return_data[0] + 18)
                    mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    ...
                    call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args mem[(98 * stor0.length) + 356], address(_1414), 997 * -1000 * ext_call.return_data[0] / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * -1000 * ext_call.return_data[0] / 997) / 10^(-ext_call.return_data[0] + 18)
                    mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
            ...
            if (10 * 2 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) - (10 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) / 10^18 <= 3:
                ...
                if not stor0.length:
                    ...
                    call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args ext_call.return_data[44 len 20], address(_1229), 997 * (-1000 * ext_call.return_data[0]) + 1 / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * (-1000 * ext_call.return_data[0]) + 1 / 997) / 10^(-ext_call.return_data[0] + 18)
                    mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    ...
                    call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                         gas gas_remaining wei
                        args mem[(98 * stor0.length) + 356], address(_1412), 997 * (-1000 * ext_call.return_data[0]) + 1 / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * (-1000 * ext_call.return_data[0]) + 1 / 997) / 10^(-ext_call.return_data[0] + 18)
                    mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
            ...
            if not stor0.length:
                ...
                require 0 < stor0.length
                require 2 < stor0.length
                _1362 = ext_call.return_data[28 len 4], mem[(64 * stor0.length) + 420 len 28]
                require 0 < stor0.length
                require ext_code.size(ext_call.return_data[44 len 20])
                call ext_call.return_data[44 len 20].0x313ce567 with:
                     gas gas_remaining wei
                ...
                require 10^(-ext_call.return_data[0] + 18)
                mem[(98 * stor0.length) + 356] = ext_call.return_data[44 len 20]
                mem[(98 * stor0.length) + 388] = address(_1362)
                mem[(98 * stor0.length) + 420] = 997 * t - (1000 * ext_call.return_data[0]) / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * t - (1000 * ext_call.return_data[0]) / 997) / 10^(-ext_call.return_data[0] + 18)
                require ext_code.size(arg1)
                call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args ext_call.return_data[44 len 20], address(_1362), 997 * t - (1000 * ext_call.return_data[0]) / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * t - (1000 * ext_call.return_data[0]) / 997) / 10^(-ext_call.return_data[0] + 18)
                mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                ...
                call arg1.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args mem[(98 * stor0.length) + 356], address(_1465), 997 * t - (1000 * ext_call.return_data[0]) / 997 * ext_call.return_data[0] / (1000 * eth.balance(ext_call.return_data[0])) + (997 * t - (1000 * ext_call.return_data[0]) / 997) / 10^(-ext_call.return_data[0] + 18)
                mem[(98 * stor0.length) + 352] = ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
