...
function sub_58fbb277(?) {
    ...
    require arg1.length <= 4294967296 and arg1 + (32 * arg1.length) + 36 <= calldata.size
    mem[128 len 32 * arg1.length] = call.data[arg1 + 36 len 32 * arg1.length]
    mem[(32 * arg1.length) + 128 len 320] = code.data[11550 len 320]
    mem[(32 * arg1.length) + 448 len 320] = code.data[11550 len 320]
    mem[(32 * arg1.length) + 768 len 320] = code.data[11550 len 320]
    idx = 0
    while idx < arg1.length:
        require idx < arg1.length
        require stor12
...
function openBox(uint256 arg1) {
    ...
    stor19++
    require ext_code.size(sub_63f0385cAddress)
    call sub_63f0385cAddress.burn(uint256 arg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
