...
function _fallback() payable {
    ...
    if msg.sender == msg.sender:
        if code.data[9316 len 20] != 0:
            if 0 == address(stor1):
                call address(code.data[9304 len 32]).0xe001f841 with:
                     gas gas_remaining - 25050 wei
                    args 'dex', this.address
                require ext_call.success
                if ext_call.return_data[0]:
                    uint256(stor1) = code.data[9304 len 32] or Mask(96, 160, uint256(stor1))
            else:
...
address stor2;
uint256 stor2;
mapping of struct balanceOfAll;
uint8 stor4;
...
function balanceOfAll(address arg1) payable {
    return balanceOfAll[address(arg1)].field_0, 
           balanceOfAll[address(arg1)].field_256,
           balanceOfAll[address(arg1)].field_512,
           balanceOfAll[address(arg1)].field_768
}
...
function depositEther() payable {
    balanceOfAll[address(msg.sender)].field_0 += msg.value
}
...
function withdrawEther(uint256 arg1) payable {
    if balanceOfAll[address(msg.sender)].field_0 < arg1:
    balanceOfAll[address(msg.sender)].field_0 -= arg1
...
function RewardOrder(uint256 arg1, uint256 arg2) payable {
    ...
    if msg.sender == ext_call.return_data[12 len 20]:
        require arg1 < 500
        stor6[arg1] -= arg2
        balanceOfAll[stor5[arg1]].field_512 += arg2
        balanceOfAll[stor5[arg1]].field_0 += arg2 * stor7[arg1] / 2
        balanceOfAll[stor5[arg1]].field_256 += -1 * arg2 * stor7[arg1]
        balanceOfAll[this.address].field_0 = (arg2 * stor7[arg1]) - (arg2 * stor7[arg1] / 2) + balanceOfAll[this.address].field_0
}

function dexWithdrawCollectedFees() payable {
    if msg.sender == stor0:
        balanceOfAll[address(this.address)].field_0 = 0
        call msg.sender with:
           value balanceOfAll[address(this.address)].field_0 wei
             gas 0 wei
        if ext_call.success:
    else:
        call address(stor1).0x21f8a721 with:
...
function withdrawToken(uint256 arg1) payable {
    if balanceOfAll[address(msg.sender)].field_512 >= arg1:
        balanceOfAll[address(msg.sender)].field_512 -= arg1
        if address(stor1):
            call address(stor1).0x21f8a721 with:
                 gas gas_remaining - 25050 wei
                args 0x746f6b656e000000000000000000000000000000000000000000000000000000
...
function cancelOrder(uint256 arg1, uint256 arg2) payable {
    if 1 == arg1:
        ...
        if stor5[arg2] == msg.sender:
            ...
            require arg2 < 500
            if stor4 != 1:
                balanceOfAll[address(msg.sender)].field_512 += stor6[arg2]
                balanceOfAll[address(msg.sender)].field_768 -= stor6[arg2]
            else:
                balanceOfAll[address(msg.sender)].field_0 += stor6[arg2] * stor7[arg2]
                balanceOfAll[address(msg.sender)].field_256 += -1 * stor6[arg2] * stor7[arg2]
            if 1 == stor4:
                call address(stor1).0x21f8a721 with:
                     gas gas_remaining - 25050 wei
                    args 0x6465786c69640000000000000000000000000000000000000000000000000000
        ...
        if 2 == arg1:
            ...
            if storBC2[arg2] == msg.sender:
                ...
                require arg2 < 500
                if storBC1 != 1:
                    balanceOfAll[address(msg.sender)].field_512 += storBC3[arg2]
                    balanceOfAll[address(msg.sender)].field_768 -= storBC3[arg2]
                else:
                    balanceOfAll[address(msg.sender)].field_0 += storBC3[arg2] * storBC4[arg2]
                    balanceOfAll[address(msg.sender)].field_256 += -1 * storBC3[arg2] * storBC4[arg2]
                if 1 == storBC1:
                    call address(stor1).0x21f8a721 with:
                         gas gas_remaining - 25050 wei
                        args 0x6465786c69640000000000000000000000000000000000000000000000000000
