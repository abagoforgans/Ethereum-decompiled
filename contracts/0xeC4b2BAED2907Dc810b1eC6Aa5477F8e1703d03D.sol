...
function _fallback() payable {
    ...
    stor5 = code.data[4816 len 20]
    if code.data[4836 len 32]:
        stor1 = code.data[4836 len 32]
        stor2 = code.data[4868 len 32]
        emit ChangeOfRules(code.data[4836 len 32], code.data[4868 len 32], stor5);
    else:
        stor1 = 1
        stor2 = code.data[4868 len 32]
        emit ChangeOfRules(1, code.data[4868 len 32], stor5);
    return code.data[270 len 4534]
}
