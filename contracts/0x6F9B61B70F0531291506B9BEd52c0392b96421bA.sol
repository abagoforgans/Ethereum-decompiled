...
uint8 direct_drop_range; offset 160
...
function transfer(address arg1, uint256 arg2) {
    ...
    if lockInfo[address(msg.sender)].field_0 > 0:
        if block.timestamp < lockInfo[address(msg.sender)].field_256:
            require balanceOf[address(msg.sender)] >= lockInfo[address(msg.sender)].field_0
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if lockInfo[address(arg1)].field_0 > 0:
        if block.timestamp < lockInfo[address(arg1)].field_256:
            require balanceOf[address(arg1)] >= lockInfo[address(arg1)].field_0
...
function airDrop(address arg1) payable {
    ...
    if lockInfo[stor17].field_0 > 0:
        if block.timestamp < lockInfo[stor17].field_256:
            require balanceOf[stor17] >= lockInfo[stor17].field_0
...
function buyTokens(address arg1) payable {
    ...
    if lockInfo[stor11].field_0 > 0:
        if block.timestamp < lockInfo[stor11].field_256:
            require balanceOf[stor11] >= lockInfo[stor11].field_0
