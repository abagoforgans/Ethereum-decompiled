...
function _fallback() {
    ...
    call 0xd99b9b07803e4d3a0d7ee773da4bedbe14b6661d.0xbb34534c with:
         gas gas_remaining - 50 wei
        args 'custodian'
    require ext_call.success
    stor0 = ext_call.return_data[12 len 20] or Mask(96, 160, stor0)
    return code.data[262 len 6444]
}
...
function register() {
    if stor1 == msg.sender:
        require ext_code.size(0xd99b9b07803e4d3a0d7ee773da4bedbe14b6661d)
        call 0xd99b9b07803e4d3a0d7ee773da4bedbe14b6661d.0xe1fa8e84 with:
             gas gas_remaining - 50 wei
            args 'bond'
        require ext_call.success
}
...
function sub_84d6755a(?) {
    if arg1 <= issues.length:
        ...
        return issues[arg1].field_512, 
               ...
               bool(issues[arg1].field_2816),
               bool(issues[arg1].field_2824)
    emit code.data[6412 len 32]: arg1, 1, msg.sender
    return 0
}
...
function sub_940589d6(?) {
    if arg1 > issues.length:
        ...
        if issues[arg1].field_0 != msg.sender:
            emit code.data[6412 len 32]: arg1, 11, msg.sender
        else:
            if arg2 < 0:
                emit code.data[6412 len 32]: arg1, 12, msg.sender
            else:
...
function sub_386da5f7(?) {
    ...
    sub_7aa90a60[stor2.length + 1].field_512 = arg8
    sub_7aa90a60[stor2.length + 1].field_256 = arg7
    sub_7aa90a60[stor2.length + 1].field_264 = 0
    require ext_code.size(stor0)
    call stor0.0xc5e11e2 with:
         gas gas_remaining - 50 wei
        args issues.length + 1, msg.sender, arg5, 0, 1
    require ext_call.success
    emit 0x7945715b: issues.length + 1, arg5, 1, msg.sender
    emit 0xf474b986: msg.sender, block.timestamp, arg4, arg5, block.number, 0, 0, arg7 << 248, arg8, 0, 8, issues.length + 1
}
