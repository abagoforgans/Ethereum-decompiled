...
function proxyPayment(address arg1) payable {
    ...
    if block.timestamp < 1501951071:
        ...
        require (2700 * msg.value) + balanceOf[stor5] >= balanceOf[stor5]
        require (2700 * msg.value) + balanceOf[stor5] >= 2700 * msg.value
        balanceOf[stor5] += 2700 * msg.value
        ...
        emit Transfer((2700 * msg.value), 0, multisigAddress);
    else:
        if block.timestamp < 1502728671:
            ...
            require (2400 * msg.value) + balanceOf[stor5] >= balanceOf[stor5]
            require (2400 * msg.value) + balanceOf[stor5] >= 2400 * msg.value
            balanceOf[stor5] += 2400 * msg.value
            ...
            emit Transfer((2400 * msg.value), 0, multisigAddress);
        else:
            if block.timestamp < 1503506271:
                ...
                require (2050 * msg.value) + balanceOf[stor5] >= balanceOf[stor5]
                require (2050 * msg.value) + balanceOf[stor5] >= 2050 * msg.value
                balanceOf[stor5] += 2050 * msg.value
                ...
                emit Transfer((2050 * msg.value), 0, multisigAddress);
            else:
                require block.timestamp <= 1504543071
                ...
                require (1500 * msg.value) + balanceOf[stor5] >= balanceOf[stor5]
                require (1500 * msg.value) + balanceOf[stor5] >= 1500 * msg.value
                balanceOf[stor5] += 1500 * msg.value
                ...
                emit Transfer((1500 * msg.value), 0, multisigAddress);
