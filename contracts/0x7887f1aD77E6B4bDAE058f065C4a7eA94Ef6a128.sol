...
function sub_82db4f19(?) payable {
    ...
    if uint256(stor17[stor8][arg1]) <= 0:
        ...
        while idx < uint256(stor17[stor8][stor12]):
            ...
            mem[0] = address(stor17[stor8][stor12][idx])
            require ext_code.size(stor6)
            if not stor18[address(stor17[stor8][stor12][idx])]:
                call stor6.0xa9059cbb with:
                     gas gas_remaining wei
                    args address(stor17[stor8][stor12][idx]), gameJackpot[stor8] / uint256(stor17[stor8][arg1])
            else:
                call stor6.0xa9059cbb with:
                     gas gas_remaining wei
                    args address(stor17[stor8][stor12][idx]), 90 * gameJackpot[stor8] / uint256(stor17[stor8][arg1]) / 100
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[0] = address(stor17[stor8][stor12][idx])
                ...
                call stor6.0xa9059cbb with:
                     gas gas_remaining wei
                    args stor18[address(stor17[stor8][stor12][idx])], 10 * gameJackpot[stor8] / uint256(stor17[stor8][arg1]) / 100
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            ...
            emit Winner(address(stor17[stor8][stor12][idx]), sub_f96afe87, gameJackpot[stor8] / uint256(stor17[stor8][arg1]));
            mem[0] = sub_f96afe87
            mem[32] = sha3(game, 17)
