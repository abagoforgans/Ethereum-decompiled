...
const TOKEN_NAME = 'FightCoin'

const TOKEN_SYMBOL = 'FGTC'

const TOKEN_DECIMAL_MULTIPLIER = 10000

const TOKEN_DECIMALS = 4

const TARGET_USER = 0x6391511c98e62390092b852665db30118dd8818e

const PAUSED = 0

const TOKEN_DECIMALS_UINT8 = 4
