...
function _fallback() payable {
    ...
    mem[160 len -4329] = code.data[5586 len -4329]
    stor5 = 25 * 10^10
    stor0 = 5 * 10^11
    stor1[0xd0f0d8e19c5c4afb1cba7e973ed98cc7b34e2807] = 81250 * 10^6
    stor1[0xeb103261b80a322c09ce94580b114d5d6cc5b94a] = 81250 * 10^6
    stor1[0x6f8a400161235de47491dc7d5d1c39a2f1822c36] = 25 * 10^9
    ...
    return code.data[1257 len 4329]
}
...
function _fallback() payable {
    if msg.value <= stor4:
        ...
        call 0xeb103261b80a322c09ce94580b114d5d6cc5b94a with:
           value 325000 * msg.value / 1000 / 1000 wei
             gas 2300 * is_zero(value) wei
        call 0x6f8a400161235de47491dc7d5d1c39a2f1822c36 with:
