...
function emergencyFixGameResult(uint64 arg1, uint256 arg2) {
    ...
    require 200 == stor9[arg1].field_768
    require arg1 < stor9.length
    stor9[arg1].field_768 = uint8(sha3(stor9[arg1].field_0, arg2) % 37)
    ...
    while uint8(idx) < 157:
        if not stor9[arg1].field_1024 or not 2^idx:
            ...
            continue 
        mem[1024] = 0
        mem[996] = uint16((256 * uint8(idx) + 1) + stor9[arg1].field_768 + 1)
        require ext_code.size(stor4)
        call stor4.getCoeff(uint16 rg1) with:
             gas gas_remaining - 50 wei
            args uint16((256 * uint8(idx) + 1) + stor9[arg1].field_768 + 1)
    ...
    if u:
        ...
        call stor9[arg1].field_0 with:
           value 1 wei
             gas 0 wei
    require ext_call.success
    emit EndGame(stor9[arg1].field_0, stor9[arg1].field_768, arg1);
}
...
function placeBet(uint256 arg1, bytes32 arg2, bytes32 arg3) payable {
    ...
    if not stor6[address(msg.sender)]:
        ...
        if 37 == stor9[uint64(stor6[address(msg.sender)] - 1)].field_768:
...
function getGame(uint64 arg1) {
    ...
    while uint8(idx) < 157:
        if not stor9[arg1].field_1024 or not 2^idx:
            ...
            continue 
        mem[576] = 0
        mem[548] = uint16((256 * uint8(idx) + 1) + stor9[arg1].field_768 + 1)
        require ext_code.size(stor4)
        call stor4.getCoeff(uint16 rg1) with:
             gas gas_remaining - 50 wei
            args uint16((256 * uint8(idx) + 1) + stor9[arg1].field_768 + 1)
...
function SpinTheWheel(address arg1) {
    if arg1:
        if not stor6[address(arg1)]:
            ...
            if stor9[uint64(stor6[address(arg1)] - 1)].field_768 != 37:
                emit ErrorLog(address(arg1), Array(len=22, data='Gamble already spinned'));
            else:
                require uint64(stor6[address(arg1)] - 1) < stor9.length
                if block.number <= stor9[uint64(stor6[address(arg1)] - 1)].field_256 + uint8(stor1.field_160):
                    ...
                    if block.hash(stor9[uint64(stor6[address(arg1)] - 1)].field_256 + uint8(stor1.field_160)):
                        require uint64(stor6[address(arg1)] - 1) < stor9.length
                        stor9[uint64(stor6[address(arg1)] - 1)].field_768 = uint8(sha3(stor9[uint64(stor6[address(arg1)] - 1)].field_0, block.hash(stor9[uint64(stor6[address(arg1)] - 1)].field_256 + uint8(stor1.field_160))) % 37)
                    else:
                        emit ErrorLog(address(msg.sender), Array(len=29, data='Cannot generate random number'));
                        require uint64(stor6[address(arg1)] - 1) < stor9.length
                        stor9[uint64(stor6[address(arg1)] - 1)].field_768 = 200
                    ...
                    while uint8(idx) < 157:
                        if not stor9[uint64(stor6[address(arg1)] - 1)].field_1024 or not 2^idx:
                            ...
                            continue 
                        mem[576] = 0
                        mem[548] = uint16((256 * uint8(idx) + 1) + stor9[uint64(stor6[address(arg1)] - 1)].field_768 + 1)
                        require ext_code.size(stor4)
                        call stor4.getCoeff(uint16 rg1) with:
                             gas gas_remaining - 50 wei
                            args uint16((256 * uint8(idx) + 1) + stor9[uint64(stor6[address(arg1)] - 1)].field_768 + 1)
                        mem[544] = ext_call.return_data[0]
                        require ext_call.success
                        if ext_call.return_data[0] <= 0:
                            if uint8(t + 1) <= 32:
                        ...
                        revert 
                    if u:
                        call stor9[uint64(stor6[address(arg1)] - 1)].field_0 with:
                           value u wei
                             gas 2300 * is_zero(value) wei
                    else:
                        call stor9[uint64(stor6[address(arg1)] - 1)].field_0 with:
                    ...
                    require ext_call.success
                    require uint64(stor6[address(arg1)] - 1) < stor9.length
                    emit EndGame(stor9[uint64(stor6[address(arg1)] - 1)].field_0, stor9[uint64(stor6[address(arg1)] - 1)].field_768, uint64(stor6[address(arg1)] - 1));
    else:
        if not stor6[address(msg.sender)]:
            emit ErrorLog(address(msg.sender), Array(len=19, data='No games for player'));
        else:
            require uint64(stor6[address(msg.sender)] - 1) < stor9.length
            if stor9[uint64(stor6[address(msg.sender)] - 1)].field_768 != 37:
                emit ErrorLog(address(msg.sender), Array(len=22, data='Gamble already spinned'));
            else:
                require uint64(stor6[address(msg.sender)] - 1) < stor9.length
                if block.number <= stor9[uint64(stor6[address(msg.sender)] - 1)].field_256 + uint8(stor1.field_160):
                    emit ErrorLog(address(msg.sender), Array(len=31, data='Wait for playerblock+blockDelay'));
                else:
                    require uint64(stor6[address(msg.sender)] - 1) < stor9.length
                    if block.hash(stor9[uint64(stor6[address(msg.sender)] - 1)].field_256 + uint8(stor1.field_160)):
                        require uint64(stor6[address(msg.sender)] - 1) < stor9.length
                        stor9[uint64(stor6[address(msg.sender)] - 1)].field_768 = uint8(sha3(stor9[uint64(stor6[address(msg.sender)] - 1)].field_0, block.hash(stor9[uint64(stor6[address(msg.sender)] - 1)].field_256 + uint8(stor1.field_160))) % 37)
                    else:
                        emit ErrorLog(address(msg.sender), Array(len=29, data='Cannot generate random number'));
                        require uint64(stor6[address(msg.sender)] - 1) < stor9.length
                        stor9[uint64(stor6[address(msg.sender)] - 1)].field_768 = 200
                    ...
                    while uint8(idx) < 157:
                        if not stor9[uint64(stor6[address(msg.sender)] - 1)].field_1024 or not 2^idx:
                            ...
                            continue 
                        mem[576] = 0
                        mem[548] = uint16((256 * uint8(idx) + 1) + stor9[uint64(stor6[address(msg.sender)] - 1)].field_768 + 1)
                        require ext_code.size(stor4)
                        call stor4.getCoeff(uint16 rg1) with:
                             gas gas_remaining - 50 wei
                            args uint16((256 * uint8(idx) + 1) + stor9[uint64(stor6[address(msg.sender)] - 1)].field_768 + 1)
                        mem[544] = ext_call.return_data[0]
                        require ext_call.success
                        if ext_call.return_data[0] <= 0:
                            if uint8(t + 1) <= 32:
                        ...
                        revert 
                    if u:
                        call stor9[uint64(stor6[address(msg.sender)] - 1)].field_0 with:
                           value u wei
                             gas 2300 * is_zero(value) wei
                    else:
                        call stor9[uint64(stor6[address(msg.sender)] - 1)].field_0 with:
                    ...
                    require ext_call.success
                    require uint64(stor6[address(msg.sender)] - 1) < stor9.length
                    emit EndGame(stor9[uint64(stor6[address(msg.sender)] - 1)].field_0, stor9[uint64(stor6[address(msg.sender)] - 1)].field_768, uint64(stor6[address(msg.sender)] - 1));
}
