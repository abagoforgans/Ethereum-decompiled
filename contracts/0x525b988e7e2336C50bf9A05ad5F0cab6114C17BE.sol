...
function sub_f102e883(?) {
    require msg.sender == managerAddress
    require ext_code.size(arg1)
    call arg1.transferTo(address arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function sub_93f02dc2(?) {
    ...
    while idx < stor1.length:
        ...
        call stor1[idx].field_0.0x9b66c8a0 with:
             gas gas_remaining wei
            args arg1
...
function sub_3d3c17b9(?) {
    ...
    if arg1 != 0x2b6a0cc24865af72f43639a7485d1de65ebeb1c4:
        if arg1 != 0xb478974446f6059b2174956cff8df887bbcd192c:
            if arg1 != 0x34914eb31594896c3b9efa8339db764ae278f61f:
                if arg1 != 0x7e870065e0dc5a51ed1a68b891007a7cdc023371:
...
function sub_9167ba14(?) {
    ...
    mem[ceil32(arg6.length) + 16700 len ceil32(arg6.length)] = arg6[all], mem[arg6.length + 128 len ceil32(arg6.length) - arg6.length]
    if not arg6.length % 32:
        create contract with 0 wei
                        code: code.data[8588 len 15836], arg1, arg2, arg3, arg4 << 240, stor3, Array(len=arg14, data=arg6.length, Mask(8 * arg6.length, -(8 * arg6.length) + 256, arg6[all], mem[arg6.length + 128 len ceil32(arg6.length) - arg6.length]) << (8 * arg6.length) - 256), arg8, arg9, address(arg10), address(arg11), address(arg12), msg.sender, address(arg13)
    else:
        mem[floor32(arg6.length) + ceil32(arg6.length) + 16700] = mem[floor32(arg6.length) + ceil32(arg6.length) + -(arg6.length % 32) + 16732 len arg6.length % 32]
        create contract with 0 wei
                        code: code.data[8588 len 15836], arg1, arg2, arg3, arg4 << 240, stor3, Array(len=arg14, data=arg6.length, Mask(8 * ceil32(arg6.length), -(8 * ceil32(arg6.length)) + 256, arg6[all], mem[arg6.length + 128 len ceil32(arg6.length) - arg6.length]) << (8 * ceil32(arg6.length)) - 256, mem[(2 * ceil32(arg6.length)) + 16700 len floor32(arg6.length) + -ceil32(arg6.length) + 32]), arg8, arg9, address(arg10), address(arg11), address(arg12), msg.sender, address(arg13)
            ...
            if arg1 != 0x34914eb31594896c3b9efa8339db764ae278f61f:
                if arg1 != 0x7e870065e0dc5a51ed1a68b891007a7cdc023371:
                    if not stor5[address(arg1)]:
                        ...
                        sub_5aeef402.length++
                        _42 = mem[_9 + 352]
                        sub_5aeef402[sub_5aeef402.length][].field_0 = Array(len=_42, data=mem[_9 + 384 len _42])
