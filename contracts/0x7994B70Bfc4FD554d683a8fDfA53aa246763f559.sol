...
':
    ...
    if not t:
        ...
        if not _228 + _227 + _226 + _225:
            ...
            return 32, mem[mem[64] + 32 len floor32(_659) + 64]
        ...
        return 32, mem[mem[64] + 32 len floor32(_664) + 64]
    ...
    if not _233 + _232 + _231 + _230:
        ...
        return 32, mem[mem[64] + 32 len floor32(_669) + 64]
    ...
    return 32, mem[mem[64] + 32 len floor32(_674) + 64]
}
