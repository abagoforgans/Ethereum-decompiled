...
function _fallback() payable {
    ...
    stor1 = 10^18 * code.data[2144 len 32]
    stor2 = 10^15 * code.data[2176 len 32]
    uint8(stor8.field_0) = uint8(code.data[2208 len 32])
    Mask(248, 0, stor8.field_8) = 0
    stor5 = code.data[2240 len 32]
    stor6 = 0
    return code.data[111 len 2033]
}
...
array of uint256 stor39192952402756187425302384862487251540968225014669488259582314013099748177609;
...
function recentWins(uint256 arg1) payable {
    ...
    return stor56A6[arg1], storA66C[arg1], storA66C[arg1], storA66C[arg1]
}
        ...
        while idx < stor4.length:
            ...
            if stor7.length >= stor8:
                ...
                if not stor7.length <= stor7.length + 1:
                    s = sha3(7) + (4 * stor7.length + 1)
                    while sha3(7) + (4 * stor7.length) > s:
                        address(stor[s]) = 0
                        stor1[s] = 0
                        stor2[s] = 0
                        contributions[s] = 0
            ...
            stor56A6[stor7.length - 1] = contributors[idx]
            stor56A6[stor7.length - 1] = block.timestamp
            stor56A6[stor7.length - 1] = contributions[stor888A[idx]]
            stor56A6[stor7.length - 1] = eth.balance(this.address)
            emit Won(contributors[idx], block.timestamp, contributions[stor888A[idx]]);
            idx = 0
            while idx < stor4.length:
                mem[0] = contributors[idx]
                mem[32] = 3
        ...
        if stor7.length >= stor8:
            ...
            if not stor7.length <= stor7.length + 1:
                ...
                while 4 * stor7.length > idx:
                    ...
                    continue 
        require stor7.length - 1 < stor7.length
        stor56A6[stor7.length - 1] = 0
        stor56A6[stor7.length - 1] = block.timestamp
        stor56A6[stor7.length - 1] = contributions[0]
        stor56A6[stor7.length - 1] = eth.balance(this.address)
