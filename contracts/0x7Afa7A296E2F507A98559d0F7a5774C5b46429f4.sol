...
function messageForReason(uint8 arg1) {
    ...
    if arg1 != 6:
        return 'Success'
    return Array(len=51, data='Transfer value must be bigger th', 'an MINIMAL_TRANSFER', Mask(152, -256, 'Transfer value must be bigger th', 'an MINIMAL_TRANSFER') << 256), 
}
