...
const _fallback = code.data[19 len 1105]
...
function sub_21e27fde(?) payable {
    require arg1 < avatarCount[address(arg2)].field_2560
    if stor[arg1 + ('array', 10, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg2')), ('name', 'avatarCount', 0)))].field_0:
        mem[160] = stor[sha3(arg1 + ('array', 10, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg2')), ('name', 'avatarCount', 0))))].field_0
        idx = 160
        s = 0
        while stor[arg1 + ('array', 10, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg2')), ('name', 'avatarCount', 0)))].field_0 + 128 > idx:
            mem[idx + 32] = stor[s + sha3(arg1 + ('array', 10, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg2')), ('name', 'avatarCount', 0))))].field_256
            idx = idx + 32
            s = s + 1
            continue 
    return Array(len=stor[arg1 + ('array', 10, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg2')), ('name', 'avatarCount', 0)))].field_0, data=mem[160 len stor[arg1 + ('array', 10, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg2')), ('name', 'avatarCount', 0)))].field_0]), 
}

function setAvatar(uint256 arg1, bytes arg2) payable {
    mem[128 len arg2.length] = arg2[all]
    if avatarCount[address(msg.sender)].field_2560 <= arg1:
        avatarCount[address(msg.sender)].field_2560 = arg1
        if not avatarCount[address(msg.sender)].field_2560 <= arg1:
            mem[0] = sha3(address(msg.sender), 0) + 10
            idx = arg1
            while sha3(sha3(address(msg.sender), 0) + 10) + avatarCount[address(msg.sender)].field_2560 > idx + sha3(mem[0]):
                stor[idx + sha3(mem[0])] = 0
