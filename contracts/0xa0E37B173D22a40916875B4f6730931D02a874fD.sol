...
function _fallback() payable {
    ...
    stor15 = 0
    stor1 = msg.sender
    stor0 = code.data[8732 len 20]
    stor2 = code.data[8700 len 20]
    stor11 = 0
    stor3.length++
    if not stor3.length <= stor3.length + 1:
        ...
        while stor3.length > idx:
            ...
            idx = idx + 1
            continue 
    address(stor3[stor3.length]) = code.data[8732 len 20]
    stor5[address(code.data[8688 len 32])] = stor13
    return code.data[546 len 8142]
}
