...
function main() payable {
    stor1[stor0] += msg.value / 1000
    sub_0dd41aab[address(msg.sender)].field_0 = msg.value - (msg.value / 1000) + sub_0dd41aab[address(msg.sender)].field_0
    if sub_0dd41aab[address(msg.sender)].field_256 <= 0:
