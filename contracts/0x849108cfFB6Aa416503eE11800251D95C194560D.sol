...
function _fallback() {
    ...
    require code.data[7354 len 32] > block.timestamp
    require code.data[7430 len 20]
    require code.data[7354 len 32] < block.timestamp + (2160 * 24 * 3600)
    create contract with 0 wei
                    code: code.data[3996 len 1434]
    require create.new_address
    stor1 = address(create.new_address)
    require ext_code.size(address(create.new_address))
    call address(create.new_address).0xcf12e870 with:
         gas gas_remaining - 710 wei
        args msg.sender
    require ext_call.success
    create contract with 0 wei
                    code: code.data[5430 len 1924], block.timestamp + (2160 * 24 * 3600), address(code.data[7418 len 32])
    require create.new_address
    ...
    call address(create.new_address).0xcf12e870 with:
        ...
        args msg.sender
    require ext_call.success
    stor6 = uint32(code.data[7354 len 32])
    stor3 = address(code.data[7386 len 32])
    return code.data[628 len 3368]
}
...
address fundAddress;
address stor3;
address companiesManagerAddress;
...
function companiesManager() {
    return companiesManagerAddress
}
...
function setCompanyManager(address arg1) {
    require stor0[address(msg.sender)]
    companiesManagerAddress = arg1
}
...
function buyTicketsFor(address arg1, uint256 arg2) payable {
    ...
    require ext_code.size(ticketHolderAddress)
    if companiesManagerAddress:
        call ticketHolderAddress.totalTickets() with:
             gas gas_remaining - 710 wei
        require ext_call.success
        require ext_code.size(companiesManagerAddress)
        call companiesManagerAddress.processing(address rg1, uint256 rg2, uint256 rg3, uint256 rg4) with:
             gas gas_remaining - 710 wei
            args 0, 0, msg.value - (msg.value % 10^17), msg.value - (msg.value % 10^17) / 10^17, uint64(ext_call.return_data[0])
        require ext_call.success
...
function buyTickets(uint256 arg1) payable {
    ...
    if companiesManagerAddress:
        ...
        call companiesManagerAddress.processing(address rg1, uint256 rg2, uint256 rg3, uint256 rg4) with:
             gas gas_remaining - 710 wei
            args 0, uint32(msg.sender), msg.value - (msg.value % 10^17), msg.value - (msg.value % 10^17) / 10^17, uint64(ext_call.return_data[0])
        require ext_call.success
    call ticketHolderAddress.issueTickets(address rg1, uint256 rg2, uint256 rg3) with:
         gas gas_remaining - 710 wei
