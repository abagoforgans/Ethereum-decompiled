...
function _fallback() payable {
    mem[96 len -630] = code.data[1680 len -630]
    mem[64] = -470
    mem[-534] = mem[96] + 96
    mem[-502] = 0
...
uint256 sub_8a5f13fe;
uint256 sub_7dbaff91;
uint256 sub_25ef0ede;
uint256 sub_f3118cdc;

function sub_25ef0ede(?) payable {
    return sub_25ef0ede
}

function sub_7dbaff91(?) payable {
    return sub_7dbaff91
}

function sub_8a5f13fe(?) payable {
    return sub_8a5f13fe
}

function sub_f3118cdc(?) payable {
    return sub_f3118cdc
}
