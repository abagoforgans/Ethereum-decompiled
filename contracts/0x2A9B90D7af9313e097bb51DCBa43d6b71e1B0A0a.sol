...
function _fallback() {
    stor0 = msg.sender
    stor1 = code.data[1844 len 20]
    stor2 = code.data[1864 len 32]
    stor3 = code.data[1896 len 32]
    stor4 = code.data[1928 len 32]
    uint8(stor5.field_0) = uint8(bool(code.data[1960 len 32]))
    Mask(248, 0, stor5.field_8) = Mask(248, 0, bool(code.data[1992 len 32]))
    Mask(240, 0, stor5.field_16) = Mask(240, 16, bool(code.data[1960 len 32])) >> 16
    emit ActivatedEvent(bool(uint8(bool(code.data[1960 len 32]))), bool(uint8(bool(code.data[1992 len 32]))));
    return code.data[271 len 1561]
}
