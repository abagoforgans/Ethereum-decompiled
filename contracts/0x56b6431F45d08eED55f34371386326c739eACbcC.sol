...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'Ethereum Meta' / 256
    idx = 0
    ...
    while stor1.length + 31 / 32 > idx:
        ...
        continue 
    stor2 = 18
    stor3 = 96571598 * 10^18
    require not msg.value
    mem[224 len -2260] = code.data[2750 len -2260]
