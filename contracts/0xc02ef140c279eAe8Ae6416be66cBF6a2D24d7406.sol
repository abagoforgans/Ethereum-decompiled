...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 1000000000000 * 10^18
    stor2 = 1000000000000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 9
    stor3.length.field_8 = 'AchilleDN' / 256
    idx = 0
