...
function buyToken() payable {
    ...
    require msg.value * currentEthPrice / 100 * 10^18 * currentTokenPrice / 10^16 <= totalAmount
    totalAmount -= msg.value * currentEthPrice / 100 * 10^18 * currentTokenPrice / 10^16
