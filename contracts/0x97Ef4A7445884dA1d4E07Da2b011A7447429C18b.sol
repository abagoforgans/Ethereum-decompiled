...
function _fallback() payable {
    ...
    while stor3.length + 31 / 32 > idx:
        ...
        continue 
    stor4 = 18
    require address(code.data[10221 len 32])
    stor9 = address(code.data[10221 len 32])
    return code.data[677 len 9544]
}
...
function _fallback() payable {
    ...
    require usdPerKEther
    require contributedEth + msg.value >= contributedEth
    if contributedEth + msg.value <= 1000 * 10^18 * usdCap / usdPerKEther:
        require msg.value > 0
        require contributedEth + msg.value >= contributedEth
        contributedEth += msg.value
        require contributedUsd + (msg.value * usdPerKEther / 1000 * 10^18) >= contributedUsd
        ...
        require _totalSupply + msg.value >= _totalSupply
        ...
        require contributedUsd + ((1000 * 10^18 * usdCap / usdPerKEther * usdPerKEther) - (contributedEth * usdPerKEther) / 1000 * 10^18) >= contributedUsd
        contributedUsd += (1000 * 10^18 * usdCap / usdPerKEther * usdPerKEther) - (contributedEth * usdPerKEther) / 1000 * 10^18
        require uint8(stor6.field_8)
        require balanceOf[address(msg.sender)] + (1000 * 10^18 * usdCap / usdPerKEther) - contributedEth >= balanceOf[address(msg.sender)]
        balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + (1000 * 10^18 * usdCap / usdPerKEther) - contributedEth
        require _totalSupply + (1000 * 10^18 * usdCap / usdPerKEther) - contributedEth >= _totalSupply
        _totalSupply = _totalSupply + (1000 * 10^18 * usdCap / usdPerKEther) - contributedEth
