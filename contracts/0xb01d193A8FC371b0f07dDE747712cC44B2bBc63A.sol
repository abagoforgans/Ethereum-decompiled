...
function claimWinnings(uint256 arg1) payable {
    ...
    if not match[arg1].field_768 / match[arg1].field_512:
        require 0 <= match[stor2].field_1536
        ...
        require match[arg1][match[arg1].field_256][msg.sender].field_0 * match[arg1].field_768 / match[arg1].field_512 <= match[stor2].field_1536
        match[stor2].field_1536 += -1 * match[arg1][match[arg1].field_256][msg.sender].field_0 * match[arg1].field_768 / match[arg1].field_512
        require ext_code.size(sub_ba9da211Address)
        call sub_ba9da211Address.0xa9059cbb with:
             gas gas_remaining wei
...
function sub_cac0b9e4(?) payable {
    ...
    if not match[stor2][arg1 << 248].field_512 + 1:
        ...
        require -match[stor2][arg1 << 248].field_256 + match[stor2].field_1536 >= match[stor2].field_1536
        match[stor2].field_1536 -= match[stor2][arg1 << 248].field_256
        ...
        require (match[stor2].field_1024 * ((10^18 * match[stor2][arg1 << 248].field_512) + 10^18)^2 / 2 / 10^18) - match[stor2][arg1 << 248].field_256 + match[stor2].field_1536 >= match[stor2].field_1536
        match[stor2].field_1536 = (match[stor2].field_1024 * ((10^18 * match[stor2][arg1 << 248].field_512) + 10^18)^2 / 2 / 10^18) - match[stor2][arg1 << 248].field_256 + match[stor2].field_1536
        match[stor2][arg1 << 248][msg.sender].field_0++
        match[stor2][arg1 << 248].field_512++
...
function sub_1aee8521(?) payable {
    require calldata.size - 4 >= 32
    if match[stor2].field_1280:
        revert with 0, 'Match ended'
    if arg1 >= match[stor2].field_264:
        revert with 0, 'Invalid Team'
    ...
    if not match[stor2][arg1 << 248].field_512:
        ...
        if not match[stor2][arg1 << 248].field_512 - 1:
            ...
            match[stor2].field_768 -= match[stor2][arg1 << 248].field_256
            require match[stor2][arg1 << 248].field_256 <= match[stor2].field_1536
            match[stor2].field_1536 -= match[stor2][arg1 << 248].field_256
            require ext_code.size(sub_ba9da211Address)
            call sub_ba9da211Address.0xa9059cbb with:
                 gas gas_remaining wei
            ...
            require match[stor2][arg1 << 248].field_256 - (match[stor2].field_1024 * ((10^18 * match[stor2][arg1 << 248].field_512) - 10^18)^2 / 2 / 10^18) <= match[stor2].field_1536
            match[stor2].field_1536 = match[stor2].field_1536 - match[stor2][arg1 << 248].field_256 + (match[stor2].field_1024 * ((10^18 * match[stor2][arg1 << 248].field_512) - 10^18)^2 / 2 / 10^18)
            require ext_code.size(sub_ba9da211Address)
            call sub_ba9da211Address.0xa9059cbb with:
                 gas gas_remaining wei
