...
function _fallback() payable {
    ...
    require 1514230020 >= block.timestamp
    stor0 = 0
    stor1 = 1514230020
    stor2 = 1514233620
    stor4 = 21
    ...
    create contract with 0 wei
                    code: code.data[2996 len 1548], stor3
    require create.new_address
    stor8 = address(create.new_address)
    stor7 = 47619047619047619
    stor9 = 95238095238095238
    stor0 = code.data[4556 len 20]
    return code.data[466 len 2530]
}
...
function buyTokens(address arg1) payable {
    ...
    if not msg.value:
        ...
        require 21 * msg.value / msg.value == 21
        require msg.value + weiRaised >= weiRaised
        weiRaised += msg.value
        require ext_code.size(tokenAddress)
        call tokenAddress.0x40c10f19 with:
             gas gas_remaining - 710 wei
            args address(arg1), 21 * msg.value
        require ext_call.success
        emit TokenPurchase(msg.value, 21 * msg.value, msg.sender, arg1);
    require ext_code.size(vaultAddress)
...
function _fallback() payable {
    ...
    if not msg.value:
        ...
        call tokenAddress.0x40c10f19 with:
             gas gas_remaining - 710 wei
            args msg.sender, 21 * msg.value
        require ext_call.success
        emit TokenPurchase(msg.value, 21 * msg.value, msg.sender, msg.sender);
    require ext_code.size(vaultAddress)
    call vaultAddress.deposit(address rg1) with:
       value msg.value wei
         gas gas_remaining - 9710 wei
