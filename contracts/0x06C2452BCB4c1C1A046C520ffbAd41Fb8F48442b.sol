...
uint256 stor0;
array of uint256 jeopardy;
address stor2;
uint256 stor2;

function Jeopardy() {
    return jeopardy[0 len jeopardy.length]
}
...
function NewQuestion(string arg1, bytes32 arg2) payable {
    if msg.sender == address(stor2):
        jeopardy[] = Array(len=arg1.length, data=arg1[all])
        stor0 = arg2
}

function EndQuestion() payable {
    if msg.sender == address(stor2):
...
function Answer(string arg1) payable {
...
function QuestionIs(string arg1, string arg2) payable {
