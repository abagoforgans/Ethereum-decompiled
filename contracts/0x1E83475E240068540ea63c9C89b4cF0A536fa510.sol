...
function _fallback() payable {
    ...
    stor14 = 0
    require msg.value > 0
    require code.data[11708 len 32] > 0
    require code.data[11740 len 32] >= block.timestamp
    require code.data[11772 len 32] >= code.data[11740 len 32]
    require code.data[11804 len 32] > 0
    require code.data[11848 len 20]
    stor0 = msg.sender
    stor2 = code.data[11708 len 32]
    stor3 = code.data[11740 len 32]
    stor4 = code.data[11772 len 32]
    stor6 = code.data[11804 len 32]
    stor8 = code.data[11848 len 20]
    create contract with 0 wei
                    code: code.data[7190 len 4518]
...
function changeWallet(address arg1) payable {
    ...
    require msg.value > 0
    walletAddress = arg1
    emit WalletChanged(arg1, walletAddress);
