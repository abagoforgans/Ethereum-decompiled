...
function _fallback() {
    stor0 = msg.sender
    stor0 = code.data[3829 len 20]
    require code.data[3849 len 32]
    require code.data[3881 len 32]
    stor7 = code.data[3881 len 32]
    stor8 = code.data[3913 len 32]
    stor6 = code.data[3849 len 32]
    return code.data[164 len 3653]
}
