...
#
const name = 'Point Value Bonus Token'
...
const TOKEN_NAME = 'Point Value Bonus Token'

const TOKEN_SYMBOL = 'PVBT'

const TOKEN_DECIMAL_MULTIPLIER = 1

const TOKEN_DECIMALS = 0

const TARGET_USER = 0x5e0c441b6df595d6f5431ef806a9e9fe714b090c

const PAUSED = 0

const TOKEN_DECIMALS_UINT8 = 0
