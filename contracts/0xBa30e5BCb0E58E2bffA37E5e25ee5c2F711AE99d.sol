...
function getPlayers() {
    if not lastIndex:
        ...
        mem[128 len 32 * lastIndex] = code.data[5167 len 32 * lastIndex]
        mem[(32 * lastIndex) + 128] = lastIndex
        mem[(32 * lastIndex) + 160 len 32 * lastIndex] = code.data[5167 len 32 * lastIndex]
    idx = 0
    while idx < lastIndex:
...
function getTickets(address arg1) {
    ...
    if not ticketsMap[address(arg1)].field_0:
        ...
        mem[128 len 32 * ticketsMap[address(arg1)].field_0] = code.data[5167 len 32 * ticketsMap[address(arg1)].field_0]
        mem[(32 * ticketsMap[address(arg1)].field_0) + 128] = ticketsMap[address(arg1)].field_0
        mem[64] = (64 * ticketsMap[address(arg1)].field_0) + 160
        mem[(32 * ticketsMap[address(arg1)].field_0) + 160 len 32 * ticketsMap[address(arg1)].field_0] = code.data[5167 len 32 * ticketsMap[address(arg1)].field_0]
    idx = 0
