...
function _fallback() {
    mem[96 len -5355] = code.data[5848 len -5355]
    mem[64] = -5259
...
function withdrawEther(uint256 arg1) {
    require msg.sender == sub_5db82fa0Address
    call sub_5db82fa0Address with:
       value arg1 wei
