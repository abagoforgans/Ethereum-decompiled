...
function _fallback() payable {
    mem[96 len -2518] = code.data[3041 len -2518]
    mem[64] = -2422
    ...
    stor6 = mem[224]
    stor7 = mem[256]
    uint32(stor8.field_0) = mem[348 len 4]
    Mask(224, 0, stor8.field_32) = 0
    return code.data[523 len 2518]
}
...
function buy() payable {
    ...
    while idx < 10:
        ...
        continue 
    if s < uint32(odds):
        balanceOf[address(msg.sender)] += 19998 * msg.value
        balanceOf[address(stor5)] = msg.value + balanceOf[address(stor5)] - 1
        balanceOf[this.address] = balanceOf[this.address] + (-19999 * msg.value) - 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
        emit 0x56ddf252: (19998 * msg.value), this.address, msg.sender
    else:
        balanceOf[address(msg.sender)]++
        balanceOf[address(stor5)] = msg.value + balanceOf[address(stor5)] - 1
        balanceOf[this.address] -= msg.value
        emit 0x56ddf252: 1, this.address, msg.sender
    emit 0x56ddf252: (msg.value - 1), this.address, address(houseAddress)
    return msg.value
}
