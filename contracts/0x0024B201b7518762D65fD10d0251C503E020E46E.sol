...
function GetContributionInfo(uint16 arg1, uint16 arg2) payable {
    return getContributionInfo[arg1 << 240][1][arg2 << 240].field_0, 
           ...
           uint8(getContributionInfo[arg1 << 240][1][arg2 << 240].field_1792),
            ...
            if stor3.length + msg.value > stor4.length:
                ...
                while uint16(idx) < uint16(stor7.length):
                    ...
                    if uint16(idx) != 65535:
                        ...
                        getContributionInfo[idx << 240][1][uint16(getContributionInfo[idx << 240].field_0)].field_512 = Mask(240, 0, getContributionInfo[idx << 240][1][uint16(getContributionInfo[idx << 240].field_0)].field_528)
                        getContributionInfo[idx << 240][1][uint16(getContributionInfo[idx << 240].field_0)].field_768 = msg.value - (msg.value / 100 * arg2) + (msg.value / 100 * arg2) / 10000 * uint16(uint64(uint64(stor2.field_64) + (uint8((100 * msg.value) - (100 * msg.value / 100 * arg2) / msg.value - (msg.value / 100 * arg2) + (msg.value / 100 * arg2)) * uint8((100 * msg.value) - (100 * msg.value / 100 * arg2) / msg.value - (msg.value / 100 * arg2) + (msg.value / 100 * arg2)) * uint64(stor1.length.field_160)) + (uint8((100 * msg.value) - (100 * msg.value / 100 * arg2) / msg.value - (msg.value / 100 * arg2) + (msg.value / 100 * arg2)) * uint64(stor2.field_0))) / 10000) / 5
                        getContributionInfo[idx << 240][1][uint16(getContributionInfo[idx << 240].field_0)].field_1024 = Mask(248, 0, getContributionInfo[idx << 240][1][uint16(getContributionInfo[idx << 240].field_0)].field_1032)
                        ...
                        getContributionInfo[uint16(stor7.length)][1][uint16(getContributionInfo[uint16(stor7.length)].field_0)].field_512 = Mask(240, 0, getContributionInfo[uint16(stor7.length)][1][uint16(getContributionInfo[uint16(stor7.length)].field_0)].field_528)
                        getContributionInfo[uint16(stor7.length)][1][uint16(getContributionInfo[uint16(stor7.length)].field_0)].field_768 = msg.value - (msg.value / 100 * arg2) + (msg.value / 100 * arg2) / 10000 * uint16(uint64(uint64(stor2.field_64) + (uint8((100 * msg.value) - (100 * msg.value / 100 * arg2) / msg.value - (msg.value / 100 * arg2) + (msg.value / 100 * arg2)) * uint8((100 * msg.value) - (100 * msg.value / 100 * arg2) / msg.value - (msg.value / 100 * arg2) + (msg.value / 100 * arg2)) * uint64(stor1.length.field_160)) + (uint8((100 * msg.value) - (100 * msg.value / 100 * arg2) / msg.value - (msg.value / 100 * arg2) + (msg.value / 100 * arg2)) * uint64(stor2.field_0))) / 10000) / 5
                        getContributionInfo[uint16(stor7.length)][1][uint16(getContributionInfo[uint16(stor7.length)].field_0)].field_1024 = Mask(248, 0, getContributionInfo[uint16(stor7.length)][1][uint16(getContributionInfo[uint16(stor7.length)].field_0)].field_1032)
    ...
    if msg.sender == stor0:
        ...
        while uint16(idx) < uint16(stor7.length):
            ...
            while uint16(s) < uint16(getContributionInfo[idx << 240].field_160):
                _107 = sha3(s << 240, sha3(mem[0 len 64]) + 1)
                if not uint8(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]):
                    if block.timestamp - stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] >= 24 * 3600:
                        if block.timestamp <= stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600):
                            if eth.balance(this.address) - stor5.length - stor6.length >= uint8(block.timestamp - stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] / 24 * 3600) * stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]:
                                if stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(block.timestamp - stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] / 24 * 3600) > 10^17:
                                    call address(getContributionInfo[idx << 240].field_0) with:
                                       value stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(block.timestamp - stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] / 24 * 3600) wei
                                         gas 0 wei
                                    stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] += 24 * 3600 * uint8(block.timestamp - stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] / 24 * 3600) % 16777216
                                else:
                                    if block.timestamp > stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600):
                                        call address(getContributionInfo[idx << 240].field_0) with:
                                           value stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(block.timestamp - stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] / 24 * 3600) wei
                            ...
                            if uint8(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]):
                                if eth.balance(this.address) - stor5.length - stor6.length >= uint8(stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + -stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600) / 24 * 3600) * stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]:
                                    if stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + -stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600) / 24 * 3600) > 10^17:
                                        call address(getContributionInfo[idx << 240].field_0) with:
                                           value stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + -stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600) / 24 * 3600) wei
                                             gas 0 wei
                                        stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] += 24 * 3600 * uint8(stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + -stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600) / 24 * 3600) % 16777216
                                    else:
                                        if block.timestamp > stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600):
                                            call address(getContributionInfo[idx << 240].field_0) with:
                                               value stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + -stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600) / 24 * 3600) wei
                                ...
                                if not stor4[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]:
                                    if stor5.length >= stor[sha3(mem[0 len 64]) + 1][s << 240]:
                                        ...
                                        stor3.length = stor3.length - stor[sha3(mem[0 len 64]) + 1][s << 240] - stor1[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))].field_0
                                        call address(getContributionInfo[idx << 240].field_0) with:
                                           value stor1[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))].field_0 + stor[sha3(mem[0 len 64]) + 1][s << 240] wei
                                             gas 0 wei
                                        uint8(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]) = 1
                                    if eth.balance(this.address) - stor5.length - stor6.length >= uint8(stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + -stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600) / 24 * 3600) * stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]:
                                        if stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + -stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600) / 24 * 3600) > 10^17:
                                            call address(getContributionInfo[idx << 240].field_0) with:
                                               value stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + -stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600) / 24 * 3600) wei
                                    ...
                                    getContributionInfo[idx << 240][1][uint16(getContributionInfo[idx << 240].field_0)].field_512 = Mask(240, 0, getContributionInfo[idx << 240][1][uint16(getContributionInfo[idx << 240].field_0)].field_528)
                                    getContributionInfo[idx << 240][1][uint16(getContributionInfo[idx << 240].field_0)].field_768 = stor[sha3(mem[0 len 64]) + 1][s << 240] + stor1[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))].field_0 / 10000 * uint16(uint64(uint64(stor2.field_64) + (uint8(100 * stor[sha3(mem[0 len 64]) + 1][s << 240] / stor[sha3(mem[0 len 64]) + 1][s << 240] + stor1[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))].field_0) * uint8(100 * stor[sha3(mem[0 len 64]) + 1][s << 240] / stor[sha3(mem[0 len 64]) + 1][s << 240] + stor1[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))].field_0) * uint64(stor1.length.field_160)) + (uint8(100 * stor[sha3(mem[0 len 64]) + 1][s << 240] / stor[sha3(mem[0 len 64]) + 1][s << 240] + stor1[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))].field_0) * uint64(stor2.field_0))) / 10000) / 5
                    ...
                    if stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600) != stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]:
                        if block.timestamp - stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] >= 24 * 3600:
                            if block.timestamp <= stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600):
                                if eth.balance(this.address) - stor5.length - stor6.length >= uint8(block.timestamp - stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] / 24 * 3600) * stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]:
                                    if stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(block.timestamp - stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] / 24 * 3600) > 10^17:
