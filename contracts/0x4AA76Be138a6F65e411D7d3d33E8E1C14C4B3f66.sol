...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[3750 len 32] > 0
    require code.data[3782 len 32] > 0
    stor6 = msg.sender
    stor7 = code.data[3750 len 32]
    stor8 = code.data[3782 len 32]
    stor3 = 10^18 * code.data[3814 len 32]
    return code.data[192 len 3558]
}
...
const SUPPLY_LIMIT = 6000000 * 10^18
...
function _fallback() payable {
    ...
    require block.number <= endAtBlock
    require totalSupply < 6000000 * 10^18
    require block.number >= startAtBlock
    require block.number <= endAtBlock
    require totalSupply < 6000000 * 10^18
    ...
    if msg.value >= 100 * 10^18:
        ...
        require (3000 * msg.value) + totalSupply <= 6000000 * 10^18
        require totalSupply <= 6000000 * 10^18
        ...
        if msg.value < 5 * 10^18:
            ...
            require (1500 * msg.value) + totalSupply <= 6000000 * 10^18
            require totalSupply <= 6000000 * 10^18
            require msg.value + etherContributions[address(msg.sender)] >= etherContributions[address(msg.sender)]
            require msg.value + etherContributions[address(msg.sender)] >= msg.value
            etherContributions[address(msg.sender)] += msg.value
            ...
            require (2250 * msg.value) + totalSupply <= 6000000 * 10^18
            require totalSupply <= 6000000 * 10^18
            require msg.value + etherContributions[address(msg.sender)] >= etherContributions[address(msg.sender)]
            require msg.value + etherContributions[address(msg.sender)] >= msg.value
            etherContributions[address(msg.sender)] += msg.value
