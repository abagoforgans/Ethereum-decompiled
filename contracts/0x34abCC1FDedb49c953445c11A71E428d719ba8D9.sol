...
function sell_label(address arg1, uint256 arg2) {
    ...
    call stor3.entries(bytes32 rg1) with:
         gas gas_remaining - 710 wei
        args sha3(mem[96 len stor0[address(msg.sender)].length])
    require ext_call.success
    require ext_code.size(address(ext_call.return_data[32]))
    call address(ext_call.return_data[32]).previousOwner() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require address(ext_call.return_data[0]) == stor0[address(msg.sender)].field_512
    require ext_code.size(stor2)
    call stor2.setResolver(bytes32 rg1, address rg2) with:
         gas gas_remaining - 710 wei
        args sha3(stor5, sha3(mem[96 len stor0[address(msg.sender)].length])), stor4
    require ext_call.success
    require ext_code.size(stor4)
    call stor4.setAddr(bytes32 rg1, address rg2) with:
         gas gas_remaining - 710 wei
        args sha3(stor5, sha3(mem[96 len stor0[address(msg.sender)].length])), arg1
    require ext_call.success
    require ext_code.size(stor3)
    call stor3.transfer(bytes32 rg1, address rg2) with:
         gas gas_remaining - 710 wei
        args sha3(mem[96 len stor0[address(msg.sender)].length]), arg1
    require ext_call.success
