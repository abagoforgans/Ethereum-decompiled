...
function _fallback() payable {
    ...
    mem[96 len -2530] = code.data[2887 len -2530]
    mem[64] = -2434
...
function _fallback() payable {
    ...
    require (RATE * msg.value / 10^18) + _totalSupply >= _totalSupply
    _totalSupply += RATE * msg.value / 10^18
    require (RATE * msg.value / 10^18) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
