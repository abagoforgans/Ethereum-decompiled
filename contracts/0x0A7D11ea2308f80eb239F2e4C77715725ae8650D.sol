...
function _fallback() payable {
    ...
    stor4 = stor26
    stor8[address(msg.sender)] = stor26
    bool(stor1.length) = 0
    stor1.length.field_1 = 3
    stor1.length.field_8 = 'ZBC' / 256
    idx = 0
    ...
    stor2.length.field_8 = 'ZBC' / 256
    idx = 0
    while stor2.length + 31 / 32 > idx:
        stor2[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[597 len 4690]
}
...
function releaseSell(uint256 arg1) {
    require owner == msg.sender
    require sellSupply >= arg1
