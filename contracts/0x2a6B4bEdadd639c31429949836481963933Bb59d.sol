...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor10[address(msg.sender)] = 150000 * 10^18
    stor6 = 0
    return code.data[547 len 3347]
}
...
function priviledgedAddressBurnUnsoldCoins() {
    require priviledgedAddress == msg.sender
