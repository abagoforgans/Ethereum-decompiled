...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 10^18
    stor2 = 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 25
    stor3.length.field_8 = 'South African Rands Token' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'ZARt' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[565 len 4002]
}
