...
function sub_2eaff41f(?) payable {
    if cd[4] > 0:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(0x5e8cfcbaaee5839853435519d39ee0e5eb3cbfed)
    delegate 0x5e8cfcbaaee5839853435519d39ee0e5eb3cbfed.0x45b13e1 with:
         gas gas_remaining wei
...
function sub_be830823(?) {
    ...
    require return_data.size >= 32
    require ext_code.size(0x650e91a5316b502f3923b3afcc0dde5aa86ebaf0)
    delegate 0x650e91a5316b502f3923b3afcc0dde5aa86ebaf0.mul(uint128 arg1, uint128 arg2) with:
         gas gas_remaining wei
