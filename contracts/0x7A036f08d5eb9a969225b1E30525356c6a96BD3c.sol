...
function _fallback() payable {
    stor1 = 0x3b5331a3a9b0ddbd56e4a58b21a6cd9da3203d21
    stor2 = 0
    stor3 = 0
    ...
    address(stor4.field_0) = code.data[2617 len 20]
    return code.data[343 len 2262]
}
...
const ICO_START_TIME = (420301 * 3600)
...
function buyTokens() payable {
    require block.timestamp >= 420301 * 3600
    ...
    if block.timestamp < 420301 * 3600:
        require 3000 * msg.value / 10^10 > 0
        require ext_call.return_data[0] >= 3000 * msg.value / 10^10
        require (3000 * msg.value / 10^10) + totalTokensSold >= totalTokensSold
        ...
        if block.timestamp < 420349 * 3600:
            ...
            require (120 * 3000 * msg.value / 10^10 / 100) + totalTokensSold >= totalTokensSold
            ...
            if block.timestamp < 420469 * 3600:
                ...
                require (115 * 3000 * msg.value / 10^10 / 100) + totalTokensSold >= totalTokensSold
                ...
                if block.timestamp >= 420661 * 3600:
                    ...
                    require (110 * 3000 * msg.value / 10^10 / 100) + totalTokensSold >= totalTokensSold
