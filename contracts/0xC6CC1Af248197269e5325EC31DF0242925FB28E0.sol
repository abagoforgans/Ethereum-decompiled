...
function _fallback() {
    stor1 = msg.sender
    stor3 = msg.sender
    stor5 = 0xea74796cd4770e58e58771b2b7e0d773d9d32bd4
    stor2 = 0x6cd8a476659a748eef2164fec3c0bb606ad14606
    ...
    stor23 = 17 * 10^14
    stor24 = 12 * 10^15
    return code.data[820 len 12645]
}
...
function finalize() {
    require msg.sender == owner
    if rLCSentToETH + rLCSentToBTC < maxCap - 5 * 10^10:
        require block.timestamp >= endBlock
...
function _fallback() payable {
    ...
    if block.timestamp < startBlock + (240 * 24 * 3600):
        ...
        require ext_call.success
        require ext_call.return_data[0]
        require backers[address(msg.sender)].field_1024 + (msg.value * rLCPerETH / 10^18) + (msg.value * rLCPerETH / 10^18 / 5) >= backers[address(msg.sender)].field_1024
        require backers[address(msg.sender)].field_1024 >= 0
        backers[address(msg.sender)].field_1024 = backers[address(msg.sender)].field_1024 + (msg.value * rLCPerETH / 10^18) + (msg.value * rLCPerETH / 10^18 / 5)
        ...
        if block.timestamp >= startBlock + (480 * 24 * 3600):
            ...
            require ext_call.success
            require ext_call.return_data[0]
            require backers[address(msg.sender)].field_1024 + (msg.value * rLCPerETH / 10^18) >= backers[address(msg.sender)].field_1024
            require backers[address(msg.sender)].field_1024 + (msg.value * rLCPerETH / 10^18) >= msg.value * rLCPerETH / 10^18
            backers[address(msg.sender)].field_1024 += msg.value * rLCPerETH / 10^18
            require backers[address(msg.sender)].field_0 + msg.value >= backers[address(msg.sender)].field_0
            require backers[address(msg.sender)].field_0 + msg.value >= msg.value
            backers[address(msg.sender)].field_0 += msg.value
            require eTHReceived + msg.value >= eTHReceived
            ...
            require ext_call.success
            require ext_call.return_data[0]
            require backers[address(msg.sender)].field_1024 + (msg.value * rLCPerETH / 10^18) + (msg.value * rLCPerETH / 10^18 / 10) >= backers[address(msg.sender)].field_1024
            require backers[address(msg.sender)].field_1024 >= 0
            backers[address(msg.sender)].field_1024 = backers[address(msg.sender)].field_1024 + (msg.value * rLCPerETH / 10^18) + (msg.value * rLCPerETH / 10^18 / 10)
            require backers[address(msg.sender)].field_0 + msg.value >= backers[address(msg.sender)].field_0
            require backers[address(msg.sender)].field_0 + msg.value >= msg.value
            backers[address(msg.sender)].field_0 += msg.value
            require eTHReceived + msg.value >= eTHReceived
...
function receiveBTC(address arg1, string arg2, uint256 arg3, string arg4) {
    ...
    if block.timestamp < startBlock + (240 * 24 * 3600):
        ...
        require ext_call.success
        require ext_call.return_data[0]
        require backers[address(arg1)].field_1024 + (arg3 * rLCPerSATOSHI) + (arg3 * rLCPerSATOSHI / 5) >= backers[address(arg1)].field_1024
        require backers[address(arg1)].field_1024 >= 0
        backers[address(arg1)].field_1024 = backers[address(arg1)].field_1024 + (arg3 * rLCPerSATOSHI) + (arg3 * rLCPerSATOSHI / 5)
        ...
        if block.timestamp >= startBlock + (480 * 24 * 3600):
            ...
            require ext_call.success
            require ext_call.return_data[0]
            require backers[address(arg1)].field_1024 + (arg3 * rLCPerSATOSHI) >= backers[address(arg1)].field_1024
            require backers[address(arg1)].field_1024 + (arg3 * rLCPerSATOSHI) >= arg3 * rLCPerSATOSHI
            backers[address(arg1)].field_1024 += arg3 * rLCPerSATOSHI
            backers[address(arg1)][1][].field_0 = Array(len=arg2.length, data=arg2[all])
            require backers[address(arg1)].field_512 + arg3 >= backers[address(arg1)].field_512
            require backers[address(arg1)].field_512 + arg3 >= arg3
            backers[address(arg1)].field_512 += arg3
            ...
            require ext_call.success
            require ext_call.return_data[0]
            require backers[address(arg1)].field_1024 + (arg3 * rLCPerSATOSHI) + (arg3 * rLCPerSATOSHI / 10) >= backers[address(arg1)].field_1024
            require backers[address(arg1)].field_1024 >= 0
            backers[address(arg1)].field_1024 = backers[address(arg1)].field_1024 + (arg3 * rLCPerSATOSHI) + (arg3 * rLCPerSATOSHI / 10)
            backers[address(arg1)][1][].field_0 = Array(len=arg2.length, data=arg2[all])
            require backers[address(arg1)].field_512 + arg3 >= backers[address(arg1)].field_512
            require backers[address(arg1)].field_512 + arg3 >= arg3
            backers[address(arg1)].field_512 += arg3
