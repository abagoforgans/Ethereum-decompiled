...
function _fallback() payable {
    ...
    mem[96 len -6023] = code.data[6755 len -6023]
    mem[64] = -5927
    stor3 = msg.sender
    stor8 = msg.sender
    stor3 = msg.sender
...
function mint(address arg1, uint256 arg2) {
    ...
    require not stor6
    require ext_code.size(0x9ea466fe8d08f880f364cc93a68160f3c2cd60e3)
    delegate 0x9ea466fe8d08f880f364cc93a68160f3c2cd60e3.0x66098d4f with:
         gas gas_remaining - 50 wei
