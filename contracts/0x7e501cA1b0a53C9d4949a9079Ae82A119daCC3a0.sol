...
function getPrice() {
    ...
    staticcall address(stor0).getPrice(string arg1, uint256 arg2) with:
            gas gas_remaining wei
           args 0, 64, 100000, 3, 'URL'
...
function bla() {
    ...
    staticcall address(stor0).getPrice(string arg1, uint256 arg2) with:
            gas gas_remaining wei
           args 64, 100000, 3, 'URL' % 16777216
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] <= (100000 * block.gasprice) + 10^18:
        require ext_code.size(address(stor0))
        call address(stor0).query_withGasLimit(uint256 arg1, string arg2, string arg3, uint256 arg4) with:
           value ext_call.return_data[0] wei
             gas gas_remaining wei
            args 0, 128, 192, 100000, 3, 'URL' << 232, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
}
