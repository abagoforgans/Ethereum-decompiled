...
function approve(address[] arg1, address[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        mem[mem[64]] = 68
        mem[64] = mem[64] + 100
        mem[_20 + 32] = mem[_20 + 36 len 28] or 0x95ea7b300000000000000000000000000000000000000000000000000000000
        _23 = mem[_20]
        t = _20 + 32
        u = _19 + 100
        s = mem[_20]
        while s >= 32:
            ...
            s = s - 32
            continue 
        mem[_19 + floor32(mem[_20]) + 100] = mem[_20 + -(mem[_20] % 32) + floor32(mem[_20]) + 64 len mem[_20] % 32] or Mask(8 * -(mem[_20] % 32) + 32, -(8 * -(mem[_20] % 32) + 32) + 256, mem[_19 + floor32(mem[_20]) + 100])
        call address(cd[((32 * idx) + arg1 + 36)]).mem[_19 + 100 len 4] with:
             gas gas_remaining wei
            args mem[_19 + 104 len _23 - 4]
        if return_data.size:
            mem[64] = _19 + ceil32(return_data.size) + 101
            mem[_19 + 100] = return_data.size
            mem[_19 + 132 len return_data.size] = ext_call.return_data[0 len return_data.size]
        if not ext_call.success:
...
function sub_12807c4b(?) {
    ...
    if uint255(('cd', 4).length):
        mem[128 len 64 * ('cd', 4).length] = code.data[11847 len 64 * ('cd', 4).length]
    idx = 0
...
function sub_2e4e5281(?) {
    ...
    if not uint255(('cd', 4).length):
        ...
        mem[128 len 64 * ('cd', 4).length] = code.data[11847 len 64 * ('cd', 4).length]
        mem[(64 * ('cd', 4).length) + 128] = 2 * ('cd', 4).length
        mem[(64 * ('cd', 4).length) + 160 len 64 * ('cd', 4).length] = code.data[11847 len 64 * ('cd', 4).length]
    ...
    idx = 0
    while idx < ('cd', 4).length:
        mem[(128 * ('cd', 4).length) + 196] = address(cd[((32 * idx) + cd[4] + 36)])
        mem[(128 * ('cd', 4).length) + 228] = cd[68]
        mem[(128 * ('cd', 4).length) + 260] = 1
        require ext_code.size(address(ext_call.return_data[0]))
        staticcall address(ext_call.return_data[0]).searchBestRate(address arg1, address arg2, uint256 arg3, bool arg4) with:
                gas gas_remaining wei
        ...
        if ext_call.return_data[32] * cd[68] / 10^(-ext_call.return_data[0] + 36):
            require idx < ('cd', 36).length
            mem[(128 * ('cd', 4).length) + 164] = ext_call.return_data[32] * cd[68] / 10^(-ext_call.return_data[0] + 36)
            require ext_code.size(address(cd[((32 * idx) + cd[36] + 36)]))
            staticcall address(cd[((32 * idx) + cd[36] + 36)]).getTokenToEthInputPrice(uint256 arg1) with:
                    gas gas_remaining wei
        ...
        idx = idx + 1
        continue 
    mem[(128 * ('cd', 4).length) + 160] = 64
    mem[(128 * ('cd', 4).length) + 224] = 2 * ('cd', 4).length
    mem[(128 * ('cd', 4).length) + 256 len 2 * Mask(251, 4, ('cd', 4).length)] = mem[128 len 2 * Mask(251, 4, ('cd', 4).length)]
    mem[(128 * ('cd', 4).length) + 192] = (64 * ('cd', 4).length) + 96
    mem[(194 * ('cd', 4).length) + 256] = mem[(64 * ('cd', 4).length) + 128]
    mem[(194 * ('cd', 4).length) + 288 len floor32(mem[(64 * ('cd', 4).length) + 128])] = mem[(64 * ('cd', 4).length) + 160 len floor32(mem[(64 * ('cd', 4).length) + 128])]
    return memory
      from (128 * ('cd', 4).length) + 160
       len (32 * mem[(64 * ('cd', 4).length) + 128]) + (64 * ('cd', 4).length) + 128
}
