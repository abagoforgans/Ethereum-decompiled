...
function getPubKeyByHash(string arg1) {
    ...
    if not mem[ceil32(arg1.length) + 160]:
        if not mem[ceil32(arg1.length) + 160] % 32:
            return 64, stor[_33], mem[mem[64] + 64 len mem[ceil32(arg1.length) + 160] + 32]
        ...
        mem[mem[64] + 128 len floor32(_65 - 1)] = mem[ceil32(arg1.length) + 224 len floor32(_65 - 1)]
        if not _65 % 32:
            return 64, stor[_33], mem[mem[64] + 64 len _65 + 32]
        mem[floor32(_65) + mem[64] + 96] = mem[floor32(_65) + mem[64] + -(_65 % 32) + 128 len _65 % 32]
    return 64, stor[_33], mem[mem[64] + 64 len floor32(_65) + 64]
}
