...
function _fallback() {
    mem[96 len -9375] = code.data[10085 len -9375]
    mem[64] = -9279
    if mem[mem[96] + 96] >= 50:
...
function getTransactionDescription(uint256 arg1) {
    return transactionDescription[arg1][4][0 len transactionDescription[arg1][4].length].field_0
}
...
function addOwner(address arg1, string arg2) {
    require msg.sender == this.address
...
function transactions(uint256 arg1) {
    ...
    while transactionDescription[arg1][2].length + 288 > idx + 32:
        ...
        s = s + 1
        continue 
    mem[transactionDescription[arg1][2].length + (floor32(transactionDescription[arg1][2].length - 1) + -transactionDescription[arg1][2].length + 32 % 32) + 288] = transactionDescription[arg1][4].length
    mem[transactionDescription[arg1][2].length + (floor32(transactionDescription[arg1][2].length - 1) + -transactionDescription[arg1][2].length + 32 % 32) + 320] = transactionDescription[arg1][4].field_0
    idx = transactionDescription[arg1][2].length + (floor32(transactionDescription[arg1][2].length - 1) + -transactionDescription[arg1][2].length + 32 % 32) + 320
    s = 0
    while transactionDescription[arg1][2].length + (floor32(transactionDescription[arg1][2].length - 1) + -transactionDescription[arg1][2].length + 32 % 32) + transactionDescription[arg1][4].length + 320 > idx + 32:
        mem[idx + 32] = transactionDescription[arg1][s + 4].field_256
        idx = idx + 32
        s = s + 1
        continue 
    return address(transactionDescription[arg1].field_0), 
           transactionDescription[arg1].field_256,
           Array(len=transactionDescription[arg1][2].length, data=mem[288 len transactionDescription[arg1][2].length + (floor32(transactionDescription[arg1][2].length - 1) + -transactionDescription[arg1][2].length + 32 % 32) + transactionDescription[arg1][4].length + (floor32(transactionDescription[arg1][4].length - 1) + -transactionDescription[arg1][4].length + 32 % 32) + 32]),
           bool(uint8(transactionDescription[arg1].field_768)),
           transactionDescription[arg1][2].length + (floor32(transactionDescription[arg1][2].length - 1) + -transactionDescription[arg1][2].length + 32 % 32) + 192
}

function sub_46e24b08(?) {
    require arg1
    ...
    transactionDescription[stor5][4][].field_0 = Array(len=arg4.length, data=arg4[all])
    transactionCount++
    ...
    while idx < owners.length:
        ...
        mem[ceil32(arg3.length) + ceil32(arg4.length) + 320] = transactionDescription[stor5][2].field_0
        idx = ceil32(arg3.length) + ceil32(arg4.length) + 320
        s = sha3(sha3(transactionCount, 0) + 2)
        while ceil32(arg3.length) + ceil32(arg4.length) + transactionDescription[stor5][2].length + 320 > idx + 32:
            mem[idx + 32] = uint256(stor1[s])
            idx = idx + 32
            s = s + 1
            continue 
        call address(transactionDescription[stor5].field_0).mem[ceil32(arg3.length) + ceil32(arg4.length) + 320 len 4] with:
           value transactionDescription[stor5].field_256 wei
             gas gas_remaining - 34710 wei
            args mem[ceil32(arg3.length) + ceil32(arg4.length) + 324 len transactionDescription[stor5][2].length + (floor32(transactionDescription[stor5][2].length - 1) + -transactionDescription[stor5][2].length + 32 % 32) - 4]
        if ext_call.success:
