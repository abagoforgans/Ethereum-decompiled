...
function _fallback() payable {
    mem[96 len -1660] = code.data[2116 len -1660]
    mem[64] = -1564
    if mem[96] != 0:
        if mem[204 len 20] != 0:
            stor2 = mem[192]
            stor6[mem[204 len 20]] = mem[96]
        else:
        ...
        if mem[204 len 20] != 0:
            stor2 = mem[192]
            stor6[mem[204 len 20]] = 3
        else:
            stor2 = msg.sender or Mask(96, 160, stor2)
            stor6[address(msg.sender)] = 3
...
function sub_4d46b656(?) payable {
    ...
    while idx < stor4.length:
        ...
        if s <= 0:
            ...
            s = s
            continue 
        if stor8A35[idx] / stor8A35[idx] >= 2:
            s = (3 * idx) - 0x75ca53043ea007e5c65182cbb028f60d7179ff4b55739a3949b401801c942e65
            idx = idx + 1
            s = s
            continue 
