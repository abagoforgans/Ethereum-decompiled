...
const _fallback = code.data[18 len 3536]
...
function _fallback() payable {
    ...
    uint8(stor1.field_0) = uint8(mem[192 len 1] + (Mask(8, 248, mem[191]) >> 244))
    uint8(stor1.field_8) = 0
    idx = 0
    while idx < 32:
        stor18.field_0 % 16 = 0
        Mask(252, 0, stor18.field_4) = Mask(252, 0, stor18.field_0)
        require idx + 33 < calldata.size
        uint256(stor18.field_0) += mem[idx + 193 len 1]
        stor19.field_0 % 16 = 0
        Mask(252, 0, stor19.field_4) = Mask(252, 0, stor19.field_0)
        require idx + 65 < calldata.size
        uint256(stor19.field_0) += mem[idx + 225 len 1]
        idx = idx + 1
        continue 
    idx = 0
    while idx < 24:
        stor20.field_0 % 16 = 0
        Mask(252, 0, stor20.field_4) = Mask(192, 0, stor20.field_0)
        require idx + 97 < calldata.size
        uint256(stor18.field_0) += mem[idx + 257 len 1]
        stor21.field_0 % 16 = 0
        Mask(252, 0, stor21.field_4) = Mask(192, 0, stor21.field_0)
        require idx + 121 < calldata.size
        uint256(stor19.field_0) += mem[idx + 281 len 1]
        idx = idx + 1
        continue 
    ...
    idx = 0
    while idx < uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]):
        require idx + 147 < calldata.size
        require idx < stor0.length
        mem[0] = 0
        stor0[0.03125 / idx] = mem[idx + 307 len 1] * 256^(idx % 32) or !(255 * 256^(idx % 32)) and stor0[0.03125 / idx]
        idx = idx + 1
        continue 
    require (uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + 1 < calldata.size
    require uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216 < calldata.size
    uint8(stor21.field_192) = uint8((Mask(8, 248, mem[(uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + 160]) >> 244) + mem[(uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + 161 len 1])
    uint8(stor21.field_200) = 0
    ...
    uint8(stor21.field_208) = uint8(mem[(uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + 163 len 1] + (Mask(8, 248, mem[(uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + 162]) >> 244))
    uint8(stor21.field_216) = 0
    s = 0
    idx = 0
    while idx < 8:
    ...
    idx = 0
    while idx < 0:
        require (uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + idx + 12 < calldata.size
        require idx < stor22
        mem[0] = 22
        storD833[0.03125 / idx] = mem[(uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + idx + 172 len 1] * 256^(idx % 32) or !(255 * 256^(idx % 32)) and storD833[0.03125 / idx]
        idx = idx + 1
        continue 
    ...
    idx = 0
    while idx < 512:
        require (uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + uint16(stor23.field_0) + idx + 15 < calldata.size
        require idx < 512
        stor42[0.03125 / idx] = mem[(uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + uint16(stor23.field_0) + idx + 175 len 1] * 256^(idx % 32) or !(255 * 256^(idx % 32)) and stor42[0.03125 / idx]
        idx = idx + 1
        continue 
    idx = 0
    while idx < 32:
        require (uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + uint16(stor23.field_0) + idx + 527 < calldata.size
        require idx < 32
        stor25[0.03125 / idx] = mem[(uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + uint16(stor23.field_0) + idx + 687 len 1] * 256^(idx % 32) or !(255 * 256^(idx % 32)) and stor25[0.03125 / idx]
        idx = idx + 1
        continue 
    idx = 0
    while idx < 512:
        require (uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + uint16(stor23.field_0) + idx + 559 < calldata.size
        require idx < 512
        stor26[0.03125 / idx] = mem[(uint16((Mask(8, 248, mem[305]) >> 240) + (Mask(4, 248, mem[306]) >> 244) + mem[307 len 1]) + 147 % 16777216) + uint16(stor23.field_0) + idx + 719 len 1] * 256^(idx % 32) or !(255 * 256^(idx % 32)) and stor26[0.03125 / idx]
        require stor26[0.03125 / idx] / 256^(idx % 32) << 248 == stor2[0.03125 / idx] / 256^(idx % 32) << 248
        idx = idx + 1
        continue 
}
