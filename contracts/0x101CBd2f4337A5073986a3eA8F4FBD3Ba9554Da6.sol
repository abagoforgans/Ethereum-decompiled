...
function _fallback() payable {
    ...
    mem[160 len -6295] = code.data[6992 len -6295]
    stor0 = msg.sender
    stor6[address(msg.sender)] = mem[160]
    stor5 = 125 * 10^11 * 3600
    bool(stor2.length) = 0
    stor2.length.field_1 = 8
    stor2.length.field_8 = 'Parollax' / 256
    idx = 0
