...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'Crypto GBP' / 256
    idx = 0
    ...
    require stor6 + 20120511000 > stor6
    stor6 += 20120511000
    stor7[address(msg.sender)] += 20120511000
    emit Transfer(20120511000, 0, msg.sender);
