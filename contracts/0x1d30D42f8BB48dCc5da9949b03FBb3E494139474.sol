...
function _fallback() {
    stor0 = msg.sender
    stor2 = code.data[5249 len 20]
    return code.data[188 len 5049]
}
...
function sub_3f630dcb(?) {
    ...
    if eth.balance(this.address) <= 0:
        ...
        call stor2.0x481dc719 with:
             gas gas_remaining - 710 wei
            args (eth.balance(this.address) / 8 * 10^15)
        require ext_call.success
