...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0xcda82e76457635faa151babd2d4ca3ee54db203f)
    delegate 0xcda82e76457635faa151babd2d4ca3ee54db203f.0x66098d4f with:
         gas gas_remaining - 50 wei
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0xcda82e76457635faa151babd2d4ca3ee54db203f):
                            delegate 0xcda82e76457635faa151babd2d4ca3ee54db203f.0x66098d4f with:
                                 gas gas_remaining - 50 wei
