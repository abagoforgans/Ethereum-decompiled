...
function buy(address arg1) payable {
    ...
    require balances[address(arg1)] + (msg.value / stor5) >= balances[address(arg1)]
    balances[address(arg1)] += msg.value / stor5
    if arg1 != msg.sender:
        spread += msg.value / stor5
        points[address(msg.sender)] += msg.value / stor5
}
