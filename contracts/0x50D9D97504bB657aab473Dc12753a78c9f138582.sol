...
function _fallback() {
    ...
    require code.data[7564 len 32] > block.timestamp
    require code.data[7640 len 20]
    require code.data[7564 len 32] < block.timestamp + (2160 * 24 * 3600)
    create contract with 0 wei
                    code: code.data[4013 len 1629], code.data[7660 len 32]
    ...
    create contract with 0 wei
                    code: code.data[5642 len 1922], block.timestamp + (2160 * 24 * 3600), address(code.data[7628 len 32])
    require create.new_address
    ...
    call address(create.new_address).giveAccess(address rg1) with:
        ...
        args msg.sender
    require ext_call.success
    stor6 = uint32(code.data[7564 len 32])
    stor3 = address(code.data[7596 len 32])
    return code.data[645 len 3368]
}
