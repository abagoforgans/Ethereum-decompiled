...
function initElevations(uint8 arg1, uint8[33] arg2) payable {
    ...
    if not locked:
        idx = 0
        while idx < 33:
            require idx + uint8(33 * arg1) < 1089
            uint256(elevation[0.03125 / idx + uint8(33 * arg1)]) = mem[(32 * idx) + 96] * 256^(idx + uint8(33 * arg1) % 32) or uint256(elevation[0.03125 / idx + uint8(33 * arg1)]) and !(255 * 256^(idx + uint8(33 * arg1) % 32))
            idx = idx + 1
            continue 
}
