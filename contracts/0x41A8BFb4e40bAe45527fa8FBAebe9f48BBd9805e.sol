...
const _fallback = code.data[31 len 4233]
...
function transferToICAPWithReference(string arg1, uint256 arg2, string arg3) {
    ...
    mem[ceil32(arg1.length) + ceil32(arg3.length) + 160] = 0x9b487f3f00000000000000000000000000000000000000000000000000000000
    if this.address == msg.sender:
        mem[ceil32(arg1.length) + ceil32(arg3.length) + 164] = stor1
        mem[ceil32(arg1.length) + ceil32(arg3.length) + 196] = mem[128]
        mem[ceil32(arg1.length) + ceil32(arg3.length) + 228] = arg2
        mem[ceil32(arg1.length) + ceil32(arg3.length) + 292] = stor1
        mem[ceil32(arg1.length) + ceil32(arg3.length) + 260] = 160
        mem[ceil32(arg1.length) + ceil32(arg3.length) + 324] = arg3.length
        if 0 < arg3.length:
            mem[ceil32(arg1.length) + ceil32(arg3.length) + 356] = mem[ceil32(arg1.length) + 160]
            mem[ceil32(arg1.length) + ceil32(arg3.length) + 388 len floor32(arg3.length - 1)] = mem[ceil32(arg1.length) + 192 len floor32(arg3.length - 1)]
        require ext_code.size(proxyAddress)
        call proxyAddress._forwardTransferFromToICAPWithReference(address rg1, bytes32 rg2, uint256 rg3, string rg4, address rg5) with:
             gas gas_remaining - 710 wei
            args stor1, mem[128], arg2, Array(len=arg3.length, data=mem[ceil32(arg1.length) + ceil32(arg3.length) + 356 len arg3.length]), stor1
    else:
        mem[ceil32(arg1.length) + ceil32(arg3.length) + 164] = msg.sender
        mem[ceil32(arg1.length) + ceil32(arg3.length) + 196] = mem[128]
        mem[ceil32(arg1.length) + ceil32(arg3.length) + 228] = arg2
        ...
        call proxyAddress._forwardTransferFromToICAPWithReference(address rg1, bytes32 rg2, uint256 rg3, string rg4, address rg5) with:
             gas gas_remaining - 710 wei
            args msg.sender, mem[128], arg2, Array(len=arg3.length, data=mem[ceil32(arg1.length) + ceil32(arg3.length) + 356 len arg3.length]), msg.sender
    require ext_call.success
    return bool(ext_call.return_data[0])
}
