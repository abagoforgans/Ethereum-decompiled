...
function sub_8060830a(?) payable {
    ...
    if 352 < (32 * stor2.length - 1) + 352:
        ...
        while idx < stor2.length - 1:
            ...
            idx = idx + 1
            continue 
        _msize = max((32 * stor2.length - 1) + (32 * idx), (64 * stor2.length - 1) + 32)
        mem[_msize + 416] = 0
        ...
        mem[(32 * stor2.length - 1) + (_msize + 416) + 160] = mem[(32 * stor2.length - 1) + 352]
        _445 = mem[(32 * stor2.length - 1) + 352]
        mem[(32 * stor2.length - 1) + (_msize + 416) + 192 len 32 * mem[(32 * stor2.length - 1) + 352]] = mem[(32 * stor2.length - 1) + 384 len 32 * mem[(32 * stor2.length - 1) + 352]]
        mem[(_msize + 416) + 96] = (32 * mem[(32 * stor2.length - 1) + 352]) + (32 * stor2.length - 1) + 160
        mem[(32 * _445) + (32 * stor2.length - 1) + (_msize + 416) + 192] = 0, None
        mem[(32 * _445) + (32 * stor2.length - 1) + (_msize + 416) + 224 len 32 * 0, None] = mem[(_msize + 416) + 32 len 32 * 0, None]
        return memory
          from (_msize + 416) + 32
           len (32 * 0, None) + (32 * _445) + (32 * stor2.length - 1) + 192
    ...
    if 384 < (32 * stor2.length - 1) + 384:
        ...
        return Array(len=stor2.length - 1, data=mem[(32 * stor2.length - 1) + (32 * -stor2.length + -stor5.length + (stor2.length * stor5.length) + 1) + 576 len (32 * mem[(32 * stor2.length - 1) + (32 * -stor2.length + -stor5.length + (stor2.length * stor5.length) + 1) + 416]) + (32 * mem[352]) + (32 * stor2.length - 1) + 64]), 
               (32 * stor2.length - 1) + 128,
               (32 * mem[352]) + (32 * stor2.length - 1) + 160
    ...
    if msize < (32 * -stor2.length + -stor5.length + (stor2.length * stor5.length) + 1) + 416:
        ...
        return Array(len=stor2.length - 1, data=mem[(32 * -stor2.length + -stor5.length + (stor2.length * stor5.length) + 1) + 576 len 32 * stor2.length - 1], mem[352], mem[(32 * stor2.length - 1) + (32 * -stor2.length + -stor5.length + (stor2.length * stor5.length) + 1) + 608 len (32 * mem[(32 * -stor2.length + -stor5.length + (stor2.length * stor5.length) + 1) + 416]) + (32 * mem[352]) + 32]), 
               (32 * stor2.length - 1) + 128,
               (32 * mem[352]) + (32 * stor2.length - 1) + 160
    ...
    mem[(32 * _469) + (32 * stor2.length - 1) + (_msize + 416) + 192] = 0, None
    mem[(32 * _469) + (32 * stor2.length - 1) + (_msize + 416) + 224 len 0] = None
    return 96, 
           (32 * stor2.length - 1) + 128,
           (32 * mem[352]) + (32 * stor2.length - 1) + 160,
           stor2.length - 1,
           mem[_msize + 576 len (32 * _469) + (32 * stor2.length - 1) + 32],
           0,
           None
}
...
function multiAccessChangeRequirement(uint256 arg1) payable {
    if uint256(stor4[address(msg.sender)].field_0) <= 0:
        ...
        if stor1[call.data[0 len calldata.size]] != 0:
            require stor1[call.data[0 len calldata.size]] < stor2.length
            if uint256(stor4[address(msg.sender)].field_0) < uint256(stor[code.data[4753 len 32] + (3 * stor1[call.data[0 len calldata.size]])]):
                if not stor(floor32(stor[('map', ('mask_shl', 160, 0, 96, 'msg.sender'), ('name', 'stor4', 4))]) + sha3(code.data[4753 len 32] + (3 * stor[('map', ('data', ('call.data', 0, 'calldatasize')), ('name', 'stor1', 1))])))[stor4[address(msg.sender)].field_0 % 32]:
                    if stor1[call.data[0 len calldata.size]]:
                        require stor1[call.data[0 len calldata.size]] < stor2.length
                        if stor4057[stor1[call.data[0 len calldata.size]]] > 1:
                            emit Confirmation(0, msg.sender, sha3(call.data[0 len calldata.size]));
