...
function _fallback() payable {
    ...
    stor15 = code.data[4431 len 20]
    stor14 = code.data[4431 len 20]
    stor1[code.data[4335 len 20]] = 1
    stor0[address(code.data[4355 len 32])] = 1
    ...
    stor13 = code.data[4399 len 20]
    return code.data[394 len 3929]
}
...
function sub_92eb8b72(?) {
    require burnerAddress == msg.sender
