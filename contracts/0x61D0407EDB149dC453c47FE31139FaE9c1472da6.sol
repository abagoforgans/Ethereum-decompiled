...
function _fallback() payable {
    mem[128] = 'DSCS.GODZ.TOKEN'
    bool(stor0.length) = 0
    stor0.length.field_1 = 15
    stor0.length.field_8 = 'DSCS.GODZ.TOKEN' / 256
    idx = 0
    ...
    mem[160 len -3036] = code.data[3446 len -3036]
...
function transferFromOrigin(address arg1, uint256 arg2) {
    require tx.origin
    require arg1
    require balanceOf[tx.origin] >= arg2
