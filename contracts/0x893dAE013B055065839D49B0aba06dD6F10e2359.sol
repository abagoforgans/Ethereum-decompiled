...
function _fallback() payable {
    ...
    stor0 = code.data[1416 len 20]
    stor1 = code.data[1436 len 32]
    stor2 = code.data[1480 len 20]
    stor3 = code.data[1512 len 20]
    stor4 = code.data[1544 len 20]
    stor5 = code.data[1564 len 32]
    return code.data[190 len 1214]
}
...
function _fallback() payable {
    ...
    if not ext_call.success:
        emit 0x603bb827: msg.sender, tx.origin, msg.value
        revert
