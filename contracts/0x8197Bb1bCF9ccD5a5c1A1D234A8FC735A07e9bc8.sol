...
function sub_5fc27f96(?) {
    ...
    if arg1.length:
        mem[ceil32(arg1.length) + 160 len 32 * arg1.length] = code.data[1061 len 32 * arg1.length]
    idx = 0
    while idx < arg1.length:
        require idx < arg1.length
        require arg1.length + -idx - 1 < mem[ceil32(arg1.length) + 128]
        mem[ceil32(arg1.length) + arg1.length + -idx + 159 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 1, ('mem', ('range', ('add', 128, ('var', 0)), 1)), ('mul', -1, ('cd', ('add', 4, ('param', 'arg1')))), ('var', 0), ('mul', -1, 'gasprice'))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 1, ('mem', ('range', ('add', 128, ('var', 0)), 1)), ('mul', -1, ('cd', ('add', 4, ('param', 'arg1')))), ('var', 0), ('mul', -1, 'gasprice'))), 0) - 256
        idx = idx + 1
        continue 
    ...
    return Array(len=mem[ceil32(arg1.length) + 128], data=mem[(2 * ceil32(arg1.length)) + 224 len floor32(mem[ceil32(arg1.length) + 128]) + 32]), 
}
...
function sub_79f94f2b(?) payable {
    ...
    if arg3.length:
        mem[ceil32(arg3.length) + 160 len 32 * arg3.length] = code.data[1061 len 32 * arg3.length]
    idx = 0
    while idx < arg3.length:
        require idx < arg3.length
        require arg3.length + -idx - 1 < mem[ceil32(arg3.length) + 128]
        mem[ceil32(arg3.length) + arg3.length + -idx + 159 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 1, ('mem', ('range', ('add', 128, ('var', 0)), 1)), ('mul', -1, ('cd', ('add', 4, ('param', 'arg3')))), ('var', 0), ('mul', -1, 'gasprice'))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 1, ('mem', ('range', ('add', 128, ('var', 0)), 1)), ('mul', -1, ('cd', ('add', 4, ('param', 'arg3')))), ('var', 0), ('mul', -1, 'gasprice'))), 0) - 256
        idx = idx + 1
        continue 
