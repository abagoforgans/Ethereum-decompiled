...
function mint(string arg1) {
    ...
    stor13++
    require owner
    require not ownerOf[stor13 - 1]
    ownerOf[stor13 - 1] = owner
    require balanceOf[stor12] + 1 >= balanceOf[stor12]
    balanceOf[stor12]++
    emit Transfer(0, owner, stor13 - 1);
    stor6[stor13 - 1] = tokenOfOwnerByIndex[stor12]
    tokenOfOwnerByIndex[stor12]++
    tokenOfOwnerByIndex[stor12][tokenOfOwnerByIndex[stor12]] = stor13 - 1
    stor8[stor13 - 1] = tokenByIndex.length
    tokenByIndex.length++
    tokenByIndex[tokenByIndex.length] = stor13 - 1
    require ownerOf[stor13 - 1]
    tokenURI[stor13 - 1][] = Array(len=arg1.length, data=arg1[all])
}
