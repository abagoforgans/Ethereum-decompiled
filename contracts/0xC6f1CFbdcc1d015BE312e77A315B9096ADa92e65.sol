...
function _fallback() payable {
    ...
    stor6.length.field_8 = '0.0.2' / 256
    idx = 0
    ...
    stor0[address(msg.sender)] = 42 * 10^6
    stor2 = 42 * 10^6
    bool(stor3.length) = 0
    stor3.length.field_1 = 8
    stor3.length.field_8 = 'TopiCoin' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'TOP' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[557 len 4004]
}
