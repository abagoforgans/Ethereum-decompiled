...
function sub_17b673ef(?) {
    return sub_17b673efAddress
}
...
function sub_99b38974(?) {
    require msg.sender == sub_17b673efAddress
    require arg1
    require sub_17b673efAddress != arg1
    sub_17b673efAddress = arg1
    return 1
}
