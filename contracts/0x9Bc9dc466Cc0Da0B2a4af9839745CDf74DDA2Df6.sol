...
function sub_6e6b32f2(?) {
    return sub_6e6b32f2Address
}
...
function sub_99b38974(?) {
    require msg.sender == sub_6e6b32f2Address
    require arg1
    require sub_6e6b32f2Address != arg1
    sub_6e6b32f2Address = arg1
    return 1
}
