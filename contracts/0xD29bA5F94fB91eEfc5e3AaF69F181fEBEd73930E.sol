...
const name = 'IMMLA Presale Token'
...
const TOKEN_SUPPLY_LIMIT = 14284400 * 10^18
...
function buyTokens(address arg1) payable {
    ...
    require msg.value
    require totalSupply + (5200 * msg.value) <= 14284400 * 10^18
    balanceOf[address(arg1)] += 5200 * msg.value
    totalSupply += 5200 * msg.value
    emit LogBuy((5200 * msg.value), arg1);
}
...
function _fallback() payable {
    ...
    totalSupply += 5200 * msg.value
    emit LogBuy((5200 * msg.value), msg.sender);
}
