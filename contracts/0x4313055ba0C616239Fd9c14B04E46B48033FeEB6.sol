...
address sub_801420abAddress; offset 16
...
function sub_801420ab(?) {
    return sub_801420abAddress
}
...
function sub_420c17eb(?) {
    require msg.sender == owner
    sub_801420abAddress = arg1
}
...
function whitelist_addys(address[] arg1) {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 7
        contributors[mem[(32 * idx) + 140 len 20]].field_520 = 1
        s = sha3(mem[(32 * idx) + 140 len 20], 7)
        idx = idx + 1
        continue 
}

function blacklist_addys(address[] arg1) {
    mem[128 len 32 * arg1.length] = call.data[arg1 + 36 len 32 * arg1.length]
    require msg.sender == owner
    s = 0
    idx = 0
    while idx < arg1.length:
        ...
        mem[0] = mem[(32 * idx) + 140 len 20]
        mem[32] = 7
        contributors[mem[(32 * idx) + 140 len 20]].field_520 = 0
        s = sha3(mem[(32 * idx) + 140 len 20], 7)
        idx = idx + 1
        continue 
}
...
function _fallback() payable {
    ...
    if uint8(stor6.field_8):
        if not contributors[address(msg.sender)].field_520:
            require ext_code.size(sub_801420abAddress)
            call sub_801420abAddress.0x779ee628 with:
                 gas gas_remaining wei
                args msg.sender
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
