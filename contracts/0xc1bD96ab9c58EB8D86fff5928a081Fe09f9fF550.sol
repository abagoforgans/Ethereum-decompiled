...
function _fallback() {
    stor0 = msg.sender
    stor2[address(this.address)] = 100000000000000 * 10^18
    stor1 = 100000000000000 * 10^18
    emit Transfer(100000000000000 * 10^18, 0, this.address);
    return code.data[161 len 4097]
}
...
const name = 'CollegePower orange'
