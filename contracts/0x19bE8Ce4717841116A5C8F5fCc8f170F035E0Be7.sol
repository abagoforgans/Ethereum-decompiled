...
function _fallback() payable {
    ...
    stor2.length.field_8 = 'CheapMineableEthereumToken' / 256
    idx = 0
    ...
    if msg.sender == owner:
        ...
        if block.number < deadline:
            ...
            if hash / stor11 >= (Mask(236, 20, 933233 * Mask(236, 0, balanceOf[address(msg.sender)]) / supply) >> 20) + 10485:
                ...
                uint256(balanceOf[address(msg.sender)]) += miningReward
                supply += miningReward
                emit Transfer(miningReward, 0, this.address);
