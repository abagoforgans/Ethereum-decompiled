...
function _fallback() payable {
    stor4 = code.data[3371 len 32]
    if code.data[3403 len 32]:
        stor0 = code.data[3403 len 32]
    else:
        stor0 = 1
    stor1 = code.data[3435 len 32]
    return code.data[96 len 3275]
}
...
function newProposal(address arg1, uint256 arg2, string arg3, bytes arg4) payable {
    ...
    if not proposals.length <= proposals.length + 1:
        idx = (9 * proposals.length) + 0x56405787fa12a823e0f2b7631cc41b3ba8828b3321ca811111fa75cd3aa3bb63
        while (9 * proposals.length) + 0x56405787fa12a823e0f2b7631cc41b3ba8828b3321ca811111fa75cd3aa3bb5a > idx:
