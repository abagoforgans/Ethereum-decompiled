...
function _fallback() payable {
    stor10 = 17440
    stor11 = 0xa9d585ce3b227d69985c3f7a866fe7d0e510da50
    stor12 = 0xf2de6c66544780715a84a80ea92c5ddd386318a
    require not msg.value
    mem[96 len -3059] = code.data[3479 len -3059]
    mem[64] = -2963
    if mem[96]:
...
function claim_bounty() {
    if not stor3:
        ...
        call tokenAddress.0xf48c3054 with:
...
function _fallback() payable {
    if msg.value > 10^15:
        ...
        if not stor3:
            ...
            require ext_call.success
        require ext_code.size(tokenAddress)
        call tokenAddress.0xec81b483 with:
