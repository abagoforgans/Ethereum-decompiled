...
function buyTicket(uint256 arg1, uint256 arg2) {
    ...
    emit 0xf62b0129: uint256(playersInGame[stor8]), block.timestamp, arg1, arg2, msg.sender, game
}

function pickTheWinner() payable {
    mem[64] = 96
    require not msg.value
    require msg.sender == owner
    require sub_f96afe87 > 0
    if uint256(stor17[stor8][stor12]) <= 0:
        emit Lose(sub_f96afe87, gameJackpot[stor8]);
    else:
        require uint256(stor17[stor8][stor12])
        require uint256(stor17[stor8][stor12])
        s = 0
        idx = 0
        while idx < uint256(stor17[stor8][stor12]):
            require idx < uint256(stor17[stor8][stor12])
            mem[0] = sha3(sub_f96afe87, sha3(game, 17))
            require ext_code.size(stor6)
            call stor6.0xa9059cbb with:
                 gas gas_remaining wei
                args address(stor17[stor8][stor12][idx]), gameJackpot[stor8] / uint256(stor17[stor8][stor12])
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            ...
            mem[32] = sha3(game, 17)
            require idx < uint256(stor17[stor8][stor12])
            mem[mem[64]] = address(stor17[stor8][stor12][idx])
            mem[mem[64] + 32] = sub_f96afe87
            mem[mem[64] + 64] = gameJackpot[stor8] / uint256(stor17[stor8][stor12])
            emit Winner(address(stor17[stor8][stor12][idx]), sub_f96afe87, gameJackpot[stor8] / uint256(stor17[stor8][stor12]));
            mem[0] = sub_f96afe87
            mem[32] = sha3(game, 17)
            s = address(stor17[stor8][stor12][idx])
            idx = idx + 1
            continue 
