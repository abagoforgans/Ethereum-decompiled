...
function partnerInfo_for_Partner(bytes32 arg1, uint8 arg2, bytes32 arg3, bytes32 arg4) {
    ...
    if msize < ceil32(stor2[address(signer)][1].length) + 416:
        ...
        mem[32] = 4
        idx = 0
        while idx < uint256(stor4[address(signer)].field_0):
            require idx < uint256(stor4[address(signer)].field_0)
            require idx < uint256(stor4[address(signer)].field_0)
            mem[ceil32(stor2[address(signer)][1].length) + (32 * idx) + 448] = uint256(stor4[address(signer)][idx].field_0)
            mem[32] = 4
            require idx < uint256(stor4[address(signer)].field_0)
            mem[0] = sha3(address(signer), 4)
            require idx < mem[_msize + 448]
            mem[(_msize + 448) + (32 * idx) + 32] = uint256(stor4[address(signer)][idx].field_512)
            mem[32] = 4
            require idx < uint256(stor4[address(signer)].field_0)
            mem[0] = sha3(address(signer), 4)
            require idx < mem[_msize + 32]
            mem[(_msize + 32) + (32 * idx) + 32] = stor4[address(signer)][idx].field_256
            mem[0] = address(signer)
            mem[32] = 4
            idx = idx + 1
            continue 
        ...
        mem[stor2[address(signer)][1].length + (_msize + 32) + (32 * uint256(stor4[address(signer)].field_0)) + 224] = uint256(stor4[address(signer)].field_0)
        mem[stor2[address(signer)][1].length + (_msize + 32) + (32 * uint256(stor4[address(signer)].field_0)) + 256 len floor32(uint256(stor4[address(signer)].field_0))] = mem[ceil32(stor2[address(signer)][1].length) + 448 len floor32(uint256(stor4[address(signer)].field_0))]
        mem[(_msize + 32) + (32 * uint256(stor4[address(signer)].field_0)) + 128] = (32 * uint256(stor4[address(signer)].field_0)) + stor2[address(signer)][1].length + 224
        mem[(64 * uint256(stor4[address(signer)].field_0)) + stor2[address(signer)][1].length + (_msize + 32) + 256] = mem[_msize + 448]
        mem[(64 * uint256(stor4[address(signer)].field_0)) + stor2[address(signer)][1].length + (_msize + 32) + 288 len floor32(mem[_msize + 448])] = mem[(_msize + 448) + 32 len floor32(mem[_msize + 448])]
        mem[(_msize + 32) + (32 * uint256(stor4[address(signer)].field_0)) + 160] = (32 * mem[_msize + 448]) + (32 * uint256(stor4[address(signer)].field_0)) + stor2[address(signer)][1].length + 256
        mem[(32 * mem[_msize + 448]) + (64 * uint256(stor4[address(signer)].field_0)) + stor2[address(signer)][1].length + (_msize + 32) + 288] = mem[_msize + 32]
        mem[(32 * mem[_msize + 448]) + (64 * uint256(stor4[address(signer)].field_0)) + stor2[address(signer)][1].length + (_msize + 32) + 320 len floor32(mem[_msize + 32])] = mem[(_msize + 32) + 32 len floor32(mem[_msize + 32])]
        return Array(len=stor2[address(signer)][1].length, data=mem[416 len ceil32(stor2[address(signer)][1].length)], uint256(stor4[address(signer)].field_0), mem[ceil32(stor2[address(signer)][1].length) + 448 len floor32(uint256(stor4[address(signer)].field_0))], mem[(_msize + 32) + (32 * uint256(stor4[address(signer)].field_0)) + stor2[address(signer)][1].length + floor32(uint256(stor4[address(signer)].field_0)) + 256 len (32 * uint256(stor4[address(signer)].field_0)) - floor32(uint256(stor4[address(signer)].field_0))], mem[_msize + 448], mem[(_msize + 32) + (64 * uint256(stor4[address(signer)].field_0)) + stor2[address(signer)][1].length + 288 len (32 * mem[_msize + 32]) + (32 * mem[_msize + 448]) + 32]), 
               uint256(stor2[address(signer)].field_0),
               stor2[address(signer)][1].length + 192,
               (32 * uint256(stor4[address(signer)].field_0)) + stor2[address(signer)][1].length + 224,
               (32 * mem[_msize + 448]) + (32 * uint256(stor4[address(signer)].field_0)) + stor2[address(signer)][1].length + 256
    ...
    if 0 >= 32 * uint256(stor4[address(signer)].field_0):
        ...
        if msize < (max(0, floor32(stor2[address(signer)][1].length - 1)) + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 32:
            ...
            while idx < uint256(stor4[address(signer)].field_0):
                ...
                require idx < uint256(stor4[address(signer)].field_0)
                mem[0] = sha3(address(signer), 4)
                require idx < mem[_msize + 480]
                mem[(_msize + 480) + (32 * idx) + 32] = uint256(stor4[address(signer)][idx].field_0)
                mem[32] = 4
                require idx < uint256(stor4[address(signer)].field_0)
                mem[0] = sha3(address(signer), 4)
                require idx < mem[_msize + 480]
                mem[(_msize + 480) + (32 * idx) + 32] = uint256(stor4[address(signer)][idx].field_512)
                require idx < uint256(stor4[address(signer)].field_0)
                require idx < mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 32]
                mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + (32 * idx) + 64] = stor4[address(signer)][idx].field_256
                mem[0] = address(signer)
                mem[32] = 4
                idx = idx + 1
                continue 
        ...
        while idx < uint256(stor4[address(signer)].field_0):
            ...
            mem[0] = sha3(address(signer), 4)
            require idx < mem[_msize + 480]
            mem[(_msize + 480) + (32 * idx) + 32] = stor4[address(signer)][idx].field_256
            mem[0] = address(signer)
            mem[32] = 4
            idx = idx + 1
            continue 
    ...
    if 32 >= (64 * uint256(stor4[address(signer)].field_0)) + 64:
        ...
        while idx < uint256(stor4[address(signer)].field_0):
            ...
            require idx < uint256(stor4[address(signer)].field_0)
            require idx < mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 32]
            mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + (32 * idx) + 64] = uint256(stor4[address(signer)][idx].field_512)
            require idx < uint256(stor4[address(signer)].field_0)
            require idx < mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 64]
            mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + (32 * idx) + 96] = stor4[address(signer)][idx].field_256
            mem[0] = address(signer)
            mem[32] = 4
            idx = idx + 1
            continue 
    ...
    while idx < uint256(stor4[address(signer)].field_0):
        ...
        mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + (32 * idx) + 64] = uint256(stor4[address(signer)][idx].field_512)
        require idx < uint256(stor4[address(signer)].field_0)
        require idx < mem[(_msize + 480) + (64 * uint256(stor4[address(signer)].field_0)) + 64]
        mem[(_msize + 480) + (64 * uint256(stor4[address(signer)].field_0)) + (32 * idx) + 96] = stor4[address(signer)][idx].field_256
        mem[0] = address(signer)
        mem[32] = 4
        idx = idx + 1
        continue 
    _3147 = mem[64]
    mem[mem[64] + 32] = uint256(stor2[address(signer)].field_0)
    mem[mem[64]] = 160
    mem[mem[64] + 160] = mem[384]
    _3149 = mem[384]
    mem[mem[64] + 192 len ceil32(mem[384])] = mem[416 len ceil32(mem[384])]
    if not _3149 % 32:
        mem[mem[64] + 64] = _3149 + 192
        mem[_3149 + mem[64] + 192] = mem[_msize + 480]
        _3712 = mem[_msize + 480]
        mem[_3149 + mem[64] + 224 len floor32(mem[_msize + 480])] = mem[(_msize + 480) + 32 len floor32(mem[_msize + 480])]
        mem[mem[64] + 96] = (32 * _3712) + _3149 + 224
        mem[(32 * _3712) + _3149 + mem[64] + 224] = mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 32]
        _4228 = mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 32]
        mem[(32 * _3712) + _3149 + mem[64] + 256 len floor32(mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 32])] = mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 64 len floor32(mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 32])]
        mem[mem[64] + 128] = (32 * _4228) + (32 * _3712) + _3149 + 256
        mem[(32 * _4228) + (32 * _3712) + _3149 + mem[64] + 256] = mem[(_msize + 480) + (64 * uint256(stor4[address(signer)].field_0)) + 64]
        _4500 = mem[(_msize + 480) + (64 * uint256(stor4[address(signer)].field_0)) + 64]
        mem[(32 * _4228) + (32 * _3712) + _3149 + mem[64] + 288 len floor32(mem[(_msize + 480) + (64 * uint256(stor4[address(signer)].field_0)) + 64])] = mem[(_msize + 480) + (64 * uint256(stor4[address(signer)].field_0)) + 96 len floor32(mem[(_msize + 480) + (64 * uint256(stor4[address(signer)].field_0)) + 64])]
        return 160, 
               uint256(stor2[address(signer)].field_0),
               _3149 + 192,
               (32 * _3712) + _3149 + 224,
               (32 * _4228) + (32 * _3712) + _3149 + 256,
               mem[mem[64] + 160 len (32 * _4500) + (32 * _4228) + (32 * _3712) + _3149 + 128]
    mem[floor32(_3149) + mem[64] + 192] = mem[floor32(_3149) + mem[64] + -(_3149 % 32) + 224 len _3149 % 32]
    mem[mem[64] + 64] = floor32(_3149) + 224
    mem[floor32(_3149) + _3147 + 224] = mem[_msize + 480]
    _3844 = mem[_msize + 480]
    mem[floor32(_3149) + _3147 + 256 len floor32(mem[_msize + 480])] = mem[(_msize + 480) + 32 len floor32(mem[_msize + 480])]
    mem[_3147 + 96] = (32 * _3844) + floor32(_3149) + 256
    mem[(32 * _3844) + floor32(_3149) + _3147 + 256] = mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 32]
    _4231 = mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 32]
    mem[(32 * _3844) + floor32(_3149) + _3147 + 288 len floor32(mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 32])] = mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 64 len floor32(mem[(_msize + 480) + (32 * uint256(stor4[address(signer)].field_0)) + 32])]
    mem[_3147 + 128] = (32 * _4231) + (32 * _3844) + floor32(_3149) + 288
    mem[(32 * _4231) + (32 * _3844) + floor32(_3149) + _3147 + 288] = mem[(_msize + 480) + (64 * uint256(stor4[address(signer)].field_0)) + 64]
    _4503 = mem[(_msize + 480) + (64 * uint256(stor4[address(signer)].field_0)) + 64]
    mem[(32 * _4231) + (32 * _3844) + floor32(_3149) + _3147 + 320 len floor32(mem[(_msize + 480) + (64 * uint256(stor4[address(signer)].field_0)) + 64])] = mem[(_msize + 480) + (64 * uint256(stor4[address(signer)].field_0)) + 96 len floor32(mem[(_msize + 480) + (64 * uint256(stor4[address(signer)].field_0)) + 64])]
    return memory
      from mem[64]
       len (32 * _4503) + (32 * _4231) + (32 * _3844) + floor32(_3149) + _3147 + -mem[64] + 320
}
