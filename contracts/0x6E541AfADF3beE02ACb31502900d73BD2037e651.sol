...
function sub_1bb95617(?) payable {
    require arg1 < 10
    return (stor40[0.03125 / arg1].field_0 / 256^(arg1 % 32) << 248)
}
...
function sub_0c1766c9(?) payable {
    ...
    while idx < 8:
        require -idx + 9 < 10
        if s % 16 >= 10:
            stor40[0.03125 / -idx + 9].field_0 = uint8((s % 16) + 87) * 256^(-idx + 9 % 32) or !(255 * 256^(-idx + 9 % 32)) and stor40[0.03125 / -idx + 9].field_0
        else:
            stor40[0.03125 / -idx + 9].field_0 = uint8((s % 16) + 48) * 256^(-idx + 9 % 32) or !(255 * 256^(-idx + 9 % 32)) and stor40[0.03125 / -idx + 9].field_0
        s = s % 16
        idx = idx + 1
        s = s / 16
        continue 
...
function addressHash(address arg1) payable {
    ...
    while idx < 8:
        require -idx + 9 < 10
        if u % 16 >= 10:
            stor40[0.03125 / -idx + 9].field_0 = uint8((u % 16) + 87) * 256^(-idx + 9 % 32) or !(255 * 256^(-idx + 9 % 32)) and stor40[0.03125 / -idx + 9].field_0
        else:
            stor40[0.03125 / -idx + 9].field_0 = uint8((u % 16) + 48) * 256^(-idx + 9 % 32) or !(255 * 256^(-idx + 9 % 32)) and stor40[0.03125 / -idx + 9].field_0
        u = u % 16
        idx = idx + 1
        u = u / 16
        continue 
