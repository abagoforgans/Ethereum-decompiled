...
uint32 issuedSupplyRatio; offset 224
...
function issuedSupplyRatio() {
    return issuedSupplyRatio
}
...
function setissuedSupplyRatio(uint256 arg1) {
    if not stor1[address(msg.sender)]:
        require creatorAddress == msg.sender
    require arg1 > 0
    issuedSupplyRatio = uint32(arg1)
}
...
function getSalePrice(uint256 arg1) {
    ...
    call formulaContractAddress.calculateSaleReturn(uint256 arg1, uint256 arg2, uint32 arg3, uint256 arg4) with:
         gas gas_remaining wei
        args 0, uint32((ext_call.return_data[0] / issuedSupplyRatio) - ext_call.return_data[0]), eth.balance(this.address) + virtualReserveBalance, stor3, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function buy(uint256 arg1) payable {
    ...
    call formulaContractAddress.calculatePurchaseReturn(uint256 arg1, uint256 arg2, uint32 arg3, uint256 arg4) with:
         gas gas_remaining wei
        args 0, uint32((ext_call.return_data[0] / issuedSupplyRatio) - ext_call.return_data[0]), eth.balance(this.address) + virtualReserveBalance - msg.value, stor3, msg.value
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require stor2
...
function receiveApproval(address arg1, uint256 arg2, address arg3, bytes arg4) {
    ...
    call formulaContractAddress.calculateSaleReturn(uint256 arg1, uint256 arg2, uint32 arg3, uint256 arg4) with:
         gas gas_remaining wei
        args 0, uint32((ext_call.return_data[0] / issuedSupplyRatio) - ext_call.return_data[0]), eth.balance(this.address) + virtualReserveBalance, stor3, arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require stor2
