...
function distributeTokens(address[] arg1, uint256[] arg2) {
    ...
    require msg.sender == owner
    if arg1.length > 100:
        revert with 0, 'Too large wallets array'
    if arg2.length > 100:
        revert with 0, 'Too large amounts array'
    ...
    while idx < arg1.length:
        ...
        mem[(32 * arg1.length) + (32 * arg2.length) + 228] = _36
        ...
        mem[(32 * arg1.length) + (32 * arg2.length) + 192] = _44
        emit 0x3e0b9848: mem[(32 * arg1.length) + (32 * arg2.length) + 160], _44
        idx = idx + 1
        continue 
    return 1
}
