        ...
        if s != randomNumber:
            if kingBlock - warriorBlock <= 2000:
                call kingAddress with:
                   value rewardPercent * eth.balance(contractAddress) / 100 wei
                     gas 0 wei
            else:
                call kingAddress with:
                   value 90 * eth.balance(contractAddress) / 100 wei
                     gas 0 wei
        else:
            rewardPercent = 50
