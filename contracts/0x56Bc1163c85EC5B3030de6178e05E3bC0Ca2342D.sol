...
function _fallback() payable {
    mem[96 len -1784] = code.data[2795 len -1784]
    mem[64] = -1688
    mem[32] = 5
    ...
    while (stor2.length + 31 / 32) + 0x405787fa12a823e0f2b7631cc41b3ba8828b3321ca811111fa75cd3aa3bb5ace > idx:
        ...
        idx = idx + 1
        continue 
    require stor5[address(msg.sender)] >= mem[96]
    require stor5[mem[268 len 20]] + mem[96] >= stor5[mem[268 len 20]]
    require stor5[mem[300 len 20]] + mem[96] >= stor5[mem[300 len 20]]
    require mem[96] + stor5[mem[332 len 20]] >= stor5[mem[332 len 20]]
    stor5[address(msg.sender)] -= mem[96]
    stor5[mem[268 len 20]] += mem[96] / 3
    stor5[mem[300 len 20]] += mem[96] / 3
    stor5[mem[332 len 20]] += mem[96] / 3
    emit code.data[2763 len 32]: mem[96], msg.sender, mem[268 len 20]
    emit code.data[2763 len 32]: mem[96], msg.sender, mem[300 len 20]
    emit code.data[2763 len 32]: mem[96], msg.sender, mem[332 len 20]
    return code.data[1011 len 1752]
}
