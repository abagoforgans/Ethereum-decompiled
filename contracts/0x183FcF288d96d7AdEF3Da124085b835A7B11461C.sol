...
function _fallback() payable {
    mem[96 len -773] = code.data[1707 len -773]
    stor0 = 100
    mem[64] = -613
    mem[-677] = 3
    uint8(stor1.length) = 6
    Mask(248, 0, stor1.length.field_8) = 'abc' / 256
    ...
    while mem[192] + mem[mem[192] + 96] + 128 > idx:
        ...
        idx = idx + 32
        continue 
    idx = (Mask(251, 0, mem[mem[192] + 96] + 31) >> 5) - 0x75ca53043ea007e5c65182cbb028f60d7179ff4b55739a3949b401801c942e65
    while (stor4.length + 31 / 32) - 0x75ca53043ea007e5c65182cbb028f60d7179ff4b55739a3949b401801c942e65 > idx:
        stor[idx] = 0
        idx = idx + 1
        continue 
    mem[0] = 5
    stor5.length = (2 * mem[mem[224] + 96]) + 1
    ...
    while mem[224] + mem[mem[224] + 96] + 128 > idx:
        ...
        idx = idx + 32
        continue 
    idx = (Mask(251, 0, mem[mem[224] + 96] + 31) >> 5) + 0x36b6384b5eca791c62761152d0c79bb0604c104a5fb6f4eb0703f3154bb3db0
    while (stor5.length + 31 / 32) + 0x36b6384b5eca791c62761152d0c79bb0604c104a5fb6f4eb0703f3154bb3db0 > idx:
        stor[idx] = 0
        idx = idx + 1
        continue 
    stor6.length = (2 * mem[mem[160] + 96]) + 1
    ...
    while mem[160] + mem[mem[160] + 96] + 128 > idx:
        ...
        idx = idx + 32
        continue 
    idx = (Mask(251, 0, mem[mem[160] + 96] + 31) >> 5) - 0x9addddcec1d7ba6ad726df49aeea3e93fb0c1037d551236841a60c0c883f2c1
