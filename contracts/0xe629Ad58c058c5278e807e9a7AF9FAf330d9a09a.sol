...
function deposit() payable {
    ...
    stor12[address(msg.sender)] += msg.value * roi / 100
    stor13[address(msg.sender)] += msg.value * roi / 100
}
        ...
        if block.timestamp - stor11[address(arg1)] >= sub_d9607482:
            ...
            if eth.balance(this.address) > stor2:
                ...
                if uint8(stor0):
                    ...
                    stor13[address(msg.sender)] += stor10[address(msg.sender)] * roi / 100
                    stor12[address(msg.sender)] += stor10[address(msg.sender)] * roi / 100
}
