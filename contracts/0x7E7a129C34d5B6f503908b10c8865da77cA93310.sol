...
function _fallback() {
    stor0 = msg.sender
    stor0 = msg.sender
    require code.data[3174 len 32]
    require code.data[3206 len 32]
    require ext_code.size(code.data[3250 len 20])
    call code.data[3250 len 20].0x4551dd59 with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require ext_call.return_data[0]
    stor5 = code.data[3174 len 32]
    stor6 = code.data[3206 len 32]
    stor9 = code.data[3250 len 20]
    require code.data[3270 len 32]
    stor8 = code.data[3270 len 32]
    return code.data[338 len 2836]
}
...
function setWeiCap(uint256 arg1) {
    require owner == msg.sender
    require arg1
    weiCap = arg1
    require ext_code.size(crowdsaleAddress)
    call crowdsaleAddress.0xa709b6e4 with:
         gas gas_remaining - 710 wei
        args arg1
    require ext_call.success
}
