...
function sub_744f6755(?) {
    ...
    call sub_554fbbcdAddress.getIds(uint256 rg1) with:
         gas gas_remaining - 710 wei
        args arg1
    ...
    while idx < 32:
        ...
        require ext_code.size(sub_55ef20e6Address)
        call sub_55ef20e6Address.getContentHash(uint256 rg1) with:
             gas gas_remaining - 710 wei
...
function sub_55293334(?) {
    require ext_code.size(sub_55ef20e6Address)
    call sub_55ef20e6Address.proposalExists(uint256 rg1) with:
         gas gas_remaining - 710 wei
        args arg1
    require ext_call.success
    if not ext_call.return_data[0]:
...
function sub_3e67021b(?) {
    ...
    require ext_call.success
    require ext_code.size(contributorsAddress)
    call contributorsAddress.addProposal(address rg1, uint256 rg2) with:
         gas gas_remaining - 710 wei
...
function sub_8702038d(?) {
    ...
    while uint8(idx) < ext_call.return_data[0]:
        require ext_code.size(sub_55ef20e6Address)
        call sub_55ef20e6Address.getVoter(uint256 rg1, uint256 rg2) with:
             gas gas_remaining - 710 wei
            args arg1, uint8(idx)
        require ext_call.success
...
function sub_2f0f9607(?) {
    ...
    require ext_code.size(sub_554fbbcdAddress)
    if ext_call.return_data[0]:
        call sub_554fbbcdAddress.rejectProposal(uint256 rg1) with:
             gas gas_remaining - 710 wei
            args ext_call.return_data[0]
        require ext_call.success
    call sub_554fbbcdAddress.0xef4cd6ea with:
...
function sub_a54c4b29(?) {
    ...
    if ext_call.return_data[0]:
        ...
        if _237 * None / ext_call.return_data[0] <= acceptanceThreshold:
            call sub_55ef20e6Address.rejectProposal(uint256 rg1) with:
                 gas gas_remaining - 710 wei
                args arg1
            require ext_call.success
            require ext_code.size(sub_554fbbcdAddress)
            ...
            require ext_call.success
            require ext_code.size(sub_55ef20e6Address)
            call sub_55ef20e6Address.getParentId(uint256 rg1) with:
                 gas gas_remaining - 710 wei
                args arg1
            require ext_call.success
            require ext_code.size(sub_55ef20e6Address)
            ...
            require ext_call.success
            require ext_code.size(sub_55ef20e6Address)
            call sub_55ef20e6Address.acceptProposal(uint256 rg1) with:
                 gas gas_remaining - 710 wei
                args arg1
            require ext_call.success
            require ext_code.size(sub_554fbbcdAddress)
            call sub_554fbbcdAddress.acceptProposal(uint256 rg1) with:
                 gas gas_remaining - 710 wei
                args ext_call.return_data[0]
            require ext_call.success
            require ext_code.size(sub_55ef20e6Address)
