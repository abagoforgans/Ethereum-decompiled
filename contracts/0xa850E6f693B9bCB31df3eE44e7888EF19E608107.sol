...
function PlusOnePonzi() payable {
  stop
}

function payouts(uint256 arg1) payable {
    require arg1 < stor0.length
    return address(stor0[arg1].field_0), stor[code.data[709 len 32] + (2 * arg1)]
}
...
function _fallback() payable {
    ...
    if stor[code.data[709 len 32] + (2 * stor1)] >= eth.balance(this.address):
