...
function _fallback() payable {
    create contract with 0 wei
                    code: code.data[3780 len 3186]
    require create.new_address
    stor3 = address(create.new_address)
    stor5 = 277777777777777777775 * 10^14 * 3600
    stor7 = 0
    stor8 = 1510825174
    stor0 = msg.sender
    stor1.length = 2
...
function _fallback() payable {
    ...
    require block.timestamp < start + (2399999999999999999976 * 24 * 3600)
