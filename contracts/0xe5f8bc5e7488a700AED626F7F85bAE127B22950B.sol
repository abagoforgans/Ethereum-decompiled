...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'Dr Colossus' / 256
    idx = 0
    ...
    stor0[address(msg.sender)] = 2 * 10^10
    stor2 = 2 * 10^10
    bool(stor3.length) = 0
    stor3.length.field_1 = 14
    stor3.length.field_8 = 'BratwurstToken' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        stor3[idx].field_0 = 0
        idx = idx + 1
