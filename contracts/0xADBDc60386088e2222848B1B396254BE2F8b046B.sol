...
function _fallback() {
    stor0 = code.data[4407 len 20]
    require code.data[4427 len 32]
    require code.data[4459 len 32]
    require code.data[4491 len 32]
    stor7 = code.data[4459 len 32]
    stor8 = code.data[4491 len 32]
    stor9 = code.data[4523 len 32]
    stor6 = code.data[4427 len 32]
    return code.data[171 len 4224]
}
...
function buyForEverybody() {
    ...
    call address(ext_call.return_data[0]).balanceOf(address rg1) with:
         gas gas_remaining - 710 wei
        args this.address
    require ext_call.success
...
function buy() payable {
    ...
    emit Invested(address(msg.sender), msg.value, 0, 0);
}
...
function buyWithCustomerId(uint128 arg1) payable {
    ...
    weiRaised += msg.value
    require msg.value + weiRaised <= weiCap
    emit Invested(address(msg.sender), msg.value, 0, arg1);
}
