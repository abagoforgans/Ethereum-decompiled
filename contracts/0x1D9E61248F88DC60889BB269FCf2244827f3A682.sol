...
function BetPriceLimit() payable {
    return 10^16, 10^6 * stor5 / 10 * 10^6
}
...
function GetMyInvestmentBalance() payable {
    ...
    require None + 2 < stor10.length
    require uint256(stor[code.data[7163 len 32] + (5 * None) + 10])
    require None + 2 < stor10.length
    call msg.sender with:
       value uint256(stor[code.data[7163 len 32] + (5 * None) + 10]) wei
         gas 0 wei
    require ext_call.success
    require None + 2 < stor10.length
    uint256(stor[code.data[7163 len 32] + (5 * None) + 10]) = 0
}
...
function ChanceOfWinning(uint256 arg1) payable {
    if 0 == stor5:
        return 0
    if arg1 >= 10^16:
        if arg1 >= 10^6 * stor5 / 50 * 10^6 * 130 * 100 * 10^6 * stor5 / arg1 / 50 / 100 / 10^6 / 130:
            if 130 * 100 * 10^6 * stor5 / arg1 / 50 / 100 / 10^6 >= 26:
                return 130 * 100 * 10^6 * stor5 / arg1 / 50 / 100 / 10^6, 
                       10^6 * stor5 / 50 * 10^6 * 130 * 100 * 10^6 * stor5 / arg1 / 50 / 100 / 10^6 / 130
        else:
            if (130 * 100 * 10^6 * stor5 / arg1 / 50 / 100 / 10^6) + 1 >= 26:
                return (130 * 100 * 10^6 * stor5 / arg1 / 50 / 100 / 10^6) + 1, 
                       10^6 * stor5 / (50 * 10^6 * 130 * 100 * 10^6 * stor5 / arg1 / 50 / 100 / 10^6) + 50 * 10^6 / 130
    else:
        if 10^16 >= 10^6 * stor5 / 50 * 10^6 * 130 * 100 * 10^6 * stor5 / 10^16 / 50 / 100 / 10^6 / 130:
            if 130 * 100 * 10^6 * stor5 / 10^16 / 50 / 100 / 10^6 >= 26:
                return 130 * 100 * 10^6 * stor5 / 10^16 / 50 / 100 / 10^6, 
                       10^6 * stor5 / 50 * 10^6 * 130 * 100 * 10^6 * stor5 / 10^16 / 50 / 100 / 10^6 / 130
        else:
            if (130 * 100 * 10^6 * stor5 / 10^16 / 50 / 100 / 10^6) + 1 >= 26:
                return (130 * 100 * 10^6 * stor5 / 10^16 / 50 / 100 / 10^6) + 1, 
                       10^6 * stor5 / (50 * 10^6 * 130 * 100 * 10^6 * stor5 / 10^16 / 50 / 100 / 10^6) + 50 * 10^6 / 130
    return 26, 10^6 * stor5 / 10 * 10^6
}
...
function CancelMyInvestment() payable {
    ...
    if not uint8(storA1C6[None].field_0):
        if uint256(stor[code.data[7163 len 32] + (5 * None) + 10]) <= 0:
            call msg.sender with:
                 gas 0 wei
        else:
            require None + 2 < stor10.length
        ...
        if uint256(stor[code.data[7163 len 32] + (5 * None) + 10]) <= 0:
            ...
            require None + 2 < stor10.length
            call msg.sender with:
               value uint256(stor[code.data[7163 len 32] + (5 * None) + 10]) + stor56C6[None] wei
                 gas 0 wei
    require ext_call.success
    require None + 2 < stor10.length
    storC65A[None] = 0
    stor56C6[None] = 0
    uint256(stor[(5 * None) + code.data[7163 len 32] + 10]) = 0
        ...
        if uint256(stor9[address(msg.sender)][idx].field_0) + 30 <= block.number:
            ...
            while s < stor10.length:
                ...
                if not uint8(storA1C6[s].field_8):
                    ...
                    continue 
                require s < stor10.length
                uint256(stor[code.data[7163 len 32] + (5 * s)]) += (uint256(stor9[address(msg.sender)][idx].field_768) * stor56C6[s]) - (uint255(stor9[address(msg.sender)][idx].field_769) * stor56C6[s]) / stor5
                mem[0] = msg.sender
                mem[32] = 9
                s = s + 1
                t = 1
                ...
                if uint256(stor9[address(msg.sender)][idx].field_1024) != stor3.length:
                    ...
                    while t < stor10.length:
                        ...
                        if not uint8(storA1C6[t].field_8):
                            ...
                            continue 
                        require t < stor10.length
                        uint256(stor[code.data[7163 len 32] + (5 * t)]) += 50 * uint256(stor9[address(msg.sender)][idx].field_768) / 100 * stor56C6[t] / stor5
                        mem[0] = msg.sender
                        mem[32] = 9
                        t = t + 1
                        u = 1
                    ...
                    require idx < uint256(stor9[address(msg.sender)].field_0)
                    mem[0] = sha3(address(msg.sender), 9)
                    if uint64(u) % 130 * 100 * 10^6 * stor5 / uint256(stor9[address(msg.sender)][idx].field_768) / 50 / 100 / 10^6 != 0:
                        mem[32] = 9
                        require idx < uint256(stor9[address(msg.sender)].field_0)
                        mem[mem[64]] = msg.sender
                        mem[mem[64] + 32] = uint256(stor9[address(msg.sender)][idx].field_768)
                        ...
                        mem[mem[64] + 256] = 130 * 100 * 10^6 * stor5 / uint256(stor9[address(msg.sender)][idx].field_768) / 50 / 100 / 10^6
                        mem[mem[64] + 288] = uint64(u) % 130 * 100 * 10^6 * stor5 / uint256(stor9[address(msg.sender)][idx].field_768) / 50 / 100 / 10^6
                        emit 0xa933d140: msg.sender, uint256(stor9[address(msg.sender)][idx].field_768), uint256(stor9[address(msg.sender)][idx].field_1280), 0, 0, 1, 0, u << 192, 130 * 100 * 10^6 * stor5 / uint256(stor9[address(msg.sender)][idx].field_768) / 50 / 100 / 10^6, uint64(u) % 130 * 100 * 10^6 * stor5 / uint256(stor9[address(msg.sender)][idx].field_768) / 50 / 100 / 10^6
                    else:
                        t = 1
                        while t < stor10.length:
                        ...
                        mem[mem[64] + 256] = 130 * 100 * 10^6 * stor5 / uint256(stor9[address(msg.sender)][idx].field_768) / 50 / 100 / 10^6
                        mem[mem[64] + 288] = uint64(u) % 130 * 100 * 10^6 * stor5 / uint256(stor9[address(msg.sender)][idx].field_768) / 50 / 100 / 10^6
                        emit 0xa933d140: msg.sender, stor1.length, uint256(stor9[address(msg.sender)][idx].field_1280), 0, 0, 0, 1, u << 192, 130 * 100 * 10^6 * stor5 / uint256(stor9[address(msg.sender)][idx].field_768) / 50 / 100 / 10^6, uint64(u) % 130 * 100 * 10^6 * stor5 / uint256(stor9[address(msg.sender)][idx].field_768) / 50 / 100 / 10^6
                    require idx < uint256(stor9[address(msg.sender)].field_0)
                    stor8 -= uint256(stor9[address(msg.sender)][idx].field_768)
        uint256(stor9[address(msg.sender)][idx].field_0) = 0
        uint256(stor9[address(msg.sender)][idx].field_256) = 0
...
function _fallback() payable {
    ...
    require stor5 != 0
    if msg.value >= 10^6 * stor5 / 50 * 10^6 * 130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6 / 130:
        if 130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6 >= 26:
            if msg.value - (10^6 * stor5 / 50 * 10^6 * 130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6 / 130) > 0:
                call msg.sender with:
                   value msg.value - (10^6 * stor5 / 50 * 10^6 * 130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6 / 130) wei
                     gas 0 wei
                require ext_call.success
            mem[0] = msg.sender
            mem[32] = 9
            ...
            while idx < uint256(stor9[address(msg.sender)].field_0):
                ...
                require idx < uint256(stor9[address(msg.sender)].field_0)
                uint256(stor9[address(msg.sender)][idx].field_768) = 10^6 * stor5 / 50 * 10^6 * 130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6 / 130
                require idx < uint256(stor9[address(msg.sender)].field_0)
                uint256(stor9[address(msg.sender)][idx].field_1024) = stor3.length
                require idx < uint256(stor9[address(msg.sender)].field_0)
                uint256(stor9[address(msg.sender)][idx].field_1280) = stor2.length
                stor8 += 10^6 * stor5 / 50 * 10^6 * 130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6 / 130
                require idx < uint256(stor9[address(msg.sender)].field_0)
                require idx < uint256(stor9[address(msg.sender)].field_0)
                require idx < uint256(stor9[address(msg.sender)].field_0)
            ...
            require uint256(stor9[address(msg.sender)].field_0) - 1 < uint256(stor9[address(msg.sender)].field_0)
            uint256(stor9[address(msg.sender)][uint256(stor9[address(msg.sender)].field_0)].field_0) = 10^6 * stor5 / 50 * 10^6 * 130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6 / 130
            require uint256(stor9[address(msg.sender)].field_0) - 1 < uint256(stor9[address(msg.sender)].field_0)
            ...
            if msg.value - (10^6 * stor5 / 10 * 10^6) > 0:
                call msg.sender with:
                   value msg.value - (10^6 * stor5 / 10 * 10^6) wei
                     gas 0 wei
                require ext_call.success
            mem[0] = msg.sender
            mem[32] = 9
            ...
            while idx < uint256(stor9[address(msg.sender)].field_0):
                ...
                uint8(stor9[address(msg.sender)][idx].field_512) = 1
                require idx < uint256(stor9[address(msg.sender)].field_0)
                uint256(stor9[address(msg.sender)][idx].field_768) = 10^6 * stor5 / 10 * 10^6
                require idx < uint256(stor9[address(msg.sender)].field_0)
                uint256(stor9[address(msg.sender)][idx].field_1024) = stor3.length
                require idx < uint256(stor9[address(msg.sender)].field_0)
                uint256(stor9[address(msg.sender)][idx].field_1280) = stor2.length
                stor8 += 10^6 * stor5 / 10 * 10^6
                require idx < uint256(stor9[address(msg.sender)].field_0)
                require idx < uint256(stor9[address(msg.sender)].field_0)
                require idx < uint256(stor9[address(msg.sender)].field_0)
                emit PrepareRollEvent(address(msg.sender), uint256(stor9[address(msg.sender)][idx].field_0), uint256(stor9[address(msg.sender)][idx].field_768), uint256(stor9[address(msg.sender)][idx].field_1280));
            ...
            uint8(stor9[address(msg.sender)][uint256(stor9[address(msg.sender)].field_0)].field_0) = 1
            require uint256(stor9[address(msg.sender)].field_0) - 1 < uint256(stor9[address(msg.sender)].field_0)
            uint256(stor9[address(msg.sender)][uint256(stor9[address(msg.sender)].field_0)].field_0) = 10^6 * stor5 / 10 * 10^6
            require uint256(stor9[address(msg.sender)].field_0) - 1 < uint256(stor9[address(msg.sender)].field_0)
            uint256(stor9[address(msg.sender)][uint256(stor9[address(msg.sender)].field_0)].field_0) = stor3.length
            require uint256(stor9[address(msg.sender)].field_0) - 1 < uint256(stor9[address(msg.sender)].field_0)
            uint256(stor9[address(msg.sender)][uint256(stor9[address(msg.sender)].field_0)].field_0) = stor2.length
        ...
        if (130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6) + 1 >= 26:
            if msg.value - (10^6 * stor5 / (50 * 10^6 * 130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6) + 50 * 10^6 / 130) > 0:
                call msg.sender with:
                   value msg.value - (10^6 * stor5 / (50 * 10^6 * 130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6) + 50 * 10^6 / 130) wei
                     gas 0 wei
                require ext_call.success
            mem[0] = msg.sender
            mem[32] = 9
            ...
            while idx < uint256(stor9[address(msg.sender)].field_0):
                ...
                uint8(stor9[address(msg.sender)][idx].field_512) = 1
                require idx < uint256(stor9[address(msg.sender)].field_0)
                uint256(stor9[address(msg.sender)][idx].field_768) = 10^6 * stor5 / (50 * 10^6 * 130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6) + 50 * 10^6 / 130
                require idx < uint256(stor9[address(msg.sender)].field_0)
                uint256(stor9[address(msg.sender)][idx].field_1024) = stor3.length
                require idx < uint256(stor9[address(msg.sender)].field_0)
                uint256(stor9[address(msg.sender)][idx].field_1280) = stor2.length
                stor8 += 10^6 * stor5 / (50 * 10^6 * 130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6) + 50 * 10^6 / 130
                require idx < uint256(stor9[address(msg.sender)].field_0)
                require idx < uint256(stor9[address(msg.sender)].field_0)
                require idx < uint256(stor9[address(msg.sender)].field_0)
                emit PrepareRollEvent(address(msg.sender), uint256(stor9[address(msg.sender)][idx].field_0), uint256(stor9[address(msg.sender)][idx].field_768), uint256(stor9[address(msg.sender)][idx].field_1280));
            ...
            uint8(stor9[address(msg.sender)][uint256(stor9[address(msg.sender)].field_0)].field_0) = 1
            require uint256(stor9[address(msg.sender)].field_0) - 1 < uint256(stor9[address(msg.sender)].field_0)
            uint256(stor9[address(msg.sender)][uint256(stor9[address(msg.sender)].field_0)].field_0) = 10^6 * stor5 / (50 * 10^6 * 130 * 100 * 10^6 * stor5 / msg.value / 50 / 100 / 10^6) + 50 * 10^6 / 130
            require uint256(stor9[address(msg.sender)].field_0) - 1 < uint256(stor9[address(msg.sender)].field_0)
            uint256(stor9[address(msg.sender)][uint256(stor9[address(msg.sender)].field_0)].field_0) = stor3.length
            require uint256(stor9[address(msg.sender)].field_0) - 1 < uint256(stor9[address(msg.sender)].field_0)
            uint256(stor9[address(msg.sender)][uint256(stor9[address(msg.sender)].field_0)].field_0) = stor2.length
