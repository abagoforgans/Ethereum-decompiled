...
function MTPToken() {
    require 0x144efef99f7f126987c2b5ccd717cf6edad1e67d == msg.sender
    totalSupply = 99878631000000 * 10^18
    maxPresaleSupply = (8 * totalSupply / 1000) + (27466623525 * 10^18 * 24 * 3600)
    balanceOf[address(msg.sender)] = 27466623525 * 10^18 * 24 * 3600
    totalMTPAllocated = 27466623525 * 10^18 * 24 * 3600
}
