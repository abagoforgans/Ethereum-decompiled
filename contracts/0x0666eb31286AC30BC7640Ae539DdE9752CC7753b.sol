...
function annualInterest() {
    return (3650 * maxMintProofOfStake / 100)
}
        ...
        while idx < stor19[address(msg.sender)].field_0:
            ...
            if block.timestamp >= stor19[address(msg.sender)][idx].field_128 + stakeMinAge:
                ...
                if block.timestamp - stor19[address(msg.sender)][idx].field_128 <= stakeMaxAge:
                    require stor19[address(msg.sender)][idx].field_0 * block.timestamp - stor19[address(msg.sender)][idx].field_128 / 720 >= 0
                else:
                    require stor19[address(msg.sender)][idx].field_0 * stakeMaxAge / 720 >= 0
            mem[0] = msg.sender
            mem[32] = 19
            idx = idx + 1
            continue 
        ...
        while idx < stor19[address(arg1)].field_0:
            ...
            if block.timestamp >= stor19[address(arg1)][idx].field_128 + stakeMinAge:
                ...
                if block.timestamp - stor19[address(arg1)][idx].field_128 <= stakeMaxAge:
                    require stor19[address(arg1)][idx].field_0 * block.timestamp - stor19[address(arg1)][idx].field_128 / 720 >= 0
                else:
                    require stor19[address(arg1)][idx].field_0 * stakeMaxAge / 720 >= 0
            mem[0] = arg1
            mem[32] = 19
            idx = idx + 1
            continue 
