...
function _fallback() payable {
    ...
    stor0 = code.data[1599 len 20]
    stor1 = 10^18 * code.data[1619 len 32]
    stor3 = (60 * code.data[1651 len 32]) + block.timestamp
    stor4 = 10^18 * code.data[1683 len 32]
    stor5 = code.data[1727 len 20]
    return code.data[167 len 1420]
}
...
function _fallback() payable {
    ...
    call tokenRewardAddress.0xa9059cbb with:
        ...
        args msg.sender, msg.value / price / 100
