...
#
#  - registerNameXname(string arg1, bytes32 arg2, bool arg3)
#
...
function addGame(address arg1, string arg2) {
    ...
    while idx <= pID_:
        ...
        mem[mem[64] + 4] = idx
        mem[mem[64] + 36] = playerAddr[idx].field_0
        mem[mem[64] + 68] = playerAddr[idx].field_256
        mem[mem[64] + 100] = playerAddr[idx].field_512
        ...
        call games_[stor6].receivePlayerInfo(uint256 arg1, address arg2, bytes32 arg3, uint256 arg4) with:
             gas gas_remaining wei
            args idx, playerAddr[idx].field_0, playerAddr[idx].field_256, playerAddr[idx].field_512
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        idx = idx + 1
        continue 
