...
function _fallback() {
    ...
    require code.data[7352 len 32] > block.timestamp
    require code.data[7428 len 20]
    require code.data[7352 len 32] < block.timestamp + (2160 * 24 * 3600)
    ...
    create contract with 0 wei
                    code: code.data[5430 len 1922], block.timestamp + (2160 * 24 * 3600), address(code.data[7416 len 32])
    require create.new_address
    ...
    call address(create.new_address).0xcf12e870 with:
        ...
        args msg.sender
    require ext_call.success
    stor6 = uint32(code.data[7352 len 32])
    stor3 = address(code.data[7384 len 32])
