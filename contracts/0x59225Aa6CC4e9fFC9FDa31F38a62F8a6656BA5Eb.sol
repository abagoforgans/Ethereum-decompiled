...
const _fallback = code.data[18 len 1958]
...
function _fallback() payable {
    ...
    while idx < stor2.length:
        mem[0] = 2
        call address(stor[code.data[1926 len 32] + (2 * idx)]) with:
...
function changeMemberAddress(address arg1) payable {
    ...
    if address(stor[code.data[1926 len 32] + (2 * stor1[address(msg.sender)])]) == msg.sender:
        require stor1[address(msg.sender)] < stor2.length
...
function sub_fc9fc96e(?) payable {
    ...
    while stor[(2 * arg1) + 0x405787fa12a823e0f2b7631cc41b3ba8828b3321ca811111fa75cd3aa3bb5acf].length + 192 > idx + 32:
        ...
        s = s + 1
        continue 
    return address(stor[(2 * arg1) + code.data[1926 len 32]]), 
...
function removeMember(address arg1) payable {
    ...
    while idx < stor2.length - 1:
        ...
        address(stor[code.data[1926 len 32] + (2 * idx)]) = address(stor[code.data[1926 len 32] + (2 * idx + 1)])
        mem[0] = code.data[1926 len 32] + (2 * idx) + 1
        if 31 >= stor[code.data[1926 len 32] + (2 * idx + 1) + 1].length:
            uint256(stor[code.data[1926 len 32] + (2 * idx) + 1]) = uint256(stor[code.data[1926 len 32] + (2 * idx + 1) + 1])
            s = sha3(code.data[1926 len 32] + (2 * s) + 1)
            while sha3(code.data[1926 len 32] + (2 * s) + 1) + (stor[code.data[1926 len 32] + (2 * s) + 1].length + 31 / 32) > s:
                uint256(stor[s]) = 0
                s = s + 1
                continue 
            s = s + 1
            continue 
        uint256(stor[code.data[1926 len 32] + (2 * idx) + 1]) = Mask(255, 1, uint256(stor[code.data[1926 len 32] + (2 * idx + 1) + 1]) and (256 * not bool(stor[code.data[1926 len 32] + (2 * idx + 1) + 1])) - 1) + 1
        if not Mask(255, 1, uint256(stor[code.data[1926 len 32] + (2 * idx + 1) + 1]) and (256 * not bool(stor[code.data[1926 len 32] + (2 * idx + 1) + 1])) - 1):
            s = sha3(code.data[1926 len 32] + (2 * s) + 1)
            while sha3(code.data[1926 len 32] + (2 * s) + 1) + (stor[code.data[1926 len 32] + (2 * s) + 1].length + 31 / 32) > s:
                uint256(stor[s]) = 0
                s = s + 1
            ...
            s = s + 1
            continue 
        mem[0] = code.data[1926 len 32] + (2 * idx + 1) + 1
        s = sha3(code.data[1926 len 32] + (2 * idx) + 1)
        t = sha3(code.data[1926 len 32] + (2 * idx + 1) + 1)
        while sha3(code.data[1926 len 32] + (2 * idx + 1) + 1) + (stor[code.data[1926 len 32] + (2 * idx + 1) + 1].length + 31 / 32) > t:
            uint256(stor[s]) = uint256(stor[t])
            s = s + 1
            t = t + 1
            continue 
        t = s
        while sha3(code.data[1926 len 32] + (2 * idx) + 1) + (stor[code.data[1926 len 32] + (2 * idx) + 1].length + 31 / 32) > t:
            uint256(stor[t]) = 0
            t = t + 1
            continue 
        idx = idx + 1
