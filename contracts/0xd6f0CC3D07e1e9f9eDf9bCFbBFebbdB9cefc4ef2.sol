...
function mintWithTokenURI(address arg1, string arg2) payable {
    require calldata.size - 4 >= 64
    ...
    tokenOfOwnerByIndex[address(arg1)][tokenOfOwnerByIndex[address(arg1)]] = tokenId
    stor8[stor13] = tokenByIndex.length
    tokenByIndex.length++
    tokenByIndex[tokenByIndex.length] = tokenId
    require ownerOf[stor13]
    tokenURI[stor13][] = Array(len=arg2.length, data=arg2[all])
    require tokenId + 1 >= tokenId
    tokenId++
}
