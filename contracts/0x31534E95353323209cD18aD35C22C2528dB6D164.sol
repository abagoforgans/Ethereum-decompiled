...
function left() payable {
    return uint256(left[0 len left.length].field_0)
}
...
function sub_94e2e13c(?) payable {
    require arg1 < 10
    return (uint256(stor42[0.03125 / arg1].field_0) / 256^(arg1 % 32) << 248)
}
...
function sub_7f74f7de(?) payable {
    ...
    while idx < 8:
        require -idx + 9 < 10
        if u % 16 >= 10:
            uint256(stor42[0.03125 / -idx + 9].field_0) = uint8((u % 16) + 87) * 256^(-idx + 9 % 32) or !(255 * 256^(-idx + 9 % 32)) and uint256(stor42[0.03125 / -idx + 9].field_0)
        else:
            uint256(stor42[0.03125 / -idx + 9].field_0) = uint8((u % 16) + 48) * 256^(-idx + 9 % 32) or !(255 * 256^(-idx + 9 % 32)) and uint256(stor42[0.03125 / -idx + 9].field_0)
        u = u % 16
        idx = idx + 1
        u = u / 16
        continue 
...
function sub_90929040(?) payable {
    ...
    while right.length + 31 / 32 > idx:
        ...
        idx = idx + 1
        continue 
    require 0 < left.length
    if not bool(left.length):
        uint8(left.length.field_248) = 0
    else:
        uint8(stor[code.data[10776 len 32]].field_248) = 0
}
...
function sub_15692138(?) payable {
    ...
    while idx < 10:
        ...
        if not bool(left.length):
            ...
            mem[0] = 40
            uint256(stor[code.data[10776 len 32] + (0.03125 / idx)].field_0) = uint8(stor42[uint8(idx)].field_0) * 256^(-(idx % 32) + 31) or !(255 * 256^(-(idx % 32) + 31)) and uint256(stor[code.data[10776 len 32] + (0.03125 / idx)].field_0)
        idx = idx + 1
        continue 
}
