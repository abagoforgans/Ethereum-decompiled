...
function _fallback() {
    stor13 = msg.sender
    stor0 = code.data[2220 len 32]
    stor1 = code.data[2252 len 32]
    stor8 = code.data[2284 len 32]
    stor9 = code.data[2316 len 32]
    stor10 = code.data[2348 len 32]
    stor11[code.data[2424 len 20]] = 1
    stor11[code.data[2456 len 20]] = 1
    stor11[code.data[2488 len 20]] = 1
    stor12 = code.data[2392 len 20]
    return code.data[242 len 1978]
}
