...
function multisend(address arg1, address[] arg2, uint256[] arg3) {
    ...
    while idx < arg2.length:
        ...
        mem[(32 * arg3.length) + (32 * arg2.length) + 164] = address(_18)
        mem[(32 * arg3.length) + (32 * arg2.length) + 196] = _20
        ...
        require idx < arg2.length
        require idx < arg3.length
        _26 = mem[(32 * arg2.length) + (32 * idx) + 160]
        mem[(32 * arg3.length) + (32 * arg2.length) + 160] = mem[(32 * idx) + 140 len 20]
        mem[(32 * arg3.length) + (32 * arg2.length) + 192] = _26
        emit TokenDrop(mem[(32 * arg3.length) + (32 * arg2.length) + 160], _26);
        idx = idx + 1
        continue 
}
