...
function _fallback() payable {
    ...
    stor0 = msg.sender
    address(stor11.field_8) = address(code.data[11647 len 32])
    bool(stor1.length) = 0
    stor1.length.field_1 = 26
    stor1.length.field_8 = 'WePower Contribution Token' / 256
    idx = 0
    ...
    stor7 = block.number
    return code.data[763 len 10884]
}
