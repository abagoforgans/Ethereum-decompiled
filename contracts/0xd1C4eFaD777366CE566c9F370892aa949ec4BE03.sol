...
function _fallback() payable {
    ...
    stor0 = code.data[2648 len 20]
    stor1 = 10^18 * code.data[2668 len 32]
    stor3 = block.timestamp + (60 * code.data[2700 len 32])
    stor4 = 166666666667
    stor5 = code.data[2776 len 20]
    return code.data[323 len 2313]
}
...
function _fallback() payable {
    ...
    call tokenRewardAddress.0xa9059cbb with:
        ...
        args msg.sender, 6 * msg.value / 10^9
