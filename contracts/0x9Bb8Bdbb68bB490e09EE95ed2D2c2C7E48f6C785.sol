...
function _fallback() {
    ...
    stor5.field_256 % 1 = 0
    stor4 = 0
    stor3 = 30000 * 24 * 3600 * 10^18
    stor11[address(stor5.field_0)] = 30000 * 24 * 3600 * 10^18
    stor6 = 5 * 10^(stor2 - 1)
    stor7.field_0 % 4 = 0
...
function _fallback() payable {
    ...
    balances[address(msg.sender)] += 5000 * msg.value
    funds += msg.value
