...
function _fallback() payable {
    ...
    stor6.length.field_8 = 'DOLL1.0' / 256
    idx = 0
    ...
    stor0[address(msg.sender)] = 3 * 10^10
    stor2 = 3 * 10^10
    bool(stor3.length) = 0
    stor3.length.field_1 = 8
    stor3.length.field_8 = 'DollHair' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'DOLL' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[560 len 4028]
}
