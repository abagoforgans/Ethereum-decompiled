...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[3428 len 32] > block.timestamp
    require code.data[3428 len 32] >= code.data[3396 len 32]
    require code.data[3472 len 20]
    require code.data[3504 len 20]
    stor1 = code.data[3396 len 32]
    stor2 = code.data[3428 len 32]
    stor5 = code.data[3504 len 20]
    address(stor6.field_0) = code.data[3472 len 20]
    uint8(stor6.field_160) = 0
    return code.data[261 len 3135]
}
