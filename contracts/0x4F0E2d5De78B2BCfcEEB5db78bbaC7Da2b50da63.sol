...
function revoke(address arg1) {
    ...
    if block.timestamp < cliff:
        ...
        if not -released[address(arg1)] / uint8(10^ext_call.return_data[0]):
            ...
            require -released[address(arg1)] / uint8(10^ext_call.return_data[0])
            require -released[address(arg1)] / uint8(10^ext_call.return_data[0]) * uint8(10^ext_call.return_data[0]) / -released[address(arg1)] / uint8(10^ext_call.return_data[0]) == uint8(10^ext_call.return_data[0])
            require -released[address(arg1)] / uint8(10^ext_call.return_data[0]) * uint8(10^ext_call.return_data[0]) <= ext_call.return_data[0]
            stor7[address(arg1)] = 1
            require ext_code.size(arg1)
            call arg1.0xa9059cbb with:
                 gas gas_remaining wei
                args owner, ext_call.return_data[0] - (-released[address(arg1)] / uint8(10^ext_call.return_data[0]) * uint8(10^ext_call.return_data[0]))
    else:
        require start + duration >= start
        if block.timestamp >= start + duration:
            require released[address(arg1)] <= ext_call.return_data[0] + released[address(arg1)]
            require uint8(10^ext_call.return_data[0])
            if not ext_call.return_data[0] / uint8(10^ext_call.return_data[0]):
                require 0 <= ext_call.return_data[0]
                stor7[address(arg1)] = 1
                require ext_code.size(arg1)
                call arg1.0xa9059cbb with:
                ...
                require ext_call.return_data[0] / uint8(10^ext_call.return_data[0])
                require ext_call.return_data[0] / uint8(10^ext_call.return_data[0]) * uint8(10^ext_call.return_data[0]) / ext_call.return_data[0] / uint8(10^ext_call.return_data[0]) == uint8(10^ext_call.return_data[0])
                require ext_call.return_data[0] / uint8(10^ext_call.return_data[0]) * uint8(10^ext_call.return_data[0]) <= ext_call.return_data[0]
                stor7[address(arg1)] = 1
                require ext_code.size(arg1)
                call arg1.0xa9059cbb with:
                     gas gas_remaining wei
                    args owner, ext_call.return_data[0] - (ext_call.return_data[0] / uint8(10^ext_call.return_data[0]) * uint8(10^ext_call.return_data[0]))
        else:
            if stor7[address(arg1)]:
                require released[address(arg1)] <= ext_call.return_data[0] + released[address(arg1)]
                require uint8(10^ext_call.return_data[0])
                ...
                if not ext_call.return_data[0] + released[address(arg1)]:
                    ...
                    require uint8(10^ext_call.return_data[0])
                    if not (0 / duration) - released[address(arg1)] / uint8(10^ext_call.return_data[0]):
                        require 0 <= ext_call.return_data[0]
                        stor7[address(arg1)] = 1
                        require ext_code.size(arg1)
                        call arg1.0xa9059cbb with:
                        ...
                        require (0 / duration) - released[address(arg1)] / uint8(10^ext_call.return_data[0])
                        require (0 / duration) - released[address(arg1)] / uint8(10^ext_call.return_data[0]) * uint8(10^ext_call.return_data[0]) / (0 / duration) - released[address(arg1)] / uint8(10^ext_call.return_data[0]) == uint8(10^ext_call.return_data[0])
                        require (0 / duration) - released[address(arg1)] / uint8(10^ext_call.return_data[0]) * uint8(10^ext_call.return_data[0]) <= ext_call.return_data[0]
                        stor7[address(arg1)] = 1
                        require ext_code.size(arg1)
                        call arg1.0xa9059cbb with:
                             gas gas_remaining wei
                            args owner, ext_call.return_data[0] - ((0 / duration) - released[address(arg1)] / uint8(10^ext_call.return_data[0]) * uint8(10^ext_call.return_data[0]))
                else:
                    ...
                    require uint8(10^ext_call.return_data[0])
                    if not ((block.timestamp * ext_call.return_data[0]) - (start * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (start * released[address(arg1)]) / duration) - released[address(arg1)] / uint8(10^ext_call.return_data[0]):
                        require 0 <= ext_call.return_data[0]
                        stor7[address(arg1)] = 1
                        require ext_code.size(arg1)
                        call arg1.0xa9059cbb with:
                        ...
                        require ((block.timestamp * ext_call.return_data[0]) - (start * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (start * released[address(arg1)]) / duration) - released[address(arg1)] / uint8(10^ext_call.return_data[0])
                        require ((block.timestamp * ext_call.return_data[0]) - (start * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (start * released[address(arg1)]) / duration) - released[address(arg1)] / uint8(10^ext_call.return_data[0]) * uint8(10^ext_call.return_data[0]) / ((block.timestamp * ext_call.return_data[0]) - (start * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (start * released[address(arg1)]) / duration) - released[address(arg1)] / uint8(10^ext_call.return_data[0]) == uint8(10^ext_call.return_data[0])
                        require ((block.timestamp * ext_call.return_data[0]) - (start * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (start * released[address(arg1)]) / duration) - released[address(arg1)] / uint8(10^ext_call.return_data[0]) * uint8(10^ext_call.return_data[0]) <= ext_call.return_data[0]
                        stor7[address(arg1)] = 1
                        require ext_code.size(arg1)
                        call arg1.0xa9059cbb with:
                             gas gas_remaining wei
                            args owner, ext_call.return_data[0] - (((block.timestamp * ext_call.return_data[0]) - (start * ext_call.return_data[0]) + (block.timestamp * released[address(arg1)]) - (start * released[address(arg1)]) / duration) - released[address(arg1)] / uint8(10^ext_call.return_data[0]) * uint8(10^ext_call.return_data[0]))
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit Revoked()
}
