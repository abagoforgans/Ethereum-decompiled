...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'BitcoinGo' / 256
    idx = 0
    ...
    stor1.length.field_8 = 'BTCGO' / 256
    idx = 0
    while stor1.length + 31 / 32 > idx:
        ...
        continue 
    stor2 = 18
    stor3 = 30000000000 * 10^18
    require not msg.value
    mem[224 len -2260] = code.data[2751 len -2260]
