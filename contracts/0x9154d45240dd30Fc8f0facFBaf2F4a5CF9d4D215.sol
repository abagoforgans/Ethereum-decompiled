...
function _fallback() payable {
    ...
    if 3000000 * 10^18 > totalSupply:
        if stor17 * msg.value / 100:
            require stor17 * msg.value / 100
            require 142857 * stor17 * msg.value / 100 / stor17 * msg.value / 100 == 142857
        if 142857 * stor17 * msg.value / 100 / 100000 < 10^18:
            revert with 0, 'Tokens bellow TOKEN_MIN'
        require (142857 * stor17 * msg.value / 100 / 100000) + totalSupply >= totalSupply
        require (142857 * stor17 * msg.value / 100 / 100000) + totalSupply >= 142857 * stor17 * msg.value / 100 / 100000
        if (142857 * stor17 * msg.value / 100 / 100000) + totalSupply > 12500 * 10^18 * 3600:
        ...
        totalSupply += 142857 * stor17 * msg.value / 100 / 100000
        balanceOf[msg.sender] += 142857 * stor17 * msg.value / 100 / 100000
        sub_65aebd83 += 142857 * stor17 * msg.value / 100 / 100000
        if not stor10[address(msg.sender)]:
            holder.length++
            stor175B[stor11.length] = msg.sender
            stor10[address(msg.sender)] = 1
        stor9[msg.sender] = 1
        emit 0x3add18e9: (142857 * stor17 * msg.value / 100 / 100000), msg.sender
        emit Transfer((142857 * stor17 * msg.value / 100 / 100000), this.address, msg.sender);
    else:
        if 10000000 * 10^18 > totalSupply:
            if stor17 * msg.value / 100:
                require stor17 * msg.value / 100
                require 125000 * stor17 * msg.value / 100 / stor17 * msg.value / 100 == 125000
            if 125000 * stor17 * msg.value / 100 / 100000 < 10^18:
                revert with 0, 'Tokens bellow TOKEN_MIN'
            require (125000 * stor17 * msg.value / 100 / 100000) + totalSupply >= totalSupply
            require (125000 * stor17 * msg.value / 100 / 100000) + totalSupply >= 125000 * stor17 * msg.value / 100 / 100000
            if (125000 * stor17 * msg.value / 100 / 100000) + totalSupply > 12500 * 10^18 * 3600:
                revert with 0, 'Token supply above TokenCap'
            if stor8[msg.sender]:
                require msg.value + stor27[msg.sender] >= stor27[msg.sender]
                require msg.value + stor27[msg.sender] >= msg.value
            ...
            require msg.value + allReceivedEth >= msg.value
            allReceivedEth += msg.value
            totalSupply += 125000 * stor17 * msg.value / 100 / 100000
            balanceOf[msg.sender] += 125000 * stor17 * msg.value / 100 / 100000
            sub_65aebd83 += 125000 * stor17 * msg.value / 100 / 100000
            if not stor10[address(msg.sender)]:
                holder.length++
                stor175B[stor11.length] = msg.sender
                stor10[address(msg.sender)] = 1
            stor9[msg.sender] = 1
            emit 0x3add18e9: (125000 * stor17 * msg.value / 100 / 100000), msg.sender
            emit Transfer((125000 * stor17 * msg.value / 100 / 100000), this.address, msg.sender);
        else:
            if 30000000 * 10^18 <= totalSupply:
                if stor17 * msg.value / 100:
                    require stor17 * msg.value / 100
                    require 100000 * stor17 * msg.value / 100 / stor17 * msg.value / 100 == 100000
                if 100000 * stor17 * msg.value / 100 / 100000 < 10^18:
                    revert with 0, 'Tokens bellow TOKEN_MIN'
                require (100000 * stor17 * msg.value / 100 / 100000) + totalSupply >= totalSupply
                require (100000 * stor17 * msg.value / 100 / 100000) + totalSupply >= 100000 * stor17 * msg.value / 100 / 100000
                if (100000 * stor17 * msg.value / 100 / 100000) + totalSupply > 12500 * 10^18 * 3600:
                    revert with 0, 'Token supply above TokenCap'
                if stor8[msg.sender]:
                    require msg.value + stor27[msg.sender] >= stor27[msg.sender]
                    require msg.value + stor27[msg.sender] >= msg.value
                ...
                require msg.value + allReceivedEth >= msg.value
                allReceivedEth += msg.value
                totalSupply += 100000 * stor17 * msg.value / 100 / 100000
                balanceOf[msg.sender] += 100000 * stor17 * msg.value / 100 / 100000
                sub_65aebd83 += 100000 * stor17 * msg.value / 100 / 100000
                if not stor10[address(msg.sender)]:
                    holder.length++
                    stor175B[stor11.length] = msg.sender
                    stor10[address(msg.sender)] = 1
                stor9[msg.sender] = 1
                emit 0x3add18e9: (100000 * stor17 * msg.value / 100 / 100000), msg.sender
                emit Transfer((100000 * stor17 * msg.value / 100 / 100000), this.address, msg.sender);
            else:
                if stor17 * msg.value / 100:
                    require stor17 * msg.value / 100
                    require 111111 * stor17 * msg.value / 100 / stor17 * msg.value / 100 == 111111
                if 111111 * stor17 * msg.value / 100 / 100000 < 10^18:
                    revert with 0, 'Tokens bellow TOKEN_MIN'
                require (111111 * stor17 * msg.value / 100 / 100000) + totalSupply >= totalSupply
                require (111111 * stor17 * msg.value / 100 / 100000) + totalSupply >= 111111 * stor17 * msg.value / 100 / 100000
                if (111111 * stor17 * msg.value / 100 / 100000) + totalSupply > 12500 * 10^18 * 3600:
                    revert with 0, 'Token supply above TokenCap'
                if stor8[msg.sender]:
                    require msg.value + stor27[msg.sender] >= stor27[msg.sender]
                    require msg.value + stor27[msg.sender] >= msg.value
                ...
                require msg.value + allReceivedEth >= msg.value
                allReceivedEth += msg.value
                totalSupply += 111111 * stor17 * msg.value / 100 / 100000
                balanceOf[msg.sender] += 111111 * stor17 * msg.value / 100 / 100000
                sub_65aebd83 += 111111 * stor17 * msg.value / 100 / 100000
                if not stor10[address(msg.sender)]:
                    holder.length++
                    stor175B[stor11.length] = msg.sender
                    stor10[address(msg.sender)] = 1
                stor9[msg.sender] = 1
                emit 0x3add18e9: (111111 * stor17 * msg.value / 100 / 100000), msg.sender
                emit Transfer((111111 * stor17 * msg.value / 100 / 100000), this.address, msg.sender);
}
