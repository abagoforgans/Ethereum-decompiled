...
function _fallback() {
    uint8(stor2.field_0) = code.data[1080 len 1]
    uint8(stor2.field_8) = code.data[1112 len 1]
    Mask(240, 0, stor2.field_16) = Mask(72, 0, stor2.field_16)
    address(stor2.field_88) = msg.sender
    return code.data[126 len 923]
}
...
function submitValue(bytes8 arg1) {
    ...
    stor1[Mask(64, 192, arg1)] = uint8(stor1[Mask(64, 192, arg1)] + 1)
    emit VoteSubmitted(msg.sender, Mask(64, 192, arg1));
    if m == stor1[Mask(64, 192, arg1)]:
