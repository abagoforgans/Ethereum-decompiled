...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0xfefff0e0a21dc58e09fac822eaf9584d130a9519)
    delegate 0xfefff0e0a21dc58e09fac822eaf9584d130a9519.0x66098d4f with:
         gas gas_remaining - 50 wei
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0xfefff0e0a21dc58e09fac822eaf9584d130a9519):
                            delegate 0xfefff0e0a21dc58e09fac822eaf9584d130a9519.0x66098d4f with:
                                 gas gas_remaining - 50 wei
