...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0x573178c69e537761270598ef867fb26b1ddf930e)
    delegate 0x573178c69e537761270598ef867fb26b1ddf930e.0x66098d4f with:
         gas gas_remaining - 710 wei
...
function getKYCPayload(bytes arg1) {
    ...
    require ext_code.size(0x6139235b2e2ddce47beddcadf6b1c1f6ad8ed07b)
    delegate 0x6139235b2e2ddce47beddcadf6b1c1f6ad8ed07b.0xb655e138 with:
         gas gas_remaining - 710 wei
    ...
    require delegate.return_code
    require ext_code.size(0x6139235b2e2ddce47beddcadf6b1c1f6ad8ed07b)
    delegate 0x6139235b2e2ddce47beddcadf6b1c1f6ad8ed07b.0x16419aa7 with:
         gas gas_remaining - 710 wei
        args Array(len=arg1.length, data=arg1[all]), 20
    require delegate.return_code
    require ext_code.size(0x6139235b2e2ddce47beddcadf6b1c1f6ad8ed07b)
    delegate 0x6139235b2e2ddce47beddcadf6b1c1f6ad8ed07b.0xd54dd8f9 with:
         gas gas_remaining - 710 wei
