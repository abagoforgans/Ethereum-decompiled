...
function _fallback() payable {
    ...
    stor0 = msg.sender
    address(stor11.field_8) = address(code.data[11648 len 32])
    bool(stor1.length) = 0
    stor1.length.field_1 = 28
    stor1.length.field_8 = 'WePower Contribution Token 1' / 256
    idx = 0
    ...
    stor7 = block.number
    return code.data[761 len 10887]
}
                                    ...
                                    if block.number >= stor8[address(arg1)][stor8[address(arg1)].field_0].field_0:
                                        ...
                                        if block.number < stor8[address(arg1)].field_0:
                                            ...
                                            while stor8[address(arg1)].field_0 - 1 > s:
                                                require stor8[address(arg1)].field_0 + s / 2 < stor8[address(arg1)].field_0
                                                mem[0] = sha3(address(arg1), 8)
                                                if stor8[address(arg1)][0.5 / stor8[address(arg1)].field_0 + s].field_0 > block.number:
                                                    t = stor8[address(arg1)].field_0 + s / 2
                                                    s = s
                                                    continue 
                                                t = stor8[address(arg1)].field_0 + s / 2
                                                s = stor8[address(arg1)].field_0 + s / 2
                                                continue 
