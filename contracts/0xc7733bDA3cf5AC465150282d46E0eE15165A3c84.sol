...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    require balances[address(arg2)] + balances[arg1] >= balances[arg1]
    ...
    require balances[address(arg2)] + balances[arg1] >= balances[arg1]
    require balances[address(arg2)] + balances[arg1] == balances[address(arg2)] + balances[arg1]
...
function transfer2(address arg1, uint256 arg2) {
    require arg1
    s = 0
    t = 0
    u = 0
    ...
    if 1 == bool(stor8[address(msg.sender)]):
        ...
        mem[256] = block.timestamp + (72 * 24 * 3600)
        stor5[address(arg1)].field_0++
        s = 3 * stor5[address(arg1)].field_0
        idx = 192
        while 288 > idx:
