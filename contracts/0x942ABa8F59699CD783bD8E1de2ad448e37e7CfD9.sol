...
function _fallback() {
    stor0 = code.data[7113 len 20]
    stor1 = code.data[7145 len 20]
    stor3 = code.data[7165 len 32]
    stor2 = code.data[7197 len 32]
    return code.data[233 len 6868]
}
...
function takeSell(address arg1, uint256 arg2, uint256 arg3, address arg4) payable {
    ...
    call feeAccount with:
       value arg2 * arg3 * buyFee / 10^18 wei
         gas 2300 * is_zero(value) wei
