...
function _fallback() {
    ...
    stor4.field_256 % 1 = 0
    return code.data[1168 len 11865]
}
...
function giveAnimals(uint8 arg1, address arg2) payable {
    ...
    while uint8(idx) < uint8(msg.value / stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg1')), ('name', 'stor6', 6))[uint8(arg1)]):
        if numAnimals < stor3.length:
            ...
            mem[_33] = arg1
            require arg1 < stor7.length
            mem[_33 + 32] = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg1')), ('name', 'stor7', 7))[uint8(arg1)]
            mem[_33 + 64] = arg2
        else:
            stor3.length++
            if not stor3.length > stor3.length + 1:
                ...
                mem[_40] = arg1
                require arg1 < stor7.length
                mem[_40 + 32] = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg1')), ('name', 'stor7', 7))[uint8(arg1)]
                mem[_40 + 64] = arg2
            else:
        ...
        address(animal[stor4].field_256) = arg2
