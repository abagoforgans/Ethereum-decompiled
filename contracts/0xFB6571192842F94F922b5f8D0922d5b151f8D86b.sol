...
function _fallback() {
    mem[96 len -14264] = code.data[16370 len -14264]
    mem[64] = -14168
    stor0 = msg.sender
    ...
    emit AddShare(msg.sender, 1, stor9[address(msg.sender)].field_256);
    return code.data[2106 len 14264]
}
...
function members(address arg1) {
    mem[320] = returnMember[arg1][3].field_0
    idx = 320
    s = 0
    while returnMember[arg1][3].length + 320 > idx + 32:
    ...
    return bool(returnMember[arg1].field_0), 
           ...
           bool(returnMember[arg1].field_16),
           returnMember[arg1].field_256,
           returnMember[arg1].field_512,
           Array(len=returnMember[arg1][3].length, data=mem[320 len returnMember[arg1][3].length + (floor32(returnMember[arg1][3].length - 1) + -returnMember[arg1][3].length + 32 % 32)])
}
...
function returnMember(address arg1) {
    ...
    mem[576] = returnMember[address(arg1)][3].field_0
    idx = 576
    s = 0
    while returnMember[address(arg1)][3].length + 544 > idx:
        mem[idx + 32] = returnMember[address(arg1)][s + 3].field_256
        idx = idx + 32
        s = s + 1
        continue 
    return bool(returnMember[address(arg1)].field_8), 
           bool(returnMember[address(arg1)].field_16),
           returnMember[address(arg1)].field_256,
           returnMember[address(arg1)].field_512,
           Array(len=returnMember[address(arg1)][3].length, data=mem[576 len returnMember[address(arg1)][3].length])
}
...
function changeAdminPrivilege(address arg1, bool arg2) {
    if owner != msg.sender:
        require returnMember[address(msg.sender)].field_16
    emit ChangePrivilege(address(arg1), bool(returnMember[address(arg1)].field_16), arg2);
    returnMember[address(arg1)].field_16 = Mask(240, 0, arg2)
}
...
function addMember(address arg1, uint256 arg2, bool arg3, string arg4) {
    ...
    returnMember[address(arg1)].field_8 = 1
    returnMember[address(arg1)].field_16 = Mask(240, 0, arg3)
