...
function _fallback() payable {
    ...
    stor0 = msg.sender
    address(stor11.field_8) = address(code.data[6936 len 32])
    bool(stor1.length) = 0
    stor1.length.field_1 = 12
    stor1.length.field_8 = 'Wowbit Token' / 256
    idx = 0
    ...
    stor0 = address(code.data[6904 len 32])
    return code.data[694 len 6210]
}
