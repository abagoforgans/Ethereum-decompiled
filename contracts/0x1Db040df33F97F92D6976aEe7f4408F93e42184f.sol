...
function _fallback() payable {
    bool(stor6.length) = 0
    stor6.length.field_1 = 13
    stor6.length.field_8 = 'Contract V1.0' / 256
    idx = 0
...
function _fallback() payable {
    ...
    if balanceOf[stor9] >= msg.value * unitsOneEthCanBuy:
        balanceOf[stor9] += -1 * msg.value * unitsOneEthCanBuy
        balanceOf[msg.sender] += msg.value * unitsOneEthCanBuy
...
function NewtonTree() {
    ...
    name.length.field_8 = 'Flood Token' / 256
    idx = 0
    ...
    symbol.length.field_8 = 'FLT' / 256
    idx = 0
    while symbol.length + 31 / 32 > idx:
        symbol[idx].field_0 = 0
        idx = idx + 1
        continue 
    fundsWalletAddress = 0xf3e22529d348a12b7976671a0a3770b7d44068d9
}
