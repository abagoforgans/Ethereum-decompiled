...
function _fallback() payable {
    mem[96 len -2228] = code.data[2715 len -2228]
    ...
    uint8(stor1.length) = 10
    Mask(248, 0, stor1.length.field_8) = 'MPBux' / 256
    idx = 0xb10e2d527612073b26eecdfd717e6a320cf44b4afac2b0732d9fcbe2b7fa0cf6
    while (stor1.length + 31 / 32) - 0x4ef1d2ad89edf8c4d91132028e8195cdf30bb4b5053d4f8cd260341d4805f30a > idx:
        stor[idx] = 0
        idx = idx + 1
        continue 
    uint8(stor2.length) = 6
    Mask(248, 0, stor2.length.field_8) = 'MPB' / 256
