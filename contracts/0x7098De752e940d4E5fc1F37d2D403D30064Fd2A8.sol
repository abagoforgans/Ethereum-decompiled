...
function _fallback() payable {
    ...
    require code.data[3341 len 32] >= code.data[3309 len 32]
    require code.data[3373 len 32] > 0
    require code.data[3417 len 20]
    require code.data[3449 len 20]
    require code.data[3469 len 32] > 0
    stor1 = code.data[3309 len 32]
    stor2 = code.data[3341 len 32]
    stor5 = code.data[3373 len 32]
    stor3 = code.data[3417 len 20]
    stor4 = code.data[3449 len 20]
    stor6 = code.data[3469 len 32]
    return code.data[478 len 2831]
}
