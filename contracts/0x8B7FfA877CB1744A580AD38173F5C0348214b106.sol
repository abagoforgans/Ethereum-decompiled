...
function sub_7f899d0b(?) {
    ...
    require return_data.size >= 64
    require ext_call.return_data[0]
    require (2 * arg3 * arg4) - (2 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * arg4)
    return ((10^18 * arg3 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) - (10^18 * arg4 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) / (2 * arg3 * arg4) - (2 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * arg4))
}
    ...
    if not stor0.length:
        ...
        if not stor0.length:
            ...
            if not stor0.length:
                ...
                call 0xb89570f6ad742cb1fd440a930d6c2a2ea29c51ee.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args mem[(98 * stor0.length) + 356], address(_909), (10^18 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) - (10^18 * 10^18 * defaultAmount / ext_call.return_data[0] * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) / (2 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * 10^18 * defaultAmount / ext_call.return_data[0]) - (2 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * 10^18 * defaultAmount / ext_call.return_data[0])
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 64
                mem[(98 * stor0.length) + 388] = arg1
            ...
            if not stor0.length:
                ...
                call 0xb89570f6ad742cb1fd440a930d6c2a2ea29c51ee.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args mem[(98 * stor0.length) + 356], address(_1275), (10^18 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) - (10^18 * 10^18 * defaultAmount / ext_call.return_data[0] * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) / (2 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * 10^18 * defaultAmount / ext_call.return_data[0]) - (2 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * 10^18 * defaultAmount / ext_call.return_data[0])
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 64
            mem[(98 * stor0.length) + 388] = arg1
        ...
        if not stor0.length:
            ...
            if not stor0.length:
                ...
                call 0xb89570f6ad742cb1fd440a930d6c2a2ea29c51ee.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args mem[(98 * stor0.length) + 356], address(_1278), (10^18 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) - (10^18 * 10^18 * defaultAmount / ext_call.return_data[0] * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) / (2 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * 10^18 * defaultAmount / ext_call.return_data[0]) - (2 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * 10^18 * defaultAmount / ext_call.return_data[0])
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 64
            mem[(98 * stor0.length) + 388] = arg1
            ...
            if not stor0.length:
                ...
                call 0xb89570f6ad742cb1fd440a930d6c2a2ea29c51ee.getReturn(address arg1, address arg2, uint256 arg3) with:
                     gas gas_remaining wei
                    args mem[(98 * stor0.length) + 356], address(_1510), (10^18 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) - (10^18 * 10^18 * defaultAmount / ext_call.return_data[0] * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) / (2 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * 10^18 * defaultAmount / ext_call.return_data[0]) - (2 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * 10^18 * defaultAmount / ext_call.return_data[0])
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 64
                mem[(98 * stor0.length) + 388] = arg1
