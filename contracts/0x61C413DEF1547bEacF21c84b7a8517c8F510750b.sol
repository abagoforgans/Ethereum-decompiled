...
function _fallback() payable {
    ...
    stor6 = 0
    stor10 = 1848 * 24 * 3600
    stor13 = 0xcccb9baadd61f9e0ab25bd782765013817821bd
    stor14 = 0xfc6851324e2901b3ea6170a90cc43bfe667d617a
    stor15 = 0x21f0f5e81bef4dc696c6bf0196c60a1ac797f953
    stor16 = 0xe8726942a46e6c6b3c1f061c14a15c0053a97b6b
    stor17 = 0x194eac9301b15629c54c02c45bbbcb9134f914b2
    require not msg.value
    stor6 = 0
    stor9 = block.timestamp
    stor18 = msg.sender
    stor11 = 3 * 10^6 * 10^stor5
    stor12 = 200 * 10^6 * 10^stor5
    stor7 = 200 * 10^6 * 10^stor5
    stor1[address(msg.sender)] = 200 * 10^6 * 10^stor5
    emit Transfer((200 * 10^6 * 10^stor5), 0, stor18);
    return code.data[686 len 5096]
}
