...
function _fallback() payable {
    mem[96 len -1253] = code.data[1467 len -1253]
    mem[64] = -1157
...
function requestWithdrawal(address arg1, uint256 arg2) payable {
    ...
    sub_ba3ae0ce[block.hash(block.number - 1) xor stor0 + 1][arg1][arg2].field_0 = arg1 or Mask(96, 160, sub_ba3ae0ce[block.hash(block.number - 1) xor stor0 + 1][arg1][arg2].field_0)
    sub_ba3ae0ce[block.hash(block.number - 1) xor stor0 + 1][arg1][arg2].field_256 = arg2
    sub_ba3ae0ce[block.hash(block.number - 1) xor stor0 + 1][arg1][arg2].field_512 = block.hash(block.number - 1) xor withdrawalRequestCount + 1
    emit 0xd0df5d45: block.hash(block.number - 1) xor withdrawalRequestCount + 1, address(arg1), arg2, sha3(block.hash(block.number - 1) xor withdrawalRequestCount + 1, arg1, arg2)
    return sha3(block.hash(block.number - 1) xor withdrawalRequestCount + 1, arg1, arg2)
}
