...
function _fallback() payable {
    ...
    uint256(stor5) = code.data[3965 len 32]
    if code.data[3997 len 32]:
        stor1 = code.data[3997 len 32]
        stor2 = code.data[4029 len 32]
        emit ChangeOfRules(code.data[3997 len 32], code.data[4029 len 32], address(stor5));
    else:
        stor1 = 1
        stor2 = code.data[4029 len 32]
        emit ChangeOfRules(1, code.data[4029 len 32], address(stor5));
    return code.data[217 len 3748]
}
