...
function sub_39e9e8eb(?) {
    if 10 * price / 10 != price:
        revert with 0, 'ds-math-mul-overflow'
    if 10000000000 * 10^18 * price / 1000000000 * 10^18 != 10 * price:
        revert with 0, 'ds-math-mul-overflow'
    if (10000000000 * 10^18 * price) + 50000000000 * 10^18 < 10000000000 * 10^18 * price:
        revert with 0, 'ds-math-add-overflow'
    if ((10000000000 * 10^18 * price) + 50000000000 * 10^18 / 100000000000 * 10^18) + price < (10000000000 * 10^18 * price) + 50000000000 * 10^18 / 100000000000 * 10^18:
        revert with 0, 'ds-math-add-overflow'
    return (((10000000000 * 10^18 * price) + 50000000000 * 10^18 / 100000000000 * 10^18) + price + 10^16)
}
...
function buyArt(uint256 arg1, uint256 arg2) {
    ...
    if ((10000000000 * 10^18 * price) + 50000000000 * 10^18 / 100000000000 * 10^18) + price < (10000000000 * 10^18 * price) + 50000000000 * 10^18 / 100000000000 * 10^18:
        revert with 0, 'ds-math-add-overflow'
    if arg2 <= ((10000000000 * 10^18 * price) + 50000000000 * 10^18 / 100000000000 * 10^18) + price + 10^16:
        require arg2 == arg2
    else:
        require ((10000000000 * 10^18 * price) + 50000000000 * 10^18 / 100000000000 * 10^18) + price + 10^16 == arg2
    require not stor5
    stor5 = 1
    ...
    if arg2 <= price:
        if arg2 == arg2:
            ...
            if (1000000000 * 10^18 * arg2) - (1000000000 * 10^18 * price) / 1000000000 * 10^18 != arg2 - price:
                revert with 0, 'ds-math-mul-overflow'
            sub_6a07a832 = (1000000000 * 10^18 * arg2) + (-1000000000 * 10^18 * price) + 1000000000 * 10^18 / 2000000000 * 10^18
    else:
        if price == arg2:
            sub_6a07a832 = 0
        else:
