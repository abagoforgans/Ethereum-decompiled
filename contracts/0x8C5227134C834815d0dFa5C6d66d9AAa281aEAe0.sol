...
function _fallback() {
    ...
    stor3.length.field_8 = 'tessr.credit' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        ...
        continue 
    stor4 = 18
    stor5 = 400000000 * 10^18
    stor6 = block.timestamp
    stor7 = block.timestamp + (168 * 24 * 3600)
    stor8 = block.timestamp + (912 * 24 * 3600)
    stor9[stor0] = stor5
    emit Transfer(stor5, 0, stor0);
    return code.data[751 len 6173]
}
...
function _fallback() payable {
    ...
    if block.timestamp > bonusEnds:
        ...
        require _totalSupply + (5000 * msg.value) >= _totalSupply
        _totalSupply += 5000 * msg.value
        emit Transfer((5000 * msg.value), 0, msg.sender);
    else:
        require balanceOf[address(msg.sender)] + (6250 * msg.value) >= balanceOf[address(msg.sender)]
        balanceOf[address(msg.sender)] += 6250 * msg.value
        require _totalSupply + (6250 * msg.value) >= _totalSupply
        _totalSupply += 6250 * msg.value
        emit Transfer((6250 * msg.value), 0, msg.sender);
    call owner with:
       value msg.value wei
