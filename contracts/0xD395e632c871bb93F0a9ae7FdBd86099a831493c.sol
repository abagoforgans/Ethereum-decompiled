...
function _fallback() payable {
    ...
    stor1 = msg.sender
    require not stor7
    require stor5 + 425 * 10^12 >= stor5
    stor5 += 425 * 10^12
    require stor2[stor1] + 425 * 10^12 >= stor2[stor1]
    stor2[stor1] += 425 * 10^12
    emit Distr(425 * 10^12, stor1);
    emit Transfer(425 * 10^12, 0, stor1);
    return code.data[759 len 7724]
}
