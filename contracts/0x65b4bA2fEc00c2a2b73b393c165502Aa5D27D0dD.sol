...
function _fallback() payable {
    mem[96 len -3165] = code.data[3443 len -3165]
    mem[64] = -3069
...
function recoverAddressFromSignature(bytes32 arg1, bytes arg2) payable {
    ...
    if mem[192 len 1] >= 27:
        ...
        emit 0xeb7789b6: Array(len=arg2.length, data=arg2[all]), arg1, mem[192 len 1] + 27 << 248, mem[128], mem[160]
...
function sendMultiSig(address arg1, uint256 arg2, bytes arg3, uint256 arg4, uint256 arg5, bytes arg6) payable {
    ...
    if mem[ceil32(arg3.length) + 224 len 1] >= 27:
        ...
        emit 0xeb7789b6: Array(len=arg6.length, data=arg6[all]), sha3(arg1, arg2, arg3[all], arg4, arg5), mem[ceil32(arg3.length) + 224 len 1] + 27 << 248, mem[ceil32(arg3.length) + 160], mem[ceil32(arg3.length) + 192]
