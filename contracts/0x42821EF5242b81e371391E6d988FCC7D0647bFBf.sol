...
function sub_97de8db0(?) {
    if tokenOfOwnerByIndex[address(arg1)]:
        mem[128 len 32 * tokenOfOwnerByIndex[address(arg1)]] = code.data[14384 len 32 * tokenOfOwnerByIndex[address(arg1)]]
    idx = 0
...
function claimToken(bytes32 arg1) payable {
    ...
    while idx < 7:
        ...
        while s >= 32:
            ...
            s = s - 32
            continue 
        mem[_44 + floor32(mem[_45]) + 84] = mem[_45 + -(mem[_45] % 32) + floor32(mem[_45]) + 64 len mem[_45] % 32] or Mask(8 * -(mem[_45] % 32) + 32, -(8 * -(mem[_45] % 32) + 32) + 256, mem[_44 + floor32(mem[_45]) + 84])
        if arg1 != sha3(mem[_44 + 84 len _47]):
            u = u + 1
            continue 
        idx = 0
...
function claimPrize(uint256 arg1) {
    ...
    while idx < tokenOfOwnerByIndex[address(msg.sender)]:
        ...
        if uint256(sub_cbd7a6b8[arg1]):
            ...
            if uint256(sub_cbd7a6b8[arg1]) <= 0:
                if eth.balance(this.address) >= 3 * 10^17:
                    call msg.sender with:
                       value 3 * 10^17 wei
                         gas 0 wei
                    if not ext_call.success:
        ...
        address(sub_cbd7a6b8[arg1][uint256(sub_cbd7a6b8[arg1])]) = msg.sender
                                ...
                                if stor12[stor4[address(msg.sender)][idx]] == 3:
                                    ...
                                    while idx < tokenOfOwnerByIndex[address(msg.sender)]:
                                        ...
                                        if stor12[stor4[address(msg.sender)][idx]] == 4:
                                            ...
                                            while idx < tokenOfOwnerByIndex[address(msg.sender)]:
                                                require idx < tokenOfOwnerByIndex[address(msg.sender)]
                                                if stor12[stor4[address(msg.sender)][idx]] == 5:
                                                    idx = 0
                                                    while idx < tokenOfOwnerByIndex[address(msg.sender)]:
                                                        require idx < tokenOfOwnerByIndex[address(msg.sender)]
                                                        if stor12[stor4[address(msg.sender)][idx]] != 6:
                                                            mem[0] = msg.sender
                                                            mem[32] = 4
                                                            idx = idx + 1
                                                            continue 
                                                        sub_6caf419aAddress = msg.sender
                                                        if not stor15[address(msg.sender)]:
                                                            sub_91f009cf++
                                                            stor15[address(msg.sender)] = 1
