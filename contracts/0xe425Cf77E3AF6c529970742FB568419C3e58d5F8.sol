...
function _fallback() payable {
    stor1 = code.data[2860 len 32]
    return code.data[55 len 2805]
}
...
function vote(uint256 arg1, bool arg2) payable {
    ...
    require bool(uint8(stor[(9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e56b][address(msg.sender)].field_0)) != 1
    require bool(uint8(stor290D[arg1].field_0)) != 1
    require block.timestamp <= stor290D[arg1]
    stor290D[arg1]++
    if not stor290D[arg1] <= stor290D[arg1] + 1:
        idx = stor290D[arg1] + 1
        while stor290D[arg1] > idx:
            Mask(168, 0, stor[idx + sha3((9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e567)].field_0) = 0
            idx = idx + 1
            continue 
    uint8(stor[(9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e56b][address(msg.sender)].field_0) = 1
    require stor290D[arg1] < stor290D[arg1]
    address(stor[stor290D[arg1] + sha3((9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e567)].field_0) = msg.sender
    Mask(96, 0, stor[stor290D[arg1] + sha3((9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e567)].field_160) = Mask(96, 0, arg2)
    Mask(88, 0, stor[stor290D[arg1] + sha3((9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e567)].field_168) = Mask(88, 168, msg.sender) >> 168
...
function sub_24a7f211(?) payable {
    ...
    if not stor0.length <= stor0.length + 1:
        ...
        while sha3(0) + (9 * stor0.length) > idx + sha3(mem[0]):
            ...
            uint16(stor[idx + sha3(mem[0]) + 3].field_0) = 0
            uint256(stor[idx + sha3(mem[0]) + 4].field_0) = 0
            mem[0] = idx + sha3(mem[0]) + 4
            s = sha3(idx + sha3(mem[0]) + 4)
            while sha3(idx + sha3(mem[0]) + 4) + uint256(stor[idx + sha3(mem[0]) + 4].field_0) > s:
    ...
    uint256(stor[sha3((9 * stor0.length) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e568)][].field_0) = Array(len=arg4.length, data=arg4[all])
    ...
    uint256(stor[sha3((9 * stor0.length) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e569)][].field_0) = Array(len=arg5.length, data=arg5[all])
    return stor0.length
}

function proposals(uint256 arg1) payable {
    require arg1 < stor0.length
    mem[384] = uint256(stor[sha3((9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e568)].field_0)
    idx = 384
    s = 0
    while stor[(9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e568].length + 384 > idx + 32:
        mem[idx + 32] = uint256(stor[s + sha3((9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e568) + 1].field_0)
        idx = idx + 32
        s = s + 1
        continue 
    ...
    while stor[(9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e568].length + (floor32(stor[(9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e568].length - 1) + -stor[(9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e568].length + 32 % 32) + stor[(9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e569].length + 416 > idx + 32:
        mem[idx + 32] = uint256(stor[s + sha3((9 * arg1) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e569) + 1].field_0)
        idx = idx + 32
        s = s + 1
        continue 
