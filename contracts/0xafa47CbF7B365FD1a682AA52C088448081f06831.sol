...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'Stable_Test1' / 256
    idx = 0
    ...
    stor1.length.field_8 = 'Stable_Test1' / 256
    idx = 0
    ...
    while stor2.length + 31 / 32 > idx:
        ...
        continue 
    stor3 = 4
    return code.data[1312 len 4532]
}
