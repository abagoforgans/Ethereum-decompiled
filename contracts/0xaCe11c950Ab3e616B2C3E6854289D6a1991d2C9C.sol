    ...
    if var18003 - 1:
        ...
        if var26003 - 1:
            ...
            if var34003 - 1:
                ...
                if var80003 - 1:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[768] = ext_call.return_data[0] * 10^ext_call.return_data[0] / 10^18
                    mem[608] = 736
                    mem[800] = 1
                    require ext_code.size(stor2)
                    staticcall stor2.getExchange(address arg1) with:
                    ...
                    while idx < 2:
                        ...
                        continue 
                    if mem[s] <= 1:
                        return 0, ext_call.return_data[0] * 10^ext_call.return_data[0] / 10^18, mem[s] << 248, mem[s + 32]
                    revert
        else:
            mem[320] = 0
            require ext_code.size(stor1)
            ...
            if not var72003 - 1:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[704] = ext_call.return_data[0] * 10^ext_call.return_data[0] / 10^18
                mem[544] = 672
                mem[736] = 1
                require ext_code.size(stor2)
                staticcall stor2.getExchange(address arg1) with:
        ...
        if not var64003 - 1:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            mem[640] = ext_call.return_data[0] * 10^ext_call.return_data[0] / 10^18
            mem[480] = 608
            mem[672] = 1
            require ext_code.size(stor2)
            staticcall stor2.getExchange(address arg1) with:
