...
function _fallback() {
    ...
    if not stor1.length <= stor1.length + 1:
        ...
        while stor1.length > idx:
            ...
            idx = idx + 1
            continue 
    address(stor1[stor1.length]) = code.data[2635 len 20]
    stor3[address(code.data[2623 len 32])] = stor0
    stor4[address(code.data[2623 len 32])] = 1
    stor7 = 50000
    stor6 = 10
    return code.data[325 len 2298]
}
