...
function sub_b8055bd2(?) payable {
    if msg.sender == address(sub_be60040eAddress):
        if sub_f0f0b7c0[arg1[all]].field_256:
            sub_f0f0b7c0[arg1[all]].field_128 = uint128(arg2 + sub_f0f0b7c0[arg1[all]].field_128)
}
...
function addString(string arg1) payable {
    if sub_f0f0b7c0[arg1[all]].field_256 != 0:
        return 0
    ...
    if 31 >= sub_f0f0b7c0[arg1[all]][3].length:
        ...
        sub_f0f0b7c0[arg1[all]].field_768 = Mask(255, 1, sub_f0f0b7c0[arg1[all]].field_768 and (256 * not sub_f0f0b7c0[arg1[all]].field_768) - 1) + 1
        if not Mask(255, 1, sub_f0f0b7c0[arg1[all]].field_768 and (256 * not sub_f0f0b7c0[arg1[all]].field_768) - 1):
            idx = 0
            while sub_f0f0b7c0[arg1[all]][3].length + 31 / 32 > idx:
                sub_f0f0b7c0[arg1[all]][idx + 3].field_0 = 0
                idx = idx + 1
