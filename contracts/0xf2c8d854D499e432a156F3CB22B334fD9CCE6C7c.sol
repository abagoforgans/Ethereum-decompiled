...
function _fallback() {
    ...
    stor0.length.field_8 = 'storage1' / 256
    idx = 0
...
uint8 decimals;
array of struct parents1;
array of struct sub_d8227627;
...
function parents1(uint256 arg1) {
    require arg1 < parents1.length
    return parents1[arg1].field_0
}
...
function sub_d8227627(?) {
    require arg1 < sub_d8227627.length
    return sub_d8227627[arg1].field_0
}
...
function transfer(address arg1, uint256 arg2) {
    ...
    sub_d8227627.length = 37
    s = 0
    idx = 96
    while 1280 > idx:
        sub_d8227627[s].field_0 = mem[idx + 12 len 20]
        s = s + 1
        idx = idx + 32
        continue 
    idx = 37
    while sub_d8227627.length > idx:
        sub_d8227627[idx].field_0 = 0
        idx = idx + 1
        continue 
    ...
    idx = 1280
    while 2464 > idx:
        parents1[s].field_0 = mem[idx + 12 len 20]
        s = s + 1
        idx = idx + 32
        continue 
    idx = 37
    while parents1.length > idx:
        parents1[idx].field_0 = 0
        idx = idx + 1
        continue 
    if not parents1.length:
        if not sub_d8227627.length:
            require ext_code.size(0xee22430595ae400a30ffba37883363fbf293e24e)
            call 0xee22430595ae400a30ffba37883363fbf293e24e.0xc48e1c4d with:
                 gas gas_remaining - 710 wei
                args 64, 96, parents1.length, sub_d8227627.length
        else:
            mem[2596] = address(sub_d8227627.field_0)
            idx = 2596
            s = 0
            while (32 * sub_d8227627.length) + 2596 > idx + 32:
                mem[idx + 32] = sub_d8227627[s].field_256
                idx = idx + 32
                s = s + 1
                continue 
            require ext_code.size(0xee22430595ae400a30ffba37883363fbf293e24e)
            call 0xee22430595ae400a30ffba37883363fbf293e24e.0xc48e1c4d with:
                 gas gas_remaining - 710 wei
                args 64, 96, parents1.length, sub_d8227627.length, mem[2596 len 32 * sub_d8227627.length]
    else:
        mem[2564] = address(parents1.field_0)
        idx = 2564
        s = 0
        while (32 * parents1.length) + 2564 > idx + 32:
            mem[idx + 32] = parents1[s].field_256
            idx = idx + 32
            s = s + 1
            continue 
        mem[(32 * parents1.length) + 2564] = sub_d8227627.length
        if not sub_d8227627.length:
            require ext_code.size(0xee22430595ae400a30ffba37883363fbf293e24e)
            call 0xee22430595ae400a30ffba37883363fbf293e24e.0xc48e1c4d with:
                 gas gas_remaining - 710 wei
                args Array(len=parents1.length, data=mem[2564 len (32 * parents1.length) + 32]), (32 * parents1.length) + 96
        else:
            mem[(32 * parents1.length) + 2596] = address(sub_d8227627.field_0)
            idx = (32 * parents1.length) + 2596
            s = 0
            while (32 * parents1.length) + (32 * sub_d8227627.length) + 2596 > idx + 32:
                mem[idx + 32] = sub_d8227627[s].field_256
                idx = idx + 32
                s = s + 1
                continue 
            ...
            call 0xee22430595ae400a30ffba37883363fbf293e24e.0xc48e1c4d with:
                 gas gas_remaining - 710 wei
                args Array(len=parents1.length, data=mem[2564 len (32 * parents1.length) + (32 * sub_d8227627.length) + 32]), (32 * parents1.length) + 96
