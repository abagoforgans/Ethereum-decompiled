...
function _fallback() payable {
    ...
    address(stor4.field_16) = 0x89464d51af1c6edb2e116c28798c9a06e574d299
    stor5 = 15 * 10^14
    stor6 = 100 * stor5
    stor7 = 250000 * stor5
    stor8 = block.timestamp + (168 * 24 * 3600)
    stor9 = 0xd8a19038ca6d75227ad5a5d7ec335a111ad6e141
    require not msg.value
    return code.data[292 len 4046]
}
...
function _fallback() payable {
    ...
    if amountRaised < minimumTarget:
        ...
        if not uint8(stor4.field_8):
            Mask(248, 0, stor4.field_8) = 1
            emit GoalReached(address(stor4.field_0), minimumTarget);
        else:
            call beneficiaryAddress with:
               value msg.value wei
                 gas 2300 * is_zero(value) wei
