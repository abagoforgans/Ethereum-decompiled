    ...
    if 0x531d3bd0400ae601f26b335efbd787415aa5cb81 == msg.sender:
        ...
        if msg.sender != 0x203bf6b46508ed917c085f50f194f36b0a62eb02:
            if sub_d960e8de <= 0:
                ...
                if uint8((block.timestamp / 24 * 3600) + 4 % 7) != 7:
                    if msg.value == 10^16:
                        stor5 += 12 * 10^14
                        stor0[stor3].field_768 += 88 * 10^14
                        emit 0xe2a6acbc: stor0[stor3].field_768
                        mem[416 len 160] = code.data[6892 len 160]
                        if calldata.size == 5:
                            idx = 0
                            ...
                            while uint8(idx) < 4:
                                ...
                                idx = idx + 1
                                continue 
                            mem[576 len 160] = code.data[6892 len 160]
                            idx = 0
                            s = 0
                            while uint8(idx) < 4:
                                t = 0
                    ...
                    if uint8(block.timestamp / 60 / 60 % 24) < 8:
                        if msg.value == 10^16:
                            stor5 += 12 * 10^14
                            stor0[stor3].field_768 += 88 * 10^14
                            emit 0xe2a6acbc: stor0[stor3].field_768
            ...
            if 0 == sub_d960e8de:
                ...
                if uint8((block.timestamp / 24 * 3600) + 4 % 7) != 7:
                    ...
                    if uint8(block.timestamp / 60 / 60 % 24) != 9:
                        uint8(stor0[stor3].field_1024) = 1
                    else:
                        if 1 == uint8(stor0[stor3].field_1024):
                            ...
                            while 256 > idx + 32:
                                ...
                                s = -(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1
                                continue 
                            mem[256 len 160] = code.data[6892 len 160]
                            idx = 0
                            s = 0
                            while uint8(idx) < 4:
                                t = 0
                            ...
                            if stor0[stor3].field_512 > 0:
                                ...
                                while idx <= stor0[stor3].field_512:
                                    ...
                                    _756 = mem[64]
                                    mem[64] = mem[64] + 160
                                    mem[_756] = uint8(stor0[stor3].field_256)
                                    w = _756
                                    x = 0
                                    while _756 + 160 > w + 32:
                                        mem[0] = sub_d960e8de
                                    ...
                                    _3492 = mem[64]
                                    mem[64] = mem[64] + 160
                                    mem[_3492] = uint8(stor0[stor3][5][idx].field_512)
                                    w = _3492
                                    x = 0
                                    while _3492 + 160 > w + 32:
                                        mem[0] = sub_d960e8de
                                        mem[32] = 0
                                    ...
                                    while uint8(w) < 5:
                                        ...
                                        while uint8(idx) < 5:
                                            mem[0] = sub_d960e8de
                                            mem[32] = 0
                                            if mem[(32 * uint8(idx)) + _756 + 31 len 1] != mem[(32 * uint8(idx)) + _3492 + 31 len 1]:
                                                idx = idx + 1
                                                continue 
                                            idx = idx + 1
                                            x = x + 1
