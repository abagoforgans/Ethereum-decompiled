...
function contestant(uint256 arg1) payable {
    ...
    return address(stor[code.data[801 len 32] + arg1])
}
...
function enter() payable {
    if 10^18 != msg.value:
        ...
        uint256(stor[code.data[801 len 32] + stor0.length]) = msg.sender or Mask(96, 160, uint256(stor[code.data[801 len 32] + stor0.length]))
        ...
        if stor0.length:
            if stor2 - stor1 <= 180:
                ...
                require stor0.length < stor0.length
                call address(stor[code.data[801 len 32] + stor0.length]) with:
                ...
                if not stor0.length <= 0:
                    ...
                    while stor0.length > idx:
                        ...
                        continue 
                stor0.length = 0
                idx = code.data[801 len 32]
                while code.data[801 len 32] + stor0.length > idx:
                    address(stor[idx]) = 0
                    idx = idx + 1
                    continue 
}
