...
function _fallback() payable {
    ...
    stor4 = code.data[10903 len 20]
    stor0 = code.data[10923 len 32]
    stor1[address(msg.sender)] = code.data[10923 len 32]
    emit Transfer(code.data[10923 len 32], 0, msg.sender);
    return code.data[430 len 10461]
}
...
const name = 'Transaction Ongoing System'
...
mapping of uint256 lockFundsReleaseTime;
...
function getLockFundsReleaseTime(address arg1) {
    return lockFundsReleaseTime[address(arg1)]
}
...
function removeLockFund(address arg1) {
    require msg.sender == owner
    lockFundsReleaseTime[address(arg1)] = 0
    lockFundsReleaseTime[address(arg1)] = 0
}
...
function setLockFund(address arg1, uint256 arg2) {
    ...
    lockFundsReleaseTime[address(arg1)] = arg2
}
...
function setLockFunds(address[] arg1, uint256 arg2) {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 5
        lockFundsReleaseTime[mem[(32 * idx) + 140 len 20]] = arg2
        idx = idx + 1
        continue 
}
...
function removeLockFunds(address[] arg1) {
    ...
    while idx < arg1.length:
        require idx < arg1.length
        lockFundsReleaseTime[mem[(32 * idx) + 140 len 20]] = 0
        require idx < arg1.length
        mem[0] = mem[(32 * idx) + 140 len 20]
        mem[32] = 5
        lockFundsReleaseTime[mem[(32 * idx) + 140 len 20]] = 0
...
function transfer(address arg1, uint256 arg2) {
    require block.timestamp >= lockFundsReleaseTime[address(msg.sender)]
    require arg1
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    require block.timestamp >= lockFundsReleaseTime[address(arg1)]
    if uint8(stor3.field_160):
        require not uint8(stor3.field_168)
        if adminAddress != msg.sender:
            require msg.sender == owner
