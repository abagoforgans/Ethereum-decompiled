...
function sub_0922f6cf(?) {
    ...
    staticcall stor2.0x809a9e55 with:
            gas gas_remaining wei
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return (ext_call.return_data[0] * arg2 * 10^ext_call.return_data[31 len 1])
}
                    ...
                    if var77003 - 1:
                        ...
                        if not ext_call.return_data[32]:
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            mem[768] = ext_call.return_data[0] * _2360 * 10^ext_call.return_data[31 len 1]
                        mem[608] = 736
                        mem[800] = 1
                        require ext_code.size(stor3)
                        staticcall stor3.getExchange(address arg1) with:
                    ...
                    if var82003 - 1:
                        ...
                        if not ext_call.return_data[32]:
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            mem[768] = ext_call.return_data[0] * _2356 * 10^ext_call.return_data[31 len 1]
                        mem[608] = 736
                        mem[800] = 1
                        require ext_code.size(stor3)
                        staticcall stor3.getExchange(address arg1) with:
                ...
                if not var69003 - 1:
                    ...
                    if not ext_call.return_data[32]:
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        mem[704] = ext_call.return_data[0] * _1011 * 10^ext_call.return_data[31 len 1]
                    mem[544] = 672
                    mem[736] = 1
                    require ext_code.size(stor3)
                    staticcall stor3.getExchange(address arg1) with:
                ...
                if var77003 - 1:
                    ...
                    if not ext_call.return_data[32]:
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        mem[768] = ext_call.return_data[0] * _1011 * 10^ext_call.return_data[31 len 1]
                    mem[544] = 736
                    mem[800] = 1
                    require ext_code.size(stor3)
                    staticcall stor3.getExchange(address arg1) with:
                ...
                if not var74003 - 1:
                    ...
                    if not ext_call.return_data[32]:
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        mem[704] = ext_call.return_data[0] * _1007 * 10^ext_call.return_data[31 len 1]
                    mem[544] = 672
                    mem[736] = 1
                    require ext_code.size(stor3)
                    staticcall stor3.getExchange(address arg1) with:
                ...
                if var82003 - 1:
                    ...
                    if not ext_call.return_data[32]:
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        mem[768] = ext_call.return_data[0] * _1007 * 10^ext_call.return_data[31 len 1]
                    mem[544] = 736
                    mem[800] = 1
                    require ext_code.size(stor3)
                    staticcall stor3.getExchange(address arg1) with:
            ...
            if not var61003 - 1:
                ...
                if not ext_call.return_data[32]:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[640] = ext_call.return_data[0] * _316 * 10^ext_call.return_data[31 len 1]
                mem[480] = 608
                mem[672] = 1
                require ext_code.size(stor3)
                staticcall stor3.getExchange(address arg1) with:
            ...
            if not var69003 - 1:
                ...
                if not ext_call.return_data[32]:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[704] = ext_call.return_data[0] * _316 * 10^ext_call.return_data[31 len 1]
                mem[480] = 672
                mem[736] = 1
                require ext_code.size(stor3)
                staticcall stor3.getExchange(address arg1) with:
            ...
            if var77003 - 1:
                ...
                if not ext_call.return_data[32]:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[768] = ext_call.return_data[0] * _316 * 10^ext_call.return_data[31 len 1]
                mem[480] = 736
                mem[800] = 1
                require ext_code.size(stor3)
                staticcall stor3.getExchange(address arg1) with:
            ...
            if not var66003 - 1:
                ...
                if not ext_call.return_data[32]:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[640] = ext_call.return_data[0] * _312 * 10^ext_call.return_data[31 len 1]
                mem[480] = 608
                mem[672] = 1
                require ext_code.size(stor3)
                staticcall stor3.getExchange(address arg1) with:
            ...
            if not var74003 - 1:
                ...
                if not ext_call.return_data[32]:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[704] = ext_call.return_data[0] * _312 * 10^ext_call.return_data[31 len 1]
                mem[480] = 672
                mem[736] = 1
                require ext_code.size(stor3)
                staticcall stor3.getExchange(address arg1) with:
            ...
            if var82003 - 1:
                ...
                if not ext_call.return_data[32]:
                    ...
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    mem[768] = ext_call.return_data[0] * _312 * 10^ext_call.return_data[31 len 1]
                mem[480] = 736
                mem[800] = 1
                require ext_code.size(stor3)
                staticcall stor3.getExchange(address arg1) with:
