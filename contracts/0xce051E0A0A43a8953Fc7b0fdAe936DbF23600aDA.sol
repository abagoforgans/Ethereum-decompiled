...
function sub_c93a633a(?) {
    ...
    return address(sub_c93a633a[arg1])
}
...
function totalStake() {
    ...
    while idx < sub_c93a633a.length:
        mem[0] = address(sub_c93a633a[idx])
        mem[32] = 6
        require stakes[address(stor7[idx])] >= 0
        idx = idx + 1
        continue 
    return 0
}
...
function sub_949e68ae(?) {
    ...
    sub_c93a633a.length++
    address(sub_c93a633a[sub_c93a633a.length]) = msg.sender
...
function sub_891c5ce0(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if (40 * arg2) + 39 <= ext_call.return_data[0] - 1:
        if 40 * arg2 <= (40 * arg2) + 39:
            s = 0
            idx = 40 * arg2
            while idx <= (40 * arg2) + 39:
                require ext_code.size(arg1)
                ...
                sub_c93a633a.length++
                address(sub_c93a633a[sub_c93a633a.length]) = address(ext_call.return_data[0])
        ...
        if 40 * arg2 <= ext_call.return_data[0] - 1:
            s = 0
            idx = 40 * arg2
...
function sub_1d484c1e(?) {
    ...
    if not stakes[address(arg2)]:
        sub_c93a633a.length++
        address(sub_c93a633a[sub_c93a633a.length]) = arg2
    ...
    while idx < sub_c93a633a.length:
        mem[0] = 7
        if address(sub_c93a633a[idx]) != arg1:
            idx = idx + 1
            continue 
        require sub_c93a633a.length - 1 < sub_c93a633a.length
        require idx < sub_c93a633a.length
        address(sub_c93a633a[idx]) = address(sub_c93a633a[sub_c93a633a.length])
        require sub_c93a633a.length - 1 < sub_c93a633a.length
        address(sub_c93a633a[sub_c93a633a.length]) = 0
        sub_c93a633a.length--
    ...
    sub_c93a633a.length--
    if sub_c93a633a.length > sub_c93a633a.length - 1:
        idx = sub_c93a633a.length - 1
        while sub_c93a633a.length > idx:
            uint256(sub_c93a633a[idx]) = 0
            idx = idx + 1
            continue 
    lockedTill[address(msg.sender)] = 0
    if stor8[address(arg1)]:
    ...
    if stor20.length < 100:
        ...
        while idx < stor20.length:
            ...
            while s < sub_c93a633a.length:
                mem[0] = 7
                if address(sub_c93a633a[s]) != stor20[idx]:
                    s = s + 1
                    continue 
                require sub_c93a633a.length - 1 < sub_c93a633a.length
                require s < sub_c93a633a.length
                address(sub_c93a633a[s]) = address(sub_c93a633a[sub_c93a633a.length])
                require sub_c93a633a.length - 1 < sub_c93a633a.length
                address(sub_c93a633a[sub_c93a633a.length]) = 0
                sub_c93a633a.length--
                if sub_c93a633a.length > sub_c93a633a.length - 1:
