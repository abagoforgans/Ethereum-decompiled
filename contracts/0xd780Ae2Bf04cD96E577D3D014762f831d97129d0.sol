...
const ETH_RECEIVED_MIN = 1000 * 10^18
...
const TOKEN_CREATION_CAP = 130000000 * 10^18
...
function retrieveEth(uint256 arg1, address arg2) {
    require allReceivedEth >= 1000 * 10^18
...
function deliverTeamTokens(address arg1) {
    ...
    if stor27[stor14] == stor27[stor15]:
        ...
        if totalSupply:
            require totalSupply
            require 107526 * totalSupply / totalSupply == 107526
        require 107526 * totalSupply / 100000 >= totalSupply
        balanceOf[address(arg1)] = (107526 * totalSupply / 100000) - totalSupply
        teamTokensDelivered = 1
        totalSupply = 107526 * totalSupply / 100000
        ...
        emit LogTeamTokensDelivered(((107526 * totalSupply / 100000) - totalSupply), arg1);
        stor27[stor14] = 0
        stor27[stor15] = 0
}
...
function deliverTokens(address arg1, uint256 arg2, string arg3, bool arg4) {
    require state <= 2
    require not state
    ...
    require (10^16 * arg2) + totalSupply >= totalSupply
    require (10^16 * arg2) + totalSupply >= 10^16 * arg2
    require (10^16 * arg2) + totalSupply <= 130000000 * 10^18
    totalSupply += 10^16 * arg2
    require not address(stor17[arg3[all]].field_0)
    Mask(96, 0, stor17[arg3[all]].field_0) = 0
    uint64(stor17[arg3[all]].field_96) = uint64(arg1)
    uint256(stor17[arg3[all]].field_256) = 10^16 * arg2
    uint8(stor17[arg3[all]].field_512) = 1
    ...
    if not purchaseArray.length <= purchaseArray.length + 1:
        ...
        while sha3(19) + purchaseArray.length > idx + sha3(mem[0]):
            ...
            s = s + 1
            continue 
    purchaseArray[purchaseArray.length] = (2 * arg3.length) + 1
    s = 0
    idx = arg3 + 36
    ...
    while purchaseArray[purchaseArray.length].length + 31 / 32 > idx:
        ...
        continue 
    if not arg4:
        require (10^16 * arg2) + ccLockedUpBalances[address(arg1)] >= ccLockedUpBalances[address(arg1)]
        require (10^16 * arg2) + ccLockedUpBalances[address(arg1)] >= 10^16 * arg2
        ccLockedUpBalances[address(arg1)] += 10^16 * arg2
    require (10^16 * arg2) + balanceOf[address(arg1)] >= balanceOf[address(arg1)]
    require (10^16 * arg2) + balanceOf[address(arg1)] >= 10^16 * arg2
    balanceOf[address(arg1)] += 10^16 * arg2
    if not stor20[address(arg1)]:
        holder.length++
        if not holder.length <= holder.length + 1:
            idx = holder.length + 1
    ...
    emit LogDeliverEVN((10^16 * arg2), arg1);
}
...
function createTokens() payable {
    ...
    if block.number < roundTwoBlock:
        ...
        require (142857 * ETH_USD_EXCHANGE_RATE_IN_CENTS * msg.value / 100 / 100000) + totalSupply <= 130000000 * 10^18
        ...
        emit LogCreateEVN((142857 * ETH_USD_EXCHANGE_RATE_IN_CENTS * msg.value / 100 / 100000), msg.sender);
    else:
        if block.number < roundThreeBlock:
            ...
            require (125000 * ETH_USD_EXCHANGE_RATE_IN_CENTS * msg.value / 100 / 100000) + totalSupply <= 130000000 * 10^18
            if stor29[address(msg.sender)]:
                require msg.value + stor23[address(msg.sender)] >= stor23[address(msg.sender)]
                require msg.value + stor23[address(msg.sender)] >= msg.value
                stor23[address(msg.sender)] += msg.value
            ...
            if not stor20[address(msg.sender)]:
                ...
                stor20[address(msg.sender)] = 1
            stor22[address(msg.sender)] = 1
            emit LogCreateEVN((125000 * ETH_USD_EXCHANGE_RATE_IN_CENTS * msg.value / 100 / 100000), msg.sender);
        else:
            if block.number >= roundFourBlock:
                ...
                require (100000 * ETH_USD_EXCHANGE_RATE_IN_CENTS * msg.value / 100 / 100000) + totalSupply <= 130000000 * 10^18
                if stor29[address(msg.sender)]:
                    require msg.value + stor23[address(msg.sender)] >= stor23[address(msg.sender)]
                    require msg.value + stor23[address(msg.sender)] >= msg.value
                    stor23[address(msg.sender)] += msg.value
                ...
                if not stor20[address(msg.sender)]:
                    ...
                    stor20[address(msg.sender)] = 1
                stor22[address(msg.sender)] = 1
                emit LogCreateEVN((100000 * ETH_USD_EXCHANGE_RATE_IN_CENTS * msg.value / 100 / 100000), msg.sender);
            else:
                if ETH_USD_EXCHANGE_RATE_IN_CENTS * msg.value / 100:
                    require ETH_USD_EXCHANGE_RATE_IN_CENTS * msg.value / 100
                ...
                require (111111 * ETH_USD_EXCHANGE_RATE_IN_CENTS * msg.value / 100 / 100000) + totalSupply <= 130000000 * 10^18
                if stor29[address(msg.sender)]:
                    require msg.value + stor23[address(msg.sender)] >= stor23[address(msg.sender)]
                    require msg.value + stor23[address(msg.sender)] >= msg.value
                    stor23[address(msg.sender)] += msg.value
                ...
                if not stor20[address(msg.sender)]:
                    ...
                    stor20[address(msg.sender)] = 1
                stor22[address(msg.sender)] = 1
                emit LogCreateEVN((111111 * ETH_USD_EXCHANGE_RATE_IN_CENTS * msg.value / 100 / 100000), msg.sender);
}
