...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'IWC ECOSYSTEM' / 256
    idx = 0
...
function balanceOf(address arg1) {
    ...
    if stor7[address(arg1)]:
        return stor6[address(arg1)]
    require stor5 + stor6[address(arg1)] >= stor6[address(arg1)]
    return (stor5 + stor6[address(arg1)])
}
...
function transfer(address arg1, uint256 arg2) {
    ...
    if not stor7[address(msg.sender)]:
        if currentTotalSupply < totalSupply:
            require stor5 + stor6[address(msg.sender)] >= stor6[address(msg.sender)]
            stor6[address(msg.sender)] += stor5
            stor7[address(msg.sender)] = 1
            require stor5 + currentTotalSupply >= currentTotalSupply
