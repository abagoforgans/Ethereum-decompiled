...
function _fallback() payable {
    ...
    mem[96 len -6165] = code.data[6773 len -6165]
    mem[64] = -6069
    stor3 = msg.sender
    stor8 = msg.sender
    stor3 = msg.sender
...
function mint(address arg1, uint256 arg2) {
    ...
    require not stor6
    require ext_code.size(0x754b99dd4126df9f1d661f6ce36e61d2acdb9536)
    delegate 0x754b99dd4126df9f1d661f6ce36e61d2acdb9536.0x66098d4f with:
         gas gas_remaining - 710 wei
