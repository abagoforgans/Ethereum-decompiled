...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 29 * 10^14
    stor2 = 29 * 10^14
    bool(stor3.length) = 0
    stor3.length.field_1 = 18
    stor3.length.field_112 = 0x546f72624b6ec3b6646c48696d6265657265
    idx = 0
