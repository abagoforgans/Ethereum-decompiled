...
function _fallback() payable {
    stor0 = code.data[2207 len 32] or Mask(96, 160, stor0)
    stor1 = code.data[2239 len 32]
    stor3 = block.timestamp + (60 * code.data[2271 len 32])
    stor4 = code.data[2303 len 32]
    stor5 = code.data[2335 len 32] or Mask(96, 160, stor5)
    return code.data[195 len 2012]
}
