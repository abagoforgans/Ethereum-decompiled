...
function _fallback() payable {
    stor4 = code.data[2908 len 32]
    if code.data[2940 len 32]:
        stor0 = code.data[2940 len 32]
    else:
        stor0 = 1
    stor1 = code.data[2972 len 32]
    return code.data[96 len 2812]
}
...
function vote(uint256 arg1, bool arg2) payable {
    ...
    require arg1 < stor2.length
    require uint8(stor[(9 * arg1) + 0x405787fa12a823e0f2b7631cc41b3ba8828b3321ca811111fa75cd3aa3bb5ad6][address(msg.sender)].field_0) != 1
    stor5640[arg1]++
...
function executeProposal(uint256 arg1) payable {
    ...
    while idx < stor5640[arg1]:
        ...
        mem[100] = address(stor[idx + sha3((9 * arg1) + 0x56405787fa12a823e0f2b7631cc41b3ba8828b3321ca811111fa75cd3aa3bb61)].field_8)
        call address(stor4.length).0x70a08231 with:
             gas gas_remaining - 25050 wei
    ...
    if t > minimumQuorum:
        if s <= 0:
            ...
            call address(stor5640[arg1]) with:
               funct uint32(stor5640[arg1].field_224)
               value 10^18 * stor5640[arg1] wei
                 gas gas_remaining - 34050 wei
                args Mask(224, 0, stor5640[arg1].field_0)
...
function newProposal(address arg1, uint256 arg2, string arg3, bytes32 arg4) payable {
    ...
    uint256(stor5640[stor2.length].field_0) = arg4
