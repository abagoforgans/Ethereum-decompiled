...
function _fallback() payable {
    ...
    require code.data[9443 len 32] >= block.timestamp
    require code.data[9475 len 32] >= code.data[9443 len 32]
    require code.data[9507 len 32] > 0
    require code.data[9615 len 20]
    stor0 = 0
    stor1 = code.data[9443 len 32]
    stor2 = code.data[9475 len 32]
    stor4 = code.data[9507 len 32]
    stor3 = code.data[9615 len 20]
    address(stor6.field_0) = msg.sender
    require code.data[9347 len 32] > 0
    require code.data[9647 len 20]
    stor7 = code.data[9347 len 32]
    stor8 = code.data[9379 len 32]
    stor9 = code.data[9411 len 32]
    stor10 = code.data[9539 len 32]
    stor11 = code.data[9571 len 32]
    stor12 = code.data[9647 len 20]
    return code.data[710 len 8637]
}
...
function allocateTokens(address arg1, uint256 arg2) {
    ...
    if not arg2 / rate:
        ...
        call tokenAddress.0x40c10f19 with:
             gas gas_remaining - 710 wei
            args tokenWalletAddress, 0
    else:
        require arg2 / rate
        require arg2 / rate * ownerRate / arg2 / rate == ownerRate
        require ext_code.size(tokenAddress)
        call tokenAddress.0x40c10f19 with:
             gas gas_remaining - 710 wei
            args tokenWalletAddress, arg2 / rate * ownerRate
    require ext_call.success
...
function lockupTokens(address arg1, uint256 arg2) {
    ...
    if not ownerRate:
        ...
        call tokenAddress.0x40c10f19 with:
             gas gas_remaining - 710 wei
            args tokenWalletAddress, 0 / rate
    else:
        require ownerRate
        ...
        call tokenAddress.0x40c10f19 with:
             gas gas_remaining - 710 wei
            args tokenWalletAddress, ownerRate * arg2 / rate
    require ext_call.success
    if not bonusRate:
        require ext_code.size(lockupAddress)
...
function buyTokens(address arg1) payable {
    ...
    call authorizerAddress.isAuthorized(address rg1) with:
         gas gas_remaining - 710 wei
        args msg.sender
    require ext_call.success
    require ext_code.size(tokenAddress)
    ...
    if not msg.value:
        ...
        call tokenAddress.0x40c10f19 with:
             gas gas_remaining - 710 wei
            args tokenWalletAddress, msg.value * ownerRate
    require ext_call.success
}
