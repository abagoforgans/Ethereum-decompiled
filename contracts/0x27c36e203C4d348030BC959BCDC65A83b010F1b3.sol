...
function createLiability(bytes arg1, bytes arg2) payable {
    ...
    call factoryAddress.0xfeb67918 with:
         gas gas_remaining wei
        args address(ext_call.return_data[0]), s + -gas_remaining + 5292
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0]
...
function sub_563e52d5(?) payable {
    ...
    mem[ceil32(('cd', 36).length) + 228] = ('cd', 100).length
    mem[ceil32(('cd', 36).length) + 260 len ('cd', 100).length] = call.data[cd[100] + 36 len ('cd', 100).length]
    mem[ceil32(('cd', 36).length) + ('cd', 100).length + 260] = 0
    require ext_code.size(address(cd[4]))
    call address(cd[4]).0x4fe6365e with:
         gas gas_remaining wei
        args 0, 96, bool(cd[68]), ceil32(('cd', 36).length) + 128, ('cd', 36).length, call.data[cd[36] + 36 len ('cd', 36).length], 0, mem[('cd', 36).length + 260 len ceil32(('cd', 36).length) + ceil32(('cd', 100).length) - ('cd', 36).length]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0]
    ...
    call factoryAddress.0xa51daf26 with:
         gas gas_remaining wei
        args address(cd[4]), s + -gas_remaining + 23363
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0]
