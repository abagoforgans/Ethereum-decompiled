...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[15509 len 20]
    stor2 = code.data[15509 len 20]
    require code.data[15541 len 20]
    stor5 = code.data[15541 len 20]
    if code.data[15573 len 20]:
        require msg.sender == stor0
        require code.data[15573 len 20]
        require code.data[15573 len 20] != this.address
        require code.data[15624 len 1] > 0
        require code.data[15624 len 1] <= 100
        stor7[code.data[15573 len 20]].field_0 = 0
        stor7[address(code.data[15561 len 32])].field_256 = code.data[15624 len 1]
        stor7[address(code.data[15561 len 32])].field_264 = 0
        stor7[address(code.data[15561 len 32])].field_272 = 1
        stor7[address(code.data[15561 len 32])].field_280 = 1
        stor6.length++
        if not stor6.length <= stor6.length + 1:
            ...
            while stor6.length > idx:
                ...
                idx = idx + 1
                continue 
        address(stor6[stor6.length]) = code.data[15573 len 20]
        stor8 = uint8(stor8 + code.data[15593 len 32])
    return code.data[1690 len 13807]
}
...
function getSaleReturn(address arg1, uint256 arg2) {
    ...
    require reserves[address(arg1)].field_280
    if reserves[address(arg1)].field_264:
        if 2 * reserves[address(arg1)].field_0 >= reserves[address(arg1)].field_0:
            if ext_code.size(formulaAddress):
                call formulaAddress.0xd39cce1c with:
                     gas gas_remaining - 710 wei
                    args 0, ext_call.return_data[28 len 4], 2 * reserves[address(arg1)].field_0, reserves[address(arg1)].field_256, arg2
                if ext_call.success:
                    return ext_call.return_data[0]
    else:
        if ext_code.size(arg1):
            call arg1.0x70a08231 with:
                ...
                args this.address
            if ext_call.success:
                if ext_call.return_data[0] + reserves[address(arg1)].field_0 >= ext_call.return_data[0]:
                    if ext_code.size(formulaAddress):
                        call formulaAddress.0xd39cce1c with:
                             gas gas_remaining - 710 wei
                            args 0, ext_call.return_data[28 len 4], ext_call.return_data[0] + reserves[address(arg1)].field_0, reserves[address(arg1)].field_256, arg2
                        if ext_call.success:
                            return ext_call.return_data[0]
    revert
}
...
function getPurchaseReturn(address arg1, uint256 arg2) {
    require reserves[address(arg1)].field_280
    require reserves[address(arg1)].field_272
    require ext_code.size(tokenAddress)
    call tokenAddress.0x18160ddd with:
         gas gas_remaining - 710 wei
    require ext_call.success
...
function buy(address arg1, uint256 arg2, uint256 arg3) {
    ...
    require reserves[address(arg1)].field_280
    if reserves[address(arg1)].field_264:
        require 2 * reserves[address(arg1)].field_0 >= reserves[address(arg1)].field_0
        ...
        call arg1.0x70a08231 with:
            ...
            args this.address
        require ext_call.success
        require ext_call.return_data[0] + reserves[address(arg1)].field_0 >= ext_call.return_data[0]
        require ext_code.size(formulaAddress)
        call formulaAddress.0xa78e887c with:
             gas gas_remaining - 710 wei
            args 0, ext_call.return_data[28 len 4], ext_call.return_data[0] + reserves[address(arg1)].field_0, reserves[address(arg1)].field_256, arg2
...
function sell(address arg1, uint256 arg2, uint256 arg3) {
    ...
    require reserves[address(arg1)].field_280
    if reserves[address(arg1)].field_264:
        require reserves[address(arg1)].field_0 + uint256(stor0) >= reserves[address(arg1)].field_0
        require ext_call.return_data[0] <= reserves[address(arg1)].field_0 + uint256(stor0)
        require ext_code.size(tokenAddress)
        call tokenAddress.0x18160ddd with:
             gas gas_remaining - 710 wei
        require ext_call.success
        if ext_call.return_data[0] >= reserves[address(arg1)].field_0 + uint256(stor0):
            require arg2 == ext_call.return_data[0]
    else:
        require ext_code.size(arg1)
        call arg1.0x70a08231 with:
            ...
            args this.address
        require ext_call.success
        require ext_call.return_data[0] + uint256(stor0) >= ext_call.return_data[0]
        require ext_call.return_data[0] <= ext_call.return_data[0] + uint256(stor0)
        require ext_code.size(tokenAddress)
        call tokenAddress.0x18160ddd with:
             gas gas_remaining - 710 wei
        require ext_call.success
        if ext_call.return_data[0] >= ext_call.return_data[0] + uint256(stor0):
            require arg2 == ext_call.return_data[0]
    if reserves[address(arg1)].field_264:
                ...
                if reserves[address(arg1)].field_264:
                    if 2 * reserves[address(arg1)].field_0 >= reserves[address(arg1)].field_0:
                        if ext_code.size(formulaAddress):
                            call formulaAddress.0xa78e887c with:
                                 gas gas_remaining - 710 wei
                                args 0, ext_call.return_data[28 len 4], 2 * reserves[address(arg1)].field_0, reserves[address(arg1)].field_256, arg3
                            if ext_call.success:
                                return ext_call.return_data[0]
                else:
                    if ext_code.size(arg1):
                        ...
                        if ext_call.success:
                            if ext_call.return_data[0] + reserves[address(arg1)].field_0 >= ext_call.return_data[0]:
                                if ext_code.size(formulaAddress):
                                    call formulaAddress.0xa78e887c with:
                                         gas gas_remaining - 710 wei
                                        args 0, ext_call.return_data[28 len 4], ext_call.return_data[0] + reserves[address(arg1)].field_0, reserves[address(arg1)].field_256, arg3
                                    if ext_call.success:
                                        return ext_call.return_data[0]
    else:
        if arg1 == tokenAddress:
            if ext_code.size(tokenAddress):
                ...
                if ext_call.success:
                    ...
                    if reserves[address(arg2)].field_264:
                        if 2 * reserves[address(arg2)].field_0 >= reserves[address(arg2)].field_0:
                            if ext_code.size(formulaAddress):
                                call formulaAddress.0xd39cce1c with:
                                     gas gas_remaining - 710 wei
                                    args 0, ext_call.return_data[28 len 4], 2 * reserves[address(arg2)].field_0, reserves[address(arg2)].field_256, arg3
                                if ext_call.success:
                                    return ext_call.return_data[0]
                    else:
                        if ext_code.size(arg2):
                            call arg2.0x70a08231 with:
                                ...
                                args this.address
                            if ext_call.success:
                                if ext_call.return_data[0] + reserves[address(arg2)].field_0 >= ext_call.return_data[0]:
                                    if ext_code.size(formulaAddress):
                                        call formulaAddress.0xd39cce1c with:
                                             gas gas_remaining - 710 wei
                                            args 0, ext_call.return_data[28 len 4], ext_call.return_data[0] + reserves[address(arg2)].field_0, reserves[address(arg2)].field_256, arg3
                                        if ext_call.success:
                                            return ext_call.return_data[0]
        else:
            require reserves[address(arg1)].field_280
                                                ...
                                                if reserves[address(arg2)].field_264:
                                                    if 2 * reserves[address(arg2)].field_0 >= reserves[address(arg2)].field_0:
                                                        if ext_code.size(formulaAddress):
                                                            call formulaAddress.0xd39cce1c with:
                                                                 gas gas_remaining - 710 wei
                                                                args 0, 2 * ext_call.return_data[0] % 2147483648, 2 * reserves[address(arg2)].field_0, reserves[address(arg2)].field_256, ext_call.return_data[0]
                                                            if ext_call.success:
                                                                return ext_call.return_data[0]
                                                else:
                                                    if ext_code.size(arg2):
                                                        ...
                                                        if ext_call.success:
                                                            if ext_call.return_data[0] + reserves[address(arg2)].field_0 >= ext_call.return_data[0]:
                                                                if ext_code.size(formulaAddress):
                                                                    call formulaAddress.0xd39cce1c with:
                                                                         gas gas_remaining - 710 wei
                                                                        args 0, 2 * ext_call.return_data[0] % 2147483648, ext_call.return_data[0] + reserves[address(arg2)].field_0, reserves[address(arg2)].field_256, ext_call.return_data[0]
                                                                    if ext_call.success:
                                                                        return ext_call.return_data[0]
                    else:
                        if ext_code.size(arg1):
...
function change(address arg1, address arg2, uint256 arg3, uint256 arg4) {
    ...
    if arg2 == tokenAddress:
        ...
        if arg1 == tokenAddress:
            ...
            require reserves[address(arg2)].field_280
            if reserves[address(arg2)].field_264:
                require 2 * reserves[address(arg2)].field_0 >= reserves[address(arg2)].field_0
                require ext_code.size(formulaAddress)
                call formulaAddress.0xd39cce1c with:
                     gas gas_remaining - 710 wei
                    args 0, ext_call.return_data[28 len 4], 2 * reserves[address(arg2)].field_0, reserves[address(arg2)].field_256, arg3
                ...
                call arg2.0x70a08231 with:
                    ...
                    args this.address
                require ext_call.success
                require ext_call.return_data[0] + reserves[address(arg2)].field_0 >= ext_call.return_data[0]
                require ext_code.size(formulaAddress)
                call formulaAddress.0xd39cce1c with:
                     gas gas_remaining - 710 wei
                    args 0, ext_call.return_data[28 len 4], ext_call.return_data[0] + reserves[address(arg2)].field_0, reserves[address(arg2)].field_256, arg3
            ...
            require reserves[address(arg2)].field_280
            if reserves[address(arg2)].field_264:
                require reserves[address(arg2)].field_0 + uint256(stor0) >= reserves[address(arg2)].field_0
                require ext_call.return_data[0] <= reserves[address(arg2)].field_0 + uint256(stor0)
                require ext_code.size(tokenAddress)
                call tokenAddress.0x18160ddd with:
                     gas gas_remaining - 710 wei
                require ext_call.success
                if ext_call.return_data[0] >= reserves[address(arg2)].field_0 + uint256(stor0):
                    require arg3 == ext_call.return_data[0]
            else:
                require ext_code.size(arg2)
                call arg2.0x70a08231 with:
            ...
            if reserves[address(arg2)].field_264:
                ...
                call formulaAddress.0xd39cce1c with:
                     gas gas_remaining - 710 wei
                    args 0, ext_call.return_data[28 len 4], 2 * reserves[address(arg2)].field_0, reserves[address(arg2)].field_256, ext_call.return_data[0]
            else:
                require ext_code.size(arg2)
                call arg2.0x70a08231 with:
                     gas gas_remaining - 710 wei
                ...
                call formulaAddress.0xd39cce1c with:
                     gas gas_remaining - 710 wei
                    args 0, ext_call.return_data[28 len 4], ext_call.return_data[0] + reserves[address(arg2)].field_0, reserves[address(arg2)].field_256, ext_call.return_data[0]
            require ext_call.success
            require ext_call.return_data[0]
            require ext_call.return_data[0] >= arg4
            require reserves[address(arg2)].field_280
