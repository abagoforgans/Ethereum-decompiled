...
function create(address arg1, string arg2, bytes32 arg3, uint256 arg4, address arg5) payable {
            ...
            if msg.value > buildingCostWei:
                call msg.sender with:
                   value msg.value - buildingCostWei wei
                     gas 2300 * is_zero(value) wei
                require ext_call.success
    require ext_code.size(0x33098a5e8f5e932831434748cdad425487b9aaf1)
    delegate 0x33098a5e8f5e932831434748cdad425487b9aaf1.0x980934ec with:
