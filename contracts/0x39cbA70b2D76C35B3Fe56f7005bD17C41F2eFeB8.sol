...
function _fallback() payable {
    ...
    stor5 = code.data[7158 len 20]
    stor3 = code.data[7178 len 32]
    stor4 = code.data[7210 len 32]
    require stor10 <= 3
    if stor10 != 3:
        require stor10 <= 3
        if stor10 != 2:
...
function buy(address arg1) payable {
    ...
    if not _saleState:
        ...
        require totalSupply + (42007 * msg.value) >= totalSupply
        require crowdsaleSupply + (42007 * msg.value) >= crowdsaleSupply
        require totalSupply + (42007 * msg.value) < tokenCap
        require crowdsaleSupply + (42007 * msg.value) < crowdsaleAllocation
        require balanceOf[address(arg1)] + (42007 * msg.value) >= balanceOf[address(arg1)]
        ...
        if _saleState != 1:
            ...
            require totalSupply + (21000 * msg.value) >= totalSupply
            require crowdsaleSupply + (21000 * msg.value) >= crowdsaleSupply
            require totalSupply + (21000 * msg.value) < tokenCap
            require crowdsaleSupply + (21000 * msg.value) < crowdsaleAllocation
            require balanceOf[address(arg1)] + (21000 * msg.value) >= balanceOf[address(arg1)]
            ...
            if block.number <= startBlock + (128 * 3600):
                ...
                require totalSupply + (31500 * msg.value) >= totalSupply
                require crowdsaleSupply + (31500 * msg.value) >= crowdsaleSupply
                require totalSupply + (31500 * msg.value) < tokenCap
                require crowdsaleSupply + (31500 * msg.value) < crowdsaleAllocation
                require balanceOf[address(arg1)] + (31500 * msg.value) >= balanceOf[address(arg1)]
...
function _fallback() payable {
    ...
    if not _saleState:
        ...
        require totalSupply + (42007 * msg.value) < tokenCap
        require crowdsaleSupply + (42007 * msg.value) < crowdsaleAllocation
        require balanceOf[address(msg.sender)] + (42007 * msg.value) >= balanceOf[address(msg.sender)]
        ...
        if _saleState != 1:
            ...
            require totalSupply + (21000 * msg.value) < tokenCap
            require crowdsaleSupply + (21000 * msg.value) < crowdsaleAllocation
            require balanceOf[address(msg.sender)] + (21000 * msg.value) >= balanceOf[address(msg.sender)]
            ...
            if block.number <= startBlock + (128 * 3600):
                ...
                require totalSupply + (31500 * msg.value) < tokenCap
                require crowdsaleSupply + (31500 * msg.value) < crowdsaleAllocation
                require balanceOf[address(msg.sender)] + (31500 * msg.value) >= balanceOf[address(msg.sender)]
