...
function leave() {
    ...
    sub_0d69ac04[Mask(32, 224, stor0[msg.sender].field_256)] = 0
    sub_2b19e34e[Mask(160, 96, stor0[msg.sender].field_768)] = 0
    sub_ada78075[msg.sender].field_0 = 0
    if 31 < sub_ada78075[msg.sender].length:
        idx = 0
        while sub_ada78075[msg.sender].length + 31 / 32 > idx:
            sub_ada78075[msg.sender][idx].field_0 = 0
            idx = idx + 1
            continue 
    sub_ada78075[msg.sender].field_256 = 0
    sub_ada78075[msg.sender].field_512 = 0
    if 31 < sub_ada78075[msg.sender][2].length:
        idx = 0
        while sub_ada78075[msg.sender][2].length + 31 / 32 > idx:
            sub_ada78075[msg.sender][idx + 2].field_0 = 0
            idx = idx + 1
            continue 
    sub_ada78075[msg.sender].field_768 = 0
    sub_ada78075[msg.sender].field_1024 = 0
    sub_ada78075[msg.sender].field_1280 = 0
