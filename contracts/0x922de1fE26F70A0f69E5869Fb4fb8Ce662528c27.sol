...
const sub_0e9c2a53(?) = (block.timestamp + 61)
...
const sub_54f42b66(?) = (block.timestamp + 7321)

const sub_57077019(?) = 3600

const sub_649d75a7(?) = 2 * 10^9

const finalizeStartTime = (block.timestamp + 10981)

const finalizeEndTime = (block.timestamp + 31536010981)
...
const sub_aa4cfe0f(?) = (block.timestamp + 10921)

const tokensPerCHF = 10

const sub_e19b8c26(?) = (block.timestamp + 7261)
