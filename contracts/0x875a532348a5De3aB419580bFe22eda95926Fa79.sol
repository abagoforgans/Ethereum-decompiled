...
function _fallback() payable {
    mem[96 len -1090] = code.data[1602 len -1090]
    mem[64] = -994
    mem[32] = 3
...
function create(address arg1, uint256 arg2) payable {
    ...
    balanceOf[address(arg1)] += arg2 * uint8(10^decimals)
    emit Transfer((arg2 * uint8(10^decimals)), 0, arg1);
}
...
function destroy(uint256 arg1) payable {
    ...
    balanceOf[address(msg.sender)] += -1 * arg1 * uint8(10^decimals)
    emit Transfer((-1 * arg1 * uint8(10^decimals)), msg.sender, 0);
}
