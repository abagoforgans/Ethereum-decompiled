...
function _fallback() payable {
    ...
    stor0 = msg.sender
    address(stor11.field_8) = address(code.data[7582 len 32])
    bool(stor1.length) = 0
    stor1.length.field_1 = 21
    stor1.length.field_8 = 'Sharpe Platform Token' / 256
    idx = 0
