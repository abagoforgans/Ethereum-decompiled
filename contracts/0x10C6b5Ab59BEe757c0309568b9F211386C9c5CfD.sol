...
mapping of uint256 stor18229899224800559576703814021310056227045488497972289045743625528708495403;
...
function deposit() payable {
    require msg.value + storA515[msg.sender] >= storA515[msg.sender]
    require msg.value + storA515[msg.sender] >= msg.value
    storA515[msg.sender] += msg.value
    emit Deposit(0, msg.sender, msg.value, msg.value + storA515[msg.sender]);
}
...
function withdraw(uint256 arg1) {
    require arg1 <= storA515[msg.sender]
    require arg1 <= storA515[msg.sender]
    storA515[msg.sender] -= arg1
    call msg.sender with:
       value arg1 wei
         gas gas_remaining wei
    require ext_call.success
    emit Withdraw(0, msg.sender, arg1, storA515[msg.sender]);
}
...
function sub_67679360(?) {
    if block.number - stor19[msg.sender] / 548000 > 100:
    ...
    if block.number - stor19[msg.sender] / 548000 < 0:
        return ((block.number * 18 * invested[address(arg1)] / 1000) - (sub_f490df26[address(arg1)] * 18 * invested[address(arg1)] / 1000) / 5900)
    require 2^(block.number - stor19[msg.sender] / 548000)
    return ((block.number * 18 * invested[address(arg1)] / 1000) - (sub_f490df26[address(arg1)] * 18 * invested[address(arg1)] / 1000) / 5900 / 2^(block.number - stor19[msg.sender] / 548000))
}
...
function getIncome(address arg1) {
    ...
    require 2^(block.number - stor19[msg.sender] / 548000)
    return (bonus[address(arg1)] + sub_268c01cf[address(arg1)][0] + ((block.number * 18 * invested[address(arg1)] / 1000) - (sub_f490df26[address(arg1)] * 18 * invested[address(arg1)] / 1000) / 5900 / 2^(block.number - stor19[msg.sender] / 548000)))
}
        ...
        if sub_22be4e68 > sub_b979d22b:
            ...
            while idx <= sub_7cfd2964:
                if 2 * invested[stor13[idx]] <= bonus[stor13[idx]]:
                    ...
                    mem[32] = 19
                    stor19[stor13[idx]] = block.number
                    idx = idx + 1
                    s = s
                    t = investor[idx]
                    continue 
