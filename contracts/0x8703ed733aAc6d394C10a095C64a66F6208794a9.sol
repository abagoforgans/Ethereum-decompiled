...
function _fallback() payable {
    ...
    stor4 = code.data[7875 len 20]
    stor5 = 0
    stor6 = 0
    stor7 = 0
    stor8 = 10^18 * code.data[7895 len 32]
    stor0 = 200000000 * 10^18
    stor1[address(msg.sender)] = stor0
    require stor8 <= stor0
    return code.data[640 len 7223]
}
...
const name = Array(len=45, data='German New Energy Development Ec', 'ological Pass', Mask(104, -256, 'German New Energy Development Ec', 'ological Pass') << 256)
