...
function _fallback() payable {
    ...
    stor0 = msg.sender
    address(stor9.field_8) = code.data[3917 len 20]
    stor11 = code.data[3937 len 32]
    stor8 = code.data[3969 len 32]
    stor0 = msg.sender
    return code.data[189 len 3716]
}
