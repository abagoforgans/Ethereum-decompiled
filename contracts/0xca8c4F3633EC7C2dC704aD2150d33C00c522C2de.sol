...
function _fallback() {
    ...
    stor3.length.field_8 = 'Arysum Tokens' / 256
    idx = 0
    ...
    stor4 = 0
    stor5 = 10^6
    stor6[0xd873696a3dda855676777861294820f4f91a39fd] = stor5
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  stor5,
    emit 0x0: stor5
    emit 0xd873696a: stor5
    return code.data[685 len 5596]
}
