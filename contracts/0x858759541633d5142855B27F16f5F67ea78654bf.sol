...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor0 = msg.sender
    require code.data[2100 len 32]
    require code.data[2132 len 32]
    stor6 = code.data[2132 len 32]
    stor5 = code.data[2100 len 32]
    return code.data[148 len 1952]
}
...
function invest() payable {
    require not moving
    require ext_code.size(0x8fd011ad5d39da2f0a09c2d89e7d6ae861fe42ba)
    delegate 0x8fd011ad5d39da2f0a09c2d89e7d6ae861fe42ba.0x66098d4f with:
