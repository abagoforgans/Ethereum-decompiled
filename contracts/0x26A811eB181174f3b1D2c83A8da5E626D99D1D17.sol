...
function _fallback() {
    stor0 = msg.sender
    stor3 = 18
    stor4 = 398462298 * 10^18
    stor5[address(msg.sender)] = stor4
    bool(stor1.length) = 0
    stor1.length.field_1 = 15
    stor1.length.field_8 = 'BouncyCoinToken' / 256
    idx = 0
    ...
    stor2.length.field_8 = 'BOUNCY' / 256
    idx = 0
    while stor2.length + 31 / 32 > idx:
        stor2[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[614 len 6476]
}
...
const _myTokeName = 'BouncyCoinToken'

const _mySymbol = 'BOUNCY'

const _myinitialSupply = 398462298
