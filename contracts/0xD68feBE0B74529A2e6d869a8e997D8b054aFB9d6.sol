...
function _fallback() payable {
    ...
    stor4 = 8
    stor0[address(msg.sender)] = 25 * 10^6 * 10^stor4
    bool(stor3.length) = 0
    stor3.length.field_1 = 9
    stor3.length.field_8 = 'TORQToken' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'TORQ' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    stor2 = 25 * 10^6 * 10^stor4
    return code.data[603 len 4004]
}
