...
const getLavaDomainTypehash = sha3('EIP712Domain(string contractName', ',string version,uint256 chainId,', Mask(208, 48, 'address verifyingContract)') >> 48)
...
function getLavaTypedDataHash(string arg1, address arg2, address arg3, address arg4, address arg5, uint256 arg6, uint256 arg7, uint256 arg8, uint256 arg9) {
    ...
    return sha3(0, sha3(sha3('EIP712Domain(string contractName', ',string version,uint256 chainId,', 'address verifyingContract)'), sha3('Lava Wallet'), sha3('1'), 1, this.address), sha3(sha3(), sha3(arg1[all]), address(arg2), address(arg3), address(arg4), address(arg5), arg6, arg7, arg8, arg9))
}
...
function getEIP712DomainHash(string arg1, string arg2, uint256 arg3, address arg4) {
    ...
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 160] = 'EIP712Domain(string contractName'
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 192] = ',string version,uint256 chainId,'
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 192] = sha3(Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 0), mem[ceil32(arg1.length) + arg2.length + 192 len ceil32(arg2.length) + -arg2.length + 32], 'address verifyingContract)')
...
function burnSignature(string arg1, address arg2, address arg3, address arg4, address arg5, uint256 arg6, uint256 arg7, uint256 arg8, uint256 arg9, bytes arg10) {
    ...
    if arg10.length != 65:
        ...
        if uint8((Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 224, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1')))))), 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 224, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1')))))), 32))), 0) - 256) + 27) == 27:
            signer = erecover(sha3(0, sha3(sha3('EIP712Domain(string contractName', ',string version,uint256 chainId,', 'address verifyingContract)'), sha3('Lava Wallet'), sha3('1'), 1, this.address), sha3(sha3(), sha3(arg1[all]), address(arg2), address(arg3), address(arg4), address(arg5), arg6, arg7, arg8, arg9)), (Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 224, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1')))))), 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 224, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1')))))), 32))), 0) - 256) + 27 << 248, mem[ceil32(arg1.length) + 160], mem[ceil32(arg1.length) + 192]) 
