...
function _fallback() payable {
    ...
    mem[96 len -11254] = code.data[12152 len -11254]
    mem[64] = -11158
    ...
    require mem[352] > 0
    create contract with 0 wei
                    code: code.data[7862 len 1562], stor3
    require create.new_address
...
function buyTokens(address arg1) payable {
    ...
    if block.timestamp <= icoStartTime:
        if msg.value:
            require msg.value
            require 249999900 * msg.value / msg.value == 249999900
        require ext_code.size(tokenAddress)
        call tokenAddress.0x18160ddd with:
             gas gas_remaining - 710 wei
        require ext_call.success
        require (249999900 * msg.value) + ext_call.return_data[0] >= ext_call.return_data[0]
        require msg.value + weiRaised >= weiRaised
        require block.number >= startBlock
        require block.number <= endBlock
        require msg.value
        require msg.value + weiRaised <= cap
        require (249999900 * msg.value) + ext_call.return_data[0] <= tokenCap
    else:
        require icoStartTime + (168 * 24 * 3600) >= icoStartTime
        if block.timestamp <= icoStartTime + (168 * 24 * 3600):
            if msg.value:
    ...
    if block.timestamp > icoStartTime:
        ...
        if block.timestamp > icoStartTime:
            ...
            if block.timestamp <= icoStartTime:
                ...
                call tokenAddress.0x40c10f19 with:
                     gas gas_remaining - 710 wei
                    args address(arg1), 249999900 * msg.value
                require ext_call.success
                emit TokenPurchase(msg.value, 249999900 * msg.value, msg.sender, arg1);
            else:
                require icoStartTime + (168 * 24 * 3600) >= icoStartTime
                if block.timestamp <= icoStartTime + (168 * 24 * 3600):
                    if msg.value:
    ...
    if block.timestamp > icoStartTime:
        ...
        if block.timestamp > icoStartTime:
            ...
            if block.timestamp <= icoStartTime:
                ...
                call tokenAddress.0x40c10f19 with:
                     gas gas_remaining - 710 wei
                    args msg.sender, 249999900 * msg.value
                require ext_call.success
                emit TokenPurchase(msg.value, 249999900 * msg.value, msg.sender, msg.sender);
            else:
                require icoStartTime + (168 * 24 * 3600) >= icoStartTime
                if block.timestamp <= icoStartTime + (168 * 24 * 3600):
                    if msg.value:
