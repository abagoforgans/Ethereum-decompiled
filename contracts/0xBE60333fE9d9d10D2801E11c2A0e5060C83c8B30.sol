...
function extensionAsset() payable {
    return extensionAssetAddress
}
...
function setExtensionAssetAddress(address arg1) payable {
    require calldata.size - 4 >= 32
    require msg.sender == owner
    extensionAssetAddress = arg1
}
...
function depositExtension(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require not stor3
    require ext_code.size(extensionAssetAddress)
    call extensionAssetAddress.safeTransferFrom(address arg1, address arg2, uint256 arg3) with:
...
function mintExtension(address arg1, uint256 arg2, bytes32 arg3) payable {
    require calldata.size - 4 >= 96
    require msg.sender
    require stor1[address(msg.sender)]
    require not stor6[arg3]
    require ext_code.size(extensionAssetAddress)
    call extensionAssetAddress.mintExtensionAsset(address arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function withdrawExtensionWithMint(address arg1, uint256 arg2, bytes32 arg3) payable {
    require calldata.size - 4 >= 96
    require msg.sender
    require stor1[address(msg.sender)]
    require not stor6[arg3]
    require ext_code.size(extensionAssetAddress)
    staticcall extensionAssetAddress.isAlreadyMinted(uint256 arg1) with:
            gas gas_remaining wei
           args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function transferAllTokensOfGateway(address arg1) payable {
    ...
    require msg.sender == owner
    require ext_code.size(extensionAssetAddress)
    staticcall extensionAssetAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    ...
    while idx > 0:
        require ext_code.size(extensionAssetAddress)
        staticcall extensionAssetAddress.tokenOfOwnerByIndex(address arg1, uint256 arg2) with:
                gas gas_remaining wei
