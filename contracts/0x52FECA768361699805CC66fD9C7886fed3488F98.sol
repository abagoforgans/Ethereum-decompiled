...
function sub_70914237(?) {
    ...
    require stor1[address(msg.sender)]
    require ext_code.size(etherdeltaAddress)
    staticcall etherdeltaAddress.feeTake() with:
            gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if ext_call.return_data[0] <= call.data[132] * ext_call.return_data[0] / call.data[100]:
        require ext_code.size(etherdeltaAddress)
        staticcall etherdeltaAddress.0xf7888aec with:
                gas gas_remaining wei
               args 0, this.address
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if ext_call.return_data[0] >= ext_call.return_data[0] + (ext_call.return_data[0] * ext_call.return_data[0] / 10^18):
            ...
            require 10^18 * ext_call.return_data[0] / ext_call.return_data[0] + 10^18 > 0
            require ext_code.size(etherdeltaAddress)
            call etherdeltaAddress.trade(address arg1, uint256 arg2, address arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint8 arg8, bytes32 arg9, bytes32 arg10, uint256 arg11) with:
                 gas gas_remaining wei
                args 0, call.data[100], address(call.data[4]), call.data[132], call.data[164], call.data[196], address(call.data[36]), call.data[356] << 248, call.data[420], call.data[452], 10^18 * ext_call.return_data[0] / ext_call.return_data[0] + 10^18
    else:
        require call.data[100]
        require ext_code.size(etherdeltaAddress)
        staticcall etherdeltaAddress.0xf7888aec with:
        ...
        require return_data.size >= 32
        if ext_call.return_data[0] >= call.data[132] * ext_call.return_data[0] / call.data[100]:
            if ext_call.return_data[0] >= (call.data[132] * ext_call.return_data[0] / call.data[100]) + (call.data[132] * ext_call.return_data[0] / call.data[100] * ext_call.return_data[0] / 10^18):
                require call.data[132] * ext_call.return_data[0] / call.data[100] > 0
                require ext_code.size(etherdeltaAddress)
                call etherdeltaAddress.trade(address arg1, uint256 arg2, address arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint8 arg8, bytes32 arg9, bytes32 arg10, uint256 arg11) with:
                     gas gas_remaining wei
                    args 0, call.data[100], address(call.data[4]), call.data[132], call.data[164], call.data[196], address(call.data[36]), call.data[356] << 248, call.data[420], call.data[452], call.data[132] * ext_call.return_data[0] / call.data[100]
            else:
                require ext_call.return_data[0] + 10^18
                require 10^18 * call.data[132] * ext_call.return_data[0] / call.data[100] / ext_call.return_data[0] + 10^18 > 0
                require ext_code.size(etherdeltaAddress)
                call etherdeltaAddress.trade(address arg1, uint256 arg2, address arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint8 arg8, bytes32 arg9, bytes32 arg10, uint256 arg11) with:
                     gas gas_remaining wei
                    args 0, call.data[100], address(call.data[4]), call.data[132], call.data[164], call.data[196], address(call.data[36]), call.data[356] << 248, call.data[420], call.data[452], 10^18 * call.data[132] * ext_call.return_data[0] / call.data[100] / ext_call.return_data[0] + 10^18
        else:
            if ext_call.return_data[0] >= ext_call.return_data[0] + (ext_call.return_data[0] * ext_call.return_data[0] / 10^18):
                require ext_call.return_data[0] > 0
                require ext_code.size(etherdeltaAddress)
    ...
    if ext_call.return_data[0] >= ext_call.return_data[0] + (ext_call.return_data[0] * ext_call.return_data[0] / 10^18):
        ...
        call etherdeltaAddress.trade(address arg1, uint256 arg2, address arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint8 arg8, bytes32 arg9, bytes32 arg10, uint256 arg11) with:
             gas gas_remaining wei
            args address(call.data[4]), call.data[228], 0, call.data[260], call.data[292], call.data[324], address(call.data[68]), call.data[388] << 248, call.data[484], call.data[516], 10^18 * ext_call.return_data[0] / ext_call.return_data[0] + 10^18
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(etherdeltaAddress)
    staticcall etherdeltaAddress.0xf7888aec with:
