...
function sub_ce458581(?) {
    if not stor6[address(arg1)].field_512:
        return 0
    return 1
}
...
function sub_80fb948c(?) {
    ...
    mem[224] = stor6[stor7[arg1]].length
    mem[256] = stor6[stor7[arg1]].field_0
    idx = 256
    s = 0
    while stor6[stor7[arg1]].length + 224 > idx:
        mem[idx + 32] = stor6[stor7[arg1]][s].field_256
        idx = idx + 32
        s = s + 1
        continue 
    mem[32] = 6
    mem[64] = ceil32(stor6[stor7[arg1]].length) + ceil32(stor6[stor7[arg1]][1].length) + 288
    mem[ceil32(stor6[stor7[arg1]].length) + 256] = stor6[stor7[arg1]][1].length
    mem[0] = sha3(stor7[arg1], 6) + 1
    mem[ceil32(stor6[stor7[arg1]].length) + 288] = stor6[stor7[arg1]][1].field_0
    idx = ceil32(stor6[stor7[arg1]].length) + 288
    s = 0
    while ceil32(stor6[stor7[arg1]].length) + stor6[stor7[arg1]][1].length + 256 > idx:
        mem[idx + 32] = stor6[stor7[arg1]][s + 1].field_256
        idx = idx + 32
        s = s + 1
        continue 
    mem[ceil32(stor6[stor7[arg1]].length) + ceil32(stor6[stor7[arg1]][1].length) + 288] = stor7[arg1]
    mem[ceil32(stor6[stor7[arg1]].length) + ceil32(stor6[stor7[arg1]][1].length) + 320] = 96
    mem[ceil32(stor6[stor7[arg1]].length) + ceil32(stor6[stor7[arg1]][1].length) + 384] = stor6[stor7[arg1]].length
    mem[ceil32(stor6[stor7[arg1]].length) + ceil32(stor6[stor7[arg1]][1].length) + 416 len ceil32(stor6[stor7[arg1]].length)] = mem[256 len ceil32(stor6[stor7[arg1]].length)]
    mem[ceil32(stor6[stor7[arg1]].length) + ceil32(stor6[stor7[arg1]][1].length) + 352] = stor6[stor7[arg1]].length + 128
    mem[stor6[stor7[arg1]].length + ceil32(stor6[stor7[arg1]].length) + ceil32(stor6[stor7[arg1]][1].length) + 416] = stor6[stor7[arg1]][1].length
    mem[stor6[stor7[arg1]].length + ceil32(stor6[stor7[arg1]].length) + ceil32(stor6[stor7[arg1]][1].length) + 448 len ceil32(stor6[stor7[arg1]][1].length)] = mem[ceil32(stor6[stor7[arg1]].length) + 288 len ceil32(stor6[stor7[arg1]][1].length)]
    if not stor6[stor7[arg1]][1].length % 32:
        return stor7[arg1], 
               Array(len=stor6[stor7[arg1]].length, data=mem[256 len ceil32(stor6[stor7[arg1]].length)], mem[(2 * ceil32(stor6[stor7[arg1]].length)) + ceil32(stor6[stor7[arg1]][1].length) + 416 len stor6[stor7[arg1]][1].length + stor6[stor7[arg1]].length + -ceil32(stor6[stor7[arg1]].length) + 32]),
               stor6[stor7[arg1]].length + 128
    mem[floor32(stor6[stor7[arg1]][1].length) + stor6[stor7[arg1]].length + ceil32(stor6[stor7[arg1]].length) + ceil32(stor6[stor7[arg1]][1].length) + 448] = mem[floor32(stor6[stor7[arg1]][1].length) + stor6[stor7[arg1]].length + ceil32(stor6[stor7[arg1]].length) + ceil32(stor6[stor7[arg1]][1].length) + -stor6[stor7[arg1]][1].length % 32 + 480 len stor6[stor7[arg1]][1].length % 32]
    return stor7[arg1], 
           Array(len=stor6[stor7[arg1]].length, data=mem[256 len ceil32(stor6[stor7[arg1]].length)], mem[(2 * ceil32(stor6[stor7[arg1]].length)) + ceil32(stor6[stor7[arg1]][1].length) + 416 len floor32(stor6[stor7[arg1]][1].length) + stor6[stor7[arg1]].length + -ceil32(stor6[stor7[arg1]].length) + 64]),
           stor6[stor7[arg1]].length + 128
}
...
function sub_0ade8f90(?) {
    ...
    if address(ext_call.return_data[0]) == msg.sender:
        ...
        mem[333 len 0] = None
        mem[333 len 13] = Mask(104, 0, 0x4d656d626572466561747572, 0)
