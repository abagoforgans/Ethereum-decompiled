...
function getPackage(string arg1) {
    ...
    mem[ceil32(arg1.length) + 128 len 96] = code.data[6046 len 96]
...
function create(string arg1, string arg2, address arg3, bytes arg4) payable {
    ...
    if not address(stor[mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg4.length) + floor32(arg1.length) + 192 len (arg1.length % 32) + 32]][call.data[arg1 + 36 len floor32(arg1.length)]]):
        mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg4.length) + 192 len 2986] = code.data[6046 len 2986]
        ...
        if not arg4.length % 32:
            create contract with callvalue wei
                            code: code.data[6046 len 2986], 0, address(arg3), 96, arg4.length, Mask(8 * arg4.length, -(8 * arg4.length) + 256, arg4[all], mem[ceil32(arg1.length) + ceil32(arg2.length) + arg4.length + 192 len ceil32(arg4.length) - arg4.length]) << (8 * arg4.length) - 256
        else:
            ...
            create contract with callvalue wei
                            code: code.data[6046 len 2986], 0, address(arg3), 96, arg4.length, Mask(8 * ceil32(arg4.length), -(8 * ceil32(arg4.length)) + 256, arg4[all], mem[ceil32(arg1.length) + ceil32(arg2.length) + arg4.length + 192 len ceil32(arg4.length) - arg4.length]) << (8 * ceil32(arg4.length)) - 256, mem[ceil32(arg1.length) + ceil32(arg2.length) + (2 * ceil32(arg4.length)) + 3306 len floor32(arg4.length) + -ceil32(arg4.length) + 32]
    else:
        mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg4.length) + 196] = uint64(stor1[('map', ('call.data', ('add', 36, ('param', 'arg1')), ('mask_shl', 251, 5, 0, ('cd', ('add', 4, ('param', 'arg1'))))), ('mem', ('range', ('add', 192, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1'))))), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg2'))))), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg4'))))), ('mask_shl', 251, 5, 0, ('cd', ('add', 4, ('param', 'arg1'))))), ('add', 32, ('mask_shl', 5, 0, 0, ('cd', ('add', 4, ('param', 'arg1'))))))))].field_0)
        ...
        call address(stor[_89]).getContract(uint64[3] arg1) with:
             gas gas_remaining wei
            args mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg4.length) + 196 len 96]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if not address(ext_call.return_data[0]):
            ...
            if not arg4.length % 32:
                create contract with callvalue wei
                                code: code.data[6046 len 2986], address(ext_call.return_data[0]), address(arg3), 96, arg4.length, Mask(8 * arg4.length, -(8 * arg4.length) + 256, arg4[all], mem[ceil32(arg1.length) + ceil32(arg2.length) + arg4.length + 192 len ceil32(arg4.length) - arg4.length]) << (8 * arg4.length) - 256
            else:
                mem[floor32(arg4.length) + ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg4.length) + 3306] = mem[floor32(arg4.length) + ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg4.length) + -(arg4.length % 32) + 3338 len arg4.length % 32]
                create contract with callvalue wei
                                code: code.data[6046 len 2986], address(ext_call.return_data[0]), address(arg3), 96, arg4.length, Mask(8 * ceil32(arg4.length), -(8 * ceil32(arg4.length)) + 256, arg4[all], mem[ceil32(arg1.length) + ceil32(arg2.length) + arg4.length + 192 len ceil32(arg4.length) - arg4.length]) << (8 * ceil32(arg4.length)) - 256, mem[ceil32(arg1.length) + ceil32(arg2.length) + (2 * ceil32(arg4.length)) + 3306 len floor32(arg4.length) + -ceil32(arg4.length) + 32]
