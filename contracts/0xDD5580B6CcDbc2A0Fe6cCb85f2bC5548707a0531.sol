...
function _fallback() payable {
    ...
    return code.data[754 len 13095]
}
...
function sub_3963ef83(?) payable {
    ...
    mem[448] = stor[sha3((11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_3963ef83', 12)) + 6)].field_0
    idx = 448
    s = 0
    while stor[(11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_3963ef83', 12)) + 6].length + 448 > idx + 32:
        mem[idx + 32] = stor[s + sha3((11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_3963ef83', 12)) + 6)].field_256
        idx = idx + 32
        s = s + 1
        continue 
    return sub_3963ef83[arg1][arg2].field_0, 
           ...
           Array(len=stor[(11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_3963ef83', 12)) + 6].length, data=mem[448 len stor[(11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_3963ef83', 12)) + 6].length + (floor32(stor[(11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_3963ef83', 12)) + 6].length - 1) + -stor[(11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_3963ef83', 12)) + 6].length + 32 % 32)]),
...
function sub_44d855f1(?) payable {
    ...
    mem[448] = stor[sha3((11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 15)) + 6)].field_0
    idx = 448
    s = 0
    while stor[(11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 15)) + 6].length + 448 > idx + 32:
        mem[idx + 32] = stor[s + sha3((11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 15)) + 6)].field_256
        idx = idx + 32
        s = s + 1
        continue 
    return sub_44d855f1[arg1][arg2].field_0, 
           ...
           Array(len=stor[(11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 15)) + 6].length, data=mem[448 len stor[(11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 15)) + 6].length + (floor32(stor[(11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 15)) + 6].length - 1) + -stor[(11 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 15)) + 6].length + 32 % 32)]),
...
function players(address arg1) payable {
    return players[arg1].field_0, 
           ...
           address(players[arg1].field_512),
...
function sub_236af88c(?) payable {
    require not address(players[address(msg.sender)].field_512)
    require sub_6a52dfdb[address(arg1)]
    players[address(msg.sender)].field_512 = arg1 or Mask(96, 160, players[address(msg.sender)].field_512)
}
...
function games(uint256 arg1) payable {
    ...
    return storBF01[arg1], 
           ...
           stor175B[arg1],
           stor[(15 * arg1) + code.data[13063 len 32]],
           stor175B[arg1],
           bool(stor5601[arg1])
}
...
function draw() payable {
    mem[96] = 0
    require gameID < stor11
    require block.timestamp >= stor[code.data[13063 len 32] + (15 * stor10)] + sub_ae466313
    require gameID < stor11
...
function sub_ef2d1714(?) payable {
    ...
    if 0 >= arg1:
        ...
        if 0 == address(players[address(msg.sender)].field_512):
            require gameID < stor11
            storB901[stor10] += 10 * msg.value / 100
        else:
            require sub_6a52dfdb[address(stor14[address(msg.sender)].field_512)] < stor5.length
            storC703[stor4[address(stor14[address(msg.sender)].field_512)]] += 10 * msg.value / 100
            require gameID < stor11
