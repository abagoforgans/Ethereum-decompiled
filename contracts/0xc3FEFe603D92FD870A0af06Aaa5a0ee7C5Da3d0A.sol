...
function _fallback() {
    stor0 = address(code.data[6249 len 32])
    stor1 = msg.sender
    stor2 = address(code.data[6281 len 32])
    stor3 = address(code.data[6313 len 32])
    stor4 = 0
    uint64(stor5.field_0) = uint64(code.data[6345 len 32])
    uint8(stor5.field_64) = 0
    return code.data[252 len 5997]
}
...
function sub_33836408(?) payable {
    ...
    if escrowDeed[arg1 << 192].field_1280 != 1:
        require escrowDeed[arg1 << 192].field_1280 <= 6
        if escrowDeed[arg1 << 192].field_1280 != 3:
            require escrowDeed[arg1 << 192].field_1280 <= 6
            require escrowDeed[arg1 << 192].field_1280 == 5
    require ext_code.size(address(ext_call.return_data[32]))
    call address(ext_call.return_data[32]).previousOwner() with:
    ...
    call stor0.transfer(bytes32 rg1, address rg2) with:
         gas gas_remaining - 710 wei
        args escrowDeed[arg1 << 192].field_0, address(ext_call.return_data[0])
    require ext_call.success
...
function startEscrow(string arg1, uint256 arg2, uint64 arg3) payable {
    ...
    if arg3 > 0:
        ...
        call stor3.getBidInfo(uint64 rg1) with:
             gas gas_remaining - 710 wei
            args arg3
        require ext_call.success
