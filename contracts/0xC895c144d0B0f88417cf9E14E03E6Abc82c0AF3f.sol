...
function sub_8f00e61a(?) payable {
    codecall 0xce642b6a82e72147ceade0e72c786ba8eaeb31d7.0xe6ce3a6a with:
...
function sub_c75e8f88(?) payable {
    ...
    require callcode.return_code
    require callcode.return_data[0] != 0
    codecall 0x4f830b115c86d93a1a4e324548ef80b0f2dd4c76.0x81a33a6f with:
         gas gas_remaining - 50 wei
...
function sub_b6cbfdb2(?) payable {
    ...
    codecall 0x4f830b115c86d93a1a4e324548ef80b0f2dd4c76.0x94e8767d with:
         gas gas_remaining - 50 wei
        args (stor3[uint32(call.func_hash)] + 1)
    require callcode.return_code
    codecall 0xce642b6a82e72147ceade0e72c786ba8eaeb31d7.0xbacd6958 with:
         gas gas_remaining - 50 wei
