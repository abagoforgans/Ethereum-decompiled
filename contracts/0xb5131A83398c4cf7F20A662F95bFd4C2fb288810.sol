...
function _fallback() payable {
    ...
    stor5 = 0xe1821594daf259d99cebad8e5a0131eea55145e3
    address(stor0.field_0) = msg.sender
    uint16(stor0.field_160) = 0
    return code.data[202 len 4371]
}
...
function sub_6d5123ce(?) {
    ...
    call petCardDataContractAddress.getPet(uint256 arg1) with:
        ...
        args arg1
    require ext_call.success
    require msg.sender == address(ext_call.return_data[300 len 20])
            ...
            if uint8(ext_call.return_data[96]) != 3:
                if uint8(ext_call.return_data[96]) != 4:
                    if uint8(ext_call.return_data[96]) != 5:
                        if uint8(ext_call.return_data[96]) != 6:
                            call aBTokenDataContractAddress.0xab5c83b1 with:
                                 gas gas_remaining - 710 wei
                                args address(ext_call.return_data[332 len 20]), ext_call.return_data[32] << 248, ext_call.return_data[64] << 240, 0, 0, 0, 288, 0, ext_call.return_data[0] << 240, 1, '0'
                        else:
                            call aBTokenDataContractAddress.0xab5c83b1 with:
                                 gas gas_remaining - 710 wei
                                args address(ext_call.return_data[332 len 20]), ext_call.return_data[32] << 248, ext_call.return_data[64] << 240, 0, 1, 1, 288, 0, ext_call.return_data[0] << 240, 1, '0'
                    else:
                        if uint8(ext_call.return_data[96]) != 6:
                            call aBTokenDataContractAddress.0xab5c83b1 with:
                                 gas gas_remaining - 710 wei
                                args address(ext_call.return_data[332 len 20]), ext_call.return_data[32] << 248, ext_call.return_data[64] << 240, 1, 0, 0, 288, 0, ext_call.return_data[0] << 240, 1, '0'
                        else:
                            call aBTokenDataContractAddress.0xab5c83b1 with:
                                 gas gas_remaining - 710 wei
                                args address(ext_call.return_data[332 len 20]), ext_call.return_data[32] << 248, ext_call.return_data[64] << 240, 1, 1, 1, 288, 0, ext_call.return_data[0] << 240, 1, '0'
                else:
                    if uint8(ext_call.return_data[96]) != 6:
                        call aBTokenDataContractAddress.0xab5c83b1 with:
                             gas gas_remaining - 710 wei
                            args address(ext_call.return_data[332 len 20]), ext_call.return_data[32] << 248, ext_call.return_data[64] << 240, 1, 1, 0, 288, 0, ext_call.return_data[0] << 240, 1, '0'
                    else:
                        call aBTokenDataContractAddress.0xab5c83b1 with:
                             gas gas_remaining - 710 wei
                            args address(ext_call.return_data[332 len 20]), ext_call.return_data[32] << 248, ext_call.return_data[64] << 240, 1, 1, 1, 288, 0, ext_call.return_data[0] << 240, 1, '0'
                ...
                if uint8(ext_call.return_data[96]) != 4:
                    if uint8(ext_call.return_data[96]) != 6:
                        call aBTokenDataContractAddress.0xab5c83b1 with:
                             gas gas_remaining - 710 wei
                            args address(ext_call.return_data[332 len 20]), ext_call.return_data[32] << 248, ext_call.return_data[64] << 240, 1, 0, 1, 288, 0, ext_call.return_data[0] << 240, 1, '0'
                    else:
                        call aBTokenDataContractAddress.0xab5c83b1 with:
                             gas gas_remaining - 710 wei
                            args address(ext_call.return_data[332 len 20]), ext_call.return_data[32] << 248, ext_call.return_data[64] << 240, 1, 1, 1, 288, 0, ext_call.return_data[0] << 240, 1, '0'
                ...
                if uint8(ext_call.return_data[96]) != 4:
                    if uint8(ext_call.return_data[96]) != 5:
                        if uint8(ext_call.return_data[96]) != 6:
                            call aBTokenDataContractAddress.0xab5c83b1 with:
                                 gas gas_remaining - 710 wei
                                args address(ext_call.return_data[332 len 20]), ext_call.return_data[32] << 248, ext_call.return_data[64] << 240, 0, 1, 0, 288, 0, ext_call.return_data[0] << 240, 1, '0'
                        else:
                            call aBTokenDataContractAddress.0xab5c83b1 with:
                                 gas gas_remaining - 710 wei
                                args address(ext_call.return_data[332 len 20]), ext_call.return_data[32] << 248, ext_call.return_data[64] << 240, 0, 1, 1, 288, 0, ext_call.return_data[0] << 240, 1, '0'
                ...
                if uint8(ext_call.return_data[96]) != 4:
                    if uint8(ext_call.return_data[96]) != 5:
                        if uint8(ext_call.return_data[96]) != 6:
                            call aBTokenDataContractAddress.0xab5c83b1 with:
                                 gas gas_remaining - 710 wei
                                args address(ext_call.return_data[332 len 20]), ext_call.return_data[32] << 248, ext_call.return_data[64] << 240, 0, 0, 1, 288, 0, ext_call.return_data[0] << 240, 1, '0'
                        else:
                            call aBTokenDataContractAddress.0xab5c83b1 with:
                                 gas gas_remaining - 710 wei
                                args address(ext_call.return_data[332 len 20]), ext_call.return_data[32] << 248, ext_call.return_data[64] << 240, 0, 1, 1, 288, 0, ext_call.return_data[0] << 240, 1, '0'
