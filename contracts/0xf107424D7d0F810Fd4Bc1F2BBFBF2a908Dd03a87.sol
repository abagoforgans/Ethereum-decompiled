...
function submitTransactionWithSignatures(address arg1, uint256 arg2, bytes arg3, uint256 arg4, uint8[] arg5, bytes32[] arg6) {
    ...
    mem[ceil32(arg3.length) + 180 len arg3.length] = arg3[all]
    mem[arg3.length + ceil32(arg3.length) + 180] = arg4
    mem[0] = sha3(arg1, arg2, arg3[all], arg4)
    mem[32] = 0
    if address(stor0[arg1][arg2][arg3[all]][arg4].field_0):
        ...
        if s == required:
            ...
            idx = mem[64]
            s = 0
            while _1428 + stor0[arg1][arg2][arg3[all]][arg4][2].length > idx + 32:
                mem[idx + 32] = stor[s + sha3(mem[0]) + 1]
                idx = idx + 32
                s = s + 1
                continue 
            call address(stor0[arg1][arg2][arg3[all]][arg4].field_0).mem[mem[64] len 4] with:
               value stor0[arg1][arg2][arg3[all]][arg4].field_256 wei
                 gas gas_remaining - 34050 wei
                args mem[mem[64] + 4 len _1428 + stor0[arg1][arg2][arg3[all]][arg4][2].length + (floor32(stor0[arg1][arg2][arg3[all]][arg4][2].length - 1) + -stor0[arg1][arg2][arg3[all]][arg4][2].length + 32 % 32) + -mem[64] - 4]
            require ext_call.success
            emit Execution(sha3(arg1, arg2, arg3[all], arg4));
    else:
        ...
        if not stor4.length > stor4.length + 1:
            ...
            if s == required:
                ...
                idx = mem[64]
                s = 0
                while _2074 + stor0[arg1][arg2][arg3[all]][arg4][2].length > idx + 32:
                    mem[idx + 32] = stor[s + sha3(mem[0]) + 1]
                    idx = idx + 32
                    s = s + 1
                    continue 
                call address(stor0[arg1][arg2][arg3[all]][arg4].field_0).mem[mem[64] len 4] with:
                   value stor0[arg1][arg2][arg3[all]][arg4].field_256 wei
                     gas gas_remaining - 34050 wei
                    args mem[mem[64] + 4 len _2074 + stor0[arg1][arg2][arg3[all]][arg4][2].length + (floor32(stor0[arg1][arg2][arg3[all]][arg4][2].length - 1) + -stor0[arg1][arg2][arg3[all]][arg4][2].length + 32 % 32) + -mem[64] - 4]
                require ext_call.success
                emit Execution(sha3(arg1, arg2, arg3[all], arg4));
    return sha3(arg1, arg2, arg3[all], arg4)
}
