        ...
        if not winningOutcome[arg1 + (100 * 10^18 * arg2) + (10000000000000000000000 * 10^18 * arg3)].field_0:
            if block.difficulty >= arg2:
                if block.difficulty <= arg3:
                    winningOutcome[arg1 + (100 * 10^18 * arg2) + (10000000000000000000000 * 10^18 * arg3)].field_0 = (10000 * block.difficulty) - (10000 * arg2) / arg3 - arg2 or Mask(240, 16, winningOutcome[arg1 + (100 * 10^18 * arg2) + (10000000000000000000000 * 10^18 * arg3)].field_0)
                else:
