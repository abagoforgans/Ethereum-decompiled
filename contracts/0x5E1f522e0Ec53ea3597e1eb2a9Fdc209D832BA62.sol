...
function _fallback() payable {
    ...
    stor5[address(msg.sender)] = 10 * 10^18
    stor4 = 10 * 10^18
    bool(stor1.length) = 0
    stor1.length.field_1 = 12
    stor1.length.field_8 = 'Artwork File' / 256
    idx = 0
