...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 40000000 * 10^18
    stor2 = 40000000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 15
    stor3.length.field_8 = 'InCaritateToken' / 256
    idx = 0
