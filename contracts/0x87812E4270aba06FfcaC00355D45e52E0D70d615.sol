...
function _fallback() {
    stor2 = msg.sender
    stor0 = code.data[1386 len 20]
    address(stor1.field_0) = code.data[1418 len 20]
    uint8(stor1.field_160) = code.data[1469 len 1]
    uint8(stor1.field_168) = uint8(-code.data[1438 len 32] + 100)
    return code.data[224 len 1150]
}
...
function _fallback() payable {
    ...
    call withdraw2Address with:
       value msg.value - (msg.value * percent1 / 100) wei
         gas 2300 * is_zero(value) wei
    require ext_call.success
    emit 0x381570d5: address(msg.sender), msg.value * percent1 / 100, withdraw1Address, msg.value - (msg.value * percent1 / 100), withdraw2Address, gas_remaining, block.gas_limit, block.gasprice
}
