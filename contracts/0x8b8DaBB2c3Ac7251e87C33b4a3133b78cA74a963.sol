...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor2[address(this.address)] = 500000000 * 10^18
    stor1 = 500000000 * 10^18
    emit Transfer(500000000 * 10^18, 0, this.address);
    return code.data[174 len 4413]
}
...
function DailyMint() {
    require 423648 * 24 * 3600 <= block.timestamp
    require block.timestamp - (423648 * 24 * 3600) / 24 * 3600 >= lastDayPaid
