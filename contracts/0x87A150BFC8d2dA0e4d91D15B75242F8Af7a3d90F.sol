...
function isSane() {
    ...
    call tokenAddress.releaseAgent() with:
...
function finalizeCrowdsale() {
    ...
    require ext_code.size(tokenAddress)
    call tokenAddress.reservedTokensDestinationsLen() with:
         gas gas_remaining - 710 wei
    require ext_call.success
...
function distributeReservedTokens(uint256 arg1) payable {
    ...
    if uint8(var25014) >= 0:
        ...
        call tokenAddress.reservedTokensDestinationsLen() with:
             gas gas_remaining - 710 wei
        require ext_call.success
        require ext_code.size(0xb679564572dd853add08f9303535d09c6ca6514c)
        delegate 0xb679564572dd853add08f9303535d09c6ca6514c.minus(uint256 arg1, uint256 arg2) with:
             gas gas_remaining - 710 wei
        ...
        if delegate.return_data[0] < arg1:
            ...
            while idx < distributedReservedTokensDestinationsLen + delegate.return_data[0]:
                require ext_code.size(tokenAddress)
                call tokenAddress.reservedTokensDestinations(uint256 arg1) with:
                     gas gas_remaining - 710 wei
                    args idx
                require ext_call.success
                mem[128] = 0
                ...
                require ext_code.size(tokenAddress)
                call tokenAddress.areTokensDistributedForAddress(address arg1) with:
                     gas gas_remaining - 710 wei
                ...
                if ext_call.return_data[0]:
                    ...
                    continue 
                require ext_code.size(tokenAddress)
                call tokenAddress.getReservedTokens(address arg1) with:
                     gas gas_remaining - 710 wei
                    args address(ext_call.return_data[0])
                require ext_call.success
                require ext_code.size(tokenAddress)
                call tokenAddress.getReservedPercentageUnit(address arg1) with:
                     gas gas_remaining - 710 wei
                    args address(ext_call.return_data[0])
                require ext_call.success
                mem[128] = 0
                require ext_code.size(tokenAddress)
                call tokenAddress.getReservedPercentageDecimals(address arg1) with:
                     gas gas_remaining - 710 wei
                    args address(ext_call.return_data[0])
                require ext_call.success
                if ext_call.return_data[0] <= 0:
                    ...
                    mem[100] = address(ext_call.return_data[0])
                    require ext_code.size(tokenAddress)
                    call tokenAddress.finalizeReservedAddress(address arg1) with:
                         gas gas_remaining - 710 wei
                        args address(ext_call.return_data[0])
                    require ext_call.success
        ...
        require ext_code.size(0xb679564572dd853add08f9303535d09c6ca6514c)
        delegate 0xb679564572dd853add08f9303535d09c6ca6514c.mem[var37002 len 4] with:
             gas gas_remaining - 710 wei
            args mem[var37002 + 4 len var37003 - 4]
        require delegate.return_code
        require ext_code.size(crowdsaleAddress)
        call crowdsaleAddress.joinedCrowdsalesLen() with:
             gas gas_remaining - 710 wei
        require ext_call.success
        s = var39013
        idx = var39014
        ...
        while uint8(idx + 1) < uint8(ext_call.return_data[0]):
            require ext_code.size(crowdsaleAddress)
            call crowdsaleAddress.joinedCrowdsales(uint256 arg1) with:
                 gas gas_remaining - 710 wei
                args uint8(idx + 1)
            require ext_call.success
            require ext_code.size(address(ext_call.return_data[0]))
            call address(ext_call.return_data[0]).tokensSold() with:
                 gas gas_remaining - 710 wei
            require ext_call.success
            mem[132] = ext_call.return_data[0]
            require ext_code.size(0xb679564572dd853add08f9303535d09c6ca6514c)
            delegate 0xb679564572dd853add08f9303535d09c6ca6514c.plus(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining - 710 wei
