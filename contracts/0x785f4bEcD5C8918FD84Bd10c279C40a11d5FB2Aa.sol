...
function hashes(uint256 arg1) payable {
    require arg1 < stor4
    return stor[code.data[1983 len 32] + arg1]
}

function applicants(uint256 arg1) payable {
    require arg1 < stor3
    return address(applicants[arg1].field_0)
}
...
function reject(address arg1) payable {
    ...
    address(applicants[stor1[address(arg1)]].field_0) = 0
    require index[address(arg1)] < stor2
    requests[stor1[address(arg1)]] = 0
    require index[address(arg1)] < stor4
    stor[stor1[address(arg1)] + code.data[1983 len 32]] = 0
    emit Reject(arg1);
    return 1
}
...
function sub_dfab9895(?) payable {
    ...
    while idx < stor3:
        mem[0] = 3
        if address(applicants[idx].field_0):
            idx = idx + 1
            continue 
        if idx != 0:
            require idx < stor3
            applicants[idx].field_0 = Mask(96, 0, applicants[idx].field_160)
            require idx < stor2
            requests[idx] = arg2
            require idx < stor4
            stor[code.data[1983 len 32] + idx] = arg3
            ...
            stor4++
            if not stor4 <= stor4 + 1:
                idx = stor4 + code.data[1983 len 32] + 1
                while code.data[1983 len 32] + stor4 > idx:
                    stor[idx] = 0
                    idx = idx + 1
                    continue 
            require stor3 < stor3
            applicants[stor3].field_0 = Mask(96, 0, applicants[stor3].field_160)
            require stor3 < stor2
            requests[stor3] = arg2
            require stor3 < stor4
            stor[code.data[1983 len 32] + stor3] = arg3
