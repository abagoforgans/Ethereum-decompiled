...
function kill(address arg1) payable {
    ...
    if not stor259[call.data[0 len calldata.size]][block.number].field_0:
        ...
        stor[code.data[3999 len 32] + stor260.length] = sha3(call.data[0 len calldata.size], block.number)
    ...
    stor[code.data[3999 len 32] + stor259[call.data[0 len calldata.size]][block.number].field_512] = 0
...
function confirm(bytes32 arg1) payable {
    ...
    if not stor259[arg1].field_0:
        ...
        require stor260.length < stor260.length
        stor[code.data[3999 len 32] + stor260.length] = arg1
    if 2^stor258[tx.origin] and stor259[arg1].field_256 != 0:
        return 0
    mem[128] = arg1
    ...
    stor[code.data[3999 len 32] + stor259[arg1].field_512] = 0
            ...
            if stor259[call.data[0 len calldata.size]][block.number].field_0 > 1:
                ...
                if arg1 <= m_numOwners:
                    ...
                    while idx < stor260.length:
                        mem[32] = 265
                        address(stor265[stor[code.data[3999 len 32] + idx]].field_0) = 0
                        stor265[stor[code.data[3999 len 32] + idx]].field_256 = 0
                        stor265[stor[code.data[3999 len 32] + idx]].field_512 = 0
                        mem[0] = sha3(stor[code.data[3999 len 32] + idx], 265) + 2
                        s = sha3(sha3(stor[code.data[3999 len 32] + s], 265) + 2)
                        while sha3(sha3(stor[code.data[3999 len 32] + s], 265) + 2) + (stor265[stor[code.data[3999 len 32] + s]].field_512 + 31 / 32) > s:
                            stor[s] = 0
                            s = s + 1
                            continue 
                        s = sha3(sha3(stor[code.data[3999 len 32] + s], 265) + 2) + (stor265[stor[code.data[3999 len 32] + s]].field_512 + 31 / 32) + 1
                        continue 
                    idx = 0
                    while idx < stor260.length:
                        mem[0] = 260
                        if stor[code.data[3999 len 32] + idx]:
                            require idx < stor260.length
                            mem[0] = stor[code.data[3999 len 32] + idx]
                            mem[32] = 259
                            stor259[stor[code.data[3999 len 32] + idx]].field_0 = 0
                            stor259[stor[code.data[3999 len 32] + idx]].field_256 = 0
                            stor259[stor[code.data[3999 len 32] + idx]].field_512 = 0
                        idx = idx + 1
                        continue 
                    stor260.length = 0
                    idx = code.data[3999 len 32]
                    while code.data[3999 len 32] + stor260.length > idx:
                        stor[idx] = 0
                        idx = idx + 1
                        continue 
