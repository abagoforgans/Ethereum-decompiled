...
function getPrices() payable {
    ...
    call stor4.mem[var17004 len 4] with:
    ...
    mem[100] = var23001
    require ext_code.size(stor4)
    call stor4.mem[var25004 len 4] with:
         gas gas_remaining wei
    ...
    require ext_code.size(stor4)
    call stor4.mem[var31004 len 4] with:
         gas gas_remaining wei
    ...
    stor3.length++
    mem[0] = 3
    stor3[stor3.length].field_0 = _248
    mem[96] = 0x6e2ede0300000000000000000000000000000000000000000000000000000000
    require ext_code.size(stor4)
    call stor4.mem[var39004 len 4] with:
         gas gas_remaining wei
    ...
    mem[100] = var45001
    require ext_code.size(stor4)
    call stor4.mem[var47004 len 4] with:
         gas gas_remaining wei
...
function sub_1afbe0e1(?) payable {
    ...
    stor2.length++
    mem[0] = 2
    stor2[stor2.length].field_0 = _248
    mem[96] = 0x6e2ede0300000000000000000000000000000000000000000000000000000000
    require ext_code.size(stor4)
    call stor4.mem[var39004 len 4] with:
         gas gas_remaining wei
...
function getBalances(address arg1) payable {
    ...
    mem[96] = 0x6e2ede0300000000000000000000000000000000000000000000000000000000
    require ext_code.size(stor4)
    call stor4.mem[var23004 len 4] with:
         gas gas_remaining wei
    ...
    if var27005 >= mem[var27002]:
        require ext_code.size(stor4)
        call stor4.calculateAccountValues(address arg1) with:
             gas gas_remaining wei
            args arg1
        ...
        if stor0.length:
            ...
            while (32 * stor0.length) + 96 > idx:
                ...
                continue 
        if stor1.length:
            mem[(32 * stor0.length) + 160] = uint256(stor1.field_0)
            idx = (32 * stor0.length) + 160
            s = 0
            while (32 * stor0.length) + (32 * stor1.length) + 128 > idx:
                mem[idx + 32] = stor1[s].field_256
                idx = idx + 32
                s = s + 1
                continue 
        mem[(32 * stor0.length) + (32 * stor1.length) + 320 len floor32(stor0.length)] = mem[128 len floor32(stor0.length)]
        mem[(64 * stor0.length) + (32 * stor1.length) + 320] = stor1.length
        mem[(64 * stor0.length) + (32 * stor1.length) + 352 len floor32(stor1.length)] = mem[(32 * stor0.length) + 160 len floor32(stor1.length)]
        return Array(len=stor0.length, data=mem[128 len floor32(stor0.length)], mem[(32 * stor0.length) + (32 * stor1.length) + floor32(stor0.length) + 320 len (32 * stor0.length) + (32 * stor1.length) + -floor32(stor0.length) + 32]), 
               (32 * stor0.length) + 160,
    ...
    mem[100] = arg1
    mem[132] = address(_372)
    require ext_code.size(stor4)
    call stor4.mem[var37004 len 4] with:
         gas gas_remaining wei
    ...
    stor0.length++
    mem[0] = 0
    stor0[stor0.length].field_0 = _512
    mem[96] = 0xbeb5461500000000000000000000000000000000000000000000000000000000
    mem[100] = var41006
    require ext_code.size(stor4)
    call stor4.mem[var43004 len 4] with:
         gas gas_remaining wei
    ...
    mem[100] = arg1
    mem[132] = address(_634)
    require ext_code.size(stor4)
    call stor4.mem[var49004 len 4] with:
         gas gas_remaining wei
    ...
    stor1.length++
    mem[0] = 1
    stor1[stor1.length].field_0 = _755
    mem[96] = 0x6e2ede0300000000000000000000000000000000000000000000000000000000
    require ext_code.size(stor4)
    call stor4.mem[var57004 len 4] with:
         gas gas_remaining wei
