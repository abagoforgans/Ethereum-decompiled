...
const _fallback = code.data[30 len 8407]
...
function kill(address arg1) {
    ...
    if not stor262[call.data[0 len calldata.size]].field_0:
        ...
        stor263[stor262[call.data[0 len calldata.size]].field_512] = sha3(call.data[0 len calldata.size])
    if stor262[call.data[0 len calldata.size]].field_256 and 2^stor261[address(msg.sender)]:
    ...
    if stor262[call.data[0 len calldata.size]].field_0 > 1:
        ...
        stor262[call.data[0 len calldata.size]].field_256 = stor262[call.data[0 len calldata.size]].field_256 or 2^stor261[address(msg.sender)]
    require stor262[call.data[0 len calldata.size]].field_512 < stor263.length
...
function initDaylimit(uint256 arg1) {
...
function hasConfirmed(bytes32 arg1, address arg2) {
    if stor261[address(arg2)]:
        return not not stor262[arg1].field_256 and 2^stor261[address(arg2)]
    else:
        return 0
}
...
function initMultiowned(address[] arg1, uint256 arg2) {
...
function resetSpentToday() {
    if stor261[address(msg.sender)]:
        if not stor262[call.data[0 len calldata.size]].field_0:
            ...
            require stor262[call.data[0 len calldata.size]].field_512 < stor263.length
            stor263[stor262[call.data[0 len calldata.size]].field_512] = sha3(call.data[0 len calldata.size])
        if not stor262[call.data[0 len calldata.size]].field_256 or not 2^stor261[address(msg.sender)]:
            emit Confirmation(msg.sender, sha3(call.data[0 len calldata.size]));
            if stor262[call.data[0 len calldata.size]].field_0 > 1:
                stor262[call.data[0 len calldata.size]].field_0--
                stor262[call.data[0 len calldata.size]].field_256 = stor262[call.data[0 len calldata.size]].field_256 or 2^stor261[address(msg.sender)]
...
function confirm(bytes32 arg1) {
    ...
    if not stor262[arg1].field_0:
        ...
        stor263[stor262[arg1].field_512] = arg1
    if stor262[arg1].field_256 and 2^stor261[address(msg.sender)]:
        return 0
    mem[128] = arg1
    emit Confirmation(msg.sender, arg1);
    if stor262[arg1].field_0 > 1:
        stor262[arg1].field_0--
        stor262[arg1].field_256 = stor262[arg1].field_256 or 2^stor261[address(msg.sender)]
        return 0
    require stor262[arg1].field_512 < stor263.length
...
function addOwner(address arg1) {
    ...
    if stor262[call.data[0 len calldata.size]].field_0:
        ...
        if m_numOwners >= 250:
            ...
            m_numOwners++
            address(stor5[stor1].field_0) = arg1
            Mask(96, 0, stor5[stor1].field_160) = 0
