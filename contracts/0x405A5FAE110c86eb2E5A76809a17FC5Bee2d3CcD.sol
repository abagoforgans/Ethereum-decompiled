...
function _fallback() payable {
    ...
    mem[96 len 64] = code.data[7764 len 64]
    mem[64] = 160
    stor0 = msg.sender
    require code.data[7776 len 20]
    require code.data[7808 len 20]
    stor6 = code.data[7776 len 20]
    stor0 = code.data[7808 len 20]
    idx = 0
    while idx < 4:
        _44 = mem[64]
        mem[64] = mem[64] + 32
        ...
        idx = idx + 1
        continue 
    require address(code.data[7764 len 32])
    stor8 = address(code.data[7764 len 32])
    return code.data[778 len 6986]
}
...
function getPendingTaxData() {
    ...
    if uint256(stor7.field_1536):
        ...
        while (32 * uint256(stor7.field_1536)) + 160 > idx:
            ...
            s = s + 1
            continue 
    return stor16, stor17, uint256(stor7.field_1792)
}
...
function getPendingWalletFeeData() {
    ...
    if uint256(stor7.field_1024):
        ...
        while (32 * uint256(stor7.field_1024)) + 160 > idx:
            ...
            s = s + 1
            continue 
    return stor14, stor15, uint256(stor7.field_1280)
}
...
function getPendingAddReserveData() {
    ...
    if uint256(stor7.field_512):
        ...
        while (32 * uint256(stor7.field_512)) + 160 > idx:
            ...
            s = s + 1
            continue 
    return stor11, stor12, stor13, uint256(stor7.field_768)
}
...
function registerWalletForFeeSharing(address arg1) {
    ...
    call feeBurnerContractAddress.0x45ab63b9 with:
         gas gas_remaining - 710 wei
        args arg1
    require ext_call.success
    require not ext_call.return_data[0]
    require ext_code.size(feeBurnerContractAddress)
    call feeBurnerContractAddress.0x65dfc20f with:
         gas gas_remaining - 710 wei
...
function approveAddReserveData(uint256 arg1) {
    ...
    if uint256(stor7.field_512) == stor4.length:
        require ext_code.size(feeBurnerContractAddress)
        call feeBurnerContractAddress.0x46b8c49e with:
             gas gas_remaining - 710 wei
            args stor11, stor12, stor13
        require ext_call.success
}
...
function approveTaxData(uint256 arg1) {
    ...
    if uint256(stor7.field_1536) == stor4.length:
        require ext_code.size(feeBurnerContractAddress)
        call feeBurnerContractAddress.0x9fad2dcb with:
             gas gas_remaining - 710 wei
            args stor17
        require ext_call.success
        require ext_code.size(feeBurnerContractAddress)
        call feeBurnerContractAddress.0xea414b28 with:
             gas gas_remaining - 710 wei
            args stor16
        require ext_call.success
}
