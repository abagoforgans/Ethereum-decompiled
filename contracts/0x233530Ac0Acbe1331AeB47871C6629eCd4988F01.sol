...
function getAccounts() {
    ...
    if Mask(251, 0, accounts.length):
        mem[(32 * accounts.length) + 224] = mem[160]
        mem[(32 * accounts.length) + 256 len floor32((32 * accounts.length) - 1)] = mem[192 len floor32((32 * accounts.length) - 1)]
    return Array(len=accounts.length, data=mem[(32 * accounts.length) + 224 len 32 * accounts.length])
}
...
function issue(address arg1, uint256 arg2, string arg3) {
    ...
    mem[ceil32(arg3.length) + arg3.length + 128] = 10
    ...
    if uint8(stor[mem[ceil32(arg3.length) + floor32(arg3.length) + 128 len (arg3.length % 32) + 32]][call.data[arg3 + 36 len floor32(arg3.length)]]):
        ...
        if not arg3.length % 32:
            emit Issue(address rg1, address rg2, uint256 rg3, string rg4):
                       arg2,
                       mem[ceil32(arg3.length) + 160 len arg3.length],
                       0,
                       mem[ceil32(arg3.length) + arg3.length + 160 len 64],
                       msg.sender,
                       arg1,
        else:
            ...
            emit Issue(address rg1, address rg2, uint256 rg3, string rg4):
                       ...
                       mem[ceil32(arg3.length) + 160 len arg3.length],
                       0,
                       mem[ceil32(arg3.length) + arg3.length + 160 len -(arg3.length % 32) + 96],
                       msg.sender,
                       arg1,
    else:
        mem[ceil32(arg3.length) + 128 len floor32(arg3.length)] = call.data[arg3 + 36 len floor32(arg3.length)]
        ...
        if not proofIds.length <= proofIds.length + 1:
            ...
            while sha3(8) + proofIds.length > idx + sha3(mem[0]):
                ...
                idx = idx + 1
                continue 
        proofIds[proofIds.length] = (2 * arg3.length) + 1
        s = 0
        idx = 128
        while arg3.length + 128 > idx:
            proofIds[proofIds.length + s] = mem[idx]
            s = s + 1
            idx = idx + 32
            continue 
        if proofIds[proofIds.length].length + 31 / 32 > Mask(251, 0, arg3.length + 31) >> 5:
            stor[('array', ('stor', ('length', ('name', 'proofIds', 8))), ('name', 'proofIds', 8)) + (Mask(251, 0, arg3.length + 31) >> 5)] = 0
            idx = (Mask(251, 0, arg3.length + 31) >> 5) + 1
            while proofIds[proofIds.length].length + 31 / 32 > idx:
                proofIds[proofIds.length + idx] = 0
                idx = idx + 1
                continue 
        mem[ceil32(arg3.length) + 128] = arg2
        mem[ceil32(arg3.length) + 160] = 64
