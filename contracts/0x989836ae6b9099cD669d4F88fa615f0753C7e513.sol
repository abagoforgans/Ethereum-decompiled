    ...
    while uint32(idx) < arg1.length:
        ...
        if ext_call.return_data[0] == 1:
            ...
            call stor2.0x1115366c with:
                 gas gas_remaining wei
                args address(cd[((32 * uint32(idx)) + arg1 + 36)]), ext_call.return_data[0], ext_call.return_data[32], ext_call.return_data[64], 0, ext_call.return_data[160], ext_call.return_data[192], 0
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
        idx = idx + 1
        continue 
