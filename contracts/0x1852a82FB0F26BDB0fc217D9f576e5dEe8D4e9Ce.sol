...
function batchTransfer(address[] arg1, uint256[] arg2) {
    ...
    while uint32(idx) < arg1.length:
        ...
        require balanceOf[address(mem[(32 * uint32(idx)) + 128])] + mem[(32 * uint32(idx)) + (32 * arg1.length) + 160] >= balanceOf[address(mem[(32 * uint32(idx)) + 128])]
        mem[0] = mem[(32 * uint32(idx)) + 140 len 20]
        mem[32] = 1
        balanceOf[address(mem[(32 * uint32(idx)) + 128])] += mem[(32 * uint32(idx)) + (32 * arg1.length) + 160]
