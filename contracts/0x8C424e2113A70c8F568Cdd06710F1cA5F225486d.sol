...
const _fallback = code.data[33 len 5181]
...
function sub_8afc141c(?) {
    require 0x3e132a49a9c0f066ce2fe2ab48b886b340cf == msg.sender
    call arg1 with:
...
function sub_513bd11b(?) {
    ...
    call 0x00003e132a49a9c0f066ce2fe2ab48b886b340cf with:
       value arg1 wei
         gas gas_remaining - 34710 wei
...
function sub_158ab5ba(?) {
    ...
    call arg1.0xa9059cbb with:
         gas gas_remaining - 710 wei
        args 0x3e132a49a9c0f066ce2fe2ab48b886b340cf, arg2
    require ext_call.success
    require ext_call.return_data[0]
}
...
function sub_7831ce79(?) {
    ...
    if ext_call.return_data[0] < _5:
        ...
        if ext_call.return_data[0] < _34:
            ...
            mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 228] = this.address
            require ext_code.size(arg1)
            ...
            if ext_call.return_data[0] - (3 * 10^15 * ext_call.return_data[0] / 10^18) <= mem[160]:
                require 1 < arg5.length
                _108 = mem[(32 * arg4.length) + 192]
                require 1 < arg4.length
                require 3 < arg5.length
                _114 = mem[(32 * arg4.length) + 256]
                require 3 < arg4.length
                _117 = mem[224]
                require 5 < arg4.length
                _121 = mem[288]
                ...
                _125 = mem[352]
                require 5 < arg5.length
                _129 = mem[(32 * arg4.length) + 320]
                require 1 < arg6.length
                _133 = mem[(32 * arg4.length) + (32 * arg5.length) + 224]
                require 3 < arg6.length
                _137 = mem[(32 * arg4.length) + (32 * arg5.length) + 288]
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 196] = mem[(32 * arg4.length) + 204 len 20]
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 228] = mem[160]
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 260] = address(_114)
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 292] = _117
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 324] = _121
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 356] = _125
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 420] = arg3
                require ext_code.size(arg1)
                call arg1.availableVolume(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10) with:
                     gas gas_remaining - 710 wei
                    args address(_108), mem[160], address(_114), _117, _121, _125, address(_129), arg3 << 248, _133, _137
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 192] = ext_call.return_data[0]
                require ext_call.success
                require 0 < arg4.length
                require 0 < arg4.length
                ...
                if ext_call.return_data[0] - (3 * 10^15 * ext_call.return_data[0] / 10^18) <= ext_call.return_data[0]:
                    ...
                    call arg1.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
                         gas gas_remaining - 710 wei
                        args address(mem[(32 * arg4.length) + 192]), mem[160], address(mem[(32 * arg4.length) + 256]), mem[224], mem[288], mem[352], address(mem[(32 * arg4.length) + 320]), arg3 << 248, mem[(32 * arg4.length) + (32 * arg5.length) + 224], mem[(32 * arg4.length) + (32 * arg5.length) + 288], ext_call.return_data[0] - (3 * 10^15 * ext_call.return_data[0] / 10^18)
                else:
                    require 0 < arg4.length
                    require 9 < arg4.length
                ...
                mem[416] = mem[160]
                require 1 < arg5.length
                _119 = mem[(32 * arg4.length) + 192]
                require 1 < arg4.length
                require 3 < arg5.length
                _127 = mem[(32 * arg4.length) + 256]
                require 3 < arg4.length
                _131 = mem[224]
                require 5 < arg4.length
                _135 = mem[288]
                ...
                _141 = mem[352]
                require 5 < arg5.length
                _143 = mem[(32 * arg4.length) + 320]
                require 1 < arg6.length
                _148 = mem[(32 * arg4.length) + (32 * arg5.length) + 224]
                require 3 < arg6.length
                _151 = mem[(32 * arg4.length) + (32 * arg5.length) + 288]
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 196] = mem[(32 * arg4.length) + 204 len 20]
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 228] = mem[160]
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 260] = address(_127)
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 292] = _131
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 324] = _135
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 356] = _141
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 420] = arg3
                require ext_code.size(arg1)
                call arg1.availableVolume(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10) with:
                     gas gas_remaining - 710 wei
                    args address(_119), mem[160], address(_127), _131, _135, _141, address(_143), arg3 << 248, _148, _151
                mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 192] = ext_call.return_data[0]
                require ext_call.success
                require 0 < arg4.length
                require 0 < arg4.length
