...
function _fallback() {
    mem[96 len -5027] = code.data[5361 len -5027]
    mem[64] = -4931
...
function kill(address arg1) {
    ...
    require 0 == stor259[call.data[0 len calldata.size]].field_256 and 2^stor258[address(msg.sender)]
...
function changeRequirement(uint256 arg1) {
    ...
    if arg1 <= m_numOwners:
        ...
        while idx < stor260.length:
            ...
            s = sha3(sha3(stor260[s], 264) + 2)
            while sha3(sha3(stor260[s], 264) + 2) + (stor264[stor260[s]][2].length + 31 / 32) > s:
                stor[s] = 0
                s = s + 1
                continue 
            s = sha3(sha3(stor260[s], 264) + 2) + (stor264[stor260[s]][2].length + 31 / 32) + 1
            continue 
        idx = 0
        while idx < stor260.length:
            mem[0] = 260
