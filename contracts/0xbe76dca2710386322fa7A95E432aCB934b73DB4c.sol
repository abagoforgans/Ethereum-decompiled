    ...
    if 0 >= stor6[stor18[msg.sender].field_0].field_264:
        if stor6[stor18[msg.sender].field_0].field_264 <= 1:
            ...
            if stor6[stor18[msg.sender].field_0].field_264 <= 2:
                if remainder <= 0:
                    ...
                    remainder = 0
                    stor18[msg.sender].field_512 = 2
                    require remainder + (stor15 * stor18[msg.sender].field_256) >= 0
                    require ext_code.size(projectTokenAddress)
                    call projectTokenAddress.0xa9059cbb with:
                         gas gas_remaining wei
                ...
                if stor6[stor18[msg.sender].field_0].field_264 <= 3:
                    if remainder <= 0:
                        stor18[msg.sender].field_512 = 2
                        require (stor16 * stor18[msg.sender].field_256) + (stor15 * stor18[msg.sender].field_256) >= 0
                        require ext_code.size(projectTokenAddress)
                        call projectTokenAddress.0xa9059cbb with:
                             gas gas_remaining wei
                        ...
                        remainder = 0
                        stor18[msg.sender].field_512 = 2
                        require remainder + (stor16 * stor18[msg.sender].field_256) + (stor15 * stor18[msg.sender].field_256) >= 0
                        require ext_code.size(projectTokenAddress)
                        call projectTokenAddress.0xa9059cbb with:
                             gas gas_remaining wei
                    ...
                    if remainder <= 0:
                        stor18[msg.sender].field_512 = 2
                        require (stor17 * stor18[msg.sender].field_256) + (stor16 * stor18[msg.sender].field_256) + (stor15 * stor18[msg.sender].field_256) >= 0
                        require ext_code.size(projectTokenAddress)
                        call projectTokenAddress.0xa9059cbb with:
                             gas gas_remaining wei
                        ...
                        remainder = 0
                        stor18[msg.sender].field_512 = 2
                        require remainder + (stor17 * stor18[msg.sender].field_256) + (stor16 * stor18[msg.sender].field_256) + (stor15 * stor18[msg.sender].field_256) >= 0
                        require ext_code.size(projectTokenAddress)
                        call projectTokenAddress.0xa9059cbb with:
                             gas gas_remaining wei
        ...
        if stor6[stor18[msg.sender].field_0].field_264 <= 1:
            if remainder <= 0:
                ...
                remainder = 0
                stor18[msg.sender].field_512 = 2
                require remainder + (stor14 * stor18[msg.sender].field_256) >= 0
                require ext_code.size(projectTokenAddress)
                call projectTokenAddress.0xa9059cbb with:
                     gas gas_remaining wei
            ...
            if stor6[stor18[msg.sender].field_0].field_264 <= 2:
                if remainder <= 0:
                    stor18[msg.sender].field_512 = 2
                    require (stor15 * stor18[msg.sender].field_256) + (stor14 * stor18[msg.sender].field_256) >= 0
                    require ext_code.size(projectTokenAddress)
                    call projectTokenAddress.0xa9059cbb with:
                         gas gas_remaining wei
                    ...
                    remainder = 0
                    stor18[msg.sender].field_512 = 2
                    require remainder + (stor15 * stor18[msg.sender].field_256) + (stor14 * stor18[msg.sender].field_256) >= 0
                    require ext_code.size(projectTokenAddress)
                    call projectTokenAddress.0xa9059cbb with:
                         gas gas_remaining wei
                ...
                if stor6[stor18[msg.sender].field_0].field_264 <= 3:
                    if remainder <= 0:
                        stor18[msg.sender].field_512 = 2
                        require (stor16 * stor18[msg.sender].field_256) + (stor15 * stor18[msg.sender].field_256) + (stor14 * stor18[msg.sender].field_256) >= 0
                        require ext_code.size(projectTokenAddress)
                        call projectTokenAddress.0xa9059cbb with:
                             gas gas_remaining wei
                        ...
                        remainder = 0
                        stor18[msg.sender].field_512 = 2
                        require remainder + (stor16 * stor18[msg.sender].field_256) + (stor15 * stor18[msg.sender].field_256) + (stor14 * stor18[msg.sender].field_256) >= 0
                        require ext_code.size(projectTokenAddress)
                        call projectTokenAddress.0xa9059cbb with:
                             gas gas_remaining wei
                    ...
                    if remainder <= 0:
                        stor18[msg.sender].field_512 = 2
                        require (stor17 * stor18[msg.sender].field_256) + (stor16 * stor18[msg.sender].field_256) + (stor15 * stor18[msg.sender].field_256) + (stor14 * stor18[msg.sender].field_256) >= 0
                        require ext_code.size(projectTokenAddress)
                        call projectTokenAddress.0xa9059cbb with:
                             gas gas_remaining wei
                        ...
                        remainder = 0
                        stor18[msg.sender].field_512 = 2
                        require remainder + (stor17 * stor18[msg.sender].field_256) + (stor16 * stor18[msg.sender].field_256) + (stor15 * stor18[msg.sender].field_256) + (stor14 * stor18[msg.sender].field_256) >= 0
                        require ext_code.size(projectTokenAddress)
                        call projectTokenAddress.0xa9059cbb with:
                             gas gas_remaining wei
