...
function _fallback() payable {
    ...
    stor0 = code.data[12340 len 32]
    stor1[address(msg.sender)] = code.data[12340 len 32]
    ...
    return code.data[1808 len 10532]
}
...
function sell(uint256 arg1) {
    ...
    require balanceOf[address(stor3.field_0)] + arg1 - (arg1 / stor10 * stor12) >= balanceOf[address(stor3.field_0)]
    balanceOf[address(stor3.field_0)] = balanceOf[address(stor3.field_0)] + arg1 - (arg1 / stor10 * stor12)
    require stor8
    call msg.sender with:
       value arg1 - (arg1 / stor10 * stor12) / stor8 wei
    ...
    if not stor16[0]:
        if uint32(stor17.field_0) != stor15.length:
            ...
            uint32(stor17.field_0) = uint32(uint32(stor17.field_0) + 1)
    Mask(88, 0, stor3.field_168) = 0
    return (arg1 - (arg1 / stor10 * stor12) / stor8)
}
