...
function _fallback() payable {
    ...
    while stor4.length + 31 / 32 > idx:
        ...
        continue 
    stor5 = 18
    stor10 = address(code.data[10544 len 32])
    stor11 = address(code.data[10576 len 32])
    stor13 = address(code.data[10640 len 32])
    stor12 = address(code.data[10608 len 32])
    stor7[address(code.data[10544 len 32])] = 800000000 * 10^18
    stor7[address(code.data[10608 len 32])] = 600000000 * 10^18
    stor16 += 600000000 * 10^18
    return code.data[1302 len 9242]
}
