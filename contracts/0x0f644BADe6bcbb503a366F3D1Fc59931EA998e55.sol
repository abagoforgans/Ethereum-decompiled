...
function _fallback() payable {
    ...
    stor1.length.field_8 = 'ETHERMINI' / 256
    idx = 0
    ...
    mem[224 len -5913] = code.data[6596 len -5913]
    stor0 = msg.sender
    stor4 = mem[224] * 10^18^stor3
