...
function _fallback() payable {
    ...
    mem[160 len -4035] = code.data[4551 len -4035]
    stor1[mem[236 len 20]] = mem[160]
    stor0 = mem[160]
    stor3[] = Array(len=mem[mem[192] + 160], data=mem[mem[192] + 192 len mem[mem[192] + 160]])
    stor4 = mem[287 len 1]
    stor5[] = Array(len=mem[mem[288] + 160], data=mem[mem[288] + 192 len mem[mem[288] + 160]])
    return code.data[516 len 4035]
}
