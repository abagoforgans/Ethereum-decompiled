...
function _fallback() payable {
    ...
    stor4.length.field_8 = 'MMT_0.2' / 256
    idx = 0
    ...
    mem[160 len -6210] = code.data[6745 len -6210]
    stor0 = msg.sender
    address(stor11.field_8) = mem[172 len 20]
    stor1[] = Array(len=mem[mem[256] + 160], data=mem[mem[256] + 192 len mem[mem[256] + 160]])
    stor2 = mem[319 len 1]
    stor3[] = Array(len=mem[mem[320] + 160], data=mem[mem[320] + 192 len mem[mem[320] + 160]])
    stor5 = mem[204 len 20]
    stor6 = mem[224]
    uint8(stor11.field_0) = uint8(bool(mem[352]))
    stor7 = block.number
    return code.data[535 len 6210]
}
