...
function _fallback() payable {
    ...
    while stor6.length + 31 / 32 > idx:
        ...
        idx = idx + 1
        continue 
    stor0[address(msg.sender)] = 0xc5df3685889de636f0613f304811f38e78f0c7a3
    stor2 = 10^9
    bool(stor3.length) = 0
    stor3.length.field_1 = 7
    stor3.length.field_8 = 'OneGett' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'OGTT' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[858 len 3400]
}
