...
function createRandomHorseFor(address arg1, string arg2, uint256 arg3) {
    ...
    if not horsesRemaining[arg3]:
        revert with 0, 'Limit for genotype reached'
    require ext_code.size(stor111)
    call stor111.createGOP(address arg1, string arg2, uint256 arg3) with:
         gas gas_remaining wei
...
function claim(uint256 arg1) {
    ...
    if msg.sender == bidOfBidder[arg1].field_1024:
        require ext_code.size(stor111)
        call stor111.safeTransferFrom(address arg1, address arg2, uint256 arg3) with:
             gas gas_remaining wei
...
function createGOP(address arg1, string arg2) payable {
    if not stor107:
        revert with 0, 'No batch open'
    if not horsesRemaining[stor108]:
        revert with 0, 'Cap for specified genotype already met'
    if stor108 != 1:
        if stor108 != 2:
            if stor108 != 3:
                if stor108 != 4:
                    if stor108 != 5:
                        ...
                        call stor111.createGOP(address arg1, string arg2, uint256 arg3) with:
                             gas gas_remaining wei
                            args address(arg1), Array(len=arg2.length, data=arg2[all]), stor108
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        if ext_call.return_data[0]:
                            ...
                            require 1 <= horsesRemaining[stor108]
                            horsesRemaining[stor108]--
                            if 1 <= stor108:
                                if stor108 <= 4:
                                    if 500 == horsesRemaining[stor108]:
                                        stor107 = 0
                                        stor108 = 0
                            if 5 == stor108:
                                if 1000 == stor77CE:
                    ...
                    if 1500 >= stor77CE:
                        ...
                        if ext_call.return_data[0]:
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                        return ext_call.return_data[0]
    ('lt', 1500, ('stor', ('name', 'stor77CE', 54189552365721282554752408548789621626309128933315086820625451395457894814477)))
    require ext_code.size(stor111)
    call stor111.createGOP(address arg1, string arg2, uint256 arg3) with:
         gas gas_remaining wei
        args address(arg1), Array(len=arg2.length, data=arg2[all]), stor108
