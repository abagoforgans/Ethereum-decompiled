...
function registerPlayer(string arg1, uint256 arg2) {
    ...
    if not arg1.length % 32:
        emit 0xe058c2d6: Array(len=mem[ceil32(arg1.length) + 320 len floor32(arg1.length) - (arg1.length % 32)], data=mem[floor32(arg1.length) + -(arg1.length % 32) + 160 len arg1.length % 32], Mask(8 * arg1.length % 32, 0, 7), mem[ceil32(arg1.length) + arg1.length + 320])
    else:
        ...
        emit 0xe058c2d6: Array(len=mem[ceil32(arg1.length) + 320 len floor32(arg1.length) - (arg1.length % 32)], data=mem[floor32(arg1.length) + -(arg1.length % 32) + 160 len arg1.length % 32], Mask(8 * arg1.length % 32, 0, 7), mem[ceil32(arg1.length) + arg1.length + 320 len -(arg1.length % 32) + 64])
}
...
function sub_a2c07c31(?) {
    ...
    mem[ceil32(arg1.length) + 352 len ceil32(arg1.length)] = arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]
    if not arg1.length % 32:
        emit 0x5dea6787: Array(len=mem[ceil32(arg1.length) + 320 len floor32(arg1.length) - (arg1.length % 32)], data=mem[floor32(arg1.length) + -(arg1.length % 32) + 160 len arg1.length % 32], Mask(8 * arg1.length % 32, 0, 7), mem[ceil32(arg1.length) + arg1.length + 320])
    else:
        mem[floor32(arg1.length) + ceil32(arg1.length) + 352] = mem[floor32(arg1.length) + ceil32(arg1.length) + -(arg1.length % 32) + 384 len arg1.length % 32]
        emit 0x5dea6787: Array(len=mem[ceil32(arg1.length) + 320 len floor32(arg1.length) - (arg1.length % 32)], data=mem[floor32(arg1.length) + -(arg1.length % 32) + 160 len arg1.length % 32], Mask(8 * arg1.length % 32, 0, 7), mem[ceil32(arg1.length) + arg1.length + 320 len -(arg1.length % 32) + 64])
}
