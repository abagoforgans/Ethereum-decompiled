...
function _fallback() payable {
    ...
    stor1 = code.data[3339 len 32]
    stor2 = code.data[3371 len 32]
    stor3 = code.data[3371 len 32]
    stor4 = code.data[3403 len 32]
    return code.data[165 len 3174]
}
...
function getActionStatus(uint256 arg1) payable {
    return actionStatus[arg1].field_768, 
           ...
           bool(actionStatus[arg1].field_1280),
...
function propose(address arg1, bytes arg2, uint256 arg3) payable {
    stor5++
    actionStatus[stor5 + 1].field_0 = arg1
    actionStatus[stor5 + 1][1][].field_0 = Array(len=arg2.length, data=arg2[all])
    actionStatus[stor5 + 1].field_512 = arg3
    actionStatus[stor5 + 1].field_768 = 0
    actionStatus[stor5 + 1].field_1024 = block.timestamp + stor4
    actionStatus[stor5 + 1].field_1280 = 0
    actionStatus[stor5 + 1].field_1536 = 0
...
function updateAuthority(address arg1, uint8 arg2) payable {
    if 0 == _auth_mode:
        ...
        require 1 == _auth_mode
        call _authorityAddress.canCall(address arg1, address arg2, bytes4 arg3) with:
             gas gas_remaining - 25050 wei
            args msg.sender, address(this.address), call.func_hash
        require ext_call.success
        require ext_call.return_data[0]
    uint256(stor0.field_0) = arg2 or 256 * arg1 or Mask(88, 168, uint256(stor0.field_0)) or Mask(248, 8, _auth_mode)
...
function easyPropose(address arg1, uint256 arg2) payable {
    ...
    stor5++
    actionStatus[stor5 + 1].field_0 = arg1
    actionStatus[stor5 + 1][1][].field_0 = Array(len=stor8[address(msg.sender)].length, data=mem[128 len stor8[address(msg.sender)].length])
    actionStatus[stor5 + 1].field_512 = arg2
    actionStatus[stor5 + 1].field_768 = 0
    actionStatus[stor5 + 1].field_1024 = block.timestamp + stor4
    actionStatus[stor5 + 1].field_1280 = 0
    actionStatus[stor5 + 1].field_1536 = 0
