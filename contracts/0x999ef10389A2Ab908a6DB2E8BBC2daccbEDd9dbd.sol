...
function sub_4d701ad2(?) payable {
    ...
    while idx < 10:
        ...
        if not bool(sub_603277c5.length):
            ...
            mem[0] = 43
            uint256(stor[code.data[5079 len 32] + (0.03125 / idx)].field_0) = uint8(stor40[uint8(idx)].field_0) * 256^(-(idx % 32) + 31) or !(255 * 256^(-(idx % 32) + 31)) and uint256(stor[code.data[5079 len 32] + (0.03125 / idx)].field_0)
        idx = idx + 1
        continue 
    idx = 96
    s = 0
    while 416 > idx + 32:
        ...
        continue 
    sub_52f62631 = sha3(uint8(stor40.length), mem[128 len 288])
}
