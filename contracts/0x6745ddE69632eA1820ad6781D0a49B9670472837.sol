...
function _fallback() {
    mem[96 len -9587] = code.data[9987 len -9587]
    mem[64] = -9491
    ...
    if address(stor0[arg1][arg2][call.data[arg3 + 36 len floor32(arg3.length)]][mem[ceil32(arg3.length) + floor32(arg3.length) + 180 len (arg3.length % 32) + 32]].field_0):
        ...
        if s == required:
            ...
            while ceil32(arg3.length) + stor0[_267][2].length + 128 > idx + 32:
                mem[idx + 32] = stor0[_267][s + 2].field_256
                idx = idx + 32
                s = s + 1
                continue 
            call address(stor0[_267].field_0).mem[ceil32(arg3.length) + 128 len 4] with:
               value stor0[_267].field_256 wei
                 gas gas_remaining - 34710 wei
                args mem[ceil32(arg3.length) + 132 len stor0[_267][2].length + (floor32(stor0[_267][2].length - 1) + -stor0[_267][2].length + 32 % 32) - 4]
            require ext_call.success
            emit Execution(_267);
    else:
        ...
        if s == required:
            ...
            while ceil32(arg3.length) + stor0[_267][2].length + 288 > idx + 32:
                ...
                s = s + 1
                continue 
            call address(stor0[_267].field_0).mem[ceil32(arg3.length) + 288 len 4] with:
               value stor0[_267].field_256 wei
                 gas gas_remaining - 34710 wei
                args mem[ceil32(arg3.length) + 292 len stor0[_267][2].length + (floor32(stor0[_267][2].length - 1) + -stor0[_267][2].length + 32 % 32) - 4]
            require ext_call.success
            emit Execution(_267);
    return _267
}
...
function submitTransactionWithSignatures(address arg1, uint256 arg2, bytes arg3, uint256 arg4, uint8[] arg5, bytes32[] arg6) {
    ...
    if s == required:
        ...
        idx = mem[64]
        s = 0
        while mem[64] + stor0[_477][2].length > idx + 32:
            mem[idx + 32] = stor[s + sha3(mem[0]) + 1]
            idx = idx + 32
            s = s + 1
            continue 
        call address(stor0[_477].field_0).mem[mem[64] len 4] with:
           value stor0[_477].field_256 wei
             gas gas_remaining - 34710 wei
            args mem[mem[64] + 4 len stor0[_477][2].length + (floor32(stor0[_477][2].length - 1) + -stor0[_477][2].length + 32 % 32) - 4]
        require ext_call.success
        emit Execution(_477);
    return _477
}
