...
function _fallback() payable {
    ...
    stor1 = msg.sender
    require not stor7
    require stor5 + 25 * 10^16 >= stor5
    stor5 += 25 * 10^16
    require stor2[address(msg.sender)] + 25 * 10^16 >= stor2[address(msg.sender)]
    stor2[address(msg.sender)] += 25 * 10^16
    emit Distr(25 * 10^16, msg.sender);
    emit Transfer(25 * 10^16, 0, msg.sender);
