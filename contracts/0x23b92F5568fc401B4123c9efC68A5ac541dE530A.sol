...
function _fallback() payable {
    mem[96 len -857] = code.data[1296 len -857]
    mem[64] = -761
    if mem[96] != 0:
        stor3[address(this.address)] = mem[96]
    else:
        stor3[address(this.address)] = 10^6
...
function Mint(uint256 arg1) payable {
    if arg1 == 52013:
        balanceOf[address(msg.sender)] += 8
        balanceOf[this.address] -= 8
        emit Transfer(8, this.address, msg.sender);
}
