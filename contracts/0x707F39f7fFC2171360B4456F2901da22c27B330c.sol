...
const sub_137ac021(?) = block.number
...
function availableBalanceOf(address arg1) {
    ...
    if stor7 < 0:
        stor7 = 0
    if initialSupplyPerAddress - stor7 - balanceOf[address(arg1)] <= 0:
        return 0
    return (initialSupplyPerAddress - stor7 - balanceOf[address(arg1)])
}
