...
function isApprovedOnceFor(address arg1, address arg2) payable {
    return isApprovedOnceFor[address(arg1)][1][address(arg2)]
}
...
function disapprove(address arg1) payable {
    isApprovedOnceFor[address(msg.sender)][1][address(arg1)] = 0
}

function isApproved(address arg1) payable {
    return (isApprovedOnceFor[address(msg.sender)][1][address(arg1)] > 0)
}

function approveOnce(address arg1, uint256 arg2) payable {
    isApprovedOnceFor[address(msg.sender)][1][address(arg1)] += arg2
}

function approve(address arg1) payable {
    isApprovedOnceFor[address(msg.sender)][1][address(arg1)] = 0x100000000000000000000000000000000
}
...
function sendCoinFrom(address arg1, uint256 arg2, address arg3) payable {
    if isApprovedOnceFor[address(arg1)] < arg2:
        return 0
    if isApprovedOnceFor[address(arg1)][1][address(msg.sender)] < arg2:
        return 0
    if arg2 >= 0x100000000000000000000000000000000:
        return 0
    isApprovedOnceFor[address(arg1)][1][address(msg.sender)] -= arg2
