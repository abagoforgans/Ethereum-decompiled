...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor5 = code.data[4183 len 32]
    stor6 = code.data[4215 len 32]
    stor7 = code.data[4247 len 32]
    return code.data[121 len 4062]
}
...
function proxyPayment(address arg1) payable {
    ...
    if block.timestamp < STARTDATE + (216 * 24 * 3600):
        ...
        require (2700 * msg.value) + balanceOf[stor8] >= balanceOf[stor8]
        require (2700 * msg.value) + balanceOf[stor8] >= 2700 * msg.value
        balanceOf[stor8] += 2700 * msg.value
        ...
        if block.timestamp < STARTDATE + (432 * 24 * 3600):
            ...
            require (2400 * msg.value) + balanceOf[stor8] >= balanceOf[stor8]
            require (2400 * msg.value) + balanceOf[stor8] >= 2400 * msg.value
            balanceOf[stor8] += 2400 * msg.value
            ...
            if block.timestamp < STARTDATE + (648 * 24 * 3600):
                ...
                require (2050 * msg.value) + balanceOf[stor8] >= balanceOf[stor8]
                require (2050 * msg.value) + balanceOf[stor8] >= 2050 * msg.value
                balanceOf[stor8] += 2050 * msg.value
                ...
                require (1500 * msg.value) + balanceOf[stor8] >= balanceOf[stor8]
                require (1500 * msg.value) + balanceOf[stor8] >= 1500 * msg.value
                balanceOf[stor8] += 1500 * msg.value
