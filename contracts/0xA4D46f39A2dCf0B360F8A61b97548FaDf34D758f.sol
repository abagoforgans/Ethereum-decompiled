...
function _fallback() payable {
    stor0 = code.data[1381 len 32]
    stor1 = code.data[1413 len 32]
    stor3 = block.timestamp + (60 * code.data[1445 len 32])
    stor4 = code.data[1477 len 32]
    uint256(stor5.field_0) = Mask(96, 0, stor5.field_160)
    return code.data[99 len 1282]
}
