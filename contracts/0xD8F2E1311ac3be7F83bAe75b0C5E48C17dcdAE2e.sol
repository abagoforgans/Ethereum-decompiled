...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[13203 len 20]
    stor2 = code.data[13203 len 20]
    stor3 = msg.sender
    require code.data[13235 len 20]
    require code.data[13283 len 4] >= 0
    require code.data[13283 len 4] <= 10^6
    stor7 = code.data[13235 len 20]
    uint32(stor11.field_32) = code.data[13283 len 4]
    if code.data[13299 len 20]:
        ...
        require code.data[13299 len 20]
        require code.data[13299 len 20] != this.address
        require code.data[13347 len 4] > 0
        require code.data[13347 len 4] <= 10^6
        require stor2 != code.data[13299 len 20]
        require not stor10[address(code.data[13287 len 32])].field_304
        require uint32(code.data[13319 len 32] + uint32(stor11.field_0)) <= 10^6
        stor10[address(code.data[13287 len 32])].field_0 = 0
        stor10[address(code.data[13287 len 32])].field_256 = code.data[13347 len 4]
        stor10[address(code.data[13287 len 32])].field_288 = 0
        stor10[address(code.data[13287 len 32])].field_296 = 1
        stor10[address(code.data[13287 len 32])].field_304 = 1
        stor10[address(code.data[13287 len 32])].field_312 = 0
        stor10[address(code.data[13287 len 32])].field_512 = 0
        stor8.length++
        if not stor8.length <= stor8.length + 1:
            ...
            while stor8.length > idx:
                ...
                idx = idx + 1
                continue 
        address(stor8[stor8.length]) = code.data[13299 len 20]
        uint32(stor11.field_0) = uint32(code.data[13319 len 32] + uint32(stor11.field_0))
    return code.data[1388 len 11803]
}
    ...
    if connectors[address(arg1)].field_288:
        ...
        if ext_call.return_data[31 len 1] != uint8(ext_call.return_data[0]):
            if uint8(ext_call.return_data[0]) <= ext_call.return_data[31 len 1]:
                if connectors[address(arg1)].field_256 * ext_call.return_data[0]:
                    require connectors[address(arg1)].field_256 * ext_call.return_data[0]
                    require 10^0 * connectors[address(arg1)].field_256 * ext_call.return_data[0] / connectors[address(arg1)].field_256 * ext_call.return_data[0] == 10^0
            else:
                if 10^6 * connectors[address(arg1)].field_0:
                    require 10^6 * connectors[address(arg1)].field_0
                    require 10^6 * 10^0 * connectors[address(arg1)].field_0 / 10^6 * connectors[address(arg1)].field_0 == 10^0
        ...
        if ext_call.return_data[31 len 1] != uint8(ext_call.return_data[0]):
            if uint8(ext_call.return_data[0]) <= ext_call.return_data[31 len 1]:
                ...
                if 10^6 * ext_call.return_data[0]:
                    ...
                    require 10^6 * 10^0 * ext_call.return_data[0] / 10^6 * ext_call.return_data[0] == 10^0
