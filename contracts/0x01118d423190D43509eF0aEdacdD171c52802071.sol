...
function sub_0922f6cf(?) {
    ...
    return (ext_call.return_data[0] * arg2 / 10^18 / 10^18 / 10^ext_call.return_data[31 len 1])
}
...
function sub_8aca752d(?) {
    ...
    if var18003 - 1:
        ...
        if var26003 - 1:
            ...
            if var34003 - 1:
                ...
                if var42003 - 1:
                    ...
                    require return_data.size >= 32
                    require 10^ext_call.return_data[31 len 1]
                    mem[480] = ext_call.return_data[0] * arg2 / 10^18 / 10^18 / 10^ext_call.return_data[31 len 1]
                    mem[128] = 448
                    mem[512] = 1
                    require ext_code.size(stor2)
                    staticcall stor2.getExchange(address arg1) with:
                ...
                require return_data.size >= 32
                require 10^ext_call.return_data[31 len 1]
                mem[416] = ext_call.return_data[0] * arg2 / 10^18 / 10^18 / 10^ext_call.return_data[31 len 1]
                mem[128] = 384
                mem[448] = 1
                require ext_code.size(stor2)
                staticcall stor2.getExchange(address arg1) with:
                ...
                if var81003 - 1:
                    ...
                    require return_data.size >= 32
                    require 10^ext_call.return_data[31 len 1]
                    mem[768] = ext_call.return_data[0] * _977 / 10^18 / 10^18 / 10^ext_call.return_data[31 len 1]
                    mem[608] = 736
                    mem[800] = 1
                    require ext_code.size(stor2)
                    staticcall stor2.getExchange(address arg1) with:
            ...
            require return_data.size >= 32
            require 10^ext_call.return_data[31 len 1]
            mem[352] = ext_call.return_data[0] * arg2 / 10^18 / 10^18 / 10^ext_call.return_data[31 len 1]
            mem[128] = 320
            mem[384] = 1
            require ext_code.size(stor2)
            staticcall stor2.getExchange(address arg1) with:
            ...
            if not var73003 - 1:
                ...
                require return_data.size >= 32
                require 10^ext_call.return_data[31 len 1]
                mem[704] = ext_call.return_data[0] * _486 / 10^18 / 10^18 / 10^ext_call.return_data[31 len 1]
                mem[544] = 672
                mem[736] = 1
                require ext_code.size(stor2)
                staticcall stor2.getExchange(address arg1) with:
            ...
            if var81003 - 1:
                ...
                require return_data.size >= 32
                require 10^ext_call.return_data[31 len 1]
                mem[768] = ext_call.return_data[0] * _486 / 10^18 / 10^18 / 10^ext_call.return_data[31 len 1]
                mem[544] = 736
                mem[800] = 1
                require ext_code.size(stor2)
                staticcall stor2.getExchange(address arg1) with:
        ...
        require return_data.size >= 32
        require 10^ext_call.return_data[31 len 1]
        mem[288] = ext_call.return_data[0] * arg2 / 10^18 / 10^18 / 10^ext_call.return_data[31 len 1]
        mem[128] = 256
        mem[320] = 1
        require ext_code.size(stor2)
        staticcall stor2.getExchange(address arg1) with:
        ...
        if not var65003 - 1:
            ...
            require return_data.size >= 32
            require 10^ext_call.return_data[31 len 1]
            mem[640] = ext_call.return_data[0] * _186 / 10^18 / 10^18 / 10^ext_call.return_data[31 len 1]
            mem[480] = 608
            mem[672] = 1
            require ext_code.size(stor2)
            staticcall stor2.getExchange(address arg1) with:
        ...
        if not var73003 - 1:
            ...
            require return_data.size >= 32
            require 10^ext_call.return_data[31 len 1]
            mem[704] = ext_call.return_data[0] * _186 / 10^18 / 10^18 / 10^ext_call.return_data[31 len 1]
            mem[480] = 672
            mem[736] = 1
            require ext_code.size(stor2)
            staticcall stor2.getExchange(address arg1) with:
        ...
        if var81003 - 1:
            ...
            require return_data.size >= 32
            require 10^ext_call.return_data[31 len 1]
            mem[768] = ext_call.return_data[0] * _186 / 10^18 / 10^18 / 10^ext_call.return_data[31 len 1]
            mem[480] = 736
            mem[800] = 1
            require ext_code.size(stor2)
            staticcall stor2.getExchange(address arg1) with:
