...
function _fallback() {
    stor0 = address(code.data[7802 len 32])
    stor1 = msg.sender
    stor2 = address(code.data[7834 len 32])
    stor3 = address(code.data[7866 len 32])
    stor4 = 0
    uint64(stor5.field_0) = uint64(code.data[7898 len 32])
    Mask(192, 0, stor5.field_64) = 0
    return code.data[621 len 7181]
}
...
function abandon() {
    ...
    Mask(192, 0, stor5.field_64) = 1
}

function admin() {
    return stor0, stor1, stor2, stor3, stor4, nextEscrowId, bool(uint8(stor5.field_64))
}
...
function sub_6c886ee4(?) payable {
    require msg.sender == escrowDeed[arg1 << 192].field_512
    require escrowDeed[arg1 << 192].field_1280 <= 6
    require escrowDeed[arg1 << 192].field_1280 == 2
    require arg2 < escrowDeed[arg1 << 192].field_768
    escrowDeed[arg1 << 192].field_1280 = 4
    stor4 += arg2
    call escrowDeed[arg1 << 192].field_512 with:
       value escrowDeed[arg1 << 192].field_768 - arg2 wei
         gas 2300 * is_zero(value) wei
    require ext_call.success
    emit 0xebe11e2d: arg1
}

function sub_bf25b2dd(?) {
    require escrowDeed[arg1 << 192].field_1024 + (2016 * 24 * 3600) < block.timestamp
    require escrowDeed[arg1 << 192].field_1280 <= 6
    require escrowDeed[arg1 << 192].field_1280 != 4
    require escrowDeed[arg1 << 192].field_1280 <= 6
    require escrowDeed[arg1 << 192].field_1280 != 5
    require escrowDeed[arg1 << 192].field_1280 <= 6
    require escrowDeed[arg1 << 192].field_1280 != 6
    escrowDeed[arg1 << 192].field_1280 = 6
    stor4 += escrowDeed[arg1 << 192].field_768
    emit 0x92c36d49: arg1
}

function withdrawEscrow(uint64 arg1) payable {
    require msg.sender == escrowDeed[arg1 << 192].field_256
    require escrowDeed[arg1 << 192].field_1280 <= 6
    ...
    call escrowDeed[arg1 << 192].field_256 with:
       value escrowDeed[arg1 << 192].field_768 wei
         gas 2300 * is_zero(value) wei
    require ext_call.success
    emit 0x4fe8698d: arg1
}

function sub_70d8efc6(?) {
...
function reject(uint64 arg1, string arg2) payable {
    ...
    emit 0xc32a2ed2: arg1 << 192, Array(len=arg2.length, data=mem[ceil32(arg2.length) + 224 len arg2.length])
}
...
function startEscrow(string arg1, uint256 arg2, uint64 arg3) payable {
    ...
    require not uint8(stor5.field_64)
    ...
    mem[ceil32(arg1.length) + 448] = block.timestamp + (168 * 24 * 3600)
    mem[ceil32(arg1.length) + 480] = 1
    escrowDeed[uint64(stor5.field_0)].field_0 = _81
    escrowDeed[uint64(stor5.field_0)].field_256 = msg.sender
    escrowDeed[uint64(stor5.field_0)].field_512 = 0
    escrowDeed[uint64(stor5.field_0)].field_768 = 0
    escrowDeed[uint64(stor5.field_0)].field_768 = arg2
    escrowDeed[uint64(stor5.field_0)].field_1024 = block.timestamp + (168 * 24 * 3600)
    escrowDeed[uint64(stor5.field_0)].field_1280 = 1
    stor4 = stor4 + msg.value - arg2
    if arg3 > 0:
        require ext_code.size(stor3)
        call stor3.recordEscrowOnBid(uint64 rg1, uint64 rg2) with:
             gas gas_remaining - 710 wei
