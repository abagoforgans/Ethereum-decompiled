...
function _fallback() payable {
    ...
    stor0 = msg.sender
    address(stor11.field_8) = address(code.data[8069 len 32])
    bool(stor1.length) = 0
    stor1.length.field_1 = 14
    stor1.length.field_8 = 'Realisto Token' / 256
    idx = 0
...
#  - generate_token_for(address arg1, uint256 arg2)
...
function mayGenerateAddr() {
    return mayGenerateAddr
}
...
function setGenerateAddr(address arg1) {
    require controllerAddress == msg.sender
    require arg1
    mayGenerateAddr = arg1
}

function finalize() {
    require mayGenerateAddr == msg.sender
