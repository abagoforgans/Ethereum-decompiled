...
const baseTokenURI = Array(len=57, data='https://opensea-creatures-api.he', 'rokuapp.com/api/creature/', Mask(200, -256, 'https://opensea-creatures-api.he', 'rokuapp.com/api/creature/') << 256)
...
function tokenURI(uint256 arg1) {
    require calldata.size - 4 >= 32
    mem[96] = 57
    mem[128] = 'https://opensea-creatures-api.he'
    mem[160] = 'rokuapp.com/api/creature/'
    if not arg1:
        mem[192] = 1
        mem[224] = '0'
        mem[256] = 0
        ...
        mem[320] = 0
        mem[352] = 58
        mem[384 len 58] = code.data[10292 len 58]
        idx = 0
        s = 0
        while idx < 57:
            require idx < 57
    ...
    if not s:
        ...
        mem[_280 + 32 len _279 + _278] = code.data[10292 len _279 + _278]
        _424 = mem[96]
        idx = 0
        s = 0
        while idx < _424:
    ...
    mem[224 len s] = code.data[10292 len s]
    t = s - 1
    idx = arg1
    while idx:
        require t < mem[192]
    ...
    mem[_286 + 32 len _285 + _284] = code.data[10292 len _285 + _284]
    _426 = mem[96]
    idx = 0
    s = 0
    while idx < _426:
