...
function sub_c84044e9(?) payable {
    ...
    if not msg.value:
        ...
        if 1 == arg3:
            ...
            require return_data.size >= 32
            require arg3 <= 3
            emit 0x8bf8ced9: ext_call.return_data[12 len 20], msg.value, address(arg1), stor5, arg3 << 248, msg.sender, arg2
        else:
            require arg3 <= 3
            if 2 == arg3:
                require ext_code.size(configAddress)
                ...
                require return_data.size >= 32
                require arg3 <= 3
                emit 0x8bf8ced9: address(ext_call.return_data[0]), msg.value, address(arg1), stor5, arg3, msg.sender, arg2
            else:
                require arg3 <= 3
                require ext_code.size(configAddress)
                if arg3 != 3:
                    ...
                    require return_data.size >= 32
                    require arg3 <= 3
                    emit 0x8bf8ced9: ext_call.return_data[12 len 20], msg.value, address(arg1), stor5, arg3, msg.sender, arg2
    else:
...
function sub_0f44226c(?) {
    ...
    if not arg2:
        ...
        if 1 == arg4:
            ...
            require return_data.size >= 32
            require arg4 <= 3
            emit 0x8bf8ced9: ext_call.return_data[12 len 20], arg2, address(arg1), stor5, arg4 << 248, msg.sender, arg3
        else:
            require arg4 <= 3
            if 2 == arg4:
                require ext_code.size(configAddress)
                ...
                require return_data.size >= 32
                require arg4 <= 3
                emit 0x8bf8ced9: address(ext_call.return_data[0]), arg2, address(arg1), stor5, arg4, msg.sender, arg3
            else:
                require arg4 <= 3
                require ext_code.size(configAddress)
                if arg4 != 3:
                    ...
                    require return_data.size >= 32
                    require arg4 <= 3
                    emit 0x8bf8ced9: ext_call.return_data[12 len 20], arg2, address(arg1), stor5, arg4, msg.sender, arg3
    else:
