...
mapping of uint256 stor325631079636760216277952345173520764934726024905726490500512775315278244574;
...
function deposit() payable {
    require msg.value + storB84C[msg.sender] >= storB84C[msg.sender]
    require msg.value + storB84C[msg.sender] >= msg.value
    storB84C[msg.sender] += msg.value
    emit Deposit(0, msg.sender, msg.value, msg.value + storB84C[msg.sender]);
}
...
function sub_97c9daf5(?) {
    ...
    while idx < arg2:
        ...
        if stor25[address(s)]:
            ...
            s = stor25[address(s)]
            continue 
        return stor25[address(s)]
    return address(arg1 + (160 * arg2))
}

function withdraw(uint256 arg1) {
    require arg1 <= storB84C[msg.sender]
    require arg1 <= storB84C[msg.sender]
    storB84C[msg.sender] -= arg1
    call msg.sender with:
       value arg1 wei
         gas gas_remaining wei
    require ext_call.success
    emit Withdraw(0, msg.sender, arg1, storB84C[msg.sender]);
}
    ...
    if msg.sender == owner:
        if sub_22be4e68 > sub_b979d22b:
            ...
            while idx <= sub_7cfd2964:
                if 2 * invested[stor17[idx]] <= bonus[stor17[idx]]:
                    invested[stor17[idx]] = 0
                    sub_c0e8886c[stor17[idx]] = 0
                    sub_5653c65b[stor17[idx]] = 0
                    bonus[stor17[idx]] = 0
                    sub_268c01cf[stor17[idx]][0] = 0
                    mem[0] = investor[idx]
                    sub_f490df26[stor17[idx]] = block.number
                    mem[32] = 24
                    sub_a8b39170[stor17[idx]] = block.number
                    idx = idx + 1
                    s = s
                    t = investor[idx]
                    continue 
                require (2 * invested[stor17[idx]] * sub_df75d236) - (bonus[stor17[idx]] * sub_df75d236) + tokens[stor10][stor17[idx]] >= tokens[stor10][stor17[idx]]
                require tokens[stor10][stor17[idx]] >= 0
                tokens[stor10][stor17[idx]] = (2 * invested[stor17[idx]] * sub_df75d236) - (bonus[stor17[idx]] * sub_df75d236) + tokens[stor10][stor17[idx]]
                invested[stor17[idx]] = 0
                sub_c0e8886c[stor17[idx]] = 0
                sub_5653c65b[stor17[idx]] = 0
                bonus[stor17[idx]] = 0
                ...
                sub_a8b39170[stor17[idx]] = block.number
                idx = idx + 1
                s = (2 * invested[stor17[idx]] * sub_df75d236) - (bonus[stor17[idx]] * sub_df75d236)
                t = investor[idx]
                continue 
            sub_bd3f04a5 = 0
            sub_45a568fa = 1
