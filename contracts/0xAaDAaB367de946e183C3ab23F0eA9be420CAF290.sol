...
function sub_e3c45cd3(?) payable {
    if msg.sender == sub_aaabd6b0Address:
        ...
        uint256(stor1.field_0) = arg2 or Mask(96, 160, uint256(stor1.field_0))
}
    ...
    if 31 >= sub_f0f0b7c0[arg1[all]][2].length:
        ...
        if not Mask(255, 1, (256 * not sub_f0f0b7c0[arg1[all]].field_512) - 1 and sub_f0f0b7c0[arg1[all]].field_512):
            ...
            while sub_f0f0b7c0[arg1[all]][2].length + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
    sub_97c052f1[uint64(stor1.field_0)] = sha3(arg1[all])
    Mask(96, 0, stor1.field_160) = Mask(96, 0, sub_12d3b72a + 1)
    return 1
}
