...
function _fallback() payable {
    ...
    require code.data[22906 len 32] >= block.number
    require code.data[22938 len 32] >= code.data[22906 len 32]
    require code.data[22970 len 32] >= code.data[22938 len 32]
    stor0 = code.data[22886 len 20]
    stor1 = code.data[23014 len 20]
    create contract with 0 wei
                    code: code.data[16456 len 6418], 10^18, 160, 9, 224, address(this.address), 6, 'Leverj' << 208, 3, 'LEV' % 16777216
    require create.new_address
    stor3 = address(create.new_address)
    stor4 = code.data[22906 len 32]
    stor5 = code.data[22938 len 32]
    stor6 = code.data[22970 len 32]
    ...
    return code.data[1994 len 14462]
}
...
function changeStartBlock(uint256 arg1) {
    ...
    require freezeBlock <= startBlock
    require startBlock - freezeBlock <= arg1
...
function reversePurchase(address arg1) payable {
    ...
    if ext_call.return_data[0]:
        require ext_call.return_data[0]
        require ext_call.return_data[0] * price_in_wei / ext_call.return_data[0] == price_in_wei
    require msg.value >= ext_call.return_data[0] * price_in_wei
    require ext_call.return_data[0] * price_in_wei <= msg.value
...
function lockUnsoldTokens(address arg1) {
    ...
    require msg.sender == owner
    create contract with 0 wei
                    code: code.data[11759 len 2660], address(arg1), 8760 * 24 * 3600, block.timestamp
    require create.new_address
...
function distributePresaleTokens(address[] arg1, uint256[] arg2) {
    ...
    while idx < arg1.length:
        require idx < arg2.length
        require privateAllocated + mem[(32 * idx) + (32 * arg1.length) + 160] >= privateAllocated
        require privateAllocated + mem[(32 * idx) + (32 * arg1.length) + 160] <= 7502 * 10^14
        require idx < arg1.length
        require idx < arg2.length
    ...
    call tokenAddress.0x70a08231 with:
        ...
        args this.address
    require ext_call.success
    if ext_call.return_data[0] >= 2498 * 10^14:
    revert
}
...
function distributeTimelockedTokens(address[] arg1, uint256[] arg2, uint256[] arg3, uint256[] arg4) {
    ...
    while idx < arg1.length:
        ...
        mem[mem[64] len 2660] = code.data[11759 len 2660]
        mem[mem[64] + 2660] = address(_57)
        mem[mem[64] + 2692] = _61
        mem[mem[64] + 2724] = _63
        create contract with 0 wei
                        code: code.data[11759 len 2660], address(_57), _61, _63
        require create.new_address
        require ext_code.size(address(create.new_address))
        call address(create.new_address).setup(address rg1) with:
             gas gas_remaining - 710 wei
...
function purchaseTokens() payable {
    ...
    if publicSale:
        ...
        if msg.value / price_in_wei <= whitelistRegistrants[address(msg.sender)]:
            require msg.value / price_in_wei <= whitelistRegistrants[address(msg.sender)]
            ...
            require whitelistRegistrants[address(msg.sender)] <= msg.value / price_in_wei
            require (msg.value % price_in_wei) + (msg.value / price_in_wei * price_in_wei) - (whitelistRegistrants[address(msg.sender)] * price_in_wei) >= msg.value % price_in_wei
            require whitelistRegistrants[address(msg.sender)] <= whitelistRegistrants[address(msg.sender)]
