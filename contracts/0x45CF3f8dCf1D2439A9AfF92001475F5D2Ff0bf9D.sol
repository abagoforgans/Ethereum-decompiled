...
function _fallback() {
    stor1 = msg.sender
    stor3 = msg.sender
    stor5 = 0x3472a603fed6345a87083b61eae0e0db7821959e
    stor2 = 0x3472a603fed6345a87083b61eae0e0db7821959e
    stor4 = 0x3472a603fed6345a87083b61eae0e0db7821959e
    stor21 = 0x3472a603fed6345a87083b61eae0e0db7821959e
    stor20 = 0x3472a603fed6345a87083b61eae0e0db7821959e
    stor19 = 0x3472a603fed6345a87083b61eae0e0db7821959e
    stor10 = 0
    stor11 = 0
    stor17 = 10^12
    stor18 = 5
...
function finalize() {
    ...
    require ext_call.success
    require ext_code.size(rlcAddress)
    if rLCSentToETH + rLCSentToBTC + rlc_team + rlc_bounty + rlc_reserve < ext_call.return_data[0]:
        call rlcAddress.0x18160ddd with:
             gas gas_remaining - 710 wei
        require ext_call.success
        require ext_code.size(rlcAddress)
        call rlcAddress.0x42966c68 with:
             gas gas_remaining - 710 wei
            args (ext_call.return_data[0] - rLCSentToETH - rLCSentToBTC - rlc_team - rlc_bounty - rlc_reserve)
        require ext_call.success
...
function receiveBTC(address arg1, string arg2, uint256 arg3, string arg4) {
    ...
    if block.timestamp < startBlock + (240 * 24 * 3600):
        ...
        if rLCSentToBTC + rLCSentToETH + (rLCPerSATOSHI * arg3 / 5) + (rLCPerSATOSHI * arg3) > maxCap:
            emit RefundBTC(Array(len=arg2.length, data=arg2[all]), arg3);
            return 0
        require ext_code.size(rlcAddress)
        call rlcAddress.0xa9059cbb with:
             gas gas_remaining - 710 wei
    ...
    mem[ceil32(arg2.length) + ceil32(arg4.length) + 320 len ceil32(arg2.length)] = arg2[all], mem[arg2.length + 128 len ceil32(arg2.length) - arg2.length]
    mem[arg2.length + ceil32(arg2.length) + ceil32(arg4.length) + 320] = arg4.length
    mem[arg2.length + ceil32(arg2.length) + ceil32(arg4.length) + 352 len ceil32(arg4.length)] = arg4[all], mem[ceil32(arg2.length) + arg4.length + 160 len ceil32(arg4.length) - arg4.length]
    if not arg4.length % 32:
        emit ReceivedBTC(address(arg1), Array(len=arg2.length, data=Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], mem[arg2.length + 128 len ceil32(arg2.length) - arg2.length]) << (8 * ceil32(arg2.length)) - 256, mem[(2 * ceil32(arg2.length)) + ceil32(arg4.length) + 320 len arg4.length + arg2.length + -ceil32(arg2.length) + 32]), bTCReceived, arg2.length + 160);
    else:
        ...
        emit ReceivedBTC(address(arg1), Array(len=arg2.length, data=Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], mem[arg2.length + 128 len ceil32(arg2.length) - arg2.length]) << (8 * ceil32(arg2.length)) - 256, mem[(2 * ceil32(arg2.length)) + ceil32(arg4.length) + 320 len floor32(arg4.length) + arg2.length + -ceil32(arg2.length) + 64]), bTCReceived, arg2.length + 160);
    return 1
}
