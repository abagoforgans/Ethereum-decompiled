...
address owner;
mapping of address sub_9a0f6dc0;
array of uint256 sub_47f76914;

function sub_47f76914(?) {
    return sub_47f76914[address(msg.sender)][0 len sub_47f76914[address(msg.sender)].length]
}

function last_result(address arg1) {
    return sub_47f76914[arg1][0 len sub_47f76914[arg1].length]
}
...
function sub_9a0f6dc0(?) {
    return sub_9a0f6dc0[arg1]
}
...
function __callback(bytes32 arg1, string arg2) {
    ...
    sub_47f76914[stor6[arg1]][] = Array(len=arg2.length, data=arg2[all])
}
