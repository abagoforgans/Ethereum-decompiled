...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0xec2b914efd8a89c8137b2719635e18c8003a7f5d)
    delegate 0xec2b914efd8a89c8137b2719635e18c8003a7f5d.0x66098d4f with:
         gas gas_remaining - 50 wei
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0xec2b914efd8a89c8137b2719635e18c8003a7f5d):
                            delegate 0xec2b914efd8a89c8137b2719635e18c8003a7f5d.0x66098d4f with:
                                 gas gas_remaining - 50 wei
