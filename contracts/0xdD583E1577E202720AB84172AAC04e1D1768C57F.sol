...
function sub_b1ee7a08(?) {
    if stor5[address(msg.sender)]:
        mem[128 len 32 * stor5[address(msg.sender)]] = code.data[2888 len 32 * stor5[address(msg.sender)]]
    idx = 0
    s = 0
...
function sub_caf50b80(?) {
    if stor2[address(msg.sender)]:
        mem[128 len 32 * stor2[address(msg.sender)]] = code.data[2888 len 32 * stor2[address(msg.sender)]]
    idx = 0
    s = 0
    while idx < stor0.length:
        mem[0] = idx
