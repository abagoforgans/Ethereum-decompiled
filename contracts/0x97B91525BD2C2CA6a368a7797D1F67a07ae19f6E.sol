...
const sub_54f42b66(?) = (block.timestamp + 3721)

const sub_57077019(?) = 3600

const sub_649d75a7(?) = 2 * 10^9

const finalizeStartTime = (block.timestamp + 7381)

const finalizeEndTime = (block.timestamp + 31536007381)
...
const sub_aa4cfe0f(?) = (block.timestamp + 7321)

const tokensPerCHF = 10

const sub_e19b8c26(?) = (block.timestamp + 3661)
