...
function shuffle(uint256 arg1) {
    ...
    while idx < 100:
        ...
        while s >= 32:
            ...
            s = s - 32
            continue 
        mem[mem[64] + floor32(mem[_23])] = mem[_23 + floor32(mem[_23]) + -(mem[_23] % 32) + 64 len mem[_23] % 32] or Mask(8 * -(mem[_23] % 32) + 32, -(8 * -(mem[_23] % 32) + 32) + 256, mem[mem[64] + floor32(mem[_23])])
        _44 = sha3(mem[mem[64] len _25 + _22 + -mem[64] + 64])
        require sha3(mem[mem[64] len _25 + _22 + -mem[64] + 64]) % 52 < mem[96]
        _47 = mem[(32 * sha3(mem[mem[64] len _25 + _22 + -mem[64] + 64]) % 52) + 128]
        require idx % 52 < mem[96]
        require sha3(mem[mem[64] len _25 + _22 + -mem[64] + 64]) % 52 < mem[96]
        mem[(32 * sha3(mem[mem[64] len _25 + _22 + -mem[64] + 64]) % 52) + 128] = mem[(32 * idx % 52) + 128]
        require idx % 52 < mem[96]
