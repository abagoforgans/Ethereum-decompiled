...
function getOwner(uint256 arg1) payable {
    ...
    return address(stor[code.data[8340 len 32] + (7 * arg1)].field_0)
}
...
function getBox(uint256 arg1) payable {
    require arg1 < stor11.length
    return address(stor[code.data[8340 len 32] + (7 * arg1)].field_0), 
           uint16(stor[code.data[8340 len 32] + (7 * arg1)].field_0),
           uint16(stor[code.data[8340 len 32] + (7 * arg1)].field_0),
           uint16(stor[code.data[8340 len 32] + (7 * arg1)].field_0),
           uint16(stor[code.data[8340 len 32] + (7 * arg1)].field_208),
           stor5601[arg1],
           storBE01[arg1]
}
...
function sub_7719265a(?) payable {
    ...
    mem[0] = 11
    if uint16(stor[code.data[8340 len 32] + (7 * var20001)].field_160) > arg1:
        var20001 = var20001 + 1
        continue 
    require var20001 < stor11.length
    mem[0] = 11
    if uint16(stor[code.data[8340 len 32] + (7 * var20001)].field_176) > arg2:
        var20001 = var20001 + 1
        continue 
    require var20001 < stor11.length
    mem[0] = 11
    if uint16(stor[code.data[8340 len 32] + (7 * var20001)].field_192) < arg1:
        var20001 = var20001 + 1
        continue 
    require var20001 < stor11.length
    mem[0] = 11
    if uint16(stor[code.data[8340 len 32] + (7 * var20001)].field_208) < arg2:
        var20001 = var20001 + 1
        continue 
    require var20001 < stor11.length
    mem[0] = 11
    if address(stor[code.data[8340 len 32] + (7 * var20001)].field_0) != msg.sender:
        if stor0 != msg.sender:
            var20001 = var20001 + 1
            continue 
    require var20001 != -1
...
function sub_ef957b76(?) payable {
    ...
    mem[0] = 11
    if uint16(stor[code.data[8340 len 32] + (7 * var30001)].field_160) > arg1:
        var30001 = var30001 + 1
        continue 
    require var30001 < stor11.length
    mem[0] = 11
    if uint16(stor[code.data[8340 len 32] + (7 * var30001)].field_176) > arg2:
        var30001 = var30001 + 1
        continue 
    require var30001 < stor11.length
    mem[0] = 11
    if uint16(stor[code.data[8340 len 32] + (7 * var30001)].field_192) < arg1:
        var30001 = var30001 + 1
        continue 
    require var30001 < stor11.length
    mem[0] = 11
    if uint16(stor[code.data[8340 len 32] + (7 * var30001)].field_208) < arg2:
        var30001 = var30001 + 1
        continue 
    require var30001 < stor11.length
    require storBE01[var30001] < block.timestamp
    require var30001 < stor11.length
    uint256(stor[code.data[8340 len 32] + (7 * var30001)].field_0) = msg.sender or Mask(96, 160, uint256(stor[code.data[8340 len 32] + (7 * var30001)].field_0))
    uint256(stor[sha3(code.data[8340 len 32] + (7 * var30001) + 1)][].field_0) = Array(len=arg3.length, data=arg3[all])
    require var30001 < stor11.length
    uint256(stor[sha3(code.data[8340 len 32] + (7 * var30001) + 3)][].field_0) = Array(len=arg4.length, data=arg4[all])
    require var30001 < stor11.length
    uint256(stor[sha3(code.data[8340 len 32] + (7 * var30001) + 2)][].field_0) = Array(len=arg5.length, data=arg5[all])
    require var30001 < stor11.length
    uint256(stor[sha3(code.data[8340 len 32] + (7 * var30001) + 4)][].field_0) = Array(len=arg6.length, data=arg6[all])
    require var30001 < stor11.length
...
function sub_d92ed137(?) payable {
    ...
    mem[ceil32(arg5.length) + ceil32(arg6.length) + ceil32(arg7.length) + ceil32(arg8.length) + 544] = 0
    ...
    while idx < stor11.length:
        ...
        _1505 = mem[64]
        mem[64] = mem[64] + 352
        mem[_1505] = address(stor[code.data[8340 len 32] + (7 * idx)].field_0)
        mem[_1505 + 32] = uint16(stor[code.data[8340 len 32] + (7 * idx)].field_160)
        mem[_1505 + 64] = uint16(stor[code.data[8340 len 32] + (7 * idx)].field_176)
        mem[_1505 + 96] = uint16(stor[code.data[8340 len 32] + (7 * idx)].field_192)
        mem[_1505 + 128] = uint16(stor[code.data[8340 len 32] + (7 * idx)].field_208)
        _1506 = mem[64]
        mem[64] = mem[64] + ceil32(stor[code.data[8340 len 32] + (7 * idx) + 1].length) + 32
        mem[_1506] = stor[code.data[8340 len 32] + (7 * idx) + 1].length
        mem[0] = code.data[8340 len 32] + (7 * idx) + 1
        mem[_1506 + 32] = uint256(stor[sha3(code.data[8340 len 32] + (7 * idx) + 1)].field_0)
        s = _1506 + 32
        t = sha3(mem[0])
        while _1506 + stor[code.data[8340 len 32] + (7 * idx) + 1].length > s:
            mem[s + 32] = stor1[t]
            s = s + 32
            t = t + 1
            continue 
        mem[_1505 + 160] = _1506
        _3004 = mem[64]
        mem[64] = mem[64] + ceil32(stor[code.data[8340 len 32] + (7 * idx) + 2].length) + 32
        mem[_3004] = stor[code.data[8340 len 32] + (7 * idx) + 2].length
        mem[0] = code.data[8340 len 32] + (7 * idx) + 2
        mem[_3004 + 32] = uint256(stor[sha3(code.data[8340 len 32] + (7 * idx) + 2)].field_0)
        s = _3004 + 32
        t = sha3(mem[0])
        while _3004 + stor[code.data[8340 len 32] + (7 * idx) + 2].length > s:
            mem[s + 32] = stor1[t]
            s = s + 32
            t = t + 1
            continue 
        mem[_1505 + 192] = _3004
        _4325 = mem[64]
        mem[64] = mem[64] + ceil32(stor[code.data[8340 len 32] + (7 * idx) + 3].length) + 32
        mem[_4325] = stor[code.data[8340 len 32] + (7 * idx) + 3].length
        mem[0] = code.data[8340 len 32] + (7 * idx) + 3
        mem[_4325 + 32] = uint256(stor[sha3(code.data[8340 len 32] + (7 * idx) + 3)].field_0)
        s = _4325 + 32
        t = sha3(mem[0])
        while _4325 + stor[code.data[8340 len 32] + (7 * idx) + 3].length > s:
            mem[s + 32] = stor1[t]
            s = s + 32
            t = t + 1
            continue 
        mem[_1505 + 224] = _4325
        _5349 = mem[64]
        mem[64] = mem[64] + ceil32(stor[code.data[8340 len 32] + (7 * idx) + 4].length) + 32
        mem[_5349] = stor[code.data[8340 len 32] + (7 * idx) + 4].length
        mem[0] = code.data[8340 len 32] + (7 * idx) + 4
        mem[_5349 + 32] = uint256(stor[sha3(code.data[8340 len 32] + (7 * idx) + 4)].field_0)
        s = _5349 + 32
        t = sha3(mem[0])
        while _5349 + stor[code.data[8340 len 32] + (7 * idx) + 4].length > s:
            mem[s + 32] = stor1[t]
            s = s + 32
            t = t + 1
            continue 
        mem[_1505 + 256] = _5349
        mem[_1505 + 288] = uint256(stor[code.data[8340 len 32] + (7 * idx) + 5].field_0)
        mem[_1505 + 320] = uint256(stor[code.data[8340 len 32] + (7 * idx) + 6].field_0)
