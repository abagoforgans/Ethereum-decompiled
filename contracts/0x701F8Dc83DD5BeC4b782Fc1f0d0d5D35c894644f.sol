...
function withdrawTokenToFounders() {
    ...
    if block.timestamp > startTime + (17280 * 24 * 3600):
        if stor12:
            ...
            call tokenAddress.0xa9059cbb with:
                 gas gas_remaining - 710 wei
                args foundersWalletAddress, stor12
            require ext_call.success
            stor12 = 0
    if block.timestamp > startTime + (15120 * 24 * 3600):
        if stor11:
            require ext_code.size(tokenAddress)
            call tokenAddress.0xa9059cbb with:
                 gas gas_remaining - 710 wei
                args foundersWalletAddress, stor11
            require ext_call.success
            stor11 = 0
    if block.timestamp > startTime + (12960 * 24 * 3600):
        if stor10:
            require ext_code.size(tokenAddress)
            call tokenAddress.0xa9059cbb with:
                 gas gas_remaining - 710 wei
                args foundersWalletAddress, stor10
            require ext_call.success
            stor10 = 0
    if block.timestamp > startTime + (3 * 3600 * 24 * 3600):
        if stor9:
            ...
            call tokenAddress.0xa9059cbb with:
                 gas gas_remaining - 710 wei
                args foundersWalletAddress, stor9
            require ext_call.success
            stor9 = 0
    if block.timestamp > startTime + (8640 * 24 * 3600):
        if stor8:
            ...
            call tokenAddress.0xa9059cbb with:
                 gas gas_remaining - 710 wei
                args foundersWalletAddress, stor8
            require ext_call.success
            stor8 = 0
    if block.timestamp > startTime + (6480 * 24 * 3600):
        if stor7:
            ...
            call tokenAddress.0xa9059cbb with:
                 gas gas_remaining - 710 wei
                args foundersWalletAddress, stor7
            require ext_call.success
            stor7 = 0
    if block.timestamp > startTime + (4320 * 24 * 3600):
        if stor6:
            ...
            call tokenAddress.0xa9059cbb with:
                 gas gas_remaining - 710 wei
                args foundersWalletAddress, stor6
            require ext_call.success
            stor6 = 0
    if block.timestamp > startTime + (2160 * 24 * 3600):
        if founderAmounts.length:
            require ext_code.size(tokenAddress)
            call tokenAddress.0xa9059cbb with:
                 gas gas_remaining - 710 wei
                args foundersWalletAddress, founderAmounts.length
            require ext_call.success
