...
function _fallback() payable {
    ...
    stor3 = code.data[5384 len 32]
    stor7 = 0
    return code.data[74 len 5310]
}
...
function getProduct(bytes32 arg1) payable {
    return product[arg1].field_0, product[arg1].field_256, product[arg1].field_512, product[arg1].field_768
}
...
function sub_a0b5e936(?) payable {
    return product[arg1].field_768
}

function sub_aa5594ca(?) payable {
    return product[arg1].field_512
}
...
function deleteProduct(bytes32 arg1) payable {
    if msg.sender == address(owner):
        product[arg1].field_0 = 0
        product[arg1].field_256 = 0
        product[arg1].field_512 = 0
        product[arg1].field_768 = 0
...
function sub_55850f6e(?) payable {
    if msg.sender == address(owner):
        call configAddress.0x855fe6ed with:
             gas gas_remaining - 25050 wei
            args ('settings/base' << 152)
        require ext_call.success
        product[arg1].field_0 = arg2 * ext_call.return_data[0]
        product[arg1].field_256 = arg3
        product[arg1].field_512 = arg4
        product[arg1].field_768 = arg5 or Mask(248, 8, product[arg1].field_768)
...
function sub_198876d8(?) payable {
    ...
    call configAddress.0x4cb44f8d with:
        ...
        args 0x72656769737472792f676f6c6400000000000000000000000000000000000000
    require ext_call.success
    call address(ext_call.return_data[0]).0xa0922e99 with:
         gas gas_remaining - 25050 wei
        args 0, uint32(msg.sender), arg2, arg3, product[stor5[arg1].field_0].field_0, sub_2e5d5385[arg1].field_0, sub_2e5d5385[arg1].field_1024, address(arg4), product[stor5[arg1].field_0].field_768
