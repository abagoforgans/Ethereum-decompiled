...
function _fallback() {
    ...
    stor6 = code.data[2873 len 20]
    stor5 = code.data[2905 len 20]
    stor7 = code.data[2937 len 20]
    stor1[code.data[2905 len 20]] = 4000000000 * 10^18
    return code.data[169 len 2692]
}
...
function sub_a7b7d51a(?) {
    require stor7 == msg.sender
    require balanceOf[address(msg.sender)] + 100000 >= balanceOf[address(msg.sender)]
