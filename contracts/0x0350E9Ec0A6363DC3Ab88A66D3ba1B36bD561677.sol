    ...
    if arg1 > 0:
        if gas_remaining < 620000:
            ...
            if not var30001:
                ...
                _388 = mem[(32 * var34001) + 96]
                mem[1696] = 0
                mem[1376] = 0xe98b7f4d00000000000000000000000000000000000000000000000000000000
                mem[1380] = uint64(_388)
                require ext_code.size(stor0)
