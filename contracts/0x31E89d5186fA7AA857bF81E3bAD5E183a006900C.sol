...
function updateRates(uint256[] arg1) {
    ...
    if var14005 < var14001 / 2:
        ...
        _45 = mem[(64 * var16003) + 128]
        require (2 * var16003) + 1 < arg1.length
        _47 = mem[(32 * (2 * var16003) + 1) + 128]
        rates[mem[(64 * var16003) + 128]] = mem[(32 * (2 * var16003) + 1) + 128]
        mem[(32 * arg1.length) + 128] = block.timestamp
        mem[(32 * arg1.length) + 160] = _45
        mem[(32 * arg1.length) + 192] = _47
        emit RateUpdated(block.timestamp, _45, _47);
        s = 2 * var16003
        s = var16001
        s = var16002
        idx = var16003
        while idx + 1 < arg1.length / 2:
            ...
            _45 = mem[(64 * idx + 2) + 128]
            require (2 * idx + 1) + 1 < arg1.length
            _47 = mem[(32 * (2 * idx + 1) + 1) + 128]
