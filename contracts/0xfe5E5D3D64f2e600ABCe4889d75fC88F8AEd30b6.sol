...
function _fallback() payable {
    ...
    require ext_call.success
    return code.data[1789 len 5444]
}
...
function update() payable {
    ...
    call address(stor1).query_withGasLimit(uint256 rg1, string rg2, string rg3, uint256 rg4) with:
       value ext_call.return_data[0] wei
        ...
        args 60, 128, 192, 500000, 0, 3, 'URL' % 16777216, 0, 101, 'json(https://api.kraken.com/0/pu', 'blic/Ticker?pair=ETHXBT,DASHXBT,', 'ETHUSD,LTCXBT,XBTUSD).result.*[b', ',a].0' >> 256, Mask(40, -512, 'blic/Ticker?pair=ETHXBT,DASHXBT,', 'ETHUSD,LTCXBT,XBTUSD).result.*[b', ',a].0') << 512
    require ext_call.success
}
