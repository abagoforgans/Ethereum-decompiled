...
mapping of struct sub_d0e4dec3;
mapping of struct sub_abbd27a6;
uint256 stor5;

function sub_0779e0e5(?) {
    return sub_abbd27a6[arg1].field_768
}

function sub_0aaaea93(?) {
    return sub_d0e4dec3[address(msg.sender)].field_256
}

function getToken() {
    return sub_d0e4dec3[address(msg.sender)].field_768
}
...
function _fallback() payable {
    jackpot += msg.value
    stor5++
    if not sub_d0e4dec3[address(msg.sender)].field_0:
        call msg.sender with:
             gas 2300 wei
        require ext_call.success
        sub_d0e4dec3[address(msg.sender)].field_0 = stor2.length
        stor2.length++
    ...
    sub_d0e4dec3[address(msg.sender)].field_512 = msg.value
    sub_d0e4dec3[address(msg.sender)].field_256 = stor5
    sub_abbd27a6[stor5].field_0 = sub_d0e4dec3[address(msg.sender)].field_0
    sub_abbd27a6[stor5].field_256 = sub_d0e4dec3[address(msg.sender)].field_256
    sub_abbd27a6[stor5].field_512 = sub_d0e4dec3[address(msg.sender)].field_512
    sub_abbd27a6[stor5].field_768 = sub_d0e4dec3[address(msg.sender)].field_768
    ...
    sub_d0e4dec3[address(stor2[stor4[stor5].field_0])].field_768 = sha3(block.timestamp, msg.sender, stor5) % 1024 % 445
