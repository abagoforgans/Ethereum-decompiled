...
function _fallback() payable {
    ...
    require code.data[9197 len 20]
    require code.data[9217 len 32] > block.number
    require code.data[9249 len 32] > code.data[9217 len 32]
    Mask(96, 0, stor0.field_160) = 0
    stor1 = code.data[9197 len 20]
    create contract with 0 wei
                    code: code.data[4989 len 4196]
    require create.new_address
    stor2 = address(create.new_address)
    stor5 = code.data[9217 len 32]
    stor6 = code.data[9249 len 32]
    return code.data[540 len 4449]
}
...
function getTokenAmount(uint256 arg1, uint256 arg2) {
    ...
    if arg1 >= 31250 * 10^18:
        ...
        require (-45 * arg1) + (80 * arg2) + (890625 * 10^15 * 24 * 3600) >= (-125 * arg1) + 8906250 * 10^18
        require (-45 * arg1) + (890625 * 10^15 * 24 * 3600) >= (80 * arg1) - 5700000 * 10^18
        return ((-45 * arg1) + (80 * arg2) + (890625 * 10^15 * 24 * 3600))
    ...
    if 40000 * 10^18 >= arg2 + arg1 - 31250 * 10^18:
        ...
        require (-35 * arg1) + (125 * arg2) + 1093750 * 10^18 >= (-160 * arg1) + 5000000 * 10^18
        require (-35 * arg1) + 1093750 * 10^18 >= (125 * arg1) - 3906250 * 10^18
        return ((-35 * arg1) + (125 * arg2) + 1093750 * 10^18)
    ...
    require (-80 * arg1) + (80 * arg2) + 4300000 * 10^18 >= (-160 * arg1) + 5000000 * 10^18
    require (-80 * arg1) + 4300000 * 10^18 >= (80 * arg1) - 700000 * 10^18
    return ((-80 * arg1) + (80 * arg2) + 4300000 * 10^18)
}
...
function _fallback() payable {
    ...
    require etherReceived + msg.value >= msg.value
    require etherReceived + msg.value <= 133750 * 10^18
    if not msg.value:
        require ext_code.size(moedaTokenAddress)
        call moedaTokenAddress.create(address rg1, uint256 rg2) with:
             gas gas_remaining - 710 wei
        ...
        if etherReceived >= 31250 * 10^18:
            if etherReceived >= 71250 * 10^18:
                ...
                if -etherReceived + 133750 * 10^18 < msg.value:
                    ...
                    require etherReceived + msg.value >= msg.value
                    etherReceived += msg.value
                    require totalTokensSold + (-80 * etherReceived) + 10700000 * 10^18 >= totalTokensSold
                    require totalTokensSold >= 0
                    totalTokensSold = totalTokensSold + (-80 * etherReceived) + 10700000 * 10^18
                    ...
                    require etherReceived + msg.value >= msg.value
                    etherReceived += msg.value
                    require totalTokensSold + (80 * msg.value) >= totalTokensSold
                    require totalTokensSold + (80 * msg.value) >= 80 * msg.value
                ...
                if -etherReceived + 71250 * 10^18 >= msg.value:
                    ...
                    require etherReceived + msg.value >= msg.value
                    etherReceived += msg.value
                    require totalTokensSold + (125 * msg.value) >= totalTokensSold
                    require totalTokensSold + (125 * msg.value) >= 125 * msg.value
                    ...
                    if not msg.value + etherReceived - 71250 * 10^18:
                        ...
                        require etherReceived + msg.value >= msg.value
                        etherReceived += msg.value
                        require totalTokensSold + (-125 * etherReceived) + 8906250 * 10^18 >= totalTokensSold
                        require totalTokensSold >= 0
                        totalTokensSold = totalTokensSold + (-125 * etherReceived) + 8906250 * 10^18
                        ...
                        if 62500 * 10^18 < msg.value + etherReceived - 71250 * 10^18:
                            ...
                            require etherReceived + msg.value >= msg.value
                            etherReceived += msg.value
                            require totalTokensSold + (-125 * etherReceived) + 13906250 * 10^18 >= totalTokensSold
                            require totalTokensSold >= 0
                            totalTokensSold = totalTokensSold + (-125 * etherReceived) + 13906250 * 10^18
                            ...
                            require (-45 * etherReceived) + (80 * msg.value) + (890625 * 10^15 * 24 * 3600) >= (-125 * etherReceived) + 8906250 * 10^18
                            require (-45 * etherReceived) + (890625 * 10^15 * 24 * 3600) >= (80 * etherReceived) - 5700000 * 10^18
                            require ext_code.size(moedaTokenAddress)
                            call moedaTokenAddress.create(address rg1, uint256 rg2) with:
                                 gas gas_remaining - 710 wei
                                args msg.sender, (-45 * etherReceived) + (80 * msg.value) + (890625 * 10^15 * 24 * 3600)
                            require ext_call.success
                            require etherReceived + msg.value >= etherReceived
                            require etherReceived + msg.value >= msg.value
                            etherReceived += msg.value
                            require totalTokensSold + (-45 * etherReceived) + (80 * msg.value) + (890625 * 10^15 * 24 * 3600) >= totalTokensSold
                            require totalTokensSold >= 0
                            totalTokensSold = totalTokensSold + (-45 * etherReceived) + (80 * msg.value) + (890625 * 10^15 * 24 * 3600)
                            emit Purchase(msg.value, (-45 * etherReceived) + (80 * msg.value) + (890625 * 10^15 * 24 * 3600), msg.sender);
        else:
            ...
            if -etherReceived + 31250 * 10^18 >= msg.value:
                ...
                require etherReceived + msg.value >= msg.value
                etherReceived += msg.value
                require totalTokensSold + (160 * msg.value) >= totalTokensSold
                require totalTokensSold + (160 * msg.value) >= 160 * msg.value
                ...
                if not msg.value + etherReceived - 31250 * 10^18:
                    ...
                    require etherReceived + msg.value >= msg.value
                    etherReceived += msg.value
                    require totalTokensSold + (-160 * etherReceived) + 5000000 * 10^18 >= totalTokensSold
                    require totalTokensSold >= 0
                    totalTokensSold = totalTokensSold + (-160 * etherReceived) + 5000000 * 10^18
                    ...
                    if 40000 * 10^18 >= msg.value + etherReceived - 31250 * 10^18:
                        ...
                        require (-35 * etherReceived) + (125 * msg.value) + 1093750 * 10^18 >= (-160 * etherReceived) + 5000000 * 10^18
                        require (-35 * etherReceived) + 1093750 * 10^18 >= (125 * etherReceived) - 3906250 * 10^18
                        require ext_code.size(moedaTokenAddress)
                        call moedaTokenAddress.create(address rg1, uint256 rg2) with:
                             gas gas_remaining - 710 wei
                            args msg.sender, (-35 * etherReceived) + (125 * msg.value) + 1093750 * 10^18
                        require ext_call.success
                        require etherReceived + msg.value >= etherReceived
                        require etherReceived + msg.value >= msg.value
                        etherReceived += msg.value
                        require totalTokensSold + (-35 * etherReceived) + (125 * msg.value) + 1093750 * 10^18 >= totalTokensSold
                        require totalTokensSold >= 0
                        totalTokensSold = totalTokensSold + (-35 * etherReceived) + (125 * msg.value) + 1093750 * 10^18
                        emit Purchase(msg.value, (-35 * etherReceived) + (125 * msg.value) + 1093750 * 10^18, msg.sender);
                    else:
                        ...
                        if not msg.value + etherReceived - 71250 * 10^18:
                            ...
                            require etherReceived + msg.value >= msg.value
                            etherReceived += msg.value
                            require totalTokensSold + (-160 * etherReceived) + 10000000 * 10^18 >= totalTokensSold
                            require totalTokensSold >= 0
                            totalTokensSold = totalTokensSold + (-160 * etherReceived) + 10000000 * 10^18
                            ...
                            if 62500 * 10^18 < msg.value + etherReceived - 71250 * 10^18:
                                ...
                                require etherReceived + msg.value >= msg.value
                                etherReceived += msg.value
                                require totalTokensSold + (-160 * etherReceived) + 15000000 * 10^18 >= totalTokensSold
                                require totalTokensSold >= 0
                                totalTokensSold = totalTokensSold + (-160 * etherReceived) + 15000000 * 10^18
                                ...
                                require (-80 * etherReceived) + (80 * msg.value) + 4300000 * 10^18 >= (-160 * etherReceived) + 5000000 * 10^18
                                require (-80 * etherReceived) + 4300000 * 10^18 >= (80 * etherReceived) - 700000 * 10^18
                                require ext_code.size(moedaTokenAddress)
                                call moedaTokenAddress.create(address rg1, uint256 rg2) with:
                                     gas gas_remaining - 710 wei
                                    args msg.sender, (-80 * etherReceived) + (80 * msg.value) + 4300000 * 10^18
                                require ext_call.success
                                require etherReceived + msg.value >= etherReceived
                                require etherReceived + msg.value >= msg.value
                                etherReceived += msg.value
                                require totalTokensSold + (-80 * etherReceived) + (80 * msg.value) + 4300000 * 10^18 >= totalTokensSold
                                require totalTokensSold >= 0
                                totalTokensSold = totalTokensSold + (-80 * etherReceived) + (80 * msg.value) + 4300000 * 10^18
                                emit Purchase(msg.value, (-80 * etherReceived) + (80 * msg.value) + 4300000 * 10^18, msg.sender);
