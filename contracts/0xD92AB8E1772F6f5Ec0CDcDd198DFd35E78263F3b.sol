...
function sub_e6309682(?) {
    ...
    if stor1[address(arg1)][Mask(249, 7, arg2)] / 2^(2 * arg2 % 128) % 4 > 1:
        require 2^(32 * arg2 % 8)
        return sub_f11badc0[address(arg1)].field_256 + (Mask(23, 9, stor2[address(arg1)][Mask(253, 3, arg2)] / 2^(32 * arg2 % 8)) >> 9), 
               stor2[address(arg1)][Mask(253, 3, arg2)] / 2^(32 * arg2 % 8) << 247,
    ...
    if bool(stor1[address(arg1)][Mask(249, 7, arg2)] / 2^(2 * arg2 % 128)) != sub_f11badc0[address(arg1)].field_784:
        return 0
    if msg.sender == sub_f11badc0[address(arg1)][2][arg4 << 240].field_0:
        if arg3:
