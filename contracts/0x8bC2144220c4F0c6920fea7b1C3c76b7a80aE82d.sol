...
function baseUnit(bytes32 arg1) payable {
    if not sub_c4242719[arg1]:
        return 0
    require sub_c4242719[arg1] < assets.length
    return uint8(assets[stor0[arg1]].field_256)
}
...
function sub_70abebab(?) payable {
    ...
    uint256(stor[sha3((8 * assets.length) + ('name', 'assets', 1) + 5)].field_256) = msg.sender or Mask(96, 160, uint256(stor[sha3((8 * assets.length) + ('name', 'assets', 1) + 5)].field_256))
    require assets.length < assets.length
    uint256(stor[(8 * assets.length) + ('name', 'assets', 1) + 4][address(msg.sender)].field_0) = 1
