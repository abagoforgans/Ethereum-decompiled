...
function _fallback() payable {
    ...
    mem[96 len -7020] = code.data[7860 len -7020]
    mem[64] = -6924
    stor6 = mem[160]
    stor3 = mem[160]
...
function transfer(address arg1, uint256 arg2) {
    if balanceOf[address(msg.sender)] < (arg2 * stor8 / 100 * 10^6) + (3 * arg2 * stor9 / 100 * 10^6) + arg2:
        return 0
    if arg2 <= 0:
        return 0
    if balanceOf[address(arg1)] + arg2 <= balanceOf[address(arg1)]:
        return 0
    require (arg2 * stor8 / 100 * 10^6) + (3 * arg2 * stor9 / 100 * 10^6) + arg2 <= balanceOf[address(msg.sender)]
    balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] - (arg2 * stor8 / 100 * 10^6) - (3 * arg2 * stor9 / 100 * 10^6) - arg2
    require balanceOf[address(arg1)] + arg2 >= balanceOf[address(arg1)]
    balanceOf[address(arg1)] += arg2
    require balanceOf[stor7] + (arg2 * stor8 / 100 * 10^6) >= balanceOf[stor7]
    balanceOf[stor7] += arg2 * stor8 / 100 * 10^6
    require balanceOf[stor10] + (arg2 * stor9 / 100 * 10^6) >= balanceOf[stor10]
    balanceOf[stor10] += arg2 * stor9 / 100 * 10^6
    require balanceOf[stor11] + (arg2 * stor9 / 100 * 10^6) >= balanceOf[stor11]
    balanceOf[stor11] += arg2 * stor9 / 100 * 10^6
    require balanceOf[stor12] + (arg2 * stor9 / 100 * 10^6) >= balanceOf[stor12]
    balanceOf[stor12] += arg2 * stor9 / 100 * 10^6
...
function _fallback() payable {
    ...
    require balanceOf[stor5] >= msg.value * price / 10^18
