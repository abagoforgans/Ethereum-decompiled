...
function _fallback() {
    stor3 = msg.sender
    stor7 = code.data[4346 len 20]
    stor8 = code.data[4378 len 20]
    stor0 = code.data[4398 len 32]
    stor5 = code.data[4430 len 32]
    stor6 = code.data[4462 len 32]
    stor1[code.data[4378 len 20]] = code.data[4398 len 32]
    return code.data[187 len 4147]
}
...
function _fallback() payable {
    ...
    require price * msg.value / 10^18 <= balanceOf[stor8]
    balanceOf[stor8] -= price * msg.value / 10^18
