...
function _fallback() payable {
    ...
    require code.data[2605 len 20]
    require code.data[2625 len 32] > block.timestamp
    address(stor0.field_0) = code.data[2605 len 20]
    stor1 = code.data[2625 len 32]
    return code.data[271 len 2322]
}
...
function setWallet() payable {
    ...
    walletAddress = 0x803bbb9ee603dfd30dad37c405c5ecca01d9a120
}
...
function _fallback() payable {
    ...
    require msg.sender == 0x803bbb9ee603dfd30dad37c405c5ecca01d9a120
