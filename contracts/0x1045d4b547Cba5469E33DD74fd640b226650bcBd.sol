...
function _fallback() payable {
    ...
    stor4 = code.data[5781 len 20]
    address(stor5.field_0) = code.data[5813 len 20]
    stor6 = code.data[5833 len 32]
    stor7 = code.data[5865 len 32]
    stor0 = 500000000 * 10^18
    stor1[address(stor5.field_0)] = 500000000 * 10^18
    emit CreateBAT(500000000 * 10^18, address(stor5.field_0));
    return code.data[773 len 4996]
}
