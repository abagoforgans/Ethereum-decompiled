...
function _fallback() payable {
    ...
    stor0 = msg.sender
    address(stor11.field_8) = 0
    bool(stor1.length) = 0
    stor1.length.field_1 = 11
    stor1.length.field_8 = 'Proxy Token' / 256
    idx = 0
    ...
    stor4.length.field_8 = 'Proxy 1.1' / 256
    idx = 0
    while stor4.length + 31 / 32 > idx:
        stor4[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[652 len 6986]
}
