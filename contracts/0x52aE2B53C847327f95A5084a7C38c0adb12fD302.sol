...
function _fallback() {
    stor0 = msg.sender
    stor0 = code.data[2401 len 20]
    stor2 = code.data[2433 len 20]
    stor3 = code.data[2465 len 20]
    stor5 = code.data[2497 len 20]
    return code.data[175 len 2214]
}
...
function changeController(address arg1) {
    ...
    call sntAddress.0x3cebb823 with:
...
function onApprove(address arg1, address arg2, uint256 arg3) {
    ...
    return (sgtExchangerAddress == arg1)
}
