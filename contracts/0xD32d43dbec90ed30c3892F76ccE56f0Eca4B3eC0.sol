...
function organizations(bytes32 arg1) payable {
    require calldata.size - 4 >= 32
    return address(organizations[arg1])
}
...
function redeemDaoBounty(bytes32 arg1, address arg2) payable {
    ...
    emit RedeemDaoBounty((voteInfo[arg1][19][address(arg2)].field_512 * voteInfo[arg1].field_1792 / voteInfo[arg1][18][voteInfo[arg1].field_512].field_0), arg1, address(organizations[stor1[arg1].field_0]), arg2);
    return voteInfo[arg1][19][address(arg2)].field_512 * voteInfo[arg1].field_1792 / voteInfo[arg1][18][voteInfo[arg1].field_512].field_0, 
           voteInfo[arg1][19][address(arg2)].field_512 * voteInfo[arg1].field_1792 / voteInfo[arg1][18][voteInfo[arg1].field_512].field_0
}

function propose(uint256 arg1, bytes32 arg2, address arg3, address arg4) payable {
    require calldata.size - 4 >= 128
    if block.timestamp <= stor0[arg2].field_2816:
        revert with 0, 'not active yet'
    require 50 <= stor0[arg2].field_0
    require proposalsCnt + 1 >= proposalsCnt
    proposalsCnt++
    mem[692 len 96] = code.data[17454 len 96]
    mem[788] = 40
    mem[692] = block.timestamp
    if not address(organizations[msg.sender][arg4]):
        if arg4:
            address(organizations[msg.sender][arg4]) = arg4
        else:
            uint256(organizations[msg.sender][arg4]) = msg.sender or Mask(96, 160, uint256(organizations[msg.sender][arg4]))
    if not stor0[arg2].field_2560:
        voteInfo[this.address][stor5].field_0 = sha3(msg.sender, arg4)
        voteInfo[this.address][stor5].field_256 = msg.sender
        voteInfo[this.address][stor5].field_256 = msg.sender
        voteInfo[this.address][stor5].field_416 = 3
        voteInfo[this.address][stor5].field_512 = 2
        voteInfo[this.address][stor5].field_768 = arg3
        voteInfo[this.address][stor5].field_1024 = stor0[arg2].field_512
        voteInfo[this.address][stor5].field_1280 = arg2
        if 0 >= stor0[arg2].field_2304:
            voteInfo[this.address][stor5].field_1536 = 0
            voteInfo[this.address][stor5].field_1792 = 0
            voteInfo[this.address][stor5].field_2048 = 0
            voteInfo[this.address][stor5].field_2304 = 0
            voteInfo[this.address][stor5].field_2560 = 0
            s = 11
            idx = 692
            while 788 > idx:
                voteInfo[this.address][stor5][s].field_0 = mem[idx]
                s = s + 1
                idx = idx + 32
                continue 
            idx = 14
            while 14 > idx:
                voteInfo[this.address][stor5][idx].field_0 = 0
                idx = idx + 1
                continue 
            voteInfo[this.address][stor5].field_3584 = 0
            voteInfo[this.address][stor5][18][2].field_0 = 0
        else:
            voteInfo[this.address][stor5].field_1536 = stor0[arg2].field_2304
            voteInfo[this.address][stor5].field_1792 = 0
            voteInfo[this.address][stor5].field_2048 = stor0[arg2].field_2304
            voteInfo[this.address][stor5].field_2304 = 0
            voteInfo[this.address][stor5].field_2560 = 0
            s = 11
            idx = 692
            ...
            while 14 > idx:
                ...
                continue 
            voteInfo[this.address][stor5].field_3584 = 0
            voteInfo[this.address][stor5][18][2].field_0 = stor0[arg2].field_2304
    else:
        require averagesDownstakesOfBoosted[msg.sender][arg4] * stor0[arg2].field_2560 / stor0[arg2].field_2560 == averagesDownstakesOfBoosted[msg.sender][arg4]
        voteInfo[this.address][stor5].field_0 = sha3(msg.sender, arg4)
        voteInfo[this.address][stor5].field_256 = msg.sender
        voteInfo[this.address][stor5].field_256 = msg.sender
        voteInfo[this.address][stor5].field_416 = 3
        ...
        voteInfo[this.address][stor5].field_1024 = stor0[arg2].field_512
        voteInfo[this.address][stor5].field_1280 = arg2
        if averagesDownstakesOfBoosted[msg.sender][arg4] * stor0[arg2].field_2560 / 100 >= stor0[arg2].field_2304:
            voteInfo[this.address][stor5].field_1536 = averagesDownstakesOfBoosted[msg.sender][arg4] * stor0[arg2].field_2560 / 100
            voteInfo[this.address][stor5].field_1792 = 0
            voteInfo[this.address][stor5].field_2048 = averagesDownstakesOfBoosted[msg.sender][arg4] * stor0[arg2].field_2560 / 100
            voteInfo[this.address][stor5].field_2304 = 0
            voteInfo[this.address][stor5].field_2560 = 0
            s = 11
            idx = 692
            ...
            while 14 > idx:
                ...
                continue 
            voteInfo[this.address][stor5].field_3584 = 0
            voteInfo[this.address][stor5][18][2].field_0 = averagesDownstakesOfBoosted[msg.sender][arg4] * stor0[arg2].field_2560 / 100
        else:
            voteInfo[this.address][stor5].field_1536 = stor0[arg2].field_2304
            voteInfo[this.address][stor5].field_1792 = 0
            voteInfo[this.address][stor5].field_2048 = stor0[arg2].field_2304
            ...
            voteInfo[this.address][stor5].field_3584 = 0
            voteInfo[this.address][stor5][18][2].field_0 = stor0[arg2].field_2304
    emit NewProposal(2, address(arg3), arg2, sha3(this.address, proposalsCnt), address(organizations[msg.sender][arg4]));
    return sha3(this.address, proposalsCnt)
}
