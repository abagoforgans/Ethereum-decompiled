...
function transferViaSignature(address arg1, address arg2, uint256 arg3, uint256 arg4, address arg5, uint256 arg6, uint256 arg7, bytes arg8, uint8 arg9) {
    ...
    if not arg9:
        ...
        if arg9 == 1:
            ...
            signer = erecover(sha3(mem[ceil32(arg8.length) + 288 len 6], 7310869555711666030, mem[ceil32(arg8.length) + 314 len mem[ceil32(arg8.length) + 192] + 2]), (Mask(8, -(('mask_shl', 256, 0, -3, ('data', ('mask_shl', 224, 0, 0, ('param', 'arg4')), ('mask_shl', 32, 0, 0, ('param', 'arg5')))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('data', ('mask_shl', 224, 0, 0, ('param', 'arg4')), ('mask_shl', 32, 0, 0, ('param', 'arg5')))), 0) - 256) + 27 << 248, _5, Mask(224, 0, arg3), uint32(arg4)) 
            if not erecover.result:
                revert with ext_call.return_data[0 len return_data.size]
            if arg1 != address(signer):
