...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0xf72ae48e3b71927d83fbaf0f5b3d8596f947a2f5)
    delegate 0xf72ae48e3b71927d83fbaf0f5b3d8596f947a2f5.0x66098d4f with:
         gas gas_remaining - 50 wei
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0xf72ae48e3b71927d83fbaf0f5b3d8596f947a2f5):
                            delegate 0xf72ae48e3b71927d83fbaf0f5b3d8596f947a2f5.0x66098d4f with:
                                 gas gas_remaining - 50 wei
