...
function _fallback() payable {
    ...
    mem[96 len -6555] = code.data[7287 len -6555]
    mem[64] = -6459
    stor3 = msg.sender
    stor8 = msg.sender
    stor3 = msg.sender
...
function mint(address arg1, uint256 arg2) {
    ...
    require not stor6
    require ext_code.size(0xe33200380894bc3d79e4b8314f85373daca3636a)
    delegate 0xe33200380894bc3d79e4b8314f85373daca3636a.0x66098d4f with:
         gas gas_remaining - 50 wei
