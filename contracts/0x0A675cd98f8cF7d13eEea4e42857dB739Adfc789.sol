...
function _fallback() {
    ...
    stor2.length.field_8 = 'Pre volcano token' / 256
    idx = 0
...
function sub_e962ee15(?) {
    require msg.sender == owner
    require arg1 > 0
    require stor4 + (arg1 * 10^decimals) >= stor4
    stor4 += arg1 * 10^decimals
