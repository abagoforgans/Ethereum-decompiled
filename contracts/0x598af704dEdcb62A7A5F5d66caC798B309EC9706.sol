...
function ship(string arg1) {
    ...
    require ext_code.size(0x6398104c6f110591dd4a862c3dfee514a3d4c2e9)
    delegate 0x6398104c6f110591dd4a862c3dfee514a3d4c2e9.0xcfb51928 with:
         gas gas_remaining - 710 wei
        ...
        if 31 >= storehouse[delegate.return_data[0]][1].length:
            ...
            if 31 >= storehouse[delegate.return_data[0]][3].length:
                ...
                while mem[64] + storehouse[delegate.return_data[0]].length + 96 > idx + 32:
                    ...
                    s = s + 1
                    continue 
                emit Ship(string rg1, uint256 rg2):
                          mem[mem[64] len _760 + storehouse[delegate.return_data[0]].length + (floor32(storehouse[delegate.return_data[0]].length - 1) + -storehouse[delegate.return_data[0]].length + 32 % 32) + -mem[64] + 96],
            else:
                ...
                while mem[64] + storehouse[delegate.return_data[0]].length + 96 > idx + 32:
                    ...
                    continue 
                emit Ship(string rg1, uint256 rg2):
                          mem[mem[64] len _1082 + storehouse[delegate.return_data[0]].length + (floor32(storehouse[delegate.return_data[0]].length - 1) + -storehouse[delegate.return_data[0]].length + 32 % 32) + -mem[64] + 96],
        else:
            ...
            if 31 >= storehouse[delegate.return_data[0]][3].length:
                ...
                while mem[64] + storehouse[delegate.return_data[0]].length + 96 > idx + 32:
                    ...
                    continue 
                emit Ship(string rg1, uint256 rg2):
                          mem[mem[64] len _1120 + storehouse[delegate.return_data[0]].length + (floor32(storehouse[delegate.return_data[0]].length - 1) + -storehouse[delegate.return_data[0]].length + 32 % 32) + -mem[64] + 96],
            else:
                mem[0] = sha3(delegate.return_data[0], 5) + 3
                idx = 0
                while storehouse[delegate.return_data[0]][3].length + 31 / 32 > idx:
                ...
                while mem[64] + storehouse[delegate.return_data[0]].length + 96 > idx + 32:
                    ...
                    continue 
                emit Ship(string rg1, uint256 rg2):
                          mem[mem[64] len _1317 + storehouse[delegate.return_data[0]].length + (floor32(storehouse[delegate.return_data[0]].length - 1) + -storehouse[delegate.return_data[0]].length + 32 % 32) + -mem[64] + 96],
    else:
        ...
        if 31 >= storehouse[delegate.return_data[0]][1].length:
            ...
            if 31 >= storehouse[delegate.return_data[0]][3].length:
                ...
                while mem[64] + storehouse[delegate.return_data[0]].length + 96 > idx + 32:
                    ...
                    continue 
                emit Ship(string rg1, uint256 rg2):
                          mem[mem[64] len _1151 + storehouse[delegate.return_data[0]].length + (floor32(storehouse[delegate.return_data[0]].length - 1) + -storehouse[delegate.return_data[0]].length + 32 % 32) + -mem[64] + 96],
            else:
                mem[0] = sha3(delegate.return_data[0], 5) + 3
                idx = 0
                while storehouse[delegate.return_data[0]][3].length + 31 / 32 > idx:
                ...
                while mem[64] + storehouse[delegate.return_data[0]].length + 96 > idx + 32:
                    ...
                    continue 
                emit Ship(string rg1, uint256 rg2):
                          mem[mem[64] len _1316 + storehouse[delegate.return_data[0]].length + (floor32(storehouse[delegate.return_data[0]].length - 1) + -storehouse[delegate.return_data[0]].length + 32 % 32) + -mem[64] + 96],
        else:
            mem[0] = sha3(delegate.return_data[0], 5) + 1
            idx = 0
            while storehouse[delegate.return_data[0]][1].length + 31 / 32 > idx:
            ...
            if 31 >= storehouse[delegate.return_data[0]][3].length:
                ...
                while mem[64] + storehouse[delegate.return_data[0]].length + 96 > idx + 32:
                    ...
                    continue 
                emit Ship(string rg1, uint256 rg2):
                          mem[mem[64] len _1340 + storehouse[delegate.return_data[0]].length + (floor32(storehouse[delegate.return_data[0]].length - 1) + -storehouse[delegate.return_data[0]].length + 32 % 32) + -mem[64] + 96],
            else:
                mem[0] = sha3(delegate.return_data[0], 5) + 3
                idx = 0
                while storehouse[delegate.return_data[0]][3].length + 31 / 32 > idx:
                ...
                while mem[64] + storehouse[delegate.return_data[0]].length + 96 > idx + 32:
                    ...
                    continue 
                emit Ship(string rg1, uint256 rg2):
                          mem[mem[64] len _1422 + storehouse[delegate.return_data[0]].length + (floor32(storehouse[delegate.return_data[0]].length - 1) + -storehouse[delegate.return_data[0]].length + 32 % 32) + -mem[64] + 96],
    return 1
}
