...
function _fallback() payable {
    ...
    while stor1.length + 31 / 32 > idx:
        ...
        continue 
    stor2 = 8
    uint32(stor3.field_0) = uint32(20 * 10^6 * uint8(10^8))
    Mask(224, 0, stor3.field_32) = 0
    stor11 = 0
    stor12 = 0
    stor13 = 0
    stor16 = msg.sender
    stor14[address(msg.sender)] = uint256(stor3.field_0)
    stor4 = block.timestamp
    stor5 = block.timestamp + (168 * 24 * 3600)
    return code.data[476 len 4566]
}
        ...
        if owner == msg.sender:
            if balanceOf[stor16] - arg2 < 13 * 10^13:
                if block.timestamp < stor6 + (4320 * 24 * 3600):
                    return 0
            if owner == msg.sender:
                if balanceOf[stor16] - arg2 < 975 * 10^11:
                    if block.timestamp < stor6 + (8640 * 24 * 3600):
                        return 0
                if owner == msg.sender:
                    if balanceOf[stor16] - arg2 < 43 * 10^12:
