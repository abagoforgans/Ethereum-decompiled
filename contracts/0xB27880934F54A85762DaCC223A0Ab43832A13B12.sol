...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor0 = msg.sender
    stor3 = code.data[7571 len 20]
    require stor0 == msg.sender
    stor4 = code.data[7603 len 20]
    require ext_code.size(code.data[7603 len 20])
    call code.data[7603 len 20].isPricingStrategy() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require ext_call.return_data[0]
    stor6 = code.data[7635 len 20]
    require code.data[7635 len 20]
    require code.data[7655 len 32]
    stor8 = code.data[7655 len 32]
    require code.data[7687 len 32]
    stor9 = code.data[7687 len 32]
    require stor8 < code.data[7687 len 32]
    stor7 = code.data[7719 len 32]
    stor20 = code.data[7751 len 32]
    return code.data[559 len 7000]
}
