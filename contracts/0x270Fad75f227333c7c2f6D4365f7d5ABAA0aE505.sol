...
function _fallback() payable {
    ...
    require stor12[address(msg.sender)] + 100000000 * 10^18 >= stor12[address(msg.sender)]
    stor12[address(stor3.field_0)] = stor12[address(msg.sender)] + 100000000 * 10^18
    require stor1 + 100000000 * 10^18 >= stor1
    stor1 += 100000000 * 10^18
    stor4 = 0x6c5140f605a9add003b3626aae4f08f41e6c6fff
    stor11 = 420648 * 24 * 3600
    return code.data[347 len 4041]
}
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    require _ownerWallet == msg.sender
    require stor13[address(arg1)][address(msg.sender)] >= 10^18 * arg3
    require balanceOf[address(arg1)] >= 10^18 * arg3
    require 10^18 * arg3 > 0
    require 10^18 * arg3 <= balanceOf[address(arg1)]
    require (10^18 * arg3) + balanceOf[address(arg2)] >= balanceOf[address(arg2)]
    require 10^18 * arg3 <= stor13[address(arg1)][address(msg.sender)]
...
function _fallback() payable {
    ...
    require balanceOf[address(msg.sender)] >= 10^18 * msg.value
    require 10^18 * msg.value > 0
    require 10^18 * msg.value <= balanceOf[address(msg.sender)]
    require (10^18 * msg.value) + balanceOf[address(stor3.field_0)] >= balanceOf[address(stor3.field_0)]
    emit Transfer((10^18 * msg.value), msg.sender, _ownerWallet);
}
