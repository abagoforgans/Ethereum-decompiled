...
function _fallback() payable {
    mem[96 len -4057] = code.data[4334 len -4057]
    mem[64] = -3961
...
function confirm(bytes32 arg1) payable {
    ...
    if not stor259[arg1].field_0:
        ...
        require stor260.length < stor260.length
        stor[code.data[4025 len 32] + stor260.length] = arg1
    if 2^stor258[address(msg.sender)] and stor259[arg1].field_256 != 0:
        return 0
    mem[128] = arg1
    ...
    stor[code.data[4025 len 32] + stor259[arg1].field_512] = 0
            ...
            if stor259[call.data[0 len calldata.size]].field_0 > 1:
                ...
                if arg1 <= m_numOwners:
                    ...
                    while idx < stor260.length:
                        ...
                        mem[32] = 264
                        address(stor264[stor[code.data[4025 len 32] + idx]].field_0) = 0
