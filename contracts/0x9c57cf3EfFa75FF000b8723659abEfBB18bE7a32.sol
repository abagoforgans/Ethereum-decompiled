...
function _fallback() {
    mem[96 len -3551] = code.data[3874 len -3551]
    mem[64] = -3455
    stor5 = mem[96]
    stor7 = mem[128]
    stor6 = mem[192]
    stor8 = mem[160]
    stor11.length = (2 * mem[mem[224] + 96]) + 1
    ...
    while mem[224] + mem[mem[224] + 96] + 128 > idx:
        ...
        idx = idx + 32
        continue 
    idx = (Mask(251, 0, mem[mem[224] + 96] + 31) >> 5) + 0x175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9
    while (stor11.length + 31 / 32) + 0x175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9 > idx:
        stor[idx] = 0
        idx = idx + 1
        continue 
    stor0 = mem[268 len 20]
    return code.data[323 len 3551]
}
...
function getBracketScore(bytes8 arg1) {
    ...
    require ext_code.size(0x2d75f40927cb3639613c2a509926e13e53348194)
    delegate 0x2d75f40927cb3639613c2a509926e13e53348194.0x24248168 with:
...
function startScoring() {
    ...
    require ext_code.size(0x2d75f40927cb3639613c2a509926e13e53348194)
    delegate 0x2d75f40927cb3639613c2a509926e13e53348194.getScoringMask(bytes8 rg1) with:
         gas gas_remaining - 50 wei
