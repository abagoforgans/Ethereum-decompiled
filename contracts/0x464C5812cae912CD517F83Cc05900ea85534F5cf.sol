...
function _fallback() {
    stor0 = msg.sender
    stor0 = code.data[2642 len 20]
    require code.data[2642 len 20]
    stor9 = code.data[2706 len 20]
    require code.data[2662 len 32]
    require code.data[2726 len 32]
    stor7 = code.data[2662 len 32]
    stor2 = code.data[2726 len 32]
    return code.data[215 len 2415]
}
