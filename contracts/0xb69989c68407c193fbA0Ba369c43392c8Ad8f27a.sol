...
function _fallback() {
    require code.data[8874 len 20]
    require code.data[8906 len 20]
    require code.data[8938 len 20]
    stor3 = code.data[8906 len 20]
    stor4 = code.data[8938 len 20]
    stor5 = code.data[8874 len 20]
    stor9[address(msg.sender)] = 1
    emit LogNewFundraiser(1, msg.sender);
    stor1[stor3] = 175000000 * 10^18
    emit code.data[8830 len 32]: 175000000 * 10^18, 0, stor3
    stor1[stor4] = 12500000 * 10^18
    emit code.data[8830 len 32]: 12500000 * 10^18, 0, stor4
    stor1[0] = 62500000 * 10^18
    stor1[code.data[8874 len 20]] = 750000000 * 10^18
    emit code.data[8830 len 32]: 750000000 * 10^18, 0, code.data[8874 len 20]
    stor0 = 1000000000 * 10^18
    return code.data[590 len 8240]
}
...
function declareMvpLaunched(uint256 arg1) {
    ...
    call starbaseCrowdsaleAddress.0xa4fd6f56 with:
        ...
        if not ext_call.return_data[0]:
            ...
            if block.timestamp - ext_call.return_data[0] / 24 * 3600 >= 7:
                if block.timestamp - ext_call.return_data[0] / 24 * 3600 >= 14:
                    ...
                    require ext_code.size(starbaseCrowdsaleAddress)
                    call starbaseCrowdsaleAddress.0x4d730d51 with:
                         gas gas_remaining - 710 wei
                        args msg.sender
                    require ext_call.success
                ...
                require ext_code.size(starbaseCrowdsaleAddress)
                call starbaseCrowdsaleAddress.0x7a960154 with:
                     gas gas_remaining - 710 wei
                    args msg.sender
                require ext_call.success
                require ext_call.return_data[0] >= 0
