...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'HayekSysERC20' / 256
    idx = 0
    ...
    stor6.length.field_8 = 'HS1.0' / 256
    idx = 0
    ...
    mem[288 len -4014] = code.data[4701 len -4014]
    stor1[address(msg.sender)] = mem[288]
    stor0 = mem[288]
    stor3[].field_0 = Array(len=mem[mem[320] + 288], data=mem[mem[320] + 320 len mem[mem[320] + 288]])
    stor4 = mem[383 len 1]
    stor5[].field_0 = Array(len=mem[mem[384] + 288], data=mem[mem[384] + 320 len mem[mem[384] + 288]])
    return code.data[687 len 4014]
}
