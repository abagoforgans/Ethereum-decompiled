...
function setReference(address arg1) {
    investorInfo[address(msg.sender)].field_256 = arg1
}
...
function sub_68bcad04(?) {
    ...
    if not (10^10 * keyCount) + 3 * 10^13:
        return 0
    require (10^10 * keyCount) + 3 * 10^13
...
function withdraw() payable {
    if msg.sender == stor17:
        investorInfo[address(msg.sender)].field_1280 += sub_ab03cfaf
        sub_ab03cfaf = 0
    if investorInfo[address(msg.sender)].field_1280:
        call msg.sender with:
           value investorInfo[address(msg.sender)].field_1280 wei
             gas 2300 * is_zero(value) wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        investorInfo[address(msg.sender)].field_1280 = 0
        investorInfo[address(msg.sender)].field_0 += investorInfo[address(msg.sender)].field_1280
}
