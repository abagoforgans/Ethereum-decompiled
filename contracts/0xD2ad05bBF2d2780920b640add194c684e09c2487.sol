...
function _fallback() {
    stor0 = msg.sender
    stor2 = code.data[7284 len 20]
    stor3 = code.data[7316 len 20]
    return code.data[266 len 7006]
}
...
function getRemainCoins() {
    ...
    require ext_call.success
    require backers[address(stor0.field_0)].field_256 + -coinSentToEther + 6 * 10^14 >= backers[address(stor0.field_0)].field_256
    backers[address(stor0.field_0)].field_256 = backers[address(stor0.field_0)].field_256 + -coinSentToEther + 6 * 10^14
    require 6 * 10^14 >= coinSentToEther
    coinSentToEther = 6 * 10^14
    emit LogCoinsEmited((-coinSentToEther + 6 * 10^14), this.address);
...
function _fallback() payable {
    ...
    require startTime + (48 * 24 * 3600) >= startTime
    if block.timestamp >= startTime + (48 * 24 * 3600):
        require (6 * 10^9 * msg.value / 10^18) + coinSentToEther >= 6 * 10^9 * msg.value / 10^18
        require (6 * 10^9 * msg.value / 10^18) + coinSentToEther <= 6 * 10^14
        require ext_code.size(coinAddress)
        call coinAddress.0xa9059cbb with:
             gas gas_remaining - 710 wei
            args msg.sender, 6 * 10^9 * msg.value / 10^18
        require ext_call.success
        require backers[address(msg.sender)].field_256 + (6 * 10^9 * msg.value / 10^18) >= backers[address(msg.sender)].field_256
        ...
        require coinSentToEther + (6 * 10^9 * msg.value / 10^18) >= coinSentToEther
        coinSentToEther += 6 * 10^9 * msg.value / 10^18
        emit LogCoinsEmited((6 * 10^9 * msg.value / 10^18), msg.sender);
    else:
        require 6 * 10^9 * msg.value / 10^18 == (5 * 6 * 10^9 * msg.value / 10^18 / 5) + (6 * 10^9 * msg.value / 10^18 % 5)
        require (6 * 10^9 * msg.value / 10^18) + (6 * 10^9 * msg.value / 10^18 / 5) >= 6 * 10^9 * msg.value / 10^18
        require coinSentToEther >= 0
        require (6 * 10^9 * msg.value / 10^18) + (6 * 10^9 * msg.value / 10^18 / 5) + coinSentToEther <= 6 * 10^14
        require ext_code.size(coinAddress)
        call coinAddress.0xa9059cbb with:
             gas gas_remaining - 710 wei
            args msg.sender, (6 * 10^9 * msg.value / 10^18) + (6 * 10^9 * msg.value / 10^18 / 5)
        require ext_call.success
        require backers[address(msg.sender)].field_256 + (6 * 10^9 * msg.value / 10^18) + (6 * 10^9 * msg.value / 10^18 / 5) >= backers[address(msg.sender)].field_256
        backers[address(msg.sender)].field_256 = backers[address(msg.sender)].field_256 + (6 * 10^9 * msg.value / 10^18) + (6 * 10^9 * msg.value / 10^18 / 5)
        require backers[address(msg.sender)].field_0 + msg.value >= backers[address(msg.sender)].field_0
        backers[address(msg.sender)].field_0 += msg.value
        require etherReceived + msg.value >= etherReceived
        etherReceived += msg.value
        require coinSentToEther + (6 * 10^9 * msg.value / 10^18) + (6 * 10^9 * msg.value / 10^18 / 5) >= coinSentToEther
        coinSentToEther = coinSentToEther + (6 * 10^9 * msg.value / 10^18) + (6 * 10^9 * msg.value / 10^18 / 5)
        emit LogCoinsEmited(((6 * 10^9 * msg.value / 10^18) + (6 * 10^9 * msg.value / 10^18 / 5)), msg.sender);
