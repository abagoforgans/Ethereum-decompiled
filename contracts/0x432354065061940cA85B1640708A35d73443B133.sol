...
function isKeyActive(uint256 arg1) {
    ...
    return not priceOfActivation[stor17[arg1].field_0].field_1536
}
...
function activate(uint256 arg1) payable {
    ...
    require block.timestamp + priceOfActivation[stor17[arg1].field_0].field_1536 >= block.timestamp
    keyInfo[arg1].field_768 = block.timestamp + priceOfActivation[stor17[arg1].field_0].field_1536
    require ownerOf[arg1]
