...
function completeFailed() {
    ...
    call controllerAddr.ceiling() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require ext_code.size(controllerAddr)
    call controllerAddr.moveFloor(uint256 rg1) with:
         gas gas_remaining - 710 wei
...
function startCollection() {
    ...
    require ext_code.size(controllerAddr)
    call controllerAddr.burnPool() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require ext_code.size(controllerAddr)
    call controllerAddr.powerPool() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require ext_code.size(controllerAddr)
    call controllerAddr.activeSupply() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    ...
    require RATE_FACTOR
    require ext_code.size(controllerAddr)
    call controllerAddr.moveCeiling(uint256 rg1) with:
         gas gas_remaining - 710 wei
...
function completeClosed() {
    ...
    require ext_code.size(controllerAddr)
    call controllerAddr.dilutePower(uint256 rg1, uint256 rg2) with:
         gas gas_remaining - 710 wei
    ...
    require ext_call.success
    require ext_code.size(controllerAddr)
    call controllerAddr.setMaxPower(uint256 rg1) with:
         gas gas_remaining - 710 wei
        args ext_call.return_data[0]
    require ext_call.success
    require initialReserve <= eth.balance(address(nutzAddr))
    ...
    while idx < milestoneRecipients.length:
        ...
        require ext_code.size(controllerAddr)
        call controllerAddr.allocateEther(uint256 rg1, address rg2) with:
             gas gas_remaining - 710 wei
