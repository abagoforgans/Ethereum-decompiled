...
function proofOfWork(uint256 arg1) {
    ...
    require block.timestamp - timeOfLastProof >= 55
    balanceOf[msg.sender] = (103 * block.timestamp) - (103 * timeOfLastProof) + balanceOf[msg.sender]
    require block.timestamp - timeOfLastProof
    difficulty = (6000 * difficulty / block.timestamp - timeOfLastProof) + 1
