...
function _fallback() payable {
    ...
    if stor0 != msg.sender:
        ...
        if stor2[address(msg.sender)] + 10^14 < stor2[address(msg.sender)]:
            emit code.data[3207 len 32]: -2
            revert 
        if stor1 + 10^14 < stor1:
            emit code.data[3207 len 32]: -3
            revert 
        stor2[address(msg.sender)] += 10^14
        stor1 += 10^14
        emit code.data[3175 len 32]: 10^14, 0, stor0
        emit code.data[3175 len 32]: 10^14, stor0, msg.sender
    return code.data[639 len 2536]
}
