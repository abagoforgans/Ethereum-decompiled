...
function _fallback() payable {
    ...
    mem[160 len -5138] = code.data[5781 len -5138]
    stor0 = msg.sender
...
function mintToken(address arg1, uint256 arg2) {
    require msg.sender == owner
    require not stopped
    require totalSupply < stor9
    if totalSupply + arg2 <= stor9:
        balanceOf[address(arg1)] += arg2
        totalSupply += arg2
        emit Transfer(arg2, 0, this.address);
        emit Transfer(arg2, this.address, arg1);
    else:
        balanceOf[address(arg1)] = balanceOf[address(arg1)] + stor9 - totalSupply
        totalSupply = stor9
        emit Transfer((stor9 - totalSupply), 0, this.address);
        emit Transfer((stor9 - totalSupply), this.address, arg1);
}
