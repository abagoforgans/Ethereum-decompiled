...
function sub_46232d21(?) payable {
    ...
    stor[mem[ceil32(arg1.length) + floor32(arg1.length) + 128 len (arg1.length % 32) + 32]][call.data[arg1 + 36 len floor32(arg1.length)]] = msg.value / 10^9
    stor3['test'] = 1234
    return 1
}
