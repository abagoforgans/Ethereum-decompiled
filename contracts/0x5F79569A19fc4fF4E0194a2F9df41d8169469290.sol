...
function _fallback() payable {
    ...
    stor16 = 91000000 * 10^18
    stor17 = 0xf835e26371f12aa5e6ee99fa4362cdd18e5503cc
    stor18 = 0xa9f126575dbec1ecc92d2877d4c3d95a92b5d683
    stor19 = 0x8bee31d204d3cb2c2c616e681bf72efd36ee07b9
    stor20 = 0x2d90ded68632064ad1bfd8490ea6918c1c321b5d
    stor21 = 0xb928c92ca0b2f16afe3ed9dc5b7f1c6db74985d0
    stor22 = 0xb0b7549b37061151ce8c6ab632bed85abd897cf1
    stor23 = 0x717b09bd3955dbe28d731aa311bd4e963db9fdb4
    stor24 = 0x2fc8c6dad2b94e174dee75cf589bb73b758c9a87
    require not msg.value
    bool(stor3.length) = 0
    stor3.length.field_1 = 5
    stor3.length.field_8 = 'TTCIV' / 256
    idx = 0
    ...
    stor5.field_256 % 1 = 0
    stor1[address(msg.sender)] = stor16 + stor15 + stor14 + stor13 + stor12
    stor11 = stor16 + stor15 + stor14 + stor13 + stor12
    stor1[stor17] = 910000000 * 10^18
    stor1[stor18] = 568750 * 10^18 * 3600
    stor1[stor19] = 227500000 * 10^18
    stor1[stor20] = 910000000 * 10^18
    return code.data[905 len 4389]
}
...
function sub_890cf7a7(?) {
    ...
    if block.timestamp > 421853 * 3600:
        balanceOf[stor18] += sub_8bdf52ae
        sub_8bdf52ae = 0
        if block.timestamp > 421877 * 3600:
            balanceOf[stor18] += sub_073418d6
            sub_073418d6 = 0
            if block.timestamp > 424013 * 3600:
                balanceOf[stor18] += sub_3b751de6
                sub_3b751de6 = 0
                if block.timestamp > 426221 * 3600:
                    balanceOf[stor18] += sub_7ef351a8
                    sub_7ef351a8 = 0
                    if block.timestamp > 428429 * 3600:
                        balanceOf[stor18] += sub_1251ca40
                        sub_1251ca40 = 0
}
...
function _fallback() payable {
    ...
    emit 0x8022b191: (msg.value * sub_c48f4616), msg.sender
    call stor21 with:
