...
function _fallback() payable {
    mem[96 len -3130] = code.data[3408 len -3130]
    mem[64] = -3034
...
function sendMultiSig(address arg1, uint256 arg2, bytes arg3, uint256 arg4, uint256 arg5, bytes arg6) payable {
    ...
    if not stor1:
        ...
        _21 = mem[ceil32(arg3.length) + 192]
        _22 = mem[ceil32(arg3.length) + 193]
        if mem[ceil32(arg3.length) + 224 len 1] >= 27:
            ...
            mem[ceil32(arg3.length) + ceil32(arg6.length) + 256] = _21
            signer = erecover(sha3(arg1, arg2, arg3[all], arg4, arg5), _22 << 248, mem[ceil32(arg3.length) + 160], _21) 
        else:
            mem[ceil32(arg3.length) + ceil32(arg6.length) + 192] = uint8(mem[ceil32(arg3.length) + 224 len 1] + 27)
            mem[ceil32(arg3.length) + ceil32(arg6.length) + 224] = mem[ceil32(arg3.length) + 160]
            mem[ceil32(arg3.length) + ceil32(arg6.length) + 256] = _21
            signer = erecover(sha3(arg1, arg2, arg3[all], arg4, arg5), uint8(_22) + 27 << 248, mem[ceil32(arg3.length) + 160], _21) 
    else:
        require 0 < signers.length
        idx = 0
        ...
        mem[arg3.length + ceil32(arg3.length) + ceil32(arg6.length) + 244] = arg5
        require arg6.length == 65
        _123 = mem[ceil32(arg3.length) + 192]
        _124 = mem[ceil32(arg3.length) + 193]
        if mem[ceil32(arg3.length) + 224 len 1] >= 27:
            mem[ceil32(arg3.length) + ceil32(arg6.length) + 192] = mem[ceil32(arg3.length) + 224 len 1]
            mem[ceil32(arg3.length) + ceil32(arg6.length) + 224] = mem[ceil32(arg3.length) + 160]
            mem[ceil32(arg3.length) + ceil32(arg6.length) + 256] = _123
            signer = erecover(sha3(arg1, arg2, arg3[all], arg4, arg5), _124 << 248, mem[ceil32(arg3.length) + 160], _123) 
        else:
            mem[ceil32(arg3.length) + ceil32(arg6.length) + 192] = uint8(mem[ceil32(arg3.length) + 224 len 1] + 27)
            mem[ceil32(arg3.length) + ceil32(arg6.length) + 224] = mem[ceil32(arg3.length) + 160]
            mem[ceil32(arg3.length) + ceil32(arg6.length) + 256] = _123
            signer = erecover(sha3(arg1, arg2, arg3[all], arg4, arg5), uint8(_124) + 27 << 248, mem[ceil32(arg3.length) + 160], _123) 
    ...
    if not arg3.length % 32:
        ...
        if not arg6.length % 32:
            emit 0x5e785417: msg.sender, mem[ceil32(arg3.length) + ceil32(arg6.length) + 192 len arg3.length + 20], arg4, arg5, mem[ceil32(arg3.length) + ceil32(arg6.length) + arg3.length + 276 len 140], arg6.length, arg6[all]
        else:
            ...
            emit 0x5e785417: msg.sender, mem[ceil32(arg3.length) + ceil32(arg6.length) + 192 len arg3.length + 20], arg4, arg5, mem[ceil32(arg3.length) + ceil32(arg6.length) + arg3.length + 276 len 140], arg6.length, arg6[all], mem[ceil32(arg3.length) + ceil32(arg6.length) + arg3.length + arg6.length + 448 len -(arg6.length % 32) + 32]
    else:
        ...
        if not arg6.length % 32:
            emit 0x5e785417: msg.sender, mem[ceil32(arg3.length) + ceil32(arg6.length) + 192 len arg3.length + 20], arg4, arg5, mem[ceil32(arg3.length) + ceil32(arg6.length) + arg3.length + 276 len -(arg3.length % 32) + 172], arg6.length, arg6[all]
        else:
