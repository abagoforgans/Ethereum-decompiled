...
function deleteOwner(address arg1) {
    if not stor0[address(msg.sender)]:
        revert with 0, 'aven't enough right to access'
    require bool(stor0[address(arg1)]) != 0
...
function deleteMinter(address arg1) {
    if not stor0[address(msg.sender)]:
        revert with 0, 'aven't enough right to access'
    require bool(stor1[address(arg1)]) != 0
...
function availableTokens() {
    ...
    require leftOnLastMint >= 0
    if size < leftOnLastMint + (block.timestamp * rate) - (lastMintTime * rate):
        return size
    return (leftOnLastMint + (block.timestamp * rate) - (lastMintTime * rate))
}
...
function mint(address arg1, uint256 arg2) {
    ...
    if not rate:
        ...
        if size < leftOnLastMint + (block.timestamp * rate) - (lastMintTime * rate):
            ...
            require arg2 <= leftOnLastMint + (block.timestamp * rate) - (lastMintTime * rate)
            leftOnLastMint = leftOnLastMint + (block.timestamp * rate) - (lastMintTime * rate) - arg2
