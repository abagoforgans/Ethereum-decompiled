...
function _fallback() payable {
    require 0x54c676cddc496ecbd20511a5c143cac2cbca6b3f == tx.origin
}
...
function sub_f54c93c7(?) {
    ...
    call arg5.getReturn(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
        args address(mem[128]), address(_11), arg2 / ext_call.return_data[32]
    mem[(32 * arg1.length) + 128 len 64] = ext_call.return_data[0 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 64
...
function sub_687fc0c4(?) {
    ...
    call arg4.getReturn(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
        args address(_11), address(_13), ext_call.return_data[0]
    mem[(32 * arg1.length) + 128 len 64] = ext_call.return_data[0 len 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 64
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 64
    require arg2 <= (ext_call.return_data[32] * ext_call.return_data[0]) - arg3
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require arg2 <= ext_call.return_data[0] - arg3
    return ext_call.return_data[0]
}
