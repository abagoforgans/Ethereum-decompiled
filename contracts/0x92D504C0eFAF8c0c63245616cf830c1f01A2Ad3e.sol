...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 16000000000 * 10^18
    stor2 = 20000000000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 29
    stor3.length.field_8 = 'Global Supply Chain Community' / 256
    idx = 0
