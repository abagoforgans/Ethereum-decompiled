...
function sendMessage(address arg1, string arg2) payable {
    ...
    if not arg2.length:
        ...
        while (sub_15853113.length + 31 / 32) - 0x4ef1d2ad89edf8c4d91132028e8195cdf30bb4b5053d4f8cd260341d4805f30a > idx:
            ...
            idx = idx + 1
            continue 
    uint64(sub_39bfc4a1[address(arg1)][sha3(arg2[all])].field_0) = uint64(sub_39bfc4a1.length)
    sub_39bfc4a1[address(arg1)][sha3(arg2[all])].field_256 = sub_15853113.length
    if not sub_15853113.length:
        ...
        while sub_15853113.length + 31 / 32 > idx:
            sub_39bfc4a1[address(arg1)][sha3(arg2[all])][s + 1].field_0 = sub_15853113[idx].field_0
            s = s + 1
            idx = idx + 1
            continue 
        ...
        while sub_39bfc4a1[address(arg1)][sha3(arg2[all])].field_256 + 31 / 32 > idx:
            ...
            idx = idx + 1
            continue 
    i = sub_15853113[address(arg1)].field_0
}
