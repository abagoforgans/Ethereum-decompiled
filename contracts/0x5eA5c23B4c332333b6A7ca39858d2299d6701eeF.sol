...
function sendMultiSig(address arg1, uint256 arg2, bytes arg3, uint256 arg4, uint256 arg5, bytes arg6) {
    ...
    _58 = sha3('ETHER', arg1, arg2, call.data[arg3 + 36 len floor32(arg3.length)], mem[ceil32(arg3.length) + ceil32(arg6.length) + floor32(arg3.length) + 217 len (arg3.length % 32) + 32], arg5, None)
    require 65 == arg6.length
    _62 = mem[ceil32(arg3.length) + 192]
    _63 = mem[ceil32(arg3.length) + 193]
    ...
    if mem[ceil32(arg3.length) + 224 len 1] >= 27:
        mem[ceil32(arg3.length) + ceil32(arg6.length) + 224] = uint8(_63)
        mem[ceil32(arg3.length) + ceil32(arg6.length) + 256] = mem[ceil32(arg3.length) + 160]
        mem[ceil32(arg3.length) + ceil32(arg6.length) + 288] = _62
        signer = erecover(_58, _63 << 248, mem[ceil32(arg3.length) + 160], _62) 
        if not erecover.result:
            revert with ext_call.return_data[0 len return_data.size]
        if stor1:
            require 0 < signers.length
        ...
        mem[ceil32(arg3.length) + ceil32(arg6.length) + 224] = uint8(uint8(_63) + 27)
        mem[ceil32(arg3.length) + ceil32(arg6.length) + 256] = mem[ceil32(arg3.length) + 160]
        mem[ceil32(arg3.length) + ceil32(arg6.length) + 288] = _62
        signer = erecover(_58, uint8(_63) + 27 << 248, mem[ceil32(arg3.length) + 160], _62) 
        if not erecover.result:
            revert with ext_call.return_data[0 len return_data.size]
        if not stor1:
            require arg4 >= block.timestamp
    ...
    mem[ceil32(arg3.length) + ceil32(arg6.length) + 256] = _58
