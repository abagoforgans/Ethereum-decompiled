...
function _fallback() payable {
    stor3 = 0x1426c1f91b923043f7c5fbabc6e369e7cbaef3f0
    stor7 = 4023333
    stor8 = 4057233
    stor9 = 4066633
    stor10 = 4100233
    ...
    stor12 = 4201433
    stor13 = 4201433
    stor14 = 250000 * 10^18 * 3600
    stor15 = 100000000 * 10^18
    ...
    stor4 = msg.sender
    require stor15 + stor16 >= stor15
    stor0 = stor15 + stor16
    stor1[stor4] = stor0
    return code.data[510 len 9414]
}
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    require endBlock + transferLockup >= endBlock
...
function returnRate() {
    ...
    if block.number < phase1StartBlock:
        ...
        if block.number <= phase2EndBlock:
            return 7500
    ('gt', 'number', ('stor', ('name', 'phase2EndBlock', 11)))
...
function buyRecipient(address arg1) payable {
    ...
    if block.number < startBlock:
        ...
        if block.number > preEndBlock:
            ...
            require block.number <= endBlock
    require (etherRaised / 100) + 1000 * 10^18 >= 1000 * 10^18
    require stor6[address(arg1)] + msg.value >= stor6[address(arg1)]
    require stor6[address(arg1)] + msg.value <= (etherRaised / 100) + 1000 * 10^18
    if block.number < startBlock:
        if block.number < phase1StartBlock:
            if block.number <= phase1EndBlock:
                if block.number <= phase2EndBlock:
                    ...
                    require tokenSold >= tokenSold
                    if tokenSold == crowdsaleTokenSupply:
                        if block.number < preEndBlock:
                    ...
                    if block.number > phase3EndBlock:
                        ...
                        require tokenSold + (7000 * msg.value) >= tokenSold
                        require tokenSold + (7000 * msg.value) <= crowdsaleTokenSupply
                        require balanceOf[address(arg1)] + (7000 * msg.value) >= balanceOf[address(arg1)]
                        balanceOf[address(arg1)] += 7000 * msg.value
                        require totalSupply + (7000 * msg.value) >= totalSupply
                        totalSupply += 7000 * msg.value
                        require etherRaised + msg.value >= etherRaised
                        etherRaised += msg.value
                        require stor6[address(arg1)] + msg.value >= stor6[address(arg1)]
                        stor6[address(arg1)] += msg.value
                        require tokenSold + (7000 * msg.value) >= tokenSold
                        tokenSold += 7000 * msg.value
                        if tokenSold == crowdsaleTokenSupply:
                            if block.number < preEndBlock:
                                preEndBlock = block.number
                            endBlock = block.number
                        call multisigAddress with:
                           value msg.value wei
                             gas 2300 * is_zero(value) wei
                        require ext_call.success
                        emit Transfer((7000 * msg.value), this.address, arg1);
            else:
                if block.number <= phase2EndBlock:
                    if msg.value:
                        require msg.value
                        require 7500 * msg.value / msg.value == 7500
                    require tokenSold + (7500 * msg.value) >= tokenSold
                    require tokenSold + (7500 * msg.value) <= crowdsaleTokenSupply
                    require balanceOf[address(arg1)] + (7500 * msg.value) >= balanceOf[address(arg1)]
                    balanceOf[address(arg1)] += 7500 * msg.value
                    require totalSupply + (7500 * msg.value) >= totalSupply
                    ...
                    call multisigAddress with:
                       value msg.value wei
                         gas 2300 * is_zero(value) wei
                    require ext_call.success
                    emit Transfer((7500 * msg.value), this.address, arg1);
                else:
                    if block.number > phase3EndBlock:
                        if msg.value:
                            require msg.value
            ...
            if block.number <= phase1EndBlock:
                ...
                require tokenSold + (8000 * msg.value) >= tokenSold
                require tokenSold + (8000 * msg.value) <= crowdsaleTokenSupply
        ...
        if block.number <= preEndBlock:
            ...
            require tokenSold + (8888 * msg.value) >= tokenSold
            require tokenSold + (8888 * msg.value) <= crowdsaleTokenSupply
            require balanceOf[address(arg1)] + (8888 * msg.value) >= balanceOf[address(arg1)]
            balanceOf[address(arg1)] += 8888 * msg.value
            require totalSupply + (8888 * msg.value) >= totalSupply
            ...
            call multisigAddress with:
               value msg.value wei
                 gas 2300 * is_zero(value) wei
            require ext_call.success
            emit Transfer((8888 * msg.value), this.address, arg1);
        else:
            if block.number < phase1StartBlock:
                if block.number <= phase1EndBlock:
                    if block.number <= phase2EndBlock:
...
function buy() payable {
    ...
    require stor6[address(msg.sender)] + msg.value <= (etherRaised / 100) + 1000 * 10^18
    if block.number < startBlock:
        if block.number < phase1StartBlock:
            if block.number <= phase1EndBlock:
                if block.number <= phase2EndBlock:
                    ...
                    if block.number > phase3EndBlock:
                        ...
                        require tokenSold + (7000 * msg.value) >= tokenSold
                        require tokenSold + (7000 * msg.value) <= crowdsaleTokenSupply
                        require balanceOf[address(msg.sender)] + (7000 * msg.value) >= balanceOf[address(msg.sender)]
                        balanceOf[address(msg.sender)] += 7000 * msg.value
                        require totalSupply + (7000 * msg.value) >= totalSupply
                        totalSupply += 7000 * msg.value
                        require etherRaised + msg.value >= etherRaised
                        etherRaised += msg.value
                        ...
                        call multisigAddress with:
                           value msg.value wei
                             gas 2300 * is_zero(value) wei
                        require ext_call.success
                        emit Transfer((7000 * msg.value), this.address, msg.sender);
            else:
                if block.number <= phase2EndBlock:
                    if msg.value:
                        require msg.value
                    ...
                    call multisigAddress with:
                       value msg.value wei
                         gas 2300 * is_zero(value) wei
                    require ext_call.success
                    emit Transfer((7500 * msg.value), this.address, msg.sender);
                else:
                    if block.number > phase3EndBlock:
                        if msg.value:
                            require msg.value
        ...
        if block.number <= preEndBlock:
            ...
            require tokenSold + (8888 * msg.value) >= tokenSold
            require tokenSold + (8888 * msg.value) <= crowdsaleTokenSupply
            require balanceOf[address(msg.sender)] + (8888 * msg.value) >= balanceOf[address(msg.sender)]
            ...
            call multisigAddress with:
               value msg.value wei
                 gas 2300 * is_zero(value) wei
            require ext_call.success
            emit Transfer((8888 * msg.value), this.address, msg.sender);
        else:
            if block.number < phase1StartBlock:
                if block.number <= phase1EndBlock:
                    if block.number <= phase2EndBlock:
