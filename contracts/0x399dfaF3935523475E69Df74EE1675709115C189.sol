...
const _fallback = code.data[19 len 1625]
...
function sendMessage(address arg1, string arg2) payable {
    ...
    nonce++
    uint8(sub_39bfc4a1.length) = 4
    sub_39bfc4a1.length.field_8 % 72057594037927936 = 0
    ...
    if not arg2.length:
        ...
        if not sub_15853113.length:
            ...
            while sub_39bfc4a1[address(arg1)][stor2].field_256 + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
            require var16001 < sub_15853113[address(arg1)].field_0
            if stor[sha3(var18002) + var18001]:
                # nil
            else:
                require var18003 < sub_15853113[address(arg1)].field_0
                sub_15853113[address(arg1)][var18003].field_0 = nonce
        else:
            s = 0
            idx = 0
            ...
            while sub_39bfc4a1[address(arg1)][stor2].field_256 + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
            require var19001 < sub_15853113[address(arg1)].field_0
            if stor[sha3(var21002) + var21001]:
                # nil
            else:
                require var21003 < sub_15853113[address(arg1)].field_0
                sub_15853113[address(arg1)][var21003].field_0 = nonce
    else:
        ...
        if not sub_15853113.length:
            ...
            while sub_39bfc4a1[address(arg1)][stor2].field_256 + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
            require var22001 < sub_15853113[address(arg1)].field_0
            if stor[sha3(var24002) + var24001]:
                # nil
            else:
                require var24003 < sub_15853113[address(arg1)].field_0
                sub_15853113[address(arg1)][var24003].field_0 = nonce
}
