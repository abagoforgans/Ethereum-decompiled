...
function _fallback() payable {
    ...
    stor1 = block.timestamp + 600
    stor2 = block.timestamp + 1200
    return code.data[273 len 4111]
}
    ...
    if block.timestamp >= icoStart:
        ...
        if msg.value < 2 * 10^16:
            ...
            if msg.value < 25 * 10^16:
                call tokenRewardAddress.0xa9059cbb with:
                     gas gas_remaining - 710 wei
                    args msg.sender, msg.value * sub_a8a75b78 / 10
            else:
                if msg.value < 3 * 10^17:
                    call tokenRewardAddress.0xa9059cbb with:
                         gas gas_remaining - 710 wei
                        args msg.sender, msg.value * sub_3b41ddba / 10
                else:
                    if msg.value < 50 * 10^18:
                        call tokenRewardAddress.0xa9059cbb with:
                             gas gas_remaining - 710 wei
                            args msg.sender, msg.value * sub_89e66aea / 10
                    else:
                        if msg.value < 100 * 10^18:
                            call tokenRewardAddress.0xa9059cbb with:
                                 gas gas_remaining - 710 wei
                                args msg.sender, msg.value * sub_31252103 / 10
                        else:
                            if msg.value >= 150 * 10^18:
                                call tokenRewardAddress.0xa9059cbb with:
                                     gas gas_remaining - 710 wei
                                    args msg.sender, msg.value * sub_7c24ce7d / 10
                            else:
                                call tokenRewardAddress.0xa9059cbb with:
                                     gas gas_remaining - 710 wei
                                    args msg.sender, msg.value * sub_4c95f5d0 / 10
    require ext_call.success
