...
function _fallback() payable {
    ...
    stor1 = msg.sender
    address(stor6.field_8) = code.data[6457 len 20]
    stor1 = msg.sender
    stor0 = code.data[6477 len 32]
    stor3[address(msg.sender)] = code.data[6477 len 32]
    return code.data[455 len 5990]
}
...
const TOKENS_TOTAL = 6000000000 * 10^18
...
const TOKENS_HARD_CAP = 3000000000 * 10^18
...
function burnFrom(address arg1, uint256 arg2) {
    if balanceOf[address(arg1)] < arg2:
        return 0
    if allowance[address(arg1)][address(arg1)] < arg2:
        return 0
    if arg2 <= 0:
        return 0
    ...
    balanceOf[address(arg1)] -= arg2
    require arg2 <= allowance[address(arg1)][address(arg1)]
    require allowance[address(arg1)][address(arg1)] - arg2 <= allowance[address(arg1)][address(arg1)]
    allowance[address(arg1)][address(arg1)] -= arg2
...
function _fallback() payable {
    ...
    require (msg.value * tokensPerKEther / 1000) + totalSupply <= 3000000000 * 10^18
