...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'BCS Token' / 256
    idx = 0
    ...
    stor5[address(msg.sender)] = 100 * 10^6 * 10^stor2
    stor4 = msg.sender
    return code.data[406 len 1824]
}
...
function transfer(address arg1, uint256 arg2) {
    ...
    require balanceOf[arg1] + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
    require balanceOf[arg1] + balanceOf[address(msg.sender)] == balanceOf[arg1] + balanceOf[address(msg.sender)]
}
