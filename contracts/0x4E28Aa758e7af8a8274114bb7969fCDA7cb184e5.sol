...
function sub_1c1f1a64(?) payable {
    if adminAddress == msg.sender:
        if holding[arg1].field_256 != 0:
            if arg2 >= 1:
...
function sub_0c5e11e2(?) payable {
    ...
    holding[stor5].field_512 = arg2 or Mask(96, 160, holding[stor5].field_512)
    ...
    while idx < stor5:
        ...
        while s < stor5:
            ...
            if holding[s].field_0 != 0:
                ...
                stor5++
                holding[stor5].field_256 = arg1
                holding[stor5].field_512 = arg3 or Mask(96, 160, holding[stor5].field_512)
