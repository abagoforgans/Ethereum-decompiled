...
function sub_a91c2a93(?) payable {
    if msg.sender == sub_aaabd6b0Address:
        ...
        uint256(stor2.field_0) = arg3 or Mask(96, 160, uint256(stor2.field_0))
}
...
function addString(string arg1) payable {
    ...
    sub_f0f0b7c0[arg1[all]].field_256 = sub_f0f0b7c0[arg1[all]].field_256
    sub_f0f0b7c0[arg1[all]].field_320 = sub_f0f0b7c0[arg1[all]].field_320
    if 31 >= sub_f0f0b7c0[arg1[all]][2].length:
        idx = 0
        while sub_f0f0b7c0[arg1[all]][2].length + 31 / 32 > idx:
            sub_f0f0b7c0[arg1[all]][idx + 2].field_0 = 0
            idx = idx + 1
            continue 
    else:
        sub_f0f0b7c0[arg1[all]].field_512 = Mask(255, 1, (256 * not sub_f0f0b7c0[arg1[all]].field_512) - 1 and sub_f0f0b7c0[arg1[all]].field_512) + 1
        if not Mask(255, 1, (256 * not sub_f0f0b7c0[arg1[all]].field_512) - 1 and sub_f0f0b7c0[arg1[all]].field_512):
            idx = 0
            while sub_f0f0b7c0[arg1[all]][2].length + 31 / 32 > idx:
                sub_f0f0b7c0[arg1[all]][idx + 2].field_0 = 0
                idx = idx + 1
            ...
            idx = 0
            while sub_f0f0b7c0[arg1[all]][2].length + 31 / 32 > idx:
                sub_f0f0b7c0[arg1[all]][s + 2].field_0 = sub_f0f0b7c0[arg1[all]][idx + 2].field_0
                s = s + 1
                idx = idx + 1
                continue 
            idx = sub_f0f0b7c0[arg1[all]][2].length + 31 / 32
            while sub_f0f0b7c0[arg1[all]][2].length + 31 / 32 > idx:
                sub_f0f0b7c0[arg1[all]][idx + 2].field_0 = 0
                idx = idx + 1
                continue 
    sub_97c052f1[uint64(stor2.field_0)] = sha3(arg1[all])
    Mask(96, 0, stor2.field_160) = Mask(96, 0, sub_12d3b72a + 1)
    return 1
}
