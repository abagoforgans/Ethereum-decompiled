...
function _fallback() payable {
    ...
    create contract with 0 wei
                    code: code.data[472 len 3341], 0, 160, 0, 224, address(this.address), 10, 'GreenPower', 2, 'P+'
    stor1 = create.new_address or Mask(96, 160, stor1)
    create contract with 0 wei
                    code: code.data[3813 len 3341], 0, 160, 0, 224, address(this.address), 10, 'GreyPower', 2, 'P-'
    uint256(stor2.field_0) = Mask(96, 0, stor2.field_160)
    stor9[address(msg.sender)] = 1
    return code.data[7154 len 3075]
}
