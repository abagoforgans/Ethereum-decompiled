...
function sendRewardBlockCDN(address arg1, uint256 arg2) {
    ...
    totalSupply += arg2 / 2
    emit code.data[2426 len 32]: arg2, owner, arg1
    return 1
}
...
function reFundByOther(address arg1) {
    ...
    emit code.data[2426 len 32]: balanceOf[address(arg1)].field_0, msg.sender, this.address
    return 1
}
...
function reFund() {
    ...
    balanceOf[stor2].field_0 = stor7
    totalSupply = balanceOf[stor2].field_0 + sub_b8491317
    emit code.data[2426 len 32]: balanceOf[address(msg.sender)].field_0, msg.sender, this.address
    return 1
}
        ...
        if arg1 == this.address:
            ...
            if balanceOf[address(msg.sender)].field_0 > 0:
                ...
                if not ext_call.success:
                    return 0
    emit code.data[2426 len 32]: arg2, msg.sender, arg1
    return 1
}
...
function _fallback() {
    ...
    if sub_cdbb2e79 - (336 * 24 * 3600) > block.timestamp:
        ...
        emit code.data[2426 len 32]: msg.value, this.address, msg.sender
    else:
        ...
        if eth.balance(this.address) >= minFundedValue:
            isFunded = 1
        stor1[address(msg.sender)] = msg.value
        emit code.data[2426 len 32]: s, this.address, msg.sender
}
