...
function _fallback() {
    ...
    stor3.length.field_8 = 'SecureXR' / 256
    idx = 0
    ...
    stor8 = block.timestamp + (8736 * 24 * 3600)
    return code.data[502 len 5804]
}
...
function _fallback() payable {
    ...
    require _totalSupply + (4000 * msg.value) >= _totalSupply
