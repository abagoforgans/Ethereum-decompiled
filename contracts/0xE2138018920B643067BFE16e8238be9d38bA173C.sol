...
function _fallback() payable {
    create contract with 0 wei
                    code: code.data[1454 len 2546]
    require create.new_address
    stor4 = address(create.new_address)
    require not msg.value
    stor0 = msg.sender
    stor1 = 0xa6d9df476577c0d4a24eb50220fad007e444db8
    stor3 = 0x32078b6948e8a7f0914200c2685819e4974da6f0
    stor2 = 40
    stor8 = 100 * 10^18
    stor5 = 416772 * 3600
    stor6 = 300
    return code.data[248 len 1206]
}
