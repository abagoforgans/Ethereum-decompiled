...
function _fallback() payable {
    ...
    stor3 = 44444525 * 10^14 * 3600
    stor4[address(msg.sender)] = 44444525 * 10^14 * 3600
    bool(stor0.length) = 0
    stor0.length.field_1 = 6
    stor0.length.field_8 = 'Blupee' / 256
    idx = 0
    ...
    stor1.length.field_8 = 'BLU' / 256
    idx = 0
    while stor1.length + 31 / 32 > idx:
        stor1[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[392 len 1823]
}
