...
function setBaseTokenURI(string arg1) {
    ...
    require msg.sender == owner
    stor14[] = Array(len=arg1.length, data=arg1[all])
}
...
function mint(address arg1) {
    ...
    stor13[stor7.length + 1] = 2^(tokenByIndex.length + 1 % 3)
    require arg1
...
function sub_438098d0(?) {
    ...
    while idx < arg1.length:
        ...
        require not ownerOf[stor7.length + 1]
        ownerOf[stor7.length + 1] = mem[(32 * idx) + 140 len 20]
        balanceOf[address(mem[(32 * idx) + 128])]++
        emit Transfer(0, mem[(32 * idx) + 140 len 20], tokenByIndex.length + 1);
        stor6[stor7.length + 1] = tokenOfOwnerByIndex[address(mem[(32 * idx) + 128])]
        tokenOfOwnerByIndex[address(mem[(32 * idx) + 128])]++
        tokenOfOwnerByIndex[address(mem[(32 * idx) + 128])][tokenOfOwnerByIndex[address(mem[(32 * idx) + 128])]] = tokenByIndex.length + 1
        mem[32] = 8
        stor8[stor7.length + 1] = tokenByIndex.length
        tokenByIndex.length++
        mem[0] = 7
