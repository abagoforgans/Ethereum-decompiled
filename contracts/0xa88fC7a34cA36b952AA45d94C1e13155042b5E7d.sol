...
function _fallback() payable {
    mem[96 len -915] = code.data[1320 len -915]
    mem[64] = -819
...
function sub_aa9744b8(?) payable {
    mem[128 len arg2.length] = arg2[all]
    if arg1 >= stor2:
        return 0
    stor1[arg1].field_256 = arg2.length
    if not arg2.length:
        idx = 0
        while stor1[arg1].field_256 + 31 / 32 > idx:
        ...
        while arg2.length + 128 > idx:
            stor1[arg1][s + 1].field_0 = mem[idx]
            s = s + 1
            idx = idx + 32
            continue 
