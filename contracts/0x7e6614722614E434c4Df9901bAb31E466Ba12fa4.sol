...
function _fallback() {
    mem[96 len -5533] = code.data[6034 len -5533]
    mem[64] = -5437
...
function submitTransaction(address arg1, uint256 arg2, bytes arg3) {
    ...
    stor0[stor5].field_512 = (2 * arg3.length) + 1
    s = 0
    idx = 128
    while arg3.length + 128 > idx:
        ...
        idx = idx + 32
        continue 
    if stor0[stor5][2].length + 31 / 32 > Mask(251, 0, arg3.length + 31) >> 5:
        stor[('array', 2, ('map', ('stor', ('name', 'stor5', 5)), ('name', 'stor0', 0))) + (Mask(251, 0, arg3.length + 31) >> 5)].field_0 = 0
