...
const _fallback = code.data[31 len 3937]
...
function ElevenElevenToken() {
    totalSupply = 308641975 * 10^14 * 3600
    bool(name.length) = 0
    name.length.field_1 = 4
    name.length.field_8 = '1111' / 256
    idx = 0
    ...
    symbol.length.field_8 = '1111' / 256
    idx = 0
    while symbol.length + 31 / 32 > idx:
        symbol[idx].field_0 = 0
        idx = idx + 1
        continue 
    bool(version.length) = 0
    version.length.field_1 = 5
    version.length.field_8 = '1.111' / 256
    idx = 0
