...
function getUserByIndex(uint256 arg1) {
    require arg1 < userByIndex.length
    return userByIndex[arg1]
}
...
function sub_0778d72d(?) {
    if owner == msg.sender:
        ...
        userByIndex.length++
        userByIndex[userByIndex.length] = arg1
...
function sub_0d2da3fd(?) {
    ...
    if 1 == bool(sub_1a9fcb9c[address(arg1)].field_768):
        if arg1 == msg.sender:
            sub_1a9fcb9c[address(arg1)].field_512 = (2 * arg3.length) + 1
            s = 0
            idx = 128
            while arg3.length + 128 > idx:
                ...
                idx = idx + 32
                continue 
            if sub_1a9fcb9c[address(arg1)][2].length + 31 / 32 > Mask(251, 0, arg3.length + 31) >> 5:
                stor[('array', 2, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'sub_1a9fcb9c', 1))) + (Mask(251, 0, arg3.length + 31) >> 5)].field_0 = 0
                ...
                while sub_1a9fcb9c[address(arg1)][2].length + 31 / 32 > idx:
                    ...
                    continue 
            sub_1a9fcb9c[address(arg1)].field_0 = arg2
            sub_1a9fcb9c[address(arg1)].field_776 = arg4
            sub_1a9fcb9c[address(arg1)].field_1024 = arg5
            emit 0x1e28ec5e: arg1
            emit 0xba2837e1: arg4, arg1
            emit 0x512dad2b: arg5, arg1
        else:
            require sub_1a9fcb9c[address(msg.sender)].field_256 <= 8
            if sub_1a9fcb9c[address(msg.sender)].field_256 == 1:
                sub_1a9fcb9c[address(arg1)].field_512 = (2 * arg3.length) + 1
