...
function sub_363c43d5(?) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(0x912da54e84bcf60b3b43bf253a1e867797f5b8ad)
    delegate 0x912da54e84bcf60b3b43bf253a1e867797f5b8ad.mul(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
    ...
    require return_data.size >= 32
    require ext_code.size(0x912da54e84bcf60b3b43bf253a1e867797f5b8ad)
    delegate 0x912da54e84bcf60b3b43bf253a1e867797f5b8ad.sub(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function sub_75b3c687(?) {
    ...
    require return_data.size >= 32
    require ext_code.size(0x912da54e84bcf60b3b43bf253a1e867797f5b8ad)
    delegate 0x912da54e84bcf60b3b43bf253a1e867797f5b8ad.div(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
...
function sub_7966b059(?) {
    ...
    require return_data.size >= 32
    require ext_code.size(0x912da54e84bcf60b3b43bf253a1e867797f5b8ad)
    delegate 0x912da54e84bcf60b3b43bf253a1e867797f5b8ad.add(uint256 arg1, uint256 arg2) with:
         gas gas_remaining wei
        args delegate.return_data[0], ext_call.return_data[0]
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
