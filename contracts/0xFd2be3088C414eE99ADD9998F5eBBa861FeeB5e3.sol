...
function _fallback() {
    stor4 = msg.sender
    stor0 = code.data[11866 len 32]
    uint256(stor1) = code.data[11866 len 32] + (672 * 24 * 3600)
    stor2 = code.data[11814 len 20]
    stor3 = code.data[11846 len 20]
    create contract with 0 wei
                    code: code.data[5982 len 5820], 1000000000 * 10^18
    ...
    require ext_call.success
    return code.data[2186 len 3796]
}
...
const ALLOC_CROWDSALE = 485000000 * 10^18
...
function sub_33e16ddb(?) {
    ...
    call cdtTokenAddress.0xa9059cbb with:
         gas gas_remaining - 50 wei
        args address(arg1), -sub_d43e9544 + 485000000 * 10^18
    require ext_call.success
}
...
function _fallback() payable {
    ...
    if block.timestamp <= publicStartTime + (72 * 24 * 3600):
        ...
        require (12125 * 10^18 * msg.value / 10^18) + sub_d43e9544 <= 485000000 * 10^18
        ...
        if block.timestamp <= publicStartTime + (168 * 24 * 3600):
            ...
            require (11200 * 10^18 * msg.value / 10^18) + sub_d43e9544 <= 485000000 * 10^18
            call multisigAddress with:
               value msg.value wei
                 gas 2300 * is_zero(value) wei
            require ext_call.success
            ...
            if block.timestamp <= publicStartTime + (336 * 24 * 3600):
                ...
                require (10200 * 10^18 * msg.value / 10^18) + sub_d43e9544 <= 485000000 * 10^18
                call multisigAddress with:
                   value msg.value wei
                     gas 2300 * is_zero(value) wei
                require ext_call.success
                ...
                if block.timestamp > publicStartTime + (672 * 24 * 3600):
                    ...
                    require sub_d43e9544 <= 485000000 * 10^18
                    call multisigAddress with:
                       value msg.value wei
                         gas 2300 * is_zero(value) wei
                    require ext_call.success
                    ...
                    require (9300 * 10^18 * msg.value / 10^18) + sub_d43e9544 <= 485000000 * 10^18
                    call multisigAddress with:
                       value msg.value wei
                         gas 2300 * is_zero(value) wei
                    require ext_call.success
