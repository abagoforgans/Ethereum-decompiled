...
function _fallback() {
    ...
    mem[224] = 0x941f1cff8fe69d31780a71fc3a864a360516676a
    mem[256] = 0xc2b3cdf87b449e61a7765795b9b99c0cd1487ff
    mem[288] = 0xcba53ad7b53bcd27b4ae41ea720f6b77ca3d4177
    mem[320] = 0xd58fb7eaa42556fb570e1d30d5a9625db8896b1d
    stor6.length = 4
    s = 0
    idx = 224
    while 352 > idx:
    ...
    while stor6.length > idx:
        ...
        idx = idx + 1
        continue 
    return code.data[1135 len 3477]
}
