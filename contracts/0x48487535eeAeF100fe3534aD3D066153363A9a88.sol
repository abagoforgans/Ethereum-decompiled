...
function _fallback() payable {
    ...
    if not msg.value:
        ...
        if tokensSold + (msg.value * stor4 / 10^18) <= 2 * 10^9:
            require tokensSold + (msg.value * stor4 / 10^18) >= tokensSold
            ...
            require tokensSold <= 2 * 10^9
            require stor4
            if not -tokensSold + 2 * 10^9 / stor4:
                require 0 <= msg.value
                require 2 * 10^9 >= tokensSold
                tokensSold = 2 * 10^9
                require tokensSold <= tokensToSell
                remainingTokens = tokensToSell - tokensSold
                if msg.value > 0:
                ...
                require balanceOf[address(msg.sender)] + -tokensSold + 2 * 10^9 >= balanceOf[address(msg.sender)]
                balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + -tokensSold + 2 * 10^9
                emit Transfer((-tokensSold + 2 * 10^9), this.address, msg.sender);
                call owner with:
                     gas 2300 wei
            else:
                require -tokensSold + 2 * 10^9 / stor4
                require 10^18 * -tokensSold + 2 * 10^9 / stor4 / -tokensSold + 2 * 10^9 / stor4 == 10^18
                require 10^18 * -tokensSold + 2 * 10^9 / stor4 <= msg.value
                require 2 * 10^9 >= tokensSold
                tokensSold = 2 * 10^9
                require tokensSold <= tokensToSell
                remainingTokens = tokensToSell - tokensSold
                if msg.value - (10^18 * -tokensSold + 2 * 10^9 / stor4) > 0:
                    call msg.sender with:
                       value msg.value - (10^18 * -tokensSold + 2 * 10^9 / stor4) wei
                         gas 2300 * is_zero(value) wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    emit Transfer((msg.value - (10^18 * -tokensSold + 2 * 10^9 / stor4)), this.address, msg.sender);
                require balanceOf[address(msg.sender)] + -tokensSold + 2 * 10^9 >= balanceOf[address(msg.sender)]
                balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + -tokensSold + 2 * 10^9
                emit Transfer((-tokensSold + 2 * 10^9), this.address, msg.sender);
                call owner with:
                   value 10^18 * -tokensSold + 2 * 10^9 / stor4 wei
                     gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
