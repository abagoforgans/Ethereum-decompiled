...
function query(uint256 arg1, string arg2, string arg3, uint256 arg4) payable {
    if arg4 > 200000:
        if 0 == (arg4 * stor8) + stor5[arg2[all]]:
            stor3[address(msg.sender)] = 1
        require msg.value >= (arg4 * stor8) + stor5[arg2[all]]
        call 0xf65b3b60010d57d0bb8478aa6ced15fe720621b4 with:
           value (arg4 * stor8) + stor5[arg2[all]] wei
             gas 0 wei
        if msg.value - (arg4 * stor8) - stor5[arg2[all]] > 0:
            call msg.sender with:
               value msg.value - (arg4 * stor8) - stor5[arg2[all]] wei
                 gas 0 wei
    else:
...
function query2_withGasLimit(uint256 arg1, string arg2, string arg3, string arg4, uint256 arg5) payable {
    if arg5 > 200000:
        if 0 == (arg5 * stor8) + stor5[arg2[all]]:
            stor3[address(msg.sender)] = 1
        require msg.value >= (arg5 * stor8) + stor5[arg2[all]]
        call 0xf65b3b60010d57d0bb8478aa6ced15fe720621b4 with:
           value (arg5 * stor8) + stor5[arg2[all]] wei
             gas 0 wei
        if msg.value - (arg5 * stor8) - stor5[arg2[all]] > 0:
            call msg.sender with:
               value msg.value - (arg5 * stor8) - stor5[arg2[all]] wei
                 gas 0 wei
    else:
        if 0 == stor3[address(msg.sender)]:
            stor3[address(msg.sender)] = 1
