...
function _fallback() payable {
    ...
    if block.timestamp > bonusEnds:
        ...
        balanceOf[msg.sender] += 8000 * msg.value
        require (8000 * msg.value) + _totalSupply >= _totalSupply
        _totalSupply += 8000 * msg.value
        emit Transfer((8000 * msg.value), owner, msg.sender);
    else:
        require (9600 * msg.value) + balanceOf[msg.sender] >= balanceOf[msg.sender]
        balanceOf[msg.sender] += 9600 * msg.value
        require (9600 * msg.value) + _totalSupply >= _totalSupply
        _totalSupply += 9600 * msg.value
        emit Transfer((9600 * msg.value), owner, msg.sender);
    call owner with:
       value msg.value wei
