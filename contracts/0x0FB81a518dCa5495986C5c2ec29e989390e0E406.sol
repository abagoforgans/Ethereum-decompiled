...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0xdeb19e773ab46c4e5c1a89b60b9cf21e1132fd15)
    delegate 0xdeb19e773ab46c4e5c1a89b60b9cf21e1132fd15.0x66098d4f with:
         gas gas_remaining - 50 wei
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0xdeb19e773ab46c4e5c1a89b60b9cf21e1132fd15):
                            delegate 0xdeb19e773ab46c4e5c1a89b60b9cf21e1132fd15.0x66098d4f with:
                                 gas gas_remaining - 50 wei
