...
function _fallback() payable {
    require not code.data[2905 len 32] % code.data[2937 len 32]
    stor0 = msg.sender or Mask(96, 160, stor0)
    stor1 = 10^15 * code.data[2905 len 32]
    stor2 = 10^15 * code.data[2937 len 32]
    uint8(stor6.field_0) = uint8(code.data[2969 len 32])
    Mask(248, 0, stor6.field_8) = 0
    return code.data[102 len 2803]
}
...
array of address stor79851256701774443061155405950526993623084363668856671811988742250743927630802;
    ...
    if not contributions[address(msg.sender)] - arg1:
        ...
        while idx < stor4.length:
            ...
            while s < stor4.length - 1:
                ...
                mem[0] = 4
                contributors[s] = storB08A[s]
                s = s + 1
                continue 
            stor4.length--
            if not stor4.length <= stor4.length - 1:
                idx = stor4.length - 0x4f75ca53043ea007e5c65182cbb028f60d7179ff4b55739a3949b401801c9430
...
function _fallback() payable {
    ...
    if eth.balance(this.address) == stor1.length:
        idx = 0
        s = block.hash(block.number - 1) % stor4.length
        while idx < stor4.length:
...
function setContribution(uint256 arg1) payable {
    require 0 == arg1 % stor2.length
    require arg1 != contributions[address(msg.sender)]
    if arg1 <= contributions[address(msg.sender)]:
        if msg.value > 0:
            call msg.sender with:
               value msg.value wei
                 gas 0 wei
        require contributions[address(msg.sender)] - arg1 != 0
        require 0 == contributions[address(msg.sender)] - arg1 % stor2.length
        require msg.value <= 0
        require contributions[address(msg.sender)] - arg1 <= contributions[address(msg.sender)]
        call msg.sender with:
           value contributions[address(msg.sender)] - arg1 wei
             gas 0 wei
        contributions[address(msg.sender)] = arg1
        if not arg1:
            idx = 0
        ...
        if msg.value - arg1 + contributions[address(msg.sender)] <= 0:
            require msg.value - arg1 + contributions[address(msg.sender)] >= 0
        else:
            call msg.sender with:
               value msg.value - arg1 + contributions[address(msg.sender)] wei
                 gas 0 wei
        require arg1 - contributions[address(msg.sender)] != 0
        require 0 == arg1 - contributions[address(msg.sender)] % stor2.length
        require eth.balance(this.address) <= stor1.length
        if not contributions[address(msg.sender)]:
            stor4.length++
            if not stor4.length <= stor4.length + 1:
