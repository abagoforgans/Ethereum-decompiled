...
function _fallback() payable {
    ...
    require code.data[25614 len 32] >= code.data[25582 len 32]
    require 10^18 * code.data[25646 len 32] > 0
    create contract with 0 wei
                    code: code.data[17945 len 7637]
    require create.new_address
    address(stor0.field_0) = address(create.new_address)
    uint32(stor0.field_160) = code.data[25610 len 4]
    uint32(stor0.field_192) = code.data[25642 len 4]
    stor4 = 10^18 * code.data[25646 len 32]
    ...
    return code.data[2381 len 12978]
}
...
function _fallback() payable {
    ...
    weiRaised += msg.value
    require soldTokens + (msg.value * ext_call.return_data[0] / ext_call.return_data[0]) >= soldTokens
    soldTokens += msg.value * ext_call.return_data[0] / ext_call.return_data[0]
    require ext_code.size(tokenAddress)
    call tokenAddress.mint(address arg1, uint256 arg2) with:
         gas gas_remaining - 710 wei
        args msg.sender, msg.value * ext_call.return_data[0] / ext_call.return_data[0]
    require ext_call.success
    emit TokenPurchase(msg.value, msg.value * ext_call.return_data[0] / ext_call.return_data[0], msg.sender, msg.sender);
