...
function _fallback() {
    ...
    stor3 = code.data[6307 len 20]
    stor4 = code.data[6339 len 20]
    require ext_code.size(code.data[6307 len 20])
    call code.data[6307 len 20].0xbe38a4fe with:
    ...
    return code.data[1359 len 4936]
}
...
function sub_cbd5accc(?) {
    ...
    require ext_call.success
    require ext_code.size(tubAddress)
    call tubAddress.0x69245009 with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require ext_code.size(jugAddress)
    call jugAddress.0xe0cd1d69 with:
    ...
    require ext_call.success
    require ext_call.return_data[0] == ext_call.return_data[16 len 16]
    require uint128(10^9 * uint128(arg1))
    require (uint128(10^9 * uint128(arg1)) / 2) + 0xa70c3c40a64e6c51999090b65f67d9240000000000000 / uint128(10^9 * uint128(arg1)) == uint128((uint128(10^9 * uint128(arg1)) / 2) + 0xa70c3c40a64e6c51999090b65f67d9240000000000000 / uint128(10^9 * uint128(arg1)))
    require ext_code.size(tubAddress)
    call tubAddress.0x8a95a746 with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require uint128(ext_call.return_data[0])
    require (1000000000 * 10^18 * ext_call.return_data[16 len 16]) + (uint128(ext_call.return_data[0]) / 2) / uint128(ext_call.return_data[0]) == uint128((1000000000 * 10^18 * ext_call.return_data[16 len 16]) + (uint128(ext_call.return_data[0]) / 2) / uint128(ext_call.return_data[0]))
...
function cage() {
    ...
    require ext_call.success
    require ext_code.size(address(ext_call.return_data[0]))
    call address(ext_call.return_data[0]).0x57de26a4 with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require ext_code.size(tubAddress)
