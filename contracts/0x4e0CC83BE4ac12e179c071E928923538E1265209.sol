...
function sub_071c3c7a(?) {
    ...
    require stor5
    require stor4
    if not (997000 * 10 * 10^18 * defaultAmount / stor4 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0])) - (997000 * 10 * 10^18 * defaultAmount / stor5 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0])):
    ...
    if (997000 * 10 * 10^18 * defaultAmount / stor4 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0])) - (997000 * 10 * 10^18 * defaultAmount / stor5 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0])) <= 3:
        ...
        return (-1000 * eth.balance(ext_call.return_data[0])) + 1 / 997, 
               ...
               address(ext_call.return_data[0]),
               (9970 * defaultAmount * eth.balance(ext_call.return_data[0]) / (1000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) + (9970 * defaultAmount)) - stor4
    s = (997000 * 10 * 10^18 * defaultAmount / stor4 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0])) + (-997000 * 10 * 10^18 * defaultAmount / stor5 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0])) + 1 / 2
    t = (997000 * 10 * 10^18 * defaultAmount / stor4 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0])) - (997000 * 10 * 10^18 * defaultAmount / stor5 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0]))
    while s < t:
        require s
        s = ((997000 * 10 * 10^18 * defaultAmount / stor4 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0])) - (997000 * 10 * 10^18 * defaultAmount / stor5 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0])) / s) + s / 2
        t = s
        continue 
...
function sub_778e4cd7(?) {
    ...
    require stor4
    require stor5
    if not (997000 * 10 * 10^18 * defaultAmount / stor5 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) - (997000 * 10 * 10^18 * defaultAmount / stor4 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)):
    ...
    if (997000 * 10 * 10^18 * defaultAmount / stor5 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) - (997000 * 10 * 10^18 * defaultAmount / stor4 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) <= 3:
        ...
        return (-1000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) + 1 / 997, 
               ...
               address(ext_call.return_data[0]),
               stor4 - (10^18 * defaultAmount / 997 * defaultAmount * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) / (1000 * eth.balance(ext_call.return_data[0])) + (997 * defaultAmount))
    s = (997000 * 10 * 10^18 * defaultAmount / stor5 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) + (-997000 * 10 * 10^18 * defaultAmount / stor4 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) + 1 / 2
    t = (997000 * 10 * 10^18 * defaultAmount / stor5 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) - (997000 * 10 * 10^18 * defaultAmount / stor4 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18))
    while s < t:
        require s
        s = ((997000 * 10 * 10^18 * defaultAmount / stor5 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) - (997000 * 10 * 10^18 * defaultAmount / stor4 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) / s) + s / 2
        t = s
        continue 
