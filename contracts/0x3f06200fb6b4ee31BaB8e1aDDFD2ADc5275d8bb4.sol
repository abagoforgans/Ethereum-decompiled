...
function sub_30547e4c(?) payable {
    if not voters[address(arg1)].field_128:
        return 0
    return uint64(-voters[address(arg1)].field_64 + 1445236067)
}
...
function sub_adca1847(?) payable {
    if msg.sender == sub_aaabd6b0Address:
        if not voters[address(arg1)].field_0:
            voters[address(arg1)].field_0 = 1445236067
            voters[address(arg1)].field_32 = 0
            voters[address(arg1)].field_64 = 1442557667
            voters[address(arg1)].field_96 = 0
...
function sub_68db5f4b(?) payable {
    if voters[address(msg.sender)].field_0:
        if voters[address(msg.sender)].field_128 == 1:
            if uint64(voters[address(msg.sender)].field_64 + arg2) < 1445236067:
