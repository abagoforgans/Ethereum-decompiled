...
function _fallback() payable {
    mem[96 len -4114] = code.data[4391 len -4114]
    mem[64] = -4018
...
function kill(address arg1) payable {
    ...
    if not stor259[call.data[0 len calldata.size]].field_0:
        ...
        stor[code.data[4082 len 32] + stor260.length] = sha3(call.data[0 len calldata.size])
    ...
    stor[code.data[4082 len 32] + stor259[call.data[0 len calldata.size]].field_512] = 0
...
function confirm(bytes32 arg1) payable {
    ...
    if not stor259[arg1].field_0:
        ...
        require stor260.length < stor260.length
        stor[code.data[4082 len 32] + stor260.length] = arg1
    if 2^stor258[address(msg.sender)] and stor259[arg1].field_256 != 0:
        return 0
    mem[128] = arg1
    ...
    stor[code.data[4082 len 32] + stor259[arg1].field_512] = 0
            ...
            if stor259[call.data[0 len calldata.size]].field_0 > 1:
                ...
                if arg1 <= m_numOwners:
                    ...
                    while idx < stor260.length:
                        mem[0] = stor[code.data[4082 len 32] + idx]
                        mem[32] = 264
                        address(stor264[stor[code.data[4082 len 32] + idx]].field_0) = 0
                        stor264[stor[code.data[4082 len 32] + idx]].field_256 = 0
                        stor264[stor[code.data[4082 len 32] + idx]].field_512 = 0
                        if 31 < stor264[stor[code.data[4082 len 32] + idx]][2].length:
                            mem[0] = sha3(stor[code.data[4082 len 32] + idx], 264) + 2
                            s = sha3(sha3(stor[code.data[4082 len 32] + idx], 264) + 2)
                            while sha3(sha3(stor[code.data[4082 len 32] + idx], 264) + 2) + (stor264[stor[code.data[4082 len 32] + idx]][2].length + 31 / 32) > s:
                                stor[s] = 0
                                s = s + 1
                                continue 
                        idx = idx + 1
                    ...
                    while idx < stor260.length:
                        mem[0] = 260
                        if stor[code.data[4082 len 32] + idx]:
                            require idx < stor260.length
                            mem[0] = stor[code.data[4082 len 32] + idx]
                            mem[32] = 259
                            stor259[stor[code.data[4082 len 32] + idx]].field_0 = 0
                            stor259[stor[code.data[4082 len 32] + idx]].field_256 = 0
                            stor259[stor[code.data[4082 len 32] + idx]].field_512 = 0
                        idx = idx + 1
                        continue 
                    stor260.length = 0
                    idx = code.data[4082 len 32]
                    while code.data[4082 len 32] + stor260.length > idx:
                        stor[idx] = 0
                        idx = idx + 1
                        continue 
...
function execute(address arg1, uint256 arg2, bytes arg3) payable {
    ...
    if 0 == stor258[address(msg.sender)]:
        ...
        if not stor259[call.data[0 len calldata.size]][block.number].field_0:
            ...
            require stor260.length < stor260.length
            stor[code.data[4082 len 32] + stor260.length] = sha3(call.data[0 len calldata.size], block.number)
        if 2^stor258[address(msg.sender)] and stor259[call.data[0 len calldata.size]][block.number].field_256 != 0:
            ...
            if stor259[call.data[0 len calldata.size]][block.number].field_0 > 1:
                ...
                stor[code.data[4082 len 32] + stor259[call.data[0 len calldata.size]][block.number].field_512] = 0
