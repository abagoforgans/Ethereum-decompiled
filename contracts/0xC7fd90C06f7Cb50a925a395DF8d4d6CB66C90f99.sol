...
function _fallback() payable {
    ...
    stor3 = msg.sender
    stor6 = code.data[13917 len 32]
    stor7 = code.data[13949 len 32]
    stor14 = 0
    stor15 = 0
    stor20 = 0
    stor17 = 0
    if code.data[13897 len 20]:
        stor5 = code.data[13897 len 20]
        if code.data[13865 len 20]:
            stor4 = code.data[13865 len 20]
            stor20 = 1
    stor8 = code.data[13981 len 32]
    stor9 = code.data[14013 len 32]
    return code.data[673 len 13180]
}
...
function setTokenAddress(address arg1) {
    ...
    require uint8(stor20) <= 11
    require uint8(stor20) != 8
...
function sub_ec26fe84(?) {
    if not arg1:
        ...
        if stor19 * arg1 / arg1 == stor19:
            if (stor19 * arg1 / 100) + arg1 >= arg1:
                return arg1, stor19 * arg1 / 100, (stor19 * arg1 / 100) + arg1
    revert
}
...
function sub_8f16943e(?) {
    ...
    while stor1[uint8(idx)] != msg.sender:
        ...
        continue 
    require arg1 <= 11
    uint256(stor20) = arg1 or Mask(248, 8, uint256(stor20))
}
...
function sub_dfccdcd0(?) {
    ...
    if not arg1:
        if stor19 + 100:
            if 0 / stor19 + 100 <= arg1:
                return 0 / stor19 + 100, arg1 - (0 / stor19 + 100)
    else:
        if 100 * arg1 / arg1 == 100:
            if stor19 + 100:
                if 100 * arg1 / stor19 + 100 <= arg1:
                    return 100 * arg1 / stor19 + 100, arg1 - (100 * arg1 / stor19 + 100)
    revert
}
...
function sub_85e74fed(?) payable {
    ...
    if not msg.value:
        require stor19 + 100
        require 0 / stor19 + 100 <= msg.value
        require (0 / stor19 + 100) + stor15 >= stor15
        if (0 / stor19 + 100) + stor15 <= stor6:
            sub_1571c632[uint32(stor14.field_0)].field_0 = arg3
            sub_1571c632[uint32(stor14.field_0)].field_256 = arg2
            sub_1571c632[uint32(stor14.field_0)].field_512 = 0 / stor19 + 100
            ...
            sub_1571c632[uint32(stor14.field_0)].field_1280 = msg.value - (0 / stor19 + 100)
            require (0 / stor19 + 100) + stor15 >= stor15
            stor15 += 0 / stor19 + 100
            if not 0 / stor19 + 100:
                require stor16 >= stor16
            else:
                require arg1 * 0 / stor19 + 100 / 0 / stor19 + 100 == arg1
                require (arg1 * 0 / stor19 + 100) + stor16 >= stor16
                stor16 += arg1 * 0 / stor19 + 100
            call stor2 with:
               value msg.value - (0 / stor19 + 100) wei
                 gas 2300 * is_zero(value) wei
            require ext_call.success
            emit Invest((0 / stor19 + 100), arg2, arg3, msg.value - (0 / stor19 + 100));
            uint32(stor14.field_0) = uint32(uint32(stor14.field_0) + 1)
            if stor12[address(msg.sender)].field_0 > 0:
                stor12[address(msg.sender)].field_0 = uint32(stor12[address(msg.sender)].field_0 + 1)
            else:
                stor12[address(msg.sender)].field_0 = 1
                stor12[address(msg.sender)].field_8 = 0
                uint32(stor14.field_32) = uint32(uint32(stor14.field_32) + 1)
            return (0 / stor19 + 100)
    else:
        require 100 * msg.value / msg.value == 100
        require stor19 + 100
        require 100 * msg.value / stor19 + 100 <= msg.value
        require (100 * msg.value / stor19 + 100) + stor15 >= stor15
        if (100 * msg.value / stor19 + 100) + stor15 <= stor6:
            sub_1571c632[uint32(stor14.field_0)].field_0 = arg3
            sub_1571c632[uint32(stor14.field_0)].field_256 = arg2
            sub_1571c632[uint32(stor14.field_0)].field_512 = 100 * msg.value / stor19 + 100
            sub_1571c632[uint32(stor14.field_0)].field_768 = arg1
            sub_1571c632[uint32(stor14.field_0)].field_1024 = 0
            sub_1571c632[uint32(stor14.field_0)].field_1280 = 0
            sub_1571c632[uint32(stor14.field_0)].field_1280 = msg.value - (100 * msg.value / stor19 + 100)
            require (100 * msg.value / stor19 + 100) + stor15 >= stor15
            stor15 += 100 * msg.value / stor19 + 100
            if not 100 * msg.value / stor19 + 100:
                require stor16 >= stor16
            else:
                require arg1 * 100 * msg.value / stor19 + 100 / 100 * msg.value / stor19 + 100 == arg1
                require (arg1 * 100 * msg.value / stor19 + 100) + stor16 >= stor16
                stor16 += arg1 * 100 * msg.value / stor19 + 100
            call stor2 with:
               value msg.value - (100 * msg.value / stor19 + 100) wei
                 gas 2300 * is_zero(value) wei
            require ext_call.success
            emit Invest((100 * msg.value / stor19 + 100), arg2, arg3, msg.value - (100 * msg.value / stor19 + 100));
            uint32(stor14.field_0) = uint32(uint32(stor14.field_0) + 1)
            if stor12[address(msg.sender)].field_0 > 0:
                stor12[address(msg.sender)].field_0 = uint32(stor12[address(msg.sender)].field_0 + 1)
            else:
                ...
                stor12[address(msg.sender)].field_8 = 0
                uint32(stor14.field_32) = uint32(uint32(stor14.field_32) + 1)
            return (100 * msg.value / stor19 + 100)
    stor15 = stor6
    if not stor6 - stor15:
        require stor16 >= stor16
    else:
    ...
    if not stor6 - stor15:
        ...
        call stor2 with:
             gas 2300 wei
        emit Invest((stor6 - stor15), arg2, arg3, 0);
    else:
        require (stor6 * stor19) - (stor15 * stor19) / stor6 - stor15 == stor19
        require (stor6 * stor19) - (stor15 * stor19) / 100 >= 0
        sub_1571c632[uint32(stor14.field_0)].field_0 = arg3
        sub_1571c632[uint32(stor14.field_0)].field_256 = arg2
        sub_1571c632[uint32(stor14.field_0)].field_512 = stor6 - stor15
        sub_1571c632[uint32(stor14.field_0)].field_768 = arg1
        sub_1571c632[uint32(stor14.field_0)].field_1024 = 0
        sub_1571c632[uint32(stor14.field_0)].field_1280 = 0
        sub_1571c632[uint32(stor14.field_0)].field_1280 = (stor6 * stor19) - (stor15 * stor19) / 100
        call arg2 with:
           value msg.value - stor6 + stor15 wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        call stor2 with:
           value (stor6 * stor19) - (stor15 * stor19) / 100 wei
             gas 2300 * is_zero(value) wei
        emit Invest((stor6 - stor15), arg2, arg3, (stor6 * stor19) - (stor15 * stor19) / 100);
    uint32(stor14.field_0) = uint32(uint32(stor14.field_0) + 1)
    if stor12[address(msg.sender)].field_0 > 0:
        stor12[address(msg.sender)].field_0 = uint32(stor12[address(msg.sender)].field_0 + 1)
    else:
