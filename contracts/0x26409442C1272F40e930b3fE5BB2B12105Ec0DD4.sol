...
function _fallback() {
    mem[96 len -8356] = code.data[9052 len -8356]
    mem[64] = -8260
...
function sub_1614e30c(?) {
    require msg.sender == 0xc9f248c1331c1a61b4771c033ab7992f7e039b55
    call arg1 with:
       value arg2 wei
