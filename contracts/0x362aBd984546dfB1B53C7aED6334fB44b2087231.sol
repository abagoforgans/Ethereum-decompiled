...
function sub_07673ffc(?) payable {
    return sub_07673ffc[arg1].field_2560
}

function sub_11f7c705(?) payable {
    return sub_07673ffc[arg1].field_256
}

function sub_34d105ea(?) payable {
    return sub_07673ffc[arg1].field_1024
}

function sub_38e47f47(?) payable {
    return sub_07673ffc[arg1].field_1288
}

function sub_3bc45e61(?) payable {
...
function sub_5c47cd21(?) payable {
    require arg2 < sub_5127c79d[arg1].field_0
    return sub_5127c79d[arg1][arg2].field_1536
}

function sub_86bae08e(?) payable {
    return sub_07673ffc[arg1].field_512
}

function sub_8df170b1(?) payable {
    return sub_07673ffc[arg1].field_2048
}

function sub_927bf691(?) payable {
...
function sub_98cbe541(?) payable {
    require arg2 < sub_5127c79d[arg1].field_0
    return sub_5127c79d[arg1][arg2].field_1792
}

function sub_9e67786b(?) payable {
    require arg2 < sub_5127c79d[arg1].field_0
    return sub_5127c79d[arg1][arg2].field_256
}

function sub_ce53e4dc(?) payable {
...
function sub_d0cde072(?) payable {
    if stor1[address(arg1)].field_0:
        mem[192] = stor1[address(arg1)].field_0
        idx = 192
        s = 0
        while (32 * stor1[address(arg1)].field_0) + 160 > idx:
            mem[idx + 32] = stor1[address(arg1)][s].field_256
            idx = idx + 32
            s = s + 1
            continue 
    return Array(len=stor1[address(arg1)].field_0, data=mem[192 len 32 * stor1[address(arg1)].field_0])
}

function sub_cd0b71a8(?) payable {
...
function sub_53a3d72b(?) payable {
    mem[896] = 0
    mem[928 len 768] = 0
    idx = 1
    s = 0
    while idx <= numberOfRequests:
        mem[0] = idx
        mem[32] = 2
        if not sub_07673ffc[idx].field_256:
            if block.timestamp - (24 * 3600) >= sub_07673ffc[idx].field_0:
                idx = idx + 1
                s = s
                continue 
        else:
            if sub_07673ffc[idx].field_256 == 1:
                if block.timestamp - (48 * 24 * 3600) >= sub_07673ffc[idx].field_0:
                    idx = idx + 1
                    s = s
                    continue 
            else:
                if sub_07673ffc[idx].field_256 != 2:
                    if 0 >= sub_07673ffc[idx].field_0:
                        idx = idx + 1
                        s = s
                        continue 
                else:
                    if block.timestamp - (168 * 24 * 3600) >= sub_07673ffc[idx].field_0:
                        idx = idx + 1
                        s = s
                        continue 
        require s < 25
                            ...
                            if arg10 > 120:
                                ...
                                if arg9 > 4:
                                    ...
                                    if arg12 > 2:
                                        ...
                                        if not arg8:
                                            emit 0x9e609148: 0, 64, 29, 'Maximum price cannot be zero.', msg.sender
                                        else:
                                            if arg7 > 4:
                                                ...
                                                sub_07673ffc[stor0].field_256 = arg12 or Mask(248, 8, sub_07673ffc[stor0].field_256)
                                                sub_07673ffc[stor0].field_264 = Mask(248, 0, msg.sender)
                                                sub_07673ffc[stor0].field_512 = arg1
                                                sub_07673ffc[stor0].field_768 = arg2
                                                sub_07673ffc[stor0].field_1024 = arg8
                                                sub_07673ffc[stor0].field_1280 = arg7 or Mask(248, 8, sub_07673ffc[stor0].field_1280)
                                                sub_07673ffc[stor0].field_1288 = Mask(248, 0, arg5)
                                                sub_07673ffc[stor0].field_1536 = arg3
                                                sub_07673ffc[stor0][7][].field_0 = Array(len=arg4.length, data=arg4[all])
                                                sub_07673ffc[stor0].field_2048 = arg6 or Mask(248, 8, sub_07673ffc[stor0].field_2048)
                                                sub_07673ffc[stor0].field_2056 = Mask(248, 0, arg11)
                                                sub_07673ffc[stor0].field_2304 = arg10
                                                sub_07673ffc[stor0].field_2560 = arg9 or Mask(248, 8, sub_07673ffc[stor0].field_2560)
