...
function _fallback() payable {
    ...
    mem[96 len -5026] = code.data[5366 len -5026]
    mem[64] = -4930
...
function kill(address arg1) {
    ...
    require 0 == stor259[call.data[0 len calldata.size]][block.number].field_256 and 2^stor258[address(msg.sender)]
...
function hasConfirmed(bytes32 arg1, address arg2) {
    if stor258[address(arg2)]:
        if stor259[arg1].field_256 and 2^stor258[address(arg2)] != 0:
            return 1
        else:
            return 0
    else:
...
function confirm(bytes32 arg1) {
    ...
    require 0 == stor259[arg1].field_256 and 2^stor258[address(msg.sender)]
    mem[128] = arg1
...
function changeRequirement(uint256 arg1) {
    ...
    if arg1 <= m_numOwners:
        ...
        while idx < stor260.length:
            ...
            s = sha3(sha3(stor260[s], 265) + 2)
            while sha3(sha3(stor260[s], 265) + 2) + (stor265[stor260[s]][2].length + 31 / 32) > s:
                stor[s] = 0
                s = s + 1
                continue 
            s = sha3(sha3(stor260[s], 265) + 2) + (stor265[stor260[s]][2].length + 31 / 32) + 1
            continue 
        idx = 0
        while idx < stor260.length:
            mem[0] = 260
...
function execute(address arg1, uint256 arg2, bytes arg3) {
    ...
    if not address(stor265[call.data[0 len calldata.size]][block.number].field_0):
        if not address(stor265[call.data[0 len calldata.size]][block.number].field_0):
            address(stor265[call.data[0 len calldata.size]][block.number].field_0) = arg1
