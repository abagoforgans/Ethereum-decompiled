...
function _fallback() payable {
    ...
    stor0 = code.data[1602 len 20]
    stor1 = 10^18 * code.data[1622 len 32]
    stor3 = (60 * code.data[1654 len 32]) + block.timestamp
    stor4 = 10^18 * code.data[1686 len 32]
    stor5 = code.data[1730 len 20]
    return code.data[167 len 1423]
}
...
function _fallback() payable {
    ...
    call tokenRewardAddress.0xa9059cbb with:
        ...
        args msg.sender, msg.value / price / 100 * 10^6
