            ...
            while ext_call.success:
                ...
                if stor15:
                    ...
                    if not stor21:
                        ...
                        require 4000 * stor21 / stor21 == 4000
                        require ext_code.size(address(tokenAddress))
                        call address(tokenAddress).approve(address arg1, uint256 arg2) with:
                             gas gas_remaining wei
                            args address(stor10.field_0), 4000 * stor21 / 10000
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require ext_code.size(sub_c5415fcdAddress)
                        call sub_c5415fcdAddress.0xa9059cbb with:
                             gas gas_remaining wei
                            args address(arg1), 4000 * stor21 / 10000
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require ext_code.size(address(tokenAddress))
                        call address(tokenAddress).approve(address arg1, uint256 arg2) with:
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        emit 0x3e498ea7: (4000 * stor21 / 10000), arg1
                    ...
                    if stor15:
                        ...
                        if not stor20:
                            ...
                            if not rate * stor20 / 10^18:
                                ...
                                require 4000 * rate * stor20 / 10^18 / rate * stor20 / 10^18 == 4000
                                require ext_code.size(address(tokenAddress))
                                call address(tokenAddress).approve(address arg1, uint256 arg2) with:
                                     gas gas_remaining wei
                                    args address(stor10.field_0), 4000 * rate * stor20 / 10^18 / 10000
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require return_data.size >= 32
                                require ext_code.size(sub_c5415fcdAddress)
                                call sub_c5415fcdAddress.0xa9059cbb with:
                                     gas gas_remaining wei
                                    args address(arg1), 4000 * rate * stor20 / 10^18 / 10000
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require ext_code.size(address(tokenAddress))
                                call address(tokenAddress).approve(address arg1, uint256 arg2) with:
                                ...
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require return_data.size >= 32
                                emit 0x3e498ea7: (4000 * rate * stor20 / 10^18 / 10000), arg1
