...
function participants(uint256 arg1) payable {
    require arg1 < stor0
    return address(stor5629[arg1]), uint256(stor[(2 * arg1) + code.data[1119 len 32]])
}
...
function enter() payable {
    ...
    if msg.value <= 21 * 10^18:
        ...
        if not stor0 > stor0 + 1:
            ...
            uint256(stor[code.data[1119 len 32] + (2 * stor0)]) = msg.value
            if not stor0:
                collectedFees += msg.value
            else:
                collectedFees += msg.value / 50
                balance += msg.value
            if balance <= 155 * uint256(stor[code.data[1119 len 32] + (2 * stor1.length)]) / 100:
            require stor1.length < stor0
            call address(stor5629[stor1.length]) with:
               value var25003 wei
                 gas 0 wei
            balance += -155 * uint256(stor[code.data[1119 len 32] + (2 * stor1.length)]) / 100
            stor1.length++
            if balance <= 155 * uint256(stor[code.data[1119 len 32] + (2 * stor1.length)]) / 100:
            require stor1.length < stor0
            call address(stor5629[stor1.length]) with:
        ...
        if not stor0 > stor0 + 1:
            require stor0 < stor0
            uint256(stor5629[stor0]) = msg.sender or Mask(96, 160, uint256(stor5629[stor0]))
            uint256(stor[code.data[1119 len 32] + (2 * stor0)]) = 21 * 10^18
            if not stor0:
