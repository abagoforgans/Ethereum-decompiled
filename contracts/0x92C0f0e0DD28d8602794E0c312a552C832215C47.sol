...
function _fallback() payable {
    ...
    while stor6.length + 31 / 32 > idx:
        ...
        idx = idx + 1
        continue 
    stor0[address(msg.sender)] = 3 * 10^16
    stor2 = 3 * 10^16
    bool(stor3.length) = 0
    stor3.length.field_1 = 20
    stor3.length.field_8 = 'VietnamGemstoneChain' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'VGC' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[848 len 3400]
}
