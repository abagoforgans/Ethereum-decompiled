...
function _fallback() payable {
    ...
    stor1.length.field_8 = 'WWAMT4' / 256
    idx = 0
    ...
    stor5 = code.data[4783 len 20]
    stor0[stor5] = stor4
    return code.data[703 len 4068]
}
    ...
    if block.timestamp < sub_0dca9e7f:
        if block.timestamp < sub_5638efce:
            ...
            if block.timestamp >= sub_d2768f05:
                ...
                require 110 * msg.value / 5 * 10^12 / 100 <= -(totalSupply / 50) - 1
                require balanceOf[stor5] >= (110 * msg.value / 5 * 10^12 / 100) + (totalSupply / 50)
                require balanceOf[address(msg.sender)] <= (-110 * msg.value / 5 * 10^12 / 100) - 1
                balanceOf[address(msg.sender)] += 110 * msg.value / 5 * 10^12 / 100
                require balanceOf[stor5] >= 110 * msg.value / 5 * 10^12 / 100
                balanceOf[stor5] += -110 * msg.value / 5 * 10^12 / 100
    else:
        if block.timestamp < sub_5638efce:
            require 115 * msg.value / 5 * 10^12 / 100 <= -(totalSupply / 50) - 1
            require balanceOf[stor5] >= (115 * msg.value / 5 * 10^12 / 100) + (totalSupply / 50)
            require balanceOf[address(msg.sender)] <= (-115 * msg.value / 5 * 10^12 / 100) - 1
            balanceOf[address(msg.sender)] += 115 * msg.value / 5 * 10^12 / 100
            require balanceOf[stor5] >= 115 * msg.value / 5 * 10^12 / 100
            balanceOf[stor5] += -115 * msg.value / 5 * 10^12 / 100
        else:
            if block.timestamp >= sub_d2768f05:
                require msg.value / 5 * 10^12 <= -(totalSupply / 50) - 1
                require balanceOf[stor5] >= (msg.value / 5 * 10^12) + (totalSupply / 50)
