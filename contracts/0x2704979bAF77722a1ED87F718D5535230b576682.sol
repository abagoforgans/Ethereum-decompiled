...
mapping of uint256 sub_1f28299a;
mapping of uint256 sub_d177ba32;
mapping of uint256 sub_4041bfd8;
mapping of uint256 sub_5b54fa9c;
...
function sub_1f28299a(?) {
    return sub_1f28299a[arg1]
}
...
function sub_4041bfd8(?) {
    return sub_4041bfd8[arg1]
}
...
function sub_5b54fa9c(?) {
    return sub_5b54fa9c[arg1]
}
...
function sub_d177ba32(?) {
    return sub_d177ba32[arg1]
}
...
function sub_4100d758(?) {
    ...
    call investTokenAddress.0xa9059cbb with:
         gas gas_remaining wei
        args msg.sender, sub_ad594cf7[msg.sender]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
}
