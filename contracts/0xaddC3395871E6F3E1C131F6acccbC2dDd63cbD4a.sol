...
function _fallback() payable {
    ...
    stor0 = msg.sender
    address(stor11.field_8) = 0x693a9cfbace1b67558e78ce2d081965193002223
    bool(stor1.length) = 0
    stor1.length.field_1 = 8
    stor1.length.field_8 = 'MISTOKEN' / 256
    idx = 0
