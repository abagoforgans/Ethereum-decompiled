...
function _fallback() payable {
    ...
    stor1 = msg.sender
    require not stor7
    require stor5 + 2 * 10^17 >= stor5
    stor5 += 2 * 10^17
    require stor2[address(msg.sender)] + 2 * 10^17 >= stor2[address(msg.sender)]
    stor2[address(msg.sender)] += 2 * 10^17
    emit Distr(2 * 10^17, msg.sender);
    emit Transfer(2 * 10^17, 0, msg.sender);
    return code.data[439 len 3998]
}
...
const name = 'CyberMusic'

const decimals = 8

const symbol = 'CYMT'

const MIN_PURCHASE = 10^16
