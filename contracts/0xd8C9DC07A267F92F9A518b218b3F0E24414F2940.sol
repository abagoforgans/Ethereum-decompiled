...
function _fallback() payable {
    ...
    stor2 = code.data[3668 len 32] or Mask(96, 160, stor2)
    stor0 = code.data[3700 len 32]
    stor1 = code.data[3732 len 32]
    return code.data[169 len 3499]
}
...
function vote(uint256 arg1, int256 arg2) payable {
    call sub_fd46146aAddress.0xbbd39ac0 with:
...
function executeProposal(uint256 arg1) payable {
    ...
    while idx < uint256(stor4[arg1].field_1536):
        ...
        mem[100] = address(stor[(2 * idx) + sha3((8 * arg1) + ('name', 'stor4', 4) + 6)].field_256)
        call sub_fd46146aAddress.0xbbd39ac0 with:
             gas gas_remaining - 25050 wei
            args address(stor[(2 * idx) + sha3((8 * arg1) + ('name', 'stor4', 4) + 6)].field_256)
        ...
        t = t + (ext_call.return_data[0] * uint256(stor[(2 * idx) + sha3((8 * arg1) + ('name', 'stor4', 4) + 6)].field_0))
        continue 
