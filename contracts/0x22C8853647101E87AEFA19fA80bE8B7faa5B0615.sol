...
function sub_70abebab(?) payable {
    ...
    if not assets.length > assets.length + 1:
        ...
        uint256(assets[assets.length].field_0) = 0
        uint8(assets[assets.length].field_256) = 0
        assets[assets.length].field_512 % 1 = 0
        uint256(assets[assets.length].field_512) = 0
        uint256(assets[assets.length].field_768) = 0
    ...
    while uint256(assets[assets.length].field_1536) > idx:
        ...
        idx = idx + 1
        continue 
    uint8(assets[assets.length].field_1792) = 0
    assets[assets.length].field_2048 % 1 = 0
    require assets.length < assets.length
    uint256(assets[assets.length].field_1280) = 2
    if not uint256(assets[assets.length].field_1280) <= 2:
        idx = 2
        while uint256(assets[assets.length].field_1280) > idx:
            uint256(stor[idx + sha3((8 * assets.length) + ('name', 'assets', 1) + 5)].field_0) = 0
            idx = idx + 1
            continue 
    require assets.length < assets.length
    uint256(assets[assets.length].field_1536) = 2
    if not uint256(assets[assets.length].field_1536) <= 2:
        idx = 2
        while uint256(assets[assets.length].field_1536) > idx:
            uint256(stor[idx + sha3((8 * assets.length) + ('name', 'assets', 1) + 6)].field_0) = 0
            idx = idx + 1
    ...
    if not sub_c4242719[arg3]:
        ...
        if not uint256(stor[(8 * stor0[arg3]) + ('name', 'assets', 1) + 4][tx.origin].field_0):
            ...
            if uint256(stor[uint256(stor[(8 * stor0[arg3]) + ('name', 'assets', 1) + 4][tx.origin].field_0) + sha3((8 * stor0[arg3]) + ('name', 'assets', 1) + 6)].field_0) < arg2:
                emit 0x5b59a413: 3
                return 0
            if uint256(stor[uint256(stor[(8 * stor0[arg3]) + ('name', 'assets', 1) + 4][tx.origin].field_0) + sha3((8 * stor0[arg3]) + ('name', 'assets', 1) + 6)].field_0) + arg2 < uint256(stor[uint256(stor[(8 * stor0[arg3]) + ('name', 'assets', 1) + 4][tx.origin].field_0) + sha3((8 * stor0[arg3]) + ('name', 'assets', 1) + 6)].field_0):
                emit 0x5b59a413: 4
                revert 
    require sub_c4242719[arg3] < assets.length
    emit 0x5b59a413: 4
