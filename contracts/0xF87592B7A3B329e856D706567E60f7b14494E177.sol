...
function _fallback() payable {
    ...
    require code.data[5082 len 20]
    stor3 = msg.sender
    stor4 = code.data[5082 len 20]
    uint64(stor5.field_160) = uint64(block.timestamp)
    return code.data[202 len 4868]
}
...
function close(uint256 arg1) {
    ...
    require arg1 + totalSupply <= 500000000 * 10^18
    totalSupply += arg1
    create contract with 0 wei
                    code: code.data[3934 len 891], address(this.address), owner, uint64(uint64(stor5.field_160) + (2400 * 24 * 3600))
    require create.new_address
    timelockContractAddress = address(create.new_address)
    require arg1 + balanceOf[address(create.new_address)] >= balanceOf[address(create.new_address)]
    balanceOf[address(stor5.field_0)] = arg1 + balanceOf[address(create.new_address)]
    issueIndex++
