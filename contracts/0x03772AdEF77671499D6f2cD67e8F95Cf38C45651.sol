...
function _fallback() payable {
    ...
    require code.data[2793 len 20]
    address(stor2.field_0) = code.data[2793 len 20]
    return code.data[453 len 2328]
}
...
const howManyEthersToKillContract = 500 * 10^18

const howManyEthersToChangeSymbolName = 400 * 10^18

const tokensPerEth = 1

const howManyEthersToBecomeOwner = 1000 * 10^18
