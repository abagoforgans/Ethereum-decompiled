...
function _fallback() payable {
    mem[96 len -5341] = code.data[5618 len -5341]
    mem[64] = -5245
...
function kill(address arg1) payable {
    ...
    if not stor259[call.data[0 len calldata.size]].field_0:
        ...
        stor[code.data[5309 len 32] + stor260.length] = sha3(call.data[0 len calldata.size])
    ...
    stor[code.data[5309 len 32] + stor259[call.data[0 len calldata.size]].field_512] = 0
...
function confirm(bytes32 arg1) payable {
    ...
    if not stor259[arg1].field_0:
        ...
        require stor260.length < stor260.length
        stor[code.data[5309 len 32] + stor260.length] = arg1
    if 2^stor258[address(msg.sender)] and stor259[arg1].field_256 != 0:
        return 0
    mem[128] = arg1
    ...
    stor[code.data[5309 len 32] + stor259[arg1].field_512] = 0
            ...
            if stor259[call.data[0 len calldata.size]].field_0 > 1:
                ...
                if arg1 <= m_numOwners:
                    ...
                    while idx < stor260.length:
                        mem[0] = stor[code.data[5309 len 32] + idx]
                        mem[32] = 274
                        address(stor274[stor[code.data[5309 len 32] + idx]].field_0) = 0
                        stor274[stor[code.data[5309 len 32] + idx]].field_256 = 0
                        stor274[stor[code.data[5309 len 32] + idx]].field_512 = 0
                        if 31 < stor274[stor[code.data[5309 len 32] + idx]][2].length:
                            mem[0] = sha3(stor[code.data[5309 len 32] + idx], 274) + 2
                            s = sha3(sha3(stor[code.data[5309 len 32] + idx], 274) + 2)
                            while sha3(sha3(stor[code.data[5309 len 32] + idx], 274) + 2) + (stor274[stor[code.data[5309 len 32] + idx]][2].length + 31 / 32) > s:
                                stor[s] = 0
                                s = s + 1
                                continue 
                        idx = idx + 1
                    ...
                    while idx < stor260.length:
                        mem[0] = 260
                        if stor[code.data[5309 len 32] + idx]:
                            require idx < stor260.length
                            mem[0] = stor[code.data[5309 len 32] + idx]
                            mem[32] = 259
                            stor259[stor[code.data[5309 len 32] + idx]].field_0 = 0
                            stor259[stor[code.data[5309 len 32] + idx]].field_256 = 0
                            stor259[stor[code.data[5309 len 32] + idx]].field_512 = 0
                        idx = idx + 1
                        continue 
                    stor260.length = 0
                    idx = code.data[5309 len 32]
                    while code.data[5309 len 32] + stor260.length > idx:
                        stor[idx] = 0
                        idx = idx + 1
                        continue 
    ...
    if 65 == ('cd', 164).length:
        ...
        if stor258[address(signer)] != 0:
            if not stor259[address(cd[4])][cd[36]][call.data[cd[68] + 36 len ('cd', 68).length]][cd[100]][cd[132]].field_0:
                ...
                require stor260.length < stor260.length
                stor[code.data[5309 len 32] + stor260.length] = sha3(address(cd[4]), cd[36], call.data[cd[68] + 36 len ('cd', 68).length], cd[100], cd[132])
            if 0 == 2^stor258[address(signer)] and stor259[address(cd[4])][cd[36]][call.data[cd[68] + 36 len ('cd', 68).length]][cd[100]][cd[132]].field_256:
                ...
                if stor259[address(cd[4])][cd[36]][call.data[cd[68] + 36 len ('cd', 68).length]][cd[100]][cd[132]].field_0 <= 1:
                    ...
                    stor[code.data[5309 len 32] + stor259[address(cd[4])][cd[36]][call.data[cd[68] + 36 len ('cd', 68).length]][cd[100]][cd[132]].field_512] = 0
...
function execute(address arg1, uint256 arg2, bytes arg3) payable {
    ...
    if 0 == stor258[address(msg.sender)]:
        ...
        if not stor259[call.data[0 len calldata.size]][block.number].field_0:
            ...
            require stor260.length < stor260.length
            stor[code.data[5309 len 32] + stor260.length] = sha3(call.data[0 len calldata.size], block.number)
        if 2^stor258[address(msg.sender)] and stor259[call.data[0 len calldata.size]][block.number].field_256 != 0:
            ...
            if stor259[call.data[0 len calldata.size]][block.number].field_0 > 1:
                ...
                stor[code.data[5309 len 32] + stor259[call.data[0 len calldata.size]][block.number].field_512] = 0
