...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'Tronix' / 256
    idx = 0
    ...
    stor5 = 10^17
    stor3[code.data[3186 len 20]] = 10^17
    emit Transfer(10^17, 0, code.data[3186 len 20]);
    return code.data[518 len 2656]
}
