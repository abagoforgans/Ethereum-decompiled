...
function _fallback() payable {
    ...
    if block.timestamp <= bonus1Ends:
        ...
        require (10000 * msg.value) + _totalSupply < maxSupply
        ...
        if block.timestamp > bonus2Ends:
            ...
            require (5000 * msg.value) + _totalSupply >= _totalSupply
            require (5000 * msg.value) + _totalSupply < maxSupply
            require (5000 * msg.value) + balanceOf[msg.sender] >= balanceOf[msg.sender]
            balanceOf[msg.sender] += 5000 * msg.value
            require (5000 * msg.value) + _totalSupply >= _totalSupply
