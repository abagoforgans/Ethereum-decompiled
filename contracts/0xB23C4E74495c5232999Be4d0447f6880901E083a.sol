...
function sub_81f3c8ea(?) {
    ...
    staticcall sub_f3ad65f4Address.0xd502db97 with:
...
function sub_56905d50(?) {
    ...
    require return_data.size >= 32
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).getExpectedRate(address arg1, address arg2, uint256 arg3) with:
            gas gas_remaining wei
...
function sub_98689001(?) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    emit 0xc4cc1eb8: address(ext_call.return_data[0]), arg1, address(ext_call.return_data[0]), ext_call.return_data[0], msg.sender, ext_call.return_data[32]
