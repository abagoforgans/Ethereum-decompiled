...
function _fallback() {
    mem[96 len -5520] = code.data[6048 len -5520]
    mem[64] = -5424
...
function propose(address arg1, bytes arg2, uint256 arg3) {
    ...
    require stor6[address(msg.sender)]
    mem[ceil32(arg2.length) + 224 len calldata.size] = call.data[0 len calldata.size]
    emit call.func_hash: msg.value, Array(len=calldata.size, data=call.data[0 len calldata.size]), msg.sender, arg1, arg2
    actionCount++
    ...
    mem[ceil32(arg2.length) + 128] = actionCount + 1
    ...
    emit Proposed(actionCount + 1, Array(len=arg2.length, data=mem[ceil32(arg2.length) + 224 len arg2.length]));
...
function trigger(uint256 arg1) {
    ...
    mem[0] = arg1
    mem[32] = 4
    if calldata[arg1][1].length:
        mem[ceil32(calldata[arg1][1].length) + 128] = mem[128]
        mem[ceil32(calldata[arg1][1].length) + 160 len floor32(calldata[arg1][1].length - 1)] = mem[160 len floor32(calldata[arg1][1].length - 1)]
