...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = code.data[2516 len 32]
    stor5 += code.data[2516 len 32]
    return code.data[162 len 2354]
}
...
function sub_2ba2d69a(?) payable {
    if coinBalanceOf[address(msg.sender)] < arg2 + stor6:
        return 0
