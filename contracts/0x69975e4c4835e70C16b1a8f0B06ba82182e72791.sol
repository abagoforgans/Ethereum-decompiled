...
function sub_8060830a(?) payable {
    ...
    if 352 < (32 * stor2.length - 1) + 352:
        ...
        if 32 * stor2.length - 1 >= 64 * stor2.length - 1:
            ...
            mem[(32 * stor2.length - 1) + (32 * idx) + 512] = (32 * mem[(32 * stor2.length - 1) + 352]) + (32 * stor2.length - 1) + 160
            ...
            return memory
              from (32 * stor2.length - 1) + (32 * idx) + 448
               len (32 * mem[(32 * stor2.length - 1) + 352]) + (32 * stor2.length - 1) + 192
        ...
        mem[(32 * _445) + (32 * stor2.length - 1) + (_msize + 416) + 224 len 0] = None
        return 96, 
               (32 * stor2.length - 1) + 128,
               (32 * mem[(32 * stor2.length - 1) + 352]) + (32 * stor2.length - 1) + 160,
               stor2.length - 1,
               mem[_msize + 576 len (32 * _445) + (32 * stor2.length - 1) + 32],
               0,
               None
