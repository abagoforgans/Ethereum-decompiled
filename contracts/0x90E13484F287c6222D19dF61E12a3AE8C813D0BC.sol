...
function sub_5681a433(?) {
    return stor[(7 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_5127c79d', 3)) + 4][0 len stor[(7 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_5127c79d', 3)) + 4].length].field_0
}
...
function sub_927bf691(?) {
    return stor[(7 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_5127c79d', 3)) + 3][0 len stor[(7 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_5127c79d', 3)) + 3].length].field_0
}
...
function sub_e5a73e27(?) {
    return stor[(7 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_5127c79d', 3)) + 5][0 len stor[(7 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_5127c79d', 3)) + 5].length].field_0
}

function sub_e9d77598(?) {
    return stor[(7 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_5127c79d', 3)) + 2][0 len stor[(7 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_5127c79d', 3)) + 2].length].field_0
}
...
function sub_afce5059(?) {
    if arg1 <= block.timestamp:
        emit Response(Array(len=43, data='The start date for this journey ', 'is invalid.'), msg.sender);
    else:
        if not arg3:
            emit Response(Array(len=22, data='Insurance amount is 0.'), msg.sender);
        else:
            if arg2 < arg1:
                emit Response(Array(len=55, data='The end date for this journey is', ' before the start date.'), msg.sender);
            else:
                if arg6 > 4:
                    emit Response(Array(len=26, data='Insurance Type is invalid.'), msg.sender);
                else:
                    if arg5 > 3:
                        emit Response(Array(len=23, data='Travel Type is invalid.'), msg.sender);
                    else:
                        if arg10 > 120:
                            emit Response(Array(len=29, data='Traveller parameters invalid.'), msg.sender);
                        else:
                            if arg9 > 4:
                                emit Response(Array(len=29, data='Traveller parameters invalid.'), msg.sender);
                            else:
                                if arg11 > 2:
                                    emit Response(Array(len=25, data='Invalid auction duration.'), msg.sender);
                                else:
                                    if arg7 > 4:
                                        emit Response(Array(len=28, data='Invalid destination country.'), msg.sender);
                                    else:
                                        emit Response(Array(len=7, data='Success'), msg.sender);
                                        numberOfRequests++
                                        sub_07673ffc[stor0].field_0 = block.timestamp
                                        sub_07673ffc[stor0].field_256 = uint8(arg11)
