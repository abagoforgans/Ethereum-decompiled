...
function getColorFromId(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require arg1 < colorFromId.length
    return colorFromId[arg1].field_0, colorFromId[arg1].field_0, colorFromId[arg1].field_16
}
...
function mint() payable {
    colorFromId.length++
    colorFromId[colorFromId.length].field_0 = uint8(block.timestamp)
    colorFromId[colorFromId.length].field_8 = uint8(block.timestamp - 1000)
    colorFromId[colorFromId.length].field_16 = uint8(block.timestamp - 5500)
    require msg.sender
    require not ownerOf[stor13.length]
    ownerOf[stor13.length] = msg.sender
    balanceOf[address(msg.sender)]++
    emit Transfer(0, msg.sender, colorFromId.length);
    stor6[stor13.length] = tokenOfOwnerByIndex[address(msg.sender)]
    tokenOfOwnerByIndex[address(msg.sender)]++
    tokenOfOwnerByIndex[address(msg.sender)][tokenOfOwnerByIndex[address(msg.sender)]] = colorFromId.length
    stor8[stor13.length] = tokenByIndex.length
    tokenByIndex.length++
    tokenByIndex[tokenByIndex.length] = colorFromId.length
}
