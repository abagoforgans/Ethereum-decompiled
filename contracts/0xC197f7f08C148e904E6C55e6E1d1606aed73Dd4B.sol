...
function _fallback() payable {
    ...
    require 1514230560 >= block.timestamp
    stor0 = 0
    stor1 = 1514230560
    stor2 = 1514234160
    stor4 = 100000
    ...
    create contract with 0 wei
                    code: code.data[2999 len 1548], stor3
    require create.new_address
    stor8 = address(create.new_address)
    stor7 = 10^15
    stor9 = 10^16
    stor0 = code.data[4559 len 20]
    return code.data[467 len 2532]
}
...
function buyTokens(address arg1) payable {
    ...
    if not msg.value:
        ...
        call tokenAddress.0x40c10f19 with:
             gas gas_remaining - 710 wei
            args address(arg1), 100000 * msg.value
        require ext_call.success
        emit TokenPurchase(msg.value, 100000 * msg.value, msg.sender, arg1);
    require ext_code.size(vaultAddress)
...
function _fallback() payable {
    ...
    if not msg.value:
        ...
        call tokenAddress.0x40c10f19 with:
             gas gas_remaining - 710 wei
            args msg.sender, 100000 * msg.value
        require ext_call.success
        emit TokenPurchase(msg.value, 100000 * msg.value, msg.sender, msg.sender);
    require ext_code.size(vaultAddress)
    call vaultAddress.deposit(address rg1) with:
       value msg.value wei
         gas gas_remaining - 9710 wei
