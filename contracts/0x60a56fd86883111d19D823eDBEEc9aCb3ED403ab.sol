...
function sub_dc08ea20(?) {
    mem[192 len 0] = None
    if sub_f51efd7a[msg.sender] < sub_585c5b83[Mask(72, 0, mem[192 len 9], 0)]:
        revert with 0, 'permission deny'
