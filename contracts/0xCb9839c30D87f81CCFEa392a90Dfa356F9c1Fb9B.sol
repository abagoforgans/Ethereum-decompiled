...
function sub_a8f60688(?) {
    ...
    mem[316 len 32 * uint256(stor[sha3(sha3(sha3('delegatesEnhancedMappingSlot')))].field_0)] = code.data[7196 len 32 * uint256(stor[sha3(sha3(sha3('delegatesEnhancedMappingSlot')))].field_0)]
    idx = 0
    while idx < uint256(stor[sha3(sha3(sha3('delegatesEnhancedMappingSlot')))].field_0):
        _59 = mem[64]
        mem[mem[64] + 32] = 'delegatesEnhancedMappingSlot'
...
function _fallback() payable {
    ...
    mem[_241 + 209] = 8
    mem[_241 + 241 len 8] = code.data[7196 len 8]
    mem[64] = _241 + 337
    mem[_241 + 273] = 16
