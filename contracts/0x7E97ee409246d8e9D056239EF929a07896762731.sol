                        ...
                        if sub_3cd6d89a[_354]:
                            ...
                            if idx < ('cd', 4).length:
                                ...
                                while s >= 32:
                                    ...
                                    s = s - 32
                                    continue 
                                mem[_543 + floor32(mem[_543]) + 64] = !(256^(-(mem[_543] % 32) + 32) - 1) and mem[_543 + floor32(mem[_543]) + 32] or 256^(-(mem[_543] % 32) + 32) - 1 and mem[_543 + floor32(mem[_543]) + 64]
                                mem[_543 + mem[_543] + 64] = Mask(8, 248, cd[(idx + cd[4] + 36)])
                                mem[_543 + 32] = mem[_543] + 1
                                mem[64] = _543 + mem[_543] + 65
                                if 0 >= ('cd', 36).length - 1:
                                    idx = idx + 1
                                    s = _543 + 32
                                    continue 
                            ...
                            if not sub_86dbef02:
                                ...
                                if idx < ('cd', 4).length:
                                    ...
                                    while s >= 32:
                                        ...
                                        s = s - 32
                                        continue 
                                    mem[mem[64] + floor32(mem[_544]) + 32] = !(256^(-(mem[_544] % 32) + 32) - 1) and mem[_544 + floor32(mem[_544]) + 32] or 256^(-(mem[_544] % 32) + 32) - 1 and mem[mem[64] + floor32(mem[_544]) + 32]
                                    mem[_544 + _578 + 64] = Mask(8, 248, cd[(idx + cd[4] + 36)])
                                    _697 = mem[64]
                                    mem[mem[64]] = _544 + _578 + -mem[64] + 33
                                    mem[64] = _544 + _578 + 65
                                    if 0 >= ('cd', 36).length - 1:
                                        idx = idx + 1
                                        s = _697
                                ...
                                if stor11[stor8[_354]][address(msg.sender)]:
                                    ...
                                    if idx < ('cd', 4).length:
                                        ...
                                        while s >= 32:
                                            ...
                                            s = s - 32
                                            continue 
                                        mem[_496 + floor32(mem[_496]) + 64] = !(256^(-(mem[_496] % 32) + 32) - 1) and mem[_496 + floor32(mem[_496]) + 32] or 256^(-(mem[_496] % 32) + 32) - 1 and mem[_496 + floor32(mem[_496]) + 64]
                                        mem[_496 + mem[_496] + 64] = Mask(8, 248, cd[(idx + cd[4] + 36)])
                                        mem[_496 + 32] = mem[_496] + 1
                                        mem[64] = _496 + mem[_496] + 65
                                        if 0 >= ('cd', 36).length - 1:
                                            idx = idx + 1
                                            s = _496 + 32
                                            continue 
                                        ...
                                        if not sub_86dbef02:
                                            ...
                                            if idx < ('cd', 4).length:
                                                ...
                                                while s >= 32:
                                                    ...
                                                    s = s - 32
                                                    continue 
                                                mem[_521 + floor32(mem[_521]) + 64] = !(256^(-(mem[_521] % 32) + 32) - 1) and mem[_521 + floor32(mem[_521]) + 32] or 256^(-(mem[_521] % 32) + 32) - 1 and mem[_521 + floor32(mem[_521]) + 64]
                                                mem[_521 + mem[_521] + 64] = Mask(8, 248, cd[(idx + cd[4] + 36)])
                                                mem[_521 + 32] = mem[_521] + 1
                                                mem[64] = _521 + mem[_521] + 65
                                                if 0 >= ('cd', 36).length - 1:
                                                    idx = idx + 1
                                                    s = _521 + 32
                                                    continue 
                                            ...
                                            if idx < ('cd', 4).length:
                                                ...
                                                while s >= 32:
                                                    ...
                                                    s = s - 32
                                                    continue 
                                                mem[_640 + floor32(mem[_640]) + 64] = !(256^(-(mem[_640] % 32) + 32) - 1) and mem[_640 + floor32(mem[_640]) + 32] or 256^(-(mem[_640] % 32) + 32) - 1 and mem[_640 + floor32(mem[_640]) + 64]
                                                mem[_640 + mem[_640] + 64] = Mask(8, 248, cd[(idx + cd[4] + 36)])
                                                mem[_640 + 32] = mem[_640] + 1
                                                mem[64] = _640 + mem[_640] + 65
                                                if 0 >= ('cd', 36).length - 1:
                                                    idx = idx + 1
                                                    s = _640 + 32
                                                    continue 
