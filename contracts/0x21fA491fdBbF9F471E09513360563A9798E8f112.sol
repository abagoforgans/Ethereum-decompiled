...
function _fallback() payable {
    ...
    stor9[address(stor2.field_0)] = 7 * 10^15
    stor9[address(this.address)] = 5 * 10^12 * 3600
    stor11 = 0
        ...
        if block.timestamp >= stor5:
                    ...
                    if msg.value / 80 * ext_call.return_data[0] / 100 * 10^6 < 2 * 10^11:
                        if msg.value / 80 * ext_call.return_data[0] / 100 * 10^6 <= 1999900 * 10^6:
                            if msg.value / 80 * ext_call.return_data[0] / 100 * 10^6:
                                ...
                                require 10 * msg.value / 80 * ext_call.return_data[0] / 100 * 10^6 / msg.value / 80 * ext_call.return_data[0] / 100 * 10^6 == 10
                                require ext_code.size(this.address)
                                call this.address.0xa9059cbb with:
                                     gas gas_remaining - 710 wei
                                    args msg.sender, (msg.value / 80 * ext_call.return_data[0] / 100 * 10^6) + (10 * msg.value / 80 * ext_call.return_data[0] / 100 * 10^6 / 100)
                                require ext_call.success
                            else:
                                require ext_code.size(this.address)
                                call this.address.0xa9059cbb with:
            ...
            if msg.value / 80 * ext_call.return_data[0] / 100 * 10^6 < 2 * 10^11:
                if msg.value / 80 * ext_call.return_data[0] / 100 * 10^6 <= 1999900 * 10^6:
                    if msg.value / 80 * ext_call.return_data[0] / 100 * 10^6:
                        require msg.value / 80 * ext_call.return_data[0] / 100 * 10^6
                        require 15 * msg.value / 80 * ext_call.return_data[0] / 100 * 10^6 / msg.value / 80 * ext_call.return_data[0] / 100 * 10^6 == 15
                        require ext_code.size(this.address)
                        call this.address.0xa9059cbb with:
                             gas gas_remaining - 710 wei
                            args msg.sender, (msg.value / 80 * ext_call.return_data[0] / 100 * 10^6) + (15 * msg.value / 80 * ext_call.return_data[0] / 100 * 10^6 / 100)
                        require ext_call.success
                    else:
                        require ext_code.size(this.address)
                        call this.address.0xa9059cbb with:
