        ...
        if not ethBalanceOf[address(msg.sender)]:
            if arg2.length <= 0:
                if not arg2.length:
                    ...
                    require (bonus * arg2.length / 100) + bonusDropsOf[address(msg.sender)] >= bonusDropsOf[address(msg.sender)]
                    bonusDropsOf[address(msg.sender)] += bonus * arg2.length / 100
                if not arg2.length:
                    require 0 <= ethBalanceOf[address(msg.sender)]
                else:
                    require dropUnitPrice * arg2.length / arg2.length == dropUnitPrice
                    require dropUnitPrice * arg2.length <= ethBalanceOf[address(msg.sender)]
                    ethBalanceOf[address(msg.sender)] += -1 * dropUnitPrice * arg2.length
                if not arg2.length:
                    call owner with:
                         gas 2300 wei
                else:
                ...
                if not ethBalanceOf[address(msg.sender)]:
                    ...
                    if ethBalanceOf[address(msg.sender)] > 0:
                        if not ethBalanceOf[address(msg.sender)]:
                            ...
                            if not rate * ethBalanceOf[address(msg.sender)] / 10^18:
                                ...
                                require (bonus * rate * ethBalanceOf[address(msg.sender)] / 10^18 / 100) + bonusDropsOf[address(msg.sender)] >= bonusDropsOf[address(msg.sender)]
                                bonusDropsOf[address(msg.sender)] += bonus * rate * ethBalanceOf[address(msg.sender)] / 10^18 / 100
                        call owner with:
                    ...
                    if ethBalanceOf[address(msg.sender)] > 0:
                        ...
                        require ext_call.success
                        ethBalanceOf[address(msg.sender)] = 0
                    require arg2.length - (rate * ethBalanceOf[address(msg.sender)] / 10^18) <= bonusDropsOf[address(msg.sender)]
                    bonusDropsOf[address(msg.sender)] = bonusDropsOf[address(msg.sender)] - arg2.length + (rate * ethBalanceOf[address(msg.sender)] / 10^18)
        else:
            require rate * ethBalanceOf[address(msg.sender)] / ethBalanceOf[address(msg.sender)] == rate
