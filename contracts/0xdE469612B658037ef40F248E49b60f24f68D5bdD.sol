...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 24691358 * 10^6 * 3600
    stor2 = 24691358 * 10^6 * 3600
    bool(stor3.length) = 0
    stor3.length.field_1 = 5
    stor3.length.field_8 = 'Ardex' / 256
    idx = 0
