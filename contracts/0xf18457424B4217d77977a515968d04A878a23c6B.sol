...
function _fallback() payable {
    uint8(stor0.field_160) = 3
    require not msg.value
    address(stor0.field_0) = msg.sender
    require msg.sender
    require code.data[1864 len 20]
    uint256(stor1.field_0) = 21 * 10^9 * 10^uint8(stor0.field_160)
    stor3 = 21 * 10^9 * 10^uint8(stor0.field_160) / 10
    stor2 = uint255(stor1.field_1)
    stor4[code.data[1864 len 20]] = uint255(stor1.field_1)
    return code.data[254 len 1598]
}
