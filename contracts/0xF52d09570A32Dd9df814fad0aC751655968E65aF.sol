...
function Set_your_game_number(uint16 arg1) payable {
    ...
    if 8 * msg.value > eth.balance(this.address):
        ...
        while 169 > idx:
            ...
            idx = idx + 32
            continue 
        idx = code.data[2563 len 32] + 2
        while code.data[2563 len 32] + (stor9.length + 31 / 32) > idx:
            stor[idx] = 0
            idx = idx + 1
            continue 
