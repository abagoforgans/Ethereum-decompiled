...
function multisend(address arg1, address[] arg2, uint256[] arg3) {
    ...
    require 0x4bbe6342043b790b6515976da292407440f234eb == msg.sender
    require arg2.length == arg3.length
    require 150 >= arg2.length
    idx = 0
    while uint8(idx) < arg2.length:
        require uint8(idx) < arg2.length
        require uint8(idx) < arg3.length
        _23 = mem[(32 * uint8(idx)) + (32 * arg2.length) + 160]
        mem[(32 * arg3.length) + (32 * arg2.length) + 164] = mem[(32 * uint8(idx)) + 140 len 20]
        mem[(32 * arg3.length) + (32 * arg2.length) + 196] = _23
        require ext_code.size(arg1)
        call arg1.0xa9059cbb with:
             gas gas_remaining wei
            args mem[(32 * arg3.length) + (32 * arg2.length) + 164], _23
