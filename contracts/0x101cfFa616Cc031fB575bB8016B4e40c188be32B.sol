...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor1 = 10^18 * code.data[4492 len 32]
    stor7[address(msg.sender)] = 10^18 * code.data[4492 len 32]
    return code.data[116 len 4376]
}
...
function _fallback() payable {
    require (buyPrice * msg.value) + stor7[address(msg.sender)] >= stor7[address(msg.sender)]
    stor7[address(msg.sender)] += buyPrice * msg.value
    ...
    if not stor6[address(msg.sender)]:
        if currentTotalSupply < totalSupply:
            if currentTotalSupply < airdrop:
                require startBalance + stor7[address(msg.sender)] >= stor7[address(msg.sender)]
