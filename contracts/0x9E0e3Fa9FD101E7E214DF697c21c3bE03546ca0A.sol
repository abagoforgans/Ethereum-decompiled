...
const name = 'BitferryToken'

const decimals = 0

const symbol = 'BTF'

const weiPerToken = 1333333333333333
...
function _fallback() payable {
    require msg.sender
    require msg.value / 1333333333333333 > 0
    ...
    require (msg.value / 1333333333333333) + totalSupply >= totalSupply
    totalSupply += msg.value / 1333333333333333
    require (msg.value / 1333333333333333) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
    balanceOf[address(msg.sender)] += msg.value / 1333333333333333
    emit Transfer((msg.value / 1333333333333333), 0, msg.sender);
}
