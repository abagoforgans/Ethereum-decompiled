...
function _fallback() {
    ...
    stor5 = 8
    stor8 = 21 * 10^18
    stor0[address(msg.sender)] = 525 * 10^13 * 24 * 3600
    require stor0[address(msg.sender)] >= 525 * 10^13 * 24 * 3600
    stor0[address(msg.sender)] -= 525 * 10^13 * 24 * 3600
    stor0[stor1] += 525 * 10^13 * 24 * 3600
    emit Transfer((525 * 10^13 * 24 * 3600), msg.sender, stor1);
    stor6 = stor8 / 10
    return code.data[681 len 1924]
}
