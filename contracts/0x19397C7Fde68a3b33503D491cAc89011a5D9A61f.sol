...
function _fallback() payable {
    ...
    stor1 = code.data[9960 len 32]
    stor2 = code.data[9992 len 32]
    stor3 = code.data[10024 len 32]
    emit ChangeOfRules(stor1, stor2, stor3);
    if stor6[0]:
        require stor6[0] < stor7.length
        address(stor7[stor6[0]].field_0) = 0
        stor7[stor6[0]].field_256 % 1 = 0
        bool(stor7[stor6[0]].field_256) = 0
        uint255(stor7[stor6[0]].field_257) = 0
        Mask(248, 0, stor7[stor6[0]].field_264) = 0
        idx = 0
        while stor[(3 * stor6[0]) + ('name', 'stor7', 7) + 1].length + 31 / 32 > idx:
            uint256(stor[idx + sha3((3 * stor6[0]) + ('name', 'stor7', 7) + 1)].field_0) = 0
            idx = idx + 1
            continue 
        uint256(stor7[stor6[0]].field_512) = block.timestamp
    else:
    ...
    if stor6[stor0]:
        ...
        address(stor7[stor6[stor0]].field_0) = stor0
        bool(stor7[stor6[stor0]].field_256) = 0
        uint255(stor7[stor6[stor0]].field_257) = 7
        Mask(248, 0, stor7[stor6[stor0]].field_264) = 'founder' / 256
        idx = 0
        while stor[(3 * stor6[stor0]) + ('name', 'stor7', 7) + 1].length + 31 / 32 > idx:
            uint256(stor[idx + sha3((3 * stor6[stor0]) + ('name', 'stor7', 7) + 1)].field_0) = 0
            idx = idx + 1
            continue 
        uint256(stor7[stor6[stor0]].field_512) = block.timestamp
    else:
    ...
    return code.data[1518 len 8442]
}
...
function changeVotingRules(uint256 arg1, uint256 arg2, int256 arg3) {
    ...
    majorityMargin = arg3
    emit ChangeOfRules(stor1.length, debatingPeriodInMinutes, majorityMargin);
}
