...
function _fallback() payable {
    ...
    stor5 = msg.sender
    stor0 = code.data[6210 len 32]
    stor1 = code.data[6242 len 32]
    stor2 = code.data[6274 len 32]
    stor3 = code.data[6306 len 32]
    stor4 = code.data[6338 len 32]
    stor8.length++
...
function sub_02f9f208(?) {
    ...
    while idx < arg1.length:
        ...
        if not investors.length > investors.length + 1:
            ...
            mem[64] = mem[64] + 192
            require idx < mem[96]
            mem[_67] = mem[(32 * idx) + 128]
            require idx < mem[(32 * arg1.length) + 128]
            mem[_67 + 32] = mem[(32 * idx) + (32 * arg1.length) + 160]
            mem[_67 + 64] = 0
            require idx < mem[(32 * arg1.length) + (32 * arg2.length) + 160]
            mem[_67 + 96] = mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + 192]
            mem[_67 + 128] = 0
            mem[_67 + 160] = 0
            require investors.length < investors.length
            mem[0] = 8
            investors[investors.length].field_0 = mem[_67]
            address(investors[investors.length].field_256) = mem[_67 + 44 len 20]
            uint8(investors[investors.length].field_416) = 0
            investors[investors.length].field_512 % 1 = 0
            investors[investors.length].field_512 = mem[_67 + 96]
        else:
            mem[0] = 8
            ...
            mem[64] = mem[64] + 192
            require idx < mem[96]
            mem[_116] = mem[(32 * idx) + 128]
            require idx < mem[(32 * arg1.length) + 128]
            mem[_116 + 32] = mem[(32 * idx) + (32 * arg1.length) + 160]
            mem[_116 + 64] = 0
            require idx < mem[(32 * arg1.length) + (32 * arg2.length) + 160]
            mem[_116 + 96] = mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + 192]
            mem[_116 + 128] = 0
            mem[_116 + 160] = 0
            require investors.length < investors.length
            mem[0] = 8
            investors[investors.length].field_0 = mem[_116]
            address(investors[investors.length].field_256) = mem[_116 + 44 len 20]
            uint8(investors[investors.length].field_416) = 0
            investors[investors.length].field_512 % 1 = 0
            investors[investors.length].field_512 = mem[_116 + 96]
