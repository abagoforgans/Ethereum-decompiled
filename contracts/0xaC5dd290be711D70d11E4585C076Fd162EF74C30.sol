...
function sub_6ce44bf5(?) payable {
    require calldata.size - 4 >= 64
    return sha3(0x1a50696c6c7362757279205369676e6564204d657373, arg1, arg2)
}
...
function sub_c063621b(?) payable {
    ...
    signer = erecover(sha3(0x1a50696c6c7362757279205369676e6564204d657373, arg4, arg6), arg1 << 248, arg2, arg3) 
...
function sub_2c7e23d4(?) payable {
    ...
    require not stor9[address(arg4)]
    stor9[address(arg4)] = 1
    signer = erecover(sha3(0x1a50696c6c7362757279205369676e6564204d657373, arg4, arg5), arg1 << 248, arg2, arg3) 
    if not erecover.result:
        revert with ext_call.return_data[0 len return_data.size]
    require address(signer)
    require stor6[address(signer)]
