...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'We Want Freedom Token' / 256
    idx = 0
    ...
    mem[224 len -2614] = code.data[3150 len -2614]
    stor3 = mem[224] * 10^stor2
    stor5[address(msg.sender)] = mem[224] * 10^stor2
...
function sub_3ceb4bd0(?) {
    require owner == msg.sender
    require arg2 >= 1
    require balanceOf[stor4] >= arg2 + 420
    require arg1
    ...
    require balanceOf[address(arg1)] + balanceOf[stor4] == balanceOf[stor4] + balanceOf[address(arg1)]
    return 1
}
