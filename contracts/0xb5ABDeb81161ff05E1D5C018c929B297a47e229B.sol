...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0x6a7aef1e65ffd83888e820a3c3a668108a16a652)
    delegate 0x6a7aef1e65ffd83888e820a3c3a668108a16a652.0x66098d4f with:
         gas gas_remaining - 710 wei
...
function getKYCPayload(bytes arg1) {
    ...
    require ext_code.size(0xa1120a3fc0ef5afba4850d2f487943e7e6c03330)
    delegate 0xa1120a3fc0ef5afba4850d2f487943e7e6c03330.0xb655e138 with:
         gas gas_remaining - 710 wei
    ...
    require delegate.return_code
    require ext_code.size(0xa1120a3fc0ef5afba4850d2f487943e7e6c03330)
    delegate 0xa1120a3fc0ef5afba4850d2f487943e7e6c03330.0x16419aa7 with:
         gas gas_remaining - 710 wei
        args Array(len=arg1.length, data=arg1[all]), 20
    require delegate.return_code
    require ext_code.size(0xa1120a3fc0ef5afba4850d2f487943e7e6c03330)
    delegate 0xa1120a3fc0ef5afba4850d2f487943e7e6c03330.0xd54dd8f9 with:
         gas gas_remaining - 710 wei
