...
function _fallback() {
    mem[96 len -5172] = code.data[5993 len -5172]
    mem[64] = -5076
    stor0 = msg.sender
    ...
    if stor4[0]:
        ...
        stor5[stor4[0]].field_0 = 0
        stor5[stor4[0]].field_256 = 0
        stor5[stor4[0]].field_256 = 0
        stor5[stor4[0]].field_512 = block.timestamp
        stor5[stor4[0]].field_768 = 0
    else:
        stor4[0] = stor5.length
        stor5.length++
        if not stor5.length <= stor5.length + 1:
            idx = 4 * stor5.length + 1
        ...
        stor5[stor5.length].field_256 = 0
        stor5[stor5.length].field_512 = block.timestamp
        stor5[stor5.length].field_768 = 0
    emit MembershipChanged(0, 1);
    require stor0 == msg.sender
    if stor4[stor0]:
        require stor4[stor0] < stor5.length
        stor5[stor4[stor0]].field_0 = stor0
        stor5[stor4[stor0]].field_256 = 'founder'
        stor5[stor4[stor0]].field_512 = block.timestamp
        stor5[stor4[stor0]].field_768 = 'founder'
    else:
        stor4[stor0] = stor5.length
        stor5.length++
        if not stor5.length <= stor5.length + 1:
            idx = 4 * stor5.length + 1
            while 4 * stor5.length > idx:
                ...
                continue 
        require stor5.length < stor5.length
        stor5[stor5.length].field_0 = stor0
        stor5[stor5.length].field_256 = 'founder'
        stor5[stor5.length].field_512 = block.timestamp
        stor5[stor5.length].field_768 = 'founder'
    emit MembershipChanged(stor0, 1);
    return code.data[821 len 5172]
}
...
function cancel(bytes32 arg1) {
    require address(amount[arg1].field_1280) == msg.sender
...
function sub_684bfaac(?) {
    ...
    while idx < arg1.length:
        ...
        require address(amount[mem[(32 * idx) + 128]].field_1280) == msg.sender
...
function sub_d594c465(?) {
    require member[address(msg.sender)]
    ...
    uint8(amount[arg1].field_1032) = uint8(arg7)
    address(amount[arg1].field_1040) = arg5
    uint8(amount[arg1].field_1200) = 1
    Mask(72, 0, amount[arg1].field_1208) = Mask(72, 176, arg7) >> 176
    Mask(72, 0, amount[arg1].field_1208) = Mask(72, 184, arg6) >> 184
    address(amount[arg1].field_1280) = msg.sender
    sub_9777f31e.length++
    if not sub_9777f31e.length <= sub_9777f31e.length + 1:
        idx = sub_9777f31e.length + 1
        while sub_9777f31e.length > idx:
            sub_9777f31e[idx] = 0
            idx = idx + 1
            continue 
...
function sub_5b453140(?) {
    ...
    if member[address(arg1)]:
        ...
        memberAt.length++
        if not memberAt.length <= memberAt.length + 1:
...
function sub_055b100b(?) {
    ...
    mem[64] = (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + (32 * arg7.length) + 320
    ...
    while idx < arg1.length:
        ...
        require idx < mem[(32 * arg1.length) + (32 * arg2.length) + 160]
        _42 = mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + 192]
        require idx < mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 192]
        _44 = mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 224]
        require idx < mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + 224]
        _46 = mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + 256]
        require idx < mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + (32 * arg5.length) + 256]
        require idx < mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 288]
        require member[address(msg.sender)]
        mem[32] = 2
        address(amount[mem[(32 * idx) + 128]].field_0) = mem[(32 * idx) + (32 * arg1.length) + 172 len 20]
        uint256(amount[mem[(32 * idx) + 128]].field_256) = mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + 192]
        uint256(amount[mem[(32 * idx) + 128]].field_512) = mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 224]
        uint256(amount[mem[(32 * idx) + 128]].field_768) = block.timestamp
        uint8(amount[mem[(32 * idx) + 128]].field_1024) = uint8(bool(mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + (32 * arg5.length) + 288]))
        uint8(amount[mem[(32 * idx) + 128]].field_1032) = uint8(bool(mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 320]))
        address(amount[mem[(32 * idx) + 128]].field_1040) = mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + 268 len 20]
        uint8(amount[mem[(32 * idx) + 128]].field_1200) = 1
        Mask(72, 0, amount[mem[(32 * idx) + 128]].field_1208) = Mask(72, 176, bool(mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 320])) >> 176
        Mask(72, 0, amount[mem[(32 * idx) + 128]].field_1208) = Mask(72, 184, bool(mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + (32 * arg5.length) + 288])) >> 184
        address(amount[mem[(32 * idx) + 128]].field_1280) = msg.sender
        sub_9777f31e.length++
        if not sub_9777f31e.length <= sub_9777f31e.length + 1:
            s = sub_9777f31e.length + sha3(3) + 1
            while sha3(3) + sub_9777f31e.length > s:
                uint256(stor[s]) = 0
                s = s + 1
                continue 
        mem[0] = 3
        ...
        mem[mem[64] + 32] = address(_40)
        mem[mem[64] + 64] = _42
        mem[mem[64] + 96] = _44
        mem[mem[64] + 128] = address(_46)
        emit 0xf451ca8c: mem[mem[64]], address(_40), _42, _44, address(_46)
        idx = idx + 1
        continue 
    return idx
}
