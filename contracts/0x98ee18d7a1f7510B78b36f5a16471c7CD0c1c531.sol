...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0x5c01578c6c916ab2da8c3249f6e140b66397c8f6)
    delegate 0x5c01578c6c916ab2da8c3249f6e140b66397c8f6.0x66098d4f with:
         gas gas_remaining - 50 wei
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0x5c01578c6c916ab2da8c3249f6e140b66397c8f6):
                            delegate 0x5c01578c6c916ab2da8c3249f6e140b66397c8f6.0x66098d4f with:
                                 gas gas_remaining - 50 wei
