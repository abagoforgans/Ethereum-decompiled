...
function fillOrderNoThrow(address arg1, address arg2, address arg3, address arg4, uint256 arg5, uint256 arg6, uint256 arg7, uint256 arg8, uint256 arg9, uint256 arg10, bytes arg11, bytes arg12, uint256 arg13, bytes arg14) {
    ...
    if not delegate.return_code:
        ...
        mem[(2 * ceil32(cd[(arg1 + cd[(arg1 + 324)] + 4)])) + ceil32(cd[(arg1 + cd[(arg1 + 356)] + 4)]) + ceil32(arg3.length) + ceil32(_45) + ceil32(Mask(8 * -ceil32(cd[(arg1 + cd[(arg1 + 356)] + 4)]) + cd[(arg1 + cd[(arg1 + 356)] + 4)] + 32, 0, 0), mem[ceil32(cd[(arg1 + cd[(arg1 + 324)] + 4)]) + cd[(arg1 + cd[(arg1 + 356)] + 4)] + 576 len -cd[(arg1 + cd[(arg1 + 356)] + 4)] + ceil32(cd[(arg1 + cd[(arg1 + 356)] + 4)])]) + 1348] = 0
        mem[(2 * ceil32(cd[(arg1 + cd[(arg1 + 324)] + 4)])) + ceil32(cd[(arg1 + cd[(arg1 + 356)] + 4)]) + ceil32(arg3.length) + ceil32(_45) + ceil32(Mask(8 * -ceil32(cd[(arg1 + cd[(arg1 + 356)] + 4)]) + cd[(arg1 + cd[(arg1 + 356)] + 4)] + 32, 0, 0), mem[ceil32(cd[(arg1 + cd[(arg1 + 324)] + 4)]) + cd[(arg1 + cd[(arg1 + 356)] + 4)] + 576 len -cd[(arg1 + cd[(arg1 + 356)] + 4)] + ceil32(cd[(arg1 + cd[(arg1 + 356)] + 4)])]) + 1380] = 0
        mem[_93 + 96] = 0
        return memory
    ...
    mem[(2 * ceil32(cd[(arg1 + cd[(arg1 + 324)] + 4)])) + ceil32(cd[(arg1 + cd[(arg1 + 356)] + 4)]) + ceil32(arg3.length) + ceil32(_45) + ceil32(Mask(8 * -ceil32(cd[(arg1 + cd[(arg1 + 356)] + 4)]) + cd[(arg1 + cd[(arg1 + 356)] + 4)] + 32, 0, 0), mem[ceil32(cd[(arg1 + cd[(arg1 + 324)] + 4)]) + cd[(arg1 + cd[(arg1 + 356)] + 4)] + 576 len -cd[(arg1 + cd[(arg1 + 356)] + 4)] + ceil32(cd[(arg1 + cd[(arg1 + 356)] + 4)])]) + 1348] = delegate.return_data[32]
    mem[(2 * ceil32(cd[(arg1 + cd[(arg1 + 324)] + 4)])) + ceil32(cd[(arg1 + cd[(arg1 + 356)] + 4)]) + ceil32(arg3.length) + ceil32(_45) + ceil32(Mask(8 * -ceil32(cd[(arg1 + cd[(arg1 + 356)] + 4)]) + cd[(arg1 + cd[(arg1 + 356)] + 4)] + 32, 0, 0), mem[ceil32(cd[(arg1 + cd[(arg1 + 324)] + 4)]) + cd[(arg1 + cd[(arg1 + 356)] + 4)] + 576 len -cd[(arg1 + cd[(arg1 + 356)] + 4)] + ceil32(cd[(arg1 + cd[(arg1 + 356)] + 4)])]) + 1380] = delegate.return_data[64]
