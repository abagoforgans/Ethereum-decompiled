...
function _fallback() {
    stor0 = code.data[4982 len 20]
    stor1 = code.data[5014 len 20]
    stor2 = code.data[5046 len 20]
    return code.data[127 len 4843]
}
