...
function _fallback() payable {
    ...
    while stor6.length + 31 / 32 > idx:
        ...
        idx = idx + 1
        continue 
    stor1 = code.data[8520 len 32]
    stor2[address(msg.sender)] = code.data[8520 len 32]
    return code.data[709 len 7811]
}
...
function _fallback() payable {
    if not msg.value:
        ...
        emit Transfer(stor14, owner, msg.sender);
        ...
        if msg.value < 5 * 10^16:
            ...
            emit Transfer((1000 * msg.value), owner, msg.sender);
        else:
            ...
            emit Transfer(((1000 * msg.value) + (stor8[address(msg.sender)] * stor10)), owner, msg.sender);
}
