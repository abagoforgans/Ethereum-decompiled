...
const baseTokenURI = Array(len=34, data='https://coindesk2018.alto.gg/car', 'd/', Mask(16, -256, 'https://coindesk2018.alto.gg/car', 'd/') << 256)
...
function tokenURI(uint256 arg1) {
    mem[96] = 34
    mem[128] = 'https://coindesk2018.alto.gg/car'
    mem[160] = 'd/'
    if not arg1:
        mem[192] = 1
        mem[224] = '0'
        ...
        mem[320] = 0
        mem[352] = 35
        mem[384 len 1120] = code.data[10307 len 1120]
        idx = 0
        s = 0
        while idx < 34:
            require idx < 34
        ...
        while idx < 0:
            ...
            s = s + 1
            continue 
        return Array(len=35, data=mem[384], mem[445 len 3])
    s = 0
    idx = arg1
    while idx:
        s = s + 1
    ...
    if not s:
        ...
        mem[_280 + 32 len 32 * _279 + _278] = code.data[10307 len 32 * _279 + _278]
        _424 = mem[96]
        idx = 0
        s = 0
        while idx < _424:
    ...
    mem[224 len 32 * s] = code.data[10307 len 32 * s]
    t = s - 1
    idx = arg1
    while idx:
        require t < mem[192]
    ...
    mem[_286 + 32 len 32 * _285 + _284] = code.data[10307 len 32 * _285 + _284]
    _426 = mem[96]
    idx = 0
    s = 0
    while idx < _426:
