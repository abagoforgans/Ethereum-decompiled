...
function sub_cc07c0b9(?) {
    return bool(sub_cc07c0b9)
}
...
function sub_58440807(?) {
    require calldata.size - 4 >= 32
    if not stor5[msg.sender]:
        if msg.sender != this.address:
            revert with 0, 32, 21, 0xfe4f6e6c79206d616e616765727320616c6c6f77656400000000000000000000
    sub_cc07c0b9 = uint8(arg1)
}

function sub_345ae8af(?) {
    require calldata.size - 4 >= 64
    if not stor5[msg.sender]:
        if msg.sender != this.address:
            revert with 0, 32, 21, 0xfe4f6e6c79206d616e616765727320616c6c6f77656400000000000000000000
    sub_bacda826[arg1 << 240] = arg2
}
...
function setBoxContract(address arg1) {
    require calldata.size - 4 >= 32
    if not stor5[msg.sender]:
        if msg.sender != this.address:
            revert with 0, 32, 21, 0xfe4f6e6c79206d616e616765727320616c6c6f77656400000000000000000000
    sub_63f0385cAddress = arg1
}
...
function sub_89429c2a(?) {
    ...
    while idx < arg1.length:
        ...
        mem[0] = uint16(idx)
        mem[32] = 16
        sub_bacda826[idx << 240] = mem[(32 * idx) + 128]
        idx = idx + 1
        continue 
}
...
function sub_58fbb277(?) {
    ...
    require arg1.length <= 4294967296 and arg1 + (32 * arg1.length) + 36 <= calldata.size
    mem[128 len 32 * arg1.length] = call.data[arg1 + 36 len 32 * arg1.length]
    mem[(32 * arg1.length) + 128 len 320] = code.data[11743 len 320]
    mem[(32 * arg1.length) + 448 len 320] = code.data[11743 len 320]
    mem[(32 * arg1.length) + 768 len 320] = code.data[11743 len 320]
    idx = 0
    while idx < arg1.length:
        require idx < arg1.length
        require stor12
    ...
    if stor13 + (stor11 * block.timestamp - stor10 / 24 * 3600) >= stor12:
        if not arg3:
            ...
            if not arg3:
                ...
                call arg3.0x23b872dd with:
                     gas gas_remaining wei
                    args this.address, beneficiaryAddress, 0
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
    else:
