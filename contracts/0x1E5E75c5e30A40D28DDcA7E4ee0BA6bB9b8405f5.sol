...
const MAX_NUM_OZT_TOKENS = 730000000 * 10^18
...
function batchAssignTokens(address[] arg1, uint256[] arg2, uint256[] arg3) {
    ...
    while idx < arg1.length:
        ...
        if not mem[(32 * arg1.length) + (32 * idx) + 160]:
            ...
            require 10^18 * mem[(32 * arg1.length) + (32 * idx) + 160] <= balanceOf[address(msg.sender)]
            balanceOf[address(msg.sender)] += -1 * 10^18 * mem[(32 * arg1.length) + (32 * idx) + 160]
        ...
        while idx < arg2:
            ...
            if 1 == (block.timestamp - (424046 * 3600) / 60 / 12 * 3600) - 3:
                ...
                if (10 * sub_81325e54[stor4[idx]] + sub_22a02661[stor4[idx]] / 20) - sub_81325e54[stor4[idx]] > 0:
                    if 10 * sub_81325e54[stor4[idx]] + sub_22a02661[stor4[idx]] / 20 > 0:
                        ...
                        require (10 * sub_81325e54[stor4[idx]] + sub_22a02661[stor4[idx]] / 20) - sub_81325e54[stor4[idx]] <= balanceOf[address(msg.sender)]
                        balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] - (10 * sub_81325e54[stor4[idx]] + sub_22a02661[stor4[idx]] / 20) + sub_81325e54[stor4[idx]]
            ...
            if (10 * sub_81325e54[stor4[idx]] + sub_22a02661[stor4[idx]] / 20) + ((-4 * sub_81325e54[stor4[idx]]) + (block.timestamp - (424046 * 3600) / 60 / 12 * 3600 * sub_81325e54[stor4[idx]]) - (4 * sub_22a02661[stor4[idx]]) + (block.timestamp - (424046 * 3600) / 60 / 12 * 3600 * sub_22a02661[stor4[idx]]) / 20) - sub_81325e54[stor4[idx]] > 0:
                if (10 * sub_81325e54[stor4[idx]] + sub_22a02661[stor4[idx]] / 20) + ((-4 * sub_81325e54[stor4[idx]]) + (block.timestamp - (424046 * 3600) / 60 / 12 * 3600 * sub_81325e54[stor4[idx]]) - (4 * sub_22a02661[stor4[idx]]) + (block.timestamp - (424046 * 3600) / 60 / 12 * 3600 * sub_22a02661[stor4[idx]]) / 20) > 0:
                    ...
                    require sub_3f7b7380[idx]
                    require (10 * sub_81325e54[stor4[idx]] + sub_22a02661[stor4[idx]] / 20) + ((-4 * sub_81325e54[stor4[idx]]) + (block.timestamp - (424046 * 3600) / 60 / 12 * 3600 * sub_81325e54[stor4[idx]]) - (4 * sub_22a02661[stor4[idx]]) + (block.timestamp - (424046 * 3600) / 60 / 12 * 3600 * sub_22a02661[stor4[idx]]) / 20) - sub_81325e54[stor4[idx]] <= balanceOf[address(msg.sender)]
                    balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] - (10 * sub_81325e54[stor4[idx]] + sub_22a02661[stor4[idx]] / 20) - ((-4 * sub_81325e54[stor4[idx]]) + (block.timestamp - (424046 * 3600) / 60 / 12 * 3600 * sub_81325e54[stor4[idx]]) - (4 * sub_22a02661[stor4[idx]]) + (block.timestamp - (424046 * 3600) / 60 / 12 * 3600 * sub_22a02661[stor4[idx]]) / 20) + sub_81325e54[stor4[idx]]
