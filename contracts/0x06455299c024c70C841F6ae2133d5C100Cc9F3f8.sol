...
function finalizeCrowdsale() payable {
    ...
    if uint8(var34009) < 0xc331051700000000000000000000000000000000000000000000000000000000:
        ...
        if var52007 > 0:
            ...
            require ext_code.size(0x682b9a1868d548fae710c4e94960dec2e0be6ce7)
            delegate 0x682b9a1868d548fae710c4e94960dec2e0be6ce7.mem[var60002 len 4] with:
                 gas gas_remaining - 710 wei
            ...
            while uint8(idx + 1) < ext_call.return_data[0]:
                ...
                require ext_code.size(0x682b9a1868d548fae710c4e94960dec2e0be6ce7)
                delegate 0x682b9a1868d548fae710c4e94960dec2e0be6ce7.0x66098d4f with:
                     gas gas_remaining - 710 wei
                ...
                if ext_call.success:
                    ...
                    if ext_code.size(tokenAddress):
                        ...
                        if ext_call.success:
                            ...
                            mem[100] = var47007
                            mem[132] = var47001
                            if ext_code.size(0x682b9a1868d548fae710c4e94960dec2e0be6ce7):
                                delegate 0x682b9a1868d548fae710c4e94960dec2e0be6ce7.mem[var49002 len 4] with:
                                     gas gas_remaining - 710 wei
