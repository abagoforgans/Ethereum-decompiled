...
function _fallback() payable {
    ...
    stor0 = msg.sender
    address(stor11.field_8) = address(code.data[11764 len 32])
    bool(stor1.length) = 0
    stor1.length.field_1 = 14
    stor1.length.field_8 = 'FinChain Token' / 256
    idx = 0
    ...
    stor7 = block.number
    return code.data[801 len 10963]
}
