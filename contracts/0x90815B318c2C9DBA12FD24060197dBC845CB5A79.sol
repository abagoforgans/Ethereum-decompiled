...
function _fallback() payable {
    stor0.field_0 % 16777216 = 0
    Mask(232, 0, stor0.field_24) = Mask(232, 0, msg.sender)
    return code.data[43 len 1787]
}
...
function teardown() payable {
    require address(stor0.field_24) == msg.sender
    ...
    selfdestruct(address(stor0.field_24))
}
...
function approveTransfer() payable {
    ...
    call 0xbb9bc244d798123fde783fcc1c72d3bb8c189413.approve(address rg1, uint256 rg2) with:
         gas gas_remaining - 25050 wei
        args 0xbf4ed7b27f1d666546e30d74d50d173d20bca754, ext_call.return_data[0]
    Mask(240, 0, stor0.field_16) = Mask(240, 0, ext_call.return_data[0])
    return bool(ext_call.return_data[31 len 1])
}
