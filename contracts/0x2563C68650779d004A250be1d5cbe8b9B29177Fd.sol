...
function buy() payable {
    require buyPrice
    require msg.sender
    require balanceOf[address(this.address)] >= msg.value * 10^decimals / buyPrice
    ...
    require not stor9[address(msg.sender)]
    balanceOf[address(this.address)] -= msg.value * 10^decimals / buyPrice
    balanceOf[address(msg.sender)] += msg.value * 10^decimals / buyPrice
    emit Transfer((msg.value * 10^decimals / buyPrice), this.address, msg.sender);
}
