...
function artworksFactory(address arg1) {
    return artworksFactory[arg1]
}
...
function isFactoryApproved(address arg1) {
...
function setReferrer(address arg1) {
    if not referred[address(msg.sender)]:
        if not stor7[address(msg.sender)]:
            referred[address(msg.sender)] = arg1
}
...
function callContractFunctionByAddress(address arg1, string arg2, address arg3, address arg4, uint256 arg5, uint256 arg6, bool arg7, string arg8, bytes32 arg9) {
    mem[128 len arg2.length] = arg2[all]
    mem[ceil32(arg2.length) + 128] = arg8.length
    mem[ceil32(arg2.length) + 160 len arg8.length] = arg8[all]
    require owner == msg.sender
    mem[ceil32(arg2.length) + ceil32(arg8.length) + 160 len floor32(arg2.length)] = call.data[arg2 + 36 len floor32(arg2.length)]
    mem[ceil32(arg2.length) + ceil32(arg8.length) + floor32(arg2.length) + -(arg2.length % 32) + 192 len arg2.length % 32] = mem[floor32(arg2.length) + -(arg2.length % 32) + 160 len arg2.length % 32]
    mem[ceil32(arg2.length) + ceil32(arg8.length) + 160] = Mask(32, 224, sha3(call.data[arg2 + 36 len floor32(arg2.length)], mem[ceil32(arg2.length) + ceil32(arg8.length) + floor32(arg2.length) + 160 len arg2.length % 32]))
    mem[ceil32(arg2.length) + ceil32(arg8.length) + 164] = arg3
    mem[ceil32(arg2.length) + ceil32(arg8.length) + 196] = arg4
    mem[ceil32(arg2.length) + ceil32(arg8.length) + 228] = arg5
    mem[ceil32(arg2.length) + ceil32(arg8.length) + 260] = arg6
    mem[ceil32(arg2.length) + ceil32(arg8.length) + 292] = arg7
    if not arg8.length:
        if not arg8.length % 32:
            mem[arg8.length + ceil32(arg2.length) + ceil32(arg8.length) + 324] = arg9
            call arg1.mem[ceil32(arg2.length) + ceil32(arg8.length) + 160 len 4] with:
                 gas gas_remaining - 25710 wei
                args address(arg3), address(arg4), arg5, arg6, arg7, mem[ceil32(arg2.length) + ceil32(arg8.length) + 324 len arg8.length + 32]
        else:
            mem[floor32(arg8.length) + ceil32(arg2.length) + ceil32(arg8.length) + 324] = mem[floor32(arg8.length) + ceil32(arg2.length) + ceil32(arg8.length) + -(arg8.length % 32) + 356 len arg8.length % 32]
            call arg1.mem[ceil32(arg2.length) + ceil32(arg8.length) + 160 len 4] with:
                 gas gas_remaining - 25710 wei
                args address(arg3), address(arg4), arg5, arg6, arg7, mem[ceil32(arg2.length) + ceil32(arg8.length) + 324 len floor32(arg8.length) + 32], arg9
    else:
        mem[ceil32(arg2.length) + ceil32(arg8.length) + 324] = mem[ceil32(arg2.length) + 160]
        mem[ceil32(arg2.length) + ceil32(arg8.length) + 356 len floor32(arg8.length - 1)] = mem[ceil32(arg2.length) + 192 len floor32(arg8.length - 1)]
        if not arg8.length % 32:
            mem[arg8.length + ceil32(arg2.length) + ceil32(arg8.length) + 324] = arg9
            call arg1.mem[ceil32(arg2.length) + ceil32(arg8.length) + 160 len 4] with:
                 gas gas_remaining - 25710 wei
                args address(arg3), address(arg4), arg5, arg6, arg7, mem[ceil32(arg2.length) + 160], mem[ceil32(arg2.length) + ceil32(arg8.length) + 356 len arg8.length]
        else:
            mem[floor32(arg8.length) + ceil32(arg2.length) + ceil32(arg8.length) + 324] = mem[floor32(arg8.length) + ceil32(arg2.length) + ceil32(arg8.length) + -(arg8.length % 32) + 356 len arg8.length % 32]
            mem[floor32(arg8.length) + ceil32(arg2.length) + ceil32(arg8.length) + 356] = arg9
            call arg1.mem[ceil32(arg2.length) + ceil32(arg8.length) + 160 len 4] with:
                 gas gas_remaining - 25710 wei
                args address(arg3), address(arg4), arg5, arg6, arg7, mem[ceil32(arg2.length) + 160], mem[ceil32(arg2.length) + ceil32(arg8.length) + 356 len floor32(arg8.length) + 32]
    require ext_call.success
}
