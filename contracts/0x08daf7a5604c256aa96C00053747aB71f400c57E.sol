...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 112000000 * 10^18
    stor2 = 112000000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 11
    stor3.length.field_8 = 'Block Clout' / 256
    idx = 0
