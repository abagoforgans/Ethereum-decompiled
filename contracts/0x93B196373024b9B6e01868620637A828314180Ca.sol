...
function _fallback() payable {
    stor0 = 0xbd19393cd5d45b318b714442e653b469e6b4ab72
    stor1 = 0x9adbb95c97c1f1d7d9d8abe8cdd2f2043292aa79
    stor5 = 0
    require not msg.value
    stor2 = stor0
    stor3 = msg.sender
    return code.data[163 len 3322]
}
...
const duration = 157553

const devRatio = 20

const fundingMax = 2000000 * 10^18

const startBlock = 4038197

const isStarted = block.number >= 4038197
