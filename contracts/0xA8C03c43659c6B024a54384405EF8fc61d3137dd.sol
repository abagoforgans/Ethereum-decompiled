...
function _fallback() payable {
    ...
    stor9 = 0
    stor8 = 0
    stor4 = code.data[3474 len 32] + block.timestamp
    stor5 = 0
    stor7 = code.data[3506 len 32]
    stor10 = code.data[3538 len 32] or Mask(96, 160, stor10)
    address(stor12.field_0) = address(code.data[3570 len 32])
    uint8(stor12.field_160) = 0
    Mask(88, 0, stor12.field_168) = Mask(88, 168, code.data[3570 len 32]) >> 168
    stor13 = 0
    return code.data[149 len 3325]
}
