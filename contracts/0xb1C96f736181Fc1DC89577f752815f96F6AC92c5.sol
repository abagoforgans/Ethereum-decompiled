...
function _fallback() payable {
    stor4 = 0x990a10058406e445fee83127d5eb0e2977c43126
    require not msg.value
    mem[96 len -5355] = code.data[6037 len -5355]
    mem[64] = -5259
    stor5[stor4] = mem[96]
    stor3 = mem[96]
    ...
    stor2 = mem[191 len 1]
    emit Transfer(mem[96], this.address, stor4);
    return code.data[682 len 5355]
}
