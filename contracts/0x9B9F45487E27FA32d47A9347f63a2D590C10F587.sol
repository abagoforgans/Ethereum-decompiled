...
function withdrawEther() {
    ...
    require ext_code.size(stor364)
    call stor364.deposit(address arg1, uint256 arg2, string arg3) with:
         gas gas_remaining wei
        args 0, 0, eth.balance(this.address) - sub_6b1b2490, 96, 18, 'Continuous Funding'
...
function sub_925c0328(?) {
    ...
    call stor364.deposit(address arg1, uint256 arg2, string arg3) with:
         gas gas_remaining wei
        args address(this.address), uint255(stor361.field_1) - stor363, Array(len=18, data='DAO Founder Tokens')
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
