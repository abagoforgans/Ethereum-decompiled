    ...
    if totalSupply <= 0:
        if balanceOf[address(msg.sender)].field_1024 > 0:
            ...
            call msg.sender with:
               value balanceOf[address(msg.sender)].field_512 + balanceOf[address(msg.sender)].field_768 - balanceOf[address(msg.sender)].field_1024 wei
            ...
            if balanceOf[address(msg.sender)].field_1024 >= 0:
                ...
                call msg.sender with:
                   value balanceOf[address(msg.sender)].field_512 + balanceOf[address(msg.sender)].field_768 wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
        ...
        if not stor10:
            ...
            if balanceOf[address(msg.sender)].field_1024 > 0:
                ...
                call msg.sender with:
                   value balanceOf[address(msg.sender)].field_512 + balanceOf[address(msg.sender)].field_768 + (0 / totalSupply) - balanceOf[address(msg.sender)].field_1024 wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if balanceOf[address(msg.sender)].field_1024 >= 0:
                    ...
                    call msg.sender with:
                       value balanceOf[address(msg.sender)].field_512 + balanceOf[address(msg.sender)].field_768 + (0 / totalSupply) wei
                         gas 2300 * is_zero(value) wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
            ...
            if balanceOf[address(msg.sender)].field_1024 > 0:
                ...
                call msg.sender with:
                   value balanceOf[address(msg.sender)].field_512 + balanceOf[address(msg.sender)].field_768 + (stor10 * balanceOf[address(msg.sender)].field_256 / totalSupply) - balanceOf[address(msg.sender)].field_1024 wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                if balanceOf[address(msg.sender)].field_1024 >= 0:
                    ...
                    call msg.sender with:
                       value balanceOf[address(msg.sender)].field_512 + balanceOf[address(msg.sender)].field_768 + (stor10 * balanceOf[address(msg.sender)].field_256 / totalSupply) wei
                         gas 2300 * is_zero(value) wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
