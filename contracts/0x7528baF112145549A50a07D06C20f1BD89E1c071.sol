...
function set(uint256 arg1) payable {
    ...
    if 10 == get:
        call stor3 with:
           funct Mask(32, 224, '0x30312d30352c3138') >> 224
           value 5 * 10^17 wei
             gas gas_remaining - 34050 wei
            args Mask(224, 0, '0x30312d30352c3138')
    if 20 == get:
        call stor3 with:
    ...
    if 30 == get:
        call stor3 with:
           funct Mask(32, 224, '30312d30352c3138') >> 224
           value 5 * 10^17 wei
             gas gas_remaining - 34050 wei
            args Mask(224, 0, '30312d30352c3138')
    if 40 == get:
        call stor3 with:
           funct Mask(32, 128, '01-05,18') >> 128
           value 5 * 10^17 wei
             gas gas_remaining - 34050 wei
            args (uint128('01-05,18') << 96)
}
