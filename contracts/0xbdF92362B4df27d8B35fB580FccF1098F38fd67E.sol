...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor2 = block.timestamp + (60 * code.data[2377 len 32])
    stor3 = 42352
    stor4 = code.data[2421 len 20]
    return code.data[246 len 2131]
}
...
function buyToken() payable {
    ...
    call tokenRewardAddress.0x23b872dd with:
        ...
        args address(this.address), msg.sender, msg.value * rateOfEther
