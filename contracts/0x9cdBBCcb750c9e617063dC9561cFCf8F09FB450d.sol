...
function sub_0ec63fff(?) payable {
    ...
    while idx < arg1.length:
        ...
        mem[mem[64]] = 5
        mem[64] = mem[64] + 192
        mem[_33 + 32 len 160] = code.data[20389 len 160]
        s = 5 * idx
        while s <= (5 * idx) + 4:
        ...
        mem[mem[64]] = 13
        mem[64] = mem[64] + 448
        mem[_56 + 32 len 416] = code.data[20389 len 416]
        s = 13 * idx
        while s <= (13 * idx) + 12:
...
function sub_4869d5dd(?) payable {
    ...
    mem[128 len 32 * arg2 + -arg1 + 1] = code.data[20389 len 32 * arg2 + -arg1 + 1]
    mem[(32 * arg2 + -arg1 + 1) + 128] = arg2 + -arg1 + 1
    mem[(32 * arg2 + -arg1 + 1) + 160 len 32 * arg2 + -arg1 + 1] = code.data[20389 len 32 * arg2 + -arg1 + 1]
    idx = 0
    while idx < ext_call.return_data[0]:
        require ext_code.size(operatorAddress)
        staticcall operatorAddress.0xe83a25c5 with:
...
function sub_ab0b6739(?) payable {
    ...
    mem[128 len 32 * ext_call.return_data[0]] = code.data[20389 len 32 * ext_call.return_data[0]]
    mem[(32 * ext_call.return_data[0]) + 128] = ext_call.return_data[0]
    mem[(32 * ext_call.return_data[0]) + 160 len 32 * ext_call.return_data[0]] = code.data[20389 len 32 * ext_call.return_data[0]]
    mem[(64 * ext_call.return_data[0]) + 160] = ext_call.return_data[0]
    mem[(64 * ext_call.return_data[0]) + 192 len 32 * ext_call.return_data[0]] = code.data[20389 len 32 * ext_call.return_data[0]]
    mem[(98 * ext_call.return_data[0]) + 192] = ext_call.return_data[0]
    mem[64] = (131 * ext_call.return_data[0]) + 224
    mem[(98 * ext_call.return_data[0]) + 224 len 32 * ext_call.return_data[0]] = code.data[20389 len 32 * ext_call.return_data[0]]
    idx = 0
    while idx < ext_call.return_data[0]:
        require ext_code.size(operatorAddress)
        staticcall operatorAddress.0x3865079f with:
...
function sub_8a055fe1(?) payable {
    ...
    mem[(131 * ext_call.return_data[0]) + 224] = ext_call.return_data[0]
    mem[64] = (164 * ext_call.return_data[0]) + 256
    mem[(131 * ext_call.return_data[0]) + 256 len 32 * ext_call.return_data[0]] = code.data[20389 len 32 * ext_call.return_data[0]]
    idx = 0
    while idx < ext_call.return_data[0]:
        require ext_code.size(operatorAddress)
        staticcall operatorAddress.0x95a25efa with:
...
function sub_712bf703(?) payable {
    ...
    mem[(164 * ext_call.return_data[0]) + 256] = ext_call.return_data[0]
    mem[64] = (197 * ext_call.return_data[0]) + 288
    mem[(164 * ext_call.return_data[0]) + 288 len 32 * ext_call.return_data[0]] = code.data[20389 len 32 * ext_call.return_data[0]]
    idx = 0
    while idx < ext_call.return_data[0]:
        require ext_code.size(operatorAddress)
        staticcall operatorAddress.0x95a25efa with:
...
function sub_f72cf324(?) payable {
    ...
    mem[(197 * ext_call.return_data[0]) + 288] = ext_call.return_data[0]
    mem[64] = (230 * ext_call.return_data[0]) + 320
    mem[(197 * ext_call.return_data[0]) + 320 len 32 * ext_call.return_data[0]] = code.data[20389 len 32 * ext_call.return_data[0]]
    idx = 0
    while idx < ext_call.return_data[0]:
        require ext_code.size(operatorAddress)
        staticcall operatorAddress.0x95a25efa with:
...
function sub_aa9aab19(?) payable {
    ...
    mem[ceil32(return_data.size) + 128 len 32 * _6] = code.data[20389 len 32 * _6]
    mem[ceil32(return_data.size) + (32 * _6) + 128] = _6
    mem[ceil32(return_data.size) + (32 * _6) + 160 len 32 * _6] = code.data[20389 len 32 * _6]
    mem[ceil32(return_data.size) + (64 * _6) + 160] = _6
    mem[ceil32(return_data.size) + (64 * _6) + 192 len 32 * _6] = code.data[20389 len 32 * _6]
    mem[ceil32(return_data.size) + (98 * _6) + 192] = _6
    mem[ceil32(return_data.size) + (98 * _6) + 224 len 32 * _6] = code.data[20389 len 32 * _6]
    mem[ceil32(return_data.size) + (131 * _6) + 224] = _6
    mem[ceil32(return_data.size) + (131 * _6) + 256 len 32 * _6] = code.data[20389 len 32 * _6]
    mem[ceil32(return_data.size) + (164 * _6) + 256] = _6
    mem[64] = ceil32(return_data.size) + (197 * _6) + 288
    mem[ceil32(return_data.size) + (164 * _6) + 288 len 32 * _6] = code.data[20389 len 32 * _6]
    idx = 0
    while idx < _6:
        require idx < mem[_4 + 96]
        require ext_code.size(operatorAddress)
