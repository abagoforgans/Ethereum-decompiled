...
const _fallback = code.data[19 len 11055]
...
function sub_de56a544(?) payable {
    ...
    emit code.data[11023 len 32]: msg.sender
}
...
function getBasicInfo(address arg1) payable {
    return uint8(parentCount[address(arg1)].field_0), 
           ...
           uint8(parentCount[address(arg1)].field_16)
}
...
function sub_f2f35ff5(?) payable {
    if uint256(parentCount[address(arg1)].field_512):
        mem[160] = uint256(parentCount[address(arg1)][2].field_0)
        idx = 160
        s = 0
        while uint256(parentCount[address(arg1)].field_512) + 128 > idx:
            mem[idx + 32] = uint256(parentCount[address(arg1)][s + 2].field_256)
            idx = idx + 32
            s = s + 1
            continue 
    return Array(len=uint256(parentCount[address(arg1)].field_512), data=mem[160 len uint256(parentCount[address(arg1)].field_512)]), 
}
...
function getLocation(address arg1) payable {
    if uint256(parentCount[address(arg1)].field_768):
        mem[160] = uint256(parentCount[address(arg1)][3].field_0)
        if uint256(parentCount[address(arg1)].field_768) + 32 > 64:
            mem[192] = uint256(parentCount[address(arg1)][3].field_256)
            idx = 192
            s = 1
            while uint256(parentCount[address(arg1)].field_768) + 128 > idx:
                mem[idx + 32] = uint256(parentCount[address(arg1)][s + 3].field_256)
                idx = idx + 32
                s = s + 1
                continue 
    return Array(len=uint256(parentCount[address(arg1)].field_768), data=mem[160 len uint256(parentCount[address(arg1)].field_768)]), 
}
