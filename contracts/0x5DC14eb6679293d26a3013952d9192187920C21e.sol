...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor0 = msg.sender
    stor2 = code.data[8534 len 20]
    require stor0 == msg.sender
    stor3 = code.data[8566 len 20]
    require ext_code.size(code.data[8566 len 20])
    call code.data[8566 len 20].isPricingStrategy() with:
         gas gas_remaining - 50 wei
    require ext_call.success
    require ext_call.return_data[0]
    stor5 = code.data[8598 len 20]
    require code.data[8598 len 20]
    require code.data[8618 len 32]
    stor7 = code.data[8618 len 32]
    require code.data[8650 len 32]
    stor8 = code.data[8650 len 32]
    require stor7 < code.data[8650 len 32]
    stor6 = code.data[8682 len 32]
    stor19 = code.data[8714 len 32]
    return code.data[555 len 7967]
}
...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0xb1f67fedfe7b9dc35b0aa96551965ff799ccbd62)
    delegate 0xb1f67fedfe7b9dc35b0aa96551965ff799ccbd62.0x66098d4f with:
         gas gas_remaining - 50 wei
...
function preallocate(address arg1, uint256 arg2, uint256 arg3) {
    ...
    if not arg3:
        ...
        delegate 0xb1f67fedfe7b9dc35b0aa96551965ff799ccbd62.0x66098d4f with:
             gas gas_remaining - 50 wei
            args uint256(weiRaised), arg3
        require delegate.return_code
        uint256(weiRaised) = delegate.return_data[0]
        require ext_code.size(0xb1f67fedfe7b9dc35b0aa96551965ff799ccbd62)
        delegate 0xb1f67fedfe7b9dc35b0aa96551965ff799ccbd62.0x66098d4f with:
             gas gas_remaining - 50 wei
            args tokensSold, arg2
        require delegate.return_code
        tokensSold = delegate.return_data[0]
        require ext_code.size(0xb1f67fedfe7b9dc35b0aa96551965ff799ccbd62)
        delegate 0xb1f67fedfe7b9dc35b0aa96551965ff799ccbd62.0x66098d4f with:
             gas gas_remaining - 50 wei
            args investedAmountOf[address(arg1)], arg3
        require delegate.return_code
        ...
        call tokenAddress.0x40c10f19 with:
            ...
            args address(arg1), arg2
        require ext_call.success
        emit Invested(address(arg1), arg3, arg2, 0);
}
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0xb1f67fedfe7b9dc35b0aa96551965ff799ccbd62):
                            delegate 0xb1f67fedfe7b9dc35b0aa96551965ff799ccbd62.0x66098d4f with:
                                 gas gas_remaining - 50 wei
