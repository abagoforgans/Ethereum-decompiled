...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'Mythumos Token' / 256
    idx = 0
    ...
    stor0[address(msg.sender)] = 24000000 * 10^18
    stor2 = 24000000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 8
    stor3.length.field_8 = 'Mythumos' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        stor3[idx].field_0 = 0
        idx = idx + 1
