...
function _fallback() payable {
    stor0[address(code.data[1845 len 32])] = code.data[1813 len 32]
    stor1 = code.data[1845 len 32] or Mask(96, 160, stor1)
    stor2 = code.data[1877 len 32]
    return code.data[165 len 1648]
}
