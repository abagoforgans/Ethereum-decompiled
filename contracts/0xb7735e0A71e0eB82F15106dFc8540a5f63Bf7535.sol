...
function changeVotingRules(address arg1, uint256 arg2) payable {
    require msg.sender == address(owner)
    tokenAddress = arg1
...
function veto(uint256 arg1) {
    ...
    address(stor[uint256(proposals[arg1].field_1792) + sha3((9 * arg1) + ('name', 'proposals', 2) + 7)].field_8) = msg.sender
    ...
    require ext_code.size(tokenAddress)
    call tokenAddress.0x4a501381 with:
         gas gas_remaining - 50 wei
    require ext_call.success
...
function sub_dfe12c31(?) {
    ...
    uint64(proposals[proposals.length].field_0) = uint64(stor0)
    Mask(96, 0, proposals[proposals.length].field_64) = 0
    ...
    if s >= ext_call.return_data[0] / 2:
        ...
        if not arg2.length % 32:
            call address(proposals[arg1].field_0) with:
               ...
               value 10^15 * uint256(proposals[arg1].field_256) wei
