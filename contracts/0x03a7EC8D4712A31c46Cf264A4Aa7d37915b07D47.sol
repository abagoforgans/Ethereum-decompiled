...
function _fallback() payable {
    ...
    stor6.length.field_8 = 'Version 1.0' / 256
    idx = 0
    ...
    stor0[address(msg.sender)] = 250000 * 3600
    stor2 = 250000 * 3600
    bool(stor3.length) = 0
    stor3.length.field_1 = 15
    stor3.length.field_8 = 'Bitcoin Compact' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'BTC' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    stor9 = 0x78863e62856d8c2047061f447c7e55c5838b7064
    return code.data[642 len 4934]
}
