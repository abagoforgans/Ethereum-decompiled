...
function sub_30ce4895(?) {
    ...
    stor1 = arg6
    stor7 = arg1
    require sha3(arg1) == arg3
    if block.number > uint256(stor3):
        revert with 0, 'Commit has expired.'
    signer = erecover(sha3(stor3 % 1099511627776, Mask(216, 0, stor4.field_40), stor4.field_0 % 1099511627776), 27, stor5, stor6) 
...
function sub_ebeca895(?) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    if stor2 != msg.sender:
        revert with 0, 'OnlyOwner methods called by nonowner.'
    stor5 = arg4
    stor6 = arg5
    uint256(stor4.field_0) = arg3
    uint256(stor3) = arg2 + 1152921504606846976
