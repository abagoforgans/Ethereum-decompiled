...
function sub_a8e02dfc(?) {
    ...
    idx = 0
    while idx <= arg1:
        mem[96 len 510] = code.data[5481 len 510]
        create contract with 0 wei
                        code: code.data[5481 len 510]
...
function sub_227e9247(?) payable {
    ...
    if not uint256(sub_0cd26ebe[stor7[var60003].field_0]):
        ...
        mem[64] = 1183
        mem[319] = 810
        mem[351 len 810] = code.data[5991 len 810]
        mem[1219] = 810
        mem[1251 len 832] = code.data[5991 len 810], mem[1161 len 22]
        mem[2051] = mem[1173 len 10]
        require ext_code.size(stor7[var60003].field_0)
        call stor7[var60003].field_0.0x9a875cc2 with:
           value msg.value wei
             gas gas_remaining wei
            args Array(len=810, data=code.data[5991 len 810], mem[1161 len 22] >> 6144, mem[1173 len 10])
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require var60003 < stor7.length
        ...
        if uint256(sub_0cd26ebe[stor7[var60003].field_0]) <= 127:
            ...
            if uint256(sub_0cd26ebe[stor7[var60003].field_0]) <= 255:
                ...
                mem[64] = 1184
                mem[320] = 810
                mem[352 len 810] = code.data[5991 len 810]
                mem[1220] = 810
                mem[1252 len 832] = code.data[5991 len 810], mem[1162 len 22]
                mem[2052] = mem[1174 len 10]
                require ext_code.size(stor7[var60003].field_0)
                call stor7[var60003].field_0.0x9a875cc2 with:
                   value msg.value wei
                     gas gas_remaining wei
                    args Array(len=810, data=code.data[5991 len 810], mem[1162 len 22] >> 6144, mem[1174 len 10])
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require var60003 < stor7.length
                ...
                if uint256(sub_0cd26ebe[stor7[var60003].field_0]) <= 65535:
                    ...
                    mem[64] = 1185
                    mem[321] = 810
                    mem[353 len 810] = code.data[5991 len 810]
                    mem[1221] = 810
                    mem[1253 len 832] = code.data[5991 len 810], mem[1163 len 22]
                    mem[2053] = mem[1175 len 10]
                    require ext_code.size(stor7[var60003].field_0)
                    call stor7[var60003].field_0.0x9a875cc2 with:
                       value msg.value wei
                         gas gas_remaining wei
                        args Array(len=810, data=code.data[5991 len 810], mem[1163 len 22] >> 6144, mem[1175 len 10])
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    require var60003 < stor7.length
                    ...
                    if uint256(sub_0cd26ebe[stor7[var60003].field_0]) <= 16777215:
                        ...
                        mem[64] = 1186
                        mem[322] = 810
                        mem[354 len 810] = code.data[5991 len 810]
                        mem[1222] = 810
                        mem[1254 len 832] = code.data[5991 len 810], mem[1164 len 22]
                        mem[2054] = mem[1176 len 10]
                        require ext_code.size(stor7[var60003].field_0)
                        call stor7[var60003].field_0.0x9a875cc2 with:
                           value msg.value wei
                             gas gas_remaining wei
                            args Array(len=810, data=code.data[5991 len 810], mem[1164 len 22] >> 6144, mem[1176 len 10])
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require var60003 < stor7.length
                        ...
                        mem[64] = 1187
                        mem[323] = 810
                        mem[355 len 810] = code.data[5991 len 810]
                        mem[1223] = 810
                        mem[1255 len 832] = code.data[5991 len 810], mem[1165 len 22]
                        mem[2055] = mem[1177 len 10]
                        require ext_code.size(stor7[var60003].field_0)
                        call stor7[var60003].field_0.0x9a875cc2 with:
                           value msg.value wei
                             gas gas_remaining wei
                            args Array(len=810, data=code.data[5991 len 810], mem[1165 len 22] >> 6144, mem[1177 len 10])
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require var60003 < stor7.length
