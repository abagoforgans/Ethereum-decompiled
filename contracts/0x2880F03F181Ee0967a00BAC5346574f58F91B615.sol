...
function _fallback() {
    stor3 = block.number + 3456
    stor4 = block.number + (24 * 3600)
    return code.data[56 len 2173]
}
...
const sale = 0x7093128612a02e32f1c1aa44ccd7411d84ee09ac

const max_raised_amount = 300 * 10^18
...
function _fallback() payable {
    require eth.balance(this.address) <= 300 * 10^18
    if not stor1:
...
function buy_the_tokens() {
    if not stor1:
        ...
        call 0x7093128612a02e32f1c1aa44ccd7411d84ee09ac with:
