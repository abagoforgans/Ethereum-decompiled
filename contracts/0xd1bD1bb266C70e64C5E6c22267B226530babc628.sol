...
function transfer(address arg1, uint256 arg2) {
    ...
    if not stor6:
        require crowdsaleAgentAddress == msg.sender
    if owner == msg.sender:
        if block.timestamp < crowdSaleOverTimestamp + (8760 * 24 * 3600):
            require arg2 <= balanceOf[stor1]
            require balanceOf[stor1] - arg2 > 10 * 10^6 * 10^decimals
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if owner == arg1:
        if block.timestamp < crowdSaleOverTimestamp + (8760 * 24 * 3600):
            ...
            require balanceOf[stor1] - arg3 > 10 * 10^6 * 10^decimals
