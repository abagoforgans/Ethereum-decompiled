...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 11500000 * 10^18
    stor2 = 11500000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 12
    stor3.length.field_8 = 'XfiniteAsset' / 256
    idx = 0
