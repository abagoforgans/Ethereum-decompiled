...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[3868 len 20]
    require code.data[3888 len 32] >= block.timestamp
    require code.data[3920 len 32] > 0
    stor2 = code.data[3836 len 20]
    stor3 = code.data[3868 len 20]
    stor4 = code.data[3888 len 32]
    require ext_code.size(code.data[3836 len 20])
    call code.data[3836 len 20].0x313ce567 with:
         gas gas_remaining - 710 wei
    require ext_call.success
    stor9 = 10^ext_call.return_data[0] * code.data[3920 len 32]
    return code.data[345 len 3479]
}
