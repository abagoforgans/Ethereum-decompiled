...
function sub_49aa5e54(?) {
    mem[ceil32(arg3.length) + 160 len arg4.length] = arg4[all]
    mem[ceil32(arg3.length) + ceil32(arg4.length) + 276 len arg3.length] = arg3[all]
    mem[arg3.length + ceil32(arg3.length) + ceil32(arg4.length) + 276 len arg4.length] = arg4[all]
    signer = erecover(sha3(arg1, arg2, arg5, arg6, mem[ceil32(arg3.length) + ceil32(arg4.length) + 276 len arg4.length + arg3.length]), arg7 << 248, arg8, arg9) 
    mem[ceil32(arg3.length) + ceil32(arg4.length) + 160] = signer
    require erecover.result
    require stor1[address(signer)]
    require stor3[arg1].field_1024 <= arg6
    require stor4[address(arg2)].field_512 <= arg6
    stor3[arg1].field_0 = arg2
    stor3[arg1][1][].field_0 = Array(len=arg3.length, data=arg3[all])
    stor3[arg1].field_512 = (2 * arg4.length) + 1
    s = 0
    ...
    if stor3[arg1][2].length + 31 / 32 > Mask(251, 0, arg4.length + 31) >> 5:
        ...
        while stor3[arg1][2].length + 31 / 32 > idx:
            ...
            continue 
    stor3[arg1].field_768 = arg5
    stor3[arg1].field_1024 = arg6
    emit 0x707dee33: arg1, address(arg2), Array(len=arg3.length, data=arg3[all]), arg3.length + 224, arg5, arg6
    stor4[address(arg2)].field_0 = arg1
    stor4[address(arg2)].field_256 = arg5
    stor4[address(arg2)].field_512 = arg6
    emit 0xba52317b: address(arg2), arg1, arg5, arg6
    sub_acdc969b = block.timestamp
    return 0
}
