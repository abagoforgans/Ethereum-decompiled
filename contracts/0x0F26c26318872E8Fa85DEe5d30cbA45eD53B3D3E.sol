...
function persons(uint256 arg1) payable {
    ...
    return address(stor0[arg1].field_0), stor[code.data[1027 len 32] + (2 * arg1)]
}
...
function enter() payable {
    ...
    if msg.value <= 40 * 10^18:
        ...
        if not stor0.length > stor0.length + 1:
            ...
            stor[code.data[1027 len 32] + (2 * stor0.length)] = msg.value
            if stor0.length:
                ...
                collectedFees = 0
            balance += msg.value
            if balance <= 180 * stor[code.data[1027 len 32] + (2 * stor1)] / 100:
        ...
        call msg.sender with:
           value msg.value - 40 * 10^18 wei
             gas 0 wei
        stor0.length++
        if not stor0.length > stor0.length + 1:
            require stor0.length < stor0.length
            stor0[stor0.length].field_0 = msg.sender or Mask(96, 160, stor0[stor0.length].field_0)
            stor[code.data[1027 len 32] + (2 * stor0.length)] = 10 * 10^18
            if stor0.length:
                call address(owner) with:
                   value collectedFees wei
                     gas 0 wei
