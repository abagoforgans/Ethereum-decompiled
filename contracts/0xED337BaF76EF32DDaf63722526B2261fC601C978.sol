...
function execute(address[] arg1, bytes arg2) {
    ...
    if msg.sender == this.address:
        ...
        while idx < arg1.length:
            ...
            call address(_192).0xdd62ed3e with:
                 gas gas_remaining - 710 wei
        ...
        while idx < arg2.length:
            call mem[(32 * arg1.length) + idx + 192 len 20].mem[(32 * arg1.length) + idx + 212 len 4] with:
                 gas gas_remaining - 5000 wei
                args mem[(32 * arg1.length) + idx + 216 len mem[(32 * arg1.length) + idx + 160] - 24]
            require ext_call.success
            s = mem[(32 * arg1.length) + idx + 160] - 20
            s = (32 * arg1.length) + idx + 212
            s = mem[(32 * arg1.length) + idx + 192 len 20]
            s = mem[(32 * arg1.length) + idx + 160]
            idx = idx + mem[(32 * arg1.length) + idx + 160] + 32
            continue 
        idx = 0
        while idx < arg1.length:
            require idx < arg1.length
        ...
        if msg.sender == owner:
            ...
            while idx < arg1.length:
                ...
                call address(_187).0xdd62ed3e with:
                     gas gas_remaining - 710 wei
                    args msg.sender, this.address
                mem[(32 * arg1.length) + ceil32(arg2.length) + 160] = ext_call.return_data[0]
                require ext_call.success
            ...
            while idx < arg1.length:
                ...
                call address(_182).0xdd62ed3e with:
                     gas gas_remaining - 710 wei
                    args msg.sender, this.address
                mem[(32 * arg1.length) + ceil32(arg2.length) + 160] = ext_call.return_data[0]
                require ext_call.success
