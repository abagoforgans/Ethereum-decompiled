...
function sub_2e83a193(?) {
    ...
    while idx < arg3.length:
        ...
        _15 = mem[(32 * arg3.length) + (32 * idx) + 160]
        mem[(32 * arg4.length) + (32 * arg3.length) + 164] = arg2
        mem[(32 * arg4.length) + (32 * arg3.length) + 196] = address(_13)
        mem[(32 * arg4.length) + (32 * arg3.length) + 228] = _15
        require ext_code.size(arg1)
        call arg1.0x23b872dd with:
             gas gas_remaining wei
            args address(arg2), address(_13), _15
