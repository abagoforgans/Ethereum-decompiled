...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor0 = msg.sender
    stor1 = code.data[6973 len 20]
    require stor0 == msg.sender
    stor2 = code.data[7005 len 20]
    require ext_code.size(code.data[7005 len 20])
    call code.data[7005 len 20].isPricingStrategy() with:
         gas gas_remaining - 50 wei
    require ext_call.success
    require ext_call.return_data[0]
    stor4 = code.data[7037 len 20]
    require code.data[7037 len 20]
    require code.data[7057 len 32]
    stor6 = code.data[7057 len 32]
    require code.data[7089 len 32]
    stor7 = code.data[7089 len 32]
    require stor6 < code.data[7089 len 32]
    stor5 = code.data[7121 len 32]
    stor18 = code.data[7153 len 32]
    return code.data[538 len 6423]
}
...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0x80308f4359ffc4c6f5698886b44532afe525d783)
    delegate 0x80308f4359ffc4c6f5698886b44532afe525d783.0x66098d4f with:
         gas gas_remaining - 50 wei
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0x80308f4359ffc4c6f5698886b44532afe525d783):
                            delegate 0x80308f4359ffc4c6f5698886b44532afe525d783.0x66098d4f with:
                                 gas gas_remaining - 50 wei
