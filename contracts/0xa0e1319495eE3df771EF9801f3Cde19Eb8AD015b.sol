...
function _fallback() payable {
    ...
    stor12 = msg.sender
    stor0 = code.data[6956 len 20]
    address(stor13.field_0) = msg.sender
    return code.data[168 len 6776]
}
...
function play(address arg1, uint256 arg2) {
    ...
    bets[stor15].field_512 = bool(sha3((block.timestamp * block.difficulty * block.number) + (stor17 % block.timestamp) + block.hash(block.number - 1) + 1, uint256(stor16.field_0)))
    bets[stor15].field_513 = 0
    if bool(sha3((block.timestamp * block.difficulty * block.number) + (stor17 % block.timestamp) + block.hash(block.number - 1) + 1, uint256(stor16.field_0))) != 1:
        require not bool(sha3((block.timestamp * block.difficulty * block.number) + (stor17 % block.timestamp) + block.hash(block.number - 1) + 1, uint256(stor16.field_0)))
        ...
        emit 0x84461757: address(arg1), arg2, 1, bool(sha3((block.timestamp * block.difficulty * block.number) + (stor17 % block.timestamp) + block.hash(block.number - 1) + 1, uint256(stor16.field_0)))
        ...
        emit 0x84461757: address(arg1), arg2, (1900 * arg2 / 1000) - (1000 * 900 * arg2 / 1000 / 10000), bool(sha3((block.timestamp * block.difficulty * block.number) + (stor17 % block.timestamp) + block.hash(block.number - 1) + 1, uint256(stor16.field_0)))
