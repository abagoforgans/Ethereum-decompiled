...
function payout(uint256 arg1, address arg2, uint256 arg3) payable {
    ...
    if adminAddress != msg.sender:
        if sub_022d8ac1Address != msg.sender:
            return 0
        require arg3 >= sub_451f0f23
        require arg3 <= sub_74fcbb28
        require not sub_34cb7ab3
        require arg1 >= sub_404d5217
        require arg1 <= sub_21f45851
    require ext_code.size(stor1)
    call stor1.0x23b872dd with:
         gas gas_remaining wei
