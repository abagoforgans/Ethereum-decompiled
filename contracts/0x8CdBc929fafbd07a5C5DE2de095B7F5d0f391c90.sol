...
const baseTokenURI = Array(len=46, data='https://eznft-metadata.etherzaar', '.com/v1/token/', Mask(112, -256, 'https://eznft-metadata.etherzaar', '.com/v1/token/') << 256)
...
function isApprovedForAll(address arg1, address arg2) {
    ...
    staticcall stor12.proxies(address arg1) with:
...
function tokenURI(uint256 arg1) {
    require calldata.size - 4 >= 32
    mem[96] = 46
    mem[128] = 'https://eznft-metadata.etherzaar'
    mem[160] = '.com/v1/token/'
    if not arg1:
        mem[192] = 1
        mem[224] = '0'
        mem[256] = 0
        ...
        mem[320] = 0
        mem[352] = 47
        mem[384 len 47] = code.data[10241 len 47]
        idx = 0
        s = 0
        while idx < 46:
            require idx < 46
        ...
        while idx < 0:
            ...
            s = s + 1
            continue 
        return Array(len=47, data=mem[384], mem[433 len 15])
    s = 0
    idx = arg1
    while idx:
        s = s + 1
    ...
    if not s:
        ...
        mem[_280 + 32 len _279 + _278] = code.data[10241 len _279 + _278]
        _424 = mem[96]
        idx = 0
        s = 0
        while idx < _424:
    ...
    mem[224 len s] = code.data[10241 len s]
    t = s - 1
    idx = arg1
    while idx:
        require t < mem[192]
    ...
    mem[_286 + 32 len _285 + _284] = code.data[10241 len _285 + _284]
    _426 = mem[96]
    idx = 0
    s = 0
    while idx < _426:
