...
function sub_94d47d1e(?) {
    bool(symbol.length) = 0
    symbol.length.field_1 = 4
    symbol.length.field_8 = 'LTCA' / 256
    idx = 0
    ...
    name.length.field_8 = 'ltcatoken' / 256
    idx = 0
    ...
    balanceOf[0x31675706c5b1b362343b932f387ceb677e9c74b0] = _totalSupply
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  _totalSupply,
    emit 0x0: _totalSupply
    emit 0x31675706: _totalSupply
}
