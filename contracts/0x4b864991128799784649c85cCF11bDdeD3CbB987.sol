...
function _fallback() payable {
    ...
    if not stor1.length <= 600000:
        ...
        while 3 * stor1.length > idx:
            ...
            idx = idx + 3
            continue 
    stor19 = code.data[8125 len 20]
    stor20 = code.data[8157 len 20]
    stor21 = code.data[8189 len 20]
    stor12 = code.data[8209 len 32]
    stor13 = code.data[8241 len 32]
    ...
    emit code.data[8081 len 32]: 4 * 10^14, this.address, stor20
    emit code.data[8081 len 32]: 4 * 10^14, this.address, stor21
    return code.data[1485 len 6596]
}
