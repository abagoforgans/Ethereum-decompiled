...
function sub_62c529e4(?) {
    ...
    if address(signer) != address(('cd', 4)[5]):
        emit 0x1d7ce720: address(('cd', 4).length), address(('cd', 4)[5])
    else:
        ...
        if not ext_call.success:
            emit 0x422d7d13: address(('cd', 4).length), address(('cd', 4)[5])
        else:
...
function sub_10bfce71(?) {
    ...
    while idx < _116:
        require idx < mem[96]
        _118 = mem[(32 * idx) + 128]
        _119 = mem[mem[(32 * idx) + 128]]
        _120 = mem[mem[(32 * idx) + 128] + 32]
        _121 = mem[mem[(32 * idx) + 128] + 64]
        _122 = mem[mem[(32 * idx) + 128] + 128]
        mem[mem[64]] = mem[mem[(32 * idx) + 128] + 12 len 20]
        ...
        while s >= 32:
            ...
            s = s - 32
            continue 
        mem[_131 + floor32(mem[_127]) + 20] = mem[_127 + floor32(mem[_127]) + -(mem[_127] % 32) + 64 len mem[_127] % 32] or Mask(8 * -(mem[_127] % 32) + 32, -(8 * -(mem[_127] % 32) + 32) + 256, mem[_131 + floor32(mem[_127]) + 20])
        mem[_132 + _131 + 20] = _128
        _173 = sha3(mem[mem[64] len _132 + _131 + -mem[64] + 52])
        _174 = mem[64]
        mem[64] = mem[64] + 64
        mem[_174] = 28
        ...
        mem[mem[64] + 28] = _173
        _210 = sha3(mem[mem[64] len 28], _173)
        _212 = mem[_130]
        _213 = mem[_130 + 32]
        _214 = mem[_130 + 64]
        _215 = mem[64]
        ...
        if address(signer) != address(_129):
            mem[_215 + 32] = address(_119)
            mem[_215 + 64] = address(_122)
            emit 0x1d7ce720: address(_119), address(_122)
        else:
            _222 = mem[_120]
            s = 0
            while s < _222:
            ...
            if not _222 % 32:
                call address(_119).mem[mem[64] len 4] with:
                   value _121 wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _222 + _215 + -mem[64] + 28]
            else:
                mem[floor32(_222) + _215 + 32] = mem[floor32(_222) + _215 + -(_222 % 32) + 64 len _222 % 32]
                call address(_119).mem[mem[64] len 4] with:
                   value _121 wei
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len floor32(_222) + _215 + -mem[64] + 60]
            mem[mem[64]] = address(_119)
            mem[mem[64] + 32] = address(_122)
            if not ext_call.success:
                emit 0x422d7d13: address(_119), address(_122)
            else:
