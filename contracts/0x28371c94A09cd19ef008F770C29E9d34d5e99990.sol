...
function _fallback() {
    ...
    stor8 = code.data[4353 len 20]
    stor9 = code.data[4385 len 20]
    return code.data[488 len 3853]
}
...
function _fallback() payable {
    ...
    call balancesAddress.0x66e7ea0f with:
         gas gas_remaining - 710 wei
        args msg.sender, (msg.value * ext_call.return_data[0] / 10^18 / sub_f7bb3f3e) - (msg.value * ext_call.return_data[0] / 10^18 / cost)
    require ext_call.success
    require ext_code.size(balancesAddress)
    call balancesAddress.0xecfc5964 with:
         gas gas_remaining - 710 wei
