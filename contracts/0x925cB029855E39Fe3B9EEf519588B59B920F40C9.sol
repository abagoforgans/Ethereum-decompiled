...
function transfer(string arg1, string arg2) payable {
    ...
    call address(stor0.field_0).0x60f66701 with:
         gas gas_remaining - 25050 wei
        ...
        if Mask(8, 248, mem[129]) != 't':
            ...
            if Mask(8, 248, mem[130]) != 'c':
                ...
                if arg2.length > 35:
                    ...
                    mem[ceil32(arg1.length) + ceil32(arg2.length) + 352 len arg2.length] = arg2[all]
                    emit 0x89fa2bf8: Array(len=arg2.length, data=arg2[all])
                    call 0x1d11e5eae3112dbd44f99266872ff1d07c77dce8.getAddress() with:
                         gas gas_remaining - 25050 wei
                    require ext_call.success
                    uint256(stor0.field_0) = ext_call.return_data[0] or Mask(96, 160, uint256(stor0.field_0))
                    mem[ceil32(arg1.length) + ceil32(arg2.length) + 644] = mem[ceil32(arg1.length) + ceil32(arg2.length) + 673 len 3]
                    call address(stor0.field_0).0x524f3889 with:
                         gas gas_remaining - 25050 wei
                        args Array(len=3, data=mem[ceil32(arg1.length) + ceil32(arg2.length) + 644])
                    require ext_call.success
                    mem[ceil32(arg1.length) + ceil32(arg2.length) + 740] = mem[ceil32(arg1.length) + ceil32(arg2.length) + 769 len 3]
                    mem[ceil32(arg1.length) + ceil32(arg2.length) + 836] = 0, mem[ceil32(arg1.length) + ceil32(arg2.length) + 853 len 15]
                    mem[ceil32(arg1.length) + ceil32(arg2.length) + 964] = mem[ceil32(arg1.length) + ceil32(arg2.length) + 992 len 4]
                    call address(stor0.field_0).0x77228659 with:
                       value ext_call.return_data[0] wei
                         gas gas_remaining - 34050 wei
                        args 0, 128, 192, 288, 3, mem[ceil32(arg1.length) + ceil32(arg2.length) + 740], 49, 'json(https://shapeshift.io/shift', ').success.deposit', mem[ceil32(arg1.length) + ceil32(arg2.length) + 836], 68, '{"pair":"eth_btc","withdrawal":"', '1MCwBbhNGp5hRm5rC1Aims2YFRe2SXPY', 'Kt"}' >> 256, mem[ceil32(arg1.length) + ceil32(arg2.length) + 964]
                    require ext_call.success
}
