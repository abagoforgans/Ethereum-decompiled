...
function _fallback() payable {
    ...
    stor6.length.field_8 = '1.0.0' / 256
    idx = 0
    ...
    stor0[address(msg.sender)] = 10000000 * 10^18
    stor2 = 10000000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 18
    stor3.length.field_8 = 'DavidCittadiniCoin' / 256
    idx = 0
