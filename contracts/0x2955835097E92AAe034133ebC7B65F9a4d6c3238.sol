...
function _fallback() {
    require code.data[3252 len 20]
    require code.data[3272 len 32]
    require code.data[3304 len 32]
    stor2 = msg.sender
    stor1 = code.data[3252 len 20]
    stor3 = code.data[3272 len 32]
    stor4 = code.data[3304 len 32]
    stor10 = 0
    return code.data[167 len 3073]
}
