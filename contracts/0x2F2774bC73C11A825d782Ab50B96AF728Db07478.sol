...
function sub_db9f6d47(?) {
    ...
    ownerOf[stor12] = stor13
    require balanceOf[stor13] + 1 >= balanceOf[stor13]
    balanceOf[stor13]++
    emit Transfer(0, stor13, stor12);
    stor6[stor12] = tokenOfOwnerByIndex[stor13]
    tokenOfOwnerByIndex[stor13]++
    tokenOfOwnerByIndex[stor13][tokenOfOwnerByIndex[stor13]] = stor12
    ...
    mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg3.length) + 288] = 1
    stor14[stor12][].field_0 = Array(len=arg1.length, data=arg1[all])
    stor14[stor12][1][].field_0 = Array(len=Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)], data=mem[ceil32(arg1.length) + 160 len Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)]])
    stor14[stor12][2][].field_0 = Array(len=Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 0), mem[ceil32(arg1.length) + arg2.length + 192 len -arg2.length + ceil32(arg2.length)], data=mem[ceil32(arg1.length) + ceil32(arg2.length) + 192 len Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 0), mem[ceil32(arg1.length) + arg2.length + 192 len -arg2.length + ceil32(arg2.length)]])
    stor14[stor12].field_768 = 1
    emit 0x9f4c6dfe: stor12, Array(len=arg1.length, data=arg1[all]), stor13
}
