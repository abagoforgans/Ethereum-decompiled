...
function _fallback() {
    stor1 = code.data[7213 len 20]
    stor0 = code.data[7181 len 20]
    return code.data[104 len 7065]
}
...
function sub_2cb0526a(?) {
    ...
    mem[(32 * arg4.length) + (32 * arg3.length) + (32 * arg2.length) + 224] = 0
    mem[(32 * arg4.length) + (32 * arg3.length) + (32 * arg2.length) + 196] = tx.origin
    require ext_code.size(sub_44624e34Address)
    call sub_44624e34Address.0x39bc5a53 with:
         gas gas_remaining - 50 wei
        args tx.origin
                ...
                if arg2.length == arg3.length:
                    if arg2.length == arg4.length:
                        ...
                        while idx < arg2.length:
                            ...
                            mem[64] = mem[64] + 160
                            require idx < mem[96]
                            mem[_42] = mem[(32 * idx) + 128]
                            require idx < mem[(32 * arg2.length) + 128]
                            mem[_42 + 32] = mem[(32 * arg2.length) + (32 * idx) + 160]
                            mem[_42 + 64] = 0
                            require idx < mem[(32 * arg3.length) + (32 * arg2.length) + 160]
                            mem[_42 + 96] = mem[(32 * idx) + (32 * arg3.length) + (32 * arg2.length) + 192]
                            mem[_42 + 128] = 0
                            mem[mem[64]] = arg1
                            mem[mem[64] + 32] = idx
                            mem[0] = sha3(arg1, idx)
                            mem[32] = 3
                            sub_91abe6b2[arg1][idx].field_0 = mem[_42]
                            sub_91abe6b2[arg1][idx].field_256 = mem[_42 + 32]
                            sub_91abe6b2[arg1][idx].field_512 = 0
                            sub_91abe6b2[arg1][idx].field_768 = 0
                            sub_91abe6b2[arg1][idx].field_768 = mem[_42 + 96]
...
function sub_37c5fc01(?) {
    ...
    mem[64] = (32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 224
        ...
        if not sub_5fa80c12[arg1].field_2048:
            if arg3.length == arg4.length:
                if arg3.length == arg5.length:
                    ...
                    sub_5fa80c12[arg1].field_1280 = arg7
                    sub_5fa80c12[arg1].field_2048 = uint64(block.timestamp)
                    mem[(32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 256] = 0
                    mem[(32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 228] = tx.origin
                    require ext_code.size(sub_44624e34Address)
                    call sub_44624e34Address.0x39bc5a53 with:
                         gas gas_remaining - 50 wei
                        args tx.origin
                    mem[(32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 224] = ext_call.return_data[0]
                    require ext_call.success
                    if ext_call.return_data[0]:
                        if 1 == bool(sub_5fa80c12[arg1].field_2048):
                            if sub_5fa80c12[arg1].field_1024 <= 0:
                                if arg3.length == arg4.length:
                                    if arg3.length == arg5.length:
                                        ...
                                        while idx < arg3.length:
                                            ...
                                            mem[_489] = mem[(32 * idx) + ceil32(arg2.length) + 160]
                                            require idx < mem[(32 * arg3.length) + ceil32(arg2.length) + 160]
                                            mem[_489 + 32] = mem[(32 * arg3.length) + ceil32(arg2.length) + (32 * idx) + 192]
                                            mem[_489 + 64] = 0
                                            require idx < mem[(32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 192]
                                            mem[_489 + 96] = mem[(32 * idx) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 224]
                                            mem[_489 + 128] = 0
                                            mem[mem[64]] = arg1
                                            mem[mem[64] + 32] = idx
                                            mem[0] = sha3(arg1, idx)
                                            mem[32] = 3
                                            sub_91abe6b2[arg1][idx].field_0 = mem[_489]
                                            sub_91abe6b2[arg1][idx].field_256 = mem[_489 + 32]
                                            sub_91abe6b2[arg1][idx].field_512 = 0
                                            sub_91abe6b2[arg1][idx].field_768 = 0
                                            sub_91abe6b2[arg1][idx].field_768 = mem[_489 + 96]
                                            sub_91abe6b2[arg1][idx].field_1024 = 0
                                            idx = idx + 1
                                            continue 
                                        emit 0x233e3b80: 'ConfirmExecution'
