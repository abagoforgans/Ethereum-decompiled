    ...
    if ext_call.return_data[0] <= (200000 * block.gasprice) + 10^18:
        ...
        call address(stor1).query(uint256 rg1, string rg2, string rg3) with:
           value ext_call.return_data[0] wei
            ...
            args 0, 96, 160, 0, 3, 'URL' % 16777216, 0, 105, 'html(https://www.youtube.com/wat', 'ch?v=9bZkp7q19f0).xpath(//*[cont', 'ains(@class, "watch-view-count")', ']/text())' >> 256, Mask(72, -512, 'ch?v=9bZkp7q19f0).xpath(//*[cont', 'ains(@class, "watch-view-count")', ']/text())') << 512
        require ext_call.success
    return code.data[2009 len 3254]
}
