...
function _fallback() payable {
    ...
    stor5 = code.data[3811 len 20]
    stor1[stor5] += 1000000000 * 10^18
    emit Transfer(1000000000 * 10^18, this.address, stor5);
    return code.data[650 len 3149]
}
