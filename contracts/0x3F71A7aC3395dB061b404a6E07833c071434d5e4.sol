...
function _fallback() {
    ...
    stor0.length.field_8 = 'LUNOX' / 256
    idx = 0
    ...
    stor1.length.field_8 = 'LUNOX' / 256
    idx = 0
    while stor1.length + 31 / 32 > idx:
        stor1[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[542 len 4751]
}
...
const _myTokeName = 'LUNOX'

const _mySymbol = 'LUNOX'

const _myinitialSupply = 2 * 10^17
