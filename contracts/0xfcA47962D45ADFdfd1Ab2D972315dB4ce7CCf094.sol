...
function _fallback() payable {
    ...
    mem[96 len -5786] = code.data[6506 len -5786]
    mem[64] = -5690
    stor3 = msg.sender
    stor8 = msg.sender
    stor3 = msg.sender
...
function mint(address arg1, uint256 arg2) {
    ...
    require not stor6
    require ext_code.size(0xcee69b39f622ddd074fc272df7528bc665fbe185)
    delegate 0xcee69b39f622ddd074fc272df7528bc665fbe185.0x66098d4f with:
         gas gas_remaining - 50 wei
