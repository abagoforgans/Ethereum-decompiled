...
function _fallback() payable {
    ...
    require ext_code.size(mem[108 len 20])
    call mem[108 len 20].artist() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    stor4 = ext_call.return_data[12 len 20] or Mask(96, 160, stor4)
    require ext_code.size(mem[108 len 20])
    call mem[108 len 20].trivial() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    stor5 = ext_call.return_data[12 len 20] or Mask(96, 160, stor5)
    require ext_code.size(mem[108 len 20])
    call mem[108 len 20].tokensForArtist() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    stor9 = ext_call.return_data[0]
    require ext_code.size(mem[108 len 20])
    call mem[108 len 20].tokensForTrivial() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    stor10 = ext_call.return_data[0]
    require ext_code.size(mem[108 len 20])
    call mem[108 len 20].tokensForIco() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    ...
    while idx < 7:
        require ext_code.size(mem[108 len 20])
        call mem[108 len 20].contributors(uint256 rg1) with:
             gas gas_remaining - 710 wei
            args idx
        require ext_call.success
        mem[-7764] = 0
        ...
        require ext_code.size(mem[108 len 20])
        call mem[108 len 20].contributions(address rg1) with:
             gas gas_remaining - 710 wei
        ...
        continue 
    require ext_code.size(mem[108 len 20])
    call mem[108 len 20].icoEndTime() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    ...
    require ext_code.size(mem[108 len 20])
    call mem[108 len 20].auctionEndTime() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    stor8 = ext_call.return_data[0]
    require ext_code.size(mem[108 len 20])
    call mem[108 len 20].highestBidder() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    stor13 = address(ext_call.return_data[0])
    require ext_code.size(mem[108 len 20])
    call mem[108 len 20].highestBid() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    stor14 = ext_call.return_data[0]
    require ext_code.size(mem[108 len 20])
    call mem[108 len 20].auctionWinnerMessageHash() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    stor15 = ext_call.return_data[0]
    require ext_code.size(mem[108 len 20])
    call mem[108 len 20].nextContributorIndexToBeGivenTokens() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    stor16 = ext_call.return_data[0]
    require ext_code.size(mem[108 len 20])
    call mem[108 len 20].tokensDistributedToContributors() with:
         gas gas_remaining - 710 wei
    require ext_call.success
