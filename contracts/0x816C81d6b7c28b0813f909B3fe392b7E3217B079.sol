...
const INTERFACE_SIGNATURE_ERC721 = Mask(32, 224, sha3(Mask(192, 64, 'approve(address,uint256)') >> 64) xor sha3('transferFrom(address,address,uin', Mask(40, 216, 't256)') >> 216) xor sha3('safeTransferFrom(address,address', Mask(72, 184, ',uint256)') >> 184) xor sha3('safeTransferFrom(address,address', Mask(120, 136, ',uint256,bytes)') >> 136) xor sha3(Mask(128, 128, 'ownerOf(uint256)') >> 128) xor sha3(Mask(144, 112, 'balanceOf(address)') >> 112) xor sha3(Mask(104, 152, 'totalSupply()') >> 152) xor sha3(Mask(64, 192, 'symbol()') >> 192) xor sha3(Mask(48, 208, 'name()') >> 208) xor sha3(Mask(248, 8, 'setApprovalForAll(address,bool)') >> 8) xor sha3(Mask(160, 96, 'getApproved(uint256)') >> 96) xor sha3('isApprovedForAll(address,address', Mask(8, 248, ')') >> 248))
...
function getTokenStatus(uint256 arg1) {
    ...
    if not ('signextend', 0, ('signextend', 0, ('type', 256, ('stor', ('map', ('param', 'arg1'), ('name', 'stor9', 9)))))):
        return 'PENDING'
    if 1 == ('signextend', 0, ('signextend', 0, ('type', 256, ('stor', ('map', ('param', 'arg1'), ('name', 'stor9', 9)))))):
        return 'ACTIVE'
...
function supportsInterface(bytes4 arg1) {
    if Mask(32, 224, sha3('supportsInterface(bytes4)')) == Mask(32, 224, arg1):
        return True
    return (Mask(32, 224, sha3('getApproved(uint256)') xor sha3('setApprovalForAll(address,bool)') xor sha3('approve(address,uint256)') xor sha3('transferFrom(address,address,uin', 't256)') xor sha3('safeTransferFrom(address,address', ',uint256)') xor sha3('totalSupply()') xor sha3('symbol()') xor sha3('name()') xor sha3('balanceOf(address)') xor sha3('ownerOf(uint256)') xor sha3('safeTransferFrom(address,address', ',uint256,bytes)') xor sha3('isApprovedForAll(address,address', ')')) == Mask(32, 224, arg1))
}
...
function sub_9cb0e261(?) {
    ...
    if not arg3:
        ...
        if not arg2:
            stor16[arg1] = 0
            emit 0xc3bcb264: arg1, 64, 6, 0x534e4154434800000000000000000000000000000000000000000000000000
        else:
            if 1 == arg2:
                stor16[arg1] = 1
