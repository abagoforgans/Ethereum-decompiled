...
function sub_54746dac(?) payable {
    ...
    while idx < arg2.length:
        _18 = mem[64]
        mem[64] = mem[64] + 96
        mem[_18 len 96] = call.data[arg2 + (96 * idx) + 36 len 96]
        mem[s] = _18
        s = s + 32
        idx = idx + 1
        continue 
    ...
    while uint8(idx) < _54:
        require arg1 < 20
        stor6D2[arg1]++
        if not stor6D2[arg1] > stor6D2[arg1] + 1:
            require idx < mem[_3]
            require arg1 < 20
            ...
            s = 0
            t = mem[_3 + (32 * idx) + 32]
            while mem[_3 + (32 * idx) + 32] + 96 > t:
                uint256(stor[sha3((10 * arg1) + 1746) + idx].field_0) = mem[t + 31 len 1] * 256^s or !(255 * 256^s) and uint256(stor[sha3((10 * arg1) + 1746) + idx].field_0)
                _54 = mem[_3]
                s = s + -(s + 1 / 32) + (-1 * s * s + 1 / 32) + 1
                t = t + 32
                continue 
            t = s
            u = sha3((10 * arg1) + 1746) + idx
            while t:
                ...
                u = (t + 1 / 32) + u
                continue 
            t = sha3((10 * arg1) + 1746) + idx + (floor32(None + 3) >> 4) + (None * None + 3 / 32) - (s * None + 3 / 32)
            while sha3((10 * arg1) + 1746) + idx + 1 > t:
            ...
            continue 
        mem[0] = (10 * arg1) + 1746
        s = stor6D2[arg1] + sha3((10 * arg1) + 1746) + 1
        while sha3((10 * arg1) + 1746) + stor6D2[arg1] > s:
            uint256(stor[s].field_0) = 0
            _54 = mem[_3]
            s = s + 1
            continue 
        ...
        while t:
            ...
            u = (t + 1 / 32) + u
            continue 
        idx = sha3((10 * arg1) + 1746) + None + (floor32(None + 3) >> 4) + (None * None + 3 / 32) + (-1 * s * None + 3 / 32) + 2
        while sha3((10 * arg1) + 1746) + None + 3 > idx:
