...
const _fallback = code.data[18 len 1710]
...
function sub_3ed48679(?) payable {
    ...
    call address(stor1).0xa1add510 with:
         gas gas_remaining - 25050 wei
        args name, 0x7369676e65720000000000000000000000000000000000000000000000000000, msg.sender
    require ext_call.success
    if not ext_call.return_data[0]:
        return 0
    call address(stor1).0x2ade6c36 with:
         gas gas_remaining - 25050 wei
        args 0x657a636f696e0000000000000000000000000000000000000000000000000000
    require ext_call.success
