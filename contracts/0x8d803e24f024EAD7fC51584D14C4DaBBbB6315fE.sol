...
function distributeReservedTokens(uint256 arg1) payable {
    ...
    if uint8(var25014) >= 0:
        ...
        call tokenAddress.0xc3310517 with:
             gas gas_remaining - 710 wei
        require ext_call.success
        require ext_code.size(0x687b469bb28f2957a4f82234b5e717b88ac8d468)
        delegate 0x687b469bb28f2957a4f82234b5e717b88ac8d468.minus(uint256 arg1, uint256 arg2) with:
             gas gas_remaining - 710 wei
        ...
        require ext_code.size(0x687b469bb28f2957a4f82234b5e717b88ac8d468)
        delegate 0x687b469bb28f2957a4f82234b5e717b88ac8d468.mem[var37002 len 4] with:
             gas gas_remaining - 710 wei
        ...
        while uint8(idx + 1) < uint8(ext_call.return_data[0]):
            ...
            mem[132] = ext_call.return_data[0]
            require ext_code.size(0x687b469bb28f2957a4f82234b5e717b88ac8d468)
            delegate 0x687b469bb28f2957a4f82234b5e717b88ac8d468.plus(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining - 710 wei
