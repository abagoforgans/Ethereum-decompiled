...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'IotaGold' / 256
    idx = 0
    ...
    stor1.length.field_8 = 'IOTAG' / 256
    idx = 0
    ...
    stor7 = 27795302800
    stor3[code.data[5401 len 20]] = 27795302800
    emit Transfer(27795302800, 0, code.data[5401 len 20]);
    return code.data[738 len 4651]
}
