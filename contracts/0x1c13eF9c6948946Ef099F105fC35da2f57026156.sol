...
function _fallback() payable {
    ...
    mem[96 len -2311] = code.data[2646 len -2311]
    mem[64] = -2215
...
function sub_ffe6e7d7(?) {
    return sub_ffe6e7d7[0 len sub_ffe6e7d7.length]
}
