...
function payout() payable {
    if block.number - stor2[address(msg.sender)].field_512 >= 30240:
        if eth.balance(this.address) >= (stor2[address(msg.sender)].field_256 * stor0 * block.number - stor2[address(msg.sender)].field_512 / 30240 / 100) + stor2[address(msg.sender)].field_256:
            call msg.sender with:
               value (stor2[address(msg.sender)].field_256 * stor0 * block.number - stor2[address(msg.sender)].field_512 / 30240 / 100) + stor2[address(msg.sender)].field_256 wei
                 gas 0 wei
