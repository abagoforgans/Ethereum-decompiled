...
function dayFor(uint256 arg1, uint256 arg2) {
    if arg1 < arg2:
        return 0
    return ((arg1 - arg2 / 24 * 3600) + 1)
}

function today(uint256 arg1) {
    if block.timestamp < arg1:
        return 0
    return ((block.timestamp - arg1 / 24 * 3600) + 1)
}
...
function adjustSupply(uint256 arg1, uint256 arg2, uint256 arg3) {
    require msg.sender == etherProceedsAccount
    window0TotalSupply = arg1
    window1TotalSupply = arg2
    window2TotalSupply = arg3
}
...
function adjustCap(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) {
    require msg.sender == etherProceedsAccount
    preservedTokens = arg1
    window0TokenCreationCap = arg2
    window1TokenCreationCap = arg3
    window2TokenCreationCap = arg4
}
