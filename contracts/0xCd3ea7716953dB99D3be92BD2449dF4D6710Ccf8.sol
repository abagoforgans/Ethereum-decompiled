...
function _fallback() payable {
    ...
    Mask(192, 0, stor10.field_64) = Mask(192, 0, code.data[2828 len 32])
    return code.data[789 len 2039]
}
...
uint8 stor10;
uint8 status; offset 128
uint8 stor10; offset 136
uint64 sub_7cd87ba2;
uint64 sub_d826dbd3; offset 64

function getStatus() payable {
    return status
}

function sub_7cd87ba2(?) payable {
    return sub_7cd87ba2
}

function getFund() payable {
    return fundAddress
}

function sub_d826dbd3(?) payable {
    return sub_d826dbd3
}
...
function get() payable {
    if stor7.length:
        ...
        while stor7.length + 128 > idx:
            ...
            s = s + 1
            continue 
    return uint8(stor10.field_0), fundAddress, sub_7cd87ba2, sub_7cd87ba2, Array(len=stor7.length, data=mem[160 len stor7.length])
}
