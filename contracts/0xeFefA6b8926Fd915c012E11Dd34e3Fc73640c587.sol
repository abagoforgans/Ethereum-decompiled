...
function getFee(uint256 arg1) {
    ...
    while idx < ethRate.length:
        ...
        t = (10 * t) + mem[idx + 405 len 1] - 48
        continue 
    mem[ceil32(ethRate.length) + 437] = uint256(stor13.field_0)
    idx = ceil32(ethRate.length) + 437
    u = 0
    while ceil32(ethRate.length) + stor13.length + 405 > idx:
        mem[idx + 32] = stor13[u].field_256
        idx = idx + 32
        u = u + 1
        continue 
    u = 0
