...
function PUNCToken() {
    ...
    symbol.length.field_8 = 'PUNC' / 256
    idx = 0
    while symbol.length + 31 / 32 > idx:
        ...
        continue 
    bool(name.length) = 0
    name.length.field_1 = 19
    name.length.field_8 = 'PureNatureCoinToken' / 256
    idx = 0
    ...
    balanceOf[0xf58a749ab4929b462f33b8a07f1e3b568ed8ec43] = _totalSupply
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  _totalSupply,
    emit 0x0: _totalSupply
    emit 0xf58a749a: _totalSupply
}
