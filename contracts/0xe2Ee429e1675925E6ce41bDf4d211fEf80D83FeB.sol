...
function _fallback() payable {
    mem[96 len -1761] = code.data[2202 len -1761]
    mem[64] = -1665
...
function reFund() {
    ...
    if sub_f29eff1c[address(msg.sender)] > 0:
        call msg.sender with:
           value sub_f29eff1c[address(msg.sender)] wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
    sub_b8491317 -= balances[address(msg.sender)].field_0
    balances[address(msg.sender)].field_0 = 0
    balances[stor2].field_0 = stor7
    totalSupply = balances[stor2].field_0 + sub_b8491317
    emit Transfer(balances[address(msg.sender)].field_0, msg.sender, this.address);
    return 1
}
