...
function _fallback() {
    ...
    stor2.length.field_8 = 'VPC0x' / 256
    idx = 0
    ...
    stor3.length.field_8 = 'VotePumpCOin0x' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        ...
        continue 
    stor4 = 18
    stor5 = 46000000 * 10^18
    stor6[stor0] = 46000000 * 10^18
    emit Transfer(46000000 * 10^18, 0, stor0);
    return code.data[476 len 2920]
}
