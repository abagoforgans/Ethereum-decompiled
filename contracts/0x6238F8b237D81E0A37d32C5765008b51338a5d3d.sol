...
function _fallback() payable {
    stor2 = 0xd43d09ec1bc5e57c8f3d0c64020d403b04c7f783
    stor3 = 0xb97048628db6b661d4c2aa833e95dbe1a905b280
...
function claim() payable {
    require block.number >= 3930000
    require ext_code.size(tokenAddress)
    call tokenAddress.0x70a08231 with:
         gas gas_remaining - 710 wei
        args this.address
    require ext_call.success
    require ext_call.return_data[0] - total_pay_claimed >= block.number - 3930000 / 10 * msg.value
    pay_claimed[address(msg.sender)] += block.number - 3930000 / 10 * msg.value
    total_pay_claimed += block.number - 3930000 / 10 * msg.value
    call stor4 with:
       value msg.value wei
