...
function _fallback() payable {
    ...
    mem[96 len -6330] = code.data[6898 len -6330]
    mem[64] = -6234
    stor8 = msg.sender
    stor3 = msg.sender
...
function transferToOwner(address arg1) {
    ...
    require balanceOf[address(arg1)] + balanceOf[stor3] >= balanceOf[stor3]
...
function mint(address arg1, uint256 arg2) {
    ...
    require not stor6
    require ext_code.size(0xe07bbd290c9a647493bd7c45101ad4385bf9680a)
    delegate 0xe07bbd290c9a647493bd7c45101ad4385bf9680a.0x66098d4f with:
         gas gas_remaining - 710 wei
