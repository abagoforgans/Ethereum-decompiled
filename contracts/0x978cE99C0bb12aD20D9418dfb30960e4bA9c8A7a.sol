...
function participants(uint256 arg1) payable {
    require arg1 < stor0
    return address(stor5629[arg1]), uint256(stor[code.data[1123 len 32] + (2 * arg1)])
}
    ...
    if msg.value < 5 * 10^18:
        ...
        if balance > 155 * uint256(stor[code.data[1123 len 32] + (2 * stor1.length)]) / 100:
            ...
            call address(stor5629[stor1.length]) with:
               value 49 * uint256(stor[code.data[1123 len 32] + (2 * stor1.length)]) / 50 wei
                 gas 0 wei
            balance -= 2 * uint256(stor[code.data[1123 len 32] + (2 * stor1.length)])
            stor1.length++
            s = 49 * uint256(stor[code.data[1123 len 32] + (2 * stor1.length)]) / 50
            while balance > 155 * uint256(stor[code.data[1123 len 32] + (2 * stor1.length)]) / 100:
                require stor1.length < stor0
                call address(stor5629[stor1.length]) with:
                   value 49 * uint256(stor[code.data[1123 len 32] + (2 * stor1.length)]) / 50 wei
                     gas 0 wei
