...
function redeem(bytes arg1, bytes arg2) payable {
    ...
    if arg1.length != 65:
        ...
        if sub_76748bfe[address(s)].field_256 / sub_76748bfe[address(s)].field_512:
            ...
            _457 = mem[_454]
            mem[mem[64] len floor32(mem[_454])] = mem[_454 + 32 len floor32(mem[_454])]
            mem[mem[64] + floor32(mem[_454]) + -(mem[_454] % 32) + 32 len mem[_454] % 32] = mem[_454 + floor32(mem[_454]) + -(mem[_454] % 32) + 64 len mem[_454] % 32]
            call sub_76748bfe[address(s)].field_0 with:
                 gas gas_remaining wei
                args mem[mem[64] + 4 len _457 + _453 + -mem[64] + 96]
            if return_data.size:
                _677 = mem[64]
        ...
        if Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', 192, 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', 192, 32))), 0) - 256 >= 27:
            ...
            if sub_76748bfe[address(s)].field_256 / sub_76748bfe[address(s)].field_512:
                ...
                _437 = mem[_434]
                mem[mem[64] len floor32(mem[_434])] = mem[_434 + 32 len floor32(mem[_434])]
                mem[mem[64] + floor32(mem[_434]) + -(mem[_434] % 32) + 32 len mem[_434] % 32] = mem[_434 + floor32(mem[_434]) + -(mem[_434] % 32) + 64 len mem[_434] % 32]
                call sub_76748bfe[address(s)].field_0 with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _437 + _433 + -mem[64] + 96]
                if return_data.size:
                    _673 = mem[64]
                    mem[64] = mem[64] + ceil32(return_data.size) + 1
                    mem[_673] = return_data.size
                    mem[_673 + 32 len return_data.size] = ext_call.return_data[0 len return_data.size]
                require ext_call.success
                if return_data.size:
                    require return_data.size == 32
                require sub_76748bfe[address(s)].field_256 / sub_76748bfe[address(s)].field_512 <= ext_call.return_data[0]
            ...
            if 27 == uint8((Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', 192, 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', 192, 32))), 0) - 256) + 27):
                ...
                if sub_76748bfe[address(s)].field_256 / sub_76748bfe[address(s)].field_512:
                    ...
                    _442 = mem[_439]
                    mem[mem[64] len floor32(mem[_439])] = mem[_439 + 32 len floor32(mem[_439])]
                    mem[mem[64] + floor32(mem[_439]) + -(mem[_439] % 32) + 32 len mem[_439] % 32] = mem[_439 + floor32(mem[_439]) + -(mem[_439] % 32) + 64 len mem[_439] % 32]
                    call sub_76748bfe[address(s)].field_0 with:
                         gas gas_remaining wei
                        args mem[mem[64] + 4 len _442 + _438 + -mem[64] + 96]
                    if return_data.size:
                        _674 = mem[64]
                        mem[64] = mem[64] + ceil32(return_data.size) + 1
                ...
                if uint8((Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', 192, 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', 192, 32))), 0) - 256) + 27) != 28:
                    ...
                    if sub_76748bfe[address(s)].field_256 / sub_76748bfe[address(s)].field_512:
                        ...
                        _452 = mem[_449]
                        mem[mem[64] len floor32(mem[_449])] = mem[_449 + 32 len floor32(mem[_449])]
                        mem[mem[64] + floor32(mem[_449]) + -(mem[_449] % 32) + 32 len mem[_449] % 32] = mem[_449 + floor32(mem[_449]) + -(mem[_449] % 32) + 64 len mem[_449] % 32]
                        call sub_76748bfe[address(s)].field_0 with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _452 + _448 + -mem[64] + 96]
                        if return_data.size:
                            _676 = mem[64]
                            mem[64] = mem[64] + ceil32(return_data.size) + 1
                    ...
                    if sub_76748bfe[address(s)].field_256 / sub_76748bfe[address(s)].field_512:
                        ...
                        _447 = mem[_444]
                        mem[mem[64] len floor32(mem[_444])] = mem[_444 + 32 len floor32(mem[_444])]
                        mem[mem[64] + floor32(mem[_444]) + -(mem[_444] % 32) + 32 len mem[_444] % 32] = mem[_444 + floor32(mem[_444]) + -(mem[_444] % 32) + 64 len mem[_444] % 32]
                        call sub_76748bfe[address(s)].field_0 with:
                             gas gas_remaining wei
                            args mem[mem[64] + 4 len _447 + _443 + -mem[64] + 96]
                        if return_data.size:
                            _675 = mem[64]
                            mem[64] = mem[64] + ceil32(return_data.size) + 1
...
function sub_3f22fa97(?) payable {
    ...
    if not arg1.length:
        ...
        mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(arg4.length) + 224 len 32 * arg1.length] = code.data[7769 len 32 * arg1.length]
        idx = 0
        while idx < arg1.length:
            require idx < arg1.length
            _195 = mem[(32 * idx) + 128]
