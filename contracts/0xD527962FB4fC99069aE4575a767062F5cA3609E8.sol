...
function _fallback() {
    ...
    stor3.length.field_8 = 'LucidCube Power' / 256
    idx = 0
    ...
    stor4 = 8
    stor5 = 10^17
    stor6[0xa93e87515d7d158b2532529d605ef8a352ecb7f] = stor5
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  stor5,
    emit 0x0: stor5
    emit 0xa93e8751: stor5
    return code.data[690 len 5596]
}
