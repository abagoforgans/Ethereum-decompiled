...
function _fallback() payable {
    ...
    if msg.value <= 0:
        ...
        require block.number >= sub_2df5e84b + 42
        ...
        if 20 * 10^18 > sub_4bde9006:
            sub_4bde9006 += msg.value / 5
        ...
        if totalInvested <= 20 * 10^18:
            ...
            if 50 * 10^18 >= totalInvested:
                ...
                while idx < queue.length:
                    require currentReceiverIndex + idx < queue.length
                    if 117 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100 <= stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512:
                        if t < s:
                            call stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_0 with:
                               value t wei
                                 gas 2300 * is_zero(value) wei
                            ...
                            if s <= 0:
                                ...
                                if gas_remaining > 55000:
                                    s = s
                                    t = 117 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100
                                    t = (3 * currentReceiverIndex) + (3 * idx) + sha3(4)
                                    t = currentReceiverIndex + idx
                                    idx = idx + 1
                                    t = t
                        ...
                        if t < (117 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100) - stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512:
                            call stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_0 with:
                               value t wei
                                 gas 2300 * is_zero(value) wei
                            stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512 += t
                        else:
                            if (117 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100) - stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512 <= 0:
                                mem[32] = 5
                                sub_1c603964[stor[(3 * stor6) + (3 * idx) + ('name', 'stor4', 4)].field_0] = 0
                                require currentReceiverIndex + idx < queue.length
                                mem[0] = 4
                                ...
                                stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512 = 0
                                if gas_remaining > 55000:
                                    s = (117 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100) - stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512
                                    t = 117 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100
                                    t = (3 * currentReceiverIndex) + (3 * idx) + sha3(4)
                                    t = currentReceiverIndex + idx
                                    idx = idx + 1
                                ...
                                call stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_0 with:
                                   value (117 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100) - stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512 wei
                                     gas 2300 * is_zero(value) wei
                                mem[32] = 5
                                sub_1c603964[stor[(3 * stor6) + (3 * idx) + ('name', 'stor4', 4)].field_0] = 0
                                require currentReceiverIndex + idx < queue.length
                                ...
                                if gas_remaining > 55000:
                                    ...
                                    t = currentReceiverIndex + idx
                                    idx = idx + 1
                                    t = t - (117 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100) + stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512
                                    continue 
                            ('le', 'gas', 55000)
                    currentReceiverIndex += idx
            else:
                if 100 * 10^18 >= totalInvested:
                    ...
                    if 200 * 10^18 < totalInvested:
                        ...
                        while idx < queue.length:
                            require currentReceiverIndex + idx < queue.length
                            if 113 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100 <= stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512:
                                if t < s:
                                    call stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_0 with:
                                       value t wei
                                         gas 2300 * is_zero(value) wei
                                    ...
                                    if s <= 0:
                                        ...
                                        if gas_remaining > 55000:
                                            s = s
                                            t = 113 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100
                                            t = (3 * currentReceiverIndex) + (3 * idx) + sha3(4)
                                            t = currentReceiverIndex + idx
                                            idx = idx + 1
                                            t = t
                                ...
                                if t < (113 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100) - stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512:
                                    call stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_0 with:
                                       value t wei
                                         gas 2300 * is_zero(value) wei
                                    stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512 += t
                                else:
                                    if (113 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100) - stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512 <= 0:
                                        mem[32] = 5
                                        sub_1c603964[stor[(3 * stor6) + (3 * idx) + ('name', 'stor4', 4)].field_0] = 0
                                        require currentReceiverIndex + idx < queue.length
                                        mem[0] = 4
                                        ...
                                        stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512 = 0
                                        if gas_remaining > 55000:
                                            s = (113 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100) - stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512
                                            t = 113 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100
                                            t = (3 * currentReceiverIndex) + (3 * idx) + sha3(4)
                                            t = currentReceiverIndex + idx
                                            idx = idx + 1
                                        ...
                                        call stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_0 with:
                                           value (113 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100) - stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512 wei
                                             gas 2300 * is_zero(value) wei
                                        mem[32] = 5
                                        sub_1c603964[stor[(3 * stor6) + (3 * idx) + ('name', 'stor4', 4)].field_0] = 0
                                        require currentReceiverIndex + idx < queue.length
                                        ...
                                        if gas_remaining > 55000:
                                            ...
                                            t = currentReceiverIndex + idx
                                            idx = idx + 1
                                            t = t - (113 * stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_256 / 100) + stor[(3 * stor6) + (3 * idx) + ('name', 'queue', 4)].field_512
                                            continue 
                                    ('le', 'gas', 55000)
                            currentReceiverIndex += idx
        currentReceiverIndex += idx
