...
function _fallback() payable {
    stor261 = 2
    mem[96 len -3849] = code.data[4079 len -3849]
    mem[64] = -3753
...
function getOwnerAt(uint256 arg1) {
    require arg1 < 256
    return address(ownerAt[arg1].field_0)
}
            ...
            if stor259[call.data[0 len calldata.size]][block.number].field_0 > 1:
                ...
                if stor258[address(arg2)] <= 0:
                    if stor258[address(arg1)]:
                        ...
                        address(ownerAt[stor258[address(arg1)]].field_0) = arg2
                        Mask(96, 0, ownerAt[stor258[address(arg1)]].field_160) = 0
...
function removeOwner(address arg1) {
    ...
    if stor259[call.data[0 len calldata.size]][block.number].field_0:
        ...
        require stor258[address(arg1)] < 256
        ownerAt[stor258[address(arg1)]].field_0 = 0
        stor258[address(arg1)] = 0
        idx = 0
        while idx < stor260.length:
            mem[0] = stor260[idx]
