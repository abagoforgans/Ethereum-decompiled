...
function _fallback() payable {
    ...
    require code.data[20756 len 32] >= block.number
    require code.data[20788 len 32] >= code.data[20756 len 32]
    require code.data[20820 len 32] >= code.data[20788 len 32]
    stor0 = code.data[20736 len 20]
    create contract with 0 wei
                    code: code.data[14897 len 5827], 10^18, 160, 9, 224, address(this.address), 6, 'Leverj' << 208, 3, 'LEV' % 16777216
    require create.new_address
    stor2 = address(create.new_address)
    stor3 = code.data[20756 len 32]
    stor4 = code.data[20788 len 32]
    stor5 = code.data[20820 len 32]
    ...
    return code.data[1899 len 12998]
}
...
function presale_price_in_wei() {
    return presale_price_in_wei
}
...
function lockUnsoldTokens(address arg1) {
    ...
    require msg.sender == owner
    create contract with 0 wei
                    code: code.data[10438 len 2517], address(arg1), 8760 * 24 * 3600, block.timestamp
    require create.new_address
...
function distributeTimelockedTokens(address[] arg1, uint256[] arg2, uint256[] arg3, uint256[] arg4) {
    ...
    while idx < arg1.length:
        ...
        mem[mem[64] len 2517] = code.data[10438 len 2517]
        mem[mem[64] + 2517] = address(_57)
        mem[mem[64] + 2549] = _61
        mem[mem[64] + 2581] = _63
        create contract with 0 wei
                        code: code.data[10438 len 2517], address(_57), _61, _63
        require create.new_address
        require ext_code.size(address(create.new_address))
        call address(create.new_address).setup(address rg1) with:
             gas gas_remaining - 710 wei
