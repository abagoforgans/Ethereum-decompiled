...
const _fallback = code.data[18 len 4067]
...
function sub_63be1d22(?) payable {
    ...
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 320 len 222] = code.data[3845 len 222]
    idx = 0
    s = 0
    while idx < arg1.length:
        require idx < arg1.length
...
function register(string arg1, uint256 arg2) payable {
    ...
    if msg.value != 0:
        ...
        mem[ceil32(arg1.length) + 352 len 222] = code.data[3845 len 222]
        idx = 0
        s = 0
        while idx < 7:
            require idx < 7
        ...
        mem[ceil32(arg1.length) + 800 len 222] = code.data[3845 len 222]
        idx = 0
        s = 0
        while idx < mem[ceil32(arg1.length) + 320]:
            require idx < mem[ceil32(arg1.length) + 320]
        ...
        _264 = mem[ceil32(arg1.length) + 768]
        ...
        if not _264 % 32:
            call address(stor0.field_0).0xadf59f99 with:
                 gas gas_remaining - 25050 wei
                args arg2, 96, 160, 12, 'WolframAlpha', mem[mem[64] + 164 len _264 + 32]
        else:
            mem[floor32(_264) + mem[64] + 196] = mem[floor32(_264) + mem[64] + -(_264 % 32) + 228 len _264 % 32]
            call address(stor0.field_0).0xadf59f99 with:
                 gas gas_remaining - 25050 wei
                args arg2, 96, 160, 12, 'WolframAlpha', mem[mem[64] + 164 len floor32(_264) + 64]
        require ext_call.success
