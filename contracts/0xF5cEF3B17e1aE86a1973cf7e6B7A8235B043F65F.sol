...
function _fallback() payable {
    ...
    stor1 = code.data[5215 len 32]
    stor2 = code.data[5247 len 32]
    ...
    if address(code.data[5311 len 32]) != 0:
        stor0 = code.data[5311 len 32] or Mask(96, 160, stor0)
    return code.data[622 len 4593]
}
