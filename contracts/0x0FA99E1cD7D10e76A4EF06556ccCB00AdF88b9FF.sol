...
function sub_d7da3662(?) payable {
    ...
    emit 0x2153f79b: address(arg1), stor9
    stor9 = 0
}
...
function sub_56bab09f(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit 0x63814986: address(arg1), stor10
    stor10 = 0
}
...
function withdraw(uint256 arg1) payable {
    if not stor6[msg.sender][arg1].field_2048:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        emit 0xdb3540a4: msg.sender, arg1, stor12 - stor6[msg.sender][arg1].field_1280 - stor6[msg.sender][arg1].field_1536 - stor6[msg.sender][arg1].field_2304
        if stor6[msg.sender][arg1].field_512 > 0:
            stor6[msg.sender][arg1].field_1792 = stor6[msg.sender][arg1].field_512
            emit 0x4407b81c: msg.sender, arg1, stor6[msg.sender][arg1].field_512
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        emit 0xdb3540a4: msg.sender, arg1, stor6[msg.sender][arg1].field_2560 - stor6[msg.sender][arg1].field_1280 - stor6[msg.sender][arg1].field_1536 - stor6[msg.sender][arg1].field_2304
        if stor6[msg.sender][arg1].field_512 > 0:
            stor6[msg.sender][arg1].field_1792 = stor6[msg.sender][arg1].field_512
            emit 0x4407b81c: msg.sender, arg1, stor6[msg.sender][arg1].field_512
        stor6[msg.sender][arg1].field_512 = 0
