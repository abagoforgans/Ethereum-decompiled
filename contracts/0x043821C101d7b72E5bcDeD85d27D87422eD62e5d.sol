...
function transfer(address arg1, uint256 arg2) {
    ...
    if ext_code.size(arg1) > 0:
        ...
        call arg1.tokenFallback(address arg1, uint256 arg2, bytes arg3) with:
            ...
            args msg.sender, arg2, Array(len=1, data=code.data[5894 len 1])
...
function lockBalance(uint256 arg1, uint256 arg2) {
    ...
    require arg1 + block.timestamp >= block.timestamp
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if ext_code.size(arg2) > 0:
        ...
        call arg2.tokenFallback(address arg1, uint256 arg2, bytes arg3) with:
             gas gas_remaining wei
            args msg.sender, arg3, Array(len=1, data=code.data[5894 len 1])
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    require arg3 <= balanceOf[address(arg1)]
...
function transferdata(address arg1, uint256 arg2, bytes arg3) payable {
    ...
    emit Transferdata(arg2, msg.sender, arg1, sha3(call.data[arg3 + 36 len floor32(arg3.length)], mem[ceil32(arg3.length) + floor32(arg3.length) + 128 len arg3.length % 32]));
}
    ...
    while idx < arg3:
        ...
        if ext_code.size(mem[(32 * idx) + 128]) <= 0:
            ...
            if idx < mem[96]:
                ...
                mem[mem[64]] = 1
                mem[64] = mem[64] + 64
                mem[_71 + 32] = code.data[5863 len 32]
                if idx < mem[(32 * arg1.length) + 128]:
                    ...
                    if not mem[_71] % 32:
                        ...
                        call address(_70).tokenFallback(address arg1, uint256 arg2, bytes arg3) with:
                             gas gas_remaining wei
