...
function _fallback() payable {
    ...
    stor8 = code.data[13375 len 20]
    require ext_code.size(code.data[13375 len 20])
    call code.data[13375 len 20].0x7bd2bea7 with:
    ...
    stor5 = code.data[13407 len 20]
    require ext_code.size(code.data[13407 len 20])
    call code.data[13407 len 20].0x9166cba4 with:
         gas gas_remaining - 710 wei
    require ext_call.success
    ...
    stor9 = code.data[13439 len 20]
    stor10 = code.data[13471 len 20]
    ...
    stor2 = code.data[13503 len 20]
    require ext_code.size(code.data[13503 len 20])
    call code.data[13503 len 20].0x143e55e0 with:
         gas gas_remaining - 710 wei
    require ext_call.success
    stor13 = uint64(ext_call.return_data[0])
    return code.data[1136 len 12227]
}
...
function sub_6299c83e(?) {
    ...
    if not reg:
        if tax != 1:
            ...
            rho = uint64(ext_call.return_data[0])
    require uint128(stor14.field_0)
    require (1000000000 * 10^18 * uint128(arg2)) + Mask(127, 0, stor14.field_1) / uint128(stor14.field_0) == uint128((1000000000 * 10^18 * uint128(arg2)) + Mask(127, 0, stor14.field_1) / uint128(stor14.field_0))
    require uint128(ink[arg1].field_256 - ((1000000000 * 10^18 * uint128(arg2)) + Mask(127, 0, stor14.field_1) / uint128(stor14.field_0))) <= ink[arg1].field_256
