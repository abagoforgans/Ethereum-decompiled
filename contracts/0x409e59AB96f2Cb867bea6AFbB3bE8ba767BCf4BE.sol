...
function sub_071c3c7a(?) {
    ...
    require stor4
    require stor5
    if not (20 * 10^18 * defaultAmount / stor5 * 997000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0]) / 10^18) - (10 * 10^18 * defaultAmount / stor4 * 997000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0]) / 10^18):
    ...
    if (20 * 10^18 * defaultAmount / stor5 * 997000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0]) / 10^18) - (10 * 10^18 * defaultAmount / stor4 * 997000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0]) / 10^18) <= 3:
        ...
        return (-1000 * eth.balance(ext_call.return_data[0])) + 1 / 997, 
               ...
               address(ext_call.return_data[0]),
               stor4 - (9970 * defaultAmount * eth.balance(ext_call.return_data[0]) / (1000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) + (9970 * defaultAmount))
    s = (20 * 10^18 * defaultAmount / stor5 * 997000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0]) / 10^18) + (-1 * 10 * 10^18 * defaultAmount / stor4 * 997000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0]) / 10^18) + 1 / 2
    t = (20 * 10^18 * defaultAmount / stor5 * 997000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0]) / 10^18) - (10 * 10^18 * defaultAmount / stor4 * 997000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0]) / 10^18)
    while s < t:
        require s
        s = ((20 * 10^18 * defaultAmount / stor5 * 997000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0]) / 10^18) - (10 * 10^18 * defaultAmount / stor4 * 997000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) * eth.balance(ext_call.return_data[0]) / 10^18) / s) + s / 2
        t = s
        continue 
...
function sub_778e4cd7(?) {
    ...
    require stor5
    require stor4
    if not (10 * 10^18 * defaultAmount / stor4 * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) / 10^18) - (20 * 10^18 * defaultAmount / stor5 * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) / 10^18):
    ...
    if (10 * 10^18 * defaultAmount / stor4 * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) / 10^18) - (20 * 10^18 * defaultAmount / stor5 * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) / 10^18) <= 3:
        ...
        return (-1000 * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18)) + 1 / 997, 
               ...
               address(ext_call.return_data[0]),
               stor4 - (10^18 * defaultAmount / 997 * defaultAmount * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) / (1000 * eth.balance(ext_call.return_data[0])) + (997 * defaultAmount))
    s = (10 * 10^18 * defaultAmount / stor4 * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) / 10^18) + (-1 * 20 * 10^18 * defaultAmount / stor5 * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) / 10^18) + 1 / 2
    t = (10 * 10^18 * defaultAmount / stor4 * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) / 10^18) - (20 * 10^18 * defaultAmount / stor5 * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) / 10^18)
    while s < t:
        require s
        s = ((10 * 10^18 * defaultAmount / stor4 * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) / 10^18) - (20 * 10^18 * defaultAmount / stor5 * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] * 10^(-ext_call.return_data[0] + 18) / 10^18) / s) + s / 2
        t = s
        continue 
