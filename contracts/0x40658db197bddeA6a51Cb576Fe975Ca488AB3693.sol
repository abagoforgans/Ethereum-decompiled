...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor1 = msg.sender
    stor3F0 = code.data[7431 len 20]
    stor3F1 = code.data[7463 len 20]
    stor3F2 = code.data[7495 len 20]
    return code.data[167 len 7252]
}
...
address affiliateNetworkAddress;
...
function affiliateNetwork() {
    return affiliateNetworkAddress
}
...
function needsLotteryFinalization() {
    ...
    if -1 == ticketOwner[stor3].field_256:
        return ticketOwner[stor3].field_256 != -1
...
function getFullTicketDetails(int256 arg1, uint256 arg2, uint256 arg3) {
    ...
    while idx < arg3:
        ...
        require idx < arg3
        mem[(32 * idx) + 160] = ticketOwner[arg1][11][idx + arg2].field_0
        idx = idx + 1
        continue 
...
function initLottery(uint256 arg1, uint256 arg2, uint256 arg3) {
    if owner != msg.sender:
    ...
    ticketOwner[stor3].field_256 = -1
    ticketOwner[stor3].field_512 = arg2
    ticketOwner[stor3].field_1024 = arg3
    ticketOwner[stor3].field_1536 = -1
    require arg2
    ticketOwner[stor3].field_1280 = arg3 - (arg1 / arg2) / 2
    ticketOwner[stor3].field_1535 = 0
...
function buyTickets(uint256[] arg1, uint256 arg2, uint256 arg3) payable {
    mem[128 len 32 * arg1.length] = call.data[arg1 + 36 len 32 * arg1.length]
    require id >= 0
    if ticketOwner[stor3].field_768 == ticketOwner[stor3].field_512:
        emit PurchaseFailed(arg2, 0, msg.sender);
        ...
        while idx < arg1.length:
            ...
            if not ticketOwner[stor3][11][mem[(32 * idx) + 128]].field_0:
                s = mem[(32 * idx) + 128]
                idx = idx + 1
                continue 
            emit PurchaseFailed(arg2, 1, msg.sender);
            call msg.sender with:
               value msg.value wei
                 gas 2300 * is_zero(value) wei
            require ext_call.success
        ...
        require ext_code.size(affiliateNetworkAddress)
        call affiliateNetworkAddress.0x3fb8b692 with:
             gas gas_remaining - 710 wei
            args arg3
        require ext_call.success
        if ext_call.return_data[12 len 20]:
            call address(ext_call.return_data[0]) with:
               value ticketOwner[stor3].field_1280 * arg1.length wei
                 gas 35000 wei
        emit PurchaseSuccessful(arg2, msg.sender);
}
...
function needsBlockFinalization() {
    ...
    while idx < 32:
        require idx + 68 / 32 < 5
        require idx + 68 % 32 < 32
        s = Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 256, ('mask_shl', 251, 5, 0, ('add', 68, ('var', 0)))), 32))), 0) + 256, idx + 68 % 32) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 256, ('mask_shl', 251, 5, 0, ('add', 68, ('var', 0)))), 32))), 0) - 8
        s = idx + 68
        idx = idx + 1
        s = s or Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 256, ('mask_shl', 251, 5, 0, ('add', 68, ('var', 0)))), 32))), 0) + 256, idx + 68 % 32) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 256, ('mask_shl', 251, 5, 0, ('add', 68, ('var', 0)))), 32))), 0) - 256 * 256^idx
        continue 
    s = 256
    s = 2176
    idx = 0
    s = 0
    while idx < 4:
        require idx + 132 / 32 < 5
        require idx + 132 % 32 < 32
        s = Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 256, ('mask_shl', 251, 5, 0, ('add', 132, ('var', 0)))), 32))), 0) + 256, idx + 132 % 32) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 256, ('mask_shl', 251, 5, 0, ('add', 132, ('var', 0)))), 32))), 0) - 8
        s = idx + 132
        idx = idx + 1
        s = s or Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 256, ('mask_shl', 251, 5, 0, ('add', 132, ('var', 0)))), 32))), 0) + 256, idx + 132 % 32) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 256, ('mask_shl', 251, 5, 0, ('add', 132, ('var', 0)))), 32))), 0) - 256 * 256^idx
        continue 
    if s << 160 < block.timestamp:
        if block.timestamp - (s << 160) >= 2 * 3600:
            return (block.timestamp - (s << 160) < 2 * 3600)
    if ticketOwner[stor3].field_768 != ticketOwner[stor3].field_512:
        return (ticketOwner[stor3].field_768 == ticketOwner[stor3].field_512)
    return (-1 == ticketOwner[stor3].field_256)
}
...
function finalizeBlock() {
    ...
    while idx < 4:
        ...
        continue 
    if s << 160 < block.timestamp:
        require block.timestamp - (s << 160) < 2 * 3600
    require ticketOwner[stor3].field_768 == ticketOwner[stor3].field_512
    require -1 == ticketOwner[stor3].field_256
    require ext_code.size(btcRelayAddress)
    call btcRelayAddress.getLastBlockHeight() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    ticketOwner[stor3].field_256 = ext_call.return_data[0] + 54
}
...
function finalizeLottery(uint256 arg1) payable {
    ...
    require ext_call.success
    require ticketOwner[stor3].field_256 != -1
    ...
    if ticketOwner[stor3].field_3072 == ticketOwner[stor3].field_256:
        ...
        mem[0] = id
        if ticketOwner[stor3].field_3072:
            mem[0] = id
            mem[32] = 1007
            idx = 0
            s = stor13[sha3(mem[0 len 64])]
            t = stor12[sha3(mem[0 len 64])]
            while idx < arg1:
                _81 = mem[64]
                mem[64] = mem[64] + 160
                mem[_81] = 0
                ...
                while idx < 32:
                    require idx + 68 / 32 < 5
                    require idx + 68 % 32 < 32
                    s = Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 68, ('var', 0))), ('var', '_99')), 32))), 0) + 256, idx + 68 % 32) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 68, ('var', 0))), ('var', '_99')), 32))), 0) - 8
                    s = idx + 68
                    idx = idx + 1
                    s = s or Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 68, ('var', 0))), ('var', '_99')), 32))), 0) + 256, idx + 68 % 32) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 68, ('var', 0))), ('var', '_99')), 32))), 0) - 256 * 256^idx
                    continue 
                t = 256
                t = 2176
                t = 0
                ...
                while t < 4:
                    require t + 132 / 32 < 5
                    require t + 132 % 32 < 32
                    t = Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 132, ('var', 2))), ('var', '_99')), 32))), 0) + 256, t + 132 % 32) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 132, ('var', 2))), ('var', '_99')), 32))), 0) - 8
                    t = t + 132
                    t = t + 1
                    u = u or Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 132, ('var', 2))), ('var', '_99')), 32))), 0) + 256, t + 132 % 32) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 132, ('var', 2))), ('var', '_99')), 32))), 0) - 256 * 256^t
                    continue 
                mem[0] = id
                mem[32] = 1007
                if ticketOwner[stor3].field_256 != 3:
                    t = 289
                    t = 0
                    t = 3
                    continue 
                ticketOwner[stor3].field_3072 = 3
                ticketOwner[stor3].field_3328 = 0
                ticketOwner[stor3].field_3333 = 0
        else:
            require ext_code.size(btcRelayAddress)
            call btcRelayAddress.getLastBlockHeight() with:
                 gas gas_remaining - 710 wei
            ...
            while idx < arg1:
                ...
                while idx < 32:
                    require idx + 68 / 32 < 5
                    require idx + 68 % 32 < 32
                    s = Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 68, ('var', 0))), ('var', '_100')), 32))), 0) + 256, idx + 68 % 32) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 68, ('var', 0))), ('var', '_100')), 32))), 0) - 8
                    s = idx + 68
                    idx = idx + 1
                    s = s or Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 68, ('var', 0))), ('var', '_100')), 32))), 0) + 256, idx + 68 % 32) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 68, ('var', 0))), ('var', '_100')), 32))), 0) - 256 * 256^idx
                    continue 
                t = 256
                t = 2176
                t = 0
                ...
                while t < 4:
                    require t + 132 / 32 < 5
                    require t + 132 % 32 < 32
                    t = Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 132, ('var', 2))), ('var', '_100')), 32))), 0) + 256, t + 132 % 32) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 132, ('var', 2))), ('var', '_100')), 32))), 0) - 8
                    t = t + 132
                    t = t + 1
                    u = u or Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 132, ('var', 2))), ('var', '_100')), 32))), 0) + 256, t + 132 % 32) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', ('mask_shl', 251, 5, 0, ('add', 132, ('var', 2))), ('var', '_100')), 32))), 0) - 256 * 256^t
                    continue 
                mem[0] = id
                mem[32] = 1007
                if ticketOwner[stor3].field_256 != 3:
                ...
                ticketOwner[stor3].field_3328 = 0
                ticketOwner[stor3].field_3333 = 0
        ticketOwner[stor3].field_3072 = t
        ticketOwner[stor3].field_3328 = s
}
