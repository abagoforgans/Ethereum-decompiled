...
function _fallback() payable {
    ...
    mem[96 len -2783] = code.data[3114 len -2783]
    mem[64] = -2687
...
function sub_53079c9f(?) {
    name[] = Array(len=arg1.length, data=arg1[all])
    return 1
}

function sub_c47494ad(?) {
...
function generate(uint256 arg1) {
    balanceOf[address(msg.sender)] += arg1
    totalSupply += arg1
    emit 0xf0edcfe7: arg1, msg.sender
    return 1
}
