...
function sub_6289efd8(?) {
    return address(sub_6289efd8Address)
}
...
function sub_b628becd(?) {
    return address(sub_b628becdAddress)
}
...
function sub_f91a7385(?) {
    if address(sub_b628becdAddress) != msg.sender:
        return 0
...
function sub_b985b718(?) {
    emit Created(arg1);
    uint256(stor3) = arg2 or Mask(96, 160, uint256(stor3))
    uint256(stor4) = arg3 or Mask(96, 160, uint256(stor4))
    balance[address(stor3)].field_0 = -stor5 + (stor6 * stor5)
    balance[address(stor3)].field_256 = 0
    balance[address(stor3)].field_512 = 1
    balance[address(stor4)].field_0 = stor5
    balance[address(stor4)].field_256 = 0
    balance[address(stor4)].field_512 = 1
    address(stor1[stor2]) = address(sub_6289efd8Address)
    stor2++
    address(stor1[stor2]) = address(sub_b628becdAddress)
    stor2++
    sub_1dd0563e[stor10].field_0 = block.timestamp
    sub_1dd0563e[stor10].field_256 = block.number
    sub_1dd0563e[stor10].field_512 = stor5
    sub_1dd0563e[stor10].field_768 = address(sub_b628becdAddress)
    sub_1dd0563e[stor10].field_1024 = address(sub_6289efd8Address)
    transactionCount++
    emit Transfer(stor5, address(sub_6289efd8Address), address(sub_b628becdAddress));
}
...
function sub_05dc2e51(?) payable {
    ...
    while idx < sub_bd0e5113:
        ...
        if sub_6f30e552[idx].field_0 <= 0:
            ...
            w = w
            continue 
        balance[address(stor4)].field_0 -= sub_6f30e552[idx].field_256
        balance[address(stor4)].field_512 = balance[address(stor4)].field_512
        ...
        mem[_21 + 128] = address(sub_b628becdAddress)
        ...
        sub_1dd0563e[stor10].field_1024 = address(sub_b628becdAddress)
        transactionCount++
        mem[mem[64]] = sub_6f30e552[idx].field_256
        emit Transfer(sub_6f30e552[idx].field_256, address(sub_b628becdAddress), sub_6f30e552[idx].field_512);
        mem[0] = idx
        mem[32] = 12
        ...
        t = sha3(address(sub_b628becdAddress), 0)
