...
function _fallback() payable {
    ...
    stor1 = code.data[10034 len 32]
    stor2 = code.data[10066 len 32]
    stor3 = code.data[10098 len 32]
    emit ChangeOfRules(stor1, stor2, stor3);
    if address(code.data[10130 len 32]):
        stor0 = address(code.data[10130 len 32])
    require msg.sender == stor0
    if stor6[0]:
    ...
    return code.data[1755 len 8279]
}
