...
function addNewBetAmount(uint256 arg1) {
    require msg.sender == stor0
    stor8[arg1] = 1
}
...
function finishSpin() {
    ...
    if block.number - playerSpins[address(msg.sender)].field_200 > 255:
        require playerSpins[address(msg.sender)].field_0 + balanceOf >= balanceOf
        balanceOf += playerSpins[address(msg.sender)].field_0
    ...
    if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 > 476662:
        ...
        if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 2:
            if not playerSpins[address(msg.sender)].field_0:
                ...
                require 500 * playerSpins[address(msg.sender)].field_0 <= balanceOf
                balanceOf += -500 * playerSpins[address(msg.sender)].field_0
                require ext_code.size(stor7)
                call stor7.0xa9059cbb with:
                     gas gas_remaining wei
            ...
            if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 299:
                if not playerSpins[address(msg.sender)].field_0:
                    ...
                    require 232 * playerSpins[address(msg.sender)].field_0 <= balanceOf
                    balanceOf += -232 * playerSpins[address(msg.sender)].field_0
                    require ext_code.size(stor7)
                    call stor7.0xa9059cbb with:
                         gas gas_remaining wei
                ...
                if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 3128:
                    if not playerSpins[address(msg.sender)].field_0:
                        ...
                        require 232 * playerSpins[address(msg.sender)].field_0 / 10 <= balanceOf
                        balanceOf -= 232 * playerSpins[address(msg.sender)].field_0 / 10
                        require ext_code.size(stor7)
                        call stor7.0xa9059cbb with:
                             gas gas_remaining wei
                    ...
                    if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 5957:
                        if not playerSpins[address(msg.sender)].field_0:
                            ...
                            require 25 * playerSpins[address(msg.sender)].field_0 <= balanceOf
                            balanceOf += -25 * playerSpins[address(msg.sender)].field_0
                            require ext_code.size(stor7)
                            call stor7.0xa9059cbb with:
                                 gas gas_remaining wei
                            ...
                            if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 11615:
                                ...
                                if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 14444:
                                    if not playerSpins[address(msg.sender)].field_0:
                                        ...
                                        require 50 * playerSpins[address(msg.sender)].field_0 <= balanceOf
                                        balanceOf += -50 * playerSpins[address(msg.sender)].field_0
                                        require ext_code.size(stor7)
                                        call stor7.0xa9059cbb with:
                                             gas gas_remaining wei
                                    ...
                                    if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 17273:
                                        if not playerSpins[address(msg.sender)].field_0:
                                            ...
                                            require 40 * playerSpins[address(msg.sender)].field_0 <= balanceOf
                                            balanceOf += -40 * playerSpins[address(msg.sender)].field_0
                                            require ext_code.size(stor7)
                                            call stor7.0xa9059cbb with:
                                                 gas gas_remaining wei
                                        ...
                                        if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 20102:
                                            if not playerSpins[address(msg.sender)].field_0:
                                                ...
                                                require 20 * playerSpins[address(msg.sender)].field_0 <= balanceOf
                                                balanceOf += -20 * playerSpins[address(msg.sender)].field_0
                                                require ext_code.size(stor7)
                                                call stor7.0xa9059cbb with:
                                                     gas gas_remaining wei
                                            ...
                                            if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 22930:
                                                ...
                                                if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 52333:
                                                    if not playerSpins[address(msg.sender)].field_0:
                                                        ...
                                                        require 125 * playerSpins[address(msg.sender)].field_0 / 10 <= balanceOf
                                                        balanceOf -= 125 * playerSpins[address(msg.sender)].field_0 / 10
                                                        require ext_code.size(stor7)
                                                        call stor7.0xa9059cbb with:
                                                             gas gas_remaining wei
                                                    ...
                                                    if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 120226:
                                                        if not playerSpins[address(msg.sender)].field_0:
                                                            ...
                                                            require 15 * playerSpins[address(msg.sender)].field_0 / 10 <= balanceOf
                                                            balanceOf -= 15 * playerSpins[address(msg.sender)].field_0 / 10
                                                            require ext_code.size(stor7)
                                                            call stor7.0xa9059cbb with:
                                                                 gas gas_remaining wei
                                                        ...
                                                        if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 171147:
                                                            if not playerSpins[address(msg.sender)].field_0:
                                                                ...
                                                                require 232 * playerSpins[address(msg.sender)].field_0 / 100 <= balanceOf
                                                                balanceOf -= 232 * playerSpins[address(msg.sender)].field_0 / 100
                                                                require ext_code.size(stor7)
                                                                call stor7.0xa9059cbb with:
                                                                     gas gas_remaining wei
                                                                ...
                                                                if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 272989:
                                                                    ...
                                                                    if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 323910:
                                                                        if not playerSpins[address(msg.sender)].field_0:
                                                                            ...
                                                                            require 375 * playerSpins[address(msg.sender)].field_0 / 100 <= balanceOf
                                                                            balanceOf -= 375 * playerSpins[address(msg.sender)].field_0 / 100
                                                                            require ext_code.size(stor7)
                                                                            call stor7.0xa9059cbb with:
                                                                                 gas gas_remaining wei
                                                                        ...
                                                                        if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 < 374831:
                                                                            if not playerSpins[address(msg.sender)].field_0:
                                                                                ...
                                                                                require 35 * playerSpins[address(msg.sender)].field_0 / 10 <= balanceOf
                                                                                balanceOf -= 35 * playerSpins[address(msg.sender)].field_0 / 10
                                                                                require ext_code.size(stor7)
                                                                                call stor7.0xa9059cbb with:
                                                                                     gas gas_remaining wei
                                                                            ...
                                                                            if (sha3(this.address, block.hash(playerSpins[address(msg.sender)].field_200), msg.sender) % 10^6) + 1 >= 425752:
                                                                                if not playerSpins[address(msg.sender)].field_0:
                                                                                    ...
                                                                                    require 2 * Mask(200, 0, playerSpins[address(msg.sender)].field_0) <= balanceOf
                                                                                    balanceOf -= 2 * Mask(200, 0, playerSpins[address(msg.sender)].field_0)
                                                                                    require ext_code.size(stor7)
                                                                                    call stor7.0xa9059cbb with:
                                                                                         gas gas_remaining wei
                                                                                ...
                                                                                if not playerSpins[address(msg.sender)].field_0:
                                                                                    ...
                                                                                    require 225 * playerSpins[address(msg.sender)].field_0 / 100 <= balanceOf
                                                                                    balanceOf -= 225 * playerSpins[address(msg.sender)].field_0 / 100
                                                                                    require ext_code.size(stor7)
                                                                                    call stor7.0xa9059cbb with:
                                                                                         gas gas_remaining wei
...
function tokenFallback(address arg1, uint256 arg2, bytes arg3) {
    if stor1 == arg1:
        require arg2 + balanceOf >= balanceOf
        balanceOf += arg2
    else:
        ...
        if not arg2:
            if balanceOf / 10:
                require 9 * balanceOf / 10 / balanceOf / 10 == 9
                require 0 <= 9 * balanceOf / 10
        else:
            ...
            if not balanceOf / 10:
                ...
                require 9 * balanceOf / 10 / balanceOf / 10 == 9
                require 500 * arg2 <= 9 * balanceOf / 10
        ...
        if not playerSpins[address(arg1)].field_200:
            ...
            if block.number - playerSpins[address(arg1)].field_200 > 255:
                require playerSpins[address(arg1)].field_0 + balanceOf >= balanceOf
                balanceOf += playerSpins[address(arg1)].field_0
                ...
                if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 > 476662:
                    ...
                    if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 2:
                        if not playerSpins[address(arg1)].field_0:
                            ...
                            require 500 * playerSpins[address(arg1)].field_0 <= balanceOf
                            balanceOf += -500 * playerSpins[address(arg1)].field_0
                            require ext_code.size(stor7)
                            call stor7.0xa9059cbb with:
                                 gas gas_remaining wei
                        ...
                        if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 299:
                            if not playerSpins[address(arg1)].field_0:
                                ...
                                require 232 * playerSpins[address(arg1)].field_0 <= balanceOf
                                balanceOf += -232 * playerSpins[address(arg1)].field_0
                                require ext_code.size(stor7)
                                call stor7.0xa9059cbb with:
                                     gas gas_remaining wei
                            ...
                            if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 3128:
                                if not playerSpins[address(arg1)].field_0:
                                    ...
                                    require 232 * playerSpins[address(arg1)].field_0 / 10 <= balanceOf
                                    balanceOf -= 232 * playerSpins[address(arg1)].field_0 / 10
                                    require ext_code.size(stor7)
                                    call stor7.0xa9059cbb with:
                                         gas gas_remaining wei
                                ...
                                if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 5957:
                                    if not playerSpins[address(arg1)].field_0:
                                        ...
                                        require 25 * playerSpins[address(arg1)].field_0 <= balanceOf
                                        balanceOf += -25 * playerSpins[address(arg1)].field_0
                                        require ext_code.size(stor7)
                                        call stor7.0xa9059cbb with:
                                             gas gas_remaining wei
                                        ...
                                        if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 11615:
                                            ...
                                            if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 14444:
                                                if not playerSpins[address(arg1)].field_0:
                                                    ...
                                                    require 50 * playerSpins[address(arg1)].field_0 <= balanceOf
                                                    balanceOf += -50 * playerSpins[address(arg1)].field_0
                                                    require ext_code.size(stor7)
                                                    call stor7.0xa9059cbb with:
                                                         gas gas_remaining wei
                                                ...
                                                if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 17273:
                                                    if not playerSpins[address(arg1)].field_0:
                                                        ...
                                                        require 40 * playerSpins[address(arg1)].field_0 <= balanceOf
                                                        balanceOf += -40 * playerSpins[address(arg1)].field_0
                                                        require ext_code.size(stor7)
                                                        call stor7.0xa9059cbb with:
                                                             gas gas_remaining wei
                                                    ...
                                                    if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 20102:
                                                        if not playerSpins[address(arg1)].field_0:
                                                            ...
                                                            require 20 * playerSpins[address(arg1)].field_0 <= balanceOf
                                                            balanceOf += -20 * playerSpins[address(arg1)].field_0
                                                            require ext_code.size(stor7)
                                                            call stor7.0xa9059cbb with:
                                                                 gas gas_remaining wei
                                                        ...
                                                        if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 22930:
                                                            ...
                                                            if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 52333:
                                                                if not playerSpins[address(arg1)].field_0:
                                                                    ...
                                                                    require 125 * playerSpins[address(arg1)].field_0 / 10 <= balanceOf
                                                                    balanceOf -= 125 * playerSpins[address(arg1)].field_0 / 10
                                                                    require ext_code.size(stor7)
                                                                    call stor7.0xa9059cbb with:
                                                                         gas gas_remaining wei
                                                                ...
                                                                if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 120226:
                                                                    if not playerSpins[address(arg1)].field_0:
                                                                        ...
                                                                        require 15 * playerSpins[address(arg1)].field_0 / 10 <= balanceOf
                                                                        balanceOf -= 15 * playerSpins[address(arg1)].field_0 / 10
                                                                        require ext_code.size(stor7)
                                                                        call stor7.0xa9059cbb with:
                                                                             gas gas_remaining wei
                                                                    ...
                                                                    if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 171147:
                                                                        if not playerSpins[address(arg1)].field_0:
                                                                            ...
                                                                            require 232 * playerSpins[address(arg1)].field_0 / 100 <= balanceOf
                                                                            balanceOf -= 232 * playerSpins[address(arg1)].field_0 / 100
                                                                            require ext_code.size(stor7)
                                                                            call stor7.0xa9059cbb with:
                                                                                 gas gas_remaining wei
                                                                            ...
                                                                            if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 272989:
                                                                                ...
                                                                                if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 323910:
                                                                                    if not playerSpins[address(arg1)].field_0:
                                                                                        ...
                                                                                        require 375 * playerSpins[address(arg1)].field_0 / 100 <= balanceOf
                                                                                        balanceOf -= 375 * playerSpins[address(arg1)].field_0 / 100
                                                                                        require ext_code.size(stor7)
                                                                                        call stor7.0xa9059cbb with:
                                                                                             gas gas_remaining wei
                                                                                    ...
                                                                                    if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 < 374831:
                                                                                        if not playerSpins[address(arg1)].field_0:
                                                                                            ...
                                                                                            require 35 * playerSpins[address(arg1)].field_0 / 10 <= balanceOf
                                                                                            balanceOf -= 35 * playerSpins[address(arg1)].field_0 / 10
                                                                                            require ext_code.size(stor7)
                                                                                            call stor7.0xa9059cbb with:
                                                                                                 gas gas_remaining wei
                                                                                        ...
                                                                                        if (sha3(this.address, block.hash(playerSpins[address(arg1)].field_200), arg1) % 10^6) + 1 >= 425752:
                                                                                            if not playerSpins[address(arg1)].field_0:
                                                                                                ...
                                                                                                require 2 * Mask(200, 0, playerSpins[address(arg1)].field_0) <= balanceOf
                                                                                                balanceOf -= 2 * Mask(200, 0, playerSpins[address(arg1)].field_0)
                                                                                                require ext_code.size(stor7)
                                                                                                call stor7.0xa9059cbb with:
                                                                                                     gas gas_remaining wei
                                                                                            ...
                                                                                            if not playerSpins[address(arg1)].field_0:
                                                                                                ...
                                                                                                require 225 * playerSpins[address(arg1)].field_0 / 100 <= balanceOf
                                                                                                balanceOf -= 225 * playerSpins[address(arg1)].field_0 / 100
                                                                                                require ext_code.size(stor7)
                                                                                                call stor7.0xa9059cbb with:
                                                                                                     gas gas_remaining wei
