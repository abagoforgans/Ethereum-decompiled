...
function _fallback() {
    ...
    stor6 = code.data[2770 len 20]
    stor5 = code.data[2802 len 20]
    stor1[code.data[2834 len 20]] = 200000000 * 10^18
    stor1[stor5] = 4000000000 * 10^18
    return code.data[179 len 2579]
}
...
const sub_06721779(?) = 1120000000 * 10^18
...
function createTokens() payable {
    require msg.value
    require block.timestamp - startTime / 168 * 24 * 3600 <= 4
    if block.timestamp - startTime / 168 * 24 * 3600 < 1:
        if msg.value:
            require msg.value
            require 12320 * msg.value / msg.value == 12320
        require 12320 * msg.value <= 1120000000 * 10^18
        require balanceOf[stor5] <= 4000000000 * 10^18
        require -balanceOf[stor5] + 4000000000 * 10^18 <= (-12320 * msg.value) + 1120000000 * 10^18
        require 12320 * msg.value <= balanceOf[stor5]
        balanceOf[stor5] += -12320 * msg.value
        require (12320 * msg.value) + balanceOf[msg.sender] >= balanceOf[msg.sender]
        balanceOf[address(msg.sender)] = (12320 * msg.value) + balanceOf[msg.sender]
    else:
        if block.timestamp - startTime / 168 * 24 * 3600 < 2:
            if msg.value:
                require msg.value
                require 10267 * msg.value / msg.value == 10267
            require 10267 * msg.value <= 1120000000 * 10^18
            require balanceOf[stor5] <= 4000000000 * 10^18
            require -balanceOf[stor5] + 4000000000 * 10^18 <= (-10267 * msg.value) + 1120000000 * 10^18
            ...
            if block.timestamp - startTime / 168 * 24 * 3600 >= 3:
                if msg.value:
                    require msg.value
                    require 7700 * msg.value / msg.value == 7700
                require 7700 * msg.value <= 1120000000 * 10^18
                require balanceOf[stor5] <= 4000000000 * 10^18
                require -balanceOf[stor5] + 4000000000 * 10^18 <= (-7700 * msg.value) + 1120000000 * 10^18
                ...
                require 8800 * msg.value <= 1120000000 * 10^18
                require balanceOf[stor5] <= 4000000000 * 10^18
                require -balanceOf[stor5] + 4000000000 * 10^18 <= (-8800 * msg.value) + 1120000000 * 10^18
