...
const name = 'Crypto Neo-value Neural System'
    ...
    if not tokensPerEth:
        if stor4[address(msg.sender)]:
            ...
            if progress0drop > target0drop:
                ...
                require not distributionFinished
                require totalDistributed + 22222 * 10^18 >= totalDistributed
                totalDistributed += 22222 * 10^18
                require balanceOf[address(msg.sender)] + 22222 * 10^18 >= balanceOf[address(msg.sender)]
                balanceOf[address(msg.sender)] += 22222 * 10^18
                emit Distr(22222 * 10^18, msg.sender);
                emit Transfer(22222 * 10^18, 0, msg.sender);
