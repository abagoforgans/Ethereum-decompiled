...
function _fallback() payable {
    mem[96 len -716] = code.data[1163 len -716]
    mem[64] = -620
    mem[32] = 3
    if mem[160] != 0:
    ...
    mem[0] = 0
    stor0.length = (2 * mem[mem[192] + 96]) + 1
    ...
    while mem[192] + mem[mem[192] + 96] + 128 > idx:
        ...
        idx = idx + 32
        continue 
    idx = (Mask(251, 0, mem[mem[192] + 96] + 31) >> 5) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e563
