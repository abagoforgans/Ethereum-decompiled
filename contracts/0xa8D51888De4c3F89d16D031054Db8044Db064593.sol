...
function sub_1fe9f877(?) {
    ...
    while uint8(idx) < arg1.length:
        ...
        _64 = mem[(32 * uint8(idx)) + 128]
        require not ownerOf[mem[(32 * uint8(idx)) + 128]]
        balanceOf[address(arg2)]++
        mem[0] = mem[(32 * uint8(idx)) + 128]
        mem[32] = 1
        ownerOf[mem[(32 * uint8(idx)) + 128]] = arg2
        mem[mem[64] + 64] = mem[(32 * uint8(idx)) + 128]
        emit Transfer(0, address(arg2), _64);
        mem[mem[64]] = arg2
        mem[mem[64] + 32] = _64
        emit Create(address(arg2), _64);
        _72 = mem[64]
        mem[64] = mem[64] + 96
        mem[_72 + 64] = 0
        mem[_72] = _72 + 64
        mem[_72 + 32] = uint64(block.timestamp)
        stor4[_64] = 1
        if arg2:
            stor6.length++
            bool(stor6[stor6.length].field_0) = 0
            uint255(stor6[stor6.length].field_1) = 0
            Mask(248, 0, stor6[stor6.length].field_8) = mem[_72 + 96 len 31]
        ...
        stor7[_64] = stor6.length
        stor8.length++
        stor8[stor8.length].field_0 = _64
        stor9[_64] = stor8.length
        stor10[address(arg2)].field_0++
        stor10[address(arg2)][stor10[address(arg2)].field_0].field_0 = _64
        mem[0] = _64
        mem[32] = 11
        stor11[_64] = stor10[address(arg2)].field_0
        s = _72
        idx = idx + 1
        s = _64
        continue 
