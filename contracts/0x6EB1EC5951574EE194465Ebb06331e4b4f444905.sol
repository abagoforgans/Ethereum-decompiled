...
function price(uint256 arg1) {
    ...
    if not stor5:
        ...
        return stor4
    require stor5
    if stor5 * rounds[arg1].field_0 / stor5 != rounds[arg1].field_0:
        revert with 0, 'SafeMath mul failed.'
    if stor4 + (stor5 * rounds[arg1].field_0) < stor4:
        revert with 0, 'SafeMath add failed.'
    if stor4 + (stor5 * rounds[arg1].field_0) > stor6:
        return stor6
    return (stor4 + (stor5 * rounds[arg1].field_0))
}
            ...
            if -stor17[address(msg.sender)].field_768 <= 0:
                ...
                if stor17[address(msg.sender)].field_1536 > 0:
                    if -stor17[address(msg.sender)].field_768 < stor17[address(msg.sender)].field_1536:
                        ...
                        if stor17[address(msg.sender)].field_1536 > stor17[address(msg.sender)].field_1536:
                            revert with 0, 'SafeMath sub failed.'
                        stor17[address(msg.sender)].field_1536 = 0
                        if stor17[address(msg.sender)].field_768 + stor17[address(msg.sender)].field_1536 < stor17[address(msg.sender)].field_768:
                            revert with 0, 'SafeMath add failed.'
                        stor17[address(msg.sender)].field_768 += stor17[address(msg.sender)].field_1536
                        if stor17[address(msg.sender)].field_1024 > 0:
                            stor17[address(msg.sender)].field_1024 = 0
                        if stor17[address(msg.sender)].field_1536 + stor17[address(msg.sender)].field_1024 < stor17[address(msg.sender)].field_1536:
                            revert with 0, 'SafeMath add failed.'
                        require ext_code.size(sub_6e5ec052Address)
                        call sub_6e5ec052Address.0xbeabacc8 with:
                             gas gas_remaining wei
                            args address(this.address), msg.sender, stor17[address(msg.sender)].field_1536 + stor17[address(msg.sender)].field_1024
                else:
                    if not stor17[address(msg.sender)].field_256:
                        ...
                        if stor17[address(msg.sender)].field_1280 - stor17[address(msg.sender)].field_768 < 0:
                            ...
                            if not stor5:
                                ...
                                require stor5
                                if stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 / stor5 != rounds[stor17[address(msg.sender)].field_0].field_0:
                                    revert with 0, 'SafeMath mul failed.'
                                if stor4 + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0) < stor4:
                                    revert with 0, 'SafeMath add failed.'
                                if stor4 + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0) > stor6:
                                    if not stor6:
                                        revert with 0, 'SafeMath mod failed.'
                                    require stor6
                                    if stor6 * uint8(stor12.field_24) / stor6 != uint8(stor12.field_24):
                                    ...
                                    if not stor4 + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0):
                                        revert with 0, 'SafeMath mod failed.'
                                    require stor4 + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0)
                                    if (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) / stor4 + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0) != uint8(stor12.field_24):
                                        revert with 0, 'SafeMath mul failed.'
                                    if not (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)):
                                        revert with 0, 'SafeMath mod failed.'
                                    require (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))
                                    if stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) > stor17[address(msg.sender)].field_1280:
                                        revert with 0, 'SafeMath sub failed.'
                                    if stor17[address(msg.sender)].field_1280 - (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) > 0:
                                        revert with 0, 'SafeMath sub failed.'
                                    if (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) <= 0:
                                        revert with 0, 'SafeMath div failed.'
                                    require (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))
                                    if 0 < stor17[address(msg.sender)].field_768:
                                        revert with 0, 'SafeMath add failed.'
                                    if -stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) > stor17[address(msg.sender)].field_512:
                                        revert with 0, 'SafeMath sub failed.'
                                    if not stor17[address(msg.sender)].field_512 - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))):
                                        stor17[address(msg.sender)].field_768 = 0
                                    else:
                                        require stor17[address(msg.sender)].field_512 - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)))
                                        if (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / stor17[address(msg.sender)].field_512 - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) != rounds[stor17[address(msg.sender)].field_0].field_1024:
                                            revert with 0, 'SafeMath mul failed.'
                                        if 0 < (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18:
                                            stor17[address(msg.sender)].field_768 = 0
                                        else:
                                            if (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18 > 0:
                                                revert with 0, 'SafeMath sub failed.'
                                            stor17[address(msg.sender)].field_768 = -(stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18
                                    if -stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) > stor17[address(msg.sender)].field_512:
                                        revert with 0, 'SafeMath sub failed.'
                                    if stor17[address(msg.sender)].field_512 - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) > rounds[stor17[address(msg.sender)].field_0].field_768:
                                        revert with 0, 'SafeMath sub failed.'
                                    rounds[stor17[address(msg.sender)].field_0].field_768 = rounds[stor17[address(msg.sender)].field_0].field_768 - stor17[address(msg.sender)].field_512 + (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)))
                                    stor17[address(msg.sender)].field_512 = -stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))
                            if stor17[address(msg.sender)].field_1024 > 0:
                                stor17[address(msg.sender)].field_1024 = 0
                            if -stor17[address(msg.sender)].field_768 + stor17[address(msg.sender)].field_1024 < -stor17[address(msg.sender)].field_768:
                            ...
                            if not stor5:
                                ...
                                if stor4 + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0) > stor6:
                                    ...
                                    if not stor17[address(msg.sender)].field_512 - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))):
                                        ...
                                        if (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / stor17[address(msg.sender)].field_512 - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) != rounds[stor17[address(msg.sender)].field_0].field_1024:
                                            revert with 0, 'SafeMath mul failed.'
                                        if stor17[address(msg.sender)].field_768 - stor17[address(msg.sender)].field_1280 < (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18:
                                            stor17[address(msg.sender)].field_768 = 0
                                        else:
                                            if (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18 > stor17[address(msg.sender)].field_768 - stor17[address(msg.sender)].field_1280:
                                                revert with 0, 'SafeMath sub failed.'
                                            stor17[address(msg.sender)].field_768 = stor17[address(msg.sender)].field_768 - stor17[address(msg.sender)].field_1280 - ((stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18)
                                    if -stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) > stor17[address(msg.sender)].field_512:
                                        revert with 0, 'SafeMath sub failed.'
                                    if stor17[address(msg.sender)].field_512 - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) > rounds[stor17[address(msg.sender)].field_0].field_768:
                                        revert with 0, 'SafeMath sub failed.'
                        ...
                        if stor17[address(msg.sender)].field_1280 - stor17[address(msg.sender)].field_768 < stor17[address(msg.sender)].field_256 * uint8(stor12.field_24):
                            ...
                            if not stor5:
                                ...
                                if stor4 + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0) > stor6:
                                    ...
                                    if stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) > stor17[address(msg.sender)].field_1280:
                                        revert with 0, 'SafeMath sub failed.'
                                    if stor17[address(msg.sender)].field_1280 - (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) > stor17[address(msg.sender)].field_256 * uint8(stor12.field_24):
                                        revert with 0, 'SafeMath sub failed.'
                                    if (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) <= 0:
                                        revert with 0, 'SafeMath div failed.'
                                    require (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))
                                    if 0 < stor17[address(msg.sender)].field_768:
                                        revert with 0, 'SafeMath add failed.'
                                    if (stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) > stor17[address(msg.sender)].field_512:
                                        revert with 0, 'SafeMath sub failed.'
                                    if not stor17[address(msg.sender)].field_512 - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))):
                                        stor17[address(msg.sender)].field_768 = 0
                                    else:
                                        require stor17[address(msg.sender)].field_512 - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)))
                                        if (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / stor17[address(msg.sender)].field_512 - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) != rounds[stor17[address(msg.sender)].field_0].field_1024:
                                            revert with 0, 'SafeMath mul failed.'
                                        if 0 < (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18:
                                            stor17[address(msg.sender)].field_768 = 0
                                        else:
                                            if (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18 > 0:
                                                revert with 0, 'SafeMath sub failed.'
                                            stor17[address(msg.sender)].field_768 = -(stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18
                                    if (stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) > stor17[address(msg.sender)].field_512:
                                        revert with 0, 'SafeMath sub failed.'
                                    if stor17[address(msg.sender)].field_512 - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) > rounds[stor17[address(msg.sender)].field_0].field_768:
                                        revert with 0, 'SafeMath sub failed.'
                                    rounds[stor17[address(msg.sender)].field_0].field_768 = rounds[stor17[address(msg.sender)].field_0].field_768 - stor17[address(msg.sender)].field_512 + ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)))
                                    stor17[address(msg.sender)].field_512 = (stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))
                            if stor17[address(msg.sender)].field_1024 > 0:
                                stor17[address(msg.sender)].field_1024 = 0
                            if -stor17[address(msg.sender)].field_768 + stor17[address(msg.sender)].field_1024 < -stor17[address(msg.sender)].field_768:
                            ...
                            if not stor5:
                                ...
                                if stor4 + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0) > stor6:
                                    ...
                                    if not stor17[address(msg.sender)].field_512 - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))):
                                        ...
                                        if (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / stor17[address(msg.sender)].field_512 - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) != rounds[stor17[address(msg.sender)].field_0].field_1024:
                                            revert with 0, 'SafeMath mul failed.'
                                        if stor17[address(msg.sender)].field_768 + (stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 < (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18:
                                            stor17[address(msg.sender)].field_768 = 0
                                        else:
                                            if (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18 > stor17[address(msg.sender)].field_768 + (stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280:
                                                revert with 0, 'SafeMath sub failed.'
                                            stor17[address(msg.sender)].field_768 = stor17[address(msg.sender)].field_768 + (stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 - ((stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18)
                                    if (stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) > stor17[address(msg.sender)].field_512:
                                        revert with 0, 'SafeMath sub failed.'
                                    if stor17[address(msg.sender)].field_512 - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) > rounds[stor17[address(msg.sender)].field_0].field_768:
                                        revert with 0, 'SafeMath sub failed.'
                            ...
                            if not stor5:
                                ...
                                if stor4 + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0) > stor6:
                                    ...
                                    if not stor17[address(msg.sender)].field_512 - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))):
                                        ...
                                        if (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / stor17[address(msg.sender)].field_512 - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) != rounds[stor17[address(msg.sender)].field_0].field_1024:
                                            revert with 0, 'SafeMath mul failed.'
                                        if rounds[stor17[address(msg.sender)].field_0].field_1024 * stor17[address(msg.sender)].field_512 / 10^18 < (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18:
                                            stor17[address(msg.sender)].field_768 = 0
                                        else:
                                            if (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18 > rounds[stor17[address(msg.sender)].field_0].field_1024 * stor17[address(msg.sender)].field_512 / 10^18:
                                                revert with 0, 'SafeMath sub failed.'
                                            stor17[address(msg.sender)].field_768 = (rounds[stor17[address(msg.sender)].field_0].field_1024 * stor17[address(msg.sender)].field_512 / 10^18) - ((stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18)
                                    if -stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) > stor17[address(msg.sender)].field_512:
                                        revert with 0, 'SafeMath sub failed.'
                                    if stor17[address(msg.sender)].field_512 - (-stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) > rounds[stor17[address(msg.sender)].field_0].field_768:
                                        revert with 0, 'SafeMath sub failed.'
                            ...
                            if not stor5:
                                ...
                                if stor4 + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0) > stor6:
                                    ...
                                    if not stor17[address(msg.sender)].field_512 - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))):
                                        ...
                                        if (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / stor17[address(msg.sender)].field_512 - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) != rounds[stor17[address(msg.sender)].field_0].field_1024:
                                            revert with 0, 'SafeMath mul failed.'
                                        if rounds[stor17[address(msg.sender)].field_0].field_1024 * stor17[address(msg.sender)].field_512 / 10^18 < (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18:
                                            stor17[address(msg.sender)].field_768 = 0
                                        else:
                                            if (stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18 > rounds[stor17[address(msg.sender)].field_0].field_1024 * stor17[address(msg.sender)].field_512 / 10^18:
                                                revert with 0, 'SafeMath sub failed.'
                                            stor17[address(msg.sender)].field_768 = (rounds[stor17[address(msg.sender)].field_0].field_1024 * stor17[address(msg.sender)].field_512 / 10^18) - ((stor17[address(msg.sender)].field_512 * rounds[stor17[address(msg.sender)].field_0].field_1024) - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) * rounds[stor17[address(msg.sender)].field_0].field_1024) / 10^18)
                                    if (stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24)) > stor17[address(msg.sender)].field_512:
                                        revert with 0, 'SafeMath sub failed.'
                                    if stor17[address(msg.sender)].field_512 - ((stor17[address(msg.sender)].field_256 * uint8(stor12.field_24)) - stor17[address(msg.sender)].field_1280 + (stor17[address(msg.sender)].field_1280 % (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) / (stor4 * uint8(stor12.field_24)) + (stor5 * rounds[stor17[address(msg.sender)].field_0].field_0 * uint8(stor12.field_24))) > rounds[stor17[address(msg.sender)].field_0].field_768:
                                        revert with 0, 'SafeMath sub failed.'
