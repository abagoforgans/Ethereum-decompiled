...
function sub_596ba5bb(?) {
    ...
    _44 = sha3(call.data[arg1 + 36 len floor32(arg1.length)], mem[ceil32(arg1.length) + ceil32(arg2.length) + floor32(arg1.length) + 192 len (arg1.length % 32) + 32])
    ...
    mem[arg2.length + ceil32(arg1.length) + ceil32(arg2.length) + 192] = _44
    _79 = sha3(call.data[arg2 + 36 len floor32(arg2.length)], mem[ceil32(arg1.length) + ceil32(arg2.length) + floor32(arg2.length) + 192 len (arg2.length % 32) + 32])
    mem[64] = ceil32(arg1.length) + ceil32(arg2.length) + ceil32(stor[mem[ceil32(arg1.length) + ceil32(arg2.length) + floor32(arg2.length) + 192 len (arg2.length % 32) + 32]][call.data[arg2 + 36 len floor32(arg2.length)]].length) + 224
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 192] = stor[mem[ceil32(arg1.length) + ceil32(arg2.length) + floor32(arg2.length) + 192 len (arg2.length % 32) + 32]][call.data[arg2 + 36 len floor32(arg2.length)]].length
    mem[0] = _79
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 224] = stor[sha3(_79)]
    idx = ceil32(arg1.length) + ceil32(arg2.length) + 224
    s = 0
    while ceil32(arg1.length) + ceil32(arg2.length) + stor[_79].length + 192 > idx:
        mem[idx + 32] = stor[s + sha3(_79) + 1]
        idx = idx + 32
        s = s + 1
        continue 
    mem[mem[64]] = 32
    mem[mem[64] + 32] = mem[ceil32(arg1.length) + ceil32(arg2.length) + 192]
    _113 = mem[ceil32(arg1.length) + ceil32(arg2.length) + 192]
    mem[mem[64] + 64 len ceil32(mem[ceil32(arg1.length) + ceil32(arg2.length) + 192])] = mem[ceil32(arg1.length) + ceil32(arg2.length) + 224 len ceil32(mem[ceil32(arg1.length) + ceil32(arg2.length) + 192])]
    if not _113 % 32:
        return 32, mem[mem[64] + 32 len _113 + 32]
    mem[floor32(_113) + mem[64] + 64] = mem[floor32(_113) + mem[64] + -(_113 % 32) + 96 len _113 % 32]
    return 32, mem[mem[64] + 32 len floor32(_113) + 64]
}
