...
uint8 reservedTokensAreDistributed;
...
function reservedTokensAreDistributed() {
    return bool(reservedTokensAreDistributed)
}
...
function finalizeCrowdsale() {
    ...
    if ext_call.return_data[0] <= 0:
        ...
        if reservedTokensAreDistributed:
            if ext_code.size(tokenAddress):
                call tokenAddress.'_A-O' with:
                     gas gas_remaining - 710 wei
                if ext_call.success:
...
function distributeReservedTokens(uint256 arg1) payable {
    ...
    require arg1 > 0
    require not reservedTokensAreDistributed
    require ext_code.size(tokenAddress)
    call tokenAddress.0xc3310517 with:
         gas gas_remaining - 710 wei
    require ext_call.success
    ...
    if uint8(var25014) >= 0:
        ...
        require ext_code.size(0x2ff940449a4c2104d4b593a321161a4d031c946a)
        delegate 0x2ff940449a4c2104d4b593a321161a4d031c946a.mem[var37002 len 4] with:
             gas gas_remaining - 710 wei
    ...
    if distributedReservedTokensDestinationsLen == ext_call.return_data[0]:
        reservedTokensAreDistributed = 1
}
