...
function doBlockContract() {
    require viewSuperOwner == msg.sender
    stor0 = 1
}
...
function _fallback() payable {
    require msg.value > 0
    require msg.value + getReserveAmount[0] >= getReserveAmount[0]
...
function HodlEth(uint256 arg1) payable {
    ...
    require msg.value + sub_666a7370[0] >= sub_666a7370[0]
...
function OwnerRetireHodl(uint256 arg1) {
    ...
    if getsafe[arg1].field_1024 < block.timestamp:
        if not address(getsafe[arg1].field_512):
            require getsafe[arg1].field_768 <= eth.balance(this.address)
        ...
        if not getsafe[arg1].field_768:
            ...
            require comission * getsafe[arg1].field_768 / getsafe[arg1].field_768 == comission
            require comission * getsafe[arg1].field_768 / 100 <= getsafe[arg1].field_768
            if not address(getsafe[arg1].field_512):
                require getsafe[arg1].field_768 - (comission * getsafe[arg1].field_768 / 100) <= eth.balance(this.address)
                call address(getsafe[arg1].field_256) with:
                   value getsafe[arg1].field_768 - (comission * getsafe[arg1].field_768 / 100) wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            else:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0] >= getsafe[arg1].field_768 - (comission * getsafe[arg1].field_768 / 100)
                require ext_code.size(address(getsafe[arg1].field_512))
                call address(getsafe[arg1].field_512).0xa9059cbb with:
                     gas gas_remaining wei
                    args address(getsafe[arg1].field_256), getsafe[arg1].field_768 - (comission * getsafe[arg1].field_768 / 100)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
            require (comission * getsafe[arg1].field_768 / 100) + getReserveAmount[address(stor2[arg1].field_512)] >= getReserveAmount[address(stor2[arg1].field_512)]
            getReserveAmount[address(stor2[arg1].field_512)] += comission * getsafe[arg1].field_768 / 100
        idx = 0
        while idx < sub_1c019a52.length:
            mem[0] = 7
            ...
            while idx < sub_11a3311c[address(msg.sender)]:
                ...
                if sub_11a3311c[address(msg.sender)] > sub_11a3311c[address(msg.sender)] - 1:
                    idx = sub_11a3311c[address(msg.sender)] + sha3(sha3(address(msg.sender), 1)) - 1
