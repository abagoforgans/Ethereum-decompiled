...
function _fallback() payable {
    mem[96 len -3702] = code.data[3923 len -3702]
    mem[64] = -3606
...
function confirm(bytes32 arg1) {
    ...
    while stor261[arg1][2].length + 96 > idx + 32:
        ...
        s = s + 1
        continue 
    call address(stor261[arg1].field_0).mem[96 len 4] with:
    ...
    while stor261[arg1][2].length + 288 > idx + 32:
        ...
        s = s + 1
        continue 
    emit MultiTransact(msg.sender, arg1, stor261[arg1].field_256, address(stor261[arg1].field_0), Array(len=stor261[arg1][2].length, data=mem[288 len stor261[arg1][2].length + (floor32(stor261[arg1][2].length - 1) + -stor261[arg1][2].length + 32 % 32)]));
    address(stor261[arg1].field_0) = 0
...
function changeRequirement(uint256 arg1) {
    if stor258[address(msg.sender)] != 0:
        if not stor259[call.data[0 len calldata.size]].field_0:
            ...
            require stor260.length < stor260.length
            stor4C0B[stor260.length] = sha3(call.data[0 len calldata.size])
            ...
            if stor259[call.data[0 len calldata.size]].field_0 > 1:
                ...
                if arg1 <= m_numOwners:
                    ...
                    while idx < stor260.length:
                        mem[0] = stor260[idx]
                        mem[32] = 261
                        address(stor261[stor260[idx]].field_0) = 0
                        stor261[stor260[idx]].field_256 = 0
                        stor261[stor260[idx]].field_512 = 0
                        if 31 < stor261[stor260[idx]][2].length:
                            mem[0] = sha3(stor260[idx], 261) + 2
                            s = sha3(sha3(stor260[idx], 261) + 2)
                            while sha3(sha3(stor260[idx], 261) + 2) + (stor261[stor260[idx]][2].length + 31 / 32) > s:
                                stor[s] = 0
                                s = s + 1
                                continue 
                        idx = idx + 1
...
function execute(address arg1, uint256 arg2, bytes arg3) {
    ...
    if 0 == stor258[address(msg.sender)]:
        if not address(stor261[call.data[0 len calldata.size]][block.number].field_0):
            stor261[call.data[0 len calldata.size]][block.number].field_0 = arg1 or Mask(96, 160, stor261[call.data[0 len calldata.size]][block.number].field_0)
            ...
            if stor259[call.data[0 len calldata.size]][block.number].field_0 > 1:
                ...
                if not address(stor261[call.data[0 len calldata.size]][block.number].field_0):
                    ...
                    while stor261[call.data[0 len calldata.size]][block.number][2].length + 96 > idx + 32:
                        ...
                        s = s + 1
                        continue 
                    call address(stor261[call.data[0 len calldata.size]][block.number].field_0).mem[96 len 4] with:
                    ...
                    if not ext_call.success:
                        ...
                        while stor261[call.data[0 len calldata.size]][block.number][2].length + 288 > idx + 32:
                            ...
                            s = s + 1
                            continue 
                        emit MultiTransact(msg.sender, sha3(call.data[0 len calldata.size], block.number), stor261[call.data[0 len calldata.size]][block.number].field_256, address(stor261[call.data[0 len calldata.size]][block.number].field_0), Array(len=stor261[call.data[0 len calldata.size]][block.number][2].length, data=mem[288 len stor261[call.data[0 len calldata.size]][block.number][2].length + (floor32(stor261[call.data[0 len calldata.size]][block.number][2].length - 1) + -stor261[call.data[0 len calldata.size]][block.number][2].length + 32 % 32)]));
                        address(stor261[call.data[0 len calldata.size]][block.number].field_0) = 0
