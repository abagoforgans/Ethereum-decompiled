...
function _fallback() payable {
    ...
    stor4 = code.data[7783 len 20]
    stor5 = 0
    stor6 = 0
    stor7 = 0
    stor8 = 10^6 * code.data[7803 len 32]
    stor0 = 2500000 * 10^18 * 3600
    stor1[address(msg.sender)] = stor0
    require stor8 <= stor0
    return code.data[644 len 7127]
}
...
function decreaseSupply(uint256 arg1) {
    require msg.sender == ethFundDepositAddress
    require (10^6 * arg1) + tokenRaised <= currentSupply
    require currentSupply >= 10^6 * arg1
    currentSupply += -1 * 10^6 * arg1
    emit DecreaseSupply((10^6 * arg1));
}
...
function increaseSupply(uint256 arg1) {
    require msg.sender == ethFundDepositAddress
    require (10^6 * arg1) + currentSupply <= totalSupply
    require currentSupply + (10^6 * arg1) >= currentSupply
    require currentSupply + (10^6 * arg1) >= 10^6 * arg1
    currentSupply += 10^6 * arg1
    emit IncreaseSupply((10^6 * arg1));
}
...
function allocateToken(address arg1, uint256 arg2) {
    ...
    if 10^6 * arg2:
        require 10^6 * arg2
        require 10^6 * arg2 * tokenExchangeRate / 10^6 * arg2 == tokenExchangeRate
    require (10^6 * arg2 * tokenExchangeRate) + tokenRaised <= currentSupply
    require tokenRaised + (10^6 * arg2 * tokenExchangeRate) >= tokenRaised
    require tokenRaised + (10^6 * arg2 * tokenExchangeRate) >= 10^6 * arg2 * tokenExchangeRate
    tokenRaised += 10^6 * arg2 * tokenExchangeRate
    balanceOf[address(arg1)] += 10^6 * arg2 * tokenExchangeRate
    emit AllocateToken((10^6 * arg2 * tokenExchangeRate), arg1);
}
