...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'CMCToken' / 256
    idx = 0
    ...
    stor5 = 5 * 10^16
    stor3[code.data[3185 len 20]] = 5 * 10^16
    emit Transfer(5 * 10^16, 0, code.data[3185 len 20]);
    return code.data[517 len 2656]
}
