...
function distributeReservedTokens(uint256 arg1) payable {
    ...
    if uint8(var25014) >= 0:
        ...
        call tokenAddress.reservedTokensDestinationsLen() with:
             gas gas_remaining - 710 wei
        require ext_call.success
        require ext_code.size(0x836f3eb783231bd7adaea7679a15ed1482c7e45f)
        delegate 0x836f3eb783231bd7adaea7679a15ed1482c7e45f.minus(uint256 arg1, uint256 arg2) with:
             gas gas_remaining - 710 wei
        ...
        require ext_code.size(0x836f3eb783231bd7adaea7679a15ed1482c7e45f)
        delegate 0x836f3eb783231bd7adaea7679a15ed1482c7e45f.mem[var37002 len 4] with:
             gas gas_remaining - 710 wei
        ...
        while uint8(idx + 1) < uint8(ext_call.return_data[0]):
            ...
            mem[132] = ext_call.return_data[0]
            require ext_code.size(0x836f3eb783231bd7adaea7679a15ed1482c7e45f)
            delegate 0x836f3eb783231bd7adaea7679a15ed1482c7e45f.plus(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining - 710 wei
