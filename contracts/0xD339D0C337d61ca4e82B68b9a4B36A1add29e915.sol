...
uint256 increasePrice_20_January;
uint256 increasePrice_20_February;
uint256 price;
uint256 stor8;
uint256 tokenSold;
uint256 tokenFree;
...
function increasePrice_20_February() {
    return increasePrice_20_February
}
...
function increasePrice_20_January() {
    return increasePrice_20_January
}
...
function _fallback() payable {
    if block.timestamp > increasePrice_20_February:
        price = 7 * 10^16
    else:
        if block.timestamp > increasePrice_20_January:
            price = 525 * 10^13
