...
function BuyTokens(address arg1) payable {
    ...
    emit TokenPurchase(msg.value / 10^18, buyRate * msg.value / 10^18, buyRate, msg.sender, arg1);
}
...
function _fallback() payable {
    ...
    require buyRate * msg.value / 10^18 <= balanceOf[stor3]
    balanceOf[stor3] += -1 * buyRate * msg.value / 10^18
    emit TokenPurchase(msg.value / 10^18, buyRate * msg.value / 10^18, buyRate, msg.sender, msg.sender);
}
...
function SellTokens(uint256 arg1) {
    ...
    call msg.sender with:
       value 10^18 * arg1 / sellRate wei
         gas 2300 * is_zero(value) wei
    require ext_call.success
    emit TokenSold(10^18 * arg1 / sellRate, sellRate, msg.sender);
}
