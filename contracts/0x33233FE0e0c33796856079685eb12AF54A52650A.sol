...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'Neocash' / 256
    idx = 0
    ...
    stor5 = 10^14
    stor3[code.data[5119 len 20]] = 10^14
    emit Transfer(10^14, 0, code.data[5119 len 20]);
    return code.data[740 len 4367]
}
