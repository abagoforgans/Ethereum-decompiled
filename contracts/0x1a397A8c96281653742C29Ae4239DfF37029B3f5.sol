...
function _fallback() payable {
    ...
    require code.data[6755 len 32] <= 10000
    stor5 = code.data[6755 len 32]
    require ext_code.size(address(code.data[6723 len 32]))
    call address(code.data[6723 len 32]).supportsInterface(bytes4 rg1) with:
         gas gas_remaining - 710 wei
        args 0x9a20483d00000000000000000000000000000000000000000000000000000000
    require ext_call.success
    require ext_call.return_data[0]
    stor4 = address(code.data[6723 len 32])
    return code.data[714 len 6009]
}
...
function averageGen0SalePrice() {
    ...
    while idx < 5:
        idx = idx + 1
        s = s + lastGen0SalePrices[idx]
        continue 
    return (0x35f9dea3e1f6bdfef70cdd17b25efa418ca63a22764cec1 * s / 5)
}
...
function bid(uint256 arg1) payable {
    ...
    if block.timestamp <= auction[arg1].field_576:
        if 0 >= auction[arg1].field_512:
            ...
            require ext_call.success
            if auction[arg1].field_0 == nonFungibleContractAddress:
                require gen0SaleCount % 5 < 5
                lastGen0SalePrices[stor8 % 5] = auction[arg1].field_384
                gen0SaleCount++
        else:
            ...
            if auction[arg1].field_0 == nonFungibleContractAddress:
                require gen0SaleCount % 5 < 5
                lastGen0SalePrices[stor8 % 5] = auction[arg1].field_256 + (0 / auction[arg1].field_512)
                gen0SaleCount++
    else:
        if block.timestamp - auction[arg1].field_576 >= auction[arg1].field_512:
            require msg.value >= auction[arg1].field_384
            ...
            if auction[arg1].field_0 == nonFungibleContractAddress:
                require gen0SaleCount % 5 < 5
                lastGen0SalePrices[stor8 % 5] = auction[arg1].field_256 + ((block.timestamp * auction[arg1].field_384) - (auction[arg1].field_576 * auction[arg1].field_384) - (block.timestamp * auction[arg1].field_256) + (auction[arg1].field_576 * auction[arg1].field_256) / auction[arg1].field_512)
                gen0SaleCount++
}
