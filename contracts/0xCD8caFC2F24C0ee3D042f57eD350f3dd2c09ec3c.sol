...
function _fallback() payable {
    ...
    mem[96 len -5570] = code.data[6128 len -5570]
    mem[64] = -5474
    stor8 = msg.sender
    stor3 = msg.sender
...
function mint(address arg1, uint256 arg2) {
    ...
    require not mintingFinished
    require ext_code.size(0xbc6189e3043242978813fb7d8cbfa3b2f6d1e644)
    delegate 0xbc6189e3043242978813fb7d8cbfa3b2f6d1e644.plus(uint256 rg1, uint256 rg2) with:
         gas gas_remaining - 710 wei
