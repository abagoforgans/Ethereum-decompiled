...
const name = 'Optherium Node Tokens'

const symbol = 'OPEXnode'
...
function withdraw(address arg1, uint256 arg2) {
    if msg.sender != 0xcba6ee74b7ca65bd0506cf21d62bdd7c71f86ad8:
        revert with 0, 'Access denied'
    require ext_code.size(0xb34a04b77aa9bd2c07ef365c05f7d0234c95630)
    call 0x0b34a04b77aa9bd2c07ef365c05f7d0234c95630.transferWithLock(address arg1, uint256 arg2, uint256 arg3) with:
         gas gas_remaining wei
        args address(arg1), arg2, block.timestamp + (8760 * 24 * 3600)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if not ext_call.return_data[0]:
