...
function transfer(address arg1, uint256 arg2) {
    if stor7:
        ...
        while idx < addressArray.length:
            require 0 < addressArray.length
            mem[0] = 6
            if address(addressArray.field_0) != arg1:
                s = s
                t = t
                u = u
                v = v
                ...
                idx = idx + 1
                continue 
            require 1 < addressArray.length
            mem[0] = 6
            if address(addressArray.field_256) != msg.sender:
                s = s
                t = t
                u = u
                v = v
        ...
        idx = 0
        while idx < addressArray.length:
            require (2 * addressArray.length.field_1) + 1 < addressArray.length
            mem[0] = 6
            if addressArray[addressArray.length.field_1].field_256 != arg1:
                s = s
                t = t
                u = u
                v = v
                ...
                idx = idx + 1
                continue 
            if bool((2 * addressArray.length.field_1) + 1):
                s = s
                t = t
                u = u
                v = v
                ...
                idx = idx + 1
                continue 
            require (2 * addressArray.length.field_1) + 2 < addressArray.length
            mem[0] = 6
            if addressArray[addressArray.length.field_1].field_512 != msg.sender:
                s = s
                t = t
                u = u
                v = v
