...
function _fallback() payable {
    ...
    stor4 = code.data[5024 len 20]
    stor5 = 0
    stor6 = 0
    stor7 = 0
    stor8 = 10^18 * code.data[5044 len 32]
    stor0 = 500000000 * 10^18
    stor1[address(msg.sender)] = 500000000 * 10^18
    require stor8 <= 500000000 * 10^18
    return code.data[502 len 4510]
}
...
const name = 'Medicine  Anti Cheating Chain'
