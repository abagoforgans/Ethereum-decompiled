...
uint8 stor15; offset 64
uint8 stor15; offset 72
uint8 stor15; offset 80
...
function sub_64c5ca45(?) {
    return bool(uint8(stor15.field_72))
}
...
function sub_6f539e7c(?) {
    return bool(uint8(stor15.field_64))
}

function sub_7ced874c(?) {
    return bool(uint8(stor15.field_80))
}
...
function sub_7d1495b7(?) {
    ...
    if not uint8(stor15.field_0):
        ...
        if bool(uint8(stor15.field_0)) == 1:
...
function sub_0ddfb0d9(?) {
    require msg.sender == owner
    if not uint8(stor15.field_24):
        Mask(232, 0, stor15.field_24) = 1
    else:
        if bool(uint8(stor15.field_24)) == 1:
            Mask(232, 0, stor15.field_24) = 0
}

function sub_25bfa438(?) {
    require msg.sender == owner
    if not uint8(stor15.field_56):
        Mask(200, 0, stor15.field_56) = 1
    else:
        if bool(uint8(stor15.field_56)) == 1:
...
function sub_c3053961(?) {
    ...
    if not uint8(stor15.field_32):
        ...
        if bool(uint8(stor15.field_32)) == 1:
            Mask(224, 0, stor15.field_32) = 0
}

function sub_e6898d42(?) {
    require msg.sender == owner
    if not uint8(stor15.field_64):
        Mask(192, 0, stor15.field_64) = 1
    else:
        if bool(uint8(stor15.field_64)) == 1:
...
function _fallback() payable {
    ...
    call stor1.0x23b872dd with:
        ...
        args sub_a26a66eeAddress, msg.sender, msg.value * rate
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    emit 0x4bf20ea3: msg.sender, sub_a26a66eeAddress, msg.value * rate
}
...
function sub_7bed5b1a(?) {
    require calldata.size - 4 >= 32
    require arg1
    require not uint8(stor15.field_40)
...
function sub_ae941cca(?) {
    require calldata.size - 4 >= 32
    require arg1
    require not uint8(stor15.field_32)
...
function sub_1fd13fcb(?) {
    require calldata.size - 4 >= 32
    require arg1
    require not uint8(stor15.field_64)
...
function sub_354bfa6b(?) {
    require calldata.size - 4 >= 32
    require arg1
    require not uint8(stor15.field_48)
    ...
    call stor1.0x23b872dd with:
         gas gas_remaining wei
        args sub_ef7fc217Address, msg.sender, 10^14 * sub_be186509
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    emit 0x1d75069b: msg.sender, sub_ef7fc217Address, arg1
    emit 0x323851f1: sub_ef7fc217Address, msg.sender, arg1
}
...
function sub_51a83511(?) {
    require calldata.size - 4 >= 32
    require arg1
    require not uint8(stor15.field_80)
...
function sub_96704552(?) {
    require calldata.size - 4 >= 32
    require arg1
    require not uint8(stor15.field_72)
