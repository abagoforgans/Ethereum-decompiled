...
uint64 stor4; offset 136
uint64 stor4;
uint64 stor4; offset 64

function _fallback() {
    uint64(stor3.field_0) = code.data[6657 len 8]
    uint64(stor2.field_64) = code.data[6721 len 8]
    uint64(stor2.field_128) = 0
    uint64(stor2.field_192) = code.data[6625 len 8]
    uint64(stor2.field_192) = 0
    uint64(stor2.field_192) = 0
    if not code.data[6729 len 32]:
        uint64(stor2.field_0) = 16344623761438316625
    else:
        uint64(stor2.field_0) = code.data[6753 len 8]
    uint128(stor3.field_64) = 0
    uint64(stor3.field_192) = code.data[6689 len 8]
    idx = 1
    while uint64(idx) <= uint64(stor3.field_192):
        ...
        idx = idx + 1
        continue 
    uint64(stor4.field_0) = code.data[6785 len 8]
    ...
    stor4.field_136 % 72057594037927936 = 0
    emit 0xfc556794: 0, code.data[6625 len 8], code.data[6633 len 32] << 192, code.data[6665 len 32] << 192, code.data[6697 len 32] << 192, code.data[6729 len 32] << 192, uint64(code.data[6761 len 32])
    return code.data[802 len 5799]
}
...
function sub_95e71ad4(?) {
    require arg3 < uint256(stor0[arg1 << 192][4][arg2 << 192].field_0)
    uint256(stor0[arg1 << 192][4][arg2 << 192][uint64(arg3) / 4].field_0) = uint64(stor('array', ('mask_shl', 62, 2, -2, ('param', 'arg3')), ('map', ('mask_shl', 64, 0, 192, ('param', 'arg2')), ('array', 4, ('map', ('mask_shl', 64, 0, 192, ('param', 'arg1')), ('name', 'stor0', 0)))))[uint8(arg3)] + arg4) * 256^(8 * arg3 % 4) or uint256(stor0[arg1 << 192][4][arg2 << 192][uint64(arg3) / 4].field_0) and !(test266151307() * 256^(8 * arg3 % 4))
    require 0 < uint256(stor0[arg1 << 192][4][arg2 << 192].field_0)
    uint64(stor0[arg1 << 192][4][arg2 << 192].field_0) = uint64(uint64(stor0[arg1 << 192][4][arg2 << 192].field_0) + arg4)
    uint64(stor4.field_128) = uint64(uint64(stor4.field_128) + 1)
    emit 0xee4d4307: uint64(stor4.field_0), arg1 << 192, arg2 << 192, arg3 << 192, uint64(arg4)
}
...
function sub_a1b27aa4(?) {
    ...
    uint64(stor4.field_128) = uint64(uint64(stor4.field_128) + 1)
    mem[32] = 0
    mem[mem[64] + 64] = uint64(stor0[uint64(stor3.field_64) + 1 << 192].field_320)
    mem[mem[64] + 96] = uint64(stor0[uint64(stor3.field_64) + 1 << 192].field_256)
    mem[mem[64] + 224] = uint256(stor0[uint64(stor3.field_64) + 1 << 192][3].field_0)
    idx = mem[64] + 224
    s = 0
    while mem[64] + stor0[uint64(stor3.field_64) + 1 << 192][3].length + 224 > idx + 32:
        mem[idx + 32] = uint256(stor0[uint64(stor3.field_64) + 1 << 192][s + 3].field_256)
        idx = idx + 32
        s = s + 1
        continue 
    emit 0x37bac8e6: uint64(stor4.field_0), uint64(stor0[uint64(stor3.field_64) + 1 << 192].field_0), uint64(stor0[uint64(stor3.field_64) + 1 << 192].field_256), uint64(stor0[uint64(stor3.field_64) + 1 << 192].field_256), Array(len=stor0[uint64(stor3.field_64) + 1 << 192][3].length, data=mem[mem[64] + 224 len stor0[uint64(stor3.field_64) + 1 << 192][3].length + (floor32(stor0[uint64(stor3.field_64) + 1 << 192][3].length - 1) + -stor0[uint64(stor3.field_64) + 1 << 192][3].length + 32 % 32)]), Mask(8, 248, uint8(stor0[uint64(stor3.field_64) + 1 << 192].field_0))
}
