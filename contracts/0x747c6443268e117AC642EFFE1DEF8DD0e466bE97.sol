...
function play(uint8 arg1) payable {
    ...
    if block.number - stor16[msg.sender].field_0 < 250:
        ...
        if msg.value > maxBet:
            revert with 0, 'Amount should be within range'
        if stor16[msg.sender].field_512:
            revert with 0, 'You have already bet'
        if arg1:
            if arg1 != 1:
                revert with 0, 'Coin side is incorrect'
        if paused:
            revert with 0, 'Game was stopped'
        stor16[msg.sender].field_512 = msg.value
        stor16[msg.sender].field_0 = block.number
        stor16[msg.sender].field_256 = arg1
        ...
        if stor16[msg.sender].field_0 > 0:
            emit 0x292f7e37: 0, jackpotBalance, 0, stor16[msg.sender].field_512, msg.sender, 0, 1200
