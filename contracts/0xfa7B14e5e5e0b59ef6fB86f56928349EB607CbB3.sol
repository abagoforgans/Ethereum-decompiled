...
function acceptAction(bytes32 arg1) {
    ...
    call requestCoreAddress.getPayer(bytes32 arg1) with:
    ...
    require ext_code.size(requestCoreAddress)
    call requestCoreAddress.accept(bytes32 arg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function additionalAction(bytes32 arg1, uint256[] arg2) {
    ...
    require ext_code.size(requestCoreAddress)
    call requestCoreAddress.getSubPayeesCount(bytes32 arg1) with:
         gas gas_remaining wei
        args arg1
        ...
        if not mem[(32 * uint8(idx)) + 128]:
            ...
            if uint8(idx) < arg2.length:
                ...
                if mem[(32 * uint8(idx)) + 128] >= 0:
                    ...
                    require ext_code.size(requestCoreAddress)
                    call requestCoreAddress.updateExpectedAmount(bytes32 arg1, uint8 arg2, int256 arg3) with:
                         gas gas_remaining wei
...
function cancelAction(bytes32 arg1) {
    ...
    require ext_code.size(requestCoreAddress)
    if ext_call.return_data[12 len 20] != msg.sender:
        call requestCoreAddress.getPayeeAddress(bytes32 arg1, uint8 arg2) with:
             gas gas_remaining wei
            args arg1, 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    require ext_code.size(requestCoreAddress)
    call requestCoreAddress.cancel(bytes32 arg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
        ...
        if not mem[(32 * uint8(idx)) + 128]:
            ...
            if uint8(idx) < arg2.length:
                ...
                if mem[(32 * uint8(idx)) + 128] >= 0:
                    ...
                    mem[(32 * arg2.length) + 164] = uint8(idx)
                    require ext_code.size(requestCoreAddress)
                    call requestCoreAddress.getPayeeExpectedAmount(bytes32 arg1, uint8 arg2) with:
                         gas gas_remaining wei
                        args arg1, uint8(idx)
                    mem[(32 * arg2.length) + 128] = ext_call.return_data[0]
                    if not ext_call.success:
                ...
                if not mem[(32 * uint8(idx)) + 128]:
                    ...
                    if uint8(idx) < arg2.length:
                        ...
                        if mem[(32 * uint8(idx)) + 128] >= 0:
                            ...
                            require ext_code.size(requestCoreAddress)
                            call requestCoreAddress.updateBalance(bytes32 arg1, uint8 arg2, int256 arg3) with:
                                 gas gas_remaining wei
