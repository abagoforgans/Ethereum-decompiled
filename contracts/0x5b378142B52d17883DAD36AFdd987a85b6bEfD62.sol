...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 13000000 * 10^18
    stor2 = 13000000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 21
    stor3.length.field_8 = 'Ethereum Reward Token' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'ERW' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[571 len 4004]
}
