...
#  - sub_91fd8349(?)
#
const sub_14cee1ce(?) = 1700

const sub_c75a3fd9(?) = 575000000 * 10^18

const CROWDSALE_MAX_ACES = 425000000 * 10^18
...
uint8 sub_1c100d62; offset 160
uint8 sub_950debd2; offset 168
...
function sub_836be1c2(?) {
    if bool(stor3[address(msg.sender)]) != 1:
        revert with 0, 'agent required'
    require not sub_1c100d62
    require not sub_950debd2
    require block.timestamp > stor12
    require arg1 == 440164909
    require stor17 <= 425000000 * 10^18
    require stor13 <= -stor17 + 425000000 * 10^18
    sub_475efeaf = -stor17 + -stor13 + 425000000 * 10^18
    require sub_475efeaf <= 425000000000000000000000000 * 10^18
...
function sub_f013e322(?) {
    ...
    require sub_76760991 + arg2 <= 575000000 * 10^18
    require sub_c5e0534a[address(arg1)].field_0 + arg2 >= sub_c5e0534a[address(arg1)].field_0
    sub_c5e0534a[address(arg1)].field_0 += arg2
    require sub_76760991 + arg2 >= sub_76760991
    sub_76760991 += arg2
