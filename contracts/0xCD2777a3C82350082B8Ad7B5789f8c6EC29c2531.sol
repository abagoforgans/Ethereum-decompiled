...
function _fallback() payable {
    ...
    create contract with 0 wei
                    code: code.data[4672 len 2986], address(this.address), stor2
    ...
    require ext_call.success
    return code.data[1443 len 3229]
}
...
function preBuy() payable {
    ...
    require not halted
    require 1000 <= -btcsPortionTotal + 17625 * 10^6
    ...
    call gupTokenAddress.createToken(address rg1, uint256 rg2) with:
         gas gas_remaining - 50 wei
        args msg.sender, 1000
    require ext_call.success
    require ext_call.return_data[0]
    gupSold += 1000
    btcsPortionTotal += 1000
    emit PreBuy(1000);
}
