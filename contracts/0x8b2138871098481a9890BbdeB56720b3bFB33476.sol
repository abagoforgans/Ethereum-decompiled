...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor1 = msg.sender
    stor2 = 10^18 * code.data[1733 len 32]
    stor4 = (60 * code.data[1765 len 32]) + block.timestamp
    stor5 = code.data[1797 len 32]
    stor6 = code.data[1841 len 20]
    return code.data[196 len 1537]
}
