...
function _fallback() payable {
    ...
    stor10 = code.data[4419 len 20]
    stor11 = code.data[4451 len 20]
    stor8 = code.data[4483 len 20]
    require code.data[4503 len 32] > 100
    stor2 = code.data[4503 len 32]
    stor3 = 60 * code.data[4535 len 32]
    return code.data[287 len 4120]
}
...
function withdrawATN() {
    ...
    call ATNAddress.transfer(address rg1, uint256 rg2) with:
         gas gas_remaining - 710 wei
...
function batchWithdraw(address[] arg1) {
    ...
    while idx < arg1.length:
        ...
        if records[address(msg.sender)].field_0:
            require records[address(msg.sender)].field_0
            require rate * records[address(msg.sender)].field_0 / records[address(msg.sender)].field_0 == rate
        mem[(32 * arg1.length) + 164] = rate * records[address(msg.sender)].field_0 / 100
        require ext_code.size(ATNAddress)
        call ATNAddress.transfer(address rg1, uint256 rg2) with:
             gas gas_remaining - 710 wei
            args msg.sender, rate * records[address(msg.sender)].field_0 / 100
        ...
        mem[(32 * arg1.length) + 160] = rate * records[address(msg.sender)].field_0 / 100
        emit Withdrawal(withdrawId, rate * records[address(msg.sender)].field_0 / 100, msg.sender);
        s = _28
        idx = idx + 1
        continue 
