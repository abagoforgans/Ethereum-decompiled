...
function sub_e61021e8(?) {
    ...
    mem[(2 * ceil32(return_data.size)) + 288] = mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 288] + 288]
    ...
    if ceil32(_12) <= _12:
        ...
        getSafe[stor7][5][].field_0 = Array(len=mem[(2 * ceil32(return_data.size)) + 288], data=mem[(2 * ceil32(return_data.size)) + 320 len mem[(2 * ceil32(return_data.size)) + 288]])
