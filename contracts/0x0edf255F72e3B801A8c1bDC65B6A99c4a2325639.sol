...
function _fallback() payable {
    stor4 = code.data[3558 len 32]
    if code.data[3590 len 32]:
        stor0 = code.data[3590 len 32]
    else:
        stor0 = 1
    stor1 = code.data[3622 len 32]
    return code.data[96 len 3462]
}
...
function newProposal(address arg1, uint256 arg2, string arg3, bytes arg4) payable {
    ...
    if not stor2 <= stor2 + 1:
        mem[0] = 2
        idx = (9 * stor2) + 9
        while sha3(2) + (9 * stor2) > idx + sha3(mem[0]):
            ...
            continue 
    require stor2 < stor2
    uint256(stor5640[stor2]) = arg1 or Mask(96, 160, uint256(stor5640[stor2]))
    stor4057[stor2] = arg2
    uint256(stor[sha3((9 * stor2) + 0x405787fa12a823e0f2b7631cc41b3ba8828b3321ca811111fa75cd3aa3bb5ad0)][].field_0) = Array(len=arg3.length, data=arg3[all])
    stor5640[stor2] = sha3(arg1, arg2, arg4[all])
    stor5640[stor2] = block.timestamp + (60 * debatingPeriodInMinutes)
    uint8(stor5640[stor2].field_0) = 1
    uint8(stor5640[stor2].field_8) = 0
    stor5640[stor2] = 0
    emit ProposalAdded(stor2, address(arg1), arg2, Array(len=arg3.length, data=arg3[all]));
    numProposals = stor2 + 1
    return stor2
}
