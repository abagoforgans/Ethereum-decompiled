...
function _fallback() payable {
    stor2 = code.data[3772 len 32]
    stor3 = msg.sender or Mask(96, 160, stor3)
    create contract with 0 wei
                    code: code.data[147 len 2012], address(this.address), code.data[3784 len 20]
    uint256(stor1.field_0) = Mask(96, 0, stor1.field_160)
    return code.data[2159 len 1613]
}
...
function sub_c2158415(?) payable {
    require stor2 == msg.sender
    if 0 == address(stor0[arg1[all]]):
        return 0
    call address(stor0[arg1[all]]).0x5532cef5 with:
