...
function finalizeCrowdsale() payable {
    ...
    if uint8(var33007) >= 0xc331051700000000000000000000000000000000000000000000000000000000:
        ...
        require ext_code.size(0x8398a1896dfda239ab8f2ae23c532ef3dcafbd8c)
        delegate 0x8398a1896dfda239ab8f2ae23c532ef3dcafbd8c.mem[var61002 len 4] with:
             gas gas_remaining - 710 wei
        ...
        require ext_code.size(0x8398a1896dfda239ab8f2ae23c532ef3dcafbd8c)
        delegate 0x8398a1896dfda239ab8f2ae23c532ef3dcafbd8c.mem[var57002 len 4] with:
             gas gas_remaining - 710 wei
