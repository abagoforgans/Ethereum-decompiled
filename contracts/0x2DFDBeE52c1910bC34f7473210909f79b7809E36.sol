...
function sub_9bcd7865(?) {
    return stor29, stor30, stor31, stor32, bool(stor33)
}

function sub_efc3f2a0(?) {
    require calldata.size - 4 >= 32
    require arg1 < 3
    return stor14[arg1], stor15[arg1], stor16[arg1], stor17[arg1], bool(stor18[arg1])
}
...
function sub_e1c2c15e(?) {
    ...
    while idx < sub_56b16162.length:
        ...
        mem[32] = 1
        if voters[address(stor3[idx])].field_0 >= 10^11:
...
function _fallback() payable {
    ...
    while uint8(idx) < sub_56b16162.length:
        ...
        if address(sub_56b16162[uint8(idx)]) != msg.sender:
            idx = idx + 1
            continue 
        if voters[msg.sender].field_0 > voters[address(stor6)].field_0:
    ...
    if arg1:
        ...
        while idx < sub_47c8eb0b + 2:
            ...
            if arg1:
                ...
                mem[mem[64] + 36] = voters[address(stor3[idx])].field_256
                mem[mem[64] + 68] = arg1
                require ext_code.size(sub_0fc922d1Address)
                call sub_0fc922d1Address.0xe7d7f950 with:
                     gas gas_remaining wei
                    args address(sub_56b16162[idx]), voters[address(stor3[idx])].field_256, arg1
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            else:
                if owner != msg.sender:
                ...
                call address(sub_56b16162[idx]) with:
                   value voters[address(stor3[idx])].field_768 wei
                     gas 2300 * is_zero(value) wei
                if ext_call.success:
                    if arg1:
                        require ext_code.size(sub_0fc922d1Address)
                        call sub_0fc922d1Address.0x6180547 with:
                             gas gas_remaining wei
                            args address(sub_56b16162[idx]), voters[address(stor3[idx])].field_768
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                    else:
                        if voters[address(stor3[idx])].field_768 > voters[address(stor3[idx])].field_768:
                            revert with 0, 'b should be small than a on sub'
                        voters[address(stor3[idx])].field_768 -= voters[address(stor3[idx])].field_768
                        if voters[address(stor3[idx])].field_768 + voters[address(stor3[idx])].field_1024 < voters[address(stor3[idx])].field_1024:
                            revert with 0, 'overflow on add'
                        mem[0] = address(sub_56b16162[idx])
                        mem[32] = 1
                        voters[address(stor3[idx])].field_1024 += voters[address(stor3[idx])].field_768
                mem[mem[64]] = address(sub_56b16162[idx])
                mem[mem[64] + 32] = voters[address(stor3[idx])].field_768
                mem[mem[64] + 64] = bool(ext_call.success)
                mem[mem[64] + 96] = arg1
                emit 0x380c75f6: address(sub_56b16162[idx]), voters[address(stor3[idx])].field_768, bool(ext_call.success), arg1
        ...
        while idx < sub_d30cda85 + 2:
            ...
            if not arg1:
                ...
                sub_2dbcc7fe++
    if not arg1:
        if sub_d30cda85 + 2 < sub_d30cda85:
            revert with 0, 'overflow on add'
        sub_d30cda85 += 2
    else:
        if sub_47c8eb0b + 2 < sub_47c8eb0b:
            revert with 0, 'overflow on add'
        sub_47c8eb0b += 2
}
...
function sub_ef4dd10a(?) payable {
    ...
    if arg1:
        ...
        while idx < sub_47c8eb0b + 2:
            ...
            mem[132] = voters[address(stor3[idx])].field_256
            mem[164] = 1
            require ext_code.size(sub_0fc922d1Address)
            call sub_0fc922d1Address.0xe7d7f950 with:
                 gas gas_remaining wei
                args address(sub_56b16162[idx]), voters[address(stor3[idx])].field_256, 1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            if idx != sub_56b16162.length - 1:
                idx = idx + 1
            ...
            while idx < sub_d30cda85 + 2:
                ...
                mem[mem[64] + 64] = bool(ext_call.success)
                mem[mem[64] + 96] = 0
                emit 0x380c75f6: address(sub_56b16162[idx]), voters[address(stor3[idx])].field_768, bool(ext_call.success), 0
                if idx != sub_56b16162.length - 1:
                    idx = idx + 1
                    continue 
                sub_d30cda85 = 0
...
function sub_777ac55b(?) payable {
    ...
    if not sub_f443e231:
        ...
        while idx < sub_614cb988.length:
            if not shareholders[stor5[idx]].field_0:
                require idx < sub_614cb988.length
                if shareholders[stor5[idx]].field_0 <= 0:
                    revert with 0, 'shareholder address is invalid'
                call sub_614cb988[idx] with:
                     gas 2300 wei
                if not ext_call.success:
                    if shareholders[stor5[idx]].field_512 < shareholders[stor5[idx]].field_512:
                        revert with 0, 'overflow on add'
                if shareholders[stor5[idx]].field_256 < shareholders[stor5[idx]].field_256:
                    revert with 0, 'overflow on add'
                ...
                if -1 * sub_f37f2107 * shareholders[stor5[idx]].field_0 / shareholders[stor5[idx]].field_0 != -sub_f37f2107:
                    revert with 0, 
                                32,
                                41,
                                0x256d756c20726573756c74206973206e6f7420657175616c206f6e20736166656d6174682063686563,
                ...
                if shareholders[stor5[idx]].field_0 <= 0:
                    revert with 0, 'shareholder address is invalid'
                call sub_614cb988[idx] with:
                   value -1 * sub_f37f2107 * shareholders[stor5[idx]].field_0 / 30 wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    if (-1 * sub_f37f2107 * shareholders[stor5[idx]].field_0 / 30) + shareholders[stor5[idx]].field_512 < shareholders[stor5[idx]].field_512:
                        revert with 0, 'overflow on add'
                    shareholders[stor5[idx]].field_512 += -1 * sub_f37f2107 * shareholders[stor5[idx]].field_0 / 30
                if (-1 * sub_f37f2107 * shareholders[stor5[idx]].field_0 / 30) + shareholders[stor5[idx]].field_256 < shareholders[stor5[idx]].field_256:
                    revert with 0, 'overflow on add'
                mem[0] = sub_614cb988[idx]
                mem[32] = 2
                shareholders[stor5[idx]].field_256 += -1 * sub_f37f2107 * shareholders[stor5[idx]].field_0 / 30
                mem[mem[64]] = sub_614cb988[idx]
                mem[mem[64] + 32] = -1 * sub_f37f2107 * shareholders[stor5[idx]].field_0 / 30
                mem[mem[64] + 64] = bool(ext_call.success)
                emit 0x3ecf3cbb: sub_614cb988[idx], -1 * sub_f37f2107 * shareholders[stor5[idx]].field_0 / 30, bool(ext_call.success)
                if (-1 * sub_f37f2107 * shareholders[stor5[idx]].field_0 / 30) + sub_f37f2107 < sub_f37f2107:
                    revert with 0, 'overflow on add'
                sub_f37f2107 += -1 * sub_f37f2107 * shareholders[stor5[idx]].field_0 / 30
            idx = idx + 1
            continue 
    else:
        ...
        while idx < sub_614cb988.length:
            if not shareholders[stor5[idx]].field_0:
                ...
                if (30 * sub_f443e231 / 100 * shareholders[stor5[idx]].field_0) - (sub_f37f2107 * shareholders[stor5[idx]].field_0) / shareholders[stor5[idx]].field_0 != (30 * sub_f443e231 / 100) - sub_f37f2107:
                    revert with 0, 
                                32,
                                41,
                                0x256d756c20726573756c74206973206e6f7420657175616c206f6e20736166656d6174682063686563,
                ...
                if shareholders[stor5[idx]].field_0 <= 0:
                    revert with 0, 'shareholder address is invalid'
                call sub_614cb988[idx] with:
                   value (30 * sub_f443e231 / 100 * shareholders[stor5[idx]].field_0) - (sub_f37f2107 * shareholders[stor5[idx]].field_0) / 30 wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    if ((30 * sub_f443e231 / 100 * shareholders[stor5[idx]].field_0) - (sub_f37f2107 * shareholders[stor5[idx]].field_0) / 30) + shareholders[stor5[idx]].field_512 < shareholders[stor5[idx]].field_512:
                        revert with 0, 'overflow on add'
                    shareholders[stor5[idx]].field_512 += (30 * sub_f443e231 / 100 * shareholders[stor5[idx]].field_0) - (sub_f37f2107 * shareholders[stor5[idx]].field_0) / 30
                if ((30 * sub_f443e231 / 100 * shareholders[stor5[idx]].field_0) - (sub_f37f2107 * shareholders[stor5[idx]].field_0) / 30) + shareholders[stor5[idx]].field_256 < shareholders[stor5[idx]].field_256:
                    revert with 0, 'overflow on add'
                mem[0] = sub_614cb988[idx]
                mem[32] = 2
                shareholders[stor5[idx]].field_256 += (30 * sub_f443e231 / 100 * shareholders[stor5[idx]].field_0) - (sub_f37f2107 * shareholders[stor5[idx]].field_0) / 30
                mem[mem[64]] = sub_614cb988[idx]
                mem[mem[64] + 32] = (30 * sub_f443e231 / 100 * shareholders[stor5[idx]].field_0) - (sub_f37f2107 * shareholders[stor5[idx]].field_0) / 30
                mem[mem[64] + 64] = bool(ext_call.success)
                emit 0x3ecf3cbb: sub_614cb988[idx], (30 * sub_f443e231 / 100 * shareholders[stor5[idx]].field_0) - (sub_f37f2107 * shareholders[stor5[idx]].field_0) / 30, bool(ext_call.success)
                if ((30 * sub_f443e231 / 100 * shareholders[stor5[idx]].field_0) - (sub_f37f2107 * shareholders[stor5[idx]].field_0) / 30) + sub_f37f2107 < sub_f37f2107:
                    revert with 0, 'overflow on add'
                sub_f37f2107 += (30 * sub_f443e231 / 100 * shareholders[stor5[idx]].field_0) - (sub_f37f2107 * shareholders[stor5[idx]].field_0) / 30
            idx = idx + 1
            continue 
    require ext_code.size(sub_0fc922d1Address)
    ...
    if msg.sender == owner:
        if arg1:
            if not poolTotalAmount:
                ...
                while idx < arg2.length:
                    require idx < arg2.length
                    _361 = sha3(mem[(32 * idx) + 140 len 20], 1)
                    if not voters[mem[(32 * idx) + 140 len 20]].field_0:
                        if sub_f443e231 <= 0:
                            revert with 0, 'b should large than 0 on div'
                        require sub_f443e231
        ...
        if arg1:
            if not poolTotalAmount:
                ...
                while idx < arg2.length:
                    require idx < arg2.length
                    _365 = sha3(mem[(32 * idx) + 140 len 20], 1)
                    if not voters[mem[(32 * idx) + 140 len 20]].field_0:
                        if sub_f443e231 <= 0:
                            revert with 0, 'b should large than 0 on div'
                        require sub_f443e231
    ...
    if msg.sender == owner:
        if arg1:
            ...
            if not ext_call.return_data[0]:
                ...
                while idx < arg3.length:
                    ...
                    _471 = sha3(mem[(32 * idx) + 140 len 20], 1)
                    if not voters[mem[(32 * idx) + 140 len 20]].field_0:
                        if sub_f443e231 <= 0:
                            revert with 0, 'b should large than 0 on div'
                        require sub_f443e231
                ...
                while idx < arg3.length:
                    require idx < arg3.length
                    _469 = sha3(mem[(32 * idx) + 140 len 20], 1)
                    if not voters[mem[(32 * idx) + 140 len 20]].field_0:
                        if sub_f443e231 <= 0:
                            revert with 0, 'b should large than 0 on div'
                        require sub_f443e231
        ...
        if arg1:
            ...
            if not ext_call.return_data[0]:
                ...
                while idx < arg3.length:
                    require idx < arg3.length
                    _475 = sha3(mem[(32 * idx) + 140 len 20], 1)
                    if not voters[mem[(32 * idx) + 140 len 20]].field_0:
                        if sub_f443e231 <= 0:
                            revert with 0, 'b should large than 0 on div'
                        require sub_f443e231
                ...
                while idx < arg3.length:
                    require idx < arg3.length
                    _473 = sha3(mem[(32 * idx) + 140 len 20], 1)
                    if not voters[mem[(32 * idx) + 140 len 20]].field_0:
                        if sub_f443e231 <= 0:
                            revert with 0, 'b should large than 0 on div'
                        require sub_f443e231
