...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[14175 len 8] > code.data[14143 len 8]
    stor1[address(msg.sender)] = 1
    create contract with 0 wei
                    code: code.data[8275 len 3565], 6000000000 * 10^18
    ...
    call address(stor2.field_0).0x7d64bcb4 with:
         gas gas_remaining - 710 wei
    require ext_call.success
    uint64(stor2.field_160) = uint64(code.data[14119 len 32])
    stor3 = uint64(code.data[14151 len 32])
    stor4 = code.data[14183 len 32]
    create contract with 0 wei
                    code: code.data[11840 len 1548], 0xe0831b1687c9fad3447a517f9371e66672505db0
    require create.new_address
    stor14 = address(create.new_address)
    create contract with 0 wei
                    code: code.data[13388 len 731], address(stor2.field_0), 0x4452d6454e777743a5ee233fbe873055008ff528, uint64(uint64(stor2.field_160) + (4320 * 24 * 3600))
    address(stor11.field_8) = address(create.new_address)
    create contract with 0 wei
                    code: code.data[13388 len 731], address(stor2.field_0), 0x4452d6454e777743a5ee233fbe873055008ff528, uint64(uint64(stor2.field_160) + (8640 * 24 * 3600))
    stor12 = address(create.new_address)
    create contract with 0 wei
                    code: code.data[13388 len 731], address(stor2.field_0), 0xd68947892ef4d94cdef7165b109cf6cd3f58a8e8, uint64(uint64(stor2.field_160) + (8640 * 24 * 3600))
    stor13 = address(create.new_address)
    require ext_code.size(address(stor2.field_0))
    call address(stor2.field_0).0xa9059cbb with:
         gas gas_remaining - 710 wei
        args 0xd68947892ef4d94cdef7165b109cf6cd3f58a8e8, 933333333 * 10^18
    require ext_call.success
    ...
    call address(stor2.field_0).0xa9059cbb with:
         gas gas_remaining - 710 wei
        args stor13, 56666667 * 10^18
    require ext_call.success
    require ext_call.return_data[0]
    return code.data[1932 len 6343]
}
...
const FOUNDATION_POOL_TOKENS_VESTED = 56666667 * 10^18
...
const FOUNDATION_POOL_TOKENS = 933333333 * 10^18
...
function releaseLockFounders1() {
    ...
    call foundersTimelock1Address.0x86d1a69f with:
         gas gas_remaining - 710 wei
    require ext_call.success
}
...
function releaseLockFounders2() {
    ...
    call foundersTimelock2Address.0x86d1a69f with:
         gas gas_remaining - 710 wei
    require ext_call.success
}
...
function releaseLockFoundation() {
    ...
    call foundationTimelockAddress.0x86d1a69f with:
         gas gas_remaining - 710 wei
    require ext_call.success
}
...
function releaseLock(address arg1) {
    ...
    call vestedTokens[address(arg1)].0x86d1a69f with:
         gas gas_remaining - 710 wei
    require ext_call.success
}
...
function finalize() {
    ...
    if totalPurchased < goal:
        ...
        require ext_call.success
        require ext_code.size(tokenAddress)
        call tokenAddress.enableTransfers() with:
             gas gas_remaining - 710 wei
    require ext_call.success
    emit Finalized()
    stor11 = 1
...
function addPrecommitment(address arg1, uint256 arg2, bool arg3) {
    ...
    if not arg3:
        ...
        if vestedTokens[address(arg1)]:
            ...
            create contract with 0 wei
                            code: code.data[5569 len 731], tokenAddress, address(arg1), uint64(startTime + (4320 * 24 * 3600))
            require create.new_address
