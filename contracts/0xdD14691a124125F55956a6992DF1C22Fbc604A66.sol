...
function _fallback() payable {
    ...
    mem[96 len -6318] = code.data[7038 len -6318]
    mem[64] = -6222
    stor3 = msg.sender
    stor8 = msg.sender
    stor3 = msg.sender
...
function mint(address arg1, uint256 arg2) {
    ...
    require not stor6
    require ext_code.size(0xe4834de85bd73dd6a1cc68847b7a3691ccb7c9d4)
    delegate 0xe4834de85bd73dd6a1cc68847b7a3691ccb7c9d4.0x66098d4f with:
         gas gas_remaining - 50 wei
