...
function _fallback() {
    stor0 = msg.sender
    stor1 = code.data[4660 len 20]
    return code.data[113 len 4535]
}
...
function sub_ea69b4f2(?) {
    if block.timestamp >= sub_852513ab[address(arg1)].field_256 + (240 * 24 * 3600):
        return 0
    return ((sub_852513ab[address(arg1)].field_256 + -block.timestamp + (240 * 24 * 3600) / 24 * 3600) + 1)
}

function sub_7b143e27(?) {
    if block.timestamp >= sub_852513ab[address(arg1)].field_256 + (1680 * 24 * 3600):
        return 0
    return ((sub_852513ab[address(arg1)].field_256 + -block.timestamp + (1680 * 24 * 3600) / 24 * 3600) + 1)
}
...
function reward(address arg1) {
    ...
    stor0 = 1
    if block.timestamp < sub_852513ab[address(arg1)].field_256 + (240 * 24 * 3600):
        require not (sub_852513ab[address(arg1)].field_256 + -block.timestamp + (240 * 24 * 3600) / 24 * 3600) + 1
