...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'LotteChain' / 256
    idx = 0
    ...
    stor4.length.field_8 = 'LOTTE' / 256
    idx = 0
    ...
    stor1 = msg.sender
    stor6 = 20000000000 * 10^18
    stor7[address(msg.sender)] = 20000000000 * 10^18
    emit Transfer(20000000000 * 10^18, 0, msg.sender);
    return code.data[464 len 2496]
}
