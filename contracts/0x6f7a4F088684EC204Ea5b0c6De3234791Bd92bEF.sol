...
function _fallback() {
    mem[96 len -7093] = code.data[7592 len -7093]
    mem[64] = -6997
    stor0 = msg.sender
...
mapping of uint32 sub_e3b5908a;
...
function sub_e3b5908a(?) {
    return sub_e3b5908a[address(arg1)]
}
...
function transferProxy(address arg1, address arg2, uint256 arg3, uint256 arg4, uint8 arg5, bytes32 arg6, bytes32 arg7) {
    require arg2
    signer = erecover(sha3(arg1, arg2, arg3, arg4, sub_e3b5908a[address(arg1)]), arg5 << 248, arg6, arg7) 
    require erecover.result
    require address(signer) == arg1
    sub_e3b5908a[address(arg1)] = uint32(sub_e3b5908a[address(arg1)] + 1)
    require arg3 <= balanceOf[address(arg1)]
    if arg4 <= 0:
        balanceOf[address(arg1)] -= arg3
    else:
        require arg4 <= balanceOf[address(arg1)] - arg3
