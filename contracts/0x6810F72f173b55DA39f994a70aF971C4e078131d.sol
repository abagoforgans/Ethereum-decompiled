...
function sub_6721a38a(?) {
    balanceOf[address(msg.sender)] = 5 * 10^10
    totalSupply = 50 * 10^6
    bool(name.length) = 0
    name.length.field_1 = 13
    name.length.field_8 = 'BITSDAQ CANDY' / 256
    idx = 0
    ...
    symbol.length.field_8 = 'BXBC' / 256
    idx = 0
