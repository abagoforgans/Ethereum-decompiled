...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 2777775 * 10^14 * 24 * 3600
    stor2 = 2777775 * 10^14 * 24 * 3600
    bool(stor3.length) = 0
    stor3.length.field_1 = 8
    stor3.length.field_8 = 'MK2Token' / 256
    idx = 0
