...
function _fallback() payable {
    ...
    stor2 = code.data[8010 len 32]
    stor3 = 1
    return code.data[146 len 7864]
}
...
function sub_38f8316b(?) payable {
    ...
    create contract with 0 wei
                    code: code.data[5272 len 1296], tokenContractAddress
...
function createDepositAddress() payable {
    ...
    if address(sub_99d26960[stor3]):
        return 0
    create contract with 0 wei
                    code: code.data[6568 len 1296], tokenContractAddress
