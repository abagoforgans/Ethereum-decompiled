...
function _fallback() payable {
    ...
    require stor2[stor1] + uint256(stor5.field_0) >= stor2[stor1]
    stor2[stor1] += uint256(stor5.field_0)
    emit Distr(uint256(stor5.field_0), stor1);
    emit Transfer(uint256(stor5.field_0), 0, stor1);
    return code.data[757 len 7478]
}
