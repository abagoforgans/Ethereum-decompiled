...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'Crypto EUR' / 256
    idx = 0
    ...
    require stor6 + 19640702000 > stor6
    stor6 += 19640702000
    stor7[address(msg.sender)] += 19640702000
    emit Transfer(19640702000, 0, msg.sender);
