...
function _fallback() payable {
    ...
    stor3 = msg.sender
    stor1[address(msg.sender)] = 15000000 * 10^18
    stor0 = 15000000 * 10^18
    emit Transfer(15000000 * 10^18, 0, msg.sender);
    address(stor4.field_0) = msg.sender
    require msg.sender == stor3
    require address(stor4.field_0)
    emit OwnershipTransferred(stor3, address(stor4.field_0));
    stor3 = address(stor4.field_0)
    return code.data[792 len 6851]
}
