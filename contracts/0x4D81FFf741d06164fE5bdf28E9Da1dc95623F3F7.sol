...
function initialize(address arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint256 arg5) {
    ...
    totalSupply = arg5
    require arg4 <= arg5
    balanceOf[stor8] = arg5 - arg4
    balanceOf[msg.sender] = saleCap
}
...
function _fallback() payable {
    ...
    if block.timestamp < startDate:
        ...
        if block.timestamp < startDate + (24 * 3600):
            ...
            require (5600 * msg.value) + balanceOf[msg.sender] >= balanceOf[msg.sender]
            balanceOf[address(msg.sender)] = (5600 * msg.value) + balanceOf[msg.sender]
            ...
            if block.timestamp < startDate + (48 * 24 * 3600):
                ...
                require (5200 * msg.value) + balanceOf[msg.sender] >= balanceOf[msg.sender]
                balanceOf[address(msg.sender)] = (5200 * msg.value) + balanceOf[msg.sender]
                ...
                if block.timestamp < startDate + (72 * 24 * 3600):
                    ...
                    require (4800 * msg.value) + balanceOf[msg.sender] >= balanceOf[msg.sender]
                    balanceOf[address(msg.sender)] = (4800 * msg.value) + balanceOf[msg.sender]
                    ...
                    if block.timestamp < startDate + (96 * 24 * 3600):
                        ...
                        require (4400 * msg.value) + balanceOf[msg.sender] >= balanceOf[msg.sender]
                        balanceOf[address(msg.sender)] = (4400 * msg.value) + balanceOf[msg.sender]
                        ...
                        if block.timestamp > endDate:
                            ...
                            require (4000 * msg.value) + balanceOf[msg.sender] >= balanceOf[msg.sender]
                            balanceOf[address(msg.sender)] = (4000 * msg.value) + balanceOf[msg.sender]
