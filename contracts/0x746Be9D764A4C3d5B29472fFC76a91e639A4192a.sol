...
const name = Array(len=38, data='Market & Ethical Agricultural Tr', 'acking', Mask(48, -256, 'Market & Ethical Agricultural Tr', 'acking') << 256)

const decimals = 18

const initialSupply = 40000000000 * 10^18
