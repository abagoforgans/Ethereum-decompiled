...
function vote(uint256 arg1, bool arg2, string arg3) {
    ...
    require arg1 < proposals.length
    require not uint8(stor[(10 * arg1) + ('name', 'proposals', 4) + 9][address(msg.sender)].field_0)
...
function addMember(address arg1, string arg2) {
    ...
    if memberId[address(arg1)]:
        ...
        address(members[stor6[address(arg1)]].field_0) = arg1
        uint256(stor[sha3((3 * stor6[address(arg1)]) + ('name', 'members', 7) + 1)][].field_0) = Array(len=arg2.length, data=arg2[all])
        uint256(members[stor6[address(arg1)]].field_512) = block.timestamp
    else:
...
function Congress(uint256 arg1, uint256 arg2, int256 arg3) payable {
    require owner == msg.sender
    stor1.length = arg1
    debatingPeriodInMinutes = arg2
    majorityMargin = arg3
    emit ChangeOfRules(arg1, arg2, arg3);
    if memberId[0]:
        require memberId[0] < members.length
        address(members[stor6[0]].field_0) = 0
        members[stor6[0]].field_256 % 1 = 0
        bool(members[stor6[0]].field_256) = 0
        uint255(members[stor6[0]].field_257) = 0
        Mask(248, 0, members[stor6[0]].field_264) = 0
        idx = 0
        while stor[(3 * stor6[0]) + ('name', 'members', 7) + 1].length + 31 / 32 > idx:
            uint256(stor[idx + sha3((3 * stor6[0]) + ('name', 'members', 7) + 1)].field_0) = 0
            idx = idx + 1
            continue 
        uint256(members[stor6[0]].field_512) = block.timestamp
    else:
        ...
        require members.length < members.length
        address(members[members.length].field_0) = 0
        members[members.length].field_256 % 1 = 0
        bool(members[members.length].field_256) = 0
        uint255(members[members.length].field_257) = 0
        Mask(248, 0, members[members.length].field_264) = 0
        idx = 0
    ...
    if memberId[stor0]:
        ...
        address(members[stor6[stor0]].field_0) = owner
        bool(members[stor6[stor0]].field_256) = 0
        uint255(members[stor6[stor0]].field_257) = 7
        Mask(248, 0, members[stor6[stor0]].field_264) = 'founder' / 256
        idx = 0
        while stor[(3 * stor6[stor0]) + ('name', 'members', 7) + 1].length + 31 / 32 > idx:
            uint256(stor[idx + sha3((3 * stor6[stor0]) + ('name', 'members', 7) + 1)].field_0) = 0
            idx = idx + 1
            continue 
        uint256(members[stor6[stor0]].field_512) = block.timestamp
    else:
        memberId[stor0] = members.length
        members.length++
        if not members.length <= members.length + 1:
            mem[0] = 7
            idx = (3 * members.length) + 3
            while sha3(7) + (3 * members.length) > idx + sha3(mem[0]):
                ...
                continue 
        require members.length < members.length
        address(members[members.length].field_0) = owner
        bool(members[members.length].field_256) = 0
        uint255(members[members.length].field_257) = 7
        Mask(248, 0, members[members.length].field_264) = 'founder' / 256
        idx = 0
        while stor[(3 * members.length) + ('name', 'members', 7) + 1].length + 31 / 32 > idx:
            uint256(stor[idx + sha3((3 * members.length) + ('name', 'members', 7) + 1)].field_0) = 0
            idx = idx + 1
            continue 
        uint256(members[members.length].field_512) = block.timestamp
    emit MembershipChanged(owner, 1);
}
