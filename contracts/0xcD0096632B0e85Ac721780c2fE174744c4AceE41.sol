...
function _fallback() payable {
    ...
    mem[96 len -5603] = code.data[6405 len -5603]
    mem[64] = -5507
    stor0 = mem[256]
    ...
    while idx < mem[mem[224] + 96]:
        ...
        mem[0] = 3
        require idx < mem[mem[224] + 96]
        address(stor3[stor3.length]) = mem[(32 * idx) + mem[224] + 140 len 20]
        idx = idx + 1
        continue 
    stor6 = mem[191 len 1]
    stor7 = mem[96] * 10^mem[191 len 1]
    stor9[address(msg.sender)] = mem[96] * 10^mem[191 len 1]
