...
function _fallback() payable {
    ...
    stor4 = code.data[7148 len 20]
    return code.data[514 len 6622]
}
...
const sub_233f8123(?) = 675

const goal = 10^16

const baseExchangeRate = 5000

const hardCap = 10^17

const DECIMALS = 18

const BLOCKS_PER_PHASE = 30
...
function saleDue() {
    return block.number >= firstblock + 300
}
...
function saleEnded() {
    if firstblock <= 0:
        return (firstblock > 0)
    if block.number >= firstblock + 300:
        return block.number >= firstblock + 300
    return totalEthReceived >= 10^17
}
                ...
                if totalEthReceived < 10^16:
                    ...
                    if stor6:
                        ...
                        if totalEthReceived - 10^16 / 10000 * 10^18 > 7:
                            ...
                            emit Issue(targetAddress, 0, 500 * totalSupply / 500);
                        else:
                            ...
                            emit Issue(targetAddress, 0, (675 * totalSupply / (25 * totalEthReceived - 10^16 / 10000 * 10^18) + 325) - (25 * totalEthReceived - 10^16 / 10000 * 10^18 * totalSupply / (25 * totalEthReceived - 10^16 / 10000 * 10^18) + 325));
                        stor6 = 1
                    emit SaleSucceeded()
            else:
    ...
    if firstblock <= 0:
        ...
        if block.number < firstblock:
            ...
            if firstblock <= 0:
                ...
                if block.number - firstblock / 30 >= 10:
                    if 5000 * msg.value:
                    ...
                    emit Issue(address(arg1), msg.value, (5000 * msg.value) + (5000 * msg.value * bonusPercentages.length.field_72 / 100));
                else:
                    require block.number - firstblock / 30 < 10
                    if 5000 * msg.value:
                        require 5000 * msg.value
                        require 5000 * msg.value * bonusPercentages[uint8(block.number - stor5 / 30)].field_0 / 5000 * msg.value == bonusPercentages[uint8(block.number - stor5 / 30)].field_0
                    require (5000 * msg.value) + (5000 * msg.value * bonusPercentages[uint8(block.number - stor5 / 30)].field_0 / 100) >= 5000 * msg.value
                    require totalEthReceived + msg.value >= totalEthReceived
                    totalEthReceived += msg.value
                    require totalSupply + (5000 * msg.value) + (5000 * msg.value * bonusPercentages[uint8(block.number - stor5 / 30)].field_0 / 100) >= totalSupply
                    totalSupply = totalSupply + (5000 * msg.value) + (5000 * msg.value * bonusPercentages[uint8(block.number - stor5 / 30)].field_0 / 100)
                    require balanceOf[address(arg1)] + (5000 * msg.value) + (5000 * msg.value * bonusPercentages[uint8(block.number - stor5 / 30)].field_0 / 100) >= balanceOf[address(arg1)]
                    balanceOf[address(arg1)] = balanceOf[address(arg1)] + (5000 * msg.value) + (5000 * msg.value * bonusPercentages[uint8(block.number - stor5 / 30)].field_0 / 100)
                    emit Issue(address(arg1), msg.value, (5000 * msg.value) + (5000 * msg.value * bonusPercentages[uint8(block.number - stor5 / 30)].field_0 / 100));
        ...
        if block.number < firstblock:
            ...
            if firstblock <= 0:
                ...
                if block.number - firstblock / 30 >= 10:
                    ...
                    emit Issue(msg.sender, msg.value, (5000 * msg.value) + (5000 * msg.value * bonusPercentages.length.field_72 / 100));
                else:
                    require block.number - firstblock / 30 < 10
                    if 5000 * msg.value:
                        require 5000 * msg.value
                    ...
                    require totalSupply + (5000 * msg.value) + (5000 * msg.value * bonusPercentages[uint8(block.number - stor5 / 30)].field_0 / 100) >= totalSupply
                    totalSupply = totalSupply + (5000 * msg.value) + (5000 * msg.value * bonusPercentages[uint8(block.number - stor5 / 30)].field_0 / 100)
                    require balanceOf[address(msg.sender)] + (5000 * msg.value) + (5000 * msg.value * bonusPercentages[uint8(block.number - stor5 / 30)].field_0 / 100) >= balanceOf[address(msg.sender)]
                    balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + (5000 * msg.value) + (5000 * msg.value * bonusPercentages[uint8(block.number - stor5 / 30)].field_0 / 100)
                    emit Issue(msg.sender, msg.value, (5000 * msg.value) + (5000 * msg.value * bonusPercentages[uint8(block.number - stor5 / 30)].field_0 / 100));
                call targetAddress with:
                   value msg.value wei
                     gas 2300 * is_zero(value) wei
                require ext_call.success
