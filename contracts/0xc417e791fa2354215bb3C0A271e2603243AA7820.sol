...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 7500000 * 24 * 3600
    stor2 = 7500000 * 24 * 3600
    bool(stor3.length) = 0
    stor3.length.field_1 = 7
    stor3.length.field_8 = 'Exacoin' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'EXA' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[559 len 4004]
}
