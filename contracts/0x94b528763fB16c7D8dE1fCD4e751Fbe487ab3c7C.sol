...
function _fallback() payable {
    ...
    if not stor1.length <= 600000:
        ...
        while 3 * stor1.length > idx:
            ...
            idx = idx + 3
            continue 
    stor19 = code.data[8216 len 20]
    stor20 = code.data[8248 len 20]
    stor21 = code.data[8280 len 20]
    stor12 = code.data[8300 len 32]
    stor13 = code.data[8332 len 32]
    stor24[address(this.address)] = stor8
    require 24 * 3600 * stor15 <= (24 * 3600 * stor15) + stor12
    stor23 = 24 * 3600 * stor15 / 24 * 3600
    require stor0 == msg.sender
    if stor26 <= 0:
        require block.timestamp - stor22 <= block.timestamp
        require block.timestamp - stor22 >= 8760 * 24 * 3600
    else:
        require stor26 - stor22 <= stor26
        require stor26 - stor22 >= 8760 * 24 * 3600
    ...
    require stor24[stor20] + 4 * 10^14 >= stor24[stor20]
    stor24[stor20] += 4 * 10^14
    stor10 -= 4 * 10^14
    require stor24[this.address] - 4 * 10^14 <= stor24[this.address]
    stor24[address(this.address)] = stor24[this.address] - 4 * 10^14
    require stor24[stor21] + 4 * 10^14 >= stor24[stor21]
    stor24[stor21] += 4 * 10^14
    emit code.data[8172 len 32]: 4 * 10^14, this.address, stor20
    emit code.data[8172 len 32]: 4 * 10^14, this.address, stor21
    return code.data[1576 len 6596]
}
...
function scheduledTopUp() {
    ...
    require balanceOf[stor20] + 4 * 10^14 >= balanceOf[stor20]
    balanceOf[stor20] += 4 * 10^14
    teamAndExpertsTokens -= 4 * 10^14
    ...
    require balanceOf[stor21] + 4 * 10^14 >= balanceOf[stor21]
    balanceOf[stor21] += 4 * 10^14
...
function processPendingTickets() {
    ...
    while 0 < stor3 - stor2:
        ...
        if cTime <= 0:
            ...
            if maxDailyCap - dailyTotals[stor23 + 1] < stor1[stor2].field_256:
                lastProcessedDay++
            else:
                if stor1[stor2].field_512 - 1000 > startTime + (24 * 3600 * lastProcessedDay):
                    ...
                    require dailyTotals[stor23 + 1] + stor1[stor2].field_256 >= dailyTotals[stor23 + 1]
                    dailyTotals[stor23 + 1] += stor1[stor2].field_256
            ...
            s = _58
            s = maxDailyCap - dailyTotals[stor23 + 1]
        ...
        if block.timestamp - startTime <= firstStageDuration:
            ...
            call beneficiaryAddress with:
               value 4 * msg.value / 5 wei
                 gas 2300 * is_zero(value) wei
            require ext_call.success
            if maxDailyCap - dailyTotals[stor23 + 1] >= msg.value / price:
                require availableTokens - (msg.value / price) <= availableTokens
                availableTokens -= msg.value / price
                require balanceOf[address(this.address)] - (msg.value / price) <= balanceOf[address(this.address)]
                balanceOf[address(this.address)] -= msg.value / price
                require dailyTotals[stor23 + 1] + (msg.value / price) >= dailyTotals[stor23 + 1]
                dailyTotals[stor23 + 1] += msg.value / price
