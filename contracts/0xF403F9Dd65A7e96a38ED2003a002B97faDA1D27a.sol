...
function _fallback() payable {
    ...
    return code.data[520 len 20026]
}
...
function sub_139371be(?) {
    require msg.sender == stor1
    stor3[address(arg1)] = 0
}

function sub_c8f3a3ca(?) {
    require msg.sender == stor1
    stor3[address(arg1)] = 1
}

function sub_2488121d(?) {
    require msg.sender == stor1
    call stor1 with:
       value arg1 wei
...
function sub_e127efb2(?) payable {
    ...
    if not mem[140 len 20]:
        ...
        require ext_call.success
        require ext_code.size(address(ext_call.return_data[0]))
        call address(ext_call.return_data[0]).0xfc0c546a with:
             gas gas_remaining wei
        require ext_call.success
        ...
        if address(ext_call.return_data[0]) == stor8:
            ...
            require ext_code.size(address(ext_call.return_data[0]))
            call address(ext_call.return_data[0]).0xf0843ba9 with:
                 gas gas_remaining wei
        ...
        if mem[172 len 20]:
            ...
            call mem[172 len 20].0xfc0c546a with:
                 gas gas_remaining wei
            require ext_call.success
            if mem[140 len 20] == ext_call.return_data[12 len 20]:
                if arg2:
            ...
            if mem[140 len 20] == stor8:
                mem[(32 * arg3.length) + 456 len 0] = None
                require ext_code.size(mem[172 len 20])
                call mem[172 len 20].0xf0843ba9 with:
                     gas gas_remaining wei
                    args Array(len=3, data=mem[(32 * arg3.length) + 456 len 96]), ext_call.return_data[0], 1
            else:
                mem[(32 * arg3.length) + 520 len 0] = None
