...
function getInvestorDividendsAmount(address arg1) {
    return (4 * (block.timestamp * investors[address(arg1)].field_256 / 100) - (investors[address(arg1)].field_768 * investors[address(arg1)].field_256 / 100) / 24 * 3600)
}
...
function _fallback() payable {
    if owner != msg.sender:
        if not msg.value:
            ...
            if 4 * (block.timestamp * investors[address(msg.sender)].field_256 / 100) - (investors[address(msg.sender)].field_768 * investors[address(msg.sender)].field_256 / 100) / 24 * 3600 > eth.balance(this.address):
                stor9 = 1
            else:
                call msg.sender with:
                   value 4 * (block.timestamp * investors[address(msg.sender)].field_256 / 100) - (investors[address(msg.sender)].field_768 * investors[address(msg.sender)].field_256 / 100) / 24 * 3600 wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                emit Payout(address arg1, uint256 arg2, string arg3, address arg4):
                            msg.sender,
                            4 * (block.timestamp * investors[address(msg.sender)].field_256 / 100) - (investors[address(msg.sender)].field_768 * investors[address(msg.sender)].field_256 / 100) / 24 * 3600,
                            128,
                            0,
                            11,
                            'self-payout',
            ...
            if investors[msg.sender].field_1024 <= 0:
                if address(stor5) <= 0:
                    ...
                    call address(stor5) with:
                       value 4 * msg.value / 100 wei
                         gas 2300 * is_zero(value) wei
                    if ext_call.success:
                        emit Payout(address(stor5), 4 * msg.value / 100, Array(len=6, data='killer'), msg.sender);
                    if investors[msg.sender].field_256 > stor6:
                        uint256(stor5) = msg.sender or Mask(96, 160, uint256(stor5))
                        stor6 = investors[msg.sender].field_256
                        emit GorgonaKillerChanged(msg.sender, investors[msg.sender].field_256);
                ...
                call investors[msg.sender].field_1024 with:
                   value 4 * msg.value / 100 wei
                     gas 2300 * is_zero(value) wei
                if ext_call.success:
                    emit Payout(investors[msg.sender].field_1024, 4 * msg.value / 100, Array(len=8, data='referral'), msg.sender);
