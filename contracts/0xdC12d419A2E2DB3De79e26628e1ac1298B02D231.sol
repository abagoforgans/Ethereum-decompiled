...
function isWhitelisted(address arg1) {
    require ext_code.size(0xf0482be25e05607baee7478873673cbecec3c7f5)
    delegate 0xf0482be25e05607baee7478873673cbecec3c7f5.0xf593633c with:
...
function getNextWhitelistedNode(address arg1) {
    require ext_code.size(0xf0482be25e05607baee7478873673cbecec3c7f5)
    delegate 0xf0482be25e05607baee7478873673cbecec3c7f5.0x574047ac with:
         gas gas_remaining wei
        args 7, address(arg1), 1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function removeNodeFromWhitelist(address arg1) {
    require msg.sender == owner
    if not arg1:
        return 0
    ...
    if not arg1:
        return 0
    emit WhitelistedNodeRemoved(arg1);
    return 1
}
...
function addNodeToWhitelist(address arg1) {
    require msg.sender == owner
    ...
    if arg1 == uint256(stor7[0][1].field_0):
        return 0
    if not uint256(stor7[0][0].field_0):
        if not uint256(stor7[0][1].field_0):
            if uint256(stor7[0][1].field_0) != 0:
                return 0
    uint256(stor7[address(arg1)][1].field_0) = 0
    ...
    emit WhitelistedNodeAdded(arg1);
    return 1
}
...
function addAuditRequest(address arg1, string arg2, uint256 arg3) {
    require stor[sha3(0, 0, 1)][address(msg.sender)]
    stor8++
    address(auditState[stor8 + 1].field_0) = arg1
    uint256(auditState[stor8 + 1][1][].field_0) = Array(len=arg2.length, data=arg2[all])
    uint256(auditState[stor8 + 1].field_512) = arg3
    uint256(auditState[stor8 + 1].field_768) = block.number
    auditState[stor8 + 1].field_1024 = 1
    address(auditState[stor8 + 1].field_1032) = 0
    auditState[stor8 + 1].field_1280 % 1 = 0
    uint256(auditState[stor8 + 1].field_1280) = 0
    bool(auditState[stor8 + 1].field_1536) = 0
    uint255(auditState[stor8 + 1].field_1537) = 0
    Mask(248, 0, auditState[stor8 + 1].field_1544) = mem[ceil32(arg2.length) + 544 len 31]
    idx = 0
    while auditState[stor8 + 1][6].length + 31 / 32 > idx:
        uint256(auditState[stor8 + 1][idx + 6].field_0) = 0
        idx = idx + 1
        continue 
    uint256(auditState[stor8 + 1].field_1792) = 0
    address(auditState[stor8 + 1].field_2048) = msg.sender
    return (stor8 + 1)
}
