...
function sub_b341d6f3(?) {
    return bool(sub_b341d6f3)
}
...
function sub_1dc7fbab(?) {
    ...
    require balanceOf[stor10] + sub_447fda2a >= balanceOf[stor10]
    balanceOf[stor10] += sub_447fda2a
