...
function _fallback() payable {
    ...
    stor12.length.field_8 = '2018010901' / 256
    idx = 0
    ...
    stor3 = msg.sender
    stor5 = code.data[8814 len 20]
    stor0 = 0
    stor6 = block.timestamp
    stor11 = stor6
    if stor7:
        require stor7
        require stor7 * code.data[8834 len 32] / stor7 == code.data[8834 len 32]
    stor9 = stor7 * code.data[8834 len 32]
    stor10 = stor9
    return code.data[892 len 7910]
}
