...
function _fallback() payable {
    ...
    require code.data[1610 len 20]
    address(stor0.field_0) = code.data[1610 len 20]
    stor2 = code.data[1642 len 20]
    address(stor1.field_0) = msg.sender
    uint64(stor1.field_168) = code.data[1718 len 8]
    stor3 = code.data[1662 len 32]
    return code.data[245 len 1353]
}
