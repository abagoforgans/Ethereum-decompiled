...
function _fallback() payable {
    ...
    require code.data[5953 len 20]
    require code.data[5973 len 32] > block.number
    require code.data[6005 len 32] > code.data[5973 len 32]
    uint8(stor0.field_160) = 0
    stor1 = code.data[5953 len 20]
    create contract with 0 wei
                    code: code.data[3402 len 2539]
    require create.new_address
    stor2 = address(create.new_address)
    stor5 = code.data[5973 len 32]
    stor6 = code.data[6005 len 32]
    return code.data[311 len 3091]
}
