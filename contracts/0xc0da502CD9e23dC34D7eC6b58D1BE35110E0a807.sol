...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 100000000000 * 10^18
    stor2 = 100000000000 * 10^18
    bool(stor5.length) = 0
    stor5.length.field_1 = 3
    stor5.length.field_8 = 'HPT' / 256
    idx = 0
    ...
    stor3.length.field_8 = 'HupayX Test' / 256
    idx = 0
