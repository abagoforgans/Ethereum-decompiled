...
function _fallback() payable {
    ...
    require code.data[19328 len 32] >= block.timestamp
    require code.data[19360 len 32] >= code.data[19328 len 32]
    require code.data[19392 len 32] > 0
    require code.data[19500 len 20]
    create contract with 0 wei
                    code: code.data[13187 len 6141]
    require create.new_address
    stor0 = address(create.new_address)
    stor1 = code.data[19328 len 32]
    stor2 = code.data[19360 len 32]
    stor4 = code.data[19392 len 32]
    stor3 = code.data[19500 len 20]
    require code.data[19456 len 32] > 0
    stor6 = code.data[19456 len 32]
    address(stor7.field_0) = msg.sender
    require code.data[19424 len 32] > 0
    create contract with 0 wei
                    code: code.data[10508 len 2679], stor3
    require create.new_address
    stor9 = address(create.new_address)
    stor8 = code.data[19424 len 32]
    require code.data[19424 len 32] <= code.data[19456 len 32]
    return code.data[832 len 9676]
}
