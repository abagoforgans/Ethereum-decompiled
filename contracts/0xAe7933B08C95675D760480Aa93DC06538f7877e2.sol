...
function _fallback() payable {
    ...
    mem[96 len -2754] = code.data[3179 len -2754]
    mem[64] = -2658
    require mem[128] >= 1
    require mem[160] >= 1
    idx = 0
...
function getMsgWaiting(uint256 arg1) {
    ...
    return stor12[arg1].field_0, 
           ...
           Array(len=stor12[arg1][2].length, data=mem[160 len stor12[arg1][2].length]),
...
function addAudit(uint256 arg1, bool arg2) {
    ...
    if stor12[arg1].field_0 < nAuditorsRequired:
        ...
        if stor12[arg1].field_256 >= nAuditorsAlarm:
            ...
            idx = 192
            s = 0
            while stor12[arg1][2].length + 160 > idx:
                mem[idx + 32] = stor12[arg1][s + 2].field_256
                idx = idx + 32
                s = s + 1
                continue 
