...
function _fallback() {
    stor0 = msg.sender
    stor0 = code.data[3826 len 20]
    require code.data[3846 len 32]
    require code.data[3878 len 32]
    stor7 = code.data[3878 len 32]
    stor8 = code.data[3910 len 32]
    stor6 = code.data[3846 len 32]
    return code.data[164 len 3650]
}
