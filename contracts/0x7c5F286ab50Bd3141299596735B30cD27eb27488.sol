...
function sub_ad70d556(?) {
    totalSupply = 11 * 10^15
    balanceOf[address(msg.sender)] = 11 * 10^15
    emit Transfer(11 * 10^15, 0, msg.sender);
}
