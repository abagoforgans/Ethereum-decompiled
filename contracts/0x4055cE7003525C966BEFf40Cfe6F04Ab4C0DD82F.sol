...
function setPreICOLimit(uint256 arg1) {
...
function finalize() {
    ...
    balanceOf[stor4] = balanceOf[stor4] + totalSupply - window0TotalSupply - window1TotalSupply - window2TotalSupply
    if not multiWalletAddress:
        call etherProceedsAccount with:
