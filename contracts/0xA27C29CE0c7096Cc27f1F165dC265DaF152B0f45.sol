...
function _fallback() {
    stor0 = code.data[1166 len 20]
    address(stor4.field_0) = code.data[1198 len 20]
    stor1 = code.data[1218 len 32]
    Mask(96, 0, stor4.field_160) = 0
    stor2 = 0
    stor3 = code.data[1250 len 32]
    return code.data[268 len 886]
}
