...
function _fallback() payable {
    ...
    create contract with 0 wei
                    code: code.data[2758 len 3312]
    require create.new_address
    stor1 = address(create.new_address)
    return code.data[218 len 2540]
}
...
function _fallback() payable {
    ...
    if block.timestamp < 420768 * 24 * 3600:
        ...
        require 1000 * msg.value <= tokensLeft
        require tokensLeft - (1000 * msg.value) >= 0
        require 1000 * msg.value <= tokensLeft
        tokensLeft += -1000 * msg.value
        ...
        if block.timestamp <= 421104 * 24 * 3600:
            if msg.value:
                require msg.value
                require 835 * msg.value / msg.value == 835
            require 835 * msg.value <= tokensLeft
            require tokensLeft - (835 * msg.value) >= 0
            require 835 * msg.value <= tokensLeft
            tokensLeft += -835 * msg.value
            require msg.value + weiRaised >= weiRaised
            weiRaised += msg.value
            require ext_code.size(tokenAddress)
            call tokenAddress.0x40c10f19 with:
                 gas gas_remaining - 710 wei
                args msg.sender, 835 * msg.value
        else:
            if block.timestamp > 421440 * 24 * 3600:
                if msg.value:
                    require msg.value
                    require 500 * msg.value / msg.value == 500
                require 500 * msg.value <= tokensLeft
                require tokensLeft - (500 * msg.value) >= 0
                require 500 * msg.value <= tokensLeft
                tokensLeft += -500 * msg.value
                require msg.value + weiRaised >= weiRaised
                weiRaised += msg.value
                require ext_code.size(tokenAddress)
                call tokenAddress.0x40c10f19 with:
                ...
                if msg.value:
                    require msg.value
                    require 665 * msg.value / msg.value == 665
                require 665 * msg.value <= tokensLeft
                require tokensLeft - (665 * msg.value) >= 0
                require 665 * msg.value <= tokensLeft
                tokensLeft += -665 * msg.value
                require msg.value + weiRaised >= weiRaised
                weiRaised += msg.value
                require ext_code.size(tokenAddress)
                call tokenAddress.0x40c10f19 with:
                     gas gas_remaining - 710 wei
                    args msg.sender, 665 * msg.value
    require ext_call.success
...
function buyTokens(address arg1) payable {
    ...
    if block.timestamp < 420768 * 24 * 3600:
        ...
        if block.timestamp <= 421104 * 24 * 3600:
            ...
            call tokenAddress.0x40c10f19 with:
                 gas gas_remaining - 710 wei
                args address(arg1), 835 * msg.value
        else:
            if block.timestamp > 421440 * 24 * 3600:
                if msg.value:
                    require msg.value
                ...
                call tokenAddress.0x40c10f19 with:
                     gas gas_remaining - 710 wei
                    args address(arg1), 665 * msg.value
    require ext_call.success
    call walletAddress with:
       value msg.value wei
         gas 2300 * is_zero(value) wei
