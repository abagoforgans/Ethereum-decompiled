...
function _fallback() payable {
    ...
    stor1 = code.data[5568 len 32]
    stor2 = code.data[5600 len 32]
    stor3 = code.data[5632 len 32]
    emit ChangeOfRules(code.data[5568 len 32], code.data[5600 len 32], code.data[5632 len 32]);
    stor7.length++
    ...
    if address(code.data[5664 len 32]) != 0:
        uint256(stor0) = code.data[5664 len 32] or Mask(96, 160, uint256(stor0))
    return code.data[730 len 4838]
}
...
function vote(uint256 arg1, bool arg2, string arg3) payable {
    ...
    require arg1 < stor4.length
    require bool(uint8(stor[(10 * arg1) - 0x7775ca53043ea007e5c65182cbb028f60d7179ff4b55739a3949b401801c9426][address(msg.sender)])) != 1
...
function members(uint256 arg1) payable {
    ...
    return address(stor56A6[arg1].field_0), 
           bool(uint8(stor56A6[arg1].field_160)),
...
function executeProposal(uint256 arg1, bytes arg2) payable {
    ...
    emit ProposalTallied(arg1, stor888A[arg1], stor888A[arg1], bool(uint8(stor888A[arg1].field_8)));
    return 0
}
