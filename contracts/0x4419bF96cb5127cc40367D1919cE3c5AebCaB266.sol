...
function _fallback() payable {
    ...
    mem[96 len -4626] = code.data[5057 len -4626]
    mem[64] = -4530
    stor0 = msg.sender
...
function auctionEnd() {
    ...
    while idx >= 0:
        ...
        if 100 * sub_1226cbd3[address(stor14[idx])] <= s:
            ...
            sub_1226cbd3[address(stor14[idx])] = 100 * sub_1226cbd3[address(stor14[idx])]
        ...
        mem[0] = address(stor14[idx])
        sub_1226cbd3[address(stor14[idx])] = s
        sub_a5eefd9e[address(stor14[idx])] = block.timestamp - (720 * 24 * 3600)
        mem[32] = 11
        sub_13af6ab8[address(stor14[idx])] = block.timestamp
        s = s
...
function sub_b4a60512(?) {
    ...
    if sub_13af6ab8[address(msg.sender)] != sub_a5eefd9e[address(msg.sender)]:
        require eth.balance(this.address) >= 10^18 * sub_1226cbd3[address(msg.sender)] / sellPrice
        call msg.sender with:
           value 10^18 * sub_1226cbd3[address(msg.sender)] / sellPrice wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        sub_1226cbd3[address(msg.sender)] = 0
        sub_13af6ab8[address(msg.sender)] = block.timestamp
        emit 0x6df75305: msg.sender, 10^18 * sub_1226cbd3[address(msg.sender)] / sellPrice
    else:
        require eth.balance(this.address) >= (10^18 * 246529 * sub_1226cbd3[address(msg.sender)] / 10000 / 30) + (10^18 * sub_1226cbd3[address(msg.sender)]) / sellPrice
        call msg.sender with:
           value (10^18 * 246529 * sub_1226cbd3[address(msg.sender)] / 10000 / 30) + (10^18 * sub_1226cbd3[address(msg.sender)]) / sellPrice wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        sub_1226cbd3[address(msg.sender)] = 0
        sub_13af6ab8[address(msg.sender)] = block.timestamp
        emit 0x6df75305: msg.sender, (10^18 * 246529 * sub_1226cbd3[address(msg.sender)] / 10000 / 30) + (10^18 * sub_1226cbd3[address(msg.sender)]) / sellPrice
}
