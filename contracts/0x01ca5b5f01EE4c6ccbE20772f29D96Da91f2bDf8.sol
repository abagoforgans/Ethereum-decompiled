...
function sub_0ec63fff(?) payable {
    ...
    while idx < arg1.length:
        ...
        mem[mem[64]] = 5
        mem[64] = mem[64] + 192
        mem[_33 + 32 len 160] = code.data[19480 len 160]
        s = 5 * idx
        while s <= (5 * idx) + 4:
        ...
        mem[mem[64]] = 13
        mem[64] = mem[64] + 448
        mem[_56 + 32 len 416] = code.data[19480 len 416]
        s = 13 * idx
        while s <= (13 * idx) + 12:
...
function sub_1a45bf6a(?) payable {
    ...
    if not ext_call.return_data[0]:
        ...
        mem[128 len 32 * ext_call.return_data[0]] = code.data[19480 len 32 * ext_call.return_data[0]]
        mem[(32 * ext_call.return_data[0]) + 128] = ext_call.return_data[0]
        mem[(32 * ext_call.return_data[0]) + 160 len 32 * ext_call.return_data[0]] = code.data[19480 len 32 * ext_call.return_data[0]]
        mem[(64 * ext_call.return_data[0]) + 160] = ext_call.return_data[0]
        mem[(64 * ext_call.return_data[0]) + 192 len 32 * ext_call.return_data[0]] = code.data[19480 len 32 * ext_call.return_data[0]]
        mem[(98 * ext_call.return_data[0]) + 192] = ext_call.return_data[0]
        mem[(98 * ext_call.return_data[0]) + 224 len 32 * ext_call.return_data[0]] = code.data[19480 len 32 * ext_call.return_data[0]]
    idx = 0
    while idx < ext_call.return_data[0]:
        require ext_code.size(operatorAddress)
        staticcall operatorAddress.0xe83a25c5 with:
...
function sub_ab0b6739(?) payable {
    ...
    if not ext_call.return_data[0]:
        ...
        mem[(32 * _151) + (32 * _129) + (32 * _76) + mem[64] + 256 len floor32(mem[(98 * ext_call.return_data[0]) + 192])] = mem[(98 * ext_call.return_data[0]) + 224 len floor32(mem[(98 * ext_call.return_data[0]) + 192])]
        return 128, mem[mem[64] + 32 len (32 * _167) + (32 * _151) + (32 * _129) + (32 * _76) + 224]
    mem[128 len 32 * ext_call.return_data[0]] = code.data[19480 len 32 * ext_call.return_data[0]]
    mem[(32 * ext_call.return_data[0]) + 128] = ext_call.return_data[0]
    mem[(32 * ext_call.return_data[0]) + 160 len 32 * ext_call.return_data[0]] = code.data[19480 len 32 * ext_call.return_data[0]]
    mem[(64 * ext_call.return_data[0]) + 160] = ext_call.return_data[0]
...
function sub_ccbf19de(?) payable {
    ...
    while ext_call.return_data[0] < 32 * _150:
        ...
        s = ext_call.return_data[0] + 32
        continue 
    mem[mem[64] + 96] = (32 * _150) + (32 * _128) + (32 * mem[96]) + 224
    mem[(32 * _150) + (32 * _128) + (32 * mem[96]) + mem[64] + 224] = mem[(98 * ext_call.return_data[0]) + 192]
    _166 = mem[(98 * ext_call.return_data[0]) + 192]
    mem[(32 * _150) + (32 * _128) + (32 * mem[96]) + mem[64] + 256 len floor32(mem[(98 * ext_call.return_data[0]) + 192])] = mem[(98 * ext_call.return_data[0]) + 224 len floor32(mem[(98 * ext_call.return_data[0]) + 192])]
    return 128, 
           (32 * mem[96]) + 160,
           (32 * _128) + (32 * mem[96]) + 192,
           (32 * _150) + (32 * _128) + (32 * mem[96]) + 224,
           mem[mem[64] + 128 len (32 * _166) + (32 * _150) + (32 * _128) + (32 * mem[96]) + 128]
}
...
function sub_8a055fe1(?) payable {
    ...
    mem[(131 * ext_call.return_data[0]) + 224] = ext_call.return_data[0]
    mem[64] = (164 * ext_call.return_data[0]) + 256
    mem[(131 * ext_call.return_data[0]) + 256 len 32 * ext_call.return_data[0]] = code.data[19480 len 32 * ext_call.return_data[0]]
    idx = 0
    while idx < ext_call.return_data[0]:
        require ext_code.size(operatorAddress)
        staticcall operatorAddress.0x95a25efa with:
...
function sub_712bf703(?) payable {
    ...
    if not ext_call.return_data[0]:
        ...
        mem[(32 * _203) + (32 * _169) + (32 * _98) + mem[64] + 288] = mem[(98 * ext_call.return_data[0]) + 192]
    ...
    mem[(164 * ext_call.return_data[0]) + 256] = ext_call.return_data[0]
    mem[64] = (197 * ext_call.return_data[0]) + 288
    mem[(164 * ext_call.return_data[0]) + 288 len 32 * ext_call.return_data[0]] = code.data[19480 len 32 * ext_call.return_data[0]]
    idx = 0
    while idx < ext_call.return_data[0]:
        require ext_code.size(operatorAddress)
        staticcall operatorAddress.0x95a25efa with:
...
function sub_f72cf324(?) payable {
    ...
    if not ext_call.return_data[0]:
        ...
        mem[(32 * _205) + (32 * _171) + (32 * _100) + mem[64] + 288] = mem[(131 * ext_call.return_data[0]) + 224]
        _233 = mem[(131 * ext_call.return_data[0]) + 224]
        mem[(32 * _205) + (32 * _171) + (32 * _100) + mem[64] + 320 len floor32(mem[(131 * ext_call.return_data[0]) + 224])] = mem[(131 * ext_call.return_data[0]) + 256 len floor32(mem[(131 * ext_call.return_data[0]) + 224])]
        mem[mem[64] + 128] = (32 * _233) + (32 * _205) + (32 * _171) + (32 * _100) + 320
    ...
    mem[(197 * ext_call.return_data[0]) + 288] = ext_call.return_data[0]
    mem[64] = (230 * ext_call.return_data[0]) + 320
    mem[(197 * ext_call.return_data[0]) + 320 len 32 * ext_call.return_data[0]] = code.data[19480 len 32 * ext_call.return_data[0]]
    idx = 0
    while idx < ext_call.return_data[0]:
        require ext_code.size(operatorAddress)
        staticcall operatorAddress.0x95a25efa with:
...
function sub_c6689696(?) payable {
    ...
    mem[(32 * mem[(98 * ext_call.return_data[0]) + 192]) + (32 * mem[(64 * ext_call.return_data[0]) + 160]) + (32 * mem[(32 * ext_call.return_data[0]) + 128]) + (263 * ext_call.return_data[0]) + 704 len floor32(mem[(131 * ext_call.return_data[0]) + 224])] = mem[(131 * ext_call.return_data[0]) + 256 len floor32(mem[(131 * ext_call.return_data[0]) + 224])]
    mem[(230 * ext_call.return_data[0]) + 480] = (32 * mem[(131 * ext_call.return_data[0]) + 224]) + (32 * mem[(98 * ext_call.return_data[0]) + 192]) + (32 * mem[(64 * ext_call.return_data[0]) + 160]) + (32 * mem[(32 * ext_call.return_data[0]) + 128]) + (32 * ext_call.return_data[0]) + 384
    mem[(32 * mem[(131 * ext_call.return_data[0]) + 224]) + (32 * mem[(98 * ext_call.return_data[0]) + 192]) + (32 * mem[(64 * ext_call.return_data[0]) + 160]) + (32 * mem[(32 * ext_call.return_data[0]) + 128]) + (263 * ext_call.return_data[0]) + 704] = mem[(164 * ext_call.return_data[0]) + 256]
    mem[(32 * mem[(131 * ext_call.return_data[0]) + 224]) + (32 * mem[(98 * ext_call.return_data[0]) + 192]) + (32 * mem[(64 * ext_call.return_data[0]) + 160]) + (32 * mem[(32 * ext_call.return_data[0]) + 128]) + (263 * ext_call.return_data[0]) + 736 len floor32(mem[(164 * ext_call.return_data[0]) + 256])] = mem[(164 * ext_call.return_data[0]) + 288 len floor32(mem[(164 * ext_call.return_data[0]) + 256])]
    mem[(230 * ext_call.return_data[0]) + 512] = (32 * mem[(164 * ext_call.return_data[0]) + 256]) + (32 * mem[(131 * ext_call.return_data[0]) + 224]) + (32 * mem[(98 * ext_call.return_data[0]) + 192]) + (32 * mem[(64 * ext_call.return_data[0]) + 160]) + (32 * mem[(32 * ext_call.return_data[0]) + 128]) + (32 * ext_call.return_data[0]) + 416
    mem[(32 * mem[(164 * ext_call.return_data[0]) + 256]) + (32 * mem[(131 * ext_call.return_data[0]) + 224]) + (32 * mem[(98 * ext_call.return_data[0]) + 192]) + (32 * mem[(64 * ext_call.return_data[0]) + 160]) + (32 * mem[(32 * ext_call.return_data[0]) + 128]) + (263 * ext_call.return_data[0]) + 736] = mem[(197 * ext_call.return_data[0]) + 288]
    mem[(32 * mem[(164 * ext_call.return_data[0]) + 256]) + (32 * mem[(131 * ext_call.return_data[0]) + 224]) + (32 * mem[(98 * ext_call.return_data[0]) + 192]) + (32 * mem[(64 * ext_call.return_data[0]) + 160]) + (32 * mem[(32 * ext_call.return_data[0]) + 128]) + (263 * ext_call.return_data[0]) + 768 len floor32(mem[(197 * ext_call.return_data[0]) + 288])] = mem[(197 * ext_call.return_data[0]) + 320 len floor32(mem[(197 * ext_call.return_data[0]) + 288])]
    return memory
      from (230 * ext_call.return_data[0]) + 320
       len (32 * mem[(197 * ext_call.return_data[0]) + 288]) + (32 * mem[(164 * ext_call.return_data[0]) + 256]) + (32 * mem[(131 * ext_call.return_data[0]) + 224]) + (32 * mem[(98 * ext_call.return_data[0]) + 192]) + (32 * mem[(64 * ext_call.return_data[0]) + 160]) + (32 * mem[(32 * ext_call.return_data[0]) + 128]) + (32 * ext_call.return_data[0]) + 448
}
...
function sub_aa9aab19(?) payable {
    ...
    mem[ceil32(return_data.size) + 128 len 32 * _6] = code.data[19480 len 32 * _6]
    mem[ceil32(return_data.size) + (32 * _6) + 128] = _6
    mem[ceil32(return_data.size) + (32 * _6) + 160 len 32 * _6] = code.data[19480 len 32 * _6]
    mem[ceil32(return_data.size) + (64 * _6) + 160] = _6
    mem[ceil32(return_data.size) + (64 * _6) + 192 len 32 * _6] = code.data[19480 len 32 * _6]
    mem[ceil32(return_data.size) + (98 * _6) + 192] = _6
    mem[ceil32(return_data.size) + (98 * _6) + 224 len 32 * _6] = code.data[19480 len 32 * _6]
    mem[ceil32(return_data.size) + (131 * _6) + 224] = _6
    mem[ceil32(return_data.size) + (131 * _6) + 256 len 32 * _6] = code.data[19480 len 32 * _6]
    mem[ceil32(return_data.size) + (164 * _6) + 256] = _6
    mem[64] = ceil32(return_data.size) + (197 * _6) + 288
    mem[ceil32(return_data.size) + (164 * _6) + 288 len 32 * _6] = code.data[19480 len 32 * _6]
    idx = 0
    while idx < _6:
        require idx < mem[_4 + 96]
        require ext_code.size(operatorAddress)
