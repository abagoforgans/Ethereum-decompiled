...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'Ethchange' / 256
    idx = 0
    ...
    stor7 = 100 * 10^6
    stor3[code.data[5398 len 20]] = 100 * 10^6
    emit Transfer(100 * 10^6, 0, code.data[5398 len 20]);
    return code.data[735 len 4651]
}
