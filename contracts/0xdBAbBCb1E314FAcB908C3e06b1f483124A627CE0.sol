...
function _fallback() payable {
    ...
    stor4 = 0xa1e57e38f347f4cccb441366a35d949142fad7b0
    stor5 = 0
    stor6 = 0
    stor7 = 0
    stor8 = 0
    ...
    require stor8 <= stor0
    stor1[stor4] = stor0 - stor8
    return code.data[661 len 7911]
}
...
function decreaseSupply(uint256 arg1) {
    ...
    require 10^18 * arg1 <= currentSupply - tokenRaised
