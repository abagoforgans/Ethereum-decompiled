...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[16035 len 20]
    stor2 = code.data[16035 len 20]
    require code.data[16067 len 20]
    stor5 = code.data[16067 len 20]
    if code.data[16099 len 20]:
        require msg.sender == stor0
        require code.data[16099 len 20]
        require code.data[16099 len 20] != this.address
        require code.data[16150 len 1] > 0
        require code.data[16150 len 1] <= 100
        require code.data[16099 len 20] != stor2
        require not stor7[code.data[16099 len 20]].field_280
        require uint8(stor8 + code.data[16119 len 32]) <= 100
        stor7[address(code.data[16087 len 32])].field_0 = 0
        stor7[address(code.data[16087 len 32])].field_256 = code.data[16150 len 1]
        stor7[address(code.data[16087 len 32])].field_264 = 0
        stor7[address(code.data[16087 len 32])].field_272 = 1
        stor7[address(code.data[16087 len 32])].field_280 = 1
        stor6.length++
        if not stor6.length <= stor6.length + 1:
            ...
            while stor6.length > idx:
                ...
                idx = idx + 1
                continue 
        address(stor6[stor6.length]) = code.data[16099 len 20]
        stor8 = uint8(stor8 + code.data[16119 len 32])
    return code.data[1909 len 14114]
}
