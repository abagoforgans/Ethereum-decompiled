...
function sub_1bec0d39(?) {
    return sub_1bec0d39Address
}
...
function sub_9c482f16(?) {
    require msg.sender == owner
    require arg1
    sub_1bec0d39Address = arg1
}
...
function close() {
    ...
    call tokenAddress.0xa9059cbb with:
         gas gas_remaining wei
        args sub_1bec0d39Address, ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    emit Close(owner, ext_call.return_data[0]);
}
