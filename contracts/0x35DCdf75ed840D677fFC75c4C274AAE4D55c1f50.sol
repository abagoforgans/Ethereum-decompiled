...
function mintToken(address arg1, uint256 arg2) payable {
    ...
    totalSupply += arg2
    emit 0xfeddf252: arg2, 0, owner
    emit 0xfeddf252: arg2, owner, arg1
    return 1
}
...
function sub_a9914eef(?) payable {
    ...
    if owner != arg1:
        if arg4:
            ...
            emit 0xfeddf252: Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[arg5.length + 160 len -arg5.length + ceil32(arg5.length)], arg1, owner
    ...
    emit 0xfeddf252: Mask(8 * -ceil32(arg5.length) + arg5.length + 32, 0, 0), mem[arg5.length + 160 len -arg5.length + ceil32(arg5.length)], arg1, arg2
