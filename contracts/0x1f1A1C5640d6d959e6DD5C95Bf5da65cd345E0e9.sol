...
function _fallback() payable {
    if not stor11:
        require 1527359400 < block.timestamp
        stor11 = 0
        ...
        if eth.balance(this.address) - msg.value > 2 * 10^18:
            ...
            require stor7[address(msg.sender)] + msg.value <= 11 * 10^17
...
function reinvest() {
    ...
    if not stor11:
        ...
        if eth.balance(this.address) - (Mask(192, 64, (stor9 * balanceOf[address(msg.sender)]) - stor6[address(msg.sender)]) >> 64) - stor5[address(msg.sender)] > 2 * 10^18:
            require 1527359400 < block.timestamp
            stor11 = 0
            require (Mask(192, 64, (stor9 * balanceOf[address(msg.sender)]) - stor6[address(msg.sender)]) >> 64) + stor5[address(msg.sender)] / 10 / 3 <= (Mask(192, 64, (stor9 * balanceOf[address(msg.sender)]) - stor6[address(msg.sender)]) >> 64) + stor5[address(msg.sender)] / 10
            require (Mask(192, 64, (stor9 * balanceOf[address(msg.sender)]) - stor6[address(msg.sender)]) >> 64) + stor5[address(msg.sender)] / 10 <= (Mask(192, 64, (stor9 * balanceOf[address(msg.sender)]) - stor6[address(msg.sender)]) >> 64) + stor5[address(msg.sender)]
            ...
            require bool(stor3[address(msg.sender)]) == 1
            require stor7[address(msg.sender)] + (Mask(192, 64, (stor9 * balanceOf[address(msg.sender)]) - stor6[address(msg.sender)]) >> 64) + stor5[address(msg.sender)] <= 11 * 10^17
