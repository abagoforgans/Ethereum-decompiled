...
function _fallback() payable {
    ...
    stor1 = 0x8301fb8945760fa2b3c669e8f420b8795dc03766
    require not msg.value
    return code.data[105 len 1642]
}
...
function unlistSubName(bytes32 arg1) {
    require subRegistrationPeriod[arg1].field_0 == msg.sender
...
function subBuy(bytes32 arg1, bytes32 arg2, address arg3) payable {
    ...
    call subRegistrationPeriod[arg1].field_0 with:
       value msg.value - (msg.value / 20) wei
         gas 2300 * is_zero(value) wei
    subRegistrationPeriod[arg1][arg2].field_256 = subRegistrationPeriod[arg1].field_1024 + block.timestamp
