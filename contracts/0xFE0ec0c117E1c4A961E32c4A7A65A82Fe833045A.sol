...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor5 = code.data[4265 len 20]
    address(stor6.field_0) = code.data[4297 len 20]
    uint8(stor6.field_160) = 0
    stor10 = code.data[4317 len 32]
    stor7 = code.data[4349 len 32]
    stor8 = code.data[4381 len 32]
    stor1 = 10000000000 * 10^18
    stor2[address(msg.sender)] = 10000000000 * 10^18
    emit CreateXPA(stor10, msg.sender);
    return code.data[530 len 3723]
}
...
function finalize() {
    ...
    emit CreateXPA(balanceOf[address(stor6.field_0)], xpaFundDepositAddress);
