...
function _fallback() payable {
    ...
    stor15 = 10^18
    stor16 = 10000 * 10^18
    require code.data[6679 len 32] >= block.timestamp
    require code.data[6711 len 32] >= code.data[6679 len 32]
    require code.data[6755 len 20]
    stor10 = code.data[6679 len 32]
    stor11 = code.data[6711 len 32]
    stor13 = code.data[6755 len 20]
    stor8[code.data[6755 len 20]] = stor3
    address(stor12.field_8) = msg.sender
    uint8(stor12.field_0) = 0
    address(stor12.field_8) = msg.sender
    Mask(248, 0, stor12.field_8) = 0
    return code.data[687 len 5992]
}
