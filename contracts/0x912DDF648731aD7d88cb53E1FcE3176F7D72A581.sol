...
function _fallback() {
    stor3 = msg.sender
    stor1[address(msg.sender)] = code.data[3034 len 32]
    stor0 = 10^10
    emit Transfer(code.data[3034 len 32], 0, msg.sender);
    stor4 = block.timestamp
    stor5 = 4320 * 24 * 3600
    stor6 = msg.sender
    require stor3 == msg.sender
    if code.data[3142 len 20]:
        stor3 = code.data[3142 len 20]
    return code.data[326 len 2708]
}
