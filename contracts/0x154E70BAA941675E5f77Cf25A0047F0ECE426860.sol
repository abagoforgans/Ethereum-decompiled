...
function _fallback() payable {
    ...
    while uint8(idx) < uint8(stor0.field_160):
        require idx < 17
        stor308[0.03125 / idx] = !(255 * 256^(idx % 32)) and stor308[0.03125 / idx]
        idx = idx + 1
        continue 
    return code.data[187 len 1417]
}
        ...
        if address(stor0.field_0) == msg.sender:
            ...
            while uint8(idx) < arg1.length:
                ...
                while uint8(s) < uint8(stor0.field_160):
                    ...
                    continue 
                require mem[(32 * idx) + 128] < 17
                uint256(stor308[0.03125 / mem[(32 * idx) + 128]]) = 256^(mem[(32 * idx) + 128] % 32) or !(255 * 256^(mem[(32 * idx) + 128] % 32)) and uint256(stor308[0.03125 / mem[(32 * idx) + 128]])
                idx = idx + 1
                s = mem[(32 * idx) + 128]
                continue 
        idx = 0
