...
function _fallback() payable {
    mem[96 len -1734] = code.data[2254 len -1734]
    mem[64] = -1638
...
uint256 sub_f2f3962f;
uint256 sub_330229a5;
uint256 sub_c8ed3ca6;
address sub_d2f5fe87Address;
...
function sub_d2f5fe87(?) payable {
    return sub_d2f5fe87Address
}
...
function transfer(address arg1, address arg2, uint256 arg3) payable {
    ...
    if 0 == balanceOf[address(arg2)]:
        sub_215d1343++
        uint256(sub_76a39356[stor8 + 1]) = arg2 or Mask(96, 160, uint256(sub_76a39356[stor8 + 1]))
...
function sub_57990807(?) payable {
    sub_f2f3962f = sub_d1e93151 - sub_4f7672f4
    sub_4f7672f4 = sub_d1e93151
    sub_330229a5 = sub_d1e93151 - sub_4f7672f4 / sub_ec727e13
    s = 0
    idx = 0
    while idx < sub_215d1343:
        sub_d2f5fe87Address = address(sub_76a39356[idx + 1])
        mem[0] = address(sub_76a39356[idx + 1])
        mem[32] = 13
        sub_c8ed3ca6 = balanceOf[address(stor15[idx + 1])] * sub_330229a5
        mem[96] = 0x489ffdbc00000000000000000000000000000000000000000000000000000000
        mem[100] = address(sub_76a39356[idx + 1])
        mem[132] = balanceOf[address(stor15[idx + 1])] * sub_330229a5
        call sub_dee35eceAddress.0x489ffdbc with:
             gas gas_remaining - 25050 wei
            args address(sub_76a39356[idx + 1]), balanceOf[address(stor15[idx + 1])] * sub_330229a5
