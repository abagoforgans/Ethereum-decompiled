...
function _fallback() payable {
    ...
    stor1 = 0x88c2a0bf00000000000000000000000000000000000000000000000000000000
    stor2 = 0xde49de6739d54b43c80e8e0d15a4adc2b35fbf11
    require not msg.value
    return code.data[128 len 292]
}
...
function _fallback() payable {
    if calldata.size >= 8:
        ...
        if calldata.size >= 12:
            call 0x692a70d2e424a56d2c6c27aa97d1a86395877b3a with:
               funct stor1
                 gas gas_remaining wei
