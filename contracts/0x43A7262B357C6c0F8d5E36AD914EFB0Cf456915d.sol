...
function withdraw() {
    ...
    if not checkInvestments[address(msg.sender)]:
        ...
        if -checkWithdrawals[address(msg.sender)] >= eth.balance(this.address):
            return 0
        if -checkWithdrawals[address(msg.sender)] > sub_c7bf8860 / 100:
        ...
        if not step * checkInvestments[address(msg.sender)] / 100:
            ...
            if (block.timestamp - stor1[address(msg.sender)] / 60 * step * checkInvestments[address(msg.sender)] / 100 / 1440) - checkWithdrawals[address(msg.sender)] >= eth.balance(this.address):
                return 0
            if (block.timestamp - stor1[address(msg.sender)] / 60 * step * checkInvestments[address(msg.sender)] / 100 / 1440) - checkWithdrawals[address(msg.sender)] > sub_c7bf8860 / 100:
        ...
        if arg1 != msg.sender:
            if checkInvestments[address(arg1)] >= stakingRequirement:
                if not msg.value:
                    ...
                    require (10 * msg.value / 100) + checkReferral[address(arg1)] >= checkReferral[address(arg1)]
                    checkReferral[address(arg1)] += 10 * msg.value / 100
    if checkInvestments[msg.sender] > 0:
        require 0 < stor1[msg.sender]
        require stor1[address(msg.sender)] <= block.timestamp
        if not checkInvestments[address(msg.sender)]:
