...
function _fallback() payable {
    ...
    stor1 = code.data[5325 len 32]
    stor2 = code.data[5357 len 32]
    stor3 = code.data[5389 len 32]
    emit ChangeOfRules(code.data[5325 len 32], code.data[5357 len 32], code.data[5389 len 32]);
    stor7.length++
    ...
    if address(code.data[5421 len 32]) != 0:
        uint256(stor0) = code.data[5421 len 32] or Mask(96, 160, uint256(stor0))
    return code.data[730 len 4595]
}
