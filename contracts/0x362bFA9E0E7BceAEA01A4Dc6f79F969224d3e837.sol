...
function sub_8281a4cd(?) {
    ...
    require not sub_c3700467
    call contractorAddress with:
       value sub_b84317bf wei
         gas gas_remaining - 34710 wei
    sub_c3700467 = uint8(bool(ext_call.success))
    if uint8(bool(ext_call.success)):
        emit 0x9e7810ac 
    uint8(stor23.field_176) = 0
}
...
function sub_b6631173(?) {
    ...
    require not sub_2b5c46e9
    call contractorAddress with:
       value sub_8b0da566 wei
         gas gas_remaining - 34710 wei
    sub_2b5c46e9 = uint8(bool(ext_call.success))
    if uint8(bool(ext_call.success)):
        emit 0x3615a5d7 
    uint8(stor23.field_176) = 0
}
...
function pay() payable {
    ...
    call address(stor23.field_16).fee() with:
