...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'YunXinToken ' / 256
    idx = 0
    ...
    stor5 = 6 * 10^14
    stor3[code.data[2876 len 20]] = 6 * 10^14
    emit Transfer(6 * 10^14, 0, code.data[2876 len 20]);
    return code.data[510 len 2354]
}
