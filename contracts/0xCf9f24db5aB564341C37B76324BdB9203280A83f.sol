...
function getDeposits(address arg1) {
    ...
    mem[128 len 32 * s] = code.data[3183 len 32 * s]
    mem[(32 * s) + 128] = s
    mem[(32 * s) + 160 len 32 * s] = code.data[3183 len 32 * s]
    mem[(64 * s) + 160] = s
    mem[(64 * s) + 192 len 32 * s] = code.data[3183 len 32 * s]
    if s <= 0:
        mem[(98 * s) + 192] = 96
        mem[(98 * s) + 288] = s
        mem[(98 * s) + 320 len floor32(s)] = code.data[3183 len floor32(s)]
        mem[(98 * s) + 224] = (32 * s) + 128
        mem[(131 * s) + 320] = s
        t = 0
        while t < 32 * s:
            ...
            t = t + 32
            continue 
        mem[(164 * s) + 384 len floor32(s)] = code.data[3183 len floor32(s)]
        return Array(len=s, data=code.data[3183 len floor32(s)], mem[(98 * s) + floor32(s) + 320 len (66 * s) + -floor32(s) + 32], s, code.data[3183 len floor32(s)], mem[(164 * s) + floor32(s) + 384 len (225 * s) - floor32(s)]), 
               (32 * s) + 128,
               (64 * s) + 160
    t = 0
    idx = currentReceiverIndex
