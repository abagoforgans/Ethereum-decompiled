...
function sub_ee7ac1ce(?) {
    ...
    mem[ceil32(('cd', 4).length) + 352] = ('cd', 36).length
    mem[ceil32(('cd', 4).length) + 384 len ('cd', 36).length] = call.data[cd[36] + 36 len ('cd', 36).length]
    mem[('cd', 36).length + ceil32(('cd', 4).length) + 384] = 0
    emit 0x7e6d1919: 224, ceil32(('cd', 4).length) + 256, address(cd[68]), cd[100], cd[132], cd[164], cd[196], ('cd', 4).length, call.data[cd[4] + 36 len ('cd', 4).length], 0, mem[('cd', 4).length + 384 len ceil32(('cd', 4).length) + ceil32(('cd', 36).length) - ('cd', 4).length], msg.sender
}
