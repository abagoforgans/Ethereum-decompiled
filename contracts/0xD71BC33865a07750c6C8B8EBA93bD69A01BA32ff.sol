...
function sub_cf8bb185(?) {
    require owner == msg.sender
    if arg10:
        emit 0x34d6d9be: arg1
        emit 0x34d6d9be: arg10
        emit 0x34d6d9be: arg10
        if arg10 <= 0:
            emit 0x34d6d9be: 1
        else:
            ...
            call stor1.testTrade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11, address rg12) with:
                 gas gas_remaining - 710 wei
                args 0, 0, uint32(arg1), address(arg2), arg3, arg4, arg5, address(arg6), arg7 << 248, arg8, arg9, arg10, this.address
            require ext_call.success
        ...
        call stor1.0xfb6e155f with:
             gas gas_remaining - 710 wei
            args 0, 0, uint32(arg1), address(arg2), arg3, arg4, arg5, address(arg6), arg7 << 248, arg8, arg9
        require ext_call.success
        emit 0x34d6d9be: arg1
        emit 0x34d6d9be: arg10
        ...
        if ext_call.return_data[0] <= 0:
            ...
            call stor1.testTrade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11, address rg12) with:
                 gas gas_remaining - 710 wei
                args 0, 0, uint32(arg1), address(arg2), arg3, arg4, arg5, address(arg6), arg7 << 248, arg8, arg9, ext_call.return_data[0], this.address
            require ext_call.success
            if not ext_call.return_data[0]:
                emit 0x34d6d9be: 17
            else:
                ...
                call stor1.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
                     gas gas_remaining - 710 wei
                    args 0, 0, uint32(arg1), address(arg2), arg3, arg4, arg5, address(arg6), arg7 << 248, arg8, arg9, ext_call.return_data[0]
                require ext_call.success
}
