...
function _fallback() {
    stor0[address(msg.sender)] = code.data[3973 len 32]
    stor2 = code.data[3973 len 32]
    stor7 = code.data[4017 len 20]
    uint8(stor3.length) = 14
    stor3.length.field_8 = 'MyConin' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        ...
        continue 
    stor4 = 3
    uint8(stor5.length) = 4
    stor5.length.field_8 = 'MY' / 256
    idx = 0
    ...
    while stor6.length + 31 / 32 > idx:
        ...
        idx = idx + 1
        continue 
    stor10 = address(code.data[4069 len 32])
    stor11 = address(code.data[4037 len 32])
    return code.data[559 len 3414]
}
...
uint256 buyPrice;
uint256 sellPrice;
address sub_228a94cdAddress;
address sub_949fe331Address;
...
function sub_228a94cd(?) {
    return sub_228a94cdAddress
}
...
function sub_949fe331(?) {
    return sub_949fe331Address
}
...
function buy2(uint256 arg1) {
    call sub_228a94cdAddress with:
       value arg1 wei
