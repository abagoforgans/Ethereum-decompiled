...
const _fallback = code.data[19 len 1473]
...
function sendMessage(address arg1, string arg2) payable {
    ...
    if not arg2.length:
        ...
        if stor[var13001 + sha3(var13002)] != 0:
            # nil
        else:
            require var13003 < sub_15853113[address(arg1)].field_0
            sub_15853113[address(arg1)][var13003].field_0 = stor2
    else:
        s = 0
        idx = 128
        ...
        if stor[var16001 + sha3(var16002)] != 0:
            # nil
        else:
            require var16003 < sub_15853113[address(arg1)].field_0
            sub_15853113[address(arg1)][var16003].field_0 = stor2
}
