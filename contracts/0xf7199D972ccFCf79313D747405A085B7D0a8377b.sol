...
function sub_06eed2e9(?) {
    ...
    if address(ext_call.return_data[0]) == msg.sender:
        ...
        idx = mem[64] + 32
        s = 0
        while (2 * namespace.length) + 296 > idx:
            mem[idx + 32] = namespace[s].field_256
            idx = idx + 32
            s = s + 1
            continue 
        _1237 = mem[namespace.length + 232]
        mem[(2 * namespace.length) + 328 len floor32(mem[namespace.length + 232])] = mem[namespace.length + 264 len floor32(mem[namespace.length + 232])]
        mem[(2 * namespace.length) + floor32(mem[namespace.length + 232]) + -(mem[namespace.length + 232] % 32) + 360 len mem[namespace.length + 232] % 32] = mem[namespace.length + floor32(mem[namespace.length + 232]) + -(mem[namespace.length + 232] % 32) + 296 len mem[namespace.length + 232] % 32]
        _1333 = mem[64]
        mem[mem[64]] = mem[namespace.length + 232] + (2 * namespace.length) + -mem[64] + 296
        mem[64] = _1237 + (2 * namespace.length) + 328
        _1340 = mem[_1333]
        mem[_1237 + (2 * namespace.length) + 328 len floor32(mem[_1333])] = mem[_1333 + 32 len floor32(mem[_1333])]
        mem[_1237 + (2 * namespace.length) + floor32(mem[_1333]) + 328] = mem[_1237 + (2 * namespace.length) + floor32(mem[_1333]) + 328] and 256^(-(mem[_1333] % 32) + 32) - 1 or mem[_1333 + floor32(mem[_1333]) + 32] and !(256^(-(mem[_1333] % 32) + 32) - 1)
        mem[_1237 + (2 * namespace.length) + 332] = sha3(mem[_1237 + (2 * namespace.length) + 328 len _1340])
        require ext_code.size(eternalStorageAddress)
        call eternalStorageAddress.setUint(bytes32 arg1, uint256 arg2) with:
             gas gas_remaining wei
            args mem[_1237 + (2 * namespace.length) + 332], arg1
    else:
        ...
        _1337 = mem[64]
        mem[mem[64]] = mem[namespace.length + 232] + (2 * namespace.length) + -mem[64] + 296
        mem[64] = _1238 + (2 * namespace.length) + 328
        _1342 = mem[_1337]
        mem[_1238 + (2 * namespace.length) + 328 len floor32(mem[_1337])] = mem[_1337 + 32 len floor32(mem[_1337])]
        mem[_1238 + (2 * namespace.length) + floor32(mem[_1337]) + 328] = mem[_1238 + (2 * namespace.length) + floor32(mem[_1337]) + 328] and 256^(-(mem[_1337] % 32) + 32) - 1 or mem[_1337 + floor32(mem[_1337]) + 32] and !(256^(-(mem[_1337] % 32) + 32) - 1)
        mem[_1238 + (2 * namespace.length) + 332] = sha3(mem[_1238 + (2 * namespace.length) + 328 len _1342])
        require ext_code.size(eternalStorageAddress)
        call eternalStorageAddress.setUint(bytes32 arg1, uint256 arg2) with:
             gas gas_remaining wei
            args mem[_1238 + (2 * namespace.length) + 332], arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    return 1
}
...
function sub_b1595763(?) {
    ...
    if address(ext_call.return_data[0]) == msg.sender:
        ...
        idx = mem[64] + 32
        s = 0
        while ceil32(arg1.length) + (2 * namespace.length) + 328 > idx:
            mem[idx + 32] = namespace[s].field_256
            idx = idx + 32
            s = s + 1
            continue 
        _1574 = mem[ceil32(arg1.length) + namespace.length + 264]
        mem[ceil32(arg1.length) + (2 * namespace.length) + 360 len floor32(mem[ceil32(arg1.length) + namespace.length + 264])] = mem[ceil32(arg1.length) + namespace.length + 296 len floor32(mem[ceil32(arg1.length) + namespace.length + 264])]
        mem[ceil32(arg1.length) + (2 * namespace.length) + floor32(mem[ceil32(arg1.length) + namespace.length + 264]) + 360] = 256^(-(mem[ceil32(arg1.length) + namespace.length + 264] % 32) + 32) - 1 and mem[ceil32(arg1.length) + (2 * namespace.length) + floor32(mem[ceil32(arg1.length) + namespace.length + 264]) + 360] or mem[ceil32(arg1.length) + namespace.length + floor32(mem[ceil32(arg1.length) + namespace.length + 264]) + 296] and !(256^(-(mem[ceil32(arg1.length) + namespace.length + 264] % 32) + 32) - 1)
        _1744 = mem[96]
        mem[ceil32(arg1.length) + (2 * namespace.length) + mem[ceil32(arg1.length) + namespace.length + 264] + 360 len floor32(mem[96])] = mem[128 len floor32(mem[96])]
        mem[ceil32(arg1.length) + (2 * namespace.length) + mem[ceil32(arg1.length) + namespace.length + 264] + floor32(mem[96]) + -(mem[96] % 32) + 392 len mem[96] % 32] = mem[floor32(mem[96]) + -(mem[96] % 32) + 160 len mem[96] % 32]
        _1826 = mem[64]
        mem[mem[64]] = _1744 + ceil32(arg1.length) + (2 * namespace.length) + mem[ceil32(arg1.length) + namespace.length + 264] + -mem[64] + 328
        mem[64] = _1744 + ceil32(arg1.length) + (2 * namespace.length) + _1574 + 360
        _1833 = mem[_1826]
        mem[_1744 + ceil32(arg1.length) + (2 * namespace.length) + _1574 + 360 len floor32(mem[_1826])] = mem[_1826 + 32 len floor32(mem[_1826])]
        mem[_1744 + ceil32(arg1.length) + (2 * namespace.length) + _1574 + floor32(mem[_1826]) + 360] = mem[_1744 + ceil32(arg1.length) + (2 * namespace.length) + _1574 + floor32(mem[_1826]) + 360] and 256^(-(mem[_1826] % 32) + 32) - 1 or mem[_1826 + floor32(mem[_1826]) + 32] and !(256^(-(mem[_1826] % 32) + 32) - 1)
        mem[_1744 + ceil32(arg1.length) + (2 * namespace.length) + _1574 + 364] = sha3(mem[_1744 + ceil32(arg1.length) + (2 * namespace.length) + _1574 + 360 len _1833])
        require ext_code.size(eternalStorageAddress)
        call eternalStorageAddress.setUint(bytes32 arg1, uint256 arg2) with:
             gas gas_remaining wei
            args mem[_1744 + ceil32(arg1.length) + (2 * namespace.length) + _1574 + 364], arg2
    else:
        require ext_code.size(address(ext_call.return_data[0]))
        call address(ext_call.return_data[0]).0x471aedc2 with:
             gas gas_remaining wei
        ...
        mem[ceil32(arg1.length) + (2 * namespace.length) + mem[ceil32(arg1.length) + namespace.length + 264] + floor32(mem[96]) + -(mem[96] % 32) + 392 len mem[96] % 32] = mem[floor32(mem[96]) + -(mem[96] % 32) + 160 len mem[96] % 32]
        _1830 = mem[64]
        mem[mem[64]] = _1760 + ceil32(arg1.length) + (2 * namespace.length) + mem[ceil32(arg1.length) + namespace.length + 264] + -mem[64] + 328
        mem[64] = _1760 + ceil32(arg1.length) + (2 * namespace.length) + _1575 + 360
        _1835 = mem[_1830]
        mem[_1760 + ceil32(arg1.length) + (2 * namespace.length) + _1575 + 360 len floor32(mem[_1830])] = mem[_1830 + 32 len floor32(mem[_1830])]
        mem[_1760 + ceil32(arg1.length) + (2 * namespace.length) + _1575 + floor32(mem[_1830]) + 360] = mem[_1760 + ceil32(arg1.length) + (2 * namespace.length) + _1575 + floor32(mem[_1830]) + 360] and 256^(-(mem[_1830] % 32) + 32) - 1 or mem[_1830 + floor32(mem[_1830]) + 32] and !(256^(-(mem[_1830] % 32) + 32) - 1)
        mem[_1760 + ceil32(arg1.length) + (2 * namespace.length) + _1575 + 364] = sha3(mem[_1760 + ceil32(arg1.length) + (2 * namespace.length) + _1575 + 360 len _1835])
        require ext_code.size(eternalStorageAddress)
        call eternalStorageAddress.setUint(bytes32 arg1, uint256 arg2) with:
             gas gas_remaining wei
            args mem[_1760 + ceil32(arg1.length) + (2 * namespace.length) + _1575 + 364], arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    return 1
}

function sub_06c11b24(?) {
    mem[96] = arg1.length
    mem[128 len arg1.length] = arg1[all]
    mem[ceil32(arg1.length) + 128] = 8
    mem[ceil32(arg1.length) + 160] = 'services'
    ...
    require return_data.size >= 32
    require ext_code.size(address(ext_call.return_data[0]))
    call address(ext_call.return_data[0]).ISSUER() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if uint8(ext_call.return_data[0]) == uint8(ext_call.return_data[0]):
        mem[64] = ceil32(arg1.length) + namespace.length + 328
        mem[ceil32(arg1.length) + namespace.length + 264] = 9
        mem[ceil32(arg1.length) + namespace.length + 296] = 'countries'
        mem[0] = 2
        mem[ceil32(arg1.length) + namespace.length + 360] = uint256(namespace.field_0)
        idx = mem[64] + 32
        s = 0
