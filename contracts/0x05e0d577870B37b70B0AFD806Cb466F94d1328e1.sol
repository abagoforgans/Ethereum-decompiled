...
const name = 'Network Token Payment'
            ...
            if tokensPerEth * msg.value / 10^18:
                ...
                if stor4[address(msg.sender)]:
                    ...
                    if progress0drop > target0drop:
                        ...
                        require not distributionFinished
                        require totalDistributed + 3 * 10^9 >= totalDistributed
                        totalDistributed += 3 * 10^9
                        require balanceOf[address(msg.sender)] + 3 * 10^9 >= balanceOf[address(msg.sender)]
                        balanceOf[address(msg.sender)] += 3 * 10^9
                        emit Distr(3 * 10^9, msg.sender);
                        emit Transfer(3 * 10^9, 0, msg.sender);
                                            ...
                                            if tokensPerEth * msg.value / 10^18 <= 0:
                                                ...
                                                if block.timestamp < deadline:
                                                    if msg.value < 10^16:
                                                        ...
                                                        require not distributionFinished
                                                        require totalDistributed + (tokensPerEth * msg.value / 10^18) + (5 * tokensPerEth * msg.value / 10^18 / 100) >= totalDistributed
                                                        totalDistributed = totalDistributed + (tokensPerEth * msg.value / 10^18) + (5 * tokensPerEth * msg.value / 10^18 / 100)
                                                        require balanceOf[address(msg.sender)] + (tokensPerEth * msg.value / 10^18) + (5 * tokensPerEth * msg.value / 10^18 / 100) >= balanceOf[address(msg.sender)]
                                                        balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + (tokensPerEth * msg.value / 10^18) + (5 * tokensPerEth * msg.value / 10^18 / 100)
                                                        emit Distr(((tokensPerEth * msg.value / 10^18) + (5 * tokensPerEth * msg.value / 10^18 / 100)), msg.sender);
                                                        emit Transfer(((tokensPerEth * msg.value / 10^18) + (5 * tokensPerEth * msg.value / 10^18 / 100)), 0, msg.sender);
                                                        if totalDistributed < totalSupply:
                                                        else:
                                                            distributionFinished = 1
                                                else:
                                    ...
                                    if tokensPerEth * msg.value / 10^18 <= 0:
                                        ...
                                        if block.timestamp < deadline:
                                            if msg.value < 10^16:
                                                ...
                                                require not distributionFinished
                                                require totalDistributed + (tokensPerEth * msg.value / 10^18) + (3 * tokensPerEth * msg.value / 10^18 / 100) >= totalDistributed
                                                totalDistributed = totalDistributed + (tokensPerEth * msg.value / 10^18) + (3 * tokensPerEth * msg.value / 10^18 / 100)
                                                require balanceOf[address(msg.sender)] + (tokensPerEth * msg.value / 10^18) + (3 * tokensPerEth * msg.value / 10^18 / 100) >= balanceOf[address(msg.sender)]
                                                balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + (tokensPerEth * msg.value / 10^18) + (3 * tokensPerEth * msg.value / 10^18 / 100)
                                                emit Distr(((tokensPerEth * msg.value / 10^18) + (3 * tokensPerEth * msg.value / 10^18 / 100)), msg.sender);
                                                emit Transfer(((tokensPerEth * msg.value / 10^18) + (3 * tokensPerEth * msg.value / 10^18 / 100)), 0, msg.sender);
                                                if totalDistributed < totalSupply:
                                                else:
                                                    distributionFinished = 1
                                        else:
