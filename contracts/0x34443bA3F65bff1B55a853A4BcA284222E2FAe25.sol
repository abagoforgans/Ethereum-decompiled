...
function sub_57324cd2(?) {
    require arg2 < sub_57324cd2[arg1]
    return sub_57324cd2[arg1][arg2]
}
...
function sub_437b7e25(?) {
    ...
    if not documents.length > documents.length + 1:
        ...
        while idx < arg2.length:
            ...
            require idx < mem[ceil32(arg1.length) + 128]
            mem[32] = 4
            sub_57324cd2[mem[(32 * idx) + ceil32(arg1.length) + 160]]++
            if not sub_57324cd2[mem[(32 * idx) + ceil32(arg1.length) + 160]] <= sub_57324cd2[mem[(32 * idx) + ceil32(arg1.length) + 160]] + 1:
                s = sha3(sha3(mem[(32 * idx) + ceil32(arg1.length) + 160], 4)) + sub_57324cd2[mem[(32 * idx) + ceil32(arg1.length) + 160]] + 1
                while sha3(sha3(mem[(32 * idx) + ceil32(arg1.length) + 160], 4)) + sub_57324cd2[mem[(32 * idx) + ceil32(arg1.length) + 160]] > s:
                    uint256(stor[s].field_0) = 0
                    s = s + 1
                    continue 
            mem[0] = sha3(mem[(32 * idx) + ceil32(arg1.length) + 160], 4)
            sub_57324cd2[mem[(32 * idx) + ceil32(arg1.length) + 160]][sub_57324cd2[mem[(32 * idx) + ceil32(arg1.length) + 160]]] = documents.length
    ...
    while s < arg2.length:
        ...
        require s < mem[ceil32(arg1.length) + 128]
        mem[32] = 4
        sub_57324cd2[mem[(32 * s) + ceil32(arg1.length) + 160]]++
        if not sub_57324cd2[mem[(32 * s) + ceil32(arg1.length) + 160]] <= sub_57324cd2[mem[(32 * s) + ceil32(arg1.length) + 160]] + 1:
            t = sha3(sha3(mem[(32 * s) + ceil32(arg1.length) + 160], 4)) + sub_57324cd2[mem[(32 * s) + ceil32(arg1.length) + 160]] + 1
            while sha3(sha3(mem[(32 * s) + ceil32(arg1.length) + 160], 4)) + sub_57324cd2[mem[(32 * s) + ceil32(arg1.length) + 160]] > t:
                uint256(stor[t].field_0) = 0
                t = t + 1
                continue 
        mem[0] = sha3(mem[(32 * s) + ceil32(arg1.length) + 160], 4)
        sub_57324cd2[mem[(32 * s) + ceil32(arg1.length) + 160]][sub_57324cd2[mem[(32 * s) + ceil32(arg1.length) + 160]]] = documents.length
