...
function sub_7f520499(?) {
    ...
    return ext_call.return_data[0], arg3, ext_call.return_data[32], arg3 / ext_call.return_data[32]
}
...
function sub_7f899d0b(?) {
    ...
    require return_data.size >= 64
    require ext_call.return_data[32]
    require (4 * ext_call.return_data[0] * arg3) - (2 * ext_call.return_data[0] * arg3)
    return arg3, 
           ext_call.return_data[0],
           (ext_call.return_data[0] * ext_call.return_data[0]) - (arg3 * ext_call.return_data[0]) / (4 * ext_call.return_data[0] * arg3) - (2 * ext_call.return_data[0] * arg3),
           '3 step'
}
...
function sub_7bab93b7(?) {
    ...
    if arg3 - ext_call.return_data[0] <= 0:
        return arg3, ext_call.return_data[0], 0, 128, 6, '1 step' % 281474976710656
    require 0 < arg1.length
    require 1 < arg1.length
    require ext_code.size(0xb89570f6ad742cb1fd440a930d6c2a2ea29c51ee)
    call 0xb89570f6ad742cb1fd440a930d6c2a2ea29c51ee.getReturn(address arg1, address arg2, uint256 arg3) with:
