...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'Crypto JPY' / 256
    idx = 0
    ...
    require stor6 + 20090420000 > stor6
    stor6 += 20090420000
    stor7[address(msg.sender)] += 20090420000
    emit Transfer(20090420000, 0, msg.sender);
