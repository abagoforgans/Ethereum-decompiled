...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor1 = msg.sender
    stor3F0 = code.data[6962 len 20]
    stor3F1 = code.data[6994 len 20]
    stor3F2 = code.data[7026 len 20]
    return code.data[157 len 6793]
}
...
function getRecentActivity() {
    ...
    while idx < 1000:
        ...
        idx = idx + 1
        continue 
    return id, recentActivityIdx, mem[96], mem[128 len 31968]
}
...
function getTicketDetails(int256 arg1, uint256 arg2, uint256 arg3, address arg4) {
    ...
    if Mask(251, 0, arg3):
        mem[(32 * arg3) + 224] = mem[160]
        mem[(32 * arg3) + 256 len floor32((32 * arg3) - 1)] = mem[192 len floor32((32 * arg3) - 1)]
    return Array(len=arg3, data=mem[(32 * arg3) + 224 len 32 * arg3])
}
...
function initLottery(uint256 arg1, uint256 arg2, uint256 arg3, int256 arg4) payable {
    ...
    call poissonDataAddress.0x5a4fc9c5 with:
         gas gas_remaining - 710 wei
        args (arg4 - 1)
    require ext_call.success
    ...
    call btcRelayAddress.getLastBlockHeight() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    ticketOwner[stor3].field_256 = ext_call.return_data[0] + arg4
...
function finalizeLottery(uint256 arg1) payable {
    ...
    if ticketOwner[stor3].field_3072 == ticketOwner[stor3].field_256:
        ...
        ticketOwner[stor3].field_2304 = msg.sender
...
function getLotteryDetailsB(int256 arg1) {
    if arg1 != -1:
        ...
        call btcRelayAddress.getLastBlockHeight() with:
             gas gas_remaining - 710 wei
        require ext_call.success
        mem[ceil32(ticketOwner[arg1][10].length) + 160] = arg1
        mem[ceil32(ticketOwner[arg1][10].length) + 192] = ticketOwner[arg1].field_1536
        mem[ceil32(ticketOwner[arg1][10].length) + 224] = ticketOwner[arg1].field_1792
        mem[ceil32(ticketOwner[arg1][10].length) + 256] = ticketOwner[arg1].field_2048
        mem[ceil32(ticketOwner[arg1][10].length) + 288] = ticketOwner[arg1].field_2304
        if arg1 != 0:
            mem[ceil32(ticketOwner[arg1][10].length) + 352] = arg1 - 1
            if arg1 != id:
                mem[ceil32(ticketOwner[arg1][10].length) + 384] = arg1 + 1
                mem[ceil32(ticketOwner[arg1][10].length) + 416] = ext_call.return_data[0]
                mem[ceil32(ticketOwner[arg1][10].length) + 320] = 288
                mem[ceil32(ticketOwner[arg1][10].length) + 448] = ticketOwner[arg1][10].length
                if ticketOwner[arg1][10].length:
                    mem[ceil32(ticketOwner[arg1][10].length) + 480] = mem[160]
                    mem[ceil32(ticketOwner[arg1][10].length) + 512 len floor32(ticketOwner[arg1][10].length - 1)] = mem[192 len floor32(ticketOwner[arg1][10].length - 1)]
                return arg1, 
                       ticketOwner[arg1].field_1536,
                       ticketOwner[arg1].field_1792,
                       ticketOwner[arg1].field_2048,
                       ticketOwner[arg1].field_2304,
                       Array(len=ticketOwner[arg1][10].length, data=mem[ceil32(ticketOwner[arg1][10].length) + 480 len ticketOwner[arg1][10].length]),
                       arg1 - 1,
                       arg1 + 1,
                       ext_call.return_data[0]
            mem[ceil32(ticketOwner[arg1][10].length) + 384] = -1
            mem[ceil32(ticketOwner[arg1][10].length) + 416] = ext_call.return_data[0]
            mem[ceil32(ticketOwner[arg1][10].length) + 320] = 288
            mem[ceil32(ticketOwner[arg1][10].length) + 448] = ticketOwner[arg1][10].length
            if ticketOwner[arg1][10].length:
            ...
            return arg1, 
                   ...
                   -1,
                   ext_call.return_data[0]
        mem[ceil32(ticketOwner[arg1][10].length) + 352] = -1
        if arg1 != id:
            mem[ceil32(ticketOwner[arg1][10].length) + 384] = arg1 + 1
            mem[ceil32(ticketOwner[arg1][10].length) + 416] = ext_call.return_data[0]
            mem[ceil32(ticketOwner[arg1][10].length) + 320] = 288
    ...
    call btcRelayAddress.getLastBlockHeight() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    mem[ceil32(ticketOwner[stor3][10].length) + 160] = id
    mem[ceil32(ticketOwner[stor3][10].length) + 192] = ticketOwner[stor3].field_1536
    mem[ceil32(ticketOwner[stor3][10].length) + 224] = ticketOwner[stor3].field_1792
    mem[ceil32(ticketOwner[stor3][10].length) + 256] = ticketOwner[stor3].field_2048
    mem[ceil32(ticketOwner[stor3][10].length) + 288] = ticketOwner[stor3].field_2304
    if id != 0:
        mem[ceil32(ticketOwner[stor3][10].length) + 352] = id - 1
        if id != id:
            mem[ceil32(ticketOwner[stor3][10].length) + 384] = id + 1
            mem[ceil32(ticketOwner[stor3][10].length) + 416] = ext_call.return_data[0]
            mem[ceil32(ticketOwner[stor3][10].length) + 320] = 288
            mem[ceil32(ticketOwner[stor3][10].length) + 448] = ticketOwner[stor3][10].length
            if ticketOwner[stor3][10].length:
                mem[ceil32(ticketOwner[stor3][10].length) + 480] = mem[160]
                mem[ceil32(ticketOwner[stor3][10].length) + 512 len floor32(ticketOwner[stor3][10].length - 1)] = mem[192 len floor32(ticketOwner[stor3][10].length - 1)]
            return id, 
                   ticketOwner[stor3].field_1536,
                   ticketOwner[stor3].field_1792,
                   ticketOwner[stor3].field_2048,
                   ticketOwner[stor3].field_2304,
                   Array(len=ticketOwner[stor3][10].length, data=mem[ceil32(ticketOwner[stor3][10].length) + 480 len ticketOwner[stor3][10].length]),
                   id - 1,
                   id + 1,
                   ext_call.return_data[0]
        mem[ceil32(ticketOwner[stor3][10].length) + 384] = -1
        mem[ceil32(ticketOwner[stor3][10].length) + 416] = ext_call.return_data[0]
        mem[ceil32(ticketOwner[stor3][10].length) + 320] = 288
        mem[ceil32(ticketOwner[stor3][10].length) + 448] = ticketOwner[stor3][10].length
        if ticketOwner[stor3][10].length:
        ...
        return id, 
               ...
               -1,
               ext_call.return_data[0]
    mem[ceil32(ticketOwner[stor3][10].length) + 352] = -1
    if id != id:
        mem[ceil32(ticketOwner[stor3][10].length) + 384] = id + 1
        mem[ceil32(ticketOwner[stor3][10].length) + 416] = ext_call.return_data[0]
        mem[ceil32(ticketOwner[stor3][10].length) + 320] = 288
