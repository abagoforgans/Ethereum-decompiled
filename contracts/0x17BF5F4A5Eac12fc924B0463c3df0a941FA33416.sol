...
function _fallback() payable {
    mem[96 len -876] = code.data[1926 len -876]
    mem[64] = -716
    mem[-780] = mem[96] + 96
    mem[-748] = 0
...
function sub_cc07696d(?) payable {
    ...
    while uint8(idx) < 4:
        ...
        continue 
    stor1.length = 10000 * arg1 * stor1[_2] * None / stor1[_2] * None * stor1[_2] * None * storAD32
    sub_a4baecc9 = 10000 * arg1 * stor1[_2] * None / stor1[_2] * None * stor1[_2] * None * storADA5
    sub_bbd8f83a = 10000 * arg1 * stor1[_2] * None / stor1[_2] * None * stor1[_2] * None * storABBB
    sub_f33d3a41 = stor101E * 10000 * arg1 * stor1[_2] * None / stor1[_2] * None * stor1[_2] * None
}
