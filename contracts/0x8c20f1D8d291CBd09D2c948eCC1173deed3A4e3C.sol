...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 21000000 * 10^18
    stor2 = 21000000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 6
    stor3.length.field_8 = 'FUTRON' / 256
    idx = 0
...
function _fallback() payable {
    ...
    if balanceOf[stor9] < 21 * 10^6:
        tokens = 0
        balanceOf[stor9] -= tokens
        balanceOf[address(msg.sender)] += tokens
        emit Transfer(tokens, fundsWalletAddress, msg.sender);
