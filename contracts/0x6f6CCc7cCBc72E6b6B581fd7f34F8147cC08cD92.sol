...
const sub_053cee5e(?) = 10^6

const name = 'JP CAP-USDT'

const decimals = 8

const symbol = 'JP CAP-USDT'

const sub_a066e5a7(?) = 100 * 10^6
...
array of address stor36516136433507714556481507284757523525550975291680945358964353894568634540881;
array of uint256 stor36516136433507714556481507284757523525550975291680945358964353894568634540882;
...
function sub_3c35703f(?) {
    ...
    return sub_3c35703f[arg1].field_0, sub_3c35703f[arg1].field_256, sub_3c35703f[arg1].field_512, sub_3c35703f[arg1].field_768
}
...
function sub_49a10a26(?) {
    return bool(uint8(stor23.field_24))
}
...
function transfer(address arg1, uint256 arg2) {
    require 1 == bool(uint8(stor23.field_8))
...
function refund() {
    require not uint8(stor23.field_16)
    require not uint8(stor23.field_24)
    ...
    if not balanceOf[address(msg.sender)]:
        ...
        call stor29.0xa9059cbb with:
             gas gas_remaining wei
            args msg.sender, ratio * balanceOf[address(msg.sender)] / 100 * 10^6
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        emit LogRefunded(ratio * balanceOf[address(msg.sender)] / 100 * 10^6, block.timestamp, msg.sender);
    return 0
}
...
function finalize(uint256 arg1) {
    ...
    require arg1 > 0
    require ext_code.size(stor29)
    call stor29.0x70a08231 with:
         gas gas_remaining wei
        args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] <= soft_cap:
        uint8(stor23.field_24) = 0
    else:
        sub_d85cfda0 = arg1
        nav = arg1
...
function requestRedeem(uint256 arg1) {
    ...
    emit 0xfac850b5: arg1, stor4, block.timestamp, msg.sender
    stor4++
...
function getRedeemValue(uint256 arg1) {
    ...
    if not arg1:
        ...
        if ratio * arg1 / arg1 == ratio:
            if nav < roi:
                if not ratio * arg1 / 100 * 10^6:
                    return 0
                if nav * ratio * arg1 / 100 * 10^6 / ratio * arg1 / 100 * 10^6 == nav:
                    if 0 <= nav * ratio * arg1 / 100 * 10^6 / 10000:
                        return (nav * ratio * arg1 / 100 * 10^6 / 10000)
            else:
                if roi <= nav:
                    if not ratio * arg1 / 100 * 10^6:
                        if not ratio * arg1 / 100 * 10^6:
                        ...
                        if (nav * ratio * arg1 / 100 * 10^6) - (roi * ratio * arg1 / 100 * 10^6) / ratio * arg1 / 100 * 10^6 == nav - roi:
                            if not (nav * ratio * arg1 / 100 * 10^6) - (roi * ratio * arg1 / 100 * 10^6) / 10000:
                                if not ratio * arg1 / 100 * 10^6:
                                    return 0
                                if nav * ratio * arg1 / 100 * 10^6 / ratio * arg1 / 100 * 10^6 == nav:
                                    if 0 <= nav * ratio * arg1 / 100 * 10^6 / 10000:
                                ...
                                if sub_1843356c * (nav * ratio * arg1 / 100 * 10^6) - (roi * ratio * arg1 / 100 * 10^6) / 10000 / (nav * ratio * arg1 / 100 * 10^6) - (roi * ratio * arg1 / 100 * 10^6) / 10000 == sub_1843356c:
                                    if not ratio * arg1 / 100 * 10^6:
                                        if sub_1843356c * (nav * ratio * arg1 / 100 * 10^6) - (roi * ratio * arg1 / 100 * 10^6) / 10000 / 10000 <= 0:
                                            return -(sub_1843356c * (nav * ratio * arg1 / 100 * 10^6) - (roi * ratio * arg1 / 100 * 10^6) / 10000 / 10000)
                                    else:
                                        if nav * ratio * arg1 / 100 * 10^6 / ratio * arg1 / 100 * 10^6 == nav:
                                            if sub_1843356c * (nav * ratio * arg1 / 100 * 10^6) - (roi * ratio * arg1 / 100 * 10^6) / 10000 / 10000 <= nav * ratio * arg1 / 100 * 10^6 / 10000:
                                                return ((nav * ratio * arg1 / 100 * 10^6 / 10000) - (sub_1843356c * (nav * ratio * arg1 / 100 * 10^6) - (roi * ratio * arg1 / 100 * 10^6) / 10000 / 10000))
    revert
}

function buyTokens(uint256 arg1) {
    require uint8(stor23.field_16)
    require arg1 >= minimum
    if not arg1:
        require ratio
        if 0 == start_time:
        ...
        require arg1 + ext_call.return_data[0] < hard_cap
        require ext_code.size(stor29)
        call stor29.0xdd62ed3e with:
             gas gas_remaining wei
        ...
        emit 0x1cd70c7e: arg1, 0 / ratio, stor4, block.timestamp, msg.sender, msg.sender
    else:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require 100 * 10^6 * arg1 / ratio <= balanceOf[stor3]
        balanceOf[stor3] -= 100 * 10^6 * arg1 / ratio
        require (100 * 10^6 * arg1 / ratio) + balanceOf[msg.sender] >= balanceOf[msg.sender]
        balanceOf[address(msg.sender)] = (100 * 10^6 * arg1 / ratio) + balanceOf[msg.sender]
        emit 0x1cd70c7e: arg1, 100 * 10^6 * arg1 / ratio, stor4, block.timestamp, msg.sender, msg.sender
    stor4++
    return 1
}
...
function updateNAV(uint256 arg1) payable {
    ...
    while idx < sub_3c35703f.length:
        require sub_3c35703f[idx].field_512 > 0
        if not sub_3c35703f[idx].field_512:
            if nav >= roi:
                require roi <= nav
            if 0 >= sub_57a8cc06:
                ...
                call sub_350da22eAddress.0x1e9a6950 with:
                     gas gas_remaining wei
                    args sub_3c35703f[idx].field_256, 0
            else:
            ...
            require ext_call.return_data[0]
            mem[32] = 31
            members[stor30[idx].field_256].field_0 = 0
            require idx < sub_3c35703f.length
            mem[0] = 30
            mem[mem[64]] = sub_3c35703f[idx].field_512
            mem[mem[64] + 32] = nav
            mem[mem[64] + 64] = 0
            mem[mem[64] + 96] = sub_3c35703f[idx].field_0
            mem[mem[64] + 128] = block.timestamp
            emit 0xd3610103: sub_3c35703f[idx].field_512, nav, 0, sub_3c35703f[idx].field_0, block.timestamp, sub_3c35703f[idx].field_256
        else:
            require ratio * sub_3c35703f[idx].field_512 / sub_3c35703f[idx].field_512 == ratio
            if nav < roi:
                if not ratio * sub_3c35703f[idx].field_512 / 100 * 10^6:
                    if 0 >= sub_57a8cc06:
                        require ext_code.size(sub_350da22eAddress)
                        call sub_350da22eAddress.0x1e9a6950 with:
                             gas gas_remaining wei
                    ...
                    require nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 / ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 == nav
                    require 0 <= nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 / 10000
                    if nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 / 10000 >= sub_57a8cc06:
                        require ext_code.size(sub_350da22eAddress)
                        call sub_350da22eAddress.0x1e9a6950 with:
                             gas gas_remaining wei
                            args sub_3c35703f[idx].field_256, nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 / 10000
                    else:
                        require ext_code.size(sub_997dd812Address)
                        call sub_997dd812Address.0x1e9a6950 with:
                             gas gas_remaining wei
                    ...
                    mem[mem[64]] = sub_3c35703f[idx].field_512
                    mem[mem[64] + 32] = nav
                    mem[mem[64] + 64] = nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 / 10000
                    mem[mem[64] + 96] = sub_3c35703f[idx].field_0
                    mem[mem[64] + 128] = block.timestamp
                    emit 0xd3610103: sub_3c35703f[idx].field_512, nav, nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 / 10000, sub_3c35703f[idx].field_0, block.timestamp, sub_3c35703f[idx].field_256
            else:
                require roi <= nav
                if not ratio * sub_3c35703f[idx].field_512 / 100 * 10^6:
                    if not ratio * sub_3c35703f[idx].field_512 / 100 * 10^6:
                    ...
                    require (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 == nav - roi
                    if not (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000:
                        if not ratio * sub_3c35703f[idx].field_512 / 100 * 10^6:
                            if 0 >= sub_57a8cc06:
                                require ext_code.size(sub_350da22eAddress)
                                call sub_350da22eAddress.0x1e9a6950 with:
                        ...
                        require sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000 / (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000 == sub_1843356c
                        if not ratio * sub_3c35703f[idx].field_512 / 100 * 10^6:
                            require sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000 / 10000 <= 0
                            if -sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000 / 10000 >= sub_57a8cc06:
                                require ext_code.size(sub_350da22eAddress)
                                call sub_350da22eAddress.0x1e9a6950 with:
                                     gas gas_remaining wei
                                    args sub_3c35703f[idx].field_256, -sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000 / 10000
                            else:
                                require ext_code.size(sub_997dd812Address)
                                call sub_997dd812Address.0x1e9a6950 with:
                                     gas gas_remaining wei
                            ...
                            mem[mem[64]] = sub_3c35703f[idx].field_512
                            mem[mem[64] + 32] = nav
                            mem[mem[64] + 64] = -sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000 / 10000
                            mem[mem[64] + 96] = sub_3c35703f[idx].field_0
                            mem[mem[64] + 128] = block.timestamp
                            emit 0xd3610103: sub_3c35703f[idx].field_512, nav, -sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000 / 10000, sub_3c35703f[idx].field_0, block.timestamp, sub_3c35703f[idx].field_256
                        else:
                            require nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 / ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 == nav
                            require sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000 / 10000 <= nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 / 10000
                            if (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 / 10000) - (sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000 / 10000) >= sub_57a8cc06:
                                require ext_code.size(sub_350da22eAddress)
                                call sub_350da22eAddress.0x1e9a6950 with:
                                     gas gas_remaining wei
                                    args sub_3c35703f[idx].field_256, (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 / 10000) - (sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000 / 10000)
                            else:
                                require ext_code.size(sub_997dd812Address)
                                call sub_997dd812Address.0x1e9a6950 with:
                                     gas gas_remaining wei
                            ...
                            mem[mem[64]] = sub_3c35703f[idx].field_512
                            mem[mem[64] + 32] = nav
                            mem[mem[64] + 64] = (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 / 10000) - (sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000 / 10000)
                            mem[mem[64] + 96] = sub_3c35703f[idx].field_0
                            mem[mem[64] + 128] = block.timestamp
                            emit 0xd3610103: sub_3c35703f[idx].field_512, nav, (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6 / 10000) - (sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) - (roi * ratio * sub_3c35703f[idx].field_512 / 100 * 10^6) / 10000 / 10000), sub_3c35703f[idx].field_0, block.timestamp, sub_3c35703f[idx].field_256
        s = sub_3c35703f[idx].field_512
        s = sub_3c35703f[idx].field_256
        idx = idx + 1
        continue 
    sub_3c35703f.length = 0
    idx = 0
    while 4 * sub_3c35703f.length > idx:
        sub_3c35703f[idx].field_0 = 0
        sub_3c35703f[idx].field_256 = 0
        sub_3c35703f[idx].field_512 = 0
        sub_3c35703f[idx].field_768 = 0
        idx = idx + 4
        continue 
