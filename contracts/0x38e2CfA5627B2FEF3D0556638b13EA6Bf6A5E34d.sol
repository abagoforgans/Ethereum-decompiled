...
function quickAuditEthCredited(uint256 arg1) {
    ...
    return charities[stor0].field_512, 
           ...
           charities[stor0].field_1024 / 10^15,
           98 * charities[stor0].field_1024 / 10^15 / 100,
           (98 * charities[stor0].field_1024 / 10^15 / 100) + (8 * (1000 * charities[stor0].field_512) - (1000 * charities[stor0].field_0) / 10^18 * charities[stor0].field_2048 / charities[stor0].field_1792 / 10),
           (98 * charities[stor0].field_1024 / 10^15 / 100) + (8 * (1000 * charities[stor0].field_512) - (1000 * charities[stor0].field_0) / 10^18 * charities[stor0].field_2048 / charities[stor0].field_1792 / 10) - (1000 * charities[stor0].field_1280)
}
