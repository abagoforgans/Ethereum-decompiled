...
function _fallback() payable {
    ...
    mem[96 len -5305] = code.data[5896 len -5305]
    mem[64] = -5209
    stor3 = msg.sender
    stor8 = msg.sender
    stor3 = msg.sender
...
function mint(address arg1, uint256 arg2) {
    ...
    require not stor6
    require ext_code.size(0x54c6896983ecca5bce0ef613cc83283a8982a645)
    delegate 0x54c6896983ecca5bce0ef613cc83283a8982a645.0x66098d4f with:
         gas gas_remaining - 50 wei
