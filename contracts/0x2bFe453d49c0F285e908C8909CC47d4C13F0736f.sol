...
function transferAll(address arg1, address arg2) {
    require stor1[address(msg.sender)]
    require ext_code.size(0x4ada7a41e32decf484f0565f506bf9875a9e71cb)
    delegate 0x4ada7a41e32decf484f0565f506bf9875a9e71cb.0x771602f7 with:
...
function withdrawFrom(address arg1, address arg2, uint256 arg3) {
    ...
    require ext_code.size(0x4ada7a41e32decf484f0565f506bf9875a9e71cb)
    delegate 0x4ada7a41e32decf484f0565f506bf9875a9e71cb.0x3ef5e445 with:
         gas gas_remaining - 50 wei
