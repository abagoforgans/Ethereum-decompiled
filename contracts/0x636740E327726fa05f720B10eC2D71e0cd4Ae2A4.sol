...
function _fallback() payable {
    ...
    if msg.value:
        ...
        if msg.value < 10^18:
            ...
            balanceOf[address(msg.sender)] += msg.value / 10000
            emit Transfer((msg.value / 10000), this.address, msg.sender);
        else:
            totalBonusTokensIssued += msg.value / 10000
            totalSupply += 2 * msg.value / 10000
            balanceOf[address(msg.sender)] += 2 * msg.value / 10000
            emit Transfer((2 * msg.value / 10000), this.address, msg.sender);
}
