...
function _fallback() {
    ...
    stor3.length.field_8 = 'Digital Birr' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        ...
        continue 
    stor4 = 18
    stor5 = 20000000000 * 10^18
    stor6[0xc61de381a2981b32579acb34875e60ff23ed34c5] = stor5
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  stor5,
    emit 0x0: stor5
    emit 0xc61de381: stor5
    return code.data[694 len 5579]
}
