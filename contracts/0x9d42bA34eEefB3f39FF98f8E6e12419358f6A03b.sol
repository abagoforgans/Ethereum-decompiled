...
function _fallback() payable {
    ...
    require balanceOf[address(stor7.field_0)] >= distributeAmount
    ...
    require distributeAmount <= balanceOf[address(stor7.field_0)]
    balanceOf[address(stor7.field_0)] -= distributeAmount
    ...
    emit Transfer(distributeAmount, ownerAddress, msg.sender);
}
