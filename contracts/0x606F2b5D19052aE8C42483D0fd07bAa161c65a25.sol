...
function _fallback() payable {
    mem[128] = 'https://bz.cash'
    bool(stor1.length) = 0
    stor1.length.field_1 = 15
    stor1.length.field_8 = 'https://bz.cash' / 256
    idx = 0
    ...
    mem[160 len -3429] = code.data[3859 len -3429]
    stor0 = msg.sender
    stor5 = mem[160] * 10^stor4
    stor6[address(msg.sender)] = mem[160] * 10^stor4
