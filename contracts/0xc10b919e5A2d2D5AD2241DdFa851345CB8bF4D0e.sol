...
function sub_5e42ee3f(?) {
    return sub_5e42ee3fAddress
}
...
function totalSupply() {
    require ext_code.size(sub_5e42ee3fAddress)
    call sub_5e42ee3fAddress.0x18160ddd with:
...
function balanceOf(address arg1) {
    require ext_code.size(sub_5e42ee3fAddress)
    call sub_5e42ee3fAddress.0x27e235e3 with:
         gas gas_remaining wei
        args arg1
    require ext_call.success
    return ext_call.return_data[0]
...
function allowance(address arg1, address arg2) {
    require ext_code.size(sub_5e42ee3fAddress)
    call sub_5e42ee3fAddress.0x5c658165 with:
         gas gas_remaining wei
...
function requestPrint(address arg1, uint256 arg2) {
    ...
    emit PrintingLocked(sha3(block.hash(block.number - 1), this.address, sub_486cefbb + 1), address(arg1), arg2);
    return sha3(block.hash(block.number - 1), this.address, sub_486cefbb + 1)
}
...
function approveWithSender(address arg1, address arg2, uint256 arg3) {
    ...
    require arg2
    require ext_code.size(sub_5e42ee3fAddress)
    call sub_5e42ee3fAddress.0xda46098c with:
         gas gas_remaining wei
        args address(arg1), address(arg2), arg3
    require ext_call.success
    require ext_code.size(frontAddress)
    call frontAddress.0x5687f2b8 with:
         gas gas_remaining wei
        args address(arg1), address(arg2), arg3
    require ext_call.success
    return 1
...
function transferWithSender(address arg1, address arg2, uint256 arg3) {
    ...
    require ext_code.size(sub_5e42ee3fAddress)
    call sub_5e42ee3fAddress.0xe30443bc with:
         gas gas_remaining wei
        args address(arg1), ext_call.return_data[0] - arg3
    require ext_call.success
    require ext_code.size(sub_5e42ee3fAddress)
    call sub_5e42ee3fAddress.0x21e5383a with:
         gas gas_remaining wei
        args address(arg2), arg3
    require ext_call.success
    require ext_code.size(frontAddress)
    call frontAddress.0x23de6651 with:
         gas gas_remaining wei
        args address(arg1), address(arg2), arg3
    require ext_call.success
    return 1
...
function burn(uint256 arg1) {
    ...
    require ext_call.success
    require ext_code.size(sub_5e42ee3fAddress)
    call sub_5e42ee3fAddress.0xf7ea7a3d with:
         gas gas_remaining wei
