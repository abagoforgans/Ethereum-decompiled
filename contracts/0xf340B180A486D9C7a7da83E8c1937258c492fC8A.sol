...
function _fallback() payable {
    ...
    stor4[address(msg.sender)] = 100 * 10^6 * 10^stor2
    bool(stor0.length) = 0
    stor0.length.field_1 = 7
    stor0.length.field_8 = 'TL Coin' / 256
    idx = 0
    ...
    stor1.length.field_8 = 'TLC' / 256
    idx = 0
    while stor1.length + 31 / 32 > idx:
        stor1[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[399 len 2057]
}
...
function multisend(address[] arg1, uint256[] arg2) {
    ...
    while idx < arg1.length:
        ...
        _27 = sha3(address(mem[(32 * idx) + 128]), 4)
        ...
        mem[32] = 4
        mem[0] = msg.sender
        require stor[_27] + balanceOf[msg.sender] == balanceOf[msg.sender] + balanceOf[address(_22)]
        idx = idx + 1
        continue 
    return arg1.length
}
