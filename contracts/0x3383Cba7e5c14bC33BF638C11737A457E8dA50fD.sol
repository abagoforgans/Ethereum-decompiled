...
function sub_db2e5007(?) {
    ...
    if ext_call.return_data[0] != stor22:
        ...
        while idx <= arg1 + stor22:
            ...
            require ext_code.size(stor14)
            staticcall stor14.ownerOf(uint256 arg1) with:
                    gas gas_remaining wei
                   args idx
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
...
function sub_8e146833(?) {
    ...
    if ext_call.return_data[0] != stor20:
        ...
        while idx <= arg1 + stor20:
            if idx == ext_call.return_data[0]:
            require ext_code.size(stor10)
            staticcall stor10.ownerOf(uint256 arg1) with:
                    gas gas_remaining wei
                   args idx
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
...
function sub_8a9d91fa(?) {
    ...
    if ext_call.return_data[0] != stor23:
        ...
        while idx <= arg1 + stor23:
            if idx == ext_call.return_data[0]:
            require ext_code.size(stor16)
            staticcall stor16.ownerOf(uint256 arg1) with:
                    gas gas_remaining wei
                   args idx
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
    ...
    if stor5[msg.sender]:
        if stor19 < arg1:
            if var14001 <= 0:
                ...
                mem[100] = var14001
                require ext_code.size(stor8)
                call stor8.burn(uint256 arg1) with:
                     gas gas_remaining wei
                    args var14001
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
    ...
    if stor5[msg.sender]:
        if stor18 < arg1:
            if var14001 <= 0:
                ...
                call stor6.burn(uint256 arg1) with:
                     gas gas_remaining wei
                    args var14001
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
    ...
    if stor5[msg.sender]:
        if stor21 < arg1:
            if var14001 <= 0:
                ...
                mem[100] = var14001
                require ext_code.size(stor12)
                call stor12.burn(uint256 arg1) with:
                     gas gas_remaining wei
                    args var14001
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
    ...
    if stor5[msg.sender]:
        if stor23 < arg1:
            if var14001 <= 0:
                ...
                mem[100] = var14001
                require ext_code.size(stor16)
                call stor16.burn(uint256 arg1) with:
                     gas gas_remaining wei
                    args var14001
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
    ...
    if stor5[msg.sender]:
        if stor20 < arg1:
            if var14001 <= 0:
                ...
                mem[100] = var14001
                require ext_code.size(stor10)
                call stor10.burn(uint256 arg1) with:
                     gas gas_remaining wei
                    args var14001
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
    ...
    if stor5[msg.sender]:
        if stor22 < arg1:
            if var14001 <= 0:
                ...
                mem[100] = var14001
                require ext_code.size(stor14)
                call stor14.burn(uint256 arg1) with:
                     gas gas_remaining wei
                    args var14001
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
    ...
    if stor5[msg.sender]:
        ...
        if ext_call.return_data[0] != stor18:
            ...
            while idx <= arg1 + stor18:
                if idx == ext_call.return_data[0]:
                require ext_code.size(stor6)
                staticcall stor6.ownerOf(uint256 arg1) with:
                        gas gas_remaining wei
                       args idx
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
