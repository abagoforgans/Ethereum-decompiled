...
function sub_a51daf26(?) payable {
    ...
    if not ext_call.return_data[0]:
        ...
        call xrtAddress.0x40c10f19 with:
             gas gas_remaining wei
            args tx.origin, (150 * arg2) + (150 * sub_99d5bae1[address(arg1)])
    else:
        require ext_code.size(auctionAddress)
        staticcall auctionAddress.0xa6b513ee with:
                gas gas_remaining wei
...
function createLiability(bytes arg1, bytes arg2) payable {
    ...
    mem[arg1.length + floor32(arg1.length + 4) + -(arg1.length + 4 % 32) + 256 len arg1.length + 4 % 32] = mem[floor32(arg1.length + 4) + -(arg1.length + 4 % 32) + 252 len arg1.length + 4 % 32]
