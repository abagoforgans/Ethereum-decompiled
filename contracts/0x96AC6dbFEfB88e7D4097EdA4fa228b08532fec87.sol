...
function _fallback() payable {
    ...
    if not msg.value:
        ...
        if tokensSold + (100 * 10^18 * msg.value / 10^18) <= 21000000 * 10^18:
            require tokensSold + (100 * 10^18 * msg.value / 10^18) >= tokensSold
            ...
            require tokensSold <= 21000000 * 10^18
            if not -tokensSold + 21000000 * 10^18 / 100 * 10^18:
                require 0 <= msg.value
                ...
                require -tokensSold + 21000000 * 10^18 / 100 * 10^18
                require 10^18 * -tokensSold + 21000000 * 10^18 / 100 * 10^18 / -tokensSold + 21000000 * 10^18 / 100 * 10^18 == 10^18
                require 10^18 * -tokensSold + 21000000 * 10^18 / 100 * 10^18 <= msg.value
                require 21000000 * 10^18 >= tokensSold
                tokensSold = 21000000 * 10^18
                require tokensSold <= 21000000 * 10^18
                remainingTokens = -tokensSold + 21000000 * 10^18
                if msg.value - (10^18 * -tokensSold + 21000000 * 10^18 / 100 * 10^18) > 0:
                    call msg.sender with:
                       value msg.value - (10^18 * -tokensSold + 21000000 * 10^18 / 100 * 10^18) wei
                         gas 2300 * is_zero(value) wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    emit Transfer((msg.value - (10^18 * -tokensSold + 21000000 * 10^18 / 100 * 10^18)), this.address, msg.sender);
                require balanceOf[address(msg.sender)] + -tokensSold + 21000000 * 10^18 >= balanceOf[address(msg.sender)]
                balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + -tokensSold + 21000000 * 10^18
                emit Transfer((-tokensSold + 21000000 * 10^18), this.address, msg.sender);
                require totalSupply + -tokensSold + 21000000 * 10^18 >= totalSupply
                totalSupply = totalSupply + -tokensSold + 21000000 * 10^18
                call owner with:
                   value 10^18 * -tokensSold + 21000000 * 10^18 / 100 * 10^18 wei
                     gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
