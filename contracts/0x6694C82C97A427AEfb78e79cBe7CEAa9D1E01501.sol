...
function _fallback() payable {
    ...
    stor5[address(msg.sender)] = stor7 * 10^stor3
    bool(stor1.length) = 0
    stor1.length.field_1 = 18
    stor1.length.field_8 = 'Stock Equity Chain' / 256
    idx = 0
    ...
    stor2.length.field_8 = 'SEC' / 256
    idx = 0
    while stor2.length + 31 / 32 > idx:
        stor2[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[433 len 3602]
}
...
function _fallback() payable {
    ...
    require msg.sender
    require balanceOf[stor0] >= buyPrice * msg.value
    require balanceOf[address(msg.sender)] + (buyPrice * msg.value) > balanceOf[address(msg.sender)]
    require not stor9[stor0]
    require not stor9[address(msg.sender)]
    balanceOf[stor0] += -1 * buyPrice * msg.value
