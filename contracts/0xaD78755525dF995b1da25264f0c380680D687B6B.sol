...
function _fallback() payable {
    ...
    require code.data[19656 len 32] >= block.timestamp
    require code.data[19688 len 32] >= code.data[19656 len 32]
    require code.data[19720 len 32] > 0
    require code.data[19828 len 20]
    create contract with 0 wei
                    code: code.data[13351 len 6305]
    require create.new_address
    stor0 = address(create.new_address)
    stor1 = code.data[19656 len 32]
    stor2 = code.data[19688 len 32]
    stor4 = code.data[19720 len 32]
    stor3 = code.data[19828 len 20]
    require code.data[19784 len 32] > 0
    stor6 = code.data[19784 len 32]
    address(stor7.field_0) = msg.sender
    require code.data[19752 len 32] > 0
    create contract with 0 wei
                    code: code.data[10672 len 2679], stor3
    require create.new_address
    stor9 = address(create.new_address)
    stor8 = code.data[19752 len 32]
    require code.data[19752 len 32] <= code.data[19784 len 32]
    return code.data[832 len 9840]
}
