...
function _fallback() payable {
    mem[96 len -5458] = code.data[5737 len -5458]
    mem[64] = -5362
...
function orders(uint256 arg1) payable {
    return uint8(orders[arg1].field_0), 
...
function confirmSell(uint256 arg1) payable {
    if locked:
        emit Error(9);
        return 0
    require msg.sender == operatorAddress
    if 0 == orders[arg1].field_256:
        return 0
    if orders[arg1].field_2304 != 0:
        return 0
    if uint8(orders[arg1].field_0) != 0:
        return 0
    orders[arg1].field_2304 = block.number
    return 1, orders[arg1].field_256, orders[arg1].field_768, orders[arg1].field_1280
}

function sub_05ff1605(?) payable {
    if locked:
        emit Error(9);
        return 0
    require msg.sender == operatorAddress
    ...
    if arg2 != orders[arg1].field_512:
        return 0
    if uint8(orders[arg1].field_0) != 1:
        return 0
    orders[arg1].field_2304 = block.number
    return 1, orders[arg1].field_256, orders[arg1].field_1024
}
...
function sub_91f6dc8f(?) payable {
    ...
    while idx < arg7.length:
        ...
        mem[32] = 264
        if not sub_3f54580d[mem[(32 * idx) + 128]]:
            s = mem[(32 * idx) + 128]
            idx = idx + 1
            continue 
        mem[0] = mem[(32 * idx) + 128]
        if arg1 == sub_3f54580d[mem[(32 * idx) + 128]]:
            s = mem[(32 * idx) + 128]
            idx = idx + 1
            continue 
        else:
            return 0
    if orders[arg1].field_256:
        return 0
    if arg3 <= 0:
        return 0
    if arg4 <= 0:
    ...
    if arg6 < 0:
        return 0
    mem[(32 * arg7.length) + 128] = 1
    uint8(orders[arg1].field_0) = 1
    orders[arg1].field_256 = arg2
    orders[arg1].field_512 = arg3
    orders[arg1].field_768 = arg4
    orders[arg1].field_1024 = arg5
    orders[arg1].field_1280 = arg6
    orders[arg1].field_1536 = arg7.length
    if not arg7.length:
        idx = 0
        while orders[arg1].field_1536 > idx:
            orders[arg1][idx + 6].field_0 = 0
            idx = idx + 1
            continue 
    else:
        s = 0
        idx = 128
        while (32 * arg7.length) + 128 > idx:
            orders[arg1][s + 6].field_0 = mem[idx]
            s = s + 1
            idx = idx + 32
            continue 
    ...
    idx = 0
    while orders[arg1].field_1792 > idx:
        orders[arg1][idx + 7].field_0 = 0
        idx = idx + 1
        continue 
    orders[arg1].field_2048 = block.number
    orders[arg1].field_2304 = 0
    return 1
}
...
function sub_21096830(?) payable {
    ...
    if arg6 < 0:
        return 0
    mem[(32 * arg7.length) + 128] = 0
    uint8(orders[arg1].field_0) = 0
    orders[arg1].field_256 % 1 = 0
    orders[arg1].field_256 = arg2
    orders[arg1].field_512 = arg3
    orders[arg1].field_768 = arg4
    orders[arg1].field_1024 = arg5
