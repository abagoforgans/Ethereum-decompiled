...
function _fallback() payable {
    ...
    mem[96 len -5151] = code.data[5724 len -5151]
    mem[64] = -5055
    stor3 = msg.sender
    stor3 = msg.sender
    stor8 = msg.sender
...
function UpgradeAgentEnabledToken(address arg1) {
...
function setReleaseAgent(address arg1) {
    require owner == msg.sender
    require not stor4
    require not releaseAgentAddress
...
function mint(address arg1, uint256 arg2) {
    ...
    require not stor6
    require ext_code.size(0xc876feeb952cfc930580cd7aa35f593c30b04e41)
    delegate 0xc876feeb952cfc930580cd7aa35f593c30b04e41.0x66098d4f with:
         gas gas_remaining - 50 wei
...
function upgrade(uint256 arg1) {
    ...
    require arg1
    require ext_code.size(0xc876feeb952cfc930580cd7aa35f593c30b04e41)
    delegate 0xc876feeb952cfc930580cd7aa35f593c30b04e41.0xf4f3bdc1 with:
         gas gas_remaining - 50 wei
