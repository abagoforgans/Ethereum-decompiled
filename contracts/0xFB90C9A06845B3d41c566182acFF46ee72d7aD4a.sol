...
function sub_d4842e6d(?) payable {
    require arg1 < 32
    return (stor43[0.03125 / arg1].field_0 / 256^(arg1 % 32) << 248)
}
...
function sub_1a2cf5aa(?) payable {
    ...
    while idx < 32:
        require -idx + 31 < 32
        if t % 16 >= 10:
            stor43[0.03125 / -idx + 31].field_0 = uint8((t % 16) + 87) * 256^(-idx + 31 % 32) or !(255 * 256^(-idx + 31 % 32)) and stor43[0.03125 / -idx + 31].field_0
        else:
            stor43[0.03125 / -idx + 31].field_0 = uint8((t % 16) + 48) * 256^(-idx + 31 % 32) or !(255 * 256^(-idx + 31 % 32)) and stor43[0.03125 / -idx + 31].field_0
        s = t % 16
        idx = idx + 1
        t = t / 16
        continue 
    ...
    sub_9b2e93d8 = 48
    r1 = 0
    sub_2b81d6e0 = uint16((0 or 12288) + 120)
    Mask(112, 0, stor44.field_144) = uint8(stor43.length.field_8)
    Mask(96, 0, stor44.field_160) = Mask(96, 32, (0 or 12288) + 120) >> 32
    Mask(96, 0, stor44.field_160) = 0
    stor44.field_256 % 1 = 0
    stor44.field_256 % 1 = 0
}

function sub_e2c3eed9(?) payable {
    s = 0
    idx = 0
    t = arg1
    while idx < 32:
    ...
    uint16(stor44.field_16) = uint16((0 or 12288) + 120)
    uint16(stor44.field_32) = uint8(stor43.length.field_8)
    uint32(stor44.field_48) = uint32((0 or 0 or uint8(stor42.length.field_24)) + (0 or 0 or 256 * uint8(stor42.length.field_16)) + (0 or 805306368) + 7864320)
    stor44.field_256 % 1 = 0
    stor44.field_256 % 1 = 0
}

function sub_592a13d7(?) payable {
    s = 0
    idx = 0
    t = arg1
    while idx < 32:
    ...
    r1 = 0
    sub_2b81d6e0 = uint16((0 or 12288) + 120)
    r2 = uint8(stor43.length.field_8)
    Mask(96, 0, stor44.field_160) = Mask(96, 0, (0 or 0 or uint8(stor42.length.field_24)) + (0 or 0 or 256 * uint8(stor42.length.field_16)) + (0 or 805306368) + 7864320)
    uint64(stor44.field_192) = 0
    uint64(stor44.field_192) = Mask(64, 64, (0 or 12288) + 120) >> 64
    uint64(stor44.field_192) = 0
    stor44.field_256 % 1 = 0
    stor44.field_256 % 1 = 0
}

function sub_36a15cbb(?) payable {
    s = 0
    idx = 0
    t = arg1
    while idx < 32:
    ...
    uint16(stor44.field_16) = uint16((0 or 12288) + 120)
    uint16(stor44.field_32) = uint8(stor43.length.field_8)
    uint32(stor44.field_48) = uint32((0 or 805306368) + (0 or 0 or 256 * uint8(stor42.length.field_16)) + (0 or 0 or uint8(stor42.length.field_24)) + 7864320)
    uint32(stor44.field_80) = uint32((65536 * uint8(stor43.length.field_8)) + (256 * uint8(stor43.length.field_16)) + uint8(stor43.length.field_24))
    stor44.field_256 % 1 = 0
    stor44.field_256 % 1 = 0
}
...
function sub_415ae829(?) payable {
    ...
    idx = 0
    while idx < 10:
        s = (256 * s) + uint8(stor42[uint8(idx)].field_0)
        idx = idx + 1
        continue 
    left = Mask(80, 0, 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * 10 * 256 * s)
    s = 0
    idx = 0
    while idx < 32:
        s = uint8(stor43[uint8(idx)].field_0) + (256 * s)
        idx = idx + 1
        continue 
    stor41.field_0 % 32 = 0
    Mask(251, 0, stor41.field_5) = sub_1d465bfd
}
...
function sub_15692138(?) payable {
    ...
    uint16(stor44.field_32) = uint8(stor43.length.field_8)
    uint32(stor44.field_48) = uint32((0 or 0 or uint8(stor42.length.field_24)) + (0 or 0 or 256 * uint8(stor42.length.field_16)) + (0 or 805306368) + 7864320)
    sub_08fd226d = uint32(stor44.field_80)
    sub_9b2e93d8 = 48
    r1 = 0
    sub_2b81d6e0 = uint16((0 or 12288) + 120)
    r2 = uint8(stor43.length.field_8)
    sub_b43b3062 = uint32((0 or 0 or uint8(stor42.length.field_24)) + (0 or 0 or 256 * uint8(stor42.length.field_16)) + (0 or 805306368) + 7864320)
    uint64(stor44.field_192) = uint64(uint8(stor43.length.field_24) + (256 * uint8(stor43.length.field_16)) + (65536 * uint8(stor43.length.field_8)))
    uint32(stor44.field_224) = Mask(32, 64, (0 or 0 or uint8(stor42.length.field_24)) + (0 or 0 or 256 * uint8(stor42.length.field_16)) + (0 or 805306368) + 7864320) >> 64
    uint32(stor44.field_224) = 0
    uint32(stor44.field_224) = Mask(32, 96, (0 or 12288) + 120) >> 96
    uint32(stor44.field_224) = 0
    stor44.field_256 % 1 = 0
    stor44.field_256 % 1 = 0
    stor44.field_256 % 1 = 0
...
function addressHash(address arg1) payable {
    ...
    s = 0
    while 416 > idx + 32:
        mem[idx + 32] = stor42.length / 256^(-(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1) << 248
        idx = idx + 32
        s = -(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1
        continue 
    sub_e8223650 = sha3(uint8(stor42.length), mem[128 len 288])
    idx = 96
    s = 0
    while 1120 > idx + 32:
        mem[idx + 32] = stor43.length / 256^(-(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1) << 248
        idx = idx + 32
        s = -(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1
        continue 
    sub_b1936aa4 = sha3(uint8(stor43.length), mem[128 len 992])
    idx = 96
    s = 0
    while 416 > idx + 32:
        mem[idx + 32] = stor42.length / 256^(-(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1) << 248
    ...
    while 1440 > idx + 32:
        ...
        s = -(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1
        continue 
    sub_6ba04322 = sha3(uint8(stor42.length), mem[128 len 288], uint8(stor43.length), mem[448 len 992])
    sub_ea448c55 = sha3(left)
    sub_cfb3ec31 = sha3(right)
    sub_d8a6203b = sha3(left, right)
...
function sub_3ffe4585(?) payable {
    ...
    while 416 > idx + 32:
        ...
        s = -(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1
        continue 
    mem[416] = stor43.length / 256^0 << 248
    idx = 416
    s = 0
    while 1440 > idx + 32:
        mem[idx + 32] = stor43.length / 256^(-(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1) << 248
