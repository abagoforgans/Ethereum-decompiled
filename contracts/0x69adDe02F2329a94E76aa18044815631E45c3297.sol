    ...
    while idx < 42:
            ...
            if mem[idx + 384 len 1] <= 102:
                if mem[idx + 385 len 1] >= 97:
                    if mem[idx + 385 len 1] <= 102:
                        ...
                        s = mem[idx + 385 len 1] + (16 * mem[idx + 384 len 1] - 87) + (256 * s) - 87
                        continue 
                if mem[idx + 385 len 1] < 48:
                    idx = idx + 2
                    s = mem[idx + 385 len 1]
                    s = mem[idx + 384 len 1] - 87
                    s = mem[idx + 385 len 1] + (16 * mem[idx + 384 len 1] - 87) + (256 * s)
                    continue 
                ...
                s = mem[idx + 384 len 1] - 87
                s = mem[idx + 385 len 1] + (16 * mem[idx + 384 len 1] - 87) + (256 * s) - 48
                continue 
        if mem[idx + 384 len 1] < 48:
            if mem[idx + 385 len 1] >= 97:
                if mem[idx + 385 len 1] <= 102:
                    ...
                    s = mem[idx + 385 len 1] - 87
                    s = mem[idx + 384 len 1]
                    s = mem[idx + 385 len 1] + (Mask(8, 248, mem[idx + 384]) >> 244) + (256 * s) - 87
                    continue 
            if mem[idx + 385 len 1] < 48:
                idx = idx + 2
                s = mem[idx + 385 len 1]
                s = mem[idx + 384 len 1]
                s = mem[idx + 385 len 1] + (Mask(8, 248, mem[idx + 384]) >> 244) + (256 * s)
                continue 
            if mem[idx + 385 len 1] > 57:
                idx = idx + 2
                s = mem[idx + 385 len 1]
            ...
            s = mem[idx + 385 len 1] - 48
            s = mem[idx + 384 len 1]
            s = mem[idx + 385 len 1] + (Mask(8, 248, mem[idx + 384]) >> 244) + (256 * s) - 48
            continue 
        ...
        if mem[idx + 385 len 1] >= 97:
            if mem[idx + 385 len 1] <= 102:
                ...
                s = mem[idx + 385 len 1] + (16 * mem[idx + 384 len 1] - 48) + (256 * s) - 87
                continue 
        if mem[idx + 385 len 1] < 48:
            idx = idx + 2
            s = mem[idx + 385 len 1]
            s = mem[idx + 384 len 1] - 48
            s = mem[idx + 385 len 1] + (16 * mem[idx + 384 len 1] - 48) + (256 * s)
            continue 
        if mem[idx + 385 len 1] > 57:
            idx = idx + 2
            s = mem[idx + 385 len 1]
        ...
        s = mem[idx + 385 len 1] - 48
        s = mem[idx + 384 len 1] - 48
        s = mem[idx + 385 len 1] + (16 * mem[idx + 384 len 1] - 48) + (256 * s) - 48
        continue 
    mem[480] = 64
    ...
    while idx < 42:
            ...
            if mem[idx + 512 len 1] <= 102:
                if mem[idx + 513 len 1] >= 97:
                    if mem[idx + 513 len 1] <= 102:
                        ...
                        t = mem[idx + 513 len 1] + (16 * mem[idx + 512 len 1] - 87) + (256 * t) - 87
                        continue 
                if mem[idx + 513 len 1] < 48:
                    idx = idx + 2
                    t = mem[idx + 513 len 1]
                    t = mem[idx + 512 len 1] - 87
                    t = mem[idx + 513 len 1] + (16 * mem[idx + 512 len 1] - 87) + (256 * t)
                    continue 
                ...
                t = mem[idx + 512 len 1] - 87
                t = mem[idx + 513 len 1] + (16 * mem[idx + 512 len 1] - 87) + (256 * t) - 48
                continue 
        if mem[idx + 512 len 1] < 48:
            if mem[idx + 513 len 1] >= 97:
                if mem[idx + 513 len 1] <= 102:
                    ...
                    t = mem[idx + 513 len 1] - 87
                    t = mem[idx + 512 len 1]
                    t = mem[idx + 513 len 1] + (Mask(8, 248, mem[idx + 512]) >> 244) + (256 * t) - 87
                    continue 
            if mem[idx + 513 len 1] < 48:
                idx = idx + 2
                t = mem[idx + 513 len 1]
                t = mem[idx + 512 len 1]
                t = mem[idx + 513 len 1] + (Mask(8, 248, mem[idx + 512]) >> 244) + (256 * t)
                continue 
            if mem[idx + 513 len 1] > 57:
                idx = idx + 2
                t = mem[idx + 513 len 1]
            ...
            t = mem[idx + 513 len 1] - 48
            t = mem[idx + 512 len 1]
            t = mem[idx + 513 len 1] + (Mask(8, 248, mem[idx + 512]) >> 244) + (256 * t) - 48
            continue 
        ...
        if mem[idx + 513 len 1] >= 97:
            if mem[idx + 513 len 1] <= 102:
                ...
                t = mem[idx + 513 len 1] + (16 * mem[idx + 512 len 1] - 48) + (256 * t) - 87
                continue 
        if mem[idx + 513 len 1] < 48:
            idx = idx + 2
            t = mem[idx + 513 len 1]
            t = mem[idx + 512 len 1] - 48
            t = mem[idx + 513 len 1] + (16 * mem[idx + 512 len 1] - 48) + (256 * t)
            continue 
        if mem[idx + 513 len 1] > 57:
            idx = idx + 2
            t = mem[idx + 513 len 1]
        ...
        t = mem[idx + 513 len 1] - 48
        t = mem[idx + 512 len 1] - 48
        t = mem[idx + 513 len 1] + (16 * mem[idx + 512 len 1] - 48) + (256 * t) - 48
        continue 
    mem[608] = 64
    ...
    while idx < 42:
            ...
            if mem[idx + 640 len 1] <= 102:
                if mem[idx + 641 len 1] >= 97:
                    if mem[idx + 641 len 1] <= 102:
                        ...
                        t = mem[idx + 641 len 1] + (16 * mem[idx + 640 len 1] - 87) + (256 * t) - 87
                        continue 
                if mem[idx + 641 len 1] < 48:
                    idx = idx + 2
                    t = mem[idx + 641 len 1]
                    t = mem[idx + 640 len 1] - 87
                    t = mem[idx + 641 len 1] + (16 * mem[idx + 640 len 1] - 87) + (256 * t)
                    continue 
                ...
                t = mem[idx + 640 len 1] - 87
                t = mem[idx + 641 len 1] + (16 * mem[idx + 640 len 1] - 87) + (256 * t) - 48
                continue 
        if mem[idx + 640 len 1] < 48:
            if mem[idx + 641 len 1] >= 97:
                if mem[idx + 641 len 1] <= 102:
                    ...
                    t = mem[idx + 641 len 1] - 87
                    t = mem[idx + 640 len 1]
                    t = mem[idx + 641 len 1] + (Mask(8, 248, mem[idx + 640]) >> 244) + (256 * t) - 87
                    continue 
            if mem[idx + 641 len 1] < 48:
                idx = idx + 2
                t = mem[idx + 641 len 1]
                t = mem[idx + 640 len 1]
                t = mem[idx + 641 len 1] + (Mask(8, 248, mem[idx + 640]) >> 244) + (256 * t)
                continue 
            if mem[idx + 641 len 1] > 57:
                idx = idx + 2
                t = mem[idx + 641 len 1]
            ...
            t = mem[idx + 641 len 1] - 48
            t = mem[idx + 640 len 1]
            t = mem[idx + 641 len 1] + (Mask(8, 248, mem[idx + 640]) >> 244) + (256 * t) - 48
            continue 
        ...
        if mem[idx + 641 len 1] >= 97:
            if mem[idx + 641 len 1] <= 102:
                ...
                t = mem[idx + 641 len 1] + (16 * mem[idx + 640 len 1] - 48) + (256 * t) - 87
                continue 
        if mem[idx + 641 len 1] < 48:
            idx = idx + 2
            t = mem[idx + 641 len 1]
            t = mem[idx + 640 len 1] - 48
            t = mem[idx + 641 len 1] + (16 * mem[idx + 640 len 1] - 48) + (256 * t)
            continue 
        if mem[idx + 641 len 1] > 57:
            idx = idx + 2
            t = mem[idx + 641 len 1]
        ...
        t = mem[idx + 641 len 1] - 48
        t = mem[idx + 640 len 1] - 48
        t = mem[idx + 641 len 1] + (16 * mem[idx + 640 len 1] - 48) + (256 * t) - 48
        continue 
}
