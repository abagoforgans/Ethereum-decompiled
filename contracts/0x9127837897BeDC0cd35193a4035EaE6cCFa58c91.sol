...
function _fallback() payable {
    ...
    mem[160 len -13600] = code.data[14156 len -13600]
    stor1 = msg.sender
    require mem[223 len 1] == 4
    stor16[] = Array(len=mem[mem[160] + 160], data=mem[mem[160] + 192 len mem[mem[160] + 160]])
    stor17[] = Array(len=mem[mem[224] + 160], data=mem[mem[224] + 192 len mem[mem[224] + 160]])
    stor7 = mem[223 len 1]
    stor19 = uint8(bool(mem[256]))
    return code.data[556 len 13600]
}
