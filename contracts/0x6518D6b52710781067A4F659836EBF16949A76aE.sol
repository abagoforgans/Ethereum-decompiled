...
const name = 'US CAP-USDT'

const decimals = 12

const symbol = 'US CAP-USDT'

const sub_a066e5a7(?) = 10^12
...
function refund() {
    ...
    if not balanceOf[address(msg.sender)]:
        ...
        call stor29.0xa9059cbb with:
             gas gas_remaining wei
            args msg.sender, ratio * balanceOf[address(msg.sender)] / 10^12
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        emit LogRefunded(ratio * balanceOf[address(msg.sender)] / 10^12, block.timestamp, msg.sender);
    return 0
}
...
function getRedeemValue(uint256 arg1) {
    ...
    if not arg1:
        ...
        if ratio * arg1 / arg1 == ratio:
            if nav < roi:
                if not ratio * arg1 / 10^12:
                    return 0
                if nav * ratio * arg1 / 10^12 / ratio * arg1 / 10^12 == nav:
                    if 0 <= nav * ratio * arg1 / 10^12 / 10000:
                        return (nav * ratio * arg1 / 10^12 / 10000)
            else:
                if roi <= nav:
                    if not ratio * arg1 / 10^12:
                        if not ratio * arg1 / 10^12:
                        ...
                        if (nav * ratio * arg1 / 10^12) - (roi * ratio * arg1 / 10^12) / ratio * arg1 / 10^12 == nav - roi:
                            if not (nav * ratio * arg1 / 10^12) - (roi * ratio * arg1 / 10^12) / 10000:
                                if not ratio * arg1 / 10^12:
                                    return 0
                                if nav * ratio * arg1 / 10^12 / ratio * arg1 / 10^12 == nav:
                                    if 0 <= nav * ratio * arg1 / 10^12 / 10000:
                                ...
                                if sub_1843356c * (nav * ratio * arg1 / 10^12) - (roi * ratio * arg1 / 10^12) / 10000 / (nav * ratio * arg1 / 10^12) - (roi * ratio * arg1 / 10^12) / 10000 == sub_1843356c:
                                    if not ratio * arg1 / 10^12:
                                        if sub_1843356c * (nav * ratio * arg1 / 10^12) - (roi * ratio * arg1 / 10^12) / 10000 / 10000 <= 0:
                                            return -(sub_1843356c * (nav * ratio * arg1 / 10^12) - (roi * ratio * arg1 / 10^12) / 10000 / 10000)
                                    else:
                                        if nav * ratio * arg1 / 10^12 / ratio * arg1 / 10^12 == nav:
                                            if sub_1843356c * (nav * ratio * arg1 / 10^12) - (roi * ratio * arg1 / 10^12) / 10000 / 10000 <= nav * ratio * arg1 / 10^12 / 10000:
                                                return ((nav * ratio * arg1 / 10^12 / 10000) - (sub_1843356c * (nav * ratio * arg1 / 10^12) - (roi * ratio * arg1 / 10^12) / 10000 / 10000))
    revert
}
...
function buyTokens(uint256 arg1) {
    ...
    if not arg1:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require 10^12 * arg1 / ratio <= balanceOf[stor3]
        balanceOf[stor3] -= 10^12 * arg1 / ratio
        require (10^12 * arg1 / ratio) + balanceOf[msg.sender] >= balanceOf[msg.sender]
        balanceOf[address(msg.sender)] = (10^12 * arg1 / ratio) + balanceOf[msg.sender]
        emit 0x1cd70c7e: arg1, 10^12 * arg1 / ratio, stor4, block.timestamp, msg.sender, msg.sender
    stor4++
    return 1
}
...
function updateNAV(uint256 arg1) payable {
    ...
    while idx < sub_3c35703f.length:
        ...
        if not sub_3c35703f[idx].field_512:
            ...
            if nav < roi:
                if not ratio * sub_3c35703f[idx].field_512 / 10^12:
                    if 0 >= sub_57a8cc06:
                        require ext_code.size(sub_350da22eAddress)
                        call sub_350da22eAddress.0x1e9a6950 with:
                             gas gas_remaining wei
                    ...
                    require nav * ratio * sub_3c35703f[idx].field_512 / 10^12 / ratio * sub_3c35703f[idx].field_512 / 10^12 == nav
                    require 0 <= nav * ratio * sub_3c35703f[idx].field_512 / 10^12 / 10000
                    if nav * ratio * sub_3c35703f[idx].field_512 / 10^12 / 10000 >= sub_57a8cc06:
                        require ext_code.size(sub_350da22eAddress)
                        call sub_350da22eAddress.0x1e9a6950 with:
                             gas gas_remaining wei
                            args sub_3c35703f[idx].field_256, nav * ratio * sub_3c35703f[idx].field_512 / 10^12 / 10000
                    else:
                        require ext_code.size(sub_997dd812Address)
                        call sub_997dd812Address.0x1e9a6950 with:
                             gas gas_remaining wei
                    ...
                    mem[mem[64]] = sub_3c35703f[idx].field_512
                    mem[mem[64] + 32] = nav
                    mem[mem[64] + 64] = nav * ratio * sub_3c35703f[idx].field_512 / 10^12 / 10000
                    mem[mem[64] + 96] = sub_3c35703f[idx].field_0
                    mem[mem[64] + 128] = block.timestamp
                    emit 0xd3610103: sub_3c35703f[idx].field_512, nav, nav * ratio * sub_3c35703f[idx].field_512 / 10^12 / 10000, sub_3c35703f[idx].field_0, block.timestamp, sub_3c35703f[idx].field_256
            else:
                require roi <= nav
                if not ratio * sub_3c35703f[idx].field_512 / 10^12:
                    if not ratio * sub_3c35703f[idx].field_512 / 10^12:
                    ...
                    require (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / ratio * sub_3c35703f[idx].field_512 / 10^12 == nav - roi
                    if not (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000:
                        if not ratio * sub_3c35703f[idx].field_512 / 10^12:
                            if 0 >= sub_57a8cc06:
                                require ext_code.size(sub_350da22eAddress)
                                call sub_350da22eAddress.0x1e9a6950 with:
                        ...
                        require sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000 / (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000 == sub_1843356c
                        if not ratio * sub_3c35703f[idx].field_512 / 10^12:
                            require sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000 / 10000 <= 0
                            if -sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000 / 10000 >= sub_57a8cc06:
                                require ext_code.size(sub_350da22eAddress)
                                call sub_350da22eAddress.0x1e9a6950 with:
                                     gas gas_remaining wei
                                    args sub_3c35703f[idx].field_256, -sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000 / 10000
                            else:
                                require ext_code.size(sub_997dd812Address)
                                call sub_997dd812Address.0x1e9a6950 with:
                                     gas gas_remaining wei
                            ...
                            mem[mem[64]] = sub_3c35703f[idx].field_512
                            mem[mem[64] + 32] = nav
                            mem[mem[64] + 64] = -sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000 / 10000
                            mem[mem[64] + 96] = sub_3c35703f[idx].field_0
                            mem[mem[64] + 128] = block.timestamp
                            emit 0xd3610103: sub_3c35703f[idx].field_512, nav, -sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000 / 10000, sub_3c35703f[idx].field_0, block.timestamp, sub_3c35703f[idx].field_256
                        else:
                            require nav * ratio * sub_3c35703f[idx].field_512 / 10^12 / ratio * sub_3c35703f[idx].field_512 / 10^12 == nav
                            require sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000 / 10000 <= nav * ratio * sub_3c35703f[idx].field_512 / 10^12 / 10000
                            if (nav * ratio * sub_3c35703f[idx].field_512 / 10^12 / 10000) - (sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000 / 10000) >= sub_57a8cc06:
                                require ext_code.size(sub_350da22eAddress)
                                call sub_350da22eAddress.0x1e9a6950 with:
                                     gas gas_remaining wei
                                    args sub_3c35703f[idx].field_256, (nav * ratio * sub_3c35703f[idx].field_512 / 10^12 / 10000) - (sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000 / 10000)
                            else:
                                require ext_code.size(sub_997dd812Address)
                                call sub_997dd812Address.0x1e9a6950 with:
                                     gas gas_remaining wei
                            ...
                            mem[mem[64]] = sub_3c35703f[idx].field_512
                            mem[mem[64] + 32] = nav
                            mem[mem[64] + 64] = (nav * ratio * sub_3c35703f[idx].field_512 / 10^12 / 10000) - (sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000 / 10000)
                            mem[mem[64] + 96] = sub_3c35703f[idx].field_0
                            mem[mem[64] + 128] = block.timestamp
                            emit 0xd3610103: sub_3c35703f[idx].field_512, nav, (nav * ratio * sub_3c35703f[idx].field_512 / 10^12 / 10000) - (sub_1843356c * (nav * ratio * sub_3c35703f[idx].field_512 / 10^12) - (roi * ratio * sub_3c35703f[idx].field_512 / 10^12) / 10000 / 10000), sub_3c35703f[idx].field_0, block.timestamp, sub_3c35703f[idx].field_256
