...
function setBadgeGiver(address arg1) payable {
    require calldata.size - 4 >= 32
    require msg.sender == address(stor8)
    stor7 = arg1
}
...
function uint256ToString(uint256 arg1) payable {
    ...
    mem[128 len s + 1] = code.data[5729 len s + 1]
    t = s + 1
    idx = arg1
    while idx:
        require t - 1 < mem[96]
...
function concatStrings(string arg1, string arg2) payable {
    ...
    if uint255(arg1.length):
        mem[ceil32(arg1.length) + ceil32(arg2.length) + 192 len 2 * arg1.length] = code.data[5729 len 2 * arg1.length]
    idx = 0
...
function tokenURI(uint256 arg1) payable {
    ...
    if not arg1:
        ...
        mem[224] = '0'
        mem[256] = 86
        mem[288 len 86] = code.data[5729 len 86]
        idx = 0
        while idx < 43:
            require idx < 43
            require idx < 86
    ...
    if not s + 1:
        ...
        mem[_161 + 32 len 2 * _159] = code.data[5729 len 2 * _159]
        idx = 0
        while idx < _159:
            require idx < mem[96]
            require idx < mem[_161]
    ...
    mem[224 len s + 1] = code.data[5729 len s + 1]
    t = s + 1
    idx = arg1
    while idx:
        require t - 1 < mem[192]
    ...
    mem[_164 + 32 len 2 * _162] = code.data[5729 len 2 * _162]
    idx = 0
    while idx < _162:
        require idx < mem[96]
        require idx < mem[_164]
