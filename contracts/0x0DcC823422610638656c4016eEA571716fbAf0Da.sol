...
function getTokens() payable {
    ...
    if msg.value < 10^16:
        ...
        if 1000 * value / 1000 <= totalRemaining:
            require not distributionFinished
            require totalDistributed + (1000 * value / 1000) >= totalDistributed
            totalDistributed += 1000 * value / 1000
            require 1000 * value / 1000 <= totalRemaining
            totalRemaining -= 1000 * value / 1000
            require balanceOf[address(msg.sender)] + (1000 * value / 1000) >= balanceOf[address(msg.sender)]
            balanceOf[address(msg.sender)] += 1000 * value / 1000
            emit Distr((1000 * value / 1000), msg.sender);
            emit Transfer((1000 * value / 1000), 0, msg.sender);
        else:
        ...
        if 2000 * value:
            require 2000 * value
            require 2000 * value * msg.value / 2000 * value == msg.value
        call 0x8abf406f5be5bf9209e9b841758bd063185dac80 with:
           value msg.value wei
             gas 2300 * is_zero(value) wei
        if not ext_call.success:
        ...
        if value / 1000:
            require value / 1000
            require 999 * value / 1000 / value / 1000 == 999
        value = 999 * value / 1000
        if 2000 * value * msg.value / 10^18 <= totalRemaining:
            require not distributionFinished
            require totalDistributed + (2000 * value * msg.value / 10^18) >= totalDistributed
            totalDistributed += 2000 * value * msg.value / 10^18
            require 2000 * value * msg.value / 10^18 <= totalRemaining
            totalRemaining -= 2000 * value * msg.value / 10^18
            require balanceOf[address(msg.sender)] + (2000 * value * msg.value / 10^18) >= balanceOf[address(msg.sender)]
            balanceOf[address(msg.sender)] += 2000 * value * msg.value / 10^18
            emit Distr((2000 * value * msg.value / 10^18), msg.sender);
            emit Transfer((2000 * value * msg.value / 10^18), 0, msg.sender);
        else:
            require totalRemaining <= totalRemaining
            require not distributionFinished
            require totalDistributed + totalRemaining >= totalDistributed
    ...
    if value / 10 * 10^6:
        ...
        require 9999988 * value / 10 * 10^6 / value / 10 * 10^6 == 9999988
    value = 9999988 * value / 10 * 10^6
}
