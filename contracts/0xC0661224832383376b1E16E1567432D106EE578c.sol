...
function redeem(bytes arg1, bytes arg2) payable {
    ...
    mem[128] = msg.sender
    mem[96] = 32
    mem[192] = '\x19Ethereum Signed Message:\n32'
    mem[220] = sha3(msg.sender)
    mem[160] = 60
    mem[252] = arg1.length
    mem[284 len arg1.length] = arg1[all]
    mem[arg1.length + 284] = 0
    if arg1.length != 65:
        mem[64] = ceil32(arg1.length) + ceil32(arg2.length) + 316
        mem[ceil32(arg1.length) + 284] = arg2.length
        mem[ceil32(arg1.length) + 316 len arg2.length] = arg2[all]
        mem[ceil32(arg1.length) + arg2.length + 316] = 0
        idx = 0
        s = 0
        t = 0
        while idx < arg2.length / 20:
            _341 = mem[ceil32(arg1.length) + (20 * idx) + 316]
            if address(s) >= mem[ceil32(arg1.length) + (20 * idx) + 316 len 20]:
                mem[mem[64] + 32] = Mask(160, 96, mem[ceil32(arg1.length) + (20 * idx) + 316])
        ...
        _13 = mem[348]
        if Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', 348, 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', 348, 32))), 0) - 256 >= 27:
            mem[64] = ceil32(arg1.length) + ceil32(arg2.length) + 316
            mem[ceil32(arg1.length) + 284] = arg2.length
            mem[ceil32(arg1.length) + 316 len arg2.length] = arg2[all]
            mem[ceil32(arg1.length) + arg2.length + 316] = 0
            ...
            t = 0
            while idx < arg2.length / 20:
                _337 = mem[ceil32(arg1.length) + (20 * idx) + 316]
                if address(s) >= mem[ceil32(arg1.length) + (20 * idx) + 316 len 20]:
                    mem[mem[64] + 32] = Mask(160, 96, mem[ceil32(arg1.length) + (20 * idx) + 316])
                    mem[mem[64] + 52] = address(s)
                    _344 = mem[64]
            ...
            if uint8((Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', 348, 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', 348, 32))), 0) - 256) + 27) != 27:
                if uint8((Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', 348, 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', 348, 32))), 0) - 256) + 27) != 28:
                    mem[64] = ceil32(arg1.length) + ceil32(arg2.length) + 316
                    mem[ceil32(arg1.length) + 284] = arg2.length
                    mem[ceil32(arg1.length) + 316 len arg2.length] = arg2[all]
                    mem[ceil32(arg1.length) + arg2.length + 316] = 0
                    ...
                    t = 0
                    while idx < arg2.length / 20:
                        _340 = mem[ceil32(arg1.length) + (20 * idx) + 316]
                        if address(s) >= mem[ceil32(arg1.length) + (20 * idx) + 316 len 20]:
                            mem[mem[64] + 32] = Mask(160, 96, mem[ceil32(arg1.length) + (20 * idx) + 316])
                            mem[mem[64] + 52] = address(s)
                            _371 = mem[64]
                    ...
                    mem[ceil32(arg1.length) + 348] = uint8((Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', 348, 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', 348, 32))), 0) - 256) + 27)
                    mem[ceil32(arg1.length) + 380] = mem[284]
                    mem[ceil32(arg1.length) + 412] = mem[316]
                    signer = erecover(sha3(Mask(224, 32, '\x19Ethereum Signed Message:\n32') >> 32, sha3(msg.sender)), (Mask(8, -(('mask_shl', 256, 0, -3, ('var', '_13')), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('var', '_13')), 0) - 256) + 27 << 248, mem[284], mem[316]) 
                    mem[ceil32(arg1.length) + 284] = signer
                    if not erecover.result:
                        revert with ext_call.return_data[0 len return_data.size]
                    mem[64] = ceil32(arg1.length) + ceil32(arg2.length) + 348
                    mem[ceil32(arg1.length) + 316] = arg2.length
                    mem[ceil32(arg1.length) + 348 len arg2.length] = arg2[all]
                    mem[ceil32(arg1.length) + arg2.length + 348] = 0
                    idx = 0
                    s = signer
                    t = 0
                    while idx < arg2.length / 20:
                        _339 = mem[ceil32(arg1.length) + (20 * idx) + 348]
                        if address(s) >= mem[ceil32(arg1.length) + (20 * idx) + 348 len 20]:
                            mem[mem[64] + 32] = Mask(160, 96, mem[ceil32(arg1.length) + (20 * idx) + 348])
                            mem[mem[64] + 52] = address(s)
                            _362 = mem[64]
                            mem[mem[64]] = 40
                            mem[64] = mem[64] + 72
                ...
                t = 0
                while idx < arg2.length / 20:
                    _338 = mem[ceil32(arg1.length) + (20 * idx) + 348]
                    if address(s) >= mem[ceil32(arg1.length) + (20 * idx) + 348 len 20]:
                        mem[mem[64] + 32] = Mask(160, 96, mem[ceil32(arg1.length) + (20 * idx) + 348])
                        mem[mem[64] + 52] = address(s)
                        _353 = mem[64]
...
function sub_3f22fa97(?) payable {
    ...
    if not arg1.length:
        ...
        mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(arg4.length) + 224 len 32 * arg1.length] = code.data[5564 len 32 * arg1.length]
        idx = 0
        while idx < arg1.length:
            require idx < arg1.length
            _195 = mem[(32 * idx) + 128]
