...
const _fallback = code.data[25 len 1678]
...
function sub_9f341e13(?) payable {
    ...
    while uint8(idx) < uint256(stor[arg1]):
        ...
        s = s + 1
        continue 
    require ext_code.size(0xbeac5df5f1c56f949852c8589314036042c1d603)
    delegate 0xbeac5df5f1c56f949852c8589314036042c1d603.0xea9c8820 with:
