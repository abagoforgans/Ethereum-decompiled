...
function _fallback() payable {
    ...
    if code.data[9045 len 32]:
        stor4 = code.data[9045 len 32]
    else:
        stor4 = block.number
    return code.data[150 len 8895]
}
...
const delayOfICO2 = 430500

const blocksByDay = 6150
...
const delayOfICOEND = 553500

const coinMultiplayer = 10^18

const minimumGoal = 178600000 * 10^18

const delayOfPreICO = 184500

const maxTokenSupplyICO1 = 595000000 * 10^18

const delayOfICO1 = 307500

const maxTokenSupplyPreICO = 357000000 * 10^18

const TEAM_SHARE_PERCENTAGE = 16

const PRICE_ICO4 = 10000

const PRICE_ICO1 = 16666

const PRICE_ICO2 = 12500

const PRICE_PREICO = 25000
...
function IsPreICO() {
    require ext_code.size(0x6240ab6af6432935087788fa403ad0067b3a5c07)
    delegate 0x6240ab6af6432935087788fa403ad0067b3a5c07.0x771602f7 with:
         gas gas_remaining - 710 wei
        args _startBlock, 184500
...
function sendAllFunds() {
    ...
    require ext_call.return_data[0] >= 178600000 * 10^18
...
function getAllTimes() {
    require ext_code.size(0x6240ab6af6432935087788fa403ad0067b3a5c07)
    if block.number < _startBlock:
        delegate 0x6240ab6af6432935087788fa403ad0067b3a5c07.0xb67d77c5 with:
             gas gas_remaining - 710 wei
...
function getMaxEther() {
    require ext_code.size(coinAddress)
    call coinAddress.getMaxTokenAvaliable() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require ext_code.size(0x6240ab6af6432935087788fa403ad0067b3a5c07)
    if block.number < _startBlock:
        delegate 0x6240ab6af6432935087788fa403ad0067b3a5c07.0xa391c15b with:
             gas gas_remaining - 710 wei
        ...
        if block.number >= delegate.return_data[0]:
            ...
            if block.number >= delegate.return_data[0]:
                ...
                if block.number >= delegate.return_data[0]:
                    ...
                    if block.number > delegate.return_data[0]:
                        ...
                        if 1000000000 * 10^18 < ext_call.return_data[0]:
                            ...
                            delegate 0x6240ab6af6432935087788fa403ad0067b3a5c07.0xa391c15b with:
                                 gas gas_remaining - 710 wei
                                args ext_call.return_data[0], 10000
                else:
                    require ext_code.size(coinAddress)
                    call coinAddress.0x18160ddd with:
                         gas gas_remaining - 710 wei
                    ...
                    if 833000000 * 10^18 > ext_call.return_data[0]:
                        delegate 0x6240ab6af6432935087788fa403ad0067b3a5c07.0xa391c15b with:
                             gas gas_remaining - 710 wei
                            args ext_call.return_data[0], 12500
                    else:
                        delegate 0x6240ab6af6432935087788fa403ad0067b3a5c07.0x771602f7 with:
                             gas gas_remaining - 710 wei
                            args _startBlock, 553500
                ...
                if 595000000 * 10^18 > ext_call.return_data[0]:
                    delegate 0x6240ab6af6432935087788fa403ad0067b3a5c07.0xa391c15b with:
                         gas gas_remaining - 710 wei
                        args ext_call.return_data[0], 16666
                else:
                    delegate 0x6240ab6af6432935087788fa403ad0067b3a5c07.0x771602f7 with:
                         gas gas_remaining - 710 wei
                        args _startBlock, 430500
...
function refund(address arg1) payable {
    ...
    if block.number < _startBlock:
        ...
        call coinAddress.0x18160ddd with:
             gas gas_remaining - 710 wei
        require ext_call.success
        if ext_call.return_data[0] >= 178600000 * 10^18:
            if msg.value > 0:
                call arg1 with:
                   value msg.value wei
            ...
            if not stor0[address(msg.sender)]:
                ...
                delegate 0x6240ab6af6432935087788fa403ad0067b3a5c07.0xc8a4ac9c with:
                     gas gas_remaining - 710 wei
