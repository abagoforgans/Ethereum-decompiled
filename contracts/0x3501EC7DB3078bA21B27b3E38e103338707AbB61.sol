...
function _fallback() payable {
    mem[128] = 'Novi Slovenski Tolar v1.0'
    bool(stor0.length) = 0
    stor0.length.field_1 = 25
    stor0.length.field_8 = 'Novi Slovenski Tolar v1.0' / 256
    idx = 0
    ...
    mem[160 len -2932] = code.data[3342 len -2932]
