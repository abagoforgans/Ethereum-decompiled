...
function sub_46eb584c(?) payable {
    ...
    if not arg2:
        ...
        require arg3 / 100 >= 0
        mem[480 len 11422] = code.data[2040 len 11422]
        mem[11902] = daiContractAddress
        mem[11934] = devFeeAddress
        create contract with 0 wei
                        code: code.data[2040 len 11422], daiContractAddress, devFeeAddress
        ...
        call daiContractAddress.0x23b872dd with:
            ...
            args msg.sender, address(create.new_address), (arg3 / 100) + arg4 + arg3
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if not ext_call.return_data[0]:
            revert with 0, 32, 66, code.data[13462 len 66], code.data[2238 len 30]
        ...
        call daiContractAddress.0x23b872dd with:
             gas gas_remaining wei
            args msg.sender, address(create.new_address), (arg3 / 100) + arg4 + (arg3 / 3)
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if not ext_call.return_data[0]:
