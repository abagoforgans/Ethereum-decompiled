...
function finalizeCrowdsale() payable {
    ...
    if uint8(var34009) < 0xc331051700000000000000000000000000000000000000000000000000000000:
        ...
        if var52007 > 0:
            ...
            require ext_code.size(0x2231d656b0c5fbeebb3ba29cebb58181d671eb55)
            delegate 0x2231d656b0c5fbeebb3ba29cebb58181d671eb55.mem[var60002 len 4] with:
                 gas gas_remaining - 710 wei
            ...
            while uint8(idx + 1) < ext_call.return_data[0]:
                ...
                require ext_call.success
                require ext_code.size(tokenAddress)
                call tokenAddress.getReservedTokensListValInPercentageDecimals(address arg1) with:
                     gas gas_remaining - 710 wei
                    args address(ext_call.return_data[0])
                require ext_call.success
                ...
                require ext_code.size(0x2231d656b0c5fbeebb3ba29cebb58181d671eb55)
                delegate 0x2231d656b0c5fbeebb3ba29cebb58181d671eb55.0x66098d4f with:
                     gas gas_remaining - 710 wei
                ...
                if ext_call.success:
                    ...
                    if ext_code.size(tokenAddress):
                        ...
                        if ext_call.success:
                            ...
                            mem[100] = var47007
                            mem[132] = var47001
                            if ext_code.size(0x2231d656b0c5fbeebb3ba29cebb58181d671eb55):
                                delegate 0x2231d656b0c5fbeebb3ba29cebb58181d671eb55.mem[var49002 len 4] with:
                                     gas gas_remaining - 710 wei
