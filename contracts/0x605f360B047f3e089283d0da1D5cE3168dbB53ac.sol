...
function _fallback() payable {
    ...
    stor1 = msg.sender
    require not stor7
    require stor5 + 10^16 >= stor5
    stor5 += 10^16
    require stor2[stor1] + 10^16 >= stor2[stor1]
    stor2[stor1] += 10^16
    emit Distr(10^16, stor1);
    emit Transfer(10^16, 0, stor1);
    return code.data[758 len 7685]
}
