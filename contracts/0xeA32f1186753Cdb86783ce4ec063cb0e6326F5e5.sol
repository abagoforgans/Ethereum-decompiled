...
function sub_68b55839(?) {
    ...
    if balanceOf[address(arg1)]:
        mem[128 len 32 * balanceOf[address(arg1)]] = code.data[13380 len 32 * balanceOf[address(arg1)]]
    idx = 0
    s = 0
...
function sub_5b236d97(?) {
    if not stor10.length:
        ...
        mem[128 len 32 * stor10.length] = code.data[13380 len 32 * stor10.length]
        mem[(32 * stor10.length) + 128] = stor10.length
        mem[(32 * stor10.length) + 160 len 32 * stor10.length] = code.data[13380 len 32 * stor10.length]
    idx = 0
    while idx < stor10.length:
