...
function transfer(address arg1, uint256 arg2) {
    ...
    if timelockList[msg.sender].field_0 > 0:
        # nil
    else:
        require not stor9
        require arg1
...
function balanceOf(address arg1) {
    require calldata.size - 4 >= 32
    if 0 >= timelockList[address(arg1)].field_0:
    ...
    while idx < timelockList[address(arg1)].field_0:
        ...
        continue 
    return (stor3[address(arg1)] + (stor[(2 * stor13[address(arg1)].field_0) + _14 + 1] * timelockList[address(arg1)].field_0))
}

function transferFrom(address arg1, address arg2, uint256 arg3) {
    require calldata.size - 4 >= 96
    require not stor14[address(arg1)]
    if timelockList[address(arg1)].field_0 > 0:
        # nil
    else:
        require not stor9
