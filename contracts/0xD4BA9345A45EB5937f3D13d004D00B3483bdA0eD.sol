...
function _fallback() payable {
    ...
    stor1 = 10^15
    bool(stor7.length) = 0
    stor7.length.field_1 = 11
    stor7.length.field_8 = 'USDGambling' / 256
    idx = 0
    ...
    while stor8.length + 31 / 32 > idx:
        ...
        continue 
    stor9 = 6
    stor2[address(stor0.field_0)] = stor1
    stor10 = 0
    return code.data[462 len 5697]
}
