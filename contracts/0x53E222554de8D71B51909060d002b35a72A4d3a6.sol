...
function _fallback() payable {
    ...
    stor1.length.field_8 = 'yasudem' / 256
    idx = 0
    ...
    while stor2.length + 31 / 32 > idx:
        ...
        continue 
    stor3 = 18
    stor4 = 108347059433883722041830251
    require not msg.value
    stor0 = msg.sender
    stor5[address(msg.sender)] = stor4
    return code.data[546 len 5677]
}
...
function distributeToken(address[] arg1, uint256 arg2) {
    ...
    while idx < arg1.length:
        ...
        emit Transfer(arg2, owner, address(_17));
        idx = idx + 1
        continue 
}
