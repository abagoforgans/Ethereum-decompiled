...
const initialSupply = 1500 * 10^18
...
function allocateTicket(address arg1, address arg2) {
    ...
    if not customer_tickets[address(arg1)].field_0 <= customer_tickets[address(arg1)].field_0 + 1:
        idx = customer_tickets[address(arg1)].field_0 + 1
        while customer_tickets[address(arg1)].field_0 > idx:
            customer_tickets[address(arg1)][idx].field_0 = 0
            idx = idx + 1
            continue 
