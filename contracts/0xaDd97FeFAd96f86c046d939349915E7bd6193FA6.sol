...
function _fallback() payable {
    mem[96 len -5145] = code.data[5680 len -5145]
    mem[64] = -5049
...
function executeTransaction(uint256 arg1) {
    ...
    if not stor0[arg1][2].length:
        if block.timestamp > lastDay + (24 * 3600):
            ...
            spentToday = 0
        if stor0[arg1].field_256 + spentToday <= dailyLimit:
            if stor0[arg1].field_256 <= stor0[arg1].field_256 + spentToday:
                uint8(stor0[arg1].field_768) = 1
...
function getTransactionIds(uint256 arg1, uint256 arg2, bool arg3, bool arg4) {
    ...
    if (32 * s) + 224 < (32 * transactionCount) + 192:
        ...
        if not arg2 - arg1:
            ...
            while s < arg2:
                require s < transactionCount
                require s - arg1 < mem[(32 * transactionCount) + 192]
                mem[(32 * transactionCount) + (32 * s - arg1) + 224] = mem[(32 * s) + 192]
                s = s + 1
                continue 
        mem[(32 * transactionCount) + (32 * arg2 - arg1) + 224] = 32
        mem[(32 * transactionCount) + (32 * arg2 - arg1) + 256] = mem[(32 * transactionCount) + 192]
        mem[(32 * transactionCount) + (32 * arg2 - arg1) + 288 len 32 * mem[(32 * transactionCount) + 192]] = mem[(32 * transactionCount) + 224 len 32 * mem[(32 * transactionCount) + 192]]
    ...
    if not arg2 - arg1:
        ...
        while t < arg2:
            ...
            require t - arg1 < arg2 - arg1, None
            mem[(32 * s) + (32 * t - arg1) + 256] = mem[(32 * t) + 192]
            t = t + 1
            continue 
    else:
        idx = arg1
...
function submitTransaction(address arg1, uint256 arg2, bytes arg3) {
    ...
    if not stor0[stor5][2].length:
        if block.timestamp > lastDay + (24 * 3600):
            lastDay = block.timestamp
            spentToday = 0
        if stor0[stor5].field_256 + spentToday <= dailyLimit:
            if stor0[stor5].field_256 <= stor0[stor5].field_256 + spentToday:
                uint8(stor0[stor5].field_768) = 1
