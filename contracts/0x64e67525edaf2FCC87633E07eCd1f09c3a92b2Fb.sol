...
function _fallback() payable {
    ...
    mem[96 len -7643] = code.data[8244 len -7643]
    mem[64] = -7547
    stor3 = msg.sender
    stor11 = msg.sender
    stor3 = msg.sender
...
function mint(address arg1, uint256 arg2) {
    ...
    require not stor6
    require ext_code.size(0xbe160e5e0321ec05b2cb57e5aafa40fc6161a6e4)
    delegate 0xbe160e5e0321ec05b2cb57e5aafa40fc6161a6e4.0x66098d4f with:
         gas gas_remaining - 710 wei
