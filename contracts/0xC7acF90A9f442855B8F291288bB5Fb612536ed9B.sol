    ...
    if msg.sender == stor4:
        ...
        while uint8(idx) < uint8(stor0.length):
            ...
            while s % 16777216 < getUserRank[idx << 248].field_512:
                mem[32] = 0
                stor0[stor1[idx << 248][4][s << 232].field_0].field_0 = stor0[stor1[idx << 248][4][s << 232].field_0].field_16
                mem[0] = getUserRank[idx << 248][4][s << 232].field_0
                if not stor0[stor1[idx << 248][4][s << 232].field_0].field_16:
                    mem[0] = getUserRank[idx << 248][4][s << 232].field_0
                    mem[32] = 0
            ...
            while s % 16777216 < getUserRank[idx << 248].field_512:
                ...
                getUserRank[idx << 248][3][getUserRank[idx << 248][4][s << 232].field_256].field_0 = (stor0[stor1[idx << 248][4][s << 232].field_0].field_16 / 2 * stor0[stor1[idx << 248][4][s << 232].field_0].field_0 % 32768) + getUserRank[idx << 248][3][getUserRank[idx << 248][4][s << 232].field_256].field_0 or Mask(232, 24, getUserRank[idx << 248][3][getUserRank[idx << 248][4][s << 232].field_256].field_0)
