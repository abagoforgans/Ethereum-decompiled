...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor3 = code.data[3255 len 20]
    return code.data[144 len 3099]
}
...
function releaseVestedTokens(address arg1) {
    ...
    if vestingMap[address(arg1)].field_1024 / vestingMap[address(arg1)].field_512 * vestingMap[address(arg1)].field_512 == vestingMap[address(arg1)].field_1024:
        if vestingMap[address(arg1)].field_1024 / vestingMap[address(arg1)].field_512:
            require vestingMap[address(arg1)].field_1024 / vestingMap[address(arg1)].field_512
        ...
        if (vestingMap[address(arg1)].field_1024 / vestingMap[address(arg1)].field_512) + 1:
            require (vestingMap[address(arg1)].field_1024 / vestingMap[address(arg1)].field_512) + 1
...
function releaseMyVestedTokens() {
    ...
    if vestingMap[address(msg.sender)].field_1024 / vestingMap[address(msg.sender)].field_512 * vestingMap[address(msg.sender)].field_512 == vestingMap[address(msg.sender)].field_1024:
        if vestingMap[address(msg.sender)].field_1024 / vestingMap[address(msg.sender)].field_512:
            require vestingMap[address(msg.sender)].field_1024 / vestingMap[address(msg.sender)].field_512
        ...
        if (vestingMap[address(msg.sender)].field_1024 / vestingMap[address(msg.sender)].field_512) + 1:
            require (vestingMap[address(msg.sender)].field_1024 / vestingMap[address(msg.sender)].field_512) + 1
