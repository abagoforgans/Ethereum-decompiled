...
mapping of struct sub_78f21c8d;

function sub_78f21c8d(?) payable {
    return sub_78f21c8d[('signextend', 15, ('param', 'arg1'))].field_0
}
...
function sub_4ea019af(?) payable {
    if sub_78f21c8d[('signextend', 15, ('param', 'arg1'))].field_0 != msg.sender:
        return 0
    if 0 == arg2:
        return 0
    sub_78f21c8d[('signextend', 15, ('param', 'arg1'))].field_0 = arg2 or Mask(96, 160, sub_78f21c8d[('signextend', 15, ('param', 'arg1'))].field_0)
...
function sub_47b1ad09(?) payable {
    ...
    if sub_78f21c8d[('signextend', 15, ('param', 'arg1'))].field_0 != 0:
        if sub_78f21c8d[('signextend', 15, ('param', 'arg1'))].field_0 != msg.sender:
            return 0
    if not sub_78f21c8d[('signextend', 15, ('param', 'arg1'))].field_0:
        sub_78f21c8d[('signextend', 15, ('param', 'arg1'))].field_0 = sub_78f21c8d[('signextend', 15, ('param', 'arg1'))].field_160
