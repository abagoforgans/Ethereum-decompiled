...
function _fallback() payable {
    ...
    stor1 = code.data[2957 len 20]
    return code.data[797 len 2116]
}
        ...
        if sub_8200b74d:
            ...
            if ext_code.size(sub_c7b60dcfAddress):
                ...
                if ext_call.success:
                    ...
                    require ext_call.return_data[0] + (10^6 * msg.value / sub_8200b74d) <= 5 * 10^6
                    ...
                    if ext_code.size(sub_c7b60dcfAddress):
                        call sub_c7b60dcfAddress.0x475a9fa9 with:
                             gas gas_remaining - 710 wei
