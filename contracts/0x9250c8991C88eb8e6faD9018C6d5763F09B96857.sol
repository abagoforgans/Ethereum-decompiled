...
function _fallback() payable {
    ...
    if msg.value:
        ...
        if msg.value < 10^16:
            ...
            totalSupply = totalContribution + (10000 * msg.value) + totalSupply
            balanceOf[address(msg.sender)] = totalContribution + (10000 * msg.value) + balanceOf[address(msg.sender)]
            emit Transfer((totalContribution + (10000 * msg.value)), this.address, msg.sender);
}
