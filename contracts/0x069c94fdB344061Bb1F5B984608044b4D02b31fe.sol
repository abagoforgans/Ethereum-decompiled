...
function _fallback() payable {
    ...
    stor3 = code.data[2673 len 32] * 10^stor2
    stor4[address(msg.sender)] = code.data[2673 len 32] * 10^stor2
    bool(stor0.length) = 0
    stor0.length.field_1 = 7
    stor0.length.field_8 = 'IRSTrat' / 256
    idx = 0
    ...
    stor1.length.field_8 = 'IRS' / 256
    idx = 0
    while stor1.length + 31 / 32 > idx:
        stor1[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[416 len 2257]
}
