...
function _fallback() payable {
    ...
    mem[96 len -6927] = code.data[7547 len -6927]
    mem[64] = -6831
    stor3 = msg.sender
    stor8 = msg.sender
    stor3 = msg.sender
...
function mint(address arg1, uint256 arg2) {
    ...
    require not stor6
    require ext_code.size(0xe29e2cb9bc9237ecb6fbcd14c7bebaf59024a68)
    delegate 0xe29e2cb9bc9237ecb6fbcd14c7bebaf59024a68.0x66098d4f with:
         gas gas_remaining - 710 wei
