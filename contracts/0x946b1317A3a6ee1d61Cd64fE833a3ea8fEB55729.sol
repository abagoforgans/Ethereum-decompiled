...
function sub_43779ffb(?) payable {
    ...
    while idx < 4:
        ...
        mem[ceil32(arg1.length) + s + 160] = Mask(8, 248, mem[idx + 128])
        idx = idx + 1
        s = s + 1
        continue 
    idx = 0
    ...
    while idx < 5:
        ...
        require s < arg2.length
        mem[ceil32(arg1.length) + s + 160] = Mask(8, 248, mem[ceil32(arg1.length) + idx + 160])
        idx = idx + 1
        s = s + 1
        continue 
...
function sub_211445e9(?) payable {
    ...
    while idx < 5:
        ...
        s = s + 1
        continue 
    mem[ceil32(arg1.length) + 516] = mem[ceil32(arg1.length) + 532 len 16]
    call 0xd4cb3eb955e03ac64644678fd3d6a7f3104ee70d.0xadf59f99 with:
         gas gas_remaining - 25050 wei
        args 0, 96, 160, 12, 'WolframAlpha', 16, mem[ceil32(arg1.length) + 516]
