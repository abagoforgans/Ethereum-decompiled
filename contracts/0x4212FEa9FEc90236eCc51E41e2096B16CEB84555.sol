...
function _fallback() payable {
    ...
    while stor6.length + 31 / 32 > idx:
        ...
        idx = idx + 1
        continue 
    mem[192] = 'https://sdchain.io'
    bool(stor7.length) = 0
    stor7.length.field_1 = 18
    stor7.length.field_8 = 'https://sdchain.io' / 256
    idx = 0
    ...
    mem[224 len -4279] = code.data[4871 len -4279]
    stor0 = mem[224] * 10^mem[319 len 1]
    stor1[address(msg.sender)] = stor0
    stor3[] = Array(len=mem[mem[256] + 224], data=mem[mem[256] + 256 len mem[mem[256] + 224]])
    stor4 = mem[319 len 1]
    stor5[] = Array(len=mem[mem[320] + 224], data=mem[mem[320] + 256 len mem[mem[320] + 224]])
    return code.data[592 len 4279]
}
...
array of uint256 officialWebsite;
...
function officialWebsite() {
    return officialWebsite[0 len officialWebsite.length]
}
