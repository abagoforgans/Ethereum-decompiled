...
function _fallback() {
    stor3 = msg.sender
    stor1[address(msg.sender)] = code.data[3777 len 32]
    stor0 = code.data[3777 len 32]
    emit Transfer(code.data[3777 len 32], 0, msg.sender);
    stor4 = msg.sender
    require stor3 == msg.sender
    require code.data[3821 len 20]
    emit OwnershipTransferred(stor3, code.data[3821 len 20]);
    stor3 = code.data[3821 len 20]
    return code.data[368 len 3409]
}
...
const name = 'Kyber Network Crystal'
