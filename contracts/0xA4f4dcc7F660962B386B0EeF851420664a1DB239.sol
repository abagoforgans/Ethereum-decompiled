...
function sub_c2937ab5(?) payable {
    if owner == msg.sender:
        ...
        if stor[code.data[1084 len 32]] == arg1:
            sub_a5525736 += arg2
        else:
            miners[stor[code.data[1084 len 32]]] -= arg2
}
...
function sub_e952dd05(?) payable {
    if owner == msg.sender:
        if miners[address(arg1)] - arg2 > 0:
            miners[address(arg1)] -= arg2
        if arg1 == stor[code.data[1084 len 32]]:
            sub_a5525736 -= arg2
        else:
            miners[stor[code.data[1084 len 32]]] += arg2
}
...
function sub_1b4fd32f(?) payable {
    if owner == msg.sender:
        ...
        miners[address(arg1)] = arg2
        numMiners++
        if stor[code.data[1084 len 32]] != address(arg1):
            miners[stor[code.data[1084 len 32]]] -= arg2
        if address(arg1) == stor[code.data[1084 len 32]]:
            sub_a5525736 += arg2
}
...
function sub_6f7b5589(?) payable {
    if owner == msg.sender:
        ...
        while idx > 0:
            ...
            idx = idx - 1
            continue 
        call stor[code.data[1084 len 32]] with:
