...
function _fallback() payable {
    ...
    stor2.length.field_8 = 'GrandEgyptCoin' / 256
    idx = 0
    ...
    stor3.length.field_8 = 'EGCOIN' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        ...
        continue 
    stor4 = 16
    stor5 = 20000000 * 10^18
    stor6 = 0
    stor7 = 0
    require not msg.value
    stor1 = msg.sender
    stor8[address(msg.sender)] = stor5
    return code.data[445 len 9274]
}
...
function bulkTransfer(address[] arg1, uint256[] arg2) {
    ...
    while idx < arg1.length:
        ...
        if not mem[(32 * idx) + (32 * arg1.length) + 160]:
            ...
            if 10^16 * mem[(32 * idx) + (32 * arg1.length) + 160] / mem[(32 * idx) + (32 * arg1.length) + 160] == 10^16:
                if idx < arg2.length:
                    mem[(32 * arg1.length) + (32 * idx) + 160] = 10^16 * mem[(32 * idx) + (32 * arg1.length) + 160]
                    if idx < arg2.length:
...
function tokenBack(address[] arg1, uint256[] arg2) {
    ...
    while idx < arg1.length:
        ...
        if not mem[(32 * idx) + (32 * arg1.length) + 160]:
            ...
            s = s
            continue 
        require 10^16 * mem[(32 * idx) + (32 * arg1.length) + 160] / mem[(32 * idx) + (32 * arg1.length) + 160] == 10^16
        require idx < arg2.length
        mem[(32 * arg1.length) + (32 * idx) + 160] = 10^16 * mem[(32 * idx) + (32 * arg1.length) + 160]
        require idx < arg2.length
        require idx < arg1.length
...
function bulkTransfer(address[] arg1, uint256 arg2) {
    ...
    if not 10^16 * arg2:
        ...
        while idx < arg1.length:
            ...
            require block.timestamp > unlockUnixTime[mem[(32 * idx) + 140 len 20]]
            require idx < arg1.length
            require (10^16 * arg2) + balanceOf[mem[(32 * idx) + 140 len 20]] >= balanceOf[mem[(32 * idx) + 140 len 20]]
            require idx < arg1.length
            mem[32] = 8
            balanceOf[mem[(32 * idx) + 140 len 20]] += 10^16 * arg2
            require idx < arg1.length
            _150 = mem[(32 * idx) + 128]
            mem[0] = mem[(32 * idx) + 140 len 20]
            mem[(32 * arg1.length) + 128] = 10^16 * arg2
            emit Transfer((10^16 * arg2), msg.sender, address(_150));
            idx = idx + 1
            continue 
        if 0 <= balanceOf[address(msg.sender)]:
            return 1
        revert
    require 10^16 * arg1.length * arg2 / 10^16 * arg2 == arg1.length
    require balanceOf[address(msg.sender)] >= 10^16 * arg1.length * arg2
    idx = 0
    while idx < arg1.length:
        require idx < arg1.length
        require mem[(32 * idx) + 140 len 20]
        ...
        mem[0] = mem[(32 * idx) + 140 len 20]
        mem[(32 * arg1.length) + 128] = 10^16 * arg2
        emit Transfer((10^16 * arg2), msg.sender, address(_145));
        idx = idx + 1
        continue 
    require 10^16 * arg1.length * arg2 <= balanceOf[address(msg.sender)]
    balanceOf[address(msg.sender)] += -1 * 10^16 * arg1.length * arg2
    return 1
}
