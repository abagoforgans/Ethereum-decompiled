...
function _fallback() {
    ...
    stor2 = code.data[4865 len 20]
    return code.data[196 len 4657]
}
...
function sub_26490de4(?) {
    ...
    if ext_call.return_data[0] * arg1 / arg3 >= arg1 - ext_call.return_data[0]:
        require arg11 <= arg1 - ext_call.return_data[0]
    else:
        require arg11 <= ext_call.return_data[0] * arg1 / arg3
    require ext_code.size(etherdeltaAddress)
    call etherdeltaAddress.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
         gas gas_remaining - 710 wei
        args 0, 0, uint32(arg1), address(arg2), arg3, arg4, arg5, address(arg6), arg7 << 248, arg8, arg9, arg11
    require ext_call.success
}
