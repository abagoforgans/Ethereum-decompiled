...
function winners(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
    return winners[arg1][arg2]
}

function authorizedCount() payable {
...
function getLottery(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require not stor4
    require arg1
    require lottery[arg1].field_160 <= 2
...
function tickets(uint256 arg1, uint256 arg2) payable {
    require calldata.size - 4 >= 64
...
function cancelOwnership() payable {
...
function unAuthorized(address arg1) payable {
    require calldata.size - 4 >= 32
    require isAuthorized[msg.sender] <= 3
    require isAuthorized[msg.sender] == 1
    require isAuthorized[address(arg1)] <= 3
...
function cancelLottery(uint256 arg1) payable {
    require calldata.size - 4 >= 32
    require not stor4
    require isAuthorized[msg.sender] <= 3
    require isAuthorized[msg.sender] > 0
...
function authorized(address arg1, uint8 arg2) payable {
    require calldata.size - 4 >= 64
    require isAuthorized[msg.sender] <= 3
    require isAuthorized[msg.sender] == 1
    require isAuthorized[address(arg1)] <= 3
