...
function sub_25a0b2e1(?) {
    ...
    while idx < arg1.length:
        ...
        _9 = mem[(32 * idx) + 128]
        mem[(32 * arg1.length) + 128] = 0x4c33fe9400000000000000000000000000000000000000000000000000000000
        mem[(32 * arg1.length) + 132] = msg.sender
        require ext_code.size(address(_9))
        call address(_9).cancel(address rg1) with:
...
function sub_7141f423(?) payable {
    ...
    if not arg6:
        ...
        if arg4.length:
            ...
            call marketAddress.0x1974884f with:
                 gas gas_remaining - 710 wei
                args msg.sender, arg6, Array(len=arg4.length, data=call.data[arg4 + 36 len floor32(arg4.length)], mem[(_msize + 132) + (32 * arg4.length) + floor32(arg4.length) + 196 len (32 * arg4.length) + (32 * mem[_msize + 132]) + -floor32(arg4.length) + 32]), (32 * arg4.length) + 160
            require ext_call.success
    else:
        require arg3 + 1
        idx = 0
