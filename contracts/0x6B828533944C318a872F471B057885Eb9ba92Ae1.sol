...
function _fallback() payable {
    ...
    stor12 = 250
    stor13 = 1518479999
    stor14 = 420696 * 24 * 3600
    stor15 = 1515455999
    stor16 = 420960 * 24 * 3600
    stor17 = 1516751999
    stor18 = 420600 * 24 * 3600
    stor19 = 1514246399
    stor20 = 420768 * 24 * 3600
    stor21 = 1514851199
    require not msg.value
    stor0 = msg.sender
    stor4 = stor5 * 10^stor3
    stor7[address(this.address)] = stor4
    return code.data[673 len 7248]
}
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    require not stor22[address(arg1)]
    require not stor22[address(arg2)]
...
function _fallback() payable {
    ...
    if block.timestamp < stor14:
        if block.timestamp < stor16:
            if block.timestamp < stor18:
                if block.timestamp < stor20:
                    require balanceOf[address(this.address)] - (msg.value * sub_67b0bd3d) > stor6
                    require msg.sender
                    ...
                    if block.timestamp > stor21:
                        ...
                        require balanceOf[address(this.address)] - (msg.value * sub_67b0bd3d) - (50 * msg.value * sub_67b0bd3d / 100) > stor6
                        require msg.sender
            ...
            if block.timestamp > stor17:
                ...
                if block.timestamp < stor18:
                    if block.timestamp < stor20:
                        require balanceOf[address(this.address)] - (msg.value * buyPrice) > stor6
                        require msg.sender
                        ...
                        if block.timestamp > stor21:
                            ...
                            require balanceOf[address(this.address)] - (msg.value * buyPrice) - (50 * msg.value * buyPrice / 100) > stor6
                            require msg.sender
        ...
        if block.timestamp <= stor15:
            if block.timestamp < stor18:
                if block.timestamp < stor20:
                    require balanceOf[address(this.address)] - (msg.value * sub_662f3031) > stor6
                    require msg.sender
                    ...
                    if block.timestamp > stor21:
                        ...
                        require balanceOf[address(this.address)] - (msg.value * sub_662f3031) - (50 * msg.value * sub_662f3031 / 100) > stor6
                        require msg.sender
