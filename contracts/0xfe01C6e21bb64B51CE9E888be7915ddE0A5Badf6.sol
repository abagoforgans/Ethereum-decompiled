...
function _fallback() payable {
    ...
    require code.data[16196 len 32] >= block.timestamp
    require code.data[16228 len 32] >= code.data[16196 len 32]
    require code.data[16260 len 32] > 0
    require code.data[16368 len 20]
    create contract with 0 wei
                    code: code.data[10697 len 5467]
    require create.new_address
    stor0 = address(create.new_address)
    stor1 = code.data[16196 len 32]
    stor2 = code.data[16228 len 32]
    stor4 = code.data[16260 len 32]
    stor3 = code.data[16368 len 20]
    require code.data[16324 len 32] > 0
    stor6 = code.data[16324 len 32]
    address(stor7.field_0) = msg.sender
    require code.data[16292 len 32] <= code.data[16324 len 32]
    address(stor7.field_0) = code.data[16176 len 20]
    require address(stor7.field_0) == msg.sender
    require not uint8(stor7.field_160)
    uint8(stor7.field_160) = 1
    emit Pause()
    return code.data[649 len 10048]
}
