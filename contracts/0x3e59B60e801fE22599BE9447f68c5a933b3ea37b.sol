...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor1 = 0x8d32b0da63e2c3bcf8019c9c5d849d7a9d791e6
    return code.data[110 len 4476]
}
...
function sub_ca4f9697(?) {
    ...
    if not stor10[call.data[arg5 + 36 len floor32(arg5.length)]][mem[ceil32(arg4.length) + ceil32(arg5.length) + floor32(arg5.length) + 160 len arg5.length % 32]]:
        ...
        require ext_call.success
        emit 0x32b34488: sub_75b9c1a7, this.address, msg.sender
    else:
        ...
        require ext_call.success
        emit 0x32b34488: sub_7c2dfe99, this.address, msg.sender
    return 1
}
