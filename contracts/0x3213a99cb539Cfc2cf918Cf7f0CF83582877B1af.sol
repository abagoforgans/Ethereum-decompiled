...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[13815 len 8] > code.data[13783 len 8]
    create contract with 0 wei
                    code: code.data[7915 len 3565], 6000000000 * 10^18
    ...
    call address(stor1.field_0).finishMinting() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    uint64(stor1.field_160) = uint64(code.data[13759 len 32])
    stor2 = uint64(code.data[13791 len 32])
    stor3 = code.data[13823 len 32]
    create contract with 0 wei
                    code: code.data[11480 len 1548], 0xe0831b1687c9fad3447a517f9371e66672505db0
    require create.new_address
    stor13 = address(create.new_address)
    create contract with 0 wei
                    code: code.data[13028 len 731], address(stor1.field_0), 0x4452d6454e777743a5ee233fbe873055008ff528, uint64(uint64(stor1.field_160) + (4320 * 24 * 3600))
    address(stor10.field_8) = address(create.new_address)
    create contract with 0 wei
                    code: code.data[13028 len 731], address(stor1.field_0), 0x4452d6454e777743a5ee233fbe873055008ff528, uint64(uint64(stor1.field_160) + (8640 * 24 * 3600))
    stor11 = address(create.new_address)
    create contract with 0 wei
                    code: code.data[13028 len 731], address(stor1.field_0), 0xd68947892ef4d94cdef7165b109cf6cd3f58a8e8, uint64(uint64(stor1.field_160) + (8640 * 24 * 3600))
    ...
    call address(stor1.field_0).0xa9059cbb with:
         gas gas_remaining - 710 wei
        args address(stor10.field_0), 330000000 * 10^18
    require ext_call.success
    require ext_call.return_data[0]
    require ext_code.size(address(stor1.field_0))
    call address(stor1.field_0).0xa9059cbb with:
         gas gas_remaining - 710 wei
        args stor11, 330000000 * 10^18
    require ext_call.success
    require ext_call.return_data[0]
    require ext_code.size(address(stor1.field_0))
    call address(stor1.field_0).0xa9059cbb with:
         gas gas_remaining - 710 wei
        args stor12, 56666667 * 10^18
    require ext_call.success
    require ext_call.return_data[0]
    return code.data[1894 len 6021]
}
...
function addPrecommitment(address arg1, uint256 arg2, bool arg3) {
    ...
    if not arg3:
        ...
        if vestedTokens[address(arg1)]:
            ...
            create contract with 0 wei
                            code: code.data[5247 len 731], tokenAddress, address(arg1), uint64(startTime + (4320 * 24 * 3600))
            require create.new_address
