...
function sub_274b7bf9(?) {
    require 1 <= stor4[address(arg1)].field_0
    require stor4[address(arg1)].field_0 - 1 < stor4[address(arg1)].field_0
    require stor5[address(arg1)][arg2] < stor4[address(arg1)].field_0
    stor4[address(arg1)][stor5[address(arg1)][arg2]].field_0 = stor4[address(arg1)][stor4[address(arg1)].field_0].field_0
    require stor4[address(arg1)].field_0 - 1 < stor4[address(arg1)].field_0
    stor4[address(arg1)][stor4[address(arg1)].field_0].field_0 = 0
    stor4[address(arg1)].field_0--
    if stor4[address(arg1)].field_0 > stor4[address(arg1)].field_0 - 1:
        idx = stor4[address(arg1)].field_0 - 1
        while stor4[address(arg1)].field_0 > idx:
            stor4[address(arg1)][idx].field_0 = 0
            idx = idx + 1
            continue 
    stor5[address(arg1)][arg2] = 0
    stor5[address(arg1)][stor4[address(arg1)][stor4[address(arg1)].field_0].field_0] = stor5[address(arg1)][arg2]
}

function sub_cef88df4(?) {
    require ext_code.size(stor12)
    call stor12.getVanityOwner(bytes12 arg1) with:
...
function cancelOrder(uint256 arg1) {
    ...
    if orders[arg1].field_512:
        if not orders[arg1].field_1024:
            ...
            if not orders[arg1].field_512:
                ...
                require stor8
                call orders[arg1].field_256 with:
                   value orders[arg1].field_768 * orders[arg1].field_512 / stor8 wei
                     gas 2300 * is_zero(value) wei
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
    ...
    emit 0x652d2191: arg1, msg.sender, orders[arg1].field_512, orders[arg1].field_768, bool(orders[arg1].field_1024), orders[arg1].field_1280
    uint8(stor0.length) = 0
    return 1
}

function sub_b5fd6635(?) payable {
    stor6 = msg.value
    require not uint8(stor0.length)
    uint8(stor0.length) = 1
    if arg2 <= 0:
    ...
    if arg3:
        ...
        call stor13.getAmountForUserMining(address arg1) with:
             gas gas_remaining wei
            args msg.sender
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    orders[stor7].field_1280 = block.timestamp
    stor2.length++
    ...
    if not arg3:
        ...
        if not arg2:
            require stor8
            require 0 / stor8 <= stor6
            stor6 -= 0 / stor8
        else:
            require arg1 * arg2 / arg2 == arg1
            require stor8
            require arg1 * arg2 / stor8 <= stor6
            stor6 -= arg1 * arg2 / stor8
    ...
    emit 0x1ad1a5ae: newId, msg.sender, arg2, arg1, arg3
    newId++
    if stor6 > 0:
        call msg.sender with:
           value stor6 wei
