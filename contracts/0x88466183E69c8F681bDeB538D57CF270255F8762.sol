...
function _fallback() {
    stor0 = code.data[4532 len 20]
    require code.data[4552 len 32]
    require code.data[4584 len 32]
    require code.data[4616 len 32]
    stor7 = code.data[4584 len 32]
    stor8 = code.data[4616 len 32]
    stor9 = code.data[4648 len 32]
    stor6 = code.data[4552 len 32]
    return code.data[171 len 4349]
}
