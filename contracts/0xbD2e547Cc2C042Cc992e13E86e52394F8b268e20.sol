...
function sub_2ee610a5(?) payable {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require 2 * ext_call.return_data[0] * ext_call.return_data[0] < msg.value
    require ext_code.size(sub_ef9cfdbaAddress)
    call sub_ef9cfdbaAddress.buy(address arg1, address arg2) with:
       value 2 * ext_call.return_data[0] * ext_call.return_data[0] wei
         gas gas_remaining wei
        args address(arg1), 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    call sub_d141c39bAddress.buy(address arg1, address arg2) with:
       value msg.value - (2 * ext_call.return_data[0] * ext_call.return_data[0]) wei
         gas gas_remaining wei
