...
function _fallback() {
    stor0 = code.data[2466 len 20]
    require code.data[2466 len 20]
    stor9 = code.data[2530 len 20]
    require ext_code.size(code.data[2530 len 20])
    call code.data[2530 len 20].isToken() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require ext_call.return_data[0]
    require code.data[2486 len 32]
    stor7 = code.data[2486 len 32]
    stor2 = code.data[2550 len 32]
    return code.data[309 len 2145]
}
