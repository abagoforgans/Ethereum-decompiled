...
function _fallback() payable {
    ...
    stor1 = msg.sender
    address(stor6.field_8) = code.data[6465 len 20]
    stor1 = msg.sender
    stor0 = code.data[6485 len 32]
    stor3[address(msg.sender)] = code.data[6485 len 32]
    return code.data[455 len 5998]
}
...
const TOKENS_TOTAL = 3000000000 * 10^18
...
const TOKENS_HARD_CAP = 1000000000 * 10^18
...
function burnFrom(address arg1, uint256 arg2) {
    ...
    require allowance[address(arg1)][0] - arg2 <= allowance[address(arg1)][0]
...
function _fallback() payable {
    ...
    require (msg.value * tokensPerKEther / 1000) + totalSupply <= 1000000000 * 10^18
