...
function finalizeCrowdsale() payable {
    ...
    if uint8(var33007) >= 0xc331051700000000000000000000000000000000000000000000000000000000:
        ...
        delegate 0xa877246afb851e5d0142821ad0f07f7e1d2fd889.mem[var61002 len 4] with:
             gas gas_remaining - 710 wei
        ...
        require ext_code.size(0xa877246afb851e5d0142821ad0f07f7e1d2fd889)
        delegate 0xa877246afb851e5d0142821ad0f07f7e1d2fd889.mem[var57002 len 4] with:
             gas gas_remaining - 710 wei
