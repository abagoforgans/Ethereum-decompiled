...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor2 = code.data[11873 len 20]
    stor5 = code.data[11905 len 20]
    if code.data[11937 len 20]:
        stor7[code.data[11937 len 20]].field_0 = 0
        stor7[address(code.data[11925 len 32])].field_256 = code.data[11988 len 1]
        stor7[address(code.data[11925 len 32])].field_264 = 0
        stor7[address(code.data[11925 len 32])].field_272 = 1
        stor7[address(code.data[11925 len 32])].field_280 = 1
        stor6.length++
        if not stor6.length <= stor6.length + 1:
            ...
            while stor6.length > idx:
                ...
                idx = idx + 1
                continue 
        address(stor6[stor6.length]) = code.data[11937 len 20]
        stor8 = uint8(stor8 + code.data[11957 len 32])
    return code.data[1366 len 10495]
}
...
function sell(address arg1, uint256 arg2, uint256 arg3) {
    ...
    if reserves[address(arg1)].field_264:
        ...
        call formulaAddress.calculateSaleReturn(uint256 rg1, uint256 rg2, uint16 rg3, uint256 rg4) with:
            ...
            args 0, ext_call.return_data[28 len 4], ext_call.return_data[0], reserves[address(arg1)].field_256, arg2
    require ext_call.success
    if not reserves[address(arg1)].field_264:
        require ext_code.size(arg1)
        call arg1.0x70a08231 with:
             gas gas_remaining - 710 wei
            args this.address
...
function change(address arg1, address arg2, uint256 arg3, uint256 arg4) {
    ...
    if arg2 == tokenAddress:
        ...
        if arg1 == tokenAddress:
            ...
            require ext_call.success
            if not reserves[address(arg2)].field_264:
                require ext_code.size(arg2)
                call arg2.0x70a08231 with:
                     gas gas_remaining - 710 wei
                    args this.address
