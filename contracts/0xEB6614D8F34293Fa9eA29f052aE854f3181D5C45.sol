...
function merchantFundAddress() {
    return merchantFundAddress
}
...
function changeFundAddress(address arg1) {
    require msg.sender == merchantAccount
    if ext_code.size(arg1):
        revert with 0, 'sorry humans only'
    merchantFundAddress = arg1
}
...
function withdrawAllTokensToExchange(address arg1, address arg2, uint256 arg3) {
    if merchantAccount != msg.sender:
        require stor2[msg.sender]
    require not stor0
    require arg1
