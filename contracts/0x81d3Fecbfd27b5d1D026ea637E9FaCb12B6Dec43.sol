...
function _fallback() payable {
    ...
    stor5 = code.data[7840 len 20]
    if code.data[7860 len 32]:
        stor1 = code.data[7860 len 32]
    else:
        stor1 = 1
    stor2 = code.data[7892 len 32]
    emit ChangeOfRules(stor1, stor2, stor5);
    return code.data[515 len 7313]
}
