...
function _fallback() payable {
    ...
    stor21 = 0x650887b33bfa423240ed7bc4bd26c66075e3beaf
    require not msg.value
    stor17 = 10^10
    stor22[address(msg.sender)] = 10^10
    uint8(stor6.length) = 44
    stor6.length.field_8 = 'ZIBER Crowdsale Tokens' / 256
    idx = 0
    while stor6.length + 31 / 32 > idx:
        stor6[idx].field_0 = 0
        idx = idx + 1
        continue 
    uint8(stor7.length) = 6
...
function withdraw() {
    ...
    if stor1[address(msg.sender)]:
        ...
        call tokenAddress.0xa9059cbb with:
             gas gas_remaining - 710 wei
            args stor21, stor9 * balances[address(msg.sender)] / 100
        require ext_call.success
