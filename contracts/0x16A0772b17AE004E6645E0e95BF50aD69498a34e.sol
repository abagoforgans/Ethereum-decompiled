...
function _fallback() {
    ...
    if not stor3.length > stor3.length + 1:
        address(stor3[stor3.length]) = 0x5117afb03e83d180d0059a1ad733f954220d2734
        stor3.length++
        address(stor3[stor3.length]) = 0x4f9049886d8087c7549224383075ffbb3df2b7a0
        stor3.length++
        address(stor3[stor3.length]) = 0x4e63227fcff602b3fa9e6f4e86b33194f04236b1
        stor3.length++
        address(stor3[stor3.length]) = 0x5c48a46744ca4ddc427829ca0e2d1de77db343e4
        stor3.length++
    else:
        idx = stor3.length + 1
                ...
                if not stor3.length > stor3.length + 1:
                    ...
                    if not stor3.length <= stor3.length + 1:
                        ...
                        while stor3.length > idx:
                            ...
                            idx = idx + 1
                            continue 
    address(stor3[stor3.length]) = 0xac0a13cdab06d9a17ea9cf90e7766610128f487f
    stor2[0x5117afb03e83d180d0059a1ad733f954220d2734] = 1
    stor2[0x4f9049886d8087c7549224383075ffbb3df2b7a0] = 1
    stor2[0x4e63227fcff602b3fa9e6f4e86b33194f04236b1] = 1
    stor2[0x5c48a46744ca4ddc427829ca0e2d1de77db343e4] = 1
    stor2[0xac0a13cdab06d9a17ea9cf90e7766610128f487f] = 1
    stor4 = 3
    return code.data[668 len 5705]
}
