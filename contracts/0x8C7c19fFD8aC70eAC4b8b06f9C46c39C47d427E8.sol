...
function _fallback() payable {
    ...
    stor3 = 12 * 10^6
    stor4 = 150 * 10^18
    require code.data[15923 len 32] >= block.number
    require code.data[15955 len 32] >= code.data[15923 len 32]
    require code.data[16127 len 20]
    stor6 = code.data[15923 len 32]
    stor7 = code.data[15955 len 32]
    stor9 = 350
    stor13 = 10^18
    stor8 = code.data[16127 len 20]
    require code.data[15923 len 32] < code.data[15987 len 32]
    require code.data[15987 len 32] < code.data[16019 len 32]
    require code.data[16019 len 32] < code.data[15955 len 32]
    stor15 = code.data[15987 len 32]
    stor16 = code.data[16019 len 32]
    create contract with 0 wei
                    code: code.data[6915 len 9008], code.data[16051 len 32], code.data[16083 len 32]
    require create.new_address
    stor5 = address(create.new_address)
    require ext_code.size(address(create.new_address))
    call address(create.new_address).0x40c10f19 with:
         gas gas_remaining - 710 wei
        args code.data[16127 len 20], 8950000 * 10^18
    require ext_call.success
    require ext_code.size(stor5)
    call stor5.mintTimelocked(address rg1, uint256 rg2, uint256 rg3) with:
         gas gas_remaining - 710 wei
        args address(code.data[16115 len 32]), 5000000 * 10^18, 421238 * 3600
    require ext_call.success
    ...
    call stor5.mintVested(address rg1, uint256 rg2, uint256 rg3, uint256 rg4) with:
         gas gas_remaining - 710 wei
        args address(code.data[16115 len 32]), 80000000 * 10^18, 421238 * 3600, 175200 * 24 * 3600
    require ext_call.success
    ...
    require 6050000 * 10^18 == -ext_call.return_data[0] + 100000000 * 10^18
...
const sub_38a25caf(?) = 6050000 * 10^18
...
const sub_77f34fe3(?) = 80000000 * 10^18

const sub_86eb5330(?) = 150 * 10^18

const sub_af6c0d0e(?) = 420

const sub_ce0d07ca(?) = 490

const sub_f0a11e1d(?) = 5000000 * 10^18

const RESERVED_SUPPLY = 8950000 * 10^18
...
function buyTokens(address arg1) payable {
    ...
    if block.number <= sub_02587546:
        if msg.value:
            require msg.value
            require 490 * msg.value / msg.value == 490
        require (490 * msg.value) + soldTokens >= soldTokens
        require (490 * msg.value) + soldTokens <= tokenCap
    else:
        if block.number <= sub_48a0bd05:
            if msg.value:
                require msg.value
                require 420 * msg.value / msg.value == 420
            require (420 * msg.value) + soldTokens >= soldTokens
            require (420 * msg.value) + soldTokens <= tokenCap
        else:
            if msg.value:
                require msg.value
    ...
    if block.number <= sub_02587546:
        if msg.value:
            ...
            require 490 * msg.value / msg.value == 490
        require (490 * msg.value) + soldTokens >= soldTokens
        soldTokens += 490 * msg.value
        require ext_code.size(tokenAddress)
        if block.number > sub_02587546:
            call tokenAddress.0x40c10f19 with:
                 gas gas_remaining - 710 wei
                args address(arg1), 490 * msg.value
        else:
            call tokenAddress.mintLocked(address rg1, uint256 rg2) with:
                 gas gas_remaining - 710 wei
                args address(arg1), 490 * msg.value
        require ext_call.success
        emit LogTokenPurchase((490 * msg.value), msg.sender, arg1, msg.value);
    else:
        if block.number <= sub_48a0bd05:
            if msg.value:
                require msg.value
            ...
            if block.number > sub_02587546:
                ...
                call tokenAddress.mintLocked(address rg1, uint256 rg2) with:
                    ...
                    args address(arg1), 420 * msg.value
            require ext_call.success
            emit LogTokenPurchase((420 * msg.value), msg.sender, arg1, msg.value);
        else:
            if msg.value:
                require msg.value
                require rate * msg.value / msg.value == rate
...
function _fallback() payable {
    ...
    if block.number <= sub_02587546:
        ...
        if block.number > sub_02587546:
            call tokenAddress.0x40c10f19 with:
                 gas gas_remaining - 710 wei
                args msg.sender, 490 * msg.value
        else:
            call tokenAddress.mintLocked(address rg1, uint256 rg2) with:
                 gas gas_remaining - 710 wei
                args msg.sender, 490 * msg.value
        require ext_call.success
        emit LogTokenPurchase((490 * msg.value), msg.sender, msg.sender, msg.value);
    else:
        if block.number <= sub_48a0bd05:
            if msg.value:
                require msg.value
            ...
            if block.number > sub_02587546:
                ...
                call tokenAddress.mintLocked(address rg1, uint256 rg2) with:
                    ...
                    args msg.sender, 420 * msg.value
            require ext_call.success
            emit LogTokenPurchase((420 * msg.value), msg.sender, msg.sender, msg.value);
        else:
            if msg.value:
                require msg.value
                require rate * msg.value / msg.value == rate
