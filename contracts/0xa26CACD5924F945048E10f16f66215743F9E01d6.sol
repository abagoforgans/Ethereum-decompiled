...
function sub_74937837(?) payable {
    ...
    sub_cfb3ec31 = 0xc5d2460186f7233c927e7db2dcc703c0e500b653ca82273b7bfad8045d85a470
    sub_d8a6203b = sha3(1)
    sub_04b52931 = sha3(49)
    sub_6335ec5b = sha3(arg2, arg1)
    sub_9e7bd827 = sha3(arg3, arg1)
    sub_c57f10c7 = sha3(arg4[all])
}
...
function open(uint256 arg1, uint256 arg2) payable {
    ...
    if msg.sender == address(stor1.length):
        ...
        sub_6ba04322 = sha3(msg.sender, 49)
