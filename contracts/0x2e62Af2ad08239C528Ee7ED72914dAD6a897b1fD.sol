...
function _fallback() payable {
    ...
    mem[96 len -7765] = code.data[8637 len -7765]
    mem[64] = -7669
    stor0 = msg.sender
    if mem[mem[96] + 96] > 0:
        ...
        while stor1.length + 31 / 32 > idx:
            ...
            continue 
    if mem[mem[128] + 96] > 0:
        stor2[].field_0 = Array(len=mem[mem[128] + 96], data=mem[mem[128] + 128 len mem[mem[128] + 96]])
    else:
        bool(stor2.length) = 0
    ...
    if mem[204 len 20]:
        address(stor3.field_8) = mem[204 len 20]
    else:
        address(stor3.field_8) = 0x634da488e1e122a9f2ed83e91ccb6db3414e3984
    if mem[224] > 0:
        stor4 = mem[224] * 10^uint8(stor3.field_0)
        stor6 = mem[224] * 10^uint8(stor3.field_0)
        stor5 = 0
        stor11[stor0] = mem[224] * 10^uint8(stor3.field_0)
    else:
        stor4 = 500 * 10^6 * 10^uint8(stor3.field_0)
        stor6 = 500 * 10^6 * 10^uint8(stor3.field_0)
        stor5 = 0
        stor11[stor0] = 500 * 10^6 * 10^uint8(stor3.field_0)
    if mem[256] > 0:
        stor15 = mem[256]
    else:
