...
function sub_10a624b0(?) {
    ...
    u = arg1
    while uint8(idx) < 3:
        require ext_code.size(0xd52ee9d7eb96766a9d5013e864d15a26518ff4ed)
        delegate 0xd52ee9d7eb96766a9d5013e864d15a26518ff4ed.0x5beb53cd with:
        ...
        while v > 0:
            ...
            require return_data.size >= 32
            require ext_code.size(0xd52ee9d7eb96766a9d5013e864d15a26518ff4ed)
            delegate 0xd52ee9d7eb96766a9d5013e864d15a26518ff4ed.0x33fbdfb7 with:
                 gas gas_remaining wei
