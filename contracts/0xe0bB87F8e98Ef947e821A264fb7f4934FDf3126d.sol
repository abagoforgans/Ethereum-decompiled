...
const _fallback = code.data[18 len 964]
...
function unregister(bytes32 arg1) payable {
    if stor0[arg1].field_512:
        if msg.sender == stor0[arg1].field_0:
...
function resolve(bytes32 arg1) payable {
    if stor0[arg1].field_256:
        ...
        idx = 160
        s = 0
        while stor0[arg1].field_256 + 128 > idx:
            mem[idx + 32] = stor0[arg1][s + 1].field_256
            idx = idx + 32
            s = s + 1
            continue 
    return stor0[arg1].field_0, Array(len=stor0[arg1].field_256, data=mem[160 len stor0[arg1].field_256])
}
