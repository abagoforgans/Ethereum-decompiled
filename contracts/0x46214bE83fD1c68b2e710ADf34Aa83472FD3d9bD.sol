...
function sub_9e991db2(?) {
    ...
    require sub_fac9c51f[arg3] == arg2
    if arg3 > 0:
        if sub_b3557522[arg6][arg7] == arg3:
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    signer = erecover(sha3(arg2), arg5 << 248, arg6, arg7) 
    if not erecover.result:
        revert with ext_call.return_data[0 len return_data.size]
    require address(signer) == address(ext_call.return_data[0])
    require sub_78669280[arg3]
    require sub_78669280[arg3] != arg1
    stor9.length++
    uint8(stor9[stor9.length]) = uint8(arg4)
    require stor9.length == uint32(stor9.length)
    emit 0xa10f25ef: address(arg1), stor9.length
    sub_fffb1479[stor9.length] = arg1
    sub_5501d42d[arg3]++
    sub_5501d42d[arg3][sub_5501d42d[arg3]] = stor9.length
    sub_3108e4d7[stor9.length] = arg3
    sub_b3557522[arg6][arg7] = arg3
    return stor9.length
}

function sub_e43d0775(?) {
    ...
    require return_data.size >= 32
    require arg1 != ext_call.return_data[12 len 20]
    mem[ceil32(arg3.length) + 160] = arg5
    _11 = sha3(mem[ceil32(arg3.length) + 160 len 0, 64])
    if sub_46cb96fa[mem[ceil32(arg3.length) + 160 len 0, 64]]:
        revert with 0, 'Signature Already Used'
    require ext_code.size(stor3)
    staticcall stor3.0x96b5d992 with:
            gas gas_remaining wei
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[ceil32(arg3.length) + 416] = arg6
    signer = erecover(sha3(arg2), arg4 << 248, arg5, arg6) 
    if not erecover.result:
        revert with ext_call.return_data[0 len return_data.size]
    require address(signer) == address(ext_call.return_data[0])
    mem[ceil32(arg3.length) + 416 len arg3.length] = arg3[all]
    mem[ceil32(arg3.length) + arg3.length + 416] = 0
    sub_990581b6.length++
    uint256(sub_990581b6[sub_990581b6.length][]) = Array(len=arg3.length, data=arg3[all])
    require sub_990581b6.length == uint32(sub_990581b6.length)
    mem[(2 * ceil32(arg3.length)) + 416] = arg1
    mem[(2 * ceil32(arg3.length)) + 448] = sub_990581b6.length
    emit 0xe819187a: mem[(2 * ceil32(arg3.length)) + 416 len ceil32(arg3.length) + 64]
    sub_78669280[stor4.length] = arg1
    sub_fac9c51f[stor4.length] = arg2
    mem[(2 * ceil32(arg3.length)) + 420] = arg2
    mem[(2 * ceil32(arg3.length)) + 452] = sub_990581b6.length
    require ext_code.size(stor3)
    call stor3.0x3ffe60c0 with:
         gas gas_remaining wei
        args mem[(2 * ceil32(arg3.length)) + 420 len ceil32(arg3.length) + 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    sub_46cb96fa[_11] = arg2
    mem[(2 * ceil32(arg3.length)) + 416] = sub_990581b6.length
    return memory
      from (2 * ceil32(arg3.length)) + 416
