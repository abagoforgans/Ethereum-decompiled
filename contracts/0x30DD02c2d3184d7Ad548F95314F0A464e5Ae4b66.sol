...
uint32 stor13;
address stor13; offset 96
uint256 stor13; offset 64
...
function supportsInterface(bytes4 arg1) {
    if Mask(32, 224, arg1) != Mask(32, 224, uint32(stor13.field_0)):
        if Mask(32, 224, arg1) != Mask(224, 0, stor13.field_32) << 224:
            if Mask(32, 224, arg1) != Mask(192, 0, stor13.field_64) << 224:
                if Mask(32, 224, arg1) != address(stor13.field_96) << 224:
                    return 0
    return 1
}
...
function spawnPassTo(uint256 arg1, uint256[] arg2, uint8 arg3, bytes32 arg4, bytes32 arg5, address arg6) {
    ...
    if arg1 > block.timestamp:
        ...
        mem[64] = (32 * arg2.length) + floor32((32 * arg2.length) + 115) + 160
        if not (32 * arg2.length) + 84:
            ...
            while idx < arg2.length:
                require idx < mem[96]
                require (32 * idx) + 115 < mem[(32 * arg2.length) + 128]
                mem[(32 * arg2.length) + (32 * idx) + 275 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('mem', ('range', ('add', 128, ('mask_shl', 251, 0, 5, ('var', 0))), 32))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('mem', ('range', ('add', 128, ('mask_shl', 251, 0, 5, ('var', 0))), 32))), 0) - 256
                s = 1
                while s < 32:
                    require idx < mem[96]
                    _381 = mem[(32 * idx) + 128]
                    ...
                    require (32 * idx) + -s + 115 < mem[(32 * arg2.length) + 128]
                    mem[(32 * arg2.length) + (32 * idx) + -s + 275 len 8] = Mask(8, -(('mask_shl', 8, 8, 237, ('var', '_381')), 0) + 256, 0) << (('mask_shl', 8, 8, 237, ('var', '_381')), 0) - 256
                    s = s + 1
                    continue 
                s = 32
                idx = idx + 1
            ...
            _357 = sha3(mem[mem[64] len _243 + _242 - mem[64]])
            _378 = mem[64]
            mem[64] = mem[64] + 32
            mem[_378 + 32] = _357
            mem[_378 + 64] = arg3
            mem[_378 + 96] = arg4
            mem[_378 + 128] = arg5
            signer = erecover(_357, arg3 << 248, arg4, arg5) 
            mem[_378] = signer
        else:
            mem[(32 * arg2.length) + 160 len 32 * (32 * arg2.length) + 84] = code.data[15380 len 32 * (32 * arg2.length) + 84]
            idx = 0
            while idx < 32:
                require idx < (32 * arg2.length) + 84
                mem[(32 * arg2.length) + idx + 160 len 8] = Mask(8, -(0, 0) + 256, 0) << (0, 0) - 256
            ...
            while idx < arg2.length:
                ...
                while s < 32:
                    ...
                    mem[(32 * idx) + 128] = mem[(32 * idx) + 128 len 31]
                    require (32 * idx) + -s + 115 < mem[(32 * arg2.length) + 128]
                    mem[(32 * arg2.length) + (32 * idx) + -s + 275 len 8] = Mask(8, -(('mask_shl', 8, 8, 237, ('var', '_386')), 0) + 256, 0) << (('mask_shl', 8, 8, 237, ('var', '_386')), 0) - 256
                    s = s + 1
                    continue 
                s = 32
                idx = idx + 1
            ...
            mem[mem[64] len floor32(mem[(32 * arg2.length) + 128])] = mem[(32 * arg2.length) + 160 len floor32(mem[(32 * arg2.length) + 128])]
            mem[mem[64] + floor32(mem[(32 * arg2.length) + 128]) + -(mem[(32 * arg2.length) + 128] % 32) + 32 len mem[(32 * arg2.length) + 128] % 32] = mem[(32 * arg2.length) + floor32(mem[(32 * arg2.length) + 128]) + -(mem[(32 * arg2.length) + 128] % 32) + 192 len mem[(32 * arg2.length) + 128] % 32]
            _363 = sha3(mem[mem[64] len _246 + _245 - mem[64]])
            _383 = mem[64]
            mem[64] = mem[64] + 32
            mem[_383 + 32] = _363
            mem[_383 + 64] = arg3
            mem[_383 + 96] = arg4
            mem[_383 + 128] = arg5
            signer = erecover(_363, arg3 << 248, arg4, arg5) 
            mem[_383] = signer
    else:
        require not arg1
        mem[(32 * arg2.length) + 128] = (32 * arg2.length) + 84
        ...
        if not (32 * arg2.length) + 84:
            ...
            while idx < arg2.length:
                ...
                while s < 32:
                    ...
                    mem[(32 * idx) + 128] = mem[(32 * idx) + 128 len 31]
                    require (32 * idx) + -s + 115 < mem[(32 * arg2.length) + 128]
                    mem[(32 * arg2.length) + (32 * idx) + -s + 275 len 8] = Mask(8, -(('mask_shl', 8, 8, 237, ('var', '_391')), 0) + 256, 0) << (('mask_shl', 8, 8, 237, ('var', '_391')), 0) - 256
                    s = s + 1
                    continue 
                s = 32
                idx = idx + 1
                continue 
            _248 = mem[64]
            _249 = mem[(32 * arg2.length) + 128]
            mem[mem[64] len floor32(mem[(32 * arg2.length) + 128])] = mem[(32 * arg2.length) + 160 len floor32(mem[(32 * arg2.length) + 128])]
            mem[mem[64] + floor32(mem[(32 * arg2.length) + 128]) + -(mem[(32 * arg2.length) + 128] % 32) + 32 len mem[(32 * arg2.length) + 128] % 32] = mem[(32 * arg2.length) + floor32(mem[(32 * arg2.length) + 128]) + -(mem[(32 * arg2.length) + 128] % 32) + 192 len mem[(32 * arg2.length) + 128] % 32]
            _369 = sha3(mem[mem[64] len _249 + _248 - mem[64]])
            _388 = mem[64]
            mem[64] = mem[64] + 32
            mem[_388 + 32] = _369
            mem[_388 + 64] = arg3
            mem[_388 + 96] = arg4
            mem[_388 + 128] = arg5
            signer = erecover(_369, arg3 << 248, arg4, arg5) 
            mem[_388] = signer
        else:
            mem[(32 * arg2.length) + 160 len 32 * (32 * arg2.length) + 84] = code.data[15380 len 32 * (32 * arg2.length) + 84]
            idx = 0
            ...
            while idx < arg2.length:
                ...
                while s < 32:
                    ...
                    mem[(32 * idx) + 128] = mem[(32 * idx) + 128 len 31]
                    require (32 * idx) + -s + 115 < mem[(32 * arg2.length) + 128]
                    mem[(32 * arg2.length) + (32 * idx) + -s + 275 len 8] = Mask(8, -(('mask_shl', 8, 8, 237, ('var', '_396')), 0) + 256, 0) << (('mask_shl', 8, 8, 237, ('var', '_396')), 0) - 256
                    s = s + 1
                    continue 
                s = 32
                idx = idx + 1
                continue 
            _251 = mem[64]
            _252 = mem[(32 * arg2.length) + 128]
            mem[mem[64] len floor32(mem[(32 * arg2.length) + 128])] = mem[(32 * arg2.length) + 160 len floor32(mem[(32 * arg2.length) + 128])]
            mem[mem[64] + floor32(mem[(32 * arg2.length) + 128]) + -(mem[(32 * arg2.length) + 128] % 32) + 32 len mem[(32 * arg2.length) + 128] % 32] = mem[(32 * arg2.length) + floor32(mem[(32 * arg2.length) + 128]) + -(mem[(32 * arg2.length) + 128] % 32) + 192 len mem[(32 * arg2.length) + 128] % 32]
            _375 = sha3(mem[mem[64] len _252 + _251 - mem[64]])
            _393 = mem[64]
            mem[64] = mem[64] + 32
            mem[_393 + 32] = _375
            mem[_393 + 64] = arg3
            mem[_393 + 96] = arg4
            mem[_393 + 128] = arg5
            signer = erecover(_375, arg3 << 248, arg4, arg5) 
            mem[_393] = signer
    if not erecover.result:
        revert with ext_call.return_data[0 len return_data.size]
    require address(signer) == sub_7e537486Address
    require not stor2[arg5]
    idx = 0
    while idx < mem[96]:
        mem[32] = 0
        require idx < mem[96]
...
function passTo(uint256 arg1, uint256[] arg2, uint8 arg3, bytes32 arg4, bytes32 arg5, address arg6) {
    ...
    if arg1 > block.timestamp:
        ...
        if not (2 * arg2.length) + 84:
            ...
            mem[(32 * arg2.length) + 160 len 32 * (2 * arg2.length) + 84] = code.data[15380 len 32 * (2 * arg2.length) + 84]
            idx = 0
            while idx < 32:
                require idx < (2 * arg2.length) + 84
                mem[(32 * arg2.length) + idx + 160 len 8] = Mask(8, -(0, 0) + 256, 0) << (0, 0) - 256
