...
function _fallback() payable {
    stor8 = 0x529ae9b61c174a3e005eda67eb755342558a1c3f
    stor9 = 0x41f1dcb0d41bf1e143461faf42c577a9219da415
    stor10 = stor8
    stor11 = stor9
...
function UsdToEtherConvert(uint256 arg1) {
    return (arg1 * stor12)
}
...
function setUsdToEtherExchangeRate(uint256 arg1) {
    require msg.sender == stor6
    stor12 = arg1
}

function UsdToTokenConvert(address arg1, uint256 arg2) {
    return (arg2 * exchangeRates[address(arg1)])
}

function setTokenExchangeRate(address arg1, uint256 arg2) {
    require msg.sender == stor6
...
function payday(uint256 arg1) {
    ...
    call msg.sender with:
       value uint256(stor0[stor2[arg1]].field_1536) / 7680 * uint256(stor0[stor2[arg1]].field_1024) / 100 * stor12 wei
    ...
    call stor10.0xa9059cbb with:
         gas gas_remaining - 710 wei
        args address(stor0[stor2[arg1]].field_512), uint256(stor0[stor2[arg1]].field_1536) / 7680 * uint256(stor0[stor2[arg1]].field_1280) / 100 * exchangeRates[stor8]
    require ext_call.success
    require employeeInfoById[arg1] < stor0.length
    require ext_code.size(stor11)
    call stor11.0xa9059cbb with:
         gas gas_remaining - 710 wei
        args address(stor0[stor2[arg1]].field_512), uint256(stor0[stor2[arg1]].field_1536) / 7680 * uint256(stor0[stor2[arg1]].field_768) / 100
    require ext_call.success
}
...
function getEmployeeInfoByName(string arg1) {
    ...
    mem[mem[64] + 32] = 160
    mem[_79 + 160] = stor[(10 * uint256(stor[_41])) + ('name', 'stor0', 0) + 1].length
    mem[_79 + 192 len ceil32(stor[(10 * uint256(stor[_41])) + ('name', 'stor0', 0) + 1].length)] = mem[ceil32(arg1.length) + 192 len ceil32(stor[(10 * uint256(stor[_41])) + ('name', 'stor0', 0) + 1].length)]
    if not stor[(10 * uint256(stor[_41])) + ('name', 'stor0', 0) + 1].length % 32:
        return memory
          from mem[64]
           len stor[(10 * uint256(stor[_41])) + ('name', 'stor0', 0) + 1].length + _79 + -mem[64] + 192
    mem[floor32(stor[(10 * uint256(stor[_41])) + ('name', 'stor0', 0) + 1].length) + _79 + 192] = mem[floor32(stor[(10 * uint256(stor[_41])) + ('name', 'stor0', 0) + 1].length) + _79 + -stor[(10 * uint256(stor[_41])) + ('name', 'stor0', 0) + 1].length % 32 + 224 len stor[(10 * uint256(stor[_41])) + ('name', 'stor0', 0) + 1].length % 32]
    return memory
      from mem[64]
       len floor32(stor[(10 * uint256(stor[_41])) + ('name', 'stor0', 0) + 1].length) + _79 + -mem[64] + 224
}
    ...
    if stor12:
        ...
        if exchangeRates[stor8]:
            if s * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length / 30:
                return (ext_call.return_data[0] + (eth.balance(this.address) / stor12) + (ext_call.return_data[0] / exchangeRates[stor8]) / s * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length * stor0.length / 30)
    revert
}
