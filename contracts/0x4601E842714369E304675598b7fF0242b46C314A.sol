...
function sub_f2460f78(?) {
    return sub_f2460f78Address
}

function killContract() {
    if sub_f2460f78Address != msg.sender:
        revert with 0, 'owner only'
    selfdestruct(sub_f2460f78Address)
}
...
function sub_88a0c3a0(?) {
    ...
    mem[64] = (32 * arg3) + 128
    if arg3:
        mem[128 len 32 * arg3] = code.data[6067 len 32 * arg3]
    s = 0
    idx = arg2
