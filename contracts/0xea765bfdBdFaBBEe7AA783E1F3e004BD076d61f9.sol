...
function sub_68215003(?) payable {
    mem[128 len arg1.length] = arg1[all]
    mem[ceil32(arg1.length) + 128] = arg2.length
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 384] = '://twitter.com/'
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 416] = arg1.length + 16
    idx = 0
    s = 0
    while idx < 15:
        require idx < 15
        require s < arg1.length + 16
        mem[ceil32(arg1.length) + ceil32(arg2.length) + s + 448 len 8] = Mask(8, -(('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 384, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1'))))), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg2'))))), ('var', 0)), 32))), 0) + 256, 0) << (('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 384, ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1'))))), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg2'))))), ('var', 0)), 32))), 0) - 256
        idx = idx + 1
        s = s + 1
        continue 
    idx = 0
    ...
    while idx < arg1.length:
        ...
        require s < arg1.length + 16
        mem[ceil32(arg1.length) + ceil32(arg2.length) + s + 448 len 8] = Mask(8, -(('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 128, ('var', 0)), 32))), 0) + 256, 0) << (('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 128, ('var', 0)), 32))), 0) - 256
        idx = idx + 1
        s = s + 1
        continue 
    if not arg1.length + 16 % 32:
        return 32, arg1.length + 16, mem[ceil32(arg1.length) + ceil32(arg2.length) + 448 len arg1.length + 15], 0
    mem[floor32(arg1.length + 16) + ceil32(arg1.length) + ceil32(arg2.length) + (32 * arg1.length + 16) + 512] = mem[floor32(arg1.length + 16) + ceil32(arg1.length) + ceil32(arg2.length) + (32 * arg1.length + 16) + -(arg1.length + 16 % 32) + 544 len arg1.length + 16 % 32]
    return Array(len=arg1.length + 16, data=Mask(8 * arg1.length + 16, -(8 * arg1.length + 16) + 256, mem[ceil32(arg1.length) + ceil32(arg2.length) + 448 len arg1.length + 15], 0) << (8 * arg1.length + 16) - 256, mem[ceil32(arg1.length) + ceil32(arg2.length) + (32 * arg1.length + 16) + arg1.length + 528 len floor32(arg1.length + 16) + -arg1.length + 16]), 
}
