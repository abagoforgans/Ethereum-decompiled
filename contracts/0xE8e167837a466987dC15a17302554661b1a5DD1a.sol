...
function _fallback() payable {
    ...
    stor0 = code.data[1151 len 32]
    stor2 = code.data[1183 len 32] or Mask(96, 160, stor2)
    stor3 = code.data[1215 len 32] or Mask(96, 160, stor3)
    stor1 = code.data[1247 len 32] or Mask(96, 160, stor1)
    return code.data[110 len 1041]
}
...
function sub_a4ab866a(?) payable {
    if arg1 > sub_d1e93151:
        ...
        call sub_e0fe543bAddress.approve(address rg1, uint256 rg2) with:
             gas gas_remaining - 25050 wei
            args sub_e978b932Address, arg1 - sub_d1e93151
        call sub_e978b932Address.0xf09ea2a6 with:
             gas gas_remaining - 25050 wei
            args 0, 0, sub_e0fe543bAddress, (10 * arg1) - (10 * sub_d1e93151), sub_6379be1fAddress
}
