...
uint8 sub_f5ba03dd; offset 160
uint8 isMinting; offset 168
...
function buyTokens(address arg1) payable {
    ...
    if not sub_f5ba03dd:
        ...
        if msg.value > 0:
            if not msg.value:
                ...
                call walletAddress.0x1b814f02 with:
                     gas gas_remaining wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            else:
                ...
                if tokensSold + (msg.value * rate) <= crowdsaleCap:
                    ...
                    call walletAddress with:
                       value crowdsaleCap - tokensSold / rate wei
                         gas 2300 * is_zero(value) wei
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require ext_code.size(walletAddress)
    ...
    if ext_call.return_data[0] > 0:
        if not ext_call.return_data[0]:
            ...
            require tokensSold + (ext_call.return_data[0] * sub_08095329 / 1000) >= tokensSold
            if tokensSold + (ext_call.return_data[0] * sub_08095329 / 1000) <= crowdsaleCap:
                require sub_fffae044 + ext_call.return_data[0] >= sub_fffae044
                sub_fffae044 += ext_call.return_data[0]
                require tokensSold + (ext_call.return_data[0] * sub_08095329 / 1000) >= tokensSold
                tokensSold += ext_call.return_data[0] * sub_08095329 / 1000
                require ext_code.size(sub_60e6a440Address)
                if isMinting:
                    call sub_60e6a440Address.0x40c10f19 with:
                         gas gas_remaining wei
                        args address(arg1), ext_call.return_data[0] * sub_08095329 / 1000
                else:
                    call sub_60e6a440Address.0xa9059cbb with:
                         gas gas_remaining wei
                        args address(arg1), ext_call.return_data[0] * sub_08095329 / 1000
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                emit TokenPurchaseWithStar(ext_call.return_data[0], ext_call.return_data[0] * sub_08095329 / 1000, msg.sender, arg1);
                require ext_code.size(starTokenAddress)
                call starTokenAddress.0x23b872dd with:
                     gas gas_remaining wei
                    args address(arg1), walletAddress, ext_call.return_data[0]
                ...
                require sub_fffae044 + (crowdsaleCap - tokensSold / sub_08095329 / 1000) >= sub_fffae044
                sub_fffae044 += crowdsaleCap - tokensSold / sub_08095329 / 1000
                require crowdsaleCap >= tokensSold
                tokensSold = crowdsaleCap
                require ext_code.size(sub_60e6a440Address)
                if isMinting:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                emit TokenPurchaseWithStar(crowdsaleCap - tokensSold / sub_08095329 / 1000, crowdsaleCap - tokensSold, msg.sender, arg1);
                require ext_code.size(starTokenAddress)
                call starTokenAddress.0x23b872dd with:
                     gas gas_remaining wei
                    args address(arg1), walletAddress, crowdsaleCap - tokensSold / sub_08095329 / 1000
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_code.size(walletAddress)
        call walletAddress.0x6178a8b1 with:
             gas gas_remaining wei
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
}
