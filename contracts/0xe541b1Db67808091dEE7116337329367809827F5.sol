...
function _fallback() payable {
    ...
    if balanceOf[stor8] >= msg.value * price:
        call fundsWalletAddress with:
           value msg.value wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        require balanceOf[stor8] - (msg.value * price) <= balanceOf[stor8]
        ...
        emit Transfer((msg.value * price), fundsWalletAddress, msg.sender);
}
