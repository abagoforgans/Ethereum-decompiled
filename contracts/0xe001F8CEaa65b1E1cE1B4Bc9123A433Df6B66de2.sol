...
function sub_bd90a7eb(?) payable {
    ...
    if not ext_call.success:
        ...
        emit 0xed6cce3d: ext_call.return_data[640] << 152, sha3(Mask(160, 96, block.coinbase) >> 96) % block.timestamp << 224, block.number << 224 and block.difficulty % 17592186044416 << 180 and arg1 << 176 and arg2 << 168 and uint32(sha3(Mask(160, 96, block.coinbase) >> 96) % block.timestamp) << 136 and block.timestamp << 104 and Mask(104, 0, ext_call.return_data[640]), sha3(block.number << 224 and block.difficulty % 17592186044416 << 180 and arg1 << 176 and arg2 << 168 and uint32(sha3(Mask(160, 96, block.coinbase) >> 96) % block.timestamp) << 136 and block.timestamp << 104 and Mask(104, 0, ext_call.return_data[640])), sha3(block.number << 224 and block.difficulty % 17592186044416 << 180 and arg1 << 176 and arg2 << 168 and uint32(sha3(Mask(160, 96, block.coinbase) >> 96) % block.timestamp) << 136 and block.timestamp << 104 and Mask(104, 0, ext_call.return_data[640])) << 255, 0, 0
