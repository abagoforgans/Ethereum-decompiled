...
function _fallback() payable {
    ...
    stor5 = code.data[5430 len 20]
    if code.data[5450 len 32]:
        stor1 = code.data[5450 len 32]
        stor2 = code.data[5482 len 32]
        emit ChangeOfRules(code.data[5450 len 32], code.data[5482 len 32], stor5);
    else:
        stor1 = 1
        stor2 = code.data[5482 len 32]
        emit ChangeOfRules(1, code.data[5482 len 32], stor5);
    return code.data[295 len 5123]
}
