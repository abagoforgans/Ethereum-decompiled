...
function distributeReservedTokens(uint256 arg1) payable {
    ...
    if uint8(var25014) >= 0:
        ...
        call tokenAddress.0xc3310517 with:
             gas gas_remaining - 710 wei
        require ext_call.success
        require ext_code.size(0xf54ff1371664f6ff24bc90fa287711fe07381fa)
        delegate 0xf54ff1371664f6ff24bc90fa287711fe07381fa.0xf4f3bdc1 with:
             gas gas_remaining - 710 wei
        ...
        require ext_code.size(0xf54ff1371664f6ff24bc90fa287711fe07381fa)
        delegate 0xf54ff1371664f6ff24bc90fa287711fe07381fa.mem[var37002 len 4] with:
             gas gas_remaining - 710 wei
        ...
        while uint8(idx + 1) < uint8(ext_call.return_data[0]):
            ...
            mem[132] = ext_call.return_data[0]
            require ext_code.size(0xf54ff1371664f6ff24bc90fa287711fe07381fa)
            delegate 0xf54ff1371664f6ff24bc90fa287711fe07381fa.0x66098d4f with:
                 gas gas_remaining - 710 wei
