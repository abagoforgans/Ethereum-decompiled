...
uint8 stor8;
uint16 maxAnimals; offset 200
uint32 stor8; offset 171
uint32 numAnimals; offset 168
...
function sellAnimal(uint32 arg1) {
    ...
    while uint16(idx) < stor3.length:
        ...
        require uint16(idx) < stor3.length
        uint256(stor3[uint16(idx) / 8].field_0) = stor('array', ('stor', 29, 171, ('name', 'stor8', 8)), ('name', 'stor3', 3))[stor8.field_168 % 8] * 256^(4 * idx % 8) or !(test266151307() * 256^(4 * idx % 8)) and uint256(stor3[uint16(idx) / 8].field_0)
        require numAnimals < stor3.length
        uint256(stor3[stor8.field_171 % 536870912].field_0) = !(test266151307() * 256^(4 * stor8.field_168 % 8)) and uint256(stor3[stor8.field_171 % 536870912].field_0)
    ...
    require numAnimals < stor3.length
    require 0 < stor3.length
    uint32(stor3.field_0) = stor('array', ('stor', 29, 171, ('name', 'stor8', 8)), ('name', 'stor3', 3))[stor8.field_168 % 8]
    require numAnimals < stor3.length
    uint256(stor3[stor8.field_171 % 536870912].field_0) = !(test266151307() * 256^(4 * stor8.field_168 % 8)) and uint256(stor3[stor8.field_171 % 536870912].field_0)
    call msg.sender with:
       value uint128(animal[arg1 << 224].field_8) wei
...
function init(address arg1) {
    ...
    if (stor11.length + 31 / 32) + 0x175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9 > 0x175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9:
        ...
        while (stor11.length + 31 / 32) + 0x175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9 > idx:
            ...
            idx = idx + 1
            continue 
    stor13.field_0 % 16777216 = 700000
    uint8(stor13.field_24) = 0
    address(stor8.field_8) = arg1
    uint16(stor4.field_0) = 500
    uint16(stor4.field_16) = 0
    uint16(stor4.field_32) = 500
    uint16(stor4.field_48) = 0
    stor4.field_256 % 1 = 0
}
...
function giveAnimals(uint8 arg1, address arg2) payable {
    ...
    while uint8(idx) < uint8(msg.value / stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg1')), ('name', 'stor6', 6))[uint8(arg1)]):
        if numAnimals < stor3.length:
            mem[0] = 3
            uint256(stor3[stor8.field_171 % 536870912].field_0) = nextId * 256^(4 * stor8.field_168 % 8) or !(test266151307() * 256^(4 * stor8.field_168 % 8)) and uint256(stor3[stor8.field_171 % 536870912].field_0)
            _41 = mem[64]
            mem[64] = mem[64] + 96
            mem[_41] = arg1
            require arg1 < stor7.length
            mem[_41 + 32] = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg1')), ('name', 'stor7', 7))[uint8(arg1)]
            mem[_41 + 64] = arg2
        else:
            stor3.length++
            if not stor3.length > stor3.length + 1:
                ...
                mem[_42] = arg1
                require arg1 < stor7.length
                mem[_42 + 32] = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg1')), ('name', 'stor7', 7))[uint8(arg1)]
                mem[_42 + 64] = arg2
            else:
                if stor3.length + 7 / 8 <= stor3.length + 8 / 8:
                    ...
                    mem[_68] = arg1
                    require arg1 < stor7.length
                    mem[_68 + 32] = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg1')), ('name', 'stor7', 7))[uint8(arg1)]
                    mem[_68 + 64] = arg2
        mem[0] = nextId
        mem[32] = 5
...
function transfer(address arg1) {
    ...
    while 0 < numAnimals:
        ...
        if not uint256(stor0[uint8(stor5[uint32(stor3.field_0)].field_0)].field_0) <= uint256(stor0[uint8(stor5[uint32(stor3.field_0)].field_0)].field_0) + 1:
            if uint256(stor0[uint8(stor5[uint32(stor3.field_0)].field_0)].field_0) + 7 / 8 > uint256(stor0[uint8(stor5[uint32(stor3.field_0)].field_0)].field_0) + 8 / 8:
                uint256(stor0[uint8(stor5[uint32(stor3.field_0)].field_0)][0.125 / uint256(stor0[uint8(stor5[uint32(stor3.field_0)].field_0)].field_0) + 8].field_0) = 0
                idx = sha3(sha3(uint8(animal[uint32(stor3.field_0)].field_0), 0)) + (uint256(stor0[uint8(stor5[uint32(stor3.field_0)].field_0)].field_0) + 8 / 8) + 1
        ...
        if mem[(32 * uint16(idx)) + 191 len 1] > 0:
            ...
            if not uint256(stor0[idx << 240].field_0):
                ...
                call arg1.0xf410a26b with:
                   value uint8(_272) * stor('array', ('mask_shl', 15, 1, -1, ('var', 0)), ('name', 'stor7', 7))[uint8(idx)] wei
                ...
                s = mem[64] + 132
                t = 0
                while _274 + (32 * uint256(stor0[idx << 240].field_0)) + 132 > s + 32:
                ...
                call arg1.mem[mem[64] len 4] with:
                   value uint8(_272) * stor('array', ('mask_shl', 15, 1, -1, ('var', 0)), ('name', 'stor7', 7))[uint8(idx)] wei
                     gas gas_remaining - 9050 wei
                    args mem[mem[64] + 4 len _274 + (32 * uint256(stor0[idx << 240].field_0)) + -mem[64] + 128]
            require ext_call.success
            mem[32] = 0
            uint256(stor0[idx << 240].field_0) = 0
            mem[0] = sha3(idx << 240, 0)
            if sha3(sha3(idx << 240, 0)) + (uint256(stor0[idx << 240].field_0) + 7 / 8) > sha3(sha3(idx << 240, 0)):
                uint256(stor0[idx << 240].field_0) = 0
                s = sha3(sha3(idx << 240, 0)) + 1
                while sha3(sha3(idx << 240, 0)) + (uint256(stor0[idx << 240].field_0) + 7 / 8) > s:
                    uint256(stor[s].field_0) = 0
                    s = s + 1
                    continue 
        idx = idx + 1
    ...
    while uint8(idx) < arg3.length:
        ...
        if uint128(animal[mem[(32 * uint8(idx)) + 156 len 4]].field_8):
            if numAnimals < stor3.length:
                ...
                mem[_99] = arg2
                require arg2 < stor7.length
                mem[_99 + 32] = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg2')), ('name', 'stor7', 7))[uint8(arg2)]
                mem[_99 + 64] = arg1
            else:
                stor3.length++
                if not stor3.length > stor3.length + 1:
                    ...
                    mem[_101] = arg2
                    require arg2 < stor7.length
                    mem[_101 + 32] = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg2')), ('name', 'stor7', 7))[uint8(arg2)]
                    mem[_101 + 64] = arg1
                else:
                    if stor3.length + 7 / 8 <= stor3.length + 8 / 8:
                        mem[0] = 3
                        ...
                        mem[_122] = arg2
                        require arg2 < stor7.length
                        mem[_122 + 32] = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg2')), ('name', 'stor7', 7))[uint8(arg2)]
                        mem[_122 + 64] = arg1
                    else:
                        uint256(stor3[0.125 / stor3.length + 8].field_0) = 0
                        s = sha3(3) + (stor3.length + 8 / 8) + 1
                        ...
                        mem[_170] = arg2
                        require arg2 < stor7.length
                        mem[_170 + 32] = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg2')), ('name', 'stor7', 7))[uint8(arg2)]
                        mem[_170 + 64] = arg1
            mem[0] = nextId
            mem[32] = 5
            ...
            require uint8(idx) < mem[96]
            _93 = mem[(32 * uint8(idx)) + 128]
            if numAnimals < stor3.length:
                mem[0] = 3
                uint256(stor3[stor8.field_171 % 536870912].field_0) = mem[(32 * uint8(idx)) + 156 len 4] * 256^(4 * stor8.field_168 % 8) or !(test266151307() * 256^(4 * stor8.field_168 % 8)) and uint256(stor3[stor8.field_171 % 536870912].field_0)
                _103 = mem[64]
                mem[64] = mem[64] + 96
                mem[_103] = arg2
                require arg2 < stor7.length
                mem[_103 + 32] = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg2')), ('name', 'stor7', 7))[uint8(arg2)]
                mem[_103 + 64] = arg1
            else:
                stor3.length++
                if not stor3.length > stor3.length + 1:
                    ...
                    mem[_110] = arg2
                    require arg2 < stor7.length
                    mem[_110 + 32] = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg2')), ('name', 'stor7', 7))[uint8(arg2)]
                    mem[_110 + 64] = arg1
                else:
                    if stor3.length + 7 / 8 <= stor3.length + 8 / 8:
                        mem[0] = 3
                        ...
                        mem[_171] = arg2
                        require arg2 < stor7.length
                        mem[_171 + 32] = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg2')), ('name', 'stor7', 7))[uint8(arg2)]
                        mem[_171 + 64] = arg1
            mem[0] = uint32(_93)
            mem[32] = 5
            uint8(animal[_93 << 224].field_0) = arg2
            uint128(animal[_93 << 224].field_8) = stor('array', ('mask_shl', 7, 1, -1, ('param', 'arg2')), ('name', 'stor7', 7))[uint8(arg2)]
            address(animal[_93 << 224].field_256) = arg1
            numAnimals = uint32(numAnimals + 1)
            require uint8(idx) < mem[96]
        ...
        idx = idx + 1
        continue 
    numAnimalsXType[arg2 << 248] = uint16(mem[96] + numAnimalsXType[arg2 << 248])
}
