...
function _fallback() payable {
    ...
    stor0 = code.data[1699 len 20]
    stor1 = 10^18 * code.data[1719 len 32]
    stor3 = (60 * code.data[1751 len 32]) + block.timestamp
    stor4 = code.data[1783 len 32]
    stor5 = code.data[1827 len 20]
    return code.data[175 len 1512]
}
...
function _fallback() payable {
    ...
    call tokenRewardAddress.0xa9059cbb with:
        ...
        args msg.sender, 25000 * msg.value / price
