...
function TutorialToken() {
    ...
    symbol.length.field_8 = 'CCRS' / 256
    idx = 0
    ...
    name.length.field_8 = 'CrossChainRingless' / 256
    idx = 0
    ...
    decimals = 0
    _totalSupply = 10^11
    balanceOf[0x2ad3f079a8b120a3766327c894a5ec4391fa287b] = _totalSupply
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  _totalSupply,
    emit 0x0: _totalSupply
    emit 0x2ad3f079: _totalSupply
}
