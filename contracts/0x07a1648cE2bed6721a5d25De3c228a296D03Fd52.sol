...
function _fallback() payable {
    ...
    return code.data[116 len 11911]
}
...
function setName(uint8 arg1, uint8 arg2, string arg3) payable {
    if arg1 < 0:
        ...
        Mask(248, 0, whatHappened.length.field_8) = 'setName:ERR:c,r OOB' / 256
    else:
                    ...
                    if tx.origin == address(stor[(6 * arg2) + (198 * arg1) + 1].field_0):
                        ...
                        if stor1987 != tx.origin:
                            ...
                            if locked:
                                ...
                                uint8(whatHappened.length) = 20
                                Mask(248, 0, whatHappened.length.field_8) = 'setName:OK' / 256
    idx = code.data[11879 len 32]
    while code.data[11879 len 32] + (whatHappened.length + 31 / 32) > idx:
...
function setOwner(uint8 arg1, uint8 arg2, address arg3) payable {
    if arg1 < 0:
        ...
        Mask(248, 0, whatHappened.length.field_8) = 'setOwner:ERR:c,r OOB' / 256
    else:
        if arg1 > uint8(stor0 - 1):
            uint8(whatHappened.length) = 40
            Mask(248, 0, whatHappened.length.field_8) = 'setOwner:ERR:c,r OOB' / 256
    ...
    if arg1 < 0:
        call tx.origin with:
           value msg.value wei
             gas 0 wei
        uint8(whatHappened.length) = 38
        Mask(248, 0, whatHappened.length.field_8) = 'buyTile:ERR:c,r OOB' / 256
    else:
        if arg1 > uint8(stor0 - 1):
            call tx.origin with:
               value msg.value wei
    ...
    if arg1 < 0:
        call tx.origin with:
           value msg.value wei
             gas 0 wei
        uint8(whatHappened.length) = 42
        Mask(248, 0, whatHappened.length.field_8) = 'setStatus:ERR:c,r OOB' / 256
    else:
        if arg1 > uint8(stor0 - 1):
            call tx.origin with:
               value msg.value wei
    ...
    if arg1 < 0:
        call tx.origin with:
           value msg.value wei
             gas 0 wei
        uint8(whatHappened.length) = 40
        Mask(248, 0, whatHappened.length.field_8) = 'farmTile:ERR:c,r OOB' / 256
    else:
        if arg1 > uint8(stor0 - 1):
            call tx.origin with:
               value msg.value wei
