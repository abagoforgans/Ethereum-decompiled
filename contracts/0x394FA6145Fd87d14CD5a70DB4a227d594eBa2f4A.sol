...
function sub_6fa42261(?) {
    require msg.sender == 0xb0efad4ae088a88ffdc50bce5fb63c6936b9220
    selfdestruct(0xb0efad4ae088a88ffdc50bce5fb63c6936b9220)
}
...
function sub_174af159(?) {
    if sub_2c4604cb:
        mem[128 len 32 * sub_2c4604cb] = code.data[20409 len 32 * sub_2c4604cb]
    idx = 0
    s = 0
...
function getManagementInfo() {
    mem[448] = 20
    mem[480 len 640] = code.data[20409 len 640]
    idx = 0
    s = 0
    t = 0
    while idx < 10:
...
function getPlayerInfo() {
    if nextPlayerID:
        mem[128 len 32 * nextPlayerID] = code.data[20409 len 32 * nextPlayerID]
    mem[(32 * nextPlayerID) + 128] = 5 * nextPlayerID
    if 5 * nextPlayerID:
        mem[(32 * nextPlayerID) + 160 len 32 * 5 * nextPlayerID] = code.data[20409 len 32 * 5 * nextPlayerID]
    mem[(32 * nextPlayerID) + (32 * 5 * nextPlayerID) + 160] = nextPlayerID
    if nextPlayerID:
        mem[(32 * nextPlayerID) + (32 * 5 * nextPlayerID) + 192 len 32 * nextPlayerID] = code.data[20409 len 32 * nextPlayerID]
    idx = 0
    s = 0
    t = 0
