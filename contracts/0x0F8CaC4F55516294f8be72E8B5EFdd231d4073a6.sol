...
function TokenERC20(uint256 arg1) {
    totalSupply = 500000 * 3600 * 10^decimals
    balanceOf[msg.sender] = 500000 * 3600 * 10^decimals
    uint8(name.length) = 32
    name.length.field_8 = 'Asset Game Cloud' / 256
    idx = 0
