...
function _fallback() payable {
    mem[96 len 96] = code.data[1041 len 96]
    s = 0
    idx = 0
    while idx < 3:
...
function sub_2024aa4f(?) payable {
    ...
    if arg3.length != 65:
        ...
        if mem[192 len 1] >= 27:
            ...
            signer = erecover(arg2, _6 << 248, mem[128], mem[160]) 
        else:
            mem[ceil32(arg3.length) + ceil32(arg4.length) + 192] = uint8(mem[192 len 1] + 27)
            mem[ceil32(arg3.length) + ceil32(arg4.length) + 224] = mem[128]
            signer = erecover(arg2, uint8(_6) + 27 << 248, mem[128], mem[160]) 
...
function sub_90a54997(?) payable {
    ...
    call arg4 with:
       value arg3 wei
         gas 0 wei
    stor1[arg5] = 1
    emit 0x837bb960: arg1, address(arg2), arg3, arg4
}
