...
function sub_391465cb(?) {
    if arg1 > issues.length:
        emit code.data[6613 len 32]: arg1, 1, msg.sender
        return 0
    require arg1 < issues.length
...
function sub_940589d6(?) {
    if arg1 > issues.length:
        ...
        if issues[arg1].field_0 != msg.sender:
            emit code.data[6613 len 32]: arg1, 11, msg.sender
        else:
            if arg2 < 0:
                emit code.data[6613 len 32]: arg1, 12, msg.sender
            else:
