...
function _fallback() payable {
    stor0 = code.data[3503 len 32] or Mask(96, 160, stor0)
    ...
    stor9 = 14
    stor8 = 5 * 10^9
    stor12 = code.data[3439 len 32]
    stor13 = code.data[3471 len 32]
    stor3 = code.data[3535 len 32] or Mask(96, 160, stor3)
    return code.data[168 len 3271]
}
...
function addAlt(address arg1, uint256 arg2, uint256 arg3) payable {
    ...
    create contract with 0 wei
                    code: code.data[3100 len 171], address(this.address)
    altList.length++
...
function giveFor(address arg1) payable {
    ...
    if block.timestamp >= startDate:
        ...
        if not address(sponsorList[address(msg.sender)].field_512):
            ...
            if ((startingEtherValue * msg.value) - ((nxcPerBcy * collectedBcy) + nxcSold / perStageNxc * stepEtherValue * msg.value) / 10^18) + sponsorList[address(msg.sender)].field_0 / 60 * 10^6 <= sponsorList[address(msg.sender)].field_768:
                if not isLimitReached:
                    backers[address(stor17[address(msg.sender)].field_512)].field_256 = (((startingEtherValue * msg.value) - ((nxcPerBcy * collectedBcy) + nxcSold / perStageNxc * stepEtherValue * msg.value) / 10^18) + sponsorList[address(msg.sender)].field_0 / 60 * 10^6 * sponsorList[address(msg.sender)].field_0 / 100) - sponsorList[address(msg.sender)].field_256 + backers[address(stor17[address(msg.sender)].field_512)].field_256
                else:
                    call nexiumAddress.0xa9059cbb with:
                         gas gas_remaining - 25050 wei
                        args address(sponsorList[address(msg.sender)].field_512), (((startingEtherValue * msg.value) - ((nxcPerBcy * collectedBcy) + nxcSold / perStageNxc * stepEtherValue * msg.value) / 10^18) + sponsorList[address(msg.sender)].field_0 / 60 * 10^6 * sponsorList[address(msg.sender)].field_0 / 100) - sponsorList[address(msg.sender)].field_256
                    require ext_call.success
                    require ext_call.return_data[0]
                    if backers[address(stor17[address(msg.sender)].field_512)].field_256 != 0:
                        ...
                        require ext_call.return_data[0]
                sponsorList[address(msg.sender)].field_256 = ((startingEtherValue * msg.value) - ((nxcPerBcy * collectedBcy) + nxcSold / perStageNxc * stepEtherValue * msg.value) / 10^18) + sponsorList[address(msg.sender)].field_0 / 60 * 10^6 * sponsorList[address(msg.sender)].field_0 / 100
            else:
                if not isLimitReached:
        ...
        if block.timestamp >= startDate:
            ...
            if not address(sponsorList[address(msg.sender)].field_512):
                ...
                if (startingEtherValue - ((nxcPerBcy * collectedBcy) + nxcSold / perStageNxc * stepEtherValue) / 10 * msg.value / 10^18) + sponsorList[address(msg.sender)].field_0 / 60 * 10^6 <= sponsorList[address(msg.sender)].field_768:
                    if not isLimitReached:
                        backers[address(stor17[address(msg.sender)].field_512)].field_256 = ((startingEtherValue - ((nxcPerBcy * collectedBcy) + nxcSold / perStageNxc * stepEtherValue) / 10 * msg.value / 10^18) + sponsorList[address(msg.sender)].field_0 / 60 * 10^6 * sponsorList[address(msg.sender)].field_0 / 100) - sponsorList[address(msg.sender)].field_256 + backers[address(stor17[address(msg.sender)].field_512)].field_256
                    else:
                        call nexiumAddress.0xa9059cbb with:
                             gas gas_remaining - 25050 wei
                            args address(sponsorList[address(msg.sender)].field_512), ((startingEtherValue - ((nxcPerBcy * collectedBcy) + nxcSold / perStageNxc * stepEtherValue) / 10 * msg.value / 10^18) + sponsorList[address(msg.sender)].field_0 / 60 * 10^6 * sponsorList[address(msg.sender)].field_0 / 100) - sponsorList[address(msg.sender)].field_256
                        require ext_call.success
                        require ext_call.return_data[0]
                        if backers[address(stor17[address(msg.sender)].field_512)].field_256 != 0:
                            call nexiumAddress.0xa9059cbb with:
                            ...
                            backers[address(stor17[address(msg.sender)].field_512)].field_256 = 0
                            require ext_call.return_data[0]
                    sponsorList[address(msg.sender)].field_256 = (startingEtherValue - ((nxcPerBcy * collectedBcy) + nxcSold / perStageNxc * stepEtherValue) / 10 * msg.value / 10^18) + sponsorList[address(msg.sender)].field_0 / 60 * 10^6 * sponsorList[address(msg.sender)].field_0 / 100
                else:
                    if not isLimitReached:
                        backers[address(stor17[address(msg.sender)].field_512)].field_256 = (sponsorList[address(msg.sender)].field_768 * sponsorList[address(msg.sender)].field_0 / 100) - sponsorList[address(msg.sender)].field_256 + backers[address(stor17[address(msg.sender)].field_512)].field_256
                    else:
