...
function _fallback() {
    require code.data[7250 len 32] > 0
    require code.data[7294 len 20]
    create contract with 0 wei
                    code: code.data[4177 len 3073]
    require create.new_address
    stor0 = address(create.new_address)
    stor2 = code.data[7250 len 32]
    stor1 = code.data[7294 len 20]
    return code.data[221 len 3956]
}
