...
function mint(address arg1, string arg2) {
    ...
    require stor8[address(msg.sender)]
    require arg1
    require not ownerOf[stor13.length + 1]
    ownerOf[stor13.length + 1] = arg1
    require balanceOf[address(arg1)] + 1 >= balanceOf[address(arg1)]
    balanceOf[address(arg1)]++
    tokenOfOwnerByIndex[address(arg1)]++
    tokenOfOwnerByIndex[address(arg1)][tokenOfOwnerByIndex[address(arg1)]] = tokenByIndex.length + 1
    stor12[stor13.length + 1] = tokenOfOwnerByIndex[address(arg1)]
    emit Transfer(0, arg1, tokenByIndex.length + 1);
    stor14[stor13.length + 1] = tokenByIndex.length
    tokenByIndex.length++
    tokenByIndex[tokenByIndex.length] = tokenByIndex.length + 1
    require ownerOf[stor13.length + 1]
    tokenURI[stor13.length + 1][] = Array(len=arg2.length, data=arg2[all])
    return 1
}
