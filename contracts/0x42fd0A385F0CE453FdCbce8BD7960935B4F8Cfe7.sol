...
function _fallback() {
    stor4 = msg.sender
    stor0 = code.data[11633 len 32]
    uint256(stor1) = code.data[11633 len 32] + 1200
    stor2 = code.data[11581 len 20]
    stor3 = code.data[11613 len 20]
    create contract with 0 wei
                    code: code.data[5749 len 5820], 1000000000 * 10^18
    ...
    require ext_call.success
    return code.data[2017 len 3732]
}
...
const STAGE_FOUR_TIME_END = 1200
...
const STAGE_TWO_TIME_END = 600

const STAGE_ONE_TIME_END = 300
...
const STAGE_THREE_TIME_END = 900
...
function getPriceRate() {
    if block.timestamp <= publicStartTime + 300:
        return 12500 * 10^18
    if block.timestamp <= publicStartTime + 600:
        return 11500 * 10^18
    if block.timestamp <= publicStartTime + 900:
        return 10500 * 10^18
    if block.timestamp > publicStartTime + 1200:
        return 0
    return 9500 * 10^18
}
