...
function _fallback() payable {
    ...
    stor1.length.field_8 = 'DocCoin' / 256
    idx = 0
    ...
    stor6 = 422424 * 24 * 3600
    require not msg.value
    stor0 = msg.sender
    stor7[address(msg.sender)] = stor4
    return code.data[554 len 5752]
}
...
function setCrowdsaleContract(address arg1) {
    require msg.sender == owner
