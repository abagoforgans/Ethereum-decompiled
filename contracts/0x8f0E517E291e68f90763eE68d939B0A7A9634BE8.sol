...
function sub_c129cdfb(?) payable {
    ...
    while idx < arg2:
        mem[0] = 0
        mem[32] = sha3(idx, sha3(0, 1) + 1)
        require eth.balance(this.address) >= sub_5f860f86[0][1][idx][0].field_0
        if sub_5f860f86[0][1][idx].field_768 == 1:
            require msg.sender == address(owner)
            mem[mem[64]] = sub_5f860f86[0][1][idx].field_256
            mem[mem[64] + 32] = sub_5f860f86[0][1][idx][0].field_0
            mem[mem[64] + 64] = block.timestamp
            emit OutgoingTx(sub_5f860f86[0][1][idx].field_256, sub_5f860f86[0][1][idx][0].field_0, block.timestamp, block.number);
            mem[0] = 0
            mem[32] = 1
            call sub_5f860f86[0][1][idx].field_256 with:
               value sub_5f860f86[0][1][idx][0].field_0 wei
                 gas 0 wei
...
function payDividends(uint256 arg1, uint256 arg2, uint256 arg3) payable {
    ...
    while idx < arg2:
        mem[0] = idx
        mem[32] = sha3(0, 1)
        require eth.balance(this.address) >= arg3 * sub_5f860f86[0][idx].field_256
        if sub_5f860f86[0][idx].field_512 == 1:
            require msg.sender == address(owner)
            mem[mem[64]] = sub_5f860f86[0][idx].field_0
            mem[mem[64] + 32] = arg3 * sub_5f860f86[0][idx].field_256
            mem[mem[64] + 64] = block.timestamp
            emit OutgoingTx(sub_5f860f86[0][idx].field_0, arg3 * sub_5f860f86[0][idx].field_256, block.timestamp, block.number);
            mem[0] = 0
            mem[32] = 1
            call sub_5f860f86[0][idx].field_0 with:
               value arg3 * sub_5f860f86[0][idx].field_256 wei
                 gas 0 wei
        s = arg3 * sub_5f860f86[0][idx].field_256
        s = sha3(idx, sha3(0, 1))
        idx = idx + 1
        continue 
    return 0
