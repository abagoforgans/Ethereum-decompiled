...
function _fallback() payable {
    stor13 = code.data[10826 len 32]
    stor14 = code.data[10794 len 32]
    stor15 = Mask(248, 0, code.data[10858 len 32])
    create contract with 0 wei
                    code: code.data[713 len 335], this.address
    uint256(stor16.field_0) = Mask(96, 0, stor16.field_160)
    uint256(stor4) = code.data[10730 len 32] or Mask(96, 160, uint256(stor4))
    stor12 = code.data[10762 len 32] or Mask(96, 160, stor12)
    create contract with 0 wei
                    code: code.data[1048 len 335], address(this.address)
    uint256(stor8.field_0) = Mask(96, 0, stor8.field_160)
    require address(create.new_address) != 0
    ...
    if not stor0 <= stor0 + 1:
        ...
        while sha3(0) + (14 * stor0) > idx + sha3(mem[0]):
            ...
            idx = idx + 1
            continue 
    stor5[address(this.address)] = 1
    stor5[address(stor4)] = 1
    stor5[address(stor8.field_0)] = 1
    return code.data[1383 len 9347]
}
