...
function persons(uint256 arg1) payable {
    ...
    return address(stor0[arg1].field_0), stor[code.data[877 len 32] + (2 * arg1)]
}
...
function enter() payable {
    if msg.value % 100 * 10^18 != 0:
        ...
        if not stor0.length > stor0.length + 1:
            ...
            stor[code.data[877 len 32] + (2 * stor0.length)] = msg.value
            balance += msg.value
            if balance >= 2 * stor[code.data[877 len 32] + (2 * stor1)]:
                require payoutIdx < stor0.length
                call address(stor0[stor1].field_0) with:
                   value 2 * stor[code.data[877 len 32] + (2 * stor1)] wei
                     gas 0 wei
                balance -= 2 * stor[code.data[877 len 32] + (2 * stor1)]
                payoutIdx++
                s = var16001
                while balance >= 2 * stor[code.data[877 len 32] + (2 * stor1)]:
                    require payoutIdx < stor0.length
                    call address(stor0[stor1].field_0) with:
                       value 2 * stor[code.data[877 len 32] + (2 * stor1)] wei
                         gas 0 wei
                    ...
                    payoutIdx++
                    mem[0] = 0
                    s = 2 * stor[code.data[877 len 32] + (2 * stor1)]
                    continue 
        else:
