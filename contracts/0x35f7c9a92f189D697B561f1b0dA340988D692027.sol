...
function setBasePrice(uint256 arg1) payable {
    ...
    while idx < stor8.length:
        mem[0] = stor[code.data[5305 len 32] + idx]
        mem[32] = 6
        stor6[stor[code.data[5305 len 32] + idx]] = arg1 * stor7[stor[idx + code.data[5305 len 32]]]
        idx = idx + 1
        continue 
}
...
function query(uint256 arg1, string arg2, string arg3, uint256 arg4) payable {
    ...
    emit Log1(msg.sender, sha3(msg.sender + stor0[address(msg.sender)]), arg1, Array(len=arg2.length, data=arg2[all]), arg2.length + 256, arg4, stor4[address(msg.sender)]);
    return sha3(msg.sender + stor0[address(msg.sender)])
}
...
function query2(uint256 arg1, string arg2, string arg3, string arg4, uint256 arg5) payable {
    ...
    if not arg3.length % 32:
        emit Log2(msg.sender, sha3(msg.sender + stor0[address(msg.sender)]), arg1, Array(len=arg2.length, data=arg2[all]), arg2.length + 288, arg3.length + arg2.length + 320, arg5, stor4[address(msg.sender)]);
    else:
        emit Log2(msg.sender, sha3(msg.sender + stor0[address(msg.sender)]), arg1, Array(len=arg2.length, data=arg2[all]), arg2.length + 288, floor32(arg3.length) + arg2.length + 352, arg5, stor4[address(msg.sender)]);
    return sha3(msg.sender + stor0[address(msg.sender)])
}
    ...
    if not arg1.length % 32:
        ...
        if not arg2.length % 32:
            emit Log1(address rg1, bytes32 rg2, uint256 rg3, string rg4, string rg5, uint256 rg6, bytes1 rg7):
                      msg.sender,
                      sha3(msg.sender + stor0[address(msg.sender)]),
                      0,
                      224,
                      arg1.length + 256,
                      200000,
