...
function _fallback() {
    stor0 = msg.sender
    require code.data[6469 len 20]
    require code.data[6501 len 20]
    stor1 = code.data[6469 len 20]
    stor2 = code.data[6501 len 20]
    return code.data[344 len 6113]
}
                                ...
                                if ext_call.return_data[0]:
                                    if totalSupplyCap >= totalSold:
                                        ...
                                        if ext_call.success:
                                            ...
                                            if totalSupplyCap - totalSold <= msg.value:
