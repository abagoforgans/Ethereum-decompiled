...
function _fallback() {
    ...
    stor6 = 10^16
    return code.data[296 len 10023]
}
            ...
            if ext_call.return_data[0] < arg10:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if (10^18 * arg9) + (ext_call.return_data[0] * arg9) / 10^18 <= ext_call.return_data[0]:
                        ...
                        if (10^18 * arg9 / ext_call.return_data[0] + 10^18 * 10^18 * arg2 / arg1 / 10^18) - ((10^18 * arg10) + (ext_call.return_data[0] * arg10) / 10^18) < minProfit:
                            ...
                            require ext_call.success
                            require ext_call.return_data[0] + 10^18
                            emit 0x3121fc23: (10^18 * arg10) + (ext_call.return_data[0] * arg10) / 10^18, 10^18 * arg9 / ext_call.return_data[0] + 10^18 * 10^18 * arg2 / arg1 / 10^18, sub_3acace3fAddress, arg9
                            require owner == msg.sender
                            if not stor5[stor9]:
                        ...
                        require ext_call.success
                        require ext_call.return_data[0] + 10^18
                        if (10^18 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] + 10^18 / ext_call.return_data[0] + 10^18 * 10^18 * arg2 / arg1 / 10^18) - ((10^18 * 10^18 * ext_call.return_data[0] / arg9 * arg10 / 10^18) + (ext_call.return_data[0] * 10^18 * ext_call.return_data[0] / arg9 * arg10 / 10^18) / 10^18) < minProfit:
                            emit Result(Array(len=20, data='Profit below minimum'));
                        else:
                            require ext_code.size(stor2)
                            call stor2.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
                            ...
                            require ext_call.success
                            require ext_call.return_data[0] + 10^18
                            emit 0x3121fc23: (10^18 * 10^18 * ext_call.return_data[0] / arg9 * arg10 / 10^18) + (ext_call.return_data[0] * 10^18 * ext_call.return_data[0] / arg9 * arg10 / 10^18) / 10^18, 10^18 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] + 10^18 / ext_call.return_data[0] + 10^18 * 10^18 * arg2 / arg1 / 10^18, sub_3acace3fAddress, 10^18 * ext_call.return_data[0] / ext_call.return_data[0] + 10^18
                            require owner == msg.sender
                            if not stor5[stor9]:
                                if sub_3acace3fAddress:
                                    sub_49120cfe.length++
            ...
            if ext_call.return_data[0] < ext_call.return_data[0]:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if (10^18 * 10^18 * ext_call.return_data[0] / arg10 * arg9 / 10^18) + (ext_call.return_data[0] * 10^18 * ext_call.return_data[0] / arg10 * arg9 / 10^18) / 10^18 <= ext_call.return_data[0]:
                        ...
                        require ext_call.success
                        require ext_call.return_data[0] + 10^18
                        if (10^18 * 10^18 * ext_call.return_data[0] / arg10 * arg9 / 10^18 / ext_call.return_data[0] + 10^18 * 10^18 * arg2 / arg1 / 10^18) - ((10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0]) / 10^18) < minProfit:
                            emit Result(Array(len=20, data='Profit below minimum'));
                        else:
                            require ext_code.size(stor2)
                            call stor2.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
                            ...
                            require ext_call.success
                            require ext_call.return_data[0] + 10^18
                            emit 0x3121fc23: (10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] * ext_call.return_data[0]) / 10^18, 10^18 * 10^18 * ext_call.return_data[0] / arg10 * arg9 / 10^18 / ext_call.return_data[0] + 10^18 * 10^18 * arg2 / arg1 / 10^18, sub_3acace3fAddress, 10^18 * ext_call.return_data[0] / arg10 * arg9 / 10^18
                            require owner == msg.sender
                            if not stor5[stor9]:
                                if sub_3acace3fAddress:
                                    sub_49120cfe.length++
                        ...
                        require ext_call.success
                        require ext_call.return_data[0] + 10^18
                        if (10^18 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] + 10^18 / ext_call.return_data[0] + 10^18 * 10^18 * arg2 / arg1 / 10^18) - ((10^18 * 10^18 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / arg10 * arg9 / 10^18 * ext_call.return_data[0] / 10^18) + (ext_call.return_data[0] * 10^18 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / arg10 * arg9 / 10^18 * ext_call.return_data[0] / 10^18) / 10^18) < minProfit:
                            emit Result(Array(len=20, data='Profit below minimum'));
                        else:
                            require ext_code.size(stor2)
                            call stor2.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
                            ...
                            require ext_call.success
                            require ext_call.return_data[0] + 10^18
                            emit 0x3121fc23: (10^18 * 10^18 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / arg10 * arg9 / 10^18 * ext_call.return_data[0] / 10^18) + (ext_call.return_data[0] * 10^18 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / arg10 * arg9 / 10^18 * ext_call.return_data[0] / 10^18) / 10^18, 10^18 * 10^18 * ext_call.return_data[0] / ext_call.return_data[0] + 10^18 / ext_call.return_data[0] + 10^18 * 10^18 * arg2 / arg1 / 10^18, sub_3acace3fAddress, 10^18 * ext_call.return_data[0] / ext_call.return_data[0] + 10^18
                            require owner == msg.sender
                            if not stor5[stor9]:
                                if sub_3acace3fAddress:
                                    sub_49120cfe.length++
