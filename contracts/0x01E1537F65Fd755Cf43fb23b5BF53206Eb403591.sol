...
function _fallback() payable {
    ...
    stor4 = code.data[4189 len 20]
    stor0 = code.data[4209 len 32]
    stor1[address(msg.sender)] = code.data[4209 len 32]
    emit Transfer(code.data[4209 len 32], 0, msg.sender);
    return code.data[200 len 3977]
}
...
function pause(bool arg1, bool arg2) {
    ...
    Mask(80, 0, stor3.field_176) = Mask(80, 16, arg1) >> 16
