...
const _fallback = code.data[18 len 4181]
...
function sub_63be1d22(?) payable {
    ...
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 320 len 222] = code.data[3959 len 222]
    idx = 0
    s = 0
    while idx < arg1.length:
        require idx < arg1.length
...
function register(string arg1, uint256 arg2) payable {
    ...
    if msg.value >= 10^15:
        ...
        mem[ceil32(arg1.length) + 416 len 222] = code.data[3959 len 222]
        idx = 0
        s = 0
        while idx < 7:
            require idx < 7
        ...
        mem[64] = mem[64] + 256
        mem[_422] = 222
        mem[_422 + 32 len 222] = code.data[3959 len 222]
