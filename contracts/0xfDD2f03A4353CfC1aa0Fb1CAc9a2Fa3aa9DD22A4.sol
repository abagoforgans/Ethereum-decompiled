...
function _fallback() payable {
    ...
    emit OwnershipTransferred(address(stor6.field_0), 0x8024069546651883a2b948ae67b345d7c42b19);
    Mask(152, 0, stor6.field_0) = 0x8024069546651883a2b948ae67b345d7c42b19
    uint8(stor6.field_152) = 0
    return code.data[425 len 6331]
}
...
function releaseOnce() {
    ...
    require stor4['WISH' or msg.sender << 64 or stor3['WISH' or msg.sender << 64]] + actualBalanceOf[address(msg.sender)] >= actualBalanceOf[address(msg.sender)]
