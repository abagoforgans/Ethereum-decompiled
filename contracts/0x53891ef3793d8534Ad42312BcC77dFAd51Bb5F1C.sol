...
function _fallback() payable {
    require not code.data[2920 len 32] % code.data[2952 len 32]
    stor0 = msg.sender or Mask(96, 160, stor0)
    stor1 = 10^15 * code.data[2920 len 32]
    stor2 = 10^15 * code.data[2952 len 32]
    uint8(stor6.field_0) = uint8(code.data[2984 len 32])
    Mask(248, 0, stor6.field_8) = 0
    return code.data[102 len 2818]
}
