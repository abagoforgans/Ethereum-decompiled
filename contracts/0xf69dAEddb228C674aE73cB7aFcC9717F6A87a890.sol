...
const _fallback = code.data[30 len 5227]
...
const name = 'CrowdsaleToken'

const decimals = 18

const multisig = 0xdac90db9bf9354d97014f728d2a8c2e234fef5a6
...
function createTokens(address arg1) payable {
    ...
    call 0xdac90db9bf9354d97014f728d2a8c2e234fef5a6 with:
       value msg.value wei
