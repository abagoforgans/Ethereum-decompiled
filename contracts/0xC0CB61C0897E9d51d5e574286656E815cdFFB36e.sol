...
function getPaused() {
    return bool(uint8(stor2.length))
}
...
function sub_aa841b6e(?) {
    require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
    delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0xc7132c44 with:
...
function pause(bool arg1) {
    require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
    delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0x704e5fdd with:
         gas gas_remaining wei
        args 0, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function executeProposal(uint256 arg1, uint256 arg2) {
    require arg1 < 2
    require ext_code.size(0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477)
    delegate 0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477.0x8a038235 with:
         gas gas_remaining wei
...
function sub_dc5b1daa(?) {
    require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
    delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0x9fef477 with:
         gas gas_remaining wei
        args 0, arg1, 0
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_a261c985(?) {
    require arg1 < 2
    require ext_code.size(0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477)
    delegate 0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477.0xe53149e2 with:
         gas gas_remaining wei
        args ((6 * arg1) + 14)
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function allowance(address arg1, address arg2) {
    require ext_code.size(0x9a7d0ec50b4aaed2efc459ab7264b64f7b846ecc)
    delegate 0x9a7d0ec50b4aaed2efc459ab7264b64f7b846ecc.0xa7b64b15 with:
         gas gas_remaining wei
...
function approveEscrow(address arg1, uint256 arg2) {
    require ext_code.size(0x9a7d0ec50b4aaed2efc459ab7264b64f7b846ecc)
    delegate 0x9a7d0ec50b4aaed2efc459ab7264b64f7b846ecc.0xef0cfae5 with:
         gas gas_remaining wei
...
function transfer(address arg1, uint256 arg2) {
    require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
    delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0xde810483 with:
         gas gas_remaining wei
        args 0, 0, msg.sender, address(arg1), arg2, 0, 192, 0, None
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return bool(delegate.return_data[0])
...
function vote(uint256 arg1, uint256 arg2, bool arg3) {
    require arg1 < 2
    require ext_code.size(0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477)
    delegate 0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477.0xfa57109d with:
         gas gas_remaining wei
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0xde810483 with:
         gas gas_remaining wei
        args 0, 0, address(arg1), address(arg2), arg3, 0, 192, 0, mem[324]
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return bool(delegate.return_data[0])
...
function sub_141e02e6(?) {
    ...
    require ext_code.size(0x9a7d0ec50b4aaed2efc459ab7264b64f7b846ecc)
    delegate 0x9a7d0ec50b4aaed2efc459ab7264b64f7b846ecc.0x59d915b7 with:
         gas gas_remaining wei
...
function getParent() {
    ...
    mem[100] = 0
    require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
    delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0x5f55335a with:
         gas gas_remaining wei
        args 0
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_29959a91(?) {
    ...
    if not arg1.length % 32:
        require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
        delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0x7ca7c9b with:
             gas gas_remaining wei
...
function sub_b79f680c(?) {
    ...
    if not arg1.length % 32:
        require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
        delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0x9f8366e with:
             gas gas_remaining wei
            args 0, 64, arg1.length, Mask(8 * arg1.length, -(8 * arg1.length) + 256, arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]) << (8 * arg1.length) - 256
    else:
        mem[floor32(arg1.length) + ceil32(arg1.length) + 228] = mem[floor32(arg1.length) + ceil32(arg1.length) + -(arg1.length % 32) + 260 len arg1.length % 32]
...
function sub_547e1b1a(?) {
    ...
    if not arg1.length % 32:
        require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
        delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0x8a3ac604 with:
             gas gas_remaining wei
            args 0, 64, arg1.length, Mask(8 * arg1.length, -(8 * arg1.length) + 256, arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]) << (8 * arg1.length) - 256
    else:
        mem[floor32(arg1.length) + ceil32(arg1.length) + 228] = mem[floor32(arg1.length) + ceil32(arg1.length) + -(arg1.length % 32) + 260 len arg1.length % 32]
...
function sub_b5943efe(?) {
    ...
    if not arg1.length % 32:
        require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
        delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0xac003bdd with:
             gas gas_remaining wei
            args 0, 64, arg1.length, Mask(8 * arg1.length, -(8 * arg1.length) + 256, arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]) << (8 * arg1.length) - 256
    else:
        mem[floor32(arg1.length) + ceil32(arg1.length) + 228] = mem[floor32(arg1.length) + ceil32(arg1.length) + -(arg1.length % 32) + 260 len arg1.length % 32]
...
function sub_f489584a(?) {
    ...
    if not arg1.length % 32:
        require ext_code.size(0x34572a36960e64aa2b7037232be356e93647c6e9)
        delegate 0x34572a36960e64aa2b7037232be356e93647c6e9.0xdd756863 with:
             gas gas_remaining wei
...
function sub_47602010(?) {
    ...
    if not arg1.length % 32:
        require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
        delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0xb269e446 with:
             gas gas_remaining wei
            args 0, 64, arg1.length, Mask(8 * arg1.length, -(8 * arg1.length) + 256, arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]) << (8 * arg1.length) - 256
    else:
        mem[floor32(arg1.length) + ceil32(arg1.length) + 228] = mem[floor32(arg1.length) + ceil32(arg1.length) + -(arg1.length % 32) + 260 len arg1.length % 32]
...
function sub_a4fa810d(?) {
    ...
    _30 = sha3(sha3(call.data[arg1 + 36 len floor32(arg1.length)], mem[ceil32(arg1.length) + ceil32(arg3.length) + floor32(arg1.length) + 160 len arg1.length % 32]), 9)
    ...
    if not arg3.length % 32:
        ...
        delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0xde810483 with:
             gas gas_remaining wei
            args 0, msg.sender, address(stor[_30].field_0), arg2, 0, 192, arg3.length, Mask(8 * arg3.length, -(8 * arg3.length) + 256, arg3[all], mem[ceil32(arg1.length) + arg3.length + 160 len ceil32(arg3.length) - arg3.length]) << (8 * arg3.length) - 256
    else:
...
function sub_e432c360(?) {
    ...
    if not arg1.length % 32:
        ...
        if not arg2.length % 32:
            require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
            delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0xa7d3ee6 with:
                 gas gas_remaining wei
...
function sub_2e563297(?) {
    ...
    if not arg1.length % 32:
        ...
        if not arg2.length % 32:
            require ext_code.size(0x9a7d0ec50b4aaed2efc459ab7264b64f7b846ecc)
            delegate 0x9a7d0ec50b4aaed2efc459ab7264b64f7b846ecc.0x2fb54038 with:
                 gas gas_remaining wei
...
function sub_d4f7323a(?) {
    ...
    if not arg1.length % 32:
        ...
        if not arg2.length % 32:
            require ext_code.size(0x9a7d0ec50b4aaed2efc459ab7264b64f7b846ecc)
            delegate 0x9a7d0ec50b4aaed2efc459ab7264b64f7b846ecc.0x1da19452 with:
                 gas gas_remaining wei
                args 0, 96, arg1.length + 128, arg1.length, Mask(8 * ceil32(arg1.length), -(8 * ceil32(arg1.length)) + 256, arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]) << (8 * ceil32(arg1.length)) - 256, mem[(2 * ceil32(arg1.length)) + ceil32(arg2.length) + 292 len arg2.length + arg1.length + -ceil32(arg1.length) + 32]
        else:
            mem[floor32(arg2.length) + arg1.length + ceil32(arg1.length) + ceil32(arg2.length) + 324] = mem[floor32(arg2.length) + arg1.length + ceil32(arg1.length) + ceil32(arg2.length) + -(arg2.length % 32) + 356 len arg2.length % 32]
...
function sub_4a761a6e(?) {
    ...
    if not arg1.length % 32:
        ...
        if not arg2.length % 32:
            require ext_code.size(0x9a7d0ec50b4aaed2efc459ab7264b64f7b846ecc)
            delegate 0x9a7d0ec50b4aaed2efc459ab7264b64f7b846ecc.0xaa77e7e3 with:
                 gas gas_remaining wei
                args 0, 96, arg1.length + 128, arg1.length, Mask(8 * ceil32(arg1.length), -(8 * ceil32(arg1.length)) + 256, arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]) << (8 * ceil32(arg1.length)) - 256, mem[(2 * ceil32(arg1.length)) + ceil32(arg2.length) + 292 len arg2.length + arg1.length + -ceil32(arg1.length) + 32]
        else:
            mem[floor32(arg2.length) + arg1.length + ceil32(arg1.length) + ceil32(arg2.length) + 324] = mem[floor32(arg2.length) + arg1.length + ceil32(arg1.length) + ceil32(arg2.length) + -(arg2.length % 32) + 356 len arg2.length % 32]
...
function sub_ae819fc5(?) {
    ...
    if not arg1.length % 32:
        require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
        delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0xf198ea44 with:
             gas gas_remaining wei
            args 0, 64, arg1.length, Mask(8 * arg1.length, -(8 * arg1.length) + 256, arg1[all], mem[arg1.length + 128 len ceil32(arg1.length) - arg1.length]) << (8 * arg1.length) - 256
        if not delegate.return_code:
            revert with ext_call.return_data[0 len return_data.size]
...
function sub_b1416d67(?) {
    mem[128 len arg3.length] = arg3[all]
    mem[ceil32(arg3.length) + 128] = arg4.length
    mem[ceil32(arg3.length) + 160 len arg4.length] = arg4[all]
    mem[ceil32(arg3.length) + ceil32(arg4.length) + 160 len 384] = call.data[260 len 384]
    require arg1 < 2
    mem[ceil32(arg3.length) + ceil32(arg4.length) + 1252 len ceil32(arg3.length)] = arg3[all], mem[arg3.length + 128 len ceil32(arg3.length) - arg3.length]
    if not arg3.length % 32:
        mem[arg3.length + ceil32(arg3.length) + ceil32(arg4.length) + 1252] = arg4.length
        mem[arg3.length + ceil32(arg3.length) + ceil32(arg4.length) + 1284 len ceil32(arg4.length)] = arg4[all], mem[ceil32(arg3.length) + arg4.length + 160 len ceil32(arg4.length) - arg4.length]
        if not arg4.length % 32:
            require ext_code.size(0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477)
            delegate 0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477.0x8a076830 with:
                 gas gas_remaining wei
                args 0, (6 * arg1) + 14, arg2 << 248, 672, arg3.length + 704, arg5, arg6, arg7, address(arg8), call.data[260 len 384], arg3.length, Mask(8 * ceil32(arg3.length), -(8 * ceil32(arg3.length)) + 256, arg3[all], mem[arg3.length + 128 len ceil32(arg3.length) - arg3.length]) << (8 * ceil32(arg3.length)) - 256, mem[(2 * ceil32(arg3.length)) + ceil32(arg4.length) + 1252 len arg4.length + arg3.length + -ceil32(arg3.length) + 32]
        else:
            mem[floor32(arg4.length) + arg3.length + ceil32(arg3.length) + ceil32(arg4.length) + 1284] = mem[floor32(arg4.length) + arg3.length + ceil32(arg3.length) + ceil32(arg4.length) + -(arg4.length % 32) + 1316 len arg4.length % 32]
            require ext_code.size(0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477)
            delegate 0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477.0x8a076830 with:
                 gas gas_remaining wei
                args 0, (6 * arg1) + 14, arg2 << 248, 672, arg3.length + 704, arg5, arg6, arg7, address(arg8), call.data[260 len 384], arg3.length, Mask(8 * ceil32(arg3.length), -(8 * ceil32(arg3.length)) + 256, arg3[all], mem[arg3.length + 128 len ceil32(arg3.length) - arg3.length]) << (8 * ceil32(arg3.length)) - 256, mem[(2 * ceil32(arg3.length)) + ceil32(arg4.length) + 1252 len floor32(arg4.length) + arg3.length + -ceil32(arg3.length) + 64]
    else:
        mem[floor32(arg3.length) + ceil32(arg3.length) + ceil32(arg4.length) + 1252] = mem[floor32(arg3.length) + ceil32(arg3.length) + ceil32(arg4.length) + -(arg3.length % 32) + 1284 len arg3.length % 32]
        mem[floor32(arg3.length) + ceil32(arg3.length) + ceil32(arg4.length) + 1284] = arg4.length
        mem[floor32(arg3.length) + ceil32(arg3.length) + ceil32(arg4.length) + 1316 len ceil32(arg4.length)] = arg4[all], mem[ceil32(arg3.length) + arg4.length + 160 len ceil32(arg4.length) - arg4.length]
        if not arg4.length % 32:
            require ext_code.size(0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477)
            delegate 0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477.0x8a076830 with:
                 gas gas_remaining wei
                args 0, (6 * arg1) + 14, arg2 << 248, 672, floor32(arg3.length) + 736, arg5, arg6, arg7, address(arg8), call.data[260 len 384], arg3.length, Mask(8 * ceil32(arg3.length), -(8 * ceil32(arg3.length)) + 256, arg3[all], mem[arg3.length + 128 len ceil32(arg3.length) - arg3.length]) << (8 * ceil32(arg3.length)) - 256, mem[(2 * ceil32(arg3.length)) + ceil32(arg4.length) + 1252 len arg4.length + floor32(arg3.length) + -ceil32(arg3.length) + 64]
        else:
            mem[floor32(arg4.length) + floor32(arg3.length) + ceil32(arg3.length) + ceil32(arg4.length) + 1316] = mem[floor32(arg4.length) + floor32(arg3.length) + ceil32(arg3.length) + ceil32(arg4.length) + -(arg4.length % 32) + 1348 len arg4.length % 32]
            require ext_code.size(0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477)
            delegate 0xb74f4fe1c99acc6b3f549aa1820537bd4f4c4477.0x8a076830 with:
                 gas gas_remaining wei
                args 0, (6 * arg1) + 14, arg2 << 248, 672, floor32(arg3.length) + 736, arg5, arg6, arg7, address(arg8), call.data[260 len 384], arg3.length, Mask(8 * ceil32(arg3.length), -(8 * ceil32(arg3.length)) + 256, arg3[all], mem[arg3.length + 128 len ceil32(arg3.length) - arg3.length]) << (8 * ceil32(arg3.length)) - 256, mem[(2 * ceil32(arg3.length)) + ceil32(arg4.length) + 1252 len floor32(arg4.length) + floor32(arg3.length) + -ceil32(arg3.length) + 96]
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return delegate.return_data[0]
...
function sub_98b79716(?) {
    mem[128 len arg1.length] = arg1[all]
    mem[ceil32(arg1.length) + 128] = arg2.length
    mem[ceil32(arg1.length) + 160 len arg2.length] = arg2[all]
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 160] = arg8.length
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 192 len arg8.length] = arg8[all]
    mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + 192] = arg9.length
    mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + 224 len arg9.length] = arg9[all]
    mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + 224 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
    mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + floor32(arg1.length) + -(arg1.length % 32) + 256 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    _42 = sha3(sha3(call.data[arg1 + 36 len floor32(arg1.length)], mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + floor32(arg1.length) + 224 len arg1.length % 32]), 9)
    mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + 224 len floor32(arg2.length)] = call.data[arg2 + 36 len floor32(arg2.length)]
    mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + floor32(arg2.length) + -(arg2.length % 32) + 256 len arg2.length % 32] = mem[ceil32(arg1.length) + -(arg2.length % 32) + floor32(arg2.length) + 192 len arg2.length % 32]
    _73 = sha3(sha3(call.data[arg2 + 36 len floor32(arg2.length)], mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + floor32(arg2.length) + 224 len arg2.length % 32]), 9)
    mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + 224] = 0x9bc3d34600000000000000000000000000000000000000000000000000000000
    mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + 612 len ceil32(arg8.length)] = arg8[all], mem[ceil32(arg1.length) + ceil32(arg2.length) + arg8.length + 192 len ceil32(arg8.length) - arg8.length]
    if not arg8.length % 32:
        mem[arg8.length + ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + 612] = arg9.length
        mem[arg8.length + ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + 644 len ceil32(arg9.length)] = arg9[all], mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + arg9.length + 224 len ceil32(arg9.length) - arg9.length]
        if not arg9.length % 32:
            require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
            delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0x9bc3d346 with:
                 gas gas_remaining wei
                args 0, address(stor[_42].field_0), address(stor[_73].field_0), arg3, arg4, arg5 << 248, arg6, arg7, 352, arg8.length + 384, arg10, arg8.length, Mask(8 * ceil32(arg8.length), -(8 * ceil32(arg8.length)) + 256, arg8[all], mem[ceil32(arg1.length) + ceil32(arg2.length) + arg8.length + 192 len ceil32(arg8.length) - arg8.length]) << (8 * ceil32(arg8.length)) - 256, mem[ceil32(arg1.length) + ceil32(arg2.length) + (2 * ceil32(arg8.length)) + ceil32(arg9.length) + 612 len arg9.length + arg8.length + -ceil32(arg8.length) + 32]
        else:
            mem[floor32(arg9.length) + arg8.length + ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + 644] = mem[floor32(arg9.length) + arg8.length + ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + -(arg9.length % 32) + 676 len arg9.length % 32]
            require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
            delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0x9bc3d346 with:
                 gas gas_remaining wei
                args 0, address(stor[_42].field_0), address(stor[_73].field_0), arg3, arg4, arg5 << 248, arg6, arg7, 352, arg8.length + 384, arg10, arg8.length, Mask(8 * ceil32(arg8.length), -(8 * ceil32(arg8.length)) + 256, arg8[all], mem[ceil32(arg1.length) + ceil32(arg2.length) + arg8.length + 192 len ceil32(arg8.length) - arg8.length]) << (8 * ceil32(arg8.length)) - 256, mem[ceil32(arg1.length) + ceil32(arg2.length) + (2 * ceil32(arg8.length)) + ceil32(arg9.length) + 612 len floor32(arg9.length) + arg8.length + -ceil32(arg8.length) + 64]
    else:
        mem[floor32(arg8.length) + ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + 612] = mem[floor32(arg8.length) + ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + -(arg8.length % 32) + 644 len arg8.length % 32]
        mem[floor32(arg8.length) + ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + 644] = arg9.length
        mem[floor32(arg8.length) + ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + 676 len ceil32(arg9.length)] = arg9[all], mem[ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + arg9.length + 224 len ceil32(arg9.length) - arg9.length]
        if not arg9.length % 32:
            require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
            delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0x9bc3d346 with:
                 gas gas_remaining wei
                args 0, address(stor[_42].field_0), address(stor[_73].field_0), arg3, arg4, arg5 << 248, arg6, arg7, 352, floor32(arg8.length) + 416, arg10, arg8.length, Mask(8 * ceil32(arg8.length), -(8 * ceil32(arg8.length)) + 256, arg8[all], mem[ceil32(arg1.length) + ceil32(arg2.length) + arg8.length + 192 len ceil32(arg8.length) - arg8.length]) << (8 * ceil32(arg8.length)) - 256, mem[ceil32(arg1.length) + ceil32(arg2.length) + (2 * ceil32(arg8.length)) + ceil32(arg9.length) + 612 len arg9.length + floor32(arg8.length) + -ceil32(arg8.length) + 64]
        else:
            mem[floor32(arg9.length) + floor32(arg8.length) + ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + 676] = mem[floor32(arg9.length) + floor32(arg8.length) + ceil32(arg1.length) + ceil32(arg2.length) + ceil32(arg8.length) + ceil32(arg9.length) + -(arg9.length % 32) + 708 len arg9.length % 32]
            require ext_code.size(0x2de4e2d39f003bbbe14b428052d8ba356aef911f)
            delegate 0x2de4e2d39f003bbbe14b428052d8ba356aef911f.0x9bc3d346 with:
                 gas gas_remaining wei
                args 0, address(stor[_42].field_0), address(stor[_73].field_0), arg3, arg4, arg5 << 248, arg6, arg7, 352, floor32(arg8.length) + 416, arg10, arg8.length, Mask(8 * ceil32(arg8.length), -(8 * ceil32(arg8.length)) + 256, arg8[all], mem[ceil32(arg1.length) + ceil32(arg2.length) + arg8.length + 192 len ceil32(arg8.length) - arg8.length]) << (8 * ceil32(arg8.length)) - 256, mem[ceil32(arg1.length) + ceil32(arg2.length) + (2 * ceil32(arg8.length)) + ceil32(arg9.length) + 612 len floor32(arg9.length) + floor32(arg8.length) + -ceil32(arg8.length) + 96]
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
}
...
function sub_e1d87b7c(?) {
    ...
    if not arg2.length % 32:
        ...
        if not arg3.length % 32:
            ...
            if not arg4.length % 32:
                require ext_code.size(0x34572a36960e64aa2b7037232be356e93647c6e9)
                delegate 0x34572a36960e64aa2b7037232be356e93647c6e9.0xe8a3ba35 with:
                     gas gas_remaining wei
...
function sub_aba21009(?) {
    mem[96 len 384] = code.data[21111 len 384]
    require arg1 < 2
    require arg2 < stor18[arg1]
