...
function _fallback() payable {
    ...
    address(stor2.field_24) = msg.sender
    stor2.field_256 % 1 = 0
    require address(stor2.field_24) == msg.sender
    uint8(stor2.field_0) = 1
    emit ContractEnabled()
    return code.data[196 len 4597]
}
...
function enableGeneration() {
    require owner == msg.sender
    uint8(stor2.field_16) = 1
    emit TokenGenerationEnabled()
}

function disableGeneration() {
    require owner == msg.sender
    uint8(stor2.field_16) = 0
    emit TokenGenerationDisabled()
}
...
function _fallback() payable {
    ...
    if not uint8(stor2.field_16):
        ...
        emit PaymentGot(bool(ext_call.success));
}
...
function refund(address arg1, uint256 arg2, uint256 arg3) {
    ...
    emit Refund(address(arg1), arg2, arg3);
}
...
function generateTokens(address arg1, uint256 arg2) {
    ...
    if arg1 == this.address:
        ...
        if balanceOf[address(this.address)] >= arg2:
            if stor3 == msg.sender:
                allowance[address(this.address)][address(arg1)] = arg2
                if balanceOf[address(this.address)] >= arg2:
                    if allowance[address(this.address)][address(arg1)] >= arg2:
                        if arg2 > 0:
                            if balanceOf[address(arg1)] + arg2 > balanceOf[address(arg1)]:
            ...
            if stor3 == msg.sender:
                ...
                if balanceOf[address(this.address)] >= balanceOf[address(this.address)]:
                    if allowance[address(this.address)][address(arg1)] >= balanceOf[address(this.address)]:
