...
function getBag(uint256 arg1) {
    require arg1 < stor3.length
    require timeout + stor3[arg1].field_768 >= stor3[arg1].field_768
    require timeout + stor3[arg1].field_768 >= stor3[arg1].field_768
    require timeout + stor3[arg1].field_768 >= stor3[arg1].field_768
    if block.timestamp > timeout + stor3[arg1].field_768:
        if block.timestamp > timeout + stor3[arg1].field_768:
            if block.timestamp > timeout + stor3[arg1].field_768:
                require timeout + stor3[arg1].field_768 >= stor3[arg1].field_768
                if block.timestamp > timeout + stor3[arg1].field_768:
                    ...
                    while idx < 1:
                        if not s:
                            ...
                            s = 0
                            continue 
                        require stor3[arg1].field_512 * s / s == stor3[arg1].field_512
                        idx = idx + 1
                        s = stor3[arg1].field_512 * s / 100
                        continue 
                else:
                    ...
                    while idx < stor3[arg1].field_256 + 1:
                        ...
                        s = stor3[arg1].field_512 * s / 100
                        continue 
                return contractOwner, startingPrice, s, 0, stor3[arg1].field_512, stor3[arg1].field_768
            idx = 0
            s = startingPrice
            ...
            if block.timestamp > timeout + stor3[arg1].field_768:
                ...
                while idx < 1:
                    if not t:
                        ...
                        t = 0
                        continue 
                    require stor3[arg1].field_512 * t / t == stor3[arg1].field_512
                    idx = idx + 1
                    t = stor3[arg1].field_512 * t / 100
                    continue 
            else:
                require stor3[arg1].field_256 + 1 >= stor3[arg1].field_256
                idx = 0
                ...
                while idx < stor3[arg1].field_256 + 1:
                    ...
                    t = stor3[arg1].field_512 * t / 100
                    continue 
            return contractOwner, s, t, 0, stor3[arg1].field_512, stor3[arg1].field_768
        if block.timestamp > timeout + stor3[arg1].field_768:
            require timeout + stor3[arg1].field_768 >= stor3[arg1].field_768
            if block.timestamp > timeout + stor3[arg1].field_768:
                idx = 0
                ...
                while idx < stor3[arg1].field_256 + 1:
                    ...
                    s = stor3[arg1].field_512 * s / 100
                    continue 
            return contractOwner, startingPrice, s, stor3[arg1].field_256, stor3[arg1].field_512, stor3[arg1].field_768
        idx = 0
        s = startingPrice
        while idx < stor3[arg1].field_256:
            if not s:
        ...
        if block.timestamp > timeout + stor3[arg1].field_768:
            ...
            while idx < stor3[arg1].field_256 + 1:
                ...
                t = stor3[arg1].field_512 * t / 100
                continue 
        return contractOwner, s, t, stor3[arg1].field_256, stor3[arg1].field_512, stor3[arg1].field_768
    if block.timestamp > timeout + stor3[arg1].field_768:
        if block.timestamp > timeout + stor3[arg1].field_768:
            require timeout + stor3[arg1].field_768 >= stor3[arg1].field_768
            if block.timestamp > timeout + stor3[arg1].field_768:
...
function purchase(uint256 arg1) payable {
    ...
    if block.timestamp < timeout + stor3[arg1].field_768:
        ...
        if block.timestamp > timeout + stor3[arg1].field_768:
            ...
            require timeout + stor3[arg1].field_768 >= stor3[arg1].field_768
            if block.timestamp > timeout + stor3[arg1].field_768:
                emit BagSold(arg1, stor3[arg1].field_512, startingPrice, startingPrice, contractOwner, msg.sender);
            else:
                idx = 0
                s = startingPrice
                while idx < stor3[arg1].field_256:
                    ...
                    s = stor3[arg1].field_512 * s / 100
                    continue 
                emit BagSold(arg1, stor3[arg1].field_512, startingPrice, s, contractOwner, msg.sender);
            call msg.sender with:
               value msg.value - startingPrice wei
                 gas 2300 * is_zero(value) wei
        else:
            ...
            require timeout + stor3[arg1].field_768 >= stor3[arg1].field_768
            if block.timestamp > timeout + stor3[arg1].field_768:
                emit BagSold(arg1, stor3[arg1].field_512, s, startingPrice, contractOwner, msg.sender);
            else:
                idx = 0
                t = startingPrice
                while idx < stor3[arg1].field_256:
                    ...
                    t = stor3[arg1].field_512 * t / 100
                    continue 
                emit BagSold(arg1, stor3[arg1].field_512, s, t, contractOwner, msg.sender);
            call msg.sender with:
               value msg.value - s wei
                 gas 2300 * is_zero(value) wei
    if not ext_call.success:
