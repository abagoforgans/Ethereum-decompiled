...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 4000000000 * 10^18
    stor2 = 4000000000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 14
    stor3.length.field_8 = 'XfiniteUtility' / 256
    idx = 0
