...
function _fallback() payable {
    ...
    stor0 = code.data[1962 len 20]
    stor1 = 10^18 * code.data[1982 len 32]
    stor3 = (24 * 3600 * code.data[2014 len 32]) + block.timestamp
    stor4 = 10^15 * code.data[2046 len 32]
    stor5 = code.data[2090 len 20]
    return code.data[225 len 1725]
}
...
function _fallback() payable {
    ...
    require (10^18 * msg.value) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
    balanceOf[address(msg.sender)] += 10^18 * msg.value
    require (10^18 * msg.value) + sub_5a170a3c >= sub_5a170a3c
    sub_5a170a3c += 10^18 * msg.value
    require price
    ...
    emit FundTransfer(msg.sender, 10^18 * msg.value, 1);
}
