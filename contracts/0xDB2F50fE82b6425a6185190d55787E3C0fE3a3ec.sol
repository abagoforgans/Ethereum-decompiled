...
function _fallback() payable {
    ...
    stor6.length.field_8 = 'NPC1.0' / 256
    idx = 0
    ...
    stor3.length.field_8 = 'Not For Profit Coin' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'NPC' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[555 len 4066]
}
