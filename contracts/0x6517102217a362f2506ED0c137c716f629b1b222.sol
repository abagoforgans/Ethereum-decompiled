...
const _fallback = code.data[19 len 2290]
    ...
    if not arg2.length:
        ...
        if not sub_15853113.length:
            ...
            while sub_39bfc4a1[address(arg1)][stor2].field_256 + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
            require var17001 < sub_15853113[address(arg1)].field_0
            if not stor[var19001 + sha3(var19002)]:
            # nil
        else:
            s = 0
            idx = 0
            ...
            while sub_39bfc4a1[address(arg1)][stor2].field_256 + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
            require var21001 < sub_15853113[address(arg1)].field_0
            if not stor[var23001 + sha3(var23002)]:
            # nil
    else:
        s = 0
        idx = 128
        while arg2.length + 128 > idx:
            sub_15853113[s].field_0 = mem[idx]
            s = s + 1
            idx = idx + 32
            continue 
        ...
        if not sub_15853113.length:
            ...
            while sub_39bfc4a1[address(arg1)][stor2].field_256 + 31 / 32 > idx:
                ...
                idx = idx + 1
                continue 
            require var25001 < sub_15853113[address(arg1)].field_0
            if not stor[var27001 + sha3(var27002)]:
            # nil
}
