...
function sub_413781d2(?) payable {
    ...
    while objective.length + 96 > idx + 32:
        ...
        s = s + 1
        continue 
    require sha3(mem[mem[64] len objective.length + -mem[64] + 96]) == sha3(arg2[all])
    ...
    mem[arg1.length + mem[64] + 32 len arg2.length] = arg2[all]
    mem[arg2.length + arg1.length + _321 + 32] = address(arg3)
    mem[arg2.length + arg1.length + _321 + 52] = arg4
    mem[arg2.length + arg1.length + _321 + 84] = address(arg5)
    mem[arg2.length + arg1.length + _321 + 104] = address(arg6)
    mem[arg2.length + arg1.length + _321 + 124] = arg7
    mem[arg2.length + arg1.length + _321 + 156] = arg8
    mem[arg2.length + arg1.length + _321 + 188] = ext_call.return_data[0]
    mem[arg2.length + arg1.length + _321 + 220] = address(arg9)
    _322 = mem[64]
    mem[mem[64]] = arg2.length + arg1.length + _321 + -mem[64] + 208
    mem[64] = arg2.length + arg1.length + _321 + 240
    sub_699373ca = sha3(mem[_322 + 32 len mem[_322]])
    mem[arg2.length + arg1.length + _321 + 272 len arg10.length] = arg10[all]
    mem[arg2.length + arg1.length + _321 + arg10.length + 272] = 0
    mem[arg2.length + arg1.length + _321 + ceil32(arg10.length) + 304] = '\x19Ethereum Signed Message:\n32'
    mem[arg2.length + arg1.length + _321 + ceil32(arg10.length) + 332] = sub_699373ca
    mem[arg2.length + arg1.length + _321 + ceil32(arg10.length) + 272] = 60
    if arg10.length != 65:
        promisorAddress = 0
        require 0 == arg9
    else:
        if Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 336, ('cd', ('add', 4, ('param', 'arg2'))), ('cd', ('add', 4, ('param', 'arg1'))), ('var', '_321')), 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 336, ('cd', ('add', 4, ('param', 'arg2'))), ('cd', ('add', 4, ('param', 'arg1'))), ('var', '_321')), 32))), 0) - 256 >= 27:
            promisorAddress = 0
            require 0 == arg9
        else:
            if 27 == uint8((Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 336, ('cd', ('add', 4, ('param', 'arg2'))), ('cd', ('add', 4, ('param', 'arg1'))), ('var', '_321')), 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 336, ('cd', ('add', 4, ('param', 'arg2'))), ('cd', ('add', 4, ('param', 'arg1'))), ('var', '_321')), 32))), 0) - 256) + 27):
                signer = erecover(sha3(mem[arg2.length + arg1.length + _321 + ceil32(arg10.length) + 304 len Mask(8 * -ceil32(arg10.length) + arg10.length + 32, 0, 0), mem[arg2.length + arg1.length + _321 + arg10.length + 304 len -arg10.length + ceil32(arg10.length)]]), (Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 336, ('cd', ('add', 4, ('param', 'arg2'))), ('cd', ('add', 4, ('param', 'arg1'))), ('var', '_321')), 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 336, ('cd', ('add', 4, ('param', 'arg2'))), ('cd', ('add', 4, ('param', 'arg1'))), ('var', '_321')), 32))), 0) - 256) + 27 << 248, mem[arg2.length + arg1.length + _321 + 272], mem[arg2.length + arg1.length + _321 + 304]) 
                if not erecover.result:
                    revert with ext_call.return_data[0 len return_data.size]
                promisorAddress = address(signer)
                require address(signer) == arg9
            else:
                if uint8((Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 336, ('cd', ('add', 4, ('param', 'arg2'))), ('cd', ('add', 4, ('param', 'arg1'))), ('var', '_321')), 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 336, ('cd', ('add', 4, ('param', 'arg2'))), ('cd', ('add', 4, ('param', 'arg1'))), ('var', '_321')), 32))), 0) - 256) + 27) != 28:
                    promisorAddress = 0
                    require 0 == arg9
                else:
                    signer = erecover(sha3(mem[arg2.length + arg1.length + _321 + ceil32(arg10.length) + 304 len Mask(8 * -ceil32(arg10.length) + arg10.length + 32, 0, 0), mem[arg2.length + arg1.length + _321 + arg10.length + 304 len -arg10.length + ceil32(arg10.length)]]), (Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 336, ('cd', ('add', 4, ('param', 'arg2'))), ('cd', ('add', 4, ('param', 'arg1'))), ('var', '_321')), 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', ('add', 336, ('cd', ('add', 4, ('param', 'arg2'))), ('cd', ('add', 4, ('param', 'arg1'))), ('var', '_321')), 32))), 0) - 256) + 27 << 248, mem[arg2.length + arg1.length + _321 + 272], mem[arg2.length + arg1.length + _321 + 304]) 
