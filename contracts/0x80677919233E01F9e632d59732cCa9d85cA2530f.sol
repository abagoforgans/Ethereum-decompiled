...
function _fallback() {
    stor0 = msg.sender
    stor2 = 30000000000 * 10^18
    stor1[address(msg.sender)] = 30000000000 * 10^18
    emit Transfer(30000000000 * 10^18, 0, msg.sender);
    return code.data[146 len 3031]
}
...
const name = 'Ancestor Hell Notes'
...
function multiSendFrom(address arg1, address[] arg2, uint256[] arg3) {
    ...
    while uint8(idx) < arg2.length:
        ...
        require mem[(32 * uint8(idx)) + (32 * arg2.length) + 160] + balanceOf[mem[(32 * uint8(idx)) + 140 len 20]] >= balanceOf[mem[(32 * uint8(idx)) + 140 len 20]]
        balanceOf[address(mem[(32 * uint8(idx)) + 128])] = mem[(32 * uint8(idx)) + (32 * arg2.length) + 160] + balanceOf[mem[(32 * uint8(idx)) + 140 len 20]]
        require mem[(32 * uint8(idx)) + (32 * arg2.length) + 160] <= allowance[address(arg1)][address(msg.sender)]
        mem[0] = msg.sender
