...
function _fallback() {
    stor1 = code.data[12371 len 20]
    return code.data[83 len 12276]
}
...
function updateContract(address arg1) {
    ...
    call sub_64beff2fAddress.0xf851a440 with:
         gas gas_remaining - 710 wei
    require ext_call.success
...
function calculateFee(uint256 arg1, uint256 arg2) {
    require arg2 + 1000
    if 10000 * arg1 / arg2 + 1000 * arg2 / 1000 % 10 <= 4:
        return (10000 * arg1 / arg2 + 1000 * arg2 / 1000 / 10)
    return ((10000 * arg1 / arg2 + 1000 * arg2 / 1000 / 10) + 1)
}
...
function sub_8ed8e314(?) {
    ...
    call address(dbAddress).0xf49e050b with:
        ...
        args arg1
    require ext_call.success
    return ext_call.return_data[0] and 2^uint8(arg3 + (24 * arg2)) != 0
}
...
function sub_7a2ac2ce(?) payable {
    emit 0x59f76c33: 'Just before start method kick in', arg1
    require ext_code.size(address(dbAddress))
    ...
    emit 0x59f76c33: Array(len=22, data='The first check passed'), arg1
    require ext_code.size(sub_64beff2fAddress)
    call sub_64beff2fAddress.0xa8bfd465 with:
         gas gas_remaining - 710 wei
    ...
    if 1 == uint8(ext_call.return_data[0]):
        ...
        require ext_call.success
        emit 0x59f76c33: 'After calculating charging costs', arg1
        if ext_call.return_data[0]:
            ...
            require ext_call.success
            require ext_call.return_data[0]
        emit 0x59f76c33: Array(len=48, data='After the transfer occurs, befor', 'e setting the DB'), arg1
        require ext_code.size(address(dbAddress))
...
function sub_723d3605(?) {
    ...
    if uint32(block.timestamp - ext_call.return_data[156 len 4]) > ext_call.return_data[188 len 4]:
        ...
        require ext_call.success
        require ext_call.return_data[28 len 4] + 1000
        if 10000 * ext_call.return_data[0] / ext_call.return_data[28 len 4] + 1000 * ext_call.return_data[28 len 4] / 1000 % 10 <= 4:
            if 10000 * ext_call.return_data[0] / ext_call.return_data[28 len 4] + 1000 * ext_call.return_data[28 len 4] / 1000 / 10 <= ext_call.return_data[0]:
                if 10000 * ext_call.return_data[0] / ext_call.return_data[28 len 4] + 1000 * ext_call.return_data[28 len 4] / 1000 / 10 <= 0:
                    if ext_call.return_data[0] > 10000 * ext_call.return_data[0] / ext_call.return_data[28 len 4] + 1000 * ext_call.return_data[28 len 4] / 1000 / 10:
                        require ext_code.size(address(ext_call.return_data[0]))
                        call address(ext_call.return_data[0]).0xa9059cbb with:
                             gas gas_remaining - 710 wei
                            args address(ext_call.return_data[0]), ext_call.return_data[0] - (10000 * ext_call.return_data[0] / uint32(ext_call.return_data[0]) + 1000 * uint32(ext_call.return_data[0]) / 1000 / 10)
                        require ext_call.success
                        require ext_call.return_data[0]
                else:
                    require ext_code.size(address(ext_call.return_data[0]))
                    call address(ext_call.return_data[0]).0xa9059cbb with:
                         gas gas_remaining - 710 wei
                        args address(ext_call.return_data[32]), 10000 * ext_call.return_data[0] / uint32(ext_call.return_data[0]) + 1000 * uint32(ext_call.return_data[0]) / 1000 / 10
                    require ext_call.success
                    require ext_call.return_data[0]
                    if ext_call.return_data[0] > 10000 * ext_call.return_data[0] / uint32(ext_call.return_data[0]) + 1000 * uint32(ext_call.return_data[0]) / 1000 / 10:
                        require ext_code.size(address(ext_call.return_data[0]))
                        call address(ext_call.return_data[0]).0xa9059cbb with:
                             gas gas_remaining - 710 wei
                            args address(ext_call.return_data[0]), ext_call.return_data[0] - (10000 * ext_call.return_data[0] / uint32(ext_call.return_data[0]) + 1000 * uint32(ext_call.return_data[0]) / 1000 / 10)
            ...
            if (10000 * ext_call.return_data[0] / ext_call.return_data[28 len 4] + 1000 * ext_call.return_data[28 len 4] / 1000 / 10) + 1 <= ext_call.return_data[0]:
                if (10000 * ext_call.return_data[0] / ext_call.return_data[28 len 4] + 1000 * ext_call.return_data[28 len 4] / 1000 / 10) + 1 <= 0:
                    if ext_call.return_data[0] > (10000 * ext_call.return_data[0] / ext_call.return_data[28 len 4] + 1000 * ext_call.return_data[28 len 4] / 1000 / 10) + 1:
                        require ext_code.size(address(ext_call.return_data[0]))
                        call address(ext_call.return_data[0]).0xa9059cbb with:
                             gas gas_remaining - 710 wei
                            args address(ext_call.return_data[0]), ext_call.return_data[0] + -(10000 * ext_call.return_data[0] / uint32(ext_call.return_data[0]) + 1000 * uint32(ext_call.return_data[0]) / 1000 / 10) - 1
                        require ext_call.success
                        require ext_call.return_data[0]
                else:
                    require ext_code.size(address(ext_call.return_data[0]))
                    call address(ext_call.return_data[0]).0xa9059cbb with:
                         gas gas_remaining - 710 wei
                        args address(ext_call.return_data[32]), (10000 * ext_call.return_data[0] / uint32(ext_call.return_data[0]) + 1000 * uint32(ext_call.return_data[0]) / 1000 / 10) + 1
                    require ext_call.success
                    require ext_call.return_data[0]
                    if ext_call.return_data[0] > (10000 * ext_call.return_data[0] / uint32(ext_call.return_data[0]) + 1000 * uint32(ext_call.return_data[0]) / 1000 / 10) + 1:
                        require ext_code.size(address(ext_call.return_data[0]))
                        call address(ext_call.return_data[0]).0xa9059cbb with:
                             gas gas_remaining - 710 wei
                            args address(ext_call.return_data[0]), ext_call.return_data[0] + -(10000 * ext_call.return_data[0] / uint32(ext_call.return_data[0]) + 1000 * uint32(ext_call.return_data[0]) / 1000 / 10) - 1
