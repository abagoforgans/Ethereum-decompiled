...
function signer() {
    return address(stor[sha3('threelab.wallet.signer')].field_0)
}
...
function init(address arg1) payable {
    require calldata.size - 4 >= 32
    if address(stor[sha3('threelab.wallet.signer')].field_0):
        revert with 0, 'Signer already defined'
    address(stor[sha3('threelab.wallet.signer')].field_0) = arg1
    Mask(96, 0, stor[sha3('threelab.wallet.signer')].field_160) = 0
}
...
function cancel(bytes32 arg1) {
    ...
    if address(relayedBy[arg1]):
        revert with 0, 'Meta-tx already relayed'
    if Mask(256, -255, uint256(relayedBy[arg1])):
        revert with 0, 'Meta-tx was canceled'
...
function sub_ed3d9e17(?) payable {
    ...
    if uint256(relayedBy[this.address][arg1][sha3(arg2[all])]):
        ...
        if Mask(256, -255, uint256(relayedBy[this.address][arg1][sha3(arg2[all])])):
            revert with 0, 'Meta-tx was canceled'
        revert with 0, 'Unknown error'
    if 0x9431bab00000000000000000000000039bd955c9 == address(stor[sha3('threelab.wallet.signer')].field_0):
        revert with 0, 'Signer is not a valid address'
    if msg.sender == address(stor[sha3('threelab.wallet.signer')].field_0):
        ...
        if address(stor[sha3('threelab.wallet.signer')].field_0) != address(signer):
