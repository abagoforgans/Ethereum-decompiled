...
function distributeAmounts(address[] arg1, uint256[] arg2) {
    ...
    while uint8(idx) < arg1.length:
        ...
        require mem[(32 * arg1.length) + (32 * uint8(idx)) + 160] <= totalRemaining
        ...
        emit Distr(mem[(32 * arg2.length) + (32 * arg1.length) + 160], address(_23));
        mem[(32 * arg2.length) + (32 * arg1.length) + 160] = _25
