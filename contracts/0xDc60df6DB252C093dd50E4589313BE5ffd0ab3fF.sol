...
function bet() payable {
    ...
    stor0 = block.number
    stor1 = block.hash(block.number - 1) + (ext_call.return_data[32] % block.timestamp) + (block.number * block.timestamp * block.difficulty) + 1 % 0x36ce80b791850e292b0f092bb007da906561520482
    idx = 10010
    while idx > 1000:
        if stor1 % idx != 0:
            idx = idx - 1
