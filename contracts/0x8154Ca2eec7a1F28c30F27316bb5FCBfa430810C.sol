...
function sub_3471f9cd(?) payable {
    if arg1 < stor1.length:
        return stor1[arg1], isValid[stor1[arg1]].field_256, uint8(isValid[stor1[arg1]].field_512)
    else:
        return 0
}
...
function addDocument(bytes32 arg1) payable {
    ...
    isValid[arg1].field_256 = block.timestamp
    uint8(isValid[arg1].field_512) = 1
