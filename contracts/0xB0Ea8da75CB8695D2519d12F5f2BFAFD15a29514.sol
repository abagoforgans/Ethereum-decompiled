...
function _fallback() payable {
    ...
    stor11.length.field_8 = 'GC.7' / 256
    idx = 0
    ...
    stor7 = msg.sender
    stor8 = code.data[5194 len 20]
    stor0 = 15 * 10^6
    stor1[stor8] = 3 * 10^6
    emit code.data[5150 len 32]: 3 * 10^6, 0, code.data[5194 len 20]
    stor1[address(this.address)] = 12 * 10^6
    emit code.data[5150 len 32]: 12 * 10^6, 0, this.address
    stor6 = 12 * 10^6
    stor5 = 419657 * 3600
    return code.data[767 len 4383]
}
...
function _fallback() payable {
    ...
    if block.timestamp > startTime + (672 * 24 * 3600):
        require (msg.value / 5 * 10^15) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
        balanceOf[address(msg.sender)] += msg.value / 5 * 10^15
        require msg.value / 5 * 10^15 <= balanceOf[this.address]
        balanceOf[address(this.address)] = balanceOf[this.address] - (msg.value / 5 * 10^15)
        ...
        if block.timestamp > startTime + (504 * 24 * 3600):
            require (msg.value / 4 * 10^15) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
            balanceOf[address(msg.sender)] += msg.value / 4 * 10^15
            require msg.value / 4 * 10^15 <= balanceOf[this.address]
            balanceOf[address(this.address)] = balanceOf[this.address] - (msg.value / 4 * 10^15)
            require msg.value + stor4 >= stor4
            stor4 += msg.value
            ...
            if block.timestamp > startTime + (336 * 24 * 3600):
                require (msg.value / 25 * 10^14) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
                balanceOf[address(msg.sender)] += msg.value / 25 * 10^14
                require msg.value / 25 * 10^14 <= balanceOf[this.address]
                balanceOf[address(this.address)] = balanceOf[this.address] - (msg.value / 25 * 10^14)
                require msg.value + stor4 >= stor4
                stor4 += msg.value
                ...
                if block.timestamp <= startTime + (168 * 24 * 3600):
                    require (msg.value / 16 * 10^14) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
                    balanceOf[address(msg.sender)] += msg.value / 16 * 10^14
                    require msg.value / 16 * 10^14 <= balanceOf[this.address]
                    balanceOf[address(this.address)] = balanceOf[this.address] - (msg.value / 16 * 10^14)
                    require msg.value + stor4 >= stor4
                    stor4 += msg.value
                    ...
                    require (msg.value / 2 * 10^15) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
                    balanceOf[address(msg.sender)] += msg.value / 2 * 10^15
                    require msg.value / 2 * 10^15 <= balanceOf[this.address]
                    balanceOf[address(this.address)] = balanceOf[this.address] - (msg.value / 2 * 10^15)
                    require msg.value + stor4 >= stor4
                    stor4 += msg.value
