...
const TOKEN_NAME = 'Mansio'

const TOKEN_SYMBOL = 'MNSO'

const TOKEN_DECIMAL_MULTIPLIER = 100

const TOKEN_DECIMALS = 2

const TARGET_USER = 0xcc29a679222f79c4fc32bd6ff1482d809e94cc2

const PAUSED = 0

const TOKEN_DECIMALS_UINT8 = 2
