...
function _fallback() payable {
    ...
    stor17 = msg.sender
    stor15[address(msg.sender)] = stor4
    stor5 = block.timestamp
    stor6 = block.timestamp + (168 * 24 * 3600)
    return code.data[478 len 5025]
}
...
function transferOwnership(address arg1) {
    if owner == msg.sender:
        balanceOf[arg1] = balanceOf[stor17]
        balanceOf[stor17] = 0
        owner = arg1
}
...
function startICO() {
    if owner == msg.sender:
        ...
        stor8 = block.timestamp + (744 * 24 * 3600)
        stor5 = 0
        stor6 = 0
}
