...
function rejectMint(uint256 arg1, uint256 arg2) {
    ...
    require pendingMints[arg1].field_512 + rejectedMintBalance[stor9[arg1].field_0] >= rejectedMintBalance[stor9[arg1].field_0]
    rejectedMintBalance[stor9[arg1].field_0] += pendingMints[arg1].field_512
...
function buyTokens(address arg1) payable {
    ...
    require msg.value
    if not msg.value:
        pendingMints[stor10].field_0 = arg1
        pendingMints[stor10].field_256 = 0
        pendingMints[stor10].field_512 = msg.value
        emit ContributionRegistered(address(arg1), 0, msg.value, currentMintNonce);
    else:
        require rate * msg.value / msg.value == rate
        pendingMints[stor10].field_0 = arg1
        pendingMints[stor10].field_256 = rate * msg.value
        pendingMints[stor10].field_512 = msg.value
...
function _fallback() payable {
    ...
    require msg.value
    if not msg.value:
        pendingMints[stor10].field_0 = msg.sender
        pendingMints[stor10].field_256 = 0
        pendingMints[stor10].field_512 = msg.value
...
function bulkRejectMints(uint256[] arg1, uint256[] arg2) payable {
    ...
    while idx < arg1.length:
        ...
        require pendingMints[cd[((32 * idx) + arg1 + 36)]].field_512 + rejectedMintBalance[stor9[cd[((32 * idx) + arg1 + 36)]].field_0] >= rejectedMintBalance[stor9[cd[((32 * idx) + arg1 + 36)]].field_0]
        rejectedMintBalance[stor9[cd[((32 * idx) + arg1 + 36)]].field_0] += pendingMints[cd[((32 * idx) + arg1 + 36)]].field_512
        mem[32] = 9
