...
function _fallback() payable {
    stor0 = code.data[2580 len 32]
    return code.data[55 len 2525]
}
...
function sub_e218e6d2(?) payable {
    ...
    call address(ext_call.return_data[0]).0x461b09c0 with:
         gas gas_remaining - 25050 wei
        args 2, address(signer), ext_call.return_data[0] - arg3 - arg4
    call address(sub_516c4b84Address).0x13c01368 with:
         gas gas_remaining - 25050 wei
        args 1
    call address(ext_call.return_data[0]).0x295f36d7 with:
    ...
    call address(ext_call.return_data[0]).0x461b09c0 with:
         gas gas_remaining - 25050 wei
        args 2, address(arg2), ext_call.return_data[0] + arg3
    ...
    if arg4 > 0:
        ...
        call address(ext_call.return_data[0]).0x461b09c0 with:
             gas gas_remaining - 25050 wei
            args 2, address(arg6), ext_call.return_data[0] + arg4
...
function sub_05bafaa4(?) payable {
    ...
    while idx < arg1:
        ...
        call address(ext_call.return_data[0]).0x461b09c0 with:
             gas gas_remaining - 25050 wei
            args 2, address(signer), ext_call.return_data[0] - _224 - _225
        call address(sub_516c4b84Address).0x13c01368 with:
             gas gas_remaining - 25050 wei
            args 1
        call address(ext_call.return_data[0]).0x295f36d7 with:
        ...
        call address(ext_call.return_data[0]).0x461b09c0 with:
             gas gas_remaining - 25050 wei
            args 2, address(_223), ext_call.return_data[0] + _224
        mem[mem[64]] = _224
        ...
        if _225 > 0:
            ...
            call address(ext_call.return_data[0]).0x461b09c0 with:
                 gas gas_remaining - 25050 wei
                args 2, address(arg3), ext_call.return_data[0] + _225
            mem[mem[64]] = _225
