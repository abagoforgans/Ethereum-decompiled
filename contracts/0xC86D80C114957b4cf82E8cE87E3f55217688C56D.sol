...
function _fallback() payable {
    mem[96 len -1018] = code.data[1480 len -1018]
    mem[64] = -922
...
function Mint(uint256 arg1) payable {
    if arg1 == quota:
        quota++
        balanceOf[address(msg.sender)] = (100 * quota) + balanceOf[address(msg.sender)] + 100
        balanceOf[this.address] += -100 * quota
        emit Transfer(quota, this.address, msg.sender);
}
