...
function ecverify(bytes32 arg1, bytes arg2, address arg3) {
    require ext_code.size(0x9c79a8ccf5eaf4a9ae3fc80f4e79b834e7adf0a8)
    delegate 0x9c79a8ccf5eaf4a9ae3fc80f4e79b834e7adf0a8.recover(bytes32 arg1, bytes arg2) with:
         gas gas_remaining wei
...
function sub_2c3feff0(?) {
    ...
    mem[ceil32(arg1.length) + floor32(arg1.length) + -(arg1.length % 32) + 175 len arg1.length % 32] = mem[floor32(arg1.length) + -(arg1.length % 32) + 160 len arg1.length % 32]
    mem[arg1.length + ceil32(arg1.length) + 143] = ' '
...
function unpauseRedemption() {
    mem[171 len 0] = None
    mem[171 len 27] = Mask(216, 40, Mask(168, 0, 'access.role'), mem[192 len 6], 0) >> 40
    mem[171 len 0] = 0
    require ext_code.size(stor0)
    call stor0.getBool(bytes32 arg1) with:
         gas gas_remaining wei
...
function backofficeRedeem(uint256 arg1) {
    ...
    require 0 == arg1 % 10^uint8(ext_call.return_data[0])
    require 10^uint8(ext_call.return_data[0]) >= 10
    require 10^uint8(ext_call.return_data[0])
...
function sub_52858d2f(?) {
    ...
    mem[ceil32(arg2.length) + floor32(arg2.length) + -(arg2.length % 32) + 175 len arg2.length % 32] = mem[floor32(arg2.length) + -(arg2.length % 32) + 160 len arg2.length % 32]
    mem[arg2.length + ceil32(arg2.length) + 143] = ' '
    mem[arg2.length + ceil32(arg2.length) + 144] = 'amount:'
    mem[arg2.length + ceil32(arg2.length) + 151] = arg3
    _192 = sha3('redemptionOrder', mem[ceil32(arg2.length) + 143 len 17], uint32(sha3('token.redemptionPaused')), mem[ceil32(arg2.length) + 164 len arg2.length + 19])
    mem[ceil32(arg2.length) + 128] = 'redemptionOrder'
    mem[ceil32(arg2.length) + 143 len floor32(arg2.length)] = call.data[arg2 + 36 len floor32(arg2.length)]
    mem[ceil32(arg2.length) + floor32(arg2.length) + -(arg2.length % 32) + 175 len arg2.length % 32] = mem[floor32(arg2.length) + -(arg2.length % 32) + 160 len arg2.length % 32]
    mem[arg2.length + ceil32(arg2.length) + 143] = ' '
    ...
    call stor0.getBool(bytes32 arg1) with:
         gas gas_remaining wei
        args sha3('token.redemptionFulfilled', _192)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require not ext_call.return_data[0]
    ...
    require 10^uint8(ext_call.return_data[0]) >= 10
    require 10^uint8(ext_call.return_data[0])
    require 0 == arg3 % 10^uint8(ext_call.return_data[0])
    require 10^uint8(ext_call.return_data[0]) >= 10
    require 10^uint8(ext_call.return_data[0])
    ...
    call stor0.setBool(bytes32 arg1, bool arg2) with:
         gas gas_remaining wei
        args sha3('token.redemptionFulfilled', _192), 1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit Redemption(arg3, msg.sender, _192);
}
