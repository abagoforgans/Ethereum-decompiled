...
function sub_7831ce79(?) {
    ...
    if ext_call.return_data[0] < _5:
        ...
        if ext_call.return_data[0] < _34:
            ...
            _81 = mem[320]
            require 4 < arg5.length
            _83 = mem[(32 * arg4.length) + 288]
            require 0 < arg6.length
            _85 = mem[(32 * arg4.length) + (32 * arg5.length) + 192]
            require 2 < arg6.length
            _87 = mem[(32 * arg4.length) + (32 * arg5.length) + 256]
            require 8 < arg4.length
            _89 = mem[384]
            ...
            mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 196] = mem[(32 * arg4.length) + 172 len 20]
            mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 260] = address(_75)
            mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 292] = _77
            mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 324] = _79
            mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 356] = _81
            mem[(32 * arg4.length) + (32 * arg5.length) + (32 * arg6.length) + 420] = arg2
            call arg1 with:
               funct Mask(32, 224, sha3('trade(address,uint256,address,ui', 'nt256,uint256,uint256,address,ui', 'nt8,bytes32,bytes32,uint256)')) >> 224
                 gas gas_remaining - 25710 wei
                args mem[(32 * arg4.length) + 172 len 20], mem[128], address(_75), _77, _79, _81, address(_83), arg2 << 248, _85, _87, _89
            require ext_call.success
            require 1 < arg5.length
            require ext_code.size(arg1)
            call arg1.balanceOf(address rg1, address rg2) with:
                 gas gas_remaining - 710 wei
                args address(mem[(32 * arg4.length) + 192]), msg.sender
            require ext_call.success
            require 9 < arg4.length
