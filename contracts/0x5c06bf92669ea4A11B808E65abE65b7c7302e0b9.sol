...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor9 = 0x1a8092dc958ce32cf673d6568d50eaa313fcb2ee
    stor10 = 0x102bd887b86ec7744e14912cb76826b0b6c25f10
    stor13 = stor13^8
    stor14 = stor14^16
    require not stor4
    stor3 += 10000 * stor13
    ...
    stor15 = 50000 * 10^18
    stor7 = 1980198019802000
    stor8 = 0
    return code.data[689 len 7341]
}
...
function _fallback() payable {
    ...
    require not stor4
    total += 11900000 * msg.value / price * stor13 / 10 * 10^6
    balances[address(msg.sender)] += 11900000 * msg.value / price * stor13 / 10 * 10^6
    emit Mint((11900000 * msg.value / price * stor13 / 10 * 10^6), msg.sender);
    if stor17[stor0].field_768 <= lastDivideRewardTime:
        stor17[stor0].field_768 = block.timestamp
        stor17[stor0].field_256 = balances[stor0]
    require not stor4
