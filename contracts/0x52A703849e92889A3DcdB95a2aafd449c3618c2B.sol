...
function _fallback() payable {
    ...
    mem[96 len -2650] = code.data[3010 len -2650]
    mem[64] = -2554
    stor0 = msg.sender
...
function maintenance(uint256 arg1) {
    require owner == msg.sender
    require block.timestamp > stor7 + (720 * 24 * 3600)
    require arg1 <= totalSupply / 10
    stor7 = block.timestamp
    balanceOf[address(msg.sender)] += arg1
    totalSupply += arg1
