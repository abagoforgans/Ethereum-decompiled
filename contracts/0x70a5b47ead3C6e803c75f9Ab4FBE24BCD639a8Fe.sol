...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 5 * 10^11
    stor2 = 5 * 10^11
    bool(stor3.length) = 0
    stor3.length.field_1 = 13
    stor3.length.field_8 = 'Nanofacetoken' / 256
    idx = 0
