...
function isAccountLocked(address arg1) payable {
    require calldata.size - 4 >= 32
    return (lockedAccount[address(arg1)] > block.timestamp)
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    require lockedAccount[address(msg.sender)] <= block.timestamp
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    require lockedAccount[address(arg1)] <= block.timestamp
