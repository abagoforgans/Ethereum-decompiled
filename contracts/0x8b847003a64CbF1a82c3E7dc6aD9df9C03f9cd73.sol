...
function sub_1bb95617(?) payable {
    require arg1 < 10
    return (uint256(stor40[0.03125 / arg1]) / 256^(arg1 % 32) << 248)
}
...
function addressHash(address arg1) payable {
    ...
    while idx < 32:
        require -idx + 31 < 32
        if arg1 % 16 >= 10:
            uint256(stor41[0.03125 / -idx + 31]) = uint8((arg1 % 16) + 87) * 256^(-idx + 31 % 32) or !(255 * 256^(-idx + 31 % 32)) and uint256(stor41[0.03125 / -idx + 31])
        else:
            uint256(stor41[0.03125 / -idx + 31]) = uint8((arg1 % 16) + 48) * 256^(-idx + 31 % 32) or !(255 * 256^(-idx + 31 % 32)) and uint256(stor41[0.03125 / -idx + 31])
        s = arg1 % 16
        idx = idx + 1
        continue 
    t = s
    ...
    while idx < 8:
        if arg1 % 16 >= 10:
            require -idx + 9 < 32
            uint256(stor41[0.03125 / -idx + 9]) = uint8((arg1 % 16) + 87) * 256^(-idx + 9 % 32) or !(255 * 256^(-idx + 9 % 32)) and uint256(stor41[0.03125 / -idx + 9])
        else:
            require -idx + 9 < 10
            uint256(stor40[0.03125 / -idx + 9]) = uint8((arg1 % 16) + 48) * 256^(-idx + 9 % 32) or !(255 * 256^(-idx + 9 % 32)) and uint256(stor40[0.03125 / -idx + 9])
        t = arg1 % 16
        idx = idx + 1
        continue 
    idx = 96
