...
function sub_f3e461a1(?) {
    ...
    return ((10^18 * ext_call.return_data[0] * defaultAmount / 10^18 * 10^18 * 2 * defaultAmount / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * 2 * defaultAmount / 10^18) - (10^18 * 10^18 * defaultAmount / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * defaultAmount / 10^18 * 10^18 * 2 * defaultAmount / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * 2 * defaultAmount / 10^18) / (4 * 10^18 * defaultAmount / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * defaultAmount / 10^18 * ext_call.return_data[0] * defaultAmount / 10^18) - (2 * 10^18 * 2 * defaultAmount / 10^18 * ext_call.return_data[0] / ext_call.return_data[0] * 2 * defaultAmount / 10^18 * ext_call.return_data[0] * defaultAmount / 10^18) / 1000)
}
