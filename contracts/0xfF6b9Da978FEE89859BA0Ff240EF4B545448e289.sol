...
function buyToken(address arg1, uint256 arg2) {
    ...
    if tokenPerETH:
        ...
        if arg2 < 10^16:
            ...
            if arg2 >= 10^17:
                if arg2 >= 10^18:
                    require (100 * arg2 * tokenPerETH / 10^18 / 100) + (arg2 * tokenPerETH / 10^18) >= arg2 * tokenPerETH / 10^18
                    require (100 * arg2 * tokenPerETH / 10^18 / 100) + (arg2 * tokenPerETH / 10^18) <= totalRemaining
                    require not stor10
                    require (100 * arg2 * tokenPerETH / 10^18 / 100) + (arg2 * tokenPerETH / 10^18) + totalDistributed >= totalDistributed
                    totalDistributed = (100 * arg2 * tokenPerETH / 10^18 / 100) + (arg2 * tokenPerETH / 10^18) + totalDistributed
                    require (100 * arg2 * tokenPerETH / 10^18 / 100) + (arg2 * tokenPerETH / 10^18) <= totalRemaining
                    totalRemaining = totalRemaining - (100 * arg2 * tokenPerETH / 10^18 / 100) - (arg2 * tokenPerETH / 10^18)
                    require (100 * arg2 * tokenPerETH / 10^18 / 100) + (arg2 * tokenPerETH / 10^18) + balanceOf[address(arg1)] >= balanceOf[address(arg1)]
                    balanceOf[address(arg1)] = (100 * arg2 * tokenPerETH / 10^18 / 100) + (arg2 * tokenPerETH / 10^18) + balanceOf[address(arg1)]
                    emit Distr(((100 * arg2 * tokenPerETH / 10^18 / 100) + (arg2 * tokenPerETH / 10^18)), arg1);
                    emit Transfer(((100 * arg2 * tokenPerETH / 10^18 / 100) + (arg2 * tokenPerETH / 10^18)), 0, arg1);
                else:
        ...
        if msg.value <= 0:
            ...
            if tokenPerETH:
                ...
                if msg.value < 10^16:
                    ...
                    if msg.value >= 10^17:
                        if msg.value >= 10^18:
                            require (100 * msg.value * tokenPerETH / 10^18 / 100) + (msg.value * tokenPerETH / 10^18) >= msg.value * tokenPerETH / 10^18
                            require (100 * msg.value * tokenPerETH / 10^18 / 100) + (msg.value * tokenPerETH / 10^18) <= totalRemaining
                            require not stor10
                            require (100 * msg.value * tokenPerETH / 10^18 / 100) + (msg.value * tokenPerETH / 10^18) + totalDistributed >= totalDistributed
                            totalDistributed = (100 * msg.value * tokenPerETH / 10^18 / 100) + (msg.value * tokenPerETH / 10^18) + totalDistributed
                            require (100 * msg.value * tokenPerETH / 10^18 / 100) + (msg.value * tokenPerETH / 10^18) <= totalRemaining
                            totalRemaining = totalRemaining - (100 * msg.value * tokenPerETH / 10^18 / 100) - (msg.value * tokenPerETH / 10^18)
                            require (100 * msg.value * tokenPerETH / 10^18 / 100) + (msg.value * tokenPerETH / 10^18) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
                            balanceOf[address(msg.sender)] = (100 * msg.value * tokenPerETH / 10^18 / 100) + (msg.value * tokenPerETH / 10^18) + balanceOf[address(msg.sender)]
                            emit Distr(((100 * msg.value * tokenPerETH / 10^18 / 100) + (msg.value * tokenPerETH / 10^18)), msg.sender);
                            emit Transfer(((100 * msg.value * tokenPerETH / 10^18 / 100) + (msg.value * tokenPerETH / 10^18)), 0, msg.sender);
                        else:
