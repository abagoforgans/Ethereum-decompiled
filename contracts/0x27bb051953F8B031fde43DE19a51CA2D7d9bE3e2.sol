...
function _fallback() payable {
    ...
    stor1 = code.data[7209 len 32]
    stor2 = code.data[7241 len 32]
    stor3 = code.data[7273 len 32]
    emit ChangeOfRules(code.data[7209 len 32], code.data[7241 len 32], code.data[7273 len 32]);
    if stor6[0]:
    ...
    return code.data[1077 len 6132]
}
