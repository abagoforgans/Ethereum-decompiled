...
function detectTransferRestriction(address arg1, address arg2, uint256 arg3) {
    ...
    call address(ext_call.return_data[0]).check(address arg1, address arg2, address arg3, address arg4, uint256 arg5) with:
         gas gas_remaining wei
...
function messageForTransferRestriction(uint8 arg1) {
    ...
    mem[100] = arg1
    require ext_code.size(address(ext_call.return_data[0]))
    call address(ext_call.return_data[0]).messageForReason(uint8 arg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
