...
function getRecord(address arg1) payable {
    return address(time[address(arg1)].field_0), uint256(time[address(arg1)].field_256), address(time[address(arg1)].field_768)
}
...
function getRecordAtIndex(uint256 arg1) payable {
    ...
    return address(stor[code.data[1537 len 32] + arg1]), 
           address(time[address(stor[arg1 + code.data[1537 len 32]])].field_0),
           uint256(time[address(stor[arg1 + code.data[1537 len 32]])].field_256),
           address(time[address(stor[arg1 + code.data[1537 len 32]])].field_768)
}
...
function register(address arg1, address arg2) payable {
    if not uint256(time[address(arg1)].field_256):
        ...
        if not stor3.length <= stor3.length + 1:
            idx = stor3.length + code.data[1537 len 32] + 1
            while code.data[1537 len 32] + stor3.length > idx:
                uint256(stor[idx]) = 0
                idx = idx + 1
                continue 
...
function unregister(address arg1) payable {
    if msg.sender == address(time[address(arg1)].field_0):
        ...
        uint256(time[address(stor[uint256(time[address(arg1)].field_512) + code.data[1537 len 32]])].field_512) = uint256(time[address(arg1)].field_512)
        stor3.length--
        if not stor3.length <= stor3.length - 1:
            idx = stor3.length - 1
