...
uint256 priceLastUpdateRequest;
...
function priceUpdateInterval() {
    return priceUpdateInterval
}

function priceLastUpdateRequest() {
    return priceLastUpdateRequest
}
...
function priceExpired() {
    return (block.timestamp > priceLastUpdate + maxInterval)
}

function setMaxInterval(uint256 arg1) {
...
function updateRequestExpired() {
    return block.timestamp >= priceLastUpdateRequest + maxInterval
}

function setPriceUpdateInterval(uint256 arg1) {
    require msg.sender == owner
    priceUpdateInterval = arg1
}
