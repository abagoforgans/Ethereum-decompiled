...
function verifyReport(uint16 arg1, int8[] arg2, uint32[] arg3) {
    ...
    if 0 < 32 * uint16(stor3.field_16):
        ...
        if 32 * uint16(stor3.field_16) < 64 * uint16(stor3.field_16):
            ...
            _611 = mem[(32 * arg3.length) + (32 * arg2.length) + (64 * uint16(stor3.field_16)) + 448]
            ...
            hash = sha256hash(mem[(32 * arg3.length) + (32 * arg2.length) + (64 * uint16(stor3.field_16)) + (32 * uint32(5 * arg2.length)) + 480 len _611]) 
        ...
        if 0 < 32 * uint16(stor3.field_16):
            ...
            mem[64] = (32 * arg3.length) + (32 * arg2.length) + (32 * uint32(5 * arg2.length)) + 480
            idx = 0
            s = 0
            while uint16(idx) < uint32(arg2.length):
                require uint16(idx) < arg3.length
            ...
            _623 = mem[(32 * arg3.length) + (32 * arg2.length) + 448]
            ...
            hash = sha256hash(mem[(32 * arg3.length) + (32 * arg2.length) + (32 * uint32(5 * arg2.length)) + 480 len _623]) 
        ...
        if 32 * uint16(stor3.field_16) >= 64 * uint16(stor3.field_16):
            ...
            if not uint16(stor3.field_16):
                ...
                if Mask(251, 0, mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + 352]):
                    ...
                    mem[(64 * uint16(stor3.field_16)) + (32 * arg2.length) + (32 * arg1.length) + (32 * uint32(5 * arg1.length)) + 672 len floor32((32 * mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + 352]) - 1)] = mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + 416 len (32 * uint32(5 * arg1.length)) + 32], 0, s << 224, arg1.length << 224, hash, mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + (32 * uint32(5 * arg1.length)) + 576 len floor32((32 * mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + 352]) - 1) + -(32 * uint32(5 * arg1.length)) - 160]
                return Array(len=uint16(stor3.field_0), data=mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + (32 * uint32(5 * arg1.length)) + 608 len (32 * uint16(stor3.field_16)) + (32 * mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + 352]) + 32]), 
            ...
            if Mask(251, 0, mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + 352]):
                mem[(64 * uint16(stor3.field_16)) + (32 * arg2.length) + (32 * arg1.length) + (32 * uint32(5 * arg1.length)) + 640] = mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + 384]
                mem[(64 * uint16(stor3.field_16)) + (32 * arg2.length) + (32 * arg1.length) + (32 * uint32(5 * arg1.length)) + 672 len floor32((32 * mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + 352]) - 1)] = mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + 416 len (32 * uint32(5 * arg1.length)) + 32], 0, s << 224, arg1.length << 224, hash, mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + (32 * uint32(5 * arg1.length)) + 576 len floor32((32 * mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + 352]) - 1) + -(32 * uint32(5 * arg1.length)) - 160]
            return Array(len=uint16(stor3.field_0), data=mem[(32 * arg2.length) + (32 * arg1.length) + 352], mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + (32 * uint32(5 * arg1.length)) + 640 len (32 * uint16(stor3.field_16)) + (32 * mem[(32 * arg2.length) + (32 * arg1.length) + (32 * uint16(stor3.field_16)) + 352])]), 
                   (32 * uint16(stor3.field_16)) + 192,
                   s << 224,
                   arg1.length << 224,
                   hash
