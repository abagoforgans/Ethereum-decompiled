...
function _fallback() payable {
    ...
    require code.data[6166 len 20]
    require code.data[6198 len 20]
    require code.data[6230 len 20]
    require code.data[6282 len 32] > block.number
    require code.data[6282 len 32] > code.data[6250 len 32]
    stor4 = msg.sender
    stor5 = code.data[6166 len 20]
    stor6 = code.data[6198 len 20]
    address(stor7.field_0) = code.data[6230 len 20]
    stor7.field_160 % 16777216 = 0
    stor9 = 0
    stor10 = code.data[6250 len 32]
    stor11 = code.data[6282 len 32]
    stor12 = code.data[6250 len 32] + 191301
    stor13 = code.data[6250 len 32] + 246840
    stor0 = 0
    return code.data[550 len 5604]
}
...
const sub_43e420b3(?) = 280

const symbol = 'NWAS'

const sub_a1131627(?) = 300

const sub_cc3f9b05(?) = 290

const HIDDEN_CAP = '5000 Ether'
...
function endSale() {
    ...
    emit 0xb27c74a1: ((22 * totalSupply / 78) - (2 * 22 * totalSupply / 78 / 22)), sub_08315717Address
    emit 0xb27c74a1: (2 * 22 * totalSupply / 78 / 22), sub_e07ebaf7Address
...
function createTokens() payable {
    ...
    if block.number < saleFirstEarlyBirdEndBlock:
        ...
        if block.number >= saleSecondEarlyBirdEndBlock:
            if msg.value:
                require msg.value
                require 280 * msg.value / msg.value == 280
            require (280 * msg.value) + totalSupply >= totalSupply
            require (280 * msg.value) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
            require msg.value + eTHContributed[address(msg.sender)] >= eTHContributed[address(msg.sender)]
            totalSupply += 280 * msg.value
            balanceOf[address(msg.sender)] += 280 * msg.value
            totalETHRaised += msg.value
            eTHContributed[address(msg.sender)] += msg.value
            emit 0xb27c74a1: (280 * msg.value), msg.sender
        else:
            if msg.value:
                require msg.value
                require 290 * msg.value / msg.value == 290
            require (290 * msg.value) + totalSupply >= totalSupply
            require (290 * msg.value) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
            require msg.value + eTHContributed[address(msg.sender)] >= eTHContributed[address(msg.sender)]
            totalSupply += 290 * msg.value
            balanceOf[address(msg.sender)] += 290 * msg.value
            totalETHRaised += msg.value
            eTHContributed[address(msg.sender)] += msg.value
            emit 0xb27c74a1: (290 * msg.value), msg.sender
}
