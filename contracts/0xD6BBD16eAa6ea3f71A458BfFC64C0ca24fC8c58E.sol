...
function sub_8f00e61a(?) payable {
    codecall 0x920c890a90db8fba7604864b0cf38ee667331323.0xe6ce3a6a with:
...
function sub_c75e8f88(?) payable {
    ...
    require callcode.return_code
    require callcode.return_data[0] != 0
    codecall 0x443b53559d337277373171280ec57029718203fb.0x81a33a6f with:
         gas gas_remaining - 50 wei
...
function sub_b6cbfdb2(?) payable {
    ...
    codecall 0x443b53559d337277373171280ec57029718203fb.0x94e8767d with:
         gas gas_remaining - 50 wei
        args (stor3[uint32(call.func_hash)] + 1)
    require callcode.return_code
    codecall 0x920c890a90db8fba7604864b0cf38ee667331323.0xbacd6958 with:
         gas gas_remaining - 50 wei
