...
function _fallback() {
    stor0 = msg.sender
    stor0 = code.data[3934 len 20]
    require code.data[3954 len 32]
    require code.data[3986 len 32]
    require code.data[4018 len 32]
    stor7 = code.data[3986 len 32]
    stor8 = code.data[4018 len 32]
    stor9 = code.data[4050 len 32]
    stor6 = code.data[3954 len 32]
    return code.data[188 len 3734]
}
