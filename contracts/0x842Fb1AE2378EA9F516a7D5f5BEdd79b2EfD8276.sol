...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'criptoseed' / 256
    idx = 0
    ...
    mem[224 len -4204] = code.data[4923 len -4204]
    stor3 = mem[224] * 10^stor2
    stor3 = 300 * 10^6
    stor4[address(msg.sender)] = 300 * 10^6
    bool(stor0.length) = 0
    stor0.length.field_1 = 10
    stor0.length.field_8 = 'criptoseed' / 256
    idx = 0
