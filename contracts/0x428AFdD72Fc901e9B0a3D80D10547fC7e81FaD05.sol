...
function multisend(address[] arg1, uint256[] arg2) {
    ...
    while idx < arg1.length:
        ...
        require msg.sender == owner
        require not stor7[address(msg.sender)]
        require frozenAccountTokens[address(msg.sender)] + mem[(32 * idx) + (32 * arg1.length) + 160] >= frozenAccountTokens[address(msg.sender)]
        require frozenAccountTokens[address(msg.sender)] + mem[(32 * idx) + (32 * arg1.length) + 160] <= balanceOf[address(msg.sender)]
        require not uint8(stor3.field_160)
        ...
        require msg.sender == owner
        require balanceOf[address(_29)] >= _31
        require _31 > 0
        require frozenAccountTokens[address(_29)] + _31 >= frozenAccountTokens[address(_29)]
        mem[0] = address(_29)
        mem[32] = 8
        frozenAccountTokens[address(_29)] += _31
        mem[(32 * arg1.length) + (32 * arg2.length) + 160] = _31
        emit Freeze(_31, address(_29));
        idx = idx + 1
        continue 
    return arg1.length
}
