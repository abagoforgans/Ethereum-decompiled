...
function _fallback() {
    stor0 = msg.sender
    stor1 = code.data[3465 len 20]
    stor2 = code.data[3497 len 20]
    stor3 = code.data[3517 len 32]
    stor4 = code.data[3549 len 32]
    stor5 = code.data[3581 len 32]
    uint8(stor6.field_0) = uint8(bool(code.data[3613 len 32]))
    Mask(248, 0, stor6.field_8) = Mask(248, 0, bool(code.data[3645 len 32]))
    Mask(240, 0, stor6.field_16) = Mask(240, 16, bool(code.data[3613 len 32])) >> 16
    emit ActivatedEvent(bool(uint8(bool(code.data[3613 len 32]))), bool(uint8(bool(code.data[3645 len 32]))));
    require stor0 == msg.sender
    emit OwnershipTransferred(stor0, address(code.data[3453 len 32]));
    stor0 = address(code.data[3453 len 32])
    return code.data[447 len 3006]
}
...
function sub_61e7d55a(?) payable {
    if not uint8(stor6.field_8):
        test = 222222
    else:
        require sellPrice
        test = msg.value / sellPrice
}
...
function activate(bool arg1, bool arg2) {
    ...
    Mask(248, 0, stor6.field_8) = Mask(248, 0, arg2)
    Mask(240, 0, stor6.field_16) = Mask(240, 16, arg1) >> 16
...
function ownerWithdrawERC20Token(address arg1, uint256 arg2) {
    require owner == msg.sender
    emit MakerWithdrewERC20Token(address(arg1), arg2);
