...
function _fallback() {
    stor0 = msg.sender
    require code.data[2506 len 32] >= block.timestamp
    require code.data[2538 len 32] >= code.data[2506 len 32]
    stor2 = code.data[2506 len 32]
    stor3 = code.data[2538 len 32]
    stor5 = 10000
    stor4 = 0x942b56e5a6e92b39643dcb5f232ef583680f0b01
    stor1 = 0
    stor7 = 2000 * 10^18
    stor1 = code.data[2582 len 20]
    return code.data[352 len 2154]
}
...
const FULL_TOKEN_WALLET = 0x8759a03b3beb1aa1a7ba765792cf83caae4f28e9

const FULL_TOKEN_AMOUNT = 20000000 * 10^18
