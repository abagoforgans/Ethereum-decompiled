...
function _fallback() payable {
    ...
    stor6.length.field_8 = 'H0.1.1' / 256
    idx = 0
    ...
    stor0 = 275000 * 3600
    stor1[address(msg.sender)] = 275000 * 3600
    stor4 = 4
    bool(stor3.length) = 0
    stor3.length.field_1 = 24
    stor3.length.field_8 = 'Applied Blockchain Token' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'ABT' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[452 len 2140]
}
