...
function _fallback() payable {
    mem[96 len -769] = code.data[1130 len -769]
    mem[64] = -673
    stor0 = msg.sender or Mask(96, 160, stor0)
    stor2 = 1
    stor1[1].field_0 = mem[mem[96] + 96]
    if not mem[mem[96] + 96]:
        idx = 0x66b32740ad8041bcc3b909c72d7e1afe60094ec55e3cde329b4b3a28501d826c
        while (stor1[1].field_0 + 31 / 32) + 0x66b32740ad8041bcc3b909c72d7e1afe60094ec55e3cde329b4b3a28501d826c > idx:
            stor[idx] = 0
            idx = idx + 1
            continue 
    else:
        s = 0x66b32740ad8041bcc3b909c72d7e1afe60094ec55e3cde329b4b3a28501d826c
        idx = mem[96] + 128
        while mem[96] + mem[mem[96] + 96] + 128 > idx:
            ...
            idx = idx + 32
            continue 
        idx = (Mask(251, 0, mem[mem[96] + 96] + 31) >> 5) + 0x66b32740ad8041bcc3b909c72d7e1afe60094ec55e3cde329b4b3a28501d826c
        while (stor1[1].field_0 + 31 / 32) + 0x66b32740ad8041bcc3b909c72d7e1afe60094ec55e3cde329b4b3a28501d826c > idx:
            stor[idx] = 0
            idx = idx + 1
            continue 
    stor1[stor2].field_256 = mem[mem[128] + 96]
...
function create(string arg1, string arg2) payable {
    ...
    sub_250caccc = 2
    storD9D1 = arg1.length
    if not arg1.length:
        idx = 0x9feccf6caa602894c8105bdda7f81b2a7bb7de7dba1f18af92d8d057b708cb41
        while (storD9D1 + 31 / 32) - 0x60133093559fd76b37efa4225807e4d58448218245e0e7506d272fa848f734bf > idx:
            stor[idx] = 0
            idx = idx + 1
            continue 
    else:
        s = 0x9feccf6caa602894c8105bdda7f81b2a7bb7de7dba1f18af92d8d057b708cb41
        idx = 128
        while arg1.length + 128 > idx:
            ...
            idx = idx + 32
            continue 
        idx = (Mask(251, 0, arg1.length + 31) >> 5) - 0x60133093559fd76b37efa4225807e4d58448218245e0e7506d272fa848f734bf
        while (storD9D1 + 31 / 32) - 0x60133093559fd76b37efa4225807e4d58448218245e0e7506d272fa848f734bf > idx:
            stor[idx] = 0
            idx = idx + 1
            continue 
