...
function transfer(string arg1, string arg2) payable {
    ...
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 420] = mem[ceil32(arg1.length) + ceil32(arg2.length) + 440 len 12]
    call address(stor0.field_0).0x60f66701 with:
         gas gas_remaining - 25050 wei
        args Array(len=12, data=mem[ceil32(arg1.length) + ceil32(arg2.length) + 420])
    require ext_call.success
    require 0 < arg1.length
    if 'b' == Mask(8, 248, mem[128]):
        require 1 < arg1.length
        if 't' == Mask(8, 248, mem[129]):
            require 2 < arg1.length
            if 'c' == Mask(8, 248, mem[130]):
                require arg2.length > 35
