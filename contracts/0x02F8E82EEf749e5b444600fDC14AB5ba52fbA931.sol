...
function NextPayout() payable {
    ...
    return stor[code.data[1756 len 32] + (3 * stor1)]
}
    ...
    if msg.value <= 20 * 10^18:
        ...
        if watchBalance >= 10^18:
            if stor9.length % 10 != 0:
                ...
                if msg.value <= 10^18:
                    ...
                    require stor1 < stor9.length
                    if msg.value <= stor[code.data[1756 len 32] + (3 * stor1)]:
                        if watchBalance <= stor6E15[stor1]:
                        require stor1 < stor9.length
                        # nil
                    else:
        ...
        if watchBalance >= 10^18:
            if stor9.length % 10 != 0:
                ...
                require stor1 < stor9.length
                if 20 * 10^18 <= stor[code.data[1756 len 32] + (3 * stor1)]:
                    if watchBalance <= stor6E15[stor1]:
                    require stor1 < stor9.length
                    # nil
                else:
