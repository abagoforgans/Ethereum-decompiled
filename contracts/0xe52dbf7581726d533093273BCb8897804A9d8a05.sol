...
function trusted(address arg1, address arg2) {
...
function trust(address arg1, bool arg2) {
    require calldata.size - 4 >= 64
    require not uint8(stor4.field_160)
    stor5[address(msg.sender)][address(arg1)] = uint8(arg2)
    emit Trust(arg2, msg.sender, arg1);
}
...
function push(address arg1, uint256 arg2) {
    ...
    if msg.sender != msg.sender:
        if not stor5[address(msg.sender)][address(msg.sender)]:
