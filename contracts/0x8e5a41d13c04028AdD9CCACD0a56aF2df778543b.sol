...
function _fallback() payable {
    ...
    stor0 = code.data[2215 len 20]
    stor1 = 10^18 * code.data[2235 len 32]
    stor3 = block.timestamp + (60 * code.data[2267 len 32])
    stor4 = 1337 * 10^10
    stor5 = code.data[2311 len 20]
    return code.data[314 len 1889]
}
