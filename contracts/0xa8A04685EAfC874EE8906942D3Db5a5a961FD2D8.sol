...
function sub_052a3881(?) {
    ...
    if not stor1[msg.sender]:
        ...
        mem[268] = 0x4d6173746572436f6e74726163740000000000000000000000000000000000
        mem[314] = sha3(sha3(Mask(96, 0, mem[192 len 12], 0)), mem[314 len 14])
        mem[346] = arg1
    ...
    mem[96] = 12
    mem[128] = 0x41646d696e4665617475726500000000000000000000000000000000000000
    mem[192 len 0] = None
    mem[192 len 0] = 0
    mem[160] = 12
    mem[204 len 0] = None
