...
function _fallback() payable {
    if msg.value == 10^13:
        ...
        if 2 * 10^13 == msg.value:
            call stor10 with:
               value msg.value wei
                 gas 2300 * is_zero(value) wei
            require ext_call.success
        else:
            if 3 * 10^13 == msg.value:
                call stor10 with:
                   funct Mask(32, 224, sha3('send(uint256)')) >> 224
                     gas 200000 wei
                    args msg.value
            else:
                if 4 * 10^13 == msg.value:
                    ...
                    if 5 * 10^13 == msg.value:
                        ...
                        if 6 * 10^13 == msg.value:
                            ...
                            if 7 * 10^13 == msg.value:
                                call stor7 with:
                                   funct Mask(32, 224, sha3('etherAddress.send(uint256)')) >> 224
                                     gas 200000 wei
                                    args msg.value
                            else:
                                if 8 * 10^13 == msg.value:
                                    call stor7 with:
                                       funct Mask(32, 224, sha3('etherAddress.transfer(uint256)')) >> 224
                                         gas 200000 wei
                                        args msg.value
}

function sub_4345b710(?) payable {
    if msg.value == 10^13:
        call stor10 with:
           value msg.value wei
             gas 2300 * is_zero(value) wei
