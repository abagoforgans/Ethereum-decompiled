...
function sub_46eb584c(?) payable {
    ...
    mem[480 len 11116] = code.data[2000 len 11116]
    mem[11596] = daiContractAddress
    mem[11628] = devFeeAddress
    create contract with 0 wei
                    code: code.data[2000 len 11116], daiContractAddress, devFeeAddress
    ...
    if not arg2:
        call daiContractAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
        ...
        if not ext_call.return_data[0]:
            revert with 0, 32, 66, code.data[13116 len 66], code.data[2198 len 30]
