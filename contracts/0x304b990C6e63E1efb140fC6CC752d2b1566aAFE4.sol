...
function sub_c20bf895(?) {
    ...
    mem[64] = ceil32(return_data.size) + 436
    require return_data.size >= 32
    _675 = mem[436 len 4], Mask(224, 32, sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[422 len 14])) >> 32
    require mem[436 len 4], Mask(224, 32, sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[422 len 14])) >> 32 <= 4294967296
    require mem[436 len 4], Mask(224, 32, sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[422 len 14])) >> 32 + 32 <= return_data.size
    require return_data.size >= mem[mem[436 len 4], Mask(224, 32, sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[422 len 14])) >> 32 + 436] + mem[436 len 4], Mask(224, 32, sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[422 len 14])) >> 32 + 32 and mem[mem[436 len 4], Mask(224, 32, sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[422 len 14])) >> 32 + 436] <= 4294967296
    mem[ceil32(return_data.size) + 436] = 12
    mem[ceil32(return_data.size) + 468] = 'BankCurrency'
    mem[ceil32(return_data.size) + 532] = sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender)
    mem[ceil32(return_data.size) + 564 len 0] = None
    mem[ceil32(return_data.size) + 500] = 44
    mem[ceil32(return_data.size) + 608 len 12] = mem[ceil32(return_data.size) + 564 len 12]
    mem[ceil32(return_data.size) + 576] = 0x986e791a00000000000000000000000000000000000000000000000000000000
    mem[ceil32(return_data.size) + 580] = sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[ceil32(return_data.size) + 564 len 12])
    require ext_code.size(stor4)
    call stor4.getString(bytes32 arg1) with:
         gas gas_remaining wei
        args sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[ceil32(return_data.size) + 564 len 12])
    ...
    require return_data.size >= 32
    _913 = mem[ceil32(return_data.size) + 576 len 4], Mask(224, 32, sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[ceil32(return_data.size) + 564 len 12])) >> 32
    require mem[ceil32(return_data.size) + 576 len 4], Mask(224, 32, sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[ceil32(return_data.size) + 564 len 12])) >> 32 <= 4294967296
    require mem[ceil32(return_data.size) + 576 len 4], Mask(224, 32, sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[ceil32(return_data.size) + 564 len 12])) >> 32 + 32 <= return_data.size
    require return_data.size >= mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 576 len 4], Mask(224, 32, sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[ceil32(return_data.size) + 564 len 12])) >> 32 + 576] + mem[ceil32(return_data.size) + 576 len 4], Mask(224, 32, sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[ceil32(return_data.size) + 564 len 12])) >> 32 + 32 and mem[ceil32(return_data.size) + mem[ceil32(return_data.size) + 576 len 4], Mask(224, 32, sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[ceil32(return_data.size) + 564 len 12])) >> 32 + 576] <= 4294967296
    mem[(2 * ceil32(return_data.size)) + 576] = 12
    mem[(2 * ceil32(return_data.size)) + 608] = 'BitcoinValue'
    mem[(2 * ceil32(return_data.size)) + 672] = sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender)
    mem[(2 * ceil32(return_data.size)) + 704 len 0] = None
    mem[(2 * ceil32(return_data.size)) + 640] = 44
    mem[(2 * ceil32(return_data.size)) + 748 len 12] = mem[(2 * ceil32(return_data.size)) + 704 len 12]
    mem[(2 * ceil32(return_data.size)) + 720] = sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[(2 * ceil32(return_data.size)) + 704 len 12])
    require ext_code.size(stor4)
    call stor4.getUint(bytes32 arg1) with:
         gas gas_remaining wei
        args sha3(sha3(sha3(Mask(144, 112, 0, 0, 1635022194) >> 112), msg.sender), mem[(2 * ceil32(return_data.size)) + 704 len 12])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[(2 * ceil32(return_data.size)) + 780] = ext_call.return_data[0]
    mem[(2 * ceil32(return_data.size)) + 716] = 96
    mem[(2 * ceil32(return_data.size)) + 812] = mem[_675 + 436]
    _1083 = mem[_675 + 436]
    mem[(2 * ceil32(return_data.size)) + 844 len ceil32(mem[_675 + 436])] = mem[_675 + 468 len ceil32(mem[_675 + 436])]
    if not _1083 % 32:
        mem[(2 * ceil32(return_data.size)) + 748] = _1083 + 128
        mem[_1083 + (2 * ceil32(return_data.size)) + 844] = mem[ceil32(return_data.size) + _913 + 576]
        _1124 = mem[ceil32(return_data.size) + _913 + 576]
        mem[_1083 + (2 * ceil32(return_data.size)) + 876 len ceil32(mem[ceil32(return_data.size) + _913 + 576])] = mem[ceil32(return_data.size) + _913 + 608 len ceil32(mem[ceil32(return_data.size) + _913 + 576])]
        if not _1124 % 32:
            return memory
              from (2 * ceil32(return_data.size)) + 716
               len _1124 + _1083 + ceil32(return_data.size) + 160
        mem[floor32(_1124) + _1083 + (2 * ceil32(return_data.size)) + 876] = mem[floor32(_1124) + _1083 + (2 * ceil32(return_data.size)) + -(_1124 % 32) + 908 len _1124 % 32]
        return memory
          from (2 * ceil32(return_data.size)) + 716
           len floor32(_1124) + _1083 + ceil32(return_data.size) + 192
    mem[floor32(_1083) + (2 * ceil32(return_data.size)) + 844] = mem[floor32(_1083) + (2 * ceil32(return_data.size)) + -(_1083 % 32) + 876 len _1083 % 32]
    mem[(2 * ceil32(return_data.size)) + 748] = floor32(_1083) + 160
    mem[floor32(_1083) + (2 * ceil32(return_data.size)) + 876] = mem[ceil32(return_data.size) + _913 + 576]
    _1127 = mem[ceil32(return_data.size) + _913 + 576]
    mem[floor32(_1083) + (2 * ceil32(return_data.size)) + 908 len ceil32(mem[ceil32(return_data.size) + _913 + 576])] = mem[ceil32(return_data.size) + _913 + 608 len ceil32(mem[ceil32(return_data.size) + _913 + 576])]
    if not _1127 % 32:
        return memory
          from (2 * ceil32(return_data.size)) + 716
           len _1127 + floor32(_1083) + ceil32(return_data.size) + 192
    mem[floor32(_1127) + floor32(_1083) + (2 * ceil32(return_data.size)) + 908] = mem[floor32(_1127) + floor32(_1083) + (2 * ceil32(return_data.size)) + -(_1127 % 32) + 940 len _1127 % 32]
    return memory
      from (2 * ceil32(return_data.size)) + 716
       len floor32(_1127) + floor32(_1083) + ceil32(return_data.size) + 224
}
