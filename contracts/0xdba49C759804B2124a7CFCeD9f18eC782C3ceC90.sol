...
const _fallback = code.data[18 len 4744]
...
function sub_3917d085(?) {
    mem[ceil32(arg1.length) + 4219 len arg1.length] = arg1[all]
    if not arg1.length % 32:
        create contract with 0 wei
                        code: code.data[909 len 3835], Array(len=address(arg6), data=arg1.length, arg1[all]), arg2, arg3, arg4, address(arg5), msg.sender
    else:
        mem[floor32(arg1.length) + ceil32(arg1.length) + 4219] = mem[floor32(arg1.length) + ceil32(arg1.length) + -(arg1.length % 32) + 4251 len arg1.length % 32]
        create contract with 0 wei
                        code: code.data[909 len 3835], Array(len=address(arg6), data=arg1.length, arg1[all], mem[ceil32(arg1.length) + arg1.length + 4219 len -(arg1.length % 32) + 32]), arg2, arg3, arg4, address(arg5), msg.sender
