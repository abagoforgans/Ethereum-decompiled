...
function _fallback() {
    stor0 = msg.sender
    stor1 = 0x11175e64c6082fa06daf689c59a510c2774253a1
    return code.data[185 len 2421]
}
    ...
    while idx < arg1.length:
        if address(cd[((32 * idx) + arg1 + 36)]):
            ...
            call stor1.0x70a08231 with:
                ...
                args this.address
            require ext_call.success
            if ext_call.return_data[0] < 100 * arg2:
                mem[96] = arg2
                ...
                call stor1.0xa9059cbb with:
                     gas gas_remaining - 710 wei
                    args address(cd[((32 * idx) + arg1 + 36)]), 100 * arg2
                require ext_call.success
                mem[96] = arg2
