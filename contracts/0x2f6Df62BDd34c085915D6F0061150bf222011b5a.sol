    ...
    if preico[address(arg4)] <= 0:
        ...
        while idx < 10:
            if arg2 >= pricingEndsAt[idx]:
                ...
                continue 
            require idx - 1 < 10
            require ext_code.size(0x8c6f95b719e7e4f55b538dba29b86e032fbe0a6e)
            delegate 0x8c6f95b719e7e4f55b538dba29b86e032fbe0a6e.0x1d3b9edf with:
                 gas gas_remaining - 50 wei
                args arg1, 10^arg5
            require delegate.return_code
            require stor3[idx - 1]
            return (delegate.return_data[0] / stor3[idx - 1])
        if ext_code.size(0x8c6f95b719e7e4f55b538dba29b86e032fbe0a6e):
            delegate 0x8c6f95b719e7e4f55b538dba29b86e032fbe0a6e.0x1d3b9edf with:
                 gas gas_remaining - 50 wei
                args arg1, 10^arg5
        revert 
