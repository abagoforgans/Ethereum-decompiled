...
function finalizeCrowdsale() payable {
    ...
    if uint8(var34009) < 0xc331051700000000000000000000000000000000000000000000000000000000:
        ...
        if var52007 > 0:
            ...
            require ext_code.size(0xaacb3f58b66393ec5fe90f9ad4483a992a8b7f3)
            delegate 0xaacb3f58b66393ec5fe90f9ad4483a992a8b7f3.mem[var60002 len 4] with:
                 gas gas_remaining - 710 wei
            ...
            while uint8(idx + 1) < ext_call.return_data[0]:
                ...
                require ext_code.size(0xaacb3f58b66393ec5fe90f9ad4483a992a8b7f3)
                delegate 0xaacb3f58b66393ec5fe90f9ad4483a992a8b7f3.0x66098d4f with:
                     gas gas_remaining - 710 wei
                ...
                if ext_call.success:
                    ...
                    if ext_code.size(tokenAddress):
                        ...
                        if ext_call.success:
                            ...
                            mem[100] = var47007
                            mem[132] = var47001
                            if ext_code.size(0xaacb3f58b66393ec5fe90f9ad4483a992a8b7f3):
                                delegate 0xaacb3f58b66393ec5fe90f9ad4483a992a8b7f3.mem[var49002 len 4] with:
                                     gas gas_remaining - 710 wei
