...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'Hugs Tokens' / 256
    idx = 0
    ...
    stor0[address(msg.sender)] = 500000
    stor2 = 500000
    bool(stor3.length) = 0
    stor3.length.field_1 = 10
    stor3.length.field_8 = 'HUGS TOKEN' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        stor3[idx].field_0 = 0
        idx = idx + 1
