...
function _fallback() payable {
    ...
    while idx < stor2.length:
        mem[0] = 2
        call address(stor[code.data[3053 len 32] + (2 * idx)]) with:
...
function members(uint256 arg1) payable {
    ...
    while stor[(2 * arg1) + 0x405787fa12a823e0f2b7631cc41b3ba8828b3321ca811111fa75cd3aa3bb5acf].length + 192 > idx + 32:
        ...
        s = s + 1
        continue 
    return address(stor[(2 * arg1) + code.data[3053 len 32]]), 
...
function addMember(address arg1, string arg2) payable {
    ...
    emit 0xac4f9610: address(arg1), Array(len=arg2.length, data=arg2[all]), stor2.length
}

function changeMemberAddress(address arg1) payable {
    require memberId[address(msg.sender)] < stor2.length
    if address(stor[code.data[3053 len 32] + (2 * stor1[address(msg.sender)])]) == msg.sender:
        require memberId[address(msg.sender)] < stor2.length
...
function removeMember(address arg1) payable {
    ...
    while idx < stor2.length - 1:
        ...
        address(stor[code.data[3053 len 32] + (2 * idx)]) = address(stor[code.data[3053 len 32] + (2 * idx + 1)])
        if 31 >= stor[code.data[3053 len 32] + (2 * idx + 1) + 1].length:
            uint256(stor[code.data[3053 len 32] + (2 * idx) + 1]) = uint256(stor[code.data[3053 len 32] + (2 * idx + 1) + 1])
            s = sha3(code.data[3053 len 32] + (2 * idx) + 1)
            while sha3(code.data[3053 len 32] + (2 * idx) + 1) + (stor[code.data[3053 len 32] + (2 * idx) + 1].length + 31 / 32) > s:
                uint256(stor[s]) = 0
                s = s + 1
                continue 
        else:
            uint256(stor[code.data[3053 len 32] + (2 * idx) + 1]) = Mask(255, 1, uint256(stor[code.data[3053 len 32] + (2 * idx + 1) + 1]) and (256 * not bool(stor[code.data[3053 len 32] + (2 * idx + 1) + 1])) - 1) + 1
            if not Mask(255, 1, uint256(stor[code.data[3053 len 32] + (2 * idx + 1) + 1]) and (256 * not bool(stor[code.data[3053 len 32] + (2 * idx + 1) + 1])) - 1):
                s = sha3(code.data[3053 len 32] + (2 * idx) + 1)
                while sha3(code.data[3053 len 32] + (2 * idx) + 1) + (stor[code.data[3053 len 32] + (2 * idx) + 1].length + 31 / 32) > s:
                    uint256(stor[s]) = 0
                    s = s + 1
                ...
                s = sha3(code.data[3053 len 32] + (2 * idx) + 1)
                t = sha3(code.data[3053 len 32] + (2 * idx + 1) + 1)
                while sha3(code.data[3053 len 32] + (2 * idx + 1) + 1) + (stor[code.data[3053 len 32] + (2 * idx + 1) + 1].length + 31 / 32) > t:
                    uint256(stor[s]) = uint256(stor[t])
                    s = s + 1
                    t = t + 1
                    continue 
                t = s
                while sha3(code.data[3053 len 32] + (2 * idx) + 1) + (stor[code.data[3053 len 32] + (2 * idx) + 1].length + 31 / 32) > t:
                    uint256(stor[t]) = 0
                    t = t + 1
                    continue 
        require idx < stor2.length
        mem[0] = address(stor[code.data[3053 len 32] + (2 * idx)])
        mem[32] = 1
        memberId[address(stor[code.data[3053 len 32] + (2 * idx)])] = idx
        idx = idx + 1
        continue 
    stor2.length--
    if not stor2.length <= stor2.length - 1:
        ...
        while sha3(2) + (2 * stor2.length) > s + sha3(mem[0]):
            ...
            s = s + 1
            continue 
    emit 0x3b7df5e4: address(arg1), Array(len=stor[(2 * stor1[address(arg1)]) + 0x405787fa12a823e0f2b7631cc41b3ba8828b3321ca811111fa75cd3aa3bb5acf].length, data=mem[160 len stor[(2 * stor1[address(arg1)]) + 0x405787fa12a823e0f2b7631cc41b3ba8828b3321ca811111fa75cd3aa3bb5acf].length]), memberId[address(arg1)]
}
