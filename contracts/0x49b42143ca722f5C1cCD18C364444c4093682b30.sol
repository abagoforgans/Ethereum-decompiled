...
function distributeReservedTokens(uint256 arg1) payable {
    ...
    if uint8(var25014) >= 0:
        ...
        call tokenAddress.0xc3310517 with:
             gas gas_remaining - 710 wei
        require ext_call.success
        require ext_code.size(0x7fcea1dcb2d8c55a0cb938c4233237619e5cf733)
        delegate 0x7fcea1dcb2d8c55a0cb938c4233237619e5cf733.0xf4f3bdc1 with:
             gas gas_remaining - 710 wei
        ...
        require ext_code.size(0x7fcea1dcb2d8c55a0cb938c4233237619e5cf733)
        delegate 0x7fcea1dcb2d8c55a0cb938c4233237619e5cf733.mem[var37002 len 4] with:
             gas gas_remaining - 710 wei
        ...
        while uint8(idx + 1) < uint8(ext_call.return_data[0]):
            ...
            mem[132] = ext_call.return_data[0]
            require ext_code.size(0x7fcea1dcb2d8c55a0cb938c4233237619e5cf733)
            delegate 0x7fcea1dcb2d8c55a0cb938c4233237619e5cf733.0x66098d4f with:
                 gas gas_remaining - 710 wei
