...
function _fallback() payable {
    ...
    if not stor6.length <= stor6.length + 1:
        ...
        while stor6.length > idx:
            ...
            idx = idx + 1
            continue 
    address(stor6[stor6.length]) = 0x197dd3b50cac08f9ad15e4027f44f414e3c00ab5
    return code.data[952 len 4582]
}
