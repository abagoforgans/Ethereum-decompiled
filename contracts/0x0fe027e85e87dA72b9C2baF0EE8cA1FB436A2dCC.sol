...
function getRate(string arg1) payable {
    ...
    mem[0] = msg.sender
    mem[32] = sha3(Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len ceil32(arg1.length)]) + 3
