...
function _fallback() payable {
    ...
    mem[96 len -2655] = code.data[3010 len -2655]
    mem[64] = -2559
    stor0 = msg.sender
...
function UserLock(address arg1, bool arg2) {
    require owner == msg.sender
