...
function sub_a9ab39ab(?) payable {
    require msg.sender == address(owner)
    call address(daoAddress).0x70a08231 with:
         gas gas_remaining - 25050 wei
        args this.address
    require ext_call.success
    sub_f8167eb8 = ext_call.return_data[0]
    uint256(stor7) = arg3 or Mask(96, 160, uint256(stor7))
    counter = 1
...
function _fallback() payable {
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        ...
        if counter <= sub_26f5a8c9 - 1:
            ...
            call address(daoAddress).0xa9059cbb with:
                 gas gas_remaining - 25050 wei
                args address(nextAddress), sub_f8167eb8
            require ext_call.success
            counter = 1
    return 1
}
