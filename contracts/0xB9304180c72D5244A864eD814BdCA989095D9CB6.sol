...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor2 = code.data[11615 len 20]
    stor5 = code.data[11647 len 20]
    if code.data[11679 len 20]:
        stor7[code.data[11679 len 20]].field_0 = 0
        stor7[address(code.data[11667 len 32])].field_256 = code.data[11730 len 1]
        stor7[address(code.data[11667 len 32])].field_264 = 0
        stor7[address(code.data[11667 len 32])].field_272 = 1
        stor7[address(code.data[11667 len 32])].field_280 = 1
        stor6.length++
        if not stor6.length <= stor6.length + 1:
            ...
            while stor6.length > idx:
                ...
                idx = idx + 1
                continue 
        address(stor6[stor6.length]) = code.data[11679 len 20]
        stor8 = uint8(stor8 + code.data[11699 len 32])
    return code.data[1366 len 10237]
}
    ...
    if reserves[address(arg1)].field_264:
        if ext_code.size(formulaAddress):
            call formulaAddress.calculatePurchaseReturn(uint256 rg1, uint256 rg2, uint16 rg3, uint256 rg4) with:
                 gas gas_remaining - 710 wei
                args 0, 79423000, reserves[address(arg1)].field_0, reserves[address(arg1)].field_256, arg2
            if ext_call.success:
                return ext_call.return_data[0]
    else:
        if ext_code.size(arg1):
            ...
            if ext_call.success:
                if ext_code.size(formulaAddress):
                    call formulaAddress.calculatePurchaseReturn(uint256 rg1, uint256 rg2, uint16 rg3, uint256 rg4) with:
                         gas gas_remaining - 710 wei
                        args 0, 79423000, ext_call.return_data[0], reserves[address(arg1)].field_256, arg2
                    if ext_call.success:
                        return ext_call.return_data[0]
    revert
}
...
function change(address arg1, address arg2, uint256 arg3, uint256 arg4) {
    ...
    if arg2 == tokenAddress:
        if reserves[address(arg1)].field_264:
            ...
            call formulaAddress.calculatePurchaseReturn(uint256 rg1, uint256 rg2, uint16 rg3, uint256 rg4) with:
                 gas gas_remaining - 710 wei
                args 0, 79423000, reserves[address(arg1)].field_0, reserves[address(arg1)].field_256, arg3
        else:
            require ext_code.size(arg1)
            call arg1.0x70a08231 with:
                 gas gas_remaining - 710 wei
            ...
            call formulaAddress.calculatePurchaseReturn(uint256 rg1, uint256 rg2, uint16 rg3, uint256 rg4) with:
                 gas gas_remaining - 710 wei
                args 0, 79423000, ext_call.return_data[0], reserves[address(arg1)].field_256, arg3
        require ext_call.success
        if reserves[address(arg1)].field_264:
        ...
        if arg1 == tokenAddress:
            ...
            if reserves[address(arg2)].field_264:
                require ext_call.return_data[0] <= reserves[address(arg2)].field_0
                if ext_call.return_data[0] >= reserves[address(arg2)].field_0:
                    require ext_call.return_data[0] == 79423000
            else:
                require ext_code.size(arg2)
                call arg2.0x70a08231 with:
                     gas gas_remaining - 710 wei
