...
function contestant(uint256 arg1) payable {
    ...
    return address(stor[code.data[843 len 32] + arg1])
}
    ...
    if 10^18 != msg.value:
        ...
        if stor0.length:
            if stor2 - stor1 <= 180:
                ...
                call address(stor[code.data[843 len 32] + stor0.length]) with:
                ...
                if not stor0.length <= 0:
                    ...
                    while stor0.length > idx:
                        ...
                        continue 
                stor0.length = 0
                idx = code.data[843 len 32]
                while code.data[843 len 32] + stor0.length > idx:
                    address(stor[idx]) = 0
                    idx = idx + 1
                    continue 
            stor0.length++
            if not stor0.length <= stor0.length + 1:
                ...
                while stor0.length > idx:
                    ...
                    continue 
            require stor0.length < stor0.length
            uint256(stor[code.data[843 len 32] + stor0.length]) = msg.sender or Mask(96, 160, uint256(stor[code.data[843 len 32] + stor0.length]))
