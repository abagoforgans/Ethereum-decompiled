...
function participants(uint256 arg1) payable {
    ...
    return address(stor[(2 * arg1) + code.data[1318 len 32]]), uint256(stor290D[arg1].field_0)
}
...
function NextPayout() payable {
    ...
    if balance >= uint256(stor[code.data[1318 len 32] + (2 * stor1) + 1]):
        require payoutIdx < stor0.length
        call address(stor[code.data[1318 len 32] + (2 * stor1)]) with:
           value uint256(stor[code.data[1318 len 32] + (2 * stor1) + 1]) wei
             gas 0 wei
        balance -= uint256(stor[code.data[1318 len 32] + (2 * stor1) + 1])
        payoutIdx++
}
...
function enter() payable {
    if msg.value < 10^17:
        ...
        if msg.value > 50 * 10^18:
            ...
            uint256(stor[code.data[1318 len 32] + (2 * stor0.length)]) = msg.sender or Mask(96, 160, uint256(stor[code.data[1318 len 32] + (2 * stor0.length)]))
