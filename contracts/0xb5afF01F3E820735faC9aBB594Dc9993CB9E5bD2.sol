...
function playersAmounts(uint256 arg1) payable {
    require arg1 < stor5
    return stor[code.data[2678 len 32] + arg1]
}
...
function new_mainPlayer(address arg1) payable {
    if msg.sender == mainPlayerAddress:
        stor6 = Mask(192, 0, arg1)
}

function newfirst_player(address arg1) payable {
    if msg.sender == address(first_playerAddress):
