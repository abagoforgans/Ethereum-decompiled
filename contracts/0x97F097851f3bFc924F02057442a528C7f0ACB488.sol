...
function sub_5d07cf91(?) payable {
    ...
    while idx < 8:
        ...
        s = 0
        while _7 + 96 > t + 32:
            mem[t + 32] = ('signextend', 0, ('div', ('type', 256, ('field', 0, ('stor', ('add', 1739, ('mul', 10, ('param', 'arg1')), ('mul', -1, ('div', 0.03125, ('add', 1, ('var', 1)))), ('var', 1), ('mul', -1, ('div', 0.03125, ('add', 1, ('var', 1))), ('var', 1)))))), ('exp', 256, ('add', 1, ('mul', -1, ('div', ('mask', 256, 0, ('add', 1, ('var', 1))), 32)), ('var', 1), ('mul', -1, ('div', ('mask', 256, 0, ('add', 1, ('var', 1))), 32), ('var', 1))))))
            t = t + 32
            s = -(s + 1 / 32) + s + (-1 * s + 1 / 32 * s) + 1
            continue 
        mem[_7 + 64] = _7
...
function sub_03d89745(?) payable {
    ...
    while idx < arg2.length:
        _7 = mem[64]
        mem[64] = mem[64] + 96
        mem[_7 len 96] = call.data[arg2 + (96 * idx) + 36 len 96]
        mem[s] = _7
        s = s + 32
        idx = idx + 1
        continue 
...
function sub_a713081c(?) payable {
    ...
    if address(stor[(6 * arg2) + (102 * arg1) + 1].field_8) == msg.sender:
        ...
        require arg2 < 17
        require arg3 < uint256(stor[(6 * arg2) + (102 * arg1) + 3].field_0)
        call address(stor[arg3 + sha3((6 * arg2) + (102 * arg1) + 2)].field_0) with:
           value uint256(stor[arg3 + sha3((6 * arg2) + (102 * arg1) + 3)].field_0) wei
             gas 0 wei
        require arg1 < 17
        require arg2 < 17
        ...
        while uint8(idx) < uint256(stor[(6 * arg2) + (102 * arg1) + 2].field_0):
            ...
            address(stor[idx + sha3((6 * arg2) + (102 * arg1) + 2) - 1].field_0) = address(stor[idx + sha3((6 * arg2) + (102 * arg1) + 2)].field_0)
            require arg1 < 17
            require arg2 < 17
...
function sub_edffcd57(?) payable {
    ...
    while uint8(idx) < uint256(stor[(6 * arg2) + (102 * arg1) + 2].field_0):
        ...
        require arg2 < 17
        require idx < uint256(stor[(6 * arg2) + (102 * arg1) + 3].field_0)
        call address(stor[idx + sha3((6 * arg2) + (102 * arg1) + 2)].field_0) with:
        ...
        while uint8(s) < uint256(stor[(6 * arg2) + (102 * arg1) + 2].field_0):
            ...
            address(stor[s + sha3((6 * arg2) + (102 * arg1) + 2) - 1].field_0) = address(stor[s + sha3((6 * arg2) + (102 * arg1) + 2)].field_0)
            require arg1 < 17
            require arg2 < 17
        ...
        if not uint256(stor[(6 * arg2) + (102 * arg1) + 2].field_0) <= uint256(stor[(6 * arg2) + (102 * arg1) + 2].field_0) - 1:
            mem[0] = (6 * arg2) + (102 * arg1) + 2
            idx = sha3((6 * arg2) + (102 * arg1) + 2) + uint256(stor[(6 * arg2) + (102 * arg1) + 2].field_0) - 1
        ...
        if not uint256(stor[(6 * arg2) + (102 * arg1) + 3].field_0) <= uint256(stor[(6 * arg2) + (102 * arg1) + 3].field_0) - 1:
            mem[0] = (6 * arg2) + (102 * arg1) + 3
            idx = sha3((6 * arg2) + (102 * arg1) + 3) + uint256(stor[(6 * arg2) + (102 * arg1) + 3].field_0) - 1
