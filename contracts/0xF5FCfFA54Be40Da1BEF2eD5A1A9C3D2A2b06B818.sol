...
function _fallback() payable {
    ...
    stor0 = code.data[1680 len 20]
    if code.data[1700 len 32]:
        stor1 = 10^18 * code.data[1700 len 32]
        if code.data[1732 len 32]:
            stor3 = (60 * code.data[1732 len 32]) + block.timestamp
        else:
        ...
        if code.data[1732 len 32]:
            ...
            stor3 = block.timestamp + (750 * 3600)
    stor4 = 35 * 10^14
    stor5 = code.data[1776 len 20]
    return code.data[199 len 1469]
}
