...
function withdraw() payable {
    if block.timestamp - deposits[address(msg.sender)] >= sub_d9607482:
        if eth.balance(this.address) > balance[address(msg.sender)] + profit[address(msg.sender)]:
            call msg.sender with:
               value balance[address(msg.sender)] + profit[address(msg.sender)] wei
                 gas 0 wei
