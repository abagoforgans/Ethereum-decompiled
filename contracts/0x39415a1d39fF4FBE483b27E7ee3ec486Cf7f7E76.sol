...
function _fallback() payable {
    ...
    address(stor6.field_8) = 0x2ecae89ebd1dde40e39d04f515e1f8e64ab939bd
    stor7 = 0
    stor9 = 1
...
const name = 'SANtiment TEST token'

const decimals = 15

const getRate = 1, 1

const symbol = 'SAN.TEST.MAX.2'

const getCode = 'SAN.TEST.MAX.2'
...
function _fulfillPayment(address arg1, address arg2, uint256 arg3, uint256 arg4, address arg5) {
    ...
    if balanceOf[address(arg1)] < arg3:
        emit Payment(address(arg1), address(arg2), arg3, arg3 * PLATFORM_FEE_PER_10000 / 10000, arg5, 1, arg4);
        return 0
    if balanceOf[address(arg2)] + arg3 <= balanceOf[address(arg2)]:
        emit Payment(address(arg1), address(arg2), arg3, arg3 * PLATFORM_FEE_PER_10000 / 10000, arg5, 1, arg4);
        return 0
    ...
    emit Payment(address(arg1), address(arg2), arg3, arg3 * PLATFORM_FEE_PER_10000 / 10000, arg5, 0, arg4);
    return 1
}
...
function _fulfillPreapprovedPayment(address arg1, address arg2, uint256 arg3, address arg4) {
    require SUBSCRIPTION_MODULEAddress == msg.sender
    if arg1 == arg4:
        emit Payment(address(arg1), address(arg2), arg3, arg3 * PLATFORM_FEE_PER_10000 / 10000, arg4, 2, 0);
        return arg1 != arg4
    ...
    require arg3 * PLATFORM_FEE_PER_10000 / 10000 <= arg3
    if balanceOf[address(arg1)] < arg3:
        emit Payment(address(arg1), address(arg2), arg3, arg3 * PLATFORM_FEE_PER_10000 / 10000, arg4, 1, 0);
        return 0
    if balanceOf[address(arg2)] + arg3 <= balanceOf[address(arg2)]:
        emit Payment(address(arg1), address(arg2), arg3, arg3 * PLATFORM_FEE_PER_10000 / 10000, arg4, 1, 0);
        return 0
    ...
    balanceOf[arg2] = arg3 - (arg3 * PLATFORM_FEE_PER_10000 / 10000) + balanceOf[arg2]
    balanceOf[stor8] += arg3 * PLATFORM_FEE_PER_10000 / 10000
    emit Payment(address(arg1), address(arg2), arg3, arg3 * PLATFORM_FEE_PER_10000 / 10000, arg4, 0, 0);
