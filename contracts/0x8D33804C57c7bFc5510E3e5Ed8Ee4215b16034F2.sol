...
function _fallback() payable {
    ...
    mem[96 len -6396] = code.data[7019 len -6396]
    mem[64] = -6300
    ...
    if not mem[mem[96] + 96]:
        ...
        while stor3.length > idx:
            ...
            continue 
    stor4 = mem[128]
    address(stor6.field_16) = mem[172 len 20]
    stor8 = mem[204 len 20]
    return code.data[623 len 6396]
}
...
address sub_96057ca8Address; offset 16
mapping of uint256 sub_41c39e55;
address sub_8d3b6350Address;
...
function sub_41c39e55(?) {
    return sub_41c39e55[arg1]
}

function sub_8d3b6350(?) {
    return sub_8d3b6350Address
}

function sub_96057ca8(?) {
    return sub_96057ca8Address
}
...
function sub_5f8de3df(?) {
    require msg.sender == this.address
    uint8(stor6.field_8) = 1
    emit 0x40de4174: 1
}

function sub_72226875(?) {
    require msg.sender == this.address
    uint8(stor6.field_0) = 1
    emit 0x6d85d941: 1
}

function sub_7a05fb4c(?) {
    require msg.sender == this.address
    uint8(stor6.field_0) = 0
    emit 0x6d85d941: 0
}

function sub_bb416363(?) {
    require msg.sender == this.address
...
function sub_36fb46fe(?) {
    require msg.sender == this.address
    sub_96057ca8Address = arg1
    emit 0x8d85d059: arg1
}

function sub_ced3cd03(?) {
    require msg.sender == this.address
    sub_8d3b6350Address = arg1
    emit 0x6e961cdc: arg1
}
