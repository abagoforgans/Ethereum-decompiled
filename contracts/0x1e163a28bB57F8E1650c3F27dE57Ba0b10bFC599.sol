...
function sub_00aba393(?) {
    require msg.sender == managerAddress
    require ext_code.size(arg1)
    call arg1.finalizeRequest(uint256 arg1) with:
         gas gas_remaining wei
        args arg2
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_5f4109e1(?) {
    require msg.sender == managerAddress
    require ext_code.size(arg1)
    call arg1 with:
         gas gas_remaining wei
        args Array(len=arg2.length, data=arg2[all]), arg3, address(arg4), address(arg5)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}

function sub_5f9892d4(?) {
    require msg.sender == managerAddress
    require ext_code.size(arg1)
    call arg1.setRate(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4) with:
         gas gas_remaining wei
...
function sub_9167ba14(?) {
    ...
    mem[ceil32(arg6.length) + 17388 len ceil32(arg6.length)] = arg6[all], mem[arg6.length + 128 len ceil32(arg6.length) - arg6.length]
    if not arg6.length % 32:
        create contract with 0 wei
                        code: code.data[9181 len 16524], arg1, arg2, arg3, arg4 << 240, stor3, Array(len=arg14, data=arg6.length, Mask(8 * arg6.length, -(8 * arg6.length) + 256, arg6[all], mem[arg6.length + 128 len ceil32(arg6.length) - arg6.length]) << (8 * arg6.length) - 256), arg8, arg9, address(arg10), address(arg11), address(arg12), msg.sender, address(arg13)
    else:
        mem[floor32(arg6.length) + ceil32(arg6.length) + 17388] = mem[floor32(arg6.length) + ceil32(arg6.length) + -(arg6.length % 32) + 17420 len arg6.length % 32]
        create contract with 0 wei
                        code: code.data[9181 len 16524], arg1, arg2, arg3, arg4 << 240, stor3, Array(len=arg14, data=arg6.length, Mask(8 * ceil32(arg6.length), -(8 * ceil32(arg6.length)) + 256, arg6[all], mem[arg6.length + 128 len ceil32(arg6.length) - arg6.length]) << (8 * ceil32(arg6.length)) - 256, mem[(2 * ceil32(arg6.length)) + 17388 len floor32(arg6.length) + -ceil32(arg6.length) + 32]), arg8, arg9, address(arg10), address(arg11), address(arg12), msg.sender, address(arg13)
