...
function changeAll(address arg1) {
    require msg.sender == owner
    if not uint8(stor4.field_160):
        ...
        require balanceOf[address(arg1)] + totalSupply >= balanceOf[address(arg1)]
        balanceOf[address(arg1)] += totalSupply
        emit Transfer(totalSupply, msg.sender, arg1);
        require msg.sender == owner
        emit AdminTransferred(adminAddress, arg1);
        adminAddress = arg1
        require arg1
