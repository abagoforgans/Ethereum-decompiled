...
#
const name = 'Digital Asset Swap Token'
...
const TOKEN_NAME = 'Digital Asset Swap Token'

const TOKEN_SYMBOL = 'DAS'

const TOKEN_DECIMAL_MULTIPLIER = 10^9

const TOKEN_DECIMALS = 9

const TARGET_USER = 0xd177601c2be08d752f499a80700e4b19d527f3f9
