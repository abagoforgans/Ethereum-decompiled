...
function _fallback() payable {
    mem[96 len -3053] = code.data[3331 len -3053]
    mem[64] = -2957
...
function sendMultiSig(address arg1, uint256 arg2, bytes arg3, uint256 arg4, uint256 arg5, bytes arg6) payable {
    ...
    if mem[ceil32(arg3.length) + 224 len 1] >= 27:
        ...
        signer = erecover(sha3(arg1, arg2, arg3[all], arg4, arg5), mem[ceil32(arg3.length) + 224 len 1] + 27 << 248, mem[ceil32(arg3.length) + 160], mem[ceil32(arg3.length) + 192]) 
    require erecover.result
    require 0 < signers.length
    idx = 0
