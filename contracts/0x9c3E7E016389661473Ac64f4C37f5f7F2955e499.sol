...
function depositDividends() payable {
    ...
    if not return_data.size:
        ...
        if ext_call.return_data[0] - (ext_call.return_data[0] / 100) <= 0:
            revert with 0, 'invalid parameter(s)'
        require ext_code.size(daiAddress)
        mem[360 len 96] = 0, msg.sender, address(this.address), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] / 100)) >> 32
        call daiAddress with:
             gas gas_remaining wei
            args ext_call.return_data[0] - (ext_call.return_data[0] / 100), address(this.address), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] / 100)) >> 32 >> 224, mem[456 len 4]
        if not return_data.size:
            require ext_call.success
            require unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32
        ...
        if not return_data.size:
            ...
            if ext_call.return_data[0] - (ext_call.return_data[0] / 100) <= 0:
                revert with 0, 'invalid parameter(s)'
            require ext_code.size(daiAddress)
            mem[ceil32(return_data.size) + 361 len 96] = 0, msg.sender, address(this.address), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] / 100)) >> 32
            call daiAddress with:
                 gas gas_remaining wei
                args ext_call.return_data[0] - (ext_call.return_data[0] / 100), address(this.address), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] / 100)) >> 32 >> 224, mem[ceil32(return_data.size) + 457 len 4]
            if not return_data.size:
                require ext_call.success
                require unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32
                if not uint8(stor4.field_0):
                ...
                if not uint8(stor4.field_0):
                    ...
                    if ext_call.return_data[0] - (ext_call.return_data[0] / 100):
                        ...
                        require return_data.size >= 32
                        require not ext_call.return_data[0]
                    mem[(2 * ceil32(return_data.size)) + 462 len 64] = approve(address arg1, uint256 arg2), Mask(224, 0, stor5), uint32(stor5), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] / 100)) >> 32
                    call daiAddress with:
                       funct uint32(stor5)
                         gas gas_remaining wei
                        args Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] / 100)) << 224, mem[(2 * ceil32(return_data.size)) + 526 len 4]
                    if not return_data.size:
                        require ext_call.success
                        require unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32
                        require ext_code.size(address(moneyMarketAddress))
                        ...
                        if ext_call.return_data[0]:
                            revert with 0, 
                                        ...
                                        43,
                                        0xfe616c6c6f77616e6365206e6f742066756c6c7920636f6e73756d6564206279206d6f6e65794d61726b65,
                                        mem[ceil32(return_data.size) + (2 * ceil32(return_data.size)) + 574 len 21]
                    ('iszero', ('ext_call.return_data', 0, 32))
        else:
            require return_data.size >= 32
            require mem[260]
            ...
            if not return_data.size:
                ...
                if not uint8(stor4.field_0):
                    ...
                    if ext_call.return_data[0] - (ext_call.return_data[0] / 100):
                        ...
                        require return_data.size >= 32
                        require not ext_call.return_data[0]
                    mem[(2 * ceil32(return_data.size)) + 462 len 64] = 0, address(moneyMarketAddress), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] / 100)) >> 32
                    call daiAddress with:
                       funct uint32(stor5)
                         gas gas_remaining wei
                        args ext_call.return_data[0] - (ext_call.return_data[0] / 100), Mask(224, 32, address(moneyMarketAddress), Mask(224, 32, ext_call.return_data[0] - (ext_call.return_data[0] / 100)) >> 32) >> 32, mem[(2 * ceil32(return_data.size)) + 526 len 4]
                    if not return_data.size:
                        require ext_call.success
                        require unknown_0x23b872dd(?????), Mask(224, 32, msg.sender) >> 32
                        require ext_code.size(address(moneyMarketAddress))
