...
function _fallback() payable {
    ...
    mem[96 len -2216] = code.data[2699 len -2216]
    mem[64] = -2120
    stor0 = msg.sender or Mask(96, 160, stor0)
    if mem[96] != 0:
        stor9[address(msg.sender)] = mem[96]
    else:
        stor9[address(msg.sender)] = 10^6
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    balanceOf[address(msg.sender)] += 13370
    emit 0x56ddf252: 13370, 0, msg.sender
}
