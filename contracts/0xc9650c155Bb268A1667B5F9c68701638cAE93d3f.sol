...
function _fallback() {
    stor0 = msg.sender
    stor1 = code.data[10532 len 20]
    stor2 = code.data[10488 len 32]
    return code.data[135 len 10353]
}
...
function sub_2b3a3d0a(?) {
    ...
    delegate 0x3c018100533af417f286331e0ba3b65a288fa848.toReal(int88 rg1) with:
         gas gas_remaining - 710 wei
        args 1
    ...
    require sha256hash.result
    require ext_code.size(0x3c018100533af417f286331e0ba3b65a288fa848)
    delegate 0x3c018100533af417f286331e0ba3b65a288fa848.fpart(int128 rg1) with:
         gas gas_remaining - 710 wei
    ...
    require delegate.return_code
    require ext_code.size(0x3c018100533af417f286331e0ba3b65a288fa848)
    delegate 0x3c018100533af417f286331e0ba3b65a288fa848.mul(int128 rg1, int128 rg2) with:
         gas gas_remaining - 710 wei
        args ('signextend', 15, ('signextend', 15, ('signextend', 15, ('delegate.return_data', 0, 32)))), 0
    require delegate.return_code
    require ext_code.size(0x3c018100533af417f286331e0ba3b65a288fa848)
    delegate 0x3c018100533af417f286331e0ba3b65a288fa848.fromReal(int128 rg1) with:
         gas gas_remaining - 710 wei
...
function sub_91e55035(?) {
    ...
    if ('signextend', 1, ('signextend', 1, ('param', 'arg3'))) < -10000:
        return 0
    if (('signextend', 1, ('signextend', 1, ('param', 'arg3'))) * ('signextend', 1, ('signextend', 1, ('param', 'arg3')))) + (('signextend', 1, ('signextend', 1, ('param', 'arg2'))) * ('signextend', 1, ('signextend', 1, ('param', 'arg2')))) + (('signextend', 1, ('signextend', 1, ('param', 'arg1'))) * ('signextend', 1, ('signextend', 1, ('param', 'arg1')))) < 10^6:
        ...
        if (('signextend', 1, ('signextend', 1, ('param', 'arg3'))) * ('signextend', 1, ('signextend', 1, ('param', 'arg3')))) + (('signextend', 1, ('signextend', 1, ('param', 'arg1'))) * ('signextend', 1, ('signextend', 1, ('param', 'arg1')))) >= 46240000:
            if ext_code.size(0x3c018100533af417f286331e0ba3b65a288fa848):
                delegate 0x3c018100533af417f286331e0ba3b65a288fa848.0x1dade0d4 with:
                     gas gas_remaining - 710 wei
                    args 1, 60
