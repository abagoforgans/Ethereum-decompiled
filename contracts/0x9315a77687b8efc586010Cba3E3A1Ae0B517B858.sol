...
function sub_8727af31(?) {
    ...
    if not cd[36]:
        ...
        require cd[36]
        require cd[36] * ('cd', 4).length / cd[36] == ('cd', 4).length
        require cd[36] * ('cd', 4).length <= ext_call.return_data[0]
    idx = 0
    while idx < ('cd', 4).length:
        ...
        require ext_call.success
        require ext_call.return_data[0]
        require sub_49b1cf79 + cd[36] >= sub_49b1cf79
        sub_49b1cf79 += cd[36]
        idx = idx + 1
        continue 
