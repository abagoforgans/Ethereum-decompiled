...
function sub_9be32dd7(?) {
    require calldata.size - 4 >= 32
    require ext_code.size(sub_d0d5dd40[arg1])
    call sub_d0d5dd40[arg1].rID_() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    require return_data.size >= 32
    require ext_code.size(sub_d0d5dd40[arg1])
    call sub_d0d5dd40[arg1].getBuyPrice() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(sub_d0d5dd40[arg1])
    call sub_d0d5dd40[arg1].round_(uint256 arg1) with:
         gas gas_remaining wei
    ...
    require ext_code.size(sub_d0d5dd40[arg1])
    call sub_d0d5dd40[arg1].0xde7874f3 with:
         gas gas_remaining wei
        args ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
