...
function _fallback() payable {
    stor0 = code.data[9546 len 32]
    stor1 = msg.sender or Mask(96, 160, stor1)
    stor6 = 1
    return code.data[82 len 9464]
}
...
function sub_6670c4bf(?) payable {
    return sub_1a8b3383[address(arg1)].field_3072, 
           ...
           sub_1a8b3383[address(arg1)].field_4096
}
...
function isRegistered(address arg1) payable {
    codecall 0x9988ffccd8620f49e355915fdbcc28d54b68cc98.0x186110f2 with:
...
function getInfo(address arg1) payable {
    codecall 0x55dbd10c0e2ca1e86b2c5045d0c0a53059f3a816.0x6164da3f with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
...
function sub_65afd0ed(?) payable {
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        return 0
    codecall 0x55dbd10c0e2ca1e86b2c5045d0c0a53059f3a816.0x493b26b3 with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
    if not callcode.return_data[0]:
...
function sub_0627f5a9(?) payable {
    ...
    call configAddress.0x855fe6ed with:
        ...
        args 0x73657474696e67732f62696c6c696e67706572696f6400000000000000000000
    require ext_call.success
    return (block.timestamp - sub_1a8b3383[address(arg1)].field_2560 / ext_call.return_data[0])
}
...
function submitAudit(address arg1, bytes32 arg2, bool arg3) payable {
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0x55dbd10c0e2ca1e86b2c5045d0c0a53059f3a816.0xf9993e41 with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
    codecall 0x55dbd10c0e2ca1e86b2c5045d0c0a53059f3a816.0x3414178 with:
         gas gas_remaining - 50 wei
...
function sub_87352ed5(?) payable {
    if not sub_1a8b3383[address(msg.sender)].field_1280:
        return 0
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0x55dbd10c0e2ca1e86b2c5045d0c0a53059f3a816.0xc5ad2603 with:
         gas gas_remaining - 50 wei
...
function sub_63d88608(?) payable {
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0x55dbd10c0e2ca1e86b2c5045d0c0a53059f3a816.0x5975bfa3 with:
         gas gas_remaining - 50 wei
        args 0, 3, address(arg1), arg2, tx.origin
    require callcode.return_code
    if not callcode.return_data[0]:
        return 0
    codecall 0x55dbd10c0e2ca1e86b2c5045d0c0a53059f3a816.0xa9a6a2bb with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
...
function sub_38401c43(?) payable {
    ...
    call configAddress.0x855fe6ed with:
        ...
        args ('settings/redemptionfee' << 80)
    require ext_call.success
    codecall 0x55dbd10c0e2ca1e86b2c5045d0c0a53059f3a816.0x236873f3 with:
         gas gas_remaining - 50 wei
...
function sub_c4336036(?) payable {
    codecall 0x55dbd10c0e2ca1e86b2c5045d0c0a53059f3a816.0x22c800c4 with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
    call configAddress.0x4cb44f8d with:
...
function sub_59d76fe7(?) payable {
    ...
    if sub_1a8b3383[address(arg1)].field_160 != 4:
        return 0
    codecall 0x55dbd10c0e2ca1e86b2c5045d0c0a53059f3a816.0x7f3848bc with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
    if not callcode.return_data[0]:
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0x9988ffccd8620f49e355915fdbcc28d54b68cc98.0x934a11b2 with:
         gas gas_remaining - 50 wei
...
function sub_a0922e99(?) payable {
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0x9988ffccd8620f49e355915fdbcc28d54b68cc98.0xccd7ef98 with:
         gas gas_remaining - 50 wei
        args 2, arg1
    require callcode.return_code
    if not callcode.return_data[0]:
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0x55dbd10c0e2ca1e86b2c5045d0c0a53059f3a816.0x3a0d127d with:
         gas gas_remaining - 50 wei
        args 0, 3, address(arg1), arg2, arg3, arg4, arg5, address(arg6), address(arg7), address(msg.sender), arg8
    require callcode.return_code
    if not callcode.return_data[0]:
        return 0
...
function getFee(address arg1) payable {
    ...
    if address(ext_call.return_data[0]) == sub_1a8b3383[address(arg1)].field_0:
        call configAddress.0x855fe6ed with:
            ...
            args ('settings/rate' << 152)
        require ext_call.success
        return ((0 / ext_call.return_data[0]) + sub_1a8b3383[address(arg1)].field_2816)
    call configAddress.0x855fe6ed with:
         gas gas_remaining - 25050 wei
        args 0x73657474696e67732f62696c6c696e67706572696f6400000000000000000000
    require ext_call.success
    call configAddress.0x855fe6ed with:
         gas gas_remaining - 25050 wei
        args ('settings/rate' << 152)
    return ((sub_1a8b3383[address(arg1)].field_768 * ext_call.return_data[0] * block.timestamp - sub_1a8b3383[address(arg1)].field_2560 / ext_call.return_data[0] / ext_call.return_data[0]) + sub_1a8b3383[address(arg1)].field_2816)
}
...
function sub_511cef7a(?) payable {
    ...
    if address(ext_call.return_data[0]) == sub_1a8b3383[address(msg.sender)].field_0:
        ...
        call configAddress.0x4cb44f8d with:
            ...
            args 0x636f6e74726163742f6d696e7465720000000000000000000000000000000000
        require ext_call.success
        codecall 0x55dbd10c0e2ca1e86b2c5045d0c0a53059f3a816.0x37e2eaa0 with:
             gas gas_remaining - 50 wei
        ...
        if address(ext_call.return_data[0]) == sub_1a8b3383[address(msg.sender)].field_0:
            ...
            call address(ext_call.return_data[0]).0x64e1721c with:
                 gas gas_remaining - 25050 wei
                args 0, uint32(msg.sender), tx.origin, sub_1a8b3383[address(msg.sender)].field_768, (0 / ext_call.return_data[0]) + sub_1a8b3383[address(msg.sender)].field_2816
            if not ext_call.return_data[0]:
                return 0
            call configAddress.0x4cb44f8d with:
                 gas gas_remaining - 25050 wei
            ...
            if not callcode.return_data[0]:
                return 0
            if (0 / ext_call.return_data[0]) + sub_1a8b3383[address(msg.sender)].field_2816 > 0:
            ...
            call address(ext_call.return_data[0]).0x64e1721c with:
                 gas gas_remaining - 25050 wei
                args 0, uint32(msg.sender), tx.origin, sub_1a8b3383[address(msg.sender)].field_768, (sub_1a8b3383[address(msg.sender)].field_768 * ext_call.return_data[0] * block.timestamp - sub_1a8b3383[address(msg.sender)].field_2560 / ext_call.return_data[0] / ext_call.return_data[0]) + sub_1a8b3383[address(msg.sender)].field_2816
            if not ext_call.return_data[0]:
                return 0
            call configAddress.0x4cb44f8d with:
                 gas gas_remaining - 25050 wei
            ...
            if not callcode.return_data[0]:
                return 0
            if (sub_1a8b3383[address(msg.sender)].field_768 * ext_call.return_data[0] * block.timestamp - sub_1a8b3383[address(msg.sender)].field_2560 / ext_call.return_data[0] / ext_call.return_data[0]) + sub_1a8b3383[address(msg.sender)].field_2816 > 0:
                emit 0x56e31dfd: msg.sender, 11, tx.origin
...
function sub_468e5fc3(?) payable {
    ...
    call configAddress.0x855fe6ed with:
        ...
        args 0x73657474696e67732f62696c6c696e67706572696f6400000000000000000000
    require ext_call.success
    if block.timestamp - sub_1a8b3383[address(msg.sender)].field_2560 / ext_call.return_data[0] < 180:
        return 0
    call configAddress.0x4cb44f8d with:
         gas gas_remaining - 25050 wei
        args 0x636f6e74726163742f6d696e7465720000000000000000000000000000000000
    ...
    if address(ext_call.return_data[0]) == sub_1a8b3383[address(msg.sender)].field_0:
        ...
        if address(ext_call.return_data[0]) == sub_1a8b3383[address(msg.sender)].field_0:
            ...
            call address(ext_call.return_data[0]).0x64e1721c with:
                 gas gas_remaining - 25050 wei
                args 0, uint32(msg.sender), sub_1a8b3383[address(msg.sender)].field_0, sub_1a8b3383[address(msg.sender)].field_768, (0 / ext_call.return_data[0]) + sub_1a8b3383[address(msg.sender)].field_2816
            if not ext_call.return_data[0]:
                return 0
            call configAddress.0x4cb44f8d with:
                 gas gas_remaining - 25050 wei
            ...
            call address(ext_call.return_data[0]).0x64e1721c with:
                 gas gas_remaining - 25050 wei
                args 0, uint32(msg.sender), sub_1a8b3383[address(msg.sender)].field_0, sub_1a8b3383[address(msg.sender)].field_768, (sub_1a8b3383[address(msg.sender)].field_768 * ext_call.return_data[0] * block.timestamp - sub_1a8b3383[address(msg.sender)].field_2560 / ext_call.return_data[0] / ext_call.return_data[0]) + sub_1a8b3383[address(msg.sender)].field_2816
            if not ext_call.return_data[0]:
                return 0
            call configAddress.0x4cb44f8d with:
                 gas gas_remaining - 25050 wei
    ...
    if address(ext_call.return_data[0]) == sub_1a8b3383[address(arg1)].field_0:
        ...
        if address(ext_call.return_data[0]) != sub_1a8b3383[address(arg1)].field_0:
            ...
            if address(ext_call.return_data[0]) == sub_1a8b3383[address(arg1)].field_0:
                ...
                if address(ext_call.return_data[0]) == sub_1a8b3383[address(arg1)].field_0:
                    return sub_1a8b3383[address(arg1)].field_768, 
                           ...
                           block.timestamp - sub_1a8b3383[address(arg1)].field_2560 / ext_call.return_data[0]
                call configAddress.0x855fe6ed with:
                     gas gas_remaining - 25050 wei
                    args ('settings/base' << 152)
                require ext_call.success
                ...
                if address(ext_call.return_data[0]) == sub_1a8b3383[address(arg1)].field_0:
                    ...
                    return sub_1a8b3383[address(arg1)].field_768, 
                           0,
                           sub_1a8b3383[address(arg1)].field_768 - (0 / ext_call.return_data[0]) - sub_1a8b3383[address(arg1)].field_2816,
                           block.timestamp - sub_1a8b3383[address(arg1)].field_2560 / ext_call.return_data[0]
                call configAddress.0x855fe6ed with:
                     gas gas_remaining - 25050 wei
                    args 0x73657474696e67732f62696c6c696e67706572696f6400000000000000000000
                ...
                return sub_1a8b3383[address(arg1)].field_768, 
                       0,
                       sub_1a8b3383[address(arg1)].field_768 - (sub_1a8b3383[address(arg1)].field_768 * ext_call.return_data[0] * block.timestamp - sub_1a8b3383[address(arg1)].field_2560 / ext_call.return_data[0] / ext_call.return_data[0]) - sub_1a8b3383[address(arg1)].field_2816,
                       block.timestamp - sub_1a8b3383[address(arg1)].field_2560 / ext_call.return_data[0]
            call configAddress.0x855fe6ed with:
                 gas gas_remaining - 25050 wei
                args ('settings/base' << 152)
            ...
            if address(ext_call.return_data[0]) == sub_1a8b3383[address(arg1)].field_0:
                ...
                if address(ext_call.return_data[0]) == sub_1a8b3383[address(arg1)].field_0:
                    return sub_1a8b3383[address(arg1)].field_768, 
                           (0 / ext_call.return_data[0]) + sub_1a8b3383[address(arg1)].field_2816,
                           sub_1a8b3383[address(arg1)].field_768,
                           block.timestamp - sub_1a8b3383[address(arg1)].field_2560 / ext_call.return_data[0]
                call configAddress.0x855fe6ed with:
                     gas gas_remaining - 25050 wei
            ...
            if address(ext_call.return_data[0]) == sub_1a8b3383[address(arg1)].field_0:
                return sub_1a8b3383[address(arg1)].field_768, 
                       (sub_1a8b3383[address(arg1)].field_768 * ext_call.return_data[0] * block.timestamp - sub_1a8b3383[address(arg1)].field_2560 / ext_call.return_data[0] / ext_call.return_data[0]) + sub_1a8b3383[address(arg1)].field_2816,
                       sub_1a8b3383[address(arg1)].field_768,
                       block.timestamp - sub_1a8b3383[address(arg1)].field_2560 / ext_call.return_data[0]
            call configAddress.0x855fe6ed with:
                 gas gas_remaining - 25050 wei
