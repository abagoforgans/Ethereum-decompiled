...
function withdraw(address arg1) {
    ...
    if arg1:
        if uint256(stor8[address(arg1)][0].field_0):
            uint256(stor8[uint256(stor8[address(arg1)][1].field_0)][0].field_0) = uint256(stor8[address(arg1)][0].field_0)
            uint256(stor8[uint256(stor8[address(arg1)][0].field_0)][1].field_0) = uint256(stor8[address(arg1)][1].field_0)
            uint256(stor8[address(arg1)][0].field_0) = 0
            uint256(stor8[address(arg1)][1].field_0) = 0
            if arg1:
                sub_cb50a60a--
                emit StakedNodeRemoved(arg1);
        else:
            if uint256(stor8[address(arg1)][1].field_0):
                uint256(stor8[uint256(stor8[address(arg1)][1].field_0)][0].field_0) = uint256(stor8[address(arg1)][0].field_0)
                uint256(stor8[uint256(stor8[address(arg1)][0].field_0)][1].field_0) = uint256(stor8[address(arg1)][1].field_0)
                uint256(stor8[address(arg1)][0].field_0) = 0
                uint256(stor8[address(arg1)][1].field_0) = 0
                ...
                if arg1 == uint256(stor8[0][1].field_0):
                    uint256(stor8[uint256(stor8[address(arg1)][1].field_0)][0].field_0) = uint256(stor8[address(arg1)][0].field_0)
                    uint256(stor8[uint256(stor8[address(arg1)][0].field_0)][1].field_0) = uint256(stor8[address(arg1)][1].field_0)
                    uint256(stor8[address(arg1)][0].field_0) = 0
                    uint256(stor8[address(arg1)][1].field_0) = 0
...
function deposit(address arg1, uint256 arg2) {
    ...
    if arg2 > 0:
        if not uint256(stor8[address(arg1)][0].field_0):
            if not uint256(stor8[address(arg1)][1].field_0):
                if arg1 != uint256(stor8[0][1].field_0):
                    if uint256(stor8[0][0].field_0):
                        uint256(stor8[address(arg1)][1].field_0) = 0
                        address(stor8[0][0].field_0) = arg1
                        Mask(96, 0, stor8[0][0].field_160) = 0
                        address(stor8[uint256(stor8[0][0].field_0)][1].field_0) = arg1
                        Mask(96, 0, stor8[uint256(stor8[0][0].field_0)][1].field_160) = 0
                        uint256(stor8[address(arg1)][0].field_0) = uint256(stor8[0][0].field_0)
                        sub_cb50a60a++
                        emit StakedNodeAdded(arg1);
                    else:
                        if uint256(stor8[0][1].field_0):
                            uint256(stor8[address(arg1)][1].field_0) = 0
                            address(stor8[0][0].field_0) = arg1
                            Mask(96, 0, stor8[0][0].field_160) = 0
                            address(stor8[uint256(stor8[0][0].field_0)][1].field_0) = arg1
                            ...
                            if 0 == uint256(stor8[0][1].field_0):
                                uint256(stor8[address(arg1)][1].field_0) = 0
                                address(stor8[0][0].field_0) = arg1
                                Mask(96, 0, stor8[0][0].field_160) = 0
                                address(stor8[uint256(stor8[0][0].field_0)][1].field_0) = arg1
