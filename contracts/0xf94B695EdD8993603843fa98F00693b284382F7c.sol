...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 99999999999999999
    stor2 = 99999999999999999
    bool(stor3.length) = 0
    stor3.length.field_1 = 13
    stor3.length.field_8 = 'RomikaHungary' / 256
    idx = 0
