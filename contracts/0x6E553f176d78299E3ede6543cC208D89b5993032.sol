...
function _fallback() payable {
    ...
    stor0 = code.data[1700 len 20]
    stor1 = 10^18 * code.data[1720 len 32]
    stor3 = (60 * code.data[1752 len 32]) + block.timestamp
    stor4 = code.data[1784 len 32]
    stor5 = code.data[1828 len 20]
    return code.data[175 len 1513]
}
...
function _fallback() payable {
    ...
    call tokenRewardAddress.0xa9059cbb with:
        ...
        args msg.sender, 150000 * msg.value / price
