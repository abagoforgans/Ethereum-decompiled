...
function _fallback() payable {
    call address(code.data[6350 len 32]).0x9fcdee9d with:
         gas gas_remaining - 25050 wei
        args code.data[6382 len 32]
    ...
    call address(ext_call.return_data[0]).0xee54d54f with:
         gas gas_remaining - 25050 wei
        args address(code.data[6350 len 32])
    require ext_call.return_data[0]
    call address(code.data[6350 len 32]).0x640547d9 with:
         gas gas_remaining - 25050 wei
        args code.data[6382 len 32]
    require ext_call.success
    require ext_call.return_data[0]
    call address(code.data[6350 len 32]).0x198876d8 with:
         gas gas_remaining - 25050 wei
        args code.data[6382 len 32], code.data[6446 len 32], code.data[6414 len 32], address(ext_call.return_data[0])
    require ext_call.success
    require ext_call.return_data[0]
    stor1 = ext_call.return_data[0] or Mask(96, 160, stor1)
    uint256(stor0) = code.data[6318 len 32] or Mask(96, 160, uint256(stor0))
    return code.data[734 len 5584]
}
...
function getInfo() payable {
    call configAddress.0x4cb44f8d with:
        ...
        args 0x72656769737472792f676f6c6400000000000000000000000000000000000000
    require ext_call.success
    call address(ext_call.return_data[0]).0xffdd5cf1 with:
         gas gas_remaining - 25050 wei
        args this.address
...
function sub_0ff022d4(?) payable {
    ...
    if msg.sender == ext_call.return_data[12 len 20]:
        call configAddress.0x4cb44f8d with:
            ...
            args 0x72656769737472792f676f6c6400000000000000000000000000000000000000
        require ext_call.success
        call address(ext_call.return_data[0]).0x30ccebb5 with:
             gas gas_remaining - 25050 wei
            args this.address
