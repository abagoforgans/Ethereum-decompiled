...
function sub_72d6a3c5(?) {
    require calldata.size - 4 >= 64
    user[arg1].field_768 += arg2
    return arg2
}

function sub_af572aac(?) {
    require calldata.size - 4 >= 64
    if arg2 != user[arg1].field_512:
        return 0
    return 1
}

function sub_918df00e(?) {
    require calldata.size - 4 >= 64
    require arg2 <= user[arg1].field_768
    user[arg1].field_768 -= arg2
    return arg2
}

function sub_7db527f9(?) {
    require calldata.size - 4 >= 96
    require arg2 <= user[arg1].field_768
    user[arg1].field_768 -= arg2
    user[arg3].field_768 += arg2
    return user[arg1].field_768, arg2 + user[arg3].field_768
}

function sub_5104aa32(?) {
    require calldata.size - 4 >= 96
    idx = 0
