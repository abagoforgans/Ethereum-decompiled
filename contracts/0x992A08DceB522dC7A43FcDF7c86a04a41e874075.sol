...
function _fallback() payable {
    ...
    stor17 = 241920
    stor18 = 0
    stor19 = Mask(254, 0, stor7.field_2) / 10
    stor20 = 48 * 24 * 3600
    stor21 = 0
    require not msg.value
    stor5 = code.data[6196 len 20]
    stor6 = code.data[6228 len 20]
    stor3 = code.data[6248 len 32]
    stor4 = code.data[6280 len 32]
    require stor21 <= 3
    if stor21 != 3:
        require stor21 <= 3
        if stor21 != 2:
...
#
#  - deliver(address arg1, uint256 arg2, string arg3)
#
...
function strategicLockup() {
    return strategicLockup
}
...
function allocateStrategicTokens() {
    if owner != msg.sender:
        require founderAddress == msg.sender
    require block.number > endBlock + strategicLockup
...
function buy(address arg1) payable {
    ...
    if not _saleState:
        ...
        require (6001 * msg.value) + totalTokens >= totalTokens
        require (6001 * msg.value) + totalTokens < totalSupply
        require _saleState <= 3
        if not _saleState:
            require (6001 * msg.value) + totalTokens < presaleAllocation
        else:
            require _saleState <= 3
            if _saleState == 1:
                require (6001 * msg.value) + totalTokens < presaleAllocation
        ...
        emit Transfer((6001 * msg.value), 0, arg1);
        ...
        if _saleState != 1:
            ...
            require (3000 * msg.value) + totalTokens >= totalTokens
            require (3000 * msg.value) + totalTokens < totalSupply
            require _saleState <= 3
            if not _saleState:
                require (3000 * msg.value) + totalTokens < presaleAllocation
            else:
                require _saleState <= 3
                if _saleState == 1:
                    require (3000 * msg.value) + totalTokens < presaleAllocation
            ...
            require (3000 * msg.value) + (3 * ((10000 * endBlock) - (10000 * block.number) / endBlock - startBlock) + 5 / 10 * msg.value) + totalTokens >= totalTokens
            require (3000 * msg.value) + (3 * ((10000 * endBlock) - (10000 * block.number) / endBlock - startBlock) + 5 / 10 * msg.value) + totalTokens < totalSupply
            require _saleState <= 3
            if not _saleState:
                require (3000 * msg.value) + (3 * ((10000 * endBlock) - (10000 * block.number) / endBlock - startBlock) + 5 / 10 * msg.value) + totalTokens < presaleAllocation
            else:
                require _saleState <= 3
                if _saleState == 1:
                    require (3000 * msg.value) + (3 * ((10000 * endBlock) - (10000 * block.number) / endBlock - startBlock) + 5 / 10 * msg.value) + totalTokens < presaleAllocation
            ...
            totalTokens = (3000 * msg.value) + (3 * ((10000 * endBlock) - (10000 * block.number) / endBlock - startBlock) + 5 / 10 * msg.value) + totalTokens
            require _saleState <= 3
            if not _saleState:
                require msg.value + presaleEtherRaised >= presaleEtherRaised
                presaleEtherRaised += msg.value
            ...
            call founderAddress with:
               value msg.value wei
                 gas 2300 * is_zero(value) wei
            require ext_call.success
            emit Transfer(((3000 * msg.value) + (3 * ((10000 * endBlock) - (10000 * block.number) / endBlock - startBlock) + 5 / 10 * msg.value)), 0, arg1);
    ...
    if not _saleState:
            ...
            if _saleState != 2:
                ...
                if block.number <= endBlock:
                    ...
                    if _saleState == 1:
                        if block.number > endBlock:
                            _saleState = 2
        require (6001 * msg.value) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
        balanceOf[address(msg.sender)] += 6001 * msg.value
        totalTokens += 6001 * msg.value
        require _saleState <= 3
        if not _saleState:
            require msg.value + presaleEtherRaised >= presaleEtherRaised
        ...
        call founderAddress with:
           value msg.value wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        emit Transfer((6001 * msg.value), 0, msg.sender);
        emit Buy(msg.value, 6001 * msg.value, msg.sender);
    else:
        require _saleState <= 3
        if _saleState != 1:
            if msg.value:
            ...
            emit Buy(msg.value, 3000 * msg.value, msg.sender);
        else:
            require endBlock - startBlock
            if msg.value:
                require msg.value
                ...
                if _saleState != 2:
                    ...
                    if block.number <= endBlock:
                        ...
                        if _saleState == 1:
                            if block.number > endBlock:
                                _saleState = 2
            require (3000 * msg.value) + (3 * ((10000 * endBlock) - (10000 * block.number) / endBlock - startBlock) + 5 / 10 * msg.value) + balanceOf[address(msg.sender)] >= balanceOf[address(msg.sender)]
            balanceOf[address(msg.sender)] = (3000 * msg.value) + (3 * ((10000 * endBlock) - (10000 * block.number) / endBlock - startBlock) + 5 / 10 * msg.value) + balanceOf[address(msg.sender)]
            totalTokens = (3000 * msg.value) + (3 * ((10000 * endBlock) - (10000 * block.number) / endBlock - startBlock) + 5 / 10 * msg.value) + totalTokens
            require _saleState <= 3
            if not _saleState:
                require msg.value + presaleEtherRaised >= presaleEtherRaised
            ...
            call founderAddress with:
               value msg.value wei
                 gas 2300 * is_zero(value) wei
            require ext_call.success
            emit Transfer(((3000 * msg.value) + (3 * ((10000 * endBlock) - (10000 * block.number) / endBlock - startBlock) + 5 / 10 * msg.value)), 0, msg.sender);
            emit Buy(msg.value, (3000 * msg.value) + (3 * ((10000 * endBlock) - (10000 * block.number) / endBlock - startBlock) + 5 / 10 * msg.value), msg.sender);
}
