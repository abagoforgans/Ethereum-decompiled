...
function sub_00f696f4(?) {
    ...
    if formation[sha3(block.timestamp, block.difficulty, tx.origin) % stor2].field_160 == 1:
        ...
        require stor5[stor8[sha3(block.timestamp, block.difficulty, tx.origin) % stor2].field_0] <= block.number
        if eth.balance(this.address):
            require eth.balance(this.address)
            require (block.number * eth.balance(this.address)) - (stor5[stor8[sha3(block.timestamp, block.difficulty, tx.origin) % stor2].field_0] * eth.balance(this.address)) / eth.balance(this.address) == block.number - stor5[stor8[sha3(block.timestamp, block.difficulty, tx.origin) % stor2].field_0]
        require stor11 > 0
        require stor11
        require block.number - stor5[stor8[sha3(block.timestamp, block.difficulty, tx.origin) % stor2].field_0] <= stor11
        stor11 = stor11 - block.number + stor5[stor8[sha3(block.timestamp, block.difficulty, tx.origin) % stor2].field_0]
        sub_126879e6--
        sub_8da12b2b[stor8[sha3(block.timestamp, block.difficulty, tx.origin) % stor2].field_0]--
        call msg.sender with:
           value (block.number * eth.balance(this.address)) - (stor5[stor8[sha3(block.timestamp, block.difficulty, tx.origin) % stor2].field_0] * eth.balance(this.address)) / stor11 / 2 wei
...
function sub_f0385bc4(?) {
    ...
    if formation[arg1].field_0 == msg.sender:
        ...
        if block.number - stor5[address(msg.sender)] >= 69420:
            ...
            call msg.sender with:
               value 277680 * eth.balance(this.address) / stor11 wei
                 gas 2300 * is_zero(value) wei
        else:
...
function sub_2dbb323f(?) {
    ...
    if block.number - stor5[address(msg.sender)] >= 69420:
        if not eth.balance(this.address):
            require stor11 > 0
            if stor11:
                return (277680 * eth.balance(this.address) / stor11)
        else:
            if eth.balance(this.address):
                require 277680 * eth.balance(this.address) / eth.balance(this.address) == 277680
                require stor11 > 0
