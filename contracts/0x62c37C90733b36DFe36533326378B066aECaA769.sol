...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[14092 len 20]
    stor2 = code.data[14092 len 20]
    stor3 = msg.sender
    require code.data[14124 len 20]
    require code.data[14172 len 4] >= 0
    require code.data[14172 len 4] <= 10^6
    stor7 = code.data[14124 len 20]
    require ext_code.size(address(code.data[14112 len 32]))
    call address(code.data[14112 len 32]).getAddress(bytes32 arg1) with:
    ...
    if ext_call.return_data[12 len 20]:
        ...
        call address(ext_call.return_data[0]).enableFeatures(uint256 arg1, bool arg2) with:
            ...
            args 1, 1
        require ext_call.success
    uint32(stor12.field_32) = uint32(code.data[14144 len 32])
    if address(code.data[14176 len 32]):
        ...
        require address(code.data[14176 len 32])
        require address(code.data[14176 len 32]) != this.address
        require uint32(code.data[14208 len 32]) > 0
        require uint32(code.data[14208 len 32]) <= 10^6
        require stor2 != address(code.data[14176 len 32])
        require not stor11[address(code.data[14176 len 32])].field_304
        require uint32(code.data[14208 len 32] + uint32(stor12.field_0)) <= 10^6
        stor11[address(code.data[14176 len 32])].field_0 = 0
        stor11[address(code.data[14176 len 32])].field_256 = uint32(code.data[14208 len 32])
        stor11[address(code.data[14176 len 32])].field_288 = 0
        stor11[address(code.data[14176 len 32])].field_296 = 1
        stor11[address(code.data[14176 len 32])].field_304 = 1
        stor11[address(code.data[14176 len 32])].field_312 = 0
        stor11[address(code.data[14176 len 32])].field_512 = 0
        stor9.length++
        if not stor9.length <= stor9.length + 1:
            ...
            while stor9.length > idx:
                ...
                idx = idx + 1
                continue 
        address(stor9[stor9.length]) = address(code.data[14176 len 32])
        uint32(stor12.field_0) = uint32(uint32(stor12.field_0) + code.data[14208 len 32])
    return code.data[1624 len 12456]
}
