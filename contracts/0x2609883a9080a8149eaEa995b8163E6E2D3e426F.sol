    ...
    while idx < 128:
            ...
            if mem[idx + 384 len 1] <= 102:
                if mem[idx + 385 len 1] >= 97:
                    if mem[idx + 385 len 1] <= 102:
                        ...
                        t = (256 * t) + mem[idx + 385 len 1] + (16 * mem[idx + 384 len 1] - 87) - 87
                        continue 
                if mem[idx + 385 len 1] < 48:
                    idx = idx + 2
                    t = mem[idx + 385 len 1]
                    t = mem[idx + 384 len 1] - 87
                    t = (256 * t) + mem[idx + 385 len 1] + (16 * mem[idx + 384 len 1] - 87)
                    continue 
                ...
                t = mem[idx + 384 len 1] - 87
                t = (256 * t) + mem[idx + 385 len 1] + (16 * mem[idx + 384 len 1] - 87) - 48
                continue 
        if mem[idx + 384 len 1] < 48:
            if mem[idx + 385 len 1] >= 97:
                if mem[idx + 385 len 1] <= 102:
                    ...
                    t = mem[idx + 385 len 1] - 87
                    t = mem[idx + 384 len 1]
                    t = (256 * t) + mem[idx + 385 len 1] + (Mask(8, 248, mem[idx + 384]) >> 244) - 87
                    continue 
            if mem[idx + 385 len 1] < 48:
                idx = idx + 2
                t = mem[idx + 385 len 1]
                t = mem[idx + 384 len 1]
                t = (256 * t) + mem[idx + 385 len 1] + (Mask(8, 248, mem[idx + 384]) >> 244)
                continue 
            if mem[idx + 385 len 1] > 57:
                idx = idx + 2
                t = mem[idx + 385 len 1]
            ...
            t = mem[idx + 385 len 1] - 48
            t = mem[idx + 384 len 1]
            t = (256 * t) + mem[idx + 385 len 1] + (Mask(8, 248, mem[idx + 384]) >> 244) - 48
            continue 
        ...
        if mem[idx + 385 len 1] >= 97:
            if mem[idx + 385 len 1] <= 102:
                ...
                t = (256 * t) + mem[idx + 385 len 1] + (16 * mem[idx + 384 len 1] - 48) - 87
                continue 
        if mem[idx + 385 len 1] < 48:
            idx = idx + 2
            t = mem[idx + 385 len 1]
            t = mem[idx + 384 len 1] - 48
            t = (256 * t) + mem[idx + 385 len 1] + (16 * mem[idx + 384 len 1] - 48)
            continue 
        if mem[idx + 385 len 1] > 57:
            idx = idx + 2
            t = mem[idx + 385 len 1]
        ...
        t = mem[idx + 385 len 1] - 48
        t = mem[idx + 384 len 1] - 48
        t = (256 * t) + mem[idx + 385 len 1] + (16 * mem[idx + 384 len 1] - 48) - 48
        continue 
    mem[480] = 64
    ...
    while idx < 128:
            ...
            if mem[idx + 512 len 1] <= 102:
                if mem[idx + 513 len 1] >= 97:
                    if mem[idx + 513 len 1] <= 102:
                        ...
                        u = (256 * u) + mem[idx + 513 len 1] + (16 * mem[idx + 512 len 1] - 87) - 87
                        continue 
                if mem[idx + 513 len 1] < 48:
                    idx = idx + 2
                    u = mem[idx + 513 len 1]
                    u = mem[idx + 512 len 1] - 87
                    u = (256 * u) + mem[idx + 513 len 1] + (16 * mem[idx + 512 len 1] - 87)
                    continue 
                ...
                u = mem[idx + 512 len 1] - 87
                u = (256 * u) + mem[idx + 513 len 1] + (16 * mem[idx + 512 len 1] - 87) - 48
                continue 
        if mem[idx + 512 len 1] < 48:
            if mem[idx + 513 len 1] >= 97:
                if mem[idx + 513 len 1] <= 102:
                    ...
                    u = mem[idx + 513 len 1] - 87
                    u = mem[idx + 512 len 1]
                    u = (256 * u) + mem[idx + 513 len 1] + (Mask(8, 248, mem[idx + 512]) >> 244) - 87
                    continue 
            if mem[idx + 513 len 1] < 48:
                idx = idx + 2
                u = mem[idx + 513 len 1]
                u = mem[idx + 512 len 1]
                u = (256 * u) + mem[idx + 513 len 1] + (Mask(8, 248, mem[idx + 512]) >> 244)
                continue 
            if mem[idx + 513 len 1] > 57:
                idx = idx + 2
                u = mem[idx + 513 len 1]
            ...
            u = mem[idx + 513 len 1] - 48
            u = mem[idx + 512 len 1]
            u = (256 * u) + mem[idx + 513 len 1] + (Mask(8, 248, mem[idx + 512]) >> 244) - 48
            continue 
        ...
        if mem[idx + 513 len 1] >= 97:
            if mem[idx + 513 len 1] <= 102:
                ...
                u = (256 * u) + mem[idx + 513 len 1] + (16 * mem[idx + 512 len 1] - 48) - 87
                continue 
        if mem[idx + 513 len 1] < 48:
            idx = idx + 2
            u = mem[idx + 513 len 1]
            u = mem[idx + 512 len 1] - 48
            u = (256 * u) + mem[idx + 513 len 1] + (16 * mem[idx + 512 len 1] - 48)
            continue 
        if mem[idx + 513 len 1] > 57:
            idx = idx + 2
            u = mem[idx + 513 len 1]
        ...
        u = mem[idx + 513 len 1] - 48
        u = mem[idx + 512 len 1] - 48
        u = (256 * u) + mem[idx + 513 len 1] + (16 * mem[idx + 512 len 1] - 48) - 48
        continue 
    mem[608] = 64
    ...
    while idx < 128:
            ...
            if mem[idx + 640 len 1] <= 102:
                if mem[idx + 641 len 1] >= 97:
                    if mem[idx + 641 len 1] <= 102:
                        ...
                        v = (256 * v) + mem[idx + 641 len 1] + (16 * mem[idx + 640 len 1] - 87) - 87
                        continue 
                if mem[idx + 641 len 1] < 48:
                    idx = idx + 2
                    v = mem[idx + 641 len 1]
                    v = mem[idx + 640 len 1] - 87
                    v = (256 * v) + mem[idx + 641 len 1] + (16 * mem[idx + 640 len 1] - 87)
                    continue 
                ...
                v = mem[idx + 640 len 1] - 87
                v = (256 * v) + mem[idx + 641 len 1] + (16 * mem[idx + 640 len 1] - 87) - 48
                continue 
        if mem[idx + 640 len 1] < 48:
            if mem[idx + 641 len 1] >= 97:
                if mem[idx + 641 len 1] <= 102:
                    ...
                    v = mem[idx + 641 len 1] - 87
                    v = mem[idx + 640 len 1]
                    v = (256 * v) + mem[idx + 641 len 1] + (Mask(8, 248, mem[idx + 640]) >> 244) - 87
                    continue 
            if mem[idx + 641 len 1] < 48:
                idx = idx + 2
                v = mem[idx + 641 len 1]
                v = mem[idx + 640 len 1]
                v = (256 * v) + mem[idx + 641 len 1] + (Mask(8, 248, mem[idx + 640]) >> 244)
                continue 
            if mem[idx + 641 len 1] > 57:
                idx = idx + 2
                v = mem[idx + 641 len 1]
            ...
            v = mem[idx + 641 len 1] - 48
            v = mem[idx + 640 len 1]
            v = (256 * v) + mem[idx + 641 len 1] + (Mask(8, 248, mem[idx + 640]) >> 244) - 48
            continue 
        ...
        if mem[idx + 641 len 1] >= 97:
            if mem[idx + 641 len 1] <= 102:
                ...
                v = (256 * v) + mem[idx + 641 len 1] + (16 * mem[idx + 640 len 1] - 48) - 87
                continue 
        if mem[idx + 641 len 1] < 48:
            idx = idx + 2
            v = mem[idx + 641 len 1]
            v = mem[idx + 640 len 1] - 48
            v = (256 * v) + mem[idx + 641 len 1] + (16 * mem[idx + 640 len 1] - 48)
            continue 
        if mem[idx + 641 len 1] > 57:
            idx = idx + 2
            v = mem[idx + 641 len 1]
        ...
        v = mem[idx + 641 len 1] - 48
        v = mem[idx + 640 len 1] - 48
        v = (256 * v) + mem[idx + 641 len 1] + (16 * mem[idx + 640 len 1] - 48) - 48
        continue 
