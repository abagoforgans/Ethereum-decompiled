...
function open() {
    ...
    emit 0xdb6aca7f: ext_call.return_data[0], this.address
...
function give(uint256 arg1, address arg2) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit 0x24ed1710: arg1, address(this.address), arg2
}
...
function wipe(uint256 arg1, uint256 arg2) {
    ...
    if arg2 > 0:
        ...
        if not (1000000000 * 10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            emit 0xc61fae64: arg1, ext_call.return_data[32], ext_call.return_data[0] / 2 / ext_call.return_data[0], ext_call.return_data[0], this.address
        else:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            emit 0xc61fae64: arg1, ext_call.return_data[32], (10^18 * (arg2 * (1000000000 * 10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18) + (ext_call.return_data[0] / 2) / ext_call.return_data[0], ext_call.return_data[0], this.address
}
    ...
    if msg.value > 0:
        ...
        if not ext_call.return_data[0]:
            ...
            if 0 <= msg.value:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                emit 0xa66947e0: arg1, msg.value, (1000000000 * 10^18 * msg.value) + (ext_call.return_data[0] / 2) / ext_call.return_data[0], this.address
            else:
                call 0x448a5065aebb8e423f0896e6c5d525c040f59af3.join(uint256 arg1) with:
                     gas gas_remaining wei
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                emit 0xa66947e0: arg1, msg.value, ((1000000000 * 10^18 * msg.value) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]) - 1, this.address
        else:
            require ext_call.return_data[0]
    ...
    if msg.value > 0:
        ...
        if not ext_call.return_data[0]:
            ...
            if 0 <= msg.value:
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                emit 0xa66947e0: ext_call.return_data[0], msg.value, (1000000000 * 10^18 * msg.value) + (ext_call.return_data[0] / 2) / ext_call.return_data[0], this.address
            else:
                call 0x448a5065aebb8e423f0896e6c5d525c040f59af3.join(uint256 arg1) with:
                     gas gas_remaining wei
                    args (((1000000000 * 10^18 * msg.value) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]) - 1)
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                emit 0xa66947e0: ext_call.return_data[0], msg.value, ((1000000000 * 10^18 * msg.value) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]) - 1, this.address
        else:
            require ext_call.return_data[0]
            if (1000000000 * 10^18 * msg.value) + (ext_call.return_data[0] / 2) / ext_call.return_data[0] * ext_call.return_data[0] / ext_call.return_data[0] != (1000000000 * 10^18 * msg.value) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]:
                revert with 0, 'math-not-safe'
    ...
    if arg2 > 0:
        ...
        if not ext_call.return_data[0]:
            ...
            if 0 <= arg2:
                ...
                emit 0xbc364e2c: arg1, ext_call.return_data[0], (1000000000 * 10^18 * arg2) + (ext_call.return_data[0] / 2) / ext_call.return_data[0], this.address
            else:
                call 0x448a5065aebb8e423f0896e6c5d525c040f59af3.free(bytes32 arg1, uint256 arg2) with:
                     gas gas_remaining wei
                ...
                call msg.sender with:
                   value ext_call.return_data[0] wei
                     gas 2300 * is_zero(value) wei
                emit 0xbc364e2c: arg1, ext_call.return_data[0], ((1000000000 * 10^18 * arg2) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]) - 1, this.address
        else:
            require ext_call.return_data[0]
...
function sub_ea16a202(?) payable {
    ...
    if arg3 > 0:
        ...
        if not (1000000000 * 10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]:
            ...
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            emit 0xc61fae64: arg1, ext_call.return_data[32], (10^18 * (arg3 * (1000000000 * 10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18) + (ext_call.return_data[0] / 2) / ext_call.return_data[0], ext_call.return_data[0], this.address
    if arg2 > 0:
        require ext_code.size(0x448a5065aebb8e423f0896e6c5d525c040f59af3)
        staticcall 0x448a5065aebb8e423f0896e6c5d525c040f59af3.skr() with:
                gas gas_remaining wei
