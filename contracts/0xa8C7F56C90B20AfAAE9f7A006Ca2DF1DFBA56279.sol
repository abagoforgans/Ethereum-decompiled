...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor0 = msg.sender
    stor2 = code.data[9026 len 20]
    require stor0 == msg.sender
    stor3 = code.data[9058 len 20]
    require ext_code.size(code.data[9058 len 20])
    call code.data[9058 len 20].isPricingStrategy() with:
         gas gas_remaining - 50 wei
    require ext_call.success
    require ext_call.return_data[0]
    stor5 = code.data[9090 len 20]
    require code.data[9090 len 20]
    require code.data[9110 len 32]
    stor7 = code.data[9110 len 32]
    require code.data[9142 len 32]
    stor8 = code.data[9142 len 32]
    require stor7 < code.data[9142 len 32]
    stor6 = code.data[9174 len 32]
    stor19 = code.data[9206 len 32]
    return code.data[559 len 8455]
}
...
function reissuedTransactions(uint256 arg1) {
...
function getRestoredTransactionStatus(uint256 arg1) {
    return bool(stor20[arg1])
}
...
function setInvestorData(address arg1, uint256 arg2, uint256 arg3, uint256 arg4) {
    require owner == msg.sender
    if not investedAmountOf[address(arg1)]:
        investorCount++
    investedAmountOf[address(arg1)] += arg2
    tokenAmountOf[address(arg1)] += arg3
    uint256(weiRaised) += arg2
    tokensSold += arg3
    emit Invested(address(arg1), arg2, arg3, 0);
    emit RestoredInvestment(address(arg1), arg4);
}
...
function setInvestorDataAndIssueNewToken(address arg1, uint256 arg2, uint256 arg3, uint256 arg4) {
    require owner == msg.sender
    require not stor20[arg4]
    require owner == msg.sender
    if not investedAmountOf[address(arg1)]:
        investorCount++
    investedAmountOf[address(arg1)] += arg2
...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0xd7c14ff22fe0c1cb213f7c2d0f494d192e1c86f5)
    delegate 0xd7c14ff22fe0c1cb213f7c2d0f494d192e1c86f5.0x66098d4f with:
         gas gas_remaining - 50 wei
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0xd7c14ff22fe0c1cb213f7c2d0f494d192e1c86f5):
                            delegate 0xd7c14ff22fe0c1cb213f7c2d0f494d192e1c86f5.0x66098d4f with:
                                 gas gas_remaining - 50 wei
