...
function initialize(address arg1) {
    ...
    name.length.field_8 = 'Medical Coin' / 256
    idx = 0
    ...
    while symbol.length + 31 / 32 > idx:
        ...
        continue 
    decimals = 18
    totalSupply = 10^11 * 10^18
    balanceOf[address(arg1)] = 10^11 * 10^18
    emit Transfer(100000000000 * 10^18, 0, arg1);
    owner = arg1
    stor8[stor7] = 1
}
