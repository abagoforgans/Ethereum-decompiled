...
function _fallback() {
    ...
    stor0 = msg.sender
    require msg.sender
    stor8 = code.data[2461 len 20]
    require ext_code.size(code.data[2461 len 20])
    call code.data[2461 len 20].0xeefa597b with:
         gas gas_remaining - 50 wei
    require ext_call.success
    require ext_call.return_data[0]
    require code.data[2417 len 32]
    stor6 = code.data[2417 len 32]
    return code.data[292 len 2125]
}
...
function lock(uint256 arg1) {
    require owner == msg.sender
    require lockedAt <= 0
    require arg1 == tokensAllocatedTotal
    require ext_code.size(tokenAddress)
    call tokenAddress.0x70a08231 with:
         gas gas_remaining - 50 wei
        args this.address
