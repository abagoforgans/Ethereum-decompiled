            ...
            if tokensPerEth * msg.value / 10^18:
                ...
                if stor4[address(msg.sender)]:
                    ...
                    if progress0drop > target0drop:
                        ...
                        require not stor13
                        require totalDistributed + 5000 >= totalDistributed
                        totalDistributed += 5000
                        require balanceOf[address(msg.sender)] + 5000 >= balanceOf[address(msg.sender)]
                        balanceOf[address(msg.sender)] += 5000
                        emit Distr(5000, msg.sender);
                        emit Transfer(5000, 0, msg.sender);
