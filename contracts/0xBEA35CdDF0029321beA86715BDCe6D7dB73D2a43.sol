...
function hatchEggs(address arg1) {
    ...
    if EGGS_TO_HATCH_1SHRIMP < block.timestamp - lastHatch[address(msg.sender)]:
        if not EGGS_TO_HATCH_1SHRIMP:
            ...
            claimedEggs[address(msg.sender)] = 0
            lastHatch[address(msg.sender)] = block.timestamp
            require claimedEggs[stor8[address(msg.sender)]] + (claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) / 5) >= claimedEggs[stor8[address(msg.sender)]]
            claimedEggs[stor8[address(msg.sender)]] += claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) / 5
        ...
        if not block.timestamp - lastHatch[address(msg.sender)]:
            ...
            claimedEggs[address(msg.sender)] = 0
            lastHatch[address(msg.sender)] = block.timestamp
            require claimedEggs[stor8[address(msg.sender)]] + (claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]) / 5) >= claimedEggs[stor8[address(msg.sender)]]
            claimedEggs[stor8[address(msg.sender)]] += claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]) / 5
        ...
        if not EGGS_TO_HATCH_1SHRIMP:
            ...
            if not stor2:
                if not stor3:
                    ...
                    require stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) >= stor3
                    require stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                    if not 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])):
                        claimedEggs[address(msg.sender)] = 0
                        lastHatch[address(msg.sender)] = block.timestamp
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require 0 <= 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                        call msg.sender with:
                           value 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) wei
                             gas 2300 * is_zero(value) wei
                    else:
                        require 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                        require 4 * 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) == 4
                        claimedEggs[address(msg.sender)] = 0
                        lastHatch[address(msg.sender)] = block.timestamp
                        require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                        marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                        call ceoAddress with:
                           value 4 * 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100 wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require 4 * 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100 <= 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                        call msg.sender with:
                           value (0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))) - (4 * 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100) wei
                             gas 2300 * is_zero(value) wei
                else:
                    require stor3
                    require (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / stor3 == claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                    require (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) >= 0
                    require claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                    require stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) >= stor3
                    require stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                    if not 0 / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])):
                        claimedEggs[address(msg.sender)] = 0
                        lastHatch[address(msg.sender)] = block.timestamp
                        require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                        marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require 0 <= 0 / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                        call msg.sender with:
                           value 0 / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) wei
                             gas 2300 * is_zero(value) wei
                    else:
                        require 0 / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                        require 4 * 0 / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 0 / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) == 4
                        claimedEggs[address(msg.sender)] = 0
                        lastHatch[address(msg.sender)] = block.timestamp
                        require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                        marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                        call ceoAddress with:
                           value 4 * 0 / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100 wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require 4 * 0 / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100 <= 0 / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                        call msg.sender with:
                           value (0 / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))) - (4 * 0 / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100) wei
                             gas 2300 * is_zero(value) wei
            else:
                require stor2
                require stor2 * eth.balance(this.address) / stor2 == eth.balance(this.address)
                if not stor2:
                    if not stor3:
                        ...
                        require stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) >= stor3
                        require stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                        if not stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])):
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require 0 <= stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                            call msg.sender with:
                               value stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) wei
                                 gas 2300 * is_zero(value) wei
                        else:
                            require stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                            require 4 * stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) == 4
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                            call ceoAddress with:
                               value 4 * stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100 wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require 4 * stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100 <= stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                            call msg.sender with:
                               value (stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))) - (4 * stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
                    else:
                        require stor3
                        require (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / stor3 == claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                        ...
                        require stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) >= stor3
                        require stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                        if not stor2 * eth.balance(this.address) / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])):
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require 0 <= stor2 * eth.balance(this.address) / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                            call msg.sender with:
                               value stor2 * eth.balance(this.address) / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) wei
                                 gas 2300 * is_zero(value) wei
                        else:
                            require stor2 * eth.balance(this.address) / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                            require 4 * stor2 * eth.balance(this.address) / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / stor2 * eth.balance(this.address) / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) == 4
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                            call ceoAddress with:
                               value 4 * stor2 * eth.balance(this.address) / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100 wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require 4 * stor2 * eth.balance(this.address) / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100 <= stor2 * eth.balance(this.address) / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                            call msg.sender with:
                               value (stor2 * eth.balance(this.address) / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))) - (4 * stor2 * eth.balance(this.address) / stor3 + ((claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
                else:
                    require stor2
                    require stor2 * marketEggs / stor2 == marketEggs
                    if not stor3:
                        require stor2 * marketEggs >= stor2 * marketEggs
                        require claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                        require stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) >= stor3
                        require stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                        if not stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])):
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require 0 <= stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                            call msg.sender with:
                               value stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) wei
                                 gas 2300 * is_zero(value) wei
                        else:
                            require stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                            require 4 * stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) == 4
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                            call ceoAddress with:
                               value 4 * stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100 wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require 4 * stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100 <= stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                            call msg.sender with:
                               value (stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))) - (4 * stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
                    else:
                        require stor3
                        require (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / stor3 == claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                        require (stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) >= stor2 * marketEggs
                        require claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                        require stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) >= stor3
                        require stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                        if not stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])):
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require 0 <= stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                            call msg.sender with:
                               value stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) wei
                                 gas 2300 * is_zero(value) wei
                        else:
                            require stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                            require 4 * stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) == 4
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])
                            call ceoAddress with:
                               value 4 * stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100 wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require 4 * stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100 <= stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))
                            call msg.sender with:
                               value (stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)]))) - (4 * stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (EGGS_TO_HATCH_1SHRIMP * hatcheryShrimp[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
    else:
        if not block.timestamp - lastHatch[address(msg.sender)]:
            require claimedEggs[address(msg.sender)] >= claimedEggs[address(msg.sender)]
            ...
            if not stor2:
                if not stor3:
                    ...
                    require stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) >= stor3
                    require stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]))
                    if not 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])):
                        claimedEggs[address(msg.sender)] = 0
                        lastHatch[address(msg.sender)] = block.timestamp
                        ...
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require 0 <= 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]))
                        call msg.sender with:
                           value 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) wei
                             gas 2300 * is_zero(value) wei
                    else:
                        require 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]))
                        ...
                        marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])
                        call ceoAddress with:
                           value 4 * 0 / stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) / 100 wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                    ...
                    require (claimedEggs[address(msg.sender)] * stor3) + (block.timestamp * hatcheryShrimp[address(msg.sender)] * stor3) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)] * stor3) >= 0
                    require claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])
                ...
                if not stor2:
                    if not stor3:
                        ...
                        require stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) >= stor3
                        require stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]))
                        if not stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])):
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require 0 <= stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]))
                            call msg.sender with:
                               value stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) wei
                                 gas 2300 * is_zero(value) wei
                        else:
                            require stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]))
                            ...
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])
                            call ceoAddress with:
                               value 4 * stor2 * eth.balance(this.address) / stor3 + (0 / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) / 100 wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                    ...
                    if not stor3:
                        require stor2 * marketEggs >= stor2 * marketEggs
                        require claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])
                        require stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) >= stor3
                        require stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]))
                        if not stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])):
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require 0 <= stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]))
                            call msg.sender with:
                               value stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) wei
                                 gas 2300 * is_zero(value) wei
                        else:
                            require stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]))
                            ...
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])
                            call ceoAddress with:
                               value 4 * stor2 * eth.balance(this.address) / stor3 + (stor2 * marketEggs / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) / 100 wei
                                 gas 2300 * is_zero(value) wei
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                        ...
                        require stor3
                        require (claimedEggs[address(msg.sender)] * stor3) + (block.timestamp * hatcheryShrimp[address(msg.sender)] * stor3) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)] * stor3) / stor3 == claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])
                        require (stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (block.timestamp * hatcheryShrimp[address(msg.sender)] * stor3) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)] * stor3) >= stor2 * marketEggs
                        require claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])
                        ...
                        if not stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (block.timestamp * hatcheryShrimp[address(msg.sender)] * stor3) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])):
                            ...
                            require 4 * stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (block.timestamp * hatcheryShrimp[address(msg.sender)] * stor3) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) / stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (block.timestamp * hatcheryShrimp[address(msg.sender)] * stor3) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) == 4
                            claimedEggs[address(msg.sender)] = 0
                            lastHatch[address(msg.sender)] = block.timestamp
                            require marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]) >= marketEggs
                            marketEggs = marketEggs + claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])
                            ...
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require 4 * stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (block.timestamp * hatcheryShrimp[address(msg.sender)] * stor3) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) / 100 <= stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (block.timestamp * hatcheryShrimp[address(msg.sender)] * stor3) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]))
                            call msg.sender with:
                               value (stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (block.timestamp * hatcheryShrimp[address(msg.sender)] * stor3) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)]))) - (4 * stor2 * eth.balance(this.address) / stor3 + ((stor2 * marketEggs) + (claimedEggs[address(msg.sender)] * stor3) + (block.timestamp * hatcheryShrimp[address(msg.sender)] * stor3) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)] * stor3) / claimedEggs[address(msg.sender)] + (block.timestamp * hatcheryShrimp[address(msg.sender)]) - (lastHatch[address(msg.sender)] * hatcheryShrimp[address(msg.sender)])) / 100) wei
                                 gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
