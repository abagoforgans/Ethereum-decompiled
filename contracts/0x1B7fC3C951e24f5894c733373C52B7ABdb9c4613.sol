...
function registerNameXnameFromDapp(address arg1, bytes32 arg2, bytes32 arg3, bool arg4) payable {
    ...
    if uint256(pIDxAddr_[address(arg1)]):
        if not playerAddr[uint256(stor7[address(arg1)])].field_512:
            if not arg3:
                playerAddr[uint256(stor7[address(arg1)])].field_512 = 1
            else:
                if arg2 == arg3:
                    playerAddr[uint256(stor7[address(arg1)])].field_512 = 1
                else:
        ...
        if arg4 == 1:
            ...
            while idx <= gID_:
                ...
                mem[132] = arg1
                mem[164] = arg2
                mem[196] = playerAddr[uint256(stor7[address(arg1)])].field_512
                require ext_code.size(games_[idx])
                call games_[idx].receivePlayerInfo(uint256 arg1, address arg2, bytes32 arg3, uint256 arg4) with:
                     gas gas_remaining wei
                    args uint256(pIDxAddr_[address(arg1)]), address(arg1), arg2, playerAddr[uint256(stor7[address(arg1)])].field_512
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                idx = idx + 1
                continue 
        emit onNewName(0, playerAddr[uint256(stor7[address(arg1)])].field_512, playerAddr[playerAddr[uint256(stor7[address(arg1)])].field_512].field_0, playerAddr[playerAddr[uint256(stor7[address(arg1)])].field_512].field_256, msg.value, block.timestamp, uint256(pIDxAddr_[address(arg1)]), arg1, arg2);
        return 0, playerAddr[uint256(stor7[address(arg1)])].field_512
    pID_++
    uint256(pIDxAddr_[address(arg1)]) = pID_ + 1
    playerAddr[stor6 + 1].field_0 = arg1
    if not playerAddr[uint256(stor7[address(arg1)])].field_512:
    ...
    if arg4 == 1:
        ...
        while idx <= gID_:
            ...
            idx = idx + 1
            continue 
    emit onNewName(1, playerAddr[uint256(stor7[address(arg1)])].field_512, playerAddr[playerAddr[uint256(stor7[address(arg1)])].field_512].field_0, playerAddr[playerAddr[uint256(stor7[address(arg1)])].field_512].field_256, msg.value, block.timestamp, uint256(pIDxAddr_[address(arg1)]), arg1, arg2);
    return 1, playerAddr[uint256(stor7[address(arg1)])].field_512
}
        ...
        if not playerAddr[uint256(stor7[address(arg1)])].field_512:
            if not arg3:
                ...
                if arg3 == uint256(pIDxAddr_[address(arg1)]):
                    ...
                    if not playerAddr[arg3].field_256:
                        playerAddr[uint256(stor7[address(arg1)])].field_512 = 1
                    else:
