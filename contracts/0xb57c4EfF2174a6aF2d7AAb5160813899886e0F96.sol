...
const sub_c5e48e53(?) = mem[2304 len 1024]
    ...
    while idx < 64:
            ...
            if mem[(2 * idx) + 128 len 1] <= 102:
                if mem[(2 * idx) + 129 len 1] >= 97:
                    if mem[(2 * idx) + 129 len 1] <= 102:
                        require idx < 32
                        mem[(32 * idx) + ceil32(arg1.length) + 1184] = (16 * mem[(2 * idx) + 128 len 1] - 87) + mem[(2 * idx) + 129 len 1] - 87 << 248
                ...
                if mem[(2 * idx) + 129 len 1] < 48:
                    mem[(32 * idx) + ceil32(arg1.length) + 1184] = (16 * mem[(2 * idx) + 128 len 1] - 87) + mem[(2 * idx) + 129 len 1] << 248
                ...
                if mem[(2 * idx) + 129 len 1] > 57:
                    ...
                    idx = idx + 1
                    continue 
                mem[(32 * idx) + ceil32(arg1.length) + 1184] = (16 * mem[(2 * idx) + 128 len 1] - 87) + mem[(2 * idx) + 129 len 1] - 48 << 248
        ...
        if mem[(2 * idx) + 128 len 1] < 48:
            if mem[(2 * idx) + 129 len 1] >= 97:
                if mem[(2 * idx) + 129 len 1] <= 102:
                    require idx < 32
                    mem[(32 * idx) + ceil32(arg1.length) + 1184] = (Mask(8, 248, mem[(2 * idx) + 128]) >> 244) + mem[(2 * idx) + 129 len 1] - 87 << 248
                    s = mem[(2 * idx) + 129 len 1] - 87
            ...
            require idx < 32
            if mem[(2 * idx) + 129 len 1] < 48:
                mem[(32 * idx) + ceil32(arg1.length) + 1184] = (Mask(8, 248, mem[(2 * idx) + 128]) >> 244) + mem[(2 * idx) + 129 len 1] << 248
                s = mem[(2 * idx) + 129 len 1]
                s = mem[(2 * idx) + 128 len 1]
                idx = idx + 1
                continue 
            if mem[(2 * idx) + 129 len 1] > 57:
                ...
                idx = idx + 1
                continue 
            mem[(32 * idx) + ceil32(arg1.length) + 1184] = (Mask(8, 248, mem[(2 * idx) + 128]) >> 244) + mem[(2 * idx) + 129 len 1] - 48 << 248
            s = mem[(2 * idx) + 129 len 1] - 48
            s = mem[(2 * idx) + 128 len 1]
            idx = idx + 1
            continue 
        ...
        if mem[(2 * idx) + 129 len 1] >= 97:
            if mem[(2 * idx) + 129 len 1] <= 102:
                require idx < 32
                mem[(32 * idx) + ceil32(arg1.length) + 1184] = (16 * mem[(2 * idx) + 128 len 1] - 48) + mem[(2 * idx) + 129 len 1] - 87 << 248
                s = mem[(2 * idx) + 129 len 1] - 87
        ...
        require idx < 32
        if mem[(2 * idx) + 129 len 1] < 48:
            mem[(32 * idx) + ceil32(arg1.length) + 1184] = (16 * mem[(2 * idx) + 128 len 1] - 48) + mem[(2 * idx) + 129 len 1] << 248
            s = mem[(2 * idx) + 129 len 1]
            s = mem[(2 * idx) + 128 len 1] - 48
            idx = idx + 1
            continue 
        if mem[(2 * idx) + 129 len 1] > 57:
            ...
            idx = idx + 1
            continue 
        mem[(32 * idx) + ceil32(arg1.length) + 1184] = (16 * mem[(2 * idx) + 128 len 1] - 48) + mem[(2 * idx) + 129 len 1] - 48 << 248
        s = mem[(2 * idx) + 129 len 1] - 48
        s = mem[(2 * idx) + 128 len 1] - 48
        idx = idx + 1
        continue 
