...
function contestants(uint256 arg1) {
    return address(contestants[arg1].field_0), contestants[arg1].field_256, contestants[arg1].field_512
}
...
function endRaffle() {
    if rakeAddress == msg.sender:
        ...
        while idx < 6:
            ...
            idx = idx + 1
            continue 
        emit RaffleResult(7, 0, raffleId);
        raffleId++
        nextTicket = 0
        gaps.length = 0
