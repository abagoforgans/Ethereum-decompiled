...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0x214e5ad0d721cf84b33a234437b9a3cb29e61dc7)
    delegate 0x214e5ad0d721cf84b33a234437b9a3cb29e61dc7.0x66098d4f with:
         gas gas_remaining - 50 wei
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0x214e5ad0d721cf84b33a234437b9a3cb29e61dc7):
                            delegate 0x214e5ad0d721cf84b33a234437b9a3cb29e61dc7.0x66098d4f with:
                                 gas gas_remaining - 50 wei
