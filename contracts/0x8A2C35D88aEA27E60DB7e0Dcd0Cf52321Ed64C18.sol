...
function _fallback() payable {
    stor2 = 0x5b0e4d57caf96021ce1c1c467100ad44f2b984d7ff71a525536eec64977
...
function sub_6d8d11f2(?) {
    require stor1[address(msg.sender)]
    if block.number >= (arg1 / 27776) + 1:
        if block.number < (arg1 / 27776) + 20:
            require stor1[address(msg.sender)]
            require ext_code.size(stor6)
            call stor6.0x19774d43 with:
                 gas gas_remaining - 710 wei
...
function sub_c4610fd5(?) {
    require stor1[address(msg.sender)]
    if block.number >= (arg1 / 27776) + 2:
        if block.number < (arg1 / 27776) + 20:
            require stor1[address(msg.sender)]
            require ext_code.size(stor6)
            call stor6.0x19774d43 with:
