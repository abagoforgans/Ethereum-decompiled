    ...
    if msg.value <= stor4:
        ...
        if stor3 >= msg.value + stor0:
            if not stor11.length > stor11.length + 1:
                ...
                stor1.length++
                if not uint256(stor[code.data[3256 len 32] + (3 * stor9)]):
                    if msg.value < 10^18:
                        call msg.sender with:
                ...
                call stor175B[stor9] with:
                   value uint256(stor[code.data[3256 len 32] + (3 * stor9)]) wei
                     gas 0 wei
                stor0 -= uint256(stor[code.data[3256 len 32] + (3 * stor9)])
                stor175B[stor9] = 1
                stor9++
                if not uint256(stor[code.data[3256 len 32] + (3 * stor9)]):
                    if msg.value < 10^18:
