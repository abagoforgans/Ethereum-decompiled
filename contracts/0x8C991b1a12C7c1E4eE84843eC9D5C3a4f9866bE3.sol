...
function getTokens(address arg1, uint256 arg2, uint256 arg3) payable {
...
function sub_21648c0e(?) {
    require ext_code.size(arg2)
    call arg2.tokenAddress() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if not arg1:
        ...
        if ext_call.return_data[0] < ext_call.return_data[0]:
            ...
            require return_data.size >= 32
    require ext_code.size(arg2)
    call arg2.tokenToEthTransferInput(uint256 arg1, uint256 arg2, uint256 arg3, address arg4) with:
         gas gas_remaining wei
        args 0, arg3, arg4, arg5, msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(address(ext_call.return_data[0]))
