...
function _fallback() payable {
    ...
    require code.data[5317 len 32] > block.timestamp
    require code.data[5317 len 32] >= code.data[5285 len 32]
    require code.data[5361 len 20]
    require code.data[5393 len 20]
    stor1 = code.data[5285 len 32]
    stor2 = code.data[5317 len 32]
    stor6 = code.data[5361 len 20]
    uint8(stor5.field_0) = 0
    return code.data[536 len 4749]
}
...
const maximumFunding = 11354 * 10^18
...
function _fallback() payable {
    ...
    require endFundingTime > block.timestamp
    require totalCollected < 11354 * 10^18
