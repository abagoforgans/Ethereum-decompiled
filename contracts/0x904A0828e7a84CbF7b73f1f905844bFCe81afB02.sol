...
function sub_2f1030dd(?) {
    require calldata.size - 4 >= 32
    require msg.sender == warriorToOwner[arg1]
    require sub_602493ab[address(msg.sender)] >= 25
    sub_602493ab[address(msg.sender)] -= 25
    require arg1 < sub_1a170712.length
    sub_1a170712[arg1].field_1312 = 0
    emit 0x760cd978: arg1
}
...
function sub_7a1da2cc(?) {
    if sub_1a170712.length:
        mem[128 len 32 * sub_1a170712.length] = code.data[24543 len 32 * sub_1a170712.length]
    idx = 0
...
function sub_4a5285ea(?) payable {
    ...
    balanceOf[address(msg.sender)]++
    require 1 <= balanceOf[stor7[arg1]]
...
function sub_6f29743e(?) {
    require calldata.size - 4 >= 32
    if stor10[arg1]:
        mem[128 len 32 * stor10[arg1]] = code.data[24543 len 32 * stor10[arg1]]
    idx = 0
    s = 0
    while idx < sub_1a170712.length:
        mem[0] = idx
...
function sub_574bd50c(?) {
    ...
    if balanceOf[address(arg1)]:
        mem[128 len 32 * balanceOf[address(arg1)]] = code.data[24543 len 32 * balanceOf[address(arg1)]]
    idx = 0
    s = 0
    while idx < sub_1a170712.length:
        mem[0] = idx
...
function buyWarrior(uint256 arg1) payable {
    ...
    if warriorToOwner[arg1] == owner:
        ...
        require 250 * sub_1a170712[arg1].field_1792 / 10000 <= sub_1a170712[arg1].field_1792
        require balanceOf[address(msg.sender)] + 1 >= balanceOf[address(msg.sender)]
        balanceOf[address(msg.sender)]++
        require 1 <= balanceOf[stor7[arg1]]
        balanceOf[stor7[arg1]]--
        ...
        emit Transfer(arg1, warriorToOwner[arg1], msg.sender);
        call warriorToOwner[arg1] with:
           value sub_1a170712[arg1].field_1792 - (250 * sub_1a170712[arg1].field_1792 / 10000) wei
             gas 2300 * is_zero(value) wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    emit 0xfd01ee47: arg1
...
function sub_308fa857(?) payable {
    ...
    mem[ceil32(arg2.length) + ceil32(arg3.length) + 160] = stor4.length
    mem[ceil32(arg2.length) + ceil32(arg3.length) + 192] = 96
    mem[ceil32(arg2.length) + ceil32(arg3.length) + 224] = ceil32(arg2.length) + 128
    ...
    mem[ceil32(arg2.length) + ceil32(arg3.length) + 352] = arg7
    require arg1 < stor4.length
    stor4[arg1].field_0 = stor4.length
    stor[sha3((6 * arg1) + ('name', 'stor4', 4) + 1)][].field_0 = Array(len=arg2.length, data=arg2[all])
    stor[sha3((6 * arg1) + ('name', 'stor4', 4) + 2)][].field_0 = Array(len=Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 0), mem[arg2.length + 160 len -arg2.length + ceil32(arg2.length)], data=mem[ceil32(arg2.length) + 160 len Mask(8 * -ceil32(arg2.length) + arg2.length + 32, 0, 0), mem[arg2.length + 160 len -arg2.length + ceil32(arg2.length)]])
    stor4[arg1].field_768 = arg4
    stor4[arg1].field_1024 = arg5
    stor4[arg1].field_1056 = Mask(224, 0, arg6)
    stor4[arg1].field_1280 = arg7
    stor5[arg1] = uint8(arg6)
    sub_dbbd9eed[arg1] = arg7
}
...
function sub_d07aeef2(?) {
    ...
    sub_10c3a81d[stor3.length] = 0
    stor23[stor3.length] = 0
    emit 0x7cd9d1b3: sub_1a170712.length, Array(len=arg1.length, data=arg1[all]), (10^17 * _106 % 10^10 / 10^10 % 5) + (10^15 * _106 % 10^10 / 100 * 10^6 % 100 % 5) + (10^13 * _106 % 10^10 / 10^6 % 100 % 5) + (10^11 * _106 % 10^10 / 10000 % 100 % 5) + (10^9 * _106 % 10^10 / 100 % 100 % 5) + (10 * 10^6 * block.timestamp / 10000 % 10) + (10000 * block.timestamp / 100 % 10) + (10 * block.timestamp % 10) + 101010101005005005
