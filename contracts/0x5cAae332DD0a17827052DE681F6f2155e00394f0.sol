...
function _fallback() payable {
    ...
    stor5.length.field_8 = 'SharkToken' / 256
    idx = 0
    ...
    stor4 = msg.sender
    stor15 = 16000000 * 10^18
    stor16 = 1600000 * 10^18
    stor8 = block.timestamp
    stor9 = block.number
    stor17[address(msg.sender)] = 1600000 * 10^18
    stor14 = 1600000 * 10^18
    return code.data[473 len 6524]
}
