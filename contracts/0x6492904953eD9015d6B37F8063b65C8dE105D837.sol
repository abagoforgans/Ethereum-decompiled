...
function persons(uint256 arg1) payable {
    ...
    return address(stor0[arg1].field_0), stor[code.data[1123 len 32] + (2 * arg1)]
}

function enter() payable {
    if regeneration + 30 >= block.timestamp:
    ...
    if msg.value <= 10 * 10^18:
        ...
        if not stor0.length > stor0.length + 1:
            ...
            stor[code.data[1123 len 32] + (2 * stor0.length)] = msg.value
            ...
            if balance <= 200 * stor[code.data[1123 len 32] + (2 * stor1)] / 100:
        ...
        if not stor0.length > stor0.length + 1:
            require stor0.length < stor0.length
            stor0[stor0.length].field_0 = msg.sender or Mask(96, 160, stor0[stor0.length].field_0)
            stor[code.data[1123 len 32] + (2 * stor0.length)] = 10 * 10^18
            regeneration = block.timestamp
            if not stor0.length:
                balance += 10 * 10^18
            else:
