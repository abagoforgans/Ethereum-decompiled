...
function _fallback() payable {
    create contract with 0 wei
                    code: code.data[2635 len 2546]
    require create.new_address
    stor4 = address(create.new_address)
    require not msg.value
    stor0 = msg.sender
    stor1 = 0xea15adb66dc92a4bbccc8bf32fd25e2e86a2a770
    stor3 = 0xb3ed172cc64839fb0c0aa06aa129f402e994e7de
    stor2 = 40
    stor8 = 14658 * 10^10
    stor5 = 419136 * 24 * 3600
    stor6 = 365
    stor7 = 14749891 * 10^16
    stor9 = 100392 * 10^16
    return code.data[272 len 2363]
}
