...
function sub_7a1da2cc(?) {
    if sub_1a170712.length:
        mem[128 len 32 * sub_1a170712.length] = code.data[24572 len 32 * sub_1a170712.length]
    idx = 0
...
function sub_6f29743e(?) {
    require calldata.size - 4 >= 32
    if stor10[arg1]:
        mem[128 len 32 * stor10[arg1]] = code.data[24572 len 32 * stor10[arg1]]
    idx = 0
    s = 0
    while idx < sub_1a170712.length:
        mem[0] = idx
...
function sub_574bd50c(?) {
    ...
    if balanceOf[address(arg1)]:
        mem[128 len 32 * balanceOf[address(arg1)]] = code.data[24572 len 32 * balanceOf[address(arg1)]]
    idx = 0
    s = 0
    while idx < sub_1a170712.length:
        mem[0] = idx
