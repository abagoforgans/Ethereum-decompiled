...
function set(uint256 arg1) payable {
    ...
    Mask(248, 0, stor5.length.field_8) = '13-20,02' / 256
    ...
    Mask(248, 0, stor6.length.field_8) = '19-20,02' / 256
    ...
    if 10 == get:
        if block.number + bool(block.difficulty) != 0:
            ...
            while stor6.length + 224 > idx + 32:
                ...
                s = s + 1
                continue 
            call stor3.mem[224 len 4] with:
               value 5 * 10^17 wei
                 gas gas_remaining - 34050 wei
                args mem[228 len stor6.length + (floor32(stor6.length - 1) + -stor6.length + 32 % 32) - 4]
        else:
            mem[224] = uint256(stor5.field_0)
            idx = 224
            s = 0
            while stor5.length + 224 > idx + 32:
            ...
            call stor3.mem[224 len 4] with:
               value 5 * 10^17 wei
                 gas gas_remaining - 34050 wei
                args mem[228 len stor5.length + (floor32(stor5.length - 1) + -stor5.length + 32 % 32) - 4]
}
