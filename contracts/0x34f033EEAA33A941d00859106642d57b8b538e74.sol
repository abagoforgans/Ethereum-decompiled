...
function NextPayout() payable {
    ...
    return (stor[code.data[1865 len 32] + (3 * stor1)] / 10^15)
}
        ...
        if watchBalance >= 10^15:
            if stor9.length % 10 != 0:
                ...
                if msg.value <= 10^15:
                    ...
                    require stor1 < stor9.length
                    if msg.value <= stor[code.data[1865 len 32] + (3 * stor1)]:
                        if watchBalance <= stor6E15[stor1]:
                        require stor1 < stor9.length
                        # nil
                    else:
        ...
        if watchBalance >= 10^15:
            if stor9.length % 10 != 0:
                ...
                if stor9.length <= 1:
                    ...
                    stor9[stor9.length].field_256 = (10^17 * stor4) + 10 * 10^18 / 1000
                    uint8(stor9[stor9.length].field_512) = 0
                    stor3 += 10^17 * stor7 / 1000
                    watchFees += 10^17 * stor6 / 1000
                    watchBalance += (-1 * 10^17 * stor7) + (-1 * 10^17 * stor6) + 100 * 10^18 / 1000
            ...
            if stor9.length <= 1:
                ...
                if stor9.length % 10 != 0:
                    ...
                    if stor9.length <= 1:
                        ...
                        stor9[stor9.length].field_256 = (10^17 * stor4) + 20 * 10^18 / 1000
                        uint8(stor9[stor9.length].field_512) = 0
                        stor3 += 10^17 * stor7 / 1000
                        watchFees += 10^17 * stor6 / 1000
                        watchBalance += (-1 * 10^17 * stor7) + (-1 * 10^17 * stor6) + 100 * 10^18 / 1000
