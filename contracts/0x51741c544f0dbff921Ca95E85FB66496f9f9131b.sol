...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 1010101010
    stor2 = 1010101010
    bool(stor3.length) = 0
    stor3.length.field_1 = 5
    stor3.length.field_8 = 'SALES' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'SALES' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[557 len 4077]
}
...
const totalSupply(uint256 arg1) = 0
