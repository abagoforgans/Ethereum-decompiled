...
function sub_8d541f35(?) payable {
    if address(tellerAddress) == msg.sender:
        if arg1 < sub_9705a7dd:
            sub_28b2cdfa[arg1 << 192].field_0 = arg2 + sub_28b2cdfa[arg1 << 192].field_0 or Mask(128, 128, sub_28b2cdfa[arg1 << 192].field_0)
}
