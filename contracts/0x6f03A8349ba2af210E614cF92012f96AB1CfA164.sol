...
function _fallback() {
    stor13 = msg.sender
    stor0 = code.data[2303 len 32]
    stor1 = code.data[2335 len 32]
    stor8 = code.data[2367 len 32]
    stor9 = code.data[2399 len 32]
    stor10 = code.data[2431 len 32]
    stor11[code.data[2507 len 20]] = 1
    stor11[code.data[2539 len 20]] = 1
    stor11[code.data[2571 len 20]] = 1
    stor12 = code.data[2475 len 20]
    return code.data[245 len 2058]
}
...
function purchaseMIT(address arg1) payable {
    ...
    if block.timestamp - start < 336 * 24 * 3600:
        senderMIT[address(msg.sender)] = (10 * msg.value) + (10 * msg.value / 10) + senderMIT[address(msg.sender)]
        recipientMIT[address(arg1)] = (10 * msg.value) + (10 * msg.value / 10) + recipientMIT[address(arg1)]
        if recipientETH[address(arg1)] >= bonus2StartETH:
            recipientExtraMIT[address(arg1)] = 75 * recipientMIT[address(arg1)] / 1000
        else:
            if recipientETH[address(arg1)] >= bonus1StartETH:
                recipientExtraMIT[address(arg1)] = 375 * recipientMIT[address(arg1)] / 10000
    ...
    if block.timestamp - start >= 840 * 24 * 3600:
        ...
        return (10 * msg.value)
    senderMIT[address(msg.sender)] = (10 * msg.value) + (10 * msg.value / 20) + senderMIT[address(msg.sender)]
    recipientMIT[address(arg1)] = (10 * msg.value) + (10 * msg.value / 20) + recipientMIT[address(arg1)]
    if recipientETH[address(arg1)] >= bonus2StartETH:
        recipientExtraMIT[address(arg1)] = 75 * recipientMIT[address(arg1)] / 1000
    else:
        if recipientETH[address(arg1)] >= bonus1StartETH:
