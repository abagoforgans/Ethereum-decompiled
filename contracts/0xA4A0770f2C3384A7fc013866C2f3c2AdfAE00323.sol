...
function _fallback() payable {
    stor2 = code.data[4099 len 32]
    stor3 = code.data[4131 len 32]
    stor4 = code.data[4163 len 32]
    return code.data[68 len 4031]
}
...
function cancelOrder(address arg1, uint256 arg2, address arg3, uint256 arg4, uint256 arg5, uint256 arg6, uint8 arg7, bytes32 arg8, bytes32 arg9) payable {
    require msg.value <= 0
...
function availableVolume(address arg1, uint256 arg2, address arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint8 arg8, bytes32 arg9, bytes32 arg10) payable {
    ...
    if balanceOf[address(arg3)][address(arg7)] != 0:
        require balanceOf[address(arg3)][address(arg7)]
        require arg2 * balanceOf[address(arg3)][address(arg7)] / balanceOf[address(arg3)][address(arg7)] == arg2
    require arg4
...
function trade(address arg1, uint256 arg2, address arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint8 arg8, bytes32 arg9, bytes32 arg10, uint256 arg11) payable {
    ...
    require (feeMake * arg11 / 10^18) + balanceOf[address(arg1)][stor2] >= balanceOf[address(arg1)][stor2]
    require (feeMake * arg11 / 10^18) + balanceOf[address(arg1)][stor2] >= feeMake * arg11 / 10^18
    balanceOf[address(arg1)][stor2] += feeMake * arg11 / 10^18
    if arg4 != 0:
        require arg4
        require arg11 * arg4 / arg4 == arg11
    require arg2
    require arg11 * arg4 / arg2 <= balanceOf[address(arg3)][address(arg7)]
    balanceOf[address(arg3)][address(arg7)] -= arg11 * arg4 / arg2
    if -feeTake + 10^18 != 0:
        require -feeTake + 10^18
        require (10^18 * arg4) - (feeTake * arg4) / -feeTake + 10^18 == arg4
    if (10^18 * arg4) - (feeTake * arg4) != 0:
        require (10^18 * arg4) - (feeTake * arg4)
    ...
    if feeTake != 0:
        require feeTake
        require arg4 * feeTake / feeTake == arg4
    if arg4 * feeTake != 0:
        require arg4 * feeTake
        require arg11 * arg4 * feeTake / arg4 * feeTake == arg11
    require arg2
    require (arg11 * arg4 * feeTake / arg2 / 10^18) + balanceOf[address(arg3)][stor2] >= balanceOf[address(arg3)][stor2]
    require (arg11 * arg4 * feeTake / arg2 / 10^18) + balanceOf[address(arg3)][stor2] >= arg11 * arg4 * feeTake / arg2 / 10^18
    balanceOf[address(arg3)][stor2] += arg11 * arg4 * feeTake / arg2 / 10^18
    require arg11 + stor1[hash] >= stor1[hash]
    require arg11 + stor1[hash] >= arg11
    stor1[hash] += arg11
    require arg2
