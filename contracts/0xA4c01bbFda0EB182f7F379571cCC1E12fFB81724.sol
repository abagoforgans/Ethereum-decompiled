...
function getPixelColor(uint256 arg1) {
    return pixelColor[stor41][arg1]
}
...
function sub_f571ec2d(?) {
    if bool(stor67[address(msg.sender)]) != 1:
        revert with 0, 'You don't have admin rights.'
    sub_1d64873b++
    sub_28361f57[stor70] = 1
    sub_3c6dd013[stor70] = 10^16
    sub_6f17eb42[stor70] = sub_3c6dd013[stor70]
    sub_d5de47c7[stor70][stor23[stor70]] = sub_eef565da
    stor22[stor70][stor23[stor70]] = 1
    sub_c957387b[stor70][stor23[stor70] - 1] = block.timestamp
    sub_3a173505[stor70][stor23[stor70]] = block.timestamp
}
