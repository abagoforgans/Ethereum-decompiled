...
function _fallback() payable {
    ...
    stor5.length.field_8 = 'StakeX' / 256
    idx = 0
    ...
    stor4 = msg.sender
    stor16 = 256000000 * 10^18
    stor17 = 1000000 * 10^18
    stor8 = block.timestamp
    stor9 = block.number
    stor18[address(msg.sender)] = stor17
    stor15 = stor17
    return code.data[605 len 11159]
}
...
function annualInterest() {
    ...
    if not block.timestamp - stakeStartTime / 8760 * 24 * 3600:
        return (3 * 770 * mintBase / 100)
    require stakeStartTime <= block.timestamp
    if block.timestamp - stakeStartTime / 8760 * 24 * 3600 != 1:
        return maxMintProofOfStake
    return (3 * 435 * mintBase / 100)
}

function coinAge() {
    if uint256(stor20[address(msg.sender)].field_0) > 0:
        idx = 0
        while idx < uint256(stor20[address(msg.sender)].field_0):
            require idx < uint256(stor20[address(msg.sender)].field_0)
            require uint64(stor20[address(msg.sender)][idx].field_128) + stakeMinAge >= uint64(stor20[address(msg.sender)][idx].field_128)
            if block.timestamp >= uint64(stor20[address(msg.sender)][idx].field_128) + stakeMinAge:
                require idx < uint256(stor20[address(msg.sender)].field_0)
                require uint64(stor20[address(msg.sender)][idx].field_128) <= block.timestamp
                require idx < uint256(stor20[address(msg.sender)].field_0)
                if block.timestamp - uint64(stor20[address(msg.sender)][idx].field_128) <= stakeMaxAge:
                    require uint128(stor20[address(msg.sender)][idx].field_0) * block.timestamp - uint64(stor20[address(msg.sender)][idx].field_128) / 24 * 3600 >= 0
                else:
                    require uint128(stor20[address(msg.sender)][idx].field_0) * stakeMaxAge / 24 * 3600 >= 0
            mem[0] = msg.sender
            mem[32] = 20
            idx = idx + 1
            continue 
...
function ownerBurnToken(uint256 arg1) {
    ...
    uint256(stor20[address(msg.sender)].field_0) = 0
    idx = 0
    while uint256(stor20[address(msg.sender)].field_0) > idx:
        uint128(stor20[address(msg.sender)][idx].field_0) = 0
        uint64(stor20[address(msg.sender)][idx].field_128) = 0
        idx = idx + 1
        continue 
    uint256(stor20[address(msg.sender)].field_0)++
    if not uint256(stor20[address(msg.sender)].field_0) <= uint256(stor20[address(msg.sender)].field_0) + 1:
        idx = uint256(stor20[address(msg.sender)].field_0) + 1
        while uint256(stor20[address(msg.sender)].field_0) > idx:
            uint128(stor20[address(msg.sender)][idx].field_0) = 0
            uint64(stor20[address(msg.sender)][idx].field_128) = 0
            idx = idx + 1
            continue 
    uint128(stor20[address(msg.sender)][uint256(stor20[address(msg.sender)].field_0)].field_0) = uint128(balanceOf[address(msg.sender)])
    uint64(stor20[address(msg.sender)][uint256(stor20[address(msg.sender)].field_0)].field_128) = uint64(block.timestamp)
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if uint256(stor20[address(arg1)].field_0) > 0:
        uint256(stor20[address(arg1)].field_0) = 0
        idx = 0
        while uint256(stor20[address(arg1)].field_0) > idx:
            uint128(stor20[address(arg1)][idx].field_0) = 0
            uint64(stor20[address(arg1)][idx].field_128) = 0
            idx = idx + 1
            continue 
    uint256(stor20[address(arg1)].field_0)++
    if not uint256(stor20[address(arg1)].field_0) <= uint256(stor20[address(arg1)].field_0) + 1:
        idx = uint256(stor20[address(arg1)].field_0) + 1
        while uint256(stor20[address(arg1)].field_0) > idx:
            uint128(stor20[address(arg1)][idx].field_0) = 0
            uint64(stor20[address(arg1)][idx].field_128) = 0
            idx = idx + 1
            continue 
    uint128(stor20[address(arg1)][uint256(stor20[address(arg1)].field_0)].field_0) = uint128(balanceOf[address(arg1)])
    uint64(stor20[address(arg1)][uint256(stor20[address(arg1)].field_0)].field_128) = uint64(block.timestamp)
    uint256(stor20[address(arg2)].field_0)++
    if not uint256(stor20[address(arg2)].field_0) <= uint256(stor20[address(arg2)].field_0) + 1:
        idx = uint256(stor20[address(arg2)].field_0) + 1
        while uint256(stor20[address(arg2)].field_0) > idx:
            uint128(stor20[address(arg2)][idx].field_0) = 0
            uint64(stor20[address(arg2)][idx].field_128) = 0
            idx = idx + 1
            continue 
    uint128(stor20[address(arg2)][uint256(stor20[address(arg2)].field_0)].field_0) = uint128(arg3)
    uint64(stor20[address(arg2)][uint256(stor20[address(arg2)].field_0)].field_128) = uint64(block.timestamp)
    return 1
}
...
function transfer(address arg1, uint256 arg2) {
    ...
    if not uint256(stor20[address(arg1)].field_0) <= uint256(stor20[address(arg1)].field_0) + 1:
        ...
        while uint256(stor20[address(arg1)].field_0) > idx:
            ...
            idx = idx + 1
            continue 
    uint128(stor20[address(arg1)][uint256(stor20[address(arg1)].field_0)].field_0) = uint128(arg2)
    uint64(stor20[address(arg1)][uint256(stor20[address(arg1)].field_0)].field_128) = uint64(block.timestamp)
    return 1
}
...
function batchTransfer(address[] arg1, uint256[] arg2) {
    ...
    while idx < arg1.length:
        ...
        require idx < mem[96]
        mem[32] = 20
        _195 = sha3(mem[(32 * idx) + 140 len 20], 20)
        uint256(stor20[mem[(32 * idx) + 140 len 20]].field_0)++
        if not uint256(stor20[mem[(32 * idx) + 140 len 20]].field_0) > uint256(stor20[mem[(32 * idx) + 140 len 20]].field_0) + 1:
            mem[0] = sha3(mem[(32 * idx) + 140 len 20], 20)
            _204 = sha3(sha3(mem[(32 * idx) + 140 len 20], 20))
            _205 = mem[64]
            mem[64] = mem[64] + 64
            require idx < mem[(32 * arg1.length) + 128]
            mem[_205] = mem[(32 * idx) + (32 * arg1.length) + 176 len 16]
            mem[_205 + 32] = uint64(block.timestamp)
            uint128(stor[uint256(stor[_195].field_0) + _204].field_0) = mem[_205 + 16 len 16]
            uint64(stor[uint256(stor[_195].field_0) + _204].field_128) = uint64(block.timestamp)
            require idx < mem[96]
            _212 = mem[(32 * idx) + 128]
            require idx < mem[(32 * arg1.length) + 128]
            mem[mem[64]] = mem[(32 * idx) + (32 * arg1.length) + 160]
            emit Transfer(mem[mem[64]], msg.sender, address(_212));
        else:
            s = sha3(sha3(mem[(32 * idx) + 140 len 20], 20)) + uint256(stor20[mem[(32 * idx) + 140 len 20]].field_0) + 1
            while sha3(sha3(mem[(32 * idx) + 140 len 20], 20)) + uint256(stor20[mem[(32 * idx) + 140 len 20]].field_0) > s:
                uint128(stor[s].field_0) = 0
                uint64(stor[s].field_128) = 0
                s = s + 1
                continue 
            mem[0] = sha3(mem[(32 * idx) + 140 len 20], 20)
            _261 = mem[64]
            mem[64] = mem[64] + 64
            require idx < mem[(32 * arg1.length) + 128]
            mem[_261] = mem[(32 * idx) + (32 * arg1.length) + 176 len 16]
            mem[_261 + 32] = uint64(block.timestamp)
            uint128(stor[uint256(stor[_195].field_0) + sha3(_195)].field_0) = mem[_261 + 16 len 16]
            uint64(stor[uint256(stor[_195].field_0) + sha3(_195)].field_128) = uint64(block.timestamp)
            require idx < mem[96]
            _272 = mem[(32 * idx) + 128]
            require idx < mem[(32 * arg1.length) + 128]
            mem[mem[64]] = mem[(32 * idx) + (32 * arg1.length) + 160]
            emit Transfer(mem[mem[64]], msg.sender, address(_272));
        idx = idx + 1
        continue 
    require s * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length * arg2.length <= uint256(balanceOf[address(msg.sender)])
