...
function _fallback() payable {
    ...
    stor[code.data[3981 len 32]] = 10^9 * 10^stor7
    stor[code.data[3949 len 32]] = 4 * 10^6 * 10^stor7
    stor3[msg.sender] = 996 * 10^6 * 10^stor7
    emit code.data[3917 len 32]: stor2, 0, this.address
    emit code.data[3917 len 32]: stor[code.data[3981 len 32]], this.address, 0x1789bd78712815e7fc955dbba6803303f4ef15ac
    emit code.data[3917 len 32]: stor[code.data[3949 len 32]], this.address, 0xfab6368b0f7be60c573a6562d82469b5ed9e7ee6
    emit code.data[3917 len 32]: stor3[address(msg.sender)], this.address, msg.sender
    return code.data[929 len 2988]
}
