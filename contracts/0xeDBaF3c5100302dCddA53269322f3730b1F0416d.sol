...
function _fallback() payable {
    ...
    stor5 = 100 * 10^6
    stor6 = msg.sender
    stor7[code.data[3862 len 20]] = 96 * stor5 * stor3
    stor7[address(code.data[3882 len 32])] = stor5 * stor3
    stor7[address(code.data[3914 len 32])] = stor5 * stor3
    stor7[address(code.data[3946 len 32])] = stor5 * stor3
    stor7[address(code.data[3978 len 32])] = stor5 * stor3
    stor0 = 100 * stor5 * stor3
    stor1 = stor5 * stor3
    return code.data[560 len 3290]
}
