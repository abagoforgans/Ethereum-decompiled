...
const _fallback = code.data[18 len 1322]
...
function sub_f69eebfe(?) payable {
    ...
    idx = 0
    while idx < 5:
        require (uint16((Mask(8, 248, _8) >> 240) + (Mask(4, 248, _6) >> 244) + (Mask(8, 248, _4) >> 248)) + 147 % 16777216) + uint16(stor7.field_0) + idx + 559 < arg1.length
        require idx < 512
        mem[(32 * idx) + ceil32(arg1.length) + 128] = Mask(8, 248, mem[(uint16((Mask(8, 248, _8) >> 240) + (Mask(4, 248, _6) >> 244) + (Mask(8, 248, _4) >> 248)) + 147 % 16777216) + uint16(stor7.field_0) + idx + 687])
        idx = idx + 1
        continue 
