...
function _fallback() payable {
    stor1 = 0xb7cb1c96db6b22b0d3d9536e0108d062bd488f74
    stor2 = 8
    require not msg.value
    stor0 = msg.sender
    return code.data[185 len 2904]
}
...
uint256 sub_7bbdb96e;
mapping of struct transactions;

function sub_7bbdb96e(?) {
    return sub_7bbdb96e
}
...
function send(uint256 arg1, uint256 arg2) {
    require msg.sender == owner
    idx = arg1
    while idx < arg2:
        mem[0] = idx
        ...
        if transactions[idx].field_512 > 0:
            mem[0] = idx
            mem[32] = 3
            if transactions[idx].field_512 != sub_7bbdb96e:
                mem[0] = idx
                mem[32] = 3
                ...
                if ext_call.return_data[0]:
                    mem[0] = idx
                    mem[32] = 3
                    transactions[idx].field_512 = sub_7bbdb96e
        idx = idx + 1
        continue 
}
