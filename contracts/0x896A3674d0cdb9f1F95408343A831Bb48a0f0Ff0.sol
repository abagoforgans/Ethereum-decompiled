...
function _fallback() payable {
    ...
    stor2.length.field_8 = 'DMINO' / 256
    idx = 0
    ...
    stor3.length.field_8 = 'DMINO' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        ...
        continue 
    stor4 = 10
    address(stor8.field_8) = address(code.data[4167 len 32])
    stor11[address(code.data[4167 len 32])] = stor7
    return code.data[598 len 3569]
}
