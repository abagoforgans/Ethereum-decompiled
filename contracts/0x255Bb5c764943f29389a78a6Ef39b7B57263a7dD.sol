...
function _fallback() payable {
    ...
    require code.data[21913 len 32] >= block.number
    require code.data[21945 len 32] >= code.data[21913 len 32]
    require code.data[21977 len 32] >= code.data[21945 len 32]
    stor0 = code.data[21893 len 20]
    stor1 = code.data[22021 len 20]
    create contract with 0 wei
                    code: code.data[16052 len 5829], 10^18, 160, 9, 224, address(this.address), 6, 'Leverj' << 208, 3, 'LEV' % 16777216
    require create.new_address
    stor3 = address(create.new_address)
    stor4 = code.data[21913 len 32]
    stor5 = code.data[21945 len 32]
    stor6 = code.data[21977 len 32]
    ...
    return code.data[1994 len 14058]
}
...
function lockUnsoldTokens(address arg1) {
    ...
    require msg.sender == owner
    create contract with 0 wei
                    code: code.data[11496 len 2519], address(arg1), 8760 * 24 * 3600, block.timestamp
    require create.new_address
...
function distributeTimelockedTokens(address[] arg1, uint256[] arg2, uint256[] arg3, uint256[] arg4) {
    ...
    while idx < arg1.length:
        ...
        mem[mem[64] len 2519] = code.data[11496 len 2519]
        mem[mem[64] + 2519] = address(_57)
        mem[mem[64] + 2551] = _61
        mem[mem[64] + 2583] = _63
        create contract with 0 wei
                        code: code.data[11496 len 2519], address(_57), _61, _63
        require create.new_address
        require ext_code.size(address(create.new_address))
        call address(create.new_address).setup(address rg1) with:
             gas gas_remaining - 710 wei
