...
function _fallback() payable {
    ...
    require code.data[4591 len 32] <= 10000
    stor2 = code.data[4591 len 32]
    require ext_code.size(address(code.data[4559 len 32]))
    call address(code.data[4559 len 32]).supportsInterface(bytes4 arg1) with:
         gas gas_remaining - 710 wei
        args Mask(32, 224, sha3('name()') xor sha3('symbol()') xor sha3('totalSupply()') xor sha3('balanceOf(address)') xor sha3('ownerOf(uint256)') xor sha3('approve(address,uint256)') xor sha3('transfer(address,uint256)') xor sha3('transferFrom(address,address,uin', 't256)'))
    require ext_call.success
    require ext_call.return_data[0]
    stor1 = address(code.data[4559 len 32])
    return code.data[790 len 3769]
}
...
function getSeller(uint256 arg1) {
    if auction[arg1].field_576 > 0:
        return auction[arg1].field_0
    require ext_code.size(nonFungibleContractAddress)
    call nonFungibleContractAddress.0x6352211e with:
         gas gas_remaining - 710 wei
        args arg1
    require ext_call.success
...
function bid(uint256 arg1, address arg2) payable {
    require nonFungibleContractAddress == msg.sender
    require auction[arg1].field_0 != arg2
    require auction[arg1].field_576 > 0
    if block.timestamp <= auction[arg1].field_576:
        if 0 >= auction[arg1].field_512:
            if not arg1:
                require (auction[arg1].field_384 / 5) + (auction[arg1].field_384 * ownerCut / 10000) + msg.value >= auction[arg1].field_384
                auction[arg1].field_0 = 0
                auction[arg1].field_256 = 0
                auction[arg1].field_512 = 0
                if auction[arg1].field_384 > 0:
                    call auction[arg1].field_0 with:
                       value auction[arg1].field_384 - (auction[arg1].field_384 * ownerCut / 10000) - (auction[arg1].field_384 / 5) wei
                         gas 2300 * is_zero(value) wei
                    require ext_call.success
            else:
                if arg1 != 1:
                    require (auction[arg1].field_384 * ownerCut / 10000) + msg.value >= auction[arg1].field_384
                    auction[arg1].field_0 = 0
                    auction[arg1].field_256 = 0
                    auction[arg1].field_512 = 0
                    if auction[arg1].field_384 > 0:
            ...
            require ext_call.success
            if nonFungibleContractAddress == auction[arg1].field_0:
            ...
            if not arg1:
                require (auction[arg1].field_256 + (0 / auction[arg1].field_512) / 5) + ((auction[arg1].field_256 * ownerCut) + (0 / auction[arg1].field_512 * ownerCut) / 10000) + msg.value >= auction[arg1].field_256 + (0 / auction[arg1].field_512)
                auction[arg1].field_0 = 0
                auction[arg1].field_256 = 0
                auction[arg1].field_512 = 0
                if auction[arg1].field_256 + (0 / auction[arg1].field_512) > 0:
                    call auction[arg1].field_0 with:
                       value auction[arg1].field_256 + (0 / auction[arg1].field_512) - ((auction[arg1].field_256 * ownerCut) + (0 / auction[arg1].field_512 * ownerCut) / 10000) - (auction[arg1].field_256 + (0 / auction[arg1].field_512) / 5) wei
                         gas 2300 * is_zero(value) wei
                    require ext_call.success
            else:
                if arg1 != 1:
                    require ((auction[arg1].field_256 * ownerCut) + (0 / auction[arg1].field_512 * ownerCut) / 10000) + msg.value >= auction[arg1].field_256 + (0 / auction[arg1].field_512)
                    auction[arg1].field_0 = 0
                    auction[arg1].field_256 = 0
                    auction[arg1].field_512 = 0
                    if auction[arg1].field_256 + (0 / auction[arg1].field_512) > 0:
        ...
        if block.timestamp - auction[arg1].field_576 >= auction[arg1].field_512:
            ...
            require auction[arg1].field_512
            if not arg1:
                require (auction[arg1].field_256 + ((block.timestamp * auction[arg1].field_384) - (auction[arg1].field_576 * auction[arg1].field_384) - (block.timestamp * auction[arg1].field_256) + (auction[arg1].field_576 * auction[arg1].field_256) / auction[arg1].field_512) / 5) + ((auction[arg1].field_256 * ownerCut) + ((block.timestamp * auction[arg1].field_384) - (auction[arg1].field_576 * auction[arg1].field_384) - (block.timestamp * auction[arg1].field_256) + (auction[arg1].field_576 * auction[arg1].field_256) / auction[arg1].field_512 * ownerCut) / 10000) + msg.value >= auction[arg1].field_256 + ((block.timestamp * auction[arg1].field_384) - (auction[arg1].field_576 * auction[arg1].field_384) - (block.timestamp * auction[arg1].field_256) + (auction[arg1].field_576 * auction[arg1].field_256) / auction[arg1].field_512)
                auction[arg1].field_0 = 0
                auction[arg1].field_256 = 0
                auction[arg1].field_512 = 0
                if auction[arg1].field_256 + ((block.timestamp * auction[arg1].field_384) - (auction[arg1].field_576 * auction[arg1].field_384) - (block.timestamp * auction[arg1].field_256) + (auction[arg1].field_576 * auction[arg1].field_256) / auction[arg1].field_512) > 0:
                    call auction[arg1].field_0 with:
                       value auction[arg1].field_256 + ((block.timestamp * auction[arg1].field_384) - (auction[arg1].field_576 * auction[arg1].field_384) - (block.timestamp * auction[arg1].field_256) + (auction[arg1].field_576 * auction[arg1].field_256) / auction[arg1].field_512) - ((auction[arg1].field_256 * ownerCut) + ((block.timestamp * auction[arg1].field_384) - (auction[arg1].field_576 * auction[arg1].field_384) - (block.timestamp * auction[arg1].field_256) + (auction[arg1].field_576 * auction[arg1].field_256) / auction[arg1].field_512 * ownerCut) / 10000) - (auction[arg1].field_256 + ((block.timestamp * auction[arg1].field_384) - (auction[arg1].field_576 * auction[arg1].field_384) - (block.timestamp * auction[arg1].field_256) + (auction[arg1].field_576 * auction[arg1].field_256) / auction[arg1].field_512) / 5) wei
                         gas 2300 * is_zero(value) wei
                    require ext_call.success
            else:
                if arg1 != 1:
                    require ((auction[arg1].field_256 * ownerCut) + ((block.timestamp * auction[arg1].field_384) - (auction[arg1].field_576 * auction[arg1].field_384) - (block.timestamp * auction[arg1].field_256) + (auction[arg1].field_576 * auction[arg1].field_256) / auction[arg1].field_512 * ownerCut) / 10000) + msg.value >= auction[arg1].field_256 + ((block.timestamp * auction[arg1].field_384) - (auction[arg1].field_576 * auction[arg1].field_384) - (block.timestamp * auction[arg1].field_256) + (auction[arg1].field_576 * auction[arg1].field_256) / auction[arg1].field_512)
                    auction[arg1].field_0 = 0
                    auction[arg1].field_256 = 0
                    auction[arg1].field_512 = 0
                    if auction[arg1].field_256 + ((block.timestamp * auction[arg1].field_384) - (auction[arg1].field_576 * auction[arg1].field_384) - (block.timestamp * auction[arg1].field_256) + (auction[arg1].field_576 * auction[arg1].field_256) / auction[arg1].field_512) > 0:
