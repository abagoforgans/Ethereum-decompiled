...
function _fallback() payable {
    ...
    mem[96 len 829] = code.data[9645 len 829]
    create contract with 0 wei
                    code: code.data[9645 len 829]
    require create.new_address
    stor14 = address(create.new_address)
    require not msg.value
    address(stor12.field_0) = msg.sender
    mem[128] = 'vatomic.prototyping::fec9e7d0-7d'
    mem[160] = 'e8-46a6-8555-de536f22f32a::v1::V'
    mem[192] = 'ariation::v1'
    stor4.length = 153
    s = 0
    idx = 128
...
uint8 isAdminEnabled; offset 160
address owner;
address accessAddress;
address sub_99c581f0Address;
...
function sub_99c581f0(?) {
    return sub_99c581f0Address
}
...
function sub_b4f555da(?) {
    require owner == msg.sender
    require arg1
    require ext_code.size(sub_99c581f0Address)
    call sub_99c581f0Address.0xf2fde38b with:
...
function sub_be91318d(?) {
    ...
    if not isAdminEnabled:
        ...
        if not ext_call.return_data[0]:
            ...
            require ownerOf[arg1] == msg.sender
    require ext_code.size(sub_99c581f0Address)
    call sub_99c581f0Address.0xbe91318d with:
         gas gas_remaining wei
        args arg1, arg2
    require ext_call.success
}

function setCount(uint256 arg1, uint256 arg2) {
    require ownerOf[arg1]
    require ownerOf[arg1]
    require ext_code.size(accessAddress)
    call accessAddress.isSet(address arg1) with:
    ...
    if not isAdminEnabled:
        ...
        if not ext_call.return_data[0]:
            ...
            require ownerOf[arg1] == msg.sender
    require ext_code.size(sub_99c581f0Address)
    call sub_99c581f0Address.0x7cde2a7e with:
         gas gas_remaining wei
        args arg1, arg2
    require ext_call.success
}
...
function sub_f1fb05e9(?) {
    ...
    require ext_code.size(sub_99c581f0Address)
    call sub_99c581f0Address.0xf1fb05e9 with:
         gas gas_remaining wei
...
function sub_c50d5ca0(?) {
    ...
    while idx < ('cd', 36).length:
        ...
        mem[96] = 0xf1fb05e900000000000000000000000000000000000000000000000000000000
