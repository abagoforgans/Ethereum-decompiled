...
function optIn() {
    ...
    emit OptedIn(msg.sender, latestVersionAddress);
    return 1
}
...
function optOut() {
    ...
    emit OptedOut(msg.sender, latestVersionAddress);
    return 1
}
...
function commitUpgrade() {
    ...
    emit UpgradeCommited(pendingVersionAddress);
    return 1
}

function totalSupply() {
    require ext_code.size(etoken2Address)
    call etoken2Address.totalSupply(bytes32 arg1) with:
...
function decimals() {
    require ext_code.size(etoken2Address)
    call etoken2Address.baseUnit(bytes32 arg1) with:
         gas gas_remaining wei
        args etoken2Symbol
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function balanceOf(address arg1) {
    require ext_code.size(etoken2Address)
    call etoken2Address.balanceOf(address arg1, bytes32 arg2) with:
         gas gas_remaining wei
...
function allowance(address arg1, address arg2) {
    require ext_code.size(etoken2Address)
    call etoken2Address.allowance(address arg1, address arg2, bytes32 arg3) with:
         gas gas_remaining wei
...
function purgeUpgrade() {
    require ext_code.size(etoken2Address)
    call etoken2Address.isOwner(address arg1, bytes32 arg2) with:
         gas gas_remaining wei
    ...
    if not pendingVersionAddress:
        return 0
    emit UpgradePurged(pendingVersionAddress);
    pendingVersionAddress = 0
    pendingVersionTimestamp = 0
    return 1
}
...
function _forwardApprove(address arg1, uint256 arg2, address arg3) {
    if not stor7[address(arg3)]:
        ...
        if stor7[address(arg3)] != msg.sender:
            return 0
    require ext_code.size(etoken2Address)
    call etoken2Address.proxyApprove(address arg1, uint256 arg2, bytes32 arg3, address arg4) with:
         gas gas_remaining wei
...
function transferFromToICAP(address arg1, bytes32 arg2, uint256 arg3) {
    if not stor7[address(msg.sender)]:
        ...
        call latestVersionAddress.0xeb58705b with:
             gas gas_remaining wei
            args 0, 0, arg2, arg3, 160, msg.sender, 0
    else:
        require ext_code.size(stor7[address(msg.sender)])
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    if not stor7[address(msg.sender)]:
        ...
        call latestVersionAddress.0xcca97025 with:
             gas gas_remaining wei
            args 0, 0, address(arg2), arg3, 160, msg.sender, 0, None
    else:
        require ext_code.size(stor7[address(msg.sender)])
...
function _forwardTransferFromToICAPWithReference(address arg1, bytes32 arg2, uint256 arg3, string arg4, address arg5) {
    if not stor7[address(arg5)]:
        ...
        if stor7[address(arg5)] != msg.sender:
            return 0
    require ext_code.size(etoken2Address)
    call etoken2Address.proxyTransferFromToICAPWithReference(address arg1, bytes32 arg2, uint256 arg3, string arg4, address arg5) with:
         gas gas_remaining wei
...
function _forwardTransferFromWithReference(address arg1, address arg2, uint256 arg3, string arg4, address arg5) {
    if not stor7[address(arg5)]:
        ...
        if stor7[address(arg5)] != msg.sender:
            return 0
    require ext_code.size(etoken2Address)
    call etoken2Address.proxyTransferFromWithReference(address arg1, address arg2, uint256 arg3, bytes32 arg4, string arg5, address arg6) with:
         gas gas_remaining wei
...
function change(string arg1, string arg2) {
    require ext_code.size(etoken2Address)
    call etoken2Address.isOwner(address arg1, bytes32 arg2) with:
         gas gas_remaining wei
        args msg.sender, etoken2Symbol
    ...
    if not ext_call.return_data[0]:
        return 0
    require ext_code.size(etoken2Address)
    call etoken2Address.isLocked(bytes32 arg1) with:
         gas gas_remaining wei
        args etoken2Symbol
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not stor7[address(msg.sender)]:
        if 0 >= arg4.length:
            if not arg4.length % 32:
                ...
                call latestVersionAddress.0xeb58705b with:
                     gas gas_remaining wei
                    args 0, 0, arg2, arg3, 160, msg.sender, arg4.length, mem[ceil32(arg4.length) + 324 len arg4.length]
            else:
