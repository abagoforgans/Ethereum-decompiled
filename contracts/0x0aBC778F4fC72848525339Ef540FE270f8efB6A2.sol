...
function _fallback() {
    mem[96 len -6558] = code.data[7270 len -6558]
    mem[64] = -6462
    require mem[mem[96] + 96] <= 20
    require mem[128] <= mem[mem[96] + 96]
    require mem[128] >= stor4
    require mem[128]
