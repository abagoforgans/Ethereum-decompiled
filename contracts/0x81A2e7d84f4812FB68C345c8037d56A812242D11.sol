...
function _fallback() payable {
    ...
    stor2 = code.data[3662 len 32]
    stor3 = 1
    return code.data[71 len 3591]
}
...
function sub_38f8316b(?) payable {
    ...
    create contract with 0 wei
                    code: code.data[3055 len 536], tokenContractAddress
...
function createDepositAddress() payable {
    ...
    if address(sub_99d26960[stor3]):
        return 0
    create contract with 0 wei
                    code: code.data[2519 len 536], tokenContractAddress
