...
function getKeyPurpose(bytes32 arg1) {
    require ext_code.size(0xce73fc164624cf0130590e54e8f932ff805cdcb7)
    delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0xcf58f45b with:
...
function removeKey(bytes32 arg1) {
    require ext_code.size(0xce73fc164624cf0130590e54e8f932ff805cdcb7)
    delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0x7ab17ba7 with:
         gas gas_remaining wei
        args 0, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function removeClaim(bytes32 arg1) {
    require ext_code.size(0x6c6447c05ac2d5f93070ee1031a8a47bb54b2795)
    delegate 0x6c6447c05ac2d5f93070ee1031a8a47bb54b2795.0x5c02fae1 with:
         gas gas_remaining wei
        args 0, 4, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function approve(uint256 arg1, bool arg2) payable {
    require ext_code.size(0xce73fc164624cf0130590e54e8f932ff805cdcb7)
    delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0x67d4865f with:
         gas gas_remaining wei
        args 0, arg1, arg2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function keyHasPurpose(bytes32 arg1, uint256 arg2) {
    require ext_code.size(0xce73fc164624cf0130590e54e8f932ff805cdcb7)
    delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0xd8188a40 with:
         gas gas_remaining wei
        args 0, arg1, arg2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function addKey(bytes32 arg1, uint256 arg2, uint256 arg3) {
    require ext_code.size(0xce73fc164624cf0130590e54e8f932ff805cdcb7)
    delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0x5d601c3a with:
         gas gas_remaining wei
...
function getKey(bytes32 arg1) {
    require ext_code.size(0xce73fc164624cf0130590e54e8f932ff805cdcb7)
    delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0xb01a9fb3 with:
         gas gas_remaining wei
        args 0, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getClaimIdsByType(uint256 arg1) {
...
function getKeysByPurpose(uint256 arg1) {
    ...
    mem[132] = arg1
    require ext_code.size(0xce73fc164624cf0130590e54e8f932ff805cdcb7)
    delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0x746199f9 with:
         gas gas_remaining wei
        args 0, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function execute(address arg1, uint256 arg2, bytes arg3) payable {
    ...
    mem[ceil32(arg3.length) + 128] = 0x433877a00000000000000000000000000000000000000000000000000000000
    mem[ceil32(arg3.length) + 324 len ceil32(arg3.length)] = arg3[all], mem[arg3.length + 128 len ceil32(arg3.length) - arg3.length]
    if not arg3.length % 32:
        require ext_code.size(0xce73fc164624cf0130590e54e8f932ff805cdcb7)
        delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0x433877a with:
             gas gas_remaining wei
            args 0, address(arg1), arg2, 160, 1, arg3.length, Mask(8 * arg3.length, -(8 * arg3.length) + 256, arg3[all], mem[arg3.length + 128 len ceil32(arg3.length) - arg3.length]) << (8 * arg3.length) - 256
    else:
        ...
        delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0x433877a with:
             gas gas_remaining wei
            args 0, address(arg1), arg2, 160, 1, arg3.length, Mask(8 * ceil32(arg3.length), -(8 * ceil32(arg3.length)) + 256, arg3[all], mem[arg3.length + 128 len ceil32(arg3.length) - arg3.length]) << (8 * ceil32(arg3.length)) - 256, mem[(2 * ceil32(arg3.length)) + 324 len floor32(arg3.length) + -ceil32(arg3.length) + 32]
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return delegate.return_data[0]
...
function sub_c947ac3a(?) payable {
    mem[128 len arg3.length] = arg3[all]
    mem[ceil32(arg3.length) + 128] = 0x433877a00000000000000000000000000000000000000000000000000000000
    mem[ceil32(arg3.length) + 132] = 0
    ...
    if 0 >= arg3.length:
        if not arg3.length % 32:
            ...
            delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0x433877a with:
                 gas gas_remaining wei
                args 0, 0, address(arg1), arg2, 160, 0, arg3.length, mem[ceil32(arg3.length) + 324 len arg3.length]
        else:
            mem[floor32(arg3.length) + ceil32(arg3.length) + 324] = mem[floor32(arg3.length) + ceil32(arg3.length) + -(arg3.length % 32) + 356 len arg3.length % 32]
            require ext_code.size(0xce73fc164624cf0130590e54e8f932ff805cdcb7)
            delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0x433877a with:
                 gas gas_remaining wei
                args 0, address(arg1), arg2, 160, 0, arg3.length, mem[ceil32(arg3.length) + 324 len floor32(arg3.length) + 32]
    else:
        ...
        if not arg3.length % 32:
            ...
            delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0x433877a with:
                 gas gas_remaining wei
                args 0, address(arg1), arg2, 160, 0, arg3.length, mem[ceil32(arg3.length) + 324 len arg3.length]
        else:
            mem[floor32(arg3.length) + ceil32(arg3.length) + 324] = mem[floor32(arg3.length) + ceil32(arg3.length) + -(arg3.length % 32) + 356 len arg3.length % 32]
            require ext_code.size(0xce73fc164624cf0130590e54e8f932ff805cdcb7)
            delegate 0xce73fc164624cf0130590e54e8f932ff805cdcb7.0x433877a with:
                 gas gas_remaining wei
                args 0, address(arg1), arg2, 160, 0, arg3.length, mem[128], mem[ceil32(arg3.length) + 356 len floor32(arg3.length)]
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return delegate.return_data[0]
...
function getClaim(bytes32 arg1) {
    ...
    mem[132] = arg1
    require ext_code.size(0x6c6447c05ac2d5f93070ee1031a8a47bb54b2795)
    delegate 0x6c6447c05ac2d5f93070ee1031a8a47bb54b2795.0x8522d0eb with:
         gas gas_remaining wei
        args 4, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not arg4.length % 32:
        ...
        if not arg5.length % 32:
            ...
            if not arg6.length % 32:
                require ext_code.size(0x6c6447c05ac2d5f93070ee1031a8a47bb54b2795)
                delegate 0x6c6447c05ac2d5f93070ee1031a8a47bb54b2795.0xbd2d0c28 with:
                     gas gas_remaining wei
