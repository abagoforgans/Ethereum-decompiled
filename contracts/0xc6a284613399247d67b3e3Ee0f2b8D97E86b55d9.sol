...
function mint(address arg1, string arg2) {
    ...
    balanceOf[address(arg1)]++
    emit Transfer(0, arg1, stor568);
    stor157[stor568] = tokenOfOwnerByIndex[address(arg1)]
    tokenOfOwnerByIndex[address(arg1)]++
    tokenOfOwnerByIndex[address(arg1)][tokenOfOwnerByIndex[address(arg1)]] = stor568
    stor159[stor568] = tokenByIndex.length
    tokenByIndex.length++
    tokenByIndex[tokenByIndex.length] = stor568
    stor570[stor568][].field_0 = Array(len=arg2.length, data=arg2[all])
    mem[ceil32(arg2.length) + 128] = stor568
...
function tokenURI(uint256 arg1) {
    ...
    mem[128 len s] = code.data[21756 len s]
    t = s - 1
    idx = arg1
    while idx:
        require t < mem[96]
