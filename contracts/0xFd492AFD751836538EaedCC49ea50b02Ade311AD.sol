...
function functionSignatures() {
    ...
    if not stor2.length:
        ...
        if not t:
            ...
            return memory
              from mem[64]
               len floor32(_112) + _110 + -mem[64] + 96
    ...
    if not t:
        ...
        return memory
          from mem[64]
           len floor32(_189) + _187 + -mem[64] + 96
...
function delegateFunctionSignatures(address arg1) {
    ...
    if not stor2.length:
        ...
        return memory
          from mem[64]
           len floor32(_272) + _270 + -mem[64] + 96
    mem[128] = 96
    s = 128
    idx = stor2.length
    while idx - 1:
...
function updateContract(address arg1, string arg2, string arg3) {
    ...
    if not arg1:
        ...
        while idx < arg2.length + 128:
            ...
            _1350 = sha3(mem[mem[64] len idx + -x + _683 + -mem[64] + 1])
            mem[0] = Mask(32, 224, sha3(mem[mem[64] len idx + -x + _683 + -mem[64] + 1]))
            mem[32] = 1
            _1351 = sha3(mem[0], 1)
            if arg1:
                _1359 = mem[64]
                ...
                mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
                mem[_1360 + _1359] = 3
                if uint256(stor[sha3(mem[mem[64] len _1360 + _1359 + -mem[64] + 32])]):
                    ...
                    mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
                    mem[_3380 + _3379] = 3
                    uint256(stor[sha3(mem[mem[64] len _3380 + _3379 + -mem[64] + 32])]) = stor2.length
                    _3722 = mem[64]
                    mem[mem[64]] = 32
                    mem[mem[64] + 32] = mem[y]
                    _3724 = mem[y]
            ...
            mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
            mem[_1362 + _1361] = 3
            _2015 = sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])
            if not uint256(stor[sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])]):
                revert with 0, 'Function does not exist.'
            if uint256(stor[sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])]) - 1 == stor2.length - 1:
                stor2.length--
                if stor2.length <= stor2.length - 1:
                    ...
                    mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
                    mem[_2066 + _2065] = 3
                    uint256(stor[sha3(mem[mem[64] len _2066 + _2065 + -mem[64] + 32])]) = 0
                    mem[0] = Mask(32, 224, _1350)
                    mem[32] = 1
                ...
                require uint256(stor[sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])]) - 1 < stor2.length
                if 31 >= stor[('name', 'stor2', 2) + stor2.length - 1].length:
                    uint256(stor2[uint256(stor[sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])])].field_0) = uint256(stor2[stor2.length].field_0)
                    s = sha3(sha3(2) + uint256(stor[sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])]) - 1)
                    while sha3(sha3(2) + uint256(stor[sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])]) - 1) + (stor[('name', 'stor2', 2) + uint256(stor[sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])]) - 1].length + 31 / 32) > s:
                        uint256(stor[s]) = 0
                        s = s + 1
                        continue 
                    require stor2.length - 1 < stor2.length
                    ...
                    s = mem[64]
                    t = sha3(mem[0])
                    while _2697 + stor[('name', 'stor2', 2) + stor2.length - 1].length > s + 32:
                        mem[s + 32] = uint256(delegate[t])
                        s = s + 32
                        t = t + 1
                        continue 
                    mem[_2697 + stor[('name', 'stor2', 2) + stor2.length - 1].length] = 3
                    uint256(stor[sha3(mem[mem[64] len _2697 + stor[('name', 'stor2', 2) + stor2.length - 1].length + -mem[64] + 32])]) = uint256(stor[_2015])
                    stor2.length--
                    if stor2.length <= stor2.length - 1:
                        _3933 = mem[64]
                        _3934 = mem[y]
                        ...
                        mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
                        mem[_3934 + _3933] = 3
                        uint256(stor[sha3(mem[mem[64] len _3934 + _3933 + -mem[64] + 32])]) = 0
                        mem[0] = Mask(32, 224, _1350)
                        mem[32] = 1
                        address(delegate[Mask(32, 224, _1350)]) = 0
                        _4187 = mem[64]
                        ...
                        mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
                        mem[_4318 + _4317] = 3
                        uint256(stor[sha3(mem[mem[64] len _4318 + _4317 + -mem[64] + 32])]) = 0
                        mem[0] = Mask(32, 224, _1350)
                        mem[32] = 1
                        address(delegate[Mask(32, 224, _1350)]) = 0
                        _4464 = mem[64]
                    ...
                    uint256(stor2[uint256(stor[sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])])].field_0) = Mask(255, 1, (256 * not bool(stor2[stor2.length].field_0)) - 1 and uint256(stor2[stor2.length].field_0)) + 1
                    if not Mask(255, 1, (256 * not bool(stor2[stor2.length].field_0)) - 1 and uint256(stor2[stor2.length].field_0)):
                        ...
                        if stor2.length <= stor2.length - 1:
                            ...
                            mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
                            mem[_3924 + _3923] = 3
                            uint256(stor[sha3(mem[mem[64] len _3924 + _3923 + -mem[64] + 32])]) = 0
                            mem[0] = Mask(32, 224, _1350)
                            mem[32] = 1
                            address(delegate[Mask(32, 224, _1350)]) = 0
                            _4156 = mem[64]
                        ...
                        t = sha3(sha3(2) + uint256(stor[sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])]) - 1)
                        ...
                        while sha3(sha3(2) + stor2.length - 1) + (stor[('name', 'stor2', 2) + stor2.length - 1].length + 31 / 32) > s:
                            ...
                            s = s + 1
                            continue 
                        s = sha3(sha3(2) + uint256(stor[sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])]) - 1) + (stor[('name', 'stor2', 2) + stor2.length - 1].length + 31 / 32)
                        while sha3(sha3(2) + uint256(stor[sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])]) - 1) + (stor[('name', 'stor2', 2) + uint256(stor[sha3(mem[mem[64] len _1362 + _1361 + -mem[64] + 32])]) - 1].length + 31 / 32) > s:
                            uint256(stor[s]) = 0
                            s = s + 1
                            continue 
                        ...
                        s = mem[64]
                        t = sha3(mem[0])
                        while _3419 + stor[('name', 'stor2', 2) + stor2.length - 1].length > s + 32:
                            mem[s + 32] = uint256(delegate[t])
                            s = s + 32
                            t = t + 1
                            continue 
                        mem[_3419 + stor[('name', 'stor2', 2) + stor2.length - 1].length] = 3
                        uint256(stor[sha3(mem[mem[64] len _3419 + stor[('name', 'stor2', 2) + stor2.length - 1].length + -mem[64] + 32])]) = uint256(stor[_2015])
                        stor2.length--
                        if stor2.length <= stor2.length - 1:
                            _4295 = mem[64]
                            _4296 = mem[y]
                            ...
                            mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
                            mem[_4296 + _4295] = 3
                            uint256(stor[sha3(mem[mem[64] len _4296 + _4295 + -mem[64] + 32])]) = 0
                            mem[0] = Mask(32, 224, _1350)
                            mem[32] = 1
                            address(delegate[Mask(32, 224, _1350)]) = 0
                            _4453 = mem[64]
                            ...
                            mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
                            mem[_4546 + _4545] = 3
                            uint256(stor[sha3(mem[mem[64] len _4546 + _4545 + -mem[64] + 32])]) = 0
                            mem[0] = Mask(32, 224, _1350)
                            mem[32] = 1
                            address(delegate[Mask(32, 224, _1350)]) = 0
                            _4586 = mem[64]
        ...
        while idx < arg2.length + 128:
            ...
            mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
            mem[_1366 + mem[64]] = 3
            _2025 = sha3(mem[mem[64] len _1366 + 32])
            if not uint256(stor[sha3(mem[mem[64] len _1366 + 32])]):
                revert with 0, 'Function does not exist.'
            if uint256(stor[sha3(mem[mem[64] len _1366 + 32])]) - 1 == stor2.length - 1:
                stor2.length--
                if stor2.length <= stor2.length - 1:
                    _2070 = mem[64]
                    _2071 = mem[y]
                    ...
                    mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
                    mem[_2071 + mem[64]] = 3
                    uint256(stor[sha3(mem[mem[64] len _2071 + _2070 + -mem[64] + 32])]) = 0
                    mem[0] = Mask(32, 224, _1356)
                    mem[32] = 1
                ...
                require stor2.length - 1 < stor2.length
                require uint256(stor[sha3(mem[mem[64] len _1366 + 32])]) - 1 < stor2.length
                if 31 >= stor[('name', 'stor2', 2) + stor2.length - 1].length:
                    uint256(stor2[uint256(stor[sha3(mem[mem[64] len _1366 + 32])])].field_0) = uint256(stor2[stor2.length].field_0)
                    s = sha3(sha3(2) + uint256(stor[sha3(mem[mem[64] len _1366 + 32])]) - 1)
                    while sha3(sha3(2) + uint256(stor[sha3(mem[mem[64] len _1366 + 32])]) - 1) + (stor[('name', 'stor2', 2) + uint256(stor[sha3(mem[mem[64] len _1366 + 32])]) - 1].length + 31 / 32) > s:
                        uint256(stor[s]) = 0
                        s = s + 1
                        continue 
                    require stor2.length - 1 < stor2.length
                    ...
                    s = mem[64]
                    t = sha3(mem[0])
                    while _2704 + stor[('name', 'stor2', 2) + stor2.length - 1].length > s + 32:
                        mem[s + 32] = uint256(delegate[t])
                        s = s + 32
                        t = t + 1
                        continue 
                    mem[_2704 + stor[('name', 'stor2', 2) + stor2.length - 1].length] = 3
                    uint256(stor[sha3(mem[mem[64] len _2704 + stor[('name', 'stor2', 2) + stor2.length - 1].length + -mem[64] + 32])]) = uint256(stor[_2025])
                    stor2.length--
                    if stor2.length <= stor2.length - 1:
                        _3952 = mem[y]
                        t = y + 32
                    ...
                    uint256(stor2[uint256(stor[sha3(mem[mem[64] len _1366 + 32])])].field_0) = Mask(255, 1, (256 * not bool(stor2[stor2.length].field_0)) - 1 and uint256(stor2[stor2.length].field_0)) + 1
                    if not Mask(255, 1, (256 * not bool(stor2[stor2.length].field_0)) - 1 and uint256(stor2[stor2.length].field_0)):
                        s = sha3(sha3(2) + uint256(stor[sha3(mem[mem[64] len _1366 + 32])]) - 1)
                        while sha3(sha3(2) + uint256(stor[sha3(mem[mem[64] len _1366 + 32])]) - 1) + (stor[('name', 'stor2', 2) + uint256(stor[sha3(mem[mem[64] len _1366 + 32])]) - 1].length + 31 / 32) > s:
                            uint256(stor[s]) = 0
                        ...
                        s = mem[64]
                        t = sha3(mem[0])
                        while _2702 + stor[('name', 'stor2', 2) + stor2.length - 1].length > s + 32:
                            mem[s + 32] = uint256(delegate[t])
                            s = s + 32
                            t = t + 1
                            continue 
                        mem[_2702 + stor[('name', 'stor2', 2) + stor2.length - 1].length] = 3
                        uint256(stor[sha3(mem[mem[64] len _2702 + stor[('name', 'stor2', 2) + stor2.length - 1].length + -mem[64] + 32])]) = uint256(stor[_2025])
                        stor2.length--
                        if stor2.length <= stor2.length - 1:
                            _3942 = mem[y]
                            t = y + 32
                            ...
                            mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
                            mem[_3942 + mem[64]] = 3
                            uint256(stor[sha3(mem[mem[64] len _3942 + 32])]) = 0
                            mem[0] = Mask(32, 224, _1356)
                            mem[32] = 1
                            address(delegate[Mask(32, 224, _1356)]) = 0
                            _4199 = mem[64]
                            ...
                            mem[mem[64] + floor32(mem[y])] = mem[y + floor32(mem[y]) + -(mem[y] % 32) + 64 len mem[y] % 32] or Mask(8 * -(mem[y] % 32) + 32, -(8 * -(mem[y] % 32) + 32) + 256, mem[mem[64] + floor32(mem[y])])
                            mem[_4321 + mem[64]] = 3
                            uint256(stor[sha3(mem[mem[64] len _4321 + 32])]) = 0
                            mem[0] = Mask(32, 224, _1356)
                            mem[32] = 1
                            address(delegate[Mask(32, 224, _1356)]) = 0
                            _4474 = mem[64]
                        ...
                        t = sha3(sha3(2) + uint256(stor[sha3(mem[mem[64] len _1366 + 32])]) - 1)
                        s = sha3(sha3(2) + stor2.length - 1)
                        while sha3(sha3(2) + stor2.length - 1) + (stor[('name', 'stor2', 2) + stor2.length - 1].length + 31 / 32) > s:
                            uint256(stor[t]) = uint256(stor[s])
                            t = t + 1
                            s = s + 1
                            continue 
                        s = sha3(sha3(2) + uint256(stor[sha3(mem[mem[64] len _1366 + 32])]) - 1) + (stor[('name', 'stor2', 2) + stor2.length - 1].length + 31 / 32)
                        while sha3(sha3(2) + uint256(stor[sha3(mem[mem[64] len _1366 + 32])]) - 1) + (stor[('name', 'stor2', 2) + uint256(stor[sha3(mem[mem[64] len _1366 + 32])]) - 1].length + 31 / 32) > s:
                            uint256(stor[s]) = 0
                            s = s + 1
                            continue 
                        ...
                        s = mem[64]
                        t = sha3(mem[0])
                        while _3436 + stor[('name', 'stor2', 2) + stor2.length - 1].length > s + 32:
                            mem[s + 32] = uint256(delegate[t])
                            s = s + 32
                            t = t + 1
                            continue 
                        mem[_3436 + stor[('name', 'stor2', 2) + stor2.length - 1].length] = 3
                        uint256(stor[sha3(mem[mem[64] len _3436 + stor[('name', 'stor2', 2) + stor2.length - 1].length + -mem[64] + 32])]) = uint256(stor[_2025])
                        stor2.length--
                        if stor2.length <= stor2.length - 1:
                            _4306 = mem[y]
                            t = y + 32
