...
function _fallback() payable {
    ...
    return code.data[754 len 13493]
}
...
array of uint256 stor90360717079606364098835186458696555558453061769051128491761900015901873535442;
array of uint256 stor90360717079606364098835186458696555558453061769051128491761900015901873535443;
array of uint8 stor90857304066594094779802085246612683268874473898248517823732794512697550763176;
...
array of uint256 stor101051993584849178915136821395265346177868384823507754984078593667947067386068;
...
function sub_44d855f1(?) payable {
    ...
    mem[544] = stor[sha3((14 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 16)) + 7)].field_0
    idx = 544
    s = 0
    while stor[(14 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 16)) + 7].length + 544 > idx + 32:
        mem[idx + 32] = stor[s + sha3((14 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 16)) + 7)].field_256
        idx = idx + 32
        s = s + 1
        continue 
    return sub_44d855f1[arg1][arg2].field_0, 
           ...
           Array(len=stor[(14 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 16)) + 7].length, data=mem[544 len stor[(14 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 16)) + 7].length + (floor32(stor[(14 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 16)) + 7].length - 1) + -stor[(14 * arg2) + ('map', ('param', 'arg1'), ('name', 'sub_44d855f1', 16)) + 7].length + 32 % 32)]),
...
function sub_d2a8bcf5(?) payable {
    ...
    storC7C6[stor10.length - 1] = msg.sender or Mask(96, 160, storC7C6[stor10.length - 1])
...
function games(uint256 arg1) payable {
    ...
    return stor56DF[arg1], 
           ...
           storDF69[arg1],
           stor[(15 * arg1) + code.data[13461 len 32]],
           storDF69[arg1],
           bool(storC8DF[arg1])
}
...
function draw() payable {
    mem[96] = 0
    require gameID < stor12
    require block.timestamp >= stor[code.data[13461 len 32] + (15 * stor11)] + sub_ae466313
    require gameID < stor12
    require bool(storC8DF[stor11]) != 1
    require gameID < stor12
    mem[0] = 12
    storC8DF[stor11] = 1
    storDF69[stor11] = block.timestamp
    mem[128] = 0
    mem[160] = 0
    mem[192] = 6
    ...
    if uint8(sha3(block.difficulty, block.coinbase, numTickets, block.timestamp, msg.sender, var18001) % uint8(maxNumber + 1)):
...
function sub_0cda01b0(?) payable {
    ...
    if 0 >= arg1:
        ...
        storCDDF[stor11] += 85 * msg.value / 100
        storA8DF[stor11] += 5 * msg.value / 100
        if 0 == players[address(msg.sender)].field_512:
            require gameID < stor12
            storCDDF[stor11] += 10 * msg.value / 100
        else:
            require players[address(msg.sender)].field_512 < stor10.length
            storC7C6[stor15[address(msg.sender)].field_512] += 10 * msg.value / 100
            require gameID < stor12
