...
function _fallback() payable {
    ...
    stor1.length.field_8 = 'ashxen' / 256
    idx = 0
    ...
    mem[224 len -2244] = code.data[2717 len -2244]
    stor2[address(msg.sender)] = mem[224]
    stor0 = mem[224]
    stor4[] = Array(len=mem[mem[256] + 224], data=mem[mem[256] + 256 len mem[mem[256] + 224]])
    stor5 = mem[319 len 1]
    stor6[] = Array(len=mem[mem[320] + 224], data=mem[mem[320] + 256 len mem[mem[320] + 224]])
    return code.data[473 len 2244]
}
