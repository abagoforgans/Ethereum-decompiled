...
function _fallback() payable {
    ...
    Mask(248, 0, stor11.field_8) = 5
    stor1 = stor5
    uint256(stor10.field_0) = '1.0.0'
    Mask(192, 0, stor10.field_64) = Mask(192, 0, code.data[2387 len 32])
    uint128(stor10.field_128) = uint128(code.data[2419 len 32])
    uint64(stor10.field_192) = uint64(code.data[2451 len 32])
    return code.data[865 len 1522]
}
...
function get() payable {
    if stor7.length:
        ...
        while stor7.length + 128 > idx:
            ...
            s = s + 1
            continue 
    return uint8(stor11.field_0), stor1, stor10, stor10, Array(len=stor7.length, data=mem[160 len stor7.length]), stor10, stor10
}
    ...
    if stor2 != msg.sender:
        if msg.sender == stor3:
            if not uint8(stor11.field_8):
                uint8(stor11.field_0) = 3
    else:
        if uint8(stor11.field_8) == 1:
            uint8(stor11.field_0) = 3
        else:
            if msg.sender == stor3:
                if not uint8(stor11.field_8):
