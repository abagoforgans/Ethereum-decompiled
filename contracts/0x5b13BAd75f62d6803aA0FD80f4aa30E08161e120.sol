...
function _fallback() {
    ...
    stor4.length.field_8 = 'FCToken' / 256
    idx = 0
...
function icoPlatformWithdraw(uint256 arg1) {
    ...
    emit 0x5d8a60a7: arg1, msg.sender
    ...
    if block.number < startBlock:
        if block.number < sub_08d18ef7:
            if block.number < sub_5ac727c7:
                if block.number >= sub_5f897489:
                    if block.number < sub_aa8d2a64:
                        ...
                        emit 0x5d8a60a7: (sub_420ddab4 * msg.value), msg.sender
                ...
                if block.number < sub_5f897489:
                    ...
                    emit 0x5d8a60a7: (sub_308005ab * msg.value), msg.sender
            ...
            if block.number < sub_5ac727c7:
                ...
                emit 0x5d8a60a7: (twoStepRate * msg.value), msg.sender
        ...
        if block.number < sub_08d18ef7:
            ...
            emit 0x5d8a60a7: (oneStepRate * msg.value), msg.sender
