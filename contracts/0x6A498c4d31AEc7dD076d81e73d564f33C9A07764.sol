...
function sub_f7ece0cf(?) {
    ...
    while idx < arg3.length:
        ...
        require mem[(32 * arg2.length) + (32 * arg1.length) + (32 * idx) + 192] > 0
        idx = idx + 1
        continue 
    idx = 0
    while idx < arg3.length:
        ...
        _36 = mem[(32 * idx) + 128]
        if stor1 == mem[(32 * idx) + (32 * arg1.length) + 172 len 20]:
            call mem[(32 * idx) + 140 len 20] with:
               value mem[(32 * idx) + (32 * arg2.length) + (32 * arg1.length) + 192] wei
                 gas 2300 * is_zero(value) wei
        else:
            mem[(32 * arg3.length) + (32 * arg2.length) + (32 * arg1.length) + 192] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
            mem[(32 * arg3.length) + (32 * arg2.length) + (32 * arg1.length) + 196] = address(_36)
            mem[(32 * arg3.length) + (32 * arg2.length) + (32 * arg1.length) + 228] = _34
            require ext_code.size(address(_32))
            call address(_32).0xa9059cbb with:
                 gas gas_remaining wei
                args address(_36), _34
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        idx = idx + 1
        continue 
