...
function _fallback() {
    stor1 = code.data[6847 len 20]
    stor2 = code.data[6879 len 20]
    return code.data[201 len 6634]
}
...
address sub_79035396Address;

function sub_03a896a1(?) {
    return sub_fd40d52e[arg1]
}

function sub_79035396(?) {
    return sub_79035396Address
}
...
function sub_977a5e64(?) {
    ...
    require ext_call.success
    require ext_code.size(address(ext_call.return_data[0]))
    call address(ext_call.return_data[0]).0x5715c5b7 with:
         gas gas_remaining - 710 wei
        args (Mask(8, 248, ext_call.return_data[32]) >> 248)
    require ext_call.success
    if not ext_call.return_data[12 len 20]:
        require ext_code.size(sub_79035396Address)
        call sub_79035396Address.0x649404bd with:
             gas gas_remaining - 710 wei
            args arg1, arg2
        require ext_call.success
        return 0
