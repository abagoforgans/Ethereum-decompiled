...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor0 = msg.sender
    stor2 = code.data[8591 len 20]
    require stor0 == msg.sender
    stor3 = code.data[8623 len 20]
    require ext_code.size(code.data[8623 len 20])
    call code.data[8623 len 20].isPricingStrategy() with:
         gas gas_remaining - 50 wei
    require ext_call.success
    require ext_call.return_data[0]
    stor5 = code.data[8655 len 20]
    require code.data[8655 len 20]
    require code.data[8675 len 32]
    stor7 = code.data[8675 len 32]
    require code.data[8707 len 32]
    stor8 = code.data[8707 len 32]
    require stor7 < code.data[8707 len 32]
    stor6 = code.data[8739 len 32]
    stor19 = code.data[8783 len 20]
    return code.data[565 len 8014]
}
...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0xd58ec945fe03814ccae6696ffac04870d518fcd8)
    delegate 0xd58ec945fe03814ccae6696ffac04870d518fcd8.0x66098d4f with:
         gas gas_remaining - 50 wei
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0xd58ec945fe03814ccae6696ffac04870d518fcd8):
                            delegate 0xd58ec945fe03814ccae6696ffac04870d518fcd8.0x66098d4f with:
                                 gas gas_remaining - 50 wei
