...
function sub_59697fc7(?) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require 4 < arg2.length
    mem[(32 * arg1.length) + 288] = 9969 * ext_call.return_data[0] / 1000
    require msg.sender == 0x54c676cddc496ecbd20511a5c143cac2cbca6b3f
...
function sub_effc7f22(?) {
    ...
    call stor7.0x2e1a7d4d with:
         gas gas_remaining wei
        args (10^18 * mem[(32 * arg1.length) + 160] / mem[(32 * arg1.length) + 192] * 9969 * ext_call.return_data[0] / 1000 / 10^18)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    else:
        return 0
