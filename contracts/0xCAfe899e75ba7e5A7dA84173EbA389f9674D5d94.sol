...
function sub_eb8295da(?) {
    ...
    if not (32 * arg3.length) + (32 * arg2.length) + (32 * arg1.length) + 352 % 32:
        delegate stor4.0x56b16cd5 with:
            ...
            args mem[(64 * arg3.length) + (64 * arg2.length) + (64 * arg1.length) + 580 len (32 * arg3.length) + (32 * arg2.length) + (32 * arg1.length) + 352]
    else:
        ...
        delegate stor4.0x56b16cd5 with:
             gas gas_remaining wei
            args mem[(64 * arg3.length) + (64 * arg2.length) + (64 * arg1.length) + 580 len floor32((32 * arg3.length) + (32 * arg2.length) + (32 * arg1.length) + 352) + (129 * arg3.length) + 32]
