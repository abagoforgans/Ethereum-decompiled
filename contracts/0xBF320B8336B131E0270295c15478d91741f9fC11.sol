...
function depositedBalances(address arg1, address arg2, address[] arg3) payable {
    ...
    if arg3.length:
        mem[128 len 32 * arg3.length] = code.data[3212 len 32 * arg3.length]
    idx = 0
    ...
    while arg3.length < 32 * arg3.length:
        mem[(34 * arg3.length) + 192] = mem[arg3.length + 128]
        s = arg3.length + 32
        continue 
    return memory
    ...
    if not arg3.length:
        ...
        while idx < arg3.length:
            if ext_code.size(address(cd[((32 * idx) + arg3 + 36)])) <= 0:
                ...
                mem[mem[64]] = 68
                mem[64] = mem[64] + 100
                mem[_69 + 32] = 0xdd62ed3e00000000000000000000000000000000000000000000000000000000 or mem[_69 + 36 len 28]
                _72 = mem[_69]
                t = _69 + 32
                u = _68 + 100
                s = mem[_69]
        ...
        while idx < arg3.length:
            if ext_code.size(address(cd[((32 * idx) + arg3 + 36)])) <= 0:
                ...
                mem[mem[64]] = 68
                mem[64] = mem[64] + 100
                mem[_74 + 32] = 0xdd62ed3e00000000000000000000000000000000000000000000000000000000 or mem[_74 + 36 len 28]
                _77 = mem[_74]
                t = _74 + 32
                u = mem[64]
                s = mem[_74]
...
function tokenBalances(address arg1, address[] arg2) payable {
    ...
    if not arg2.length:
        ...
        while idx < arg2.length:
            if not address(cd[((32 * idx) + arg2 + 36)]):
                ...
                if ext_code.size(address(cd[((32 * idx) + arg2 + 36)])) <= 0:
                    ...
                    mem[mem[64]] = 36
                    mem[64] = mem[64] + 68
                    mem[_73 + 32] = 0x70a0823100000000000000000000000000000000000000000000000000000000 or mem[_73 + 36 len 28]
                    _76 = mem[_73]
                    t = _73 + 32
                    u = mem[64]
                    s = mem[_73]
        ...
        mem[128 len 32 * arg2.length] = code.data[3212 len 32 * arg2.length]
        idx = 0
        while idx < arg2.length:
            if not address(cd[((32 * idx) + arg2 + 36)]):
                require idx < mem[96]
                ...
                if ext_code.size(address(cd[((32 * idx) + arg2 + 36)])) <= 0:
                    ...
                    mem[mem[64]] = 36
                    mem[64] = mem[64] + 68
                    mem[_78 + 32] = 0x70a0823100000000000000000000000000000000000000000000000000000000 or mem[_78 + 36 len 28]
                    _81 = mem[_78]
                    t = _78 + 32
                    u = mem[64]
                    s = mem[_78]
...
function depositedBalancesGeneric(address arg1, bytes4 arg2, address arg3, address[] arg4, bool arg5) payable {
    ...
    if not arg4.length:
        if not arg5:
            ...
            while idx < arg4.length:
                if ext_code.size(arg1) <= 0:
                    ...
                    mem[mem[64]] = 68
                    mem[64] = mem[64] + 100
                    mem[_135 + 32] = Mask(32, 224, arg2) or mem[_135 + 36 len 28]
                    _138 = mem[_135]
                    t = _135 + 32
                    u = mem[64]
                    s = mem[_135]
            ...
            while idx < arg4.length:
                if ext_code.size(arg1) <= 0:
                    ...
                    mem[mem[64]] = 68
                    mem[64] = mem[64] + 100
                    mem[_140 + 32] = Mask(32, 224, arg2) or mem[_140 + 36 len 28]
                    _143 = mem[_140]
                    t = _140 + 32
                    u = _139 + 100
                    s = mem[_140]
        ...
        mem[128 len 32 * arg4.length] = code.data[3212 len 32 * arg4.length]
        if not arg5:
            idx = 0
            while idx < arg4.length:
                if ext_code.size(arg1) <= 0:
                    ...
                    mem[mem[64]] = 68
                    mem[64] = mem[64] + 100
                    mem[_145 + 32] = Mask(32, 224, arg2) or mem[_145 + 36 len 28]
                    _148 = mem[_145]
                    t = _145 + 32
                    u = mem[64]
                    s = mem[_145]
            ...
            while idx < arg4.length:
                if ext_code.size(arg1) <= 0:
                    ...
                    mem[mem[64]] = 68
                    mem[64] = mem[64] + 100
                    mem[_150 + 32] = Mask(32, 224, arg2) or mem[_150 + 36 len 28]
                    _153 = mem[_150]
                    t = _150 + 32
                    u = _149 + 100
                    s = mem[_150]
