...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor1 = msg.sender
    address(stor12.field_8) = address(code.data[12345 len 32])
    bool(stor2.length) = 0
    stor2.length.field_1 = 24
    stor2.length.field_8 = 'Strategic Investor Token' / 256
    idx = 0
    ...
    stor4.length.field_8 = 'SIT' / 256
    idx = 0
    while stor4.length + 31 / 32 > idx:
        stor4[idx].field_0 = 0
        idx = idx + 1
        continue 
    stor6 = 0x60f3c7c45933d9cfae0c6950190d8c95543a4576
    stor7 = block.number
    uint8(stor12.field_0) = 0
    stor8 = block.number
    return code.data[886 len 11459]
}
