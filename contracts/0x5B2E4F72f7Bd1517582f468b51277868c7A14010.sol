...
function sub_4870c3c9(?) payable {
    ...
    if not (1000000000 * 10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]:
        ...
        staticcall 0x0.0xfa67ca36 with:
                gas gas_remaining wei
               args 0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359, 0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2, ext_call.return_data[0] / 2 / ext_call.return_data[0]
    else:
        ...
        staticcall 0x0.0xfa67ca36 with:
                gas gas_remaining wei
               args 0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359, 0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2, (10^18 * (ext_call.return_data[0] * (1000000000 * 10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function sub_1f2f90fc(?) payable {
    ...
    require arg4 == 0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2
    require arg2 == 0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359
    if arg1:
...
function sub_0610288d(?) payable {
    ...
    staticcall 0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2.0xdd62ed3e with:
            gas gas_remaining wei
           args address(this.address), 0x448a5065aebb8e423f0896e6c5d525c040f59af3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0] != -1:
        require ext_code.size(0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2)
        call 0x9f8f72aa9304c8b593d555f12ef6589cc3a579a2.approve(address arg1, uint256 arg2) with:
             gas gas_remaining wei
            args 0x448a5065aebb8e423f0896e6c5d525c040f59af3, -1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
    ...
    if arg3 != -1:
        ...
        if not (1000000000 * 10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]:
            ...
            if ext_call.return_data[0] / 2 < 0:
                revert with 0, 'ds-math-add-overflow'
            require ext_call.return_data[0]
            delegate 0x0.0xc3a579a2 with:
                 gas gas_remaining wei
                args Mask(224, 32, ext_call.return_data[0] / 2 / ext_call.return_data[0]) << 736, mem[388 len 4]
        else:
            require (1000000000 * 10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]
            ...
            delegate 0x0.0xc3a579a2 with:
                 gas gas_remaining wei
                args Mask(224, 32, (10^18 * (arg3 * (1000000000 * 10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]) << 736, mem[388 len 4]
        ...
        if not (1000000000 * 10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]:
            ...
            delegate 0x0.0xc3a579a2 with:
                 gas gas_remaining wei
                args Mask(224, 32, (10^18 * (ext_call.return_data[0] * (1000000000 * 10^18 * ext_call.return_data[0]) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]) + 500000000 * 10^18 / 1000000000 * 10^18) + (ext_call.return_data[0] / 2) / ext_call.return_data[0]) << 736, mem[388 len 4]
        if not delegate.return_code:
            revert with 0, 'swap failed'
        require ext_code.size(0x448a5065aebb8e423f0896e6c5d525c040f59af3)
        call 0x448a5065aebb8e423f0896e6c5d525c040f59af3.wipe(bytes32 arg1, uint256 arg2) with:
