...
function _fallback() {
    mem[96 len -2181] = code.data[2458 len -2181]
    mem[64] = -2085
    stor5 = mem[192]
...
function numTokensForContributor(uint256 arg1) {
    ...
    if not stor2:
        ...
        if 0 / stor5 >= stor2 - stor3:
            return (stor2 - stor3)
        return (0 / stor5)
    require arg1 * stor2 / stor2 == arg1
    require stor5
    if arg1 * stor2 / stor5 >= stor2 - stor3:
        return (stor2 - stor3)
    return (arg1 * stor2 / stor5)
}
...
function doDistribution(uint256 arg1, address arg2, uint256 arg3) {
    ...
    if uint8(stor1.field_160) == 1:
        ...
        if not stor2:
            ...
            require arg3 * stor2 / stor2 == arg3
            require stor5
            require arg1 < stor4.length
            stor4[arg1] = 0
            if arg3 * stor2 / stor5 >= stor2 - stor3:
                stor3 = stor2
                if stor2 == stor2:
                    uint8(stor1.field_160) = 3
                require ext_code.size(address(stor1.field_0))
                ...
                stor3 += arg3 * stor2 / stor5
                if stor2 == (arg3 * stor2 / stor5) + stor3:
                    uint8(stor1.field_160) = 3
                require ext_code.size(address(stor1.field_0))
                call address(stor1.field_0).0xa9059cbb with:
                     gas gas_remaining - 710 wei
                    args address(arg2), arg3 * stor2 / stor5
    require ext_call.success
...
function doDistributionRange(uint256 arg1, address[] arg2, uint256[] arg3) {
    ...
    while idx < arg1 + arg2.length:
        ...
        if not stor2:
            ...
            s = (0 / stor5) + s
            continue 
        require _43 * stor2 / stor2 == _43
        require stor5
        mem[(32 * arg2.length) + (32 * arg3.length) + 164] = address(_41)
        if _43 * stor2 / stor5 >= stor2 - stor3:
            mem[(32 * arg2.length) + (32 * arg3.length) + 196] = stor2 - stor3
            require ext_code.size(address(stor1.field_0))
            call address(stor1.field_0).0xa9059cbb with:
                 gas gas_remaining - 710 wei
            ...
            s = stor2 - stor3 + s
            continue 
        mem[(32 * arg2.length) + (32 * arg3.length) + 196] = _43 * stor2 / stor5
        require ext_code.size(address(stor1.field_0))
        call address(stor1.field_0).0xa9059cbb with:
             gas gas_remaining - 710 wei
            args address(_41), _43 * stor2 / stor5
        mem[(32 * arg2.length) + (32 * arg3.length) + 160] = ext_call.return_data[0]
        require ext_call.success
        require ext_call.return_data[0]
        s = _43 * stor2 / stor5
