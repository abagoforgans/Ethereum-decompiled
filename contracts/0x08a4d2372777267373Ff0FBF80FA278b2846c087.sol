...
const owner = 0x2bafcf3e3c183103aa94a248cc512d4dcf10cfa
...
function changePhaseToICO() {
    require 0x2bafcf3e3c183103aa94a248cc512d4dcf10cfa == msg.sender
    currentPhase = 1
    return 1
}
...
function createBountyTokens() {
    require 0x2bafcf3e3c183103aa94a248cc512d4dcf10cfa == msg.sender
    balanceOf[0x2bafcf3e3c183103aa94a248cc512d4dcf10cfa] += 60000 * 10^18
...
function _fallback() payable {
    ...
    if not currentPhase:
        if totalSupply <= 460000 * 10^18:
            ...
            call 0x02bafcf3e3c183103aa94a248cc512d4dcf10cfa with:
               value msg.value wei
