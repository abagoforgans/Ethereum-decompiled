...
function sub_cb911db4(?) payable {
    require msg.sender
    require stor5[address(msg.sender)]
    stor5[address(msg.sender)] = 0
    emit 0xf4a593cd: msg.sender
}

function renounceOwnership() payable {
    if owner != msg.sender:
        revert with 0, 'have no authority'
...
function frozenAccount(address arg1) payable {
    ...
    emit 0x6fc0a544: msg.sender, address(arg1), 1
}

function unfrozenAccount(address arg1) payable {
    require calldata.size - 4 >= 32
    require msg.sender
    if not stor5[address(msg.sender)]:
        revert with 0, 'have no authority'
    stor6[address(arg1)] = 0
    emit 0x6fc0a544: msg.sender, address(arg1), 0
}

function sub_809f1d29(?) payable {
    require calldata.size - 4 >= 32
    require msg.sender
    if not stor5[address(msg.sender)]:
        revert with 0, 'have no authority'
