...
function _fallback() payable {
    ...
    stor0 = code.data[1732 len 20]
    stor1 = 10^18 * code.data[1752 len 32]
    stor3 = (60 * code.data[1784 len 32]) + block.timestamp
    stor4 = 10^15 * code.data[1816 len 32]
    stor5 = code.data[1860 len 20]
    return code.data[183 len 1537]
}
...
function _fallback() payable {
    ...
    call tokenRewardAddress.0x79c65068 with:
         gas gas_remaining - 710 wei
        args beneficiaryAddress, msg.value / price
    require ext_call.success
