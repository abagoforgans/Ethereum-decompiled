...
function _fallback() payable {
    ...
    uint8(stor4.field_0) = 80
    require 1 < stor4.length
    uint8(stor4.field_8) = 'Q'
    require 2 < stor4.length
    uint8(stor4.field_16) = 82
    require 3 < stor4.length
    uint8(stor4.field_24) = 83
    require 4 < stor4.length
    uint8(stor4.field_32) = 84
    require 5 < stor4.length
    uint8(stor4.field_40) = 85
    require 6 < stor4.length
    uint8(stor4.field_48) = 86
    require 7 < stor4.length
    uint8(stor4.field_56) = 87
    if not stor4.length:
    ...
    return code.data[1177 len 2045]
}
