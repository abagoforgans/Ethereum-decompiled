...
function _fallback() {
    stor0 = msg.sender
    stor1 = 0x49509cb0e5720a3eadd7e7f736a5a05cf810070
    return code.data[91 len 1426]
}
    ...
    while idx < arg1.length:
        if address(cd[((32 * idx) + arg1 + 36)]):
            ...
            call stor1.0x70a08231 with:
                ...
                args this.address
            require ext_call.success
            if ext_call.return_data[0] < 100000 * arg2:
                mem[96] = arg2
                ...
                call stor1.0xa9059cbb with:
                     gas gas_remaining - 710 wei
                    args address(cd[((32 * idx) + arg1 + 36)]), 100000 * arg2
                require ext_call.success
                mem[96] = arg2
    ...
    while idx < arg1.length:
        ...
        if address(cd[((32 * idx) + arg1 + 36)]):
            ...
            call stor1.0x70a08231 with:
                ...
                args this.address
            require ext_call.success
            if ext_call.return_data[0] < 100000 * cd[((32 * idx) + arg2 + 36)]:
                mem[96] = cd[((32 * idx) + arg2 + 36)]
                emit FailedTransfer(cd[((32 * idx) + arg2 + 36)], address(cd[((32 * idx) + arg1 + 36)]));
            else:
                mem[100] = address(cd[((32 * idx) + arg1 + 36)])
                mem[132] = 100000 * cd[((32 * idx) + arg2 + 36)]
                require ext_code.size(stor1)
                call stor1.0xa9059cbb with:
                     gas gas_remaining - 710 wei
                    args address(cd[((32 * idx) + arg1 + 36)]), 100000 * cd[((32 * idx) + arg2 + 36)]
                require ext_call.success
                mem[96] = cd[((32 * idx) + arg2 + 36)]
                emit TransferredToken(cd[((32 * idx) + arg2 + 36)], address(cd[((32 * idx) + arg1 + 36)]));
        s = 100000 * cd[((32 * idx) + arg2 + 36)]
        idx = idx + 1
        continue 
}
