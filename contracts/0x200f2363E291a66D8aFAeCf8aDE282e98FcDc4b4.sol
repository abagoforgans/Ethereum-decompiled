...
function sub_82b64590(?) {
    ...
    stor[(4 * sub_9aff291d[address(arg1)].field_768) + ('array', 3, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'sub_9aff291d', 1)))].field_784 = Mask(240, 16, arg5) >> 16
}
