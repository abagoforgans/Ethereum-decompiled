...
function get_Holders(uint256 arg1) {
    ...
    while idx < ext_call.return_data[0]:
        ...
        if 2 * ext_call.return_data[0] / stor3 < tokensNeededToGetPayment:
            ...
            continue 
        require uint8(v) < 64
        mem[(32 * uint8(v)) + 96] = address(ext_call.return_data[0])
        if uint8(v + 1) != 64:
            s = ext_call.return_data[0]
            t = ext_call.return_data[0]
            u = ext_call.return_data[0]
    ...
    if arg1 <= ext_call.return_data[0]:
        return mem[96], mem[128], mem[160], mem[192 len 1952], w
    mem[2176] = 0
    require ext_code.size(stor2)
    call stor2.getCountTempHolders() with:
         gas gas_remaining - 50 wei
    ...
    t = 0
    x = 0
    idx = arg1 - ext_call.return_data[0]
    x = v
    y = w
    while idx < ext_call.return_data[0]:
        mem[2176] = 0
        ...
        while idx > 32:
            ...
            idx = idx - 32
            continue 
        return mem[96], mem[128], mem[160], mem[2240 len 1952], y + 1
    return mem[96], mem[128], mem[160], mem[192 len 1952], y
}
