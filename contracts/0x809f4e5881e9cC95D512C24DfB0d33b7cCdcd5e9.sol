...
function sub_5e2d4631(?) {
    ...
    return sub_5e2d4631[arg1].field_0, sub_5e2d4631[arg1].field_256, sub_5e2d4631[arg1].field_512
}
...
function sub_de45ffd7(?) {
    ...
    while sub_5e2d4631[arg1].field_768 > idx:
        ...
        idx = idx + 1
        continue 
    sub_5e2d4631[arg1].field_1024 = 0
    idx = 0
    while sub_5e2d4631[arg1].field_1024 > idx:
        sub_5e2d4631[arg1][idx + 4].field_0 = 0
        idx = idx + 1
        continue 
}

function sub_e1443c62(?) payable {
    require msg.sender == stor0
    require arg2 <= eth.balance(this.address)
    if not sub_5e2d4631[arg1].field_768:
        require ext_code.size(sub_5e2d4631[arg1].field_512)
        call sub_5e2d4631[arg1].field_512.quickConvert(address[] arg1, uint256 arg2, uint256 arg3) with:
           value arg2 wei
             gas gas_remaining wei
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require sub_5e2d4631[arg1].field_768 - 1 < sub_5e2d4631[arg1].field_768
    return stor[('array', 3, ('map', ('param', 'arg1'), ('name', 'sub_5e2d4631', 1))) + sub_5e2d4631[arg1].field_768].field_0, 
           ext_call.return_data[0]
}

function sub_682336b4(?) payable {
    require msg.sender == stor0
    require arg2 <= eth.balance(this.address)
    if not sub_5e2d4631[arg1].field_768:
        require ext_code.size(sub_5e2d4631[arg1].field_512)
    ...
    if ext_call.return_data[0] > 0:
        require ext_code.size(stor[('array', 3, ('map', ('param', 'arg1'), ('name', 'sub_5e2d4631', 1))) + sub_5e2d4631[arg1].field_768].field_0)
        call stor[('array', 3, ('map', ('param', 'arg1'), ('name', 'sub_5e2d4631', 1))) + sub_5e2d4631[arg1].field_768].field_0.0xa9059cbb with:
             gas gas_remaining wei
...
function sub_31a38579(?) {
    ...
    require msg.sender == stor0
    mem[(32 * arg6.length) + (32 * arg5.length) + 160] = arg2
    sub_5e2d4631[arg1].field_0 = arg2
    sub_5e2d4631[arg1].field_256 = arg3
    sub_5e2d4631[arg1].field_512 = arg4
    ...
    if not arg5.length:
        ...
        while sub_5e2d4631[arg1].field_768 > idx:
            ...
            idx = idx + 1
            continue 
    sub_5e2d4631[arg1].field_1024 = arg6.length
    if not arg6.length:
        idx = 0
        while sub_5e2d4631[arg1].field_1024 > idx:
            sub_5e2d4631[arg1][idx + 4].field_0 = 0
        ...
        s = 0
        idx = (32 * arg5.length) + 160
        while (32 * arg5.length) + (32 * arg6.length) + 160 > idx:
            sub_5e2d4631[arg1][s + 4].field_0 = mem[idx + 12 len 20]
            s = s + 1
            idx = idx + 32
            continue 
...
function sub_91919e53(?) payable {
    require msg.sender == stor0
    require 0 < sub_5e2d4631[arg1].field_1024
    require ext_code.size(sub_5e2d4631[arg1][4].field_0)
    call sub_5e2d4631[arg1][4].field_0.0x70a08231 with:
         gas gas_remaining wei
        args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if ext_call.return_data[0] < arg2:
        require 0 < sub_5e2d4631[arg1].field_1024
        require ext_code.size(sub_5e2d4631[arg1][4].field_0)
        call sub_5e2d4631[arg1][4].field_0.0x23b872dd with:
             gas gas_remaining wei
            args msg.sender, this.address, arg2
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
    if not sub_5e2d4631[arg1].field_1024:
        require ext_code.size(sub_5e2d4631[arg1].field_512)
        call sub_5e2d4631[arg1].field_512.quickConvert(address[] arg1, uint256 arg2, uint256 arg3) with:
           value arg2 wei
             gas gas_remaining wei
            args 0, 96, arg2, arg3, sub_5e2d4631[arg1].field_1024
    else:
        mem[228] = sub_5e2d4631[arg1][4].field_0
        idx = 228
        s = 0
        while (32 * sub_5e2d4631[arg1].field_1024) + 228 > idx + 32:
            mem[idx + 32] = sub_5e2d4631[arg1][s + 4].field_256
            idx = idx + 32
            s = s + 1
            continue 
        require ext_code.size(sub_5e2d4631[arg1].field_512)
        call sub_5e2d4631[arg1].field_512.quickConvert(address[] arg1, uint256 arg2, uint256 arg3) with:
           value arg2 wei
             gas gas_remaining wei
            args 0, 96, arg2, arg3, sub_5e2d4631[arg1].field_1024, mem[228 len 32 * sub_5e2d4631[arg1].field_1024]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    return ext_call.return_data[0]
...
function sub_de09f9cf(?) payable {
    ...
    if 0xc0829421c1d260bd3cb3e0f06cfe2d52db2ce315 == mem[140 len 20]:
        ...
        if 0xc0829421c1d260bd3cb3e0f06cfe2d52db2ce315 == mem[(32 * arg2.length - 1) + 140 len 20]:
            if ext_call.return_data[0] > 0:
                require msg.sender == stor0
                call msg.sender with:
                   value ext_call.return_data[0] wei
        ...
        require 0 < arg2.length
        if 0x1f573d6fb3f13d689ff844b4ce37794d79a7ff1c == mem[140 len 20]:
            mem[(32 * arg2.length) + 164] = arg3
            mem[(32 * arg2.length) + 196] = arg4
            mem[(32 * arg2.length) + 228] = arg5
            mem[(32 * arg2.length) + 260] = arg6
            ...
            if ext_call.return_data[0] >= arg3:
                ...
                call address(_33).approve(address arg1, uint256 arg2) with:
                     gas gas_remaining wei
                    args address(arg1), arg3
                mem[(32 * arg2.length) + 128] = ext_call.return_data[0]
                if not ext_call.success:
