...
function mint(address arg1, uint256 arg2) {
    ...
    require totalSupply <= 371
    require balanceOf[address(msg.sender)] <= 4
    require balanceOf[address(msg.sender)] + tokenAmount <= 5
    require tokenAmount <= 5
    require tokenAmount + totalSupply <= 372
