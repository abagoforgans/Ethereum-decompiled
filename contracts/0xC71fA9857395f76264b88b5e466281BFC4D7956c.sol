...
function _fallback() payable {
    ...
    require 310 * msg.value >= 100 * 10^18
...
function sendGifts(address[] arg1) {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 3
        _57 = sha3(mem[(32 * idx) + 140 len 20], 3)
        if balanceOf[mem[(32 * idx) + 140 len 20]] < 100 * 10^18:
            s = s
            t = t
            u = balanceOf[mem[(32 * idx) + 140 len 20]]
            idx = idx + 1
            continue 
        if not balanceOf[mem[(32 * idx) + 140 len 20]]:
            ...
            require 10^18 * 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / tokensSold <= allowance[address(stor6.field_0)][address(msg.sender)]
            require 10^18 * 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / tokensSold <= balanceOf[address(stor6.field_0)]
            balanceOf[address(stor6.field_0)] += -1 * 10^18 * 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / tokensSold
            require balanceOf[address(mem[(32 * idx) + 128])] + (10^18 * 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / tokensSold) >= balanceOf[address(mem[(32 * idx) + 128])]
            require balanceOf[address(mem[(32 * idx) + 128])] + (10^18 * 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / tokensSold) >= 10^18 * 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / tokensSold
            balanceOf[address(mem[(32 * idx) + 128])] += 10^18 * 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / tokensSold
            require 10^18 * 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / tokensSold <= allowance[address(stor6.field_0)][address(msg.sender)]
            mem[0] = msg.sender
            mem[32] = sha3(address(stor6.field_0), 4)
            allowance[address(stor6.field_0)][address(msg.sender)] += -1 * 10^18 * 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / tokensSold
            mem[(32 * arg1.length) + 128] = 10^18 * 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / tokensSold
            emit Transfer((10^18 * 200000 * stor[_57] / tokensSold), santaFundWalletAddress, address(_59));
        else:
            require balanceOf[mem[(32 * idx) + 140 len 20]]
            require 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / balanceOf[mem[(32 * idx) + 140 len 20]] == 200000
            require tokensSold
            require idx < arg1.length
            _63 = mem[(32 * idx) + 128]
            if block.timestamp < startTransferTime:
            ...
            allowance[address(stor6.field_0)][address(msg.sender)] += -1 * 10^18 * 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / tokensSold
            mem[(32 * arg1.length) + 128] = 10^18 * 200000 * balanceOf[mem[(32 * idx) + 140 len 20]] / tokensSold
            emit Transfer((10^18 * 200000 * stor[_57] / tokensSold), santaFundWalletAddress, address(_63));
        s = 10^18 * 200000 * stor[_57] / tokensSold
        t = 200000
        u = stor[_57]
        idx = idx + 1
        continue 
