...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[7529 len 20]
    stor2 = code.data[7529 len 20]
    require code.data[7593 len 20]
    require code.data[7625 len 20]
    require block.timestamp < code.data[7549 len 32]
    stor4 = code.data[7549 len 32]
    stor5 = stor4 + (336 * 24 * 3600)
    stor9 = code.data[7593 len 20]
    stor10 = code.data[7625 len 20]
    stor8 = code.data[7645 len 32]
    return code.data[968 len 6549]
}
