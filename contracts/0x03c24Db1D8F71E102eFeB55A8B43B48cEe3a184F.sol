...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[2292 len 32] >= block.timestamp
    require code.data[2324 len 32] > code.data[2292 len 32]
    require code.data[2196 len 32] > 0
    require code.data[2228 len 32] > 0
    require code.data[2400 len 20]
    require code.data[2368 len 20]
    stor5 = code.data[2196 len 32]
    stor6 = code.data[2228 len 32]
    stor7 = code.data[2260 len 32]
    stor2 = code.data[2292 len 32]
    stor3 = code.data[2324 len 32]
    stor1 = code.data[2368 len 20]
    stor4 = code.data[2400 len 20]
    return code.data[320 len 1876]
}
...
function _fallback() payable {
    ...
    if msg.value < 100 * 10^18:
        ...
        if msg.value < 300 * 10^18:
            ...
            if 115 * msg.value / 100:
                require 115 * msg.value / 100
            ...
            if msg.value < 500 * 10^18:
                ...
                if 120 * msg.value / 100:
                    require 120 * msg.value / 100
                ...
                if msg.value >= 700 * 10^18:
                    ...
                    if 130 * msg.value / 100:
                        require 130 * msg.value / 100
                    ...
                    if 125 * msg.value / 100:
                        require 125 * msg.value / 100
