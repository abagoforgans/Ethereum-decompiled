...
function getTransaction(uint256 arg1) {
    ...
    while stor0[arg1][2].length + 96 > idx:
        mem[idx + 32] = stor0[arg1][t + 2].field_256
        idx = idx + 32
        t = t + 1
        continue 
    return address(stor0[arg1].field_0), 
           ...
           bool(uint8(stor1[arg1][msg.sender])),
           s
}
...
function transactions(uint256 arg1) {
    ...
    while stor0[arg1][2].length + 96 > idx:
        ...
        s = s + 1
        continue 
    mem[ceil32(stor0[arg1][2].length) + 128] = address(stor0[arg1].field_0)
    mem[ceil32(stor0[arg1][2].length) + 160] = stor0[arg1].field_256
    mem[ceil32(stor0[arg1][2].length) + 224] = bool(uint8(stor0[arg1].field_768))
    mem[ceil32(stor0[arg1][2].length) + 256] = bool(uint8(stor0[arg1].field_776))
    mem[ceil32(stor0[arg1][2].length) + 192] = 160
    mem[ceil32(stor0[arg1][2].length) + 288] = stor0[arg1][2].length
    if 0 < stor0[arg1][2].length:
        mem[ceil32(stor0[arg1][2].length) + 320] = mem[128]
        mem[ceil32(stor0[arg1][2].length) + 352 len floor32(stor0[arg1][2].length - 1)] = mem[160 len floor32(stor0[arg1][2].length - 1)]
    return address(stor0[arg1].field_0), 
           stor0[arg1].field_256,
           Array(len=stor0[arg1][2].length, data=mem[ceil32(stor0[arg1][2].length) + 320 len stor0[arg1][2].length]),
           bool(uint8(stor0[arg1].field_768)),
           bool(uint8(stor0[arg1].field_776))
}

function getConfirmations(uint256 arg1) {
    if owners.length:
        mem[128 len 32 * owners.length] = code.data[5969 len 32 * owners.length]
    idx = 0
    s = 0
    while idx < owners.length:
        mem[0] = address(owners[idx].field_0)
    ...
    if s:
        mem[(32 * owners.length) + 160 len 32 * s] = code.data[5969 len 32 * s]
    t = 0
    while t < s:
...
function confirmTransaction(uint256 arg1) {
    ...
    require not uint8(stor0[arg1].field_776)
...
function sub_5eee2f09(?) {
    if transactionCount:
        mem[128 len 32 * transactionCount] = code.data[5969 len 32 * transactionCount]
    idx = 0
    s = 0
    while idx < transactionCount:
        mem[0] = idx
    ...
    if arg2 - arg1:
        mem[(32 * transactionCount) + 160 len 32 * arg2 - arg1] = code.data[5969 len 32 * arg2 - arg1]
    idx = arg1
    while idx < arg2:
...
function submitTransaction(address arg1, uint256 arg2, bytes arg3) {
    ...
    Mask(248, 0, stor0[stor5].field_776) = 0
    Mask(240, 0, stor0[stor5].field_784) = 0
    transactionCount++
    emit Submission(transactionCount);
    require stor2[msg.sender]
    require address(stor0[stor5].field_0)
    require not uint8(stor0[stor5].field_776)
