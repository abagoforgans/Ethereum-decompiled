...
const tokenCreationCap = 1000 * 10^18

const symbol = 'OBG'

const tokenCreationMin = 500 * 10^18
...
function _fallback() payable {
    ...
    require msg.value
    require msg.value <= -totalSupply + 1000 * 10^18 / 1000
