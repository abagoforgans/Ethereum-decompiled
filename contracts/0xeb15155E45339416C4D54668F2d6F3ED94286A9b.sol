...
function sub_a28a1c8a(?) {
    ...
    call address(ext_call.return_data[0]).0x2f54bf6e with:
         gas gas_remaining wei
        args msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_308fd11f(?) {
    ...
    mem[448 len 0] = None
    mem[448 len 14] = 0, mem[452 len 10]
    mem[671 len 0] = None
    mem[710 len 7] = mem[671 len 7]
    mem[682] = sha3(sha3(sha3(Mask(144, 0, mem[448 len 14], 0, 0)), 0x436f6d70616e795570646174), mem[671 len 7])
    require ext_code.size(stor4)
    call stor4.getUint(bytes32 arg1) with:
         gas gas_remaining wei
        args sha3(sha3(sha3(Mask(144, 0, mem[448 len 14], 0, 0)), 0x436f6d70616e795570646174), mem[671 len 7])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[710 len arg1.length] = arg1[all]
    mem[ceil32(arg1.length) + 710] = 18
    mem[ceil32(arg1.length) + 806 len 0] = None
    mem[ceil32(arg1.length) + 933] = sha3(sha3(Mask(144, 0, mem[ceil32(arg1.length) + 806 len 14], 0, 0)), mem[ceil32(arg1.length) + 933 len 13])
    mem[ceil32(arg1.length) + 1125 len 0] = None
    require ext_code.size(stor4)
    call stor4.setAddress(bytes32 arg1, address arg2) with:
         gas gas_remaining wei
        args sha3(sha3(mem[ceil32(arg1.length) + 933], ext_call.return_data[0]), mem[ceil32(arg1.length) + 1125 len 7]), msg.sender
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[ceil32(arg1.length) + 1260 len 0] = None
    mem[ceil32(arg1.length) + 1365 len ceil32(arg1.length)] = arg1[all], mem[arg1.length + 710 len ceil32(arg1.length) - arg1.length]
    require ext_code.size(stor4)
    call stor4.setString(bytes32 arg1, string arg2) with:
         gas gas_remaining wei
        args sha3(sha3(mem[ceil32(arg1.length) + 933], ext_call.return_data[0]), mem[ceil32(arg1.length) + 1260 len 5]), Array(len=arg1.length, data=arg1[all])
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    mem[ceil32(arg1.length) + 1393 len 0] = None
    require ext_code.size(stor4)
    call stor4.setUint(bytes32 arg1, uint256 arg2) with:
         gas gas_remaining wei
        args sha3(sha3(mem[ceil32(arg1.length) + 933], ext_call.return_data[0]), mem[ceil32(arg1.length) + 1393 len 4]), block.timestamp
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    # nil
}
