...
function _fallback() {
    stor0 = msg.sender
    stor1 = code.data[2304 len 20]
    stor2 = code.data[2324 len 32]
    stor3 = code.data[2356 len 32]
    stor4 = code.data[2400 len 20]
    require ext_code.size(address(code.data[2292 len 32]))
    call address(code.data[2292 len 32]).owner(bytes32 rg1) with:
...
function register(string arg1) payable {
    ...
    _34 = sha3(call.data[arg1 + 36 len floor32(arg1.length)], mem[ceil32(arg1.length) + floor32(arg1.length) + 128 len arg1.length % 32])
    mem[ceil32(arg1.length) + 160] = 0
    mem[ceil32(arg1.length) + 132] = _34
