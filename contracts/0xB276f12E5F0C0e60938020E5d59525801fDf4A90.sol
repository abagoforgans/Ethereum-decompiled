...
#
#  - transferToICAP(bytes32 arg1, uint256 arg2)
#
...
function registryICAP() payable {
    return address(registryICAPAddress)
}
...
function proxySetCosignerAddress(address arg1, bytes32 arg2) payable {
    if address(sub_c372fe16[uint256(stor4[tx.origin])][arg2]):
        call address(sub_c372fe16[uint256(stor4[tx.origin])][arg2]).0xa25035b with:
             gas gas_remaining - 25050 wei
        ...
        if address(sub_c372fe16[uint256(stor4[tx.origin])]):
            ...
            if not ext_call.return_data[0]:
                return 0
    if not uint8(proxies[arg2][1][address(msg.sender)].field_0):
        return 0
    if uint256(holderId[tx.origin]) != 0:
        uint256(sub_c372fe16[uint256(stor4[tx.origin])][arg2]) = arg1 or Mask(96, 160, uint256(sub_c372fe16[uint256(stor4[tx.origin])][arg2]))
    else:
        stor2.length++
    ...
    if uint256(holderId[address(arg1)]) != 0:
        ...
        if arg4.length > 0:
            if uint8(sub_aeadd049[('map', ('param', 'arg3'), ('name', 'sub_aeadd049', 1))]):
                return 0
        if uint256(holderId[tx.origin]) != uint256(holderId[tx.origin]):
            if uint256(allowance[arg3][5][uint256(stor4[tx.origin])][1][uint256(stor4[tx.origin])].field_0) < arg2:
                return 0
        ...
        if address(proxies[arg3].field_0) != 0:
            ...
            require ext_call.success
    if uint256(holderId[tx.origin]) != uint256(holderId[tx.origin]):
        uint256(allowance[arg3][5][uint256(stor4[tx.origin])][1][uint256(stor4[tx.origin])].field_0) -= arg2
    return 1
}
    ...
    if uint256(holderId[address(arg2)]) != 0:
        ...
        if arg5.length > 0:
            if uint8(sub_aeadd049[('map', ('param', 'arg4'), ('name', 'sub_aeadd049', 1))]):
                return 0
        if uint256(holderId[address(arg1)]) != uint256(holderId[tx.origin]):
...
function transferFromWithReference(address arg1, address arg2, uint256 arg3, bytes32 arg4, string arg5) payable {
    if uint256(holderId[address(arg2)]) != 0:
        ...
        if arg5.length > 0:
            if uint8(sub_aeadd049[('map', ('param', 'arg4'), ('name', 'sub_aeadd049', 1))]):
                return 0
        if uint256(holderId[address(arg1)]) != uint256(holderId[address(msg.sender)]):
...
function transferWithReference(address arg1, uint256 arg2, bytes32 arg3, string arg4) payable {
    if uint256(holderId[address(arg1)]) != 0:
        ...
        if arg4.length > 0:
            if uint8(sub_aeadd049[('map', ('param', 'arg3'), ('name', 'sub_aeadd049', 1))]):
                return 0
        if uint256(holderId[address(msg.sender)]) != uint256(holderId[address(msg.sender)]):
            if uint256(allowance[arg3][5][uint256(stor4[address(msg.sender)])][1][uint256(stor4[address(msg.sender)])].field_0) < arg2:
                return 0
        ...
        if address(proxies[arg3].field_0) != 0:
            ...
            require ext_call.success
    if uint256(holderId[address(msg.sender)]) != uint256(holderId[address(msg.sender)]):
        uint256(allowance[arg3][5][uint256(stor4[address(msg.sender)])][1][uint256(stor4[address(msg.sender)])].field_0) -= arg2
    return 1
}
...
function proxyTransferToICAPWithReference(bytes32 arg1, uint256 arg2, string arg3) payable {
    call address(registryICAPAddress).parse(bytes32 rg1) with:
         gas gas_remaining - 25050 wei
        args arg1
    require ext_call.success
    if not ext_call.return_data[64]:
        return 0
    if uint8(stor1[('map', ('ext_call.return_data', 32, 32), ('name', 'allowance', 5))].field_0):
        return 0
    if tx.origin != msg.sender:
        if not uint8(proxies[ext_call.return_data[32]][1][address(msg.sender)].field_0):
            return 0
    if uint256(holderId[address(ext_call.return_data[0])]) != 0:
        if address(sub_c372fe16[uint256(stor4[tx.origin])][ext_call.return_data[32]]) != 0:
            call address(sub_c372fe16[uint256(stor4[tx.origin])][ext_call.return_data[32]]).0xa25035b with:
                 gas gas_remaining - 25050 wei
                args sha3(call.data[0 len calldata.size], uint256(holderId[tx.origin]))
            require ext_call.success
            if not ext_call.return_data[0]:
            ...
            if address(sub_c372fe16[uint256(stor4[tx.origin])]):
                ...
                if not ext_call.return_data[0]:
                    return 0
        if uint8(proxies[ext_call.return_data[32]].field_160):
            if not uint8(proxies[ext_call.return_data[32]][1][address(msg.sender)].field_0):
                return 0
        if uint256(holderId[tx.origin]) == uint256(holderId[address(ext_call.return_data[0])]):
            return 0
        if arg2 < 1:
            return 0
        if uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[tx.origin])].field_0) < arg2:
            return 0
        if arg3.length > 0:
            if uint8(sub_aeadd049[('map', ('ext_call.return_data', 32, 32), ('name', 'sub_aeadd049', 1))]):
                return 0
        if uint256(holderId[tx.origin]) != uint256(holderId[tx.origin]):
            if uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[tx.origin])][1][uint256(stor4[tx.origin])].field_0) < arg2:
                return 0
        uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[tx.origin])].field_0) -= arg2
        uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(ext_call.return_data[0])])].field_0) += arg2
        emit Transfer(arg2, Array(len=arg3.length, data=arg3[all]), address(owner[uint256(stor4[tx.origin])].field_256), address(owner[uint256(stor4[address(ext_call.return_data[0])])].field_256), ext_call.return_data[32]);
        if address(proxies[ext_call.return_data[32]].field_0) != 0:
            call address(proxies[ext_call.return_data[32]].field_0).emitTransfer(address rg1, address rg2, uint256 rg3) with:
                 gas gas_remaining - 25050 wei
                args address(owner[uint256(stor4[tx.origin])].field_256), address(owner[uint256(stor4[address(ext_call.return_data[0])])].field_256), arg2
            require ext_call.success
        if uint256(holderId[tx.origin]) != uint256(holderId[tx.origin]):
            uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[tx.origin])][1][uint256(stor4[tx.origin])].field_0) -= arg2
        emit 0x36a027e2: arg2, Array(len=arg3.length, data=arg3[all]), address(owner[uint256(stor4[tx.origin])].field_256), address(owner[uint256(stor4[address(ext_call.return_data[0])])].field_256), arg1
    else:
        stor2.length++
        uint256(owner[stor2.length].field_256) = ext_call.return_data[0] or Mask(96, 160, uint256(owner[stor2.length].field_256))
        uint256(owner[stor2.length].field_0) = 1
        uint256(holderId[address(ext_call.return_data[0])]) = stor2.length
        if address(sub_c372fe16[uint256(stor4[tx.origin])][ext_call.return_data[32]]) != 0:
            call address(sub_c372fe16[uint256(stor4[tx.origin])][ext_call.return_data[32]]).0xa25035b with:
                 gas gas_remaining - 25050 wei
                args sha3(call.data[0 len calldata.size], uint256(holderId[tx.origin]))
        ...
        if uint256(holderId[tx.origin]) != uint256(holderId[tx.origin]):
            if uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[tx.origin])][1][uint256(stor4[tx.origin])].field_0) < arg2:
                return 0
        uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[tx.origin])].field_0) -= arg2
        uint256(allowance[ext_call.return_data[32]][5][stor2.length].field_0) += arg2
        emit Transfer(arg2, Array(len=arg3.length, data=arg3[all]), address(owner[uint256(stor4[tx.origin])].field_256), address(owner[stor2.length].field_256), ext_call.return_data[32]);
        if address(proxies[ext_call.return_data[32]].field_0) != 0:
            call address(proxies[ext_call.return_data[32]].field_0).emitTransfer(address rg1, address rg2, uint256 rg3) with:
                 gas gas_remaining - 25050 wei
                args address(owner[uint256(stor4[tx.origin])].field_256), address(owner[stor2.length].field_256), arg2
        ...
        if uint256(holderId[tx.origin]) != uint256(holderId[tx.origin]):
            uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[tx.origin])][1][uint256(stor4[tx.origin])].field_0) -= arg2
        emit 0x36a027e2: arg2, Array(len=arg3.length, data=arg3[all]), address(owner[uint256(stor4[tx.origin])].field_256), address(owner[stor2.length].field_256), arg1
    return 1
}

function proxyTransferFromToICAPWithReference(address arg1, bytes32 arg2, uint256 arg3, string arg4) payable {
    call address(registryICAPAddress).parse(bytes32 rg1) with:
         gas gas_remaining - 25050 wei
        args arg2
    require ext_call.success
    ...
    if uint256(holderId[address(ext_call.return_data[0])]) != 0:
        ...
        if uint8(proxies[ext_call.return_data[32]].field_160):
            if not uint8(proxies[ext_call.return_data[32]][1][address(msg.sender)].field_0):
                return 0
        if uint256(holderId[address(arg1)]) == uint256(holderId[address(ext_call.return_data[0])]):
            return 0
        if arg3 < 1:
            return 0
        if uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(arg1)])].field_0) < arg3:
            return 0
        if arg4.length > 0:
            if uint8(sub_aeadd049[('map', ('ext_call.return_data', 32, 32), ('name', 'sub_aeadd049', 1))]):
                return 0
        if uint256(holderId[address(arg1)]) != uint256(holderId[tx.origin]):
            if uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(arg1)])][1][uint256(stor4[tx.origin])].field_0) < arg3:
                return 0
        uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(arg1)])].field_0) -= arg3
        uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(ext_call.return_data[0])])].field_0) += arg3
        emit Transfer(arg3, Array(len=arg4.length, data=arg4[all]), address(owner[uint256(stor4[address(arg1)])].field_256), address(owner[uint256(stor4[address(ext_call.return_data[0])])].field_256), ext_call.return_data[32]);
        if address(proxies[ext_call.return_data[32]].field_0) != 0:
            call address(proxies[ext_call.return_data[32]].field_0).emitTransfer(address rg1, address rg2, uint256 rg3) with:
                 gas gas_remaining - 25050 wei
                args address(owner[uint256(stor4[address(arg1)])].field_256), address(owner[uint256(stor4[address(ext_call.return_data[0])])].field_256), arg3
            require ext_call.success
        if uint256(holderId[tx.origin]) != uint256(holderId[address(arg1)]):
            uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(arg1)])][1][uint256(stor4[tx.origin])].field_0) -= arg3
        emit 0x36a027e2: arg3, Array(len=arg4.length, data=arg4[all]), address(owner[uint256(stor4[address(arg1)])].field_256), address(owner[uint256(stor4[address(ext_call.return_data[0])])].field_256), arg2
    else:
        stor2.length++
        uint256(owner[stor2.length].field_256) = ext_call.return_data[0] or Mask(96, 160, uint256(owner[stor2.length].field_256))
        uint256(owner[stor2.length].field_0) = 1
        ...
        if uint256(holderId[address(arg1)]) != uint256(holderId[tx.origin]):
            if uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(arg1)])][1][uint256(stor4[tx.origin])].field_0) < arg3:
                return 0
        uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(arg1)])].field_0) -= arg3
        uint256(allowance[ext_call.return_data[32]][5][stor2.length].field_0) += arg3
        emit Transfer(arg3, Array(len=arg4.length, data=arg4[all]), address(owner[uint256(stor4[address(arg1)])].field_256), address(owner[stor2.length].field_256), ext_call.return_data[32]);
        if address(proxies[ext_call.return_data[32]].field_0) != 0:
            call address(proxies[ext_call.return_data[32]].field_0).emitTransfer(address rg1, address rg2, uint256 rg3) with:
                 gas gas_remaining - 25050 wei
                args address(owner[uint256(stor4[address(arg1)])].field_256), address(owner[stor2.length].field_256), arg3
        ...
        if uint256(holderId[tx.origin]) != uint256(holderId[address(arg1)]):
            uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(arg1)])][1][uint256(stor4[tx.origin])].field_0) -= arg3
        emit 0x36a027e2: arg3, Array(len=arg4.length, data=arg4[all]), address(owner[uint256(stor4[address(arg1)])].field_256), address(owner[stor2.length].field_256), arg2
    return 1
}
...
function transferFromToICAP(address arg1, bytes32 arg2, uint256 arg3) payable {
    ...
    if msg.sender != msg.sender:
        if not uint8(proxies[ext_call.return_data[32]][1][address(msg.sender)].field_0):
            return 0
    if uint256(holderId[address(ext_call.return_data[0])]) != 0:
        if address(sub_c372fe16[uint256(stor4[address(msg.sender)])][ext_call.return_data[32]]) != 0:
            call address(sub_c372fe16[uint256(stor4[address(msg.sender)])][ext_call.return_data[32]]).0xa25035b with:
                 gas gas_remaining - 25050 wei
                args sha3(call.data[0 len calldata.size], uint256(holderId[address(msg.sender)]))
            require ext_call.success
            if not ext_call.return_data[0]:
        ...
        if uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(arg1)])].field_0) < arg3:
            return 0
        if uint256(holderId[address(arg1)]) != uint256(holderId[address(msg.sender)]):
            if uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(arg1)])][1][uint256(stor4[address(msg.sender)])].field_0) < arg3:
                return 0
        uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(arg1)])].field_0) -= arg3
        uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(ext_call.return_data[0])])].field_0) += arg3
        emit Transfer(address rg1, address rg2, bytes32 rg3, uint256 rg4, string rg5):
                      ...
                      0,
                      address(owner[uint256(stor4[address(arg1)])].field_256),
                      address(owner[uint256(stor4[address(ext_call.return_data[0])])].field_256),
        ...
        if address(proxies[ext_call.return_data[32]].field_0) != 0:
            ...
            require ext_call.success
        if uint256(holderId[address(msg.sender)]) != uint256(holderId[address(arg1)]):
            uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(arg1)])][1][uint256(stor4[address(msg.sender)])].field_0) -= arg3
        emit 0x36a027e2: arg3, 64, 0, address(owner[uint256(stor4[address(arg1)])].field_256), address(owner[uint256(stor4[address(ext_call.return_data[0])])].field_256), arg2
    else:
        stor2.length++
        uint256(owner[stor2.length].field_256) = ext_call.return_data[0] or Mask(96, 160, uint256(owner[stor2.length].field_256))
        uint256(owner[stor2.length].field_0) = 1
        ...
        if uint256(holderId[address(msg.sender)]) != uint256(holderId[address(arg1)]):
            uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(arg1)])][1][uint256(stor4[address(msg.sender)])].field_0) -= arg3
        emit 0x36a027e2: arg3, 64, 0, address(owner[uint256(stor4[address(arg1)])].field_256), address(owner[stor2.length].field_256), arg2
    return 1
}
...
function transferToICAPWithReference(bytes32 arg1, uint256 arg2, string arg3) payable {
    ...
    if uint256(holderId[address(ext_call.return_data[0])]) != 0:
        ...
        if uint8(proxies[ext_call.return_data[32]].field_160):
            if not uint8(proxies[ext_call.return_data[32]][1][address(msg.sender)].field_0):
                return 0
        if uint256(holderId[address(msg.sender)]) == uint256(holderId[address(ext_call.return_data[0])]):
            return 0
        if arg2 < 1:
            return 0
        if uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(msg.sender)])].field_0) < arg2:
            return 0
        if arg3.length > 0:
            if uint8(sub_aeadd049[('map', ('ext_call.return_data', 32, 32), ('name', 'sub_aeadd049', 1))]):
                return 0
        if uint256(holderId[address(msg.sender)]) != uint256(holderId[address(msg.sender)]):
            if uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(msg.sender)])][1][uint256(stor4[address(msg.sender)])].field_0) < arg2:
                return 0
        uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(msg.sender)])].field_0) -= arg2
        uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(ext_call.return_data[0])])].field_0) += arg2
        emit Transfer(arg2, Array(len=arg3.length, data=arg3[all]), address(owner[uint256(stor4[address(msg.sender)])].field_256), address(owner[uint256(stor4[address(ext_call.return_data[0])])].field_256), ext_call.return_data[32]);
        if address(proxies[ext_call.return_data[32]].field_0) != 0:
            call address(proxies[ext_call.return_data[32]].field_0).emitTransfer(address rg1, address rg2, uint256 rg3) with:
                 gas gas_remaining - 25050 wei
                args address(owner[uint256(stor4[address(msg.sender)])].field_256), address(owner[uint256(stor4[address(ext_call.return_data[0])])].field_256), arg2
            require ext_call.success
        if uint256(holderId[address(msg.sender)]) != uint256(holderId[address(msg.sender)]):
            uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(msg.sender)])][1][uint256(stor4[address(msg.sender)])].field_0) -= arg2
        emit 0x36a027e2: arg2, Array(len=arg3.length, data=arg3[all]), address(owner[uint256(stor4[address(msg.sender)])].field_256), address(owner[uint256(stor4[address(ext_call.return_data[0])])].field_256), arg1
    else:
        stor2.length++
        uint256(owner[stor2.length].field_256) = ext_call.return_data[0] or Mask(96, 160, uint256(owner[stor2.length].field_256))
        uint256(owner[stor2.length].field_0) = 1
        ...
        uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(msg.sender)])].field_0) -= arg2
        uint256(allowance[ext_call.return_data[32]][5][stor2.length].field_0) += arg2
        emit Transfer(arg2, Array(len=arg3.length, data=arg3[all]), address(owner[uint256(stor4[address(msg.sender)])].field_256), address(owner[stor2.length].field_256), ext_call.return_data[32]);
        if address(proxies[ext_call.return_data[32]].field_0) != 0:
            call address(proxies[ext_call.return_data[32]].field_0).emitTransfer(address rg1, address rg2, uint256 rg3) with:
                 gas gas_remaining - 25050 wei
                args address(owner[uint256(stor4[address(msg.sender)])].field_256), address(owner[stor2.length].field_256), arg2
        ...
        if uint256(holderId[address(msg.sender)]) != uint256(holderId[address(msg.sender)]):
            uint256(allowance[ext_call.return_data[32]][5][uint256(stor4[address(msg.sender)])][1][uint256(stor4[address(msg.sender)])].field_0) -= arg2
        emit 0x36a027e2: arg2, Array(len=arg3.length, data=arg3[all]), address(owner[uint256(stor4[address(msg.sender)])].field_256), address(owner[stor2.length].field_256), arg1
    return 1
}
...
function proxyApprove(address arg1, uint256 arg2, bytes32 arg3) payable {
    ...
    if uint256(holderId[address(arg1)]) != 0:
        if uint256(holderId[tx.origin]) != 0:
            if uint8(stor1[('map', ('param', 'arg3'), ('name', 'holderId', 4))]):
                return 0
