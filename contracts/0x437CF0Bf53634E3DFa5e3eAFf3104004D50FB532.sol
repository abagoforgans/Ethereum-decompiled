...
function _fallback() payable {
    ...
    stor7 = 4
    stor10 = 30000 * 10^18
    stor11 = 0x2dd016668bd409b7e1988dfddc08388e448f1e90
    stor12 = 0xdce5999988a40af0f9e6b73eaf9d5a1dc01a24e9
    require not msg.value
    stor13 = msg.sender
    stor8 = block.timestamp
    stor9 = block.timestamp + (1008 * 24 * 3600)
    stor1[stor12] += 62500000 * 3600
    stor1[stor13] += 62500000 * 3600
    stor1[stor13] += 105 * 10^10
    return code.data[569 len 8459]
}
...
function _fallback() payable {
    ...
    if etherRaised < 3500 * 10^18:
        ...
        require (43792000 * msg.value / 10^18) + balanceOf[msg.sender] >= balanceOf[msg.sender]
        balanceOf[address(msg.sender)] = (43792000 * msg.value / 10^18) + balanceOf[msg.sender]
        ...
        if etherRaised < 8500 * 10^18:
            ...
            require (39100000 * msg.value / 10^18) + balanceOf[msg.sender] >= balanceOf[msg.sender]
            balanceOf[address(msg.sender)] = (39100000 * msg.value / 10^18) + balanceOf[msg.sender]
            ...
            if etherRaised < 14000 * 10^18:
                ...
                require (35972000 * msg.value / 10^18) + balanceOf[msg.sender] >= balanceOf[msg.sender]
                balanceOf[address(msg.sender)] = (35972000 * msg.value / 10^18) + balanceOf[msg.sender]
                ...
                if etherRaised >= 20000 * 10^18:
                    ...
                    require (31280000 * msg.value / 10^18) + balanceOf[msg.sender] >= balanceOf[msg.sender]
                    balanceOf[address(msg.sender)] = (31280000 * msg.value / 10^18) + balanceOf[msg.sender]
                    ...
                    require (32844000 * msg.value / 10^18) + balanceOf[msg.sender] >= balanceOf[msg.sender]
                    balanceOf[address(msg.sender)] = (32844000 * msg.value / 10^18) + balanceOf[msg.sender]
