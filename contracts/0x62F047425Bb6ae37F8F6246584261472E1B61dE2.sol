...
function getBNTBalance(address arg1) {
    ...
    call bntAddress.balanceOf(address rg1) with:
         gas gas_remaining - 710 wei
        args arg1
    require ext_call.success
...
function getETHBalance(address arg1) {
    require ext_code.size(address(etherTokenAddress))
    call address(etherTokenAddress).balanceOf(address rg1) with:
         gas gas_remaining - 710 wei
        args arg1
    require ext_call.success
    return ext_call.return_data[0]
...
function moo() {
    ...
    call tokenChangerAddress.change(address rg1, address rg2, uint256 rg3, uint256 rg4) with:
         gas gas_remaining - 710 wei
        args 0, uint32(stor4), address(etherTokenAddress), 877843110001289470, 1
    require ext_call.success
}
...
function closeLong() {
    ...
    call bntAddress.approve(address rg1, uint256 rg2) with:
         gas gas_remaining - 710 wei
        args tokenChangerAddress, ext_call.return_data[0] / 100
    require ext_call.success
    require ext_call.return_data[0]
    require ext_code.size(tokenChangerAddress)
    call tokenChangerAddress.change(address rg1, address rg2, uint256 rg3, uint256 rg4) with:
         gas gas_remaining - 710 wei
        args 0, uint32(stor4), address(etherTokenAddress), ext_call.return_data[0] / 100, 1
    require ext_call.success
    emit LongClosed(ext_call.return_data[0], msg.sender);
    return ext_call.return_data[0]
}
