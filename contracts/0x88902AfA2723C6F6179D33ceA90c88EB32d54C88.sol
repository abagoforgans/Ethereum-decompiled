...
function getMonth(uint256 arg1) {
    ...
    if var28003 > arg1:
        if not var28002 - 1 % 4:
            if uint16(uint16(var28002 - 1) % 100):
                var28002 = var28002 - 1
                var28003 = var28003 - (8784 * 24 * 3600)
                continue 
            if not uint16(uint16(var28002 - 1) % 400):
                var28002 = var28002 - 1
                var28003 = var28003 - (8784 * 24 * 3600)
                continue 
        var28002 = var28002 - 1
        var28003 = var28003 - (8760 * 24 * 3600)
        continue 
    mem[96] = uint16(var28002)
    s = 0
    idx = 1
    s = (24 * 3600 * uint16(var28002) - 1 / 4) + (-86400 * uint16(var28002) - 1 / 100) + (24 * 3600 * uint16(var28002) - 1 / 400) + (8760 * 24 * 3600 * uint16(uint16(var28002) - 1970)) - (11448 * 24 * 3600)
    while uint8(idx) <= 12:
        if uint8(idx) == 1:
            if s + (744 * 24 * 3600) <= arg1:
                s = 744 * 24 * 3600
                idx = idx + 1
                s = s + (744 * 24 * 3600)
                continue 
            ...
            if uint8(idx) == 1:
                var72001 = 0 == 1
                var72003 = uint16(var28002)
                var72004 = uint8(idx)
                var72007 = var72007 + 1
                var72009 = var72009 + (24 * 3600)
                continue 
            var71001 = 0 == 1
            var71003 = uint16(var28002)
            var71004 = uint8(idx)
            var71007 = var72007 + 1
            var71009 = var72009 + (24 * 3600)
            continue 
        ...
        if uint8(idx) == 4:
            ...
            if uint8(idx) == 1:
                var82001 = 0 == 1
                var82003 = uint16(var28002)
                var82004 = uint8(idx)
                var82007 = var82007 + 1
                var82009 = var82009 + (24 * 3600)
                continue 
            var81001 = 0 == 1
            var81003 = uint16(var28002)
            var81004 = uint8(idx)
            var81007 = var82007 + 1
            var81009 = var82009 + (24 * 3600)
            continue 
        ...
        if var28002 % 4:
            ...
            if uint8(idx) == 1:
                var91001 = 0 == 1
                var91003 = uint16(var28002)
                var91004 = uint8(idx)
                var91007 = var91007 + 1
                var91009 = var91009 + (24 * 3600)
                continue 
            var90001 = 0 == 1
            var90003 = uint16(var28002)
            var90004 = uint8(idx)
            var90007 = var91007 + 1
            var90009 = var91009 + (24 * 3600)
            continue 
        if uint16(uint16(var28002) % 100):
            if s + (696 * 24 * 3600) <= arg1:
                s = 696 * 24 * 3600
                idx = idx + 1
                s = s + (696 * 24 * 3600)
                continue 
            ...
            if uint8(idx) == 1:
                var93001 = 0 == 1
                var93003 = uint16(var28002)
                var93004 = uint8(idx)
                var93007 = var93007 + 1
                var93009 = var93009 + (24 * 3600)
                continue 
            var92001 = 0 == 1
            var92003 = uint16(var28002)
            var92004 = uint8(idx)
            var92007 = var93007 + 1
            var92009 = var93009 + (24 * 3600)
            continue 
        if not uint16(uint16(var28002) % 400):
            if s + (696 * 24 * 3600) <= arg1:
                s = 696 * 24 * 3600
                idx = idx + 1
                s = s + (696 * 24 * 3600)
        ...
        if uint8(idx) == 1:
            var95001 = 0 == 1
            var95003 = uint16(var28002)
            var95004 = uint8(idx)
            var95007 = var95007 + 1
            var95009 = var95009 + (24 * 3600)
            continue 
        var94001 = 0 == 1
        var94003 = uint16(var28002)
        var94004 = uint8(idx)
        var94007 = var95007 + 1
        var94009 = var95009 + (24 * 3600)
        continue 
    ...
    if mem[159 len 1] == 1:
        var60001 = mem[159 len 1] == 1
        var60003 = uint16(var28002)
        var60004 = mem[128]
        var60007 = var60007 + 1
        var60009 = var60009 + (24 * 3600)
        continue 
    var59001 = mem[159 len 1] == 1
    var59003 = uint16(var28002)
    var59004 = mem[128]
    var59007 = var60007 + 1
    var59009 = var60009 + (24 * 3600)
    continue 
