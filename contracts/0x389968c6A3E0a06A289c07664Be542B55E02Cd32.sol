...
function sub_d4cf9655(?) {
    ...
    mem[(64 * arg7.length) + (64 * arg5.length) + (64 * arg4.length) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + floor32((32 * arg7.length) + (32 * arg5.length) + (32 * arg4.length) + 72) + -((32 * arg7.length) + (32 * arg5.length) + (32 * arg4.length) + 72 % 32) + 424 len (32 * arg7.length) + (32 * arg5.length) + (32 * arg4.length) + 72 % 32] = mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + (32 * arg5.length) + (32 * arg7.length) + -((32 * arg7.length) + (32 * arg5.length) + (32 * arg4.length) + 72 % 32) + floor32((32 * arg7.length) + (32 * arg5.length) + (32 * arg4.length) + 72) + 352 len (32 * arg7.length) + (32 * arg5.length) + (32 * arg4.length) + 72 % 32]
    _503 = sha3(mem[(64 * arg7.length) + (64 * arg5.length) + (64 * arg4.length) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 392 len (32 * arg7.length) + (32 * arg5.length) + (160 * arg4.length) + 72])
    ...
    if stor2[address(signer)]:
        ...
        mem[(64 * arg7.length) + (64 * arg5.length) + (64 * arg4.length) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 488] = (129 * arg5.length) + 60
        mem[64] = (64 * arg7.length) + (64 * arg5.length) + (64 * arg4.length) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 580
        mem[(64 * arg7.length) + (64 * arg5.length) + (64 * arg4.length) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 580 len floor32((129 * arg5.length) + 60)] = mem[(64 * arg7.length) + (64 * arg5.length) + (64 * arg4.length) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 520 len 4], Mask(192, 32, '\x19Ethereum Signed Message:\n32') >> 32, mem[(64 * arg7.length) + (64 * arg5.length) + (64 * arg4.length) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 548 len floor32((129 * arg5.length) + 60) - 28]
        mem[(64 * arg7.length) + (64 * arg5.length) + (64 * arg4.length) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + floor32((129 * arg5.length) + 60) + -((129 * arg5.length) + 60 % 32) + 612 len (129 * arg5.length) + 60 % 32] = mem[(64 * arg7.length) + (64 * arg5.length) + (64 * arg4.length) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + floor32((129 * arg5.length) + 60) + -((129 * arg5.length) + 60 % 32) + 552 len (129 * arg5.length) + 60 % 32]
        _715 = sha3(mem[(64 * arg7.length) + (64 * arg5.length) + (64 * arg4.length) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 580 len (129 * arg5.length) + 60])
        s = 0
        idx = 0
        s = 0
        while idx < threshold:
