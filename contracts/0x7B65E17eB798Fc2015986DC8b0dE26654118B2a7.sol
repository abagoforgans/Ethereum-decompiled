...
function _fallback() {
    stor0 = msg.sender
    stor1 = code.data[3333 len 20]
    stor2 = code.data[3365 len 20]
    stor3 = code.data[3385 len 32]
    stor4 = code.data[3417 len 32]
    stor5 = code.data[3449 len 32]
    uint8(stor6.field_0) = uint8(bool(code.data[3481 len 32]))
    Mask(248, 0, stor6.field_8) = Mask(248, 0, bool(code.data[3513 len 32]))
    Mask(240, 0, stor6.field_16) = Mask(240, 16, bool(code.data[3481 len 32])) >> 16
    emit ActivatedEvent(bool(uint8(bool(code.data[3481 len 32]))), bool(uint8(bool(code.data[3513 len 32]))));
    require stor0 == msg.sender
    emit OwnershipTransferred(stor0, address(code.data[3321 len 32]));
    stor0 = address(code.data[3321 len 32])
    return code.data[447 len 2874]
}
