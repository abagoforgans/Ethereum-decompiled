...
function sub_211445e9(?) payable {
    ...
    mem[ceil32(arg1.length) + 352 len 222] = code.data[2815 len 222]
    idx = 0
    s = 0
...
function sub_43779ffb(?) payable {
    ...
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 320 len 222] = code.data[2815 len 222]
    idx = 0
    s = 0
    while idx < arg1.length:
        require idx < arg1.length
