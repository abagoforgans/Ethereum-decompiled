...
function addShareholder(address arg1, uint256 arg2) payable {
    ...
    sub_690b90a9[0][sub_690b90a9[0].field_1024].field_512 = 1
...
function sub_a3934658(?) payable {
    ...
    s = 0
    idx = 0
    while idx < sub_690b90a9[0].field_1536:
        mem[32] = sha3(idx, sha3(0, 1) + 1)
...
function payDividends(uint256 arg1) payable {
    ...
    s = 0
    idx = 0
    while idx < sub_690b90a9[0].field_1024:
        mem[0] = idx
        mem[32] = sha3(0, 1)
