...
function _fallback() {
    ...
    stor0.length.field_8 = 'Ripplecash' / 256
    idx = 0
    ...
    stor1.length.field_8 = 'XRPC' / 256
    idx = 0
    while stor1.length + 31 / 32 > idx:
        stor1[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[442 len 3078]
}
...
const _myTokeName = 'Ripplecash'

const _mySymbol = 'XRPC'

const _myinitialSupply = 10^10
