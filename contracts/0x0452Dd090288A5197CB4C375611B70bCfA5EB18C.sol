            ...
            while idx >= sub_5092d279[msg.sender]:
                if not sub_28adf836[idx]:
                    ...
                    if s + 1 <= 80:
                        ...
                        continue 
                    sub_5092d279[msg.sender] = sub_5acf7c6b
                    require msg.value + (balanceOf[msg.sender] * sub_28adf836[idx]) >= balanceOf[msg.sender] * sub_28adf836[idx]
                    if msg.value + (balanceOf[msg.sender] * sub_28adf836[idx]):
                        call msg.sender with:
                           value msg.value + (balanceOf[msg.sender] * sub_28adf836[idx]) wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
        sub_5092d279[msg.sender] = sub_5acf7c6b
