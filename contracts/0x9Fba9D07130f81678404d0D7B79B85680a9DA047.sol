...
function _fallback() {
    stor3 = msg.sender
    stor1[address(msg.sender)] = code.data[3161 len 32]
    stor0 = code.data[3161 len 32]
    emit Transfer(code.data[3161 len 32], 0, msg.sender);
    stor6 = msg.sender
    require stor3 == msg.sender
    if code.data[3205 len 20]:
