...
function _fallback() payable {
    ...
    stor5[address(msg.sender)] = 28000000 * 10^18
    stor4 = 28000000 * 10^18
    bool(stor0.length) = 0
    stor0.length.field_1 = 15
    stor0.length.field_8 = 'Schmeckle Token' / 256
    idx = 0
    ...
    stor2.length.field_8 = 'SHM' / 256
    idx = 0
    while stor2.length + 31 / 32 > idx:
        stor2[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[473 len 2614]
}
