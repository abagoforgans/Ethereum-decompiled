...
uint256 stor6;
uint256 len;
uint256 sub_79d3202e;
uint256 sub_36f47779;
...
function sub_09c05eb5(?) payable {
    ...
    while idx < arg1.length:
        _5 = mem[64]
        mem[64] = mem[64] + 192
        mem[_5 len 192] = call.data[arg1 + (192 * idx) + 36 len 192]
        mem[s] = _5
        s = s + 32
        idx = idx + 1
        continue 
...
function sub_d44b75ff(?) payable {
    ...
    while idx < arg1.length:
        _43 = mem[64]
        mem[64] = mem[64] + 192
        mem[_43 len 192] = call.data[arg1 + (192 * idx) + 36 len 192]
        mem[s] = _43
        s = s + 32
        idx = idx + 1
        continue 
