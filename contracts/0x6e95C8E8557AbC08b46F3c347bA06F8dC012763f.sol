...
const _fallback = code.data[30 len 11183]
...
function create(address[] arg1, uint256 arg2, uint256 arg3) {
    mem[(32 * arg1.length) + 10006 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
    create contract with 0 wei
                    code: code.data[1390 len 9750], Array(len=arg3, data=arg1.length, call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + floor32(arg1.length) + 10006 len (32 * arg1.length) - floor32(arg1.length)]), arg2
