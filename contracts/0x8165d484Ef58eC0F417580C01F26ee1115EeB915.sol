...
function _fallback() payable {
    ...
    stor4 = code.data[8681 len 20]
    stor0 = code.data[8701 len 32]
    stor1[address(msg.sender)] = code.data[8701 len 32]
    emit Transfer(code.data[8701 len 32], 0, msg.sender);
    return code.data[430 len 8239]
}
