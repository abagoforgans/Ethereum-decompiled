...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'DashBlack' / 256
    idx = 0
    ...
    stor4.length.field_8 = 'DASHB' / 256
    idx = 0
    ...
    stor1 = msg.sender
    stor6 = 5250 * 10^18 * 24 * 3600
    stor7[address(msg.sender)] = 5250 * 10^18 * 24 * 3600
    emit Transfer((5250 * 10^18 * 24 * 3600), 0, msg.sender);
    return code.data[463 len 2496]
}
