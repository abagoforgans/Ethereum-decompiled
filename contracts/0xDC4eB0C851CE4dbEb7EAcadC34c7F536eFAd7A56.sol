...
function buyTokens(address arg1) payable {
    ...
    if block.timestamp >= 433872 * 24 * 3600:
        if not msg.value:
            ...
            weiRaised += msg.value
            require ext_code.size(tokenAddress) > 0
            mem[196 len 64] = unknown_0xa9059cbb(?????), address(arg1) << 64, 0, Mask(224, 32, 5000 * msg.value) >> 32
            call tokenAddress with:
                 gas gas_remaining wei
        ...
        if not msg.value:
            ...
            weiRaised += msg.value
            require ext_code.size(tokenAddress) > 0
            mem[196 len 64] = unknown_0xa9059cbb(?????), address(arg1) << 64, 0, Mask(224, 32, 6666 * msg.value) >> 32
            call tokenAddress with:
                 gas gas_remaining wei
...
function _fallback() payable {
    ...
    if block.timestamp >= 433872 * 24 * 3600:
        if not msg.value:
            ...
            weiRaised += msg.value
            require ext_code.size(tokenAddress) > 0
            mem[196 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 5000 * msg.value) >> 32
            call tokenAddress with:
               funct uint32(msg.sender)
                 gas gas_remaining wei
                args Mask(224, 32, 5000 * msg.value) << 224, mem[260 len 4]
        ...
        if not msg.value:
            ...
            weiRaised += msg.value
            require ext_code.size(tokenAddress) > 0
            mem[196 len 64] = unknown_0xa9059cbb(?????), msg.sender, Mask(224, 32, 6666 * msg.value) >> 32
            call tokenAddress with:
               funct uint32(msg.sender)
                 gas gas_remaining wei
                args Mask(224, 32, 6666 * msg.value) << 224, mem[260 len 4]
