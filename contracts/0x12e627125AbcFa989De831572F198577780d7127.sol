...
const _fallback = code.data[25 len 8501]
...
function CreateProxyWithControllerAndRecovery(address arg1, address[] arg2, uint256 arg3, uint256 arg4) {
    ...
    create contract with 0 wei
                    code: code.data[817 len 898]
    require create.new_address
    create contract with 0 wei
                    code: code.data[1715 len 2579], address(create.new_address), address(arg1), arg3, arg4
    require ext_code.size(address(create.new_address))
    call address(create.new_address).transfer(address rg1) with:
         gas gas_remaining - 50 wei
        args address(create.new_address)
    require ext_call.success
    mem[(32 * arg2.length) + 128 len 4164] = code.data[4294 len 4164]
    ...
    create contract with 0 wei
                    code: code.data[4294 len 4164], address(create.new_address), 64, arg2.length, mem[(32 * arg2.length) + 4388 len 32 * arg2.length]
    require create.new_address
    require ext_code.size(address(create.new_address))
