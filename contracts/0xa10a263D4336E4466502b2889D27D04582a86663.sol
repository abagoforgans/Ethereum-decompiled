...
function contractsLength() payable {
...
function sub_e814861e(?) payable {
    return (sub_874c3473[address(arg1)] > 0)
}
...
function sub_028f4e47(?) payable {
    require arg1 != 0
    require address(contract[arg1]) != arg2
    if address(masterAccount) != msg.sender:
        require msg.sender == address(contract[arg1])
    require sub_874c3473[address(arg2)] <= 0
    sub_874c3473[address(stor1[arg1])] = 0
