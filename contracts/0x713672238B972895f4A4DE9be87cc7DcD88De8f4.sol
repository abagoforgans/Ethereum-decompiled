...
function _fallback() payable {
    ...
    stor4.length.field_8 = 'DR80 Token' / 256
    idx = 0
...
const START_DATE = (416117 * 3600)

const TOKENS_SOFT_CAP = 13000000 * 10^18

const END_DATE = (416119 * 3600)

const TOKENS_HARD_CAP = 30000000 * 10^18

const DECIMALSFACTOR = 10^18

const LOCKED_2Y_DATE = (416127 * 3600)

const NAME = 'DR80 Token'

const LOCKED_1Y_DATE = (416126 * 3600)
...
function setTokensPerKEther(uint256 arg1) {
    require owner == msg.sender
    require block.timestamp < 416117 * 3600
    require arg1 > 0
...
function finalise() {
    ...
    if totalSupply < 13000000 * 10^18:
        require block.timestamp > 416119 * 3600
