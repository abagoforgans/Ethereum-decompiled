...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'Adamant' / 256
    idx = 0
    ...
    stor3[code.data[5433 len 20]] = 1000000000 * 10^18
    emit Transfer(1000000000 * 10^18, 0, code.data[5433 len 20]);
    return code.data[760 len 4661]
}
