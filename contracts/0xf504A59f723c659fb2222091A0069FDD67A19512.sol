...
const name = Array(len=48, data='Class B Common - Inveniam Capita', 'l Partners (ICP)', Mask(128, -256, 'Class B Common - Inveniam Capita', 'l Partners (ICP)') << 256)
