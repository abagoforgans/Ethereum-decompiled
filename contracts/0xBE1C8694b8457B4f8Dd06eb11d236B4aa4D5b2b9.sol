...
function _fallback() payable {
    mem[96 len -2601] = code.data[3119 len -2601]
    mem[64] = -2505
...
function sell(uint256 arg1) payable {
    sub_bc094049 = 10^14 * eth.balance(this.address) / totalSupply
...
function buy() payable {
    ...
    sub_bc094049 = 10^13 * eth.balance(this.address) / totalSupply
    idx = 0
    s = 0
    while idx < 10:
        mem[96] = block.hash(block.number + -idx - 1)
