...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 2000000000 * 10^18
    emit Transfer(2000000000 * 10^18, 0, msg.sender);
    return code.data[353 len 2048]
}
...
const name = 'REFERPAYToken'

const totalSupply = 2000000000 * 10^18

const total = 2000000000 * 10^18
...
function airdropToAddresses(address[] arg1, uint256 arg2) {
    ...
    while idx < arg1.length:
        ...
        require arg2 + balanceOf[mem[(32 * idx) + 140 len 20]] >= arg2
