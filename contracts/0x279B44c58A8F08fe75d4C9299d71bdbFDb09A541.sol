    ...
    if not stor6.length > stor6.length + 1:
        ...
        if not stor7.length <= stor7.length + 1:
            if stor7.length + 1 / 2 > stor7.length + 2 / 2:
                ...
                idx = (stor7.length + 2 / 2) + 1
                while stor7.length + 1 / 2 > idx:
                    uint256(stor7[idx].field_0) = 0
                    idx = idx + 1
                    continue 
    else:
        if stor6.length + 1 / 2 > stor6.length + 2 / 2:
            uint256(stor6[0.5 / stor6.length + 2].field_0) = 0
            idx = (stor6.length + 2 / 2) + 1
...
function init() {
    ...
    idx = 96
    while 256 > idx:
        uint256(stor6.field_0) = mem[idx + 24 len 8] * 256^s or !(test266151307() * 256^s) and uint256(stor6.field_0)
