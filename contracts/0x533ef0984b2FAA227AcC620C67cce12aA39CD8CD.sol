...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'XGM token v1.0' / 256
    idx = 0
    ...
    stor4.length.field_8 = 'XaurumGamma' / 256
    idx = 0
    ...
    stor6 = 8
    stor2 = 4352535
    emit ContractLocked(4352535, 'Lock before distribution');
    return code.data[810 len 6876]
}
