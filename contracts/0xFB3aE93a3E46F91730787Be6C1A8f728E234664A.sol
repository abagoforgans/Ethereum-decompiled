...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'OBO COIN' / 256
    idx = 0
    ...
    mem[224 len -2260] = code.data[2740 len -2260]
    stor3 = 14 * 10^11
    stor4[address(msg.sender)] = 14 * 10^11
