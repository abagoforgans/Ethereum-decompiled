...
function _fallback() {
    ...
    stor0 = code.data[3236 len 20]
    address(stor1.field_0) = code.data[3268 len 20]
    stor2 = 0
    stor4 = 0
    return code.data[304 len 2920]
}
...
function Contribute(bytes24 arg1) payable {
    require accept
    hash = sha256hash(Mask(160, 96, arg1) >> 96) 
    require sha256hash.result
    hash = sha256hash(hash) 
    require Mask(32, 224, hash) == Mask(32, 64, arg1) << 160
