...
function __callback(bytes32 arg1, string arg2, bytes arg3) payable {
    ...
    mem[ceil32(arg2.length) + ceil32(arg3.length) + 160] = 7
    mem[ceil32(arg2.length) + ceil32(arg3.length) + 192] = 'DEVCON1' << 200
    call 0x1d11e5eae3112dbd44f99266872ff1d07c77dce8.getAddress() with:
         gas gas_remaining - 25050 wei
    require ext_call.success
    uint256(stor3) = ext_call.return_data[0] or Mask(96, 160, uint256(stor3))
    ...
    if arg1 != stor4:
        if arg1 == stor5:
            ...
            call address(stor3).getPrice(string rg1) with:
                 gas gas_remaining - 25050 wei
                args Array(len=3, data=mem[ceil32(arg2.length) + ceil32(arg3.length) + 580])
            require ext_call.success
            mem[ceil32(arg2.length) + ceil32(arg3.length) + 644] = mem[ceil32(arg2.length) + ceil32(arg3.length) + 673 len 3]
            mem[ceil32(arg2.length) + ceil32(arg3.length) + 804] = mem[ceil32(arg2.length) + ceil32(arg3.length) + 822 len 14]
            call address(stor3).query(uint256 rg1, string rg2, string rg3) with:
               value ext_call.return_data[0] wei
                 gas gas_remaining - 34050 wei
                args 60, 96, 160, 3, mem[ceil32(arg2.length) + ceil32(arg3.length) + 644], 110, 'json(                 https://ap', 'i.kraken.com/0/public/Ticker?pai', 'r=ETHXBT                 ).resul', 't.XETHXXBT.c.0' >> 512, mem[ceil32(arg2.length) + ceil32(arg3.length) + 804]
            require ext_call.success
            stor4 = ext_call.return_data[0]
    else:
        mem[64] = ceil32(arg2.length) + ceil32(arg3.length) + 256
        ...
        if s >= 3000:
            if arg1 == stor5:
                mem[64] = ceil32(arg2.length) + ceil32(arg3.length) + 288
                ...
                require ext_call.success
                uint256(stor3) = ext_call.return_data[0] or Mask(96, 160, uint256(stor3))
                mem[ceil32(arg2.length) + ceil32(arg3.length) + 612] = mem[ceil32(arg2.length) + ceil32(arg3.length) + 641 len 3]
                call address(stor3).getPrice(string rg1) with:
                     gas gas_remaining - 25050 wei
                    args Array(len=3, data=mem[ceil32(arg2.length) + ceil32(arg3.length) + 612])
                require ext_call.success
                mem[ceil32(arg2.length) + ceil32(arg3.length) + 676] = mem[ceil32(arg2.length) + ceil32(arg3.length) + 705 len 3]
                mem[ceil32(arg2.length) + ceil32(arg3.length) + 836] = mem[ceil32(arg2.length) + ceil32(arg3.length) + 854 len 14]
                call address(stor3).query(uint256 rg1, string rg2, string rg3) with:
                   value ext_call.return_data[0] wei
                     gas gas_remaining - 34050 wei
                    args 60, 96, 160, 3, mem[ceil32(arg2.length) + ceil32(arg3.length) + 676], 110, 'json(                 https://ap', 'i.kraken.com/0/public/Ticker?pai', 'r=ETHXBT                 ).resul', 't.XETHXXBT.c.0' >> 512, mem[ceil32(arg2.length) + ceil32(arg3.length) + 836]
                require ext_call.success
                stor4 = ext_call.return_data[0]
        else:
            call 0x1d11e5eae3112dbd44f99266872ff1d07c77dce8.getAddress() with:
            ...
            call address(stor3).getPrice(string rg1) with:
                ...
                args Array(len=3, data=mem[ceil32(arg2.length) + ceil32(arg3.length) + 612])
            require ext_call.success
            mem[ceil32(arg2.length) + ceil32(arg3.length) + 708] = mem[ceil32(arg2.length) + ceil32(arg3.length) + 737 len 3]
            mem[ceil32(arg2.length) + ceil32(arg3.length) + 804] = 0, mem[ceil32(arg2.length) + ceil32(arg3.length) + 826 len 10]
            mem[ceil32(arg2.length) + ceil32(arg3.length) + 932] = 0, mem[ceil32(arg2.length) + ceil32(arg3.length) + 963 len 1]
            call address(stor3).query2(uint256 rg1, string rg2, string rg3, string rg4) with:
               value ext_call.return_data[0] wei
                 gas gas_remaining - 34050 wei
                args 0, 128, 192, 288, 3, mem[ceil32(arg2.length) + ceil32(arg3.length) + 708], 54, 'json(https://shapeshift.io/senda', 'mount).success.deposit', mem[ceil32(arg2.length) + ceil32(arg3.length) + 804], 95, '{"pair": "eth_btc", "amount": "0', '.2", "withdrawal":        "1AAcC', 'o21EUc1jbocjssSQDzLna9Vem2UN5"}' >> 256, mem[ceil32(arg2.length) + ceil32(arg3.length) + 932]
            require ext_call.success
