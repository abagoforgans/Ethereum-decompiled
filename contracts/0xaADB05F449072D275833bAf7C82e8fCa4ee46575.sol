...
function _fallback() payable {
    ...
    stor0 = msg.sender
    address(stor11.field_8) = address(code.data[10500 len 32])
    bool(stor1.length) = 0
    stor1.length.field_1 = 21
    stor1.length.field_8 = 'Spectre Utility Token' / 256
    idx = 0
...
address spectreTeamAddress;
address managementLockedAddress;
uint8 stor16; offset 160
address optionPoolAddress;
uint256 SPECTRE_BOUNTY_ADVISORY_DEV_TEAM_ALLOC;
uint256 MANAGEMENT_LOCKED_ALLOC;
uint256 OPTION_POOL_ALLOC;
uint256 LOCK_START_TIME;
uint256 MANAGEMENT_LOCKED_PERIOD;
uint256 OPTION_POOL_PERIOD;
...
function OPTION_POOL_PERIOD() {
    return OPTION_POOL_PERIOD
}

function tokenBurner() {
    return tokenBurnerAddress
}
...
function MANAGEMENT_LOCKED_ALLOC() {
    return MANAGEMENT_LOCKED_ALLOC
}

function spectreTeam() {
    return spectreTeamAddress
}
...
function OPTION_POOL_ALLOC() {
    return OPTION_POOL_ALLOC
}
...
function MANAGEMENT_LOCKED_PERIOD() {
    return MANAGEMENT_LOCKED_PERIOD
}
...
function managementLocked() {
    return managementLockedAddress
}

function SPECTRE_BOUNTY_ADVISORY_DEV_TEAM_ALLOC() {
    return SPECTRE_BOUNTY_ADVISORY_DEV_TEAM_ALLOC
}
...
function setTokenBurner(address arg1) {
    require owner == msg.sender
    tokenBurnerAddress = arg1
}
...
function setWalletAddresses(address arg1, address arg2, address arg3) {
    require owner == msg.sender
    require not stor16
    require arg1
    require arg2
    require arg3
    spectreTeamAddress = arg1
    managementLockedAddress = arg2
    optionPoolAddress = arg3
    stor16 = 1
    emit WalletAddressesSet(address rg1, address rg2, address rg3):
                            address(arg1),
                            address(arg2),
                            0,
                            arg3,
...
function checkLockedBalance(address arg1, uint256 arg2) {
    if managementLockedAddress == arg1:
        if block.timestamp > MANAGEMENT_LOCKED_PERIOD:
            return 1
    else:
        if optionPoolAddress != arg1:
            return 1
        if managementLockedAddress == arg1:
            if block.timestamp > MANAGEMENT_LOCKED_PERIOD:
                return 1
    if optionPoolAddress == arg1:
        if block.timestamp > OPTION_POOL_PERIOD:
            return 1
    if not stor8[address(arg1)].field_0:
        if not parentTokenAddress:
            if arg2 <= 0:
                return -arg2 >= lockedBalances[address(arg1)]
        else:
            require ext_code.size(parentTokenAddress)
            if block.number < parentSnapShotBlock:
                call parentTokenAddress.0x4ee2cd7e with:
            ...
            if arg2 <= ext_call.return_data[0]:
                return ext_call.return_data[0] - arg2 >= lockedBalances[address(arg1)]
    else:
        if 0 < stor8[address(arg1)].field_0:
            if stor8[address(arg1)].field_0 > block.number:
                if not parentTokenAddress:
                ...
                if 0 == stor8[address(arg1)].field_0:
                    ...
                    if stor8[address(arg1)].field_0 - 1 < stor8[address(arg1)].field_0:
                        if block.number >= stor8[address(arg1)][stor8[address(arg1)].field_0].field_0:
                            if stor8[address(arg1)].field_0 - 1 < stor8[address(arg1)].field_0:
                                if arg2 <= stor8[address(arg1)][stor8[address(arg1)].field_0].field_0:
                                    return stor8[address(arg1)][stor8[address(arg1)].field_0].field_0 - arg2 >= lockedBalances[address(arg1)]
                        else:
                            if 0 < stor8[address(arg1)].field_0:
                                if block.number < stor8[address(arg1)].field_0:
                                    if arg2 <= 0:
                                    ...
                                    while stor8[address(arg1)].field_0 - 1 > idx:
                                        ...
                                        continue 
                                    if idx < stor8[address(arg1)].field_0:
                                        if arg2 <= stor8[address(arg1)][idx].field_128:
                                            return stor8[address(arg1)][idx].field_128 - arg2 >= lockedBalances[address(arg1)]
    revert
}
