...
function _fallback() {
    ...
    stor6 = 10^16
    return code.data[296 len 10314]
}
            ...
            if ext_call.return_data[0] < arg10:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if (ext_call.return_data[0] * arg9 / 10^18) + arg9 <= sub_367a2624:
                        ...
                        sub_f9b5cbab = 10^18 * arg9 / ext_call.return_data[0] + 10^18 * 10^18 * arg2 / arg1 / 10^18
                        require ext_code.size(stor2)
                        call stor2.feeTake() with:
                             gas gas_remaining - 710 wei
                        require ext_call.success
                        require ext_call.return_data[0] + 10^18
                        cost = 10^18 * arg10 / ext_call.return_data[0] + 10^18
                        profit = sub_f9b5cbab - (10^18 * arg10 / ext_call.return_data[0] + 10^18)
                        if sub_f9b5cbab - (10^18 * arg10 / ext_call.return_data[0] + 10^18) < minProfit:
                        ...
                        require ext_call.success
                        require ext_call.return_data[0] + 10^18
                        sub_f9b5cbab = 10^18 * 10^18 * sub_367a2624 / ext_call.return_data[0] / ext_call.return_data[0] + 10^18 * 10^18 * arg2 / arg1 / 10^18
                        require ext_code.size(stor2)
                        call stor2.feeTake() with:
                             gas gas_remaining - 710 wei
                        require ext_call.success
                        require ext_call.return_data[0] + 10^18
                        cost = 10^18 * arg10 * 10^18 * 10^18 * sub_367a2624 / ext_call.return_data[0] / arg9 / 10^18 / ext_call.return_data[0] + 10^18
                        profit = sub_f9b5cbab - (10^18 * arg10 * 10^18 * 10^18 * sub_367a2624 / ext_call.return_data[0] / arg9 / 10^18 / ext_call.return_data[0] + 10^18)
                        if sub_f9b5cbab - (10^18 * arg10 * 10^18 * 10^18 * sub_367a2624 / ext_call.return_data[0] / arg9 / 10^18 / ext_call.return_data[0] + 10^18) < minProfit:
                            emit Result(Array(len=55, data='Order(s) already partially fille', 'd; profit below minimum'));
                        else:
                            require ext_code.size(stor2)
                            call stor2.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
            ...
            if ext_call.return_data[0] < sub_367a2624:
                ...
                if not ext_call.return_data[0]:
                    ...
                    if (ext_call.return_data[0] * arg9 * 10^18 * sub_367a2624 / arg10 / 10^18 / 10^18) + (arg9 * 10^18 * sub_367a2624 / arg10 / 10^18) <= sub_367a2624:
                        ...
                        require ext_call.success
                        require ext_call.return_data[0] + 10^18
                        sub_f9b5cbab = 10^18 * arg9 * 10^18 * sub_367a2624 / arg10 / 10^18 / ext_call.return_data[0] + 10^18 * 10^18 * arg2 / arg1 / 10^18
                        require ext_code.size(stor2)
                        call stor2.feeTake() with:
                             gas gas_remaining - 710 wei
                        require ext_call.success
                        require ext_call.return_data[0] + 10^18
                        cost = 10^18 * sub_367a2624 / ext_call.return_data[0] + 10^18
                        profit = sub_f9b5cbab - (10^18 * sub_367a2624 / ext_call.return_data[0] + 10^18)
                        if sub_f9b5cbab - (10^18 * sub_367a2624 / ext_call.return_data[0] + 10^18) < minProfit:
                            emit Result(Array(len=55, data='Order(s) already partially fille', 'd; profit below minimum'));
                        else:
                            require ext_code.size(stor2)
                            call stor2.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
                        ...
                        require ext_call.success
                        require ext_call.return_data[0] + 10^18
                        cost = 10^18 * sub_367a2624 * 10^18 * 10^18 * sub_367a2624 / ext_call.return_data[0] / arg9 * 10^18 * sub_367a2624 / arg10 / 10^18 / 10^18 / ext_call.return_data[0] + 10^18
                        profit = sub_f9b5cbab - (10^18 * sub_367a2624 * 10^18 * 10^18 * sub_367a2624 / ext_call.return_data[0] / arg9 * 10^18 * sub_367a2624 / arg10 / 10^18 / 10^18 / ext_call.return_data[0] + 10^18)
                        if sub_f9b5cbab - (10^18 * sub_367a2624 * 10^18 * 10^18 * sub_367a2624 / ext_call.return_data[0] / arg9 * 10^18 * sub_367a2624 / arg10 / 10^18 / 10^18 / ext_call.return_data[0] + 10^18) < minProfit:
                            emit Result(Array(len=55, data='Order(s) already partially fille', 'd; profit below minimum'));
                        else:
                            require ext_code.size(stor2)
                            call stor2.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
