...
function keys(uint256 arg1) payable {
    return stor[arg1 + code.data[5277 len 32]][0 len stor[arg1 + code.data[5277 len 32]].length]
}
...
function sub_6598a1ae(?) payable {
    ...
    if address(record[arg1[all]].field_0) == msg.sender:
        ...
        if 31 >= stor[stor4.length - 0x75ca53043ea007e5c65182cbb028f60d7179ff4b55739a3949b401801c942e66].length:
            stor[code.data[5277 len 32] + stor2[arg1[all]].field_512] = uint256(stor8A35[stor4.length])
            idx = 0
            while stor[code.data[5277 len 32] + stor2[arg1[all]].field_512].length + 31 / 32 > idx:
                stor[idx + sha3(code.data[5277 len 32] + stor2[arg1[all]].field_512)] = 0
                idx = idx + 1
                continue 
        else:
            stor[code.data[5277 len 32] + stor2[arg1[all]].field_512] = Mask(255, 1, (256 * not bool(stor8A35[stor4.length])) - 1 and uint256(stor8A35[stor4.length])) + 1
            if not Mask(255, 1, (256 * not bool(stor8A35[stor4.length])) - 1 and uint256(stor8A35[stor4.length])):
                ...
                while stor[stor4.length - 0x75ca53043ea007e5c65182cbb028f60d7179ff4b55739a3949b401801c942e66].length + 31 / 32 > idx:
                    stor[s + sha3(code.data[5277 len 32] + stor2[arg1[all]].field_512)] = stor[idx + sha3(stor4.length - 0x75ca53043ea007e5c65182cbb028f60d7179ff4b55739a3949b401801c942e66)]
                    s = s + 1
                    idx = idx + 1
                    continue 
                ...
                while stor[code.data[5277 len 32] + stor2[arg1[all]].field_512].length + 31 / 32 > idx:
                    ...
                    continue 
        require record[arg1[all]].field_512 < stor4.length
        mem[ceil32(arg1.length) + 128] = stor[sha3(code.data[5277 len 32] + stor2[arg1[all]].field_512)]
        idx = ceil32(arg1.length) + 128
        s = 0
        while ceil32(arg1.length) + stor[code.data[5277 len 32] + stor2[arg1[all]].field_512].length + 128 > idx + 32:
            mem[idx + 32] = stor[s + sha3(code.data[5277 len 32] + stor2[arg1[all]].field_512) + 1]
            idx = idx + 32
            s = s + 1
            continue 
        mem[ceil32(arg1.length) + stor[code.data[5277 len 32] + stor2[arg1[all]].field_512].length + 128] = 2
        record[sha3(mem[ceil32(arg1.length) + 128 len stor[code.data[5277 len 32] + record[arg1[all]].field_512].length + 32])].field_0 = record[arg1[all]].field_512
        stor4.length--
        if not stor4.length <= stor4.length - 1:
            mem[0] = 4
            idx = stor4.length - 1
