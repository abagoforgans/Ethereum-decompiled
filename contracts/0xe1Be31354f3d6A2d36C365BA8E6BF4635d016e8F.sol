...
function _fallback() payable {
    ...
    stor7[address(msg.sender)] = 10000000 * 10^18
    stor3 = 10000000 * 10^18
    bool(stor0.length) = 0
    stor0.length.field_1 = 8
    stor0.length.field_8 = 'CoinCoin' / 256
    idx = 0
...
function _fallback() payable {
    ...
    if msg.value:
        ...
        require ext_call.success
        totalSupply = (10^9 * msg.value * bonusRate / 100) + (10^9 * msg.value) + totalSupply
        balanceOf[address(msg.sender)] = (10^9 * msg.value * bonusRate / 100) + (10^9 * msg.value) + balanceOf[address(msg.sender)]
        totalContribution += msg.value
        emit Transfer(((10^9 * msg.value * bonusRate / 100) + (10^9 * msg.value)), this.address, msg.sender);
}
