...
function _fallback() payable {
    ...
    stor0 = 0x634f8c7c2ddd8671632624850c7c8f3e20622f5f
    stor1 = 0x3839d8ba312751aa0248fed6a8bacb84308e20ed
    stor3 = stor1
    return code.data[331 len 2995]
}
...
function _fallback() payable {
    ...
    weiRaised += msg.value
    if msg.value < 10^17:
        require contributions[address(msg.sender)] >= 10^17
    require contributions[address(msg.sender)] + msg.value >= contributions[address(msg.sender)]
    require contributions[address(msg.sender)] + msg.value <= 550 * 10^18
    require contributions[address(msg.sender)] + msg.value >= contributions[address(msg.sender)]
