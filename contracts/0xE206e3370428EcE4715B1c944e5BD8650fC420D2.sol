...
function transfer(address arg1, uint256 arg2) {
    if block.timestamp <= 1504543071:
        require totalEthers == 50000 * 10^18
...
function proxyPayment(address arg1) payable {
    ...
    require msg.value + totalEthers <= 50000 * 10^18
    require block.timestamp >= 1501173471
    if block.timestamp < 1501951071:
        ...
        require 8100 * msg.value / 7 >= 0
        require (8100 * msg.value / 7) + (2700 * msg.value) + totalSupply >= 8100 * msg.value / 7
        totalSupply = (8100 * msg.value / 7) + (2700 * msg.value) + totalSupply
        ...
        require (8100 * msg.value / 7) + balanceOf[stor5] >= balanceOf[stor5]
        require (8100 * msg.value / 7) + balanceOf[stor5] >= 8100 * msg.value / 7
        balanceOf[stor5] += 8100 * msg.value / 7
        emit TokensBought(msg.value, totalEthers, 2700 * msg.value, 8100 * msg.value / 7, totalSupply, 2700, arg1);
        emit Transfer((2700 * msg.value), 0, arg1);
        emit Transfer((8100 * msg.value / 7), 0, multisigAddress);
    else:
        if block.timestamp < 1502728671:
            ...
            require 2 * 3600 * msg.value / 7 >= 0
            require (2 * 3600 * msg.value / 7) + (2400 * msg.value) + totalSupply >= 2 * 3600 * msg.value / 7
            totalSupply = (2 * 3600 * msg.value / 7) + (2400 * msg.value) + totalSupply
            ...
            require (2 * 3600 * msg.value / 7) + balanceOf[stor5] >= balanceOf[stor5]
            require (2 * 3600 * msg.value / 7) + balanceOf[stor5] >= 2 * 3600 * msg.value / 7
            balanceOf[stor5] += 2 * 3600 * msg.value / 7
            emit TokensBought(msg.value, totalEthers, 2400 * msg.value, 2 * 3600 * msg.value / 7, totalSupply, 2400, arg1);
            emit Transfer((2400 * msg.value), 0, arg1);
            emit Transfer((2 * 3600 * msg.value / 7), 0, multisigAddress);
        else:
            if block.timestamp < 1503506271:
                ...
                require 6150 * msg.value / 7 >= 0
                require (6150 * msg.value / 7) + (2050 * msg.value) + totalSupply >= 6150 * msg.value / 7
                totalSupply = (6150 * msg.value / 7) + (2050 * msg.value) + totalSupply
                ...
                require (6150 * msg.value / 7) + balanceOf[stor5] >= balanceOf[stor5]
                require (6150 * msg.value / 7) + balanceOf[stor5] >= 6150 * msg.value / 7
                balanceOf[stor5] += 6150 * msg.value / 7
                emit TokensBought(msg.value, totalEthers, 2050 * msg.value, 6150 * msg.value / 7, totalSupply, 2050, arg1);
                emit Transfer((2050 * msg.value), 0, arg1);
                emit Transfer((6150 * msg.value / 7), 0, multisigAddress);
            else:
                require block.timestamp <= 1504543071
                ...
                require 4500 * msg.value / 7 >= 0
                require (4500 * msg.value / 7) + (1500 * msg.value) + totalSupply >= 4500 * msg.value / 7
                totalSupply = (4500 * msg.value / 7) + (1500 * msg.value) + totalSupply
                ...
                require (4500 * msg.value / 7) + balanceOf[stor5] >= balanceOf[stor5]
                require (4500 * msg.value / 7) + balanceOf[stor5] >= 4500 * msg.value / 7
...
function _fallback() payable {
    ...
    if block.timestamp < 1501951071:
        ...
        require (8100 * msg.value / 7) + balanceOf[stor5] >= 8100 * msg.value / 7
        balanceOf[stor5] += 8100 * msg.value / 7
        emit TokensBought(msg.value, totalEthers, 2700 * msg.value, 8100 * msg.value / 7, totalSupply, 2700, msg.sender);
        ...
        if block.timestamp < 1502728671:
            ...
            require (2 * 3600 * msg.value / 7) + balanceOf[stor5] >= 2 * 3600 * msg.value / 7
            balanceOf[stor5] += 2 * 3600 * msg.value / 7
            emit TokensBought(msg.value, totalEthers, 2400 * msg.value, 2 * 3600 * msg.value / 7, totalSupply, 2400, msg.sender);
            ...
            if block.timestamp < 1503506271:
                ...
                require (6150 * msg.value / 7) + balanceOf[stor5] >= 6150 * msg.value / 7
                balanceOf[stor5] += 6150 * msg.value / 7
                emit TokensBought(msg.value, totalEthers, 2050 * msg.value, 6150 * msg.value / 7, totalSupply, 2050, msg.sender);
