...
function sub_d2cfed96(?) {
    ...
    idx = 0
    while idx < 10:
        require stor1[idx] != arg5
        require idx < 10
        idx = idx + 1
        continue 
    require arg5 >= stor1.length
    require arg5 <= stor1.length + 10000
    stor1.length = arg5
...
function sendMultiSig(address arg1, uint256 arg2, bytes arg3, uint256 arg4, uint256 arg5, bytes arg6) {
    ...
    _54 = sha3('ETHER', arg1, arg2, call.data[arg3 + 36 len floor32(arg3.length)], mem[ceil32(arg3.length) + ceil32(arg6.length) + floor32(arg3.length) + 217 len (arg3.length % 32) + 32], arg5, None)
    require arg4 >= block.timestamp
    require 65 == arg6.length
    _58 = mem[ceil32(arg3.length) + 192]
    _59 = mem[ceil32(arg3.length) + 193]
    ...
    if mem[ceil32(arg3.length) + 224 len 1] >= 27:
        mem[ceil32(arg3.length) + ceil32(arg6.length) + 224] = uint8(_59)
        mem[ceil32(arg3.length) + ceil32(arg6.length) + 256] = mem[ceil32(arg3.length) + 160]
        mem[ceil32(arg3.length) + ceil32(arg6.length) + 288] = _58
        signer = erecover(_54, _59 << 248, mem[ceil32(arg3.length) + 160], _58) 
    else:
        mem[ceil32(arg3.length) + ceil32(arg6.length) + 224] = uint8(uint8(_59) + 27)
        mem[ceil32(arg3.length) + ceil32(arg6.length) + 256] = mem[ceil32(arg3.length) + 160]
        mem[ceil32(arg3.length) + ceil32(arg6.length) + 288] = _58
        signer = erecover(_54, uint8(_59) + 27 << 248, mem[ceil32(arg3.length) + 160], _58) 
    if not erecover.result:
        revert with ext_call.return_data[0 len return_data.size]
    require address(signer) != msg.sender
    require 0 < signers.length
    ...
    mem[ceil32(arg3.length) + ceil32(arg6.length) + 256] = _54
