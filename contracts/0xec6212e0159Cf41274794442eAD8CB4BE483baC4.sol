...
function addNode(bytes32 arg1, address arg2) payable {
    ...
    while uint8(idx) < stor2.length:
        ...
        if uint8(idx) != 0:
            require idx < stor2.length
            uint256(stor2[idx]) = arg1
            require idx < stor3.length
            uint256(sub_a6a8cc00[idx]) = arg2 or Mask(96, 160, uint256(sub_a6a8cc00[idx]))
            require idx < stor4.length
            uint256(stor[idx + code.data[5618 len 32]]) = tx.origin or Mask(96, 160, uint256(stor[idx + code.data[5618 len 32]]))
            ...
            uint256(stor2[stor2.length]) = arg1
            ...
            uint256(sub_b1be9407[arg1].field_0) = uint8(stor2.length)
        return 1
    stor2.length++
    if not stor2.length <= stor2.length + 1:
        idx = stor2.length + 0x56405787fa12a823e0f2b7631cc41b3ba8828b3321ca811111fa75cd3aa3bb5b
