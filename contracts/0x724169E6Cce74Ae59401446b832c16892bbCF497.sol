...
function _fallback() payable {
    ...
    while stor4.length + 31 / 32 > idx:
        ...
        continue 
    stor5 = 0
    stor6 = 1125000 * 24 * 3600
    require not msg.value
    stor0 = stor6
    stor1[0x593344d11c1e0327779c83c415b7f83ac7c891b7] = stor6
    return code.data[481 len 5730]
}
