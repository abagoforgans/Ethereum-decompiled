...
function _fallback() payable {
    ...
    mem[96 len -2554] = code.data[2922 len -2554]
    mem[64] = -2458
    stor3 = mem[96] * 10^mem[191 len 1]
    stor4[mem[236 len 20]] = mem[96] * 10^mem[191 len 1]
    stor2 = mem[191 len 1]
    stor0[] = Array(len=mem[mem[192] + 96], data=mem[mem[192] + 128 len mem[mem[192] + 96]])
    stor1[] = Array(len=mem[mem[128] + 96], data=mem[mem[128] + 128 len mem[mem[128] + 96]])
    return code.data[368 len 2554]
}
