...
function _fallback() {
    mem[96 len -2641] = code.data[3175 len -2641]
...
function execute(address arg1, uint256 arg2, bytes32 arg3) {
    require sub_8b5857f8Address == msg.sender
    require not stor0
...
function calculateVotes() {
    ...
    while idx < sub_cf06678c.length:
        mem[0] = 8
        if sub_cf06678c[idx].field_256 == sub_cf06678c[idx].field_0:
            if sub_82794fb5 <= 3:
                idx = idx + 1
                s = (2 * idx) + sha3(8)
                s = s
        ...
        if sub_7eadebfe[stor8[idx].field_256] <= 0:
            ...
            continue 
        mem[32] = 3
        sub_7eadebfe[stor8[idx].field_256] -= sub_7eadebfe[stor8[idx].field_256] * 100 * sub_4d87682c^(sub_82794fb5 + 1) / 100^(sub_82794fb5 + 1) / 100
        mem[0] = sub_cf06678c[idx].field_0
        sub_7eadebfe[stor8[idx].field_0] += sub_7eadebfe[stor8[idx].field_256] * 100 * sub_4d87682c^(sub_82794fb5 + 1) / 100^(sub_82794fb5 + 1) / 100
        if sub_82794fb5 <= 3:
            idx = idx + 1
            s = (2 * idx) + sha3(8)
            s = sub_7eadebfe[stor8[idx].field_256] * 100 * sub_4d87682c^(sub_82794fb5 + 1) / 100^(sub_82794fb5 + 1) / 100
            t = t
            u = u
            continue 
        mem[0] = sub_cf06678c[idx].field_0
        ...
        continue 
    if sub_82794fb5 > 3:
        emit NewAppointee(address(u), address(u) == sub_8b5857f8Address);
