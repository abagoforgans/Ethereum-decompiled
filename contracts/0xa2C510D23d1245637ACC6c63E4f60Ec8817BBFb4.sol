...
const sub_537fbc09(?) = 1

const sub_abce62a8(?) = 1

const sub_bc6aae8a(?) = 1
...
function _fallback() payable {
    if msg.value > 0:
        ...
        require msg.value <= 11 * 10^15
        stor0.length++
        stor0[stor0.length].field_0 = msg.sender
        stor290D[stor0.length].field_0 = uint128(msg.value)
        stor290D[stor0.length].field_128 = uint128(110 * msg.value / 100)
        call 0x51a2bf880f4db7713e95498833308ffe4d61d080 with:
           value msg.value / 100 wei
             gas 2300 * is_zero(value) wei
        call 0x1e8f7bd53c898625cdc2416ae5f1c446a16dd8d9 with:
           value msg.value / 100 wei
             gas 2300 * is_zero(value) wei
        call 0x36413d58ca47520575889ee3e02e7bb508b3d1e8 with:
           value msg.value / 100 wei
             gas 2300 * is_zero(value) wei
        s = 0
        s = 0
...
function getDeposits(address arg1) {
    ...
    if not s:
        ...
        if s <= 0:
            ...
            while t < 32 * s:
                ...
                t = t + 32
                continue 
            mem[(98 * s) + 256] = (64 * s) + 160
            mem[(164 * s) + 352] = s
            t = 0
            while t < 32 * mem[(64 * s) + 160]:
                mem[t + (32 * mem[(32 * s) + 128]) + (32 * mem[96]) + (98 * s) + 384] = mem[t + (64 * s) + 192]
                t = t + 32
                continue 
            return memory
              from (98 * s) + 192
               len (32 * mem[(64 * s) + 160]) + (32 * mem[(32 * s) + 128]) + (32 * mem[96]) + (192 * s) + 192
        t = 0
        idx = currentReceiverIndex
        t = 0
        while idx < stor0.length:
    ...
    mem[128 len 32 * s] = code.data[2231 len 32 * s]
    mem[(32 * s) + 128] = s
    mem[(32 * s) + 160 len 32 * s] = code.data[2231 len 32 * s]
    mem[(64 * s) + 160] = s
    mem[(64 * s) + 192 len 32 * s] = code.data[2231 len 32 * s]
    if s <= 0:
        mem[(98 * s) + 192] = 96
        mem[(98 * s) + 288] = s
        mem[(98 * s) + 320 len floor32(s)] = code.data[2231 len floor32(s)]
        mem[(98 * s) + 224] = (32 * s) + 128
        mem[(131 * s) + 320] = s
        t = 0
        while t < 32 * s:
