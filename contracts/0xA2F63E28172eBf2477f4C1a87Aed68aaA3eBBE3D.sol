...
function _fallback() payable {
    ...
    return code.data[116 len 10797]
}
...
function sub_a5ffca0e(?) payable {
    ...
    call stor1987 with:
       value uint256(stor[arg3 + sha3((6 * arg2) + (198 * arg1) + 3)].field_0) / 10 wei
         gas 0 wei
    require arg1 < 33
    require arg2 < 33
    call address(stor[(6 * arg2) + (198 * arg1) + 1].field_0) with:
       value uint256(stor[arg3 + sha3((6 * arg2) + (198 * arg1) + 3)].field_0) - (uint256(stor[arg3 + sha3((6 * arg2) + (198 * arg1) + 3)].field_0) / 10) wei
         gas 0 wei
    require arg1 < 33
    require arg2 < 33
    ...
    if msg.value < 10^16:
        if msg.value != 0:
            call msg.sender with:
               value msg.value wei
                 gas 0 wei
        uint256(stor1989.field_0) = Mask(88, 0, stor1989.field_168)
    else:
