...
const _fallback = code.data[25 len 12613]
...
function getBuyPosition(bytes32 arg1, uint256 arg2) {
    ...
    mem[32] = 5
    s = 0
    idx = uint64(assets[sha3(mem[0 len 64])].field_64)
    while uint64(idx):
        mem[0] = uint64(idx)
        mem[32] = 2
        ...
        mem[132] = uint64(idx)
        require ext_code.size(0x5a9c00618ba58f52eea148ac27686a2507a9cbd9)
        delegate 0x5a9c00618ba58f52eea148ac27686a2507a9cbd9.0xb67700f4 with:
...
function getSellPosition(bytes32 arg1, uint256 arg2) {
    ...
    mem[32] = 5
    s = 0
    idx = uint64(activeBuySize[sha3(mem[0 len 64])].field_64)
    while uint64(idx):
        mem[0] = uint64(idx)
        mem[32] = 2
        if arg2 < stor2[idx << 192].field_0:
...
function getNextActiveBuyDetails(bytes32 arg1, uint64 arg2) {
    if not arg2:
        return uint64(activeBuySize[arg1].field_768), 
               address(stor2[uint64(stor5[arg1].field_768)].field_512),
               stor2[uint64(stor5[arg1].field_768)].field_0,
               stor2[uint64(stor5[arg1].field_768)].field_256
    require ext_code.size(0x5a9c00618ba58f52eea148ac27686a2507a9cbd9)
    delegate 0x5a9c00618ba58f52eea148ac27686a2507a9cbd9.0xb67700f4 with:
         gas gas_remaining - 50 wei
        args sha3(arg1, 5) + 3, arg2
    require delegate.return_code
    return delegate.return_data[0] << 192, 
           address(stor2[delegate.return_data[24 len 8]].field_512),
           stor2[delegate.return_data[24 len 8]].field_0,
           stor2[delegate.return_data[24 len 8]].field_256
}

function getNextActiveSellDetails(bytes32 arg1, uint64 arg2) {
    if not arg2:
        return uint64(activeBuySize[arg1].field_1280), 
               address(stor2[uint64(stor5[arg1].field_1280)].field_512),
               stor2[uint64(stor5[arg1].field_1280)].field_0,
               stor2[uint64(stor5[arg1].field_1280)].field_256
    require ext_code.size(0x5a9c00618ba58f52eea148ac27686a2507a9cbd9)
    delegate 0x5a9c00618ba58f52eea148ac27686a2507a9cbd9.0xb67700f4 with:
         gas gas_remaining - 50 wei
        args sha3(arg1, 5) + 5, arg2
    require delegate.return_code
    return delegate.return_data[0] << 192, 
           address(stor2[delegate.return_data[24 len 8]].field_512),
           stor2[delegate.return_data[24 len 8]].field_0,
...
function cancelOrder(bytes32 arg1, uint64 arg2) {
    if address(stor2[arg2 << 192].field_512) != msg.sender:
        emit Error('Invalid order');
        return 0
    require uint8(stor2[arg2 << 192].field_672) <= 1
    if uint8(stor2[arg2 << 192].field_672):
        ...
        balances[address(stor5[arg1].field_512)][address(msg.sender)] += stor2[arg2 << 192].field_256
        ...
        if stor2[arg2 << 192].field_256:
            require stor2[arg2 << 192].field_0 * stor2[arg2 << 192].field_256 / stor2[arg2 << 192].field_256 == stor2[arg2 << 192].field_0
        balances[address(stor5[arg1].field_256)][address(msg.sender)] += stor2[arg2 << 192].field_0 * stor2[arg2 << 192].field_256
        emit 0x51a5b22c: arg2, activeBuySize[arg1].field_0
    stor2[arg2 << 192].field_0 = 0
    stor2[arg2 << 192].field_256 = 0
    Mask(168, 0, stor2[arg2 << 192].field_512) = 0
    return 1
}
...
function getActiveBuyDetails(bytes32 arg1) {
    ...
    if not uint64(activeBuySize[arg1].field_768):
        ...
        u = address(stor2[sha3(mem[0 len 64])].field_0)
        ...
        while uint64(idx):
            ...
            if not uint64(idx):
                mem[0] = uint64(activeBuySize[arg1].field_832)
                mem[32] = 2
                s = stor2[uint64(stor5[arg1].field_768)].field_256
                t = stor2[uint64(stor5[arg1].field_768)].field_0
                u = address(stor2[uint64(stor5[arg1].field_768)].field_512)
                idx = uint64(activeBuySize[arg1].field_832)
                v = v + 1
                continue 
            ...
            mem[32] = 2
            s = stor2[delegate.return_data[0] << 192].field_256
            t = stor2[delegate.return_data[0] << 192].field_0
            u = address(stor2[delegate.return_data[0] << 192].field_512)
            idx = delegate.return_data[0]
            v = v + 1
            continue 
        mem[mem[64]] = 32
    ...
    if not uint64(activeBuySize[arg1].field_1280):
        ...
        while uint64(idx):
            ...
            if not uint64(idx):
                mem[0] = uint64(activeBuySize[arg1].field_1344)
                mem[32] = 2
                s = stor2[uint64(stor5[arg1].field_1280)].field_256
                t = stor2[uint64(stor5[arg1].field_1280)].field_0
                u = address(stor2[uint64(stor5[arg1].field_1280)].field_512)
                idx = uint64(activeBuySize[arg1].field_1344)
                v = v + 1
                continue 
