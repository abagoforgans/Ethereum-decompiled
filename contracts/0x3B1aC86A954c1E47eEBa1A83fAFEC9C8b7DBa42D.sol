...
function sub_4868eb7c(?) {
    ...
    call currencyTokenAddress.transferFrom(address arg1, address arg2, uint256 arg3) with:
         gas gas_remaining wei
...
function sub_e08b0748(?) {
    ...
    require transactionFee + arg2 >= arg2
    require ext_code.size(currencyTokenAddress)
    call currencyTokenAddress.allowance(address arg1, address arg2) with:
         gas gas_remaining wei
...
function sub_0ca7817b(?) {
    ...
    call arg4.balanceOf(address arg1) with:
         gas gas_remaining wei
        args stor8
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_code.size(currencyTokenAddress)
    call currencyTokenAddress.balanceOf(address arg1) with:
         gas gas_remaining wei
        args stor8
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(arg4)
    call arg4.allowance(address arg1, address arg2) with:
         gas gas_remaining wei
    ...
    require ext_code.size(currencyTokenAddress)
    call currencyTokenAddress.transfer(address arg1, uint256 arg2) with:
         gas gas_remaining wei
