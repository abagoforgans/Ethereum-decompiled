...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 9270405365760 * 24 * 3600 * 24 * 3600 * 24 * 3600
    stor2 = 9270405365760 * 24 * 3600 * 24 * 3600 * 24 * 3600
    bool(stor3.length) = 0
    stor3.length.field_1 = 6
    stor3.length.field_8 = 'ATHENE' / 256
    idx = 0
