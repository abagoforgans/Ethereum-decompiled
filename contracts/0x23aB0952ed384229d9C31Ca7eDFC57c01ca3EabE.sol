...
function sub_e1661299(?) {
    ...
    mem[_84 + _85] = 28
    if stor[sha3(mem[mem[64] len _84 + _85 + -mem[64] + 32])]:
    ...
    mem[_291 + _290] = 28
    stor[sha3(mem[mem[64] len _291 + _290 + -mem[64] + 32])] = uint256(stor6) + 1
    ...
    mem[mem[64]] = 160
    mem[_315 + 160] = ('cd', 36).length
    mem[_315 + 192 len ('cd', 36).length] = call.data[cd[36] + 36 len ('cd', 36).length]
    emit Mint(address arg1, address arg2, bytes32 arg3, string arg4, bytes32 arg5, uint256 arg6, bytes32 arg7, uint256 arg8):
              mem[mem[64] len _315 + ('cd', 36).length + -mem[64] + 192],
              this.address,
              address(cd[4]),
              stor20[cd[68]],
