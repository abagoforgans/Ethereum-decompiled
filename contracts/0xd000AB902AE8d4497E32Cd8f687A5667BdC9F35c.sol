...
function sub_a3a4d361(?) {
    return sub_a3a4d361Address
}
...
function sub_c0dc821b(?) {
    sub_a3a4d361Address = arg1
}
...
function wipeBlackListedTrueUSD(address arg1) {
    if owner != msg.sender:
        revert with 0, 'only Owner'
    require ext_code.size(tokenAddress)
    call tokenAddress.wipeBlacklistedAccount(address arg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function requestReclaimContract(address arg1) {
    if owner != msg.sender:
        revert with 0, 'only Owner'
    require ext_code.size(tokenAddress)
    call tokenAddress.reclaimContract(address arg1) with:
         gas gas_remaining wei
        args arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
