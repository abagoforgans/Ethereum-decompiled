...
function vote(uint256 arg1, bool arg2, string arg3) payable {
    ...
    require uint8(stor[code.data[5509 len 32] + (3 * stor7[address(msg.sender)])].field_160)
    require arg1 < stor5.length
    require uint8(stor[(10 * arg1) + 0x56036b6384b5eca791c62761152d0c79bb0604c104a5fb6f4eb0703f3154bb46][address(msg.sender)].field_0) != 1
    uint8(stor[(10 * arg1) + 0x56036b6384b5eca791c62761152d0c79bb0604c104a5fb6f4eb0703f3154bb46][address(msg.sender)].field_0) = 1
    stor5603[arg1]++
    if not arg2:
        stor5603[arg1]--
    else:
...
function members(uint256 arg1) payable {
    ...
    while stor[(3 * arg1) - 0xc085601c9b05546c4de925af5cdebeab0dd5f5d4bea4dc57b37e961749c911c].length + 256 > idx + 32:
        ...
        s = s + 1
        continue 
    return address(stor[(3 * arg1) + code.data[5509 len 32]].field_0), 
           uint8(stor[(3 * arg1) + code.data[5509 len 32]].field_0),
...
function proposals(uint256 arg1) payable {
    require arg1 < stor5.length
    mem[416] = uint256(stor[sha3((10 * arg1) + 0x36b6384b5eca791c62761152d0c79bb0604c104a5fb6f4eb0703f3154bb3db2)].field_0)
    idx = 416
    s = 0
    while stor[(10 * arg1) + 0x36b6384b5eca791c62761152d0c79bb0604c104a5fb6f4eb0703f3154bb3db2].length + 416 > idx + 32:
        mem[idx + 32] = uint256(stor[s + sha3((10 * arg1) + 0x36b6384b5eca791c62761152d0c79bb0604c104a5fb6f4eb0703f3154bb3db2) + 1].field_0)
        idx = idx + 32
        s = s + 1
        continue 
...
function executeProposal(uint256 arg1, bytes arg2) payable {
    ...
    require stor5603[arg1] >= stor2.length
...
function changeMembership(address arg1, bool arg2, string arg3) payable {
    ...
    if memberId[address(arg1)]:
        ...
        Mask(96, 0, stor[code.data[5509 len 32] + (3 * stor7[address(arg1)])].field_160) = Mask(96, 0, arg2)
    else:
...
function Congress(uint256 arg1, uint256 arg2, int256 arg3, address arg4) payable {
    ...
    Mask(168, 0, stor[code.data[5509 len 32]].field_0) = 0
    stor[code.data[5509 len 32]].field_256 % 1 = 0
    stor[code.data[5509 len 32]].field_256 % 1 = 0
    stor[code.data[5509 len 32]].field_256 % 1 = 0
    bool(stor1[code.data[5509 len 32]].field_0) = 0
    uint255(stor1[code.data[5509 len 32]].field_1) = 0
    Mask(248, 0, stor1[code.data[5509 len 32]].field_8) = mem[256 len 31]
    idx = 0
    while stor[code.data[5509 len 32] + 1].length + 31 / 32 > idx:
        uint256(stor[idx + sha3(code.data[5509 len 32] + 1)].field_0) = 0
        idx = idx + 1
        continue 
    stor2[code.data[5509 len 32]] = block.timestamp
    if arg4 != 0:
