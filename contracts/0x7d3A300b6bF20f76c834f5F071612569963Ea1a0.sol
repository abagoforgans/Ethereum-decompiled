...
function score(bytes32 arg1, string arg2) payable {
    ...
    mem[ceil32(arg2.length) + 608] = arg2.length + 116
    idx = 0
    s = 0
    while idx < 25:
        require idx < 25
        require s < arg2.length + 116
    ...
    require ext_call.success
    uint256(stor0.field_0) = ext_call.return_data[0] or Mask(96, 160, uint256(stor0.field_0))
    mem[ceil32(arg2.length) + (32 * arg2.length + 116) + 772] = mem[ceil32(arg2.length) + (32 * arg2.length + 116) + 801 len 3]
    call address(stor0.field_0).getPrice(string rg1) with:
         gas gas_remaining - 25050 wei
        args Array(len=3, data=mem[ceil32(arg2.length) + (32 * arg2.length + 116) + 772])
    require ext_call.success
    mem[ceil32(arg2.length) + (32 * arg2.length + 116) + 836] = mem[ceil32(arg2.length) + (32 * arg2.length + 116) + 865 len 3]
    mem[ceil32(arg2.length) + (32 * arg2.length + 116) + 900 len arg2.length + 116] = mem[ceil32(arg2.length) + 640 len arg2.length + 116]
    if not arg2.length + 116 % 32:
        call address(stor0.field_0).query(uint256 rg1, string rg2, string rg3) with:
           value ext_call.return_data[0] wei
             gas gas_remaining - 34050 wei
            args 0, 96, 160, 3, mem[ceil32(arg2.length) + (32 * arg2.length + 116) + 836], arg2.length + 116, mem[ceil32(arg2.length) + 640 len arg2.length + 116]
    else:
        mem[floor32(arg2.length + 116) + ceil32(arg2.length) + (32 * arg2.length + 116) + 900] = mem[floor32(arg2.length + 116) + ceil32(arg2.length) + (32 * arg2.length + 116) + -(arg2.length + 116 % 32) + 932 len arg2.length + 116 % 32]
        call address(stor0.field_0).query(uint256 rg1, string rg2, string rg3) with:
           value ext_call.return_data[0] wei
             gas gas_remaining - 34050 wei
            args 0, 96, 160, 3, mem[ceil32(arg2.length) + (32 * arg2.length + 116) + 836], arg2.length + 116, mem[ceil32(arg2.length) + 640 len floor32(arg2.length + 116)], mem[ceil32(arg2.length) + (32 * arg2.length + 116) + floor32(arg2.length + 116) + 900]
    require ext_call.success
