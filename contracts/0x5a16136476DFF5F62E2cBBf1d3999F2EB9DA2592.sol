...
function _fallback() payable {
    ...
    create contract with 0 wei
                    code: code.data[4630 len 2833]
    require create.new_address
    stor2 = address(create.new_address)
    return code.data[195 len 4435]
}
...
const sub_00df055c(?) = 120000 * 10^18
...
const sub_594eebd9(?) = (4320 * 24 * 3600)
...
function _fallback() payable {
    ...
    if (100 * 250 * msg.value / 100) + (currentBonus * 250 * msg.value / 100) <= -totalSupply + 28000000 * 10^18:
        ...
        require ext_call.success
        if totalSupply < 120000 * 10^18:
            require stor9[address(msg.sender)] + ((-100 * totalSupply) + 2800000000 * 10^18 / currentBonus + 100 / 250) >= (-100 * totalSupply) + 2800000000 * 10^18 / currentBonus + 100 / 250
            stor9[address(msg.sender)] += (-100 * totalSupply) + 2800000000 * 10^18 / currentBonus + 100 / 250
