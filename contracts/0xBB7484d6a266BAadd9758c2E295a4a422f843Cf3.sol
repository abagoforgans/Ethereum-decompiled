...
function _fallback() {
    ...
    stor0.length.field_8 = 'MedalLionLab Token' / 256
    idx = 0
    ...
    stor1.length.field_8 = 'MEDA' / 256
    idx = 0
    while stor1.length + 31 / 32 > idx:
        stor1[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[538 len 4747]
}
...
const _myTokeName = 'MedalLionLab Token'

const _mySymbol = 'MEDA'

const _myinitialSupply = 100 * 10^6
