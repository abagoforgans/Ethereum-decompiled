...
function _fallback() {
    ...
    stor3.length.field_8 = 'BKCC Token' / 256
    idx = 0
    ...
    stor4 = 18
    stor5 = 1000 * 10^18
    stor6[0x3f15df1a2724c26760d1d000b9af9c69666f2a6d] = stor5
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  stor5,
    emit 0x0: stor5
    emit 0x3f15df1a: stor5
    return code.data[647 len 5596]
}
