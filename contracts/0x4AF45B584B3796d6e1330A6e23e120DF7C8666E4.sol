...
function _fallback() payable {
    stor4 = 0x818e6fecd516ecc3849daf6845e3ec868087b755
    stor5 = 0xc0829421c1d260bd3cb3e0f06cfe2d52db2ce315
    stor6 = 0x1f573d6fb3f13d689ff844b4ce37794d79a7ff1c
    stor7 = 0xeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    mem[96] = 5 * 10^18
    mem[128] = 4 * 10^18
    mem[160] = 3 * 10^18
    mem[192] = 2 * 10^18
    ...
    idx = 96
    while 256 > idx:
        stor10[s].field_0 = mem[idx + 24 len 8]
        stor10[s].field_64 = 0
        s = s + 1
        idx = idx + 32
        continue 
    ...
    return code.data[851 len 24269]
}
...
function sub_ecd59aee(?) {
    require stor3[address(msg.sender)]
    if not stor15:
        return 0, 0, 0, 1
    if stor16 == 1:
        return 1, stor17, stor18, bool(stor15)
    if stor16 == 2:
        return 2, stor17, stor18, bool(stor15)
    if stor16 == 3:
        return 3, stor17, stor18, bool(stor15)
    if stor16 != 4:
        return 0
    return 4, stor17, stor18, bool(stor15)
}
