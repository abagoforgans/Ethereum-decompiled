...
#  - transferAndLock(address arg1, uint256 arg2)
...
function locksOf(address arg1) {
    if stor9[address(arg1)].field_0:
        mem[128 len 64 * stor9[address(arg1)].field_0] = code.data[19182 len 64 * stor9[address(arg1)].field_0]
    idx = 0
    while idx < stor9[address(arg1)].field_0:
