...
function _fallback() payable {
    ...
    if msg.value:
        ...
        if msg.value < 10^16:
            ...
            totalSupply = totalSupply + (1000 * msg.value) + totalContribution
            balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + (1000 * msg.value) + totalContribution
