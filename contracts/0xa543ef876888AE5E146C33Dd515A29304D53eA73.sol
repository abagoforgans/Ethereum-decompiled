...
const WITHDRAWAL_END = 4465650

const MAX_TOTAL_AMOUNT_TO_RECEIVE_ETH = 1

const PRESALE_START = 4465200

const PRESALE_END = 4465550

const VERSION = '0.2.0-bns-test-02'
...
function abort() {
    ...
    if block.number >= 4465200:
        if block.number > 4465550:
            require eth.balance(this.address)
            require block.number <= 4465650
