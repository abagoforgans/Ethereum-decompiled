...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'Toby Coin' / 256
    idx = 0
    ...
    stor0[address(msg.sender)] = 19870000 * 10^18
    stor2 = 19870000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 8
    stor3.length.field_8 = 'TobyCoin' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        stor3[idx].field_0 = 0
        idx = idx + 1
...
function _fallback() payable {
    ...
    if balanceOf[stor8] >= msg.value * unitsOneEthCanBuy:
        balanceOf[stor8] += -1 * msg.value * unitsOneEthCanBuy
        balanceOf[address(msg.sender)] += msg.value * unitsOneEthCanBuy
        emit Transfer((msg.value * unitsOneEthCanBuy), stor8, msg.sender);
        call stor8 with:
           value msg.value wei
