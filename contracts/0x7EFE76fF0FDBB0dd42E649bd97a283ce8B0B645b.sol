...
function cancel() {
    ...
    while idx < 2:
        ...
        mem[32] = 8
        _28 = sha3(mem[(32 * idx) + 172 len 20], 8)
        s = 0
        while s < stor[_28]:
            require s < stor8[address(_18)].field_0
            if not address(_18):
                call address(stor8[address(_18)][s].field_0) with:
                   value sub_a5e8dbc6[address(_18)][address(stor8[address(_18)][s].field_0)] wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
            else:
                mem[228] = address(stor8[address(_18)][s].field_0)
                mem[260] = sub_a5e8dbc6[address(_18)][address(stor8[address(_18)][s].field_0)]
                require ext_code.size(address(_18))
                call address(_18).0xa9059cbb with:
                     gas gas_remaining wei
                    args address(stor8[address(_18)][s].field_0), sub_a5e8dbc6[address(_18)][address(stor8[address(_18)][s].field_0)]
