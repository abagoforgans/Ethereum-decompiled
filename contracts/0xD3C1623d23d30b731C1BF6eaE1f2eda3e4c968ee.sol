...
function participants(uint256 arg1) payable {
    require arg1 < stor0
    return address(stor5629[arg1]), uint256(stor[(2 * arg1) + code.data[1115 len 32]])
}
...
function enter() payable {
    if msg.value < 10^17:
        ...
        if msg.value <= 50 * 10^18:
            ...
            uint256(stor[code.data[1115 len 32] + (2 * stor0)]) = msg.value
            if not stor0:
            ...
            require stor0 < stor0
            uint256(stor5629[stor0]) = msg.sender or Mask(96, 160, uint256(stor5629[stor0]))
            uint256(stor[code.data[1115 len 32] + (2 * stor0)]) = 50 * 10^18
            if not stor0:
                collectedFees += 50 * 10^18
            else:
                collectedFees += 10^18
                balance += 50 * 10^18
        if balance > 2 * uint256(stor[code.data[1115 len 32] + (2 * stor1.length)]):
            require stor1.length < stor0
            call address(stor5629[stor1.length]) with:
               value 98 * uint256(stor[code.data[1115 len 32] + (2 * stor1.length)]) / 50 wei
                 gas 0 wei
            balance -= 2 * uint256(stor[code.data[1115 len 32] + (2 * stor1.length)])
            stor1.length++
            s = 98 * uint256(stor[code.data[1115 len 32] + (2 * stor1.length)]) / 50
            while balance > 2 * uint256(stor[code.data[1115 len 32] + (2 * stor1.length)]):
                require stor1.length < stor0
                call address(stor5629[stor1.length]) with:
                   value 98 * uint256(stor[code.data[1115 len 32] + (2 * stor1.length)]) / 50 wei
                     gas 0 wei
