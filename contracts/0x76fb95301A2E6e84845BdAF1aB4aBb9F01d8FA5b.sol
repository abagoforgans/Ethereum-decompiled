...
function _fallback() payable {
    ...
    call address(stor0).query_withGasLimit(uint256 rg1, string rg2, string rg3, uint256 rg4) with:
       value ext_call.return_data[0] wei
        ...
        args 0, 128, 192, 500000, 3, mem[516], 76, 'json(https://api.kraken.com/0/pu', 'blic/Ticker?pair=ETHXBT).result.', 'XETHXXBT.c.0' >> 256, mem[644]
    require ext_call.success
    return code.data[1256 len 2149]
}
