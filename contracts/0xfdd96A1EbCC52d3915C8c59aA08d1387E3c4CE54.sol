...
function _fallback() payable {
    ...
    create contract with ('add', ('balance', 'address'), ('mul', -1, ('stor', ('name', 'stor1', 1)))) wei
                    code: code.data[2498 len 1250]
    uint256(stor5.field_0) = Mask(96, 0, stor5.field_160)
    return code.data[127 len 2371]
}
...
function _fallback() payable {
    ...
    if ext_call.return_data[0]:
        ...
        create contract with ('add', ('balance', 'address'), ('mul', -1, ('stor', ('name', 'collectedFees', 1)))) wei
                        code: code.data[1121 len 1250]
        uint256(stor5.field_0) = Mask(96, 0, stor5.field_160)
