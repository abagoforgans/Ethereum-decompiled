...
function _fallback() payable {
    ...
    require code.data[15290 len 32] >= block.number
    require code.data[15322 len 32] >= code.data[15290 len 32]
    require code.data[15354 len 32] > 0
    require code.data[15462 len 20]
    create contract with 0 wei
                    code: code.data[9890 len 3111]
    require create.new_address
    stor0 = address(create.new_address)
    stor1 = code.data[15290 len 32]
    stor2 = code.data[15322 len 32]
    stor4 = code.data[15354 len 32]
    stor3 = code.data[15462 len 20]
    stor6 = msg.sender
    stor8 = 252525 * 10^14 * 24 * 3600
    require code.data[15354 len 32] > 0
    require code.data[15386 len 32] > 0
    require code.data[15418 len 32] > 0
    stor12 = code.data[15354 len 32]
    stor13 = code.data[15386 len 32]
    stor10 = code.data[15418 len 32]
    create contract with 0 wei
                    code: code.data[13001 len 2289], stor4, stor3, stor0
    require create.new_address
    stor14 = address(create.new_address)
    return code.data[615 len 9275]
}
