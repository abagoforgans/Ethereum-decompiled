...
function closeCrowdsale() {
    require msg.sender == owner
    require ext_code.size(0xa40d3608bd6c272052220e18d5d6672158f55668)
    delegate 0xa40d3608bd6c272052220e18d5d6672158f55668.0x83326012 with:
...
function hasEnded() {
    require ext_code.size(0xa40d3608bd6c272052220e18d5d6672158f55668)
    delegate 0xa40d3608bd6c272052220e18d5d6672158f55668.0x1d8c3c45 with:
         gas gas_remaining wei
        args 1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function getControllerAddress() {
    require ext_code.size(0xa40d3608bd6c272052220e18d5d6672158f55668)
    delegate 0xa40d3608bd6c272052220e18d5d6672158f55668.0xe201487b with:
         gas gas_remaining wei
        args 1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_302cabba(?) {
    ...
    require msg.sender == owner
    require ext_code.size(0xa40d3608bd6c272052220e18d5d6672158f55668)
    delegate 0xa40d3608bd6c272052220e18d5d6672158f55668.0xc078f353 with:
         gas gas_remaining wei
...
function sub_f6072a10(?) {
    ...
    require msg.sender == owner
    require ext_code.size(0xa40d3608bd6c272052220e18d5d6672158f55668)
    delegate 0xa40d3608bd6c272052220e18d5d6672158f55668.0x3bd160bf with:
         gas gas_remaining wei
...
function sub_04138e6b(?) {
    require calldata.size - 4 >= 32
    require ext_code.size(0xa40d3608bd6c272052220e18d5d6672158f55668)
    delegate 0xa40d3608bd6c272052220e18d5d6672158f55668.0xf8efb47d with:
         gas gas_remaining wei
        args 1, arg1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function rescueToken(address arg1, address arg2) {
    ...
    require ext_code.size(0xa40d3608bd6c272052220e18d5d6672158f55668)
    delegate 0xa40d3608bd6c272052220e18d5d6672158f55668.0x37159bfb with:
         gas gas_remaining wei
        args 1, address(arg1), arg2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_5054db87(?) {
    ...
    require ext_code.size(0xa40d3608bd6c272052220e18d5d6672158f55668)
    delegate 0xa40d3608bd6c272052220e18d5d6672158f55668.0xc913516b with:
         gas gas_remaining wei
        args 1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    if not delegate.return_data[0]:
        revert with 0, 'assign prerequisit'
    require ext_code.size(0xa40d3608bd6c272052220e18d5d6672158f55668)
    delegate 0xa40d3608bd6c272052220e18d5d6672158f55668.0x3f781a73 with:
         gas gas_remaining wei
...
function sub_e640359f(?) {
    ...
    require ext_code.size(0xa40d3608bd6c272052220e18d5d6672158f55668)
    delegate 0xa40d3608bd6c272052220e18d5d6672158f55668.0xddf84c80 with:
         gas gas_remaining wei
    ...
    require ext_code.size(0xa40d3608bd6c272052220e18d5d6672158f55668)
    delegate 0xa40d3608bd6c272052220e18d5d6672158f55668.0xd4f10f10 with:
         gas gas_remaining wei
...
function startCrowdsale() {
    ...
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(0xa40d3608bd6c272052220e18d5d6672158f55668)
    delegate 0xa40d3608bd6c272052220e18d5d6672158f55668.0x20b6c9bc with:
         gas gas_remaining wei
        args 1
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
