...
function sub_cbcf464b(?) {
    if msg.sender == addAuthorityAddress:
        ...
        sub_d104afb7[arg1 << 224].field_256 = arg2
...
function sub_dc37b819(?) {
    if not sub_d104afb7[arg1 << 224].field_256:
        return 0, 12
...
function sub_a977ee85(?) {
    ...
    if msg.sender == addAuthorityAddress:
        sub_f11badc0[address(arg3)].field_0 = msg.sender
        sub_f11badc0[address(arg3)].field_256 = block.number
        sub_f11badc0[address(arg3)][2][arg1 << 240].field_0 = arg2
        sub_f11badc0[address(arg3)].field_808 = arg3
        sub_f11badc0[address(arg3)].field_768 = arg4
        sub_f11badc0[address(arg3)].field_776 = arg5
        sub_f11badc0[address(arg3)].field_784 = arg6
        sub_f11badc0[address(arg3)].field_792 = arg7
        if arg6 > 0:
            require arg4
            if uint16(var13003) < uint16(arg7 / arg4):
                require uint16(var15001) < arg8.length
                stor1[address(arg3)][var17003 << 240] = mem[(32 * var17001) + 128]
                require arg4
                idx = var17003
                while uint16(idx + 1) < uint16(arg7 / arg4):
                    ...
                    idx = idx + 1
                    continue 
        emit 0x3b06453a: address(arg2), address(arg3), block.number, arg7 << 240, arg4 << 248, arg5 << 248, arg6
}
...
function sub_12a9f213(?) {
    ...
    if msg.sender == addAuthorityAddress:
        ...
        while uint32(idx) < arg2:
            ...
            if uint32(var20004) >= mem[(32 * uint32(idx)) + 158 len 2]:
                idx = idx + 1
                continue 
            require uint32(var22001) < arg6.length
            require uint32(idx) < arg4.length
            require uint32(var22001) < arg5.length
            if not arg1:
                mem[0] = uint16(mem[(32 * uint32(var22001)) + (32 * arg3.length) + (32 * arg4.length) + 192]) / 128
                mem[32] = sha3(mem[(32 * uint32(idx)) + (32 * arg3.length) + 172 len 20], 1)
                stor1[mem[(32 * uint32(idx)) + (32 * arg3.length) + 172 len 20]][uint16(mem[(32 * uint32(var22001)) + (32 * arg3.length) + (32 * arg4.length) + 192]) / 128] = mem[(32 * uint32(var22001)) + (32 * arg3.length) + (32 * arg4.length) + (32 * arg5.length) + 224]
            else:
                mem[0] = uint16(mem[(32 * uint32(var22001)) + (32 * arg3.length) + (32 * arg4.length) + 192]) / 8
                mem[32] = sha3(mem[(32 * uint32(idx)) + (32 * arg3.length) + 172 len 20], 2)
                stor2[mem[(32 * uint32(idx)) + (32 * arg3.length) + 172 len 20]][uint16(mem[(32 * uint32(var22001)) + (32 * arg3.length) + (32 * arg4.length) + 192]) / 8] = mem[(32 * uint32(var22001)) + (32 * arg3.length) + (32 * arg4.length) + (32 * arg5.length) + 224]
            require uint32(idx) < arg3.length
            if uint32(var22001 + 1) >= mem[(32 * uint32(idx)) + 158 len 2]:
                idx = idx + 1
                continue 
            var22001 = var22001 + 1
            continue 
            ...
            if stor1[address(arg1)][Mask(249, 7, arg2)] / 2^(2 * arg2 % 128) % 4 <= 1:
                if bool(stor1[address(arg1)][Mask(249, 7, arg2)] / 2^(2 * arg2 % 128)) != sub_f11badc0[address(arg1)].field_784:
                    ...
                    if sub_f11badc0[address(arg1)][2][arg4 << 240].field_0 != msg.sender:
                        return 0, 
                               0,
                               stor1[address(arg1)][Mask(249, 7, arg2)] / 2^(2 * arg2 % 128) % 4 or 16 * sub_f11badc0[address(arg1)].field_776 % 16 or 1
                    else:
                        if not arg3:
                            return 0, 
                                   0,
                            ...
                            if stor1[address(arg1)][Mask(249, 7, arg2)] / 2^(2 * arg2 % 128) % 4 or 16 * sub_f11badc0[address(arg1)].field_776 % 16 or 1 <= 0:
                                return 0, 
                                       0,
                                       stor1[address(arg1)][Mask(249, 7, arg2)] / 2^(2 * arg2 % 128) % 4 or 16 * sub_f11badc0[address(arg1)].field_776 % 16 or 1
                            else:
                                _25 = mem[161]
                                _27 = mem[ceil32(arg5.length) + 180]
                                mem[ceil32(arg5.length) + ceil32(arg6.length) + 192] = mem[ceil32(arg5.length) + 160]
                                signer = erecover(mem[ceil32(arg5.length) + 160], _25 << 248, mem[128], mem[160]) 
                                mem[ceil32(arg5.length) + ceil32(arg6.length) + 160] = signer
                                require erecover.result
                                if address(_27) != address(signer):
                                    return 0, 
                                           0,
                                           stor1[address(arg1)][Mask(249, 7, arg2)] / 2^(2 * arg2 % 128) % 4 or 16 * sub_f11badc0[address(arg1)].field_776 % 16 or 1 or 8
                                else:
                                    mem[ceil32(arg5.length) + ceil32(arg6.length) + 416 len arg6.length] = arg6[all]
                                    if not arg6.length % 32:
                                        emit 0xc6fef693: 128, address(arg1), arg2, 192, 12, 'ChainSign =>', arg6.length, arg6[all], mem[ceil32(arg5.length) + 192 len 20]
                                        return 0, 
                                               0,
                                               stor1[address(arg1)][Mask(249, 7, arg2)] / 2^(2 * arg2 % 128) % 4 or 16 * sub_f11badc0[address(arg1)].field_776 % 16 or 1
                                    else:
                                        ...
                                        emit 0xc6fef693: 128, address(arg1), arg2, 192, 12, 'ChainSign =>', arg6.length, arg6[all], mem[ceil32(arg5.length) + ceil32(arg6.length) + arg6.length + 416 len -(arg6.length % 32) + 32], mem[ceil32(arg5.length) + 192 len 20]
                                        return 0, 
                                               0,
                                               stor1[address(arg1)][Mask(249, 7, arg2)] / 2^(2 * arg2 % 128) % 4 or 16 * sub_f11badc0[address(arg1)].field_776 % 16 or 1
            else:
                ...
                if sub_f11badc0[address(arg1)][2][arg4 << 240].field_0 != msg.sender:
                    ...
                    if not arg3:
                        ...
                        if stor1[address(arg1)][Mask(249, 7, arg2)] / 2^(2 * arg2 % 128) % 4 or 16 * sub_f11badc0[address(arg1)].field_776 % 16 <= 0:
                            ...
                            _44 = mem[161]
                            _46 = mem[ceil32(arg5.length) + 180]
                            mem[ceil32(arg5.length) + ceil32(arg6.length) + 192] = mem[ceil32(arg5.length) + 160]
                            signer = erecover(mem[ceil32(arg5.length) + 160], _44 << 248, mem[128], mem[160]) 
                            mem[ceil32(arg5.length) + ceil32(arg6.length) + 160] = signer
                            require erecover.result
                            if address(_46) != address(signer):
                                return sub_f11badc0[address(arg1)].field_256 + (uint32(stor2[address(arg1)][Mask(253, 3, arg2)] / 2^(32 * arg2 % 8)) / 256), 
                                       stor2[address(arg1)][Mask(253, 3, arg2)] / 2^(32 * arg2 % 8) << 248,
