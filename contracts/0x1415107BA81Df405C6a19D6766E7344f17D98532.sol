...
function _fallback() {
    stor4 = code.data[4048 len 20]
    stor5 = code.data[4080 len 20]
    stor6 = 0
    stor2 = msg.sender
    stor3 = code.data[4112 len 20]
    return code.data[142 len 3894]
}
...
function sub_243bac06(?) {
    return bool(stor11[arg1])
}

function sub_24b9b9c6(?) {
    return address(sub_24b9b9c6Address)
}
...
function sub_186f161b(?) {
    ...
    if arg5:
        if ext_code.size(sub_fc6f57a3[arg2]):
            call sub_fc6f57a3[arg2].0x41099135 with:
                 gas gas_remaining - 50 wei
                args address(arg3), address(arg1), arg4
            if ext_call.success:
                if ext_code.size(address(refundTokenAddress)):
                    call address(refundTokenAddress).0x41099135 with:
                         gas gas_remaining - 50 wei
                        args address(arg1), address(arg3), arg4
                    if ext_call.success:
    else:
        if ext_code.size(sub_929c7c22[arg2]):
            call sub_929c7c22[arg2].0x41099135 with:
                 gas gas_remaining - 50 wei
                args address(arg3), address(arg1), arg4
            if ext_call.success:
                if ext_code.size(address(sub_24b9b9c6Address)):
                    call address(sub_24b9b9c6Address).0x41099135 with:
                         gas gas_remaining - 50 wei
                        args address(arg1), address(arg3), arg4
                    if ext_call.success:
    revert
...
function sub_2a2ee811(?) {
    ...
    stor11[stor6] = 0
    emit 0x6f647608: arg6, sub_36fbad26, projectList[stor6]
}
