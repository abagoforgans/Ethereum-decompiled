...
function MTPToken() {
    require 0x144efef99f7f126987c2b5ccd717cf6edad1e67d == msg.sender
    totalSupply = 99631000000 * 10^18
    maxPresaleSupply = (8 * totalSupply / 1000) + (27398525 * 10^18 * 3600)
    balanceOf[address(msg.sender)] = 27398525 * 10^18 * 3600
    totalMTPAllocated = 27398525 * 10^18 * 3600
}
