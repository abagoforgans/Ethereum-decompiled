...
function _fallback() payable {
    ...
    require code.data[8126 len 32] >= block.timestamp
    require code.data[8158 len 32] >= code.data[8126 len 32]
    require code.data[8190 len 32] > 0
    require code.data[8298 len 20]
    stor0 = 0
    stor1 = code.data[8126 len 32]
    stor2 = code.data[8158 len 32]
    stor4 = code.data[8190 len 32]
    stor3 = code.data[8298 len 20]
    address(stor6.field_0) = msg.sender
    require code.data[8030 len 32] > 0
    stor7 = code.data[8030 len 32]
    stor8 = code.data[8062 len 32]
    stor9 = code.data[8094 len 32]
    stor10 = code.data[8222 len 32]
    stor11 = code.data[8254 len 32]
    return code.data[596 len 7434]
}
