...
function _fallback() payable {
    ...
    stor1[address(msg.sender)] = 3333333333333333
    stor0 = 8888888888888888
    bool(stor3.length) = 0
    stor3.length.field_1 = 6
    stor3.length.field_8 = 'Bubble' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'BUBBLE' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    stor9 = 5555555555555555
    stor7 = 10^18
    require stor9 / 8888
    stor8 = 10^18 / stor9 / 8888
    return code.data[754 len 4605]
}
...
#
#  - sub_33a88266(?)
#  - Dispense(address arg1, uint256 arg2)
#  - _fallback()
#
uint256 totalSupply;
...
function sub_bc246d9b(?) {
    require iCOSupply / 8888
    return (10^18 / iCOSupply / 8888)
}
