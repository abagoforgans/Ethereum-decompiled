...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0xce552ff38c16588ea6e8ce91c69e5d13a2eafd44)
    delegate 0xce552ff38c16588ea6e8ce91c69e5d13a2eafd44.0x66098d4f with:
         gas gas_remaining - 50 wei
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0xce552ff38c16588ea6e8ce91c69e5d13a2eafd44):
                            delegate 0xce552ff38c16588ea6e8ce91c69e5d13a2eafd44.0x66098d4f with:
                                 gas gas_remaining - 50 wei
