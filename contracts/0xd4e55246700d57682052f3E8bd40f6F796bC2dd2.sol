...
function _fallback() payable {
    stor264 = 2
    mem[96 len -4224] = code.data[4510 len -4224]
    mem[64] = -4128
            ...
            if stor259[call.data[0 len calldata.size]][block.number].field_0 > 1:
                ...
                if arg1 <= m_numOwners:
                    ...
                    while idx < stor260.length:
                        mem[0] = stor564C[idx]
                        mem[32] = 265
                        address(stor265[stor564C[idx]].field_0) = 0
                        stor265[stor564C[idx]].field_256 = 0
                        stor265[stor564C[idx]].field_512 = 0
                        if 31 < stor265[stor564C[idx]][2].length:
                            mem[0] = sha3(stor564C[idx], 265) + 2
                            s = sha3(sha3(stor564C[idx], 265) + 2)
                            while sha3(sha3(stor564C[idx], 265) + 2) + (stor265[stor564C[idx]][2].length + 31 / 32) > s:
                                stor[s] = 0
                                s = s + 1
                                continue 
                        idx = idx + 1
