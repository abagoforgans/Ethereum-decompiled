...
function _fallback() {
    ...
    stor0.length.field_152 = 0xe5ba94e794a8e993be20332e30
    idx = 0
    ...
    stor1.length.field_8 = 'IRC 3.0' / 256
    idx = 0
    while stor1.length + 31 / 32 > idx:
        ...
        continue 
    stor2 = 18
    stor4[0x961bfbb9429a2c42296ee6fc5f59d11d4e1ce3a7] = stor3
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  stor3,
    emit 0x0: stor3
    emit 0x961bfbb9: stor3
    return code.data[612 len 2818]
}
