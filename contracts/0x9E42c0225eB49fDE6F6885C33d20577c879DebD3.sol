...
function sub_8acb062e(?) {
    ...
    if ext_call.return_data[0] <= 0:
        ...
        _48 = mem[(32 * arg1.length) + 192]
        require 0 < arg2.length
        require mem[(32 * arg1.length) + 192]
        mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 192] = mem[(32 * arg1.length) + 160] * 11 * ext_call.return_data[0] / 10 / mem[(32 * arg1.length) + 192]
        emit 0x34d6d9be: mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 192]
        require 5 < arg2.length
        _56 = mem[(32 * arg1.length) + 320]
        require 0 < arg1.length
        require 0 < arg2.length
        require 1 < arg1.length
        require 1 < arg2.length
        _64 = mem[(32 * arg1.length) + 192]
        require 3 < arg2.length
        _66 = mem[(32 * arg1.length) + 256]
        require 4 < arg2.length
        _68 = mem[(32 * arg1.length) + 288]
        require 2 < arg1.length
        _70 = mem[192]
        require 0 < arg3.length
        _72 = mem[(32 * arg1.length) + (32 * arg2.length) + 192]
        require 1 < arg3.length
        _74 = mem[(32 * arg1.length) + (32 * arg2.length) + 224]
        require owner == msg.sender
        require ext_code.size(stor1)
        call stor1.testTrade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11, address rg12) with:
             gas gas_remaining - 710 wei
            args mem[140 len 20], mem[(32 * arg1.length) + 160], mem[172 len 20], mem[(32 * arg1.length) + 192], mem[(32 * arg1.length) + 256], mem[(32 * arg1.length) + 288], address(mem[192]), mem[(32 * arg1.length) + 320] << 248, mem[(32 * arg1.length) + (32 * arg2.length) + 192], mem[(32 * arg1.length) + (32 * arg2.length) + 224], mem[(32 * arg1.length) + 160] * 11 * ext_call.return_data[0] / 10 / _48, this.address
        require ext_call.success
        if not ext_call.return_data[0]:
            emit 0x34d6d9be: 257
            emit 0x34d6d9be: 17
            ...
            mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 292] = _64
            mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 324] = _66
            mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 356] = _68
            mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 388] = address(_70)
            mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 420] = uint8(_56)
            mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 452] = _72
            mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 484] = _74
            require ext_code.size(stor1)
            call stor1.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
                 gas gas_remaining - 710 wei
                args mem[140 len 20], mem[(32 * arg1.length) + 160], mem[172 len 20], _64, _66, _68, address(_70), _56 << 248, _72, _74, mem[(32 * arg1.length) + 160] * 11 * ext_call.return_data[0] / 10 / _48
            require ext_call.success
