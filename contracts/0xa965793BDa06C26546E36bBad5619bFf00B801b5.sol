...
function sub_842702ac(?) payable {
    require arg1 < 17
    require arg2 < 17
    require arg3 + 1 < uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0)
    require arg1 < 17
    require arg2 < 17
    require arg3 < uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0)
    require arg1 < 17
    require arg2 < 17
    require arg3 < uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0)
    address(stor[arg3 + sha3((4 * arg2) + (68 * arg1) + 2)].field_0) = 0
    require arg1 < 17
    require arg2 < 17
    require arg3 + 1 < uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0)
    address(stor[arg3 + sha3((4 * arg2) + (68 * arg1) + 2) + 1].field_0) = 0
    require arg1 < 17
    require arg2 < 17
    idx = var25001
    s = var25003
    while uint8(idx) < uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0):
        ...
        require arg1 < 17
        if not address(stor[sha3((4 * arg2) + (68 * arg1) + 2) + idx].field_0):
            require arg2 < 17
            idx = idx + 1
            s = s
            continue 
        if uint8(idx) != uint8(s):
            ...
            require arg1 < 17
            require arg2 < 17
            require s < uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0)
            mem[0] = (4 * arg2) + (68 * arg1) + 2
            uint64(stor[sha3((4 * arg2) + (68 * arg1) + 2) + s].field_0) = uint64(stor[idx + sha3((4 * arg2) + (68 * arg1) + 2)].field_0)
            Mask(96, 0, stor[sha3((4 * arg2) + (68 * arg1) + 2) + s].field_64) = 0
        require arg2 < 17
        idx = idx + 1
        s = s + 1
        continue 
    require arg1 < 17
    require arg2 < 17
    if not uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0) <= uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0):
        idx = uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0)
        while uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0) > idx:
            uint256(stor[idx + sha3((4 * arg2) + (68 * arg1) + 2)].field_0) = 0
            idx = idx + 1
            continue 
    call uint64(stor[arg3 + sha3((4 * arg2) + (68 * arg1) + 2)].field_0) with:
       value uint64(stor[sha3((4 * arg2) + (68 * arg1) + 2) + arg3 + 1].field_0) wei
         gas 0 wei
    sub_0a786f34 -= uint64(stor[sha3((4 * arg2) + (68 * arg1) + 2) + arg3 + 1].field_0)
}
        ...
        if msg.value < 10^16:
            ...
            if msg.value > test266151307():
                ...
                if uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0) <= 20:
                    ...
                    Mask(80, 0, stor[uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0) + sha3((4 * arg2) + (68 * arg1) + 2) - 1].field_0) = Mask(80, 0, msg.value)
                    Mask(80, 0, stor[uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0) + sha3((4 * arg2) + (68 * arg1) + 2) - 1].field_80) = 0
...
function sub_edffcd57(?) payable {
    ...
    while uint8(idx) < uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0):
        ...
        if address(stor[sha3((4 * arg2) + (68 * arg1) + 2) + idx].field_0) == address(msg.sender):
            ...
            require arg2 < 17
            require idx < uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0)
            address(stor[idx + sha3((4 * arg2) + (68 * arg1) + 2)].field_0) = 0
            require arg1 < 17
            require arg2 < 17
            require idx + 1 < uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0)
            mem[0] = (4 * arg2) + (68 * arg1) + 2
            address(stor[idx + sha3((4 * arg2) + (68 * arg1) + 2) + 1].field_0) = 0
            require arg1 < 17
            require arg2 < 17
            s = var35001
            t = var35003
            while uint8(s) < uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0):
                require arg1 < 17
                require arg2 < 17
                require s < uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0)
                mem[0] = (4 * arg2) + (68 * arg1) + 2
                require arg1 < 17
                if not address(stor[sha3((4 * arg2) + (68 * arg1) + 2) + s].field_0):
                    require arg2 < 17
                    require arg2 < 17
                    s = s + 1
                    t = t
                ...
                if uint8(s) != uint8(t):
                    ...
                    require arg1 < 17
                    require arg2 < 17
                    require t < uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0)
                    mem[0] = (4 * arg2) + (68 * arg1) + 2
                    uint64(stor[sha3((4 * arg2) + (68 * arg1) + 2) + t].field_0) = uint64(stor[s + sha3((4 * arg2) + (68 * arg1) + 2)].field_0)
                    Mask(96, 0, stor[sha3((4 * arg2) + (68 * arg1) + 2) + t].field_64) = 0
                require arg2 < 17
                require arg2 < 17
                s = s + 1
                t = t + 1
            ...
            if not uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0) <= uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0):
                mem[0] = (4 * arg2) + (68 * arg1) + 2
                s = uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0) + sha3((4 * arg2) + (68 * arg1) + 2)
                while sha3((4 * arg2) + (68 * arg1) + 2) + uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0) > s:
                    uint256(stor[s].field_0) = 0
                    require arg2 < 17
                    s = s + 1
                    continue 
            call uint64(stor[idx + sha3((4 * arg2) + (68 * arg1) + 2)].field_0) with:
               value uint64(stor[sha3((4 * arg2) + (68 * arg1) + 2) + idx + 1].field_0) wei
                 gas 0 wei
            sub_0a786f34 -= uint64(stor[sha3((4 * arg2) + (68 * arg1) + 2) + idx + 1].field_0)
        require arg2 < 17
        idx = idx + 2
        continue 
}
