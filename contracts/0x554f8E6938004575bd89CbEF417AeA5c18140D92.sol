...
function _fallback() {
    ...
    stor1 = code.data[8561 len 32]
    stor7 = code.data[8625 len 32]
    if code.data[8605 len 20] > 0:
        stor6 = code.data[8605 len 20]
    emit 0xd71be580: stor1, code.data[8605 len 20]
    require stor0 == msg.sender
    if stor4[0]:
        require stor4[0] < stor5.length
        stor5[stor4[0]].field_160 = 0
        stor5[stor4[0]].field_168 = 0
        stor5[stor4[0]].field_176 = 0
        stor5[stor4[0]].field_176 = 0
        ...
        stor5[stor5.length].field_176 = 0
        stor5[stor5.length].field_256 = 0
        stor5[stor5.length].field_256 = 0
    emit MembershipChanged(0, 1);
    return code.data[988 len 7573]
}
...
function changeSettings(uint256 arg1, address arg2, uint256 arg3) {
    ...
    minBalance = arg3
    if arg2 > 0:
        currentPriceAddress = arg2
    emit 0xd71be580: requiredApprovals, arg2
}

function toWei(uint256 arg1) {
    require ext_code.size(currentPriceAddress)
    call currentPriceAddress.price() with:
...
function changeMember(address arg1, bool arg2, bool arg3, uint256 arg4) {
    ...
    if memberId[address(arg1)]:
        ...
        members[stor4[address(arg1)]].field_160 = uint8(arg2)
        members[stor4[address(arg1)]].field_168 = Mask(88, 0, arg3)
        members[stor4[address(arg1)]].field_176 = Mask(80, 16, arg2) >> 16
        members[stor4[address(arg1)]].field_176 = 0
        ...
        members[members.length].field_160 = uint8(arg2)
        members[members.length].field_168 = Mask(88, 0, arg3)
        members[members.length].field_176 = Mask(80, 16, arg2) >> 16
...
function removeMember(address arg1) {
    ...
    while idx < members.length - 1:
        ...
        members[idx].field_0 = members[idx + 1].field_0
        members[idx].field_160 = uint8(bool(members[idx + 1].field_160))
        members[idx].field_168 = Mask(88, 0, bool(members[idx + 1].field_168))
        members[idx].field_176 = Mask(80, 16, bool(members[idx + 1].field_160)) >> 16
        members[idx].field_176 = 0
