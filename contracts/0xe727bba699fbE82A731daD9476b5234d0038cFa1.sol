...
function unApprove(address arg1) payable {
    uint8(coinBalanceOf[address(msg.sender)][1][address(arg1)]) = 0
    if uint8(coinBalanceOf[address(msg.sender)][1][address(arg1)]):
        uint256(coinBalanceOf[address(msg.sender)][2][address(arg1)]) = 0
    else:
        if uint256(coinBalanceOf[address(msg.sender)][2][address(arg1)]) > 0:
            uint256(coinBalanceOf[address(msg.sender)][2][address(arg1)]) = 0
}
