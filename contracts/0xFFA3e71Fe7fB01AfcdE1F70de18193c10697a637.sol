...
function sub_cdfa8495(?) {
    ...
    staticcall entityContractAddress.ownerOf(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    mem[(2 * ceil32(return_data.size)) + 2240] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[(2 * ceil32(return_data.size)) + 2208] = ext_call.return_data[12 len 20]
    mem[(4 * ceil32(return_data.size)) + 2240] = 0
    ...
    staticcall sub_c3d22fb6Address.getAuction(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    mem[(4 * ceil32(return_data.size)) + 2816 len 160] = ext_call.return_data[0 len 160]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    ...
    staticcall seedContractAddress.getAuction(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    mem[(7 * ceil32(return_data.size)) + 3776 len 160] = ext_call.return_data[0 len 160]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 160
    mem[(8 * ceil32(return_data.size)) + 3776] = 0
    mem[(8 * ceil32(return_data.size)) + 3808] = 0
    mem[(8 * ceil32(return_data.size)) + 3840] = 0
    mem[(8 * ceil32(return_data.size)) + 3872] = 0
    mem[(8 * ceil32(return_data.size)) + 3904] = 0
    mem[(8 * ceil32(return_data.size)) + 3936] = 0
    mem[(8 * ceil32(return_data.size)) + 3968] = address(ext_call.return_data[0])
    mem[(8 * ceil32(return_data.size)) + 4000] = ext_call.return_data[32]
    mem[(8 * ceil32(return_data.size)) + 4032] = ext_call.return_data[64]
    mem[(8 * ceil32(return_data.size)) + 4064] = ext_call.return_data[96]
    mem[(8 * ceil32(return_data.size)) + 4096] = ext_call.return_data[128]
    mem[(8 * ceil32(return_data.size)) + 4164] = arg1
    require ext_code.size(seedContractAddress)
    staticcall seedContractAddress.getCurrentPrice(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    mem[(8 * ceil32(return_data.size)) + 4160] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[(8 * ceil32(return_data.size)) + 4128] = ext_call.return_data[0]
    return ext_call.return_data[0], 
           ...
           mem[(2 * ceil32(return_data.size)) + 2220 len 20],
...
function sub_ab35ec63(?) {
    require calldata.size - 4 >= 32
    mem[96 len 64] = code.data[6700 len 64]
    mem[160 len 96] = code.data[6700 len 96]
    mem[256 len 608] = code.data[6700 len 608]
    require ext_code.size(entityContractAddress)
    staticcall entityContractAddress.0x18160ddd with:
            gas gas_remaining wei
    ...
    mem[(2 * ceil32(return_data.size)) + 1760] = 0
    mem[(2 * ceil32(return_data.size)) + 1792] = 0
    mem[(2 * ceil32(return_data.size)) + 1824] = 0
    mem[(2 * ceil32(return_data.size)) + 1856] = 0
    mem[(2 * ceil32(return_data.size)) + 1888] = 0
    mem[(2 * ceil32(return_data.size)) + 1920] = bool(ext_call.return_data[0])
    mem[(2 * ceil32(return_data.size)) + 1952] = bool(ext_call.return_data[32])
    mem[(2 * ceil32(return_data.size)) + 1984] = ext_call.return_data[64]
    mem[(2 * ceil32(return_data.size)) + 2016] = ext_call.return_data[96]
    mem[(2 * ceil32(return_data.size)) + 2048] = ext_call.return_data[128]
    mem[(2 * ceil32(return_data.size)) + 2080] = ext_call.return_data[160]
    mem[(2 * ceil32(return_data.size)) + 2112] = ext_call.return_data[192]
    mem[(2 * ceil32(return_data.size)) + 2144] = ext_call.return_data[224]
    mem[(2 * ceil32(return_data.size)) + 2176] = ext_call.return_data[256]
    mem[(2 * ceil32(return_data.size)) + 2208] = ext_call.return_data[288]
    mem[(2 * ceil32(return_data.size)) + 2276] = arg1
    require ext_code.size(entityContractAddress)
    staticcall entityContractAddress.ownerOf(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    mem[(2 * ceil32(return_data.size)) + 2272] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[(2 * ceil32(return_data.size)) + 2240] = ext_call.return_data[12 len 20]
    mem[(4 * ceil32(return_data.size)) + 2272] = 0
    mem[(4 * ceil32(return_data.size)) + 2304] = 0
    mem[(4 * ceil32(return_data.size)) + 2336] = 0
    mem[(4 * ceil32(return_data.size)) + 2368] = 0
    ...
    staticcall sub_c3d22fb6Address.getAuction(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    mem[(4 * ceil32(return_data.size)) + 2848 len 160] = ext_call.return_data[0 len 160]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 160
    ...
    mem[(6 * ceil32(return_data.size)) + 3040] = address(ext_call.return_data[0])
    mem[(6 * ceil32(return_data.size)) + 3072] = ext_call.return_data[32]
    mem[(6 * ceil32(return_data.size)) + 3104] = ext_call.return_data[64]
    mem[(6 * ceil32(return_data.size)) + 3136] = ext_call.return_data[96]
    mem[(6 * ceil32(return_data.size)) + 3168] = ext_call.return_data[128]
    mem[(6 * ceil32(return_data.size)) + 3236] = arg1
    require ext_code.size(sub_c3d22fb6Address)
    staticcall sub_c3d22fb6Address.getCurrentPrice(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    mem[(6 * ceil32(return_data.size)) + 3232] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[(6 * ceil32(return_data.size)) + 3200] = ext_call.return_data[0]
    mem[(7 * ceil32(return_data.size)) + 3232] = 0
    mem[(7 * ceil32(return_data.size)) + 3264] = 0
    mem[(7 * ceil32(return_data.size)) + 3296] = 0
    mem[(7 * ceil32(return_data.size)) + 3328] = 0
    mem[(7 * ceil32(return_data.size)) + 3360] = 0
    mem[(7 * ceil32(return_data.size)) + 3392] = 0
    mem[(7 * ceil32(return_data.size)) + 3424] = 0
    mem[(7 * ceil32(return_data.size)) + 3456] = 0
    mem[(7 * ceil32(return_data.size)) + 3488] = 0
    mem[(7 * ceil32(return_data.size)) + 3520] = 0
    mem[(7 * ceil32(return_data.size)) + 3552] = 0
    mem[(7 * ceil32(return_data.size)) + 3584] = 0
    mem[(7 * ceil32(return_data.size)) + 3616] = 0
    mem[(7 * ceil32(return_data.size)) + 3648] = 0
    mem[(7 * ceil32(return_data.size)) + 3680] = 0
    mem[(7 * ceil32(return_data.size)) + 3712] = 0
    mem[(7 * ceil32(return_data.size)) + 3744] = 0
    mem[(7 * ceil32(return_data.size)) + 3776] = 0
    require ext_code.size(seedContractAddress)
    staticcall seedContractAddress.getAuction(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    mem[(7 * ceil32(return_data.size)) + 3808 len 160] = ext_call.return_data[0 len 160]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 160
    mem[(8 * ceil32(return_data.size)) + 3808] = 0
    ...
    mem[(8 * ceil32(return_data.size)) + 3904] = 0
    mem[(8 * ceil32(return_data.size)) + 3936] = 0
    mem[(8 * ceil32(return_data.size)) + 3968] = 0
    mem[(8 * ceil32(return_data.size)) + 4000] = address(ext_call.return_data[0])
    mem[(8 * ceil32(return_data.size)) + 4032] = ext_call.return_data[32]
    mem[(8 * ceil32(return_data.size)) + 4064] = ext_call.return_data[64]
    mem[(8 * ceil32(return_data.size)) + 4096] = ext_call.return_data[96]
    mem[(8 * ceil32(return_data.size)) + 4128] = ext_call.return_data[128]
    mem[(8 * ceil32(return_data.size)) + 4196] = arg1
    require ext_code.size(seedContractAddress)
    staticcall seedContractAddress.getCurrentPrice(uint256 arg1) with:
            gas gas_remaining wei
           args arg1
    mem[(8 * ceil32(return_data.size)) + 4192] = ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    mem[(8 * ceil32(return_data.size)) + 4160] = ext_call.return_data[0]
    ...
    mem[(10 * ceil32(return_data.size)) + 4256] = mem[(2 * ceil32(return_data.size)) + 2252 len 20]
