...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0x55f39e01af0d045ef13e8edd6eb699494eb7b3c5)
    delegate 0x55f39e01af0d045ef13e8edd6eb699494eb7b3c5.0x66098d4f with:
         gas gas_remaining - 50 wei
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0x55f39e01af0d045ef13e8edd6eb699494eb7b3c5):
                            delegate 0x55f39e01af0d045ef13e8edd6eb699494eb7b3c5.0x66098d4f with:
                                 gas gas_remaining - 50 wei
