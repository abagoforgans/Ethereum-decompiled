...
function claim() {
    ...
    if sub_3876ed9f[address(msg.sender)]:
        if sub_65024a89 >= 125 * 10^11 * 3600:
            ...
            call this.address.0xa9059cbb with:
                 gas gas_remaining - 710 wei
                args msg.sender, 250000 * 10^18 * 3600 * etherBalanceOf[address(msg.sender)] / sub_65024a89
        require ext_call.success
...
function finalize() {
    ...
    if sub_65024a89 < 125 * 10^11 * 3600:
        ...
        balances[stor9] = 6000000000 * 10^18
        ...
        if sub_65024a89 >= 555 * 10^15:
            ...
            balances[stor9] = 2600000000 * 10^18
            ...
            balances[stor9] = (-1 * 10^10 * sub_65024a89) + -((-1 * 10^10 * sub_65024a89) + (2625000 * 10^18 * 24 * 3600) / 3) + (2625000 * 10^18 * 24 * 3600)
