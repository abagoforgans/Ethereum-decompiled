...
function sub_c638100b(?) payable {
    call address(stor1989.field_0).0x4166c1fd with:
...
function sub_8fdaa2ee(?) payable {
    call address(stor1989.field_0).0x4166c1fd with:
         gas gas_remaining - 25050 wei
        args arg1 << 248, arg2
    require ext_call.success
    Mask(96, 0, stor1989.field_160) = Mask(96, 0, ext_call.return_data[0])
    return ext_call.return_data[31 len 1]
}
    ...
    if address(stor[(6 * arg2) + (198 * arg1) + 1].field_0) == msg.sender:
        ...
        if block.number - uint256(stor[(6 * arg2) + (198 * arg1) + 5].field_0) >= 4320:
            ...
            while uint8(idx) < 20:
                ...
                if uint8(idx) != 0:
                    stor[uint256(stor[(6 * arg2) + (198 * arg1) + 4].field_0) + sha3((6 * arg2) + (198 * arg1) + 4) - 1].field_0 % 32 = (block.hash(block.number - 1) % 16^(-(2 * idx % 128) + 64)) - (block.hash(block.number - 1) % 16^(-(2 * idx % 128) + 64) % 16^(-(2 * idx % 128) + 62)) / 16^(-(2 * idx % 128) + 62) % 32
                else:
                    stor[uint256(stor[(6 * arg2) + (198 * arg1) + 4].field_0) + sha3((6 * arg2) + (198 * arg1) + 4) - 1].field_0 % 32 = block.hash(block.number - 1) - (block.hash(block.number - 1) % 16^(-(2 * idx % 128) + 62)) / 16^(-(2 * idx % 128) + 62) % 32
                stor[uint256(stor[(6 * arg2) + (198 * arg1) + 4].field_0) + sha3((6 * arg2) + (198 * arg1) + 4) - 1].field_5 % 8 = 0
                require arg1 < 33
                require arg2 < 33
                require arg1 < 33
                require arg2 < 33
...
function sub_edffcd57(?) payable {
    ...
    while uint8(idx) < uint256(stor[(6 * arg2) + (198 * arg1) + 2].field_0):
        ...
        if not uint256(stor[(6 * arg2) + (198 * arg1) + 2].field_0) <= uint256(stor[(6 * arg2) + (198 * arg1) + 2].field_0) - 1:
            mem[0] = (6 * arg2) + (198 * arg1) + 2
            idx = uint256(stor[(6 * arg2) + (198 * arg1) + 2].field_0) + sha3((6 * arg2) + (198 * arg1) + 2) - 1
            while sha3((6 * arg2) + (198 * arg1) + 2) + uint256(stor[(6 * arg2) + (198 * arg1) + 2].field_0) > idx:
        ...
        if not uint256(stor[(6 * arg2) + (198 * arg1) + 3].field_0) <= uint256(stor[(6 * arg2) + (198 * arg1) + 3].field_0) - 1:
            mem[0] = (6 * arg2) + (198 * arg1) + 3
            idx = uint256(stor[(6 * arg2) + (198 * arg1) + 3].field_0) + sha3((6 * arg2) + (198 * arg1) + 3) - 1
            while sha3((6 * arg2) + (198 * arg1) + 3) + uint256(stor[(6 * arg2) + (198 * arg1) + 3].field_0) > idx:
                uint256(stor[idx].field_0) = 0
                require arg2 < 33
                idx = idx + 1
                continue 
