...
function _fallback() payable {
    ...
    stor0 = code.data[1608 len 20]
    stor1 = 10^18 * code.data[1628 len 32]
    stor3 = block.timestamp + (60 * code.data[1660 len 32])
    stor4 = 10^18 * code.data[1692 len 32]
    stor5 = code.data[1736 len 20]
    return code.data[171 len 1425]
}
...
function _fallback() payable {
    if amountRaised <= 20000:
        price = 180
    else:
        if amountRaised >= 80000:
            price = 300
        else:
            price = 240
