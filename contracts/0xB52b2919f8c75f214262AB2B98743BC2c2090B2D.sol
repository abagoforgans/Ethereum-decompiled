...
function sub_ef50f76a(?) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 64
    return ext_call.return_data[0], ext_call.return_data[0], arg3
}
...
function sub_7f520499(?) {
    ...
    return ext_call.return_data[0], 10^18 * arg3 / ext_call.return_data[0]
}

function sub_92edac08(?) {
    mem[128 len 32 * arg1.length] = call.data[arg1 + 36 len 32 * arg1.length]
    require 0 < arg1.length
    require 1 < arg1.length
    require ext_code.size(0xb89570f6ad742cb1fd440a930d6c2a2ea29c51ee)
    ...
    require return_data.size >= 64
    require ext_call.return_data[0]
    require (4 * ext_call.return_data[0] * 10^18 * arg3 / ext_call.return_data[0]) - (2 * ext_call.return_data[0] * 10^18 * arg3 / ext_call.return_data[0])
    return 10^18 * arg3 / ext_call.return_data[0], 
           ext_call.return_data[0],
           (ext_call.return_data[0] * ext_call.return_data[0]) - (10^18 * arg3 / ext_call.return_data[0] * ext_call.return_data[0]) / (4 * ext_call.return_data[0] * 10^18 * arg3 / ext_call.return_data[0]) - (2 * ext_call.return_data[0] * 10^18 * arg3 / ext_call.return_data[0]),
           '3 step'
}

function sub_6f22b479(?) {
    mem[128 len 32 * arg1.length] = call.data[arg1 + 36 len 32 * arg1.length]
    require 0 < arg1.length
    require 1 < arg1.length
    require ext_code.size(0xb89570f6ad742cb1fd440a930d6c2a2ea29c51ee)
    ...
    require return_data.size >= 64
    require ext_call.return_data[0]
    if 10^18 * arg3 / ext_call.return_data[0] >= ext_call.return_data[0]:
        return 10^18 * arg3 / ext_call.return_data[0], ext_call.return_data[0], 0, 128, 6, '1 step' % 281474976710656
    require 0 < arg1.length
    require 1 < arg1.length
    require ext_code.size(0xb89570f6ad742cb1fd440a930d6c2a2ea29c51ee)
    call 0xb89570f6ad742cb1fd440a930d6c2a2ea29c51ee.getReturn(address arg1, address arg2, uint256 arg3) with:
