...
function allowance(address arg1, address arg2) {
    ...
    return uint256(allowance[arg1][arg2])
}
...
function burnFrom(address arg1, uint256 arg2) {
    ...
    require arg2 <= uint256(allowance[address(arg1)][address(msg.sender)])
    balanceOf[address(arg1)] -= arg2
    uint256(allowance[address(arg1)][address(msg.sender)]) -= arg2
    totalSupply -= arg2
    emit Burn(arg2, arg1);
    return 1
}
...
function sub_3f3d1086(?) {
    ...
    require arg1 + 36 <= calldata.size
    require arg1.length <= 4294967296 and arg1 + arg1.length + 36 <= calldata.size
    mem[ceil32(arg1.length) + 128] = bool(stor15[arg1[all]])
    return Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)]
}
...
function sub_8df5aa96(?) {
    require calldata.size - 4 >= 32
    mem[128 len 20] = code.data[24416 len 20]
    idx = 0
    while idx < 20:
        require 2^(8 * -idx + 19)
        require idx < 20
...
function sub_ae8bfb69(?) {
    ...
    mem[ceil32(arg1.length) + 128 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
    mem[ceil32(arg1.length) + floor32(arg1.length) + -(arg1.length % 32) + 160 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    mem[arg1.length + ceil32(arg1.length) + 128] = 14
    mem[ceil32(arg1.length) + 128] = uint256(stor[mem[arg1.length + 160 len ceil32(arg1.length)]][Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0)].field_0)
    return Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)]
}
...
function sub_6a96c21f(?) {
    ...
    return memory
      from mem[64]
       len floor32(_116) + _114 + -mem[64] + 96
}
        ...
        if 431400 * 24 * 3600 >= block.timestamp:
            if 431904 * 24 * 3600 >= block.timestamp:
                if 432408 * 24 * 3600 >= block.timestamp:
                    require 432864 * 24 * 3600 < block.timestamp
                    require 433368 * 24 * 3600 > block.timestamp
...
function sub_560b3dd2(?) {
    ...
    mem[ceil32(arg1.length) + 160 len 20] = code.data[24416 len 20]
    idx = 0
    while idx < 20:
        require 2^(8 * -idx + 19)
        require idx < Mask(8 * -ceil32(arg1.length) + arg1.length + 32, 0, 0), mem[arg1.length + 160 len -arg1.length + ceil32(arg1.length)]
        mem[ceil32(arg1.length) + idx + 160 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('div', ('type', 160, ('field', 0, ('stor', ('add', 3, ('mul', 4, ('param', 'arg2')), ('var', '_39'))))), ('exp', 2, ('mask_shl', 253, 0, 3, ('add', 19, ('mul', -1, ('var', 0))))))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('div', ('type', 160, ('field', 0, ('stor', ('add', 3, ('mul', 4, ('param', 'arg2')), ('var', '_39'))))), ('exp', 2, ('mask_shl', 253, 0, 3, ('add', 19, ('mul', -1, ('var', 0))))))), 0) - 256
        idx = idx + 1
        continue 
    ...
    mem[arg1.length + _44 + ceil32(arg1.length) + floor32(arg1.length + _44) + -(arg1.length + _44 % 32) + 256 len arg1.length + _44 % 32] = mem[ceil32(arg1.length) + -(arg1.length + _44 % 32) + floor32(arg1.length + _44) + 256 len arg1.length + _44 % 32]
    mem[(2 * arg1.length) + (2 * _44) + ceil32(arg1.length) + 224] = 15
    ...
    mem[(2 * floor32(arg1.length)) + _44 + ceil32(arg1.length) + 256 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    mem[(2 * arg1.length) + _44 + ceil32(arg1.length) + 224] = 11
    ...
    mem[arg1.length + _44 + ceil32(arg1.length) + 224 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
    mem[(2 * floor32(arg1.length)) + _44 + ceil32(arg1.length) + 256 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    mem[(2 * arg1.length) + _44 + ceil32(arg1.length) + 224] = 9
    ...
    mem[(2 * floor32(arg1.length)) + _44 + ceil32(arg1.length) + 256 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    mem[(2 * arg1.length) + _44 + ceil32(arg1.length) + 224] = 9
    _544 = sha3(call.data[arg1 + 36 len floor32(arg1.length)], mem[arg1.length + _44 + ceil32(arg1.length) + floor32(arg1.length) + 224 len (arg1.length % 32) + 32])
    require msg.sender
    require balanceOf[stor4] >= stor8[('map', ('call.data', ('add', 36, ('param', 'arg1')), ('mask_shl', 251, 5, 0, ('cd', ('add', 4, ('param', 'arg1'))))), ('mem', ('range', ('add', 224, ('cd', ('add', 4, ('param', 'arg1'))), ('var', '_44'), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1'))))), ('mask_shl', 251, 5, 0, ('cd', ('add', 4, ('param', 'arg1'))))), ('add', 32, ('mask_shl', 5, 0, 0, ('cd', ('add', 4, ('param', 'arg1'))))))))]
    ...
    emit Transfer(stor8[_544], fundsWalletAddress, msg.sender);
    require balanceOf[stor4] + balanceOf[address(msg.sender)] == balanceOf[stor4] + balanceOf[address(msg.sender)]
    mem[arg1.length + _44 + ceil32(arg1.length) + 224 len floor32(arg1.length + _44)] = mem[ceil32(arg1.length) + 224 len floor32(arg1.length + _44)]
    mem[arg1.length + _44 + ceil32(arg1.length) + floor32(arg1.length + _44) + -(arg1.length + _44 % 32) + 256 len arg1.length + _44 % 32] = mem[ceil32(arg1.length) + -(arg1.length + _44 % 32) + floor32(arg1.length + _44) + 256 len arg1.length + _44 % 32]
    mem[(2 * arg1.length) + (2 * _44) + ceil32(arg1.length) + 224] = 15
    uint8(stor[mem[arg1.length + _44 + ceil32(arg1.length) + 256 len arg1.length + _44]][stor8[_544]].field_0) = 1
    mem[arg1.length + _44 + ceil32(arg1.length) + 224 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
    mem[(2 * floor32(arg1.length)) + _44 + ceil32(arg1.length) + 256 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    mem[(2 * arg1.length) + _44 + ceil32(arg1.length) + 224] = 14
...
function sub_64ff7153(?) {
    ...
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 192 len 20] = code.data[24416 len 20]
    idx = 0
    while idx < 20:
        require 2^(8 * -idx + 19)
        ...
        mem[ceil32(arg1.length) + ceil32(arg2.length) + idx + 192 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('div', 'msg.sender', ('exp', 2, ('mask_shl', 253, 0, 3, ('add', 19, ('mul', -1, ('var', 0))))))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('div', 'msg.sender', ('exp', 2, ('mask_shl', 253, 0, 3, ('add', 19, ('mul', -1, ('var', 0))))))), 0) - 256
        idx = idx + 1
        continue 
    ...
    mem[arg1.length + _21 + ceil32(arg1.length) + ceil32(arg2.length) + floor32(arg1.length + _21) + -(arg1.length + _21 % 32) + 288 len arg1.length + _21 % 32] = mem[ceil32(arg1.length) + ceil32(arg2.length) + -(arg1.length + _21 % 32) + floor32(arg1.length + _21) + 288 len arg1.length + _21 % 32]
    mem[(2 * arg1.length) + (2 * _21) + ceil32(arg1.length) + ceil32(arg2.length) + 256] = 12
    ...
    mem[(2 * floor32(arg1.length)) + _21 + ceil32(arg1.length) + ceil32(arg2.length) + 288 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    mem[(2 * arg1.length) + _21 + ceil32(arg1.length) + ceil32(arg2.length) + 256] = 9
    ...
    mem[(2 * floor32(arg1.length)) + _21 + ceil32(arg1.length) + ceil32(arg2.length) + 288 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    mem[(2 * arg1.length) + _21 + ceil32(arg1.length) + ceil32(arg2.length) + 256] = 9
    _809 = sha3(call.data[arg1 + 36 len floor32(arg1.length)], mem[arg1.length + _21 + ceil32(arg1.length) + ceil32(arg2.length) + floor32(arg1.length) + 256 len (arg1.length % 32) + 32])
    ...
    emit Transfer(stor8[_809], msg.sender, fundsWalletAddress);
    require balanceOf[address(msg.sender)] + balanceOf[stor4] == balanceOf[address(msg.sender)] + balanceOf[stor4]
    mem[arg1.length + _21 + ceil32(arg1.length) + ceil32(arg2.length) + 256 len floor32(arg1.length + _21)] = mem[ceil32(arg1.length) + ceil32(arg2.length) + 256 len floor32(arg1.length + _21)]
    mem[arg1.length + _21 + ceil32(arg1.length) + ceil32(arg2.length) + floor32(arg1.length + _21) + -(arg1.length + _21 % 32) + 288 len arg1.length + _21 % 32] = mem[ceil32(arg1.length) + ceil32(arg2.length) + -(arg1.length + _21 % 32) + floor32(arg1.length + _21) + 288 len arg1.length + _21 % 32]
    mem[(2 * arg1.length) + (2 * _21) + ceil32(arg1.length) + ceil32(arg2.length) + 256] = 12
    uint8(stor[mem[arg1.length + _21 + ceil32(arg1.length) + ceil32(arg2.length) + 288 len arg1.length + _21]][stor8[_809]].field_0) = 1
    mem[arg1.length + _21 + ceil32(arg1.length) + ceil32(arg2.length) + 256 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
    mem[(2 * floor32(arg1.length)) + _21 + ceil32(arg1.length) + ceil32(arg2.length) + 288 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    mem[(2 * arg1.length) + _21 + ceil32(arg1.length) + ceil32(arg2.length) + 256] = 11
    ...
    mem[(2 * floor32(arg1.length)) + _21 + ceil32(arg1.length) + ceil32(arg2.length) + 416 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    mem[(2 * arg1.length) + _21 + ceil32(arg1.length) + ceil32(arg2.length) + 384] = 11
...
function sub_9ebe193a(?) payable {
    ...
    mem[arg1.length + ceil32(arg1.length) + ceil32(arg3.length) + 160] = 9
    ...
    mem[ceil32(arg1.length) + ceil32(arg3.length) + 160 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
    mem[ceil32(arg1.length) + ceil32(arg3.length) + floor32(arg1.length) + -(arg1.length % 32) + 192 len arg1.length % 32] = mem[-(arg1.length % 32) + floor32(arg1.length) + 160 len arg1.length % 32]
    mem[arg1.length + ceil32(arg1.length) + ceil32(arg3.length) + 160] = 11
    ...
    mem[ceil32(arg1.length) + ceil32(arg3.length) + 192 len 20] = code.data[24416 len 20]
    idx = 0
    while idx < 20:
        require 2^(8 * -idx + 19)
        ...
        mem[ceil32(arg1.length) + ceil32(arg3.length) + idx + 192 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('div', ('type', 160, ('field', 0, ('stor', ('add', 3, ('mul', 4, ('param', 'arg2')), ('var', '_40'))))), ('exp', 2, ('mask_shl', 253, 0, 3, ('add', 19, ('mul', -1, ('var', 0))))))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('div', ('type', 160, ('field', 0, ('stor', ('add', 3, ('mul', 4, ('param', 'arg2')), ('var', '_40'))))), ('exp', 2, ('mask_shl', 253, 0, 3, ('add', 19, ('mul', -1, ('var', 0))))))), 0) - 256
        idx = idx + 1
        continue 
    ...
    mem[(2 * arg1.length) + (2 * _45) + ceil32(arg1.length) + ceil32(arg3.length) + 256] = 15
    ...
    mem[(2 * arg1.length) + _45 + ceil32(arg1.length) + ceil32(arg3.length) + 256] = 9
    require msg.sender == address(allowance[('map', ('call.data', ('add', 36, ('param', 'arg1')), ('mask_shl', 251, 5, 0, ('cd', ('add', 4, ('param', 'arg1'))))), ('mem', ('range', ('add', 256, ('cd', ('add', 4, ('param', 'arg1'))), ('var', '_45'), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg1'))))), ('mask_shl', 251, 5, 0, ('add', 31, ('cd', ('add', 4, ('param', 'arg3'))))), ('mask_shl', 251, 5, 0, ('cd', ('add', 4, ('param', 'arg1'))))), ('add', 32, ('mask_shl', 5, 0, 0, ('cd', ('add', 4, ('param', 'arg1'))))))))])
    mem[arg1.length + _45 + ceil32(arg1.length) + ceil32(arg3.length) + 256 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
    mem[(2 * floor32(arg1.length)) + _45 + ceil32(arg1.length) + ceil32(arg3.length) + 288 len arg1.length % 32] = mem[floor32(arg1.length) + -(arg1.length % 32) + 160 len arg1.length % 32]
    mem[(2 * arg1.length) + _45 + ceil32(arg1.length) + ceil32(arg3.length) + 256] = 9
    ...
    mem[arg1.length + _45 + ceil32(arg1.length) + ceil32(arg3.length) + 256 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
    mem[(2 * floor32(arg1.length)) + _45 + ceil32(arg1.length) + ceil32(arg3.length) + 288 len arg1.length % 32] = mem[floor32(arg1.length) + -(arg1.length % 32) + 160 len arg1.length % 32]
    mem[(2 * arg1.length) + _45 + ceil32(arg1.length) + ceil32(arg3.length) + 256] = 14
