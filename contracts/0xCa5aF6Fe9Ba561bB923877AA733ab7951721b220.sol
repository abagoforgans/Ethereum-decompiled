...
address owner;
uint256 preICO;
uint256 sub_f75dd4a7;
uint256 sub_81a978e3;
uint256 sub_11c9d74b;
uint256 rate;
    ...
    if block.timestamp < 429528 * 24 * 3600:
        ...
        if block.timestamp <= 1551398399:
            ...
            if msg.value:
                ...
                preICO += 200 * msg.value
            if preICO <= 150000000 * 10^18:
                call stor20 with:
                   value msg.value wei
                     gas 2300 * is_zero(value) wei
                if not ext_call.success:
            ...
            if block.timestamp < 430944 * 24 * 3600:
                ...
                if block.timestamp <= 1556668799:
                    ...
                    if msg.value:
                        ...
                        sub_f75dd4a7 += 100 * msg.value
                    if sub_f75dd4a7 <= 330000000 * 10^18:
                        call stor20 with:
                           value msg.value wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                    ...
                    if block.timestamp < 432408 * 24 * 3600:
                        ...
                        if block.timestamp > 1559347199:
                            ...
                            if msg.value:
                                ...
                                sub_81a978e3 += 50 * msg.value
                            if sub_81a978e3 <= 330000000 * 10^18:
                                call stor20 with:
                                   value msg.value wei
                                     gas 2300 * is_zero(value) wei
                                if not ext_call.success:
