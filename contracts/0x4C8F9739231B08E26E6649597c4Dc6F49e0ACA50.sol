...
function sub_a538bd90(?) payable {
    uint256(stor6.field_0) = 10
    address(stor4) = 0
    address(stor5) = 0
}
...
function sub_797fdd7b(?) payable {
    uint256(stor4) = tx.origin or Mask(96, 160, uint256(stor4))
