...
function _fallback() payable {
    ...
    mem[96 len -3319] = code.data[3999 len -3319]
    mem[64] = -3223
    _2 = mem[96]
    _3 = mem[128]
    _4 = mem[160]
...
function withdrawAssets() {
    ...
    while idx < assets.length:
        mem[0] = 2
        require owner == msg.sender
        if assets[idx].field_0:
            require ext_code.size(assets[idx].field_0)
            call assets[idx].field_0.balanceOf(address rg1) with:
                 gas gas_remaining - 710 wei
                args this.address
            require ext_call.success
            ...
            require ext_code.size(assets[idx].field_0)
            call assets[idx].field_0.transfer(address rg1, uint256 rg2) with:
                 gas gas_remaining - 710 wei
                args msg.sender, ext_call.return_data[0]
            require ext_call.success
        idx = idx + 1
...
function buy() payable {
    ...
    while idx < assets.length:
        ...
        if msg.value:
            require msg.value
            require sub_bc9113f0 * msg.value / msg.value == sub_bc9113f0
        require assets[idx].field_256
        if sub_bc9113f0 * msg.value / assets[idx].field_256:
            require sub_bc9113f0 * msg.value / assets[idx].field_256
            require assets[idx].field_512 * sub_bc9113f0 * msg.value / assets[idx].field_256 / sub_bc9113f0 * msg.value / assets[idx].field_256 == assets[idx].field_512
        require sub_011dca50
        if assets[idx].field_512 * sub_bc9113f0 * msg.value / assets[idx].field_256 / sub_011dca50 > 0:
            require ext_code.size(assets[idx].field_0)
            call assets[idx].field_0.balanceOf(address rg1) with:
                 gas gas_remaining - 710 wei
                args this.address
            require ext_call.success
            require ext_call.return_data[0] >= assets[idx].field_512 * sub_bc9113f0 * msg.value / assets[idx].field_256 / sub_011dca50
            mem[96] = 0xa9059cbb00000000000000000000000000000000000000000000000000000000
            mem[100] = msg.sender
            mem[132] = assets[idx].field_512 * sub_bc9113f0 * msg.value / assets[idx].field_256 / sub_011dca50
            require ext_code.size(assets[idx].field_0)
            call assets[idx].field_0.transfer(address rg1, uint256 rg2) with:
                 gas gas_remaining - 710 wei
                args msg.sender, assets[idx].field_512 * sub_bc9113f0 * msg.value / assets[idx].field_256 / sub_011dca50
            require ext_call.success
        idx = idx + 1
        continue 
    ...
    if sub_bc9113f0 * msg.value / assets[assets.length].field_0:
        require sub_bc9113f0 * msg.value / assets[assets.length].field_0
        require sub_d65bcbf2 * sub_bc9113f0 * msg.value / assets[assets.length].field_0 / sub_bc9113f0 * msg.value / assets[assets.length].field_0 == sub_d65bcbf2
    require sub_011dca50
    if sub_d65bcbf2 * sub_bc9113f0 * msg.value / assets[assets.length].field_0 / sub_011dca50 > 0:
        require ext_code.size(assets[assets.length].field_0)
        call assets[assets.length].field_0.balanceOf(address rg1) with:
             gas gas_remaining - 710 wei
            args this.address
        require ext_call.success
        require ext_call.return_data[0] >= sub_d65bcbf2 * sub_bc9113f0 * msg.value / assets[assets.length].field_0 / sub_011dca50
        require ext_code.size(assets[assets.length].field_0)
        call assets[assets.length].field_0.transfer(address rg1, uint256 rg2) with:
             gas gas_remaining - 710 wei
            args sponsorAddress, sub_d65bcbf2 * sub_bc9113f0 * msg.value / assets[assets.length].field_0 / sub_011dca50
        require ext_call.success
}
