...
function sub_4abcbe15(?) payable {
    ...
    require arg2 <= 18
    mem[ceil32(arg3.length) + ceil32(arg4.length) + 160 len 4872] = code.data[6148 len 4872]
...
function sub_27644272(?) payable {
    ...
    mem[ceil32(arg2.length) + ceil32(arg4.length) + 160 len 4872] = code.data[6148 len 4872]
