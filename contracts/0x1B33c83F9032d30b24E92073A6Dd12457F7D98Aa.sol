...
function _fallback() payable {
    ...
    stor2 = 50000000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 15
    stor3.length.field_8 = 'YellowSnapToken' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'SNPT-Y' / 256
    idx = 0
...
function _fallback() payable {
    ...
    if not msg.value:
        if balanceOf[stor9] >= 0:
            emit Transfer(0, fundsWalletAddress, msg.sender);
