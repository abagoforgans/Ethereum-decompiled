...
function setPrices() payable {
    if startPrice + (startPrice * totalSupply / 10000) > buyPrice:
        buyPrice = startPrice + (startPrice * totalSupply / 10000)
