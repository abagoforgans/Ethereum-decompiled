...
address proxyOwner;
uint256 stor5870;
uint128 storA693; offset 160
address pendingProxyOwner;
uint256 storA693;
uint128 storDC8E; offset 160
...
function upgradeTo(address arg1) {
    ...
    Mask(96, 0, storDC8E.field_160) = 0
    emit Upgraded(arg1);
}
...
function transferProxyOwnership(address arg1) {
    ...
    Mask(96, 0, storA693.field_160) = 0
...
function claimProxyOwnership() {
    ...
    uint256(stor5870) = uint256(storA693.field_0)
    uint256(storA693.field_0) = 0
}

function _fallback() payable {
    delegate uint256(storDC8E.field_0) with:
