...
function _fallback() payable {
    ...
    mem[160 len -8905] = code.data[9769 len -8905]
    address(stor3.field_0) = msg.sender
    require mem[192] > 0
    require mem[236 len 20]
    stor13 = mem[192]
    stor12 = mem[160]
    address(stor11.field_40) = mem[236 len 20]
...
function stopPreIco() {
    ...
    require not uint8(stor3.field_160)
    require totalSupply + (6 * totalSupply / 100) >= totalSupply
    totalSupply += 6 * totalSupply / 100
    require balanceOf[address(stor11.field_0)] + (6 * totalSupply / 100) >= balanceOf[address(stor11.field_0)]
    balanceOf[address(stor11.field_0)] += 6 * totalSupply / 100
    emit Mint((6 * totalSupply / 100), walletAddress);
    return 1
}
...
function stopIco(address arg1) {
    ...
    require not uint8(stor11.field_32)
    require arg1
    Mask(248, 0, stor11.field_8) = 0
    uint8(stor11.field_0) = 0
    bool(currentState.length) = 0
    ...
    require not uint8(stor3.field_160)
    require totalSupply + (14 * totalSupply / 100) >= totalSupply
    totalSupply += 14 * totalSupply / 100
    require balanceOf[address(stor11.field_0)] + (14 * totalSupply / 100) >= balanceOf[address(stor11.field_0)]
    balanceOf[address(stor11.field_0)] += 14 * totalSupply / 100
    emit Mint((14 * totalSupply / 100), walletAddress);
    require not uint8(stor3.field_160)
    require totalSupply + (14 * totalSupply / 100) >= totalSupply
    totalSupply += 14 * totalSupply / 100
    require balanceOf[address(arg1)] + (14 * totalSupply / 100) >= balanceOf[address(arg1)]
    balanceOf[address(arg1)] += 14 * totalSupply / 100
    emit Mint((14 * totalSupply / 100), arg1);
    Mask(96, 0, stor3.field_160) = 1
    emit MintFinished()
    return 1
}
