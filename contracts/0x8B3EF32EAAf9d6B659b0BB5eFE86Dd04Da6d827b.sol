...
function sub_65ea4e21(?) {
    ...
    call 0xcbc6a023eb975a1e2630223a7959988948e664f3.quickConvertPrioritized(address[] arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint8 arg5, bytes32 arg6, bytes32 arg7) with:
         gas gas_remaining wei
        args Array(len=arg1.length, data=call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + floor32(arg1.length) + 388 len (32 * arg1.length) - floor32(arg1.length)]), ext_call.return_data[0], 1, arg6, arg3 << 248, Mask(8, 248, arg4), Mask(8, 248, arg5)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if msg.sender == 0xdead1241f2ee2a7950ad967993efb72d62bf6822:
        if eth.balance(this.address) >= arg2:
            ...
            call 0xcbc6a023eb975a1e2630223a7959988948e664f3.quickConvertPrioritized(address[] arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint8 arg5, bytes32 arg6, bytes32 arg7) with:
               value arg2 wei
                 gas gas_remaining wei
                args Array(len=arg1.length, data=call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + floor32(arg1.length) + 388 len (32 * arg1.length) - floor32(arg1.length)]), arg2, 1, arg6, arg3 << 248, Mask(8, 248, arg4), Mask(8, 248, arg5)
            mem[(32 * arg1.length) + 128] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            ...
            call 0xcbc6a023eb975a1e2630223a7959988948e664f3.quickConvertPrioritized(address[] arg1, uint256 arg2, uint256 arg3, uint256 arg4, uint8 arg5, bytes32 arg6, bytes32 arg7) with:
               value eth.balance(this.address) wei
                 gas gas_remaining wei
                args Array(len=arg1.length, data=call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + floor32(arg1.length) + 388 len (32 * arg1.length) - floor32(arg1.length)]), eth.balance(this.address), 1, arg6, arg3 << 248, Mask(8, 248, arg4), Mask(8, 248, arg5)
            mem[(32 * arg1.length) + 128] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
