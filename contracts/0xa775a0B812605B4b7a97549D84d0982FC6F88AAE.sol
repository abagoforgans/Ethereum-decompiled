...
function finalizeCrowdsale() payable {
    ...
    if uint8(var34009) < 0xc331051700000000000000000000000000000000000000000000000000000000:
        ...
        if var52007 > 0:
            ...
            require ext_code.size(0xb13e18faf9ddaa051cea6dc0144628bdfc8c4a4b)
            delegate 0xb13e18faf9ddaa051cea6dc0144628bdfc8c4a4b.mem[var60002 len 4] with:
                 gas gas_remaining - 710 wei
            ...
            while uint8(idx + 1) < ext_call.return_data[0]:
                ...
                require ext_code.size(0xb13e18faf9ddaa051cea6dc0144628bdfc8c4a4b)
                delegate 0xb13e18faf9ddaa051cea6dc0144628bdfc8c4a4b.0x66098d4f with:
                     gas gas_remaining - 710 wei
                ...
                if ext_call.success:
                    ...
                    if ext_code.size(tokenAddress):
                        ...
                        if ext_call.success:
                            ...
                            mem[100] = var47007
                            mem[132] = var47001
                            if ext_code.size(0xb13e18faf9ddaa051cea6dc0144628bdfc8c4a4b):
                                delegate 0xb13e18faf9ddaa051cea6dc0144628bdfc8c4a4b.mem[var49002 len 4] with:
                                     gas gas_remaining - 710 wei
