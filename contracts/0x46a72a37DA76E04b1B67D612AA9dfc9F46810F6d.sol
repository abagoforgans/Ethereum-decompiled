...
function sub_18c9dbe8(?) {
    ...
    if not arg1:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        return (ext_call.return_data[0] == 2000)
    if arg1 == 5:
    ...
    if arg1 >= 9:
        return 0
    return (ext_call.return_data[0] == 5000)
}
...
function register(address arg1) {
    ...
    mem[352] = code.data[15490 len 32]
    mem[384] = 1
    mem[416] = code.data[15490 len 32]
...
function finish() payable {
    ...
    if not uint256(sub_47014b9a[address(msg.sender)].field_256):
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0] == 2000 == 1
    else:
        if uint256(sub_47014b9a[address(msg.sender)].field_256) == 5:
        ...
        if uint256(sub_47014b9a[address(msg.sender)].field_256) < 5:
            require ext_call.return_data[0] == 1000 == 1
        else:
            require uint256(sub_47014b9a[address(msg.sender)].field_256) < 9
            require ext_call.return_data[0] == 5000 == 1
    ...
    if uint256(sub_47014b9a[address(msg.sender)].field_256) < 5:
        if uint256(sub_47014b9a[address(msg.sender)].field_256):
            ...
            call address(stor3.length).0x23b872dd with:
                 gas gas_remaining wei
                args msg.sender, address(stor2.length), 1000
        else:
            mem[164] = 2000
            require ext_code.size(address(stor3.length))
            call address(stor3.length).0x23b872dd with:
                 gas gas_remaining wei
                args msg.sender, address(stor2.length), 2000
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        ...
        while idx < uint256(sub_47014b9a[address(msg.sender)].field_1024):
            ...
            call address(stor3.length).0xa9059cbb with:
                 gas gas_remaining wei
                args sub_47014b9a[address(msg.sender)][idx + 4].field_0, 700
        ...
        if uint256(sub_47014b9a[address(msg.sender)].field_256):
            ...
            call address(stor3.length).0x23b872dd with:
                 gas gas_remaining wei
                args msg.sender, address(stor2.length), 5000
        else:
            mem[164] = 10000
            require ext_code.size(address(stor3.length))
            call address(stor3.length).0x23b872dd with:
                 gas gas_remaining wei
                args msg.sender, address(stor2.length), 10000
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require ext_call.return_data[0]
        ...
        while idx < uint256(sub_47014b9a[address(msg.sender)].field_1024):
            ...
            call address(stor3.length).0xa9059cbb with:
                 gas gas_remaining wei
                args sub_47014b9a[address(msg.sender)][idx + 4].field_0, 3500
            mem[96] = ext_call.return_data[0]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
    ...
    mem[128] = code.data[15490 len 32]
    uint256(sub_47014b9a[address(msg.sender)].field_1024) = 1
    s = 0
    idx = 128
    while 160 > idx:
