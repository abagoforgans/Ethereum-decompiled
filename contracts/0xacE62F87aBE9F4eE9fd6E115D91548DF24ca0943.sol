...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor0 = msg.sender
    stor1 = code.data[7807 len 20]
    require stor0 == msg.sender
    stor2 = code.data[7839 len 20]
    require ext_code.size(code.data[7839 len 20])
    call code.data[7839 len 20].isPricingStrategy() with:
         gas gas_remaining - 50 wei
    require ext_call.success
    require ext_call.return_data[0]
    stor4 = code.data[7871 len 20]
    require code.data[7871 len 20]
    require code.data[7891 len 32]
    stor6 = code.data[7891 len 32]
    require code.data[7923 len 32]
    stor7 = code.data[7923 len 32]
    require stor6 < code.data[7923 len 32]
    stor5 = code.data[7955 len 32]
    stor18 = code.data[7987 len 32]
    return code.data[538 len 7257]
}
...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0xd73affd658e8eff4df0da39492b24bb8e8713d3f)
    delegate 0xd73affd658e8eff4df0da39492b24bb8e8713d3f.0x66098d4f with:
         gas gas_remaining - 50 wei
...
function preallocate(address arg1, uint256 arg2, uint256 arg3) {
    ...
    delegate 0xd73affd658e8eff4df0da39492b24bb8e8713d3f.0x66098d4f with:
         gas gas_remaining - 50 wei
        args uint256(weiRaised), arg3 * arg2 * 10^ext_call.return_data[0]
    require delegate.return_code
    ...
    delegate 0xd73affd658e8eff4df0da39492b24bb8e8713d3f.0x66098d4f with:
         gas gas_remaining - 50 wei
        args investedAmountOf[address(arg1)], arg3 * arg2 * 10^ext_call.return_data[0]
    require delegate.return_code
    ...
    require ext_call.success
    emit Invested(address(arg1), arg3 * arg2 * 10^ext_call.return_data[0], arg2 * 10^ext_call.return_data[0], 0);
}
            ...
            if uint256(weiRaised) > 0:
                if loadedRefund >= uint256(weiRaised):
                    if investedAmountOf[address(msg.sender)]:
                        ...
                        if ext_code.size(0xd73affd658e8eff4df0da39492b24bb8e8713d3f):
                            delegate 0xd73affd658e8eff4df0da39492b24bb8e8713d3f.0x66098d4f with:
                                 gas gas_remaining - 50 wei
