                ...
                if ext_call.return_data[0] == -1:
                    ...
                    call sub_3a7b779eAddress.deposit() with:
                       value 10^17 wei
                         gas gas_remaining - 34050 wei
                    require ext_call.success
                    call sub_3a7b779eAddress.scheduleCall(address rg1, bytes4 rg2, bytes32 rg3, uint256 rg4) with:
                         gas gas_remaining - 25050 wei
                        args 0, 0, Mask(32, 224, sha3('alarm()')), sha3(None), block.number + 45
                    sub_85463816 = 1
