...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor2 = msg.sender
    return code.data[385 len 12385]
}
...
#
address stor0;
address sub_5fb17686Address;
address stor2;
array of address stor3;
address stor4;
mapping of uint256 balanceOf;
mapping of uint256 checkRewards;
uint256 stor7;
...
function checkRewards(address arg1) {
    return checkRewards[address(arg1)]
}
...
function sub_5fb17686(?) {
    return sub_5fb17686Address
}
...
function sub_b098d481(?) {
    ...
    require msg.sender == sub_5fb17686Address
    selfdestruct(stor2)
}
...
function withdrawRewards() {
    if not checkRewards[address(msg.sender)]:
        emit StatEvent(Array(len=12, data='Balance is 0'));
        return 0
    checkRewards[address(msg.sender)] = 0
    call msg.sender with:
       value checkRewards[address(msg.sender)] wei
         gas stor25 wei
    require ext_call.success
    emit StatEventI(Array(len=12, data='Rewards Paid'), checkRewards[address(msg.sender)]);
    return checkRewards[address(msg.sender)]
}
...
function sub_b7d08137(?) {
    if msg.sender == sub_5fb17686Address:
        if not stor4:
            stor4 = arg1
            stor7 = 0
            ...
            if totalTokensMinted:
                if holdoverBalance:
                    ...
                    while idx < stor3.length:
                        ...
                        mem[0] = address(stor3[idx])
                        mem[32] = 6
                        checkRewards[address(stor3[idx])] += holdoverBalance / totalTokensMinted * balanceOf[address(stor3[idx])]
                        idx = idx + 1
