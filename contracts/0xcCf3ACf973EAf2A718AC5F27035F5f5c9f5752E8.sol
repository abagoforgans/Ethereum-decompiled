...
function hashes(uint256 arg1) payable {
    require arg1 < stor4
    return stor[code.data[1790 len 32] + arg1]
}
...
function reject(address arg1) payable {
    ...
    stor[stor1[address(arg1)] + code.data[1790 len 32]] = 0
    emit Reject(arg1);
    return 1
}
...
function sub_dfab9895(?) payable {
    ...
    while idx < stor3:
        ...
        if idx != 0:
            ...
            requests[idx] = arg2
            require idx < stor4
            stor[code.data[1790 len 32] + idx] = arg3
            ...
            stor4++
            if not stor4 <= stor4 + 1:
                idx = stor4 + code.data[1790 len 32] + 1
                while code.data[1790 len 32] + stor4 > idx:
                    stor[idx] = 0
                    idx = idx + 1
                    continue 
            require stor3 < stor3
            ...
            requests[stor3] = arg2
            require stor3 < stor4
            stor[code.data[1790 len 32] + stor3] = arg3
