            ...
            if msg.value > buildingCostWei:
                call msg.sender with:
                   value msg.value - buildingCostWei wei
                     gas 2300 * is_zero(value) wei
                require ext_call.success
    require ext_code.size(0xf0d5d04797143840b1ac26d105338b712cc9cce8)
    if arg5:
        if arg4:
            delegate 0xf0d5d04797143840b1ac26d105338b712cc9cce8.create(uint256 rg1, uint256 rg2, int256 rg3, address rg4) with:
                 gas gas_remaining - 50 wei
                args 0, uint32(arg1), arg2, arg3, arg4
        else:
            delegate 0xf0d5d04797143840b1ac26d105338b712cc9cce8.create(uint256 rg1, uint256 rg2, int256 rg3, address rg4) with:
                 gas gas_remaining - 50 wei
                args 0, uint32(arg1), arg2, arg3, arg5
