...
function _fallback() payable {
    mem[96 len -1070] = code.data[1532 len -1070]
    mem[64] = -974
...
function Mint(uint256 arg1) payable {
    if arg1 == quota:
        ...
        quota++
        if 0 == quota % 3:
            balanceOf[address(msg.sender)] += uint8(80 xor decimals)
            balanceOf[this.address] -= uint8(80 xor decimals)
            emit Transfer(uint8(decimals xor 80), this.address, msg.sender);
}
