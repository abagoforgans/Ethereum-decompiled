...
function _fallback() payable {
    mem[96 len -1651] = code.data[2171 len -1651]
    mem[64] = -1555
...
function sub_57990807(?) payable {
    ...
    stor9 = (10 * 10^6 * sub_d1e93151) - (10 * 10^6 * sub_4f7672f4)
    stor10 = (10 * 10^6 * sub_d1e93151) - (10 * 10^6 * sub_4f7672f4) / sub_ec727e13
    s = 0
    idx = 0
