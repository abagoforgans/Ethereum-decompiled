...
function setBondAddress(address arg1) {
    ...
    emit SetBondAddress(sub_730ad923Address);
}
    ...
    if ext_call.return_data[0] > 0:
        ...
        if not ext_call.return_data[0]:
            ...
            if not ext_call.return_data[0]:
                ...
                require ext_call.return_data[0] * sub_332e7470 / ext_call.return_data[0] == sub_332e7470
                require sub_9257b8f4
                require ext_code.size(sub_c2ae90e1Address)
                call sub_c2ae90e1Address.0xa9059cbb with:
                     gas gas_remaining wei
                ...
                call sub_c2ae90e1Address.0xa9059cbb with:
                     gas gas_remaining wei
                    args sub_de2e298dAddress, ext_call.return_data[0] * sub_332e7470 / sub_9257b8f4
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                emit RefundPartCollateral(sub_de2e298dAddress, ext_call.return_data[0] * sub_332e7470 / sub_9257b8f4);
        else:
            require ext_call.return_data[0]
