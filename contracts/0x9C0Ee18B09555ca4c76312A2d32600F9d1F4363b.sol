...
array of struct getContributionInfo;
            ...
            while uint16(s) < uint16(getContributionInfo[idx << 240].field_160):
                ...
                if not uint8(getContributionInfo[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))].field_8):
                    if block.timestamp - stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] >= 24 * 3600:
                        if 5 * stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] == uint256(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]):
                            ...
                            if uint8(block.timestamp - stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] / 24 * 3600) > 5:
                                if eth.balance(this.address) - stor5.length - stor6.length < (5 * stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]) - uint256(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]):
                                    ...
                                    call address(getContributionInfo[idx << 240].field_0) with:
                                       value (5 * stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]) - uint256(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]) wei
                                         gas 0 wei
                                    uint256(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]) = 5 * stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]
                                    stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] = block.timestamp
                                    if block.timestamp <= stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600):
                                        if uint8(getContributionInfo[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))].field_0):
                                            if 5 * stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] == uint256(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]):
                                ...
                                if eth.balance(this.address) - stor5.length - stor6.length < (stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(block.timestamp - stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] / 24 * 3600)) - uint256(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]):
                                    stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] = block.timestamp
                                    if block.timestamp <= stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600):
                                        if uint8(getContributionInfo[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))].field_0):
                                            if 5 * stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] == uint256(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]):
                                    ...
                                    if (stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(block.timestamp - stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] / 24 * 3600)) - uint256(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]) > 10^17:
                                        call address(getContributionInfo[idx << 240].field_0) with:
                                           value (stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(block.timestamp - stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] / 24 * 3600)) - uint256(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]) wei
                                             gas 0 wei
                                        uint256(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]) = stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] * uint8(block.timestamp - stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] / 24 * 3600)
                                        stor6[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] = block.timestamp
                                        if block.timestamp <= stor5[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] + (120 * 24 * 3600):
                                            if uint8(getContributionInfo[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))].field_0):
                                                if 5 * stor3[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))] == uint256(stor7[('map', ('mask_shl', 16, 0, 240, ('var', 1)), ('add', 1, ('sha3', ('mem', ('range', 0, 64)))))]):
