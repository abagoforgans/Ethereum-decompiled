...
function _fallback() {
    stor0 = msg.sender
    require code.data[3549 len 20]
    stor6 = code.data[3549 len 20]
    return code.data[132 len 3405]
}
...
function registerWallet(address arg1) {
    require ext_code.size(stor6)
    call stor6.0x688057fc with:
