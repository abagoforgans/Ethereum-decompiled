...
function _fallback() payable {
    ...
    mem[160 len -2172] = code.data[2591 len -2172]
...
function _fallback() payable {
    ...
    if msg.value * stor7 > 0:
        balanceOf[address(msg.sender)] += msg.value * stor7
        totalSupply += msg.value * stor7
        emit Transfer((msg.value * stor7), 0, msg.sender);
}
