...
function _fallback() payable {
    ...
    if stor5 / 100:
        require stor5 / 100
        require 5 * stor5 / 100 / stor5 / 100 == 5
    stor7 = 5 * stor5 / 100
    require (5 * stor5 / 100) + stor6 >= stor6
    stor8 = (5 * stor5 / 100) + stor6
    require (5 * stor5 / 100) + stor6 <= stor5
    stor9 = stor5 - (5 * stor5 / 100) - stor6
    stor12 = 0
    require not msg.value
    stor1 = msg.sender
    stor10 = code.data[5415 len 32]
    stor11 = code.data[5447 len 32]
    stor2[address(msg.sender)] = stor8
    return code.data[445 len 4970]
}
...
function setParameters(uint256 arg1, uint256 arg2) {
    require stor1 == msg.sender
    value = arg1
    minReq = arg2
}
