...
function _fallback() payable {
    mem[96 len -1464] = code.data[2274 len -1464]
    ...
    uint256(stor2.field_256) = Mask(96, 0, stor2.field_416)
    stor3 = mem[160]
    stor4 = mem[192]
...
function setBuyer(address arg1) {
    require address(owner) == msg.sender
    require 0 < members.length
    stor1[address(arg1)] = stor1[address(stor2.field_0)]
    uint256(members.field_0) = Mask(96, 0, members.field_160)
}

function setSeller(address arg1) {
    require address(owner) == msg.sender
    require 1 < members.length
    stor1[address(arg1)] = stor1[address(stor2.field_256)]
    uint256(members.field_256) = Mask(96, 0, members.field_416)
}
