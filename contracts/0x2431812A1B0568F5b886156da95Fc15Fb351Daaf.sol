...
function sub_842702ac(?) payable {
    ...
    while uint8(idx) < uint256(stor[(5 * arg2) + (85 * arg1) + 2].field_0):
        ...
        address(stor[sha3((5 * arg2) + (85 * arg1) + 2) + idx - 1].field_0) = address(stor[idx + sha3((5 * arg2) + (85 * arg1) + 2)].field_0)
        require arg1 < 17
        require arg2 < 17
    ...
    call address(stor[sha3((5 * arg2) + (85 * arg1) + 2) + arg3].field_0) with:
       value uint256(stor[arg3 + sha3((5 * arg2) + (85 * arg1) + 2)].field_0) wei
         gas 0 wei
    sub_0a786f34 -= uint256(stor[arg3 + sha3((5 * arg2) + (85 * arg1) + 2)].field_0)
}
    ...
    while uint8(idx) < uint256(stor[(5 * arg2) + (85 * arg1) + 2].field_0):
        ...
        if address(stor[sha3((5 * arg2) + (85 * arg1) + 2) + idx].field_0) == msg.sender:
            ...
            while uint8(s) < uint256(stor[(5 * arg2) + (85 * arg1) + 2].field_0):
                ...
                address(stor[sha3((5 * arg2) + (85 * arg1) + 2) + s - 1].field_0) = address(stor[s + sha3((5 * arg2) + (85 * arg1) + 2)].field_0)
                require arg1 < 17
                require arg2 < 17
            ...
            call address(stor[sha3((5 * arg2) + (85 * arg1) + 2) + idx].field_0) with:
               value uint256(stor[idx + sha3((5 * arg2) + (85 * arg1) + 2)].field_0) wei
                 gas 0 wei
            sub_0a786f34 -= uint256(stor[idx + sha3((5 * arg2) + (85 * arg1) + 2)].field_0)
        require arg2 < 17
        idx = idx + 1
        continue 
}
