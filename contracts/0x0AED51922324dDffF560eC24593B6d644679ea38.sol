...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'Test Token ERC20 LAT1' / 256
    idx = 0
    while stor0.length + 31 / 32 > idx:
        stor0[idx].field_0 = 0
        idx = idx + 1
        continue 
    mem[192] = 'ERC20TESTTOKENLAT1'
    bool(stor1.length) = 0
    stor1.length.field_1 = 18
    stor1.length.field_8 = 'ERC20TESTTOKENLAT1' / 256
    idx = 0
    ...
    mem[224 len -4204] = code.data[4802 len -4204]
