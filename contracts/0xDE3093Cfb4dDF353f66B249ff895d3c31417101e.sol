...
function _fallback() payable {
    ...
    require code.data[11166 len 20]
    require code.data[11198 len 20]
    require code.data[11218 len 32] > block.number
    require code.data[11250 len 32] > code.data[11218 len 32]
    stor1 = 1
    stor4 = code.data[11198 len 20]
    stor8 = code.data[11218 len 32]
    stor9 = code.data[11250 len 32]
    create contract with 0 wei
                    code: code.data[9947 len 1207], code.data[11166 len 20]
    ...
    stor10 = code.data[11166 len 20]
    require ext_code.size(stor10)
    call stor10.isMultiSigWallet() with:
         gas gas_remaining - 50 wei
    require ext_call.success
    require ext_call.return_data[0]
    return code.data[920 len 9027]
}
...
const tokenCreationMin = 88 * 10^18
