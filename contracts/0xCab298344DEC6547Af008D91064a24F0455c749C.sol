...
const baseTokenURI = Array(len=46, data='https://cadaf-metadata.herokuapp', '.com/api/item/', Mask(112, -256, 'https://cadaf-metadata.herokuapp', '.com/api/item/') << 256)
...
function itemTypes(uint256 arg1) {
    return itemTypes[arg1]
}
