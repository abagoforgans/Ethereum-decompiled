...
function _fallback() payable {
    ...
    stor1.length.field_8 = 'Ultimate PickFive' / 256
    idx = 0
    ...
    if not stor17:
        ...
        if stor17 != 7:
            ...
            require stor17 == 6
            stor17 = 1
    return code.data[1449 len 16149]
}
...
function sub_2d25742b(?) {
    ...
    while idx > 0:
        require idx < mem[608]
        _545 = mem[(32 * idx) + 640]
        require idx - 1 < mem[608]
        _569 = mem[(32 * idx - 1) + 640]
        require mem[(32 * idx) + 640] < 5
        _594 = mem[(32 * mem[(32 * idx) + 640]) + 416]
        s = mem[(32 * idx - 1) + 640]
        t = mem[(32 * idx - 1) + 640]
        while s < _545:
            require s < 5
            if mem[(32 * s) + 416] > _594:
                s = s + 1
                t = t
                continue 
            require s < 5
            ...
            require t < 5
            require s < 5
            mem[(32 * s) + 416] = mem[(32 * t) + 416]
            mem[(32 * t) + 416] = _969
            s = s + 1
            t = t + 1
            continue 
        require _545 < 5
        _904 = mem[(32 * _545) + 416]
        require t < 5
        require t < 5
        require _545 < 5
        mem[(32 * _545) + 416] = mem[(32 * t) + 416]
        mem[(32 * t) + 416] = _904
        if t <= mem[(32 * idx - 1) + 640] + 1:
            if t + 1 >= _545:
                s = t
                s = s
                s = _594
        ...
        require idx + 1 < mem[608]
        mem[(32 * idx + 1) + 640] = t + 1
        require idx + 2 < mem[608]
        mem[(32 * idx + 2) + 640] = _545
        s = t
        s = s
        s = _594
        s = _569
    ...
    while idx < 5:
        require idx < 5
        require idx < 5
        mem[(32 * idx) + 160] = mem[(32 * idx) + 416]
        idx = idx + 1
        continue 
    mem[864 len 0] = None
    idx = 0
    s = 0
    while idx < stor18[mem[864 len 160]][stor7].field_512:
        require idx < stor18[mem[864 len 160]][stor7].field_512
        mem[0] = sha3(mem[864 len 160], stor7)
        mem[32] = 18
        if address(stor18[mem[864 len 160]][stor7][idx + 2].field_0) != msg.sender:
            idx = idx + 1
            s = s
            continue 
        idx = idx + 1
        s = s + 1
        continue 
    return stor18[mem[864 len 160]][stor7].field_512, s
}
...
function sub_9de8cf3c(?) {
    ...
    if uint8(stor17.field_8) != 2:
        ...
        if uint8(stor17.field_8) != 7:
            ...
            mem[64] = 448
            if var51003 <= 200:
                mem[448] = block.hash(block.number - var51003)
                mem[480] = block.hash(block.number + -var51003 - 1)
                mem[512] = block.hash(block.number + -var51003 - 2)
                mem[544] = block.hash(block.number + -var51003 - 3)
                mem[576] = block.hash(block.number + -var51003 - 4)
                mem[608] = block.hash(block.number + -var51003 - 5)
                mem[640] = block.hash(block.number + -var51003 - 6)
                mem[672] = block.hash(block.number + -var51003 - 7)
                mem[704] = block.hash(block.number + -var51003 - 8)
                mem[736] = block.hash(block.number + -var51003 - 9)
                mem[768] = block.timestamp
                ...
                mem[448] = block.hash(block.number - 2)
                mem[480] = block.hash(block.number - 3)
                mem[512] = block.hash(block.number - 4)
                mem[544] = block.hash(block.number - 5)
                mem[576] = block.hash(block.number - 6)
                mem[608] = block.hash(block.number - 7)
                mem[640] = block.hash(block.number - 8)
                mem[672] = block.hash(block.number - 9)
                mem[704] = block.hash(block.number - 10)
                mem[736] = block.hash(block.number - 11)
                mem[768] = block.timestamp
        ...
        mem[64] = 448
        if var45003 <= 200:
            mem[448] = block.hash(block.number - var45003)
            mem[480] = block.hash(block.number + -var45003 - 1)
            mem[512] = block.hash(block.number + -var45003 - 2)
            mem[544] = block.hash(block.number + -var45003 - 3)
            mem[576] = block.hash(block.number + -var45003 - 4)
            mem[608] = block.hash(block.number + -var45003 - 5)
            mem[640] = block.hash(block.number + -var45003 - 6)
            mem[672] = block.hash(block.number + -var45003 - 7)
            mem[704] = block.hash(block.number + -var45003 - 8)
            mem[736] = block.hash(block.number + -var45003 - 9)
            mem[768] = block.timestamp
