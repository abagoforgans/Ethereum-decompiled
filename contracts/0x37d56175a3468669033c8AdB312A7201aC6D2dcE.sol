...
function _fallback() {
    stor0 = 43500000 * 10^18
    stor1[address(msg.sender)] = 43500000 * 10^18
    return code.data[131 len 5766]
}
...
const name = 'GlobexSci'

const decimals = 18

const symbol = 'GSI'

const INITIAL_SUPPLY = 43500000 * 10^18
...
function transferWithoutDecimals(address arg1, uint256 arg2) {
    if arg2:
        require arg2
