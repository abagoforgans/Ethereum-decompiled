...
function _fallback() payable {
    ...
    stor2 = msg.sender
    stor3 = 0x5f5e3bc34347e1f10c7a0e932871d8dbfbef9f87
    stor4 = 0
    stor5 = 0
    return code.data[210 len 1564]
}
...
function transferPartner(address arg1) {
    require partnerAddress == msg.sender
...
function _fallback() payable {
    ...
    call stor1.0x70a08231 with:
        ...
        args this.address
    require ext_call.success
    require 50000 * msg.value <= ext_call.return_data[0]
    require ext_code.size(stor1)
    call stor1.0xa9059cbb with:
         gas gas_remaining - 710 wei
        args msg.sender, 50000 * msg.value
    require ext_call.success
    funds += msg.value
    call directorAddress with:
