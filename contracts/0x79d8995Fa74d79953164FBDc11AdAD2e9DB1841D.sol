...
function _fallback() payable {
    ...
    mem[96 len 1318] = code.data[9306 len 1318]
    create contract with 0 wei
                    code: code.data[9306 len 1318]
    require create.new_address
    stor14 = address(create.new_address)
    require not msg.value
    address(stor12.field_0) = msg.sender
    mem[128] = code.data[10624 len 32]
    mem[160] = 'Drone01::v1'
    stor4.length = 87
    s = 0
    idx = 128
    ...
    while stor4.length + 31 / 32 > idx:
        ...
        idx = idx + 1
        continue 
    mem[224] = code.data[10624 len 32]
    mem[256] = 'Drone01::v1'
    stor5.length = 87
    s = 0
    idx = 224
...
function sub_2a6446ca(?) {
    ...
    if not isAdminEnabled:
        ...
        if not ext_call.return_data[0]:
            ...
            require ownerOf[arg1] == msg.sender
    require ext_code.size(sub_99c581f0Address)
    call sub_99c581f0Address.0x2a6446ca with:
         gas gas_remaining wei
