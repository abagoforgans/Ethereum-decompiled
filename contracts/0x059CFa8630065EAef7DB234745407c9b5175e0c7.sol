...
function _fallback() payable {
    mem[96 len -1700] = code.data[2226 len -1700]
    mem[64] = -1604
    ...
    if mem[128]:
        if mem[236 len 20] != 0:
            stor4 = mem[224]
            stor9[mem[236 len 20]] = mem[128]
            stor12[stor8] = mem[224]
        else:
            stor4 = msg.sender or Mask(96, 160, stor4)
            stor9[address(msg.sender)] = mem[128]
            stor12[stor8] = msg.sender or Mask(96, 160, stor12[stor8])
        stor1 = mem[128]
    else:
        if mem[236 len 20] != 0:
            stor4 = mem[224]
            stor9[mem[236 len 20]] = 1000
            stor12[stor8] = mem[224]
        else:
            stor4 = msg.sender or Mask(96, 160, stor4)
...
mapping of uint256 sub_58bdd1d6;
...
function sub_58bdd1d6(?) payable {
    return sub_58bdd1d6[arg1]
}
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    balanceOf[address(arg1)] += arg2
    sub_58bdd1d6[address(msg.sender)] += -1 * arg2 * sub_48756fd8
    sub_58bdd1d6[address(arg1)] += arg2 * sub_48756fd8
...
function sub_a4ab866a(?) payable {
    if arg1 > sub_d1e93151:
        ...
        while idx < sub_215d1343:
            mem[0] = address(sub_76a39356[idx])
            mem[32] = 10
            if sub_58bdd1d6[address(stor12[idx])] >= u:
                idx = idx + 1
            ...
            u = sub_58bdd1d6[address(stor12[idx])]
            continue 
        sub_58bdd1d6[address(s)]++
}
