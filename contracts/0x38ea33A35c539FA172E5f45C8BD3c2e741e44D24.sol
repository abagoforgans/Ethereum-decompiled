...
function _fallback() payable {
    ...
    return code.data[1712 len 2583]
}
...
const sub_24c4b0ef(?) = msg.sender


array of struct stor1;
mapping of uint256 stor2;

function sub_c06d4673(?) {
    return arg1
}
...
function sub_05d22f3c(?) {
    if stor2[address(arg1)] >= stor1.length:
        ...
        return address(arg1), Array(len=7, data=mem[288])
    ...
    while stor[(3 * stor2[address(arg1)]) + ('name', 'stor1', 1) + 2].length + 128 > idx:
        ...
        continue 
    return address(arg1), 
           Array(len=stor[(3 * stor2[address(arg1)]) + ('name', 'stor1', 1) + 2].length, data=mem[160 len stor[(3 * stor2[address(arg1)]) + ('name', 'stor1', 1) + 2].length])
}

function sub_70ebdf36(?) {
    if stor2[address(msg.sender)] >= stor1.length:
        mem[256] = mem[281 len 7]
        return Array(len=7, data=mem[256])
    require stor2[address(msg.sender)] < stor1.length
    mem[160] = stor[sha3((3 * stor2[address(msg.sender)]) + ('name', 'stor1', 1) + 2)].field_0
    idx = 160
    s = 0
    while stor[(3 * stor2[address(msg.sender)]) + ('name', 'stor1', 1) + 2].length + 128 > idx:
        mem[idx + 32] = stor[s + sha3((3 * stor2[address(msg.sender)]) + ('name', 'stor1', 1) + 2)].field_256
        idx = idx + 32
        s = s + 1
        continue 
    return Array(len=stor[(3 * stor2[address(msg.sender)]) + ('name', 'stor1', 1) + 2].length, data=mem[160 len stor[(3 * stor2[address(msg.sender)]) + ('name', 'stor1', 1) + 2].length]), 
}

function sub_15992f01(?) {
