...
function _fallback() payable {
    mem[96 len -1323] = code.data[1534 len -1323]
    mem[64] = -1227
    stor1[] = Array(len=mem[mem[96] + 96], data=mem[mem[96] + 128 len mem[mem[96] + 96]])
    stor0 = msg.sender or Mask(96, 160, stor0)
    stor5 = 0
    return code.data[211 len 1323]
}
...
function sub_1f3da6aa(?) payable {
    uint256(stor2) = msg.sender or Mask(96, 160, uint256(stor2))
}

function sub_c1e6adfd(?) payable {
    sub_a29092ed++
    sub_18d9adab[stor5][].field_0 = Array(len=arg1.length, data=arg1[all])
    sub_18d9adab[stor5][1][].field_0 = Array(len=arg2.length, data=arg2[all])
    sub_18d9adab[stor5].field_512 = address(stor2)
    return sub_a29092ed
}
