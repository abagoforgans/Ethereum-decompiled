...
function _fallback() payable {
    ...
    require uint256(stor6.field_0) + stor2[address(msg.sender)] >= stor2[address(msg.sender)]
    stor2[address(msg.sender)] += uint256(stor6.field_0)
    emit Distr(uint256(stor6.field_0), msg.sender);
    emit Transfer(uint256(stor6.field_0), 0, msg.sender);
    return code.data[541 len 4331]
}
