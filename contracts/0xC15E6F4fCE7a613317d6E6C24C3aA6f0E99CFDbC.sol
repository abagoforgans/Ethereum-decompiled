...
function _fallback() payable {
    ...
    uint256(stor1) = 'd' or 0 or Mask(64, 192, uint256(stor1)) or Mask(64, 192, address(stor1)) or 0x50000000000000000000000000000000000000000 or address(stor1)
    return code.data[115 len 1963]
}
...
function sub_c7a352c2(?) payable {
    if msg.sender == stor0:
        address(stor1.field_0) = arg1
        uint16(stor1.field_160) = arg2
        Mask(80, 0, stor1.field_176) = Mask(80, 0, arg3)
        uint64(stor1.field_192) = uint64(arg2)
        uint64(stor1.field_192) = uint64(arg1)
}

function sub_c532892c(?) payable {
    idx = 0
    while uint32(idx) < uint32(stor1.field_192):
        mem[0] = uint32(idx)
        mem[32] = 2
...
function sub_4ad211ca(?) payable {
    if arg1 < uint16(stor1.field_176):
        call msg.sender with:
           value msg.value wei
             gas 0 wei
    else:
        ...
        while uint32(idx) < uint32(stor1.field_192):
            ...
            if uint32(idx) != test266151307():
                ...
                uint64(stor1.field_192) = uint64(uint32(stor1.field_192) + 1)
...
function sub_f77df859(?) payable {
    if address(stor1.field_0) == msg.sender:
        ...
        while idx:
            s = 0
            while uint32(s) < uint32(stor1.field_192):
                mem[0] = uint32(s)
                mem[32] = 2
...
function _fallback() payable {
    ...
    while uint32(idx) < uint32(stor1.field_192):
        ...
        idx = idx + 1
        continue 
    if uint16(sub_e31e5c3d[0].field_160 - uint16(stor1.field_160)) < uint16(stor1.field_176):
        call msg.sender with:
           value msg.value wei
             gas 0 wei
    else:
