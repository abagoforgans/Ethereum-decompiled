...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor1 = code.data[21124 len 20]
    stor2 = code.data[21156 len 20]
    stor3 = code.data[21188 len 20]
    return code.data[357 len 20755]
}
...
function _fallback() payable {
    ...
    create contract with 0 wei
                    code: code.data[6998 len 13714], mainAddress, msg.sender, sub_a7ede364Address, 0, sub_768c7bdbAddress
...
function sub_78c04409(?) payable {
    ...
    require ext_call.success
    create contract with 0 wei
                    code: code.data[6998 len 13714], mainAddress, msg.sender, sub_a7ede364Address, 1, sub_768c7bdbAddress
    require create.new_address
    sub_5c227c36[address(msg.sender)][stor5[address(msg.sender)]] = address(create.new_address)
    sub_bad03c29[address(msg.sender)]++
    sub_233baab3[stor6] = address(create.new_address)
...
function sub_c6b6f996(?) payable {
    ...
    require ext_call.success
    create contract with 0 wei
                    code: code.data[6998 len 13714], mainAddress, msg.sender, sub_a7ede364Address, 2, sub_768c7bdbAddress
    require create.new_address
    sub_5c227c36[address(msg.sender)][stor5[address(msg.sender)]] = address(create.new_address)
    sub_bad03c29[address(msg.sender)]++
    sub_233baab3[stor6] = address(create.new_address)
...
function sub_ab091ecd(?) payable {
    ...
    require ext_call.success
    create contract with 0 wei
                    code: code.data[6998 len 13714], mainAddress, msg.sender, sub_a7ede364Address, arg1, sub_768c7bdbAddress
    require create.new_address
    sub_5c227c36[address(msg.sender)][stor5[address(msg.sender)]] = address(create.new_address)
    sub_bad03c29[address(msg.sender)]++
    sub_233baab3[stor6] = address(create.new_address)
