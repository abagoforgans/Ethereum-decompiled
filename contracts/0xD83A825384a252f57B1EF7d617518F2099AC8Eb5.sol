...
function _fallback() {
    ...
    stor3.length.field_8 = 'BTE Application' / 256
    idx = 0
    ...
    stor7A71 = 50000000 * 10^18
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  50000000 * 10^18,
    emit 0x0: 50000000 * 10^18
    emit 0xe0a7c0b6: 50000000 * 10^18
    return code.data[511 len 2920]
}
