...
function _fallback() {
    stor4 = code.data[2380 len 20]
    stor1 = code.data[2400 len 32]
    stor5 = code.data[2444 len 20]
    stor0 = code.data[2464 len 32]
    stor2 = code.data[2496 len 32]
    stor3 = code.data[2528 len 32]
    stor54CD = msg.sender
    return code.data[208 len 2160]
}
