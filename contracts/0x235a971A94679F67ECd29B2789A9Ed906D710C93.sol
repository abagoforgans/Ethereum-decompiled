...
mapping of uint256 sub_0dfe8be0;
...
function sub_0dfe8be0(?) payable {
    return sub_0dfe8be0[arg1]
}
...
function members(uint256 arg1) payable {
    ...
    return address(stor[(2 * arg1) + code.data[2452 len 32]].field_0), 
           uint8(stor[(2 * arg1) + code.data[2452 len 32]].field_0),
           stor36B6[arg1]
}
...
function sub_15b431f2(?) payable {
    ...
    Mask(168, 0, stor[code.data[2452 len 32]].field_0) = 0
    stor[code.data[2452 len 32]].field_256 % 1 = 0
    stor[code.data[2452 len 32]].field_256 % 1 = 0
    stor[code.data[2452 len 32]].field_256 % 1 = 0
    uint256(stor1[code.data[2452 len 32]].field_0) = block.timestamp
    if arg1 != 0:
        uint256(stor0) = arg1 or Mask(96, 160, uint256(stor0))
}
...
function vote(uint256 arg1, bool arg2, string arg3) payable {
    ...
    require uint8(stor[code.data[2452 len 32] + (2 * stor4[address(msg.sender)])].field_160)
    require arg1 < stor1.length
...
function join() payable {
    if memberId[address(msg.sender)] != 0:
        require memberId[address(msg.sender)] < stor5.length
        uint8(stor[code.data[2452 len 32] + (2 * stor4[address(msg.sender)])].field_160) = 1
    else:
        ...
        address(stor[code.data[2452 len 32] + (2 * stor5.length)].field_0) = msg.sender
        uint8(stor[code.data[2452 len 32] + (2 * stor5.length)].field_160) = 1
        Mask(88, 0, stor[code.data[2452 len 32] + (2 * stor5.length)].field_168) = Mask(88, 168, msg.sender) >> 168
        uint256(stor[code.data[2452 len 32] + (2 * stor5.length) + 1].field_0) = block.timestamp
