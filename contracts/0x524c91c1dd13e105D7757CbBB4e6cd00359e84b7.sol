...
function sub_0b9c8fe8(?) {
    ...
    call msg.sender with:
       value 10^18 * sub_7300fd81[address(msg.sender)].field_0 wei
...
function sub_08bea870(?) payable {
    ...
    if not sub_7300fd81[address(msg.sender)].field_0:
        sub_7300fd81[address(msg.sender)].field_0 = 10^18 * msg.value
    else:
        require (10^18 * msg.value) + sub_7300fd81[address(msg.sender)].field_0 >= sub_7300fd81[address(msg.sender)].field_0
        require (10^18 * msg.value) + sub_7300fd81[address(msg.sender)].field_0 >= 10^18 * msg.value
        sub_7300fd81[address(msg.sender)].field_0 += 10^18 * msg.value
