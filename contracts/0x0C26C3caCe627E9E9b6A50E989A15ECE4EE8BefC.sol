...
function sub_4e797d94(?) payable {
    ...
    while idx < arg2.length:
        ...
        if mem[(32 * idx) + 128] % 8 != Mask(3, -(('mask_shl', 256, 0, -3, ('blockhash', ('add', -1, 'number'))), 0) + 256, 31) << (('mask_shl', 256, 0, -3, ('blockhash', ('add', -1, 'number'))), 0) - 256:
            s = Mask(3, 4, mem[(32 * idx) + 128]) >> 4
            s = mem[(32 * idx) + 128] % 8
            s = mem[(32 * idx) + 128] << 248
            idx = idx + 1
            continue 
        if Mask(3, 4, mem[(32 * idx) + 128]) >> 4 != Mask(3, -(('mask_shl', 256, 0, -3, ('blockhash', ('add', -1, 'number'))), 0) + 260, 31) << (('mask_shl', 256, 0, -3, ('blockhash', ('add', -1, 'number'))), 0) - 260:
            s = Mask(3, 4, mem[(32 * idx) + 128]) >> 4
            s = mem[(32 * idx) + 128] % 8
            s = mem[(32 * idx) + 128] << 248
            idx = idx + 1
        ...
        call 0xca9b7047a30b48942f61a729ecb1905e4b2a98dc.claimTile(uint256 rg1, uint256 rg2, uint256 rg3) with:
           value stor1 wei
            ...
            args mem[(32 * idx) + 128] << 253, Mask(3, 4, mem[(32 * idx) + 128]) << 249, arg1
        require ext_call.success
}
