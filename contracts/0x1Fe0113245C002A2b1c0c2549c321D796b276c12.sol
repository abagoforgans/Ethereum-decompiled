...
function emergencySplitToggle() {
    Mask(240, 0, stor14.field_16) = Mask(240, 0, not bool(splitInService))
}
...
function approve(address arg1, uint256 arg2, uint256 arg3) {
    allowance[address(msg.sender)][address(arg1)] = arg2
    stor21[address(msg.sender)][address(arg1)] = block.timestamp + arg3
    emit Approval(arg2, msg.sender, arg1);
}
...
function alterBankBalance(address arg1, uint256 arg2, bool arg3) {
    ...
    if not arg3:
        ...
        if arg2 + allowance[stor2][address(arg1)] > allowance[stor2][address(arg1)]:
            allowance[stor2][address(arg1)] += arg2
        else:
            require allowance[stor2][address(arg1)] - arg2 <= allowance[stor2][address(arg1)]
            allowance[stor2][address(arg1)] -= arg2
    emit Approval(allowance[stor2][address(arg1)], selfAddress, arg1);
}
...
function transfer(address arg1, uint256 arg2, bytes arg3) {
    ...
    Mask(224, 0, stor14.field_32) = 1
    require not isFrozen
    require balanceOf[address(msg.sender)] - arg2 <= balanceOf[address(msg.sender)]
    balanceOf[address(msg.sender)] -= arg2
    if arg1 == selfAddress:
        balanceOf[stor2] += arg2
        emit Transfer(arg2, Array(len=arg3.length, data=arg3[all]), msg.sender, selfAddress);
        allowance[stor2][address(msg.sender)] += arg2
        emit Approval(allowance[stor2][address(msg.sender)], selfAddress, msg.sender);
    else:
...
function buyTokensForAddress(address arg1) payable {
    ...
    if balanceOf[stor2] > 2 * 10^14:
        ...
        emit Transfer(address rg1, address rg2, uint256 rg3, bytes rg4):
                      10 * 10^6 * msg.value / 10^18 * pricePerEther / 50,
                      64,
                      0,
                      selfAddress,
                      arg1,
        ...
        if balanceOf[stor2] > 15 * 10^13:
            ...
            emit Transfer(address rg1, address rg2, uint256 rg3, bytes rg4):
                          10 * 10^6 * msg.value / 10^18 * pricePerEther / 200,
                          64,
                          0,
                          selfAddress,
                          arg1,
            ...
            if balanceOf[stor2] <= 10^14:
                ...
                emit Transfer(address rg1, address rg2, uint256 rg3, bytes rg4):
                              10 * 10^6 * msg.value / 10^18 * pricePerEther / 550,
                              64,
                              0,
                              selfAddress,
                              arg1,
                ...
                emit Transfer(address rg1, address rg2, uint256 rg3, bytes rg4):
                              10 * 10^6 * msg.value / 10^18 * pricePerEther / 400,
                              64,
                              0,
                              selfAddress,
                              arg1,
    ...
    if isFrozen:
        ...
        while idx < stor4.length:
            ...
            if idx != stor4.length - 1:
                ...
                require stor10
                _44 = mem[64]
                mem[mem[64]] = balanceOf[address(stor4[idx])] / stor10 * stor11
                mem[mem[64] + 32] = 64
                mem[mem[64] + 64] = mem[96]
                _46 = mem[96]
                s = 0
                while s < _46:
                    mem[mem[64] + s + 96] = mem[s + 128]
                    s = s + 32
                    continue 
                if not _46 % 32:
                    emit Transfer(address rg1, address rg2, uint256 rg3, bytes rg4):
                                  mem[mem[64] len _46 + _44 + -mem[64] + 96],
                                  selfAddress,
                                  address(stor4[idx]),
                else:
                    mem[floor32(_46) + _44 + 96] = mem[floor32(_46) + _44 + -(_46 % 32) + 128 len _46 % 32]
                    emit Transfer(address rg1, address rg2, uint256 rg3, bytes rg4):
                                  mem[mem[64] len floor32(_46) + _44 + -mem[64] + 128],
                                  selfAddress,
                                  address(stor4[idx]),
            else:
                Mask(248, 0, stor14.field_8) = 0
                balanceOf[stor2] -= stor13
                Mask(232, 0, stor14.field_24) = 1
                require idx < stor4.length
                mem[0] = address(stor4[idx])
                mem[32] = 16
                require stor10
    ...
    if isFrozen:
        ...
        while idx < stor4.length:
            ...
            if not allowance[stor2][address(stor4[idx])]:
                if idx == stor4.length - 1:
                    Mask(248, 0, stor14.field_8) = 0
                    balanceOf[0x166cb48973c2447daffa8efd3526da18076088de] += stor11 / 22
                    mem[0] = selfAddress
                    mem[32] = 16
                ...
                if balanceOf[address(stor4[idx])] / allowance[stor2][address(stor4[idx])] < 19:
                    ...
                    if idx != stor4.length - 1:
                        ...
                        if not _86 % 32:
                            emit Transfer(address rg1, address rg2, uint256 rg3, bytes rg4):
                                          mem[mem[64] len _86 + _84 + -mem[64] + 96],
                                          selfAddress,
                                          address(stor4[idx]),
                        else:
                            mem[floor32(_86) + _84 + 96] = mem[floor32(_86) + _84 + -(_86 % 32) + 128 len _86 % 32]
                            emit Transfer(address rg1, address rg2, uint256 rg3, bytes rg4):
                                          mem[mem[64] len floor32(_86) + _84 + -mem[64] + 128],
                                          selfAddress,
                                          address(stor4[idx]),
                    else:
                        Mask(248, 0, stor14.field_8) = 0
                        ...
                        if not _96 % 32:
                            emit Transfer(address rg1, address rg2, uint256 rg3, bytes rg4):
                                          mem[mem[64] len _96 + _94 + -mem[64] + 96],
                                          selfAddress,
                                          address(stor4[idx]),
                        else:
                            mem[floor32(_96) + _94 + 96] = mem[floor32(_96) + _94 + -(_96 % 32) + 128 len _96 % 32]
                            emit Transfer(address rg1, address rg2, uint256 rg3, bytes rg4):
                                          mem[mem[64] len floor32(_96) + _94 + -mem[64] + 128],
                                          selfAddress,
                                          address(stor4[idx]),
            idx = idx + 1
            continue 
