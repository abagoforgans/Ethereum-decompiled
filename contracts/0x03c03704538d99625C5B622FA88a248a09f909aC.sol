...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[15400 len 20]
    stor2 = code.data[15400 len 20]
    require code.data[15432 len 20]
    stor5 = code.data[15432 len 20]
    if code.data[15464 len 20]:
        require msg.sender == stor0
        require code.data[15464 len 20]
        require code.data[15464 len 20] != this.address
        require code.data[15515 len 1] > 0
        require code.data[15515 len 1] <= 100
        stor7[code.data[15464 len 20]].field_0 = 0
        stor7[address(code.data[15452 len 32])].field_256 = code.data[15515 len 1]
        stor7[address(code.data[15452 len 32])].field_264 = 0
        stor7[address(code.data[15452 len 32])].field_272 = 1
        stor7[address(code.data[15452 len 32])].field_280 = 1
        stor6.length++
        if not stor6.length <= stor6.length + 1:
            ...
            while stor6.length > idx:
                ...
                idx = idx + 1
                continue 
        address(stor6[stor6.length]) = code.data[15464 len 20]
        stor8 = uint8(stor8 + code.data[15484 len 32])
    return code.data[1690 len 13698]
}
                                            ...
                                            if reserves[address(arg2)].field_264:
                                                if 2 * reserves[address(arg2)].field_0 >= reserves[address(arg2)].field_0:
                                                    if ext_code.size(formulaAddress):
                                                        call formulaAddress.0xd39cce1c with:
                                                             gas gas_remaining - 710 wei
                                                            args 0, 2 * ext_call.return_data[0] % 2147483648, reserves[address(arg2)].field_0, reserves[address(arg2)].field_256, ext_call.return_data[0]
                                                        if ext_call.success:
                                                            return ext_call.return_data[0]
                                            else:
                                                if ext_code.size(arg2):
                                                    ...
                                                    if ext_call.success:
                                                        if ext_call.return_data[0] + reserves[address(arg2)].field_0 >= ext_call.return_data[0]:
                                                            if ext_code.size(formulaAddress):
                                                                call formulaAddress.0xd39cce1c with:
                                                                     gas gas_remaining - 710 wei
                                                                    args 0, 2 * ext_call.return_data[0] % 2147483648, ext_call.return_data[0], reserves[address(arg2)].field_256, ext_call.return_data[0]
                                                                if ext_call.success:
                                                                    return ext_call.return_data[0]
                    else:
                        if ext_code.size(arg1):
