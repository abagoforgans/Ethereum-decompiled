...
function distribute() payable {
    ...
    while idx < index:
        if balanceOf[stor3[idx]]:
            ...
            require msg.value * balanceOf[stor3[idx]] / balanceOf[stor3[idx]] == msg.value
        require totalSupply
        mem[32] = 3
        mem[mem[64]] = addresses[idx]
        mem[mem[64] + 32] = balanceOf[stor3[idx]]
        mem[mem[64] + 64] = msg.value * balanceOf[stor3[idx]] / totalSupply
        mem[mem[64] + 96] = idx
        emit Distribute(addresses[idx], balanceOf[stor3[idx]], msg.value * balanceOf[stor3[idx]] / totalSupply, idx);
        mem[0] = idx
        mem[32] = 3
        call addresses[idx] with:
           value msg.value * balanceOf[stor3[idx]] / totalSupply wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        s = msg.value * balanceOf[stor3[idx]] / totalSupply
