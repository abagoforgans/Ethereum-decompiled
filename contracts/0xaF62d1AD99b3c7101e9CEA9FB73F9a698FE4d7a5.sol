...
function sub_3e6769c4(?) {
    require stor0 == msg.sender
    require not finishBlock
    require not sub_2bee2b7b[Mask(40, 216, arg1)]
    tickets.length++
    ...
    tickets[tickets.length].field_256 = 2^arg2 or 2^arg3 or 2^arg4
    sub_2bee2b7b[Mask(40, 216, arg1)] = tickets.length
}
