...
function allTokens() payable {
    ...
    if ext_call.return_data[0]:
        mem[128 len 32 * ext_call.return_data[0]] = code.data[2339 len 32 * ext_call.return_data[0]]
    idx = 0
...
function sub_2d8e4b5f(?) payable {
    ...
    if not ext_call.return_data[0]:
        ...
        if not ext_call.return_data[0]:
            ...
            mem[(64 * ext_call.return_data[0]) + 192 len 32 * ext_call.return_data[0]] = code.data[2339 len 32 * ext_call.return_data[0]]
            idx = 0
            while idx < ext_call.return_data[0]:
                require idx < ext_call.return_data[0]
                _953 = mem[(32 * idx) + 128]
        ...
        mem[(32 * ext_call.return_data[0]) + 160 len 32 * ext_call.return_data[0]] = code.data[2339 len 32 * ext_call.return_data[0]]
        mem[(64 * ext_call.return_data[0]) + 160] = ext_call.return_data[0]
        if not ext_call.return_data[0]:
            idx = 0
            while idx < ext_call.return_data[0]:
