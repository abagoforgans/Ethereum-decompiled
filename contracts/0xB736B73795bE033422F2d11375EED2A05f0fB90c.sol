...
function _fallback() payable {
    mem[96 len -10391] = code.data[11037 len -10391]
    ...
    return code.data[646 len 10391]
}
...
function sub_f9132315(?) payable {
    uint256(stor4) = uint64(sub_ea9613ad) + 1 or Mask(192, 64, uint256(stor4))
    sub_ae842caa[address(arg1)] = uint64(sub_ea9613ad)
    details[address(arg1)].field_0 = 0
    details[address(arg1)].field_256 = 0
    details[address(arg1)].field_256 = 0
    details[address(arg1)][2][].field_0 = Array(len=arg2.length, data=arg2[all])
...
function sub_c01fb26b(?) payable {
    uint256(stor4) = uint64(sub_ea9613ad) + 1 or Mask(192, 64, uint256(stor4))
    sub_ae842caa[address(arg1)] = uint64(sub_ea9613ad)
    details[address(arg1)].field_0 = 0
    details[address(arg1)].field_256 = 0
    details[address(arg1)].field_256 = 0
    details[address(arg1)].field_512 = 0
    details[address(arg1)].field_513 = 0
    details[address(arg1)].field_520 = mem[ceil32(arg2.length) + 288 len 31]
    idx = 0
    while details[address(arg1)][2].length + 31 / 32 > idx:
        details[address(arg1)][idx + 2].field_0 = 0
        idx = idx + 1
        continue 
    details[address(arg1)].field_768 = msg.sender or Mask(96, 160, details[address(arg1)].field_768)
}

function sub_4c715e6e(?) payable {
    uint256(stor4) = uint64(sub_ea9613ad) + 1 or Mask(192, 64, uint256(stor4))
    sub_ae842caa[address(arg1)] = uint64(sub_ea9613ad)
    details[address(arg1)].field_0 = arg2 or Mask(248, 8, details[address(arg1)].field_0)
    details[address(arg1)].field_256 = 0
    details[address(arg1)].field_512 = 0
    details[address(arg1)].field_513 = 0
    details[address(arg1)].field_520 = mem[ceil32(arg3.length) + 288 len 31]
    idx = 0
    while details[address(arg1)][2].length + 31 / 32 > idx:
        details[address(arg1)][idx + 2].field_0 = 0
        idx = idx + 1
...
function sub_a9cc0ccb(?) payable {
    uint256(stor4) = uint64(sub_ea9613ad) + 1 or Mask(192, 64, uint256(stor4))
    sub_ae842caa[address(arg1)] = uint64(sub_ea9613ad)
    details[address(msg.sender)].field_0 = 0
    details[address(msg.sender)].field_256 = 0
    details[address(msg.sender)].field_256 = 0
    details[address(msg.sender)].field_512 = 0
    details[address(msg.sender)].field_513 = 0
    details[address(msg.sender)].field_520 = mem[ceil32(arg2.length) + 288 len 31]
    idx = 0
    while details[address(msg.sender)][2].length + 31 / 32 > idx:
        details[address(msg.sender)][idx + 2].field_0 = 0
        idx = idx + 1
        continue 
    details[address(msg.sender)].field_768 = msg.sender or Mask(96, 160, details[address(msg.sender)].field_768)
}
