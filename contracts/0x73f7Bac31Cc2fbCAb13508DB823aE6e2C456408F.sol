...
function _fallback() {
    stor3 = 42 * 10^6
    stor5[address(msg.sender)] = 42 * 10^6
    uint8(stor0.length) = 10
    Mask(248, 0, stor0.length.field_8) = 'Nexus' / 256
    ...
    Mask(248, 0, stor1.length.field_8) = 'Nxs' / 256
    if (stor1.length + 31 / 32) - 0x4ef1d2ad89edf8c4d91132028e8195cdf30bb4b5053d4f8cd260341d4805f30a > 0xb10e2d527612073b26eecdfd717e6a320cf44b4afac2b0732d9fcbe2b7fa0cf6:
        ...
        while (stor1.length + 31 / 32) - 0x4ef1d2ad89edf8c4d91132028e8195cdf30bb4b5053d4f8cd260341d4805f30a > idx:
            ...
            continue 
    stor2 = 3
    stor4 = 0xf066d5e61dc869f160b4fa9256db7fd19819ada4
    return code.data[565 len 2303]
}
