...
function sub_afa6940c(?) {
    ...
    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + 228] = 96
    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + 356 len floor32(arg1.length)] = call.data[arg1 + 36 len floor32(arg1.length)]
    require ext_code.size(stor6)
    call stor6.quickConvert(address[] arg1, uint256 arg2, uint256 arg3) with:
       value _6 wei
         gas gas_remaining wei
        args Array(len=arg1.length, data=call.data[arg1 + 36 len floor32(arg1.length)], mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + floor32(arg1.length) + 356 len (32 * arg1.length) - floor32(arg1.length)]), _8, 1
    ...
    require 4 < arg1.length
    _33 = mem[256]
    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + 228] = stor7
    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg4.length) + 260] = ext_call.return_data[0]
    ...
    require 4 < arg1.length
    require ext_code.size(stor7)
    call stor7.0x338b5dea with:
         gas gas_remaining wei
        args address(mem[256]), ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    else:
        return 0
...
function sub_59697fc7(?) {
    ...
    require 4 < arg1.length
    _60 = mem[256]
    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg5.length) + 228] = stor7
    ...
    call address(_60).approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args stor7, ext_call.return_data[0]
    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg5.length) + 224] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg5.length) + 228] = address(_66)
    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg5.length) + 260] = ext_call.return_data[0]
    require ext_code.size(stor7)
    call stor7.0x338b5dea with:
         gas gas_remaining wei
        args address(_66), ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require 4 < arg2.length
    mem[(32 * arg1.length) + 288] = 9969 * ext_call.return_data[0] / 10000
    require msg.sender == 0x54c676cddc496ecbd20511a5c143cac2cbca6b3f
...
function sub_effc7f22(?) {
    ...
    call address(_62).approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args stor7, ext_call.return_data[0]
    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg5.length) + 224] = ext_call.return_data[0]
    if not ext_call.success:
    ...
    _68 = mem[256]
    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg5.length) + 224] = 0x338b5dea00000000000000000000000000000000000000000000000000000000
    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg5.length) + 228] = address(_68)
    mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + (32 * arg5.length) + 260] = ext_call.return_data[0]
    require ext_code.size(stor7)
    call stor7.0x338b5dea with:
         gas gas_remaining wei
        args address(_68), ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require 4 < arg2.length
    mem[(32 * arg1.length) + 288] = 99688 * ext_call.return_data[0] / 100000
    require msg.sender == 0x54c676cddc496ecbd20511a5c143cac2cbca6b3f
    require 0 < arg3.length
    require 0 < arg2.length
    require 1 < arg3.length
    ...
    call stor7.trade(address arg1, uint256 arg2, address arg3, uint256 arg4, uint256 arg5, uint256 arg6, address arg7, uint8 arg8, bytes32 arg9, bytes32 arg10, uint256 arg11) with:
         gas gas_remaining wei
        args mem[(32 * arg1.length) + (32 * arg2.length) + 204 len 20], mem[(32 * arg1.length) + 160], address(mem[(32 * arg1.length) + (32 * arg2.length) + 224]), mem[(32 * arg1.length) + 192], mem[(32 * arg1.length) + 224], mem[(32 * arg1.length) + 256], address(mem[(32 * arg1.length) + (32 * arg2.length) + 256]), arg4 << 248, mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 224], mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 256], 99688 * ext_call.return_data[0] / 100000
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require 1 < arg2.length
    require 0 < arg2.length
    ...
    call stor7.0x2e1a7d4d with:
         gas gas_remaining wei
        args (10^18 * mem[(32 * arg1.length) + 160] / mem[(32 * arg1.length) + 192] * 99688 * ext_call.return_data[0] / 100000 / 10^18)
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    else:
        return 0
