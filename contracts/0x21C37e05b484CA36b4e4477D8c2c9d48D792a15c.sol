...
function _fallback() payable {
    ...
    if block.timestamp > bonusEnds:
        ...
        require balanceOf[address(msg.sender)] + (1500 * msg.value) >= balanceOf[address(msg.sender)]
        balanceOf[address(msg.sender)] += 1500 * msg.value
        require _totalSupply + (1500 * msg.value) >= _totalSupply
        _totalSupply += 1500 * msg.value
