...
function _fallback() {
    ...
    stor3.length.field_8 = 'Keenly Change Bitcoin' / 256
    idx = 0
    ...
    stor6[0x743fd6d924ae32ccddb377f11d43129cdd0d0d00] = stor5
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  stor5,
    emit 0x0: stor5
    emit 0x743fd6d9: stor5
    return code.data[650 len 5596]
}
