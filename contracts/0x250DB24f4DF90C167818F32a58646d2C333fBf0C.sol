...
function Enter() payable {
    if 10^15 == msg.value:
        ...
        while stor[(3 * stor0.length) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e564].length + 31 / 32 > idx:
            ...
            idx = idx + 1
            continue 
        s = (10^18 * stor0.length) - 999999999999999999 / 2
        t = (10^18 * stor0.length) - 10^18
        while s < t:
            s = s + ((10^18 * stor0.length) - 10^18 / s) / 2
            t = s
            continue 
        require stor0.length < stor0.length
        stor290D[stor0.length] = t
        sub_5e02eb7d = (10^18 * stor0.length) + sub_5e02eb7d - 10^18
}
