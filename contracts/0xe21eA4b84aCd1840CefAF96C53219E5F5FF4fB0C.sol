...
function _fallback() payable {
    ...
    stor10 = code.data[4600 len 20]
    stor11 = code.data[4632 len 20]
    stor8 = code.data[4664 len 20]
    require code.data[4684 len 32] > 100
    stor2 = code.data[4684 len 32]
    stor3 = 24 * 3600 * code.data[4716 len 32]
    return code.data[289 len 4299]
}
    ...
    while idx < arg1.length:
        ...
        if records[mem[(32 * idx) + 140 len 20]].field_256 > 0:
            ...
            if block.timestamp >= records[mem[(32 * idx) + 140 len 20]].field_256 + withdrawal_delay:
                ...
                _42 = mem[64]
                mem[64] = mem[64] + 64
                mem[_42] = records[address(_39)].field_0
                mem[_42 + 32] = records[address(_39)].field_256
                if records[address(_39)].field_0:
                    require records[address(_39)].field_0
                    require rate * records[address(_39)].field_0 / records[address(_39)].field_0 == rate
                mem[mem[64] + 36] = rate * records[address(_39)].field_0 / 100
                require ext_code.size(ATNAddress)
                call ATNAddress.0xa9059cbb with:
                     gas gas_remaining - 710 wei
                    args address(_39), rate * records[address(_39)].field_0 / 100
                require ext_call.success
                require ext_call.return_data[0]
                atnSent += rate * records[address(_39)].field_0 / 100
                mem[0] = address(_39)
                mem[32] = 9
                records[address(_39)].field_0 = 0
                records[address(_39)].field_256 = 0
                withdrawId++
                mem[mem[64]] = withdrawId
                mem[mem[64] + 32] = rate * records[address(_39)].field_0 / 100
                emit Withdrawal(withdrawId, rate * records[address(_39)].field_0 / 100, address(_39));
        idx = idx + 1
        continue 
}
