...
function _fallback() {
    mem[96 len -3207] = code.data[3560 len -3207]
    mem[64] = -3111
    stor2 = msg.sender
    ...
    while idx < mem[mem[96] + 96]:
        ...
        require idx + 2 < 256
        stor3[idx] = mem[(32 * idx) + mem[96] + 140 len 20]
        require idx < mem[mem[96] + 96]
    ...
    if stor258[call.data[0 len calldata.size]][block.number].field_256 and 2^stor257[address(msg.sender)] != 0:
        if not stor263[call.data[0 len calldata.size]][block.number].field_0:
            ...
            while arg3 + arg3.length + 36 > idx:
                ...
                idx = idx + 32
                continue 
            if stor263[call.data[0 len calldata.size]][block.number][2].length + 31 / 32 > Mask(251, 0, arg3.length + 31) >> 5:
                stor[('array', 2, ('map', ('data', ('call.data', 0, 'calldatasize'), 'number'), ('name', 'stor263', 263))) + (Mask(251, 0, arg3.length + 31) >> 5)].field_0 = 0
