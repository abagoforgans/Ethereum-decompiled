...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 48 * 10^13
    stor2 = 48 * 10^13
    bool(stor4.length) = 0
    stor4.length.field_1 = 4
    stor4.length.field_8 = 'NOVA' / 256
    idx = 0
...
function buy() payable {
    require msg.value > 0
    require balanceOf[address(stor3.field_0)] > 3500 * msg.value
    require balanceOf[address(msg.sender)] + (3500 * msg.value) >= balanceOf[address(msg.sender)]
    require balanceOf[address(msg.sender)] + (3500 * msg.value) >= 3500 * msg.value
    balanceOf[address(msg.sender)] += 3500 * msg.value
    require 3500 * msg.value <= balanceOf[address(stor3.field_0)]
    balanceOf[address(stor3.field_0)] += -3500 * msg.value
    emit Transfer((3500 * msg.value), owner, msg.sender);
    return 1
}
