...
function sub_b936999a(?) payable {
    ...
    if 8 * msg.value > eth.balance(this.address):
        ...
        while 169 > idx:
            ...
            idx = idx + 32
            continue 
        idx = code.data[2559 len 32] + 2
        while code.data[2559 len 32] + (stor9.length + 31 / 32) > idx:
            stor[idx] = 0
            idx = idx + 1
            continue 
