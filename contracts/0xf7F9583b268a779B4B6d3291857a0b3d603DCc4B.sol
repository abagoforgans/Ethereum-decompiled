...
function createSellENS(string arg1, uint256 arg2) {
    ...
    address(stor0[address(create.new_address)].field_512) = msg.sender
...
function sell_label(address arg1, uint256 arg2) payable {
    mem[64] = 96
    require not msg.value
    require address(stor0[address(msg.sender)].field_512)
    if arg1 != address(stor0[address(msg.sender)].field_512):
        call stor1 with:
           value stor0[address(msg.sender)].field_256 / 20 wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        call address(stor0[address(msg.sender)].field_512) with:
        ...
        if arg2 <= stor0[address(msg.sender)].field_256:
            ...
            while stor0[address(msg.sender)].length + 96 > idx + 32:
                ...
                s = s + 1
                continue 
            _174 = sha3(mem[96 len stor0[address(msg.sender)].length])
            mem[96] = stor5
            mem[0] = sha3(address(msg.sender), 0)
            mem[128] = stor0[address(msg.sender)].field_0
            idx = mem[64] + 32
            s = 0
            while stor0[address(msg.sender)].length + 96 > idx:
                mem[idx + 32] = stor[s + sha3(mem[0]) + 1]
                idx = idx + 32
                s = s + 1
                continue 
            _310 = sha3(mem[mem[64] len stor0[address(msg.sender)].length + -mem[64] + 128])
            mem[mem[64] + 4] = sha3(mem[mem[64] len stor0[address(msg.sender)].length + -mem[64] + 128])
            require ext_code.size(stor2)
            call stor2.setResolver(bytes32 rg1, address rg2) with:
                 gas gas_remaining - 710 wei
                args mem[mem[64] + 4], stor4
            require ext_call.success
            require ext_code.size(stor4)
            call stor4.setAddr(bytes32 rg1, address rg2) with:
                 gas gas_remaining - 710 wei
                args _310, arg1
            require ext_call.success
            ...
            while stor0[address(msg.sender)].length + 96 > idx + 32:
                ...
                s = s + 1
                continue 
            _181 = sha3(mem[96 len stor0[address(msg.sender)].length])
            mem[96] = stor5
            mem[0] = sha3(address(msg.sender), 0)
            mem[128] = stor0[address(msg.sender)].field_0
            idx = mem[64] + 32
            ...
            while stor0[address(msg.sender)].length + 96 > idx:
                ...
                s = s + 1
                continue 
            _314 = sha3(mem[mem[64] len stor0[address(msg.sender)].length + -mem[64] + 128])
            mem[mem[64] + 4] = sha3(mem[mem[64] len stor0[address(msg.sender)].length + -mem[64] + 128])
            require ext_code.size(stor2)
            call stor2.setResolver(bytes32 rg1, address rg2) with:
                 gas gas_remaining - 710 wei
        ...
        if arg2 <= 0:
            ...
            while stor0[address(msg.sender)].length + 96 > idx + 32:
                ...
                s = s + 1
                continue 
            _188 = sha3(mem[96 len stor0[address(msg.sender)].length])
            mem[96] = stor5
            mem[0] = sha3(address(msg.sender), 0)
            mem[128] = stor0[address(msg.sender)].field_0
            idx = mem[64] + 32
            ...
            while stor0[address(msg.sender)].length + 96 > idx:
                ...
                s = s + 1
                continue 
            _318 = sha3(mem[mem[64] len stor0[address(msg.sender)].length + -mem[64] + 128])
            mem[mem[64] + 4] = sha3(mem[mem[64] len stor0[address(msg.sender)].length + -mem[64] + 128])
            require ext_code.size(stor2)
            call stor2.setResolver(bytes32 rg1, address rg2) with:
                 gas gas_remaining - 710 wei
            ...
            while stor0[address(msg.sender)].length + 96 > idx + 32:
                ...
                s = s + 1
                continue 
            _195 = sha3(mem[96 len stor0[address(msg.sender)].length])
            mem[96] = stor5
            mem[0] = sha3(address(msg.sender), 0)
            mem[128] = stor0[address(msg.sender)].field_0
            idx = mem[64] + 32
            ...
            while stor0[address(msg.sender)].length + 96 > idx:
                ...
                s = s + 1
                continue 
            _322 = sha3(mem[mem[64] len stor0[address(msg.sender)].length + -mem[64] + 128])
            mem[mem[64] + 4] = sha3(mem[mem[64] len stor0[address(msg.sender)].length + -mem[64] + 128])
            require ext_code.size(stor2)
            call stor2.setResolver(bytes32 rg1, address rg2) with:
                 gas gas_remaining - 710 wei
