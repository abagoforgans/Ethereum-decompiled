            ...
            if block.timestamp >= stor11[address(msg.sender)]:
                if 1 == stor8[address(msg.sender)]:
                    ...
                    if 2 == stor8[address(msg.sender)]:
                        stor10[address(msg.sender)] = (100 * stor9[address(msg.sender)]) - (20 * block.timestamp - stor11[address(msg.sender)] / 720 * 24 * 3600 * stor9[address(msg.sender)]) / 100
            ...
            if block.timestamp >= stor11[address(arg1)]:
                if 1 == stor8[address(arg1)]:
                    ...
                    if 2 == stor8[address(arg1)]:
                        stor10[address(arg1)] = (100 * stor9[address(arg1)]) - (20 * block.timestamp - stor11[address(arg1)] / 720 * 24 * 3600 * stor9[address(arg1)]) / 100
...
function lock(uint256 arg1, address arg2, uint256 arg3) {
    ...
    if arg1 == 1:
        stor11[address(arg2)] = block.timestamp + (3600 * 24 * 3600)
        if not stor9[address(arg2)]:
            stor10[address(arg2)] = 0
        else:
            require 10 * stor9[address(arg2)] / stor9[address(arg2)] == 10
            stor10[address(arg2)] = 10 * stor9[address(arg2)] / 10
        stor12[address(arg2)] = stor11[address(arg2)] + (2 * 3600 * 24 * 3600)
    else:
        if 2 == arg1:
            stor11[address(arg2)] = block.timestamp + (7920 * 24 * 3600)
            if not stor9[address(arg2)]:
                stor10[address(arg2)] = 0
            else:
                require 100 * stor9[address(arg2)] / stor9[address(arg2)] == 100
                stor10[address(arg2)] = 100 * stor9[address(arg2)] / 100
            stor12[address(arg2)] = stor11[address(arg2)] + (3600 * 24 * 3600)
