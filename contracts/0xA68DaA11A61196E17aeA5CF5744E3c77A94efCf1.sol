...
const sub_dba680b9(?) = eth.balance(0x65c13da4feb34aee002678a0b44835ed43142bdc), eth.balance(0x3770943f442a0bb4e34862653f93e5615dcf7887)
...
uint256 sub_74d0d855;
uint256 sub_14936adc;
uint256 sub_b682d65d;
uint256 sub_6c85ae4c;

function sub_14936adc(?) payable {
    return sub_14936adc
}
...
function sub_6c85ae4c(?) payable {
    return sub_6c85ae4c
}

function sub_74d0d855(?) payable {
    return sub_74d0d855
}
...
function sub_08ab2167(?) payable {
    sub_9b2c3af0 = eth.balance(stor0)
    sub_d0dfec89 = eth.balance(stor2)
...
function sub_4697d3e5(?) payable {
    sub_74d0d855 = eth.balance(0x65c13da4feb34aee002678a0b44835ed43142bdc)
    sub_14936adc = eth.balance(0x3770943f442a0bb4e34862653f93e5615dcf7887)
    sub_b682d65d = eth.balance(arg1)
    sub_6c85ae4c = eth.balance(arg2)
    return eth.balance(0x65c13da4feb34aee002678a0b44835ed43142bdc), 
           eth.balance(0x3770943f442a0bb4e34862653f93e5615dcf7887),
           eth.balance(arg1),
           eth.balance(arg2)
}
