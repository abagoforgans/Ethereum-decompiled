...
function _fallback() payable {
    ...
    require code.data[15188 len 32] >= block.timestamp
    require code.data[15220 len 32] >= code.data[15188 len 32]
    require code.data[15252 len 32] > 0
    require code.data[15296 len 20]
    create contract with 0 wei
                    code: code.data[11468 len 3720]
    ...
    stor1 = code.data[15188 len 32]
    stor2 = code.data[15220 len 32]
    stor4 = code.data[15252 len 32]
    stor3 = code.data[15296 len 20]
    ...
    stor13 = 10
    stor14 = 18
    stor15 = code.data[15328 len 20]
    stor16 = this.address
    require address(stor6.field_0) == msg.sender
    require code.data[15360 len 20]
    ...
    call stor0.0x40c10f19 with:
         gas gas_remaining - 710 wei
        args code.data[15360 len 20], 1000000000 * 10^18
    require ext_call.success
    return code.data[1192 len 10276]
}
...
function mintPresaleTokens(uint256 arg1) {
    ...
    require arg1 + ext_call.return_data[0] <= tokensCap
    require ext_code.size(tokenAddress)
    call tokenAddress.0x40c10f19 with:
         gas gas_remaining - 710 wei
...
function finalize() {
    ...
    Mask(96, 0, stor6.field_160) = Mask(96, 0, bool(uint8(stor6.field_160)))
    require ext_code.size(tokenAddress)
    call tokenAddress.0x18160ddd with:
         gas gas_remaining - 710 wei
    require ext_call.success
...
function computeBonus(uint256 arg1) {
    ...
    while idx < stor9.length:
        ...
        while s < stor11.length:
            ...
            require stor('array', ('div', 0.125, ('var', 0)), ('name', 'stor10', 10))[uint8(idx)] + stor('array', ('div', 0.125, ('var', 1)), ('name', 'stor12', 12))[uint8(s)] >= stor('array', ('div', 0.125, ('var', 1)), ('name', 'stor12', 12))[uint8(s)]
            return (stor('array', ('div', 0.125, ('var', 0)), ('name', 'stor10', 10))[uint8(idx)] + stor('array', ('div', 0.125, ('var', 1)), ('name', 'stor12', 12))[uint8(s)])
...
function buyTokens(address arg1) payable {
    ...
    if rate * msg.value:
        ...
        require tokenPriceInCents * rate * msg.value / rate * msg.value == tokenPriceInCents
    require block.timestamp >= startTime
    idx = 0
    while idx < stor9.length:
        mem[0] = 9
        ...
        while s < stor11.length:
            mem[0] = 11
            if tokenPriceInCents * rate * msg.value / 100 / 10^18 < stor('array', ('div', 0.125, ('var', 1)), ('name', 'stor11', 11))[uint8(s)]:
                s = s + 1
                continue 
            require s < stor12.length
            require stor('array', ('div', 0.125, ('var', 0)), ('name', 'stor10', 10))[uint8(idx)] + stor('array', ('div', 0.125, ('var', 1)), ('name', 'stor12', 12))[uint8(s)] >= stor('array', ('div', 0.125, ('var', 1)), ('name', 'stor12', 12))[uint8(s)]
            require stor('array', ('div', 0.125, ('var', 0)), ('name', 'stor10', 10))[uint8(idx)] + stor('array', ('div', 0.125, ('var', 1)), ('name', 'stor12', 12))[uint8(s)] + 1000 >= 1000
            if rate:
                require rate
                require (1000 * rate) + (stor('array', ('div', 0.125, ('var', 0)), ('name', 'stor10', 10))[uint8(idx)] * rate) + (stor('array', ('div', 0.125, ('var', 1)), ('name', 'stor12', 12))[uint8(s)] * rate) / rate == stor('array', ('div', 0.125, ('var', 0)), ('name', 'stor10', 10))[uint8(idx)] + stor('array', ('div', 0.125, ('var', 1)), ('name', 'stor12', 12))[uint8(s)] + 1000
            rate = (1000 * rate) + (stor('array', ('div', 0.125, ('var', 0)), ('name', 'stor10', 10))[uint8(idx)] * rate) + (stor('array', ('div', 0.125, ('var', 1)), ('name', 'stor12', 12))[uint8(s)] * rate) / 1000
            require arg1
            if msg.value:
                require msg.value
                require rate * msg.value / msg.value == rate
    ...
    while idx < stor11.length:
        mem[0] = 11
        if tokenPriceInCents * rate * msg.value / 100 / 10^18 < stor('array', ('div', 0.125, ('var', 0)), ('name', 'stor11', 11))[uint8(idx)]:
            idx = idx + 1
            continue 
        require idx < stor12.length
        require stor('array', ('div', 0.125, ('var', 0)), ('name', 'stor12', 12))[uint8(idx)] >= stor('array', ('div', 0.125, ('var', 0)), ('name', 'stor12', 12))[uint8(idx)]
