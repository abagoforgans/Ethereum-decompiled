...
function sub_ebb2f04e(?) payable {
    require Mask(1, 4, stor1[address(msg.sender)]) == 16
    email[address(arg1)][].field_0 = Array(len=arg2.length, data=arg2[all])
    email[address(arg1)].field_256 = arg3
    if email[address(arg1)].field_512:
...
function sub_bf806d3e(?) payable {
    mem[96] = 0
    mem[128] = 0
    mem[160] = 0
    mem[192] = 0
    if not email[address(msg.sender)].field_1024:
        mem[32] = 2
        ...
        return 64, 
               ...
               0
    mem[224] = email[address(msg.sender)][3].length
    mem[256] = email[address(msg.sender)][3].field_0
    idx = 256
    s = 0
    while email[address(msg.sender)][3].length + 224 > idx:
        mem[idx + 32] = email[address(msg.sender)][s + 3].field_256
        idx = idx + 32
        s = s + 1
        continue 
    mem[32] = 2
    mem[64] = ceil32(email[address(msg.sender)][3].length) + ceil32(email[address(msg.sender)].length) + 288
    mem[ceil32(email[address(msg.sender)][3].length) + 256] = email[address(msg.sender)].length
    mem[0] = sha3(address(msg.sender), 2)
    mem[ceil32(email[address(msg.sender)][3].length) + 288] = email[address(msg.sender)].field_0
    idx = ceil32(email[address(msg.sender)][3].length) + 288
    s = 0
    while ceil32(email[address(msg.sender)][3].length) + email[address(msg.sender)].length + 256 > idx:
        mem[idx + 32] = email[address(msg.sender)][s].field_256
        idx = idx + 32
        s = s + 1
        continue 
    mem[ceil32(email[address(msg.sender)][3].length) + ceil32(email[address(msg.sender)].length) + 288] = 64
    mem[ceil32(email[address(msg.sender)][3].length) + ceil32(email[address(msg.sender)].length) + 352] = email[address(msg.sender)].length
    mem[ceil32(email[address(msg.sender)][3].length) + ceil32(email[address(msg.sender)].length) + 384 len email[address(msg.sender)].length] = mem[ceil32(email[address(msg.sender)][3].length) + 288 len email[address(msg.sender)].length]
    mem[ceil32(email[address(msg.sender)][3].length) + ceil32(email[address(msg.sender)].length) + 320] = email[address(msg.sender)].length + 96
    mem[email[address(msg.sender)].length + ceil32(email[address(msg.sender)][3].length) + ceil32(email[address(msg.sender)].length) + 384] = email[address(msg.sender)][3].length
    mem[email[address(msg.sender)].length + ceil32(email[address(msg.sender)][3].length) + ceil32(email[address(msg.sender)].length) + 416 len email[address(msg.sender)][3].length] = mem[256 len email[address(msg.sender)][3].length]
    if not email[address(msg.sender)][3].length % 32:
        return Array(len=email[address(msg.sender)].length, data=mem[ceil32(email[address(msg.sender)][3].length) + 288 len email[address(msg.sender)].length], email[address(msg.sender)][3].length, mem[256 len email[address(msg.sender)][3].length]), 
               email[address(msg.sender)].length + 96
    mem[floor32(email[address(msg.sender)][3].length) + email[address(msg.sender)].length + ceil32(email[address(msg.sender)][3].length) + ceil32(email[address(msg.sender)].length) + 416] = mem[floor32(email[address(msg.sender)][3].length) + email[address(msg.sender)].length + ceil32(email[address(msg.sender)][3].length) + ceil32(email[address(msg.sender)].length) + -email[address(msg.sender)][3].length % 32 + 448 len email[address(msg.sender)][3].length % 32]
    return Array(len=email[address(msg.sender)].length, data=mem[ceil32(email[address(msg.sender)][3].length) + 288 len email[address(msg.sender)].length], email[address(msg.sender)][3].length, mem[ceil32(email[address(msg.sender)][3].length) + ceil32(email[address(msg.sender)].length) + email[address(msg.sender)].length + 416 len floor32(email[address(msg.sender)][3].length) + 32]), 
           email[address(msg.sender)].length + 96
}
