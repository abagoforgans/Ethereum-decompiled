...
const _fallback = code.data[18 len 4133]
...
function sub_63be1d22(?) payable {
    ...
    mem[ceil32(arg1.length) + ceil32(arg2.length) + 320 len 222] = code.data[3911 len 222]
    idx = 0
    s = 0
    while idx < arg1.length:
        require idx < arg1.length
...
function register(string arg1, uint256 arg2) payable {
    ...
    mem[ceil32(arg1.length) + 416 len 222] = code.data[3911 len 222]
    idx = 0
    s = 0
    while idx < 7:
        require idx < 7
    ...
    mem[64] = mem[64] + 256
    mem[_422] = 222
    mem[_422 + 32 len 222] = code.data[3911 len 222]
        ...
        if not _686 % 32:
            ...
            if not _689 % 32:
                call address(stor0.field_0).0xadf59f99 with:
                   value ext_call.return_data[0] wei
                     gas gas_remaining - 34050 wei
                    args arg2, 96, _686 + 128, mem[mem[64] + 100 len _689 + _686 + 64]
            else:
                mem[floor32(_689) + _686 + mem[64] + 164] = mem[floor32(_689) + _686 + mem[64] + -(_689 % 32) + 196 len _689 % 32]
                call address(stor0.field_0).0xadf59f99 with:
                   value ext_call.return_data[0] wei
                     gas gas_remaining - 34050 wei
                    args arg2, 96, _686 + 128, mem[mem[64] + 100 len floor32(_689) + _686 + 96]
        else:
        ...
        if not _695 % 32:
            ...
            if not _701 % 32:
                call address(stor0.field_0).0xadf59f99 with:
                   value ext_call.return_data[0] wei
                     gas gas_remaining - 34050 wei
                    args arg2, 96, _695 + 128, mem[mem[64] + 100 len _701 + _695 + 64]
            else:
                mem[floor32(_701) + _695 + mem[64] + 164] = mem[floor32(_701) + _695 + mem[64] + -(_701 % 32) + 196 len _701 % 32]
                call address(stor0.field_0).0xadf59f99 with:
                   value ext_call.return_data[0] wei
                     gas gas_remaining - 34050 wei
                    args arg2, 96, _695 + 128, mem[mem[64] + 100 len floor32(_701) + _695 + 96]
        else:
            ...
            if not _711 % 32:
                call address(stor0.field_0).0xadf59f99 with:
                   value ext_call.return_data[0] wei
                     gas gas_remaining - 34050 wei
                    args arg2, 96, floor32(_695) + 160, mem[mem[64] + 100 len _711 + floor32(_695) + 96]
            else:
                mem[floor32(_711) + floor32(_695) + mem[64] + 196] = mem[floor32(_711) + floor32(_695) + mem[64] + -(_711 % 32) + 228 len _711 % 32]
                call address(stor0.field_0).0xadf59f99 with:
                   value ext_call.return_data[0] wei
                     gas gas_remaining - 34050 wei
                    args arg2, 96, floor32(_695) + 160, mem[mem[64] + 100 len floor32(_711) + floor32(_695) + 128]
    require ext_call.success
