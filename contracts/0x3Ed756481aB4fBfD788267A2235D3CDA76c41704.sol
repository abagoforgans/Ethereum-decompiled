...
function _fallback() {
    stor0 = msg.sender
    stor0 = code.data[2539 len 20]
    require code.data[2539 len 20]
    stor9 = code.data[2603 len 20]
    require ext_code.size(code.data[2603 len 20])
    call code.data[2603 len 20].0xeefa597b with:
         gas gas_remaining - 50 wei
    require ext_call.success
    require ext_call.return_data[0]
    require code.data[2559 len 32]
    require code.data[2623 len 32]
    stor7 = code.data[2559 len 32]
    stor2 = code.data[2623 len 32]
    return code.data[324 len 2203]
}
