...
function _fallback() payable {
    ...
    mem[192] = 'VVI'
    bool(stor5.length) = 0
    uint255(stor5.length.field_1) = 3
    Mask(248, 0, stor5.length.field_8) = 'VVI' / 256
    idx = 0
    ...
    mem[224 len -6392] = code.data[7267 len -6392]
    stor0 = mem[256]
...
function burn(uint256 arg1) {
    require stor1[address(msg.sender)]
    require balanceOf[address(this.address)] >= arg1 * 10^decimals
    balanceOf[address(this.address)] += -1 * arg1 * 10^decimals
    totalSupply += -1 * arg1 * 10^decimals
    emit Burn((arg1 * 10^decimals));
}

function bonus(uint256 arg1) {
    require stor1[address(msg.sender)]
    require (arg1 * 10^decimals) + balanceOf[address(this.address)] > balanceOf[address(this.address)]
    balanceOf[address(this.address)] += arg1 * 10^decimals
    totalSupply += arg1 * 10^decimals
    emit Bonus((arg1 * 10^decimals));
}
...
function AccountVoid(address arg1) {
    require stor1[address(msg.sender)]
    require balanceOf[address(arg1)] > 0
    balanceOf[address(arg1)] = 0
    balanceOf[msg.sender] += balanceOf[address(arg1)]
    emit VoidAccount(balanceOf[address(arg1)], arg1, msg.sender);
    require balanceOf[address(arg1)] + balanceOf[msg.sender] == balanceOf[arg1] + balanceOf[address(msg.sender)]
}
...
function _fallback() payable {
    require msg.value > 0
    require msg.sender
    require balanceOf[address(this.address)] >= msg.value * 10^decimals * ethPerToken / 10^18
    require balanceOf[address(msg.sender)] + (msg.value * 10^decimals * ethPerToken / 10^18) >= balanceOf[address(msg.sender)]
    require not stor10[address(this.address)]
    balanceOf[this.address] -= msg.value * 10^decimals * ethPerToken / 10^18
    balanceOf[address(msg.sender)] += msg.value * 10^decimals * ethPerToken / 10^18
    emit Transfer((msg.value * 10^decimals * ethPerToken / 10^18), this.address, msg.sender);
