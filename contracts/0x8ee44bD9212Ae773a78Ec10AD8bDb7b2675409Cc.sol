...
const WEI_RAISED_CAP = 128888 * 10^18
...
function createTokens(address arg1) payable {
    ...
    require block.timestamp <= startTime + (672 * 24 * 3600)
    require weiRaised < 128888 * 10^18
    if weiRaised + msg.value <= 128888 * 10^18:
        if block.timestamp < startTime + (168 * 24 * 3600):
            if msg.value:
                require msg.value
        ...
        call msg.sender with:
           value msg.value + weiRaised - 128888 * 10^18 wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        if block.timestamp < startTime + (168 * 24 * 3600):
            if -weiRaised + 128888 * 10^18:
                require -weiRaised + 128888 * 10^18
                require (-1000 * weiRaised) + 128888000 * 10^18 / -weiRaised + 128888 * 10^18 == 1000
            require (-1000 * weiRaised) + totalSupply + 128888000 * 10^18 >= totalSupply
            totalSupply = (-1000 * weiRaised) + totalSupply + 128888000 * 10^18
            require 128888 * 10^18 >= weiRaised
            weiRaised = 128888 * 10^18
            require (-1000 * weiRaised) + balanceOf[address(arg1)] + 128888000 * 10^18 >= balanceOf[address(arg1)]
            balanceOf[address(arg1)] = (-1000 * weiRaised) + balanceOf[address(arg1)] + 128888000 * 10^18
            emit TokenCreated(((-1000 * weiRaised) + 128888000 * 10^18), arg1);
        else:
            if block.timestamp < startTime + (336 * 24 * 3600):
                if -weiRaised + 128888 * 10^18:
                    require -weiRaised + 128888 * 10^18
                    require (-900 * weiRaised) + (32222 * 10^18 * 3600) / -weiRaised + 128888 * 10^18 == 900
                require (-900 * weiRaised) + totalSupply + (32222 * 10^18 * 3600) >= totalSupply
                totalSupply = (-900 * weiRaised) + totalSupply + (32222 * 10^18 * 3600)
                require 128888 * 10^18 >= weiRaised
                weiRaised = 128888 * 10^18
                require (-900 * weiRaised) + balanceOf[address(arg1)] + (32222 * 10^18 * 3600) >= balanceOf[address(arg1)]
                balanceOf[address(arg1)] = (-900 * weiRaised) + balanceOf[address(arg1)] + (32222 * 10^18 * 3600)
                emit TokenCreated(((-900 * weiRaised) + (32222 * 10^18 * 3600)), arg1);
            else:
                if block.timestamp >= startTime + (504 * 24 * 3600):
                    if -weiRaised + 128888 * 10^18:
                        require -weiRaised + 128888 * 10^18
                        require (-700 * weiRaised) + 90221600 * 10^18 / -weiRaised + 128888 * 10^18 == 700
                    require (-700 * weiRaised) + totalSupply + 90221600 * 10^18 >= totalSupply
                    totalSupply = (-700 * weiRaised) + totalSupply + 90221600 * 10^18
                    require 128888 * 10^18 >= weiRaised
                    weiRaised = 128888 * 10^18
                    require (-700 * weiRaised) + balanceOf[address(arg1)] + 90221600 * 10^18 >= balanceOf[address(arg1)]
                    balanceOf[address(arg1)] = (-700 * weiRaised) + balanceOf[address(arg1)] + 90221600 * 10^18
                    emit TokenCreated(((-700 * weiRaised) + 90221600 * 10^18), arg1);
                else:
                    if -weiRaised + 128888 * 10^18:
                        require -weiRaised + 128888 * 10^18
                        require (-800 * weiRaised) + 103110400 * 10^18 / -weiRaised + 128888 * 10^18 == 800
                    require (-800 * weiRaised) + totalSupply + 103110400 * 10^18 >= totalSupply
                    totalSupply = (-800 * weiRaised) + totalSupply + 103110400 * 10^18
                    require 128888 * 10^18 >= weiRaised
                    weiRaised = 128888 * 10^18
                    require (-800 * weiRaised) + balanceOf[address(arg1)] + 103110400 * 10^18 >= balanceOf[address(arg1)]
                    balanceOf[address(arg1)] = (-800 * weiRaised) + balanceOf[address(arg1)] + 103110400 * 10^18
                    emit TokenCreated(((-800 * weiRaised) + 103110400 * 10^18), arg1);
        call stor19 with:
           value -weiRaised + 128888 * 10^18 wei
             gas 2300 * is_zero(value) wei
    require ext_call.success
}
...
function _fallback() payable {
    ...
    if weiRaised + msg.value <= 128888 * 10^18:
        ...
        if block.timestamp < startTime + (168 * 24 * 3600):
            ...
            require 128888 * 10^18 >= weiRaised
            weiRaised = 128888 * 10^18
            require (-1000 * weiRaised) + balanceOf[address(msg.sender)] + 128888000 * 10^18 >= balanceOf[address(msg.sender)]
            balanceOf[address(msg.sender)] = (-1000 * weiRaised) + balanceOf[address(msg.sender)] + 128888000 * 10^18
            emit TokenCreated(((-1000 * weiRaised) + 128888000 * 10^18), msg.sender);
        else:
            if block.timestamp < startTime + (336 * 24 * 3600):
                if -weiRaised + 128888 * 10^18:
                    require -weiRaised + 128888 * 10^18
                ...
                require 128888 * 10^18 >= weiRaised
                weiRaised = 128888 * 10^18
                require (-900 * weiRaised) + balanceOf[address(msg.sender)] + (32222 * 10^18 * 3600) >= balanceOf[address(msg.sender)]
                balanceOf[address(msg.sender)] = (-900 * weiRaised) + balanceOf[address(msg.sender)] + (32222 * 10^18 * 3600)
                emit TokenCreated(((-900 * weiRaised) + (32222 * 10^18 * 3600)), msg.sender);
            else:
                if block.timestamp >= startTime + (504 * 24 * 3600):
                    if -weiRaised + 128888 * 10^18:
                        require -weiRaised + 128888 * 10^18
                    ...
                    require 128888 * 10^18 >= weiRaised
                    weiRaised = 128888 * 10^18
                    require (-700 * weiRaised) + balanceOf[address(msg.sender)] + 90221600 * 10^18 >= balanceOf[address(msg.sender)]
                    balanceOf[address(msg.sender)] = (-700 * weiRaised) + balanceOf[address(msg.sender)] + 90221600 * 10^18
                    emit TokenCreated(((-700 * weiRaised) + 90221600 * 10^18), msg.sender);
                else:
                    if -weiRaised + 128888 * 10^18:
                        require -weiRaised + 128888 * 10^18
                        require (-800 * weiRaised) + 103110400 * 10^18 / -weiRaised + 128888 * 10^18 == 800
                    ...
                    require 128888 * 10^18 >= weiRaised
                    weiRaised = 128888 * 10^18
                    require (-800 * weiRaised) + balanceOf[address(msg.sender)] + 103110400 * 10^18 >= balanceOf[address(msg.sender)]
                    balanceOf[address(msg.sender)] = (-800 * weiRaised) + balanceOf[address(msg.sender)] + 103110400 * 10^18
                    emit TokenCreated(((-800 * weiRaised) + 103110400 * 10^18), msg.sender);
        call stor19 with:
           value -weiRaised + 128888 * 10^18 wei
             gas 2300 * is_zero(value) wei
    require ext_call.success
