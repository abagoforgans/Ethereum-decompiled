...
function set(uint256 arg1) payable {
    ...
    uint8(stor5.length) = 14
    Mask(192, 0, stor5.length.field_8) = 0
    stor5.length.field_200 % 72057594037927936 = 13850742090640434
    ...
    while (stor6.length + 31 / 32) - 0x9addddcec1d7ba6ad726df49aeea3e93fb0c1037d551236841a60c0c883f2c1 > idx:
        ...
        idx = idx + 1
        continue 
    uint8(stor7.length) = 14
    Mask(192, 0, stor7.length.field_8) = 0
    stor7.length.field_200 % 72057594037927936 = 13850742090640434
    ...
    Mask(248, 0, stor8.length.field_8) = '01-05,15' / 256
