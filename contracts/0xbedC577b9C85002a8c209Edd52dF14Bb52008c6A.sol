...
function getMaxBet() {
    if invest >= investorsProfit:
        if invest + investorsProfit >= invest:
            if invest + investorsProfit >= investorsLosses:
                return ((500 * invest) + (500 * investorsProfit) - (500 * investorsLosses) / 10000)
            else:
                return 0
        else:
            return 0
...
function check(uint256 arg1) {
    ...
    if invest < investorsProfit:
        ...
        if invest + investorsProfit < invest:
            ...
            if invest + investorsProfit >= investorsLosses:
                if arg1 > (500 * invest) + (500 * investorsProfit) - (500 * investorsLosses) / 10000:
                    return 0
            else:
                if arg1 > 0:
                    return 0
...
function getStatus() {
    if invest >= investorsProfit:
                ...
                if invest >= investorsProfit:
                    if invest + investorsProfit >= invest:
                        if invest + investorsProfit >= investorsLosses:
                            return invest + investorsProfit - investorsLosses, 
                                   minBet,
                                   (500 * invest) + (500 * investorsProfit) - (500 * investorsLosses) / 10000,
                                   divestFee,
                                   1000,
                                   sub_4d1db3e9
        ...
        if invest >= investorsProfit:
            if invest + investorsProfit >= invest:
                if invest + investorsProfit >= investorsLosses:
                    return 0, minBet, (500 * invest) + (500 * investorsProfit) - (500 * investorsLosses) / 10000, divestFee, 1000, sub_4d1db3e9
