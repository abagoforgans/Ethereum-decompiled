...
function _fallback() {
    stor0 = msg.sender
    stor0 = code.data[2531 len 20]
    require code.data[2531 len 20]
    stor9 = code.data[2595 len 20]
    require ext_code.size(code.data[2595 len 20])
    call code.data[2595 len 20].isToken() with:
         gas gas_remaining - 50 wei
    require ext_call.success
    require ext_call.return_data[0]
    require code.data[2551 len 32]
    stor7 = code.data[2551 len 32]
    stor2 = code.data[2615 len 32]
    return code.data[312 len 2207]
}
