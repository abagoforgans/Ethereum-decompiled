...
function _fallback() payable {
    ...
    stor11 = block.timestamp + (8760 * 24 * 3600)
    require address(stor10.field_0) == msg.sender
    stor1[address(stor10.field_0)] -= stor12
    stor2[0x1306bfbc0c20beadeec30000f634d08985d87de] += stor12
    return code.data[336 len 3283]
}
...
function eraseUnsoldPreSaleTokens() {
    ...
    balances[stor10] -= preSaleSupply
    preSaleSupply = 0
}

function add_tokens(address arg1, uint256 arg2) {
    require owner == msg.sender
    balances[stor10] -= arg2
    balances[arg1] += arg2
}
