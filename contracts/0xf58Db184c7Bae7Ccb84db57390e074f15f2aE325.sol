        ...
        if not t:
            ...
            if not _70 % 32:
                ...
                call stor1.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _70 + _68 + -mem[64] + 128]
            else:
                mem[floor32(_70) + _68 + 132] = mem[floor32(_70) + _68 + -(_70 % 32) + 164 len _70 % 32]
                require ext_code.size(stor1)
                call stor1.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len floor32(_70) + _68 + -mem[64] + 160]
        else:
            ...
            if not _75 % 32:
                ...
                call stor1.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len _75 + _73 + -mem[64] + 128]
            else:
                mem[floor32(_75) + _73 + 132] = mem[floor32(_75) + _73 + -(_75 % 32) + 164 len _75 % 32]
                require ext_code.size(stor1)
                call stor1.mem[mem[64] len 4] with:
                     gas gas_remaining wei
                    args mem[mem[64] + 4 len floor32(_75) + _73 + -mem[64] + 160]
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        idx = idx + 1
        continue 
