...
function _fallback() payable {
    ...
    while stor3.length + 31 / 32 > idx:
        ...
        continue 
    bool(stor4.length) = 0
    stor4.length.field_1 = 13
    stor4.length.field_8 = 'openANX Token' / 256
    idx = 0
    ...
    stor0 = 0
    stor6[stor1] = 0
    stor13 = address(code.data[14436 len 32])
    create contract with 0 wei
                    code: code.data[8707 len 5729], this.address
...
const START_DATE = (416149 * 3600)

const TOKENS_SOFT_CAP = 13000000 * 10^18

const END_DATE = (416869 * 3600)

const TOKENS_HARD_CAP = 30000000 * 10^18

const DECIMALSFACTOR = 10^18

const LOCKED_2Y_DATE = (433669 * 3600)

const NAME = 'openANX Token'

const LOCKED_1Y_DATE = (424909 * 3600)
...
function setTokensPerKEther(uint256 arg1) {
    require owner == msg.sender
    require block.timestamp < 416149 * 3600
    require arg1 > 0
...
function finalise() {
    ...
    if totalSupply < 13000000 * 10^18:
        require block.timestamp > 416869 * 3600
    require not stor10
    require ext_code.size(lockedTokensAddress)
