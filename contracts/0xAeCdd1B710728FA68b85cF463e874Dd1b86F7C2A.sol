...
const sub_0e9c2a53(?) = (block.timestamp + 930)
...
const sub_54f42b66(?) = (block.timestamp + 260730)

const sub_57077019(?) = 3600

const sub_649d75a7(?) = 2 * 10^9

const finalizeStartTime = (block.timestamp + 347190)

const finalizeEndTime = (block.timestamp + 31536347190)

const sub_8a393f06(?) = (block.timestamp + 900)
...
const sub_aa4cfe0f(?) = (block.timestamp + 347130)

const tokensPerCHF = 10

const sub_e19b8c26(?) = (block.timestamp + 260130)
