...
const _fallback = code.data[28 len 9632]
...
function transfer(address arg1, uint256 arg2) {
    if not stor7[address(msg.sender)]:
        if ext_code.size(latestVersionAddress):
        ...
        if ext_code.size(stor7[address(msg.sender)]):
...
function _forwardTransferFromWithReference(address arg1, address arg2, uint256 arg3, string arg4, address arg5) {
    ...
    if not arg4.length:
        if not arg4.length % 32:
            if ext_code.size(etoken2Address):
                call etoken2Address.proxyTransferFromWithReference(address rg1, address rg2, uint256 rg3, bytes32 rg4, string rg5, address rg6) with:
                     gas gas_remaining - 710 wei
                    args 0, 0, 0, arg3, etoken2Symbol, 192, address(arg5), arg4.length, mem[ceil32(arg4.length) + 356 len arg4.length]
                if ext_call.success:
                    return bool(ext_call.return_data[0])
        else:
            ...
            if ext_code.size(etoken2Address):
                call etoken2Address.proxyTransferFromWithReference(address rg1, address rg2, uint256 rg3, bytes32 rg4, string rg5, address rg6) with:
                     gas gas_remaining - 710 wei
                    args address(arg1), address(arg2), arg3, etoken2Symbol, Array(len=arg4.length, data=mem[ceil32(arg4.length) + 356 len floor32(arg4.length) + 32]), address(arg5)
                if ext_call.success:
                    return bool(ext_call.return_data[0])
    else:
        ...
        if ext_code.size(etoken2Address):
            call etoken2Address.proxyTransferFromWithReference(address rg1, address rg2, uint256 rg3, bytes32 rg4, string rg5, address rg6) with:
                 gas gas_remaining - 710 wei
                args address(arg1), address(arg2), arg3, etoken2Symbol, Array(len=arg4.length, data=mem[ceil32(arg4.length) + 356 len arg4.length]), address(arg5)
            if ext_call.success:
                return bool(ext_call.return_data[0])
    revert
}
...
function transferToICAPWithReference(bytes32 arg1, uint256 arg2, string arg3) {
    ...
    mem[ceil32(arg3.length) + 128] = 0xc10796df00000000000000000000000000000000000000000000000000000000
        ...
        if not arg3.length:
            if not arg3.length % 32:
                if ext_code.size(latestVersionAddress):
                    call latestVersionAddress.0xc10796df with:
                         gas gas_remaining - 710 wei
                        args 0, uint32(arg1), arg2, 128, msg.sender, arg3.length, mem[ceil32(arg3.length) + 292 len arg3.length]
                    if ext_call.success:
                        return bool(ext_call.return_data[0])
            else:
                ...
                if ext_code.size(latestVersionAddress):
                    call latestVersionAddress.0xc10796df with:
                         gas gas_remaining - 710 wei
                        args arg1, arg2, Array(len=arg3.length, data=mem[ceil32(arg3.length) + 292 len floor32(arg3.length) + 32]), msg.sender
                    if ext_call.success:
                        return bool(ext_call.return_data[0])
        else:
            ...
            if ext_code.size(latestVersionAddress):
                call latestVersionAddress.0xc10796df with:
                     gas gas_remaining - 710 wei
                    args arg1, arg2, Array(len=arg3.length, data=mem[ceil32(arg3.length) + 292 len arg3.length]), msg.sender
                if ext_call.success:
                    return bool(ext_call.return_data[0])
    else:
        if not arg3.length:
...
function transferFromWithReference(address arg1, address arg2, uint256 arg3, string arg4) {
    mem[128 len arg4.length] = arg4[all]
    mem[ceil32(arg4.length) + 128] = 0xcca9702500000000000000000000000000000000000000000000000000000000
    mem[ceil32(arg4.length) + 132] = arg1
    mem[ceil32(arg4.length) + 164] = arg2
    mem[ceil32(arg4.length) + 196] = arg3
...
function transferWithReference(address arg1, uint256 arg2, string arg3) {
    ...
    if not stor7[address(msg.sender)]:
        if not arg3.length:
            ...
            mem[ceil32(arg3.length) + 292] = mem[128]
            if arg3.length > 32:
                mem[ceil32(arg3.length) + 324] = mem[160]
                mem[ceil32(arg3.length) + 356 len floor32(arg3.length - 33)] = mem[192 len floor32(arg3.length - 33)]
            if ext_code.size(latestVersionAddress):
                call latestVersionAddress.0x1962df71 with:
                     gas gas_remaining - 710 wei
