...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'MCB 1.0' / 256
    idx = 0
    ...
    if not stor5[address(msg.sender)]:
        ...
        stor7++
    stor5[address(msg.sender)] = 152 * 10^14
    stor4 = 152 * 10^14
    bool(stor1.length) = 0
    stor1.length.field_1 = 7
    stor1.length.field_8 = 'MACCABI' / 256
    idx = 0
