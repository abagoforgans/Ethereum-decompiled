...
function getUser(address arg1) payable {
    ...
    require userAtIndex[stor8[address(arg1)].field_256] == arg1
...
function isUser(address arg1) payable {
    ...
    if not userAtIndex.length:
        return 0
    require user[address(arg1)].field_256 < userAtIndex.length
    return (userAtIndex[stor8[address(arg1)].field_256] == arg1)
}
...
function sub_7b4b20e1(?) payable {
    ...
    if not userAtIndex.length:
        return 1
    require user[address(arg1)].field_256 < userAtIndex.length
    if userAtIndex[stor8[address(arg1)].field_256] != arg1:
        return 1
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if userAtIndex.length:
        ...
        if userAtIndex[stor8[address(msg.sender)].field_256] == msg.sender:
