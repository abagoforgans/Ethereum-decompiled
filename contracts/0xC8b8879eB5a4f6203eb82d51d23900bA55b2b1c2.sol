...
function _fallback() payable {
    ...
    require code.data[21709 len 32] >= block.timestamp
    require code.data[21741 len 32] >= code.data[21709 len 32]
    require code.data[21773 len 32] > 0
    require code.data[21817 len 20]
    create contract with 0 wei
                    code: code.data[14235 len 7474]
    require create.new_address
    emit CrowdSaleTokenContractCreation()
    stor0 = address(create.new_address)
    stor1 = code.data[21709 len 32]
    stor2 = code.data[21741 len 32]
    stor4 = code.data[21773 len 32]
    stor3 = code.data[21817 len 20]
    ...
    stor7 = 55
    stor8 = msg.sender
    return code.data[736 len 13499]
}
