...
function destroy() {
    ...
    staticcall sub_d348050cAddress.0x70a08231 with:
            gas gas_remaining wei
           args this.address
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_11272e72(?) {
    ...
    require ext_code.size(arg1)
    call arg1.revertStake(bytes32 arg1) with:
         gas gas_remaining wei
        args arg3
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
...
function sub_e9b77113(?) {
    ...
    call stakeRequests[arg1].field_256.bounty() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    require ext_code.size(stakeRequests[arg1].field_256)
    call stakeRequests[arg1].field_256.stake(uint256 arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5, bytes32 arg6) with:
         gas gas_remaining wei
