...
function _fallback() payable {
    ...
    mem[224 len -4866] = code.data[5472 len -4866]
...
function sub_a3646027(?) {
    ...
    mem[arg3.length + ceil32(arg3.length) + 128] = sha3(address(arg1), 6)
    stor[mem[ceil32(arg3.length) + floor32(arg3.length) + 128 len (arg3.length % 32) + 32]][call.data[arg3 + 36 len floor32(arg3.length)]] = arg2
    return 1
}
