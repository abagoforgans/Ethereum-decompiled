...
function getPlotsByReference(uint256[] arg1) {
    ...
    mem[(32 * arg1.length) + 160 len 32 * arg1.length] = code.data[10171 len 32 * arg1.length]
    mem[(64 * arg1.length) + 160] = arg1.length
    mem[(64 * arg1.length) + 192 len 32 * arg1.length] = code.data[10171 len 32 * arg1.length]
    mem[(98 * arg1.length) + 192] = arg1.length
    mem[64] = (131 * arg1.length) + 224
    mem[(98 * arg1.length) + 224 len 32 * arg1.length] = code.data[10171 len 32 * arg1.length]
    idx = 0
    while idx < arg1.length:
        require idx < mem[96]
        require idx < mem[(32 * arg1.length) + 128]
...
function getPlots(uint256[] arg1, uint256[] arg2) {
    ...
    mem[(32 * arg2.length) + (32 * arg1.length) + 192 len 32 * arg1.length] = code.data[10171 len 32 * arg1.length]
    mem[(32 * arg2.length) + (64 * arg1.length) + 192] = arg1.length
    mem[(32 * arg2.length) + (64 * arg1.length) + 224 len 32 * arg1.length] = code.data[10171 len 32 * arg1.length]
    mem[(32 * arg2.length) + (98 * arg1.length) + 224] = arg1.length
    mem[64] = (32 * arg2.length) + (131 * arg1.length) + 256
    mem[(32 * arg2.length) + (98 * arg1.length) + 256 len 32 * arg1.length] = code.data[10171 len 32 * arg1.length]
    idx = 0
    s = 0
    while idx < arg1.length:
        require idx < mem[96]
