...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require block.timestamp < code.data[4004 len 32]
    require code.data[3952 len 20]
    stor3 = code.data[4004 len 32]
    stor2 = code.data[4036 len 32]
    stor4 = code.data[3952 len 20]
    address(stor5.field_0) = code.data[3984 len 20]
    mem[224] = code.data[3952 len 20]
    mem[256] = code.data[3984 len 20]
    emit LogCreate(address rg1, address rg2, uint256 rg3, uint256 rg4):
                   mem[224 len 64],
                   code.data[4004 len 32],
                   code.data[4036 len 32],
    return code.data[746 len 3194]
}
