...
function _fallback() payable {
    ...
    stor1 = code.data[3754 len 32]
    stor2 = code.data[3786 len 32]
    stor3 = code.data[3818 len 32]
    stor6[address(msg.sender)] = 1
    if address(code.data[3850 len 32]):
        stor0 = code.data[3850 len 32] or Mask(96, 160, stor0)
    return code.data[164 len 3590]
}
...
function members(uint256 arg1) payable {
    return address(members[arg1].field_0), uint8(members[arg1].field_0), uint256(members[arg1].field_256)
}
...
function numberOfMembers() payable {
    return stor8.length
}
