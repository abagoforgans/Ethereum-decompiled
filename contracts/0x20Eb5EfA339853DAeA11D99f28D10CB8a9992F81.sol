...
function _fallback() {
    stor0 = code.data[1750 len 20]
    stor1 = 10^18 * code.data[1770 len 32]
    stor3 = (60 * code.data[1802 len 32]) + block.timestamp
    stor4 = 10^18 * code.data[1834 len 32]
    stor5 = code.data[1878 len 20]
    return code.data[165 len 1573]
}
