...
function _fallback() {
    ...
    stor5 = 32000
    stor6 = 4269
    stor10[0x18e8a5f1e402763f4d3c2a02288f7f7a7256] = stor3
    stor11[0x18e8a5f1e402763f4d3c2a02288f7f7a7256] = 1
    return code.data[553 len 2553]
}
...
function transfer(address arg1, uint256 arg2) {
    ...
    if genesis[address(msg.sender)] == 1:
        stor9 = block.number - initialBlockCount
        stor7 = rewardPerBlockPerAddress * stor9
        if stor7 > initialSupplyPerAddress:
            stor7 = initialSupplyPerAddress
        require arg2 <= stor7
