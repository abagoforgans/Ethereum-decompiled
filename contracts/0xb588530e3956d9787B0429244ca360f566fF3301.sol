...
function getWinners() {
    ...
    if 288 < (32 * ext_call.return_data[0] + ext_call.return_data[32]) + 288:
        ...
        return Array(len=ext_call.return_data[0] + ext_call.return_data[32], data=mem[288 len floor32(ext_call.return_data[0] + ext_call.return_data[32])], mem[(64 * ext_call.return_data[0] + ext_call.return_data[32]) + floor32(ext_call.return_data[0] + ext_call.return_data[32]) + 416 len (32 * mem[(32 * ext_call.return_data[0] + ext_call.return_data[32]) + 288]) + (161 * ext_call.return_data[0]) + (161 * ext_call.return_data[32]) + -floor32(ext_call.return_data[0] + ext_call.return_data[32]) + 32]), 
