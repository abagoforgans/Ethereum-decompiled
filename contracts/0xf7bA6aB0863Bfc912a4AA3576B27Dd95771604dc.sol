        ...
        if not beneficiaryAddress:
            ...
            call msg.sender with:
               value msg.value - buildingCostWei wei
                 gas 2300 * is_zero(value) wei
    require ext_code.size(0xe04b265660d4928948c9b9f858665bf26bf0598c)
    delegate 0xe04b265660d4928948c9b9f858665bf26bf0598c.create(string rg1, string rg2, uint8 rg3, uint256 rg4) with:
