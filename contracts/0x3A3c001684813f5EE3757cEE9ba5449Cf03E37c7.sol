...
function isRegistered(address arg1) payable {
    codecall 0x6fb3397291e074dddc1298bd816b932bbe164bd9.0x186110f2 with:
...
function getInfo(address arg1) payable {
    codecall 0x4c8e1e87535211e8220e2812930ee06bb892b8d9.0x6164da3f with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
...
function sub_65afd0ed(?) payable {
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        return 0
    codecall 0x4c8e1e87535211e8220e2812930ee06bb892b8d9.0x493b26b3 with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
    if not callcode.return_data[0]:
...
function submitAudit(address arg1, bytes32 arg2, bool arg3) payable {
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0x4c8e1e87535211e8220e2812930ee06bb892b8d9.0xf9993e41 with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
    codecall 0x4c8e1e87535211e8220e2812930ee06bb892b8d9.0x3414178 with:
         gas gas_remaining - 50 wei
...
function sub_63d88608(?) payable {
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0x4c8e1e87535211e8220e2812930ee06bb892b8d9.0x5975bfa3 with:
         gas gas_remaining - 50 wei
        args 0, 3, address(arg1), arg2, tx.origin
    require callcode.return_code
    if not callcode.return_data[0]:
        return 0
    codecall 0x4c8e1e87535211e8220e2812930ee06bb892b8d9.0xa9a6a2bb with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
...
function sub_38401c43(?) payable {
    ...
    call configAddress.0x855fe6ed with:
        ...
        args ('settings/redemptionfee' << 80)
    require ext_call.success
    codecall 0x4c8e1e87535211e8220e2812930ee06bb892b8d9.0x236873f3 with:
         gas gas_remaining - 50 wei
...
function sub_59d76fe7(?) payable {
    ...
    if sub_1a8b3383[address(arg1)].field_160 != 4:
        return 0
    codecall 0x6fb3397291e074dddc1298bd816b932bbe164bd9.0x934a11b2 with:
         gas gas_remaining - 50 wei
    ...
    codecall 0x4c8e1e87535211e8220e2812930ee06bb892b8d9.0x7f3848bc with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
    if not callcode.return_data[0]:
...
function sub_87352ed5(?) payable {
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0x4c8e1e87535211e8220e2812930ee06bb892b8d9.0xc5ad2603 with:
         gas gas_remaining - 50 wei
...
function sub_c4336036(?) payable {
    codecall 0x4c8e1e87535211e8220e2812930ee06bb892b8d9.0x22c800c4 with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
    call configAddress.0x4cb44f8d with:
...
function sub_97eb103e(?) payable {
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0x6fb3397291e074dddc1298bd816b932bbe164bd9.0xccd7ef98 with:
         gas gas_remaining - 50 wei
        args 2, arg1
    require callcode.return_code
    if not callcode.return_data[0]:
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0x4c8e1e87535211e8220e2812930ee06bb892b8d9.0x80718ce7 with:
         gas gas_remaining - 50 wei
...
function sub_511cef7a(?) payable {
    ...
    if address(ext_call.return_data[0]) == sub_1a8b3383[address(msg.sender)].field_0:
        ...
        call configAddress.0x4cb44f8d with:
            ...
            args 0x636f6e74726163742f6d696e7465720000000000000000000000000000000000
        require ext_call.success
        codecall 0x4c8e1e87535211e8220e2812930ee06bb892b8d9.0x37e2eaa0 with:
             gas gas_remaining - 50 wei
