...
function sub_168aacd3(?) {
    balanceOf[address(msg.sender)] = 12 * 10^10 * 24 * 3600
    totalSupply = 12 * 10^10 * 24 * 3600
    bool(name.length) = 0
    name.length.field_1 = 10
    name.length.field_8 = 'MitronCoin' / 256
    idx = 0
    ...
    symbol.length.field_8 = 'MITRO' / 256
    idx = 0
