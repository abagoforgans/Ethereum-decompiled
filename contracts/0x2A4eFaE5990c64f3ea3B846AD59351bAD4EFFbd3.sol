...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor3 = 10^18 * code.data[3408 len 32]
    stor10 = block.timestamp + (24 * 3600 * code.data[3440 len 32])
    stor6 = code.data[3472 len 32]
    stor7 = code.data[3504 len 32]
    return code.data[171 len 3237]
}
