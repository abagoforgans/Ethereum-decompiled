...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor1 = code.data[2872 len 20]
    stor0 = code.data[2904 len 20]
    stor6 = code.data[2924 len 32]
    require code.data[2924 len 32] + block.timestamp >= block.timestamp
    stor8 = code.data[2924 len 32] + block.timestamp
    return code.data[241 len 2619]
}
...
function withdraw() {
    ...
    if payouts[address(msg.sender)].field_0:
        require payouts[address(msg.sender)].field_0 - 1 < payouts[address(msg.sender)].field_0
