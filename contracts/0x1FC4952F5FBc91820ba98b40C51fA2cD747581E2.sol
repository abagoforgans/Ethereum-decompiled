...
function _fallback() payable {
    ...
    stor2 = code.data[1715 len 20]
    stor3 = 10^18 * code.data[1735 len 32]
    stor5 = (60 * code.data[1767 len 32]) + stor6
    return code.data[199 len 1504]
}
...
const sub_176d4fa1(?) = 33000 * 10^18
