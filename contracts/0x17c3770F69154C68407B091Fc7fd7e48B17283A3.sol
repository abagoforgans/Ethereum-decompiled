...
function _fallback() payable {
    ...
    stor4 = code.data[5023 len 20]
    stor5 = 0
    stor6 = 0
    stor7 = 0
    stor8 = 10^18 * code.data[5043 len 32]
    stor0 = 1000000000 * 10^18
    stor1[address(msg.sender)] = 1000000000 * 10^18
    require stor8 <= 1000000000 * 10^18
    return code.data[501 len 4510]
}
...
const name = 32, 21, 0xb3e7949fe68081e993be0000000000000000000000
