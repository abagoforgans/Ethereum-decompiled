...
function _fallback() {
    stor0 = code.data[2887 len 20]
    require code.data[2887 len 20]
    stor9 = code.data[2951 len 20]
    require ext_code.size(code.data[2951 len 20])
    call code.data[2951 len 20].isToken() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require ext_call.return_data[0]
    require code.data[2907 len 32]
    require code.data[2971 len 32]
    stor7 = code.data[2907 len 32]
    stor2 = code.data[2971 len 32]
    return code.data[321 len 2554]
}
...
function tokensToBeReturned(address arg1) {
    ...
    call tokenAddress.0x70a08231 with:
        ...
        args this.address
    require ext_call.success
    require ext_code.size(0x7ff4893eb1c2e7d027e38febcada6b1e1a001a02)
    delegate 0x7ff4893eb1c2e7d027e38febcada6b1e1a001a02.0xf4f3bdc1 with:
         gas gas_remaining - 710 wei
