...
function _fallback() payable {
    require code.data[4924 len 20] != 0
    require code.data[5008 len 32] >= 10^18
    stor2 = code.data[4912 len 32]
    stor3 = code.data[4944 len 32]
    stor6 = code.data[4976 len 32] or Mask(96, 160, stor6)
    stor5 = code.data[5008 len 32]
    stor4.length++
