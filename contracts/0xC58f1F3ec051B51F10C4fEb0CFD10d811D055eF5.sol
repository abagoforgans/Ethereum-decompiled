...
function sub_8e9e2795(?) {
    ...
    while idx < stor2:
        ...
        mem[32] = 22
        if bool(stor22[stor8[idx].field_1024]) == 1:
            require holdplatform_balance > 0
            require sub_5ae33a34[stor8[idx].field_1024] > 0
            require sub_5ae33a34[stor8[idx].field_1024]
            mem[132] = getSafe[idx].field_1536 + getSafe[idx].field_1792 / sub_5ae33a34[stor8[idx].field_1024] / 4
            require ext_code.size(holdplatform_address)
            call holdplatform_address.0xa9059cbb with:
                 gas gas_remaining wei
                args msg.sender, getSafe[idx].field_1536 + getSafe[idx].field_1792 / sub_5ae33a34[stor8[idx].field_1024] / 4
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require getSafe[idx].field_1536 + getSafe[idx].field_1792 / sub_5ae33a34[stor8[idx].field_1024] / 4 <= holdplatform_balance
            holdplatform_balance -= getSafe[idx].field_1536 + getSafe[idx].field_1792 / sub_5ae33a34[stor8[idx].field_1024] / 4
            mem[0] = 4
            mem[32] = 17
            sub_0c5d5323[4]++
            mem[96] = getSafe[idx].field_1536 + getSafe[idx].field_1792 / sub_5ae33a34[stor8[idx].field_1024] / 4
            mem[128] = block.timestamp
            emit 0x8c684a1c: Mask(254, 2, getSafe[idx].field_1536 + getSafe[idx].field_1792 / sub_5ae33a34[stor8[idx].field_1024]), block.timestamp
