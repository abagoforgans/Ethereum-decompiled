...
function _fallback() payable {
    ...
    mem[192] = 'Yee - A Blockchain-powered & Clo'
    mem[224] = 'ud-based Social Ecosystem'
    mem[256] = 3
    stor1[address(msg.sender)] = 10000000000 * 10^18
    ...
    stor5.length.field_8 = 'YEE' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[609 len 5943]
}
