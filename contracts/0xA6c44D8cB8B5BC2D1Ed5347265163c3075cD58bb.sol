...
function checkOwners(address arg1) {
...
function addSuperMan(address arg1) {
    require calldata.size - 4 >= 32
    require 1 == bool(stor1[address(msg.sender)])
    stor1[address(arg1)] = 1
}

function deleteSuperMan(address arg1) {
    require calldata.size - 4 >= 32
    require 1 == bool(stor1[address(msg.sender)])
    stor1[address(arg1)] = 0
}

function addContractAddress(string arg1, address arg2) {
...
function checkAddress(string arg1) {
    require calldata.size - 4 >= 32
    require arg1 <= 4294967296
    require arg1 + 36 <= calldata.size
    require arg1.length <= 4294967296 and arg1 + arg1.length + 36 <= calldata.size
