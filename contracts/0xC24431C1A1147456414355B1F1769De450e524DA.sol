...
function _fallback() payable {
    ...
    call address(stor0).0x2ef3accc with:
         gas gas_remaining - 25050 wei
        args Array(len=3, data=mem[388]), 200001
    require ext_call.success
    mem[452] = mem[481 len 3]
    mem[580] = mem[600 len 12]
    call address(stor0).'8Y(2' with:
       value ext_call.return_data[0] wei
         gas gas_remaining - 34050 wei
        args Mask(224, 0, '8Y(2'), 0, 128, 192, 200001, 3, mem[452], 76, 'json(https://api.kraken.com/0/pu', 'blic/Ticker?pair=ETHXBT).result.', 'XETHXXBT.c.0' >> 256, mem[580]
    require ext_call.success
    return code.data[896 len 6898]
}
...
function update() payable {
    ...
    call address(stor0.field_0).0x38592832 with:
       value ext_call.return_data[0] wei
         gas gas_remaining - 34050 wei
        args 0, 128, 192, 200001, 3, mem[452], 76, 'json(https://api.kraken.com/0/pu', 'blic/Ticker?pair=ETHXBT).result.', 'XETHXXBT.c.0' >> 256, mem[580]
    require ext_call.success
}
...
function __callback(bytes32 arg1, string arg2) payable {
    ...
    call address(stor0.field_0).0x2ef3accc with:
         gas gas_remaining - 25050 wei
        args Array(len=3, data=mem[ceil32(arg2.length) + 420]), 200001
    require ext_call.success
    mem[ceil32(arg2.length) + 484] = mem[ceil32(arg2.length) + 513 len 3]
    mem[ceil32(arg2.length) + 612] = mem[ceil32(arg2.length) + 632 len 12]
    call address(stor0.field_0).0x38592832 with:
       value ext_call.return_data[0] wei
         gas gas_remaining - 34050 wei
        args 0, 128, 192, 200001, 3, mem[ceil32(arg2.length) + 484], 76, 'json(https://api.kraken.com/0/pu', 'blic/Ticker?pair=ETHXBT).result.', 'XETHXXBT.c.0' >> 256, mem[ceil32(arg2.length) + 612]
    require ext_call.success
}
