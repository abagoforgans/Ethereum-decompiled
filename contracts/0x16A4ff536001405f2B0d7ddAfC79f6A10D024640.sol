...
function payouts(uint256 arg1) payable {
    ...
    return address(stor0[arg1].field_0), stor[code.data[698 len 32] + (2 * arg1)]
}

function _fallback() payable {
    require msg.value >= 901 * 10^15
    stor0.length++
    ...
    if stor[code.data[698 len 32] + (2 * stor1)] >= eth.balance(this.address):
