...
const name = 'matching coin'

const decimals = 18

const symbol = 'mco'

const INITIAL_SUPPLY = 12500000000 * 10^18

const TOKEN_OFFERING_ALLOWANCE = 5000000000 * 10^18

const ADMIN_ALLOWANCE = 7500000000 * 10^18
...
function setTokenOffering(address arg1, uint256 arg2) {
    ...
    if not arg2:
        allowance[address(msg.sender)][address(arg1)] = 5000000000 * 10^18
        emit Approval(5000000000 * 10^18, msg.sender, arg1);
    else:
