...
function sub_9740ee55(?) {
    ...
    require not saleTime
    require 4 >= arg2
    require endSaleTime + (30 * arg2) < block.timestamp
...
function sub_c0af35cc(?) {
    ...
    require not saleTime
    require 50 >= arg2
    require endSaleTime + (10 * arg2) < block.timestamp
...
function sub_e4a7d374(?) {
    ...
    require not saleTime
    require 1 >= arg2
    require endSaleTime + (480 * arg2) < block.timestamp
