...
function _fallback() {
    mem[96 len -1645] = code.data[2184 len -1645]
    mem[64] = -1549
    ...
    while idx < stor2:
        ...
        require mem[mem[160] + (32 * idx) + 128]
        idx = idx + 1
        continue 
    idx = 0
    while idx < stor2:
        require idx < mem[mem[192] + 96]
        require mem[mem[192] + (32 * idx) + 140 len 20]
        require idx < mem[mem[160] + 96]
        require idx < mem[mem[192] + 96]
        mem[0] = mem[mem[192] + (32 * idx) + 140 len 20]
        mem[32] = 4
        stor4[mem[mem[192] + (32 * idx) + 140 len 20]] = mem[(32 * idx) + mem[160] + 128]
        idx = idx + 1
        continue 
    return code.data[539 len 1645]
}
    ...
    while idx < totalMembers:
        ...
        if not ext_call.return_data[0]:
            ...
            if ext_call.return_data[0]:
                if stor4[stor5[idx]] * ext_call.return_data[0] / ext_call.return_data[0] == stor4[stor5[idx]]:
                    allocatedBonus = stor4[stor5[idx]] * ext_call.return_data[0] / 10000
                    if idx < team.length:
                        mem[0] = 5
                        mem[96] = 0x40c10f1900000000000000000000000000000000000000000000000000000000
