...
function _fallback() payable {
    stor0 = 17
    stor6C8 = msg.sender or Mask(96, 160, stor6C8)
    return code.data[50 len 10705]
}
    ...
    if address(stor[(6 * arg2) + (102 * arg1) + 1].field_8) == msg.sender:
        ...
        if block.number - uint256(stor[(6 * arg2) + (102 * arg1) + 5].field_0) >= 4320:
            ...
            while uint8(idx) < 20:
                require arg1 < 17
                require arg2 < 17
                uint256(stor[(6 * arg2) + (102 * arg1) + 4].field_0) += 5
                if not uint256(stor[(6 * arg2) + (102 * arg1) + 4].field_0) <= uint256(stor[(6 * arg2) + (102 * arg1) + 4].field_0) + 5:
                    s = uint256(stor[(6 * arg2) + (102 * arg1) + 4].field_0) + sha3((6 * arg2) + (102 * arg1) + 4) + 5
                ...
                if uint8(idx) != 0:
                    stor[uint256(stor[(6 * arg2) + (102 * arg1) + 4].field_0) + sha3((6 * arg2) + (102 * arg1) + 4) - 1].field_0 % 32 = (block.hash(block.number - 1) % uint8(16^(-(2 * idx) + 64))) - (block.hash(block.number - 1) % uint8(16^(-(2 * idx) + 64)) % uint8(16^(-(2 * idx) + 62))) / uint8(16^(-(2 * idx) + 62)) % 32
                else:
                    stor[uint256(stor[(6 * arg2) + (102 * arg1) + 4].field_0) + sha3((6 * arg2) + (102 * arg1) + 4) - 1].field_0 % 32 = block.hash(block.number - 1) - (block.hash(block.number - 1) % uint8(16^(-(2 * idx) + 62))) / uint8(16^(-(2 * idx) + 62)) % 32
