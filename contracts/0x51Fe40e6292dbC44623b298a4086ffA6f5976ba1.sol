    ...
    if msg.sender == synthetixAddress:
        ...
        if ext_code.size(arg2) > 0:
            ...
            if not mem[96] % 32:
                ...
                mem[128 len 4] = tokenFallback(address arg1, uint256 arg2, bytes arg3)
...
function transferSenderPaysFee(address arg1, uint256 arg2) {
    ...
    call synthetixAddress.synthInitiatedFeePayment(address arg1, bytes4 arg2, uint256 arg3) with:
         gas gas_remaining wei
    ...
    require return_data.size >= 32
    require ext_code.size(synthetixAddress)
    call synthetixAddress.synthetixState() with:
         gas gas_remaining wei
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    ...
    if Mask(32, 224, ext_call.return_data[0]):
        if Mask(32, 224, ext_call.return_data[0]) != currencyKey << 224:
            require ext_code.size(synthetixAddress)
            call synthetixAddress.synthInitiatedExchange(address arg1, bytes4 arg2, uint256 arg3, bytes4 arg4, address arg5) with:
                 gas gas_remaining wei
...
function transferFromSenderPaysFee(address arg1, address arg2, uint256 arg3) {
    ...
    if ext_code.size(arg2) > 0:
        ...
        mem[0xb46310f600000000000000000000000000000000000000000000000000000104 len 0xb46310f6000000000000000000000000000000000000000000000000000000a0] = tokenFallback(address arg1, uint256 arg2, bytes arg3), address(arg1) << 64, 0, arg3, 96, 0xb46310f600000000000000000000000000000000000000000000000000000000, mem[260 len 0xb46310f60000000000000000000000000000000000000000000000000000001c]
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if ext_code.size(arg2) > 0:
        ...
        mem[0xb46310f600000000000000000000000000000000000000000000000000000104 len 0xb46310f6000000000000000000000000000000000000000000000000000000a0] = tokenFallback(address arg1, uint256 arg2, bytes arg3), address(arg1) << 64, 0, ext_call.return_data[0], 96, 0xb46310f600000000000000000000000000000000000000000000000000000000, mem[260 len 0xb46310f60000000000000000000000000000000000000000000000000000001c]
        call arg2.mem[0xb46310f600000000000000000000000000000000000000000000000000000104 len 4] with:
             gas gas_remaining wei
            args mem[0xb46310f600000000000000000000000000000000000000000000000000000108 len -34200741572826756699665901277701165871636220859340273501194218286545538908004]
    uint8(stor5.field_160) = 0
...
function transferFromSenderPaysFee(address arg1, address arg2, uint256 arg3, bytes arg4) {
    ...
    if ext_code.size(arg2) > 0:
        ...
        if not arg4.length % 32:
            mem[arg4.length + ceil32(arg4.length) + 292 len floor32(arg4.length + 163)] = tokenFallback(address arg1, uint256 arg2, bytes arg3), address(arg1) << 64, 0, arg3, 96, arg4.length, Mask(8 * ceil32(arg4.length), -(8 * ceil32(arg4.length)) + 256, arg4[all], mem[arg4.length + 128 len ceil32(arg4.length) - arg4.length]) << (8 * ceil32(arg4.length)) - 256, mem[(2 * ceil32(arg4.length)) + 292 len floor32(arg4.length + 163) + -ceil32(arg4.length) - 132]
            ...
            mem[floor32(arg4.length) + ceil32(arg4.length) + 324 len floor32(floor32(arg4.length) + 195)] = tokenFallback(address arg1, uint256 arg2, bytes arg3), address(arg1) << 64, 0, arg3, 96, arg4.length, Mask(8 * ceil32(arg4.length), -(8 * ceil32(arg4.length)) + 256, arg4[all], mem[arg4.length + 128 len ceil32(arg4.length) - arg4.length]) << (8 * ceil32(arg4.length)) - 256, mem[(2 * ceil32(arg4.length)) + 292 len floor32(floor32(arg4.length) + 195) + -ceil32(arg4.length) - 132]
...
function transferFrom(address arg1, address arg2, uint256 arg3, bytes arg4) {
    ...
    if ext_code.size(arg2) > 0:
        mem[ceil32(arg4.length) + 292 len ceil32(arg4.length)] = arg4[all], mem[arg4.length + 128 len ceil32(arg4.length) - arg4.length]
        if not arg4.length % 32:
            mem[arg4.length + ceil32(arg4.length) + 292 len floor32(arg4.length + 163)] = tokenFallback(address arg1, uint256 arg2, bytes arg3), address(arg1) << 64, 0, ext_call.return_data[0], 96, arg4.length, Mask(8 * ceil32(arg4.length), -(8 * ceil32(arg4.length)) + 256, arg4[all], mem[arg4.length + 128 len ceil32(arg4.length) - arg4.length]) << (8 * ceil32(arg4.length)) - 256, mem[(2 * ceil32(arg4.length)) + 292 len floor32(arg4.length + 163) + -ceil32(arg4.length) - 132]
            if not arg4.length + 132 % 32:
                call arg2.mem[arg4.length + ceil32(arg4.length) + 292 len 4] with:
                     gas gas_remaining wei
                    args mem[arg4.length + ceil32(arg4.length) + 296 len arg4.length + 128]
            ...
            mem[floor32(arg4.length) + ceil32(arg4.length) + 292] = mem[floor32(arg4.length) + ceil32(arg4.length) + -(arg4.length % 32) + 324 len arg4.length % 32]
            mem[floor32(arg4.length) + ceil32(arg4.length) + 324 len floor32(floor32(arg4.length) + 195)] = tokenFallback(address arg1, uint256 arg2, bytes arg3), address(arg1) << 64, 0, ext_call.return_data[0], 96, arg4.length, Mask(8 * ceil32(arg4.length), -(8 * ceil32(arg4.length)) + 256, arg4[all], mem[arg4.length + 128 len ceil32(arg4.length) - arg4.length]) << (8 * ceil32(arg4.length)) - 256, mem[(2 * ceil32(arg4.length)) + 292 len floor32(floor32(arg4.length) + 195) + -ceil32(arg4.length) - 132]
            if not floor32(arg4.length) + 164 % 32:
                call arg2.mem[floor32(arg4.length) + ceil32(arg4.length) + 324 len 4] with:
                     gas gas_remaining wei
                    args mem[floor32(arg4.length) + ceil32(arg4.length) + 328 len (2 * floor32(arg4.length)) + 160]
