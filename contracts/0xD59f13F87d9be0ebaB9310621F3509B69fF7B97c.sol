...
uint8 sub_11b1eb1a;
uint8 sub_6f2ba5c5; offset 8

function sub_11b1eb1a(?) {
    return bool(sub_11b1eb1a)
}
...
function sub_6f2ba5c5(?) {
    return bool(sub_6f2ba5c5)
}
...
function sub_f577b1c2(?) {
    require owner == msg.sender
    require sub_11b1eb1a
    require not sub_6f2ba5c5
    increment = arg1
}
...
function sub_87b59806(?) {
    require sub_878f5965
    if 5 * 10^15 > eth.balance(this.address) / sub_878f5965:
        increment = 5 * 10^15
    else:
        increment = eth.balance(this.address) / sub_878f5965
}

function poke() payable {
    require sub_6f2ba5c5
