...
const sub_7a9e5410(?) = 5

const sub_825db5f7(?) = 2
...
function kill() payable {
    codecall 0x633419c7968332148099857773f7156c900dea02.0x7d65837a with:
...
function iterateNext(uint256 arg1) payable {
    codecall 0x633419c7968332148099857773f7156c900dea02.0x685a1f3c with:
         gas gas_remaining - 50 wei
        args 1, arg1
    require callcode.return_code
    return callcode.return_data[0]
...
function iterateValid(uint256 arg1) payable {
    codecall 0x633419c7968332148099857773f7156c900dea02.0x33556e84 with:
         gas gas_remaining - 50 wei
        args 1, arg1
    require callcode.return_code
    return callcode.return_data[0]
...
function iterateGet(uint256 arg1) payable {
    codecall 0x633419c7968332148099857773f7156c900dea02.0xf775b6b5 with:
         gas gas_remaining - 50 wei
        args 1, arg1
    require callcode.return_code
...
function add(address arg1) payable {
    ...
    require callcode.return_code
    if callcode.return_data[0]:
        codecall 0x633419c7968332148099857773f7156c900dea02.0x21ce24d4 with:
             gas gas_remaining - 50 wei
            args 1, arg1
        require callcode.return_code
}
...
function remove(address arg1) payable {
    ...
    require callcode.return_code
    if callcode.return_data[0]:
        codecall 0x633419c7968332148099857773f7156c900dea02.0x89489a87 with:
             gas gas_remaining - 50 wei
            args 1, arg1
        require callcode.return_code
}
