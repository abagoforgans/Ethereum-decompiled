...
function _fallback() {
    ...
    stor2.length.field_8 = 'IPFSC' / 256
    idx = 0
    ...
    stor3.length.field_8 = 'ipfs coin' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        ...
        continue 
    stor4 = 4
    stor5 = 277777775 * 3600
    stor6[0xb15caf6d420166c632368fa6e68079bbf8278c0c] = stor5
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  stor5,
    emit 0x0: stor5
    emit 0xb15caf6d: stor5
    return code.data[686 len 5579]
}
