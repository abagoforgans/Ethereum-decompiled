...
function set(uint256 arg1) payable {
    ...
    Mask(248, 0, stor5.length.field_8) = '15-20,02' / 256
    ...
    Mask(248, 0, stor7.length.field_8) = '17-20,14' / 256
    ...
    if eth.balance(stor4) <= 5 * 10^17:
        if 0 == block.number + bool(block.difficulty):
            ...
            if block.number + bool(block.timestamp) != 0:
                mem[352] = uint256(stor7.field_0)
                idx = 352
                s = 0
                while stor7.length + 352 > idx + 32:
                ...
                call stor3.mem[352 len 4] with:
                   value 5 * 10^17 wei
                     gas gas_remaining - 34050 wei
                    args mem[356 len stor7.length + (floor32(stor7.length - 1) + -stor7.length + 32 % 32) - 4]
            else:
