...
function _fallback() payable {
    ...
    stor1 = code.data[3196 len 32]
    stor2 = code.data[3228 len 32]
    require code.data[3272 len 20] != msg.sender
    require code.data[3304 len 20] != msg.sender
    uint256(stor6.field_0) = msg.sender or Mask(96, 160, uint256(stor6.field_0))
    stor5 = code.data[3292 len 32]
    uint256(stor4) = code.data[3260 len 32]
    ...
    return code.data[1025 len 2171]
}
