...
function _fallback() {
    mem[96 len -9454] = code.data[10246 len -9454]
    mem[64] = -9358
...
function sub_120da4df(?) {
    return block.timestamp, stor0[arg1].field_1024 + sub_7d1d8596
}

function sub_68d6b997(?) {
    return (block.timestamp < stor0[arg1].field_1024 + sub_7d1d8596)
}
...
function executeTransaction(uint256 arg1) {
    ...
    while idx < owners.length:
        ...
        if not uint8(stor1[arg1][address(stor3[idx].field_0)]):
            ...
            if s + 1 != required:
                ...
                s = s + 1
                continue 
        if block.timestamp >= stor0[arg1].field_1024 + sub_7d1d8596:
    ...
    if block.timestamp >= stor0[arg1].field_1024 + sub_7d1d8596:
        ...
        if Mask(255, 1, (256 * not bool(stor0[arg1].field_512)) - 1 and stor0[arg1].field_512):
            emit ExecutionFailure(arg1);
        else:
            if block.timestamp > lastDay + (24 * 3600):
...
function submitTransaction(address arg1, uint256 arg2, bytes arg3) {
    ...
    while idx < owners.length:
        ...
        if not uint8(stor1[stor5][address(stor3[idx].field_0)]):
            ...
            if s + 1 != required:
                ...
                s = s + 1
                continue 
        if block.timestamp >= stor0[stor5].field_1024 + sub_7d1d8596:
            ...
            while ceil32(arg3.length) + stor0[stor5][2].length + 288 > idx + 32:
                mem[idx + 32] = uint256(stor1[s])
                idx = idx + 32
                s = s + 1
                continue 
            call address(stor0[stor5].field_0).mem[ceil32(arg3.length) + 288 len 4] with:
               value stor0[stor5].field_256 wei
                 gas gas_remaining - 34710 wei
                args mem[ceil32(arg3.length) + 292 len stor0[stor5][2].length + (floor32(stor0[stor5][2].length - 1) + -stor0[stor5][2].length + 32 % 32) - 4]
            if ext_call.success:
    ...
    if block.timestamp >= stor0[stor5].field_1024 + sub_7d1d8596:
        ...
        if Mask(255, 1, (256 * not bool(stor0[stor5].field_512)) - 1 and stor0[stor5].field_512):
            emit ExecutionFailure(transactionCount);
        else:
            if block.timestamp > lastDay + (24 * 3600):
                lastDay = block.timestamp
