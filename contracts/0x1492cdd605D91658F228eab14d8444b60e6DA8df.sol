...
function persons(uint256 arg1) payable {
    ...
    return address(stor0[arg1].field_0), stor[code.data[1055 len 32] + (2 * arg1)]
}
...
function enter() payable {
    ...
    if msg.value <= 500 * 10^18:
        ...
        if not stor0.length > stor0.length + 1:
            ...
            stor[code.data[1055 len 32] + (2 * stor0.length)] = msg.value
            if not stor0.length:
                balance += msg.value
            else:
                collectedFees += 3 * msg.value / 100
                call address(owner) with:
                   value (3 * msg.value / 100) + collectedFees wei
                     gas 0 wei
                collectedFees = 0
                balance = msg.value - (3 * msg.value / 100) + balance
            if balance <= 125 * stor[code.data[1055 len 32] + (2 * stor1)] / 100:
        ...
        call msg.sender with:
           value msg.value - 500 * 10^18 wei
             gas 0 wei
        stor0.length++
        if not stor0.length > stor0.length + 1:
            require stor0.length < stor0.length
            stor0[stor0.length].field_0 = msg.sender or Mask(96, 160, stor0[stor0.length].field_0)
            stor[code.data[1055 len 32] + (2 * stor0.length)] = 500 * 10^18
            if not stor0.length:
                balance += 500 * 10^18
            else:
                collectedFees += 15 * 10^18
                call address(owner) with:
                   value collectedFees + 15 * 10^18 wei
                     gas 0 wei
                collectedFees = 0
                balance += 485 * 10^18
            if balance <= 125 * stor[code.data[1055 len 32] + (2 * stor1)] / 100:
