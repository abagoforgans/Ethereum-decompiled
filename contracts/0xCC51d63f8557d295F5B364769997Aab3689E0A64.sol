...
function getNextPrice(uint256 arg1) {
    require ext_code.size(0x3a667a506a2ea357a5f950f63d188f02163ab0d0)
    delegate 0x3a667a506a2ea357a5f950f63d188f02163ab0d0.0x574047ac with:
         gas gas_remaining wei
        args 2, arg1, 1
...
function findPrecedingPrice(uint256 arg1) {
    require ext_code.size(0x3a667a506a2ea357a5f950f63d188f02163ab0d0)
    delegate 0x3a667a506a2ea357a5f950f63d188f02163ab0d0.'5*qK' with:
         gas gas_remaining wei
...
function anyRequestAvailable() {
    require ext_code.size(0x3a667a506a2ea357a5f950f63d188f02163ab0d0)
    delegate 0x3a667a506a2ea357a5f950f63d188f02163ab0d0.0x53d00bd4 with:
         gas gas_remaining wei
        args 2
    if not delegate.return_code:
        revert with ext_call.return_data[0 len return_data.size]
...
function refund(uint256 arg1) {
    ...
    if ext_call.return_data[0] == 2:
        ...
        if ext_call.return_data[0] == 1:
            ...
            require return_data.size >= 32
            require ext_code.size(0x3a667a506a2ea357a5f950f63d188f02163ab0d0)
            delegate 0x3a667a506a2ea357a5f950f63d188f02163ab0d0.0xf593633c with:
                 gas gas_remaining wei
...
function requestAuditWithPriceHint(string arg1, uint256 arg2, uint256 arg3) {
    require not stor0
    require arg2 > 0
    require ext_code.size(auditDataAddress)
    call auditDataAddress.0xfc0c546a with:
    ...
    if delegate.return_data[0]:
        ...
        if delegate.return_data[0]:
            delegate 0x3a667a506a2ea357a5f950f63d188f02163ab0d0.'5*qK' with:
                 gas gas_remaining wei
                args 2, arg3, ext_call.return_data[0], 1
        else:
            delegate 0x3a667a506a2ea357a5f950f63d188f02163ab0d0.'5*qK' with:
                 gas gas_remaining wei
                args 2, 0, ext_call.return_data[0], 1
