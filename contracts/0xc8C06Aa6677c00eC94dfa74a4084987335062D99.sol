...
function unlockKyc(address arg1) {
    ...
    if stor29[address(arg1)] > 0:
        stor28[address(arg1)] = stor29[address(arg1)]
...
function revokeKyc(address arg1) {
    ...
    if stor28[address(arg1)] > 0:
        stor29[address(arg1)] = stor28[address(arg1)]
...
function refuseKyc(address arg1) payable {
    ...
    if stor29[address(arg1)] <= 0:
        revert with 0, 'KYC verification failed!'
    if stor29[address(arg1)] != msg.value:
        revert with 0, 'KYC verification failed!'
...
function sub_a2ace885(?) {
    ...
    if bool(stor26[Mask(128, 128, arg1)]) != 1:
...
function sub_51c951cc(?) {
    ...
    while ('cd', 4).length > uint8(idx):
        ...
        require uint8(idx) < ('cd', 68).length
        if stor26[Mask(128, 128, cd[((32 * uint8(idx)) + cd[68] + 36)])]:
...
function _fallback() payable {
    ...
    if 3000000 * 10^18 > totalSupply:
        ...
        if stor8[msg.sender]:
            ...
            require msg.value + stor29[msg.sender] >= stor29[msg.sender]
            require msg.value + stor29[msg.sender] >= msg.value
            stor29[msg.sender] += msg.value
