...
function tokenImprint(uint256 arg1) payable {
    require calldata.size - 4 >= 32
...
function updateTokenImprint(uint256 arg1, bytes32 arg2) payable {
    require calldata.size - 4 >= 64
...
function create(address arg1, uint256 arg2, bytes32 arg3) payable {
    require calldata.size - 4 >= 96
...
function revoke(uint256 arg1) payable {
    ...
    if approved[arg1]:
        approved[arg1] = 0
    require tokenOfOwnerByIndex[stor8[arg1]]
...
function tokenURI(uint256 arg1) payable {
    ...
    if not ownerOf[arg1]:
        revert with 0, ''
    if not Mask(255, 1, sub_fbca0ce1.length and (256 * not bool(sub_fbca0ce1.length)) - 1):
        return ''
    if not arg1:
    ...
    mem[192 len s] = code.data[11427 len s]
    t = s - 1
    idx = arg1
    while idx:
        require t < mem[160]
