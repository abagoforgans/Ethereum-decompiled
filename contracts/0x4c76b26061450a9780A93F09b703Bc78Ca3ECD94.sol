...
function spend(address arg1, uint256 arg2, uint8[] arg3, bytes32[] arg4, bytes32[] arg5) {
    ...
    if not arg3.length:
        ...
        while idx < arg3.length:
            ...
            _134 = mem[64]
            mem[64] = mem[64] + 32
            mem[_134 + 32] = sha3(address(arg2), uint64(arg1), sha3(spendNonce, this.address, arg2, arg1))
            mem[_134 + 64] = uint8(_123 + 27)
            mem[_134 + 96] = _128
            mem[_134 + 128] = _133
            signer = erecover(sha3(address(arg2), uint64(arg1), sha3(spendNonce, this.address, arg2, arg1)), _123 + 27 << 248, _128, _133) 
            mem[_134] = signer
        ...
        mem[(32 * arg3.length) + (32 * arg4.length) + (32 * arg5.length) + 288 len 32 * arg3.length] = code.data[2668 len 32 * arg3.length]
        idx = 0
        while idx < arg3.length:
            require idx < mem[96]
            _126 = mem[(32 * idx) + 128]
            ...
            _139 = mem[64]
            mem[64] = mem[64] + 32
            mem[_139 + 32] = sha3(address(arg2), uint64(arg1), sha3(spendNonce, this.address, arg2, arg1))
            mem[_139 + 64] = uint8(_126 + 27)
            mem[_139 + 96] = _130
            mem[_139 + 128] = _138
            signer = erecover(sha3(address(arg2), uint64(arg1), sha3(spendNonce, this.address, arg2, arg1)), _126 + 27 << 248, _130, _138) 
            mem[_139] = signer
            if not erecover.result:
                revert with ext_call.return_data[0 len return_data.size]
            require idx < mem[(32 * arg3.length) + (32 * arg4.length) + (32 * arg5.length) + 256]
