...
function sub_424b0cae(?) {
    ...
    stor5[address(msg.sender)] = sha3(call.data[0 len calldata.size])
    if stor5[stor3] == stor5[stor4]:
        stor24 = 0
        stor5[stor3] = 0
        stor5[stor4] = 0
}
...
function unlockKyc(address arg1) {
    if bool(stor7[address(msg.sender)]) != 1:
        revert with 0, 'only KYC team members!'
...
function setFundingStartTime(uint256 arg1) {
    ...
    if stor5[stor3] == stor5[stor4]:
        ...
        fundingEndTime = fundingStartTime + (696 * 24 * 3600)
        sub_43f646f8 = fundingEndTime + (4392 * 24 * 3600)
        stor5[stor3] = 0
        stor5[stor4] = 0
}
...
function sub_51c951cc(?) {
    ...
    while uint8(idx) < ('cd', 4).length:
        ...
        require totalSupply + (10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)]) >= totalSupply
        require totalSupply + (10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)]) >= 10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)]
        if totalSupply + (10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)]) > 12500 * 10^18 * 3600:
        ...
        if cd[((32 * uint8(idx)) + cd[100] + 36)]:
            ...
            require ccLockedUpBalances[address(cd[((32 * uint8(idx)) + cd[4] + 36)])] + (10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)]) >= ccLockedUpBalances[address(cd[((32 * uint8(idx)) + cd[4] + 36)])]
            require ccLockedUpBalances[address(cd[((32 * uint8(idx)) + cd[4] + 36)])] + (10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)]) >= 10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)]
            require uint8(idx) < ('cd', 4).length
            ccLockedUpBalances[address(cd[((32 * uint8(idx)) + cd[4] + 36)])] += 10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)]
        require balanceOf[address(cd[((32 * uint8(idx)) + cd[4] + 36)])] + (10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)]) >= balanceOf[address(cd[((32 * uint8(idx)) + cd[4] + 36)])]
        require balanceOf[address(cd[((32 * uint8(idx)) + cd[4] + 36)])] + (10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)]) >= 10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)]
        require uint8(idx) < ('cd', 4).length
        balanceOf[address(cd[((32 * uint8(idx)) + cd[4] + 36)])] += 10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)]
        if not stor10[address(cd[((32 * uint8(idx)) + cd[4] + 36)])]:
            holder.length++
            holder[holder.length] = address(cd[((32 * uint8(idx)) + cd[4] + 36)])
        ...
        idx = idx + 1
        s = 12500 * 10^18 * 3600
        s = totalSupply + (10^16 * cd[((32 * uint8(idx)) + cd[36] + 36)])
...
function sub_9814ccba(?) {
    ...
    if stor5[stor3] == stor5[stor4]:
        ...
        if address(stor13) != ext_call.return_data[12 len 20]:
            require ext_code.size(stor12)
            call stor12.getAddress() with:
                 gas gas_remaining wei
            if not ext_call.success:
...
function _fallback() payable {
    ...
    if totalSupply < 3000000 * 10^18:
        if msg.value * stor17 / 100:
            require msg.value * stor17 / 100
            require 142857 * msg.value * stor17 / 100 / msg.value * stor17 / 100 == 142857
        if 142857 * msg.value * stor17 / 100 / 100000 < 10^18:
            revert with 0, 'Tokens bellow TOKEN_MIN'
        require totalSupply + (142857 * msg.value * stor17 / 100 / 100000) >= totalSupply
        require totalSupply + (142857 * msg.value * stor17 / 100 / 100000) >= 142857 * msg.value * stor17 / 100 / 100000
        if totalSupply + (142857 * msg.value * stor17 / 100 / 100000) > 12500 * 10^18 * 3600:
            revert with 0, 'Token supply above TokenCap'
        if stor8[address(msg.sender)]:
            require stor27[address(msg.sender)] + msg.value >= stor27[address(msg.sender)]
            require stor27[address(msg.sender)] + msg.value >= msg.value
            stor27[address(msg.sender)] += msg.value
        else:
            require stor28[address(msg.sender)] + msg.value >= stor28[address(msg.sender)]
            require stor28[address(msg.sender)] + msg.value >= msg.value
            stor28[address(msg.sender)] += msg.value
        require allReceivedEth + msg.value >= allReceivedEth
        require allReceivedEth + msg.value >= msg.value
        allReceivedEth += msg.value
        totalSupply += 142857 * msg.value * stor17 / 100 / 100000
        balanceOf[address(msg.sender)] += 142857 * msg.value * stor17 / 100 / 100000
        sub_65aebd83 += 142857 * msg.value * stor17 / 100 / 100000
        if not stor10[address(msg.sender)]:
            holder.length++
            holder[holder.length] = msg.sender
            stor10[address(msg.sender)] = 1
        stor9[address(msg.sender)] = 1
        emit 0x3add18e9: (142857 * msg.value * stor17 / 100 / 100000), msg.sender
        emit Transfer((142857 * msg.value * stor17 / 100 / 100000), this.address, msg.sender);
    else:
        if totalSupply < 10000000 * 10^18:
            if msg.value * stor17 / 100:
                require msg.value * stor17 / 100
                require 125000 * msg.value * stor17 / 100 / msg.value * stor17 / 100 == 125000
            if 125000 * msg.value * stor17 / 100 / 100000 < 10^18:
                revert with 0, 'Tokens bellow TOKEN_MIN'
            require totalSupply + (125000 * msg.value * stor17 / 100 / 100000) >= totalSupply
            require totalSupply + (125000 * msg.value * stor17 / 100 / 100000) >= 125000 * msg.value * stor17 / 100 / 100000
            if totalSupply + (125000 * msg.value * stor17 / 100 / 100000) > 12500 * 10^18 * 3600:
                revert with 0, 'Token supply above TokenCap'
            if stor8[address(msg.sender)]:
                require stor27[address(msg.sender)] + msg.value >= stor27[address(msg.sender)]
                require stor27[address(msg.sender)] + msg.value >= msg.value
            ...
            require allReceivedEth + msg.value >= msg.value
            allReceivedEth += msg.value
            totalSupply += 125000 * msg.value * stor17 / 100 / 100000
            balanceOf[address(msg.sender)] += 125000 * msg.value * stor17 / 100 / 100000
            sub_65aebd83 += 125000 * msg.value * stor17 / 100 / 100000
            if not stor10[address(msg.sender)]:
                holder.length++
                holder[holder.length] = msg.sender
                stor10[address(msg.sender)] = 1
            stor9[address(msg.sender)] = 1
            emit 0x3add18e9: (125000 * msg.value * stor17 / 100 / 100000), msg.sender
            emit Transfer((125000 * msg.value * stor17 / 100 / 100000), this.address, msg.sender);
        else:
            if totalSupply >= 30000000 * 10^18:
                if msg.value * stor17 / 100:
                    require msg.value * stor17 / 100
                    require 100000 * msg.value * stor17 / 100 / msg.value * stor17 / 100 == 100000
                if 100000 * msg.value * stor17 / 100 / 100000 < 10^18:
                    revert with 0, 'Tokens bellow TOKEN_MIN'
                require totalSupply + (100000 * msg.value * stor17 / 100 / 100000) >= totalSupply
                require totalSupply + (100000 * msg.value * stor17 / 100 / 100000) >= 100000 * msg.value * stor17 / 100 / 100000
                if totalSupply + (100000 * msg.value * stor17 / 100 / 100000) > 12500 * 10^18 * 3600:
                    revert with 0, 'Token supply above TokenCap'
                if stor8[address(msg.sender)]:
                    require stor27[address(msg.sender)] + msg.value >= stor27[address(msg.sender)]
                    require stor27[address(msg.sender)] + msg.value >= msg.value
                ...
                require allReceivedEth + msg.value >= msg.value
                allReceivedEth += msg.value
                totalSupply += 100000 * msg.value * stor17 / 100 / 100000
                balanceOf[address(msg.sender)] += 100000 * msg.value * stor17 / 100 / 100000
                sub_65aebd83 += 100000 * msg.value * stor17 / 100 / 100000
                if not stor10[address(msg.sender)]:
                    holder.length++
                    holder[holder.length] = msg.sender
                    stor10[address(msg.sender)] = 1
                stor9[address(msg.sender)] = 1
                emit 0x3add18e9: (100000 * msg.value * stor17 / 100 / 100000), msg.sender
                emit Transfer((100000 * msg.value * stor17 / 100 / 100000), this.address, msg.sender);
            else:
                if msg.value * stor17 / 100:
                    require msg.value * stor17 / 100
                    require 111111 * msg.value * stor17 / 100 / msg.value * stor17 / 100 == 111111
                if 111111 * msg.value * stor17 / 100 / 100000 < 10^18:
                    revert with 0, 'Tokens bellow TOKEN_MIN'
                require totalSupply + (111111 * msg.value * stor17 / 100 / 100000) >= totalSupply
                require totalSupply + (111111 * msg.value * stor17 / 100 / 100000) >= 111111 * msg.value * stor17 / 100 / 100000
                if totalSupply + (111111 * msg.value * stor17 / 100 / 100000) > 12500 * 10^18 * 3600:
                    revert with 0, 'Token supply above TokenCap'
                if stor8[address(msg.sender)]:
                    require stor27[address(msg.sender)] + msg.value >= stor27[address(msg.sender)]
                    require stor27[address(msg.sender)] + msg.value >= msg.value
                ...
                require allReceivedEth + msg.value >= msg.value
                allReceivedEth += msg.value
                totalSupply += 111111 * msg.value * stor17 / 100 / 100000
                balanceOf[address(msg.sender)] += 111111 * msg.value * stor17 / 100 / 100000
                sub_65aebd83 += 111111 * msg.value * stor17 / 100 / 100000
                if not stor10[address(msg.sender)]:
                    holder.length++
                    holder[holder.length] = msg.sender
                    stor10[address(msg.sender)] = 1
                stor9[address(msg.sender)] = 1
                emit 0x3add18e9: (111111 * msg.value * stor17 / 100 / 100000), msg.sender
                emit Transfer((111111 * msg.value * stor17 / 100 / 100000), this.address, msg.sender);
}
