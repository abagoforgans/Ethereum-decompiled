...
function sub_04524263(?) {
    if lockedOf[address(arg1)] <= balanceOf[address(arg1)]:
        return (balanceOf[address(arg1)] - lockedOf[address(arg1)])
    else:
        return 0
}
...
function unlockTokens(address arg1, uint256 arg2) {
    require msg.sender == creatorAddress
    require lockedOf[address(arg1)] >= arg2
