...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'Crypto AUD' / 256
    idx = 0
    ...
    require stor6 + 19750118000 > stor6
    stor6 += 19750118000
    stor7[address(msg.sender)] += 19750118000
    emit Transfer(19750118000, 0, msg.sender);
