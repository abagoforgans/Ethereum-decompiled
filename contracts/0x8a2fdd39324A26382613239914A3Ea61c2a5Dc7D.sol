...
function _fallback() payable {
    ...
    stor2.length.field_8 = 'Coin Coin' / 256
    idx = 0
...
function getStats() {
    return totalContribution, totalSupply, totalBonusTokensIssued, bool(stor6)
}
...
function _fallback() payable {
    ...
    if msg.value:
        ...
        require ext_call.success
        totalSupply += 100000 * bonusRate * msg.value
        balanceOf[address(msg.sender)] += 100000 * bonusRate * msg.value
        totalContribution += msg.value
        emit Transfer((100000 * bonusRate * msg.value), this.address, msg.sender);
}
