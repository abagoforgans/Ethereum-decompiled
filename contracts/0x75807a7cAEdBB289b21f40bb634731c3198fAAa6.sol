...
function _fallback() payable {
    mem[96 len -8579] = code.data[10499 len -8579]
    mem[64] = -8483
    emit code.data[10467 len 32]: msg.sender
    stor1.length++
    ...
    while idx < mem[mem[256] + 96]:
        ...
        while s < stor1.length:
            ...
            idx = idx + 1
            continue 
        mem[-8483] = mem[(32 * idx) + mem[256] + 140 len 20]
        emit code.data[10467 len 32]: mem[(32 * idx) + mem[256] + 140 len 20]
        stor1.length++
        if not stor1.length <= stor1.length + 1:
    ...
    if stor20 > 0:
        ...
        if not stor1.length:
            ...
            mem[0] = 1
            mem[-8383] = address(stor1.field_0)
            idx = -8383
            s = 0
            while (32 * stor1.length) - 8383 > idx + 32:
            ...
            call stor18.0xb56af5bc with:
                 gas gas_remaining - 710 wei
                args stor20, Array(len=stor1.length, data=mem[-8383 len 32 * stor1.length])
    ...
    return code.data[1920 len 8547]
}
