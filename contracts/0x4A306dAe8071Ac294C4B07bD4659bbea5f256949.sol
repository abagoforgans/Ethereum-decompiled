...
function withdraw() {
    if stor0 != msg.sender:
        require msg.sender == 0x825d5d0df3b2d59f69cc673f041ca91a296b8183
...
function action() {
    ...
    if uint8(stor3.field_160):
        if not uint8(stor3.field_168):
            ...
            if 100 * ext_call.return_data[0] < 75 * buyPrice:
                if stor0 != msg.sender:
                    require msg.sender == 0x825d5d0df3b2d59f69cc673f041ca91a296b8183
                require ext_code.size(sub_d141c39bAddress)
                call sub_d141c39bAddress.0xe9fad8ee with:
                ...
                if 100 * ext_call.return_data[0] >= 75 * sub_0cf1b83f:
        ...
        call sub_9d652a8bAddress.buy(address arg1) with:
           value 2 * 10 * 10^18 * ext_call.return_data[0] wei
             gas gas_remaining wei
            args 0
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        buyPrice = ext_call.return_data[0]
        require ext_code.size(0x23a8939f3af99c286a3890b02452e82c0bed38a1)
        call 0x23a8939f3af99c286a3890b02452e82c0bed38a1.sellPrice() with:
             gas gas_remaining wei
        if not ext_call.success:
