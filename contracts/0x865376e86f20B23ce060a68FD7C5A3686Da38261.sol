...
function getInfo(address arg1) payable {
    codecall 0xe1d7817a2ff0c5b7af7b3ce3f804541e2d5954cf.0x6164da3f with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
...
function sub_65afd0ed(?) payable {
    ...
    if ext_call.return_data[12 len 20] != msg.sender:
        return 0
    codecall 0xe1d7817a2ff0c5b7af7b3ce3f804541e2d5954cf.0x493b26b3 with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
    if not callcode.return_data[0]:
...
function submitAudit(address arg1, bytes32 arg2, bool arg3) payable {
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0xe1d7817a2ff0c5b7af7b3ce3f804541e2d5954cf.0xf9993e41 with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
    codecall 0xe1d7817a2ff0c5b7af7b3ce3f804541e2d5954cf.0x3414178 with:
         gas gas_remaining - 50 wei
...
function sub_63d88608(?) payable {
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0xe1d7817a2ff0c5b7af7b3ce3f804541e2d5954cf.0x5975bfa3 with:
         gas gas_remaining - 50 wei
        args 0, 3, address(arg1), arg2, tx.origin
    require callcode.return_code
    if not callcode.return_data[0]:
        return 0
    codecall 0xe1d7817a2ff0c5b7af7b3ce3f804541e2d5954cf.0xa9a6a2bb with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
...
function sub_38401c43(?) payable {
    ...
    call configAddress.0x855fe6ed with:
        ...
        args ('settings/redemptionfee' << 80)
    require ext_call.success
    codecall 0xe1d7817a2ff0c5b7af7b3ce3f804541e2d5954cf.0x236873f3 with:
         gas gas_remaining - 50 wei
...
function sub_59d76fe7(?) payable {
    ...
    codecall 0xe1d7817a2ff0c5b7af7b3ce3f804541e2d5954cf.0x7f3848bc with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
    if not callcode.return_data[0]:
...
function sub_87352ed5(?) payable {
    ...
    if not ext_call.return_data[0]:
        return 0
    codecall 0xe1d7817a2ff0c5b7af7b3ce3f804541e2d5954cf.0xc5ad2603 with:
         gas gas_remaining - 50 wei
...
function sub_c4336036(?) payable {
    codecall 0xe1d7817a2ff0c5b7af7b3ce3f804541e2d5954cf.0x22c800c4 with:
         gas gas_remaining - 50 wei
        args 3, arg1
    require callcode.return_code
    call configAddress.0x4cb44f8d with:
        ...
        args 0x72656769737472792f76656e646f720000000000000000000000000000000000
    require ext_call.success
    call address(ext_call.return_data[0]).0xfe1b6f8f with:
         gas gas_remaining - 25050 wei
        args address(callcode.return_data[0])
    call configAddress.0x4cb44f8d with:
         gas gas_remaining - 25050 wei
        args 0x72656769737472792f637573746f6469616e0000000000000000000000000000
    call address(ext_call.return_data[0]).0xb168da8a with:
         gas gas_remaining - 25050 wei
...
function sub_97eb103e(?) payable {
    ...
    if not callcode.return_data[0]:
        return 0
    call arg6.0x4d471e85 with:
         gas gas_remaining - 25050 wei
        args address(arg1), arg2
    require ext_call.success
    if not ext_call.return_data[0]:
        return 0
    codecall 0xe1d7817a2ff0c5b7af7b3ce3f804541e2d5954cf.0x80718ce7 with:
         gas gas_remaining - 50 wei
...
function sub_511cef7a(?) payable {
    ...
    if address(ext_call.return_data[0]) == sub_1a8b3383[address(msg.sender)].field_0:
        ...
        call configAddress.0x4cb44f8d with:
            ...
            args 0x636f6e74726163742f6d696e7465720000000000000000000000000000000000
        require ext_call.success
        codecall 0xe1d7817a2ff0c5b7af7b3ce3f804541e2d5954cf.0x37e2eaa0 with:
             gas gas_remaining - 50 wei
