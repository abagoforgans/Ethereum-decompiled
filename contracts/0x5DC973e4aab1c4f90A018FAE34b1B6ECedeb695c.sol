...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'ArabCoin' / 256
    idx = 0
    ...
    mem[224 len -2260] = code.data[2746 len -2260]
    stor3 = mem[224] * 20 * 10^6^stor2
    stor4[address(msg.sender)] = mem[224] * 20 * 10^6^stor2
