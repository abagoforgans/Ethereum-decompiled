...
function _fallback() payable {
    ...
    stor1 = code.data[6502 len 32]
    stor2 = code.data[6534 len 32]
    stor3 = code.data[6566 len 32]
    emit ChangeOfRules(code.data[6502 len 32], code.data[6534 len 32], code.data[6566 len 32]);
    if address(code.data[6598 len 32]) != 0:
        uint256(stor0) = code.data[6598 len 32] or Mask(96, 160, uint256(stor0))
    require msg.sender == address(stor0)
    if stor6[0]:
        require stor6[0] < stor7.length
        uint8(stor7[stor6[0]].field_160) = 0
    else:
        ...
        Mask(168, 0, stor7[stor7.length].field_0) = 0
    ...
    emit MembershipChanged(address rg1, bool rg2):
                           0,
    require msg.sender == address(stor0)
    if stor6[address(stor0)]:
        require stor6[address(stor0)] < stor7.length
        uint8(stor7[stor6[address(stor0)]].field_160) = 1
    else:
        stor6[address(stor0)] = stor7.length
        stor7.length++
        if not stor7.length <= stor7.length + 1:
            mem[0] = 7
            idx = (3 * stor7.length) + 3
            while sha3(7) + (3 * stor7.length) > idx + sha3(mem[0]):
                ...
                continue 
        require stor7.length < stor7.length
        address(stor7[stor7.length].field_0) = address(stor0)
        uint8(stor7[stor7.length].field_160) = 1
        Mask(88, 0, stor7[stor7.length].field_168) = 0
        bool(stor7[stor7.length].field_256) = 0
        ...
        while stor[(3 * stor7.length) + ('name', 'stor7', 7) + 1].length + 31 / 32 > idx:
            ...
            continue 
        uint256(stor7[stor7.length].field_512) = block.timestamp
    emit MembershipChanged(address(stor0), 1);
    return code.data[1104 len 5398]
}
...
function checkProposalCode(uint256 arg1, address arg2, uint256 arg3, bytes arg4) {
    ...
    return (uint256(stor4[arg1].field_1792) == sha3(arg2, arg3, arg4[all]))
}
...
function vote(uint256 arg1, bool arg2, string arg3) {
    ...
    require arg1 < stor4.length
    require bool(uint8(stor[(10 * arg1) + ('name', 'stor4', 4) + 9][address(msg.sender)].field_0)) != 1
    uint8(stor[(10 * arg1) + ('name', 'stor4', 4) + 9][address(msg.sender)].field_0) = 1
...
function members(uint256 arg1) {
    ...
    return address(stor7[arg1].field_0), 
           bool(uint8(stor7[arg1].field_160)),
...
function proposals(uint256 arg1) {
    ...
    return address(stor4[arg1].field_0), 
           ...
           stor8A35[arg1],
           bool(uint8(stor8A35[arg1].field_0)),
           bool(uint8(stor8A35[arg1].field_8)),
           stor8A35[arg1],
           stor8A35[arg1],
           stor8A35[arg1]
}
...
function executeProposal(uint256 arg1, bytes arg2) {
    ...
    mem[ceil32(arg2.length) + 128] = address(stor4[arg1].field_0)
    mem[ceil32(arg2.length) + 148] = stor8A35[arg1]
    mem[ceil32(arg2.length) + 180 len arg2.length] = arg2[all]
    require stor8A35[arg1] == sha3(address(stor4[arg1].field_0), stor8A35[arg1], arg2[all])
    ...
    if stor8A35[arg1] <= majorityMargin:
        ...
        if not arg2.length % 32:
            ...
            call address(stor4[arg1].field_0).mem[ceil32(arg2.length) + 128 len 4] with:
               value 10^18 * stor8A35[arg1] wei
                 gas gas_remaining - 34050 wei
                args mem[ceil32(arg2.length) + 132 len floor32(arg2.length) + 28]
        require ext_call.success
        uint8(stor8A35[arg1].field_8) = 1
    emit ProposalTallied(arg1, stor8A35[arg1], stor8A35[arg1], bool(uint8(stor8A35[arg1].field_8)));
    return 0
}
...
function changeMembership(address arg1, bool arg2, string arg3) {
    ...
    if memberId[address(arg1)]:
        ...
        Mask(96, 0, stor7[stor6[address(arg1)]].field_160) = Mask(96, 0, arg2)
    else:
