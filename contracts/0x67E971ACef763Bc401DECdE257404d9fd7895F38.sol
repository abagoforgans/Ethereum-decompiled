...
const _fallback = code.data[28 len 13736]
    ...
    if arg3 * feePercent / 10000 < absMinFee:
        if 75 * arg4.length > 7500:
            ...
            if tx.origin != msg.sender:
                ...
                mem[ceil32(arg4.length) + 192] = 0xf0cbe05900000000000000000000000000000000000000000000000000000000
                mem[ceil32(arg4.length) + 196] = arg1
                mem[ceil32(arg4.length) + 228] = arg2
                mem[ceil32(arg4.length) + 260] = arg3
                mem[ceil32(arg4.length) + 292] = symbol
                mem[ceil32(arg4.length) + 324] = 160
                ...
                call multiAssetAddress.proxyTransferFromWithReference(address rg1, address rg2, uint256 rg3, bytes32 rg4, string rg5) with:
                     gas gas_remaining - 50 wei
                    args address(arg1), address(arg2), arg3, symbol, Array(len=arg4.length, data=mem[ceil32(arg4.length) + 388 len arg4.length])
                require ext_call.success
                uint8(stor21.field_160) = 0
                if ext_call.return_data[0]:
                    if block.gasprice > txGasPriceLimit:
    ...
    if arg2 * feePercent / 10000 < absMinFee:
        if 75 * arg3.length > 7500:
            ...
            if msg.sender == tx.origin:
                mem[ceil32(arg3.length) + 192] = 0xc548766100000000000000000000000000000000000000000000000000000000
                mem[ceil32(arg3.length) + 196] = arg1
                mem[ceil32(arg3.length) + 228] = arg2
                mem[ceil32(arg3.length) + 260] = 96
                mem[ceil32(arg3.length) + 292] = arg3.length
                if arg3.length:
                    mem[ceil32(arg3.length) + 324] = mem[128]
                    mem[ceil32(arg3.length) + 356 len floor32(arg3.length - 1)] = mem[160 len floor32(arg3.length - 1)]
                ...
                call multiAssetAddress.proxyTransferToICAPWithReference(bytes32 rg1, uint256 rg2, string rg3) with:
                     gas gas_remaining - 50 wei
                    args arg1, arg2, Array(len=arg3.length, data=mem[ceil32(arg3.length) + 324 len arg3.length])
            else:
...
function transferWithReference(address arg1, uint256 arg2, string arg3) {
    ...
    if arg2 * feePercent / 10000 < absMinFee:
        if 75 * arg3.length > 7500:
            ...
            uint8(stor21.field_160) = 1
            if msg.sender == tx.origin:
                mem[ceil32(arg3.length) + 192] = 0x64ef212e00000000000000000000000000000000000000000000000000000000
                mem[ceil32(arg3.length) + 196] = arg1
                mem[ceil32(arg3.length) + 228] = arg2
                mem[ceil32(arg3.length) + 260] = symbol
                mem[ceil32(arg3.length) + 292] = 128
                mem[ceil32(arg3.length) + 324] = arg3.length
                if arg3.length:
                    mem[ceil32(arg3.length) + 356] = mem[128]
                ...
                call multiAssetAddress.proxyTransferWithReference(address rg1, uint256 rg2, bytes32 rg3, string rg4) with:
                     gas gas_remaining - 50 wei
                    args address(arg1), arg2, symbol, Array(len=arg3.length, data=mem[ceil32(arg3.length) + 356 len arg3.length])
            else:
