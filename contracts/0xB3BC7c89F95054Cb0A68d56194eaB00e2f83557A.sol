    ...
    if arg1 != stor0[address(msg.sender)].field_512:
        ...
        if arg2 <= stor0[address(msg.sender)].field_256:
            ...
            while stor0[address(msg.sender)].length + 96 > idx + 32:
                ...
                s = s + 1
                continue 
            _130 = sha3(mem[96 len stor0[address(msg.sender)].length])
            _133 = sha3(stor5, sha3(mem[96 len stor0[address(msg.sender)].length]))
            mem[100] = sha3(stor5, sha3(mem[96 len stor0[address(msg.sender)].length]))
            ...
            while stor0[address(msg.sender)].length + 96 > idx + 32:
                ...
                s = s + 1
                continue 
            _137 = sha3(mem[96 len stor0[address(msg.sender)].length])
            _140 = sha3(stor5, sha3(mem[96 len stor0[address(msg.sender)].length]))
            mem[100] = sha3(stor5, sha3(mem[96 len stor0[address(msg.sender)].length]))
            require ext_code.size(stor2)
            call stor2.setResolver(bytes32 rg1, address rg2) with:
                 gas gas_remaining - 710 wei
        ...
        if arg2 <= 0:
            ...
            while stor0[address(msg.sender)].length + 96 > idx + 32:
                ...
                s = s + 1
                continue 
            _144 = sha3(mem[96 len stor0[address(msg.sender)].length])
            _147 = sha3(stor5, sha3(mem[96 len stor0[address(msg.sender)].length]))
            mem[100] = sha3(stor5, sha3(mem[96 len stor0[address(msg.sender)].length]))
            require ext_code.size(stor2)
            call stor2.setResolver(bytes32 rg1, address rg2) with:
                 gas gas_remaining - 710 wei
            ...
            while stor0[address(msg.sender)].length + 96 > idx + 32:
                ...
                s = s + 1
                continue 
            _151 = sha3(mem[96 len stor0[address(msg.sender)].length])
            _154 = sha3(stor5, sha3(mem[96 len stor0[address(msg.sender)].length]))
            mem[100] = sha3(stor5, sha3(mem[96 len stor0[address(msg.sender)].length]))
            require ext_code.size(stor2)
            call stor2.setResolver(bytes32 rg1, address rg2) with:
                 gas gas_remaining - 710 wei
