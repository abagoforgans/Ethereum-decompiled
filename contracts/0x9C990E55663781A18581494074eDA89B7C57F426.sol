...
function _fallback() {
    ...
    return code.data[1498 len 10193]
}
...
uint8 payoutsPaused; offset 160
...
uint256 costToCallOraclizeInWei;
uint256 totalWeiWon;
...
function costToCallOraclizeInWei() {
    return costToCallOraclizeInWei
}
...
function ownerUpdateCostToCallOraclize(uint256 arg1) {
    require owner == msg.sender
    costToCallOraclizeInWei = arg1
}
