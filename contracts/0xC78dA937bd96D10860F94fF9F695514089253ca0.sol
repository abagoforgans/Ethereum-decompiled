...
function _fallback() payable {
    ...
    stor4 = code.data[5759 len 20]
    address(stor5.field_0) = code.data[5791 len 20]
    stor6 = code.data[5811 len 32]
    stor7 = code.data[5843 len 32]
    stor0 = 500000000 * 10^18
    stor1[address(stor5.field_0)] = 500000000 * 10^18
    emit CreateBAT(500000000 * 10^18, address(stor5.field_0));
    return code.data[773 len 4974]
}
...
function createTokens() payable {
    ...
    emit CreateBAT((6400 * msg.value), msg.sender);
}
