...
function _fallback() payable {
    ...
    mem[96 len -6636] = code.data[7854 len -6636]
    mem[64] = -6540
    stor8 = msg.sender
    stor2 = mem[256]
    stor3 = mem[288]
    ...
    create contract with 0 wei
                    code: code.data[4857 len 2997], address(this.address), stor4
    ...
    call stor9.createToken(address rg1, uint256 rg2) with:
        ...
        args stor7, 200 * 10^6
    require ext_call.success
    return code.data[1218 len 3639]
}
...
const STAGE_ONE_TIME_END = (2 * 3600)
...
function sub_f8c5c1e6(?) {
    return sub_f8c5c1e6Address
}
