...
function sub_b401da74(?) payable {
    ...
    return address(stor[code.data[5555 len 32] + (2 * arg1)]), stor175B[arg1]
}
...
function SetName(string arg1) payable {
    ...
    emit 0xd5ccaef8: msg.sender, Array(len=arg1.length, data=arg1[all])
}
    ...
    if stor12[address(arg1)] == stor11.length:
        ...
        if stor11.length - 1 < stor11.length:
            if stor12[address(arg1)] - 1 < stor11.length:
                address(stor[code.data[5555 len 32] + (2 * stor12[address(arg1)] - 1)]) = address(stor[code.data[5555 len 32] + (2 * stor11.length - 1)])
                uint256(stor[code.data[5555 len 32] + (2 * stor12[address(arg1)] - 1) + 1]) = uint256(stor[code.data[5555 len 32] + (2 * stor11.length - 1) + 1])
                stor12[address(stor[code.data[5555 len 32] + (2 * stor12[address(arg1)] - 1)])] = stor12[address(arg1)]
                stor12[address(arg1)] = 0
                stor11.length--
                if not stor11.length <= stor11.length - 1:
                    idx = 2 * stor11.length - 1
    ...
    if stor12[address(msg.sender)] == stor11.length:
        ...
        if stor11.length - 1 < stor11.length:
            if stor12[address(msg.sender)] - 1 < stor11.length:
                address(stor[code.data[5555 len 32] + (2 * stor12[address(msg.sender)] - 1)]) = address(stor[code.data[5555 len 32] + (2 * stor11.length - 1)])
                uint256(stor[code.data[5555 len 32] + (2 * stor12[address(msg.sender)] - 1) + 1]) = uint256(stor[code.data[5555 len 32] + (2 * stor11.length - 1) + 1])
                stor12[address(stor[code.data[5555 len 32] + (2 * stor12[address(msg.sender)] - 1)])] = stor12[address(msg.sender)]
                stor12[address(msg.sender)] = 0
                stor11.length--
                if not stor11.length <= stor11.length - 1:
                    idx = 2 * stor11.length - 1
