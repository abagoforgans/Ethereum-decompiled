...
function sub_1485e4ce(?) {
    if arg1.length > 0:
        if arg2.length > 0:
            ...
            uint256(stor[sha3((3 * stor1.length) + ('name', 'stor1', 1) + 1)][].field_0) = Array(len=arg1.length, data=arg1[all])
            uint256(stor[sha3((3 * stor1.length) + ('name', 'stor1', 1) + 2)][].field_0) = Array(len=arg2.length, data=arg2[all])
