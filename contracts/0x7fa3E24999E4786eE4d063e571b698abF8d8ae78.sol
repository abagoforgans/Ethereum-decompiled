...
function _fallback() {
    stor1 = code.data[7447 len 20]
    stor0 = code.data[7415 len 20]
    return code.data[104 len 7299]
}
                ...
                if arg2.length == arg3.length:
                    if arg2.length == arg4.length:
                        ...
                        while idx < arg2.length:
                            ...
                            mem[_49 + 32] = mem[(32 * arg2.length) + (32 * idx) + 160]
                            mem[_49 + 64] = 0
                            require idx < mem[(32 * arg3.length) + (32 * arg2.length) + 160]
                            mem[_49 + 96] = mem[(32 * idx) + (32 * arg3.length) + (32 * arg2.length) + 192]
                            mem[_49 + 128] = 0
                            require idx < mem[(32 * arg4.length) + (32 * arg3.length) + (32 * arg2.length) + 192]
                            mem[_49 + 160] = bool(mem[(32 * idx) + (32 * arg4.length) + (32 * arg3.length) + (32 * arg2.length) + 224])
                            mem[mem[64]] = arg1
                            mem[mem[64] + 32] = idx
                            mem[0] = sha3(arg1, idx)
                            mem[32] = 3
                            sub_91abe6b2[arg1][idx].field_0 = mem[_49]
                            sub_91abe6b2[arg1][idx].field_256 = mem[_49 + 32]
                            sub_91abe6b2[arg1][idx].field_512 = 0
                            sub_91abe6b2[arg1][idx].field_768 = 0
                            sub_91abe6b2[arg1][idx].field_768 = mem[_49 + 96]
                            sub_91abe6b2[arg1][idx].field_1024 = 0
                            sub_91abe6b2[arg1][idx].field_1280 = uint8(bool(mem[_49 + 160]))
                            require idx < mem[(32 * arg4.length) + (32 * arg3.length) + (32 * arg2.length) + 192]
...
function sub_b9c11477(?) {
    ...
    mem[64] = (32 * arg7.length) + (32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 256
    mem[(32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 224] = arg7.length
    mem[(32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 256 len 32 * arg7.length] = call.data[arg7 + 36 len 32 * arg7.length]
    require ext_code.size(sub_44624e34Address)
    call sub_44624e34Address.0x39bc5a53 with:
         gas gas_remaining - 50 wei
        args tx.origin
        ...
        if not sub_5fa80c12[arg1].field_2048:
            if arg3.length == arg4.length:
                if arg3.length == arg5.length:
                    ...
                    sub_5fa80c12[arg1].field_256 = arg3.length
                    sub_5fa80c12[arg1].field_1792 = arg6
                    sub_5fa80c12[arg1].field_2048 = uint64(block.timestamp)
                    mem[(32 * arg7.length) + (32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 288] = 0
                    mem[(32 * arg7.length) + (32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 260] = tx.origin
                    require ext_code.size(sub_44624e34Address)
                    call sub_44624e34Address.0x39bc5a53 with:
                         gas gas_remaining - 50 wei
                        args tx.origin
                    mem[(32 * arg7.length) + (32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 256] = ext_call.return_data[0]
                    require ext_call.success
                    if ext_call.return_data[0]:
                        if 1 == bool(sub_5fa80c12[arg1].field_2048):
                            if sub_5fa80c12[arg1].field_1024 <= 0:
                                if arg3.length == arg4.length:
                                    if arg3.length == arg5.length:
                                        ...
                                        while idx < arg3.length:
                                            ...
                                            mem[_544] = mem[(32 * idx) + ceil32(arg2.length) + 160]
                                            require idx < mem[(32 * arg3.length) + ceil32(arg2.length) + 160]
                                            mem[_544 + 32] = mem[(32 * arg3.length) + ceil32(arg2.length) + (32 * idx) + 192]
                                            mem[_544 + 64] = 0
                                            require idx < mem[(32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 192]
                                            mem[_544 + 96] = mem[(32 * idx) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 224]
                                            mem[_544 + 128] = 0
                                            require idx < mem[(32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 224]
                                            mem[_544 + 160] = bool(mem[(32 * idx) + (32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 256])
                                            mem[mem[64]] = arg1
                                            mem[mem[64] + 32] = idx
                                            mem[0] = sha3(arg1, idx)
                                            mem[32] = 3
                                            sub_91abe6b2[arg1][idx].field_0 = mem[_544]
                                            sub_91abe6b2[arg1][idx].field_256 = mem[_544 + 32]
                                            sub_91abe6b2[arg1][idx].field_512 = 0
                                            sub_91abe6b2[arg1][idx].field_768 = 0
                                            sub_91abe6b2[arg1][idx].field_768 = mem[_544 + 96]
                                            sub_91abe6b2[arg1][idx].field_1024 = 0
                                            sub_91abe6b2[arg1][idx].field_1280 = uint8(bool(mem[_544 + 160]))
                                            require idx < mem[(32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 224]
