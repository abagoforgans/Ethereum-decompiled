...
const _fallback = code.data[31 len 8423]
...
function ethDonation(uint256 arg1) payable {
    ...
    call tokenAddress with:
       value msg.value / 200 wei
         gas 2300 * is_zero(value) wei
    charities[stor0].field_1024 = charities[stor0].field_1024 + msg.value - (3 * msg.value / 200) - (msg.value / 200)
    charities[stor0].field_1536 = charities[stor0].field_1536 + msg.value - (3 * msg.value / 200) - (msg.value / 200)
    charities[stor0].field_1280 = charities[stor0].field_1280 + msg.value - (3 * msg.value / 200) - (msg.value / 200)
...
function fiatToEth(uint256 arg1, uint256 arg2) payable {
    ...
    call tokenAddress with:
       value 4 * msg.value / 100 wei
         gas 2300 * is_zero(value) wei
    charities[stor0].field_1536 = charities[stor0].field_1536 + msg.value - (16 * msg.value / 100) - (4 * msg.value / 100)
    charities[stor0].field_1280 = charities[stor0].field_1280 + msg.value - (16 * msg.value / 100) - (4 * msg.value / 100)
