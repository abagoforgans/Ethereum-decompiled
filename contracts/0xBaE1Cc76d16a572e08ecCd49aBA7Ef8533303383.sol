...
function _fallback() {
    mem[96 len -3155] = code.data[3649 len -3155]
    mem[64] = -3059
    stor0 = msg.sender
    ...
    stor5 = mem[352]
    stor6 = mem[416]
    stor11 = Mask(248, 0, bool(mem[448]))
    stor9 = mem[224]
    stor10 = mem[256]
    stor13 = mem[108 len 20]
    stor14 = mem[140 len 20]
    return code.data[494 len 3155]
}
...
function _fallback() payable {
    ...
    call balancesAddress.getTotalSupply() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    ...
    require ext_code.size(balancesAddress)
    call balancesAddress.incBalance(address rg1, uint256 rg2) with:
         gas gas_remaining - 710 wei
        args msg.sender, ext_call.return_data[0] / 10^18 * msg.value / sub_1d85de4f
    require ext_call.success
    require ext_code.size(balancesAddress)
    call balancesAddress.incTotalSupply(uint256 rg1) with:
         gas gas_remaining - 710 wei
