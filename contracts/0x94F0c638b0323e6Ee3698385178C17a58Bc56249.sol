...
function _fallback() {
    ...
    stor3.length.field_8 = 'YangCoin' / 256
    idx = 0
    ...
    stor4 = 4
    stor5 = 10^13
    stor6[0xc18fe0a2b3e0efe79cf16ba411e26116d812d7d3] = stor5
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  stor5,
    emit 0x0: stor5
    emit 0xc18fe0a2: stor5
    return code.data[687 len 5596]
}
