...
function redeem(bytes arg1, bytes arg2) payable {
    ...
    if arg1.length != 65:
        ...
        while idx < arg2.length / 20:
            _341 = mem[ceil32(arg1.length) + (20 * idx) + 304]
            if address(s) >= Mask(160, 92, mem[ceil32(arg1.length) + (20 * idx) + 304]) >> 92:
                mem[mem[64] + 32] = 16 * Mask(160, 92, mem[ceil32(arg1.length) + (20 * idx) + 304])
            ...
            mem[mem[64] + 52] = 16 * Mask(160, 92, _341)
            _384 = mem[64]
            mem[mem[64]] = 40
            mem[64] = mem[64] + 72
            idx = idx + 1
        ...
        if Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', 336, 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', 336, 32))), 0) - 256 >= 27:
            ...
            t = 0
            while idx < arg2.length / 20:
                _337 = mem[ceil32(arg1.length) + (20 * idx) + 304]
                if address(s) >= Mask(160, 92, mem[ceil32(arg1.length) + (20 * idx) + 304]) >> 92:
                    mem[mem[64] + 32] = 16 * Mask(160, 92, mem[ceil32(arg1.length) + (20 * idx) + 304])
                    mem[mem[64] + 52] = address(s)
                    _344 = mem[64]
                    ...
                    continue 
                mem[mem[64] + 32] = address(s)
                mem[mem[64] + 52] = 16 * Mask(160, 92, _337)
                _348 = mem[64]
                mem[mem[64]] = 40
                mem[64] = mem[64] + 72
                idx = idx + 1
            ...
            if uint8((Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', 336, 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', 336, 32))), 0) - 256) + 27) != 27:
                if uint8((Mask(8, -(('mask_shl', 256, 0, -3, ('mem', ('range', 336, 32))), 0) + 256, 0) << (('mask_shl', 256, 0, -3, ('mem', ('range', 336, 32))), 0) - 256) + 27) != 28:
                    ...
                    t = 0
                    while idx < arg2.length / 20:
                        _340 = mem[ceil32(arg1.length) + (20 * idx) + 304]
                        if address(s) >= Mask(160, 92, mem[ceil32(arg1.length) + (20 * idx) + 304]) >> 92:
                            mem[mem[64] + 32] = 16 * Mask(160, 92, mem[ceil32(arg1.length) + (20 * idx) + 304])
                            mem[mem[64] + 52] = address(s)
                            _371 = mem[64]
                            ...
                            continue 
                        mem[mem[64] + 32] = address(s)
                        mem[mem[64] + 52] = 16 * Mask(160, 92, _340)
                        _375 = mem[64]
                        mem[mem[64]] = 40
                        mem[64] = mem[64] + 72
                        idx = idx + 1
                    ...
                    t = 0
                    while idx < arg2.length / 20:
                        _339 = mem[ceil32(arg1.length) + (20 * idx) + 336]
                        if address(s) >= Mask(160, 92, mem[ceil32(arg1.length) + (20 * idx) + 336]) >> 92:
                            mem[mem[64] + 32] = 16 * Mask(160, 92, mem[ceil32(arg1.length) + (20 * idx) + 336])
                            mem[mem[64] + 52] = address(s)
                            _362 = mem[64]
                            mem[mem[64]] = 40
                            mem[64] = mem[64] + 72
                            ...
                            continue 
                        mem[mem[64] + 32] = address(s)
                        mem[mem[64] + 52] = 16 * Mask(160, 92, _339)
                        _366 = mem[64]
                        mem[mem[64]] = 40
                        mem[64] = mem[64] + 72
                        idx = idx + 1
                ...
                t = 0
                while idx < arg2.length / 20:
                    _338 = mem[ceil32(arg1.length) + (20 * idx) + 336]
                    if address(s) >= Mask(160, 92, mem[ceil32(arg1.length) + (20 * idx) + 336]) >> 92:
                        mem[mem[64] + 32] = 16 * Mask(160, 92, mem[ceil32(arg1.length) + (20 * idx) + 336])
                        mem[mem[64] + 52] = address(s)
                        _353 = mem[64]
                        ...
                        continue 
                    mem[mem[64] + 32] = address(s)
                    mem[mem[64] + 52] = 16 * Mask(160, 92, _338)
                    _357 = mem[64]
                    mem[mem[64]] = 40
                    mem[64] = mem[64] + 72
                    idx = idx + 1
...
function sub_3f22fa97(?) payable {
    ...
    if not arg1.length:
        ...
        mem[(32 * arg1.length) + (32 * arg2.length) + ceil32(arg4.length) + 224 len 32 * arg1.length] = code.data[5570 len 32 * arg1.length]
        idx = 0
        while idx < arg1.length:
            require idx < arg1.length
            _195 = mem[(32 * idx) + 128]
