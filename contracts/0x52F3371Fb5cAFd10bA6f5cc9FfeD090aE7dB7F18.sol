    ...
    if address(stor[(4 * arg2) + (68 * arg1) + 1].field_8) == msg.sender:
        ...
        if block.number - uint256(stor[(4 * arg2) + (68 * arg1) + 4].field_0) >= 4320:
            ...
            while uint16(idx) < 10:
                ...
                if uint128(uint128(block.hash(block.number - 1)) % uint16(-idx + 103)) != 0:
                    uint256(stor[(0.03125 / uint256(stor[(4 * arg2) + (68 * arg1) + 3].field_0) - 7) + sha3((4 * arg2) + (68 * arg1) + 3)].field_0) = uint8(uint128(block.hash(block.number - 1)) % 14) * 256^(uint256(stor[(4 * arg2) + (68 * arg1) + 3].field_0) - 7 % 32) or !(255 * 256^(uint256(stor[(4 * arg2) + (68 * arg1) + 3].field_0) - 7 % 32)) and uint256(stor[(0.03125 / uint256(stor[(4 * arg2) + (68 * arg1) + 3].field_0) - 7) + sha3((4 * arg2) + (68 * arg1) + 3)].field_0)
                    require arg1 < 17
                    require arg2 < 17
                    require arg1 < 17
                    require arg2 < 17
                ...
                idx = idx + 1
                s = uint128(block.hash(block.number - 1)) % uint16(-idx + 103)
                continue 
            require arg1 < 17
            require arg2 < 17
