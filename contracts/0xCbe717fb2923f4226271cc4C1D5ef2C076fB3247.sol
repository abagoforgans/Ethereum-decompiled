...
const _fallback = code.data[31 len 1643]
...
function sub_66c19bcd(?) payable {
    if arg3 == 1:
        s = 0
        while 0 <= stor[arg1] - 1:
            if stor[sha3(arg1) + (0.5 / stor[arg1] - 1)] < arg2 == 1:
                s = stor[arg1] - 1 / 2
                continue 
            else:
                if stor[sha3(arg1) + (0.5 / stor[arg1] - 1)] >= arg2:
                    if stor[sha3(arg1) + (0.5 / stor[arg1] - 1)] > arg2 == 1:
                        s = stor[arg1] - 1 / 2
                        continue 
                    else:
