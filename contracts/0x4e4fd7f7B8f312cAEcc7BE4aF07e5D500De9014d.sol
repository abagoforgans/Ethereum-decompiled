...
function distributeReservedTokens(uint256 arg1) payable {
    ...
    if uint8(var25014) >= 0:
        ...
        call tokenAddress.reservedTokensDestinationsLen() with:
             gas gas_remaining - 710 wei
        require ext_call.success
        require ext_code.size(0x4849608a4c45a94ee3c52c419d48f144d61a2f1e)
        delegate 0x4849608a4c45a94ee3c52c419d48f144d61a2f1e.minus(uint256 arg1, uint256 arg2) with:
             gas gas_remaining - 710 wei
        ...
        require ext_code.size(0x4849608a4c45a94ee3c52c419d48f144d61a2f1e)
        delegate 0x4849608a4c45a94ee3c52c419d48f144d61a2f1e.mem[var37002 len 4] with:
             gas gas_remaining - 710 wei
        ...
        while uint8(idx + 1) < uint8(ext_call.return_data[0]):
            ...
            mem[132] = ext_call.return_data[0]
            require ext_code.size(0x4849608a4c45a94ee3c52c419d48f144d61a2f1e)
            delegate 0x4849608a4c45a94ee3c52c419d48f144d61a2f1e.plus(uint256 arg1, uint256 arg2) with:
                 gas gas_remaining - 710 wei
