...
function getContract(string arg1) {
    ...
    mem[mem[64] + 32] = 64
    mem[mem[64] + 64] = stor[_77 + 1].length
    mem[mem[64] + 96 len ceil32(stor[_77 + 1].length)] = mem[ceil32(arg1.length) + 160 len ceil32(stor[_77 + 1].length)]
    return address(stor[_42]), Array(len=stor[_77 + 1].length, data=mem[mem[64] + 96 len stor[_77 + 1].length])
}
