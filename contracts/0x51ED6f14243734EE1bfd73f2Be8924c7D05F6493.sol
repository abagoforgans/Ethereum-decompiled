...
function _fallback() payable {
    ...
    if not stor3.length <= stor3.length + 1:
        ...
        while stor3.length > idx:
            ...
            idx = idx + 1
            continue 
    stor3[stor3.length].field_0 = code.data[2086 len 32] or Mask(224, 32, stor3[stor3.length].field_0)
    stor3[stor3.length].field_32 = Mask(224, 0, 1000 * block.timestamp)
    uint32(stor1.field_64) = uint32(code.data[2118 len 32])
    uint32(stor1.field_96) = 0
    Mask(96, 0, stor0.field_160) = Mask(96, 0, code.data[2182 len 32])
    uint256(stor1.field_0) = code.data[2150 len 32] or Mask(192, 64, uint256(stor1.field_0))
    return code.data[364 len 1722]
}
