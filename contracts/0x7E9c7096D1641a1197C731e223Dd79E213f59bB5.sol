...
function withdrawTokens() {
    ...
    if not ext_call.return_data[0]:
        ...
        require 100000 * ext_call.return_data[0] / ext_call.return_data[0] == 100000
        require ext_call.return_data[0] > 0
        require ext_call.return_data[0] <= ext_call.return_data[0]
        require ext_code.size(stor1)
        call stor1.0x23b872dd with:
        ...
        call sub_3098557aAddress.0xa9059cbb with:
             gas gas_remaining wei
            args msg.sender, 100000 * ext_call.return_data[0]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
...
function recoverTokens() {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    emit 0x1b47a558: msg.sender, ext_call.return_data[0], 100000 * ext_call.return_data[0]
    emit 0x23f40518: msg.sender, 100000 * ext_call.return_data[0]
    return (100000 * ext_call.return_data[0])
}
