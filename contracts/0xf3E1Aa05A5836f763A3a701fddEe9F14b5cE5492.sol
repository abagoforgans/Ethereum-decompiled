...
function _fallback() payable {
    ...
    stor12 = msg.sender
    stor0 = code.data[6938 len 20]
    address(stor13.field_0) = msg.sender
    return code.data[168 len 6758]
}
...
function getMaxBet() {
    if invest >= investorsProfit:
        if invest + investorsProfit >= invest:
            if invest + investorsProfit >= investorsLosses:
                return ((1500 * invest) + (1500 * investorsProfit) - (1500 * investorsLosses) / 10000)
            else:
                return 0
        else:
            return 0
...
function check(uint256 arg1) {
    ...
    if invest < investorsProfit:
        ...
        if invest + investorsProfit < invest:
            ...
            if invest + investorsProfit >= investorsLosses:
                if arg1 > (1500 * invest) + (1500 * investorsProfit) - (1500 * investorsLosses) / 10000:
                    return 0
            else:
                if arg1 > 0:
                    return 0
...
function getStatus() {
    if invest >= investorsProfit:
                ...
                if invest >= investorsProfit:
                    if invest + investorsProfit >= invest:
                        if invest + investorsProfit >= investorsLosses:
                            return invest + investorsProfit - investorsLosses, 
                                   minBet,
                                   (1500 * invest) + (1500 * investorsProfit) - (1500 * investorsLosses) / 10000,
                                   divestFee,
                                   1000,
                                   sub_4d1db3e9
        ...
        if invest >= investorsProfit:
            if invest + investorsProfit >= invest:
                if invest + investorsProfit >= investorsLosses:
                    return 0, minBet, (1500 * invest) + (1500 * investorsProfit) - (1500 * investorsLosses) / 10000, divestFee, 1000, sub_4d1db3e9
...
function play(address arg1, uint256 arg2) {
    ...
    stor17 = sha3((block.timestamp * block.difficulty * block.number) + (stor17 % block.timestamp) + block.hash(block.number - 1) + 1, stor16)
    stor16 = -(sha3((block.timestamp * block.difficulty * block.number) + (stor17 % block.timestamp) + block.hash(block.number - 1) + 1, stor16) % 10000) + 10000
    bets[stor15].field_0 = arg1
    bets[stor15].field_256 = arg2
    bets[stor15].field_512 = -(sha3((block.timestamp * block.difficulty * block.number) + (stor17 % block.timestamp) + block.hash(block.number - 1) + 1, stor16) % 10000) + 10000
    if -(sha3((block.timestamp * block.difficulty * block.number) + (stor17 % block.timestamp) + block.hash(block.number - 1) + 1, stor16) % 10000) + 10000 > 7500:
        require investorsProfit + arg2 >= investorsProfit
        require investorsProfit + arg2 >= arg2
        require arg2 != 1
        require ext_code.size(sub_a498742bAddress)
        call sub_a498742bAddress.0x70a08231 with:
             gas gas_remaining - 710 wei
        ...
        emit 0x84461757: address(arg1), arg2, 1, -(sha3((block.timestamp * block.difficulty * block.number) + (stor17 % block.timestamp) + block.hash(block.number - 1) + 1, stor16) % 10000) + 10000
        investorsProfit = arg2 + investorsProfit - 1
    else:
        if not (1266 * arg2 / 1000) - (1000 * 266 * arg2 / 1000 / 10000):
            emit LOG_ZeroSend()
        else:
            require ext_code.size(sub_a498742bAddress)
            call sub_a498742bAddress.0x70a08231 with:
                ...
                args this.address
            require ext_call.success
            if ext_call.return_data[0] < (1266 * arg2 / 1000) - (1000 * 266 * arg2 / 1000 / 10000):
                emit LOG_ValueIsTooBig()
            else:
                require ext_code.size(sub_a498742bAddress)
                call sub_a498742bAddress.0xa9059cbb with:
                     gas gas_remaining - 710 wei
                    args address(arg1), (1266 * arg2 / 1000) - (1000 * 266 * arg2 / 1000 / 10000)
                require ext_call.success
                emit LOG_SuccessfulSend(address(arg1), (1266 * arg2 / 1000) - (1000 * 266 * arg2 / 1000 / 10000));
        if not 1000 * 266 * arg2 / 1000 / 10000:
            emit LOG_ZeroSend()
        else:
            require ext_code.size(sub_a498742bAddress)
            call sub_a498742bAddress.0x70a08231 with:
                ...
                args this.address
            require ext_call.success
            if ext_call.return_data[0] < 1000 * 266 * arg2 / 1000 / 10000:
                emit LOG_ValueIsTooBig()
            else:
                require ext_code.size(sub_a498742bAddress)
                call sub_a498742bAddress.0xa9059cbb with:
                     gas gas_remaining - 710 wei
                    args houseAddress, 1000 * 266 * arg2 / 1000 / 10000
                require ext_call.success
                emit LOG_SuccessfulSend(houseAddress, 1000 * 266 * arg2 / 1000 / 10000);
        emit 0x84461757: address(arg1), arg2, (1266 * arg2 / 1000) - (1000 * 266 * arg2 / 1000 / 10000), -(sha3((block.timestamp * block.difficulty * block.number) + (stor17 % block.timestamp) + block.hash(block.number - 1) + 1, stor16) % 10000) + 10000
        require investorsLosses + (1266 * arg2 / 1000) >= investorsLosses
        require investorsLosses + (1266 * arg2 / 1000) >= arg2
        investorsLosses += 266 * arg2 / 1000
    stor10 = 0
}
                ...
                if investors[stor3[investors[1].field_0]].field_256 + (investorsProfit * investors[stor3[investors[1].field_0]].field_256 / invest) < investors[stor3[investors[1].field_0]].field_256:
                    ...
                    if investors[stor3[investors[1].field_0]].field_256 + (investorsProfit * investors[stor3[investors[1].field_0]].field_256 / invest) >= investorsLosses * investors[stor3[investors[1].field_0]].field_256 / invest:
                        ...
                        if invest < investors[stor3[investors[1].field_0]].field_256:
                            ...
                            if investorIDs[stor4[1].field_0] == investorsNum:
                                investorsNum--
                                if investors[stor3[investors[1].field_0]].field_256 + (investorsProfit * investors[stor3[investors[1].field_0]].field_256 / invest) - (investorsLosses * investors[stor3[investors[1].field_0]].field_256 / invest) - ((investors[stor3[investors[1].field_0]].field_256 * divestFee) + (investorsProfit * investors[stor3[investors[1].field_0]].field_256 / invest * divestFee) - (investorsLosses * investors[stor3[investors[1].field_0]].field_256 / invest * divestFee) / 10000):
                                    require ext_code.size(sub_a498742bAddress)
                                    call sub_a498742bAddress.0x70a08231 with:
                                         gas gas_remaining - 710 wei
                                        args address(this.address)
                                    ...
                                    if ext_call.return_data[0] >= investors[stor3[investors[1].field_0]].field_256 + (investorsProfit * investors[stor3[investors[1].field_0]].field_256 / invest) - (investorsLosses * investors[stor3[investors[1].field_0]].field_256 / invest) - ((investors[stor3[investors[1].field_0]].field_256 * divestFee) + (investorsProfit * investors[stor3[investors[1].field_0]].field_256 / invest * divestFee) - (investorsLosses * investors[stor3[investors[1].field_0]].field_256 / invest * divestFee) / 10000):
                                        ...
                                        require ext_call.success
                                        emit LOG_SuccessfulSend(investors[1].field_0, investors[stor3[investors[1].field_0]].field_256 + (investorsProfit * investors[stor3[investors[1].field_0]].field_256 / invest) - (investorsLosses * investors[stor3[investors[1].field_0]].field_256 / invest) - ((investors[stor3[investors[1].field_0]].field_256 * divestFee) + (investorsProfit * investors[stor3[investors[1].field_0]].field_256 / invest * divestFee) - (investorsLosses * investors[stor3[investors[1].field_0]].field_256 / invest * divestFee) / 10000));
                                        if (investors[stor3[investors[1].field_0]].field_256 * divestFee) + (investorsProfit * investors[stor3[investors[1].field_0]].field_256 / invest * divestFee) - (investorsLosses * investors[stor3[investors[1].field_0]].field_256 / invest * divestFee) / 10000:
                                            require ext_code.size(sub_a498742bAddress)
                                            call sub_a498742bAddress.0x70a08231 with:
                                                 gas gas_remaining - 710 wei
                                                args address(this.address)
