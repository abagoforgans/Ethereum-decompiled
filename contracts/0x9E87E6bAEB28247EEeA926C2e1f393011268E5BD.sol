...
function _fallback() payable {
    mem[96 len -1631] = code.data[2067 len -1631]
    mem[64] = -1535
    uint64(stor3[address(msg.sender)].field_0) = mem[120 len 8]
    Mask(192, 0, stor3[address(msg.sender)].field_64) = 0
