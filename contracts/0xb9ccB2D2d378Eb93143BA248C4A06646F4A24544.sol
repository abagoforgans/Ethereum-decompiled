...
function getPrice(string arg1) payable {
    if sub_980bfd4e[address(msg.sender)] != 0:
...
function query(uint256 arg1, string arg2, string arg3) payable {
    if 0 == sub_980bfd4e[address(msg.sender)]:
        ...
        if 0 == price[arg2[all]]:
            sub_980bfd4e[address(msg.sender)] = 1
        require msg.value >= price[arg2[all]]
        call 0xf65b3b60010d57d0bb8478aa6ced15fe720621b4 with:
           value price[arg2[all]] wei
             gas 0 wei
        if msg.value - price[arg2[all]] > 0:
            call msg.sender with:
               value msg.value - price[arg2[all]] wei
                 gas 0 wei
    stor0++
