    ...
    if balanceOf[stor3] - (msg.value / 3 * 10^15) > stor6:
        ...
        if bonusPercentage <= 0:
            ...
            if balanceOf[stor3] >= msg.value / 3 * 10^15:
                if allowance[stor3][address(msg.sender)] >= msg.value / 3 * 10^15:
            ...
            allowance[stor3][address(msg.sender)] = (msg.value / 3 * 10^15 * bonusPercentage / 100) + (msg.value / 3 * 10^15) + allowance[stor3][address(msg.sender)]
            stor0 += msg.value / 3 * 10^15
            require owner
            require msg.sender
            require (msg.value / 3 * 10^15 * bonusPercentage / 100) + (msg.value / 3 * 10^15) > 0
            if balanceOf[stor3] >= (msg.value / 3 * 10^15 * bonusPercentage / 100) + (msg.value / 3 * 10^15):
                if allowance[stor3][address(msg.sender)] >= (msg.value / 3 * 10^15 * bonusPercentage / 100) + (msg.value / 3 * 10^15):
                    ...
                    emit Transfer(((msg.value / 3 * 10^15 * bonusPercentage / 100) + (msg.value / 3 * 10^15)), owner, msg.sender);
}
