...
function _fallback() payable {
    ...
    stor1 = code.data[3546 len 32]
    stor2 = code.data[3578 len 32]
    stor3 = code.data[3610 len 32]
    stor4 = code.data[3642 len 32]
    uint8(stor8.field_0) = 1
    uint8(stor8.field_8) = 0
    Mask(240, 0, stor8.field_16) = Mask(240, 0, code.data[3674 len 32])
    stor8.field_256 % 1 = 0
    stor9 = code.data[3706 len 32]
    stor10 = uint16(code.data[3674 len 32])
    return code.data[167 len 3379]
}
