...
function transfer(address arg1, uint256 arg2) payable {
    ...
    require balances[address(msg.sender)] >= arg2 + (arg2 / commisionRate)
    require arg2 <= balances[address(msg.sender)]
...
function transferFrom(address arg1, address arg2) payable {
    ...
    require commisionRate > 0
    require commisionRate
    require balances[address(arg2)] >= approved[address(arg2)][address(arg1)] + (approved[address(arg2)][address(arg1)] / commisionRate)
    ...
    if ext_code.size(arg1) <= 0:
        ...
        mem[floor32(0, address(arg2) << 64) + 128 len 0] = None
