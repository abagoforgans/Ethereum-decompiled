...
uint256 stor11;
uint8 stor12;
uint256 sub_93f46efa;
address sub_1d26bb20Address;

function sub_0fae39fa(?) {
    return sub_0fae39fa
}

function sub_1d26bb20(?) {
    return sub_1d26bb20Address
}
...
function sub_c97a35fd(?) {
    if owner != msg.sender:
        revert with 0, 'you are not the owner'
    stor12 = uint8(arg1)
    sub_93f46efa = arg2
    sub_1d26bb20Address = arg3
}
...
function sub_8ca60301(?) payable {
    ...
    if sub_b374befd >= sub_8acd0ac2:
        ...
        sub_8feb731e = 0
    if stor12:
        require ext_code.size(sub_1d26bb20Address)
        call sub_1d26bb20Address.0x23b872dd with:
             gas gas_remaining wei
            args stor0, msg.sender, sub_93f46efa * 10^decimals
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
