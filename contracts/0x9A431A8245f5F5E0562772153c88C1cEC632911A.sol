...
function Invest() payable {
    require stor0 == msg.sender
    if 256 * 10^15 * eth.balance(this.address) / 256 * 10^15 != uint256(stor2.field_0):
        uint256(stor2.field_0) = 256 * 10^15 * eth.balance(this.address) / 256 * 10^15
        emit SettingsChanged(256 * 10^15 * eth.balance(this.address) / 256 * 10^15, Mask(248, 8, 256 * 10^15 * eth.balance(this.address) / 256 * 10^15), stor7, storFF55, stor9EBB, uint8(stor1.field_0), bool(uint8(stor3.field_128)));
}
