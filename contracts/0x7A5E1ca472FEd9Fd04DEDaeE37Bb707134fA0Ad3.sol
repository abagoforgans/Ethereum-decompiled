...
const getAttributes = 96, 160, 224, 11, 'alicecooper' << 168, 4, 'slot' << 224, 8, uint64('v1.00.00')
...
function sub_7e60d996(?) {
    mem[96 len 160] = code.data[13525 len 160]
    mem[64] = 416
    mem[256] = 3
    mem[288] = 4
    mem[320] = 5
...
function sub_51ee0fbd(?) {
    mem[96 len 192] = code.data[13525 len 192]
    if arg1 > 5:
        mem[64] = 480
        mem[288] = 8
        mem[320] = 10
