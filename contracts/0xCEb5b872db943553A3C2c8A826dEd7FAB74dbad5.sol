...
const _fallback = code.data[19 len 1853]
...
function sub_89ac5d13(?) payable {
    emit 0xbe5c2521: Array(len=arg1.length, data=call.data[arg1 + 36 len 32 * arg1.length])
    if balances[address(msg.sender)] <= 0:
        ...
        while idx < sub_29f8df0d:
            ...
            s = (5 * balances[address(stor[idx])]) + s
            continue 
        if eth.balance(this.address) - (5 * uint256(stor[_26]) * sub_29f8df0d) < 5 * msg.value:
            call msg.sender with:
               value msg.value wei
                 gas 0 wei
        else:
            call 0xcb327b5e4872e77ae5add5aab2dbef10e8db1cba.0xb4aa6cc1 with:
