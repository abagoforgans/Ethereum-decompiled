...
function _fallback() {
    stor3 = msg.sender
    stor6 = code.data[4703 len 32]
    stor7 = code.data[4735 len 32]
    stor5 = code.data[4767 len 32]
    stor9 = code.data[4843 len 20]
    stor8 = code.data[4799 len 32]
    return code.data[164 len 4539]
}
...
function buyPriceAt(uint256 arg1) {
    ...
    if arg1 < startDate + 600:
        return curs
    if arg1 < startDate + 720:
        return (curs / 120)
    if arg1 < startDate + 840:
        return (curs / 130)
    if arg1 < startDate + 960:
        return (curs / 140)
    if arg1 > endDate:
        return 0
    return (curs / 150)
...
function buyPrice() {
    ...
    if block.timestamp < startDate + 600:
        return curs
    if block.timestamp < startDate + 720:
        return (curs / 120)
    if block.timestamp < startDate + 840:
        return (curs / 130)
    if block.timestamp < startDate + 960:
        return (curs / 140)
