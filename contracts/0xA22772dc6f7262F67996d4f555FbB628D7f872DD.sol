...
uint256 cap;
uint8 paused;
address whitelistAddress; offset 8
...
function setupWhitelist(address arg1) {
    require msg.sender == owner
    if not arg1:
        revert with 0, 'Invalid whitelist address'
    whitelistAddress = arg1
    return 1
}

function burnFor(address arg1, uint256 arg2) {
    require msg.sender == owner
...
function mint(address arg1, uint256 arg2) {
    ...
    call whitelistAddress.checkWhitelisted(address arg1) with:
