...
function _fallback() payable {
    ...
    if msg.sender == foundationAddress:
        ...
        if not sub_87036be8.length:
            ...
            if block.timestamp - startTime / 5 >= sub_87036be8.length:
                ...
                mem[0] = msg.sender
                mem[32] = 8
                require block.timestamp - startTime / 5 < sub_87036be8.length
                require stor8[address(msg.sender)] <= mem[(32 * block.timestamp - startTime / 5) + 128]
                if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)]:
                    if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)] <= ext_call.return_data[0] / 10^18:
                        if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)] > 0:
                            require mem[(32 * block.timestamp - startTime / 5) + 128] >= stor8[address(msg.sender)]
                            stor8[address(msg.sender)] = mem[(32 * block.timestamp - startTime / 5) + 128]
                            if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)]:
                                require mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)]
                                require (10^18 * mem[(32 * block.timestamp - startTime / 5) + 128]) - (10^18 * stor8[address(msg.sender)]) / mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)] == 10^18
                            require ext_code.size(sub_71953291Address)
                            call sub_71953291Address.0xa9059cbb with:
                                 gas gas_remaining wei
                                args msg.sender, (10^18 * mem[(32 * block.timestamp - startTime / 5) + 128]) - (10^18 * stor8[address(msg.sender)])
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            require return_data.size >= 32
                            require ext_call.return_data[0]
                ...
                if mem[(32 * sub_87036be8.length - 1) + 128] - stor8[address(msg.sender)]:
                    if mem[(32 * sub_87036be8.length - 1) + 128] - stor8[address(msg.sender)] > ext_call.return_data[0] / 10^18:
                        ...
                        if mem[(32 * sub_87036be8.length - 1) + 128] - stor8[address(msg.sender)] > 0:
                            ...
                            mem[(32 * sub_87036be8.length) + 164] = (10^18 * mem[(32 * sub_87036be8.length - 1) + 128]) - (10^18 * stor8[address(msg.sender)])
                            require ext_code.size(sub_71953291Address)
                            call sub_71953291Address.0xa9059cbb with:
                                 gas gas_remaining wei
        ...
        if sub_3fa582c6Address != msg.sender:
            if sub_a5f69349Address != msg.sender:
                require startTime <= block.timestamp
                if block.timestamp - startTime / 5 >= ext_call.return_data[0]:
                    ...
                    mem[0] = msg.sender
                    mem[32] = 8
                    require block.timestamp - startTime / 5 < ext_call.return_data[0]
                    require stor8[address(msg.sender)] <= mem[(32 * block.timestamp - startTime / 5) + 128]
                    if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)]:
                        if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)] <= ext_call.return_data[0] / 10^18:
                            if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)] > 0:
                ...
                if sub_013a5dda.length:
                    ...
                    while (32 * sub_013a5dda.length) + 96 > idx:
                        ...
                        continue 
                require startTime <= block.timestamp
                if block.timestamp - startTime / 5 >= sub_013a5dda.length:
                    ...
                    mem[0] = msg.sender
                    mem[32] = 8
                    require block.timestamp - startTime / 5 < sub_013a5dda.length
                    require stor8[address(msg.sender)] <= mem[(32 * block.timestamp - startTime / 5) + 128]
                    if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)]:
                        if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)] <= ext_call.return_data[0] / 10^18:
                            if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)] > 0:
            ...
            if not sub_142750d7.length:
                require startTime <= block.timestamp
                if block.timestamp - startTime / 5 >= sub_142750d7.length:
                    ...
                    mem[0] = msg.sender
                    mem[32] = 8
                    require block.timestamp - startTime / 5 < sub_142750d7.length
                    require stor8[address(msg.sender)] <= mem[(32 * block.timestamp - startTime / 5) + 128]
                    if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)]:
                        if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)] <= ext_call.return_data[0] / 10^18:
                            if mem[(32 * block.timestamp - startTime / 5) + 128] - stor8[address(msg.sender)] > 0:
