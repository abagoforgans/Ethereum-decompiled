...
function isKeyActive(uint256 arg1) {
    require calldata.size - 4 >= 32
    if keyInfo[arg1].field_768 > block.timestamp:
        return (keyInfo[arg1].field_768 > block.timestamp)
    return not priceOfActivation[stor16[arg1].field_0].field_1536
}
...
function incrementAvailability(uint256 arg1, uint256 arg2) {
    ...
    require stor10[address(msg.sender)]
    require priceOfActivation[arg1].field_0
    require priceOfActivation[arg1].field_768 + arg2 >= priceOfActivation[arg1].field_768
    if priceOfActivation[arg1].field_1024:
        require priceOfActivation[arg1].field_1280 + priceOfActivation[arg1].field_768 + arg2 >= priceOfActivation[arg1].field_1280
        require priceOfActivation[arg1].field_1280 + priceOfActivation[arg1].field_768 + arg2 <= priceOfActivation[arg1].field_1024
    priceOfActivation[arg1].field_768 += arg2
    emit ProductAvailabilityChanged(arg1, priceOfActivation[arg1].field_768);
}
...
function activate(uint256 arg1) payable {
    ...
    require keyInfo[arg1].field_768 <= block.timestamp
    require priceOfActivation[stor16[arg1].field_0].field_1536
    require block.timestamp + priceOfActivation[stor16[arg1].field_0].field_1536 >= block.timestamp
    keyInfo[arg1].field_768 = block.timestamp + priceOfActivation[stor16[arg1].field_0].field_1536
    require ownerOf[arg1]
...
function minterOnlyPurchase(uint256 arg1, address arg2) {
    ...
    require stor10[address(msg.sender)]
    require priceOfActivation[arg1].field_0
    require priceOfActivation[arg1].field_768 > 0
