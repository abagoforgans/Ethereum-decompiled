...
function _fallback() payable {
    ...
    if block.timestamp < stor6:
        if block.timestamp <= stor6 + (72 * 24 * 3600):
            ...
            if block.timestamp <= stor6 + (312 * 24 * 3600):
                if 10^18 * msg.value / 5 * 10^13:
                    require 10^18 * msg.value / 5 * 10^13
                    require 15 * 10^18 * msg.value / 5 * 10^13 / 10^18 * msg.value / 5 * 10^13 == 15
                require (15 * 10^18 * msg.value / 5 * 10^13 / 100) + (10^18 * msg.value / 5 * 10^13) >= 10^18 * msg.value / 5 * 10^13
                require ext_code.size(stor1)
                call stor1.0x70a08231 with:
                     gas gas_remaining wei
                    args this.address
                ...
                require return_data.size >= 32
                require msg.value >= stor4
                require ext_call.return_data[0] >= (15 * 10^18 * msg.value / 5 * 10^13 / 100) + (10^18 * msg.value / 5 * 10^13)
            else:
                if block.timestamp > stor6 + (1752 * 24 * 3600):
                    require 10^18 * msg.value / 5 * 10^13 >= 10^18 * msg.value / 5 * 10^13
                    require ext_code.size(stor1)
                    call stor1.0x70a08231 with:
                         gas gas_remaining wei
        ...
        if block.timestamp <= stor6 + (72 * 24 * 3600):
            if 10^18 * msg.value / 5 * 10^13:
                require 10^18 * msg.value / 5 * 10^13
                require 20 * 10^18 * msg.value / 5 * 10^13 / 10^18 * msg.value / 5 * 10^13 == 20
            require (20 * 10^18 * msg.value / 5 * 10^13 / 100) + (10^18 * msg.value / 5 * 10^13) >= 10^18 * msg.value / 5 * 10^13
            require ext_code.size(stor1)
            call stor1.0x70a08231 with:
                 gas gas_remaining wei
                args this.address
            ...
            require return_data.size >= 32
            require msg.value >= stor4
            require ext_call.return_data[0] >= (20 * 10^18 * msg.value / 5 * 10^13 / 100) + (10^18 * msg.value / 5 * 10^13)
        else:
            if block.timestamp <= stor6 + (312 * 24 * 3600):
                if 10^18 * msg.value / 5 * 10^13:
                    require 10^18 * msg.value / 5 * 10^13
    ...
    if block.timestamp < stor6:
        if block.timestamp <= stor6 + (72 * 24 * 3600):
            ...
            if block.timestamp <= stor6 + (312 * 24 * 3600):
                ...
                call stor1.0xa9059cbb with:
                     gas gas_remaining wei
                    args msg.sender, (15 * 10^18 * msg.value / 5 * 10^13 / 100) + (10^18 * msg.value / 5 * 10^13)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require msg.value + amountRaised >= amountRaised
                amountRaised += msg.value
                require (15 * 10^18 * msg.value / 5 * 10^13 / 100) + (10^18 * msg.value / 5 * 10^13) + tokensSold >= tokensSold
                tokensSold = (15 * 10^18 * msg.value / 5 * 10^13 / 100) + (10^18 * msg.value / 5 * 10^13) + tokensSold
            else:
                if block.timestamp > stor6 + (1752 * 24 * 3600):
                    require 10^18 * msg.value / 5 * 10^13 >= 10^18 * msg.value / 5 * 10^13
                    require ext_code.size(stor1)
        ...
        if block.timestamp <= stor6 + (72 * 24 * 3600):
            ...
            call stor1.0xa9059cbb with:
                 gas gas_remaining wei
                args msg.sender, (20 * 10^18 * msg.value / 5 * 10^13 / 100) + (10^18 * msg.value / 5 * 10^13)
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require msg.value + amountRaised >= amountRaised
            amountRaised += msg.value
            require (20 * 10^18 * msg.value / 5 * 10^13 / 100) + (10^18 * msg.value / 5 * 10^13) + tokensSold >= tokensSold
            tokensSold = (20 * 10^18 * msg.value / 5 * 10^13 / 100) + (10^18 * msg.value / 5 * 10^13) + tokensSold
        else:
            if block.timestamp <= stor6 + (312 * 24 * 3600):
                if 10^18 * msg.value / 5 * 10^13:
                    require 10^18 * msg.value / 5 * 10^13
