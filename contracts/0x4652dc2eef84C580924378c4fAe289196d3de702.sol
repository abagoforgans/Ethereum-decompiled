...
function _fallback() {
    stor0 = msg.sender
    stor3 = code.data[5389 len 20]
    stor2 = code.data[5389 len 20]
    ...
    return code.data[3180 len 2197]
}
...
function sub_0cb61f6c(?) {
    ...
    require ext_call.success
    require ext_code.size(stor2)
    call stor2.0x54aec416 with:
         gas gas_remaining - 710 wei
        args msg.sender, uint64(ext_call.return_data[0])
    require ext_call.success
}
