...
function _fallback() payable {
    ...
    stor2 = code.data[7336 len 20]
    stor3 = code.data[7272 len 20]
    stor4 = code.data[7304 len 20]
    return code.data[136 len 7124]
}
    ...
    if sub_7cf46945 == 3:
        ...
        if not arg1:
            call stor2.0xf5a93beb with:
                 gas gas_remaining - 50 wei
                args com.length, stor10, 0x3e10533c00000000000000000000000000000000000000000000000000000000, mem[448], call.data[132], call.data[164], call.data[196], call.data[228], arg3, arg4
            require ext_call.success
            ...
            call stor2.0x28e44298 with:
                 gas gas_remaining - 50 wei
                args arg2, com.length, stor10, 0x3e10533c00000000000000000000000000000000000000000000000000000000, mem[448], call.data[36], call.data[68]
            require ext_call.success
            require ext_call.return_data[0]
            require ext_code.size(stor3)
            call stor3.C1() with:
        ...
        if not arg1:
            call stor2.0xf5a93beb with:
                 gas gas_remaining - 50 wei
                args com.length, stor10, 0x3e10533c00000000000000000000000000000000000000000000000000000000, 0, call.data[132], call.data[164], call.data[196], call.data[228], arg3, arg4
            require ext_call.success
            require ext_call.return_data[0]
            require ext_code.size(stor3)
            call stor3.C1() with:
            ...
            call stor2.0x28e44298 with:
                 gas gas_remaining - 50 wei
                args arg2, com.length, stor10, 0x3e10533c00000000000000000000000000000000000000000000000000000000, 0, call.data[36], call.data[68]
            require ext_call.success
            require ext_call.return_data[0]
            require ext_code.size(stor3)
            call stor3.C1() with:
