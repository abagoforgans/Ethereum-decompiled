...
const name = 'blockchain financial capital'

const decimals = 2

const symbol = 'BFC'

const INITIAL_SUPPLY = 2 * 10^11
...
function setPrices(bool arg1, uint256 arg2) {
    ...
    crowdsaleClosed = uint8(arg1)
    buyPrice = arg2
}

function sub_9d376e35(?) {
    totalSupply = 2 * 10^11
    balanceOf[address(msg.sender)] = 2 * 10^11
    emit Transfer(2 * 10^11, 0, msg.sender);
}
