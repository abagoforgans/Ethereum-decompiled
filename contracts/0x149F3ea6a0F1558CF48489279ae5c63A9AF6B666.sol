...
const baseTokenURI = Array(len=68, data='https://console.mogchain.io/web-', 'admin/rest/digitalasset/metadata', '/64/' >> 256, Mask(32, -512, 'https://console.mogchain.io/web-', 'admin/rest/digitalasset/metadata', '/64/') << 512)
...
function isApprovedForAll(address arg1, address arg2) {
    ...
    call stor13.proxies(address arg1) with:
...
function tokenURI(uint256 arg1) {
    mem[96] = 68
    mem[128] = 'https://console.mogchain.io/web-'
    mem[160] = 'admin/rest/digitalasset/metadata'
    mem[192] = '/64/'
    if not arg1:
        mem[224] = 1
        mem[256] = '0'
        ...
        mem[352] = 0
        mem[384] = 69
        mem[416 len 2208] = code.data[10346 len 2208]
        idx = 0
        s = 0
        while idx < 68:
            require idx < 68
            require s < 69
            mem[s + 416 len 8] = Mask(8, -(('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 128, ('var', 0)), 32))), 0) + 256, 0) << (('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 128, ('var', 0)), 32))), 0) - 256
            idx = idx + 1
            s = s + 1
            continue 
        idx = 0
        ...
        while idx < 1:
            require idx < 1
            require s < 69
            mem[s + 416 len 8] = Mask(8, -(('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 256, ('var', 0)), 32))), 0) + 256, 0) << (('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 256, ('var', 0)), 32))), 0) - 256
            idx = idx + 1
            s = s + 1
            continue 
        idx = 0
        ...
        while idx < 0:
            require idx < 0
            require s < 69
            mem[s + 416 len 8] = Mask(8, -(('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 320, ('var', 0)), 32))), 0) + 256, 0) << (('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 320, ('var', 0)), 32))), 0) - 256
            idx = idx + 1
            s = s + 1
            continue 
        idx = 0
        ...
        while idx < 0:
            require idx < 0
            require s < 69
            mem[s + 416 len 8] = Mask(8, -(('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 352, ('var', 0)), 32))), 0) + 256, 0) << (('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 352, ('var', 0)), 32))), 0) - 256
            idx = idx + 1
            s = s + 1
            continue 
        idx = 0
        ...
        while idx < 0:
            require idx < 0
            require s < 69
            mem[s + 416 len 8] = Mask(8, -(('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 384, ('var', 0)), 32))), 0) + 256, 0) << (('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 384, ('var', 0)), 32))), 0) - 256
            idx = idx + 1
            s = s + 1
            continue 
        return Array(len=69, data=mem[416 len 64], mem[507 len 5])
    s = 0
    idx = arg1
    while idx:
        s = s + 1
    ...
    if not s:
        ...
        while idx:
            require t < mem[224]
            mem[t + 256 len 8] = Mask(8, -(('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) + 256, 0) << (('mask_shl', 8, 0, 245, ('add', 48, ('mod', ('var', 0), 10))), 0) - 256
            t = t - 1
            idx = idx / 10
            continue 
        _263 = mem[64]
        ...
        if not _279 + _278:
            ...
            while idx < _569:
                require idx < mem[224]
                require s < mem[_280]
                mem[_280 + s + 32 len 8] = Mask(8, -(('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 256, ('var', 0)), 32))), 0) + 256, 0) << (('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 256, ('var', 0)), 32))), 0) - 256
                _569 = mem[224]
                idx = idx + 1
                s = s + 1
                continue 
        ...
        mem[_280 + 32 len 32 * _279 + _278] = code.data[10346 len 32 * _279 + _278]
        _424 = mem[96]
        idx = 0
        s = 0
        while idx < _424:
    ...
    mem[256 len 32 * s] = code.data[10346 len 32 * s]
    t = s - 1
    idx = arg1
    while idx:
        require t < mem[224]
    ...
    if not _285 + _284:
        ...
        while idx < _571:
            require idx < mem[224]
            require s < mem[_286]
            mem[_286 + s + 32 len 8] = Mask(8, -(('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 256, ('var', 0)), 32))), 0) + 256, 0) << (('mask_shl', 8, 248, -3, ('mem', ('range', ('add', 256, ('var', 0)), 32))), 0) - 256
            _571 = mem[224]
            idx = idx + 1
            s = s + 1
            continue 
    ...
    mem[_286 + 32 len 32 * _285 + _284] = code.data[10346 len 32 * _285 + _284]
    _426 = mem[96]
    idx = 0
    s = 0
    while idx < _426:
