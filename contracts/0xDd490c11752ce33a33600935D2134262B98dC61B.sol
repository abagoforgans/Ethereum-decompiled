...
function _fallback() payable {
    ...
    stor0 = msg.sender
    require code.data[2839 len 32]
    stor6 = 7 * 10^18 / code.data[2839 len 32]
    stor2 = code.data[2819 len 20]
    stor3 = msg.sender
    stor4 = code.data[2871 len 32]
    return code.data[480 len 2327]
}
...
function _fallback() payable {
    require not stor0
    require msg.value >= 143 * sub_f50a3b00
    require not stor10
