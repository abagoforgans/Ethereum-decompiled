...
function _fallback() {
    stor3 = msg.sender
    stor1[address(msg.sender)] = 2000 * 10^18
    stor0 = 2000 * 10^18
    emit Transfer(2000 * 10^18, 0, msg.sender);
    stor4 = msg.sender
    require stor3 == msg.sender
    require code.data[3790 len 20]
    emit OwnershipTransferred(stor3, code.data[3790 len 20]);
    stor3 = code.data[3790 len 20]
    return code.data[369 len 3409]
}
