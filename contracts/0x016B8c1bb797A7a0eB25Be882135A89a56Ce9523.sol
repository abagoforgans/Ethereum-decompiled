...
function buyTicket() payable {
    require stor14 < 25
    require stor7
    if -stor14 + 25 >= msg.value - (msg.value % stor7) / stor7:
        stor14 += msg.value - (msg.value % stor7) / stor7
        stor12[stor8] = msg.sender
        stor13[stor8] = msg.value - (msg.value % stor7) / stor7
        stor8++
        require ext_code.size(stor9)
        call stor9.0x47f80d3e with:
             gas gas_remaining - 710 wei
            args msg.sender, msg.value - (msg.value % stor7) / stor7
        require ext_call.success
        if stor14 >= 25:
            if not stor0:
                if ext_code.size(0x1d3b2638a7cc9f2cb3d298a3da7a90b67e5506ed) > 0:
        ...
        stor13[stor8] = -stor14 + 25
        call msg.sender with:
           value (-25 * stor7) + (msg.value - (msg.value % stor7) / stor7 * stor7) + (stor14 * stor7) wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        stor14 = 25
        stor12[stor8] = msg.sender
...
function __callback(bytes32 arg1, string arg2) {
    ...
    if u < 25:
        call stor12[t] with:
           value 6 * eth.balance(this.address) + (-20 * stor7) - 15 * 10^16 / 10 wei
             gas 2300 * is_zero(value) wei
    else:
        call stor12[t] with:
           value 20 * stor7 wei
