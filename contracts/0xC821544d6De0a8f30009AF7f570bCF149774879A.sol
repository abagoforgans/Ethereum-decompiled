...
function _fallback() {
    stor4 = code.data[2885 len 20]
    stor1 = code.data[2905 len 32]
    stor5 = code.data[2949 len 20]
    stor0 = code.data[2969 len 32]
    stor2 = code.data[3001 len 32]
    stor3 = code.data[3033 len 32]
    stor54CD = msg.sender
    stor54CD = 1
    stor54CD = 20 * 10^18
    stor6[0].field_0 = 8736 * 24 * 3600
    stor6[code.data[3065 len 32]].field_1280 = msg.sender
    stor6[code.data[3065 len 32]].field_256 = block.timestamp + (8760 * 24 * 3600)
    stor6[code.data[3065 len 32]].field_512 = 1
    stor6[code.data[3065 len 32]].field_1024 = 5 * 10^17
    stor6[code.data[3065 len 32]].field_0 = 8736 * 24 * 3600
    return code.data[405 len 2468]
}
