...
function _fallback() {
    ...
    stor7.length.field_8 = 'AssetIX' / 256
    idx = 0
    ...
    stor8.length.field_8 = 'AIX' / 256
    idx = 0
    while stor8.length + 31 / 32 > idx:
        stor8[idx].field_0 = 0
        idx = idx + 1
        continue 
    mem[256] = 'AIX is a smart token by Asset In'
    mem[288] = 0x74656c6c6967656e636520546563686e6f6c6f6779204c696d69746564c2a000
    stor6.length = 127
    s = 0
    idx = 256
    while 319 > idx:
