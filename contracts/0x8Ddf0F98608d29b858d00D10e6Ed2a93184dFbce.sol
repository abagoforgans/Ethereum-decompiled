...
function _fallback() payable {
    ...
    stor5 = code.data[4476 len 20]
    stor0[stor5] = stor4
    return code.data[687 len 3777]
}
...
function _fallback() payable {
    require balanceOf[address(msg.sender)] <= -200001
    balanceOf[address(msg.sender)] += 200000
    require balanceOf[stor5] >= 200000
    balanceOf[stor5] -= 200000
    call stor5 with:
       value msg.value wei
