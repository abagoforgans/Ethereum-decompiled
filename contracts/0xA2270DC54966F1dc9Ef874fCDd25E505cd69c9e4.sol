...
function sub_fbd0a277(?) {
    sub_0cf9603f[stor41][arg1] = sub_f120dba1 - 2
}
...
function sub_e543804a(?) {
    sub_4c78e401[stor41] = 10^18
    sub_c64a2e56[stor41] = 10^18
    sub_0cf9603f[stor41][2] = sub_f120dba1 - 2
}

function sub_05e2387f(?) {
    sub_4c78e401[stor41] += 10^18
    sub_c64a2e56[stor41] += 10^18
    sub_0cf9603f[stor41][2] = sub_f120dba1 - 2
}
...
function sub_6a528028(?) {
    sub_eef565da = 100
    idx = 1
    while idx <= sub_1d64873b:
        mem[0] = sub_28361f57[idx]
        mem[32] = sha3(idx, 19)
        sub_d5de47c7[idx][stor23[idx]] = sub_eef565da
        idx = idx + 1
        continue 
}
