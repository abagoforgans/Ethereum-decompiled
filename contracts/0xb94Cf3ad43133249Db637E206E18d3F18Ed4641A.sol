...
function sub_68db5f4b(?) payable {
    if voters[address(msg.sender)].field_0:
        if 1 == voters[address(msg.sender)].field_128:
            if uint64(arg2 + voters[address(msg.sender)].field_64) < block.timestamp:
                voters[address(msg.sender)].field_64 = Mask(192, 0, arg2 + voters[address(msg.sender)].field_64)
...
function sub_adca1847(?) payable {
    if msg.sender == sub_aaabd6b0Address:
        if voters[address(arg1)].field_0 != 0:
            ...
            voters[address(arg1)].field_0 = uint64(block.timestamp)
            voters[address(arg1)].field_64 = uint64(block.timestamp - (744 * 24 * 3600))
            voters[address(arg1)].field_128 = 1
            voters[address(arg1)].field_136 = Mask(120, 72, block.timestamp - (744 * 24 * 3600)) >> 72
            voters[address(arg1)].field_136 = Mask(120, 136, block.timestamp) >> 136
}
...
function sub_02bf617f(?) payable {
    if voters[address(arg1)].field_0:
        ...
        if msg.sender == ext_call.return_data[12 len 20]:
            ...
            voters[address(arg2)].field_128 = 0
            voters[address(arg2)].field_0 = voters[address(arg1)].field_0
            voters[address(arg2)].field_64 = voters[address(arg1)].field_64
            voters[address(arg2)].field_128 = voters[address(arg1)].field_128
            voters[address(arg2)].field_136 = 0
            voters[address(arg2)].field_136 = 0
