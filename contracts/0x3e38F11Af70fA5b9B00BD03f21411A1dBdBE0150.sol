...
function _fallback() payable {
    ...
    stor3.length.field_8 = 'ArabCoin' / 256
    idx = 0
...
function ERC20Token() {
    ...
    name.length.field_8 = 'ArabCoin' / 256
    idx = 0
