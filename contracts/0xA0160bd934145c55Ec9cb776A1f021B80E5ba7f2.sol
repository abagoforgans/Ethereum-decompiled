...
function initialize() {
    ...
    uint256(stor4.field_0) = msg.sender or Mask(96, 160, uint256(stor4.field_0))
...
function increaseSupply(uint256 arg1) {
    ...
    totalSupply += arg1
    require arg1 + balanceOf[address(stor7)] >= balanceOf[address(stor7)]
    balanceOf[address(stor7)] += arg1
...
function decreaseSupply(uint256 arg1) {
    if address(supplyControllerAddress) != msg.sender:
        revert with 0, 'onlySupplyController'
    if arg1 > balanceOf[address(stor7)]:
        revert with 0, 'not enough supply'
    require arg1 <= balanceOf[address(stor7)]
    balanceOf[address(stor7)] -= arg1
