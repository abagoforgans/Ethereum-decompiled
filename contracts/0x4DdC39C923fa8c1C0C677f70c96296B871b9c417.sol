...
const baseTokenURI = 'http://adventure.pizza/token/v1/'
...
function tokenURI(uint256 arg1) {
    mem[96] = 32
    mem[128] = 'http://adventure.pizza/token/v1/'
    if not arg1:
        mem[160] = 1
        mem[192] = '0'
        mem[224] = 0
        ...
        mem[288] = 0
        mem[320] = 33
        mem[352 len 1056] = code.data[10269 len 1056]
        idx = 0
        s = 0
        while idx < 32:
            require idx < 32
        ...
        while idx < 0:
            ...
            s = s + 1
            continue 
        return Array(len=33, data=mem[352], mem[415 len 1])
    s = 0
    idx = arg1
    while idx:
        s = s + 1
    ...
    if not s:
        ...
        mem[_280 + 32 len 32 * _279 + _278] = code.data[10269 len 32 * _279 + _278]
        _424 = mem[96]
        idx = 0
        s = 0
        while idx < _424:
    ...
    mem[192 len 32 * s] = code.data[10269 len 32 * s]
    t = s - 1
    idx = arg1
    while idx:
        require t < mem[160]
    ...
    mem[_286 + 32 len 32 * _285 + _284] = code.data[10269 len 32 * _285 + _284]
    _426 = mem[96]
    idx = 0
    s = 0
    while idx < _426:
