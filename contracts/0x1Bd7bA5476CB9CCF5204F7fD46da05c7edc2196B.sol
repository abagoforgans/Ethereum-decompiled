...
function _fallback() payable {
    stor1 = code.data[2808 len 32] or Mask(96, 160, stor1)
    stor2 = code.data[2840 len 32] or Mask(96, 160, stor2)
    uint8(stor0.field_0) = 0
    Mask(248, 0, stor0.field_8) = 0
    uint8(stor0.field_8) = 1
    Mask(240, 0, stor0.field_16) = 0
    Mask(240, 0, stor0.field_16) = code.data[2778 len 30]
    stor5 = 0
    stor4 = 0
    stor6 = 0
    stor3 = code.data[2776 len 32]
    return code.data[158 len 2618]
}
