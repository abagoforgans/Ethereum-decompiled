...
function _fallback() payable {
    ...
    stor4 = 18
    stor2 = code.data[2780 len 32] * 10^18
    stor0[address(msg.sender)] = code.data[2780 len 32] * 10^18
    stor6 = msg.sender
    bool(stor3.length) = 0
    stor3.length.field_1 = 10
    stor3.length.field_8 = 'Basic Coin' / 256
    idx = 0
    ...
    stor5.length.field_8 = 'BASIC' / 256
    idx = 0
    while stor5.length + 31 / 32 > idx:
        stor5[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[438 len 2342]
}
