...
function _fallback() payable {
    mem[96 len -6484] = code.data[6761 len -6484]
    mem[64] = -6388
...
function kill(address arg1) payable {
    ...
    if not sub_e8aca2a3[call.data[0 len calldata.size]].field_0:
        ...
        stor[code.data[6452 len 32] + stor260.length] = sha3(call.data[0 len calldata.size])
    ...
    stor[code.data[6452 len 32] + stor259[call.data[0 len calldata.size]].field_512] = 0
...
function sub_432dcdb8(?) payable {
    ...
    while idx < stor260.length:
        mem[0] = stor[code.data[6452 len 32] + idx]
        mem[32] = 274
        if 0 == address(sub_67f7c83a[stor[code.data[6452 len 32] + idx]].field_0):
            require idx < stor260.length
            mem[0] = stor[idx + code.data[6452 len 32]]
            if 0 == sub_67f7c83a[stor[idx + code.data[6452 len 32]]][2].length:
                idx = idx + 1
                s = s
                continue 
        idx = idx + 1
...
function getPendingTransaction(uint256 arg1) payable {
    ...
    while idx < stor260.length:
        ...
        if arg1 != uint8(s):
            ...
            continue 
        require idx < stor260.length
        return stor[idx + code.data[6452 len 32]]
    return 0
}
...
function confirm(bytes32 arg1) payable {
    ...
    if not sub_e8aca2a3[arg1].field_0:
        ...
        require stor260.length < stor260.length
        stor[code.data[6452 len 32] + stor260.length] = arg1
    if 2^stor258[address(msg.sender)] and sub_e8aca2a3[arg1].field_256 != 0:
        return 0
    mem[128] = arg1
    ...
    stor[code.data[6452 len 32] + stor259[arg1].field_512] = 0
            ...
            if sub_e8aca2a3[call.data[0 len calldata.size]].field_0 > 1:
                ...
                if arg1 <= m_numOwners:
                    ...
                    while idx < stor260.length:
                        mem[0] = stor[code.data[6452 len 32] + idx]
                        mem[32] = 274
                        address(sub_67f7c83a[stor[code.data[6452 len 32] + idx]].field_0) = 0
                        sub_67f7c83a[stor[code.data[6452 len 32] + idx]].field_256 = 0
                        sub_67f7c83a[stor[code.data[6452 len 32] + idx]].field_512 = 0
                        if 31 < sub_67f7c83a[stor[code.data[6452 len 32] + idx]][2].length:
                            mem[0] = sha3(stor[code.data[6452 len 32] + idx], 274) + 2
                            s = sha3(sha3(stor[code.data[6452 len 32] + idx], 274) + 2)
                            while sha3(sha3(stor[code.data[6452 len 32] + idx], 274) + 2) + (sub_67f7c83a[stor[code.data[6452 len 32] + idx]][2].length + 31 / 32) > s:
                                stor[s] = 0
                                s = s + 1
                                continue 
                        idx = idx + 1
                    ...
                    while idx < stor260.length:
                        mem[0] = 260
                        if stor[code.data[6452 len 32] + idx]:
                            require idx < stor260.length
                            mem[0] = stor[code.data[6452 len 32] + idx]
                            mem[32] = 259
                            sub_e8aca2a3[stor[code.data[6452 len 32] + idx]].field_0 = 0
                            sub_e8aca2a3[stor[code.data[6452 len 32] + idx]].field_256 = 0
                            sub_e8aca2a3[stor[code.data[6452 len 32] + idx]].field_512 = 0
                        idx = idx + 1
                        continue 
                    stor260.length = 0
                    idx = code.data[6452 len 32]
                    while code.data[6452 len 32] + stor260.length > idx:
                        stor[idx] = 0
                        idx = idx + 1
                        continue 
...
function execute(address arg1, uint256 arg2, bytes arg3) payable {
    ...
    if 0 == stor258[address(msg.sender)]:
        ...
        if not sub_e8aca2a3[call.data[0 len calldata.size]][block.number].field_0:
            ...
            require stor260.length < stor260.length
            stor[code.data[6452 len 32] + stor260.length] = sha3(call.data[0 len calldata.size], block.number)
        if 2^stor258[address(msg.sender)] and sub_e8aca2a3[call.data[0 len calldata.size]][block.number].field_256 != 0:
            ...
            if sub_e8aca2a3[call.data[0 len calldata.size]][block.number].field_0 > 1:
                ...
                stor[code.data[6452 len 32] + stor259[call.data[0 len calldata.size]][block.number].field_512] = 0
    ...
    if stor258[address(msg.sender)] > 0:
        ...
        if 0 == stor258[address(signer)]:
            ...
            if not sub_e8aca2a3[address(cd[4])][cd[36]][call.data[cd[68] + 36 len ('cd', 68).length]][cd[100]][cd[132]].field_0:
                ...
                require stor260.length < stor260.length
                stor[code.data[6452 len 32] + stor260.length] = sha3(address(cd[4]), cd[36], call.data[cd[68] + 36 len ('cd', 68).length], cd[100], cd[132])
        ...
        stor[code.data[6452 len 32] + stor259[address(cd[4])][cd[36]][call.data[cd[68] + 36 len ('cd', 68).length]][cd[100]][cd[132]].field_512] = 0
