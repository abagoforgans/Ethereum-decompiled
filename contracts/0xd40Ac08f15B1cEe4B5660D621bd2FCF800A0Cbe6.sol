...
function name(string arg1) {
    return stor[_34][0 len stor[_34].length]
}
...
function sub_6535b4a5(?) payable {
    ...
    call address(create.new_address).supportsInterface(bytes4 arg1) with:
         gas gas_remaining wei
        args 0x8139792d00000000000000000000000000000000000000000000000000000000
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0]
    ...
    call address(create.new_address).supportsInterface(bytes4 arg1) with:
         gas gas_remaining wei
        args 0x5f57e78900000000000000000000000000000000000000000000000000000000
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require ext_call.return_data[0]
