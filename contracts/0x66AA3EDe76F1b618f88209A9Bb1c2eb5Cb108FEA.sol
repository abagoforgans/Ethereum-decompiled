...
function annualInterest() {
    ...
    if not block.timestamp - stakeStartTime / 8760 * 24 * 3600:
        return (2573 * baseIntCalc / 100)
    require stakeStartTime <= block.timestamp
    if block.timestamp - stakeStartTime / 8760 * 24 * 3600 > 10:
        return 0
    return (97 * baseIntCalc / 100)
}
...
function ownerBurnToken(uint256 arg1) {
    ...
    uint256(stor25[address(msg.sender)].field_0) = 0
    idx = 0
    while uint256(stor25[address(msg.sender)].field_0) > idx:
        uint128(stor25[address(msg.sender)][idx].field_0) = 0
        uint64(stor25[address(msg.sender)][idx].field_128) = 0
        idx = idx + 1
        continue 
    uint256(stor25[address(msg.sender)].field_0)++
    uint128(stor25[address(msg.sender)][uint256(stor25[address(msg.sender)].field_0)].field_0) = uint128(balanceOf[address(msg.sender)])
    uint64(stor25[address(msg.sender)][uint256(stor25[address(msg.sender)].field_0)].field_128) = uint64(block.timestamp)
...
function coinAge() {
    if uint256(stor25[address(msg.sender)].field_0) > 0:
        idx = 0
        while idx < uint256(stor25[address(msg.sender)].field_0):
            require idx < uint256(stor25[address(msg.sender)].field_0)
            require uint64(stor25[address(msg.sender)][idx].field_128) + stakeMinAge >= uint64(stor25[address(msg.sender)][idx].field_128)
            if block.timestamp >= uint64(stor25[address(msg.sender)][idx].field_128) + stakeMinAge:
                require idx < uint256(stor25[address(msg.sender)].field_0)
                require uint64(stor25[address(msg.sender)][idx].field_128) <= block.timestamp
                require idx < uint256(stor25[address(msg.sender)].field_0)
                if block.timestamp - uint64(stor25[address(msg.sender)][idx].field_128) <= stakeMaxAge:
                    require uint128(stor25[address(msg.sender)][idx].field_0) * block.timestamp - uint64(stor25[address(msg.sender)][idx].field_128) / 24 * 3600 >= 0
                else:
                    require uint128(stor25[address(msg.sender)][idx].field_0) * stakeMaxAge / 24 * 3600 >= 0
            mem[0] = msg.sender
            mem[32] = 25
            idx = idx + 1
            continue 
...
function getProofOfStakeReward(address arg1) {
    ...
    if uint256(stor25[address(arg1)].field_0) > 0:
        idx = 0
        while idx < uint256(stor25[address(arg1)].field_0):
            require idx < uint256(stor25[address(arg1)].field_0)
            require uint64(stor25[address(arg1)][idx].field_128) + stakeMinAge >= uint64(stor25[address(arg1)][idx].field_128)
            if block.timestamp >= uint64(stor25[address(arg1)][idx].field_128) + stakeMinAge:
                require idx < uint256(stor25[address(arg1)].field_0)
                require uint64(stor25[address(arg1)][idx].field_128) <= block.timestamp
                require idx < uint256(stor25[address(arg1)].field_0)
                if block.timestamp - uint64(stor25[address(arg1)][idx].field_128) <= stakeMaxAge:
                    require uint128(stor25[address(arg1)][idx].field_0) * block.timestamp - uint64(stor25[address(arg1)][idx].field_128) / 24 * 3600 >= 0
                else:
                    require uint128(stor25[address(arg1)][idx].field_0) * stakeMaxAge / 24 * 3600 >= 0
            mem[0] = arg1
            mem[32] = 25
            idx = idx + 1
            continue 
...
function transferFrom(address arg1, address arg2, uint256 arg3) {
    ...
    if uint256(stor25[address(arg1)].field_0) > 0:
        uint256(stor25[address(arg1)].field_0) = 0
        idx = 0
        while uint256(stor25[address(arg1)].field_0) > idx:
            uint128(stor25[address(arg1)][idx].field_0) = 0
            uint64(stor25[address(arg1)][idx].field_128) = 0
            idx = idx + 1
            continue 
    uint256(stor25[address(arg1)].field_0)++
    uint128(stor25[address(arg1)][uint256(stor25[address(arg1)].field_0)].field_0) = uint128(balanceOf[address(arg1)])
    uint64(stor25[address(arg1)][uint256(stor25[address(arg1)].field_0)].field_128) = uint64(block.timestamp)
    uint256(stor25[address(arg2)].field_0)++
    uint128(stor25[address(arg2)][uint256(stor25[address(arg2)].field_0)].field_0) = uint128(arg3)
    uint64(stor25[address(arg2)][uint256(stor25[address(arg2)].field_0)].field_128) = uint64(block.timestamp)
    return 1
}
...
function transfer(address arg1, uint256 arg2) {
    ...
    uint64(stor25[address(msg.sender)][uint256(stor25[address(msg.sender)].field_0)].field_128) = uint64(block.timestamp)
    uint256(stor25[address(arg1)].field_0)++
    uint128(stor25[address(arg1)][uint256(stor25[address(arg1)].field_0)].field_0) = uint128(arg2)
    uint64(stor25[address(arg1)][uint256(stor25[address(arg1)].field_0)].field_128) = uint64(block.timestamp)
    return 1
}
...
function batchTransfer(address[] arg1, uint256[] arg2) {
    ...
    while idx < arg1.length:
        ...
        mem[32] = 25
        _143 = sha3(mem[(32 * idx) + 140 len 20], 25)
        _144 = mem[64]
        mem[64] = mem[64] + 64
        require idx < mem[(32 * arg1.length) + 128]
