...
function HaraKiri() {
    ...
    emit code.data[6348 len 32]: Array(len=25, data='Kill attempt by non owner')
}
...
function setRegistrationFee(uint256 arg1) {
    if sub_b2ee56aeAddress == msg.sender:
        ...
        emit code.data[6348 len 32]: Array(len=27, data='FeeSet attempt by non owner')
}
...
function sub_8d002bc4(?) {
    ...
    emit code.data[6348 len 32]: 'Invalid Game'
    return 0
}
...
function sub_b6813e08(?) {
    ...
    emit code.data[6348 len 32]: 'Invalid Arb'
    return 0
}
...
function setArbiterLocked(address arg1, bool arg2) {
    if sub_b2ee56aeAddress != msg.sender:
        emit code.data[6348 len 32]: Array(len=16, data='Only Owner Calls')
    else:
        idx = 0
        while idx < sub_beff102b:
            mem[0] = idx
    ...
    if arg1 <= 0:
        ...
        if arg1 > numGamesStarted:
            ...
            if not stor0[arg1].field_768:
                ...
                emit code.data[6348 len 32]: Array(len=11, data='Invalid Idx')
    return 0
}
        ...
        if arg1 <= numGamesStarted:
            if stor0[arg1].field_768:
                ...
                while idx < stor0[arg1].field_512:
                    ...
                    return 0
    emit code.data[6348 len 32]: Array(len=14, data='Invalid Player')
    revert 
}

function sub_9387bf0e(?) payable {
    if stor8 != msg.value:
        emit code.data[6348 len 32]: Array(len=16, data='Insufficient Fee')
        revert 
...
function sub_7be1c2ef(?) {
    ...
    while idx < sub_beff102b:
        ...
        if stor0[arg1].field_1792 != msg.sender:
            emit code.data[6348 len 32]: Array(len=12, data='Arb Mismatch')
        else:
            if arg1 > 0:
                if arg1 <= numGamesStarted:
                    if stor0[arg1].field_768:
                        ...
                        while idx < stor0[arg1].field_512:
                            ...
                            if stor0[arg1][address(arg2)].field_0 != arg3:
                                emit code.data[6348 len 32]: Array(len=15, data='Cheat Detected!')
                            else:
                                s = 0
                                s = 0
                                idx = 0
                                ...
                                if ext_call.success:
                                    ...
                                    emit code.data[6348 len 32]: Array(len=10, data='Send Error')
                            revert 
            emit code.data[6348 len 32]: Array(len=14, data='Invalid Player')
    emit code.data[6348 len 32]: 'Invalid Arb'
}
    ...
    while idx < sub_beff102b:
        ...
        while idx < sub_beff102b:
            ...
            if arbiters[address(msg.sender)].field_1024:
                emit code.data[6348 len 32]: Array(len=10, data='Arb Locked')
                return -1
            if arg2.length < arbiters[address(msg.sender)].field_768:
                emit code.data[6348 len 32]: Array(len=18, data='Not Enough Players')
                return -1
            numGamesStarted++
            ...
            if stor0[stor6 + 1].field_512 < arg2.length:
                emit code.data[6348 len 32]: Array(len=16, data='NumPlayers<Param')
                revert 
