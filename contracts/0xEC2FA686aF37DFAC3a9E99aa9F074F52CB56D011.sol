...
function sub_07f7011f(?) {
    ...
    if not owners.length:
        ...
        mem[ceil32(arg1.length) + (32 * owners.length) + floor32(arg1.length) + -(arg1.length % 32) + 224 len arg1.length % 32] = mem[floor32(arg1.length) + -(arg1.length % 32) + 160 len arg1.length % 32]
