...
#  - sub_ca1a70be(?)
#
const sub_20350b5b(?) = 'whitepaper_url'

const sub_2a3bd17f(?) = 'project_name'

const sub_335d4b6d(?) = 'cover_image_url'

const sub_61f57b0b(?) = 'logo_url'

const sub_663a7ae7(?) = 'sale_name'

const sub_71d55e0a(?) = 'project_description'

const sub_7588309d(?) = 'website_url'

const sub_b07b3c78(?) = 'update_confirm'

const sub_d30f6e20(?) = 'update'

const sub_de4213dd(?) = 'project_summary'
