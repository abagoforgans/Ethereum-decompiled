...
function _fallback() {
    mem[96 len -4933] = code.data[5337 len -4933]
    mem[64] = -4837
...
function transferPrivileged(address arg1, uint256 arg2) {
    ...
    require arg2 + balanceOf[arg1] >= arg2
    balanceOf[address(arg1)] = arg2 + balanceOf[arg1]
    require arg2 + privilegedBalance[address(arg1)] >= privilegedBalance[address(arg1)]
    require arg2 + privilegedBalance[address(arg1)] >= arg2
