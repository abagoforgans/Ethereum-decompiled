...
function _fallback() payable {
    ...
    stor0 = code.data[1788 len 20]
    stor1 = 10^18 * code.data[1808 len 32]
    stor3 = 10^14 * code.data[1840 len 32]
    stor4 = code.data[1884 len 20]
    return code.data[165 len 1611]
}
