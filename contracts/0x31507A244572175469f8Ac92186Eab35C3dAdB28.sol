...
function _fallback() payable {
    ...
    stor3 = stor9
    stor6 = 2 * 10^16
    stor4[code.data[5916 len 20]] = 2 * 10^16
    emit Transfer(2 * 10^16, 0, code.data[5916 len 20]);
    return code.data[853 len 5051]
}
