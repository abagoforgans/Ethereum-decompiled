...
function _fallback() payable {
    stor0 = code.data[3417 len 32]
    stor1 = msg.sender or Mask(96, 160, stor1)
    return code.data[69 len 3348]
}
...
address owner;
uint256 stor1;
mapping of uint256 custodianName;
...
function getCustodianName(address arg1) payable {
    return custodianName[address(arg1)]
}
...
function setCustodianName(address arg1, bytes32 arg2) payable {
    call configAddress.0x24d7806c with:
         gas gas_remaining - 25050 wei
        args msg.sender
    require ext_call.success
    if ext_call.return_data[0]:
        custodianName[address(arg1)] = arg2
}
