...
function sub_796cc911(?) {
    return uint64(name[256 * arg1].field_384)
}
...
function getMeltValue(uint256 arg1) {
    return uint64(name[256 * arg1].field_448)
}
...
function getTotalSupply(uint256 arg1) {
    return uint64(name[256 * arg1].field_320)
}
...
function sub_f521a982(?) {
    return name[256 * arg1].field_264 % 72057594037927936
}
...
function sub_620a3cbe(?) {
    require uint64(name[256 * arg1].field_384) <= uint64(name[256 * arg1].field_320)
    return (uint64(name[256 * arg1].field_320) - uint64(name[256 * arg1].field_384))
}
...
function setTotalSupply(uint256 arg1, uint256 arg2) {
    ...
    if arg2 != uint64(arg2):
        revert with 0, 'overflow'
    uint64(name[256 * arg1].field_320) = uint64(arg2)
}
...
function sub_93fb8f39(?) {
    require stor0[msg.sender]
    if name[256 * arg1].field_264 % 72057594037927936:
        revert with 0, 'exist'
    creator[arg1] = arg2
    if arg3 > 0:
...
function sub_653ae674(?) {
    require stor0[msg.sender]
    require ext_code.size(arg1)
    call arg1.transferFrom(address arg1, address arg2, uint256 arg3, uint256 arg4) with:
         gas gas_remaining wei
...
function sub_2c4fa099(?) {
    ...
    if arg6 != arg6:
        revert with 0, 'overflow'
    if arg7 % 72057594037927936 != arg7:
        revert with 0, 'overflow'
    uint256(name[256 * arg1][].field_0) = Array(len=arg2.length, data=arg2[all])
    uint8(name[256 * arg1].field_256) = uint8(arg1)
    name[256 * arg1].field_264 % 72057594037927936 = arg7 % 72057594037927936
    uint64(name[256 * arg1].field_320) = uint64(arg4)
    uint64(name[256 * arg1].field_384) = arg5
    uint64(name[256 * arg1].field_448) = arg6
...
function sub_73ab66b2(?) {
    ...
    require ext_code.size(arg1)
    call arg1.batchTransferFrom(address arg1, address arg2, uint256[] arg3, uint256[] arg4) with:
         gas gas_remaining wei
