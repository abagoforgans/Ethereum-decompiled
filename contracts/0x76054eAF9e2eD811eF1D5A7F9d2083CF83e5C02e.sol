...
function sub_e56197c2(?) {
    return stor20, stor21, stor22, stor23, stor24, stor25, stor26, stor27, stor28, stor29, stor30, stor31
}
...
function sub_c1bb2493(?) payable {
    ...
    call address(stor1).0xaf9efd4c with:
       value msg.value wei
         gas gas_remaining - 9050 wei
    require ext_call.success
    require eth.balance(address(stor1)) <= eth.balance(address(stor1))
    call stor0 with:
       value eth.balance(this.address) wei
         gas 2300 * is_zero(value) wei
    require ext_call.success
