...
function _fallback() payable {
    ...
    mem[96 len -11011] = code.data[12139 len -11011]
    mem[64] = -10915
    stor0 = msg.sender
    require mem[96] > 0
    require mem[128] > 0
    ...
    create contract with 0 wei
                    code: code.data[8494 len 3645], 1
    ...
    stor3 = mem[288]
    return code.data[1128 len 7366]
}
...
address sub_dc33af2eAddress;
uint256 fundcruVaultLockTime;
uint8 stor4; offset 160
address sub_2b2ef4cbAddress;
uint256 duration;
uint256 startTime;
uint256 endTime;
...
function sub_2b2ef4cb(?) {
    return sub_2b2ef4cbAddress
}
...
function sub_dc33af2e(?) {
    return sub_dc33af2eAddress
}
...
function withdrawTokens() {
    ...
    call fundcruTokenAddress.0xa9059cbb with:
         gas gas_remaining - 710 wei
        args sub_2b2ef4cbAddress, ext_call.return_data[0]
    require ext_call.success
    require ext_code.size(fundcruTokenAddress)
...
function endCrowdsale() {
    ...
    call fundcruTokenAddress.0x40c10f19 with:
         gas gas_remaining - 710 wei
        args sub_2b2ef4cbAddress, ext_call.return_data[0] / 10
    require ext_call.success
