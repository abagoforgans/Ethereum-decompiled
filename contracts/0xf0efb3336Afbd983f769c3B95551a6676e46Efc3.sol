...
function getWinners() {
    ...
    if 288 < (32 * ext_call.return_data[0] + ext_call.return_data[32]) + 288:
        ...
        return Array(len=ext_call.return_data[0] + ext_call.return_data[32], data=mem[(64 * ext_call.return_data[0] + ext_call.return_data[32]) + 416 len (98 * ext_call.return_data[0]) + (98 * ext_call.return_data[32]) - (64 * ext_call.return_data[0] + ext_call.return_data[32])], mem[(32 * ext_call.return_data[0] + ext_call.return_data[32]) + 288], mem[(98 * ext_call.return_data[0]) + (98 * ext_call.return_data[32]) + 448 len (32 * mem[(32 * ext_call.return_data[0] + ext_call.return_data[32]) + 288]) + (63 * ext_call.return_data[0]) + (63 * ext_call.return_data[32]) + (64 * ext_call.return_data[0] + ext_call.return_data[32])]), 
...
function finish() {
    ...
    if msize < mem[64]:
        ...
        require ext_call.success
        mem[64] = mem[64] + (32 * ext_call.return_data[0] + ext_call.return_data[32]) + 1632
        idx = 0
        while idx < ext_call.return_data[0] + ext_call.return_data[32]:
            require idx < 50
            require idx < mem[_33]
