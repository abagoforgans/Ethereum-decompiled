...
function _fallback() payable {
    ...
    mem[96 len -5746] = code.data[6360 len -5746]
    mem[64] = -5650
    stor3 = msg.sender
    stor8 = msg.sender
    stor3 = msg.sender
    stor12.length = (2 * mem[mem[96] + 96]) + 1
    ...
    while mem[96] + mem[mem[96] + 96] + 128 > idx:
        ...
        idx = idx + 32
        continue 
    idx = (Mask(251, 0, mem[mem[96] + 96] + 31) >> 5) - 0x209699368efae3c2ab13a6e9d9f9aceb6c5aebfb5ffd7bd0a9ff6281a30b5739
    while (stor12.length + 31 / 32) - 0x209699368efae3c2ab13a6e9d9f9aceb6c5aebfb5ffd7bd0a9ff6281a30b5739 > idx:
        stor[idx] = 0
        idx = idx + 1
        continue 
    stor13.length = (2 * mem[mem[128] + 96]) + 1
    s = 0
    idx = mem[128] + 128
    while mem[128] + mem[mem[128] + 96] + 128 > idx:
        ...
        idx = idx + 32
        continue 
    if stor13.length + 31 / 32 > Mask(251, 0, mem[mem[128] + 96] + 31) >> 5:
        stor13[Mask(251, 0, mem[mem[128] + 96] + 31) >> 5] = 0
