...
function sub_581755a5(?) {
    ...
    emit 0x513dad75: ext_call.return_data[0], ext_call.return_data[0]
}
...
function sub_441c2f9d(?) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    emit 0xa8fb2f9a: ext_call.return_data[0], ext_call.return_data[0], ext_call.return_data[0]
}
...
function allTokens() {
    ...
    if ext_call.return_data[0]:
        mem[128 len 32 * ext_call.return_data[0]] = code.data[6108 len 32 * ext_call.return_data[0]]
    idx = 0
