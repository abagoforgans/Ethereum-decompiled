...
function issueTokens(address arg1, uint256 arg2) payable {
    require msg.sender == 0x74d2c502fe33d78b904299122cbc288e493540ae
    if 0 == arg2:
        return 0
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if ext_call.return_data[12 len 20] == msg.sender:
        call 0x74d2c502fe33d78b904299122cbc288e493540ae.0x49cc954b with:
             gas gas_remaining - 25050 wei
        require ext_call.success
        require ext_call.return_data[0]
    call 0xb71703c727e3697dcedaa090d5f0cb659b31eb79.0x5d0be9de with:
         gas gas_remaining - 25050 wei
        args msg.sender
    require ext_call.success
    call 0xb71703c727e3697dcedaa090d5f0cb659b31eb79.0x5d0be9de with:
