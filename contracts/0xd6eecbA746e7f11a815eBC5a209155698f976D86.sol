...
function FucksToken() {
    ...
    name.length.field_8 = 'TakCoin' / 256
    idx = 0
    ...
    balanceOf[0xa3c3b9088eb51e400a32f822379c07b01c00e3a1] = _totalSupply
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  _totalSupply,
    emit 0x0: _totalSupply
    emit 0xa3c3b908: _totalSupply
}
