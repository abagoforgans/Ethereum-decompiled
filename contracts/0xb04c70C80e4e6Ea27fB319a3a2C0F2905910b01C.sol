...
function sub_4e2fb1f6(?) {
    require msg.sender == adminAddress
    step = arg4
    minFunding = 10^18 * arg1
    maxFunding = 10^18 * arg2
    totalSale = 10^18 * arg3
    currentSale = 0
}
...
function _fallback() payable {
    ...
    require 1 == bool(uint8(stor9.field_160))
    if msg.value + currentSale <= totalSale:
        ...
        call tokenAddress.transferFromAndLock(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5) with:
            ...
            args 0, uint32(stor1), msg.sender, msg.value * tokenPerETH, 6 * msg.value * tokenPerETH / 10, step
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        ...
        call tokenAddress.transferFromAndLock(address arg1, address arg2, uint256 arg3, uint256 arg4, uint256 arg5) with:
             gas gas_remaining wei
            args 0, uint32(stor1), msg.sender, (totalSale * tokenPerETH) - (currentSale * tokenPerETH), (6 * totalSale * tokenPerETH) - (6 * currentSale * tokenPerETH) / 10, step
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
