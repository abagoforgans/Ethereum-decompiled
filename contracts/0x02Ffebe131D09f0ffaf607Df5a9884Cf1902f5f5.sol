...
function sub_2808a487(?) {
    return sub_2808a487Address
}
...
function sub_99b38974(?) {
    require msg.sender == sub_2808a487Address
    require arg1
    require sub_2808a487Address != arg1
    sub_2808a487Address = arg1
    return 1
}
