...
function _fallback() payable {
    ...
    return code.data[340 len 10817]
}
...
function _fallback() payable {
    ...
    if stor12 != msg.sender:
        if block.timestamp > stor19:
            ...
            call address(stor2).0x2ef3accc with:
                 gas gas_remaining - 710 wei
            ...
            if ext_call.return_data[0] > (500000 * block.gasprice) + 10^18:
                ...
                require ext_code.size(address(stor2))
                call address(stor2).0xc51be90f with:
                   value ext_call.return_data[0] wei
                     gas gas_remaining - 9710 wei
                    args 0, 128, 192, 500000, 3, 'URL' << 232, 68, 'json(https://poloniex.com/public', '?command=returnTicker).USDT_ETH.', 'last' >> 256, Mask(32, -512, 'json(https://poloniex.com/public', '?command=returnTicker).USDT_ETH.', 'last') << 512
                require ext_call.success
...
function __callback(bytes32 arg1, string arg2) {
    ...
    if not stor1:
        if ext_code.size(0x1d3b2638a7cc9f2cb3d298a3da7a90b67e5506ed) > 0:
            ...
            uint256(stor2) = ext_call.return_data[12 len 20] or Mask(96, 160, uint256(stor2))
            require ext_code.size(address(stor2))
            call address(stor2).0xc281d19e with:
                 gas gas_remaining - 710 wei
            require ext_call.success
                    ...
                    if userStructs[stor13[arg1]] != stor13[arg1]:
                        ...
                        if not addresses.length <= addresses.length + 1:
                            ...
                            while addresses.length > idx:
                                ...
                                continue 
                        address(addresses[addresses.length]) = stor13[arg1]
                emit Message(Array(len=14, data='transferred to'), stor13[arg1], stor17 * stor14[stor13[arg1]] / 10000 * 10^18 * stor16);
        else:
            if ext_code.size(0xc03a2615d5efaf5f49f60b7bb6583eaec212fdf1) > 0:
                stor1 = 0xc03a2615d5efaf5f49f60b7bb6583eaec212fdf1
