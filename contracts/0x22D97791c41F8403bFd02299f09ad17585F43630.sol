...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor4 = 21 * 10^6 * 10^stor3
    stor5[address(msg.sender)] = 21 * 10^6 * 10^stor3
    bool(stor1.length) = 0
    stor1.length.field_1 = 16
    stor1.length.field_8 = 'Bitcoin SegWit2x' / 256
    idx = 0
    ...
    stor2.length.field_8 = 'BTC2x' / 256
    idx = 0
    while stor2.length + 31 / 32 > idx:
        stor2[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[419 len 3353]
}
