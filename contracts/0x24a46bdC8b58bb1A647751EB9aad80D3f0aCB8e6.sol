...
function _fallback() payable {
    ...
    address(stor7.field_0) = 0xd0efef19c9157389987f0c8916de807e9db6b39d
    require not msg.value
    address(stor0.field_0) = msg.sender
    stor1 = address(stor7.field_0)
    stor8 = 4000 * 10^18
    Mask(96, 0, stor7.field_160) = 0
    return code.data[535 len 3995]
}
...
function _fallback() payable {
    ...
    call stor1.0x70a08231 with:
        ...
        args msg.sender
    require ext_call.success
    require ext_call.return_data[0] + (1000 * msg.value) <= 1000 * 10^18
