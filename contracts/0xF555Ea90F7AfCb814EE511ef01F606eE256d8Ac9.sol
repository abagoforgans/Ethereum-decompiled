...
address stor2;
mapping of uint256 sub_fbd0b18a;
uint256 stor4;
...
function sub_fbd0b18a(?) payable {
    return sub_fbd0b18a[arg1]
}
...
function getPrice(string arg1) payable {
    if sub_fbd0b18a[address(msg.sender)] != 0:
        return price[arg1[all]]
    sub_fbd0b18a[address(msg.sender)]++
    return 0
}
