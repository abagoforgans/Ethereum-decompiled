...
function transfer(address arg1, uint256 arg2) {
    ...
    while s < t:
        ...
        continue 
    if t:
        if balanceOf[address(msg.sender)] < arg2 + t:
            return 0
        if arg2 <= 0:
            return 0
        balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] - arg2 - t
        balanceOf[address(arg1)] += arg2
        balanceOf[0xbba92e4a0642ce1c33da73d9012a296dfe0f076b] += t
        emit Transfer(arg2, msg.sender, arg1);
        emit Transfer(t, msg.sender, 0xbba92e4a0642ce1c33da73d9012a296dfe0f076b);
    else:
        ...
        balanceOf[address(arg1)] += arg2
        balanceOf[0xbba92e4a0642ce1c33da73d9012a296dfe0f076b]++
        emit Transfer(arg2, msg.sender, arg1);
        emit Transfer(1, msg.sender, 0xbba92e4a0642ce1c33da73d9012a296dfe0f076b);
    return 1
}
