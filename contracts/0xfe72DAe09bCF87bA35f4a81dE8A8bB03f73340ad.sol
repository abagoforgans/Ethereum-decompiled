...
function _fallback() payable {
    ...
    if ext_call.return_data[0] <= (200000 * block.gasprice) + 10^18:
        ...
        require ext_call.success
    return code.data[2288 len 3370]
}
...
function __callback(bytes32 arg1, string arg2, bytes arg3) payable {
    ...
    if ext_call.return_data[0] <= (200000 * block.gasprice) + 10^18:
        ...
        mem[ceil32(arg2.length) + ceil32(arg3.length) + 644] = mem[ceil32(arg2.length) + ceil32(arg3.length) + 671 len 5]
        call address(stor1).query(uint256 rg1, string rg2, string rg3) with:
           value ext_call.return_data[0] wei
             gas gas_remaining - 34050 wei
            args 600, 96, 160, 3, mem[ceil32(arg2.length) + ceil32(arg3.length) + 516], 69, 'xml(https://www.fueleconomy.gov/', 'ws/rest/fuelprices).fuelPrices.d', 'iesel' >> 256, mem[ceil32(arg2.length) + ceil32(arg3.length) + 644]
        require ext_call.success
}
