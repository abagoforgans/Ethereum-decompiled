...
function sub_0df1b26e(?) {
    return sub_0df1b26eAddress
}
...
function endSale() {
    require msg.sender == sub_0df1b26eAddress
    stor3 = 1
}
...
function _fallback() payable {
    ...
    emit Transfer((purchaseRate * msg.value), sub_0df1b26eAddress, msg.sender);
    call sub_0df1b26eAddress with:
       value msg.value wei
