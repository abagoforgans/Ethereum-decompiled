...
function _fallback() payable {
    ...
    require ext_code.size(code.data[6742 len 20])
    call code.data[6742 len 20].0xc5f310c0 with:
         gas gas_remaining - 50 wei
        args Mask(96, 160, sha3(this.address, block.hash(block.number - 1)))
    require ext_call.success
    return code.data[217 len 6513]
}
...
function retractLatestRevision(bytes20 arg1) {
    ...
    flags[Mask(160, 96, arg1)].field_32 = uint32(flags[Mask(160, 96, arg1)].field_32 - 1)
...
function restart(bytes20 arg1, bytes arg2) {
    ...
    flags[Mask(160, 96, arg1)].field_64 = uint32(block.number)
    flags[Mask(160, 96, arg1)].field_96 = 0
    flags[Mask(160, 96, arg1)].field_256 = 0
