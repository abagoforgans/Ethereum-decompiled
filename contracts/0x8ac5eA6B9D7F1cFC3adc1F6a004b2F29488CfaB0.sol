...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0x33b0c36032535a7ffe33384894b4af979b7aab57)
    delegate 0x33b0c36032535a7ffe33384894b4af979b7aab57.0x66098d4f with:
         gas gas_remaining - 710 wei
...
function getKYCPayload(bytes arg1) {
    ...
    require ext_code.size(0xce705aaa8f9a9947e74a8311c93768706d34075e)
    delegate 0xce705aaa8f9a9947e74a8311c93768706d34075e.0xb655e138 with:
         gas gas_remaining - 710 wei
    ...
    require delegate.return_code
    require ext_code.size(0xce705aaa8f9a9947e74a8311c93768706d34075e)
    delegate 0xce705aaa8f9a9947e74a8311c93768706d34075e.0x16419aa7 with:
         gas gas_remaining - 710 wei
        args Array(len=arg1.length, data=arg1[all]), 20
    require delegate.return_code
    require ext_code.size(0xce705aaa8f9a9947e74a8311c93768706d34075e)
    delegate 0xce705aaa8f9a9947e74a8311c93768706d34075e.0xd54dd8f9 with:
         gas gas_remaining - 710 wei
