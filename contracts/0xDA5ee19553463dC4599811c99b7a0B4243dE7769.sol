...
function _fallback() payable {
    ...
    stor5 = address(stor3.field_0)
    stor1 = 1000000000 * 10^18
    stor0[address(stor3.field_0)] = 1000000000 * 10^18
    emit Transfer(1000000000 * 10^18, 0, msg.sender);
    return code.data[470 len 8918]
}
...
function changeWelcome(string arg1) {
    if owner != msg.sender:
        require msg.sender == adminAddress
    welcome[] = Array(len=arg1.length, data=arg1[all])
}
...
function batchTransfer(address[] arg1, uint256[] arg2) {
    ...
    if msg.sender == owner:
        ...
        while idx < arg1.length:
            ...
            emit Transfer(mem[(32 * arg1.length) + (32 * arg2.length) + 160], msg.sender, address(_125));
            idx = idx + 1
            continue 
    else:
        require msg.sender == adminAddress
        ...
        while idx < arg1.length:
            ...
            require idx < arg2.length
            mem[(32 * arg1.length) + (32 * arg2.length) + 160] = mem[(32 * idx) + (32 * arg1.length) + 160]
            emit Transfer(mem[(32 * arg1.length) + (32 * arg2.length) + 160], msg.sender, address(_127));
            idx = idx + 1
            continue 
    return 1
}
