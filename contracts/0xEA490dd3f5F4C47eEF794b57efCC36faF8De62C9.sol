...
function _fallback() {
    stor0 = msg.sender
    stor5 = code.data[14573 len 20]
    return code.data[112 len 14449]
}
...
function sub_d12a6b9f(?) {
    ...
    create contract with 0 wei
                    code: code.data[3953 len 7044], address(arg1), address(arg4), address(arg2), arg3, address(ext_call.return_data[0]), address(ext_call.return_data[0]), arg5, sub_d171cf41Address, sub_9ebc2b63Address, stor7, stor8
...
function sub_e4a06401(?) {
    ...
    if contractOwner != msg.sender:
        return 0
    mem[ceil32(arg2.length) + ceil32(arg3.length) + 160 len 3409] = code.data[10997 len 3409]
    mem[ceil32(arg2.length) + ceil32(arg3.length) + 3729 len ceil32(arg2.length)] = arg2[all], mem[arg2.length + 128 len ceil32(arg2.length) - arg2.length]
    if not arg2.length % 32:
        mem[arg2.length + ceil32(arg2.length) + ceil32(arg3.length) + 3729] = arg3.length
        mem[arg2.length + ceil32(arg2.length) + ceil32(arg3.length) + 3761 len ceil32(arg3.length)] = arg3[all], mem[ceil32(arg2.length) + arg3.length + 160 len ceil32(arg3.length) - arg3.length]
        if not arg3.length % 32:
            create contract with 0 wei
                            code: code.data[10997 len 3409], address(arg1), Array(len=arg4, data=arg2.length, Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], mem[arg2.length + 128 len ceil32(arg2.length) - arg2.length]) << (8 * ceil32(arg2.length)) - 256, mem[(2 * ceil32(arg2.length)) + ceil32(arg3.length) + 3729 len arg3.length + arg2.length + -ceil32(arg2.length) + 32]), arg2.length + 160
        else:
            mem[floor32(arg3.length) + arg2.length + ceil32(arg2.length) + ceil32(arg3.length) + 3761] = mem[floor32(arg3.length) + arg2.length + ceil32(arg2.length) + ceil32(arg3.length) + -(arg3.length % 32) + 3793 len arg3.length % 32]
            create contract with 0 wei
                            code: code.data[10997 len 3409], address(arg1), Array(len=arg4, data=arg2.length, Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], mem[arg2.length + 128 len ceil32(arg2.length) - arg2.length]) << (8 * ceil32(arg2.length)) - 256, mem[(2 * ceil32(arg2.length)) + ceil32(arg3.length) + 3729 len floor32(arg3.length) + arg2.length + -ceil32(arg2.length) + 64]), arg2.length + 160
    else:
        mem[floor32(arg2.length) + ceil32(arg2.length) + ceil32(arg3.length) + 3729] = mem[floor32(arg2.length) + ceil32(arg2.length) + ceil32(arg3.length) + -(arg2.length % 32) + 3761 len arg2.length % 32]
        mem[floor32(arg2.length) + ceil32(arg2.length) + ceil32(arg3.length) + 3761] = arg3.length
        mem[floor32(arg2.length) + ceil32(arg2.length) + ceil32(arg3.length) + 3793 len ceil32(arg3.length)] = arg3[all], mem[ceil32(arg2.length) + arg3.length + 160 len ceil32(arg3.length) - arg3.length]
        if not arg3.length % 32:
            create contract with 0 wei
                            code: code.data[10997 len 3409], address(arg1), Array(len=arg4, data=arg2.length, Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], mem[arg2.length + 128 len ceil32(arg2.length) - arg2.length]) << (8 * ceil32(arg2.length)) - 256, mem[(2 * ceil32(arg2.length)) + ceil32(arg3.length) + 3729 len arg3.length + floor32(arg2.length) + -ceil32(arg2.length) + 64]), floor32(arg2.length) + 192
        else:
            mem[floor32(arg3.length) + floor32(arg2.length) + ceil32(arg2.length) + ceil32(arg3.length) + 3793] = mem[floor32(arg3.length) + floor32(arg2.length) + ceil32(arg2.length) + ceil32(arg3.length) + -(arg3.length % 32) + 3825 len arg3.length % 32]
            create contract with 0 wei
                            code: code.data[10997 len 3409], address(arg1), Array(len=arg4, data=arg2.length, Mask(8 * ceil32(arg2.length), -(8 * ceil32(arg2.length)) + 256, arg2[all], mem[arg2.length + 128 len ceil32(arg2.length) - arg2.length]) << (8 * ceil32(arg2.length)) - 256, mem[(2 * ceil32(arg2.length)) + ceil32(arg3.length) + 3729 len floor32(arg3.length) + floor32(arg2.length) + -ceil32(arg2.length) + 96]), floor32(arg2.length) + 192
    require create.new_address
    sub_5eea03b3.length++
