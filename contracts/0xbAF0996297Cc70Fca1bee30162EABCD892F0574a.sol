...
function _fallback() payable {
    ...
    if uint8(stor1.field_0):
        if not stor13:
            stor7[code.data[11141 len 20]] = 1
        ...
        if not stor13:
            stor7[address(code.data[11129 len 32])] = 1
            uint8(stor8.field_0) = 1
            uint8(stor8.field_8) = 1
            stor10 = block.timestamp
            stor13 = 1
    stor14 = block.timestamp
    stor15 = block.timestamp + (240 * 24 * 3600)
    stor20 = code.data[11193 len 32]
    stor21 = code.data[11225 len 32]
    stor22 = code.data[11257 len 32]
...
function annualInterest() payable {
    if stor15 + sub_1f471849 > block.timestamp:
        ...
        if block.timestamp - createdAt / sub_f263123e <= 90:
            ...
            while idx < stor18.length:
                ...
                mem[32] = 0
                if not address(accountBalance[address(stor18[idx])].field_0):
                    if stor17[address(stor18[idx])].field_256 > 0:
                        accountBalance[address(stor18[idx])].field_768 += 100 * stor17[address(stor18[idx])].field_256 / 130
                        mem[96] = address(stor18[idx])
                        mem[128] = 100 * stor17[address(stor18[idx])].field_256 / 130
                        emit 0x1bd25a83: address(stor18[idx]), 100 * stor17[address(stor18[idx])].field_256 / 130
                    mem[0] = address(stor18[idx])
                    mem[32] = 17
                    uint8(stor17[address(stor18[idx])].field_0) = 0
                    stor17[address(stor18[idx])].field_256 = 0
                s = sha3(address(stor18[idx]), 0)
                s = address(stor18[idx])
                idx = idx + 1
                continue 
            stor18.length = 0
            idx = 0xbb8a6a4669ba250d26cd7a459eca9d215f8307e33aebe50379bc5a3617ec3444
            while stor18.length - 0x447595b99645daf2d93285ba613562dea07cf81cc5141afc8643a5c9e813cbbc > idx:
                stor[idx] = 0
                idx = idx + 1
                continue 
        else:
            if block.timestamp - createdAt / sub_f263123e <= 180:
                ...
                while idx < stor18.length:
                    ...
                    if not address(accountBalance[address(stor18[idx])].field_0):
                        if stor17[address(stor18[idx])].field_256 > 0:
                            accountBalance[address(stor18[idx])].field_768 += 100 * stor17[address(stor18[idx])].field_256 / 100
                            mem[96] = address(stor18[idx])
                            mem[128] = 100 * stor17[address(stor18[idx])].field_256 / 100
                            emit 0x1bd25a83: address(stor18[idx]), 100 * stor17[address(stor18[idx])].field_256 / 100
                        mem[0] = address(stor18[idx])
                        mem[32] = 17
                        uint8(stor17[address(stor18[idx])].field_0) = 0
                        stor17[address(stor18[idx])].field_256 = 0
                ...
                if block.timestamp - createdAt / sub_f263123e <= 270:
                    ...
                    while idx < stor18.length:
                        ...
                        if not address(accountBalance[address(stor18[idx])].field_0):
                            if stor17[address(stor18[idx])].field_256 > 0:
                                accountBalance[address(stor18[idx])].field_768 += 100 * stor17[address(stor18[idx])].field_256 / 80
                                mem[96] = address(stor18[idx])
                                mem[128] = 100 * stor17[address(stor18[idx])].field_256 / 80
                                emit 0x1bd25a83: address(stor18[idx]), 100 * stor17[address(stor18[idx])].field_256 / 80
                            mem[0] = address(stor18[idx])
                            mem[32] = 17
                            uint8(stor17[address(stor18[idx])].field_0) = 0
                            stor17[address(stor18[idx])].field_256 = 0
                    ...
                    if block.timestamp - createdAt / sub_f263123e <= 360:
                        ...
                        while idx < stor18.length:
                            ...
                            if not address(accountBalance[address(stor18[idx])].field_0):
                                if stor17[address(stor18[idx])].field_256 > 0:
                                    accountBalance[address(stor18[idx])].field_768 += 100 * stor17[address(stor18[idx])].field_256 / 50
                                    mem[96] = address(stor18[idx])
                                    mem[128] = 100 * stor17[address(stor18[idx])].field_256 / 50
                                    emit 0x1bd25a83: address(stor18[idx]), 100 * stor17[address(stor18[idx])].field_256 / 50
                                mem[0] = address(stor18[idx])
                                mem[32] = 17
                                uint8(stor17[address(stor18[idx])].field_0) = 0
                                stor17[address(stor18[idx])].field_256 = 0
                        ...
                        if block.timestamp - createdAt / sub_f263123e > 2190:
                            ...
                            while idx < stor18.length:
                                ...
                                if not address(accountBalance[address(stor18[idx])].field_0):
                                    if stor17[address(stor18[idx])].field_256 > 0:
                                        accountBalance[address(stor18[idx])].field_768 += 100 * stor17[address(stor18[idx])].field_256 / 20
                                        mem[96] = address(stor18[idx])
                                        mem[128] = 100 * stor17[address(stor18[idx])].field_256 / 20
                                        emit 0x1bd25a83: address(stor18[idx]), 100 * stor17[address(stor18[idx])].field_256 / 20
                                    mem[0] = address(stor18[idx])
                                    mem[32] = 17
                                    uint8(stor17[address(stor18[idx])].field_0) = 0
                                    stor17[address(stor18[idx])].field_256 = 0
...
function sub_2066a4fb(?) payable {
    ...
    if uint256(stor10.field_0) >= arg1:
        emit 0x5647a61b: 0, 64, 23, 'nonce is more than time'
        emit 0x3bc17f90: msg.sender
    else:
        if 0 == uint8(stor8.field_0):
            emit 0x5647a61b: 2, Array(len=26, data='holders is less or equal 1')
            emit 0x3bc17f90: msg.sender
        else:
            if stor6 != 0:
                ...
                if arg2.length / 2 < uint8(stor8.field_8):
                    emit 0x5647a61b: 4, Array(len=24, data='signRSs / 2 < signatures')
                    emit 0x3bc17f90: msg.sender
                else:
                    if arg3.length >= uint8(stor8.field_8):
                        if 0 == arg2.length:
                            emit 0x5647a61b: 4, Array(len=27, data='signRSs == 0 || signVs == 0')
                            emit 0x3bc17f90: msg.sender
                        else:
                            if 0 == arg3.length:
                                ...
                                if arg2.length > 512:
                                    ...
                                    while uint8(idx) < arg2.length:
                                        ...
                                        s = s + 1
                                        continue 
                                    if Mask(8, 1, None + 1) >> 1 < uint8(stor8.field_8):
                                        emit 0x3bc17f90: tx.origin
                                        emit 0x5647a61b: 8, Array(len=24, data='signs less than required')
                                        emit 0x3bc17f90: msg.sender
                                    else:
                                        emit 0x43fe456d 
                                        uint32(stor10.field_0) = arg1
                                        Mask(224, 0, stor10.field_32) = 0
                                        if uint8(stor11.field_8) >= uint8(stor11.field_0):
                                            if block.timestamp >= -(stor12 % 24 * 3600) + stor12 + (24 * 3600):
                                                uint8(stor11.field_0) = 0
                                            else:
                                                emit 0xee7469a7 
                                        else:
                                            uint256(stor11.field_0) = uint8(stor11.field_0) + 1 or Mask(248, 8, uint256(stor11.field_0))
                                            if not stor7[address(arg4)]:
                                                stor7[address(arg4)] = 1
                                                uint256(stor8.field_0) = Mask(248, 0, stor8.field_8)
                                ...
                                if arg2.length > 512:
                                    ...
                                    if Mask(8, 1, None + 1) >> 1 < uint8(stor8.field_8):
                                        ...
                                        if uint8(stor11.field_8) >= uint8(stor11.field_0):
                                            ...
                                            uint256(stor11.field_0) = uint8(stor11.field_0) + 1 or Mask(248, 8, uint256(stor11.field_0))
                                            if uint8(stor8.field_0) >= arg4:
                                                if arg4 != 0:
                                                    Mask(248, 0, stor8.field_8) = Mask(248, 0, arg4)
                                ...
                                if arg2.length > 512:
                                    ...
                                    if Mask(8, 1, None + 1) >> 1 < uint8(stor8.field_8):
                                        ...
                                        if uint8(stor11.field_8) >= uint8(stor11.field_0):
                                            ...
                                            uint256(stor11.field_0) = uint8(stor11.field_0) + 1 or Mask(248, 8, uint256(stor11.field_0))
                                            if stor7[address(arg4)]:
                                                if uint8(stor8.field_8) != uint8(stor8.field_0):
                                                    stor7[address(arg4)] = 0
                                                    uint256(stor8.field_0) = Mask(248, 0, stor8.field_8)
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    if arg2 / 100 * sub_2d3f945f < sub_5d8960c8:
        ...
        if transactionsCount + 1 >= sub_76c6a1a1:
            transactionsCount = 0
            idx = 0
            while uint8(idx) < stor23.length:
                require idx < stor23.length
                mem[0] = storC624[idx]
                mem[32] = 0
        ...
        if transactionsCount <= 99990:
            if not sub_10666547:
                if uint8(stor17[tx.origin].field_0):
                    if accountBalance[tx.origin].field_768 < stor17[tx.origin].field_256:
                        stor17[tx.origin].field_256 = accountBalance[tx.origin].field_768
                else:
                    stor18.length++
                    if not stor18.length <= stor18.length + 1:
                        ...
                        while stor18.length > idx:
                            ...
                            idx = idx + 1
                            continue 
                    uint256(stor18[stor18.length]) = tx.origin or Mask(96, 160, uint256(stor18[stor18.length]))
                    uint8(stor17[tx.origin].field_0) = 1
                    stor17[tx.origin].field_256 = accountBalance[tx.origin].field_768
        else:
            if arg2 <= 10:
                if not sub_10666547:
                ...
                if not stor23.length <= stor23.length + 1:
                    idx = 4 * stor23.length + 1
                    while 4 * stor23.length > idx:
                        address(stor23[idx].field_0) = 0
                        address(stor23[idx].field_256) = 0
                        stor23[idx].field_512 = 0
                        stor23[idx].field_768 = 0
                        idx = idx + 1
                        continue 
                address(stor23[stor23.length].field_0) = tx.origin
                address(stor23[stor23.length].field_256) = arg1
                stor23[stor23.length].field_512 = arg2
                stor23[stor23.length].field_768 = block.timestamp
                if not sub_10666547:
                    if uint8(stor17[tx.origin].field_0):
                        if accountBalance[tx.origin].field_768 < stor17[tx.origin].field_256:
                            stor17[tx.origin].field_256 = accountBalance[tx.origin].field_768
...
function sub_3ed48679(?) payable {
    ...
    if arg4.length >= uint8(accountBalance[address(arg1)].field_520):
        ...
        if arg6 / 100 * sub_2d3f945f < sub_5d8960c8:
            ...
            if transactionsCount <= 99990:
                if not sub_10666547:
                    if uint8(stor17[address(arg1)].field_0):
                        if accountBalance[address(arg1)].field_768 < stor17[address(arg1)].field_256:
                            stor17[address(arg1)].field_256 = accountBalance[address(arg1)].field_768
                    else:
                        stor18.length++
                        if not stor18.length <= stor18.length + 1:
                            idx = stor18.length + 1
                            while stor18.length > idx:
                                ...
                                idx = idx + 1
                                continue 
                        uint256(stor18[stor18.length]) = arg1 or Mask(96, 160, uint256(stor18[stor18.length]))
                        uint8(stor17[address(arg1)].field_0) = 1
                        stor17[address(arg1)].field_256 = accountBalance[address(arg1)].field_768
            else:
                if arg6 <= 10:
                    if not sub_10666547:
                    ...
                    if not stor23.length <= stor23.length + 1:
                        ...
                        while 4 * stor23.length > idx:
                            ...
                            idx = idx + 1
                            continue 
                    address(stor23[stor23.length].field_0) = arg1
                    address(stor23[stor23.length].field_256) = arg5
                    stor23[stor23.length].field_512 = arg6
                    stor23[stor23.length].field_768 = block.timestamp
                    if not sub_10666547:
                        if uint8(stor17[address(arg1)].field_0):
                            if accountBalance[address(arg1)].field_768 < stor17[address(arg1)].field_256:
