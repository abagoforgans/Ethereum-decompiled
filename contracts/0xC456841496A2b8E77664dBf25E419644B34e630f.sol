...
function _fallback() {
    stor3 = code.data[7236 len 32]
    stor4 = block.timestamp + code.data[7236 len 32]
    return code.data[114 len 7122]
}
...
function offer(uint256 arg1, address arg2, uint256 arg3, address arg4) {
    ...
    emit 0x36ecb4e2: last_offer_id, arg1 << 128, uint128(arg3), msg.sender, arg2, arg4
    stor0 = 0
    return last_offer_id
}
...
function make(address arg1, address arg2, uint128 arg3, uint128 arg4) {
    ...
    require ext_call.return_data[0]
    emit ItemUpdate(last_offer_id);
    emit 0x36ecb4e2: last_offer_id, arg3 << 128, arg4, msg.sender, arg1, arg2
    stor0 = 0
    return last_offer_id
}
...
function take(bytes32 arg1, uint128 arg2) {
    ...
    if arg2 * offers[arg1].field_512 / offers[arg1].field_0 != offers[arg1].field_512:
        ...
        require ext_call.success
        require ext_call.return_data[0]
        emit Trade(arg2 << 128, arg2 * offers[arg1].field_512 / offers[arg1].field_0, offers[arg1].field_256, offers[arg1].field_768);
        emit ItemUpdate(arg1);
        emit 0xaf0a607f: arg1, msg.sender, arg2 << 128, uint128(arg2 * offers[arg1].field_512 / offers[arg1].field_0), offers[arg1].field_1024, offers[arg1].field_256, offers[arg1].field_768
    else:
        if arg2 != offers[arg1].field_0:
            if arg2 * offers[arg1].field_512 / offers[arg1].field_0 <= 0:
                stor0 = 0
