...
const name = 'POLARIS COIN'

const decimals = 18

const symbol = 'POLARIS'

const INITIAL_SUPPLY = 10000000000 * 10^18

const TOKEN_OFFERING_ALLOWANCE = 4000000000 * 10^18

const ADMIN_ALLOWANCE = 6000000000 * 10^18
...
function setTokenOffering(address arg1, uint256 arg2) {
    ...
    if not arg2:
        allowance[address(msg.sender)][address(arg1)] = 4000000000 * 10^18
        emit Approval(4000000000 * 10^18, msg.sender, arg1);
    else:
        require arg2 <= 4000000000 * 10^18
        allowance[address(msg.sender)][address(arg1)] = arg2
        emit Approval(arg2, msg.sender, arg1);
