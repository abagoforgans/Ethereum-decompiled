...
function _fallback() payable {
    require block.timestamp >= 1541435430
    if msg.value > 0:
        ...
        while idx < stor0.length:
            ...
            if 115 * stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_256 / 100 <= stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_512:
                if t < s:
                    ...
                    if s <= 0:
                        ...
                        if gas_remaining > 55000:
                            s = s
                            t = 115 * stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_256 / 100
                ...
                if t < (115 * stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_256 / 100) - stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_512:
                    call stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_0 with:
                       value t wei
                         gas 2300 * is_zero(value) wei
                    if not ext_call.success:
                    ...
                    if (115 * stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_256 / 100) - stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_512 <= 0:
                        mem[32] = 1
                        sub_1c603964[stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_0] = 0
                        require currentReceiverIndex + idx < stor0.length
                        mem[0] = 0
                        ...
                        stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_512 = 0
                        if gas_remaining > 55000:
                            s = (115 * stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_256 / 100) - stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_512
                            t = 115 * stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_256 / 100
                            t = (3 * currentReceiverIndex) + (3 * idx) + sha3(0)
                            t = currentReceiverIndex + idx
                            idx = idx + 1
                        ...
                        call stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_0 with:
                           value (115 * stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_256 / 100) - stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_512 wei
                             gas 2300 * is_zero(value) wei
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        mem[32] = 1
                        ...
                        if gas_remaining > 55000:
                            ...
                            t = currentReceiverIndex + idx
                            idx = idx + 1
                            t = t - (115 * stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_256 / 100) + stor[(3 * stor2) + (3 * idx) + ('name', 'stor0', 0)].field_512
                            continue 
                    ('le', 'gas', 55000)
