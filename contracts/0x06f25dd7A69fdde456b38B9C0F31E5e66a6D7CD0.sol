...
function _fallback() {
    ...
    if not stor6.length > stor6.length + 1:
        stor6[stor6.length].field_0 = 0x928d99333c57d31db917b4c67d4d8a033f2143a7
        stor6.length++
        stor6[stor6.length].field_0 = 0x90e1e6587361dab23415b1b3208d7a3e7191ccda
        stor6.length++
    else:
        idx = stor6.length + 1
        ...
        if not stor6.length > stor6.length + 1:
            ...
            if not stor6.length <= stor6.length + 1:
                ...
                while stor6.length > idx:
                    ...
                    idx = idx + 1
                    continue 
    stor6[stor6.length].field_0 = 0xfa5ec36c4a1a85e069e357d75e0c52bb59d232b2
    if stor6.length:
    ...
    if not stor6.length:
        ...
        while (32 * stor6.length) + 128 > idx:
            ...
            idx = idx + 32
            continue 
        idx = Mask(251, 0, (32 * stor6.length) + 31) >> 5
        while stor3.length > idx:
            stor3[idx] = 0
            idx = idx + 1
            continue 
