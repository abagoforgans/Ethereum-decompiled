...
function cashBackFromProject(address arg1) {
    ...
    call projectAgentAddress.cashBackFromProject(address rg1, address rg2) with:
...
function buyProduct(address arg1, uint256 arg2) {
    ...
    require ext_code.size(projectAgentAddress)
    call projectAgentAddress.buyProduct(address rg1, address rg2, uint256 rg3) with:
         gas gas_remaining - 710 wei
...
function withdrawFromProject(address arg1, uint256 arg2) {
    require ext_code.size(projectAgentAddress)
    call projectAgentAddress.withdrawFromProject(address rg1, address rg2, uint256 rg3) with:
         gas gas_remaining - 710 wei
