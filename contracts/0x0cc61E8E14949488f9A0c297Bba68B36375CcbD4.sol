...
function multiSend(address arg1, address[] arg2, uint256[] arg3) payable {
    ...
    if arg2.length > 300:
        revert with 0, 
                    32,
                    39,
                    0xfe6e756d626572206f6620726563697069656e7473206973206c6172676572207468616e203330,
                    mem[(32 * arg2.length) + (32 * arg3.length) + 267 len 25]
    if arg2.length != arg3.length:
        revert with 0, 'parameters not match'
    idx = 0
    s = 0
    ...
    while idx < arg2.length:
        ...
        mem[(32 * arg2.length) + (32 * arg3.length) + 196] = _48
        require ext_code.size(arg1)
        call arg1.0xa9059cbb with:
             gas gas_remaining wei
            args mem[(32 * arg2.length) + (32 * arg3.length) + 164], _48
