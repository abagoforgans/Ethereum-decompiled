...
function _fallback() payable {
    ...
    mem[96 len -13383] = code.data[14879 len -13383]
    mem[64] = -13287
    require mem[96] >= block.number
    require mem[128] >= mem[96]
    require stor9 > 0
    require mem[172 len 20]
    mem[-13287 len 4896] = code.data[9983 len 4896]
    create contract with 0 wei
                    code: code.data[9983 len 4896]
    ...
    while idx < mem[mem[224] + 96]:
        ...
        call stor0.0x40c10f19 with:
             gas gas_remaining - 710 wei
            args address(mem[(32 * idx) + mem[224] + 128]), ext_call.return_data[0], code.data[10051 len 4828], mem[-8391 len -4828]
        require ext_call.success
        mem[-13287] = 0
        ...
        idx = idx + 1
        continue 
    return code.data[1496 len 8487]
}
...
function w0keAFPresaleAddress() {
    return w0keAFPresaleAddress
}
