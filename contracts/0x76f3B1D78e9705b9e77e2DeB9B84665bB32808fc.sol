        ...
        if msg.sender == returnChild[address(arg1)]:
            if numRewardsUsed[address(msg.sender)] < maxRewardUnitsAvailable:
                ...
                if block.timestamp < startTime + (48 * 24 * 3600):
                    balanceOf[address(msg.sender)] = balanceOf[address(msg.sender)] + (21701388888888888 * block.timestamp) + (-21701388888888888 * startTime) + 1250 * 10^18
                else:
