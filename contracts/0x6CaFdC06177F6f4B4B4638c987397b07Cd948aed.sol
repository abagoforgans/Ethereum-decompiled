...
function recentWins(uint256 arg1) payable {
    ...
    return address(stor[(4 * arg1) + code.data[2617 len 32]]), storF3F7[arg1], storF3F7[arg1], storF3F7[arg1]
}
    ...
    if sha3(arg1[all]) == seedHash:
        ...
        while idx < numPlayers:
            ...
            if stor8.length >= stor9:
                ...
                while s < stor9 - 1:
                    ...
                    mem[0] = 8
                    address(stor[code.data[2617 len 32] + (4 * s)]) = address(stor[code.data[2617 len 32] + (4 * s + 1)])
                    uint256(stor[code.data[2617 len 32] + (4 * s) + 1]) = uint256(stor[code.data[2617 len 32] + (4 * s + 1) + 1])
                    uint256(stor[code.data[2617 len 32] + (4 * s) + 2]) = uint256(stor[code.data[2617 len 32] + (4 * s + 1) + 2])
                    uint256(stor[code.data[2617 len 32] + (4 * s) + 3]) = uint256(stor[code.data[2617 len 32] + (4 * s + 1) + 3])
                    s = s + 1
                    continue 
            else:
                stor8.length++
            ...
            address(stor[code.data[2617 len 32] + (4 * stor8.length - 1)]) = address(stor3[idx])
            uint256(stor[code.data[2617 len 32] + (4 * stor8.length - 1) + 1]) = block.timestamp
            uint256(stor[code.data[2617 len 32] + (4 * stor8.length - 1) + 2]) = stor2[idx]
            uint256(stor[code.data[2617 len 32] + (4 * stor8.length - 1) + 3]) = eth.balance(this.address)
            numPlayers = 0
        ...
        if stor8.length >= stor9:
            ...
            while idx < stor9 - 1:
                ...
                mem[0] = 8
                address(stor[code.data[2617 len 32] + (4 * idx)]) = address(stor[code.data[2617 len 32] + (4 * idx + 1)])
                uint256(stor[code.data[2617 len 32] + (4 * idx) + 1]) = uint256(stor[code.data[2617 len 32] + (4 * idx + 1) + 1])
                uint256(stor[code.data[2617 len 32] + (4 * idx) + 2]) = uint256(stor[code.data[2617 len 32] + (4 * idx + 1) + 2])
                uint256(stor[code.data[2617 len 32] + (4 * idx) + 3]) = uint256(stor[code.data[2617 len 32] + (4 * idx + 1) + 3])
                idx = idx + 1
                continue 
        else:
            stor8.length++
        ...
        require stor8.length - 1 < stor8.length
        address(stor[code.data[2617 len 32] + (4 * stor8.length - 1)]) = address(stor3)
        uint256(stor[code.data[2617 len 32] + (4 * stor8.length - 1) + 1]) = block.timestamp
        uint256(stor[code.data[2617 len 32] + (4 * stor8.length - 1) + 2]) = stor2
        uint256(stor[code.data[2617 len 32] + (4 * stor8.length - 1) + 3]) = eth.balance(this.address)
        numPlayers = 0
        nextDraw = block.timestamp + (168 * 24 * 3600)
}
