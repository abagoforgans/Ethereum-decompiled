...
function _fallback() {
    stor4 = code.data[2524 len 20]
    stor1 = code.data[2544 len 32]
    stor5 = code.data[2588 len 20]
    stor0 = code.data[2608 len 32]
    stor2 = code.data[2640 len 32]
    stor3 = code.data[2672 len 32]
    stor54CD = msg.sender
    return code.data[208 len 2304]
}
