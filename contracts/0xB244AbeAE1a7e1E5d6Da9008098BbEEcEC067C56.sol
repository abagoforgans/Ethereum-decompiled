...
function _fallback() payable {
    mem[96 len -2610] = code.data[3128 len -2610]
    mem[64] = -2514
...
function sell(uint256 arg1) payable {
    uint255(stor8.field_0) = 10^14 * eth.balance(this.address) / totalSupply / 2
    bool(stor8.field_255) = 0
