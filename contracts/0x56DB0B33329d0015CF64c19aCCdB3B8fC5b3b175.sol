...
function sub_ea903899(?) {
    ...
    while idx < ('cd', 4).length:
        ...
        call 0x06012c8cf97bead5deae237070f9587f8e7a266d.getKitty(uint256 rg1) with:
            ...
            args uint32(cd[((32 * idx) + cd[4] + 36)])
        mem[96 len 320] = ext_call.return_data[0 len 320]
        require ext_call.success
        if not ext_call.return_data[0]:
            s = uint32(cd[((32 * idx) + cd[4] + 36)])
            idx = idx + 1
        ...
        if not ext_call.return_data[32]:
            ...
            continue 
        mem[128] = 0
        mem[100] = uint32(cd[((32 * idx) + cd[4] + 36)])
        require ext_code.size(0x6012c8cf97bead5deae237070f9587f8e7a266d)
    ...
    if s > 0:
        require ext_code.size(0x6012c8cf97bead5deae237070f9587f8e7a266d)
        call 0x06012c8cf97bead5deae237070f9587f8e7a266d.autoBirthFee() with:
             gas gas_remaining - 710 wei
        require ext_call.success
        call msg.sender with:
           value s * ext_call.return_data[0] wei
