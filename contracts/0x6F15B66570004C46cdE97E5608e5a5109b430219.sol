...
function _fallback() {
    stor0 = code.data[2693 len 20]
    return code.data[83 len 2598]
}
...
function walletBalances(address arg1, address[] arg2) {
    ...
    mem[(32 * arg2.length) + 192] = 2 * arg2.length
    s = 0
    idx = 0
    while idx < arg2.length:
        ...
        require idx < arg2.length
        _63 = mem[(32 * idx) + 128]
        mem[(98 * arg2.length) + 256] = 0
        mem[(98 * arg2.length) + 228] = arg1
        require ext_code.size(address(_63))
        call address(_63).0x70a08231 with:
             gas gas_remaining - 710 wei
            args arg1
        mem[(98 * arg2.length) + 224] = ext_call.return_data[0]
        require ext_call.success
        require idx < 2 * arg2.length
        ...
        idx = idx + 1
        continue 
    mem[(98 * arg2.length) + 224] = 32
    mem[(98 * arg2.length) + 256] = 2 * arg2.length
    mem[(98 * arg2.length) + 288 len 2 * Mask(251, 4, arg2.length)] = mem[(32 * arg2.length) + 224 len 2 * Mask(251, 4, arg2.length)]
    return memory
      from (98 * arg2.length) + 224
