...
function _fallback() payable {
    ...
    return code.data[153 len 11116]
}
    ...
    if address(stor[(8 * arg2) + (264 * arg1) + 1].field_0) == msg.sender:
        ...
        if block.number - uint256(stor[(8 * arg2) + (264 * arg1) + 5].field_0) >= 4320:
            ...
            while uint8(idx) < 20:
                ...
                if uint8(idx) != 0:
                    stor[uint256(stor[(8 * arg2) + (264 * arg1) + 4].field_0) + sha3((8 * arg2) + (264 * arg1) + 4) - 1].field_0 % 32 = (block.hash(block.number - 1) % 16^(-(2 * idx % 128) + 64)) - (block.hash(block.number - 1) % 16^(-(2 * idx % 128) + 64) % 16^(-(2 * idx % 128) + 62)) / 16^(-(2 * idx % 128) + 62) % 32
                else:
                    stor[uint256(stor[(8 * arg2) + (264 * arg1) + 4].field_0) + sha3((8 * arg2) + (264 * arg1) + 4) - 1].field_0 % 32 = block.hash(block.number - 1) - (block.hash(block.number - 1) % 16^(-(2 * idx % 128) + 62)) / 16^(-(2 * idx % 128) + 62) % 32
                stor[uint256(stor[(8 * arg2) + (264 * arg1) + 4].field_0) + sha3((8 * arg2) + (264 * arg1) + 4) - 1].field_5 % 8 = 0
                require arg1 < 33
                require arg2 < 33
                require arg1 < 33
                require arg2 < 33
