...
function claim() payable {
    ...
    call tokenAddress.0x70a08231 with:
        ...
        args this.address
    require ext_call.success
    require ext_call.return_data[0] - total_snt_claimed >= 2 * block.number - 3921016 * msg.value
    snt_claimed[address(msg.sender)] += 2 * block.number - 3921016 * msg.value
    total_snt_claimed += 2 * block.number - 3921016 * msg.value
    call stor3 with:
       value msg.value wei
