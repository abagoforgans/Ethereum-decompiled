...
function _fallback() {
    ...
    stor3.length.field_8 = 'Decenturion Classic' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        ...
        continue 
    stor4 = 18
    stor5 = 30000000 * 10^18
    stor4DB8 = 30000000 * 10^18
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  30000000 * 10^18,
    emit 0x0: 30000000 * 10^18
    emit 0x8df97264: 30000000 * 10^18
    return code.data[511 len 2900]
}
