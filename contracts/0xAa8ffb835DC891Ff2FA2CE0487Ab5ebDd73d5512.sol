...
function _fallback() {
    require code.data[7253 len 32] >= block.timestamp
    require code.data[7285 len 32] >= code.data[7253 len 32]
    require code.data[7329 len 20]
    stor1 = code.data[7329 len 20]
    create contract with 0 wei
                    code: code.data[1702 len 5551], code.data[7329 len 20]
    require create.new_address
    stor0 = address(create.new_address)
    stor2 = code.data[7253 len 32]
    stor3 = code.data[7285 len 32]
