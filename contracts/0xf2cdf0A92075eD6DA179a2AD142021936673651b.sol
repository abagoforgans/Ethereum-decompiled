...
function buyLong(address[2] arg1, uint256[5] arg2, uint8 arg3, bytes32[3] arg4) payable {
    signer = erecover(sha3(0x19457468657265756d205369676e6564204d6573736167, sha3(address(arg1), address(arg3), arg4, cd[132], cd[164], cd[196])), cd[228] << 248, cd[292], cd[324]) 
    require erecover.result
    require address(signer) == address(arg2)
    ...
    returnBalance[address(arg2)][cd[260]][4][msg.sender].field_0 = returnBalance[address(arg2)][cd[260]][4][address(arg1)].field_0
    returnBalance[address(arg2)][cd[260]][4][address(arg1)].field_0 = 0
    emit LongBought(call.data[4 len 64], call.data[68 len 160], cd[228] << 248, call.data[260 len 96], arg3);
}
...
function placeLong(address[2] arg1, uint256[8] arg2, uint8 arg3, bytes32[2] arg4) payable {
    ...
    require address(signer) == address(arg2)
    require block.number <= cd[132]
    require cd[228] == returnBalance[address(arg2)][sha3(address(arg1), uint64(arg2), arg3, arg4, cd[132], cd[164], cd[196], cd[228], cd[260], cd[292])].field_0
