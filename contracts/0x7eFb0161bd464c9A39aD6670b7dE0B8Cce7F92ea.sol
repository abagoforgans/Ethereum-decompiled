...
function setRegistrationFee(uint256 arg1) {
    if stor1 != msg.sender:
        if stor0 != msg.sender:
            revert with 0, 'msg sender is not the community'
    nameFee = arg1
}
...
function addGame(address arg1, string arg2) {
    ...
    call games_[stor6].receivePlayerInfo(uint256 arg1, address arg2, bytes32 arg3, uint256 arg4) with:
         gas gas_remaining wei
        args 5, storF350, storF350, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(games_[stor6])
    call games_[stor6].receivePlayerInfo(uint256 arg1, address arg2, bytes32 arg3, uint256 arg4) with:
         gas gas_remaining wei
        args 6, stor10D9, stor10D9, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require ext_code.size(games_[stor6])
    call games_[stor6].receivePlayerInfo(uint256 arg1, address arg2, bytes32 arg3, uint256 arg4) with:
         gas gas_remaining wei
        args 7, stor22E3, stor22E3, 0
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
}
                ...
                if arg2 != uint256(pIDxAddr_[address(msg.sender)]):
                    if arg3 != 1:
                        ...
                        while idx <= gID_:
                            ...
                            call games_[idx].receivePlayerInfo(uint256 arg1, address arg2, bytes32 arg3, uint256 arg4) with:
                                 gas gas_remaining wei
                                args uint256(pIDxAddr_[address(msg.sender)]), msg.sender, _1903, arg2
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            idx = idx + 1
                            continue 
                        emit onNewName(0, arg2, playerAddr[arg2].field_0, playerAddr[arg2].field_256, msg.value, block.timestamp, uint256(pIDxAddr_[address(msg.sender)]), msg.sender, _1903);
                else:
                    if arg3 != 1:
                        emit onNewName(0, 0, playerAddr[0].field_0, playerAddr[0].field_256, msg.value, block.timestamp, uint256(pIDxAddr_[address(msg.sender)]), msg.sender, mem[128]);
                    else:
                        ...
                        while idx <= gID_:
                            ...
                            call games_[idx].receivePlayerInfo(uint256 arg1, address arg2, bytes32 arg3, uint256 arg4) with:
                                 gas gas_remaining wei
                                args uint256(pIDxAddr_[address(msg.sender)]), msg.sender, _1903, 0
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
                            idx = idx + 1
                            continue 
                        emit onNewName(0, 0, playerAddr[0].field_0, playerAddr[0].field_256, msg.value, block.timestamp, uint256(pIDxAddr_[address(msg.sender)]), msg.sender, _1903);
            else:
                if arg2 == playerAddr[uint256(stor8[address(msg.sender)])].field_512:
                    if pIDxName_[mem[128]]:
                        if bool(stor11[uint256(stor8[address(msg.sender)])][mem[128]]) != 1:
                ...
                if arg2 != uint256(pIDxAddr_[address(msg.sender)]):
                    if arg3 != 1:
                        ...
                        while idx <= gID_:
                            ...
                            idx = idx + 1
                            continue 
                        emit onNewName(1, arg2, playerAddr[arg2].field_0, playerAddr[arg2].field_256, msg.value, block.timestamp, uint256(pIDxAddr_[address(msg.sender)]), msg.sender, _1903);
                else:
                    if arg3 != 1:
                        emit onNewName(1, 0, playerAddr[0].field_0, playerAddr[0].field_256, msg.value, block.timestamp, uint256(pIDxAddr_[address(msg.sender)]), msg.sender, mem[128]);
                    else:
                        ...
                        while idx <= gID_:
                            ...
                            idx = idx + 1
                            continue 
                        emit onNewName(1, 0, playerAddr[0].field_0, playerAddr[0].field_256, msg.value, block.timestamp, uint256(pIDxAddr_[address(msg.sender)]), msg.sender, _1903);
            else:
                if arg2 == playerAddr[uint256(stor8[address(msg.sender)])].field_512:
                    if pIDxName_[mem[128]]:
                        if bool(stor11[uint256(stor8[address(msg.sender)])][mem[128]]) != 1:
