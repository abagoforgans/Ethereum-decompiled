            ...
            if 31 < stor0.length:
                ...
                if not Mask(255, 1, stor0.length and (256 * not bool(stor0.length)) - 1) <= stor0.length + 1:
                    ...
                    while stor0.length + 31 / 32 > idx:
                        ...
                        continue 
                if not bool(stor0.length):
                    stor0.length = 71 * 256^(-stor0.length + 31) or !(255 * 256^(-stor0.length + 31)) and stor0.length
                else:
                    stor0[0.015625 / stor0.length and (256 * not bool(stor0.length)) - 1].field_0 = 71 * 256^(-stor0.length % 32 + 31) or !(255 * 256^(-stor0.length % 32 + 31)) and stor0[0.015625 / stor0.length and (256 * not bool(stor0.length)) - 1].field_0
            else:
        ...
        if 31 < stor0.length:
            ...
            if 31 < stor0.length:
                ...
                if not bool(stor0.length):
                    ...
                    stor0[0.015625 / stor0.length and (256 * not bool(stor0.length)) - 1].field_0 = 71 * 256^(-stor0.length % 32 + 31) or !(255 * 256^(-stor0.length % 32 + 31)) and stor0[0.015625 / stor0.length and (256 * not bool(stor0.length)) - 1].field_0
    return code.data[1128 len 1265]
}
                    ...
                    if 31 < str.length:
                        ...
                        if not Mask(255, 1, str.length and (256 * not bool(str.length)) - 1) <= str.length + 1:
                            ...
                            while str.length + 31 / 32 > idx:
                                ...
                                continue 
                        if not bool(str.length):
                            str.length = uint8((uint8(arg1 % 100) % 100) + 48) * 256^(-str.length + 31) or !(255 * 256^(-str.length + 31)) and str.length
                        else:
                            str[0.015625 / str.length and (256 * not bool(str.length)) - 1].field_0 = uint8((uint8(arg1 % 100) % 100) + 48) * 256^(-str.length % 32 + 31) or !(255 * 256^(-str.length % 32 + 31)) and str[0.015625 / str.length and (256 * not bool(str.length)) - 1].field_0
                    else:
                        if 31 >= str.length + 1:
                            str.length = Mask(255, 1, str.length and (256 * not bool(str.length)) - 1) + 2 or str.length / 2^(-(8 * str.length + 1) + 256) * 2^(-(8 * str.length + 1) + 256)
                        else:
