...
function _fallback() {
    ...
    stor3 = 0
    stor4 = 0
    stor1[0] = 0x374fd5e2a44caeacbf8dbbcd8e008d96d348ce5a
    stor2[0] = 0x4b7893ddc6f076cdfede716cd0cf2d885e5d129bdf75e71cf03ec8f50d9d852b
    return code.data[247 len 1199]
}
...
function sub_b643cf2b(?) {
    ...
    while uint8(idx) < arg1.length:
        ...
        mem[0] = v3
        mem[32] = 2
        sub_0a926786[stor3] = mem[(32 * arg1.length) + (32 * uint8(idx)) + 160]
        idx = idx + 1
        continue 
}
