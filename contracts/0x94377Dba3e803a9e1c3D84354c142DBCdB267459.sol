...
function _fallback() {
    stor0 = msg.sender
    stor1 = 12 * 10^16
    stor2[address(this.address)] = 12 * 10^16
    emit Transfer(12 * 10^16, 0, this.address);
    return code.data[148 len 3315]
}
...
const name = 'KaratBank Coin'

const decimals = 7

const symbol = 'KBC'

const INITIAL_SUPPLY = 12 * 10^16
