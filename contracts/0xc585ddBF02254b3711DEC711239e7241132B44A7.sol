...
function _fallback() payable {
    ...
    return code.data[1057 len 8794]
}
    ...
    if rate > 0:
        ...
        while uint8(idx) < 9:
            ...
            if not msg.value:
                ...
                require msg.value * rates[uint8(idx - 1)] / 10^18 <= balanceOf[stor0]
                balanceOf[stor0] -= msg.value * rates[uint8(idx - 1)] / 10^18
        ...
        if not msg.value:
            ...
            require msg.value * stor21 / 10^18 <= balanceOf[stor0]
            balanceOf[stor0] -= msg.value * stor21 / 10^18
