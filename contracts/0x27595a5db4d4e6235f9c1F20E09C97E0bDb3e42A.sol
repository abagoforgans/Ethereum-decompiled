...
function withdrawnTokens(address[] arg1, address arg2) {
    ...
    while idx < arg1.length:
        ...
        call address(_21).balanceOf(address arg1) with:
             gas gas_remaining - 710 wei
            args this.address
        ...
        if ext_call.return_data[0]:
            ...
            require ext_code.size(address(_21))
            call address(_21).transfer(address arg1, uint256 arg2) with:
                 gas gas_remaining - 710 wei
...
function distributeBonuses() {
    ...
    call bonusTokenAddress.balanceOf(address arg1) with:
         gas gas_remaining - 710 wei
        args this.address
    require ext_call.success
