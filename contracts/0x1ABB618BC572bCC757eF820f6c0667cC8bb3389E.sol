...
function _fallback() payable {
    stor0 = code.data[3415 len 32]
    stor1 = msg.sender or Mask(96, 160, stor1)
    return code.data[69 len 3346]
}
...
function getVendorName(address arg1) payable {
    return vendorName[address(arg1)]
}
...
function setVendorName(address arg1, bytes32 arg2) payable {
    call configAddress.0x24d7806c with:
         gas gas_remaining - 25050 wei
        args msg.sender
    require ext_call.success
    if ext_call.return_data[0]:
        vendorName[address(arg1)] = arg2
}
