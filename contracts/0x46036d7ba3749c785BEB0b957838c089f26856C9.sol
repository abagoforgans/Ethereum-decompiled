...
function sub_85f0e047(?) {
    ...
    call tokenRewardAddress.0xa9059cbb with:
         gas gas_remaining wei
        args 0xc98c838d075b523f94378197fedc1c814eaafcbb, 51207 * 10^18
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require sub_5627df88[0xc98c838d075b523f94378197fedc1c814eaafcbb] + 51207 * 10^18 >= sub_5627df88[0xc98c838d075b523f94378197fedc1c814eaafcbb]
    sub_5627df88[0xc98c838d075b523f94378197fedc1c814eaafcbb] += 51207 * 10^18
    require soldToken + 51207 * 10^18 >= soldToken
    soldToken += 51207 * 10^18
    require msg.sender == owner
    require ext_code.size(tokenRewardAddress)
    call tokenRewardAddress.0xa9059cbb with:
         gas gas_remaining wei
