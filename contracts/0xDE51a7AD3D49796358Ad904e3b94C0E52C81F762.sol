...
function sub_00bbb745(?) {
    ...
    if sub_9c8daade.length < 99999:
        ...
        call sub_607eff95Address.transferFrom(address arg1, address arg2, uint256 arg3) with:
        ...
        if not sub_9c8daade.length:
            ...
            call sub_607eff95Address.transferFrom(address arg1, address arg2, uint256 arg3) with:
                 gas gas_remaining wei
                args owner, msg.sender, 10^6 * arg2 * 98940 / arg1
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            emit 0xb2f7530d: block.timestamp, msg.sender, arg2, 10^6 * arg2 * 98940 / arg1, arg1, sha3(block.difficulty, block.timestamp) % 99
            return block.timestamp, msg.sender, arg2, 10^6 * arg2 * 98940 / arg1, arg1, sha3(block.difficulty, block.timestamp) % 99
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        emit 0xb2f7530d: block.timestamp, msg.sender, arg2, 10^6 * arg2 * 98940 / arg1, arg1, sha3(block.difficulty, block.timestamp, mem[192 len 32 * sub_9c8daade.length]) % 99
        return block.timestamp, 
               msg.sender,
               arg2,
               10^6 * arg2 * 98940 / arg1,
               arg1,
               sha3(block.difficulty, block.timestamp, mem[192 len 32 * sub_9c8daade.length]) % 99
    if sub_9c8daade.length <= 99999:
        require arg1 >= 1
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    emit 0xb2f7530d: block.timestamp, msg.sender, arg2, 10^6 * arg2 * 98940 / arg1, arg1, sha3(block.difficulty, block.timestamp, mem[224 len 32 * sub_9c8daade.length]) % 99
    return block.timestamp, 
           msg.sender,
           arg2,
           10^6 * arg2 * 98940 / arg1,
...
function sub_2a971e20(?) {
    ...
    if sub_9c8daade.length < 99999:
        ...
        call sub_a7c73052Address.transferFrom(address arg1, address arg2, uint256 arg3) with:
             gas gas_remaining wei
            args msg.sender, owner, 10^6 * arg2
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
