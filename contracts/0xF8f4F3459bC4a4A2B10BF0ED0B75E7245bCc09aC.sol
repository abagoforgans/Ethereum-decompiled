...
function _fallback() {
    ...
    uint8(stor3.field_160) = uint8(code.data[3635 len 32])
    uint8(stor3.field_168) = uint8(code.data[3667 len 32])
    uint8(stor3.field_176) = uint8(code.data[3699 len 32])
    uint8(stor3.field_184) = uint8(code.data[3731 len 32])
    uint64(stor3.field_192) = 0
    return code.data[412 len 3223]
}
...
function assignListingDB(address arg1) {
    ...
    sub_0c81d32c[uint8(stor3.field_0)] = arg1
}
