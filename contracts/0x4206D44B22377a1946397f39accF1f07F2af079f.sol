...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor0 = msg.sender
    stor2 = code.data[9469 len 20]
    require stor0 == msg.sender
    stor3 = code.data[9501 len 20]
    require ext_code.size(code.data[9501 len 20])
    call code.data[9501 len 20].isPricingStrategy() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require ext_call.return_data[0]
    stor5 = code.data[9533 len 20]
    require code.data[9533 len 20]
    require code.data[9553 len 32]
    stor7 = code.data[9553 len 32]
    require code.data[9585 len 32]
    stor8 = code.data[9585 len 32]
    require stor7 < code.data[9585 len 32]
    stor6 = code.data[9617 len 32]
    stor20 = code.data[9661 len 20]
    return code.data[595 len 8862]
}
...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0xccbb37565c859066b93ca6e6ba7fd4812404cd12)
    delegate 0xccbb37565c859066b93ca6e6ba7fd4812404cd12.0x66098d4f with:
         gas gas_remaining - 710 wei
...
function getKYCPayload(bytes arg1) {
    ...
    require ext_code.size(0xdaef661192d4fe4750dee8ceae01d156cd30d239)
    delegate 0xdaef661192d4fe4750dee8ceae01d156cd30d239.0xb655e138 with:
         gas gas_remaining - 710 wei
    ...
    require delegate.return_code
    require ext_code.size(0xdaef661192d4fe4750dee8ceae01d156cd30d239)
    delegate 0xdaef661192d4fe4750dee8ceae01d156cd30d239.0x16419aa7 with:
         gas gas_remaining - 710 wei
        args Array(len=arg1.length, data=arg1[all]), 20
    require delegate.return_code
    require ext_code.size(0xdaef661192d4fe4750dee8ceae01d156cd30d239)
    delegate 0xdaef661192d4fe4750dee8ceae01d156cd30d239.0xd54dd8f9 with:
         gas gas_remaining - 710 wei
