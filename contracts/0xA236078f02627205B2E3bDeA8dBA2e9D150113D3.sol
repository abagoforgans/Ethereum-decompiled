...
function sub_a9a75e28(?) payable {
    ...
    while idx < arg1.length:
        ...
        while s < sub_a5b70192[mem[(32 * idx) + 128]]:
            ...
            mem[32] = 4
            if var62006 >= sub_ad33e07a[stor5[mem[(32 * idx) + 128]][s]]:
                s = s + 1
                continue 
            require idx < arg1.length
            require var66008 < 1024
            mem[(32 * var68001) + (32 * arg1.length) + 32896] = var68003
            require s < stor[_81]
            require var70008 + 1 < 1024
            mem[(32 * var72001) + (32 * arg1.length) + 32896] = var72003
            require s < stor[_81]
            require var74006 < sub_ad33e07a[stor[s + sha3(_81)]]
            require var76008 + 2 < 1024
            mem[(32 * var78001) + (32 * arg1.length) + 32896] = var78003
            require idx < arg1.length
            require s < sub_a5b70192[mem[(32 * idx) + 128]]
            require var82010 + 3 < 1024
            mem[(32 * var84001) + (32 * arg1.length) + 32896] = var84003
            require idx < arg1.length
            require s < sub_a5b70192[mem[(32 * idx) + 128]]
...
function sub_017c2db9(?) payable {
    ...
    while idx < arg1.length:
        ...
        mem[0] = mem[(32 * idx) + 128]
        mem[32] = 3
        if uint8(var22005) > uint8(events[mem[(32 * idx) + 128]].field_8):
            s = var22005
            idx = idx + 1
        ...
        mem[(32 * var28001) + (32 * arg1.length) + 32896] = var28003
        require idx < arg1.length
        mem[0] = mem[(32 * idx) + 128]
        mem[32] = 3
        if uint8(var32005) > uint8(events[mem[(32 * idx) + 128]].field_8):
            s = var32005
            idx = idx + 1
        ...
        mem[(32 * var38001) + (32 * arg1.length) + 32896] = var38003
        require idx < arg1.length
        mem[0] = mem[(32 * idx) + 128]
        mem[32] = 3
        if uint8(var42005) > uint8(events[mem[(32 * idx) + 128]].field_8):
            s = var42005
            idx = idx + 1
