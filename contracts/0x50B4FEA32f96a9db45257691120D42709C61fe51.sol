    ...
    if arg2:
        ...
        if ext_call.return_data[31 len 1] == 18:
            ...
            if 17 == ext_call.return_data[31 len 1]:
                require 10^6 * (10 * 10^6 * arg5 / 10^17) + 5 / 10 * (10 * 10^6 * arg4 / 10^18) + 5 / 10 == msg.value
            else:
                if 16 == ext_call.return_data[31 len 1]:
                    require 10^6 * (10 * 10^6 * arg5 / 10^16) + 5 / 10 * (10 * 10^6 * arg4 / 10^18) + 5 / 10 == msg.value
                else:
                    if 15 == ext_call.return_data[31 len 1]:
                        require 10^6 * (10 * 10^6 * arg5 / 10^15) + 5 / 10 * (10 * 10^6 * arg4 / 10^18) + 5 / 10 == msg.value
                    else:
                        if 14 == ext_call.return_data[31 len 1]:
                            require 10^6 * (10 * 10^6 * arg5 / 10^14) + 5 / 10 * (10 * 10^6 * arg4 / 10^18) + 5 / 10 == msg.value
                        else:
                            if 13 == ext_call.return_data[31 len 1]:
                                require 10^6 * (10 * 10^6 * arg5 / 10^13) + 5 / 10 * (10 * 10^6 * arg4 / 10^18) + 5 / 10 == msg.value
                            else:
                                require 12 == ext_call.return_data[31 len 1]
                                require 10^6 * (10 * 10^6 * arg5 / 10^12) + 5 / 10 * (10 * 10^6 * arg4 / 10^18) + 5 / 10 == msg.value
