...
function _fallback() payable {
    ...
    stor0 = msg.sender
    return code.data[149 len 23649]
}
...
function sub_3cdc685e(?) {
    ...
    if sub_267a8da0[address(msg.sender)].field_768 != 2:
        return (sub_267a8da0[address(msg.sender)].field_768 == 2)
    ...
    if not Mask(6, 2, mem[(32 * sub_267a8da0[address(msg.sender)].field_512) + 576]):
        if not Mask(6, 2, mem[(32 * sub_267a8da0[address(msg.sender)].field_512) + 544]):
            return 1
        if uint8(mem[(32 * sub_267a8da0[address(msg.sender)].field_512) + 544]) / 4 == 11:
            return 1
        if uint8(mem[(32 * sub_267a8da0[address(msg.sender)].field_512) + 544]) / 4 == 12:
            return 1
        ...
        if uint8(mem[(32 * sub_267a8da0[address(msg.sender)].field_512) + 576]) / 4 == 11:
            if not Mask(6, 2, mem[(32 * sub_267a8da0[address(msg.sender)].field_512) + 544]):
                return 1
            if uint8(mem[(32 * sub_267a8da0[address(msg.sender)].field_512) + 544]) / 4 == 11:
                return 1
            ...
            if uint8(mem[(32 * sub_267a8da0[address(msg.sender)].field_512) + 576]) / 4 == 12:
                if not Mask(6, 2, mem[(32 * sub_267a8da0[address(msg.sender)].field_512) + 544]):
                    return 1
                if uint8(mem[(32 * sub_267a8da0[address(msg.sender)].field_512) + 544]) / 4 == 11:
                    return 1
...
function sub_0062a7fa(?) {
    ...
    return (sub_a8ea097f[address(msg.sender)].field_768 == 2)
}
