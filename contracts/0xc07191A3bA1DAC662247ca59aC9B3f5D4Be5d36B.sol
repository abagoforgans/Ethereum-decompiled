...
function sub_75f6dc55(?) payable {
    ...
    return ('smod', ('sha3', ('data', ('blockhash', ('add', -1, 'number')), 'msg.sender', 'difficulty', ('param', 'arg1'))), 2)
}
...
function sub_100c51b7(?) payable {
    ...
    while idx <= cd[4]:
        ...
        mem[mem[(32 * idx) + 128] + (32 * var80005) + 32] = ('smod', ('sha3', ('mem', ('range', ('add', 32, ('var', '_243')), ('mem', ('range', ('var', '_243'), 32))))), 2) - 1
        ...
        if var117003 <= mem[(32 * idx - 1) + 128]:
            ...
            mem[mem[(32 * var80005) + mem[(32 * idx) + 128] + 32] + (32 * var121003) + 32] = ('smod', ('sha3', ('data', ('blockhash', ('add', -1, 'number')), 'msg.sender', 'difficulty', 'timestamp')), 2)
            require idx - 1 < mem[96]
            ...
            while s + 1 <= _328:
                ...
                mem[mem[(32 * var80005) + mem[(32 * idx) + 128] + 32] + (32 * s + 1) + 32] = ('smod', ('sha3', ('mem', ('range', ('add', 180, ('var', '_242')), ('mem', ('range', ('add', 148, ('var', '_242')), 32))))), 2)
                require idx - 1 < mem[96]
                _328 = mem[(32 * idx - 1) + 128]
                s = s + 1
                continue 
...
function sub_2bbfe7b3(?) payable {
    ...
    while idx < cd[(cd[68] + ('cd', 68)[1] + 4)]:
        ...
        mem[_588] = cd[(cd[68] + ('cd', 68)[1] + cd[s] + 36)]
    ...
    while idx < cd[(cd[68] + ('cd', 68)[2] + 4)]:
        ...
        mem[_733] = cd[(cd[68] + ('cd', 68)[2] + cd[s] + 36)]
        u = 0
        ...
        while u < cd[(cd[68] + ('cd', 68)[2] + cd[s] + 36)]:
            ...
            mem[_884] = cd[(cd[68] + ('cd', 68)[2] + cd[s] + cd[v] + 68)]
