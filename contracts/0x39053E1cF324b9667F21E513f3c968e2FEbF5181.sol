...
function onceSetOwners() {
    return onceSetOwners
}
...
function setInitAttr(address[] arg1, uint256 arg2, uint256 arg3) {
    mem[128 len 32 * arg1.length] = call.data[arg1 + 36 len 32 * arg1.length]
    require arg1.length <= 50
    require arg2 <= arg1.length
    require arg2
    require arg1.length
    require onceSetOwners >= 1
