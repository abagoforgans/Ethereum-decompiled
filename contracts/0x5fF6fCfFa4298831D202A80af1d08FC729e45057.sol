...
function _fallback() payable {
    ...
    stor2.length.field_8 = 'Dosancoin' / 256
    idx = 0
    ...
    stor3.length.field_8 = 'DOSAN' / 256
    idx = 0
    ...
    address(stor7.field_8) = 0x7bcfa0482e1cf0fe34114017da38ca4e5de7127e
    stor8 = 0x7bcfa0482e1cf0fe34114017da38ca4e5de7127e
    stor9 = 0x7bcfa0482e1cf0fe34114017da38ca4e5de7127e
    stor10 = 0x7bcfa0482e1cf0fe34114017da38ca4e5de7127e
    require not msg.value
    stor1 = stor9
    if not stor5:
        stor11[address(stor7.field_0)] = 0
    else:
        require 25 * stor5 / stor5 == 25
        stor11[address(stor7.field_0)] = 25 * stor5 / 100
    if not stor5:
        stor11[stor8] = 0
    else:
        require 55 * stor5 / stor5 == 55
        stor11[stor8] = 55 * stor5 / 100
    if not stor5:
        stor11[stor9] = 0
    else:
        require 10 * stor5 / stor5 == 10
        stor11[stor9] = 10 * stor5 / 100
    if not stor5:
        stor11[stor10] = 0
    else:
        require 10 * stor5 / stor5 == 10
        stor11[stor10] = 10 * stor5 / 100
    return code.data[893 len 9558]
}
...
const AAcontributors = 32, 23, 0x82afe383aae38397e3819fe38293000000000000000000
