...
function _fallback() payable {
    ...
    stor0 = msg.sender
    stor2 = code.data[8606 len 20]
    require stor0 == msg.sender
    stor3 = code.data[8638 len 20]
    require ext_code.size(code.data[8638 len 20])
    call code.data[8638 len 20].isPricingStrategy() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    require ext_call.return_data[0]
    stor5 = code.data[8670 len 20]
    require code.data[8670 len 20]
    require code.data[8690 len 32]
    stor7 = code.data[8690 len 32]
    require code.data[8722 len 32]
    stor8 = code.data[8722 len 32]
    require stor7 < code.data[8722 len 32]
    stor6 = code.data[8754 len 32]
    stor20 = code.data[8798 len 20]
    return code.data[567 len 8027]
}
...
function loadRefund() payable {
    ...
    require msg.value
    require ext_code.size(0x95425a1ba20e7071b55e6c4851ed58469ac2dd3a)
    delegate 0x95425a1ba20e7071b55e6c4851ed58469ac2dd3a.0x66098d4f with:
         gas gas_remaining - 710 wei
...
function getKYCPayload(bytes arg1) {
    ...
    require ext_code.size(0x13e7ba62d76b14aa5c6f5bf6bccbec29d2c250b6)
    delegate 0x13e7ba62d76b14aa5c6f5bf6bccbec29d2c250b6.0xb655e138 with:
         gas gas_remaining - 710 wei
    ...
    require delegate.return_code
    require ext_code.size(0x13e7ba62d76b14aa5c6f5bf6bccbec29d2c250b6)
    delegate 0x13e7ba62d76b14aa5c6f5bf6bccbec29d2c250b6.0x16419aa7 with:
         gas gas_remaining - 710 wei
        args Array(len=arg1.length, data=arg1[all]), 20
    require delegate.return_code
    require ext_code.size(0x13e7ba62d76b14aa5c6f5bf6bccbec29d2c250b6)
    delegate 0x13e7ba62d76b14aa5c6f5bf6bccbec29d2c250b6.0xd54dd8f9 with:
         gas gas_remaining - 710 wei
