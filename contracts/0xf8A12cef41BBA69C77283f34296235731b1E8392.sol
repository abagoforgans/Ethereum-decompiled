...
function getSubscriptionHash(address arg1, address arg2, address arg3, uint256 arg4, uint256 arg5, uint256 arg6, uint256 arg7) {
    if requiredToAddress:
        if arg2 != requiredToAddress:
            revert with 0, 'requiredToAddress Failure'
    if requiredTokenAddress:
        if arg3 != requiredTokenAddress:
            revert with 0, 'requiredTokenAddress Failure'
    if requiredTokenAmount:
        if arg4 != requiredTokenAmount:
            revert with 0, 'requiredTokenAmount Failure'
    if requiredPeriodSeconds:
        if arg5 != requiredPeriodSeconds:
            revert with 0, 'requiredPeriodSeconds Failure'
    if requiredGasPrice:
        if arg6 != requiredGasPrice:
            revert with 0, 'requiredGasPrice Failure'
    mem[466] = uint32(arg6), 0, 0, Mask(96, 64, this.address) >> 64 or Mask(112, 144, mem[466])
    return sha3(0, 0, this.address, arg1, arg2, arg3, arg4, arg5, Mask(112, 144, arg6) >> 144 >> 1024, mem[466 len 18])
}
