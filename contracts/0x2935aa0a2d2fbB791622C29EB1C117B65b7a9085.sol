...
function getEventHashes(uint256[256] arg1) payable {
    mem[96 len 8192] = call.data[4 len 8192]
    mem[8288] = 0
    mem[8320 len 32736] = 0
    mem[41056] = 0
    mem[41088 len 32736] = 0
    s = 0
    idx = 0
    s = 0
    while idx < 256:
        ...
        mem[0] = mem[(32 * idx) + 96]
        mem[32] = 5
        _12 = sha3(mem[(32 * idx) + 96], 5)
        require s < 1024
        mem[(32 * s) + 41056] = mem[(32 * idx) + 96]
        require s + 1 < 1024
        mem[(32 * s + 1) + 41056] = stor[_12]
        t = 0
        while t < stor[_12]:
            mem[0] = _12
            require t + s + 2 < 1024
            mem[(32 * t + s + 2) + 41056] = stor[sha3(_12) + t]
            t = t + 1
            continue 
        s = _12
        idx = idx + 1
...
function sub_34b88204(?) payable {
    ...
    while uint8(idx) <= arg3:
        mem[0] = uint8(idx)
        mem[32] = sha3(arg1, 2) + 3
        mem[164] = call.data[132] - sub_d5d902e8[arg1][3][idx << 248].field_0 / sub_d5d902e8[arg1].field_512 / 10000 * arg2
        call stor1.e_exp(uint256 rg1) with:
             gas gas_remaining - 25050 wei
            args (call.data[132] - sub_d5d902e8[arg1][3][idx << 248].field_0 / sub_d5d902e8[arg1].field_512 / 10000 * arg2)
...
function calcCostsSelling(uint256 arg1, uint8 arg2, uint8 arg3, uint256 arg4) payable {
    ...
    while uint8(s) <= arg2:
        mem[0] = uint8(s)
        mem[32] = sha3(arg1, 2) + 3
        mem[292] = mem[256] - sub_d5d902e8[arg1][3][s << 248].field_0 / sub_d5d902e8[arg1].field_512 / 10000 * ext_call.return_data[0] / 10000
        call stor1.e_exp(uint256 rg1) with:
             gas gas_remaining - 25050 wei
            args (mem[256] - sub_d5d902e8[arg1][3][s << 248].field_0 / sub_d5d902e8[arg1].field_512 / 10000 * ext_call.return_data[0] / 10000)
    ...
    while uint8(idx) <= arg2:
        mem[0] = uint8(idx)
        mem[32] = sha3(arg1, 2) + 3
        mem[292] = mem[256] - sub_d5d902e8[arg1][3][idx << 248].field_0 / sub_d5d902e8[arg1].field_512 / 10000 * ext_call.return_data[0] / 10000
        call stor1.e_exp(uint256 rg1) with:
             gas gas_remaining - 25050 wei
            args (mem[256] - sub_d5d902e8[arg1][3][idx << 248].field_0 / sub_d5d902e8[arg1].field_512 / 10000 * ext_call.return_data[0] / 10000)
        mem[288] = ext_call.return_data[0]
        require ext_call.success
        idx = idx + 1
        s = s + ext_call.return_data[0]
