...
function _fallback() {
    ...
    if not stor3.length <= stor3.length + 1:
        ...
        while stor3.length > idx:
            ...
            idx = idx + 1
            continue 
    address(stor3[stor3.length]) = 0
    return code.data[252 len 6805]
}
...
function sub_ee98950a(?) {
    ...
    require ext_call.success
    return address(sub_49120cfe[arg1]), 96, ext_call.return_data[0], 0
}
...
function order(address arg1, uint256 arg2, address arg3, uint256 arg4, uint256 arg5, uint256 arg6) {
    require owner == msg.sender
    require ext_code.size(stor0)
    call stor0.order(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6) with:
         gas gas_remaining - 50 wei
...
function sub_66fe732a(?) {
    ...
    if not stor4[address(arg1)]:
        if arg1:
            ...
            stor4[address(arg1)] = sub_49120cfe.length + 1
}
...
function sub_0827a357(?) {
    ...
    call stor0.0x6c86888b with:
         gas gas_remaining - 50 wei
        args 0, 0, uint32(stor6), sub_3acace3fAddress, sub_01a154ac, sub_c5c19c2f, sub_332fd165, sub_b9a2cd10Address, stor11, sub_7ec3682b, sub_fc104447, arg11, this.address
    require ext_call.success
    require ext_call.return_data[0]
    require ext_code.size(stor0)
    call stor0.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
         gas gas_remaining - 50 wei
        args 0, 0, uint32(stor6), sub_3acace3fAddress, sub_01a154ac, sub_c5c19c2f, sub_332fd165, sub_b9a2cd10Address, stor11, sub_7ec3682b, sub_fc104447, arg11
    require ext_call.success
}
