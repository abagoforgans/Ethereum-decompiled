...
function sub_87982ac3(?) {
    require arg2 < sub_87982ac3[arg1].field_0
    return sub_87982ac3[arg1][arg2].field_0
}
...
function sub_a3674633(?) {
    return sub_846c4c37[address(arg1)], sub_4a7f6f2f[address(arg1)]
}
...
function sub_49598c3a(?) {
    if not sub_87982ac3[address(arg1)].field_0:
        mem[(32 * sub_87982ac3[address(arg1)].field_0) + 128] = 32
        mem[(32 * sub_87982ac3[address(arg1)].field_0) + 160] = sub_87982ac3[address(arg1)].field_0
        mem[(32 * sub_87982ac3[address(arg1)].field_0) + 192 len floor32(sub_87982ac3[address(arg1)].field_0)] = mem[128 len floor32(sub_87982ac3[address(arg1)].field_0)]
        return memory
          from (32 * sub_87982ac3[address(arg1)].field_0) + 128
           len (96 * sub_87982ac3[address(arg1)].field_0) + 64
    mem[128] = sub_87982ac3[address(arg1)].field_0
    idx = 128
    s = 0
    while (32 * sub_87982ac3[address(arg1)].field_0) + 96 > idx:
        mem[idx + 32] = sub_87982ac3[address(arg1)][s].field_256
        idx = idx + 32
        s = s + 1
        continue 
    mem[(32 * sub_87982ac3[address(arg1)].field_0) + 192 len floor32(sub_87982ac3[address(arg1)].field_0)] = mem[128 len floor32(sub_87982ac3[address(arg1)].field_0)]
    return Array(len=sub_87982ac3[address(arg1)].field_0, data=mem[128 len floor32(sub_87982ac3[address(arg1)].field_0)], mem[(32 * sub_87982ac3[address(arg1)].field_0) + floor32(sub_87982ac3[address(arg1)].field_0) + 192 len (32 * sub_87982ac3[address(arg1)].field_0) - floor32(sub_87982ac3[address(arg1)].field_0)]), 
}

function sub_6e8fa2a8(?) payable {
    if ('cd', 4).length < 4:
        revert with 0, 'Ref link should be of length [4,8]'
    if ('cd', 4).length > 8:
        revert with 0, 'Ref link should be of length [4,8]'
    if sub_c97d230f != msg.value:
        revert with 0, 'Setting referral link costs 0.1 ETH.'
    if stor31[address(msg.sender)]:
        revert with 0, 'You have already generated your ref link.'
    mem[ceil32(('cd', 4).length) + 160 len ('cd', 4).length] = call.data[cd[4] + 36 len ('cd', 4).length]
    if bool(stor37[Mask(128, 128, mem[ceil32(('cd', 4).length) + 160])]) == 1:
        revert with 0, 'This referral link already exists, try different one.'
    stor31[address(msg.sender)] = 1
    sub_5bfcdb27[address(msg.sender)] = (2 * ('cd', 4).length) + 1
    s = 0
    idx = cd[4] + 36
    while cd[4] + ('cd', 4).length + 36 > idx:
        sub_5bfcdb27[address(msg.sender)][s] = cd[idx]
        s = s + 1
        idx = idx + 32
        continue 
    idx = Mask(251, 0, ('cd', 4).length + 31) >> 5
    while sub_5bfcdb27[address(msg.sender)].length + 31 / 32 > idx:
        sub_5bfcdb27[address(msg.sender)][idx] = 0
        idx = idx + 1
        continue 
    stor37[Mask(128, 128, mem[ceil32(('cd', 4).length) + 160])] = 1
    sub_099b81ce[Mask(128, 128, mem[ceil32(('cd', 4).length) + 160])] = msg.sender
}
