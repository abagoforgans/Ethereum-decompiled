...
const _fallback = code.data[19 len 11526]
...
function getAvatarCount(address arg1) payable {
    return uint256(parentCount[address(arg1)].field_1536)
}
...
function getUriCount(address arg1) payable {
...
function sub_de56a544(?) payable {
    ...
    emit code.data[11494 len 32]: msg.sender
}
...
function deleteUri(uint256 arg1) payable {
...
function deleteAvatar(uint256 arg1) payable {
    require arg1 < uint256(parentCount[address(msg.sender)].field_1536)
    uint256(stor[arg1 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0)))].field_0) = 0
    idx = 0
    while uint256(stor[arg1 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0)))].field_0) + 31 / 32 > idx:
        uint256(stor[idx + sha3(arg1 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))))].field_0) = 0
        idx = idx + 1
        continue 
    emit code.data[11494 len 32]: msg.sender
}
...
function deleteAllUris() payable {
...
function deleteAllAvatars() payable {
    ...
    idx = 0
    while sha3(sha3(address(msg.sender), 0) + 6) + uint256(parentCount[address(msg.sender)].field_1536) > idx + sha3(mem[0]):
        uint256(stor[idx + sha3(mem[0])]) = 0
        mem[0] = idx + sha3(mem[0])
        s = sha3(s + sha3(mem[0]))
        while sha3(s + sha3(mem[0])) + (uint256(stor[s + sha3(mem[0])]) + 31 / 32) > s + sha3(mem[0]):
...
function sub_06e89f63(?) payable {
    if uint256(parentCount[address(arg1)].field_1280):
        mem[160] = uint256(parentCount[address(arg1)][5].field_0) / 256^0 << 232
        idx = 160
        s = 0
        while (32 * uint256(parentCount[address(arg1)].field_1280)) + 128 > idx:
            mem[idx + 32] = uint256(parentCount[address(arg1)][5].field_0) / 256^((-3 * s + 5 / 32) + s + (-1 * s + 5 / 32 * s) + 3) << 232
            idx = idx + 32
            s = (-3 * s + 5 / 32) + s + (-1 * s + 5 / 32 * s) + 3
            continue 
    return Array(len=uint256(parentCount[address(arg1)].field_1280), data=mem[160 len 32 * uint256(parentCount[address(arg1)].field_1280)]), 
}
...
function setFullName(string arg1) payable {
    ...
    uint256(parentCount[address(msg.sender)].field_256) = arg1.length
    if not arg1.length:
        idx = 0
        ...
        while arg1.length + 128 > idx:
            uint256(parentCount[address(msg.sender)][s + 1].field_0) = mem[idx]
            s = s + 1
            idx = idx + 32
            continue 
...
function setLocation(string arg1) payable {
    ...
    if not arg1.length:
        ...
        if arg1.length <= 0:
            ...
            uint256(parentCount[address(msg.sender)][2].field_0) = mem[128]
            s = 1
            idx = 160
            while arg1.length + 128 > idx:
...
function setForegroundColors(bytes3[] arg1) payable {
    ...
    if not arg1.length:
        idx = 0
        while uint256(parentCount[address(msg.sender)].field_768) + 9 / 10 > idx:
            parentCount[address(msg.sender)][idx + 3].field_0 % 16777216 = 0
            idx = idx + 1
            continue 
    else:
        s = 0
        ...
        while (32 * arg1.length) + 128 > idx:
            uint256(parentCount[address(msg.sender)][3].field_0) = mem[idx len 3] * 256^s or !(16777215 * 256^s) and uint256(parentCount[address(msg.sender)][3].field_0)
            s = s + (-3 * s + 5 / 32) + (-1 * s * s + 5 / 32) + 3
            idx = idx + 32
            continue 
        idx = 3 * Mask(251, 0, (32 * arg1.length) + 31) >> 5
        s = sha3(sha3(address(msg.sender), 0) + 3)
        while idx:
            ...
            continue 
        idx = s
        while sha3(sha3(address(msg.sender), 0) + 3) + (uint256(parentCount[address(msg.sender)].field_768) + 9 / 10) > idx:
            stor[idx] % 16777216 = 0
            idx = idx + 1
            continue 
    emit code.data[11494 len 32]: msg.sender
...
function getAvatar(address arg1, uint256 arg2) payable {
    require arg2 < uint256(parentCount[address(arg1)].field_1536)
    if uint256(stor[arg2 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'parentCount', 0)))].field_0):
        mem[160] = uint256(stor[sha3(arg2 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'parentCount', 0))))].field_0)
        if uint256(stor[arg2 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'parentCount', 0)))].field_0) + 32 > 64:
            mem[192] = uint256(stor[sha3(arg2 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'parentCount', 0))))].field_256)
            idx = 192
            s = 1
            while uint256(stor[arg2 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'parentCount', 0)))].field_0) + 128 > idx:
                mem[idx + 32] = uint256(stor[s + sha3(arg2 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'parentCount', 0))))].field_256)
                idx = idx + 32
                s = s + 1
                continue 
    return Array(len=uint256(stor[arg2 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'parentCount', 0)))].field_0), data=mem[160 len uint256(stor[arg2 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'parentCount', 0)))].field_0)]), 
}
...
function getUri(address arg1, uint256 arg2) payable {
...
function deleteBio(bytes3 arg1) payable {
    idx = 0
    while idx < uint256(parentCount[address(msg.sender)].field_1280):
        mem[0] = sha3(address(msg.sender), 0) + 5
        if uint256(stor[('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))) + (idx / 10)].field_0) / 256^(3 * idx % 10) << 232 != arg1:
            idx = idx + 1
            continue 
        require idx < uint256(parentCount[address(msg.sender)].field_1280)
        uint256(stor[('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))) + (idx / 10)].field_0) = !(16777215 * 256^(3 * idx % 10)) and uint256(stor[('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))) + (idx / 10)].field_0)
...
function setBackgroundColors(bytes3[] arg1) payable {
    ...
    if not arg1.length:
        ...
        if 32 * arg1.length <= 0:
            ...
            parentCount[address(msg.sender)][4].field_0 % 16777216 = mem[128 len 3]
            s = 3
            idx = 160
            while (32 * arg1.length) + 128 > idx:
...
function deleteAllBioTranslations() payable {
    ...
    while idx < uint256(parentCount[address(msg.sender)].field_1280):
        ...
        uint256(parentCount[address(msg.sender)][13][uint256(stor[('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))) + (idx / 10)].field_0) / 256^(3 * idx % 10) << 232].field_0) = 0
        mem[0] = sha3(uint256(stor[('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))) + (idx / 10)].field_0) / 256^(3 * idx % 10) << 232, sha3(address(msg.sender), 0) + 13)
        s = sha3(sha3(uint256(stor[('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))) + (s / 10)].field_0) / 256^(3 * s % 10) << 232, sha3(address(msg.sender), 0) + 13))
        while sha3(sha3(uint256(stor[('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))) + (s / 10)].field_0) / 256^(3 * s % 10) << 232, sha3(address(msg.sender), 0) + 13)) + (uint256(parentCount[address(msg.sender)][13][uint256(stor[('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))) + (s / 10)].field_0) / 256^(3 * s % 10) << 232].field_0) + 31 / 32) > s:
            uint256(stor[s]) = 0
            s = s + 1
            continue 
        s = sha3(sha3(uint256(stor[('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))) + (s / 10)].field_0) / 256^(3 * s % 10) << 232, sha3(address(msg.sender), 0) + 13)) + (uint256(parentCount[address(msg.sender)][13][uint256(stor[('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))) + (s / 10)].field_0) / 256^(3 * s % 10) << 232].field_0) + 31 / 32) + 1
        continue 
...
function setAvatar(uint256 arg1, bytes arg2) payable {
    ...
    if uint256(parentCount[address(msg.sender)].field_1536) <= arg1:
        uint256(parentCount[address(msg.sender)].field_1536) = arg1 + 1
        if not uint256(parentCount[address(msg.sender)].field_1536) <= arg1 + 1:
            mem[0] = sha3(address(msg.sender), 0) + 6
            idx = arg1 + 1
            while sha3(sha3(address(msg.sender), 0) + 6) + uint256(parentCount[address(msg.sender)].field_1536) > idx + sha3(mem[0]):
                uint256(stor[idx + sha3(mem[0])]) = 0
                ...
                continue 
    require arg1 < uint256(parentCount[address(msg.sender)].field_1536)
    uint256(stor[arg1 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0)))].field_0) = arg2.length
    if not arg2.length:
        idx = 0
        while uint256(stor[arg1 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0)))].field_0) + 31 / 32 > idx:
            uint256(stor[idx + sha3(arg1 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))))].field_0) = 0
        ...
        while arg2.length + 128 > idx:
            uint256(stor[s + sha3(arg1 + ('array', 6, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))))].field_0) = mem[idx]
            s = s + 1
            idx = idx + 32
            continue 
...
function deleteEntireGlofile() payable {
    parentCount[address(msg.sender)].field_0 % 16777216 = 0
...
function setBio(bytes3 arg1, bytes arg2) payable {
    ...
    while idx < uint256(parentCount[address(msg.sender)].field_1280):
        ...
        if uint256(stor[('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))) + (idx / 10)].field_0) / 256^(3 * idx % 10) << 232 != arg1:
            idx = idx + 1
            continue 
        if idx == uint256(parentCount[address(msg.sender)].field_1280):
            idx = 0
            while idx < uint256(parentCount[address(msg.sender)].field_1280):
                mem[0] = sha3(address(msg.sender), 0) + 5
                if stor[('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0))) + (idx / 10)].field_8 * 3 * idx % 10 % 16777216:
                    idx = idx + 1
                    continue 
                if idx == uint256(parentCount[address(msg.sender)].field_1280):
                    uint256(parentCount[address(msg.sender)].field_1280)++
                    if not uint256(parentCount[address(msg.sender)].field_1280) <= uint256(parentCount[address(msg.sender)].field_1280) + 1:
                        s = sha3(sha3(address(msg.sender), 0) + 5) + (uint256(parentCount[address(msg.sender)].field_1280) + 10 / 10)
                        while sha3(sha3(address(msg.sender), 0) + 5) + (uint256(parentCount[address(msg.sender)].field_1280) + 9 / 10) > s:
                            uint256(stor[s]) = 0
                            s = s + 1
                            continue 
                require idx < uint256(parentCount[address(msg.sender)].field_1280)
                uint256(stor[(idx / 10) + ('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0)))].field_0) = Mask(24, 232, arg1) >> 232 * 256^(3 * idx % 10) or !(16777215 * 256^(3 * idx % 10)) and uint256(stor[(idx / 10) + ('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0)))].field_0)
    ...
    if idx == uint256(parentCount[address(msg.sender)].field_1280):
        ...
        if idx == uint256(parentCount[address(msg.sender)].field_1280):
            uint256(parentCount[address(msg.sender)].field_1280)++
            if not uint256(parentCount[address(msg.sender)].field_1280) <= uint256(parentCount[address(msg.sender)].field_1280) + 1:
                s = uint256(parentCount[address(msg.sender)].field_1280) + 10 / 10
                while uint256(parentCount[address(msg.sender)].field_1280) + 9 / 10 > s:
                    uint256(parentCount[address(msg.sender)][s + 5].field_0) = 0
                    s = s + 1
                    continue 
        require idx < uint256(parentCount[address(msg.sender)].field_1280)
        uint256(stor[(idx / 10) + ('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0)))].field_0) = Mask(24, 232, arg1) >> 232 * 256^(3 * idx % 10) or !(16777215 * 256^(3 * idx % 10)) and uint256(stor[(idx / 10) + ('array', 5, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'parentCount', 0)))].field_0)
