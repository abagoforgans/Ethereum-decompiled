...
function _fallback() payable {
    ...
    return code.data[116 len 11056]
}
            ...
            if arg2 >= 0:
                if arg2 <= uint8(stor0 - 1):
                    ...
                    if msg.sender == address(stor[(8 * arg2) + (264 * arg1) + 1].field_0):
                        ...
                        emit code.data[11024 len 32]: arg1 << 248, arg2
            ...
            if arg2 < 0:
                ...
                if arg2 > uint8(stor0 - 1):
                    ...
                    if address(stor[(8 * arg2) + (264 * arg1) + 1].field_0) != msg.sender:
                        ...
                        if block.number - uint256(stor[(8 * arg2) + (264 * arg1) + 7].field_0) >= 4320:
                            idx = 0
                            while uint8(idx) < 10:
                                ...
                                if uint8(idx) != 0:
                                    stor[sha3((8 * arg2) + (264 * arg1) + 6) + uint256(stor[(8 * arg2) + (264 * arg1) + 6].field_0) - 1].field_0 % 32 = (block.hash(block.number - 1) % 16^(-(2 * uint8(idx)) + 64)) - (block.hash(block.number - 1) % 16^(-(2 * uint8(idx)) + 64) % 16^(-(2 * uint8(idx)) + 62)) / 16^(-(2 * uint8(idx)) + 62) % 32
                                else:
                                    stor[sha3((8 * arg2) + (264 * arg1) + 6) + uint256(stor[(8 * arg2) + (264 * arg1) + 6].field_0) - 1].field_0 % 32 = block.hash(block.number - 1) - (block.hash(block.number - 1) % 16^(-(2 * uint8(idx)) + 62)) / 16^(-(2 * uint8(idx)) + 62) % 32
                                stor[sha3((8 * arg2) + (264 * arg1) + 6) + uint256(stor[(8 * arg2) + (264 * arg1) + 6].field_0) - 1].field_5 % 8 = 0
                                uint8(stor[uint256(stor[(8 * arg2) + (264 * arg1) + 6].field_0) + sha3((8 * arg2) + (264 * arg1) + 6) - 1].field_8) = 0
                                require uint256(stor[(8 * arg2) + (264 * arg1) + 6].field_0) - 1 < uint256(stor[(8 * arg2) + (264 * arg1) + 6].field_0)
                                uint8(stor[uint256(stor[(8 * arg2) + (264 * arg1) + 6].field_0) + sha3((8 * arg2) + (264 * arg1) + 6) - 1].field_16) = 0
                                uint8(stor[uint256(stor[(8 * arg2) + (264 * arg1) + 6].field_0) + sha3((8 * arg2) + (264 * arg1) + 6) - 1].field_24) = 255
                                mem[0] = (8 * arg2) + (264 * arg1) + 6
                                uint8(stor[uint256(stor[(8 * arg2) + (264 * arg1) + 6].field_0) + sha3((8 * arg2) + (264 * arg1) + 6) - 1].field_32) = 0
                                idx = idx + 1
                                continue 
