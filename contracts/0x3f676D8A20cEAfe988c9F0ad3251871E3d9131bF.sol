...
function _fallback() {
    stor1 = code.data[7487 len 20]
    stor0 = code.data[7455 len 20]
    return code.data[104 len 7339]
}
                ...
                if arg2.length == arg3.length:
                    if arg2.length == arg4.length:
                        ...
                        while idx < arg2.length:
                            ...
                            mem[0] = sha3(arg1, idx)
                            mem[32] = 3
                            sub_91abe6b2[arg1][idx].field_0 = mem[_52]
                            sub_91abe6b2[arg1][idx].field_256 = mem[_52 + 32]
                            sub_91abe6b2[arg1][idx].field_512 = 0
                            sub_91abe6b2[arg1][idx].field_768 = 0
                            sub_91abe6b2[arg1][idx].field_768 = mem[_52 + 96]
                            sub_91abe6b2[arg1][idx].field_1024 = 0
                            sub_91abe6b2[arg1][idx].field_1280 = uint8(bool(mem[_52 + 160]))
                            mem[0] = arg1
                            mem[32] = 2
                            sub_5fa80c12[arg1].field_256++
                            require idx < mem[(32 * arg4.length) + (32 * arg3.length) + (32 * arg2.length) + 192]
                                ...
                                if arg3.length != arg4.length:
                                    ...
                                    if arg3.length != arg5.length:
                                        ...
                                        while idx < arg3.length:
                                            ...
                                            mem[0] = sha3(arg1, idx)
                                            mem[32] = 3
                                            sub_91abe6b2[arg1][idx].field_0 = mem[_600]
                                            sub_91abe6b2[arg1][idx].field_256 = mem[_600 + 32]
                                            sub_91abe6b2[arg1][idx].field_512 = 0
                                            sub_91abe6b2[arg1][idx].field_768 = 0
                                            sub_91abe6b2[arg1][idx].field_768 = mem[_600 + 96]
                                            sub_91abe6b2[arg1][idx].field_1024 = 0
                                            sub_91abe6b2[arg1][idx].field_1280 = uint8(bool(mem[_600 + 160]))
                                            mem[0] = arg1
                                            mem[32] = 2
                                            sub_5fa80c12[arg1].field_256++
                                            require idx < mem[(32 * arg5.length) + (32 * arg4.length) + (32 * arg3.length) + ceil32(arg2.length) + 224]
