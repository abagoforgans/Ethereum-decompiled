...
function gamblerlist(uint256 arg1) payable {
    ...
    return address(stor[(2 * arg1) + code.data[1268 len 32]]), stor290D[arg1]
}
...
function enter() payable {
    if msg.value > 10^16:
        ...
        uint256(stor[code.data[1268 len 32] + (2 * stor0.length)]) = msg.sender or Mask(96, 160, uint256(stor[code.data[1268 len 32] + (2 * stor0.length)]))
        ...
        if msg.value >= minDeposit:
            ...
            if stor0.length % 40 != 0:
                if 0 == bool(sha3(address(stor[code.data[1268 len 32] + (2 * stor0.length)]))):
                    if 0 == bool(stor0.length):
                        if bankroll > 0:
                            require stor0.length < stor0.length
                            call address(stor[code.data[1268 len 32] + (2 * stor0.length)]) with:
                               value bankroll wei
                                 gas 0 wei
