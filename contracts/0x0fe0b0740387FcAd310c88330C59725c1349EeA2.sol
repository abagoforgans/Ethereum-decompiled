...
function _fallback() payable {
    mem[96 len -4735] = code.data[5079 len -4735]
    mem[64] = -4639
...
function confirmTransactionWithSignatures(bytes32 arg1, uint8[] arg2, bytes32[] arg3) {
    ...
    if s == required:
        ...
        idx = mem[64]
        s = 0
        while _140 + stor0[arg1][2].length > idx + 32:
        ...
        call address(stor0[arg1].field_0).mem[mem[64] len 4] with:
           value stor0[arg1].field_256 wei
             gas gas_remaining - 34050 wei
            args mem[mem[64] + 4 len _140 + stor0[arg1][2].length + (floor32(stor0[arg1][2].length - 1) + -stor0[arg1][2].length + 32 % 32) + -mem[64] - 4]
        require ext_call.success
        emit Execution(arg1);
}
...
function submitTransaction(address arg1, uint256 arg2, bytes arg3, uint256 arg4) {
    ...
    if address(stor0[arg1][arg2][arg3[all]][arg4].field_0) != 0:
        ...
        stor0[arg1][arg2][arg3[all]][arg4].field_0 = arg1 or Mask(96, 160, stor0[arg1][arg2][arg3[all]][arg4].field_0)
    ...
    if address(stor0[arg1][arg2][arg3[all]][arg4].field_0) != 0:
        ...
        if not stor4.length > stor4.length + 1:
            ...
            if s == required:
                ...
                idx = mem[64]
                s = 0
                while _1912 + stor0[arg1][arg2][arg3[all]][arg4][2].length > idx + 32:
                    mem[idx + 32] = stor[s + sha3(mem[0]) + 1]
                    idx = idx + 32
                    s = s + 1
                    continue 
                call address(stor0[arg1][arg2][arg3[all]][arg4].field_0).mem[mem[64] len 4] with:
                   value stor0[arg1][arg2][arg3[all]][arg4].field_256 wei
                     gas gas_remaining - 34050 wei
                    args mem[mem[64] + 4 len _1912 + stor0[arg1][arg2][arg3[all]][arg4][2].length + (floor32(stor0[arg1][arg2][arg3[all]][arg4][2].length - 1) + -stor0[arg1][arg2][arg3[all]][arg4][2].length + 32 % 32) + -mem[64] - 4]
                require ext_call.success
                emit Execution(sha3(arg1, arg2, arg3[all], arg4));
        else:
            idx = stor4.length + 1
