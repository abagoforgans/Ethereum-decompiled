...
function _fallback() {
    ...
    call 0xca83bd8c4c7b1c0409b25fbd7e70b1ef57629ff4.token() with:
         gas gas_remaining - 710 wei
    require ext_call.success
    stor4 = ext_call.return_data[12 len 20] or Mask(96, 160, stor4)
    return code.data[301 len 4159]
}
...
function moo() {
    ...
    require ext_call.success
    require ext_code.size(bntAddress)
    call bntAddress.approve(address rg1, uint256 rg2) with:
         gas gas_remaining - 710 wei
    ...
    require ext_call.return_data[0]
    require ext_code.size(bntAddress)
    call bntAddress.0x23b872dd with:
         gas gas_remaining - 710 wei
...
function closeLong() {
    ...
    call bntAddress.0x70a08231 with:
        ...
        args msg.sender
    require ext_call.success
    require ext_code.size(address(smartTokenAddress))
    call address(smartTokenAddress).approve(address rg1, uint256 rg2) with:
         gas gas_remaining - 710 wei
        args address(smartTokenAddress), 0
    require ext_call.success
    require ext_call.return_data[0]
    require ext_code.size(address(smartTokenAddress))
    call address(smartTokenAddress).approve(address rg1, uint256 rg2) with:
         gas gas_remaining - 710 wei
        args address(smartTokenAddress), ext_call.return_data[0]
    require ext_call.success
    require ext_call.return_data[0]
    require ext_code.size(address(smartTokenAddress))
    call address(smartTokenAddress).0x23b872dd with:
         gas gas_remaining - 710 wei
        args msg.sender, address(this.address), ext_call.return_data[0]
    require ext_call.success
    require ext_call.return_data[0]
    ...
    call tokenChangerAddress.change(address rg1, address rg2, uint256 rg3, uint256 rg4) with:
         gas gas_remaining - 710 wei
        args 0, uint32(stor4), address(etherTokenAddress), ext_call.return_data[0], 1
    require ext_call.success
    require ext_code.size(address(etherTokenAddress))
