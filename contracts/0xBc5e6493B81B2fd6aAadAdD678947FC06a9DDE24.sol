...
function _fallback() payable {
    mem[96 len -1416] = code.data[1627 len -1416]
    mem[64] = -1320
    stor1[] = Array(len=mem[mem[96] + 96], data=mem[mem[96] + 128 len mem[mem[96] + 96]])
    stor0 = msg.sender or Mask(96, 160, stor0)
    stor3 = 0
    return code.data[211 len 1416]
}
...
function sub_72f546a9(?) payable {
    ...
    sub_18d9adab[stor3].field_512 = arg3 or Mask(96, 160, sub_18d9adab[stor3].field_512)
    return sub_a29092ed
}
