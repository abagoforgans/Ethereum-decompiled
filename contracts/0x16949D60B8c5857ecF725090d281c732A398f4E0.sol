...
function setbounty(uint256 arg1) {
    require supplierAddress == msg.sender
    bounty = arg1
}
...
function boleno() {
    ...
    balances[address(msg.sender)] = totalSupply
}
...
function claimSale() {
    call 0xb9f1666939d9d07652f1d555873b0b7be2a759ff with:
...
function transferSupply(address arg1) {
    ...
    balances[arg1] += balances[stor1]
    balances[stor1] -= balances[stor1]
...
function _fallback() payable {
    require 1 == bool(uint8(stor4.field_0))
    require balances[stor1] >= blnpereth * msg.value
    require balances[address(msg.sender)] + (blnpereth * msg.value) >= balances[address(msg.sender)]
    balances[stor1] += -1 * blnpereth * msg.value
    balances[msg.sender] += blnpereth * msg.value
    emit Transfer((blnpereth * msg.value), supplierAddress, msg.sender);
}

function transferFrom(address arg1, address arg2, uint256 arg3) {
    if block.timestamp < 417432 * 24 * 3600:
        require supplierAddress == arg1
...
function referral(address arg1) payable {
    require 1 == bool(uint8(stor4.field_0))
    require 1 == bool(uint8(stor4.field_8))
    ...
    balances[msg.sender] = (100 * msg.value * blnpereth / 100) + (bounty * msg.value * blnpereth / 100) + balances[msg.sender]
    ...
    balances[arg1] += msg.value * blnpereth / 100 * bounty
