...
function _fallback() {
    stor0 = msg.sender
    require code.data[5062 len 20]
    require code.data[5094 len 20]
    require code.data[5114 len 32] <= code.data[5146 len 32]
    require code.data[5146 len 32] <= 10^18
    stor1 = code.data[5062 len 20]
    stor2 = code.data[5094 len 20]
    stor3 = code.data[5114 len 32]
    stor4 = code.data[5146 len 32]
    return code.data[246 len 4804]
}
