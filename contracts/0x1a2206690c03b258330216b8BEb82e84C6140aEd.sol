...
function _fallback() payable {
    ...
    Mask(248, 0, stor3.field_8) = code.data[2417 len 31]
    address(stor1.field_0) = 0x6b62228ee04f62799e722448669e1fe21f007f91
    Mask(96, 0, stor1.field_160) = Mask(96, 0, code.data[2448 len 32])
    stor1.field_256 % 1 = 0
    uint64(stor2.field_0) = uint64(code.data[2480 len 32])
    uint64(stor2.field_64) = uint64(code.data[2512 len 32])
    uint64(stor2.field_128) = uint64(code.data[2544 len 32])
    uint64(stor2.field_192) = uint64(code.data[2576 len 32])
    return code.data[293 len 2123]
}
...
function sub_e21d9b51(?) payable {
    if 0xef2be808c8cd2533f11db5f0098ce6ed65d92bb8 == msg.sender:
        status = 2
        uint256(stor2) = 1000 * block.timestamp or Mask(192, 64, uint256(stor2))
        stor4.length++
        if not stor4.length <= stor4.length + 1:
