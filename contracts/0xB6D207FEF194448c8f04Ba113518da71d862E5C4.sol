...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'Totalbit' / 256
    idx = 0
    ...
    mem[192] = 'T'
    bool(stor1.length) = 0
    stor1.length.field_1 = 1
    stor1.length.field_8 = 'T' / 256
    idx = 0
    ...
    mem[224 len -4204] = code.data[4809 len -4204]
