...
function _fallback() payable {
    ...
    while stor4.length + 31 / 32 > idx:
        ...
        continue 
    stor5 = 18
    stor6 = 500 * 10^6 * 10^18
    stor7 = 10^9 * 10^18
    stor8 = 500
    stor9 = 10
    uint8(stor10.field_160) = 1
    require not msg.value
    stor11 = code.data[7103 len 20]
    stor12 = code.data[7135 len 20]
    address(stor10.field_0) = code.data[7167 len 20]
    stor1[code.data[7199 len 20]] = stor6
    return code.data[575 len 6516]
}
