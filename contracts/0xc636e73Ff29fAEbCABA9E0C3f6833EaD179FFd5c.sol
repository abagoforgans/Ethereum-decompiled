...
function _fallback() {
    stor0 = msg.sender
    stor0 = code.data[3214 len 20]
    stor2 = code.data[3246 len 20]
    return code.data[133 len 3069]
}
...
function toCollect(uint256 arg1) {
    require contributionAddress == msg.sender
    ...
    if arg1 < curves[stor4].field_256:
        ...
        if currentIndex + 1 >= currentIndex:
            if currentIndex + 1 >= revealedCurves:
                return 0
            currentIndex++
            if currentIndex + 1 < curves.length:
                if arg1 >= curves[stor4 + 1].field_256:
                    return 0
                if currentIndex < curves.length:
                    if arg1 <= curves[stor4].field_256:
                        if currentIndex < curves.length:
...
function revealMulti(uint256[] arg1, uint256[] arg2, uint256[] arg3, bool[] arg4, bytes32[] arg5) {
    ...
    while idx < arg1.length:
        ...
        _45 = mem[(32 * idx) + (32 * arg3.length) + (32 * arg2.length) + (32 * arg1.length) + 224]
        require idx < mem[(32 * arg4.length) + (32 * arg3.length) + (32 * arg2.length) + (32 * arg1.length) + 224]
        _47 = mem[(32 * idx) + (32 * arg4.length) + (32 * arg3.length) + (32 * arg2.length) + (32 * arg1.length) + 256]
        require not stor6
