...
function _fallback() {
    stor0 = msg.sender
    stor1 = code.data[4119 len 20]
    stor2 = code.data[4139 len 32]
    stor3 = code.data[4171 len 32]
    stor4 = code.data[4203 len 32]
    stor5 = code.data[4235 len 32]
    stor6 = code.data[4267 len 32]
    return code.data[273 len 3834]
}
