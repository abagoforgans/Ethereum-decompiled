...
function proposeUpgrade(address arg1, address arg2, string arg3) payable {
    require calldata.size - 4 >= 96
    ...
    emit NewUpgradeProposal(address(arg2), Array(len=arg3.length, data=arg3[all]), arg1, ext_call.return_data[0], parameters[ext_call.return_data[0]].field_256);
...
function proposeChangeUpgradingScheme(address arg1, address arg2, bytes32 arg3, string arg4) payable {
    require calldata.size - 4 >= 128
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    require not organizationsProposals[address(arg1)][ext_call.return_data[0]].field_512
    organizationsProposals[address(arg1)][ext_call.return_data[0]].field_0 = arg2
    organizationsProposals[address(arg1)][ext_call.return_data[0]].field_256 = arg3
    organizationsProposals[address(arg1)][ext_call.return_data[0]].field_512 = 2
    emit ChangeUpgradeSchemeProposal(address(arg2), arg3, Array(len=arg4.length, data=arg4[all]), arg1, ext_call.return_data[0], parameters[ext_call.return_data[0]].field_256);
    stor0[stor2[ext_call.return_data[0]].field_256][ext_call.return_data[0]].field_0 = block.number
    stor0[stor2[ext_call.return_data[0]].field_256][ext_call.return_data[0]].field_256 = arg1
    return ext_call.return_data[0]
}
...
function executeProposal(bytes32 arg1, int256 arg2) payable {
    ...
    if not stor0[msg.sender][arg1].field_256:
        revert with 0, 32, 18, 0xfe6f6e6c7920566f74696e674d616368696e6500000000000000000000000000
    require organizationsProposals[stor0[msg.sender][arg1].field_256][arg1].field_512
    ...
    if 1 == arg2:
        ...
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        if 1 == organizationsProposals[stor0[msg.sender][arg1].field_256][arg1].field_512:
            require ext_code.size(address(ext_call.return_data[0]))
            call address(ext_call.return_data[0]).upgradeController(address arg1, address arg2) with:
                 gas gas_remaining wei
        ...
        if 2 == organizationsProposals[stor0[msg.sender][arg1].field_256][arg1].field_512:
            require ext_code.size(address(ext_call.return_data[0]))
            staticcall address(ext_call.return_data[0]).getSchemePermissions(address arg1, address arg2) with:
                    gas gas_remaining wei
            ...
            call address(ext_call.return_data[0]).registerScheme(address arg1, bytes32 arg2, bytes4 arg3, address arg4) with:
                 gas gas_remaining wei
                args organizationsProposals[stor0[msg.sender][arg1].field_256][arg1].field_0, organizationsProposals[stor0[msg.sender][arg1].field_256][arg1].field_256, Mask(32, 224, ext_call.return_data[0]), stor0[msg.sender][arg1].field_256
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 32
            require ext_call.return_data[0]
            if organizationsProposals[stor0[msg.sender][arg1].field_256][arg1].field_0 != this.address:
                require ext_code.size(address(ext_call.return_data[0]))
                call address(ext_call.return_data[0]).unregisterSelf(address arg1) with:
                     gas gas_remaining wei
                    args stor0[msg.sender][arg1].field_256
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                require ext_call.return_data[0]
