...
function _fallback() payable {
    ...
    if block.timestamp > stor7 + (24 * 3600):
        require (10^18 * msg.value / oneTokenInWei) + totalSupply >= totalSupply
        ...
        require (10^18 * msg.value / oneTokenInWei) + (5 * 10^18 * msg.value / oneTokenInWei / 100) + totalSupply >= totalSupply
        require balanceOf[stor5] >= (10^18 * msg.value / oneTokenInWei) + (5 * 10^18 * msg.value / oneTokenInWei / 100)
        balanceOf[stor5] = balanceOf[stor5] - (10^18 * msg.value / oneTokenInWei) - (5 * 10^18 * msg.value / oneTokenInWei / 100)
        balanceOf[msg.sender] = (10^18 * msg.value / oneTokenInWei) + (5 * 10^18 * msg.value / oneTokenInWei / 100) + balanceOf[msg.sender]
        call multiSigWalletAddress with:
           value msg.value wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        emit Transfer(((10^18 * msg.value / oneTokenInWei) + (5 * 10^18 * msg.value / oneTokenInWei / 100)), teamWalletAddress, msg.sender);
}
