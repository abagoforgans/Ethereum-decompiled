...
function _fallback() payable {
    ...
    if msg.value:
        ...
        if msg.value < 10^16:
            ...
            totalBonusTokensIssued += 1000 * 1000 * msg.value % 4 * msg.value * msg.value
            totalSupply = (1000 * 1000 * msg.value % 4 * msg.value * msg.value) + (1000 * msg.value) + totalSupply
            balanceOf[address(msg.sender)] = (1000 * 1000 * msg.value % 4 * msg.value * msg.value) + (1000 * msg.value) + balanceOf[address(msg.sender)]
            emit Transfer(((1000 * 1000 * msg.value % 4 * msg.value * msg.value) + (1000 * msg.value)), this.address, msg.sender);
}
