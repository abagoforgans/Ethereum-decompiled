...
function _fallback() {
    mem[96 len -6834] = code.data[7385 len -6834]
    mem[64] = -6738
    stor0 = msg.sender
    stor2.length++
...
function kill(address[] arg1) {
    ...
    require ext_call.success
    require ext_code.size(0x8d12a197cb00d4747a1fe03395095ce2a5cc68)
    call 0x008d12a197cb00d4747a1fe03395095ce2a5cc68.withdraw(uint256 rg1) with:
         gas gas_remaining - 710 wei
...
function sub_2fcb40a0(?) {
    ...
    call 0x008d12a197cb00d4747a1fe03395095ce2a5cc68.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
        ...
        args 0, arg1, uint256(sub_1880c1cd[arg2]), call.data[4 len 128], 28, call.data[132 len 96]
}

function sub_5418b460(?) {
    require (tx.origin == 0xbd1f96df54abe78d34fba23f2f4a5190c0e0b6) + (tx.origin == 0xcf4212623cc5f81025e5af515cfad847f922bc90) + (tx.origin == 0xb85054903ed866cdb1c0799286323bb789d448) + (tx.origin == 0x9b30b999c85058dcd342d7548729bcccb16b4c)
    call 0x008d12a197cb00d4747a1fe03395095ce2a5cc68.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
         gas gas_remaining wei
        args uint256(sub_1880c1cd[arg2]), arg1, 0, call.data[4 len 128], 27, call.data[132 len 96]
}

function sub_782a92b2(?) {
    require (tx.origin == 0xbd1f96df54abe78d34fba23f2f4a5190c0e0b6) + (tx.origin == 0xcf4212623cc5f81025e5af515cfad847f922bc90) + (tx.origin == 0xb85054903ed866cdb1c0799286323bb789d448) + (tx.origin == 0x9b30b999c85058dcd342d7548729bcccb16b4c)
    call 0x008d12a197cb00d4747a1fe03395095ce2a5cc68.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
         gas gas_remaining wei
        args 0, arg1, uint256(sub_1880c1cd[arg2]), call.data[4 len 128], 27, call.data[132 len 96]
}

function sub_7e7e976b(?) {
    require (tx.origin == 0xbd1f96df54abe78d34fba23f2f4a5190c0e0b6) + (tx.origin == 0xcf4212623cc5f81025e5af515cfad847f922bc90) + (tx.origin == 0xb85054903ed866cdb1c0799286323bb789d448) + (tx.origin == 0x9b30b999c85058dcd342d7548729bcccb16b4c)
    call 0x008d12a197cb00d4747a1fe03395095ce2a5cc68.trade(address rg1, uint256 rg2, address rg3, uint256 rg4, uint256 rg5, uint256 rg6, address rg7, uint8 rg8, bytes32 rg9, bytes32 rg10, uint256 rg11) with:
         gas gas_remaining wei
        args uint256(sub_1880c1cd[arg2]), arg1, 0, call.data[4 len 128], 28, call.data[132 len 96]
}
...
function sub_7464e61b(?) {
    if call.data[100] > block.number:
        staticcall 0x8d12a197cb00d4747a1fe03395095ce2a5cc68.tokens(address rg1, address rg2) with:
                gas gas_remaining wei
               args 0, arg1
        if call.data[68] * call.data[196] / call.data[36] > ext_call.return_data[0] != 1:
            hash = sha256hash(0x8d12a197cb00d4747a1fe03395095ce2a5cc68, address(sub_1880c1cd[call.data[228]]), call.data[36], 0, call.data[68], call.data[100], call.data[132]) 
            staticcall 0x8d12a197cb00d4747a1fe03395095ce2a5cc68.orderFills(address rg1, bytes32 rg2) with:
                    gas gas_remaining wei
...
function sub_e8c6b145(?) {
    if call.data[100] > block.number:
        ...
        if call.data[68] * call.data[196] / call.data[36] > ext_call.return_data[0] != 1:
            hash = sha256hash(0x8d12a197cb00d4747a1fe03395095ce2a5cc68, 0, call.data[36], address(sub_1880c1cd[call.data[228]]), call.data[68], call.data[100], call.data[132]) 
            staticcall 0x8d12a197cb00d4747a1fe03395095ce2a5cc68.orderFills(address rg1, bytes32 rg2) with:
                    gas gas_remaining wei
                   args address(arg1), hash
            if ext_call.return_data[0] > call.data[36] - call.data[196] != 1:
        ...
        if call.data[324] > block.number:
            ...
            if call.data[292] * call.data[420] / call.data[260] > ext_call.return_data[0] != 1:
                ...
                if call.data[100] * call.data[228] / call.data[68] > ext_call.return_data[0] != 1:
                    hash = sha256hash(0x8d12a197cb00d4747a1fe03395095ce2a5cc68, 0, call.data[68], address(sub_1880c1cd[call.data[452]]), call.data[100], call.data[132], call.data[164]) 
                    staticcall 0x8d12a197cb00d4747a1fe03395095ce2a5cc68.orderFills(address rg1, bytes32 rg2) with:
                            gas gas_remaining wei
                           args call.data[4], hash
                    if ext_call.return_data[0] > call.data[68] - call.data[228] != 1:
                        hash = sha256hash(0x8d12a197cb00d4747a1fe03395095ce2a5cc68, address(sub_1880c1cd[call.data[452]]), call.data[260], 0, call.data[292], call.data[324], call.data[356]) 
                        staticcall 0x8d12a197cb00d4747a1fe03395095ce2a5cc68.orderFills(address rg1, bytes32 rg2) with:
                                gas gas_remaining wei
