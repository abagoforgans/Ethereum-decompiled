...
const workshop = 0x309f4d122e43307d77b841c143d87b5d86088494
...
function depositRevenue() payable {
    call address(singularDTVCrowdfundingAddress).0xdcf8113e with:
...
function softWithdrawRevenueFor(address arg1) payable {
    ...
    call address(singularDTVTokenAddress).0x18160ddd with:
         gas gas_remaining - 25050 wei
    require ext_call.success
    call address(singularDTVTokenAddress).0x70a08231 with:
         gas gas_remaining - 25050 wei
        args arg1
...
function withdrawRevenue() payable {
    ...
    if owed[address(msg.sender)] + ((totalRevenue * ext_call.return_data[0]) - (revenueAtTimeOfWithdraw[address(msg.sender)] * ext_call.return_data[0]) / ext_call.return_data[0]) <= 0:
        return (owed[address(msg.sender)] + ((totalRevenue * ext_call.return_data[0]) - (revenueAtTimeOfWithdraw[address(msg.sender)] * ext_call.return_data[0]) / ext_call.return_data[0]))
    call msg.sender with:
       value owed[address(msg.sender)] + ((totalRevenue * ext_call.return_data[0]) - (revenueAtTimeOfWithdraw[address(msg.sender)] * ext_call.return_data[0]) / ext_call.return_data[0]) wei
         gas 0 wei
    require ext_call.success
    return (owed[address(msg.sender)] + ((totalRevenue * ext_call.return_data[0]) - (revenueAtTimeOfWithdraw[address(msg.sender)] * ext_call.return_data[0]) / ext_call.return_data[0]))
}
