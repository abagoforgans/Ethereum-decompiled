...
function sub_211445e9(?) payable {
    ...
    while idx < 16:
        ...
        s = s + 1
        continue 
    mem[ceil32(arg1.length) + 580] = mem[ceil32(arg1.length) + 602 len 10]
    call 0xd4cb3eb955e03ac64644678fd3d6a7f3104ee70d.0xadf59f99 with:
         gas gas_remaining - 25050 wei
        args 0, 96, 160, 12, 'WolframAlpha', 10, mem[ceil32(arg1.length) + 580]
