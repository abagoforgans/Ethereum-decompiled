...
function _fallback() payable {
    ...
    call address(stor0).0xc51be90f with:
       value ext_call.return_data[0] wei
        ...
        args 180, 128, 192, 500000, 3, mem[516], 76, 'json(https://api.kraken.com/0/pu', 'blic/Ticker?pair=ETHXBT).result.', 'XETHXXBT.c.0' >> 256, mem[644]
    require ext_call.success
    return code.data[1546 len 2276]
}
...
function __callback(bytes32 arg1, string arg2, bytes arg3) payable {
    ...
    call address(stor0.field_0).0xc51be90f with:
       value ext_call.return_data[0] wei
         gas gas_remaining - 34050 wei
        args 180, 128, 192, 500000, 3, mem[ceil32(arg2.length) + ceil32(arg3.length) + 580], 76, 'json(https://api.kraken.com/0/pu', 'blic/Ticker?pair=ETHXBT).result.', 'XETHXXBT.c.0' >> 256, mem[ceil32(arg2.length) + ceil32(arg3.length) + 708]
    require ext_call.success
}
