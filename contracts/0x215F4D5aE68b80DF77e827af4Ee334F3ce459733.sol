...
function _fallback() {
    stor0 = code.data[5518 len 20]
    return code.data[84 len 5422]
}
...
function sub_20a06940(?) {
    ...
    if call.data[132] - ext_call.return_data[0] >= ext_call.return_data[0] * call.data[132] / call.data[164]:
...
function sub_28dcb279(?) {
    ...
    if call.data[292] - ext_call.return_data[0] >= ext_call.return_data[0] * call.data[292] / call.data[324]:
    ...
    if call.data[132] - ext_call.return_data[0] >= ext_call.return_data[0] * call.data[132] / call.data[164]:
        ...
        if call.data[132] - ext_call.return_data[0] < call.data[260]:
            return 5
    require ext_code.size(address(call.data[100]))
    call address(call.data[100]).0xfb6e155f with:
         gas gas_remaining - 710 wei
