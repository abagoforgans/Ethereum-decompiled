...
function sub_a352d215(?) {
    ...
    tokenIPFS[arg2][] = Array(len=arg8.length, data=arg8[all])
    tokenURI[arg2][] = Array(len=arg9.length, data=arg9[all])
    require not ownerOf[arg2]
    ownerOf[arg2] = arg1
    require arg1
    balanceOf[address(arg1)].field_0++
    balanceOf[address(arg1)][balanceOf[address(arg1)].field_0].field_0 = arg2
    stor15[arg2] = balanceOf[address(arg1)].field_0
...
function takeOwnership(uint256 arg1) {
    ...
    require ownerOf[arg1] == ownerOf[arg1]
    require ownerOf[arg1]
    require 1 <= balanceOf[stor12[arg1]].field_0
    require balanceOf[stor12[arg1]].field_0 - 1 < balanceOf[stor12[arg1]].field_0
    ownerOf[arg1] = 0
    require stor15[arg1] < balanceOf[stor12[arg1]].field_0
    balanceOf[stor12[arg1]][stor15[arg1]].field_0 = balanceOf[stor12[arg1]][balanceOf[stor12[arg1]].field_0].field_0
    require balanceOf[stor12[arg1]].field_0 - 1 < balanceOf[stor12[arg1]].field_0
    balanceOf[stor12[arg1]][balanceOf[stor12[arg1]].field_0].field_0 = 0
    balanceOf[stor12[arg1]].field_0--
    if balanceOf[stor12[arg1]].field_0 > balanceOf[stor12[arg1]].field_0 - 1:
        idx = balanceOf[stor12[arg1]].field_0 - 1
        while balanceOf[stor12[arg1]].field_0 > idx:
            balanceOf[stor12[arg1]][idx].field_0 = 0
            idx = idx + 1
            continue 
    stor15[arg1] = 0
    stor15[stor14[stor12[arg1]][stor14[stor12[arg1]].field_0].field_0] = stor15[arg1]
    ...
    stor15[arg1] = balanceOf[address(msg.sender)].field_0
    require totalSupply + 1 >= totalSupply
    totalSupply++
...
function transfer(address arg1, uint256 arg2) {
    ...
    ownerOf[arg2] = 0
    require stor15[arg2] < balanceOf[address(msg.sender)].field_0
    balanceOf[address(msg.sender)][stor15[arg2]].field_0 = balanceOf[address(msg.sender)][balanceOf[address(msg.sender)].field_0].field_0
    require balanceOf[address(msg.sender)].field_0 - 1 < balanceOf[address(msg.sender)].field_0
    ...
    if balanceOf[address(msg.sender)].field_0 > balanceOf[address(msg.sender)].field_0 - 1:
        ...
        while balanceOf[address(msg.sender)].field_0 > idx:
            ...
            continue 
    stor15[arg2] = 0
    stor15[stor14[address(msg.sender)][stor14[address(msg.sender)].field_0].field_0] = stor15[arg2]
    require 1 <= totalSupply
    totalSupply--
    require not ownerOf[arg2]
    ownerOf[arg2] = arg1
