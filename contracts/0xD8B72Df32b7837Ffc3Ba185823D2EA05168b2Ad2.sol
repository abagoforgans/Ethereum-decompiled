...
function sub_2e854433(?) {
    ...
    if stor6[stor18[address(msg.sender)].field_0].field_264 <= 0:
        if remainder <= 0:
            ...
            if remainder:
                require remainder
                require sub_b8837957 * remainder / remainder == sub_b8837957
            require 10^(-tokenDecimals + 18)
            require (sub_b8837957 * remainder / 10^(-tokenDecimals + 18)) + 211 >= 211
            require (sub_b8837957 * remainder / 10^(-tokenDecimals + 18)) + 211 >= sub_b8837957 * remainder / 10^(-tokenDecimals + 18)
            require ext_code.size(projectTokenAddress)
            call projectTokenAddress.0xa9059cbb with:
                 gas gas_remaining - 710 wei
                args msg.sender, (sub_b8837957 * remainder / 10^(-tokenDecimals + 18)) + 211
            require ext_call.success
            require ext_call.return_data[0]
            call msg.sender with:
               value remainder wei
        ...
        if stor6[stor18[address(msg.sender)].field_0].field_264 <= 1:
            if remainder <= 0:
                ...
                if stor14 * stor18[address(msg.sender)].field_256:
                    ...
                    require sub_b8837957 * stor14 * stor18[address(msg.sender)].field_256 / stor14 * stor18[address(msg.sender)].field_256 == sub_b8837957
                require 10^(-tokenDecimals + 18)
                require sub_b8837957 * stor14 * stor18[address(msg.sender)].field_256 / 10^(-tokenDecimals + 18) >= 0
                require sub_b8837957 * stor14 * stor18[address(msg.sender)].field_256 / 10^(-tokenDecimals + 18) >= sub_b8837957 * stor14 * stor18[address(msg.sender)].field_256 / 10^(-tokenDecimals + 18)
                require ext_code.size(projectTokenAddress)
                call projectTokenAddress.0xa9059cbb with:
                     gas gas_remaining - 710 wei
                    args msg.sender, sub_b8837957 * stor14 * stor18[address(msg.sender)].field_256 / 10^(-tokenDecimals + 18)
                require ext_call.success
                require ext_call.return_data[0]
                call msg.sender with:
                ...
                if remainder + (stor14 * stor18[address(msg.sender)].field_256):
                    ...
                    require (remainder * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / remainder + (stor14 * stor18[address(msg.sender)].field_256) == sub_b8837957
                require 10^(-tokenDecimals + 18)
                require ((remainder * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)) + 211 >= 211
                require ((remainder * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)) + 211 >= (remainder * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)
                require ext_code.size(projectTokenAddress)
                call projectTokenAddress.0xa9059cbb with:
                     gas gas_remaining - 710 wei
                    args msg.sender, ((remainder * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)) + 211
                require ext_call.success
                require ext_call.return_data[0]
                call msg.sender with:
            ...
            if stor6[stor18[address(msg.sender)].field_0].field_264 <= 2:
                if remainder <= 0:
                    ...
                    if (stor15 * stor18[address(msg.sender)].field_256) + (stor14 * stor18[address(msg.sender)].field_256):
                        ...
                        require (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / (stor15 * stor18[address(msg.sender)].field_256) + (stor14 * stor18[address(msg.sender)].field_256) == sub_b8837957
                    require 10^(-tokenDecimals + 18)
                    require (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18) >= 0
                    require (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18) >= (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)
                    require ext_code.size(projectTokenAddress)
                    call projectTokenAddress.0xa9059cbb with:
                         gas gas_remaining - 710 wei
                        args msg.sender, (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)
                    require ext_call.success
                    require ext_call.return_data[0]
                    call msg.sender with:
                    ...
                    if remainder + (stor15 * stor18[address(msg.sender)].field_256) + (stor14 * stor18[address(msg.sender)].field_256):
                        ...
                        require (remainder * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / remainder + (stor15 * stor18[address(msg.sender)].field_256) + (stor14 * stor18[address(msg.sender)].field_256) == sub_b8837957
                    require 10^(-tokenDecimals + 18)
                    require ((remainder * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)) + 211 >= 211
                    require ((remainder * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)) + 211 >= (remainder * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)
                    require ext_code.size(projectTokenAddress)
                    call projectTokenAddress.0xa9059cbb with:
                         gas gas_remaining - 710 wei
                        args msg.sender, ((remainder * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)) + 211
                    require ext_call.success
                    require ext_call.return_data[0]
                    call msg.sender with:
                ...
                if stor6[stor18[address(msg.sender)].field_0].field_264 <= 3:
                    if remainder <= 0:
                        ...
                        if (stor16 * stor18[address(msg.sender)].field_256) + (stor15 * stor18[address(msg.sender)].field_256) + (stor14 * stor18[address(msg.sender)].field_256):
                            ...
                            require (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / (stor16 * stor18[address(msg.sender)].field_256) + (stor15 * stor18[address(msg.sender)].field_256) + (stor14 * stor18[address(msg.sender)].field_256) == sub_b8837957
                        require 10^(-tokenDecimals + 18)
                        require (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18) >= 0
                        require (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18) >= (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)
                        require ext_code.size(projectTokenAddress)
                        call projectTokenAddress.0xa9059cbb with:
                             gas gas_remaining - 710 wei
                            args msg.sender, (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)
                        require ext_call.success
                        require ext_call.return_data[0]
                        call msg.sender with:
                        ...
                        if remainder + (stor16 * stor18[address(msg.sender)].field_256) + (stor15 * stor18[address(msg.sender)].field_256) + (stor14 * stor18[address(msg.sender)].field_256):
                            ...
                            require (remainder * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / remainder + (stor16 * stor18[address(msg.sender)].field_256) + (stor15 * stor18[address(msg.sender)].field_256) + (stor14 * stor18[address(msg.sender)].field_256) == sub_b8837957
                        require 10^(-tokenDecimals + 18)
                        require ((remainder * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)) + 211 >= 211
                        require ((remainder * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)) + 211 >= (remainder * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)
                        require ext_code.size(projectTokenAddress)
                        call projectTokenAddress.0xa9059cbb with:
                             gas gas_remaining - 710 wei
                            args msg.sender, ((remainder * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)) + 211
                        require ext_call.success
                        require ext_call.return_data[0]
                        call msg.sender with:
                    ...
                    if remainder <= 0:
                        ...
                        if (stor17 * stor18[address(msg.sender)].field_256) + (stor16 * stor18[address(msg.sender)].field_256) + (stor15 * stor18[address(msg.sender)].field_256) + (stor14 * stor18[address(msg.sender)].field_256):
                            ...
                            require (stor17 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / (stor17 * stor18[address(msg.sender)].field_256) + (stor16 * stor18[address(msg.sender)].field_256) + (stor15 * stor18[address(msg.sender)].field_256) + (stor14 * stor18[address(msg.sender)].field_256) == sub_b8837957
                        require 10^(-tokenDecimals + 18)
                        require (stor17 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18) >= 0
                        require (stor17 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18) >= (stor17 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)
                        require ext_code.size(projectTokenAddress)
                        call projectTokenAddress.0xa9059cbb with:
                             gas gas_remaining - 710 wei
                            args msg.sender, (stor17 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)
                        require ext_call.success
                        require ext_call.return_data[0]
                        call msg.sender with:
                        ...
                        if remainder + (stor17 * stor18[address(msg.sender)].field_256) + (stor16 * stor18[address(msg.sender)].field_256) + (stor15 * stor18[address(msg.sender)].field_256) + (stor14 * stor18[address(msg.sender)].field_256):
                            ...
                            require (remainder * sub_b8837957) + (stor17 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / remainder + (stor17 * stor18[address(msg.sender)].field_256) + (stor16 * stor18[address(msg.sender)].field_256) + (stor15 * stor18[address(msg.sender)].field_256) + (stor14 * stor18[address(msg.sender)].field_256) == sub_b8837957
                        require 10^(-tokenDecimals + 18)
                        require ((remainder * sub_b8837957) + (stor17 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)) + 211 >= 211
                        require ((remainder * sub_b8837957) + (stor17 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)) + 211 >= (remainder * sub_b8837957) + (stor17 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)
                        require ext_code.size(projectTokenAddress)
                        call projectTokenAddress.0xa9059cbb with:
                             gas gas_remaining - 710 wei
                            args msg.sender, ((remainder * sub_b8837957) + (stor17 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor16 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor15 * stor18[address(msg.sender)].field_256 * sub_b8837957) + (stor14 * stor18[address(msg.sender)].field_256 * sub_b8837957) / 10^(-tokenDecimals + 18)) + 211
                        require ext_call.success
                        require ext_call.return_data[0]
                        call msg.sender with:
