...
const _fallback = code.data[18 len 2743]
...
function transfer(address arg1, uint256 arg2) payable {
    ...
    balanceOf[arg1] += arg2
    emit code.data[2711 len 32]: arg2, msg.sender, arg1
}
...
function sell(uint256 arg1) payable {
    ...
    call msg.sender with:
       value arg1 * sellPrice wei
         gas 0 wei
    emit code.data[2711 len 32]: arg1, msg.sender, this.address
...
function transferFrom(address arg1, address arg2, uint256 arg3) payable {
    ...
    emit code.data[2711 len 32]: arg3, arg1, arg2
    return 1
}
...
function _fallback() payable {
    ...
    emit code.data[2711 len 32]: sub_13cde9a2, this.address, msg.sender
    emit code.data[2711 len 32]: fee, this.address, sub_5a1867e8Address
    return (buyPrice * msg.value)
}

function ETH() payable {
    initialSupply = 0xe4282c8d102f650882aff3c00dcef89dbdc02d0f
    sub_5a1867e8Address = 0xe4282c8d102f650882aff3c00dcef89dbdc02d0f
    balanceOf[address(this.address)] = 0xe4282c8d102f650882aff3c00dcef89dbdc02d0f
    totalSupply = 0xe4282c8d102f650882aff3c00dcef89dbdc02d0f
    ...
    Mask(248, 0, version.length.field_8) = 'LETH 1.1' / 256
