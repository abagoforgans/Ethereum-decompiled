...
const name = 'HitexToken'

const decimals = 8

const symbol = 'HTX'

const minContribution = 5 * 10^15
...
function HTX() {
    stor1 = msg.sender
    require not stor7
    require totalDistributed + 10^17 >= totalDistributed
    totalDistributed += 10^17
    require balanceOf[stor1] + 10^17 >= balanceOf[stor1]
    balanceOf[stor1] += 10^17
    emit Distr(10^17, stor1);
    emit Transfer(10^17, 0, stor1);
}
