...
function _fallback() payable {
    ...
    stor5 = code.data[8465 len 20]
    return code.data[261 len 8192]
}
            ...
            if block.timestamp < stor8:
                ...
                if block.timestamp >= stor9:
                    ...
                    if ext_call.return_data[0] > (500000 * block.gasprice) + 10^18:
                        stor14[0] = msg.sender
                        stor15[address(msg.sender)] = msg.value
                        stor16[0] = 0
                    else:
                        require ext_code.size(address(stor1))
                        ...
                        require ext_call.success
                        stor14[ext_call.return_data[0]] = msg.sender
                        stor15[address(msg.sender)] = msg.value
                        stor16[ext_call.return_data[0]] = ext_call.return_data[0]
    else:
        if stor12 != msg.sender:
            if not stor0:
                if ext_code.size(0x1d3b2638a7cc9f2cb3d298a3da7a90b67e5506ed) > 0:
