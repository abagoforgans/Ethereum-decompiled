...
function _fallback() payable {
    ...
    stor7 = 100
    stor6 = code.data[7640 len 32]
    stor3 = 417648 * 24 * 3600
    stor4 = 1504223999
    stor5 = 10
    return code.data[397 len 2959]
}
...
function _fallback() payable {
    ...
    require rate
    require 10^9 * msg.value / 10^18 / rate > 0
    require ext_code.size(tokenAddress)
    call tokenAddress.0x40c10f19 with:
         gas gas_remaining - 710 wei
        args msg.sender, 10^9 * msg.value / 10^18 / rate
    ...
    require tokenAmountOf[address(msg.sender)] + (10^9 * msg.value / 10^18 / rate) >= tokenAmountOf[address(msg.sender)]
    tokenAmountOf[address(msg.sender)] += 10^9 * msg.value / 10^18 / rate
    require weiRaised + msg.value >= weiRaised
    weiRaised += msg.value
    require tokensSold + (10^9 * msg.value / 10^18 / rate) >= tokensSold
    tokensSold += 10^9 * msg.value / 10^18 / rate
    call stor1 with:
       value msg.value wei
