        ...
        if 10^15 * arg2 <= stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_0:
            ...
            if stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_768 <= block.timestamp:
                ...
                if eth.balance(this.address) >= (10^15 * arg2) + ((10^15 * block.timestamp * arg2 * stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_512) - (10^15 * stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_256 * arg2 * stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_512) / 100 / 720 * 24 * 3600):
                    call msg.sender with:
                       value (10^15 * arg2) + ((10^15 * block.timestamp * arg2 * stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_512) - (10^15 * stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_256 * arg2 * stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_512) / 100 / 720 * 24 * 3600) - ((10^15 * block.timestamp * arg2 * stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_512) - (10^15 * stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_256 * arg2 * stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_512) / 100 / 720 * 24 * 3600 * stor1.length / 100) wei
                         gas 0 wei
                    call address(owner) with:
                       value (10^15 * block.timestamp * arg2 * stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_512) - (10^15 * stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_256 * arg2 * stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_512) / 100 / 720 * 24 * 3600 * stor1.length / 100 wei
                         gas 0 wei
                    require arg1 - 1 < participants[address(msg.sender)].field_256
                    if arg2 == stor[(4 * arg1 - 1) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_0:
                        mem[64] = (32 * participants[address(msg.sender)].field_256) + 128
                        mem[96] = participants[address(msg.sender)].field_256
                        s = 128
                        idx = 0
                        while idx < participants[address(msg.sender)].field_256:
                            ...
                            _40 = mem[64]
                            mem[64] = mem[64] + 128
                            mem[_40] = stor[('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0))) + (4 * idx)].field_0
                            mem[_40 + 32] = stor[('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0))) + (4 * idx)].field_256
                            mem[_40 + 64] = stor[('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0))) + (4 * idx)].field_512
                            mem[_40 + 96] = stor[('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0))) + (4 * idx)].field_768
                            mem[s] = _40
                            s = s + 32
                            idx = idx + 1
                            continue 
                        ...
                        if arg1 - 1 < mem[96]:
                            ...
                            while idx < _61 - 1:
                                ...
                                require idx < mem[96]
                                mem[(32 * idx) + 128] = mem[(32 * idx + 1) + 128]
                                _61 = mem[96]
                                idx = idx + 1
                                continue 
                ...
                if stor[(4 * idx) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_768 <= block.timestamp:
                    ...
                    if eth.balance(this.address) >= stor[(4 * idx) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_0 + ((block.timestamp * stor[(4 * idx) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_0 * stor[(4 * idx) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_512) - (stor[(4 * idx) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_256 * stor[(4 * idx) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_0 * stor[(4 * idx) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_512) / 100 / 720 * 24 * 3600):
                        ...
                        while s < participants[address(msg.sender)].field_256:
                            ...
                            _47 = mem[64]
                            mem[64] = mem[64] + 128
                            mem[_47] = stor[(4 * s) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_0
                            mem[_47 + 32] = stor[(4 * s) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_256
                            mem[_47 + 64] = stor[(4 * s) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_512
                            mem[_47 + 96] = stor[(4 * s) + ('array', 1, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'participants', 0)))].field_768
                            mem[t] = _47
                            t = t + 32
                            s = s + 1
                            continue 
