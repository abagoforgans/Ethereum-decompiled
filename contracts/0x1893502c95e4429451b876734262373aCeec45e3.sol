...
const _fallback = code.data[18 len 3313]
...
function sub_1d71c31d(?) {
    ...
    require uint8(arg4)
    if uint16(var11003) < uint16(uint16(arg3) / uint8(arg4)):
        require uint16(var13001) < arg1.length
        stor1[address(arg2)][var15003 << 240] = mem[(32 * var15001) + 128]
        require uint8(arg4)
        idx = var15003
