...
function _fallback() payable {
    ...
    require code.data[4395 len 32] <= 10000
    stor2 = code.data[4395 len 32]
    require ext_code.size(address(code.data[4363 len 32]))
    call address(code.data[4363 len 32]).supportsInterface(bytes4 arg1) with:
    ...
    stor1 = address(code.data[4363 len 32])
    return code.data[790 len 3573]
}
