...
function _fallback() payable {
    require code.data[2373 len 20]
    require code.data[2393 len 32]
    require code.data[2425 len 32]
    stor2 = msg.sender
    stor1 = code.data[2373 len 20]
    stor3 = code.data[2393 len 32]
    stor4 = code.data[2425 len 32]
    stor10 = 0
    return code.data[153 len 2208]
}
...
function setup(address arg1) {
    ...
    require not gnosisTokenAddress
    require arg1
    ...
    if arg1:
        if ceiling >= (2500 * 3600 * 10^18 * priceFactor / block.number + -startBlock + 7500) + (2500 * 3600):
            ...
            call walletAddress with:
               value (2500 * 3600 * 10^18 * priceFactor / block.number + -startBlock + 7500) + -totalReceived + (2500 * 3600) wei
                 gas 2300 * is_zero(value) wei
            require ext_call.success
            bids[address(arg1)] = (2500 * 3600 * 10^18 * priceFactor / block.number + -startBlock + 7500) + -totalReceived + bids[address(arg1)] + (2500 * 3600)
        ...
        call walletAddress with:
           value ceiling - totalReceived wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        bids[address(arg1)] = ceiling - totalReceived + bids[address(arg1)]
        ...
        if ceiling >= (2500 * 3600 * 10^18 * priceFactor / block.number + -startBlock + 7500) + (2500 * 3600):
            ...
            call walletAddress with:
               value (2500 * 3600 * 10^18 * priceFactor / block.number + -startBlock + 7500) + -totalReceived + (2500 * 3600) wei
                 gas 2300 * is_zero(value) wei
            require ext_call.success
            bids[address(msg.sender)] = (2500 * 3600 * 10^18 * priceFactor / block.number + -startBlock + 7500) + -totalReceived + bids[address(msg.sender)] + (2500 * 3600)
            totalReceived = (2500 * 3600 * 10^18 * priceFactor / block.number + -startBlock + 7500) + (2500 * 3600)
            if (2500 * 3600 * 10^18 * priceFactor / block.number + -startBlock + 7500) + -totalReceived + (2500 * 3600) == (2500 * 3600 * 10^18 * priceFactor / block.number + -startBlock + 7500) + -totalReceived + (2500 * 3600):
                stage = 2
                if ceiling != totalReceived:
        ...
        call walletAddress with:
           value ceiling - totalReceived wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        bids[address(msg.sender)] = ceiling - totalReceived + bids[address(msg.sender)]
        totalReceived = ceiling
        if ceiling - totalReceived == ceiling - totalReceived:
            stage = 2
            if ceiling != totalReceived:
