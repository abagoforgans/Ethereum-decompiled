...
function _fallback() payable {
    mem[96 len -832] = code.data[1253 len -832]
    mem[64] = -736
...
function sub_d660c45d(?) payable {
    balanceOf[address(msg.sender)] = 0
    balanceOf[arg1] = balanceOf[address(msg.sender)]
    emit 0x62de4da2: balanceOf[address(msg.sender)], msg.sender, arg1
}
...
function send(address arg1, uint256 arg2) payable {
    ...
    emit 0x62de4da2: arg2, msg.sender, arg1
}
