...
function _fallback() payable {
    ...
    mem[96 len -6551] = code.data[7565 len -6551]
    mem[64] = -6455
    ...
    if mem[160] > 0:
        ...
        stor1 += mem[160]
        require stor0[address(mem[192])] + mem[160] >= stor0[address(mem[192])]
        stor0[address(mem[192])] += mem[160]
        emit Mint(mem[160], mem[204 len 20]);
        emit Transfer(mem[160], 0, mem[204 len 20]);
    return code.data[1014 len 6551]
}
