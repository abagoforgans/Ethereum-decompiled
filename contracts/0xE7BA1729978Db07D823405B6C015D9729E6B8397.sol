...
function closeLong() {
    ...
    call address(smartTokenAddress).transfer(address rg1, uint256 rg2) with:
         gas gas_remaining - 710 wei
    ...
    require ext_call.success
    require ext_code.size(address(etherTokenAddress))
    call address(etherTokenAddress).transfer(address rg1, uint256 rg2) with:
         gas gas_remaining - 710 wei
