...
function _fallback() payable {
    ...
    stor1.length.field_8 = 'SunContract token v1.0' / 256
    idx = 0
    ...
    stor2.length.field_8 = 'SunContract' / 256
    idx = 0
    ...
    stor0 = msg.sender
    stor9[0] = 1
    stor9[address(code.data[7339 len 32])] = 1
    stor9[address(this.address)] = 1
    address(stor4.field_8) = code.data[7351 len 20]
    return code.data[887 len 6452]
}
