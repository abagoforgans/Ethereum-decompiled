...
function _fallback() {
    require code.data[1885 len 32] >= code.data[1853 len 32]
    require code.data[1917 len 32] > 0
    require code.data[1961 len 20]
    require code.data[1993 len 20]
    stor0 = code.data[1993 len 20]
    stor1 = code.data[1853 len 32]
    stor2 = code.data[1885 len 32]
    stor4 = code.data[1917 len 32]
    stor3 = code.data[1961 len 20]
    return code.data[358 len 1495]
}
