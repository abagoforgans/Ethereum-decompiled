...
function claim() {
    ...
    while idx < stor4.length:
        ...
        _18 = mem[64]
        mem[64] = mem[64] + 96
        mem[_18] = stor4[idx].field_0
        mem[_18 + 32] = stor4[idx].field_256
        mem[_18 + 64] = bool(stor4[idx].field_512)
        if stor4[idx].field_512:
            s = s
            t = _18
            idx = idx + 1
            continue 
        require stor1 + stor4[idx].field_256 >= stor4[idx].field_256
        if stor1 + stor4[idx].field_256 >= block.timestamp:
            s = s
            t = _18
            idx = idx + 1
            continue 
