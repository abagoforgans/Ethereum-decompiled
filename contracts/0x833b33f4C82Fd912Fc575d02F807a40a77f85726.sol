...
function _fallback() payable {
    ...
    mem[96 len -20859] = code.data[21388 len -20859]
    mem[64] = -20763
    stor0 = msg.sender
    ...
    stor5 = mem[224]
    return code.data[529 len 20859]
}
...
function _fallback() payable {
    ...
    if bonusMode == 3:
        ...
        while idx < bonusLevels.length:
            ...
            if u > bonusLevels[idx] - v:
                ...
                if not bonusLevels[idx] - v:
                    if t + (bonusLevels[idx] * bonusRates[idx]) - (v * bonusRates[idx]) >= t:
                        if bonusLevels[idx] - v <= u:
                            s = bonusLevels[idx] - v
                            t = t + (bonusLevels[idx] * bonusRates[idx]) - (v * bonusRates[idx])
            ...
            if u:
                require u
                require u * bonusRates[idx] / u == bonusRates[idx]
            require t + (u * bonusRates[idx]) >= t
            require ext_code.size(tokenAddress)
            call tokenAddress.0x313ce567 with:
                 gas gas_remaining - 710 wei
            require ext_call.success
            if t + (u * bonusRates[idx]) / 10^18:
                require t + (u * bonusRates[idx]) / 10^18
                require t + (u * bonusRates[idx]) / 10^18 * 10^ext_call.return_data[31 len 1] / t + (u * bonusRates[idx]) / 10^18 == 10^ext_call.return_data[31 len 1]
            require tokenPrice
            ...
            call tokenAddress.0x40c10f19 with:
                 gas gas_remaining - 710 wei
                args msg.sender, t + (u * bonusRates[idx]) / 10^18 * 10^uint8(ext_call.return_data[0]) / tokenPrice
            require ext_call.success
            require ext_call.return_data[0]
        ...
        require ext_call.success
        if t + (10^18 * u) / 10^18:
            require t + (10^18 * u) / 10^18
            require t + (10^18 * u) / 10^18 * 10^ext_call.return_data[31 len 1] / t + (10^18 * u) / 10^18 == 10^ext_call.return_data[31 len 1]
        require tokenPrice
        require amountRaised + msg.value >= amountRaised
        amountRaised += msg.value
        require amountRaised <= fundingGoal
        ...
        call tokenAddress.0x40c10f19 with:
             gas gas_remaining - 710 wei
            args msg.sender, t + (10^18 * u) / 10^18 * 10^uint8(ext_call.return_data[0]) / tokenPrice
    else:
        require ext_code.size(tokenAddress)
        call tokenAddress.0x313ce567 with:
             gas gas_remaining - 710 wei
        ...
        if msg.value:
            require msg.value
            require msg.value * 10^ext_call.return_data[31 len 1] / msg.value == 10^ext_call.return_data[31 len 1]
        require tokenPrice
        require bonusMode <= 4
        require bonusMode <= 4
        require bonusMode <= 4
                ...
                if bonusMode != 4:
                    ...
                    while idx < bonusLevels.length:
                        ...
                        if 0 > bonusLevels[idx]:
                            ...
                            continue 
                        require idx < bonusRates.length
                        if msg.value * 10^uint8(ext_call.return_data[0]) / tokenPrice:
                            require msg.value * 10^uint8(ext_call.return_data[0]) / tokenPrice
                            require msg.value * 10^uint8(ext_call.return_data[0]) / tokenPrice * bonusRates[idx] / msg.value * 10^uint8(ext_call.return_data[0]) / tokenPrice == bonusRates[idx]
                        require amountRaised + msg.value >= amountRaised
                        amountRaised += msg.value
                        require amountRaised <= fundingGoal
                        require ext_code.size(tokenAddress)
                        call tokenAddress.0x40c10f19 with:
                             gas gas_remaining - 710 wei
                            args msg.sender, msg.value * 10^uint8(ext_call.return_data[0]) / tokenPrice * bonusRates[idx] / 10^18
                        require ext_call.success
                        require ext_call.return_data[0]
                        emit Contribution(msg.sender, msg.value);
                        if fundingGoal <= amountRaised:
        ...
        call tokenAddress.0x40c10f19 with:
             gas gas_remaining - 710 wei
            args msg.sender, msg.value * 10^uint8(ext_call.return_data[0]) / tokenPrice
    require ext_call.success
    require ext_call.return_data[0]
    emit Contribution(msg.sender, msg.value);
    if fundingGoal <= amountRaised:
