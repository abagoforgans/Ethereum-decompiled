...
function sub_99a4bb62(?) {
    ...
    while idx < arg1.length:
        ...
        require balanceOf[mem[(32 * idx) + 140 len 20]] + 1 >= balanceOf[mem[(32 * idx) + 140 len 20]]
        require idx < arg1.length
        ...
        idx = idx + 1
        continue 
    require arg1.length + totalSupply >= totalSupply
    totalSupply += arg1.length
    emit 0x6490153f: arg1.length
}
