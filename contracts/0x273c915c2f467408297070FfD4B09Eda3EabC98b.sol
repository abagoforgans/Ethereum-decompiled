...
function exit() {
    idx = 0
    while uint8(idx) < 9:
        if stor5[uint8(idx)].field_0 != msg.sender:
            idx = idx + 1
            continue 
        require uint8(idx) < 9
        if not stor5[uint8(idx)].field_160:
            idx = idx + 1
            continue 
        require uint8(idx) < 9
        ...
        call msg.sender with:
           value stor4[uint8(idx)] + stor30 wei
    ...
    while uint8(idx) < 9:
        ...
        if stor4[uint8(idx)] > 0:
            if stor4[uint8(idx)] <= stor3[uint8(idx)]:
                ...
                sub_1904863c += stor4[uint8(idx)] - stor3[uint8(idx)] / 100
                call arg1 with:
...
function balance() {
    ...
    if Mask(251, 0, mem[512]):
        mem[1312] = mem[544]
        mem[1344 len floor32((32 * mem[512]) - 1)] = mem[576 len 288], 64, 416, 10, mem[192], mem[224 len 288], mem[512], mem[544], mem[1344 len floor32((32 * mem[512]) - 1) - 768]
    emit 0x5068ed09: 64, 416, 10, mem[192], mem[224 len 288], mem[1280 len (32 * mem[512]) + 32]
}
...
function _fallback() payable {
    ...
    if msg.value == stor30:
        ...
        while uint8(idx) < 9:
            ...
            stor4[uint8(idx)] = msg.value - stor31
