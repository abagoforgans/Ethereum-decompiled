...
function _fallback() payable {
    ...
    require code.data[16915 len 4] >= block.timestamp
    require code.data[16947 len 4] >= code.data[16915 len 4]
    require code.data[16963 len 20]
    require 10^18 * code.data[17015 len 32] > 0
    create contract with 0 wei
                    code: code.data[13170 len 3685]
    require create.new_address
    address(stor0.field_0) = address(create.new_address)
    uint32(stor0.field_160) = code.data[16915 len 4]
    uint32(stor0.field_192) = code.data[16947 len 4]
    stor4 = 10^18 * code.data[17015 len 32]
    stor1 = code.data[16963 len 20]
    address(stor5.field_0) = msg.sender
    require code.data[16983 len 32] > 0
    create contract with 0 wei
                    code: code.data[9976 len 1654], stor1
    require create.new_address
    stor7 = address(create.new_address)
    stor6 = code.data[16983 len 32]
    require ext_code.size(address(stor0.field_0))
    call address(stor0.field_0).0x40c10f19 with:
         gas gas_remaining - 710 wei
        args address(code.data[16855 len 32]), 11000000 * 10^18
    require ext_call.success
    require ext_code.size(address(stor0.field_0))
    call address(stor0.field_0).0x40c10f19 with:
         gas gas_remaining - 710 wei
        args address(code.data[16855 len 32]), 2000000 * 10^18
    require ext_call.success
    require ext_code.size(address(stor0.field_0))
    call address(stor0.field_0).0x40c10f19 with:
         gas gas_remaining - 710 wei
        args address(code.data[16855 len 32]), 3038800 * 10^18
    require ext_call.success
    require ext_code.size(address(stor0.field_0))
    call address(stor0.field_0).addExcluded(address rg1) with:
         gas gas_remaining - 710 wei
        args address(code.data[16855 len 32])
    require ext_call.success
    require ext_code.size(address(stor0.field_0))
    call address(stor0.field_0).addExcluded(address rg1) with:
         gas gas_remaining - 710 wei
    ...
    return code.data[1796 len 8180]
}
...
function hasEnded() {
    ...
    call rateProviderAddress.getBaseRate() with:
         gas gas_remaining - 710 wei
    require ext_call.success
