...
function _fallback() payable {
    ...
    stor1.length.field_8 = 'cryptoABS' / 256
    idx = 0
    ...
    mem[224 len -3276] = code.data[3814 len -3276]
    stor0 = msg.sender
    stor4 = mem[224] * 10^stor3
    stor5[address(msg.sender)] = mem[224] * 10^stor3
...
function distributeToken(address[] arg1, uint256 arg2) {
    ...
    while idx < arg1.length:
        ...
        emit Transfer(arg2, owner, address(_19));
        idx = idx + 1
        continue 
}
