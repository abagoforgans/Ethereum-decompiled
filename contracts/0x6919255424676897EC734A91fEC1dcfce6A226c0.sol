...
const name = 'TestAPI Check222'

const decimals = 18

const symbol = 'Test-222'

const TOTAL_SUPPLY = 10000000000 * 10^18
...
function setAdmin(address arg1) {
    ...
    require not allowance[address(msg.sender)][address(arg1)]
    allowance[address(msg.sender)][address(arg1)] = 10000000000 * 10^18
    emit Approval(10000000000 * 10^18, msg.sender, arg1);
}
