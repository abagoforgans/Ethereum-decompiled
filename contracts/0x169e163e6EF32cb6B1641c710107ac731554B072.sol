...
function _fallback() payable {
    mem[128] = 'https://mshk.top'
    bool(stor1.length) = 0
    stor1.length.field_1 = 16
    stor1.length.field_8 = 'https://mshk.top' / 256
    idx = 0
    ...
    mem[160 len -6279] = code.data[6996 len -6279]
    stor0 = msg.sender
    stor5 = mem[160] * 10^stor4
    stor6[address(this.address)] = stor5
