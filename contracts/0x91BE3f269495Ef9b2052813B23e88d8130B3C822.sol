...
uint64 stor1; offset 184
address stor1;
bool stor2; offset 256
uint32 stor2;
uint32 stor2; offset 72
uint32 stor2; offset 96
uint64 stor2; offset 24
uint16 stor7;

function _fallback() payable {
    stor0 = msg.sender or Mask(96, 160, stor0)
    address(stor1.field_0) = msg.sender
    stor1.field_160 % 16777216 = 72334
    stor1.field_184 % 1099511627776 = 0
    uint32(stor1.field_224) = Mask(32, 224, msg.sender) >> 224
    stor2.field_0 % 16777216 = 4166555
    stor2.field_24 % 281474976710656 = 0
    stor2.field_72 % 16777216 = 234375
    uint32(stor2.field_96) = 0
    stor2.field_256 % 1 = 0
    stor7 = 0
    return code.data[149 len 2209]
}
        ...
        if arg2 <= 100:
            ...
            while uint16(idx) < uint16(stor7):
                ...
                if uint16(idx) != 65535:
                    ...
                    getContributionInfo[idx << 240][1][getContributionInfo[idx << 240].field_0].field_512 = getContributionInfo[idx << 240][1][getContributionInfo[idx << 240].field_0].field_520
                    getContributionInfo[idx << 240][1][getContributionInfo[idx << 240].field_0].field_768 = uint8(uint64(uint64(stor2.field_64) + (uint64(stor2.field_0) * uint8((100 * msg.value) - (100 * msg.value / 100 * arg2) / (msg.value / 100 * arg2) + msg.value - (msg.value / 100 * arg2))) + (uint8((100 * msg.value) - (100 * msg.value / 100 * arg2) / (msg.value / 100 * arg2) + msg.value - (msg.value / 100 * arg2)) * uint8((100 * msg.value) - (100 * msg.value / 100 * arg2) / (msg.value / 100 * arg2) + msg.value - (msg.value / 100 * arg2)) * uint64(stor1.field_160))) / 10 * 10^6) * (msg.value / 100 * arg2) + msg.value - (msg.value / 100 * arg2) / 1000 / 2
                    ...
                    getContributionInfo[uint16(stor7)][1][getContributionInfo[uint16(stor7)].field_0].field_512 = getContributionInfo[uint16(stor7)][1][getContributionInfo[uint16(stor7)].field_0].field_520
                    getContributionInfo[uint16(stor7)][1][getContributionInfo[uint16(stor7)].field_0].field_768 = uint8(uint64(uint64(stor2.field_64) + (uint64(stor2.field_0) * uint8((100 * msg.value) - (100 * msg.value / 100 * arg2) / (msg.value / 100 * arg2) + msg.value - (msg.value / 100 * arg2))) + (uint8((100 * msg.value) - (100 * msg.value / 100 * arg2) / (msg.value / 100 * arg2) + msg.value - (msg.value / 100 * arg2)) * uint8((100 * msg.value) - (100 * msg.value / 100 * arg2) / (msg.value / 100 * arg2) + msg.value - (msg.value / 100 * arg2)) * uint64(stor1.field_160))) / 10 * 10^6) * (msg.value / 100 * arg2) + msg.value - (msg.value / 100 * arg2) / 1000 / 2
                        ...
                        if block.timestamp <= getContributionInfo[idx << 240][1][s << 240].field_1280 + (48 * 24 * 3600):
                            ...
                            if not getContributionInfo[idx << 240][1][s << 240].field_1024:
                                if cashForHardwareReturn >= getContributionInfo[idx << 240][1][s << 240].field_0:
                                    ...
                                    contributedAmount = contributedAmount - getContributionInfo[idx << 240][1][s << 240].field_256 - getContributionInfo[idx << 240][1][s << 240].field_0
                                    call getContributionInfo[idx << 240].field_0 with:
                                ...
                                getContributionInfo[idx << 240][1][getContributionInfo[idx << 240].field_0].field_512 = getContributionInfo[idx << 240][1][getContributionInfo[idx << 240].field_0].field_520
                                getContributionInfo[idx << 240][1][getContributionInfo[idx << 240].field_0].field_768 = uint8(uint64(uint64(stor2.field_64) + (uint64(stor2.field_0) * uint8(100 * getContributionInfo[idx << 240][1][s << 240].field_0 / getContributionInfo[idx << 240][1][s << 240].field_256 + getContributionInfo[idx << 240][1][s << 240].field_0)) + (uint8(100 * getContributionInfo[idx << 240][1][s << 240].field_0 / getContributionInfo[idx << 240][1][s << 240].field_256 + getContributionInfo[idx << 240][1][s << 240].field_0) * uint8(100 * getContributionInfo[idx << 240][1][s << 240].field_0 / getContributionInfo[idx << 240][1][s << 240].field_256 + getContributionInfo[idx << 240][1][s << 240].field_0) * uint64(stor1.field_160))) / 10 * 10^6) * getContributionInfo[idx << 240][1][s << 240].field_256 + getContributionInfo[idx << 240][1][s << 240].field_0 / 1000 / 2
                                getContributionInfo[idx << 240][1][getContributionInfo[idx << 240].field_0].field_1023 = 0
