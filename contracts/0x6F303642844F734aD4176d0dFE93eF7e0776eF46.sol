...
function _fallback() payable {
    ...
    stor0 = code.data[1803 len 20]
    stor1 = 5000 * 10^18 * code.data[1823 len 32]
    stor3 = (60 * code.data[1855 len 32]) + block.timestamp
    stor4 = 5 * 10^6 * code.data[1887 len 32]
    stor5 = code.data[1931 len 20]
    return code.data[172 len 1619]
}
...
function tokenWithdraw(uint256 arg1) {
    if block.timestamp < deadline:
