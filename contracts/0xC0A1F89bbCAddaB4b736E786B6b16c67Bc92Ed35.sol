...
function _fallback() {
    stor0 = msg.sender
    require code.data[2474 len 32] >= block.timestamp
    require code.data[2474 len 32] > code.data[2442 len 32]
    require code.data[2506 len 32] <= 10000000 * 10^18
    require code.data[2550 len 20]
    stor1 = code.data[2442 len 32]
    stor2 = code.data[2474 len 32]
    stor3 = code.data[2506 len 32]
    stor5 = code.data[2582 len 20]
    stor6 = code.data[2550 len 20]
    return code.data[243 len 2199]
}
