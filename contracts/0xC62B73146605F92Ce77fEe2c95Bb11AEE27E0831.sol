...
function sub_a977ee85(?) {
    ...
    if msg.sender == addAuthorityAddress:
        ...
        require uint8(arg4)
        if uint16(var12003) < uint16(uint16(arg7) / uint8(arg4)):
            require uint16(var14001) < arg8.length
            stor1[address(arg3)][var16003 << 240] = mem[(32 * var16001) + 128]
            require uint8(arg4)
            idx = var16003
