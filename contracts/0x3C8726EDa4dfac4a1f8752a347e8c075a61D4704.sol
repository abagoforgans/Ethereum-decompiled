...
function _fallback() payable {
    ...
    stor8 = msg.sender
    stor3 = 1990 * 10^6 * 10^stor2
    stor4[address(msg.sender)] = 1990 * 10^6 * 10^stor2
    bool(stor0.length) = 0
    stor0.length.field_1 = 8
    stor0.length.field_8 = 'DzhStock' / 256
    idx = 0
    ...
    stor1.length.field_8 = 'DZH' / 256
    idx = 0
    while stor1.length + 31 / 32 > idx:
        stor1[idx].field_0 = 0
        idx = idx + 1
        continue 
    return code.data[412 len 2657]
}
...
function _fallback() payable {
    if msg.value > 0:
        ...
        require balanceOf[stor8] >= 10000 * msg.value
        balanceOf[stor8] += -10000 * msg.value
        balanceOf[msg.sender] += 10000 * msg.value
        call adminAddress with:
           value msg.value wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        emit Transfer((10000 * msg.value), adminAddress, msg.sender);
        transferCount++
}
