...
function sub_d19d9946(?) {
    totalSupply = 8
    balanceOf[address(msg.sender)] = 6 * 10^11 * 24 * 3600
    bool(name.length) = 0
    name.length.field_1 = 8
    name.length.field_8 = 'DDBBCOIN' / 256
    idx = 0
    ...
    symbol.length.field_8 = 'DDBB' / 256
    idx = 0
