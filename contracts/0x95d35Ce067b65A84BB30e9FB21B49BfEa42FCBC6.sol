...
function sub_140de59b(?) {
    ...
    if sub_a2354324[address(msg.sender)].field_256 / 24 * 3600 != block.timestamp / 24 * 3600:
        sub_a2354324[address(msg.sender)].field_0 = 0
    require sub_a2354324[address(msg.sender)].field_0 + arg2 >= sub_a2354324[address(msg.sender)].field_0
    require sub_a2354324[address(msg.sender)].field_0 + arg2 <= sub_1ae08013
    require balanceOf[address(arg1)] + arg2 >= balanceOf[address(arg1)]
    balanceOf[address(arg1)] += arg2
    require totalSupply + arg2 >= totalSupply
    totalSupply += arg2
    sub_a2354324[address(msg.sender)].field_256 = block.timestamp
    require sub_a2354324[address(msg.sender)].field_0 + arg2 >= sub_a2354324[address(msg.sender)].field_0
    sub_a2354324[address(msg.sender)].field_0 += arg2
...
function batchTransfer(address[] arg1, uint256[] arg2) {
    ...
    while idx < arg1.length:
        ...
        require balanceOf[address(msg.sender)] + balanceOf[address(mem[(32 * idx) + 128])] >= balanceOf[address(msg.sender)]
        ...
        emit Transfer(mem[(32 * arg1.length) + (32 * arg2.length) + 160], msg.sender, address(_79));
        mem[0] = msg.sender
        mem[32] = 9
        require balanceOf[address(msg.sender)] + balanceOf[address(_79)] == balanceOf[address(msg.sender)] + stor[_83]
        idx = idx + 1
        continue 
    return 1
}
