...
function persons(uint256 arg1) payable {
    ...
    return address(stor0[arg1].field_0), stor[code.data[1050 len 32] + (2 * arg1)]
}
...
function enter() payable {
    ...
    if msg.value <= 75 * 10^14 * 24 * 3600:
        ...
        if not stor0.length > stor0.length + 1:
            ...
            stor[code.data[1050 len 32] + (2 * stor0.length)] = msg.value
            if not stor0.length:
                balance += msg.value
            else:
            ...
            if balance <= 150 * stor[code.data[1050 len 32] + (2 * stor1)] / 100:
        ...
        call msg.sender with:
           value msg.value - (75 * 10^14 * 24 * 3600) wei
             gas 0 wei
        stor0.length++
        if not stor0.length > stor0.length + 1:
            require stor0.length < stor0.length
            stor0[stor0.length].field_0 = msg.sender or Mask(96, 160, stor0[stor0.length].field_0)
            stor[code.data[1050 len 32] + (2 * stor0.length)] = 75 * 10^14 * 24 * 3600
            if not stor0.length:
                balance += 75 * 10^14 * 24 * 3600
            else:
                collectedFees += 75 * 10^13 * 24 * 3600
                call address(owner) with:
                   value collectedFees + (75 * 10^13 * 24 * 3600) wei
                     gas 0 wei
                collectedFees = 0
                balance += 1875 * 10^9 * 24 * 3600 * 24 * 3600
            if balance <= 150 * stor[code.data[1050 len 32] + (2 * stor1)] / 100:
            require payoutIdx < stor0.length
            call address(stor0[stor1].field_0) with:
               value var24003 wei
