...
const TOKEN_OFFERING_ALLOWANCE = 3200000000 * 10^18

const ADMIN_ALLOWANCE = 4800000000 * 10^18
...
function setTokenOffering(address arg1, uint256 arg2) {
    ...
    if not arg2:
        allowance[address(msg.sender)][address(arg1)] = 3200000000 * 10^18
        emit Approval(3200000000 * 10^18, msg.sender, arg1);
    else:
        require arg2 <= 3200000000 * 10^18
        allowance[address(msg.sender)][address(arg1)] = arg2
        emit Approval(arg2, msg.sender, arg1);
