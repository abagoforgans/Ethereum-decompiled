...
function _fallback() payable {
    ...
    stor0 = code.data[1689 len 20]
    stor1 = 10^18 * code.data[1709 len 32]
    stor3 = (60 * code.data[1741 len 32]) + block.timestamp
    stor4 = 10^18 * code.data[1773 len 32]
    stor5 = code.data[1817 len 20]
    return code.data[167 len 1510]
}
...
function _fallback() payable {
    ...
    if block.timestamp > deadline - (133 * 3600):
