...
function sub_48bea6e8(?) {
    if not ('cd', 4).length:
        mem[(32 * ('cd', 4).length) + 128] = ('cd', 4).length
    else:
        mem[128 len 32 * ('cd', 4).length] = code.data[5947 len 32 * ('cd', 4).length]
        mem[(32 * ('cd', 4).length) + 128] = ('cd', 4).length
        mem[(32 * ('cd', 4).length) + 160 len 32 * ('cd', 4).length] = code.data[5947 len 32 * ('cd', 4).length]
    mem[(64 * ('cd', 4).length) + 160] = 0x5a51eb0000000000000000000000000000000000000000000000000000000 * 3600
    require ext_code.size(0x818e6fecd516ecc3849daf6845e3ec868087b755)
    call 0x818e6fecd516ecc3849daf6845e3ec868087b755.kyberNetworkContract() with:
         gas gas_remaining wei
    ...
    while idx < ('cd', 4).length:
        ...
        require ext_code.size(address(ext_call.return_data[0]))
        call address(ext_call.return_data[0]).searchBestRate(address arg1, address arg2, uint256 arg3) with:
             gas gas_remaining wei
