...
function claimReadership(uint256 arg1, string arg2) {
    ...
    if not shieldsUp:
        ...
        _1082 = sha3(mem[ceil32(arg2.length) + 128 len publishedRegister[arg1].length + 32])
        ...
        if sha3(call.data[arg2 + 36 len floor32(arg2.length)], mem[ceil32(arg2.length) + floor32(arg2.length) + 128 len arg2.length % 32]) != stor[_1082]:
            emit ClaimResult(4);
            revert
    else:
        ...
        while ceil32(arg2.length) + publishedRegister[arg1].length + 128 > idx + 32:
            ...
            continue 
        mem[ceil32(arg2.length) + publishedRegister[arg1].length + 128] = 2
        _1086 = sha3(mem[ceil32(arg2.length) + 128 len publishedRegister[arg1].length + 32])
        mem[ceil32(arg2.length) + 128 len floor32(arg2.length)] = call.data[arg2 + 36 len floor32(arg2.length)]
        mem[ceil32(arg2.length) + floor32(arg2.length) + -(arg2.length % 32) + 160 len arg2.length % 32] = mem[floor32(arg2.length) + -(arg2.length % 32) + 160 len arg2.length % 32]
        if sha3(call.data[arg2 + 36 len floor32(arg2.length)], mem[ceil32(arg2.length) + floor32(arg2.length) + 128 len arg2.length % 32]) != stor[_1086]:
            emit ClaimResult(4);
            revert
    ...
    while ceil32(arg2.length) + publishedRegister[arg1].length + 128 > idx + 32:
        ...
        continue 
    mem[ceil32(arg2.length) + publishedRegister[arg1].length + 128] = 4
    stor[sha3(mem[ceil32(arg2.length) + 128 len stor3[arg1].length + 32])]--
    totalSupply++
