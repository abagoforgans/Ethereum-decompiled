    ...
    if not arg1:
        if 0 <= arg1:
            if arg4 == 18:
                ...
                if arg5^(-arg4 + 18):
                    if not arg1 / arg5^(-arg4 + 18):
                        return 0
                    if arg1 / arg5^(-arg4 + 18):
                        if arg1 / arg5^(-arg4 + 18) * arg2 / arg1 / arg5^(-arg4 + 18) == arg2:
                            return (arg1 / arg5^(-arg4 + 18) * arg2)
    else:
        if arg1:
            if arg1 * arg3 / arg1 == arg3:
                if arg1 * arg3 / 10^18 <= arg1:
                    if arg4 == 18:
                        ...
                        if arg5^(-arg4 + 18):
                            if not arg1 - (arg1 * arg3 / 10^18) / arg5^(-arg4 + 18):
                                return 0
                            if arg1 - (arg1 * arg3 / 10^18) / arg5^(-arg4 + 18):
                                if arg1 - (arg1 * arg3 / 10^18) / arg5^(-arg4 + 18) * arg2 / arg1 - (arg1 * arg3 / 10^18) / arg5^(-arg4 + 18) == arg2:
                                    return (arg1 - (arg1 * arg3 / 10^18) / arg5^(-arg4 + 18) * arg2)
    revert
}
...
function buyTokens(address arg1, address arg2) payable {
    ...
    if not msg.value:
        ...
        if tokenDecimals[address(arg2)] == 18:
            ...
            require exp^(-tokenDecimals[address(arg2)] + 18)
            if not msg.value / exp^(-tokenDecimals[address(arg2)] + 18):
                require ext_code.size(arg2)
                staticcall arg2.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                ...
                require msg.value / exp^(-tokenDecimals[address(arg2)] + 18)
                require msg.value / exp^(-tokenDecimals[address(arg2)] + 18) * sub_9e3ed8cf[address(arg2)] / msg.value / exp^(-tokenDecimals[address(arg2)] + 18) == sub_9e3ed8cf[address(arg2)]
                require ext_code.size(arg2)
                staticcall arg2.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if msg.value / exp^(-tokenDecimals[address(arg2)] + 18) * sub_9e3ed8cf[address(arg2)] <= ext_call.return_data[0]:
                    require ext_code.size(arg2)
                    call arg2.0xa9059cbb with:
                         gas gas_remaining wei
                        args address(arg1), msg.value / exp^(-tokenDecimals[address(arg2)] + 18) * sub_9e3ed8cf[address(arg2)]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    emit TokenPurchase(msg.value, msg.value / exp^(-tokenDecimals[address(arg2)] + 18) * sub_9e3ed8cf[address(arg2)], msg.sender, arg1);
                    require tokensBought[address(arg2)] + (msg.value / exp^(-tokenDecimals[address(arg2)] + 18) * sub_9e3ed8cf[address(arg2)]) >= tokensBought[address(arg2)]
                    tokensBought[address(arg2)] += msg.value / exp^(-tokenDecimals[address(arg2)] + 18) * sub_9e3ed8cf[address(arg2)]
                else:
                    require sub_9e3ed8cf[address(arg2)]
                    require ext_call.return_data[0] / sub_9e3ed8cf[address(arg2)] <= msg.value
                    call msg.sender with:
        ...
        if tokenDecimals[address(arg2)] == 18:
            ...
            require exp^(-tokenDecimals[address(arg2)] + 18)
            if not msg.value - (msg.value * tradingFee / 10^18) / exp^(-tokenDecimals[address(arg2)] + 18):
                require ext_code.size(arg2)
                staticcall arg2.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                ...
                require msg.value - (msg.value * tradingFee / 10^18) / exp^(-tokenDecimals[address(arg2)] + 18)
                require msg.value - (msg.value * tradingFee / 10^18) / exp^(-tokenDecimals[address(arg2)] + 18) * sub_9e3ed8cf[address(arg2)] / msg.value - (msg.value * tradingFee / 10^18) / exp^(-tokenDecimals[address(arg2)] + 18) == sub_9e3ed8cf[address(arg2)]
                require ext_code.size(arg2)
                staticcall arg2.0x70a08231 with:
                        gas gas_remaining wei
                       args this.address
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                if msg.value - (msg.value * tradingFee / 10^18) / exp^(-tokenDecimals[address(arg2)] + 18) * sub_9e3ed8cf[address(arg2)] <= ext_call.return_data[0]:
                    require ext_code.size(arg2)
                    call arg2.0xa9059cbb with:
                         gas gas_remaining wei
                        args address(arg1), msg.value - (msg.value * tradingFee / 10^18) / exp^(-tokenDecimals[address(arg2)] + 18) * sub_9e3ed8cf[address(arg2)]
                    if not ext_call.success:
                        revert with ext_call.return_data[0 len return_data.size]
                    require return_data.size >= 32
                    emit TokenPurchase(msg.value, msg.value - (msg.value * tradingFee / 10^18) / exp^(-tokenDecimals[address(arg2)] + 18) * sub_9e3ed8cf[address(arg2)], msg.sender, arg1);
                    require tokensBought[address(arg2)] + (msg.value - (msg.value * tradingFee / 10^18) / exp^(-tokenDecimals[address(arg2)] + 18) * sub_9e3ed8cf[address(arg2)]) >= tokensBought[address(arg2)]
                    tokensBought[address(arg2)] += msg.value - (msg.value * tradingFee / 10^18) / exp^(-tokenDecimals[address(arg2)] + 18) * sub_9e3ed8cf[address(arg2)]
                else:
                    require sub_9e3ed8cf[address(arg2)]
                    require ext_call.return_data[0] / sub_9e3ed8cf[address(arg2)] <= msg.value
                    call msg.sender with:
