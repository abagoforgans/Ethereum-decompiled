...
function _fallback() payable {
    ...
    mem[96 len -8663] = code.data[9251 len -8663]
    mem[64] = -8567
    stor11 = msg.sender
    stor3 = msg.sender
...
uint256 decimals;
uint256 minCap;
uint256 ownersProductCommissionInPerc;
uint256 operatorProductCommissionInPerc;
...
function operatorProductCommissionInPerc() {
    return operatorProductCommissionInPerc
}
...
function ownersProductCommissionInPerc() {
    return ownersProductCommissionInPerc
}
...
function setOwnersCommission(uint256 arg1) {
    require owner == msg.sender
    require arg1 >= 0
    ownersProductCommissionInPerc = arg1
    emit OwnersProductCommissionChanged(arg1);
}

function setOperatorCommission(uint256 arg1) {
    require owner == msg.sender
    require arg1 >= 0
    operatorProductCommissionInPerc = arg1
    emit OperatorProductCommissionChanged(arg1);
}
...
function upgrade(uint256 arg1) {
    if stor4:
        require not upgradeAgentAddress
    require not arg1
...
function burn(uint256 arg1) {
    ...
    delegate 0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d.0xf4f3bdc1 with:
         gas gas_remaining - 710 wei
...
function ownersProductAdded(address arg1, uint256 arg2, address arg3) {
    require owner == msg.sender
    require not stor6
    require arg2 > 100
    require arg1
    require arg3
    require ext_code.size(0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d)
    delegate 0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d.0xa12f69e0 with:
         gas gas_remaining - 710 wei
        args arg2, 100
    require delegate.return_code
    require ext_code.size(0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d)
    delegate 0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d.0x1d3b9edf with:
         gas gas_remaining - 710 wei
        args delegate.return_data[0], ownersProductCommissionInPerc
    require delegate.return_code
    require ext_code.size(0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d)
    delegate 0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d.0xf4f3bdc1 with:
         gas gas_remaining - 710 wei
    ...
    if delegate.return_data[0] > 0:
        ...
        delegate 0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d.0x66098d4f with:
             gas gas_remaining - 710 wei
            args totalSupply, delegate.return_data[0]
        require delegate.return_code
        totalSupply = delegate.return_data[0]
        require ext_code.size(0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d)
        delegate 0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d.0x66098d4f with:
             gas gas_remaining - 710 wei
            args balanceOf[address(arg1)], delegate.return_data[0]
        require delegate.return_code
        balanceOf[address(arg1)] = delegate.return_data[0]
        emit Transfer(delegate.return_data[0], 0, arg1);
    if delegate.return_data[0] > 0:
        require stor7[address(msg.sender)]
        require not stor6
        require ext_code.size(0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d)
        ...
        delegate 0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d.0x66098d4f with:
             gas gas_remaining - 710 wei
            args balanceOf[address(arg3)], delegate.return_data[0]
        require delegate.return_code
        balanceOf[address(arg3)] = delegate.return_data[0]
        emit Transfer(delegate.return_data[0], 0, arg3);
    emit OwnersProductAdded(address(arg1), arg2, arg3);
}

function independentSellerJoined(address arg1, uint256 arg2, address arg3) {
    require owner == msg.sender
    require not stor6
    require arg2 > 100
    require arg1
    ...
    delegate 0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d.0x1d3b9edf with:
         gas gas_remaining - 710 wei
        args delegate.return_data[0], operatorProductCommissionInPerc
    require delegate.return_code
    require ext_code.size(0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d)
    delegate 0xcd1279f36dbfd19d7ad917f5d86e375a8d7c970d.0xf4f3bdc1 with:
         gas gas_remaining - 710 wei
    ...
    if delegate.return_data[0] > 0:
        ...
        balanceOf[address(arg1)] = delegate.return_data[0]
        emit Transfer(delegate.return_data[0], 0, arg1);
    emit IndependentSellerJoined(address(arg1), arg2, arg3);
}
...
function setReservedTokensListMultiple(address[] arg1, uint256[] arg2, uint256[] arg3, uint256[] arg4) {
    ...
    while idx < arg1.length:
        ...
        _33 = mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + 192]
        require idx < mem[(32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 192]
        _35 = mem[(32 * idx) + (32 * arg1.length) + (32 * arg2.length) + (32 * arg3.length) + 224]
        require owner == msg.sender
        reservedTokensDestinations.length++
        if not reservedTokensDestinations.length > reservedTokensDestinations.length + 1:
            mem[0] = 9
