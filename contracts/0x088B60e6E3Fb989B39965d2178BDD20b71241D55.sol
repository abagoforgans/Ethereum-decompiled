...
const _fallback = code.data[18 len 2335]
...
function sub_c328395e(?) payable {
    ...
    mem[480] = stor0[arg1][2][arg2].length
    mem[512] = stor0[arg1][2][arg2].field_0
    idx = 512
    s = 0
    while stor0[arg1][2][arg2].length + 512 > idx + 32:
        mem[idx + 32] = stor0[arg1][2][arg2][s].field_256
        idx = idx + 32
        s = s + 1
        continue 
    mem[416] = 480
    mem[64] = ceil32(stor0[arg1][2][arg2].length) + ceil32(stor0[arg1][2][arg2][1].length) + 544
    mem[ceil32(stor0[arg1][2][arg2].length) + 512] = stor0[arg1][2][arg2][1].length
    mem[0] = sha3(arg2, sha3(arg1, 0) + 2) + 1
    mem[ceil32(stor0[arg1][2][arg2].length) + 544] = stor0[arg1][2][arg2][1].field_0
    idx = ceil32(stor0[arg1][2][arg2].length) + 544
    s = 0
    while ceil32(stor0[arg1][2][arg2].length) + stor0[arg1][2][arg2][1].length + 512 > idx:
        mem[idx + 32] = stor0[arg1][2][arg2][s + 1].field_256
        idx = idx + 32
        s = s + 1
        continue 
    mem[448] = ceil32(stor0[arg1][2][arg2].length) + 512
    mem[ceil32(stor0[arg1][2][arg2].length) + ceil32(stor0[arg1][2][arg2][1].length) + 544] = 64
    mem[ceil32(stor0[arg1][2][arg2].length) + ceil32(stor0[arg1][2][arg2][1].length) + 608] = stor0[arg1][2][arg2].length
    mem[ceil32(stor0[arg1][2][arg2].length) + ceil32(stor0[arg1][2][arg2][1].length) + 640 len stor0[arg1][2][arg2].length] = mem[512 len stor0[arg1][2][arg2].length]
    mem[ceil32(stor0[arg1][2][arg2].length) + ceil32(stor0[arg1][2][arg2][1].length) + 576] = stor0[arg1][2][arg2].length + 96
    mem[stor0[arg1][2][arg2].length + ceil32(stor0[arg1][2][arg2].length) + ceil32(stor0[arg1][2][arg2][1].length) + 640] = stor0[arg1][2][arg2][1].length
    mem[stor0[arg1][2][arg2].length + ceil32(stor0[arg1][2][arg2].length) + ceil32(stor0[arg1][2][arg2][1].length) + 672 len stor0[arg1][2][arg2][1].length] = mem[ceil32(stor0[arg1][2][arg2].length) + 544 len stor0[arg1][2][arg2][1].length]
    if not stor0[arg1][2][arg2][1].length % 32:
        return Array(len=stor0[arg1][2][arg2].length, data=mem[512 len stor0[arg1][2][arg2].length], stor0[arg1][2][arg2][1].length, mem[ceil32(stor0[arg1][2][arg2].length) + 544 len stor0[arg1][2][arg2][1].length]), 
               stor0[arg1][2][arg2].length + 96
    mem[floor32(stor0[arg1][2][arg2][1].length) + stor0[arg1][2][arg2].length + ceil32(stor0[arg1][2][arg2].length) + ceil32(stor0[arg1][2][arg2][1].length) + 672] = mem[floor32(stor0[arg1][2][arg2][1].length) + stor0[arg1][2][arg2].length + ceil32(stor0[arg1][2][arg2].length) + ceil32(stor0[arg1][2][arg2][1].length) + -stor0[arg1][2][arg2][1].length % 32 + 704 len stor0[arg1][2][arg2][1].length % 32]
    return Array(len=stor0[arg1][2][arg2].length, data=mem[512 len stor0[arg1][2][arg2].length], stor0[arg1][2][arg2][1].length, mem[ceil32(stor0[arg1][2][arg2].length) + ceil32(stor0[arg1][2][arg2][1].length) + stor0[arg1][2][arg2].length + 672 len floor32(stor0[arg1][2][arg2][1].length) + 32]), 
           stor0[arg1][2][arg2].length + 96
}
