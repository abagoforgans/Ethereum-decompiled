...
function _fallback() payable {
    ...
    return code.data[1002 len 9529]
}
...
const name = 'Bluebelt Exchange Coin'
...
function balanceOf(address arg1) {
    mem[416] = stor1[address(arg1)]
    idx = 0
    while idx < stor4.length:
        mem[32] = 5
        require idx < 4
        require idx + 1 < 5
        mem[(32 * idx + 1) + 416] = stor5[address(arg1)][idx].field_0
        ...
        if block.timestamp >= stor('array', ('div', 0.25, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]:
            ...
            mem[32] = 5
            require idx < 4
            require mem[416] + stor5[address(arg1)][idx].field_0 >= mem[416]
            mem[416] = mem[416] + stor5[address(arg1)][idx].field_0
            require idx + 1 < 5
            mem[(32 * idx + 1) + 416] = 0
        idx = idx + 1
        continue 
...
function lockupOf(address arg1) {
    mem[288 len 128] = 0
    mem[256] = stor1[address(arg1)]
    idx = 0
    while idx < stor4.length:
        mem[32] = 5
        require idx < 4
        require idx + 1 < 5
        mem[(32 * idx + 1) + 256] = stor5[address(arg1)][idx].field_0
        require idx < stor4.length
        mem[0] = 4
        if block.timestamp >= stor('array', ('div', 0.25, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]:
            mem[0] = arg1
            mem[32] = 5
            require idx < 4
            require mem[256] + stor5[address(arg1)][idx].field_0 >= mem[256]
            mem[256] = mem[256] + stor5[address(arg1)][idx].field_0
            require idx + 1 < 5
            mem[(32 * idx + 1) + 256] = 0
        idx = idx + 1
        continue 
...
function transfer(address arg1, uint256 arg2) {
    ...
    if block.timestamp <= stor4:
        ...
        while idx < 4:
            ...
            mem[32] = 5
            require idx < 4
            stor5[address(arg1)][idx].field_0 = mem[(32 * idx + 1) + 416]
            idx = idx + 1
            continue 
    else:
        if not stor8:
...
function sub_9745ad32(?) {
    require msg.sender == owner
    require arg1
    require 3 < stor4.length
    if block.timestamp <= stor4:
        mem[448 len 128] = 0
        mem[416] = stor1[address(msg.sender)]
        idx = 0
        while idx < stor4.length:
            mem[32] = 5
            require idx < 4
            require idx + 1 < 5
            mem[(32 * idx + 1) + 416] = stor5[address(msg.sender)][idx].field_0
            require idx < stor4.length
            mem[0] = 4
            if block.timestamp >= stor('array', ('div', 0.25, ('var', 0)), ('name', 'stor4', 4))[uint8(idx)]:
                mem[0] = msg.sender
                mem[32] = 5
                require idx < 4
                require mem[416] + stor5[address(msg.sender)][idx].field_0 >= mem[416]
                mem[416] = mem[416] + stor5[address(msg.sender)][idx].field_0
                require idx + 1 < 5
                mem[(32 * idx + 1) + 416] = 0
            idx = idx + 1
            continue 
        stor1[address(msg.sender)] = mem[416]
        idx = 0
        while idx < 4:
            require idx + 1 < 5
            mem[0] = msg.sender
            mem[32] = 5
            require idx < 4
            stor5[address(msg.sender)][idx].field_0 = mem[(32 * idx + 1) + 416]
            idx = idx + 1
            continue 
    else:
        if not stor8:
    ...
    require arg6 >= 0
    require arg2 >= 0
    require arg3 + arg4 + arg5 + arg6 + arg2 <= stor1[address(msg.sender)]
    stor1[address(msg.sender)] = stor1[address(msg.sender)] - arg3 - arg4 - arg5 - arg6 - arg2
    require stor1[address(arg1)] + arg2 >= stor1[address(arg1)]
    stor1[address(arg1)] += arg2
    ...
    stor6[stor7] = arg1
    stor7++
    emit Transfer((arg3 + arg4 + arg5 + arg6 + arg2), msg.sender, arg1);
    return 1
}
