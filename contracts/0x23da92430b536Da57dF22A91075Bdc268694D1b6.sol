...
function sub_480945df(?) payable {
    ...
    while idx < stor8.length:
        mem[0] = stor[code.data[4968 len 32] + idx]
        mem[32] = 6
        stor6[stor[code.data[4968 len 32] + idx]] = arg1 * stor7[stor[idx + code.data[4968 len 32]]]
        idx = idx + 1
        continue 
}
...
function setBasePrice(uint256 arg1) payable {
    ...
    while idx < stor8.length:
        mem[0] = stor[code.data[4968 len 32] + idx]
        mem[32] = 6
        stor6[stor[code.data[4968 len 32] + idx]] = arg1 * stor7[stor[code.data[4968 len 32] + idx]]
        idx = idx + 1
        continue 
}
