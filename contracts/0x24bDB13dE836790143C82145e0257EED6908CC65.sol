...
function _fallback() {
    stor0 = msg.sender
    require code.data[5842 len 20]
    stor1 = code.data[5842 len 20]
    if msg.value > 0:
        stor3 += msg.value
        stor4[stor1] += msg.value
        emit LogPaymentReceived(msg.value, stor1);
    stor2 = code.data[5862 len 32]
    ...
    require code.data[5906 len 20]
    stor5 = code.data[5906 len 20]
    return code.data[427 len 5403]
}
...
function _fallback() payable {
    if msg.value > 0:
        ...
        paymentOf[stor1] += msg.value
        emit LogPaymentReceived(msg.value, beneficiaryAddress);
}

function setBeneficiary(address arg1) {
    require owner == msg.sender
    require arg1
    if beneficiaryAddress != arg1:
        emit LogBeneficiarySet(beneficiaryAddress, arg1);
...
function setCertifierDb(address arg1) {
    require owner == msg.sender
    require arg1
    if certifierDbAddress != arg1:
        emit LogCertifierDbChanged(certifierDbAddress, arg1);
        certifierDbAddress = arg1
    return 1
}

function fixBalance() {
    if totalBalance < eth.balance(this.address):
        paymentOf[stor1] = eth.balance(this.address) - totalBalance + paymentOf[stor1]
        emit LogPaymentReceived((eth.balance(this.address) - totalBalance), beneficiaryAddress);
    return 1
}
...
function addCertificationDocumentToSelf(bytes32 arg1) {
    ...
    if not stor6[address(msg.sender)][3][arg1].field_0:
        ...
        stor[stor6[address(msg.sender)].field_1024 + ('array', 4, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'stor6', 6)))].field_0 = arg1
        emit LogCertificationDocumentAdded(msg.sender, arg1);
    return 1
}

function addCertificationDocument(address arg1, bytes32 arg2) {
    require ext_code.size(certifierDbAddress)
    call certifierDbAddress.0x1c2353e1 with:
    ...
    if not stor6[address(arg1)][3][arg2].field_0:
        ...
        stor6[address(arg1)].field_1024++
        stor[stor6[address(arg1)].field_1024 + ('array', 4, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'stor6', 6)))].field_0 = arg2
...
function certify(address arg1, bytes32 arg2) {
    ...
    stor6[address(arg1)].field_512 = msg.sender
...
function uncertify(address arg1) {
    ...
    stor6[address(arg1)].field_1024 = 0
    if sha3(sha3(address(arg1), 6) + 4) + stor6[address(arg1)].field_1024 > sha3(sha3(address(arg1), 6) + 4):
        stor6[address(arg1)][4].field_0 = 0
        idx = 1
        while stor6[address(arg1)].field_1024 > idx:
            stor6[address(arg1)][idx + 4].field_0 = 0
            idx = idx + 1
    ...
    if stor7.length > 1:
        ...
        address(stor7[stor6[address(arg1)].field_1280]) = address(stor7[stor7.length])
...
function removeCertificationDocumentFromSelf(bytes32 arg1) {
    ...
    if stor6[address(msg.sender)][3][arg1].field_0:
        ...
        if not stor6[address(msg.sender)].field_1024 <= stor6[address(msg.sender)].field_1024 - 1:
            stor[stor6[address(msg.sender)].field_1024 + ('array', 4, ('map', ('mask_shl', 160, 0, 0, 'msg.sender'), ('name', 'stor6', 6)))].field_0 = 0
            idx = stor6[address(msg.sender)].field_1024
...
function removeCertificationDocument(address arg1, bytes32 arg2) {
    ...
    if stor6[address(arg1)][3][arg2].field_0:
        ...
        if not stor6[address(arg1)].field_1024 <= stor6[address(arg1)].field_1024 - 1:
            stor[stor6[address(arg1)].field_1024 + ('array', 4, ('map', ('mask_shl', 160, 0, 0, ('param', 'arg1')), ('name', 'stor6', 6)))].field_0 = 0
            idx = stor6[address(arg1)].field_1024
            while stor6[address(arg1)].field_1024 > idx:
                stor6[address(arg1)][idx + 4].field_0 = 0
                idx = idx + 1
                continue 
