...
function vote(uint256 arg1, bool arg2, string arg3) payable {
    ...
    require uint8(stor[code.data[5188 len 32] + (3 * stor8[address(msg.sender)])].field_160)
    require arg1 < proposals.length
...
function members(uint256 arg1) payable {
    ...
    while stor[(3 * arg1) + 0x6e1540171b6c0c960b71a7020d9f60077f6af931a8bbf590da0223dacf75c7b0].length + 256 > idx + 32:
        ...
        s = s + 1
        continue 
    return address(stor[(3 * arg1) + code.data[5188 len 32]].field_0), 
           uint8(stor[(3 * arg1) + code.data[5188 len 32]].field_0),
...
function changeMembership(address arg1, bool arg2, string arg3) payable {
    ...
    if memberId[address(arg1)]:
        ...
        Mask(96, 0, stor[code.data[5188 len 32] + (3 * stor8[address(arg1)])].field_160) = Mask(96, 0, arg2)
    else:
...
function Congress(uint256 arg1, uint256 arg2, int256 arg3, address arg4) payable {
    ...
    Mask(168, 0, stor[code.data[5188 len 32]].field_0) = 0
    stor[code.data[5188 len 32]].field_256 % 1 = 0
    stor[code.data[5188 len 32]].field_256 % 1 = 0
    stor[code.data[5188 len 32]].field_256 % 1 = 0
    bool(stor1[code.data[5188 len 32]].field_0) = 0
    uint255(stor1[code.data[5188 len 32]].field_1) = 0
    Mask(248, 0, stor1[code.data[5188 len 32]].field_8) = mem[256 len 31]
    idx = 0
    while stor[code.data[5188 len 32] + 1].length + 31 / 32 > idx:
        uint256(stor[idx + sha3(code.data[5188 len 32] + 1)].field_0) = 0
        idx = idx + 1
        continue 
    stor2[code.data[5188 len 32]] = block.timestamp
    if arg4 != 0:
