...
function _fallback() payable {
    ...
    mem[160 len -5624] = code.data[6202 len -5624]
    stor0 = msg.sender
    stor4 = mem[160]
    stor6[address(msg.sender)] = stor4
    stor3 = mem[223 len 1]
    stor1[] = Array(len=mem[mem[224] + 160], data=mem[mem[224] + 192 len mem[mem[224] + 160]])
    stor2[] = Array(len=mem[mem[256] + 160], data=mem[mem[256] + 192 len mem[mem[256] + 160]])
    return code.data[578 len 5624]
}
