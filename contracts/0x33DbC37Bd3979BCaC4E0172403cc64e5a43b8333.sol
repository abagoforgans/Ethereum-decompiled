...
function _fallback() payable {
    ...
    stor0 = code.data[1673 len 20]
    stor1 = 10^18 * code.data[1693 len 32]
    stor3 = block.timestamp + (60 * code.data[1725 len 32])
    stor4 = 10^18
    require code.data[1757 len 32]
    stor4 = 10^18 / code.data[1757 len 32]
    stor5 = code.data[1801 len 20]
    return code.data[188 len 1473]
}
