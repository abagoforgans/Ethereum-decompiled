...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'Meridian' / 256
    idx = 0
...
function TokenERC20(uint256 arg1, string arg2, string arg3) {
    totalSupply = 125 * 10^6 * 10^decimals
    balanceOf[address(msg.sender)] = 125 * 10^6 * 10^decimals
    bool(name.length) = 0
    name.length.field_1 = 8
    name.length.field_8 = 'Meridian' / 256
    idx = 0
