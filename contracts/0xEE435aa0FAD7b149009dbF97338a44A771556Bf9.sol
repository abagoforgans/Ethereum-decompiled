...
function ethDeposits(address arg1) {
    return ethDeposits[arg1].field_0
}
...
function rescueEth() {
    ...
    require ext_call.success
    require ext_code.size(address(etherTokenAddress))
    call address(etherTokenAddress).0xa9059cbb with:
         gas gas_remaining - 710 wei
...
function withdrawEth() {
    if not ethDeposits[address(msg.sender)].field_0:
        return 0
    ethDeposits[address(msg.sender)].field_0 = 0
    ethDeposits[address(msg.sender)].field_1 = ethDeposits[address(msg.sender)].field_0
    ethTotal -= ethDeposits[address(msg.sender)].field_0
    require ext_code.size(address(etherTokenAddress))
    call address(etherTokenAddress).0xa9059cbb with:
         gas gas_remaining - 710 wei
        args msg.sender, ethDeposits[address(msg.sender)].field_0
    require ext_call.success
    return 1
}
...
function withdraw() {
    ...
    call address(etherTokenAddress).0x2e1a7d4d with:
         gas gas_remaining - 710 wei
        args ethDeposits[address(msg.sender)].field_0
    require ext_call.success
    call msg.sender with:
       value ethDeposits[address(msg.sender)].field_0 wei
         gas 2300 * is_zero(value) wei
    return 1
}

function sub_4261d97b(?) {
    if not sub_0828d0df[address(msg.sender)]:
        return 0
    sub_0828d0df[address(msg.sender)] = 0
    sub_77ac2957 -= sub_0828d0df[address(msg.sender)]
    require ext_code.size(tokenChangerAddress)
    ...
    require ext_call.success
    ethDeposits[address(msg.sender)].field_0 += ext_call.return_data[0]
    ethTotal += ext_call.return_data[0]
    return 1
}
...
function long() payable {
    ...
    require ext_call.success
    sub_77ac2957 += ext_call.return_data[0]
    sub_0828d0df[address(msg.sender)] += ext_call.return_data[0]
    emit 0x5b4dd6fe: 0, ext_call.return_data[0], msg.sender
    return ext_call.return_data[0]
}

function sub_35f2e0a7(?) payable {
    require ext_code.size(address(etherTokenAddress))
    call address(etherTokenAddress).deposit() with:
       value msg.value wei
         gas gas_remaining - 9710 wei
    ...
    if ext_call.return_data[0] > 0:
        if sub_0828d0df[address(msg.sender)]:
            sub_0828d0df[address(msg.sender)] = 0
            sub_77ac2957 -= sub_0828d0df[address(msg.sender)]
            require ext_code.size(tokenChangerAddress)
            call tokenChangerAddress.change(address rg1, address rg2, uint256 rg3, uint256 rg4) with:
