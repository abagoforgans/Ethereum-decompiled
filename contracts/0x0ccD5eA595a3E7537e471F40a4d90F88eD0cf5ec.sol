...
function _fallback() payable {
    ...
    if 4 * 10^16 != msg.value:
        ...
        require balanceOf[address(stor0.field_0)] >= 800 * 10^18
        require balanceOf[address(msg.sender)] + 800 * 10^18 > balanceOf[address(msg.sender)]
        call address(stor0.field_0) with:
           value msg.value wei
             gas 2300 * is_zero(value) wei
        require ext_call.success
        balanceOf[address(stor0.field_0)] -= 800 * 10^18
        balanceOf[msg.sender] += 800 * 10^18
        emit Transfer(800 * 10^18, address(stor0.field_0), msg.sender);
