...
const _fallback = code.data[18 len 1998]
...
function MyToken(uint256 arg1, string arg2, uint8 arg3, string arg4) payable {
    balanceOf[address(msg.sender)] = 777777
    uint8(name.length) = 14
    Mask(248, 0, name.length.field_8) = 'UckCoin' / 256
    ...
    while (name.length + 31 / 32) + 0x290decd9548b62a8d60345a988386fc84ba6bc95484008f6362f93160ef3e563 > idx:
        ...
        idx = idx + 1
        continue 
    uint8(symbol.length) = 2
    Mask(248, 0, symbol.length.field_8) = 'U' / 256
