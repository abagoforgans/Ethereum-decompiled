...
function _fallback() {
    stor0 = code.data[4284 len 20]
    stor1 = code.data[4316 len 20]
    stor3 = code.data[4336 len 32]
    stor2 = code.data[4368 len 32]
    return code.data[130 len 4142]
}
...
function takeSell(address arg1, uint256 arg2, uint256 arg3, address arg4) payable {
    ...
    require sellOrders[hash] >= msg.value
    require ext_code.size(arg1)
    call arg1.0xdd62ed3e with:
         gas gas_remaining - 710 wei
