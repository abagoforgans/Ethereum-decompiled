...
const _fallback = code.data[18 len 1113]
...
function sub_0ceed41c(?) payable {
    ...
    while idx < uint256(sub_a603ac6d[address(arg2)]):
        ...
        require idx < uint256(sub_a603ac6d[address(arg2)])
        address(sub_a603ac6d[address(arg2)][idx]) = 0
        uint256(sub_a603ac6d[address(arg3)])++
        if not uint256(sub_a603ac6d[address(arg3)]) <= uint256(sub_a603ac6d[address(arg3)]) + 1:
            mem[0] = sha3(address(arg3), 0)
            idx = sha3(mem[0]) + uint256(sub_a603ac6d[address(arg3)]) + 1
            while sha3(sha3(address(arg3), 0)) + uint256(sub_a603ac6d[address(arg3)]) > idx:
                uint256(stor[idx]) = 0
                mem[0] = arg2
                mem[32] = 0
                idx = idx + 1
                continue 
        require uint256(sub_a603ac6d[address(arg3)]) < uint256(sub_a603ac6d[address(arg3)])
        uint256(sub_a603ac6d[address(arg3)][uint256(sub_a603ac6d[address(arg3)])]) = arg4 or Mask(96, 160, uint256(sub_a603ac6d[address(arg3)][uint256(sub_a603ac6d[address(arg3)])]))
        return 1
    return 0
}
