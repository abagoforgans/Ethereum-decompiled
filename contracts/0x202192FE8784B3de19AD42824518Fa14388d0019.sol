...
function _fallback() payable {
    ...
    mem[96 len -6566] = code.data[7298 len -6566]
    mem[64] = -6470
    stor3 = msg.sender
    stor8 = msg.sender
    stor3 = msg.sender
...
function mint(address arg1, uint256 arg2) {
    ...
    require not stor6
    require ext_code.size(0xa373cd9cc6b2e3585f2215f0d41b769baa65361c)
    delegate 0xa373cd9cc6b2e3585f2215f0d41b769baa65361c.0x66098d4f with:
         gas gas_remaining - 50 wei
