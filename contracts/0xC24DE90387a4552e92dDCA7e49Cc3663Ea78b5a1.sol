...
function _fallback() payable {
    mem[96 len -3646] = code.data[3882 len -3646]
    mem[64] = -3550
            ...
            if stor259[call.data[0 len calldata.size]].field_0 > 1:
                ...
                if arg1 <= m_numOwners:
                    ...
                    while idx < stor260.length:
                        mem[0] = stor564C[idx]
                        mem[32] = 261
                        address(stor261[stor564C[idx]].field_0) = 0
                        stor261[stor564C[idx]].field_256 = 0
                        stor261[stor564C[idx]].field_512 = 0
                        if 31 < stor261[stor564C[idx]][2].length:
                            mem[0] = sha3(stor564C[idx], 261) + 2
                            s = sha3(sha3(stor564C[idx], 261) + 2)
                            while sha3(sha3(stor564C[idx], 261) + 2) + (stor261[stor564C[idx]][2].length + 31 / 32) > s:
                                stor[s] = 0
                                s = s + 1
                                continue 
                        idx = idx + 1
