...
function sub_e1e7ff77(?) payable {
    ...
    if (10000 * uint255(10^18 * ext_call.return_data[0] / 10^18) / 10^18 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / uint255(10^18 * ext_call.return_data[0] / 10^18) / 2) - 10000 >= 500:
        ...
        require (5 * 10^18 * ext_call.return_data[0] / uint255(10^18 * ext_call.return_data[0] / 10^18) / 50) + (5 * eth.balance(0x9cabec1ead1c0ba254b09efb3ee13841712be14) / 50) + (50000 / (10000 * uint255(10^18 * ext_call.return_data[0] / 10^18) / 10^18 * ext_call.return_data[0] / 10^18 * ext_call.return_data[0] / uint255(10^18 * ext_call.return_data[0] / 10^18) / 2) - 10000 * 10^18 * ext_call.return_data[0] / uint255(10^18 * ext_call.return_data[0] / 10^18) / 2 / 100)
