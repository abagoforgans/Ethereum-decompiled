...
function _fallback() payable {
    stor2[code.data[9472 len 20]].field_768 = code.data[9492 len 32]
    stor2[address(code.data[9460 len 32])][1][address(code.data[9460 len 32])].field_0 = 1
    stor2[address(code.data[9460 len 32])].field_512 = 1
    stor2[address(code.data[9460 len 32])].field_520 = 1
    stor2[address(code.data[9460 len 32])].field_1024 = block.timestamp
    return code.data[436 len 9024]
}
