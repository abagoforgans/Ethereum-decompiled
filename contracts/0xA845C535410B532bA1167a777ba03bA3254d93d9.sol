...
function _fallback() payable {
    ...
    stor4 = code.data[6043 len 32]
    emit 0x1d0ce96c: msg.sender, code.data[6043 len 32], Mask(64, 192, code.data[6075 len 32])
    return code.data[224 len 5819]
}
...
function sub_3b7416ad(?) {
    require not uint8(stor0.field_160)
    require block.timestamp < expireDate
    require ext_code.size(arg2)
    call arg2.cancel(address rg1) with:
         gas gas_remaining - 710 wei
        args arg1
    require ext_call.success
...
function sub_f401e49a(?) payable {
    ...
    create contract with callvalue wei
                    code: code.data[4003 len 1773], address(arg1), arg2 << 224, arg3 << 248, arg4, sub_2511b4f9 + 1 << 224
