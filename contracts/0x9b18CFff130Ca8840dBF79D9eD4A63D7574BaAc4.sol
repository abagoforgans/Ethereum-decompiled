...
function _fallback() {
    ...
    stor4 = code.data[6078 len 32]
    stor5 = block.timestamp + code.data[6078 len 32]
    return code.data[158 len 5920]
}
...
function offer(uint256 arg1, address arg2, uint256 arg3, address arg4) {
    ...
    require arg2 != arg4
    last_offer_id++
    offers[stor3 + 1].field_0 = arg1
    offers[stor3 + 1].field_256 = arg2
    offers[stor3 + 1].field_512 = arg3
    offers[stor3 + 1].field_768 = arg4
    offers[stor3 + 1].field_1024 = msg.sender
    offers[stor3 + 1].field_1184 = 1
    offers[stor3 + 1].field_1192 = uint64(block.timestamp)
    offers[stor3 + 1].field_1256 = 0
...
function make(address arg1, address arg2, uint128 arg3, uint128 arg4) {
    ...
    require arg1 != arg2
    last_offer_id++
    offers[stor3 + 1].field_0 = arg3
    offers[stor3 + 1].field_128 = 0
    offers[stor3 + 1].field_256 = arg1
    offers[stor3 + 1].field_512 = arg4
    offers[stor3 + 1].field_640 = 0
    offers[stor3 + 1].field_768 = arg2
    offers[stor3 + 1].field_1024 = msg.sender
    offers[stor3 + 1].field_1184 = 1
    offers[stor3 + 1].field_1192 = uint64(block.timestamp)
    offers[stor3 + 1].field_1256 = 0
