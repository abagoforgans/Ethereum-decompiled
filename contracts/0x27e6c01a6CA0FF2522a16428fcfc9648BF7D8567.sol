...
function sub_e33437b4(?) {
    ...
    call stor[mem[ceil32(arg1.length) + floor32(arg1.length) + 128 len (arg1.length % 32) + 32]][call.data[arg1 + 36 len floor32(arg1.length)]].approve(address arg1, uint256 arg2) with:
         gas gas_remaining wei
        args address(arg2), 1000000000000 * 10^18
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
