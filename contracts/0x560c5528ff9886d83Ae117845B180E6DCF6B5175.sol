...
function _fallback() {
    stor5 = 10^18
    stor6[code.data[6657 len 20]] = 10^18
    ...
    Mask(248, 0, stor11.length.field_8) = '0.2' / 256
    if (stor11.length + 31 / 32) + 0x175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9 > 0x175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9:
        ...
        while (stor11.length + 31 / 32) + 0x175b7a638427703f0dbe7bb9bbf987a2551717b34e79f33b5b1008d1fa01db9 > idx:
            ...
            idx = idx + 1
            continue 
    stor0 = address(code.data[6645 len 32])
    stor2 = address(code.data[6645 len 32])
    address(stor3.field_0) = address(code.data[6645 len 32])
    uint8(stor3.field_160) = 0
    stor12 = 10^18
    stor13 = 18
    return code.data[906 len 5739]
}
...
function sub_91c934fc(?) {
    ...
    if not arg1:
        if totalSupply > 0:
            if totalSupply:
                if totalGold * arg1 == (totalSupply * totalGold * arg1 / totalSupply) + (totalGold * arg1 % totalSupply):
                    return (totalGold * arg1 / totalSupply)
    else:
        if totalGold * arg1 / arg1 == totalGold:
            if totalSupply > 0:
                if totalSupply:
                    if totalGold * arg1 == (totalSupply * totalGold * arg1 / totalSupply) + (totalGold * arg1 % totalSupply):
                        return (totalGold * arg1 / totalSupply)
...
function redeem(uint256 arg1) {
    ...
    require totalGold > 0
    require totalGold
    require arg1 * totalSupply == (totalGold * arg1 * totalSupply / totalGold) + (arg1 * totalSupply % totalGold)
    require arg1 * totalSupply / totalGold <= balanceOf[address(stor3.field_0)]
    balanceOf[address(stor3.field_0)] -= arg1 * totalSupply / totalGold
    require arg1 * totalSupply / totalGold <= totalSupply
    totalSupply -= arg1 * totalSupply / totalGold
    require arg1 <= totalGold
    totalGold -= arg1
    emit 0x8406ebce: Array(len=6, data='redeem'), arg1 * totalSupply / totalGold, arg1, safeAddress
    return 1
}
...
function sub_3a5d4daf(?) {
    if not balanceOf[address(arg1)]:
        if totalSupply > 0:
            if totalSupply:
                if totalGold * balanceOf[address(arg1)] == (totalSupply * totalGold * balanceOf[address(arg1)] / totalSupply) + (totalGold * balanceOf[address(arg1)] % totalSupply):
                    return (totalGold * balanceOf[address(arg1)] / totalSupply)
    else:
        if totalGold * balanceOf[address(arg1)] / balanceOf[address(arg1)] == totalGold:
            if totalSupply > 0:
                if totalSupply:
                    if totalGold * balanceOf[address(arg1)] == (totalSupply * totalGold * balanceOf[address(arg1)] / totalSupply) + (totalGold * balanceOf[address(arg1)] % totalSupply):
                        return (totalGold * balanceOf[address(arg1)] / totalSupply)
...
function create(uint256 arg1) {
    ...
    require totalGold
    require arg1 * totalSupply == (totalGold * arg1 * totalSupply / totalGold) + (arg1 * totalSupply % totalGold)
    require (arg1 * totalSupply / totalGold) + balanceOf[address(stor3.field_0)] >= balanceOf[address(stor3.field_0)]
    require (arg1 * totalSupply / totalGold) + balanceOf[address(stor3.field_0)] >= arg1 * totalSupply / totalGold
    balanceOf[address(stor3.field_0)] += arg1 * totalSupply / totalGold
    require (arg1 * totalSupply / totalGold) + totalSupply >= totalSupply
    require (arg1 * totalSupply / totalGold) + totalSupply >= arg1 * totalSupply / totalGold
    totalSupply += arg1 * totalSupply / totalGold
    require arg1 + totalGold >= totalGold
    require arg1 + totalGold >= arg1
    totalGold += arg1
    emit 0x8406ebce: Array(len=6, data='create'), arg1 * totalSupply / totalGold, arg1, safeAddress
    return 1
}
