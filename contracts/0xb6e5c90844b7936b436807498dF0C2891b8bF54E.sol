...
function pendingWhitelistHash(address[] arg1) {
    ...
    mem[(64 * arg1.length) + floor32(96 * arg1.length) + 160] = mem[(64 * arg1.length) + floor32(96 * arg1.length) + 160] and 256^(-(96 * arg1.length % 32) + 32) - 1 or mem[(32 * arg1.length) + floor32(96 * arg1.length) + 160] and !(256^(-(96 * arg1.length % 32) + 32) - 1)
    mem[(64 * arg1.length) + 160] = sha3(mem[(64 * arg1.length) + 160 len 223 * arg1.length])
    return memory
...
function bulkTransfer(address arg1, address[] arg2) {
    ...
    while idx < arg2.length:
        ...
        if not mem[(32 * idx) + 140 len 20]:
            ...
            if stor3[address(arg1)]:
                if not mem[(32 * idx) + 140 len 20]:
                    ...
                    call mem[(32 * idx) + 140 len 20].0xa9059cbb with:
                         gas gas_remaining wei
                ...
                if not mem[(32 * idx) + 140 len 20]:
                    ...
                    if ext_call.return_data[0]:
                        ...
                        if not address(_1118):
                            ...
                            call address(_1118).0xa9059cbb with:
                                 gas gas_remaining wei
                                args address(arg1), eth.balance(this.address)
                            if not ext_call.success:
                                revert with ext_call.return_data[0 len return_data.size]
        ...
        call address(_1114).0x70a08231 with:
             gas gas_remaining wei
            args this.address
            ...
            if not mem[(32 * idx) + 140 len 20]:
                ...
                if ext_call.return_data[0]:
                    ...
                    if not address(_1122):
                        ...
                        call address(_1122).0xa9059cbb with:
                             gas gas_remaining wei
                            args address(arg1), ext_call.return_data[0]
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
