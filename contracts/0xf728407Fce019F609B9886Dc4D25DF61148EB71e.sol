            ...
            if tokensPerEth * msg.value / 10^18:
                ...
                if stor4[address(msg.sender)]:
                    ...
                    if progress0drop > target0drop:
                        ...
                        require not distributionFinished
                        require totalDistributed + 20000 >= totalDistributed
                        totalDistributed += 20000
                        require balanceOf[address(msg.sender)] + 20000 >= balanceOf[address(msg.sender)]
                        balanceOf[address(msg.sender)] += 20000
                        emit Distr(20000, msg.sender);
                        emit Transfer(20000, 0, msg.sender);
