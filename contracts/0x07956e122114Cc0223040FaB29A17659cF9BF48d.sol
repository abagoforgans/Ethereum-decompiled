...
function BellaBluToken() {
    bool(symbol.length) = 0
    symbol.length.field_1 = 5
    symbol.length.field_8 = 'BBCAT' / 256
    idx = 0
    while symbol.length + 31 / 32 > idx:
        ...
        continue 
    bool(name.length) = 0
    name.length.field_1 = 14
    name.length.field_8 = 'BellaBlu Token' / 256
    idx = 0
    ...
    balanceOf[0x21c37e05b484ca36b4e4477d8c2c9d48d792a15c] = _totalSupply
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  _totalSupply,
    emit 0x0: _totalSupply
    emit 0x21c37e05: _totalSupply
}
