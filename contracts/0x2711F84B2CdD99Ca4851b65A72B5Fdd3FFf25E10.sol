...
function _fallback() payable {
    ...
    require code.data[6481 len 32] <= 10000
    stor5 = code.data[6481 len 32]
    require ext_code.size(address(code.data[6449 len 32]))
    call address(code.data[6449 len 32]).supportsInterface(bytes4 rg1) with:
         gas gas_remaining - 710 wei
        args 0x9a20483d00000000000000000000000000000000000000000000000000000000
    require ext_call.success
    require ext_call.return_data[0]
    stor4 = address(code.data[6449 len 32])
    return code.data[683 len 5766]
}
...
function createAuction(uint256 arg1, uint256 arg2, uint256 arg3, uint256 arg4, address arg5) {
    ...
    require ext_code.size(nonFungibleContractAddress)
    call nonFungibleContractAddress.ownerOf(uint256 rg1) with:
         gas gas_remaining - 710 wei
        args arg1
    require ext_call.success
