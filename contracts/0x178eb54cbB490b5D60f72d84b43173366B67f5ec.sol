...
function sub_778e4cd7(?) {
    ...
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if (10 * 2 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) - (10 * ext_call.return_data[0] * 997000 * eth.balance(ext_call.return_data[0]) * ext_call.return_data[0] / 10^18) / 10^18:
