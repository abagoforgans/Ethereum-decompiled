...
function update() payable {
    ...
    call address(stor1).query(uint256 rg1, string rg2, string rg3) with:
       value ext_call.return_data[0] wei
        ...
        args 60, 96, 160, 0, 3, 'URL' % 16777216, 0, 76, 'json(https://api.kraken.com/0/pu', 'blic/Ticker?pair=ETHXBT).result.', 'XETHXXBT.c.0', Mask(96, -256, 'blic/Ticker?pair=ETHXBT).result.', 'XETHXXBT.c.0') << 256
    require ext_call.success
}
