...
function _fallback() payable {
    ...
    stor5.length.field_8 = 'EtherPower' / 256
    idx = 0
    ...
    stor9 = block.number
    stor17[address(msg.sender)] = 1000000 * 10^18
    stor14 = 1000000 * 10^18
    return code.data[478 len 7146]
}
...
function annualInterest() {
    ...
    if not block.timestamp - stakeStartTime / 8760 * 24 * 3600:
        return (25 * maxMintProofOfStake / 100)
    require stakeStartTime <= block.timestamp
    if block.timestamp - stakeStartTime / 8760 * 24 * 3600 != 1:
        return maxMintProofOfStake
    return (50 * maxMintProofOfStake / 100)
}
