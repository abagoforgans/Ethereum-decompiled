...
function SetSAToEContract(address arg1) {
    ...
    address(stor13.field_0) = satoeContractAddress
}
...
function TransferToBTCoE(address arg1, uint256 arg2) {
    require msg.sender == satoeContractAddress
...
function DeliverToClaimers(address[] arg1, uint256[] arg2) {
    ...
    while idx < arg1.length:
        ...
        if not stor14[mem[(32 * idx) + 140 len 20]]:
            ...
            stor1[address(mem[(32 * idx) + 128])] += mem[(32 * idx) + (32 * arg1.length) + 160]
            mem[(32 * arg1.length) + (32 * arg2.length) + 160] = mem[(32 * idx) + (32 * arg1.length) + 160]
            emit Transfer(mem[(32 * arg1.length) + (32 * arg2.length) + 160], msg.sender, address(_36));
            require idx < arg1.length
            mem[0] = mem[(32 * idx) + 140 len 20]
            mem[32] = 14
            ...
            require idx < arg2.length
            mem[(32 * arg1.length) + (32 * arg2.length) + 160] = mem[(32 * idx) + (32 * arg1.length) + 160]
            emit DeliveredBTC(mem[(32 * arg1.length) + (32 * arg2.length) + 160], address(_48));
        idx = idx + 1
        continue 
    return idx
}
