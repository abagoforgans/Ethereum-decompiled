                    ...
                    if not stor20:
                        ...
                        if not stor14:
                            ...
                            call vaultAddress.0x637b4fe1 with:
                                 gas gas_remaining wei
                                args address(arg1), stor19, stor20
                    else:
                        require 3000 * stor20 / stor20 == 3000
                        require ext_code.size(address(tokenAddress))
                        call address(tokenAddress).0xa9059cbb with:
                             gas gas_remaining wei
                            args address(arg1), 3000 * stor20 / 10000
                        if not ext_call.success:
                            revert with ext_call.return_data[0 len return_data.size]
                        require return_data.size >= 32
                        require ext_call.return_data[0]
                        emit TokenBonus((3000 * stor20 / 10000), arg1);
                        require (3000 * stor20 / 10000) + stor20 >= stor20
                        emit TokenPurchase(0, stor20, msg.sender, arg1);
                        if stor14:
                            emit 0xd5852300: stor15, stor16, stor19, (3000 * stor20 / 10000) + stor20, msg.sender, arg1
                        require stor19 + sub_d2c713a1 >= sub_d2c713a1
                        sub_d2c713a1 += stor19
                        require stor19 + contributions[address(arg1)] >= contributions[address(arg1)]
                        contributions[address(arg1)] += stor19
                        ...
                        if not stor14:
                            call vaultAddress.deposit(address arg1, uint256 arg2) with:
                                 gas 100000 wei
                                args address(arg1), (3000 * stor20 / 10000) + stor20
                        else:
                            call vaultAddress.0x637b4fe1 with:
                                 gas gas_remaining wei
                                args address(arg1), stor19, (3000 * stor20 / 10000) + stor20
                else:
                    if msg.value != 0:
                        ...
                        if not stor19:
                            ...
                            if not rate * stor19 / 10^18:
                                ...
                                if not stor14:
                                    ...
                                    call vaultAddress.0x637b4fe1 with:
                                         gas gas_remaining wei
                                        args address(arg1), stor19, rate * stor19 / 10^18
                            else:
                                require 3000 * rate * stor19 / 10^18 / rate * stor19 / 10^18 == 3000
                                require ext_code.size(address(tokenAddress))
                                call address(tokenAddress).0xa9059cbb with:
                                     gas gas_remaining wei
                                    args address(arg1), 3000 * rate * stor19 / 10^18 / 10000
                                if not ext_call.success:
                                    revert with ext_call.return_data[0 len return_data.size]
                                require return_data.size >= 32
                                require ext_call.return_data[0]
                                emit TokenBonus((3000 * rate * stor19 / 10^18 / 10000), arg1);
                                require (3000 * rate * stor19 / 10^18 / 10000) + (rate * stor19 / 10^18) >= rate * stor19 / 10^18
                                emit TokenPurchase(0, rate * stor19 / 10^18, msg.sender, arg1);
                                if stor14:
                                    emit 0xd5852300: stor15, stor16, stor19, (3000 * rate * stor19 / 10^18 / 10000) + (rate * stor19 / 10^18), msg.sender, arg1
                                require stor19 + sub_d2c713a1 >= sub_d2c713a1
                                sub_d2c713a1 += stor19
                                require stor19 + contributions[address(arg1)] >= contributions[address(arg1)]
                                contributions[address(arg1)] += stor19
                                ...
                                if not stor14:
                                    call vaultAddress.deposit(address arg1, uint256 arg2) with:
                                         gas 100000 wei
                                        args address(arg1), (3000 * rate * stor19 / 10^18 / 10000) + (rate * stor19 / 10^18)
                                else:
                                    call vaultAddress.0x637b4fe1 with:
                                         gas gas_remaining wei
                                        args address(arg1), stor19, (3000 * rate * stor19 / 10^18 / 10000) + (rate * stor19 / 10^18)
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
