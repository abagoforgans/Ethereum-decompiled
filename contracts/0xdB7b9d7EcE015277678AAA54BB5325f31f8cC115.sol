...
uint8 isTradable;
uint8 isUpgradable; offset 8
uint8 sub_42c1775b; offset 16
...
function sub_42c1775b(?) {
    return bool(sub_42c1775b)
}

function isTradable() {
    return bool(isTradable)
}

function isUpgradable() {
    return bool(isUpgradable)
}
...
function redeem(address arg1) {
    ...
    if sub_6d125c19 < 10^18 * ext_call.return_data[0]:
        return 0
    require ext_code.size(sub_cbbff2d5Address)
    call sub_cbbff2d5Address.0x950dad19 with:
         gas gas_remaining - 710 wei
        args arg1
    require ext_call.success
