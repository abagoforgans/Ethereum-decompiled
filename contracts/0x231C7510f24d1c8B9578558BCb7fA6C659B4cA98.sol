...
function _fallback() payable {
    ...
    return code.data[368 len 10945]
}
    ...
    if stor7.length <= firstActiveDuel2:
        if stor9.length > firstActiveDuel1:
            ...
            if stor6E15[stor10] + stor2.length < block.timestamp:
                require firstActiveDuel1 < stor9.length
                call address(stor[code.data[10913 len 32] + (6 * stor10)]) with:
                   value 2 * stor1.length - stor3.length wei
                     gas 0 wei
                stor4.length += 2 * stor3.length
                stor886E[stor10] = 1
                stor12[address(stor[code.data[10913 len 32] + (6 * stor10)])] = 0
                stor12[stor6E15[stor10]] = 0
                stor11.length++
                if not stor11.length > stor11.length + 1:
                    require firstActiveDuel1 < stor9.length
                    mem[288] = uint256(stor[sha3(code.data[10913 len 32] + (6 * stor10) + 1)])
                    idx = 288
                    s = 0
                    while stor[code.data[10913 len 32] + (6 * stor10) + 1].length + 256 > idx:
                        mem[idx + 32] = uint256(stor[s + sha3(code.data[10913 len 32] + (6 * stor10) + 1) + 1])
                        idx = idx + 32
                        s = s + 1
                        continue 
                    require firstActiveDuel1 < stor9.length
                    uint256(stor11[stor11.length].field_0) = address(stor[code.data[10913 len 32] + (6 * stor10)])
                    uint256(stor[sha3((5 * stor11.length) + ('name', 'stor11', 11) + 1)][].field_0) = Array(len=stor[code.data[10913 len 32] + (6 * stor10) + 1].length, data=mem[288 len stor[code.data[10913 len 32] + (6 * stor10) + 1].length])
                    address(stor11[stor11.length].field_512) = address(stor[code.data[10913 len 32] + (6 * stor10) + 2])
                            ...
                            if stor9.length > firstActiveDuel1:
                                ...
                                if stor6E15[stor10] + stor2.length < block.timestamp:
                                    ...
                                    if not stor11.length > stor11.length + 1:
                                        ...
                                        mem[288] = uint256(stor[sha3(code.data[10913 len 32] + (6 * stor10) + 1)])
                                        idx = 288
                                        s = sha3(code.data[10913 len 32] + (6 * firstActiveDuel1) + 1)
                                        while stor[code.data[10913 len 32] + (6 * stor10) + 1].length + 256 > idx:
                                            mem[idx + 32] = stor1[s]
                                            idx = idx + 32
                                            s = s + 1
                                            continue 
                                        require firstActiveDuel1 < stor9.length
                                        mem[ceil32(stor[code.data[10913 len 32] + (6 * stor10) + 1].length) + 288] = 7
                                        uint256(stor11[stor11.length].field_0) = address(stor[code.data[10913 len 32] + (6 * stor10)])
                                        uint256(stor11[stor11.length].field_256) = (2 * stor[code.data[10913 len 32] + (6 * stor10) + 1].length) + 1
                                        s = sha3((5 * stor11.length) + sha3(11) + 1)
                                        idx = 288
                                        while stor[code.data[10913 len 32] + (6 * stor10) + 1].length + 288 > idx:
                                            uint256(stor[s]) = mem[idx]
                                            s = s + 1
                                            idx = idx + 32
                                            continue 
                                        idx = sha3((5 * stor11.length) + sha3(11) + 1) + (Mask(251, 0, stor[code.data[10913 len 32] + (6 * stor10) + 1].length + 31) >> 5)
