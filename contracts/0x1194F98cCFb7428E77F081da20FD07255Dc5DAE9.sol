...
const _fallback = code.data[31 len 2982]
...
function _fallback() payable {
    ...
    require 10000 * msg.value / 85106382978723 > 0
    ...
    call 0x83984d6142934bb535793a82adb0a46ef0f66b6d.0x23b872dd with:
        ...
        args 0xbb12800e7446a51395b2d853d6ce7f22210bb5e5, msg.sender, (20 * 10000 * msg.value / 85106382978723 / 100) + (10000 * msg.value / 85106382978723)
    ...
    require ext_call.success
    emit Contributed(msg.sender, msg.value, (20 * 10000 * msg.value / 85106382978723 / 100) + (10000 * msg.value / 85106382978723));
}
...
function contributeFor(address arg1) payable {
    ...
    call 0x83984d6142934bb535793a82adb0a46ef0f66b6d.0x23b872dd with:
         gas gas_remaining - 710 wei
        args 0xbb12800e7446a51395b2d853d6ce7f22210bb5e5, address(arg1), (20 * 10000 * msg.value / 85106382978723 / 100) + (10000 * msg.value / 85106382978723)
    require ext_call.success
    require ext_call.return_data[0]
    preSaleContributions += msg.value
    ...
    call 0xbb12800e7446a51395b2d853d6ce7f22210bb5e5 with:
       value msg.value wei
         gas 2300 * is_zero(value) wei
    require ext_call.success
    emit Contributed(address(arg1), msg.value, (20 * 10000 * msg.value / 85106382978723 / 100) + (10000 * msg.value / 85106382978723));
    return 1
}
