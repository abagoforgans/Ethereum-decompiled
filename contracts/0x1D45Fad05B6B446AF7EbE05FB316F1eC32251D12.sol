...
function sub_49dc8342(?) {
    if sub_7bb7db6c.length > 0:
        require sub_7bb7db6c.length
        require arg1 % sub_7bb7db6c.length < sub_7bb7db6c.length
        require ext_code.size(stor3)
        call stor3.createGirl(uint256 arg1, address arg2, uint16 arg3) with:
             gas gas_remaining wei
            args sub_7bb7db6c[arg1 % sub_7bb7db6c.length], msg.sender, 1
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        require sub_7bb7db6c.length - 1 < sub_7bb7db6c.length
        require arg1 % sub_7bb7db6c.length < sub_7bb7db6c.length
        sub_7bb7db6c[arg1 % sub_7bb7db6c.length] = sub_7bb7db6c[sub_7bb7db6c.length]
        sub_7bb7db6c.length--
        if sub_7bb7db6c.length > sub_7bb7db6c.length - 1:
            idx = sub_7bb7db6c.length - 1
            while sub_7bb7db6c.length > idx:
                sub_7bb7db6c[idx] = 0
                idx = idx + 1
                continue 
}
