...
function _fallback() payable {
    ...
    stor0[address(msg.sender)] = 5000000000 * 10^18
    stor2 = 5000000000 * 10^18
    bool(stor3.length) = 0
    stor3.length.field_1 = 6
    stor3.length.field_8 = 'AOKEY7' / 256
    idx = 0
