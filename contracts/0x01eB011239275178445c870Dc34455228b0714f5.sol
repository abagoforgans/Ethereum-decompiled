...
const _fallback = code.data[19 len 11198]
...
function sub_de56a544(?) payable {
    ...
    emit code.data[11166 len 32]: msg.sender
}
...
function sub_160fe0f3(?) payable {
    if uint256(parentCount[address(arg1)].field_1024):
        mem[192] = uint256(parentCount[address(arg1)][4].field_0) / 256^0 << 232
        idx = 192
        s = 0
        while (32 * uint256(parentCount[address(arg1)].field_1024)) + 160 > idx:
            mem[idx + 32] = uint256(parentCount[address(arg1)][4].field_0) / 256^((-3 * s + 5 / 32) + s + (-1 * s + 5 / 32 * s) + 3) << 232
            idx = idx + 32
            s = (-3 * s + 5 / 32) + s + (-1 * s + 5 / 32 * s) + 3
            continue 
    if uint256(parentCount[address(arg1)].field_1280):
        mem[(32 * uint256(parentCount[address(arg1)].field_1024)) + 224] = uint256(parentCount[address(arg1)][5].field_0) / 256^0 << 232
        idx = (32 * uint256(parentCount[address(arg1)].field_1024)) + 224
        s = 0
        while (32 * uint256(parentCount[address(arg1)].field_1024)) + (32 * uint256(parentCount[address(arg1)].field_1280)) + 192 > idx:
            mem[idx + 32] = uint256(parentCount[address(arg1)][5].field_0) / 256^((-3 * s + 5 / 32) + s + (-1 * s + 5 / 32 * s) + 3) << 232
            idx = idx + 32
            s = (-3 * s + 5 / 32) + s + (-1 * s + 5 / 32 * s) + 3
            continue 
    mem[(64 * uint256(parentCount[address(arg1)].field_1024)) + (32 * uint256(parentCount[address(arg1)].field_1280)) + 320] = uint256(parentCount[address(arg1)].field_1280)
    mem[(64 * uint256(parentCount[address(arg1)].field_1024)) + (32 * uint256(parentCount[address(arg1)].field_1280)) + 352 len 32 * uint256(parentCount[address(arg1)].field_1280)] = mem[(32 * uint256(parentCount[address(arg1)].field_1024)) + 224 len 32 * uint256(parentCount[address(arg1)].field_1280)]
    return Array(len=uint256(parentCount[address(arg1)].field_1024), data=mem[192 len 32 * uint256(parentCount[address(arg1)].field_1024)], uint256(parentCount[address(arg1)].field_1280), mem[(32 * uint256(parentCount[address(arg1)].field_1024)) + 224 len 32 * uint256(parentCount[address(arg1)].field_1280)]), 
           (32 * uint256(parentCount[address(arg1)].field_1024)) + 96
}
...
function getBasicInfo(address arg1) payable {
    if uint256(parentCount[address(arg1)].field_512):
        mem[192] = uint256(parentCount[address(arg1)][2].field_0)
        idx = 192
        s = 0
        while uint256(parentCount[address(arg1)].field_512) + 160 > idx:
            mem[idx + 32] = uint256(parentCount[address(arg1)][s + 2].field_256)
            idx = idx + 32
            s = s + 1
            continue 
    if uint256(parentCount[address(arg1)].field_768):
        mem[ceil32(uint256(parentCount[address(arg1)].field_512)) + 224] = uint256(parentCount[address(arg1)][3].field_0)
        idx = ceil32(uint256(parentCount[address(arg1)].field_512)) + 224
        s = 0
        while ceil32(uint256(parentCount[address(arg1)].field_512)) + uint256(parentCount[address(arg1)].field_768) + 192 > idx:
            mem[idx + 32] = uint256(parentCount[address(arg1)][s + 3].field_256)
            idx = idx + 32
            s = s + 1
            continue 
    mem[uint256(parentCount[address(arg1)].field_512) + ceil32(uint256(parentCount[address(arg1)].field_512)) + ceil32(uint256(parentCount[address(arg1)].field_768)) + 448 len uint256(parentCount[address(arg1)].field_768)] = mem[ceil32(uint256(parentCount[address(arg1)].field_512)) + 224 len uint256(parentCount[address(arg1)].field_768)]
    if not parentCount[address(arg1)].field_768 % 32:
        return uint8(parentCount[address(arg1)].field_0), 
               uint8(parentCount[address(arg1)].field_0),
               uint8(parentCount[address(arg1)].field_0),
               Array(len=uint256(parentCount[address(arg1)].field_512), data=mem[192 len uint256(parentCount[address(arg1)].field_512)], uint256(parentCount[address(arg1)].field_768), mem[ceil32(uint256(parentCount[address(arg1)].field_512)) + 224 len uint256(parentCount[address(arg1)].field_768)]),
               uint256(parentCount[address(arg1)].field_512) + 192
    mem[floor32(uint256(parentCount[address(arg1)].field_768)) + uint256(parentCount[address(arg1)].field_512) + ceil32(uint256(parentCount[address(arg1)].field_512)) + ceil32(uint256(parentCount[address(arg1)].field_768)) + 448] = Mask(-(8 * -parentCount[address(arg1)].field_768 % 32 + 32) + 256, 0, mem[floor32(uint256(parentCount[address(arg1)].field_768)) + uint256(parentCount[address(arg1)].field_512) + ceil32(uint256(parentCount[address(arg1)].field_512)) + ceil32(uint256(parentCount[address(arg1)].field_768)) + 448])
    return uint8(parentCount[address(arg1)].field_0), 
           uint8(parentCount[address(arg1)].field_0),
           uint8(parentCount[address(arg1)].field_0),
           Array(len=uint256(parentCount[address(arg1)].field_512), data=mem[192 len uint256(parentCount[address(arg1)].field_512)], uint256(parentCount[address(arg1)].field_768), mem[ceil32(uint256(parentCount[address(arg1)].field_512)) + ceil32(uint256(parentCount[address(arg1)].field_768)) + uint256(parentCount[address(arg1)].field_512) + 448 len floor32(uint256(parentCount[address(arg1)].field_768)) + 32]),
           uint256(parentCount[address(arg1)].field_512) + 192
}
