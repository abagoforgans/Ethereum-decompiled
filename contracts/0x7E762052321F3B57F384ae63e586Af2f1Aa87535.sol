...
function sub_e3928d6c(?) payable {
    ...
    mem[(32 * ('cd', 100).length) + 772] = 32
    mem[(32 * ('cd', 100).length) + 804] = ('cd', 100).length
    mem[(32 * ('cd', 100).length) + 836 len floor32(('cd', 100).length)] = call.data[cd[100] + 36 len floor32(('cd', 100).length)]
    require ext_code.size(address(cd[68]))
    staticcall address(cd[68]).0x78981741 with:
            gas gas_remaining wei
           args mem[(32 * ('cd', 100).length) + 772 len (96 * ('cd', 100).length) + 64]
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    if ext_call.return_data[0] < 10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]):
        if not (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) - ext_call.return_data[0]:
            require cd[164]
            if not (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) - ext_call.return_data[0] / 2:
                require 10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])
                if cd[228]:
                    if 0 / cd[164] < cd[228]:
                        return code.data[3453 len 64], 
                               1,
                               0 / cd[164],
                               0 / 10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]),
                               code.data[3613 len 64]
                ...
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                require return_data.size >= 32
                mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 1028 len floor32(('cd', 132).length)] = call.data[cd[132] + 36 len floor32(('cd', 132).length)]
                require ext_code.size(address(cd[68]))
                staticcall address(cd[68]).getReturnByPath(address[] arg1, uint256 arg2) with:
                        gas gas_remaining wei
                       args Array(len=('cd', 132).length, data=call.data[cd[132] + 36 len floor32(('cd', 132).length)], mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + floor32(('cd', 132).length) + 1028 len (32 * ('cd', 132).length) - floor32(('cd', 132).length)]), ext_call.return_data[0]
                if not ext_call.success:
                    revert with ext_call.return_data[0 len return_data.size]
                ...
                return ext_call.return_data[0], 
                       ...
                       ext_call.return_data[0],
                       ext_call.return_data[0]
            require 0 / cd[164] * (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) - ext_call.return_data[0] / 2 / (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) - ext_call.return_data[0] / 2 == 0 / cd[164]
            require 10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])
            if cd[228]:
                if 0 / cd[164] < cd[228]:
                    return code.data[3453 len 64], 
                           1,
                           0 / cd[164],
                           0 / cd[164] * (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) - ext_call.return_data[0] / 2 / 10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]),
                           code.data[3613 len 64]
            require ext_code.size(address(cd[36]))
            staticcall address(cd[36]).getEthToTokenInputPrice(uint256 arg1) with:
                    gas gas_remaining wei
        ...
        if not (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) - ext_call.return_data[0] / 2:
            ...
            return ext_call.return_data[0], 
                   ...
                   ext_call.return_data[0],
                   ext_call.return_data[0]
        require (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) - (ext_call.return_data[0] * cd[196]) / cd[164] * (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) - ext_call.return_data[0] / 2 / (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) - ext_call.return_data[0] / 2 == (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) - (ext_call.return_data[0] * cd[196]) / cd[164]
        require 10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])
        if cd[228]:
            if (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) - (ext_call.return_data[0] * cd[196]) / cd[164] < cd[228]:
                return code.data[3453 len 64], 
                       1,
                       (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) - (ext_call.return_data[0] * cd[196]) / cd[164],
                       (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) - (ext_call.return_data[0] * cd[196]) / cd[164] * (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) - ext_call.return_data[0] / 2 / 10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]),
                       code.data[3613 len 64]
        require ext_code.size(address(cd[36]))
        staticcall address(cd[36]).getEthToTokenInputPrice(uint256 arg1) with:
                gas gas_remaining wei
    ...
    if not ext_call.return_data[0] - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])):
        require cd[164]
        if not ext_call.return_data[0] - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) / 2:
            require ext_call.return_data[0]
            if cd[228]:
                if 0 / cd[164] < cd[228]:
                    return code.data[3453 len 64], 0, 0 / cd[164], 0 / ext_call.return_data[0], code.data[3613 len 64]
            mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 964] = 0 / cd[164]
            mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 932] = 64
            mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 996] = ('cd', 100).length
            mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 1028 len floor32(('cd', 100).length)] = call.data[cd[100] + 36 len floor32(('cd', 100).length)]
            require ext_code.size(address(cd[68]))
            staticcall address(cd[68]).getReturnByPath(address[] arg1, uint256 arg2) with:
                    gas gas_remaining wei
                   args mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 932 len (161 * ('cd', 100).length) + 96]
            if not ext_call.success:
                revert with ext_call.return_data[0 len return_data.size]
            require return_data.size >= 64
            require ext_code.size(address(cd[36]))
            ...
            return ext_call.return_data[0], 
                   ...
                   ext_call.return_data[0],
                   ext_call.return_data[0]
        require 0 / cd[164] * ext_call.return_data[0] - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) / 2 / ext_call.return_data[0] - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) / 2 == 0 / cd[164]
        require ext_call.return_data[0]
        if cd[228]:
            if 0 / cd[164] < cd[228]:
                return code.data[3453 len 64], 
                       0,
                       0 / cd[164],
                       0 / cd[164] * ext_call.return_data[0] - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) / 2 / ext_call.return_data[0],
                       code.data[3613 len 64]
        mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 964] = 0 / cd[164]
        mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 932] = 64
        mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 996] = ('cd', 100).length
    ...
    if not ext_call.return_data[0] - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) / 2:
        ...
        if cd[228]:
            if (ext_call.return_data[0] * cd[196]) - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) / cd[164] < cd[228]:
                return code.data[3453 len 64], 
                       ...
                       0 / ext_call.return_data[0],
                       code.data[3613 len 64]
        mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 964] = (ext_call.return_data[0] * cd[196]) - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) / cd[164]
        mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 932] = 64
        mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 996] = ('cd', 100).length
        mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 1028 len floor32(('cd', 100).length)] = call.data[cd[100] + 36 len floor32(('cd', 100).length)]
        require ext_code.size(address(cd[68]))
        ...
        return ext_call.return_data[0], 
               ...
               ext_call.return_data[0],
               ext_call.return_data[0]
    require (ext_call.return_data[0] * cd[196]) - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) / cd[164] * ext_call.return_data[0] - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) / 2 / ext_call.return_data[0] - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) / 2 == (ext_call.return_data[0] * cd[196]) - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) / cd[164]
    require ext_call.return_data[0]
    if cd[228]:
        if (ext_call.return_data[0] * cd[196]) - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) / cd[164] < cd[228]:
            return code.data[3453 len 64], 
                   0,
                   (ext_call.return_data[0] * cd[196]) - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) / cd[164],
                   (ext_call.return_data[0] * cd[196]) - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) / cd[164] * ext_call.return_data[0] - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36])) / 2 / ext_call.return_data[0],
                   code.data[3613 len 64]
    mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 964] = (ext_call.return_data[0] * cd[196]) - (10000000 * 10^18 * ext_call.return_data[0] / eth.balance(cd[36]) * cd[196]) / cd[164]
    mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 932] = 64
    mem[(64 * ('cd', 100).length) + (32 * ('cd', 132).length) + 996] = ('cd', 100).length
