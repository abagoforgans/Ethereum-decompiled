...
function _fallback() {
    ...
    stor3 = 56666666
    stor2 = 56666666
    stor1 = 0x720762429c5d757f0c8759475e88f52552bd3d5a
    stor4 = 22000
    stor5 = 10
    stor6 = 'CVFDFGDG'
    stor9[0x720762429c5d757f0c8759475e88f52552bd3d5a] = 54545
    return code.data[197 len 2994]
}
...
function purchaseProduct(bytes32 arg1, uint256 arg2) {
    ...
    require arg2 * productPrices[arg1] <= balanceOf[address(msg.sender)]
    balanceOf[address(msg.sender)] += -1 * arg2 * productPrices[arg1]
