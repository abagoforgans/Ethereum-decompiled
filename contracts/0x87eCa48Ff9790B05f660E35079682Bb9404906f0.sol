...
function _fallback() payable {
    ...
    stor0.length.field_8 = 'Tourcoin' / 256
    idx = 0
    ...
    mem[224 len -4204] = code.data[4817 len -4204]
    stor3 = mem[224] * 18^stor2
