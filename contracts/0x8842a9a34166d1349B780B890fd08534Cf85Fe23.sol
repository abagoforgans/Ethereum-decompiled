...
function _fallback() payable {
    ...
    mem[96 len -9175] = code.data[10420 len -9175]
    mem[64] = -9079
    ...
    mem[-6141] = mem[mem[128] + 96]
    _10 = mem[mem[128] + 96]
    mem[-6109 len ceil32(mem[mem[128] + 96])] = mem[mem[128] + 128 len ceil32(mem[mem[128] + 96])]
    if not _10 % 32:
        mem[_10 - 6109] = mem[mem[160] + 96]
        _59 = mem[mem[160] + 96]
        mem[_10 - 6077 len ceil32(mem[mem[160] + 96])] = mem[mem[160] + 128 len ceil32(mem[mem[160] + 96])]
        if not _59 % 32:
            create contract with 0 wei
                            code: code.data[7578 len 2842], 96, _10 + 128, 0, mem[-6141 len _59 + _10 + 64]
        else:
            mem[floor32(_59) + _10 - 6077] = mem[floor32(_59) + _10 + -(_59 % 32) - 6045 len _59 % 32]
            create contract with 0 wei
                            code: code.data[7578 len 2842], 96, _10 + 128, 0, mem[-6141 len floor32(_59) + _10 + 96]
    else:
        mem[floor32(_10) - 6109] = mem[floor32(_10) + -(_10 % 32) - 6077 len _10 % 32]
        mem[floor32(_10) - 6077] = mem[mem[160] + 96]
        _62 = mem[mem[160] + 96]
        mem[floor32(_10) - 6045 len ceil32(mem[mem[160] + 96])] = mem[mem[160] + 128 len ceil32(mem[mem[160] + 96])]
        if not _62 % 32:
            create contract with 0 wei
                            code: code.data[7578 len 2842], 96, floor32(_10) + 160, 0, mem[-6141 len _62 + floor32(_10) + 96]
        else:
            mem[floor32(_62) + floor32(_10) - 6045] = mem[floor32(_62) + floor32(_10) + -(_62 % 32) - 6013 len _62 % 32]
            create contract with 0 wei
                            code: code.data[7578 len 2842], 96, floor32(_10) + 160, 0, mem[-6141 len floor32(_62) + floor32(_10) + 128]
    ...
    return code.data[1245 len 6333]
}
...
function sub_a39e0b09(?) {
    if sub_e477e14fAddress != msg.sender:
        require beneficiaryAddress == msg.sender
