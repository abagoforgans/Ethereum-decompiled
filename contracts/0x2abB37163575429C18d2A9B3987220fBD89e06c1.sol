...
function sub_a969304d(?) {
    return address(sub_a969304dAddress)
}
...
function sub_fc7e4746(?) {
    require address(sub_a969304dAddress) == msg.sender
...
function sub_e20151d5(?) {
    ...
    if stor0[arg1 << 192].field_256:
        ...
        stor0[arg1 << 192].field_256 = uint64(stor1)
        stor0[arg1 << 192].field_320 = 0
