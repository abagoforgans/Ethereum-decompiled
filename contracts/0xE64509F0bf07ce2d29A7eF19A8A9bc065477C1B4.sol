...
function _fallback() payable {
    ...
    stor5[address(msg.sender)] = 753190753700 * 10^6
    stor4 = 753190753700 * 10^6
    bool(stor1.length) = 0
    stor1.length.field_1 = 8
    stor1.length.field_8 = 'PiplCoin' / 256
    idx = 0
