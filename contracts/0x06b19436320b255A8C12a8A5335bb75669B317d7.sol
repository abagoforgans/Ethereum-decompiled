...
function _fallback() {
    ...
    stor3.length.field_8 = 'Mazmax Network' / 256
    idx = 0
    while stor3.length + 31 / 32 > idx:
        ...
        continue 
    stor4 = 18
    stor5 = 17770000000 * 10^18
    stor6784 = 17770000000 * 10^18
    emit Transfer(address arg1, address arg2, uint256 arg3):
                  17770000000 * 10^18,
    emit 0x0: 17770000000 * 10^18
    emit 0xb9c344fb: 17770000000 * 10^18
    return code.data[512 len 2920]
}
