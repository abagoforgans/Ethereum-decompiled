    ...
    if msg.value != 0:
        if msg.value < 10^16:
            ...
            if uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0) <= 20:
                ...
                Mask(80, 0, stor[uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0) + sha3((4 * arg2) + (68 * arg1) + 2) - 1].field_0) = Mask(80, 0, arg3)
                Mask(80, 0, stor[uint256(stor[(4 * arg2) + (68 * arg1) + 2].field_0) + sha3((4 * arg2) + (68 * arg1) + 2) - 1].field_80) = 0
                sub_0a786f34 += Mask(80, 0, arg3)
}
    ...
    if address(stor[(4 * arg2) + (68 * arg1) + 1].field_8) == msg.sender:
        ...
        if block.number - uint256(stor[(4 * arg2) + (68 * arg1) + 4].field_0) >= 4320:
            ...
            while uint16(idx) < 10:
                ...
                if uint128(uint128(block.hash(block.number - 1)) % uint16(-idx + 256)) != 0:
                    uint256(stor[(0.03125 / uint256(stor[(4 * arg2) + (68 * arg1) + 3].field_0) - 7) + sha3((4 * arg2) + (68 * arg1) + 3)].field_0) = uint256(stor[(0.03125 / uint256(stor[(4 * arg2) + (68 * arg1) + 3].field_0) - 7) + sha3((4 * arg2) + (68 * arg1) + 3)].field_0) and !(255 * 256^(uint256(stor[(4 * arg2) + (68 * arg1) + 3].field_0) - 7 % 32))
                    require arg1 < 17
                    require arg2 < 17
                    require arg1 < 17
                    require arg2 < 17
                ...
                idx = idx + 1
                s = uint128(block.hash(block.number - 1)) % uint16(-idx + 256)
                continue 
            require arg1 < 17
            require arg2 < 17
