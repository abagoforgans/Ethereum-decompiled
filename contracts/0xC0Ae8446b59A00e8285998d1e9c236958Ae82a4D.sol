...
function sub_9611cc84(?) {
    ...
    require uint256(stor1[_126].field_0) < stor4.length
    require uint256(stor1[_126].field_0) < stor5.length
    mem[ceil32(arg1.length) + 288] = uint256(stor4[uint256(stor1[_126].field_0)].field_0)
    idx = ceil32(arg1.length) + 288
    s = 0
    while ceil32(arg1.length) + stor4[uint256(stor1[_126].field_0)].length + 256 > idx:
        mem[idx + 32] = uint256(stor4[uint256(stor1[_126].field_0) + s].field_256)
        idx = idx + 32
        s = s + 1
        continue 
    mem[ceil32(arg1.length) + ceil32(stor4[uint256(stor1[_126].field_0)].length) + 480 len ceil32(stor4[uint256(stor1[_126].field_0)].length)] = mem[ceil32(arg1.length) + 288 len ceil32(stor4[uint256(stor1[_126].field_0)].length)]
    if stor3 <= block.timestamp:
        mem[stor4[uint256(stor1[_126].field_0)].length + ceil32(arg1.length) + ceil32(stor4[uint256(stor1[_126].field_0)].length) + 480] = 13
        mem[stor4[uint256(stor1[_126].field_0)].length + ceil32(arg1.length) + ceil32(stor4[uint256(stor1[_126].field_0)].length) + 512] = Mask(104, 0, 'voting closed')
    else:
        mem[stor4[uint256(stor1[_126].field_0)].length + ceil32(arg1.length) + ceil32(stor4[uint256(stor1[_126].field_0)].length) + 480] = 11
        mem[stor4[uint256(stor1[_126].field_0)].length + ceil32(arg1.length) + ceil32(stor4[uint256(stor1[_126].field_0)].length) + 512] = Mask(88, 0, 'voting open')
    return bool(stor[_126]), 
           Array(len=stor4[uint256(stor1[_126].field_0)].length, data=mem[ceil32(arg1.length) + 288 len ceil32(stor4[uint256(stor1[_126].field_0)].length)], mem[ceil32(arg1.length) + (2 * ceil32(stor4[uint256(stor1[_126].field_0)].length)) + 480 len stor4[uint256(stor1[_126].field_0)].length + -ceil32(stor4[uint256(stor1[_126].field_0)].length) + 64]),
           stor5[uint256(stor1[_126].field_0)],
           stor6,
           stor4[uint256(stor1[_126].field_0)].length + 192
}
...
function sub_e5d1d902(?) {
    ...
    if stor3 <= block.timestamp:
        ...
        mem[ceil32(stor0.length) + ceil32(stor1.length) + 448] = stor2
