...
function _fallback() payable {
    ...
    stor2 = 10^18 * code.data[2778 len 32]
    stor4 = block.timestamp + (60 * code.data[2810 len 32])
    stor5 = 10^18 * code.data[2842 len 32]
    require code.data[2842 len 32]
    stor6 = code.data[2778 len 32] / code.data[2842 len 32]
    stor7 = code.data[2886 len 20]
    return code.data[439 len 2307]
}
