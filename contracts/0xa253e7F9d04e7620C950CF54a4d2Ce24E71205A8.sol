...
mapping of uint256 voteToRemoveParams;
...
function voteToRemoveParams(address arg1, address arg2) payable {
    require calldata.size - 4 >= 64
    return voteToRemoveParams[arg1][arg2]
}
...
function proposeGlobalConstraint(address arg1, address arg2, bytes32 arg3, bytes32 arg4, string arg5) payable {
    ...
    emit NewGlobalConstraintsProposal(address(arg2), arg3, arg4, Array(len=arg5.length, data=arg5[all]), arg1, ext_call.return_data[0], parameters[ext_call.return_data[0]].field_256);
    stor0[stor3[ext_call.return_data[0]].field_256][ext_call.return_data[0]].field_0 = block.number
    stor0[stor3[ext_call.return_data[0]].field_256][ext_call.return_data[0]].field_256 = arg1
    return ext_call.return_data[0]
}
...
function executeProposal(bytes32 arg1, int256 arg2) payable {
    ...
    if not organizationsProposals[stor0[msg.sender][arg1].field_256][arg1].field_160:
        if organizationsProposals[stor0[msg.sender][arg1].field_256][arg1].field_160:
            ...
            return 1
        require ext_code.size(address(ext_call.return_data[0]))
        call address(ext_call.return_data[0]).removeGlobalConstraint(address arg1, address arg2) with:
             gas gas_remaining wei
        ...
        require ext_code.size(address(ext_call.return_data[0]))
        call address(ext_call.return_data[0]).addGlobalConstraint(address arg1, bytes32 arg2, address arg3) with:
             gas gas_remaining wei
            args organizationsProposals[stor0[msg.sender][arg1].field_256][arg1].field_0, organizationsProposals[stor0[msg.sender][arg1].field_256][arg1].field_256, stor0[msg.sender][arg1].field_256
        if not ext_call.success:
            revert with ext_call.return_data[0 len return_data.size]
        require return_data.size >= 32
        voteToRemoveParams[stor0[msg.sender][arg1].field_256][stor1[stor0[msg.sender][arg1].field_256][arg1].field_0] = organizationsProposals[stor0[msg.sender][arg1].field_256][arg1].field_512
        if not organizationsProposals[stor0[msg.sender][arg1].field_256][arg1].field_160:
            require ext_code.size(address(ext_call.return_data[0]))
            call address(ext_call.return_data[0]).removeGlobalConstraint(address arg1, address arg2) with:
                 gas gas_remaining wei
...
function proposeToRemoveGC(address arg1, address arg2, string arg3) payable {
    require calldata.size - 4 >= 96
    ...
    require return_data.size >= 32
    require ext_code.size(address(ext_call.return_data[0]))
    staticcall address(ext_call.return_data[0]).isGlobalConstraintRegistered(address arg1, address arg2) with:
            gas gas_remaining wei
    ...
    call parameters[ext_call.return_data[0]].field_256.0x88737b5e with:
         gas gas_remaining wei
        args 2, voteToRemoveParams[address(arg1)][address(arg2)], msg.sender, arg1
    if not ext_call.success:
        revert with ext_call.return_data[0 len return_data.size]
    require return_data.size >= 32
    organizationsProposals[address(arg1)][ext_call.return_data[0]].field_0 = arg2
    organizationsProposals[address(arg1)][ext_call.return_data[0]].field_160 = 0
    organizationsProposals[address(arg1)][ext_call.return_data[0]].field_256 = 0
    organizationsProposals[address(arg1)][ext_call.return_data[0]].field_512 = 0
    emit RemoveGlobalConstraintsProposal(address(arg2), Array(len=arg3.length, data=arg3[all]), arg1, ext_call.return_data[0], parameters[ext_call.return_data[0]].field_256);
    stor0[stor3[ext_call.return_data[0]].field_256][ext_call.return_data[0]].field_0 = block.number
    stor0[stor3[ext_call.return_data[0]].field_256][ext_call.return_data[0]].field_256 = arg1
    return ext_call.return_data[0]
}
